...
func TestCategoriesInterface(t *testing.T) {
	...
	t.Run("List", func(t *testing.T) {
		...
		result, err := mockCategories.List(ctx, converged.WithPage(1), converged.WithLimit(10))
		assert.NoError(t, err)
	...
	t.Run("ListAll", func(t *testing.T) {
		...
		result, err := mockCategories.List(ctx, converged.WithFilter("name eq 'test'"))
		assert.NoError(t, err)
		assert.Equal(t, expectedCategories, result)
	})
	...
	t.Run("NewIterator", func(t *testing.T) {
		...
		mockCategories.EXPECT().
			...
			Return(converged.Iterator[TestCategory](mockIterator))

		iterator := mockCategories.NewIterator(context.Background(), converged.WithPage(1))
...
func TestCategoriesInterfaceComposition(t *testing.T) {
	...
	t.Run("as Getter", func(t *testing.T) {
		var getter converged.Getter[TestCategory] = mockCategories
	...
	t.Run("as Lister", func(t *testing.T) {
		var lister converged.Lister[TestCategory] = mockCategories
	...
	t.Run("as Creator", func(t *testing.T) {
		var creator converged.Creator[TestCategory] = mockCategories
	...
	t.Run("as Updater", func(t *testing.T) {
		var updater converged.Updater[TestCategory] = mockCategories
	...
	t.Run("as Deleter", func(t *testing.T) {
		var deleter converged.Deleter[TestCategory] = mockCategories
...
func TestCategoriesWithODataOptions(t *testing.T) {
	...
	t.Run("with page option", func(t *testing.T) {
		...
		result, err := mockCategories.List(ctx, converged.WithPage(1))
		assert.NoError(t, err)
		assert.Equal(t, expectedCategories, result)
	})
	...
	t.Run("with limit option", func(t *testing.T) {
		...
		result, err := mockCategories.List(ctx, converged.WithLimit(5))
		assert.NoError(t, err)
		assert.Equal(t, expectedCategories, result)
	})
	...
	t.Run("with order by option", func(t *testing.T) {
		...
		result, err := mockCategories.List(ctx, converged.WithOrderBy("name asc"))
		assert.NoError(t, err)
		assert.Equal(t, expectedCategories, result)
	})
	...
	t.Run("with expand option", func(t *testing.T) {
		...
		result, err := mockCategories.List(ctx, converged.WithExpand("metadata"))
		assert.NoError(t, err)
		assert.Equal(t, expectedCategories, result)
	})
	...
	t.Run("with select option", func(t *testing.T) {
		...
		result, err := mockCategories.List(ctx, converged.WithSelect("id,name"))
		assert.NoError(t, err)
		assert.Equal(t, expectedCategories, result)
	})
	...
	t.Run("with apply option", func(t *testing.T) {
		...
		result, err := mockCategories.List(ctx, converged.WithApply("groupby((name))"))
		assert.NoError(t, err)
		assert.Equal(t, expectedCategories, result)
	})
	...
	t.Run("with multiple options", func(t *testing.T) {
		...
		result, err := mockCategories.List(ctx, converged.WithPage(1), converged.WithLimit(10), converged.WithFilter("name eq 'test'"), converged.WithOrderBy("name asc"))
		assert.NoError(t, err)
		assert.Equal(t, expectedCategories, result)
	})
}
