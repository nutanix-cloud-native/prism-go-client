...
import (
	...
	convergedclient "github.com/nutanix-cloud-native/prism-go-client/converged"
...
func (m *MockVMs[VM]) CreateAsync(ctx context.Context, entity *VM) (convergedclient.Operation[VM], error) {
	m.ctrl.T.Helper()
...
func (m *MockVMs[VM]) List(ctx context.Context, opts ...convergedclient.ODataOption) ([]VM, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx}
	for _, a := range opts {
...
func (m *MockVMs[VM]) NewIterator(ctx context.Context, opts ...convergedclient.ODataOption) convergedclient.Iterator[VM] {
	...
	ret0, _ := ret[0].(convergedclient.Iterator[VM])
	return ret0
}
...
func (m *MockVMs[VM]) PowerOffVM(uuid string) (convergedclient.Operation[VM], error) {
	m.ctrl.T.Helper()
...
func (m *MockVMs[VM]) PowerOnVM(uuid string) (convergedclient.Operation[VM], error) {
	m.ctrl.T.Helper()
...
func (m *MockVMs[VM]) UpdateAsync(ctx context.Context, uuid string, entity *VM) (convergedclient.Operation[VM], error) {
	m.ctrl.T.Helper()
