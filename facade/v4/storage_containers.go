...
func (f *FacadeV4Client) GetStorageContainer(uuid string) (*storageContainerModels.StorageContainer, error) {
	return CommonGetEntity[*storageContainerModels.GetStorageContainerApiResponse, storageContainerModels.StorageContainer, *storageContainerModelsError.ErrorResponse](
...
func (f *FacadeV4Client) ListStorageContainers(opts ...facade.ODataOption) ([]storageContainerModels.StorageContainer, error) {
	return CommonListEntities[*storageContainerModels.ListStorageContainersApiResponse, storageContainerModels.StorageContainer, *storageContainerModelsError.ErrorResponse](
...
func (f *FacadeV4Client) ListAllStorageContainers(filterParam *string, orderbyParam *string, selectParam *string) ([]storageContainerModels.StorageContainer, error) {
	...
	return CommonListAllEntities[*storageContainerModels.ListStorageContainersApiResponse, storageContainerModels.StorageContainer, *storageContainerModelsError.ErrorResponse](
		func(reqParams *V4ODataParams) (*storageContainerModels.ListStorageContainersApiResponse, error) {
			return f.client.StorageContainerAPI.ListStorageContainers(
				reqParams.Page,
				reqParams.Limit,
...
func (f *FacadeV4Client) GetListIteratorStorageContainers(opts ...facade.ODataOption) facade.ODataListIterator[storageContainerModels.StorageContainer] {
	return CommonGetListIterator[*storageContainerModels.ListStorageContainersApiResponse, storageContainerModels.StorageContainer, *storageContainerModelsError.ErrorResponse](
		f,
		func(reqParams *V4ODataParams) (*storageContainerModels.ListStorageContainersApiResponse, error) {
			return f.client.StorageContainerAPI.ListStorageContainers(
				reqParams.Page,
