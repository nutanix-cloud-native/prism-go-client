...
func (f *FacadeV4Client) GetImage(ctx context.Context, uuid string) (*imageModels.Image, error) {
...
func (f *FacadeV4Client) ListImages(ctx context.Context, opts ...facade.ODataOption) ([]imageModels.Image, error) {
...
func (f *FacadeV4Client) ListAllImages(ctx context.Context, filterParam *string, orderbyParam *string, selectParam *string) ([]imageModels.Image, error) {
...
func (f *FacadeV4Client) GetListIteratorImages(ctx context.Context, opts ...facade.ODataOption) facade.ODataListIterator[imageModels.Image] {
