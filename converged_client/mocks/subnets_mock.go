...
// Source: converged_client/subnets.go
//
...
func (m *MockSubnets[Subnet]) List(ctx context.Context, opts ...convergedclient.ODataOption) ([]Subnet, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx}
	for _, a := range opts {
...
func (m *MockSubnets[Subnet]) NewIterator(ctx context.Context, opts ...convergedclient.ODataOption) convergedclient.Iterator[Subnet] {
	...
	ret0, _ := ret[0].(convergedclient.Iterator[Subnet])
	return ret0
}
