...
// Source: converged_client/categories.go
//
...
func (m *MockCategories[Category]) List(ctx context.Context, opts ...convergedclient.ODataOption) ([]Category, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx}
	for _, a := range opts {
...
func (m *MockCategories[Category]) NewIterator(ctx context.Context, opts ...convergedclient.ODataOption) convergedclient.Iterator[Category] {
	...
	ret0, _ := ret[0].(convergedclient.Iterator[Category])
	return ret0
}
