...
// checks if the RecoveryPlanNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanNetwork{}

// RecoveryPlanNetwork Network configuration to be used for performing network mapping and IP preservation/mapping on Recovery Plan execution. 
type RecoveryPlanNetwork struct {
	...
	SubnetList []RecoveryPlanSubnetConfig `json:"subnet_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanNetwork RecoveryPlanNetwork
...
// GetUseVpcReference returns the UseVpcReference field value if set, zero value otherwise.
func (o *RecoveryPlanNetwork) GetUseVpcReference() bool {
	if o == nil || IsNil(o.UseVpcReference) {
		var ret bool
		return ret
	}
	return *o.UseVpcReference
}

// GetUseVpcReferenceOk returns a tuple with the UseVpcReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanNetwork) GetUseVpcReferenceOk() (*bool, bool) {
	if o == nil || IsNil(o.UseVpcReference) {
		return nil, false
	}
	return o.UseVpcReference, true
}
...
// SetUseVpcReference gets a reference to the given bool and assigns it to the UseVpcReference field.
...
// GetSubnetList returns the SubnetList field value if set, zero value otherwise.
func (o *RecoveryPlanNetwork) GetSubnetList() []RecoveryPlanSubnetConfig {
	if o == nil || IsNil(o.SubnetList) {
		var ret []RecoveryPlanSubnetConfig
		return ret
	}
	return o.SubnetList
}

// GetSubnetListOk returns a tuple with the SubnetList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanNetwork) GetSubnetListOk() ([]RecoveryPlanSubnetConfig, bool) {
	if o == nil || IsNil(o.SubnetList) {
		return nil, false
	}
	return o.SubnetList, true
}
...
// SetSubnetList gets a reference to the given []RecoveryPlanSubnetConfig and assigns it to the SubnetList field.
func (o *RecoveryPlanNetwork) SetSubnetList(v []RecoveryPlanSubnetConfig) {
	o.SubnetList = v
}

func (o RecoveryPlanNetwork) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanNetwork) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UseVpcReference) {
		toSerialize["use_vpc_reference"] = o.UseVpcReference
	}
	if !IsNil(o.VirtualNetworkReference) {
		toSerialize["virtual_network_reference"] = o.VirtualNetworkReference
	}
	if !IsNil(o.SubnetList) {
		toSerialize["subnet_list"] = o.SubnetList
	}
...
func (o *RecoveryPlanNetwork) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanNetwork := _RecoveryPlanNetwork{}

	err = json.Unmarshal(data, &varRecoveryPlanNetwork)

	if err != nil {
		return err
	}

	*o = RecoveryPlanNetwork(varRecoveryPlanNetwork)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "use_vpc_reference")
		delete(additionalProperties, "virtual_network_reference")
		delete(additionalProperties, "subnet_list")
...
type NullableRecoveryPlanNetwork struct {
	value *RecoveryPlanNetwork
	isSet bool
}

func (v NullableRecoveryPlanNetwork) Get() *RecoveryPlanNetwork {
	return v.value
}

func (v *NullableRecoveryPlanNetwork) Set(val *RecoveryPlanNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanNetwork(val *RecoveryPlanNetwork) *NullableRecoveryPlanNetwork {
	return &NullableRecoveryPlanNetwork{value: val, isSet: true}
}

func (v NullableRecoveryPlanNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
