...
// checks if the VirtualNetworkListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkListMetadataOutput{}

// VirtualNetworkListMetadataOutput All api calls that return a list will have this metadata block 
type VirtualNetworkListMetadataOutput struct {
	// The kind name
...
type _VirtualNetworkListMetadataOutput VirtualNetworkListMetadataOutput
...
func NewVirtualNetworkListMetadataOutput() *VirtualNetworkListMetadataOutput {
	this := VirtualNetworkListMetadataOutput{}
	var kind string = "virtual_network"
	this.Kind = &kind
	return &this
}
...
func (o VirtualNetworkListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualNetworkListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVirtualNetworkListMetadataOutput := _VirtualNetworkListMetadataOutput{}

	err = json.Unmarshal(data, &varVirtualNetworkListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VirtualNetworkListMetadataOutput(varVirtualNetworkListMetadataOutput)
...
type NullableVirtualNetworkListMetadataOutput struct {
	value *VirtualNetworkListMetadataOutput
	isSet bool
}

func (v NullableVirtualNetworkListMetadataOutput) Get() *VirtualNetworkListMetadataOutput {
	return v.value
}

func (v *NullableVirtualNetworkListMetadataOutput) Set(val *VirtualNetworkListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkListMetadataOutput(val *VirtualNetworkListMetadataOutput) *NullableVirtualNetworkListMetadataOutput {
	return &NullableVirtualNetworkListMetadataOutput{value: val, isSet: true}
}

func (v NullableVirtualNetworkListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
