...
// checks if the AvailabilityZoneIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneIntentResponse{}

// AvailabilityZoneIntentResponse Response object for intentful operations on a availability_zone
...
type _AvailabilityZoneIntentResponse AvailabilityZoneIntentResponse
...
func NewAvailabilityZoneIntentResponse(apiVersion string, metadata AvailabilityZoneMetadata) *AvailabilityZoneIntentResponse {
	this := AvailabilityZoneIntentResponse{}
...
func (o AvailabilityZoneIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAvailabilityZoneIntentResponse := _AvailabilityZoneIntentResponse{}

	err = json.Unmarshal(data, &varAvailabilityZoneIntentResponse)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneIntentResponse(varAvailabilityZoneIntentResponse)
...
type NullableAvailabilityZoneIntentResponse struct {
	value *AvailabilityZoneIntentResponse
	isSet bool
}

func (v NullableAvailabilityZoneIntentResponse) Get() *AvailabilityZoneIntentResponse {
	return v.value
}

func (v *NullableAvailabilityZoneIntentResponse) Set(val *AvailabilityZoneIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneIntentResponse(val *AvailabilityZoneIntentResponse) *NullableAvailabilityZoneIntentResponse {
	return &NullableAvailabilityZoneIntentResponse{value: val, isSet: true}
}

func (v NullableAvailabilityZoneIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
