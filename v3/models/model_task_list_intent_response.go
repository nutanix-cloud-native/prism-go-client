...
// checks if the TaskListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskListIntentResponse{}

// TaskListIntentResponse Task entity list.
type TaskListIntentResponse struct {
	Entities []Task `json:"entities"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata TaskListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _TaskListIntentResponse TaskListIntentResponse
...
func (o *TaskListIntentResponse) GetMetadata() TaskListMetadataOutput {
	if o == nil {
		var ret TaskListMetadataOutput
		return ret
	}
...
func (o TaskListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o TaskListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *TaskListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskListIntentResponse := _TaskListIntentResponse{}

	err = json.Unmarshal(data, &varTaskListIntentResponse)

	if err != nil {
		return err
	}

	*o = TaskListIntentResponse(varTaskListIntentResponse)
...
type NullableTaskListIntentResponse struct {
	value *TaskListIntentResponse
	isSet bool
}

func (v NullableTaskListIntentResponse) Get() *TaskListIntentResponse {
	return v.value
}

func (v *NullableTaskListIntentResponse) Set(val *TaskListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskListIntentResponse(val *TaskListIntentResponse) *NullableTaskListIntentResponse {
	return &NullableTaskListIntentResponse{value: val, isSet: true}
}

func (v NullableTaskListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
