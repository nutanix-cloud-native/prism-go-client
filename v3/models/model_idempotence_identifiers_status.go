...
// checks if the IdempotenceIdentifiersStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdempotenceIdentifiersStatus{}

// IdempotenceIdentifiersStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _IdempotenceIdentifiersStatus IdempotenceIdentifiersStatus
...
func NewIdempotenceIdentifiersStatus() *IdempotenceIdentifiersStatus {
	this := IdempotenceIdentifiersStatus{}
	return &this
}
...
func (o IdempotenceIdentifiersStatus) MarshalJSON() ([]byte, error) {
...
func (o IdempotenceIdentifiersStatus) ToMap() (map[string]interface{}, error) {
...
func (o *IdempotenceIdentifiersStatus) UnmarshalJSON(data []byte) (err error) {
	varIdempotenceIdentifiersStatus := _IdempotenceIdentifiersStatus{}

	err = json.Unmarshal(data, &varIdempotenceIdentifiersStatus)

	if err != nil {
		return err
	}

	*o = IdempotenceIdentifiersStatus(varIdempotenceIdentifiersStatus)
...
type NullableIdempotenceIdentifiersStatus struct {
	value *IdempotenceIdentifiersStatus
	isSet bool
}

func (v NullableIdempotenceIdentifiersStatus) Get() *IdempotenceIdentifiersStatus {
	return v.value
}

func (v *NullableIdempotenceIdentifiersStatus) Set(val *IdempotenceIdentifiersStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableIdempotenceIdentifiersStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableIdempotenceIdentifiersStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdempotenceIdentifiersStatus(val *IdempotenceIdentifiersStatus) *NullableIdempotenceIdentifiersStatus {
	return &NullableIdempotenceIdentifiersStatus{value: val, isSet: true}
}

func (v NullableIdempotenceIdentifiersStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdempotenceIdentifiersStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
