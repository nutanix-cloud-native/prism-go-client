...
// checks if the UnderlaySubnetStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnetStatus{}

// UnderlaySubnetStatus The status of a REST API call. Only used when there is a failure to report. 
type UnderlaySubnetStatus struct {
	// The kind name
...
type _UnderlaySubnetStatus UnderlaySubnetStatus
...
func (o UnderlaySubnetStatus) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnetStatus) ToMap() (map[string]interface{}, error) {
...
func (o *UnderlaySubnetStatus) UnmarshalJSON(data []byte) (err error) {
	varUnderlaySubnetStatus := _UnderlaySubnetStatus{}

	err = json.Unmarshal(data, &varUnderlaySubnetStatus)

	if err != nil {
		return err
	}

	*o = UnderlaySubnetStatus(varUnderlaySubnetStatus)
...
type NullableUnderlaySubnetStatus struct {
	value *UnderlaySubnetStatus
	isSet bool
}

func (v NullableUnderlaySubnetStatus) Get() *UnderlaySubnetStatus {
	return v.value
}

func (v *NullableUnderlaySubnetStatus) Set(val *UnderlaySubnetStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnetStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnetStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnetStatus(val *UnderlaySubnetStatus) *NullableUnderlaySubnetStatus {
	return &NullableUnderlaySubnetStatus{value: val, isSet: true}
}

func (v NullableUnderlaySubnetStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnetStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
