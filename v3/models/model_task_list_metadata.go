...
// checks if the TaskListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskListMetadata{}
...
type _TaskListMetadata TaskListMetadata
...
func (o TaskListMetadata) MarshalJSON() ([]byte, error) {
...
func (o TaskListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *TaskListMetadata) UnmarshalJSON(data []byte) (err error) {
	varTaskListMetadata := _TaskListMetadata{}

	err = json.Unmarshal(data, &varTaskListMetadata)

	if err != nil {
		return err
	}

	*o = TaskListMetadata(varTaskListMetadata)
...
type NullableTaskListMetadata struct {
	value *TaskListMetadata
	isSet bool
}

func (v NullableTaskListMetadata) Get() *TaskListMetadata {
	return v.value
}

func (v *NullableTaskListMetadata) Set(val *TaskListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskListMetadata(val *TaskListMetadata) *NullableTaskListMetadata {
	return &NullableTaskListMetadata{value: val, isSet: true}
}

func (v NullableTaskListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
