...
// checks if the XigDnsConfigResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &XigDnsConfigResponse{}

// XigDnsConfigResponse PC's DNS Config Response for XIG.
type XigDnsConfigResponse struct {
	// Rules to rewrite API paths.
	RewriteRulesList []RewriteRule `json:"rewrite_rules_list,omitempty"`
	// -> Required if any proxy rule has token validation on. This is the source information where XIG will poll for JSON web keys and do token validations against.
	JwkSourceList []JwkSource `json:"jwk_source_list,omitempty"`
	// -> Api path regex which needs to bypass authendication/token validation.
	BypassAuthPathList []string `json:"bypass_auth_path_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _XigDnsConfigResponse XigDnsConfigResponse
...
// GetRewriteRulesList returns the RewriteRulesList field value if set, zero value otherwise.
func (o *XigDnsConfigResponse) GetRewriteRulesList() []RewriteRule {
	if o == nil || IsNil(o.RewriteRulesList) {
		var ret []RewriteRule
		return ret
	}
	return o.RewriteRulesList
}

// GetRewriteRulesListOk returns a tuple with the RewriteRulesList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *XigDnsConfigResponse) GetRewriteRulesListOk() ([]RewriteRule, bool) {
	if o == nil || IsNil(o.RewriteRulesList) {
		return nil, false
	}
	return o.RewriteRulesList, true
}
...
// SetRewriteRulesList gets a reference to the given []RewriteRule and assigns it to the RewriteRulesList field.
func (o *XigDnsConfigResponse) SetRewriteRulesList(v []RewriteRule) {
	o.RewriteRulesList = v
}

// GetJwkSourceList returns the JwkSourceList field value if set, zero value otherwise.
func (o *XigDnsConfigResponse) GetJwkSourceList() []JwkSource {
	if o == nil || IsNil(o.JwkSourceList) {
		var ret []JwkSource
		return ret
	}
	return o.JwkSourceList
}

// GetJwkSourceListOk returns a tuple with the JwkSourceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *XigDnsConfigResponse) GetJwkSourceListOk() ([]JwkSource, bool) {
	if o == nil || IsNil(o.JwkSourceList) {
		return nil, false
	}
	return o.JwkSourceList, true
}
...
// SetJwkSourceList gets a reference to the given []JwkSource and assigns it to the JwkSourceList field.
func (o *XigDnsConfigResponse) SetJwkSourceList(v []JwkSource) {
	o.JwkSourceList = v
}

// GetBypassAuthPathList returns the BypassAuthPathList field value if set, zero value otherwise.
func (o *XigDnsConfigResponse) GetBypassAuthPathList() []string {
	if o == nil || IsNil(o.BypassAuthPathList) {
		var ret []string
		return ret
	}
	return o.BypassAuthPathList
}

// GetBypassAuthPathListOk returns a tuple with the BypassAuthPathList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *XigDnsConfigResponse) GetBypassAuthPathListOk() ([]string, bool) {
	if o == nil || IsNil(o.BypassAuthPathList) {
		return nil, false
	}
	return o.BypassAuthPathList, true
}
...
// SetBypassAuthPathList gets a reference to the given []string and assigns it to the BypassAuthPathList field.
func (o *XigDnsConfigResponse) SetBypassAuthPathList(v []string) {
	o.BypassAuthPathList = v
}

func (o XigDnsConfigResponse) MarshalJSON() ([]byte, error) {
...
func (o XigDnsConfigResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RewriteRulesList) {
		toSerialize["rewrite_rules_list"] = o.RewriteRulesList
	}
	if !IsNil(o.JwkSourceList) {
		toSerialize["jwk_source_list"] = o.JwkSourceList
	}
	if !IsNil(o.BypassAuthPathList) {
		toSerialize["bypass_auth_path_list"] = o.BypassAuthPathList
	}
...
func (o *XigDnsConfigResponse) UnmarshalJSON(data []byte) (err error) {
	varXigDnsConfigResponse := _XigDnsConfigResponse{}

	err = json.Unmarshal(data, &varXigDnsConfigResponse)

	if err != nil {
		return err
	}

	*o = XigDnsConfigResponse(varXigDnsConfigResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "rewrite_rules_list")
		delete(additionalProperties, "jwk_source_list")
		delete(additionalProperties, "bypass_auth_path_list")
...
type NullableXigDnsConfigResponse struct {
	value *XigDnsConfigResponse
	isSet bool
}

func (v NullableXigDnsConfigResponse) Get() *XigDnsConfigResponse {
	return v.value
}

func (v *NullableXigDnsConfigResponse) Set(val *XigDnsConfigResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableXigDnsConfigResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableXigDnsConfigResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableXigDnsConfigResponse(val *XigDnsConfigResponse) *NullableXigDnsConfigResponse {
	return &NullableXigDnsConfigResponse{value: val, isSet: true}
}

func (v NullableXigDnsConfigResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableXigDnsConfigResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
