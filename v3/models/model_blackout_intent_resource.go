...
// checks if the BlackoutIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackoutIntentResource{}

// BlackoutIntentResource Response object for intentful operations on a blackout
type BlackoutIntentResource struct {
...
type _BlackoutIntentResource BlackoutIntentResource
...
func (o BlackoutIntentResource) MarshalJSON() ([]byte, error) {
...
func (o BlackoutIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *BlackoutIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varBlackoutIntentResource := _BlackoutIntentResource{}

	err = json.Unmarshal(data, &varBlackoutIntentResource)

	if err != nil {
		return err
	}

	*o = BlackoutIntentResource(varBlackoutIntentResource)
...
type NullableBlackoutIntentResource struct {
	value *BlackoutIntentResource
	isSet bool
}

func (v NullableBlackoutIntentResource) Get() *BlackoutIntentResource {
	return v.value
}

func (v *NullableBlackoutIntentResource) Set(val *BlackoutIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableBlackoutIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableBlackoutIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlackoutIntentResource(val *BlackoutIntentResource) *NullableBlackoutIntentResource {
	return &NullableBlackoutIntentResource{value: val, isSet: true}
}

func (v NullableBlackoutIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlackoutIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
