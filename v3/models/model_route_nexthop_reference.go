...
// checks if the RouteNexthopReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RouteNexthopReference{}

// RouteNexthopReference Targeted link to use as the nexthop in a route.
type RouteNexthopReference struct {
...
type _RouteNexthopReference RouteNexthopReference
...
func (o RouteNexthopReference) MarshalJSON() ([]byte, error) {
...
func (o RouteNexthopReference) ToMap() (map[string]interface{}, error) {
...
func (o *RouteNexthopReference) UnmarshalJSON(data []byte) (err error) {
	varRouteNexthopReference := _RouteNexthopReference{}

	err = json.Unmarshal(data, &varRouteNexthopReference)

	if err != nil {
		return err
	}

	*o = RouteNexthopReference(varRouteNexthopReference)
...
type NullableRouteNexthopReference struct {
	value *RouteNexthopReference
	isSet bool
}

func (v NullableRouteNexthopReference) Get() *RouteNexthopReference {
	return v.value
}

func (v *NullableRouteNexthopReference) Set(val *RouteNexthopReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRouteNexthopReference) IsSet() bool {
	return v.isSet
}

func (v *NullableRouteNexthopReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRouteNexthopReference(val *RouteNexthopReference) *NullableRouteNexthopReference {
	return &NullableRouteNexthopReference{value: val, isSet: true}
}

func (v NullableRouteNexthopReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRouteNexthopReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
