...
// checks if the VmRecoveryPointMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPointMetadata{}

// VmRecoveryPointMetadata The vm_recovery_point kind metadata
type VmRecoveryPointMetadata struct {
	...
	// Categories for the vm_recovery_point. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the vm_recovery_point. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _VmRecoveryPointMetadata VmRecoveryPointMetadata
...
func (o *VmRecoveryPointMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *VmRecoveryPointMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *VmRecoveryPointMetadata) SetName(v string) {
	o.Name = &v
}

func (o VmRecoveryPointMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPointMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPointMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVmRecoveryPointMetadata := _VmRecoveryPointMetadata{}

	err = json.Unmarshal(data, &varVmRecoveryPointMetadata)

	if err != nil {
		return err
	}

	*o = VmRecoveryPointMetadata(varVmRecoveryPointMetadata)
...
type NullableVmRecoveryPointMetadata struct {
	value *VmRecoveryPointMetadata
	isSet bool
}

func (v NullableVmRecoveryPointMetadata) Get() *VmRecoveryPointMetadata {
	return v.value
}

func (v *NullableVmRecoveryPointMetadata) Set(val *VmRecoveryPointMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPointMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPointMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPointMetadata(val *VmRecoveryPointMetadata) *NullableVmRecoveryPointMetadata {
	return &NullableVmRecoveryPointMetadata{value: val, isSet: true}
}

func (v NullableVmRecoveryPointMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPointMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
