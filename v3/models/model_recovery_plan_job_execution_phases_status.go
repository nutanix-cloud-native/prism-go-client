...
// checks if the RecoveryPlanJobExecutionPhasesStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobExecutionPhasesStatus{}

// RecoveryPlanJobExecutionPhasesStatus Execution status of three phases Preprocessing, Operation, Postprocessing in the Recovery Plan Job execution. 
type RecoveryPlanJobExecutionPhasesStatus struct {
	// State of execution of the Recovery Plan Job.
	...
	// Percentage completed for Recovery Plan Job.
...
type _RecoveryPlanJobExecutionPhasesStatus RecoveryPlanJobExecutionPhasesStatus
...
func NewRecoveryPlanJobExecutionPhasesStatus(status string, percentageComplete int32) *RecoveryPlanJobExecutionPhasesStatus {
	this := RecoveryPlanJobExecutionPhasesStatus{}
	this.Status = status
...
// GetPostprocessingStatus returns the PostprocessingStatus field value if set, zero value otherwise.
func (o *RecoveryPlanJobExecutionPhasesStatus) GetPostprocessingStatus() RecoveryPlanJobStepStatus {
	if o == nil || IsNil(o.PostprocessingStatus) {
		var ret RecoveryPlanJobStepStatus
		return ret
	}
	return *o.PostprocessingStatus
}

// GetPostprocessingStatusOk returns a tuple with the PostprocessingStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobExecutionPhasesStatus) GetPostprocessingStatusOk() (*RecoveryPlanJobStepStatus, bool) {
	if o == nil || IsNil(o.PostprocessingStatus) {
		return nil, false
	}
	return o.PostprocessingStatus, true
}
...
// SetPostprocessingStatus gets a reference to the given RecoveryPlanJobStepStatus and assigns it to the PostprocessingStatus field.
func (o *RecoveryPlanJobExecutionPhasesStatus) SetPostprocessingStatus(v RecoveryPlanJobStepStatus) {
	o.PostprocessingStatus = &v
}
...
// SetOperationStatus gets a reference to the given RecoveryPlanJobStepStatus and assigns it to the OperationStatus field.
func (o *RecoveryPlanJobExecutionPhasesStatus) SetOperationStatus(v RecoveryPlanJobStepStatus) {
	o.OperationStatus = &v
}

// GetPercentageComplete returns the PercentageComplete field value
...
// GetPercentageCompleteOk returns a tuple with the PercentageComplete field value
// and a boolean to check if the value has been set.
...
// SetPercentageComplete sets field value
func (o *RecoveryPlanJobExecutionPhasesStatus) SetPercentageComplete(v int32) {
	o.PercentageComplete = v
}

// GetPreprocessingStatus returns the PreprocessingStatus field value if set, zero value otherwise.
func (o *RecoveryPlanJobExecutionPhasesStatus) GetPreprocessingStatus() RecoveryPlanJobStepStatus {
	if o == nil || IsNil(o.PreprocessingStatus) {
		var ret RecoveryPlanJobStepStatus
		return ret
	}
	return *o.PreprocessingStatus
}

// GetPreprocessingStatusOk returns a tuple with the PreprocessingStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobExecutionPhasesStatus) GetPreprocessingStatusOk() (*RecoveryPlanJobStepStatus, bool) {
	if o == nil || IsNil(o.PreprocessingStatus) {
		return nil, false
	}
	return o.PreprocessingStatus, true
}
...
// SetPreprocessingStatus gets a reference to the given RecoveryPlanJobStepStatus and assigns it to the PreprocessingStatus field.
func (o *RecoveryPlanJobExecutionPhasesStatus) SetPreprocessingStatus(v RecoveryPlanJobStepStatus) {
	o.PreprocessingStatus = &v
}

func (o RecoveryPlanJobExecutionPhasesStatus) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobExecutionPhasesStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["status"] = o.Status
	if !IsNil(o.PostprocessingStatus) {
		toSerialize["postprocessing_status"] = o.PostprocessingStatus
	}
	...
	if !IsNil(o.PreprocessingStatus) {
		toSerialize["preprocessing_status"] = o.PreprocessingStatus
	}
...
func (o *RecoveryPlanJobExecutionPhasesStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobExecutionPhasesStatus := _RecoveryPlanJobExecutionPhasesStatus{}

	err = json.Unmarshal(data, &varRecoveryPlanJobExecutionPhasesStatus)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobExecutionPhasesStatus(varRecoveryPlanJobExecutionPhasesStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "status")
		delete(additionalProperties, "postprocessing_status")
		delete(additionalProperties, "operation_status")
		delete(additionalProperties, "percentage_complete")
		delete(additionalProperties, "preprocessing_status")
...
type NullableRecoveryPlanJobExecutionPhasesStatus struct {
	value *RecoveryPlanJobExecutionPhasesStatus
	isSet bool
}

func (v NullableRecoveryPlanJobExecutionPhasesStatus) Get() *RecoveryPlanJobExecutionPhasesStatus {
	return v.value
}

func (v *NullableRecoveryPlanJobExecutionPhasesStatus) Set(val *RecoveryPlanJobExecutionPhasesStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobExecutionPhasesStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobExecutionPhasesStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobExecutionPhasesStatus(val *RecoveryPlanJobExecutionPhasesStatus) *NullableRecoveryPlanJobExecutionPhasesStatus {
	return &NullableRecoveryPlanJobExecutionPhasesStatus{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobExecutionPhasesStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobExecutionPhasesStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
