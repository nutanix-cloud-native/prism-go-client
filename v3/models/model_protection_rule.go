...
// checks if the ProtectionRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRule{}

// ProtectionRule protection Rule creation/modification spec
...
type _ProtectionRule ProtectionRule
...
func (o ProtectionRule) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRule) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionRule) UnmarshalJSON(data []byte) (err error) {
	...
	varProtectionRule := _ProtectionRule{}

	err = json.Unmarshal(data, &varProtectionRule)

	if err != nil {
		return err
	}

	*o = ProtectionRule(varProtectionRule)
...
type NullableProtectionRule struct {
	value *ProtectionRule
	isSet bool
}

func (v NullableProtectionRule) Get() *ProtectionRule {
	return v.value
}

func (v *NullableProtectionRule) Set(val *ProtectionRule) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRule) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRule(val *ProtectionRule) *NullableProtectionRule {
	return &NullableProtectionRule{value: val, isSet: true}
}

func (v NullableProtectionRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
