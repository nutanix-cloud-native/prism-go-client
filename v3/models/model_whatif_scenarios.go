...
// checks if the WhatifScenarios type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WhatifScenarios{}

// WhatifScenarios Get scenarios response definition.
type WhatifScenarios struct {
	Scenarios []WhatifScenariosScenariosInner `json:"scenarios,omitempty"`
	// Limit for query.
	Limit *int32 `json:"limit,omitempty"`
	// Total number for scenario entity.
...
type _WhatifScenarios WhatifScenarios
...
func (o *WhatifScenarios) GetScenarios() []WhatifScenariosScenariosInner {
	if o == nil || IsNil(o.Scenarios) {
		var ret []WhatifScenariosScenariosInner
		return ret
	}
	return o.Scenarios
}
...
// SetScenarios gets a reference to the given []WhatifScenariosScenariosInner and assigns it to the Scenarios field.
...
func (o WhatifScenarios) MarshalJSON() ([]byte, error) {
...
func (o WhatifScenarios) ToMap() (map[string]interface{}, error) {
...
func (o *WhatifScenarios) UnmarshalJSON(data []byte) (err error) {
	varWhatifScenarios := _WhatifScenarios{}

	err = json.Unmarshal(data, &varWhatifScenarios)

	if err != nil {
		return err
	}

	*o = WhatifScenarios(varWhatifScenarios)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "total_num")
...
type NullableWhatifScenarios struct {
	value *WhatifScenarios
	isSet bool
}

func (v NullableWhatifScenarios) Get() *WhatifScenarios {
	return v.value
}

func (v *NullableWhatifScenarios) Set(val *WhatifScenarios) {
	v.value = val
	v.isSet = true
}

func (v NullableWhatifScenarios) IsSet() bool {
	return v.isSet
}

func (v *NullableWhatifScenarios) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWhatifScenarios(val *WhatifScenarios) *NullableWhatifScenarios {
	return &NullableWhatifScenarios{value: val, isSet: true}
}

func (v NullableWhatifScenarios) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWhatifScenarios) UnmarshalJSON(src []byte) error {
	v.isSet = true
