...
// checks if the DockerRegistryIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryIntentResponse{}

// DockerRegistryIntentResponse Response object for intentful operations on a docker_registry
...
type _DockerRegistryIntentResponse DockerRegistryIntentResponse
...
func NewDockerRegistryIntentResponse(apiVersion string, metadata DockerRegistryMetadata) *DockerRegistryIntentResponse {
	this := DockerRegistryIntentResponse{}
...
func (o *DockerRegistryIntentResponse) GetStatus() DockerRegistryDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret DockerRegistryDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given DockerRegistryDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given DockerRegistry and assigns it to the Spec field.
...
func (o *DockerRegistryIntentResponse) GetMetadata() DockerRegistryMetadata {
	if o == nil {
		var ret DockerRegistryMetadata
		return ret
	}
...
func (o DockerRegistryIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerRegistryIntentResponse := _DockerRegistryIntentResponse{}

	err = json.Unmarshal(data, &varDockerRegistryIntentResponse)

	if err != nil {
		return err
	}

	*o = DockerRegistryIntentResponse(varDockerRegistryIntentResponse)
...
type NullableDockerRegistryIntentResponse struct {
	value *DockerRegistryIntentResponse
	isSet bool
}

func (v NullableDockerRegistryIntentResponse) Get() *DockerRegistryIntentResponse {
	return v.value
}

func (v *NullableDockerRegistryIntentResponse) Set(val *DockerRegistryIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryIntentResponse(val *DockerRegistryIntentResponse) *NullableDockerRegistryIntentResponse {
	return &NullableDockerRegistryIntentResponse{value: val, isSet: true}
}

func (v NullableDockerRegistryIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
