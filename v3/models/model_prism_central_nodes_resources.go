...
// checks if the PrismCentralNodesResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralNodesResources{}

// PrismCentralNodesResources Prism central nodes resources.
type PrismCentralNodesResources struct {
	CmspConfig *CmspExpansionConfig `json:"cmsp_config,omitempty"`
	PcVmList []PcVm `json:"pc_vm_list"`
	AdditionalProperties map[string]interface{}
}

type _PrismCentralNodesResources PrismCentralNodesResources
...
func NewPrismCentralNodesResources(pcVmList []PcVm) *PrismCentralNodesResources {
	this := PrismCentralNodesResources{}
...
// SetCmspConfig gets a reference to the given CmspExpansionConfig and assigns it to the CmspConfig field.
...
func (o PrismCentralNodesResources) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralNodesResources) ToMap() (map[string]interface{}, error) {
...
func (o *PrismCentralNodesResources) UnmarshalJSON(data []byte) (err error) {
	...
	varPrismCentralNodesResources := _PrismCentralNodesResources{}

	err = json.Unmarshal(data, &varPrismCentralNodesResources)

	if err != nil {
		return err
	}

	*o = PrismCentralNodesResources(varPrismCentralNodesResources)
...
type NullablePrismCentralNodesResources struct {
	value *PrismCentralNodesResources
	isSet bool
}

func (v NullablePrismCentralNodesResources) Get() *PrismCentralNodesResources {
	return v.value
}

func (v *NullablePrismCentralNodesResources) Set(val *PrismCentralNodesResources) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralNodesResources) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralNodesResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralNodesResources(val *PrismCentralNodesResources) *NullablePrismCentralNodesResources {
	return &NullablePrismCentralNodesResources{value: val, isSet: true}
}

func (v NullablePrismCentralNodesResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralNodesResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
