...
// checks if the SoftwareReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareReference{}

// SoftwareReference The reference to a software
...
type _SoftwareReference SoftwareReference
...
func (o SoftwareReference) MarshalJSON() ([]byte, error) {
...
func (o SoftwareReference) ToMap() (map[string]interface{}, error) {
...
func (o *SoftwareReference) UnmarshalJSON(data []byte) (err error) {
	...
	varSoftwareReference := _SoftwareReference{}

	err = json.Unmarshal(data, &varSoftwareReference)

	if err != nil {
		return err
	}

	*o = SoftwareReference(varSoftwareReference)
...
type NullableSoftwareReference struct {
	value *SoftwareReference
	isSet bool
}

func (v NullableSoftwareReference) Get() *SoftwareReference {
	return v.value
}

func (v *NullableSoftwareReference) Set(val *SoftwareReference) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareReference) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareReference(val *SoftwareReference) *NullableSoftwareReference {
	return &NullableSoftwareReference{value: val, isSet: true}
}

func (v NullableSoftwareReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
