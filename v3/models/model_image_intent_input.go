...
// checks if the ImageIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageIntentInput{}
...
type _ImageIntentInput ImageIntentInput
...
func (o ImageIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ImageIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ImageIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varImageIntentInput := _ImageIntentInput{}

	err = json.Unmarshal(data, &varImageIntentInput)

	if err != nil {
		return err
	}

	*o = ImageIntentInput(varImageIntentInput)
...
type NullableImageIntentInput struct {
	value *ImageIntentInput
	isSet bool
}

func (v NullableImageIntentInput) Get() *ImageIntentInput {
	return v.value
}

func (v *NullableImageIntentInput) Set(val *ImageIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableImageIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableImageIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageIntentInput(val *ImageIntentInput) *NullableImageIntentInput {
	return &NullableImageIntentInput{value: val, isSet: true}
}

func (v NullableImageIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
