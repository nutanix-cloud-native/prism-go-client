...
// checks if the AwsKeyPairMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsKeyPairMetadata{}

// AwsKeyPairMetadata The aws_key_pair kind metadata
type AwsKeyPairMetadata struct {
	...
	// Categories for the aws_key_pair
...
type _AwsKeyPairMetadata AwsKeyPairMetadata
...
func (o AwsKeyPairMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsKeyPairMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsKeyPairMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsKeyPairMetadata := _AwsKeyPairMetadata{}

	err = json.Unmarshal(data, &varAwsKeyPairMetadata)

	if err != nil {
		return err
	}

	*o = AwsKeyPairMetadata(varAwsKeyPairMetadata)
...
type NullableAwsKeyPairMetadata struct {
	value *AwsKeyPairMetadata
	isSet bool
}

func (v NullableAwsKeyPairMetadata) Get() *AwsKeyPairMetadata {
	return v.value
}

func (v *NullableAwsKeyPairMetadata) Set(val *AwsKeyPairMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsKeyPairMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsKeyPairMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsKeyPairMetadata(val *AwsKeyPairMetadata) *NullableAwsKeyPairMetadata {
	return &NullableAwsKeyPairMetadata{value: val, isSet: true}
}

func (v NullableAwsKeyPairMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsKeyPairMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
