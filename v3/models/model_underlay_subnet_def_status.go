...
// checks if the UnderlaySubnetDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnetDefStatus{}

// UnderlaySubnetDefStatus underlay subnet entity status definition
type UnderlaySubnetDefStatus struct {
	// The underlay subnet name
	Name *string `json:"name,omitempty"`
	Resources UnderlaySubnetResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _UnderlaySubnetDefStatus UnderlaySubnetDefStatus
...
func (o *UnderlaySubnetDefStatus) GetResources() UnderlaySubnetResources {
	if o == nil {
		var ret UnderlaySubnetResources
		return ret
	}
...
func (o UnderlaySubnetDefStatus) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnetDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *UnderlaySubnetDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varUnderlaySubnetDefStatus := _UnderlaySubnetDefStatus{}

	err = json.Unmarshal(data, &varUnderlaySubnetDefStatus)

	if err != nil {
		return err
	}

	*o = UnderlaySubnetDefStatus(varUnderlaySubnetDefStatus)
...
type NullableUnderlaySubnetDefStatus struct {
	value *UnderlaySubnetDefStatus
	isSet bool
}

func (v NullableUnderlaySubnetDefStatus) Get() *UnderlaySubnetDefStatus {
	return v.value
}

func (v *NullableUnderlaySubnetDefStatus) Set(val *UnderlaySubnetDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnetDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnetDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnetDefStatus(val *UnderlaySubnetDefStatus) *NullableUnderlaySubnetDefStatus {
	return &NullableUnderlaySubnetDefStatus{value: val, isSet: true}
}

func (v NullableUnderlaySubnetDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnetDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
