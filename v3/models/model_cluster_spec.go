...
// ClusterSpec Cluster Configuration Object.
type ClusterSpec struct {
	DataStoreConfig *DataStoreConfig `json:"data_store_config,omitempty"`
	NodeSpecList []NodeSpec `json:"node_spec_list,omitempty"`
	EffectiveCapacity *GenericResourceSpec `json:"effective_capacity,omitempty"`
	ResourceList []ResourceTimeSeries `json:"resource_list,omitempty"`
...
// GetNodeSpecList returns the NodeSpecList field value if set, zero value otherwise.
func (o *ClusterSpec) GetNodeSpecList() []NodeSpec {
	if o == nil || IsNil(o.NodeSpecList) {
		var ret []NodeSpec
		return ret
	}
	return o.NodeSpecList
}

// GetNodeSpecListOk returns a tuple with the NodeSpecList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterSpec) GetNodeSpecListOk() ([]NodeSpec, bool) {
	if o == nil || IsNil(o.NodeSpecList) {
		return nil, false
	}
	return o.NodeSpecList, true
}
...
// SetNodeSpecList gets a reference to the given []NodeSpec and assigns it to the NodeSpecList field.
func (o *ClusterSpec) SetNodeSpecList(v []NodeSpec) {
	o.NodeSpecList = v
}

// GetEffectiveCapacity returns the EffectiveCapacity field value if set, zero value otherwise.
func (o *ClusterSpec) GetEffectiveCapacity() GenericResourceSpec {
	if o == nil || IsNil(o.EffectiveCapacity) {
		var ret GenericResourceSpec
		return ret
	}
	return *o.EffectiveCapacity
}

// GetEffectiveCapacityOk returns a tuple with the EffectiveCapacity field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterSpec) GetEffectiveCapacityOk() (*GenericResourceSpec, bool) {
	if o == nil || IsNil(o.EffectiveCapacity) {
		return nil, false
	}
	return o.EffectiveCapacity, true
}
...
// SetEffectiveCapacity gets a reference to the given GenericResourceSpec and assigns it to the EffectiveCapacity field.
func (o *ClusterSpec) SetEffectiveCapacity(v GenericResourceSpec) {
	o.EffectiveCapacity = &v
}
...
// SetResourceList gets a reference to the given []ResourceTimeSeries and assigns it to the ResourceList field.
...
func (o ClusterSpec) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DataStoreConfig) {
		toSerialize["data_store_config"] = o.DataStoreConfig
	}
	if !IsNil(o.NodeSpecList) {
		toSerialize["node_spec_list"] = o.NodeSpecList
	}
	if !IsNil(o.EffectiveCapacity) {
		toSerialize["effective_capacity"] = o.EffectiveCapacity
	}
...
func (o *ClusterSpec) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varClusterSpec)
	...
	*o = ClusterSpec(varClusterSpec)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "data_store_config")
		delete(additionalProperties, "node_spec_list")
		delete(additionalProperties, "effective_capacity")
		delete(additionalProperties, "resource_list")
