...
// checks if the ActionTypeIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTypeIntentInput{}

// ActionTypeIntentInput An intentful representation of a action_type
type ActionTypeIntentInput struct {
	Spec ActionType `json:"spec"`
...
type _ActionTypeIntentInput ActionTypeIntentInput
...
func (o ActionTypeIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ActionTypeIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTypeIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTypeIntentInput := _ActionTypeIntentInput{}

	err = json.Unmarshal(data, &varActionTypeIntentInput)

	if err != nil {
		return err
	}

	*o = ActionTypeIntentInput(varActionTypeIntentInput)
...
type NullableActionTypeIntentInput struct {
	value *ActionTypeIntentInput
	isSet bool
}

func (v NullableActionTypeIntentInput) Get() *ActionTypeIntentInput {
	return v.value
}

func (v *NullableActionTypeIntentInput) Set(val *ActionTypeIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTypeIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTypeIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTypeIntentInput(val *ActionTypeIntentInput) *NullableActionTypeIntentInput {
	return &NullableActionTypeIntentInput{value: val, isSet: true}
}

func (v NullableActionTypeIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTypeIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
