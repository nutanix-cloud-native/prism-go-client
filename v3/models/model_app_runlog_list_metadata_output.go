...
// checks if the AppRunlogListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunlogListMetadataOutput{}

// AppRunlogListMetadataOutput All api calls that return a list will have this metadata block 
type AppRunlogListMetadataOutput struct {
	// The kind name
...
type _AppRunlogListMetadataOutput AppRunlogListMetadataOutput
...
func NewAppRunlogListMetadataOutput() *AppRunlogListMetadataOutput {
	this := AppRunlogListMetadataOutput{}
	var kind string = "app_runlog"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *AppRunlogListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o AppRunlogListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AppRunlogListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunlogListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAppRunlogListMetadataOutput := _AppRunlogListMetadataOutput{}

	err = json.Unmarshal(data, &varAppRunlogListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AppRunlogListMetadataOutput(varAppRunlogListMetadataOutput)
...
type NullableAppRunlogListMetadataOutput struct {
	value *AppRunlogListMetadataOutput
	isSet bool
}

func (v NullableAppRunlogListMetadataOutput) Get() *AppRunlogListMetadataOutput {
	return v.value
}

func (v *NullableAppRunlogListMetadataOutput) Set(val *AppRunlogListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunlogListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunlogListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunlogListMetadataOutput(val *AppRunlogListMetadataOutput) *NullableAppRunlogListMetadataOutput {
	return &NullableAppRunlogListMetadataOutput{value: val, isSet: true}
}

func (v NullableAppRunlogListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunlogListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
