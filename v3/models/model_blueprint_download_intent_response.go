...
// checks if the BlueprintDownloadIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintDownloadIntentResponse{}

// BlueprintDownloadIntentResponse Response object for intentful operations on a blueprint
type BlueprintDownloadIntentResponse struct {
	Status BlueprintDownloadDefStatus `json:"status"`
	Spec BlueprintUpload `json:"spec"`
...
type _BlueprintDownloadIntentResponse BlueprintDownloadIntentResponse
...
func NewBlueprintDownloadIntentResponse(status BlueprintDownloadDefStatus, spec BlueprintUpload, apiVersion string, metadata BlueprintMetadata) *BlueprintDownloadIntentResponse {
	this := BlueprintDownloadIntentResponse{}
	this.Status = status
	this.Spec = spec
...
func (o *BlueprintDownloadIntentResponse) GetStatus() BlueprintDownloadDefStatus {
	if o == nil {
		var ret BlueprintDownloadDefStatus
		return ret
	}
...
func (o BlueprintDownloadIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o BlueprintDownloadIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintDownloadIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintDownloadIntentResponse := _BlueprintDownloadIntentResponse{}

	err = json.Unmarshal(data, &varBlueprintDownloadIntentResponse)

	if err != nil {
		return err
	}

	*o = BlueprintDownloadIntentResponse(varBlueprintDownloadIntentResponse)
...
type NullableBlueprintDownloadIntentResponse struct {
	value *BlueprintDownloadIntentResponse
	isSet bool
}

func (v NullableBlueprintDownloadIntentResponse) Get() *BlueprintDownloadIntentResponse {
	return v.value
}

func (v *NullableBlueprintDownloadIntentResponse) Set(val *BlueprintDownloadIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintDownloadIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintDownloadIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintDownloadIntentResponse(val *BlueprintDownloadIntentResponse) *NullableBlueprintDownloadIntentResponse {
	return &NullableBlueprintDownloadIntentResponse{value: val, isSet: true}
}

func (v NullableBlueprintDownloadIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintDownloadIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
