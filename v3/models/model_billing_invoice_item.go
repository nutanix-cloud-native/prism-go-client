...
// BillingInvoiceItem line item of an invoice.
type BillingInvoiceItem struct {
	// Nature of the charge.
	ChargeType *string `json:"charge_type,omitempty"`
	// Name of the subscription.
	SubscriptionName *string `json:"subscription_name,omitempty"`
	TaxAmount *MonetaryValue `json:"tax_amount,omitempty"`
...
type _BillingInvoiceItem BillingInvoiceItem
...
// SetTaxAmount gets a reference to the given MonetaryValue and assigns it to the TaxAmount field.
...
func (o *BillingInvoiceItem) UnmarshalJSON(data []byte) (err error) {
	varBillingInvoiceItem := _BillingInvoiceItem{}

	err = json.Unmarshal(data, &varBillingInvoiceItem)

	if err != nil {
		return err
	}

	*o = BillingInvoiceItem(varBillingInvoiceItem)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "charge_type")
		delete(additionalProperties, "subscription_name")
		...
		delete(additionalProperties, "charge_name")
		delete(additionalProperties, "subscription_id")
		delete(additionalProperties, "processing_type")
		delete(additionalProperties, "charge_date")
		delete(additionalProperties, "charge_description")
