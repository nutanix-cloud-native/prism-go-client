...
// checks if the VolumeGroupResourcesOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupResourcesOutput{}

// VolumeGroupResourcesOutput Volume group resources.
type VolumeGroupResourcesOutput struct {
	...
	EnabledAuthentications *string `json:"enabled_authentications,omitempty"`
	// VMs attached to volume group.
	AttachmentList []AttachmentReferenceOutput `json:"attachment_list,omitempty"`
	...
	DiskList []VolumeDiskResourceOutput `json:"disk_list,omitempty"`
	...
	LoadBalanceVmAttachments *bool `json:"load_balance_vm_attachments,omitempty"`
...
type _VolumeGroupResourcesOutput VolumeGroupResourcesOutput
...
func NewVolumeGroupResourcesOutput() *VolumeGroupResourcesOutput {
	this := VolumeGroupResourcesOutput{}
	return &this
}
...
// GetFlashMode returns the FlashMode field value if set, zero value otherwise.
func (o *VolumeGroupResourcesOutput) GetFlashMode() string {
	if o == nil || IsNil(o.FlashMode) {
		var ret string
		return ret
	}
	return *o.FlashMode
...
// GetFlashModeOk returns a tuple with the FlashMode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VolumeGroupResourcesOutput) GetFlashModeOk() (*string, bool) {
	if o == nil || IsNil(o.FlashMode) {
		return nil, false
	}
	return o.FlashMode, true
}
...
// SetFlashMode gets a reference to the given string and assigns it to the FlashMode field.
func (o *VolumeGroupResourcesOutput) SetFlashMode(v string) {
	o.FlashMode = &v
}

// GetIscsiTargetName returns the IscsiTargetName field value if set, zero value otherwise.
func (o *VolumeGroupResourcesOutput) GetIscsiTargetName() string {
	if o == nil || IsNil(o.IscsiTargetName) {
		var ret string
		return ret
	}
	return *o.IscsiTargetName
}

// GetIscsiTargetNameOk returns a tuple with the IscsiTargetName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VolumeGroupResourcesOutput) GetIscsiTargetNameOk() (*string, bool) {
	if o == nil || IsNil(o.IscsiTargetName) {
		return nil, false
	}
	return o.IscsiTargetName, true
}
...
// SetIscsiTargetName gets a reference to the given string and assigns it to the IscsiTargetName field.
func (o *VolumeGroupResourcesOutput) SetIscsiTargetName(v string) {
	o.IscsiTargetName = &v
}

// GetEnabledAuthentications returns the EnabledAuthentications field value if set, zero value otherwise.
func (o *VolumeGroupResourcesOutput) GetEnabledAuthentications() string {
	if o == nil || IsNil(o.EnabledAuthentications) {
		var ret string
		return ret
	}
	return *o.EnabledAuthentications
}

// GetEnabledAuthenticationsOk returns a tuple with the EnabledAuthentications field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VolumeGroupResourcesOutput) GetEnabledAuthenticationsOk() (*string, bool) {
	if o == nil || IsNil(o.EnabledAuthentications) {
		return nil, false
	}
	return o.EnabledAuthentications, true
}
...
// SetEnabledAuthentications gets a reference to the given string and assigns it to the EnabledAuthentications field.
func (o *VolumeGroupResourcesOutput) SetEnabledAuthentications(v string) {
	o.EnabledAuthentications = &v
}

// GetAttachmentList returns the AttachmentList field value if set, zero value otherwise.
func (o *VolumeGroupResourcesOutput) GetAttachmentList() []AttachmentReferenceOutput {
	if o == nil || IsNil(o.AttachmentList) {
		var ret []AttachmentReferenceOutput
		return ret
	}
	return o.AttachmentList
}

// GetAttachmentListOk returns a tuple with the AttachmentList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VolumeGroupResourcesOutput) GetAttachmentListOk() ([]AttachmentReferenceOutput, bool) {
	if o == nil || IsNil(o.AttachmentList) {
		return nil, false
	}
	return o.AttachmentList, true
}
...
// SetAttachmentList gets a reference to the given []AttachmentReferenceOutput and assigns it to the AttachmentList field.
...
func (o *VolumeGroupResourcesOutput) GetDiskList() []VolumeDiskResourceOutput {
	if o == nil || IsNil(o.DiskList) {
		var ret []VolumeDiskResourceOutput
		return ret
	}
	return o.DiskList
}
...
// SetDiskList gets a reference to the given []VolumeDiskResourceOutput and assigns it to the DiskList field.
...
// GetLoadBalanceVmAttachments returns the LoadBalanceVmAttachments field value if set, zero value otherwise.
func (o *VolumeGroupResourcesOutput) GetLoadBalanceVmAttachments() bool {
	if o == nil || IsNil(o.LoadBalanceVmAttachments) {
		var ret bool
		return ret
	}
	return *o.LoadBalanceVmAttachments
}

// GetLoadBalanceVmAttachmentsOk returns a tuple with the LoadBalanceVmAttachments field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VolumeGroupResourcesOutput) GetLoadBalanceVmAttachmentsOk() (*bool, bool) {
	if o == nil || IsNil(o.LoadBalanceVmAttachments) {
		return nil, false
	}
	return o.LoadBalanceVmAttachments, true
}
...
// SetLoadBalanceVmAttachments gets a reference to the given bool and assigns it to the LoadBalanceVmAttachments field.
func (o *VolumeGroupResourcesOutput) SetLoadBalanceVmAttachments(v bool) {
	o.LoadBalanceVmAttachments = &v
}
...
// GetIscsiTargetPrefix returns the IscsiTargetPrefix field value if set, zero value otherwise.
func (o *VolumeGroupResourcesOutput) GetIscsiTargetPrefix() string {
	if o == nil || IsNil(o.IscsiTargetPrefix) {
		var ret string
		return ret
	}
	return *o.IscsiTargetPrefix
}

// GetIscsiTargetPrefixOk returns a tuple with the IscsiTargetPrefix field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VolumeGroupResourcesOutput) GetIscsiTargetPrefixOk() (*string, bool) {
	if o == nil || IsNil(o.IscsiTargetPrefix) {
		return nil, false
	}
	return o.IscsiTargetPrefix, true
}
...
// SetIscsiTargetPrefix gets a reference to the given string and assigns it to the IscsiTargetPrefix field.
func (o *VolumeGroupResourcesOutput) SetIscsiTargetPrefix(v string) {
	o.IscsiTargetPrefix = &v
}

func (o VolumeGroupResourcesOutput) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupResourcesOutput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.FlashMode) {
		toSerialize["flash_mode"] = o.FlashMode
	}
	if !IsNil(o.IscsiTargetName) {
		toSerialize["iscsi_target_name"] = o.IscsiTargetName
	}
	if !IsNil(o.EnabledAuthentications) {
		toSerialize["enabled_authentications"] = o.EnabledAuthentications
	}
	if !IsNil(o.AttachmentList) {
		toSerialize["attachment_list"] = o.AttachmentList
	}
	...
	if !IsNil(o.SharingStatus) {
		toSerialize["sharing_status"] = o.SharingStatus
	}
	if !IsNil(o.DiskList) {
	...
	if !IsNil(o.LoadBalanceVmAttachments) {
		toSerialize["load_balance_vm_attachments"] = o.LoadBalanceVmAttachments
	}
	if !IsNil(o.IsHidden) {
	...
	if !IsNil(o.IscsiTargetPrefix) {
		toSerialize["iscsi_target_prefix"] = o.IscsiTargetPrefix
	}
...
func (o *VolumeGroupResourcesOutput) UnmarshalJSON(data []byte) (err error) {
	varVolumeGroupResourcesOutput := _VolumeGroupResourcesOutput{}

	err = json.Unmarshal(data, &varVolumeGroupResourcesOutput)

	if err != nil {
		return err
	}

	*o = VolumeGroupResourcesOutput(varVolumeGroupResourcesOutput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "flash_mode")
		delete(additionalProperties, "iscsi_target_name")
		delete(additionalProperties, "enabled_authentications")
		delete(additionalProperties, "attachment_list")
		delete(additionalProperties, "created_by")
		delete(additionalProperties, "parent_reference")
		delete(additionalProperties, "sharing_status")
		delete(additionalProperties, "disk_list")
		delete(additionalProperties, "size_bytes")
		delete(additionalProperties, "usage_type")
		delete(additionalProperties, "load_balance_vm_attachments")
		delete(additionalProperties, "is_hidden")
		delete(additionalProperties, "size_mib")
		delete(additionalProperties, "iscsi_target_prefix")
...
type NullableVolumeGroupResourcesOutput struct {
	value *VolumeGroupResourcesOutput
	isSet bool
}

func (v NullableVolumeGroupResourcesOutput) Get() *VolumeGroupResourcesOutput {
	return v.value
}

func (v *NullableVolumeGroupResourcesOutput) Set(val *VolumeGroupResourcesOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupResourcesOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupResourcesOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupResourcesOutput(val *VolumeGroupResourcesOutput) *NullableVolumeGroupResourcesOutput {
	return &NullableVolumeGroupResourcesOutput{value: val, isSet: true}
}

func (v NullableVolumeGroupResourcesOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupResourcesOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
