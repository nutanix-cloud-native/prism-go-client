...
// checks if the AwsSecurityGroupListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSecurityGroupListMetadata{}

// AwsSecurityGroupListMetadata All api calls that return a list will have this metadata block as input 
type AwsSecurityGroupListMetadata struct {
	// The kind name
...
type _AwsSecurityGroupListMetadata AwsSecurityGroupListMetadata
...
func NewAwsSecurityGroupListMetadata() *AwsSecurityGroupListMetadata {
	this := AwsSecurityGroupListMetadata{}
...
func (o AwsSecurityGroupListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsSecurityGroupListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSecurityGroupListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsSecurityGroupListMetadata := _AwsSecurityGroupListMetadata{}

	err = json.Unmarshal(data, &varAwsSecurityGroupListMetadata)

	if err != nil {
		return err
	}

	*o = AwsSecurityGroupListMetadata(varAwsSecurityGroupListMetadata)
...
type NullableAwsSecurityGroupListMetadata struct {
	value *AwsSecurityGroupListMetadata
	isSet bool
}

func (v NullableAwsSecurityGroupListMetadata) Get() *AwsSecurityGroupListMetadata {
	return v.value
}

func (v *NullableAwsSecurityGroupListMetadata) Set(val *AwsSecurityGroupListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSecurityGroupListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSecurityGroupListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSecurityGroupListMetadata(val *AwsSecurityGroupListMetadata) *NullableAwsSecurityGroupListMetadata {
	return &NullableAwsSecurityGroupListMetadata{value: val, isSet: true}
}

func (v NullableAwsSecurityGroupListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSecurityGroupListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
