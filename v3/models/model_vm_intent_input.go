...
// checks if the VmIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmIntentInput{}
...
type _VmIntentInput VmIntentInput
...
func (o VmIntentInput) MarshalJSON() ([]byte, error) {
...
func (o VmIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *VmIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVmIntentInput := _VmIntentInput{}

	err = json.Unmarshal(data, &varVmIntentInput)

	if err != nil {
		return err
	}

	*o = VmIntentInput(varVmIntentInput)
...
type NullableVmIntentInput struct {
	value *VmIntentInput
	isSet bool
}

func (v NullableVmIntentInput) Get() *VmIntentInput {
	return v.value
}

func (v *NullableVmIntentInput) Set(val *VmIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmIntentInput(val *VmIntentInput) *NullableVmIntentInput {
	return &NullableVmIntentInput{value: val, isSet: true}
}

func (v NullableVmIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
