...
// checks if the MetadataOfTheClonedVm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetadataOfTheClonedVm{}

// MetadataOfTheClonedVm struct for MetadataOfTheClonedVm
type MetadataOfTheClonedVm struct {
...
type _MetadataOfTheClonedVm MetadataOfTheClonedVm
...
func (o MetadataOfTheClonedVm) MarshalJSON() ([]byte, error) {
...
func (o MetadataOfTheClonedVm) ToMap() (map[string]interface{}, error) {
...
func (o *MetadataOfTheClonedVm) UnmarshalJSON(data []byte) (err error) {
	varMetadataOfTheClonedVm := _MetadataOfTheClonedVm{}

	err = json.Unmarshal(data, &varMetadataOfTheClonedVm)

	if err != nil {
		return err
	}

	*o = MetadataOfTheClonedVm(varMetadataOfTheClonedVm)
...
type NullableMetadataOfTheClonedVm struct {
	value *MetadataOfTheClonedVm
	isSet bool
}

func (v NullableMetadataOfTheClonedVm) Get() *MetadataOfTheClonedVm {
	return v.value
}

func (v *NullableMetadataOfTheClonedVm) Set(val *MetadataOfTheClonedVm) {
	v.value = val
	v.isSet = true
}

func (v NullableMetadataOfTheClonedVm) IsSet() bool {
	return v.isSet
}

func (v *NullableMetadataOfTheClonedVm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetadataOfTheClonedVm(val *MetadataOfTheClonedVm) *NullableMetadataOfTheClonedVm {
	return &NullableMetadataOfTheClonedVm{value: val, isSet: true}
}

func (v NullableMetadataOfTheClonedVm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetadataOfTheClonedVm) UnmarshalJSON(src []byte) error {
	v.isSet = true
