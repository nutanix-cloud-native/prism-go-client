...
// checks if the DockerRegistryReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryReference{}

// DockerRegistryReference The reference to a docker_registry
...
type _DockerRegistryReference DockerRegistryReference
...
func (o DockerRegistryReference) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryReference) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryReference) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerRegistryReference := _DockerRegistryReference{}

	err = json.Unmarshal(data, &varDockerRegistryReference)

	if err != nil {
		return err
	}

	*o = DockerRegistryReference(varDockerRegistryReference)
...
type NullableDockerRegistryReference struct {
	value *DockerRegistryReference
	isSet bool
}

func (v NullableDockerRegistryReference) Get() *DockerRegistryReference {
	return v.value
}

func (v *NullableDockerRegistryReference) Set(val *DockerRegistryReference) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryReference) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryReference(val *DockerRegistryReference) *NullableDockerRegistryReference {
	return &NullableDockerRegistryReference{value: val, isSet: true}
}

func (v NullableDockerRegistryReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
