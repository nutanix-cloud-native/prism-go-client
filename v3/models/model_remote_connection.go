...
// checks if the RemoteConnection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnection{}

// RemoteConnection Remote connection information.
...
type _RemoteConnection RemoteConnection
...
func (o RemoteConnection) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteConnection) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteConnection := _RemoteConnection{}

	err = json.Unmarshal(data, &varRemoteConnection)

	if err != nil {
		return err
	}

	*o = RemoteConnection(varRemoteConnection)
