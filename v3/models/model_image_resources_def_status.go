...
// checks if the ImageResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageResourcesDefStatus{}
...
type ImageResourcesDefStatus struct {
	...
	// List of clusters where image is currently present.
	CurrentClusterReferenceList []ClusterImageReference `json:"current_cluster_reference_list,omitempty"`
	// The type of image.
	...
	InitialPlacementRefList []ClusterImageReference `json:"initial_placement_ref_list,omitempty"`
	...
	// A single image could get multiple policies applied to it. In such cases, each policy state is shown as an element of this list. 
	ImagePlacementPolicyStateList []ImagePlacementPolicyState `json:"image_placement_policy_state_list,omitempty"`
	SourceOptions *SourceOptions `json:"source_options,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ImageResourcesDefStatus ImageResourcesDefStatus
...
// GetRetrievalUriList returns the RetrievalUriList field value if set, zero value otherwise.
func (o *ImageResourcesDefStatus) GetRetrievalUriList() []string {
	if o == nil || IsNil(o.RetrievalUriList) {
		var ret []string
		return ret
	}
	return o.RetrievalUriList
}

// GetRetrievalUriListOk returns a tuple with the RetrievalUriList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImageResourcesDefStatus) GetRetrievalUriListOk() ([]string, bool) {
	if o == nil || IsNil(o.RetrievalUriList) {
		return nil, false
	}
	return o.RetrievalUriList, true
}
...
// SetRetrievalUriList gets a reference to the given []string and assigns it to the RetrievalUriList field.
func (o *ImageResourcesDefStatus) SetRetrievalUriList(v []string) {
	o.RetrievalUriList = v
}

// GetCurrentClusterReferenceList returns the CurrentClusterReferenceList field value if set, zero value otherwise.
func (o *ImageResourcesDefStatus) GetCurrentClusterReferenceList() []ClusterImageReference {
	if o == nil || IsNil(o.CurrentClusterReferenceList) {
		var ret []ClusterImageReference
		return ret
	}
	return o.CurrentClusterReferenceList
}

// GetCurrentClusterReferenceListOk returns a tuple with the CurrentClusterReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImageResourcesDefStatus) GetCurrentClusterReferenceListOk() ([]ClusterImageReference, bool) {
	if o == nil || IsNil(o.CurrentClusterReferenceList) {
		return nil, false
	}
	return o.CurrentClusterReferenceList, true
}
...
// SetCurrentClusterReferenceList gets a reference to the given []ClusterImageReference and assigns it to the CurrentClusterReferenceList field.
func (o *ImageResourcesDefStatus) SetCurrentClusterReferenceList(v []ClusterImageReference) {
	o.CurrentClusterReferenceList = v
}
...
// SetChecksum gets a reference to the given Checksum and assigns it to the Checksum field.
...
// GetInitialPlacementRefList returns the InitialPlacementRefList field value if set, zero value otherwise.
func (o *ImageResourcesDefStatus) GetInitialPlacementRefList() []ClusterImageReference {
	if o == nil || IsNil(o.InitialPlacementRefList) {
		var ret []ClusterImageReference
		return ret
	}
	return o.InitialPlacementRefList
}

// GetInitialPlacementRefListOk returns a tuple with the InitialPlacementRefList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImageResourcesDefStatus) GetInitialPlacementRefListOk() ([]ClusterImageReference, bool) {
	if o == nil || IsNil(o.InitialPlacementRefList) {
		return nil, false
	}
	return o.InitialPlacementRefList, true
}
...
// SetInitialPlacementRefList gets a reference to the given []ClusterImageReference and assigns it to the InitialPlacementRefList field.
func (o *ImageResourcesDefStatus) SetInitialPlacementRefList(v []ClusterImageReference) {
	o.InitialPlacementRefList = v
}
...
// SetVersion gets a reference to the given ImageVersionStatus and assigns it to the Version field.
...
// GetDataSourceReference returns the DataSourceReference field value if set, zero value otherwise.
func (o *ImageResourcesDefStatus) GetDataSourceReference() Reference {
	if o == nil || IsNil(o.DataSourceReference) {
		var ret Reference
		return ret
	}
	return *o.DataSourceReference
}

// GetDataSourceReferenceOk returns a tuple with the DataSourceReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImageResourcesDefStatus) GetDataSourceReferenceOk() (*Reference, bool) {
	if o == nil || IsNil(o.DataSourceReference) {
		return nil, false
	}
	return o.DataSourceReference, true
}
...
// SetDataSourceReference gets a reference to the given Reference and assigns it to the DataSourceReference field.
func (o *ImageResourcesDefStatus) SetDataSourceReference(v Reference) {
	o.DataSourceReference = &v
}

// GetImagePlacementPolicyStateList returns the ImagePlacementPolicyStateList field value if set, zero value otherwise.
func (o *ImageResourcesDefStatus) GetImagePlacementPolicyStateList() []ImagePlacementPolicyState {
	if o == nil || IsNil(o.ImagePlacementPolicyStateList) {
		var ret []ImagePlacementPolicyState
		return ret
	}
	return o.ImagePlacementPolicyStateList
}

// GetImagePlacementPolicyStateListOk returns a tuple with the ImagePlacementPolicyStateList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImageResourcesDefStatus) GetImagePlacementPolicyStateListOk() ([]ImagePlacementPolicyState, bool) {
	if o == nil || IsNil(o.ImagePlacementPolicyStateList) {
		return nil, false
	}
	return o.ImagePlacementPolicyStateList, true
}
...
// SetImagePlacementPolicyStateList gets a reference to the given []ImagePlacementPolicyState and assigns it to the ImagePlacementPolicyStateList field.
func (o *ImageResourcesDefStatus) SetImagePlacementPolicyStateList(v []ImagePlacementPolicyState) {
	o.ImagePlacementPolicyStateList = v
}

// GetSourceOptions returns the SourceOptions field value if set, zero value otherwise.
func (o *ImageResourcesDefStatus) GetSourceOptions() SourceOptions {
	if o == nil || IsNil(o.SourceOptions) {
		var ret SourceOptions
		return ret
	}
	return *o.SourceOptions
}

// GetSourceOptionsOk returns a tuple with the SourceOptions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImageResourcesDefStatus) GetSourceOptionsOk() (*SourceOptions, bool) {
	if o == nil || IsNil(o.SourceOptions) {
		return nil, false
	}
	return o.SourceOptions, true
}
...
// SetSourceOptions gets a reference to the given SourceOptions and assigns it to the SourceOptions field.
func (o *ImageResourcesDefStatus) SetSourceOptions(v SourceOptions) {
	o.SourceOptions = &v
}

func (o ImageResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ImageResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RetrievalUriList) {
		toSerialize["retrieval_uri_list"] = o.RetrievalUriList
	}
	if !IsNil(o.CurrentClusterReferenceList) {
		toSerialize["current_cluster_reference_list"] = o.CurrentClusterReferenceList
	}
	...
	if !IsNil(o.InitialPlacementRefList) {
		toSerialize["initial_placement_ref_list"] = o.InitialPlacementRefList
	}
	if !IsNil(o.Version) {
	...
	if !IsNil(o.DataSourceReference) {
		toSerialize["data_source_reference"] = o.DataSourceReference
	}
	if !IsNil(o.ImagePlacementPolicyStateList) {
		toSerialize["image_placement_policy_state_list"] = o.ImagePlacementPolicyStateList
	}
	if !IsNil(o.SourceOptions) {
		toSerialize["source_options"] = o.SourceOptions
	}
...
func (o *ImageResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varImageResourcesDefStatus := _ImageResourcesDefStatus{}

	err = json.Unmarshal(data, &varImageResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = ImageResourcesDefStatus(varImageResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "retrieval_uri_list")
		delete(additionalProperties, "current_cluster_reference_list")
		delete(additionalProperties, "image_type")
		delete(additionalProperties, "checksum")
		delete(additionalProperties, "source_uri")
		delete(additionalProperties, "initial_placement_ref_list")
		delete(additionalProperties, "version")
		delete(additionalProperties, "architecture")
		delete(additionalProperties, "size_bytes")
		delete(additionalProperties, "data_source_reference")
		delete(additionalProperties, "image_placement_policy_state_list")
		delete(additionalProperties, "source_options")
...
type NullableImageResourcesDefStatus struct {
	value *ImageResourcesDefStatus
	isSet bool
}

func (v NullableImageResourcesDefStatus) Get() *ImageResourcesDefStatus {
	return v.value
}

func (v *NullableImageResourcesDefStatus) Set(val *ImageResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableImageResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableImageResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageResourcesDefStatus(val *ImageResourcesDefStatus) *NullableImageResourcesDefStatus {
	return &NullableImageResourcesDefStatus{value: val, isSet: true}
}

func (v NullableImageResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
