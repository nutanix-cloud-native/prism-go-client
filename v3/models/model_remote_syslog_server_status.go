...
// checks if the RemoteSyslogServerStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogServerStatus{}

// RemoteSyslogServerStatus The status of a REST API call. Only used when there is a failure to report. 
type RemoteSyslogServerStatus struct {
	// The kind name
...
type _RemoteSyslogServerStatus RemoteSyslogServerStatus
...
func (o RemoteSyslogServerStatus) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogServerStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogServerStatus) UnmarshalJSON(data []byte) (err error) {
	varRemoteSyslogServerStatus := _RemoteSyslogServerStatus{}

	err = json.Unmarshal(data, &varRemoteSyslogServerStatus)

	if err != nil {
		return err
	}

	*o = RemoteSyslogServerStatus(varRemoteSyslogServerStatus)
...
type NullableRemoteSyslogServerStatus struct {
	value *RemoteSyslogServerStatus
	isSet bool
}

func (v NullableRemoteSyslogServerStatus) Get() *RemoteSyslogServerStatus {
	return v.value
}

func (v *NullableRemoteSyslogServerStatus) Set(val *RemoteSyslogServerStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogServerStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogServerStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogServerStatus(val *RemoteSyslogServerStatus) *NullableRemoteSyslogServerStatus {
	return &NullableRemoteSyslogServerStatus{value: val, isSet: true}
}

func (v NullableRemoteSyslogServerStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogServerStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
