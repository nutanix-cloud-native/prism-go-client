...
// checks if the AccessControlPolicyIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyIntentInput{}

// AccessControlPolicyIntentInput An intentful representation of a access_control_policy
type AccessControlPolicyIntentInput struct {
	Spec AccessControlPolicy `json:"spec"`
...
type _AccessControlPolicyIntentInput AccessControlPolicyIntentInput
...
func NewAccessControlPolicyIntentInput(spec AccessControlPolicy, metadata AccessControlPolicyMetadata) *AccessControlPolicyIntentInput {
	this := AccessControlPolicyIntentInput{}
	this.Spec = spec
...
func (o AccessControlPolicyIntentInput) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *AccessControlPolicyIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessControlPolicyIntentInput := _AccessControlPolicyIntentInput{}

	err = json.Unmarshal(data, &varAccessControlPolicyIntentInput)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyIntentInput(varAccessControlPolicyIntentInput)
...
type NullableAccessControlPolicyIntentInput struct {
	value *AccessControlPolicyIntentInput
	isSet bool
}

func (v NullableAccessControlPolicyIntentInput) Get() *AccessControlPolicyIntentInput {
	return v.value
}

func (v *NullableAccessControlPolicyIntentInput) Set(val *AccessControlPolicyIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyIntentInput(val *AccessControlPolicyIntentInput) *NullableAccessControlPolicyIntentInput {
	return &NullableAccessControlPolicyIntentInput{value: val, isSet: true}
}

func (v NullableAccessControlPolicyIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
