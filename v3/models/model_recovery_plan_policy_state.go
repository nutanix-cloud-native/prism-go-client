...
// checks if the RecoveryPlanPolicyState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanPolicyState{}

// RecoveryPlanPolicyState State of enforced policy on an entity.
...
type _RecoveryPlanPolicyState RecoveryPlanPolicyState
...
// SetPolicyInfo gets a reference to the given RecoveryPlanInfo and assigns it to the PolicyInfo field.
...
func (o RecoveryPlanPolicyState) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanPolicyState) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanPolicyState) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanPolicyState := _RecoveryPlanPolicyState{}

	err = json.Unmarshal(data, &varRecoveryPlanPolicyState)

	if err != nil {
		return err
	}

	*o = RecoveryPlanPolicyState(varRecoveryPlanPolicyState)
...
type NullableRecoveryPlanPolicyState struct {
	value *RecoveryPlanPolicyState
	isSet bool
}

func (v NullableRecoveryPlanPolicyState) Get() *RecoveryPlanPolicyState {
	return v.value
}

func (v *NullableRecoveryPlanPolicyState) Set(val *RecoveryPlanPolicyState) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanPolicyState) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanPolicyState) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanPolicyState(val *RecoveryPlanPolicyState) *NullableRecoveryPlanPolicyState {
	return &NullableRecoveryPlanPolicyState{value: val, isSet: true}
}

func (v NullableRecoveryPlanPolicyState) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanPolicyState) UnmarshalJSON(src []byte) error {
	v.isSet = true
