...
// checks if the AppTaskIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskIntentResource{}

// AppTaskIntentResource Response object for intentful operations on a app_task
type AppTaskIntentResource struct {
	Status *AppTaskDefStatus `json:"status,omitempty"`
	Spec *AppTask `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata AppTaskMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AppTaskIntentResource AppTaskIntentResource
...
// SetStatus gets a reference to the given AppTaskDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given AppTask and assigns it to the Spec field.
...
func (o AppTaskIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AppTaskIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskIntentResource := _AppTaskIntentResource{}

	err = json.Unmarshal(data, &varAppTaskIntentResource)

	if err != nil {
		return err
	}

	*o = AppTaskIntentResource(varAppTaskIntentResource)
...
type NullableAppTaskIntentResource struct {
	value *AppTaskIntentResource
	isSet bool
}

func (v NullableAppTaskIntentResource) Get() *AppTaskIntentResource {
	return v.value
}

func (v *NullableAppTaskIntentResource) Set(val *AppTaskIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskIntentResource(val *AppTaskIntentResource) *NullableAppTaskIntentResource {
	return &NullableAppTaskIntentResource{value: val, isSet: true}
}

func (v NullableAppTaskIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
