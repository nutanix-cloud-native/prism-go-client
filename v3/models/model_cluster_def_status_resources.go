...
// checks if the ClusterDefStatusResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterDefStatusResources{}
...
type _ClusterDefStatusResources ClusterDefStatusResources
...
func NewClusterDefStatusResources(config ClusterConfig, network ClusterNetwork) *ClusterDefStatusResources {
	this := ClusterDefStatusResources{}
	this.Config = config
...
// SetNodes gets a reference to the given ClusterNodes and assigns it to the Nodes field.
...
// SetAnalysis gets a reference to the given ClusterAnalysis and assigns it to the Analysis field.
func (o *ClusterDefStatusResources) SetAnalysis(v ClusterAnalysis) {
	o.Analysis = &v
}

// GetRuntimeStatusList returns the RuntimeStatusList field value if set, zero value otherwise.
func (o *ClusterDefStatusResources) GetRuntimeStatusList() []string {
	if o == nil || IsNil(o.RuntimeStatusList) {
		var ret []string
		return ret
	}
	return o.RuntimeStatusList
}

// GetRuntimeStatusListOk returns a tuple with the RuntimeStatusList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterDefStatusResources) GetRuntimeStatusListOk() ([]string, bool) {
	if o == nil || IsNil(o.RuntimeStatusList) {
		return nil, false
	}
	return o.RuntimeStatusList, true
}
...
// SetRuntimeStatusList gets a reference to the given []string and assigns it to the RuntimeStatusList field.
func (o *ClusterDefStatusResources) SetRuntimeStatusList(v []string) {
	o.RuntimeStatusList = v
}

func (o ClusterDefStatusResources) MarshalJSON() ([]byte, error) {
...
func (o ClusterDefStatusResources) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RuntimeStatusList) {
		toSerialize["runtime_status_list"] = o.RuntimeStatusList
	}
...
func (o *ClusterDefStatusResources) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterDefStatusResources := _ClusterDefStatusResources{}

	err = json.Unmarshal(data, &varClusterDefStatusResources)

	if err != nil {
		return err
	}

	*o = ClusterDefStatusResources(varClusterDefStatusResources)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "runtime_status_list")
...
type NullableClusterDefStatusResources struct {
	value *ClusterDefStatusResources
	isSet bool
}

func (v NullableClusterDefStatusResources) Get() *ClusterDefStatusResources {
	return v.value
}

func (v *NullableClusterDefStatusResources) Set(val *ClusterDefStatusResources) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterDefStatusResources) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterDefStatusResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterDefStatusResources(val *ClusterDefStatusResources) *NullableClusterDefStatusResources {
	return &NullableClusterDefStatusResources{value: val, isSet: true}
}

func (v NullableClusterDefStatusResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterDefStatusResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
