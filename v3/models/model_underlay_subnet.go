...
// checks if the UnderlaySubnet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnet{}

// UnderlaySubnet Underlay subnet entity definition. It is for hardware device subnets, used by datacenter management software to persist/configure devices. 
type UnderlaySubnet struct {
...
type _UnderlaySubnet UnderlaySubnet
...
func (o UnderlaySubnet) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnet) ToMap() (map[string]interface{}, error) {
...
func (o *UnderlaySubnet) UnmarshalJSON(data []byte) (err error) {
	...
	varUnderlaySubnet := _UnderlaySubnet{}

	err = json.Unmarshal(data, &varUnderlaySubnet)

	if err != nil {
		return err
	}

	*o = UnderlaySubnet(varUnderlaySubnet)
...
type NullableUnderlaySubnet struct {
	value *UnderlaySubnet
	isSet bool
}

func (v NullableUnderlaySubnet) Get() *UnderlaySubnet {
	return v.value
}

func (v *NullableUnderlaySubnet) Set(val *UnderlaySubnet) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnet) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnet(val *UnderlaySubnet) *NullableUnderlaySubnet {
	return &NullableUnderlaySubnet{value: val, isSet: true}
}

func (v NullableUnderlaySubnet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnet) UnmarshalJSON(src []byte) error {
	v.isSet = true
