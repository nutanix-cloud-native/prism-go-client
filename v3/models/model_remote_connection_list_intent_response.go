...
// checks if the RemoteConnectionListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionListIntentResponse{}

// RemoteConnectionListIntentResponse Response object for intentful operation of remote_connections
type RemoteConnectionListIntentResponse struct {
	Entities []RemoteConnectionIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata RemoteConnectionListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RemoteConnectionListIntentResponse RemoteConnectionListIntentResponse
...
func NewRemoteConnectionListIntentResponse(apiVersion string, metadata RemoteConnectionListMetadataOutput) *RemoteConnectionListIntentResponse {
	this := RemoteConnectionListIntentResponse{}
...
func (o *RemoteConnectionListIntentResponse) GetEntities() []RemoteConnectionIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []RemoteConnectionIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []RemoteConnectionIntentResource and assigns it to the Entities field.
...
func (o *RemoteConnectionListIntentResponse) GetMetadata() RemoteConnectionListMetadataOutput {
	if o == nil {
		var ret RemoteConnectionListMetadataOutput
		return ret
	}
...
func (o RemoteConnectionListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteConnectionListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteConnectionListIntentResponse := _RemoteConnectionListIntentResponse{}

	err = json.Unmarshal(data, &varRemoteConnectionListIntentResponse)

	if err != nil {
		return err
	}

	*o = RemoteConnectionListIntentResponse(varRemoteConnectionListIntentResponse)
...
type NullableRemoteConnectionListIntentResponse struct {
	value *RemoteConnectionListIntentResponse
	isSet bool
}

func (v NullableRemoteConnectionListIntentResponse) Get() *RemoteConnectionListIntentResponse {
	return v.value
}

func (v *NullableRemoteConnectionListIntentResponse) Set(val *RemoteConnectionListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionListIntentResponse(val *RemoteConnectionListIntentResponse) *NullableRemoteConnectionListIntentResponse {
	return &NullableRemoteConnectionListIntentResponse{value: val, isSet: true}
}

func (v NullableRemoteConnectionListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
