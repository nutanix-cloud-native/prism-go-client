...
// checks if the MhVmListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmListMetadataOutput{}

// MhVmListMetadataOutput All api calls that return a list will have this metadata block 
type MhVmListMetadataOutput struct {
	// The kind name
...
type _MhVmListMetadataOutput MhVmListMetadataOutput
...
func NewMhVmListMetadataOutput() *MhVmListMetadataOutput {
	this := MhVmListMetadataOutput{}
	var kind string = "mh_vm"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *MhVmListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o MhVmListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o MhVmListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varMhVmListMetadataOutput := _MhVmListMetadataOutput{}

	err = json.Unmarshal(data, &varMhVmListMetadataOutput)

	if err != nil {
		return err
	}

	*o = MhVmListMetadataOutput(varMhVmListMetadataOutput)
...
type NullableMhVmListMetadataOutput struct {
	value *MhVmListMetadataOutput
	isSet bool
}

func (v NullableMhVmListMetadataOutput) Get() *MhVmListMetadataOutput {
	return v.value
}

func (v *NullableMhVmListMetadataOutput) Set(val *MhVmListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmListMetadataOutput(val *MhVmListMetadataOutput) *NullableMhVmListMetadataOutput {
	return &NullableMhVmListMetadataOutput{value: val, isSet: true}
}

func (v NullableMhVmListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
