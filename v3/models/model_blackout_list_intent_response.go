...
// checks if the BlackoutListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackoutListIntentResponse{}

// BlackoutListIntentResponse Response object for intentful operation of blackouts
type BlackoutListIntentResponse struct {
	Entities []BlackoutIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata BlackoutListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _BlackoutListIntentResponse BlackoutListIntentResponse
...
func NewBlackoutListIntentResponse(apiVersion string, metadata BlackoutListMetadataOutput) *BlackoutListIntentResponse {
	this := BlackoutListIntentResponse{}
...
func (o *BlackoutListIntentResponse) GetEntities() []BlackoutIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []BlackoutIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []BlackoutIntentResource and assigns it to the Entities field.
...
func (o *BlackoutListIntentResponse) GetMetadata() BlackoutListMetadataOutput {
	if o == nil {
		var ret BlackoutListMetadataOutput
		return ret
	}
...
func (o BlackoutListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o BlackoutListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BlackoutListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBlackoutListIntentResponse := _BlackoutListIntentResponse{}

	err = json.Unmarshal(data, &varBlackoutListIntentResponse)

	if err != nil {
		return err
	}

	*o = BlackoutListIntentResponse(varBlackoutListIntentResponse)
...
type NullableBlackoutListIntentResponse struct {
	value *BlackoutListIntentResponse
	isSet bool
}

func (v NullableBlackoutListIntentResponse) Get() *BlackoutListIntentResponse {
	return v.value
}

func (v *NullableBlackoutListIntentResponse) Set(val *BlackoutListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlackoutListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlackoutListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlackoutListIntentResponse(val *BlackoutListIntentResponse) *NullableBlackoutListIntentResponse {
	return &NullableBlackoutListIntentResponse{value: val, isSet: true}
}

func (v NullableBlackoutListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlackoutListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
