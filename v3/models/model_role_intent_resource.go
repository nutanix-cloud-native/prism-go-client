...
// checks if the RoleIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleIntentResource{}

// RoleIntentResource Response object for intentful operations on a role
...
type _RoleIntentResource RoleIntentResource
...
func (o RoleIntentResource) MarshalJSON() ([]byte, error) {
...
func (o RoleIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *RoleIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleIntentResource := _RoleIntentResource{}

	err = json.Unmarshal(data, &varRoleIntentResource)

	if err != nil {
		return err
	}

	*o = RoleIntentResource(varRoleIntentResource)
...
type NullableRoleIntentResource struct {
	value *RoleIntentResource
	isSet bool
}

func (v NullableRoleIntentResource) Get() *RoleIntentResource {
	return v.value
}

func (v *NullableRoleIntentResource) Set(val *RoleIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleIntentResource(val *RoleIntentResource) *NullableRoleIntentResource {
	return &NullableRoleIntentResource{value: val, isSet: true}
}

func (v NullableRoleIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
