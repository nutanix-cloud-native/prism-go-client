...
// checks if the CommonReportConfigIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigIntentInput{}

// CommonReportConfigIntentInput An intentful representation of a common_report_config
type CommonReportConfigIntentInput struct {
	Spec CommonReportConfig `json:"spec"`
...
type _CommonReportConfigIntentInput CommonReportConfigIntentInput
...
func NewCommonReportConfigIntentInput(spec CommonReportConfig, metadata CommonReportConfigMetadata) *CommonReportConfigIntentInput {
	this := CommonReportConfigIntentInput{}
	this.Spec = spec
...
func (o CommonReportConfigIntentInput) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfigIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonReportConfigIntentInput := _CommonReportConfigIntentInput{}

	err = json.Unmarshal(data, &varCommonReportConfigIntentInput)

	if err != nil {
		return err
	}

	*o = CommonReportConfigIntentInput(varCommonReportConfigIntentInput)
...
type NullableCommonReportConfigIntentInput struct {
	value *CommonReportConfigIntentInput
	isSet bool
}

func (v NullableCommonReportConfigIntentInput) Get() *CommonReportConfigIntentInput {
	return v.value
}

func (v *NullableCommonReportConfigIntentInput) Set(val *CommonReportConfigIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigIntentInput(val *CommonReportConfigIntentInput) *NullableCommonReportConfigIntentInput {
	return &NullableCommonReportConfigIntentInput{value: val, isSet: true}
}

func (v NullableCommonReportConfigIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
