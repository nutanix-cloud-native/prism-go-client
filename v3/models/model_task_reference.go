...
// checks if the TaskReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskReference{}

// TaskReference The reference to a task
...
type _TaskReference TaskReference
...
func (o TaskReference) MarshalJSON() ([]byte, error) {
...
func (o TaskReference) ToMap() (map[string]interface{}, error) {
...
func (o *TaskReference) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskReference := _TaskReference{}

	err = json.Unmarshal(data, &varTaskReference)

	if err != nil {
		return err
	}

	*o = TaskReference(varTaskReference)
...
type NullableTaskReference struct {
	value *TaskReference
	isSet bool
}

func (v NullableTaskReference) Get() *TaskReference {
	return v.value
}

func (v *NullableTaskReference) Set(val *TaskReference) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskReference) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskReference(val *TaskReference) *NullableTaskReference {
	return &NullableTaskReference{value: val, isSet: true}
}

func (v NullableTaskReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
