...
// NetworkConfiguration Network configuration of the VM.
type NetworkConfiguration struct {
	...
	// List of IP information of the network interface.
	IpInfoList []IpAddress `json:"ip_info_list,omitempty"`
...
// GetIpInfoList returns the IpInfoList field value if set, zero value otherwise.
func (o *NetworkConfiguration) GetIpInfoList() []IpAddress {
	if o == nil || IsNil(o.IpInfoList) {
		var ret []IpAddress
		return ret
	}
	return o.IpInfoList
...
// GetIpInfoListOk returns a tuple with the IpInfoList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkConfiguration) GetIpInfoListOk() ([]IpAddress, bool) {
	if o == nil || IsNil(o.IpInfoList) {
		return nil, false
	}
	return o.IpInfoList, true
}
...
// SetIpInfoList gets a reference to the given []IpAddress and assigns it to the IpInfoList field.
...
func (o NetworkConfiguration) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IpInfoList) {
		toSerialize["ip_info_list"] = o.IpInfoList
	}
...
func (o *NetworkConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	*o = NetworkConfiguration(varNetworkConfiguration)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ip_info_list")
