...
// checks if the PrismCentralListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralListMetadataOutput{}

// PrismCentralListMetadataOutput All api calls that return a list will have this metadata block 
...
type _PrismCentralListMetadataOutput PrismCentralListMetadataOutput
...
func NewPrismCentralListMetadataOutput() *PrismCentralListMetadataOutput {
	this := PrismCentralListMetadataOutput{}
	var kind string = "prism_central"
	this.Kind = &kind
	return &this
}
...
func (o PrismCentralListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *PrismCentralListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varPrismCentralListMetadataOutput := _PrismCentralListMetadataOutput{}

	err = json.Unmarshal(data, &varPrismCentralListMetadataOutput)

	if err != nil {
		return err
	}

	*o = PrismCentralListMetadataOutput(varPrismCentralListMetadataOutput)
...
type NullablePrismCentralListMetadataOutput struct {
	value *PrismCentralListMetadataOutput
	isSet bool
}

func (v NullablePrismCentralListMetadataOutput) Get() *PrismCentralListMetadataOutput {
	return v.value
}

func (v *NullablePrismCentralListMetadataOutput) Set(val *PrismCentralListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralListMetadataOutput(val *PrismCentralListMetadataOutput) *NullablePrismCentralListMetadataOutput {
	return &NullablePrismCentralListMetadataOutput{value: val, isSet: true}
}

func (v NullablePrismCentralListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
