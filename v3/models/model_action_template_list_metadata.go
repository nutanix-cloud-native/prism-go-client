...
// checks if the ActionTemplateListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTemplateListMetadata{}

// ActionTemplateListMetadata All api calls that return a list will have this metadata block as input 
type ActionTemplateListMetadata struct {
	// The kind name
...
type _ActionTemplateListMetadata ActionTemplateListMetadata
...
func NewActionTemplateListMetadata() *ActionTemplateListMetadata {
	this := ActionTemplateListMetadata{}
...
func (o ActionTemplateListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ActionTemplateListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTemplateListMetadata) UnmarshalJSON(data []byte) (err error) {
	varActionTemplateListMetadata := _ActionTemplateListMetadata{}

	err = json.Unmarshal(data, &varActionTemplateListMetadata)

	if err != nil {
		return err
	}

	*o = ActionTemplateListMetadata(varActionTemplateListMetadata)
...
type NullableActionTemplateListMetadata struct {
	value *ActionTemplateListMetadata
	isSet bool
}

func (v NullableActionTemplateListMetadata) Get() *ActionTemplateListMetadata {
	return v.value
}

func (v *NullableActionTemplateListMetadata) Set(val *ActionTemplateListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTemplateListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTemplateListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTemplateListMetadata(val *ActionTemplateListMetadata) *NullableActionTemplateListMetadata {
	return &NullableActionTemplateListMetadata{value: val, isSet: true}
}

func (v NullableActionTemplateListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTemplateListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
