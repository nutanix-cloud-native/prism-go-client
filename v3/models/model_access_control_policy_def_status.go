...
// checks if the AccessControlPolicyDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyDefStatus{}

// AccessControlPolicyDefStatus Access Control Policy status definition.
type AccessControlPolicyDefStatus struct {
	// Name of the Access Control Policy.
	Name *string `json:"name,omitempty"`
	// Flag identifying if the ACP is system defined or not.
	IsSystemDefined *bool `json:"is_system_defined,omitempty"`
	// The state of the Access Control Policy entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	Resources AccessControlPolicyResources `json:"resources"`
	// The description of the association of a role to a user in a given context.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AccessControlPolicyDefStatus AccessControlPolicyDefStatus
...
func NewAccessControlPolicyDefStatus(resources AccessControlPolicyResources) *AccessControlPolicyDefStatus {
	this := AccessControlPolicyDefStatus{}
...
func (o *AccessControlPolicyDefStatus) GetResources() AccessControlPolicyResources {
	if o == nil {
		var ret AccessControlPolicyResources
		return ret
	}
...
func (o AccessControlPolicyDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Name) {
		toSerialize["name"] = o.Name
	}
	if !IsNil(o.IsSystemDefined) {
		toSerialize["is_system_defined"] = o.IsSystemDefined
	}
	if !IsNil(o.State) {
...
func (o *AccessControlPolicyDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessControlPolicyDefStatus := _AccessControlPolicyDefStatus{}

	err = json.Unmarshal(data, &varAccessControlPolicyDefStatus)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyDefStatus(varAccessControlPolicyDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "name")
		delete(additionalProperties, "is_system_defined")
...
type NullableAccessControlPolicyDefStatus struct {
	value *AccessControlPolicyDefStatus
	isSet bool
}

func (v NullableAccessControlPolicyDefStatus) Get() *AccessControlPolicyDefStatus {
	return v.value
}

func (v *NullableAccessControlPolicyDefStatus) Set(val *AccessControlPolicyDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyDefStatus(val *AccessControlPolicyDefStatus) *NullableAccessControlPolicyDefStatus {
	return &NullableAccessControlPolicyDefStatus{value: val, isSet: true}
}

func (v NullableAccessControlPolicyDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
