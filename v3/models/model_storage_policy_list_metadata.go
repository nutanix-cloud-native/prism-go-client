...
// checks if the StoragePolicyListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyListMetadata{}

// StoragePolicyListMetadata All api calls that return a list will have this metadata block as input 
type StoragePolicyListMetadata struct {
	// The kind name
...
type _StoragePolicyListMetadata StoragePolicyListMetadata
...
func NewStoragePolicyListMetadata() *StoragePolicyListMetadata {
	this := StoragePolicyListMetadata{}
...
func (o StoragePolicyListMetadata) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePolicyListMetadata) UnmarshalJSON(data []byte) (err error) {
	varStoragePolicyListMetadata := _StoragePolicyListMetadata{}

	err = json.Unmarshal(data, &varStoragePolicyListMetadata)

	if err != nil {
		return err
	}

	*o = StoragePolicyListMetadata(varStoragePolicyListMetadata)
...
type NullableStoragePolicyListMetadata struct {
	value *StoragePolicyListMetadata
	isSet bool
}

func (v NullableStoragePolicyListMetadata) Get() *StoragePolicyListMetadata {
	return v.value
}

func (v *NullableStoragePolicyListMetadata) Set(val *StoragePolicyListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyListMetadata(val *StoragePolicyListMetadata) *NullableStoragePolicyListMetadata {
	return &NullableStoragePolicyListMetadata{value: val, isSet: true}
}

func (v NullableStoragePolicyListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
