...
// checks if the VmResourceSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmResourceSpec{}

// VmResourceSpec vm resource spce object.
...
type _VmResourceSpec VmResourceSpec
...
func (o VmResourceSpec) MarshalJSON() ([]byte, error) {
...
func (o VmResourceSpec) ToMap() (map[string]interface{}, error) {
...
func (o *VmResourceSpec) UnmarshalJSON(data []byte) (err error) {
	varVmResourceSpec := _VmResourceSpec{}

	err = json.Unmarshal(data, &varVmResourceSpec)

	if err != nil {
		return err
	}

	*o = VmResourceSpec(varVmResourceSpec)
...
type NullableVmResourceSpec struct {
	value *VmResourceSpec
	isSet bool
}

func (v NullableVmResourceSpec) Get() *VmResourceSpec {
	return v.value
}

func (v *NullableVmResourceSpec) Set(val *VmResourceSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableVmResourceSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableVmResourceSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmResourceSpec(val *VmResourceSpec) *NullableVmResourceSpec {
	return &NullableVmResourceSpec{value: val, isSet: true}
}

func (v NullableVmResourceSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmResourceSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
