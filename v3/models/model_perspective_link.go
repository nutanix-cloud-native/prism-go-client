...
// checks if the PerspectiveLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PerspectiveLink{}

// PerspectiveLink Perspective link object definition.
type PerspectiveLink struct {
	SearchQuery *AutoCompletion `json:"search_query,omitempty"`
	// List of summary data.
	SummaryDataList []map[string]interface{} `json:"summary_data_list,omitempty"`
	// Title of the perspective link.
	Title *string `json:"title,omitempty"`
	// List of child perspecitve links. This is list of perspective_link objects. 
	ChildLinkList []map[string]interface{} `json:"child_link_list,omitempty"`
	// Flag to indicate if this perspective link is selected in the navigation panel. Indicates if this is the active perspective. 
	IsSelected *bool `json:"is_selected,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PerspectiveLink PerspectiveLink
...
// SetSearchQuery gets a reference to the given AutoCompletion and assigns it to the SearchQuery field.
func (o *PerspectiveLink) SetSearchQuery(v AutoCompletion) {
	o.SearchQuery = &v
}

// GetSummaryDataList returns the SummaryDataList field value if set, zero value otherwise.
func (o *PerspectiveLink) GetSummaryDataList() []map[string]interface{} {
	if o == nil || IsNil(o.SummaryDataList) {
		var ret []map[string]interface{}
		return ret
	}
	return o.SummaryDataList
}

// GetSummaryDataListOk returns a tuple with the SummaryDataList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PerspectiveLink) GetSummaryDataListOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.SummaryDataList) {
		return nil, false
	}
	return o.SummaryDataList, true
}
...
// SetSummaryDataList gets a reference to the given []map[string]interface{} and assigns it to the SummaryDataList field.
...
// GetChildLinkList returns the ChildLinkList field value if set, zero value otherwise.
func (o *PerspectiveLink) GetChildLinkList() []map[string]interface{} {
	if o == nil || IsNil(o.ChildLinkList) {
		var ret []map[string]interface{}
		return ret
	}
	return o.ChildLinkList
}

// GetChildLinkListOk returns a tuple with the ChildLinkList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PerspectiveLink) GetChildLinkListOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.ChildLinkList) {
		return nil, false
	}
	return o.ChildLinkList, true
}
...
// SetChildLinkList gets a reference to the given []map[string]interface{} and assigns it to the ChildLinkList field.
...
func (o PerspectiveLink) MarshalJSON() ([]byte, error) {
...
func (o PerspectiveLink) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SearchQuery) {
		toSerialize["search_query"] = o.SearchQuery
	}
	if !IsNil(o.SummaryDataList) {
		toSerialize["summary_data_list"] = o.SummaryDataList
	}
	if !IsNil(o.Title) {
		toSerialize["title"] = o.Title
	}
	if !IsNil(o.ChildLinkList) {
		toSerialize["child_link_list"] = o.ChildLinkList
	}
...
func (o *PerspectiveLink) UnmarshalJSON(data []byte) (err error) {
	varPerspectiveLink := _PerspectiveLink{}

	err = json.Unmarshal(data, &varPerspectiveLink)

	if err != nil {
		return err
	}

	*o = PerspectiveLink(varPerspectiveLink)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "search_query")
		delete(additionalProperties, "summary_data_list")
		delete(additionalProperties, "title")
		delete(additionalProperties, "child_link_list")
...
type NullablePerspectiveLink struct {
	value *PerspectiveLink
	isSet bool
}

func (v NullablePerspectiveLink) Get() *PerspectiveLink {
	return v.value
}

func (v *NullablePerspectiveLink) Set(val *PerspectiveLink) {
	v.value = val
	v.isSet = true
}

func (v NullablePerspectiveLink) IsSet() bool {
	return v.isSet
}

func (v *NullablePerspectiveLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePerspectiveLink(val *PerspectiveLink) *NullablePerspectiveLink {
	return &NullablePerspectiveLink{value: val, isSet: true}
}

func (v NullablePerspectiveLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePerspectiveLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
