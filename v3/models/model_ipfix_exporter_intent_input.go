...
// checks if the IpfixExporterIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpfixExporterIntentInput{}

// IpfixExporterIntentInput An intentful representation of a ipfix_exporter
type IpfixExporterIntentInput struct {
	Spec IpfixExporter `json:"spec"`
...
type _IpfixExporterIntentInput IpfixExporterIntentInput
...
func (o IpfixExporterIntentInput) MarshalJSON() ([]byte, error) {
...
func (o IpfixExporterIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *IpfixExporterIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varIpfixExporterIntentInput := _IpfixExporterIntentInput{}

	err = json.Unmarshal(data, &varIpfixExporterIntentInput)

	if err != nil {
		return err
	}

	*o = IpfixExporterIntentInput(varIpfixExporterIntentInput)
...
type NullableIpfixExporterIntentInput struct {
	value *IpfixExporterIntentInput
	isSet bool
}

func (v NullableIpfixExporterIntentInput) Get() *IpfixExporterIntentInput {
	return v.value
}

func (v *NullableIpfixExporterIntentInput) Set(val *IpfixExporterIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableIpfixExporterIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableIpfixExporterIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpfixExporterIntentInput(val *IpfixExporterIntentInput) *NullableIpfixExporterIntentInput {
	return &NullableIpfixExporterIntentInput{value: val, isSet: true}
}

func (v NullableIpfixExporterIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpfixExporterIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
