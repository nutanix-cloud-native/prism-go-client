...
// checks if the ClusterImageReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterImageReference{}

// ClusterImageReference The reference to a cluster and related image location
...
type _ClusterImageReference ClusterImageReference
...
// SetFileLocation gets a reference to the given FileLocation and assigns it to the FileLocation field.
...
func (o ClusterImageReference) MarshalJSON() ([]byte, error) {
...
func (o ClusterImageReference) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterImageReference) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterImageReference := _ClusterImageReference{}

	err = json.Unmarshal(data, &varClusterImageReference)

	if err != nil {
		return err
	}

	*o = ClusterImageReference(varClusterImageReference)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "file_location")
...
type NullableClusterImageReference struct {
	value *ClusterImageReference
	isSet bool
}

func (v NullableClusterImageReference) Get() *ClusterImageReference {
	return v.value
}

func (v *NullableClusterImageReference) Set(val *ClusterImageReference) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterImageReference) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterImageReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterImageReference(val *ClusterImageReference) *NullableClusterImageReference {
	return &NullableClusterImageReference{value: val, isSet: true}
}

func (v NullableClusterImageReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterImageReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
