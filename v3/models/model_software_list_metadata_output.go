...
// checks if the SoftwareListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareListMetadataOutput{}

// SoftwareListMetadataOutput All api calls that return a list will have this metadata block 
...
type _SoftwareListMetadataOutput SoftwareListMetadataOutput
...
func NewSoftwareListMetadataOutput() *SoftwareListMetadataOutput {
	this := SoftwareListMetadataOutput{}
...
// and a boolean to check if the value has been set.
func (o *SoftwareListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o SoftwareListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o SoftwareListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *SoftwareListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varSoftwareListMetadataOutput := _SoftwareListMetadataOutput{}

	err = json.Unmarshal(data, &varSoftwareListMetadataOutput)

	if err != nil {
		return err
	}

	*o = SoftwareListMetadataOutput(varSoftwareListMetadataOutput)
...
type NullableSoftwareListMetadataOutput struct {
	value *SoftwareListMetadataOutput
	isSet bool
}

func (v NullableSoftwareListMetadataOutput) Get() *SoftwareListMetadataOutput {
	return v.value
}

func (v *NullableSoftwareListMetadataOutput) Set(val *SoftwareListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareListMetadataOutput(val *SoftwareListMetadataOutput) *NullableSoftwareListMetadataOutput {
	return &NullableSoftwareListMetadataOutput{value: val, isSet: true}
}

func (v NullableSoftwareListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
