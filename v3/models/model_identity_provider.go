...
// IdentityProvider The configuration details of the identity provider.
type IdentityProvider struct {
	// Identity Provider name.
	Name string `json:"name"`
	Resources IdentityProviderResources `json:"resources"`
...
func (o *IdentityProvider) GetResources() IdentityProviderResources {
	if o == nil {
		var ret IdentityProviderResources
		return ret
	}
