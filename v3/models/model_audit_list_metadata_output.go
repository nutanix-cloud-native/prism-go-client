...
// checks if the AuditListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditListMetadataOutput{}

// AuditListMetadataOutput All api calls that return a list will have this metadata block 
type AuditListMetadataOutput struct {
	// The kind name
...
type _AuditListMetadataOutput AuditListMetadataOutput
...
func NewAuditListMetadataOutput() *AuditListMetadataOutput {
	this := AuditListMetadataOutput{}
	var kind string = "audit"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *AuditListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o AuditListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AuditListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AuditListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAuditListMetadataOutput := _AuditListMetadataOutput{}

	err = json.Unmarshal(data, &varAuditListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AuditListMetadataOutput(varAuditListMetadataOutput)
...
type NullableAuditListMetadataOutput struct {
	value *AuditListMetadataOutput
	isSet bool
}

func (v NullableAuditListMetadataOutput) Get() *AuditListMetadataOutput {
	return v.value
}

func (v *NullableAuditListMetadataOutput) Set(val *AuditListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditListMetadataOutput(val *AuditListMetadataOutput) *NullableAuditListMetadataOutput {
	return &NullableAuditListMetadataOutput{value: val, isSet: true}
}

func (v NullableAuditListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
