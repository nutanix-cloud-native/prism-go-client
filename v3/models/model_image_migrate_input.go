...
// checks if the ImageMigrateInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageMigrateInput{}

// ImageMigrateInput Specify the cluster and image(s) from the cluster to migrate to PC 
type ImageMigrateInput struct {
	// Reference to the images from PE cluster to be migrated 
	ImageReferenceList []ImageReference `json:"image_reference_list,omitempty"`
	ClusterReference ClusterReference `json:"cluster_reference"`
	AdditionalProperties map[string]interface{}
}

type _ImageMigrateInput ImageMigrateInput
...
// GetImageReferenceList returns the ImageReferenceList field value if set, zero value otherwise.
func (o *ImageMigrateInput) GetImageReferenceList() []ImageReference {
	if o == nil || IsNil(o.ImageReferenceList) {
		var ret []ImageReference
		return ret
	}
	return o.ImageReferenceList
}

// GetImageReferenceListOk returns a tuple with the ImageReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImageMigrateInput) GetImageReferenceListOk() ([]ImageReference, bool) {
	if o == nil || IsNil(o.ImageReferenceList) {
		return nil, false
	}
	return o.ImageReferenceList, true
}
...
// SetImageReferenceList gets a reference to the given []ImageReference and assigns it to the ImageReferenceList field.
func (o *ImageMigrateInput) SetImageReferenceList(v []ImageReference) {
	o.ImageReferenceList = v
}
...
func (o ImageMigrateInput) MarshalJSON() ([]byte, error) {
...
func (o ImageMigrateInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ImageReferenceList) {
		toSerialize["image_reference_list"] = o.ImageReferenceList
	}
...
func (o *ImageMigrateInput) UnmarshalJSON(data []byte) (err error) {
	...
	varImageMigrateInput := _ImageMigrateInput{}

	err = json.Unmarshal(data, &varImageMigrateInput)

	if err != nil {
		return err
	}

	*o = ImageMigrateInput(varImageMigrateInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "image_reference_list")
...
type NullableImageMigrateInput struct {
	value *ImageMigrateInput
	isSet bool
}

func (v NullableImageMigrateInput) Get() *ImageMigrateInput {
	return v.value
}

func (v *NullableImageMigrateInput) Set(val *ImageMigrateInput) {
	v.value = val
	v.isSet = true
}

func (v NullableImageMigrateInput) IsSet() bool {
	return v.isSet
}

func (v *NullableImageMigrateInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageMigrateInput(val *ImageMigrateInput) *NullableImageMigrateInput {
	return &NullableImageMigrateInput{value: val, isSet: true}
}

func (v NullableImageMigrateInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageMigrateInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
