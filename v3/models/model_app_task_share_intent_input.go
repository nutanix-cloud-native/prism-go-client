...
// checks if the AppTaskShareIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskShareIntentInput{}

// AppTaskShareIntentInput An intentful representation of a App task
type AppTaskShareIntentInput struct {
	Spec AppTaskShare `json:"spec"`
	ApiVersion string `json:"api_version"`
	Metadata AppTaskMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AppTaskShareIntentInput AppTaskShareIntentInput
...
func (o AppTaskShareIntentInput) MarshalJSON() ([]byte, error) {
...
func (o AppTaskShareIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskShareIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskShareIntentInput := _AppTaskShareIntentInput{}

	err = json.Unmarshal(data, &varAppTaskShareIntentInput)

	if err != nil {
		return err
	}

	*o = AppTaskShareIntentInput(varAppTaskShareIntentInput)
...
type NullableAppTaskShareIntentInput struct {
	value *AppTaskShareIntentInput
	isSet bool
}

func (v NullableAppTaskShareIntentInput) Get() *AppTaskShareIntentInput {
	return v.value
}

func (v *NullableAppTaskShareIntentInput) Set(val *AppTaskShareIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskShareIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskShareIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskShareIntentInput(val *AppTaskShareIntentInput) *NullableAppTaskShareIntentInput {
	return &NullableAppTaskShareIntentInput{value: val, isSet: true}
}

func (v NullableAppTaskShareIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskShareIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
