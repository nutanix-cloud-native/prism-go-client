...
// checks if the AppRunbookInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunbookInput{}

// AppRunbookInput Runbook definition for Application
type AppRunbookInput struct {
	// 
	TaskDefinitionList []AppTaskInput `json:"task_definition_list,omitempty"`
	// 
...
type _AppRunbookInput AppRunbookInput
...
// SetTaskDefinitionList gets a reference to the given []AppTaskInput and assigns it to the TaskDefinitionList field.
...
func (o AppRunbookInput) MarshalJSON() ([]byte, error) {
...
func (o AppRunbookInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunbookInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRunbookInput := _AppRunbookInput{}

	err = json.Unmarshal(data, &varAppRunbookInput)

	if err != nil {
		return err
	}

	*o = AppRunbookInput(varAppRunbookInput)
...
type NullableAppRunbookInput struct {
	value *AppRunbookInput
	isSet bool
}

func (v NullableAppRunbookInput) Get() *AppRunbookInput {
	return v.value
}

func (v *NullableAppRunbookInput) Set(val *AppRunbookInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunbookInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunbookInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunbookInput(val *AppRunbookInput) *NullableAppRunbookInput {
	return &NullableAppRunbookInput{value: val, isSet: true}
}

func (v NullableAppRunbookInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunbookInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
