...
// FloatingIp An intentful representation of a floating_ip spec
...
func (o *FloatingIp) UnmarshalJSON(data []byte) (err error) {
	...
	varFloatingIp := _FloatingIp{}

	err = json.Unmarshal(data, &varFloatingIp)

	if err != nil {
		return err
	}

	*o = FloatingIp(varFloatingIp)
