...
// checks if the AvailabilityZoneListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneListIntentResponse{}

// AvailabilityZoneListIntentResponse Response object for intentful operation of availability_zones
type AvailabilityZoneListIntentResponse struct {
	Entities []AvailabilityZoneIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AvailabilityZoneListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AvailabilityZoneListIntentResponse AvailabilityZoneListIntentResponse
...
func NewAvailabilityZoneListIntentResponse(apiVersion string, metadata AvailabilityZoneListMetadataOutput) *AvailabilityZoneListIntentResponse {
	this := AvailabilityZoneListIntentResponse{}
...
func (o *AvailabilityZoneListIntentResponse) GetEntities() []AvailabilityZoneIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []AvailabilityZoneIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []AvailabilityZoneIntentResource and assigns it to the Entities field.
...
func (o *AvailabilityZoneListIntentResponse) GetMetadata() AvailabilityZoneListMetadataOutput {
	if o == nil {
		var ret AvailabilityZoneListMetadataOutput
		return ret
	}
...
func (o AvailabilityZoneListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAvailabilityZoneListIntentResponse := _AvailabilityZoneListIntentResponse{}

	err = json.Unmarshal(data, &varAvailabilityZoneListIntentResponse)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneListIntentResponse(varAvailabilityZoneListIntentResponse)
...
type NullableAvailabilityZoneListIntentResponse struct {
	value *AvailabilityZoneListIntentResponse
	isSet bool
}

func (v NullableAvailabilityZoneListIntentResponse) Get() *AvailabilityZoneListIntentResponse {
	return v.value
}

func (v *NullableAvailabilityZoneListIntentResponse) Set(val *AvailabilityZoneListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneListIntentResponse(val *AvailabilityZoneListIntentResponse) *NullableAvailabilityZoneListIntentResponse {
	return &NullableAvailabilityZoneListIntentResponse{value: val, isSet: true}
}

func (v NullableAvailabilityZoneListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
