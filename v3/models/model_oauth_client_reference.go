...
// checks if the OauthClientReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthClientReference{}

// OauthClientReference The reference to a oauth_client
...
type _OauthClientReference OauthClientReference
...
func (o OauthClientReference) MarshalJSON() ([]byte, error) {
...
func (o OauthClientReference) ToMap() (map[string]interface{}, error) {
...
func (o *OauthClientReference) UnmarshalJSON(data []byte) (err error) {
	...
	varOauthClientReference := _OauthClientReference{}

	err = json.Unmarshal(data, &varOauthClientReference)

	if err != nil {
		return err
	}

	*o = OauthClientReference(varOauthClientReference)
...
type NullableOauthClientReference struct {
	value *OauthClientReference
	isSet bool
}

func (v NullableOauthClientReference) Get() *OauthClientReference {
	return v.value
}

func (v *NullableOauthClientReference) Set(val *OauthClientReference) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthClientReference) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthClientReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthClientReference(val *OauthClientReference) *NullableOauthClientReference {
	return &NullableOauthClientReference{value: val, isSet: true}
}

func (v NullableOauthClientReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthClientReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
