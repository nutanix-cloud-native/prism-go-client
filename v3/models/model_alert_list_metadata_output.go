...
// checks if the AlertListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertListMetadataOutput{}

// AlertListMetadataOutput All api calls that return a list will have this metadata block 
type AlertListMetadataOutput struct {
	// The kind name
...
type _AlertListMetadataOutput AlertListMetadataOutput
...
func NewAlertListMetadataOutput() *AlertListMetadataOutput {
	this := AlertListMetadataOutput{}
	var kind string = "alert"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *AlertListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o AlertListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AlertListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AlertListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAlertListMetadataOutput := _AlertListMetadataOutput{}

	err = json.Unmarshal(data, &varAlertListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AlertListMetadataOutput(varAlertListMetadataOutput)
...
type NullableAlertListMetadataOutput struct {
	value *AlertListMetadataOutput
	isSet bool
}

func (v NullableAlertListMetadataOutput) Get() *AlertListMetadataOutput {
	return v.value
}

func (v *NullableAlertListMetadataOutput) Set(val *AlertListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertListMetadataOutput(val *AlertListMetadataOutput) *NullableAlertListMetadataOutput {
	return &NullableAlertListMetadataOutput{value: val, isSet: true}
}

func (v NullableAlertListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
