...
// checks if the AuditResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditResources{}

// AuditResources Audit entity definition.
type AuditResources struct {
	...
	// Parameters associated with the operation captured in the audit.
	OperationParameterList []AuditParameters `json:"operation_parameter_list,omitempty"`
	SourceEntityReference *EntityInfo `json:"source_entity_reference,omitempty"`
	// UTC date and time in RFC-3339 format when operation was started. 
	OperationStartTime *time.Time `json:"operation_start_time,omitempty"`
	InitiatedUser *AuditUser `json:"initiated_user,omitempty"`
	// UTC date and time in RFC-3339 format when operation was completed. 
	OperationCompleteTime *time.Time `json:"operation_complete_time,omitempty"`
	// The operation type the audit captures.
	OperationType *string `json:"operation_type,omitempty"`
	// A list of entities causing and/or related to the audit. 
	AffectedEntityReferenceList []EntityInfo `json:"affected_entity_reference_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AuditResources AuditResources
...
// GetAuditMessage returns the AuditMessage field value
func (o *AuditResources) GetAuditMessage() string {
	...
	return o.AuditMessage
}

// GetAuditMessageOk returns a tuple with the AuditMessage field value
// and a boolean to check if the value has been set.
func (o *AuditResources) GetAuditMessageOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AuditMessage, true
}

// SetAuditMessage sets field value
...
// GetOperationParameterList returns the OperationParameterList field value if set, zero value otherwise.
func (o *AuditResources) GetOperationParameterList() []AuditParameters {
	if o == nil || IsNil(o.OperationParameterList) {
		var ret []AuditParameters
		return ret
	}
	return o.OperationParameterList
}

// GetOperationParameterListOk returns a tuple with the OperationParameterList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuditResources) GetOperationParameterListOk() ([]AuditParameters, bool) {
	if o == nil || IsNil(o.OperationParameterList) {
		return nil, false
	}
	return o.OperationParameterList, true
}
...
// SetOperationParameterList gets a reference to the given []AuditParameters and assigns it to the OperationParameterList field.
func (o *AuditResources) SetOperationParameterList(v []AuditParameters) {
	o.OperationParameterList = v
}

// GetSourceEntityReference returns the SourceEntityReference field value if set, zero value otherwise.
func (o *AuditResources) GetSourceEntityReference() EntityInfo {
	if o == nil || IsNil(o.SourceEntityReference) {
		var ret EntityInfo
		return ret
	}
	return *o.SourceEntityReference
}

// GetSourceEntityReferenceOk returns a tuple with the SourceEntityReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuditResources) GetSourceEntityReferenceOk() (*EntityInfo, bool) {
	if o == nil || IsNil(o.SourceEntityReference) {
		return nil, false
	}
	return o.SourceEntityReference, true
}
...
// SetSourceEntityReference gets a reference to the given EntityInfo and assigns it to the SourceEntityReference field.
func (o *AuditResources) SetSourceEntityReference(v EntityInfo) {
	o.SourceEntityReference = &v
}

// GetOperationStartTime returns the OperationStartTime field value if set, zero value otherwise.
func (o *AuditResources) GetOperationStartTime() time.Time {
	if o == nil || IsNil(o.OperationStartTime) {
		var ret time.Time
		return ret
	}
	return *o.OperationStartTime
}

// GetOperationStartTimeOk returns a tuple with the OperationStartTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuditResources) GetOperationStartTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.OperationStartTime) {
		return nil, false
	}
	return o.OperationStartTime, true
}
...
// SetOperationStartTime gets a reference to the given time.Time and assigns it to the OperationStartTime field.
func (o *AuditResources) SetOperationStartTime(v time.Time) {
	o.OperationStartTime = &v
}

// GetInitiatedUser returns the InitiatedUser field value if set, zero value otherwise.
func (o *AuditResources) GetInitiatedUser() AuditUser {
	if o == nil || IsNil(o.InitiatedUser) {
		var ret AuditUser
		return ret
	}
	return *o.InitiatedUser
}

// GetInitiatedUserOk returns a tuple with the InitiatedUser field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuditResources) GetInitiatedUserOk() (*AuditUser, bool) {
	if o == nil || IsNil(o.InitiatedUser) {
		return nil, false
	}
	return o.InitiatedUser, true
}
...
// SetInitiatedUser gets a reference to the given AuditUser and assigns it to the InitiatedUser field.
func (o *AuditResources) SetInitiatedUser(v AuditUser) {
	o.InitiatedUser = &v
}

// GetOperationCompleteTime returns the OperationCompleteTime field value if set, zero value otherwise.
func (o *AuditResources) GetOperationCompleteTime() time.Time {
	if o == nil || IsNil(o.OperationCompleteTime) {
		var ret time.Time
		return ret
	}
	return *o.OperationCompleteTime
}

// GetOperationCompleteTimeOk returns a tuple with the OperationCompleteTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuditResources) GetOperationCompleteTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.OperationCompleteTime) {
		return nil, false
	}
	return o.OperationCompleteTime, true
}
...
// SetOperationCompleteTime gets a reference to the given time.Time and assigns it to the OperationCompleteTime field.
func (o *AuditResources) SetOperationCompleteTime(v time.Time) {
	o.OperationCompleteTime = &v
}
...
// GetAffectedEntityReferenceList returns the AffectedEntityReferenceList field value if set, zero value otherwise.
func (o *AuditResources) GetAffectedEntityReferenceList() []EntityInfo {
	if o == nil || IsNil(o.AffectedEntityReferenceList) {
		var ret []EntityInfo
		return ret
	}
	return o.AffectedEntityReferenceList
}

// GetAffectedEntityReferenceListOk returns a tuple with the AffectedEntityReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuditResources) GetAffectedEntityReferenceListOk() ([]EntityInfo, bool) {
	if o == nil || IsNil(o.AffectedEntityReferenceList) {
		return nil, false
	}
	return o.AffectedEntityReferenceList, true
}
...
// SetAffectedEntityReferenceList gets a reference to the given []EntityInfo and assigns it to the AffectedEntityReferenceList field.
func (o *AuditResources) SetAffectedEntityReferenceList(v []EntityInfo) {
	o.AffectedEntityReferenceList = v
}

func (o AuditResources) MarshalJSON() ([]byte, error) {
...
func (o AuditResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["audit_message"] = o.AuditMessage
	if !IsNil(o.ClusterReference) {
		toSerialize["cluster_reference"] = o.ClusterReference
	}
	if !IsNil(o.OperationParameterList) {
		toSerialize["operation_parameter_list"] = o.OperationParameterList
	}
	if !IsNil(o.SourceEntityReference) {
		toSerialize["source_entity_reference"] = o.SourceEntityReference
	}
	if !IsNil(o.OperationStartTime) {
		toSerialize["operation_start_time"] = o.OperationStartTime
	}
	if !IsNil(o.InitiatedUser) {
		toSerialize["initiated_user"] = o.InitiatedUser
	}
	if !IsNil(o.OperationCompleteTime) {
		toSerialize["operation_complete_time"] = o.OperationCompleteTime
	}
	if !IsNil(o.OperationType) {
		toSerialize["operation_type"] = o.OperationType
	}
	if !IsNil(o.AffectedEntityReferenceList) {
		toSerialize["affected_entity_reference_list"] = o.AffectedEntityReferenceList
	}
...
func (o *AuditResources) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditResources := _AuditResources{}

	err = json.Unmarshal(data, &varAuditResources)

	if err != nil {
		return err
	}

	*o = AuditResources(varAuditResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "audit_message")
		delete(additionalProperties, "cluster_reference")
		delete(additionalProperties, "operation_parameter_list")
		delete(additionalProperties, "source_entity_reference")
		delete(additionalProperties, "operation_start_time")
		delete(additionalProperties, "initiated_user")
		delete(additionalProperties, "operation_complete_time")
		delete(additionalProperties, "operation_type")
		delete(additionalProperties, "affected_entity_reference_list")
...
type NullableAuditResources struct {
	value *AuditResources
	isSet bool
}

func (v NullableAuditResources) Get() *AuditResources {
	return v.value
}

func (v *NullableAuditResources) Set(val *AuditResources) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditResources) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditResources(val *AuditResources) *NullableAuditResources {
	return &NullableAuditResources{value: val, isSet: true}
}

func (v NullableAuditResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
