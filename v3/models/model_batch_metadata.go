...
// BatchMetadata The batch kind metadata
type BatchMetadata struct {
	...
	// Categories for the batch. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the batch. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
