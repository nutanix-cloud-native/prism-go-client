...
// checks if the RoutingPolicyIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyIntentResource{}

// RoutingPolicyIntentResource Response object for intentful operations on a routing_policy
type RoutingPolicyIntentResource struct {
	...
	Metadata RoutingPolicyMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RoutingPolicyIntentResource RoutingPolicyIntentResource
...
func NewRoutingPolicyIntentResource(metadata RoutingPolicyMetadata) *RoutingPolicyIntentResource {
	this := RoutingPolicyIntentResource{}
...
func (o *RoutingPolicyIntentResource) GetStatus() RoutingPolicyDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret RoutingPolicyDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given RoutingPolicyDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given RoutingPolicy and assigns it to the Spec field.
...
func (o RoutingPolicyIntentResource) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingPolicyIntentResource := _RoutingPolicyIntentResource{}

	err = json.Unmarshal(data, &varRoutingPolicyIntentResource)

	if err != nil {
		return err
	}

	*o = RoutingPolicyIntentResource(varRoutingPolicyIntentResource)
...
type NullableRoutingPolicyIntentResource struct {
	value *RoutingPolicyIntentResource
	isSet bool
}

func (v NullableRoutingPolicyIntentResource) Get() *RoutingPolicyIntentResource {
	return v.value
}

func (v *NullableRoutingPolicyIntentResource) Set(val *RoutingPolicyIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyIntentResource(val *RoutingPolicyIntentResource) *NullableRoutingPolicyIntentResource {
	return &NullableRoutingPolicyIntentResource{value: val, isSet: true}
}

func (v NullableRoutingPolicyIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
