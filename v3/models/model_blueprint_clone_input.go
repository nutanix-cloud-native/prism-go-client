...
// checks if the BlueprintCloneInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintCloneInput{}

// BlueprintCloneInput Clone Blueprint request.
...
type _BlueprintCloneInput BlueprintCloneInput
...
// GetBlueprintName returns the BlueprintName field value
...
// GetBlueprintNameOk returns a tuple with the BlueprintName field value
...
// SetBlueprintName sets field value
...
func (o BlueprintCloneInput) MarshalJSON() ([]byte, error) {
...
func (o BlueprintCloneInput) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintCloneInput) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintCloneInput := _BlueprintCloneInput{}

	err = json.Unmarshal(data, &varBlueprintCloneInput)

	if err != nil {
		return err
	}

	*o = BlueprintCloneInput(varBlueprintCloneInput)
...
type NullableBlueprintCloneInput struct {
	value *BlueprintCloneInput
	isSet bool
}

func (v NullableBlueprintCloneInput) Get() *BlueprintCloneInput {
	return v.value
}

func (v *NullableBlueprintCloneInput) Set(val *BlueprintCloneInput) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintCloneInput) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintCloneInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintCloneInput(val *BlueprintCloneInput) *NullableBlueprintCloneInput {
	return &NullableBlueprintCloneInput{value: val, isSet: true}
}

func (v NullableBlueprintCloneInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintCloneInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
