...
// checks if the AppTaskShareResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskShareResources{}

// AppTaskShareResources Libraty task resources definition.
type AppTaskShareResources struct {
...
type _AppTaskShareResources AppTaskShareResources
...
func (o AppTaskShareResources) MarshalJSON() ([]byte, error) {
...
func (o AppTaskShareResources) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskShareResources) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskShareResources := _AppTaskShareResources{}

	err = json.Unmarshal(data, &varAppTaskShareResources)

	if err != nil {
		return err
	}

	*o = AppTaskShareResources(varAppTaskShareResources)
...
type NullableAppTaskShareResources struct {
	value *AppTaskShareResources
	isSet bool
}

func (v NullableAppTaskShareResources) Get() *AppTaskShareResources {
	return v.value
}

func (v *NullableAppTaskShareResources) Set(val *AppTaskShareResources) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskShareResources) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskShareResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskShareResources(val *AppTaskShareResources) *NullableAppTaskShareResources {
	return &NullableAppTaskShareResources{value: val, isSet: true}
}

func (v NullableAppTaskShareResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskShareResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
