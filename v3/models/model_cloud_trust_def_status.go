...
// checks if the CloudTrustDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustDefStatus{}

// CloudTrustDefStatus Cloud Pairing status.
type CloudTrustDefStatus struct {
	// Cloud Trust name.
	Name *string `json:"name,omitempty"`
	Resources CloudTrustResponse `json:"resources"`
	// A description or user annotation for the cloud trust.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CloudTrustDefStatus CloudTrustDefStatus
...
func (o CloudTrustDefStatus) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrustDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTrustDefStatus := _CloudTrustDefStatus{}

	err = json.Unmarshal(data, &varCloudTrustDefStatus)

	if err != nil {
		return err
	}

	*o = CloudTrustDefStatus(varCloudTrustDefStatus)
...
type NullableCloudTrustDefStatus struct {
	value *CloudTrustDefStatus
	isSet bool
}

func (v NullableCloudTrustDefStatus) Get() *CloudTrustDefStatus {
	return v.value
}

func (v *NullableCloudTrustDefStatus) Set(val *CloudTrustDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustDefStatus(val *CloudTrustDefStatus) *NullableCloudTrustDefStatus {
	return &NullableCloudTrustDefStatus{value: val, isSet: true}
}

func (v NullableCloudTrustDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
