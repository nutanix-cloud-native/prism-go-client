...
// checks if the Layer2StretchResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchResources{}

// Layer2StretchResources Layer2 stretch creation spec.
type Layer2StretchResources struct {
	LocalSiteParams StretchSiteParams `json:"local_site_params"`
	RemoteSiteParams StretchSiteParams `json:"remote_site_params"`
	AdditionalProperties map[string]interface{}
}

type _Layer2StretchResources Layer2StretchResources
...
// GetLocalSiteParams returns the LocalSiteParams field value
...
// GetLocalSiteParamsOk returns a tuple with the LocalSiteParams field value
...
// SetLocalSiteParams sets field value
func (o *Layer2StretchResources) SetLocalSiteParams(v StretchSiteParams) {
	o.LocalSiteParams = v
}

// GetRemoteSiteParams returns the RemoteSiteParams field value
...
// GetRemoteSiteParamsOk returns a tuple with the RemoteSiteParams field value
// and a boolean to check if the value has been set.
...
func (o Layer2StretchResources) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchResources) UnmarshalJSON(data []byte) (err error) {
	...
	varLayer2StretchResources := _Layer2StretchResources{}

	err = json.Unmarshal(data, &varLayer2StretchResources)

	if err != nil {
		return err
	}

	*o = Layer2StretchResources(varLayer2StretchResources)
...
type NullableLayer2StretchResources struct {
	value *Layer2StretchResources
	isSet bool
}

func (v NullableLayer2StretchResources) Get() *Layer2StretchResources {
	return v.value
}

func (v *NullableLayer2StretchResources) Set(val *Layer2StretchResources) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchResources) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchResources(val *Layer2StretchResources) *NullableLayer2StretchResources {
	return &NullableLayer2StretchResources{value: val, isSet: true}
}

func (v NullableLayer2StretchResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
