...
// checks if the AwsInstanceDiskOutputStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsInstanceDiskOutputStatus{}

// AwsInstanceDiskOutputStatus AWS Instance Disk Status
type AwsInstanceDiskOutputStatus struct {
	// The status of the Volume.
	Status *string `json:"status,omitempty"`
	// Size of volumes in GB.
	SizeGb *int64 `json:"size_gb,omitempty"`
	// The zone on which the EBS volume is created
	AvailabilityZone *string `json:"availability_zone,omitempty"`
	// Type of the Volume.
	VolumeType *string `json:"volume_type,omitempty"`
	// Device name e.g. /dev/sdb
	DeviceName *string `json:"device_name,omitempty"`
	// The requested number of I/O operations per second that the volume can support for provisioned IOPS (SSD) volumes (io1). Minimum = 100 IOPS and Maximum = 20000 IOPS. 
	...
	// Status of delete on termination.
	DeleteOnTermination *bool `json:"delete_on_termination,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsInstanceDiskOutputStatus AwsInstanceDiskOutputStatus
...
func NewAwsInstanceDiskOutputStatus() *AwsInstanceDiskOutputStatus {
	this := AwsInstanceDiskOutputStatus{}
	return &this
}
...
func (o AwsInstanceDiskOutputStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsInstanceDiskOutputStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsInstanceDiskOutputStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsInstanceDiskOutputStatus := _AwsInstanceDiskOutputStatus{}

	err = json.Unmarshal(data, &varAwsInstanceDiskOutputStatus)

	if err != nil {
		return err
	}

	*o = AwsInstanceDiskOutputStatus(varAwsInstanceDiskOutputStatus)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "delete_on_termination")
...
type NullableAwsInstanceDiskOutputStatus struct {
	value *AwsInstanceDiskOutputStatus
	isSet bool
}

func (v NullableAwsInstanceDiskOutputStatus) Get() *AwsInstanceDiskOutputStatus {
	return v.value
}

func (v *NullableAwsInstanceDiskOutputStatus) Set(val *AwsInstanceDiskOutputStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsInstanceDiskOutputStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsInstanceDiskOutputStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsInstanceDiskOutputStatus(val *AwsInstanceDiskOutputStatus) *NullableAwsInstanceDiskOutputStatus {
	return &NullableAwsInstanceDiskOutputStatus{value: val, isSet: true}
}

func (v NullableAwsInstanceDiskOutputStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsInstanceDiskOutputStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
