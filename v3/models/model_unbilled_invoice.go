...
// checks if the UnbilledInvoice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnbilledInvoice{}

// UnbilledInvoice Summary of usages not yet invoiced to the user.
type UnbilledInvoice struct {
	UnpaidBalance *MonetaryValue `json:"unpaid_balance,omitempty"`
	UnbilledBalance *MonetaryValue `json:"unbilled_balance,omitempty"`
	// Summary of usage of individual billable items.
	InvoiceItemList []BillingInvoiceItem `json:"invoice_item_list,omitempty"`
	OutstandingBalance *MonetaryValue `json:"outstanding_balance,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UnbilledInvoice UnbilledInvoice
...
// GetUnpaidBalance returns the UnpaidBalance field value if set, zero value otherwise.
func (o *UnbilledInvoice) GetUnpaidBalance() MonetaryValue {
	if o == nil || IsNil(o.UnpaidBalance) {
		var ret MonetaryValue
		return ret
	}
	return *o.UnpaidBalance
}

// GetUnpaidBalanceOk returns a tuple with the UnpaidBalance field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnbilledInvoice) GetUnpaidBalanceOk() (*MonetaryValue, bool) {
	if o == nil || IsNil(o.UnpaidBalance) {
		return nil, false
	}
	return o.UnpaidBalance, true
}
...
// SetUnpaidBalance gets a reference to the given MonetaryValue and assigns it to the UnpaidBalance field.
func (o *UnbilledInvoice) SetUnpaidBalance(v MonetaryValue) {
	o.UnpaidBalance = &v
}

// GetUnbilledBalance returns the UnbilledBalance field value if set, zero value otherwise.
func (o *UnbilledInvoice) GetUnbilledBalance() MonetaryValue {
	if o == nil || IsNil(o.UnbilledBalance) {
		var ret MonetaryValue
		return ret
	}
	return *o.UnbilledBalance
}

// GetUnbilledBalanceOk returns a tuple with the UnbilledBalance field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnbilledInvoice) GetUnbilledBalanceOk() (*MonetaryValue, bool) {
	if o == nil || IsNil(o.UnbilledBalance) {
		return nil, false
	}
	return o.UnbilledBalance, true
}
...
// SetUnbilledBalance gets a reference to the given MonetaryValue and assigns it to the UnbilledBalance field.
func (o *UnbilledInvoice) SetUnbilledBalance(v MonetaryValue) {
	o.UnbilledBalance = &v
}

// GetInvoiceItemList returns the InvoiceItemList field value if set, zero value otherwise.
func (o *UnbilledInvoice) GetInvoiceItemList() []BillingInvoiceItem {
	if o == nil || IsNil(o.InvoiceItemList) {
		var ret []BillingInvoiceItem
		return ret
	}
	return o.InvoiceItemList
}

// GetInvoiceItemListOk returns a tuple with the InvoiceItemList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnbilledInvoice) GetInvoiceItemListOk() ([]BillingInvoiceItem, bool) {
	if o == nil || IsNil(o.InvoiceItemList) {
		return nil, false
	}
	return o.InvoiceItemList, true
}
...
// SetInvoiceItemList gets a reference to the given []BillingInvoiceItem and assigns it to the InvoiceItemList field.
func (o *UnbilledInvoice) SetInvoiceItemList(v []BillingInvoiceItem) {
	o.InvoiceItemList = v
}

// GetOutstandingBalance returns the OutstandingBalance field value if set, zero value otherwise.
func (o *UnbilledInvoice) GetOutstandingBalance() MonetaryValue {
	if o == nil || IsNil(o.OutstandingBalance) {
		var ret MonetaryValue
		return ret
	}
...
// GetOutstandingBalanceOk returns a tuple with the OutstandingBalance field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnbilledInvoice) GetOutstandingBalanceOk() (*MonetaryValue, bool) {
	if o == nil || IsNil(o.OutstandingBalance) {
		return nil, false
	}
	return o.OutstandingBalance, true
}
...
// SetOutstandingBalance gets a reference to the given MonetaryValue and assigns it to the OutstandingBalance field.
func (o *UnbilledInvoice) SetOutstandingBalance(v MonetaryValue) {
	o.OutstandingBalance = &v
}

func (o UnbilledInvoice) MarshalJSON() ([]byte, error) {
...
func (o UnbilledInvoice) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.UnpaidBalance) {
		toSerialize["unpaid_balance"] = o.UnpaidBalance
	}
	if !IsNil(o.UnbilledBalance) {
		toSerialize["unbilled_balance"] = o.UnbilledBalance
	}
	if !IsNil(o.InvoiceItemList) {
		toSerialize["invoice_item_list"] = o.InvoiceItemList
	}
	if !IsNil(o.OutstandingBalance) {
		toSerialize["outstanding_balance"] = o.OutstandingBalance
	}
...
func (o *UnbilledInvoice) UnmarshalJSON(data []byte) (err error) {
	varUnbilledInvoice := _UnbilledInvoice{}

	err = json.Unmarshal(data, &varUnbilledInvoice)

	if err != nil {
		return err
	}

	*o = UnbilledInvoice(varUnbilledInvoice)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "unpaid_balance")
		delete(additionalProperties, "unbilled_balance")
		delete(additionalProperties, "invoice_item_list")
		delete(additionalProperties, "outstanding_balance")
...
type NullableUnbilledInvoice struct {
	value *UnbilledInvoice
	isSet bool
}

func (v NullableUnbilledInvoice) Get() *UnbilledInvoice {
	return v.value
}

func (v *NullableUnbilledInvoice) Set(val *UnbilledInvoice) {
	v.value = val
	v.isSet = true
}

func (v NullableUnbilledInvoice) IsSet() bool {
	return v.isSet
}

func (v *NullableUnbilledInvoice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnbilledInvoice(val *UnbilledInvoice) *NullableUnbilledInvoice {
	return &NullableUnbilledInvoice{value: val, isSet: true}
}

func (v NullableUnbilledInvoice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnbilledInvoice) UnmarshalJSON(src []byte) error {
	v.isSet = true
