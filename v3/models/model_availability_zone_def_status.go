...
// checks if the AvailabilityZoneDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneDefStatus{}

// AvailabilityZoneDefStatus Availability Zone creation/modification spec
type AvailabilityZoneDefStatus struct {
	// Availability Zone Name
	Name string `json:"name"`
	Resources AvailabilityZoneResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _AvailabilityZoneDefStatus AvailabilityZoneDefStatus
...
func NewAvailabilityZoneDefStatus(name string, resources AvailabilityZoneResources) *AvailabilityZoneDefStatus {
	this := AvailabilityZoneDefStatus{}
	this.Name = name
...
func (o *AvailabilityZoneDefStatus) GetResources() AvailabilityZoneResources {
	if o == nil {
		var ret AvailabilityZoneResources
		return ret
	}
...
func (o AvailabilityZoneDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAvailabilityZoneDefStatus := _AvailabilityZoneDefStatus{}

	err = json.Unmarshal(data, &varAvailabilityZoneDefStatus)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneDefStatus(varAvailabilityZoneDefStatus)
...
type NullableAvailabilityZoneDefStatus struct {
	value *AvailabilityZoneDefStatus
	isSet bool
}

func (v NullableAvailabilityZoneDefStatus) Get() *AvailabilityZoneDefStatus {
	return v.value
}

func (v *NullableAvailabilityZoneDefStatus) Set(val *AvailabilityZoneDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneDefStatus(val *AvailabilityZoneDefStatus) *NullableAvailabilityZoneDefStatus {
	return &NullableAvailabilityZoneDefStatus{value: val, isSet: true}
}

func (v NullableAvailabilityZoneDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
