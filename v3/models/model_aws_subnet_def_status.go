...
// checks if the AwsSubnetDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSubnetDefStatus{}

// AwsSubnetDefStatus aws_subnet resources status
type AwsSubnetDefStatus struct {
	State *string `json:"state,omitempty"`
	// aws_subnet name.
	Name *string `json:"name,omitempty"`
	Resources *AwsSubnetResourcesDefStatus `json:"resources,omitempty"`
	// A description for aws_subnet.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsSubnetDefStatus AwsSubnetDefStatus
...
func (o *AwsSubnetDefStatus) GetResources() AwsSubnetResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret AwsSubnetResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given AwsSubnetResourcesDefStatus and assigns it to the Resources field.
...
func (o AwsSubnetDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsSubnetDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSubnetDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsSubnetDefStatus := _AwsSubnetDefStatus{}

	err = json.Unmarshal(data, &varAwsSubnetDefStatus)

	if err != nil {
		return err
	}

	*o = AwsSubnetDefStatus(varAwsSubnetDefStatus)
...
type NullableAwsSubnetDefStatus struct {
	value *AwsSubnetDefStatus
	isSet bool
}

func (v NullableAwsSubnetDefStatus) Get() *AwsSubnetDefStatus {
	return v.value
}

func (v *NullableAwsSubnetDefStatus) Set(val *AwsSubnetDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSubnetDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSubnetDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSubnetDefStatus(val *AwsSubnetDefStatus) *NullableAwsSubnetDefStatus {
	return &NullableAwsSubnetDefStatus{value: val, isSet: true}
}

func (v NullableAwsSubnetDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSubnetDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
