...
// checks if the AwsVmIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVmIntentResponse{}

// AwsVmIntentResponse Response object for intentful operations on a aws_vm
type AwsVmIntentResponse struct {
...
type _AwsVmIntentResponse AwsVmIntentResponse
...
func (o AwsVmIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsVmIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVmIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVmIntentResponse := _AwsVmIntentResponse{}

	err = json.Unmarshal(data, &varAwsVmIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsVmIntentResponse(varAwsVmIntentResponse)
...
type NullableAwsVmIntentResponse struct {
	value *AwsVmIntentResponse
	isSet bool
}

func (v NullableAwsVmIntentResponse) Get() *AwsVmIntentResponse {
	return v.value
}

func (v *NullableAwsVmIntentResponse) Set(val *AwsVmIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVmIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVmIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVmIntentResponse(val *AwsVmIntentResponse) *NullableAwsVmIntentResponse {
	return &NullableAwsVmIntentResponse{value: val, isSet: true}
}

func (v NullableAwsVmIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVmIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
