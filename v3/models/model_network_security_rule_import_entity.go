...
// checks if the NetworkSecurityRuleImportEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleImportEntity{}

// NetworkSecurityRuleImportEntity Network security rule import response data
type NetworkSecurityRuleImportEntity struct {
	// Type of update of the entity
	EntityUpdateType string `json:"entity_update_type"`
	// Name of the entity
...
type _NetworkSecurityRuleImportEntity NetworkSecurityRuleImportEntity
...
func NewNetworkSecurityRuleImportEntity(entityUpdateType string, entityName string, entityType string) *NetworkSecurityRuleImportEntity {
	this := NetworkSecurityRuleImportEntity{}
...
// GetEntityUpdateType returns the EntityUpdateType field value
func (o *NetworkSecurityRuleImportEntity) GetEntityUpdateType() string {
	...
	return o.EntityUpdateType
}

// GetEntityUpdateTypeOk returns a tuple with the EntityUpdateType field value
// and a boolean to check if the value has been set.
func (o *NetworkSecurityRuleImportEntity) GetEntityUpdateTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.EntityUpdateType, true
}

// SetEntityUpdateType sets field value
func (o *NetworkSecurityRuleImportEntity) SetEntityUpdateType(v string) {
	o.EntityUpdateType = v
}
...
func (o NetworkSecurityRuleImportEntity) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleImportEntity) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["entity_update_type"] = o.EntityUpdateType
...
func (o *NetworkSecurityRuleImportEntity) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkSecurityRuleImportEntity := _NetworkSecurityRuleImportEntity{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleImportEntity)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleImportEntity(varNetworkSecurityRuleImportEntity)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "entity_update_type")
...
type NullableNetworkSecurityRuleImportEntity struct {
	value *NetworkSecurityRuleImportEntity
	isSet bool
}

func (v NullableNetworkSecurityRuleImportEntity) Get() *NetworkSecurityRuleImportEntity {
	return v.value
}

func (v *NullableNetworkSecurityRuleImportEntity) Set(val *NetworkSecurityRuleImportEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleImportEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleImportEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleImportEntity(val *NetworkSecurityRuleImportEntity) *NullableNetworkSecurityRuleImportEntity {
	return &NullableNetworkSecurityRuleImportEntity{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleImportEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleImportEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
