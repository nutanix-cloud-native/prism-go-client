...
// checks if the AwsSubnetListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSubnetListMetadata{}

// AwsSubnetListMetadata All api calls that return a list will have this metadata block as input 
type AwsSubnetListMetadata struct {
	// The kind name
...
type _AwsSubnetListMetadata AwsSubnetListMetadata
...
func (o AwsSubnetListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsSubnetListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSubnetListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsSubnetListMetadata := _AwsSubnetListMetadata{}

	err = json.Unmarshal(data, &varAwsSubnetListMetadata)

	if err != nil {
		return err
	}

	*o = AwsSubnetListMetadata(varAwsSubnetListMetadata)
...
type NullableAwsSubnetListMetadata struct {
	value *AwsSubnetListMetadata
	isSet bool
}

func (v NullableAwsSubnetListMetadata) Get() *AwsSubnetListMetadata {
	return v.value
}

func (v *NullableAwsSubnetListMetadata) Set(val *AwsSubnetListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSubnetListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSubnetListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSubnetListMetadata(val *AwsSubnetListMetadata) *NullableAwsSubnetListMetadata {
	return &NullableAwsSubnetListMetadata{value: val, isSet: true}
}

func (v NullableAwsSubnetListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSubnetListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
