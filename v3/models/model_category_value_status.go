...
// checks if the CategoryValueStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryValueStatus{}

// CategoryValueStatus Category value definition.
...
type _CategoryValueStatus CategoryValueStatus
...
// SetAssignmentRule gets a reference to the given AssignmentRule and assigns it to the AssignmentRule field.
...
func (o CategoryValueStatus) MarshalJSON() ([]byte, error) {
...
func (o CategoryValueStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AssignmentRule) {
		toSerialize["assignment_rule"] = o.AssignmentRule
	}
	if !IsNil(o.Name) {
	...
	if !IsNil(o.SystemDefined) {
		toSerialize["system_defined"] = o.SystemDefined
	}
...
func (o *CategoryValueStatus) UnmarshalJSON(data []byte) (err error) {
	varCategoryValueStatus := _CategoryValueStatus{}

	err = json.Unmarshal(data, &varCategoryValueStatus)

	if err != nil {
		return err
	}

	*o = CategoryValueStatus(varCategoryValueStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "assignment_rule")
		delete(additionalProperties, "name")
		delete(additionalProperties, "value")
		delete(additionalProperties, "system_defined")
...
type NullableCategoryValueStatus struct {
	value *CategoryValueStatus
	isSet bool
}

func (v NullableCategoryValueStatus) Get() *CategoryValueStatus {
	return v.value
}

func (v *NullableCategoryValueStatus) Set(val *CategoryValueStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryValueStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryValueStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryValueStatus(val *CategoryValueStatus) *NullableCategoryValueStatus {
	return &NullableCategoryValueStatus{value: val, isSet: true}
}

func (v NullableCategoryValueStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryValueStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
