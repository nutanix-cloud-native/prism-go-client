...
// checks if the MulticlusterConfigIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MulticlusterConfigIntentResponse{}

// MulticlusterConfigIntentResponse An intentful representation of a multicluster config response.
type MulticlusterConfigIntentResponse struct {
	Status *MulticlusterConfigDefStatus `json:"status,omitempty"`
	Spec *MulticlusterConfigSpec `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata MulticlusterConfigMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _MulticlusterConfigIntentResponse MulticlusterConfigIntentResponse
...
func NewMulticlusterConfigIntentResponse(apiVersion string, metadata MulticlusterConfigMetadata) *MulticlusterConfigIntentResponse {
	this := MulticlusterConfigIntentResponse{}
...
func (o *MulticlusterConfigIntentResponse) GetStatus() MulticlusterConfigDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret MulticlusterConfigDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given MulticlusterConfigDefStatus and assigns it to the Status field.
...
func (o *MulticlusterConfigIntentResponse) GetSpec() MulticlusterConfigSpec {
	if o == nil || IsNil(o.Spec) {
		var ret MulticlusterConfigSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given MulticlusterConfigSpec and assigns it to the Spec field.
...
func (o *MulticlusterConfigIntentResponse) GetMetadata() MulticlusterConfigMetadata {
	if o == nil {
		var ret MulticlusterConfigMetadata
		return ret
	}
...
func (o MulticlusterConfigIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o MulticlusterConfigIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MulticlusterConfigIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMulticlusterConfigIntentResponse := _MulticlusterConfigIntentResponse{}

	err = json.Unmarshal(data, &varMulticlusterConfigIntentResponse)

	if err != nil {
		return err
	}

	*o = MulticlusterConfigIntentResponse(varMulticlusterConfigIntentResponse)
...
type NullableMulticlusterConfigIntentResponse struct {
	value *MulticlusterConfigIntentResponse
	isSet bool
}

func (v NullableMulticlusterConfigIntentResponse) Get() *MulticlusterConfigIntentResponse {
	return v.value
}

func (v *NullableMulticlusterConfigIntentResponse) Set(val *MulticlusterConfigIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMulticlusterConfigIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMulticlusterConfigIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMulticlusterConfigIntentResponse(val *MulticlusterConfigIntentResponse) *NullableMulticlusterConfigIntentResponse {
	return &NullableMulticlusterConfigIntentResponse{value: val, isSet: true}
}

func (v NullableMulticlusterConfigIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMulticlusterConfigIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
