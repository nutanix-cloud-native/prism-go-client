...
// checks if the BlueprintCustomIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintCustomIntentInput{}

// BlueprintCustomIntentInput An intentful representation of a blueprint
type BlueprintCustomIntentInput struct {
	Spec Blueprint `json:"spec"`
...
type _BlueprintCustomIntentInput BlueprintCustomIntentInput
...
func NewBlueprintCustomIntentInput(spec Blueprint, apiVersion string, metadata BlueprintMetadata) *BlueprintCustomIntentInput {
	this := BlueprintCustomIntentInput{}
	this.Spec = spec
...
func (o BlueprintCustomIntentInput) MarshalJSON() ([]byte, error) {
...
func (o BlueprintCustomIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintCustomIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintCustomIntentInput := _BlueprintCustomIntentInput{}

	err = json.Unmarshal(data, &varBlueprintCustomIntentInput)

	if err != nil {
		return err
	}

	*o = BlueprintCustomIntentInput(varBlueprintCustomIntentInput)
...
type NullableBlueprintCustomIntentInput struct {
	value *BlueprintCustomIntentInput
	isSet bool
}

func (v NullableBlueprintCustomIntentInput) Get() *BlueprintCustomIntentInput {
	return v.value
}

func (v *NullableBlueprintCustomIntentInput) Set(val *BlueprintCustomIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintCustomIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintCustomIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintCustomIntentInput(val *BlueprintCustomIntentInput) *NullableBlueprintCustomIntentInput {
	return &NullableBlueprintCustomIntentInput{value: val, isSet: true}
}

func (v NullableBlueprintCustomIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintCustomIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
