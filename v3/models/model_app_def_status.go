...
// checks if the AppDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppDefStatus{}

// AppDefStatus An intentful representation of a app status
type AppDefStatus struct {
	// app Name.
	Name string `json:"name"`
	// The state of the app.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the app, if in an error state.
	...
	Resources AppResourcesDefStatus `json:"resources"`
	// A description for app.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AppDefStatus AppDefStatus
...
func (o AppDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AppDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AppDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAppDefStatus := _AppDefStatus{}

	err = json.Unmarshal(data, &varAppDefStatus)

	if err != nil {
		return err
	}

	*o = AppDefStatus(varAppDefStatus)
...
type NullableAppDefStatus struct {
	value *AppDefStatus
	isSet bool
}

func (v NullableAppDefStatus) Get() *AppDefStatus {
	return v.value
}

func (v *NullableAppDefStatus) Set(val *AppDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAppDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAppDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppDefStatus(val *AppDefStatus) *NullableAppDefStatus {
	return &NullableAppDefStatus{value: val, isSet: true}
}

func (v NullableAppDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
