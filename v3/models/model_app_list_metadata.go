...
// checks if the AppListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppListMetadata{}

// AppListMetadata All api calls that return a list will have this metadata block as input 
...
type _AppListMetadata AppListMetadata
...
func (o AppListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AppListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AppListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAppListMetadata := _AppListMetadata{}

	err = json.Unmarshal(data, &varAppListMetadata)

	if err != nil {
		return err
	}

	*o = AppListMetadata(varAppListMetadata)
...
type NullableAppListMetadata struct {
	value *AppListMetadata
	isSet bool
}

func (v NullableAppListMetadata) Get() *AppListMetadata {
	return v.value
}

func (v *NullableAppListMetadata) Set(val *AppListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAppListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAppListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppListMetadata(val *AppListMetadata) *NullableAppListMetadata {
	return &NullableAppListMetadata{value: val, isSet: true}
}

func (v NullableAppListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
