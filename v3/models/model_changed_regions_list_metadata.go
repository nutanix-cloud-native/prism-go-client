...
// checks if the ChangedRegionsListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangedRegionsListMetadata{}

// ChangedRegionsListMetadata All api calls that return a list will have this metadata block as input 
...
type _ChangedRegionsListMetadata ChangedRegionsListMetadata
...
func NewChangedRegionsListMetadata() *ChangedRegionsListMetadata {
	this := ChangedRegionsListMetadata{}
...
func (o ChangedRegionsListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ChangedRegionsListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ChangedRegionsListMetadata) UnmarshalJSON(data []byte) (err error) {
	varChangedRegionsListMetadata := _ChangedRegionsListMetadata{}

	err = json.Unmarshal(data, &varChangedRegionsListMetadata)

	if err != nil {
		return err
	}

	*o = ChangedRegionsListMetadata(varChangedRegionsListMetadata)
...
type NullableChangedRegionsListMetadata struct {
	value *ChangedRegionsListMetadata
	isSet bool
}

func (v NullableChangedRegionsListMetadata) Get() *ChangedRegionsListMetadata {
	return v.value
}

func (v *NullableChangedRegionsListMetadata) Set(val *ChangedRegionsListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableChangedRegionsListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableChangedRegionsListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangedRegionsListMetadata(val *ChangedRegionsListMetadata) *NullableChangedRegionsListMetadata {
	return &NullableChangedRegionsListMetadata{value: val, isSet: true}
}

func (v NullableChangedRegionsListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangedRegionsListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
