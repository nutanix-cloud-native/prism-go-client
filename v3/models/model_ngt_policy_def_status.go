...
// checks if the NgtPolicyDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicyDefStatus{}

// NgtPolicyDefStatus NGT policy status.
type NgtPolicyDefStatus struct {
	// Ngt policy name.
	Name *string `json:"name,omitempty"`
	Resources NgtPolicyResources `json:"resources"`
	// A description or user annotation for the ngt policy.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NgtPolicyDefStatus NgtPolicyDefStatus
...
func (o NgtPolicyDefStatus) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicyDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicyDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtPolicyDefStatus := _NgtPolicyDefStatus{}

	err = json.Unmarshal(data, &varNgtPolicyDefStatus)

	if err != nil {
		return err
	}

	*o = NgtPolicyDefStatus(varNgtPolicyDefStatus)
...
type NullableNgtPolicyDefStatus struct {
	value *NgtPolicyDefStatus
	isSet bool
}

func (v NullableNgtPolicyDefStatus) Get() *NgtPolicyDefStatus {
	return v.value
}

func (v *NullableNgtPolicyDefStatus) Set(val *NgtPolicyDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicyDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicyDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicyDefStatus(val *NgtPolicyDefStatus) *NullableNgtPolicyDefStatus {
	return &NullableNgtPolicyDefStatus{value: val, isSet: true}
}

func (v NullableNgtPolicyDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicyDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
