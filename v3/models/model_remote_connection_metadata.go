...
// checks if the RemoteConnectionMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionMetadata{}

// RemoteConnectionMetadata The remote_connection kind metadata
type RemoteConnectionMetadata struct {
	...
	// Categories for the remote_connection. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the remote_connection. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _RemoteConnectionMetadata RemoteConnectionMetadata
...
func (o *RemoteConnectionMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *RemoteConnectionMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *RemoteConnectionMetadata) SetName(v string) {
	o.Name = &v
}

func (o RemoteConnectionMetadata) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteConnectionMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteConnectionMetadata := _RemoteConnectionMetadata{}

	err = json.Unmarshal(data, &varRemoteConnectionMetadata)

	if err != nil {
		return err
	}

	*o = RemoteConnectionMetadata(varRemoteConnectionMetadata)
...
type NullableRemoteConnectionMetadata struct {
	value *RemoteConnectionMetadata
	isSet bool
}

func (v NullableRemoteConnectionMetadata) Get() *RemoteConnectionMetadata {
	return v.value
}

func (v *NullableRemoteConnectionMetadata) Set(val *RemoteConnectionMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionMetadata(val *RemoteConnectionMetadata) *NullableRemoteConnectionMetadata {
	return &NullableRemoteConnectionMetadata{value: val, isSet: true}
}

func (v NullableRemoteConnectionMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
