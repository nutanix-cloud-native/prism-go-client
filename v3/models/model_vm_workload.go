...
// checks if the VmWorkload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmWorkload{}

// VmWorkload VM workload Object.
type VmWorkload struct {
	NumVms *int32 `json:"num_vms,omitempty"`
	ResourceSpec *VmResourceSpec `json:"resource_spec,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VmWorkload VmWorkload
...
// SetResourceSpec gets a reference to the given VmResourceSpec and assigns it to the ResourceSpec field.
func (o *VmWorkload) SetResourceSpec(v VmResourceSpec) {
	o.ResourceSpec = &v
}

func (o VmWorkload) MarshalJSON() ([]byte, error) {
...
func (o VmWorkload) ToMap() (map[string]interface{}, error) {
...
func (o *VmWorkload) UnmarshalJSON(data []byte) (err error) {
	varVmWorkload := _VmWorkload{}

	err = json.Unmarshal(data, &varVmWorkload)

	if err != nil {
		return err
	}

	*o = VmWorkload(varVmWorkload)
...
type NullableVmWorkload struct {
	value *VmWorkload
	isSet bool
}

func (v NullableVmWorkload) Get() *VmWorkload {
	return v.value
}

func (v *NullableVmWorkload) Set(val *VmWorkload) {
	v.value = val
	v.isSet = true
}

func (v NullableVmWorkload) IsSet() bool {
	return v.isSet
}

func (v *NullableVmWorkload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmWorkload(val *VmWorkload) *NullableVmWorkload {
	return &NullableVmWorkload{value: val, isSet: true}
}

func (v NullableVmWorkload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmWorkload) UnmarshalJSON(src []byte) error {
	v.isSet = true
