...
// checks if the ProjectIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectIntentResponse{}

// ProjectIntentResponse Response object for intentful operations on a project
...
type _ProjectIntentResponse ProjectIntentResponse
...
func (o ProjectIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ProjectIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectIntentResponse := _ProjectIntentResponse{}

	err = json.Unmarshal(data, &varProjectIntentResponse)

	if err != nil {
		return err
	}

	*o = ProjectIntentResponse(varProjectIntentResponse)
...
type NullableProjectIntentResponse struct {
	value *ProjectIntentResponse
	isSet bool
}

func (v NullableProjectIntentResponse) Get() *ProjectIntentResponse {
	return v.value
}

func (v *NullableProjectIntentResponse) Set(val *ProjectIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectIntentResponse(val *ProjectIntentResponse) *NullableProjectIntentResponse {
	return &NullableProjectIntentResponse{value: val, isSet: true}
}

func (v NullableProjectIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
