...
// checks if the DatacenterIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterIntentInput{}

// DatacenterIntentInput An intentful representation of a datacenter
type DatacenterIntentInput struct {
	Spec Datacenter `json:"spec"`
...
type _DatacenterIntentInput DatacenterIntentInput
...
func (o DatacenterIntentInput) MarshalJSON() ([]byte, error) {
...
func (o DatacenterIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *DatacenterIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varDatacenterIntentInput := _DatacenterIntentInput{}

	err = json.Unmarshal(data, &varDatacenterIntentInput)

	if err != nil {
		return err
	}

	*o = DatacenterIntentInput(varDatacenterIntentInput)
...
type NullableDatacenterIntentInput struct {
	value *DatacenterIntentInput
	isSet bool
}

func (v NullableDatacenterIntentInput) Get() *DatacenterIntentInput {
	return v.value
}

func (v *NullableDatacenterIntentInput) Set(val *DatacenterIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterIntentInput(val *DatacenterIntentInput) *NullableDatacenterIntentInput {
	return &NullableDatacenterIntentInput{value: val, isSet: true}
}

func (v NullableDatacenterIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
