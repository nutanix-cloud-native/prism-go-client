...
// checks if the NgtPolicyReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicyReference{}

// NgtPolicyReference The reference to a ngt_policy
type NgtPolicyReference struct {
	// The kind name
...
type _NgtPolicyReference NgtPolicyReference
...
func (o NgtPolicyReference) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicyReference) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicyReference) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtPolicyReference := _NgtPolicyReference{}

	err = json.Unmarshal(data, &varNgtPolicyReference)

	if err != nil {
		return err
	}

	*o = NgtPolicyReference(varNgtPolicyReference)
...
type NullableNgtPolicyReference struct {
	value *NgtPolicyReference
	isSet bool
}

func (v NullableNgtPolicyReference) Get() *NgtPolicyReference {
	return v.value
}

func (v *NullableNgtPolicyReference) Set(val *NgtPolicyReference) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicyReference) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicyReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicyReference(val *NgtPolicyReference) *NullableNgtPolicyReference {
	return &NullableNgtPolicyReference{value: val, isSet: true}
}

func (v NullableNgtPolicyReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicyReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
