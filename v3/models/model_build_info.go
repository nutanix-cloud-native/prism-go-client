...
// GetFullVersion returns the FullVersion field value if set, zero value otherwise.
func (o *BuildInfo) GetFullVersion() string {
	if o == nil || IsNil(o.FullVersion) {
		var ret string
		return ret
	}
...
// SetFullVersion gets a reference to the given string and assigns it to the FullVersion field.
...
// GetIsLongTermSupport returns the IsLongTermSupport field value if set, zero value otherwise.
func (o *BuildInfo) GetIsLongTermSupport() bool {
	if o == nil || IsNil(o.IsLongTermSupport) {
		var ret bool
		return ret
	}
	return *o.IsLongTermSupport
}

// GetIsLongTermSupportOk returns a tuple with the IsLongTermSupport field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BuildInfo) GetIsLongTermSupportOk() (*bool, bool) {
	if o == nil || IsNil(o.IsLongTermSupport) {
		return nil, false
	}
	return o.IsLongTermSupport, true
}
...
// SetIsLongTermSupport gets a reference to the given bool and assigns it to the IsLongTermSupport field.
func (o *BuildInfo) SetIsLongTermSupport(v bool) {
	o.IsLongTermSupport = &v
}
...
// GetShortCommitId returns the ShortCommitId field value
func (o *BuildInfo) GetShortCommitId() string {
	...
	return o.ShortCommitId
}

// GetShortCommitIdOk returns a tuple with the ShortCommitId field value
// and a boolean to check if the value has been set.
func (o *BuildInfo) GetShortCommitIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ShortCommitId, true
}

// SetShortCommitId sets field value
...
func (o BuildInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FullVersion) {
		toSerialize["full_version"] = o.FullVersion
	}
	if !IsNil(o.CommitDate) {
		toSerialize["commit_date"] = o.CommitDate
	}
	if !IsNil(o.IsLongTermSupport) {
		toSerialize["is_long_term_support"] = o.IsLongTermSupport
	}
	toSerialize["version"] = o.Version
	toSerialize["short_commit_id"] = o.ShortCommitId
...
func (o *BuildInfo) UnmarshalJSON(data []byte) (err error) {
	...
	*o = BuildInfo(varBuildInfo)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "full_version")
		delete(additionalProperties, "commit_date")
		delete(additionalProperties, "is_long_term_support")
		delete(additionalProperties, "version")
		delete(additionalProperties, "short_commit_id")
		delete(additionalProperties, "build_type")
