...
// checks if the ActionTriggerTypeIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTriggerTypeIntentResource{}

// ActionTriggerTypeIntentResource Response object for intentful operations on a action_trigger_type
type ActionTriggerTypeIntentResource struct {
	Status *ActionTriggerTypeDefStatus `json:"status,omitempty"`
	Spec *ActionTriggerType `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata ActionTriggerTypeMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ActionTriggerTypeIntentResource ActionTriggerTypeIntentResource

// NewActionTriggerTypeIntentResource instantiates a new ActionTriggerTypeIntentResource object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewActionTriggerTypeIntentResource(metadata ActionTriggerTypeMetadata) *ActionTriggerTypeIntentResource {
	this := ActionTriggerTypeIntentResource{}
	this.Metadata = metadata
	return &this
}

// NewActionTriggerTypeIntentResourceWithDefaults instantiates a new ActionTriggerTypeIntentResource object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActionTriggerTypeIntentResourceWithDefaults() *ActionTriggerTypeIntentResource {
	this := ActionTriggerTypeIntentResource{}
	return &this
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *ActionTriggerTypeIntentResource) GetStatus() ActionTriggerTypeDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret ActionTriggerTypeDefStatus
		return ret
	}
	return *o.Status
}
...
func (o *ActionTriggerTypeIntentResource) GetStatusOk() (*ActionTriggerTypeDefStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *ActionTriggerTypeIntentResource) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
// SetStatus gets a reference to the given ActionTriggerTypeDefStatus and assigns it to the Status field.
func (o *ActionTriggerTypeIntentResource) SetStatus(v ActionTriggerTypeDefStatus) {
	o.Status = &v
}

// GetSpec returns the Spec field value if set, zero value otherwise.
func (o *ActionTriggerTypeIntentResource) GetSpec() ActionTriggerType {
	if o == nil || IsNil(o.Spec) {
		var ret ActionTriggerType
		return ret
	}
	return *o.Spec
}
...
// and a boolean to check if the value has been set.
func (o *ActionTriggerTypeIntentResource) GetSpecOk() (*ActionTriggerType, bool) {
	if o == nil || IsNil(o.Spec) {
		return nil, false
	}
	return o.Spec, true
...
func (o *ActionTriggerTypeIntentResource) HasSpec() bool {
	if o != nil && !IsNil(o.Spec) {
		return true
	}
...
// SetSpec gets a reference to the given ActionTriggerType and assigns it to the Spec field.
func (o *ActionTriggerTypeIntentResource) SetSpec(v ActionTriggerType) {
	o.Spec = &v
}

// GetApiVersion returns the ApiVersion field value if set, zero value otherwise.
func (o *ActionTriggerTypeIntentResource) GetApiVersion() string {
...
// and a boolean to check if the value has been set.
func (o *ActionTriggerTypeIntentResource) GetApiVersionOk() (*string, bool) {
	if o == nil || IsNil(o.ApiVersion) {
		return nil, false
	}
...
func (o *ActionTriggerTypeIntentResource) HasApiVersion() bool {
	if o != nil && !IsNil(o.ApiVersion) {
		return true
	}
...
func (o *ActionTriggerTypeIntentResource) SetApiVersion(v string) {
	o.ApiVersion = &v
}

// GetMetadata returns the Metadata field value
func (o *ActionTriggerTypeIntentResource) GetMetadata() ActionTriggerTypeMetadata {
	if o == nil {
		var ret ActionTriggerTypeMetadata
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ActionTriggerTypeIntentResource) GetMetadataOk() (*ActionTriggerTypeMetadata, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ActionTriggerTypeIntentResource) SetMetadata(v ActionTriggerTypeMetadata) {
	o.Metadata = v
}

func (o ActionTriggerTypeIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ActionTriggerTypeIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTriggerTypeIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTriggerTypeIntentResource := _ActionTriggerTypeIntentResource{}

	err = json.Unmarshal(data, &varActionTriggerTypeIntentResource)

	if err != nil {
		return err
	}

	*o = ActionTriggerTypeIntentResource(varActionTriggerTypeIntentResource)
...
type NullableActionTriggerTypeIntentResource struct {
	value *ActionTriggerTypeIntentResource
	isSet bool
}

func (v NullableActionTriggerTypeIntentResource) Get() *ActionTriggerTypeIntentResource {
	return v.value
}

func (v *NullableActionTriggerTypeIntentResource) Set(val *ActionTriggerTypeIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTriggerTypeIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTriggerTypeIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTriggerTypeIntentResource(val *ActionTriggerTypeIntentResource) *NullableActionTriggerTypeIntentResource {
	return &NullableActionTriggerTypeIntentResource{value: val, isSet: true}
}

func (v NullableActionTriggerTypeIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTriggerTypeIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
