...
// checks if the UnderlaySubnetListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnetListMetadataOutput{}

// UnderlaySubnetListMetadataOutput All api calls that return a list will have this metadata block 
type UnderlaySubnetListMetadataOutput struct {
	// The kind name
...
type _UnderlaySubnetListMetadataOutput UnderlaySubnetListMetadataOutput
...
func NewUnderlaySubnetListMetadataOutput() *UnderlaySubnetListMetadataOutput {
	this := UnderlaySubnetListMetadataOutput{}
	var kind string = "underlay_subnet"
	this.Kind = &kind
	return &this
}
...
func (o UnderlaySubnetListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnetListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *UnderlaySubnetListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varUnderlaySubnetListMetadataOutput := _UnderlaySubnetListMetadataOutput{}

	err = json.Unmarshal(data, &varUnderlaySubnetListMetadataOutput)

	if err != nil {
		return err
	}

	*o = UnderlaySubnetListMetadataOutput(varUnderlaySubnetListMetadataOutput)
...
type NullableUnderlaySubnetListMetadataOutput struct {
	value *UnderlaySubnetListMetadataOutput
	isSet bool
}

func (v NullableUnderlaySubnetListMetadataOutput) Get() *UnderlaySubnetListMetadataOutput {
	return v.value
}

func (v *NullableUnderlaySubnetListMetadataOutput) Set(val *UnderlaySubnetListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnetListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnetListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnetListMetadataOutput(val *UnderlaySubnetListMetadataOutput) *NullableUnderlaySubnetListMetadataOutput {
	return &NullableUnderlaySubnetListMetadataOutput{value: val, isSet: true}
}

func (v NullableUnderlaySubnetListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnetListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
