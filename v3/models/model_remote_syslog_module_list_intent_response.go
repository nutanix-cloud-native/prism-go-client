...
// checks if the RemoteSyslogModuleListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogModuleListIntentResponse{}

// RemoteSyslogModuleListIntentResponse Response object for intentful operation of remote_syslog_modules
type RemoteSyslogModuleListIntentResponse struct {
	Entities []RemoteSyslogModuleIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata RemoteSyslogModuleListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RemoteSyslogModuleListIntentResponse RemoteSyslogModuleListIntentResponse
...
func NewRemoteSyslogModuleListIntentResponse(apiVersion string, metadata RemoteSyslogModuleListMetadataOutput) *RemoteSyslogModuleListIntentResponse {
	this := RemoteSyslogModuleListIntentResponse{}
...
func (o *RemoteSyslogModuleListIntentResponse) GetEntities() []RemoteSyslogModuleIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []RemoteSyslogModuleIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []RemoteSyslogModuleIntentResource and assigns it to the Entities field.
...
func (o *RemoteSyslogModuleListIntentResponse) GetMetadata() RemoteSyslogModuleListMetadataOutput {
	if o == nil {
		var ret RemoteSyslogModuleListMetadataOutput
		return ret
	}
...
func (o RemoteSyslogModuleListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogModuleListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogModuleListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogModuleListIntentResponse := _RemoteSyslogModuleListIntentResponse{}

	err = json.Unmarshal(data, &varRemoteSyslogModuleListIntentResponse)

	if err != nil {
		return err
	}

	*o = RemoteSyslogModuleListIntentResponse(varRemoteSyslogModuleListIntentResponse)
...
type NullableRemoteSyslogModuleListIntentResponse struct {
	value *RemoteSyslogModuleListIntentResponse
	isSet bool
}

func (v NullableRemoteSyslogModuleListIntentResponse) Get() *RemoteSyslogModuleListIntentResponse {
	return v.value
}

func (v *NullableRemoteSyslogModuleListIntentResponse) Set(val *RemoteSyslogModuleListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogModuleListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogModuleListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogModuleListIntentResponse(val *RemoteSyslogModuleListIntentResponse) *NullableRemoteSyslogModuleListIntentResponse {
	return &NullableRemoteSyslogModuleListIntentResponse{value: val, isSet: true}
}

func (v NullableRemoteSyslogModuleListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogModuleListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
