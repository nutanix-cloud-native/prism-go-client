...
// checks if the ProtectionPolicyState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionPolicyState{}

// ProtectionPolicyState State of enforced policy on an entity.
type ProtectionPolicyState struct {
	PolicyReference Reference `json:"policy_reference"`
	PolicyInfo *ProtectionInfo `json:"policy_info,omitempty"`
...
type _ProtectionPolicyState ProtectionPolicyState
...
// SetPolicyInfo gets a reference to the given ProtectionInfo and assigns it to the PolicyInfo field.
...
func (o ProtectionPolicyState) MarshalJSON() ([]byte, error) {
...
func (o ProtectionPolicyState) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionPolicyState) UnmarshalJSON(data []byte) (err error) {
	...
	varProtectionPolicyState := _ProtectionPolicyState{}

	err = json.Unmarshal(data, &varProtectionPolicyState)

	if err != nil {
		return err
	}

	*o = ProtectionPolicyState(varProtectionPolicyState)
...
type NullableProtectionPolicyState struct {
	value *ProtectionPolicyState
	isSet bool
}

func (v NullableProtectionPolicyState) Get() *ProtectionPolicyState {
	return v.value
}

func (v *NullableProtectionPolicyState) Set(val *ProtectionPolicyState) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionPolicyState) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionPolicyState) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionPolicyState(val *ProtectionPolicyState) *NullableProtectionPolicyState {
	return &NullableProtectionPolicyState{value: val, isSet: true}
}

func (v NullableProtectionPolicyState) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionPolicyState) UnmarshalJSON(src []byte) error {
	v.isSet = true
