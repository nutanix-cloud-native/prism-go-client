...
// checks if the VpcIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcIntentResource{}

// VpcIntentResource Response object for intentful operations on a vpc
type VpcIntentResource struct {
...
type _VpcIntentResource VpcIntentResource
...
// SetStatus gets a reference to the given VpcDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Vpc and assigns it to the Spec field.
...
func (o VpcIntentResource) MarshalJSON() ([]byte, error) {
...
func (o VpcIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *VpcIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varVpcIntentResource := _VpcIntentResource{}

	err = json.Unmarshal(data, &varVpcIntentResource)

	if err != nil {
		return err
	}

	*o = VpcIntentResource(varVpcIntentResource)
...
type NullableVpcIntentResource struct {
	value *VpcIntentResource
	isSet bool
}

func (v NullableVpcIntentResource) Get() *VpcIntentResource {
	return v.value
}

func (v *NullableVpcIntentResource) Set(val *VpcIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcIntentResource(val *VpcIntentResource) *NullableVpcIntentResource {
	return &NullableVpcIntentResource{value: val, isSet: true}
}

func (v NullableVpcIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
