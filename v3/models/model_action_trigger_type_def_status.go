...
// checks if the ActionTriggerTypeDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTriggerTypeDefStatus{}

// ActionTriggerTypeDefStatus Action trigger type entity status definition
type ActionTriggerTypeDefStatus struct {
	// The state of the entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	Resources ActionTriggerType `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _ActionTriggerTypeDefStatus ActionTriggerTypeDefStatus
...
func NewActionTriggerTypeDefStatus(resources ActionTriggerType) *ActionTriggerTypeDefStatus {
	this := ActionTriggerTypeDefStatus{}
...
func (o ActionTriggerTypeDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ActionTriggerTypeDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTriggerTypeDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTriggerTypeDefStatus := _ActionTriggerTypeDefStatus{}

	err = json.Unmarshal(data, &varActionTriggerTypeDefStatus)

	if err != nil {
		return err
	}

	*o = ActionTriggerTypeDefStatus(varActionTriggerTypeDefStatus)
...
type NullableActionTriggerTypeDefStatus struct {
	value *ActionTriggerTypeDefStatus
	isSet bool
}

func (v NullableActionTriggerTypeDefStatus) Get() *ActionTriggerTypeDefStatus {
	return v.value
}

func (v *NullableActionTriggerTypeDefStatus) Set(val *ActionTriggerTypeDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTriggerTypeDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTriggerTypeDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTriggerTypeDefStatus(val *ActionTriggerTypeDefStatus) *NullableActionTriggerTypeDefStatus {
	return &NullableActionTriggerTypeDefStatus{value: val, isSet: true}
}

func (v NullableActionTriggerTypeDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTriggerTypeDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
