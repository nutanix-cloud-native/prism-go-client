...
// checks if the VmDiskDataSourceReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDiskDataSourceReference{}

// VmDiskDataSourceReference struct for VmDiskDataSourceReference
...
type _VmDiskDataSourceReference VmDiskDataSourceReference
...
func NewVmDiskDataSourceReference() *VmDiskDataSourceReference {
	this := VmDiskDataSourceReference{}
	return &this
}
...
func (o VmDiskDataSourceReference) MarshalJSON() ([]byte, error) {
...
func (o VmDiskDataSourceReference) ToMap() (map[string]interface{}, error) {
...
func (o *VmDiskDataSourceReference) UnmarshalJSON(data []byte) (err error) {
	varVmDiskDataSourceReference := _VmDiskDataSourceReference{}

	err = json.Unmarshal(data, &varVmDiskDataSourceReference)

	if err != nil {
		return err
	}

	*o = VmDiskDataSourceReference(varVmDiskDataSourceReference)
...
type NullableVmDiskDataSourceReference struct {
	value *VmDiskDataSourceReference
	isSet bool
}

func (v NullableVmDiskDataSourceReference) Get() *VmDiskDataSourceReference {
	return v.value
}

func (v *NullableVmDiskDataSourceReference) Set(val *VmDiskDataSourceReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVmDiskDataSourceReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVmDiskDataSourceReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmDiskDataSourceReference(val *VmDiskDataSourceReference) *NullableVmDiskDataSourceReference {
	return &NullableVmDiskDataSourceReference{value: val, isSet: true}
}

func (v NullableVmDiskDataSourceReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmDiskDataSourceReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
