...
// FileItem An intentful representation of a file_item spec
type FileItem struct {
	...
	Resources FileItemResources `json:"resources"`
...
func (o *FileItem) UnmarshalJSON(data []byte) (err error) {
	...
	varFileItem := _FileItem{}

	err = json.Unmarshal(data, &varFileItem)

	if err != nil {
		return err
	}

	*o = FileItem(varFileItem)
