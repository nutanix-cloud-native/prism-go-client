...
type Workload struct {
	AdjustedWorkload *AdjustedWorkload `json:"adjusted_workload,omitempty"`
	SqlWorkload *SqlWorkload `json:"sql_workload,omitempty"`
	// Workload name.
	WorkloadName *string `json:"workload_name,omitempty"`
	ExchangeWorkload *ExchangeWorkload `json:"exchange_workload,omitempty"`
	// The variable to indicated if the workload is used as removed workload.
	ToRemove *bool `json:"to_remove,omitempty"`
	// The variable to indicate if the workload is enabled.
	Enabled *bool `json:"enabled,omitempty"`
	SplunkWorkload *SplunkWorkload `json:"splunk_workload,omitempty"`
	VdiWorkload *VdiWorkload `json:"vdi_workload,omitempty"`
	VmWorkload *VmWorkload `json:"vm_workload,omitempty"`
	// The type of workload.
	WorkloadType *string `json:"workload_type,omitempty"`
	ResourceRequirement *GenericResourceSpec `json:"resource_requirement,omitempty"`
	// The scheduled timestamp in seconds.
	ScheduleTimestampSec *int32 `json:"schedule_timestamp_sec,omitempty"`
	XenWorkload *XenWorkload `json:"xen_workload,omitempty"`
	VirtualServerWorkload *VirtualServerWorkload `json:"virtual_server_workload,omitempty"`
	VmCategoryWorkload *VmCategoryWorkload `json:"vm_category_workload,omitempty"`
...
// GetAdjustedWorkload returns the AdjustedWorkload field value if set, zero value otherwise.
func (o *Workload) GetAdjustedWorkload() AdjustedWorkload {
	if o == nil || IsNil(o.AdjustedWorkload) {
		var ret AdjustedWorkload
		return ret
	}
	return *o.AdjustedWorkload
}

// GetAdjustedWorkloadOk returns a tuple with the AdjustedWorkload field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetAdjustedWorkloadOk() (*AdjustedWorkload, bool) {
	if o == nil || IsNil(o.AdjustedWorkload) {
		return nil, false
	}
	return o.AdjustedWorkload, true
}
...
// SetAdjustedWorkload gets a reference to the given AdjustedWorkload and assigns it to the AdjustedWorkload field.
func (o *Workload) SetAdjustedWorkload(v AdjustedWorkload) {
	o.AdjustedWorkload = &v
}

// GetSqlWorkload returns the SqlWorkload field value if set, zero value otherwise.
func (o *Workload) GetSqlWorkload() SqlWorkload {
	if o == nil || IsNil(o.SqlWorkload) {
		var ret SqlWorkload
		return ret
	}
	return *o.SqlWorkload
}

// GetSqlWorkloadOk returns a tuple with the SqlWorkload field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetSqlWorkloadOk() (*SqlWorkload, bool) {
	if o == nil || IsNil(o.SqlWorkload) {
		return nil, false
	}
	return o.SqlWorkload, true
}
...
// SetSqlWorkload gets a reference to the given SqlWorkload and assigns it to the SqlWorkload field.
...
// GetExchangeWorkload returns the ExchangeWorkload field value if set, zero value otherwise.
func (o *Workload) GetExchangeWorkload() ExchangeWorkload {
	if o == nil || IsNil(o.ExchangeWorkload) {
		var ret ExchangeWorkload
		return ret
	}
	return *o.ExchangeWorkload
}

// GetExchangeWorkloadOk returns a tuple with the ExchangeWorkload field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetExchangeWorkloadOk() (*ExchangeWorkload, bool) {
	if o == nil || IsNil(o.ExchangeWorkload) {
		return nil, false
	}
	return o.ExchangeWorkload, true
}
...
// SetExchangeWorkload gets a reference to the given ExchangeWorkload and assigns it to the ExchangeWorkload field.
func (o *Workload) SetExchangeWorkload(v ExchangeWorkload) {
	o.ExchangeWorkload = &v
}

// GetToRemove returns the ToRemove field value if set, zero value otherwise.
func (o *Workload) GetToRemove() bool {
	if o == nil || IsNil(o.ToRemove) {
		var ret bool
		return ret
	}
	return *o.ToRemove
...
// GetToRemoveOk returns a tuple with the ToRemove field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetToRemoveOk() (*bool, bool) {
	if o == nil || IsNil(o.ToRemove) {
		return nil, false
	}
	return o.ToRemove, true
}
...
// SetToRemove gets a reference to the given bool and assigns it to the ToRemove field.
...
// GetSplunkWorkload returns the SplunkWorkload field value if set, zero value otherwise.
func (o *Workload) GetSplunkWorkload() SplunkWorkload {
	if o == nil || IsNil(o.SplunkWorkload) {
		var ret SplunkWorkload
		return ret
	}
	return *o.SplunkWorkload
}

// GetSplunkWorkloadOk returns a tuple with the SplunkWorkload field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetSplunkWorkloadOk() (*SplunkWorkload, bool) {
	if o == nil || IsNil(o.SplunkWorkload) {
		return nil, false
	}
	return o.SplunkWorkload, true
}
...
// SetSplunkWorkload gets a reference to the given SplunkWorkload and assigns it to the SplunkWorkload field.
func (o *Workload) SetSplunkWorkload(v SplunkWorkload) {
	o.SplunkWorkload = &v
}

// GetVdiWorkload returns the VdiWorkload field value if set, zero value otherwise.
func (o *Workload) GetVdiWorkload() VdiWorkload {
	if o == nil || IsNil(o.VdiWorkload) {
		var ret VdiWorkload
		return ret
	}
	return *o.VdiWorkload
}

// GetVdiWorkloadOk returns a tuple with the VdiWorkload field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetVdiWorkloadOk() (*VdiWorkload, bool) {
	if o == nil || IsNil(o.VdiWorkload) {
		return nil, false
	}
	return o.VdiWorkload, true
}
...
// SetVdiWorkload gets a reference to the given VdiWorkload and assigns it to the VdiWorkload field.
func (o *Workload) SetVdiWorkload(v VdiWorkload) {
	o.VdiWorkload = &v
}

// GetVmWorkload returns the VmWorkload field value if set, zero value otherwise.
func (o *Workload) GetVmWorkload() VmWorkload {
	if o == nil || IsNil(o.VmWorkload) {
		var ret VmWorkload
		return ret
	}
	return *o.VmWorkload
...
// GetVmWorkloadOk returns a tuple with the VmWorkload field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetVmWorkloadOk() (*VmWorkload, bool) {
	if o == nil || IsNil(o.VmWorkload) {
		return nil, false
	}
	return o.VmWorkload, true
}
...
// SetVmWorkload gets a reference to the given VmWorkload and assigns it to the VmWorkload field.
...
// GetResourceRequirement returns the ResourceRequirement field value if set, zero value otherwise.
func (o *Workload) GetResourceRequirement() GenericResourceSpec {
	if o == nil || IsNil(o.ResourceRequirement) {
		var ret GenericResourceSpec
		return ret
	}
	return *o.ResourceRequirement
}

// GetResourceRequirementOk returns a tuple with the ResourceRequirement field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetResourceRequirementOk() (*GenericResourceSpec, bool) {
	if o == nil || IsNil(o.ResourceRequirement) {
		return nil, false
	}
	return o.ResourceRequirement, true
}
...
// SetResourceRequirement gets a reference to the given GenericResourceSpec and assigns it to the ResourceRequirement field.
func (o *Workload) SetResourceRequirement(v GenericResourceSpec) {
	o.ResourceRequirement = &v
}

// GetScheduleTimestampSec returns the ScheduleTimestampSec field value if set, zero value otherwise.
func (o *Workload) GetScheduleTimestampSec() int32 {
	if o == nil || IsNil(o.ScheduleTimestampSec) {
		var ret int32
		return ret
	}
	return *o.ScheduleTimestampSec
}

// GetScheduleTimestampSecOk returns a tuple with the ScheduleTimestampSec field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetScheduleTimestampSecOk() (*int32, bool) {
	if o == nil || IsNil(o.ScheduleTimestampSec) {
		return nil, false
	}
	return o.ScheduleTimestampSec, true
}
...
// SetScheduleTimestampSec gets a reference to the given int32 and assigns it to the ScheduleTimestampSec field.
func (o *Workload) SetScheduleTimestampSec(v int32) {
	o.ScheduleTimestampSec = &v
}

// GetXenWorkload returns the XenWorkload field value if set, zero value otherwise.
func (o *Workload) GetXenWorkload() XenWorkload {
	if o == nil || IsNil(o.XenWorkload) {
		var ret XenWorkload
		return ret
	}
	return *o.XenWorkload
}

// GetXenWorkloadOk returns a tuple with the XenWorkload field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetXenWorkloadOk() (*XenWorkload, bool) {
	if o == nil || IsNil(o.XenWorkload) {
		return nil, false
	}
	return o.XenWorkload, true
}
...
// SetXenWorkload gets a reference to the given XenWorkload and assigns it to the XenWorkload field.
func (o *Workload) SetXenWorkload(v XenWorkload) {
	o.XenWorkload = &v
}

// GetVirtualServerWorkload returns the VirtualServerWorkload field value if set, zero value otherwise.
func (o *Workload) GetVirtualServerWorkload() VirtualServerWorkload {
	if o == nil || IsNil(o.VirtualServerWorkload) {
		var ret VirtualServerWorkload
		return ret
	}
	return *o.VirtualServerWorkload
}

// GetVirtualServerWorkloadOk returns a tuple with the VirtualServerWorkload field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetVirtualServerWorkloadOk() (*VirtualServerWorkload, bool) {
	if o == nil || IsNil(o.VirtualServerWorkload) {
		return nil, false
	}
	return o.VirtualServerWorkload, true
}
...
// SetVirtualServerWorkload gets a reference to the given VirtualServerWorkload and assigns it to the VirtualServerWorkload field.
func (o *Workload) SetVirtualServerWorkload(v VirtualServerWorkload) {
	o.VirtualServerWorkload = &v
}

// GetVmCategoryWorkload returns the VmCategoryWorkload field value if set, zero value otherwise.
func (o *Workload) GetVmCategoryWorkload() VmCategoryWorkload {
	if o == nil || IsNil(o.VmCategoryWorkload) {
		var ret VmCategoryWorkload
		return ret
	}
	return *o.VmCategoryWorkload
}

// GetVmCategoryWorkloadOk returns a tuple with the VmCategoryWorkload field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workload) GetVmCategoryWorkloadOk() (*VmCategoryWorkload, bool) {
	if o == nil || IsNil(o.VmCategoryWorkload) {
		return nil, false
	}
	return o.VmCategoryWorkload, true
}
...
// SetVmCategoryWorkload gets a reference to the given VmCategoryWorkload and assigns it to the VmCategoryWorkload field.
func (o *Workload) SetVmCategoryWorkload(v VmCategoryWorkload) {
	o.VmCategoryWorkload = &v
}
...
func (o Workload) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AdjustedWorkload) {
		toSerialize["adjusted_workload"] = o.AdjustedWorkload
	}
	if !IsNil(o.SqlWorkload) {
		toSerialize["sql_workload"] = o.SqlWorkload
	}
	if !IsNil(o.WorkloadName) {
		toSerialize["workload_name"] = o.WorkloadName
	}
	if !IsNil(o.ExchangeWorkload) {
		toSerialize["exchange_workload"] = o.ExchangeWorkload
	}
	if !IsNil(o.ToRemove) {
		toSerialize["to_remove"] = o.ToRemove
	}
	if !IsNil(o.Enabled) {
		toSerialize["enabled"] = o.Enabled
	}
	if !IsNil(o.SplunkWorkload) {
		toSerialize["splunk_workload"] = o.SplunkWorkload
	}
	if !IsNil(o.VdiWorkload) {
		toSerialize["vdi_workload"] = o.VdiWorkload
	}
	if !IsNil(o.VmWorkload) {
		toSerialize["vm_workload"] = o.VmWorkload
	}
	if !IsNil(o.WorkloadType) {
		toSerialize["workload_type"] = o.WorkloadType
	}
	if !IsNil(o.ResourceRequirement) {
		toSerialize["resource_requirement"] = o.ResourceRequirement
	}
	if !IsNil(o.ScheduleTimestampSec) {
		toSerialize["schedule_timestamp_sec"] = o.ScheduleTimestampSec
	}
	if !IsNil(o.XenWorkload) {
		toSerialize["xen_workload"] = o.XenWorkload
	}
	if !IsNil(o.VirtualServerWorkload) {
		toSerialize["virtual_server_workload"] = o.VirtualServerWorkload
	}
	if !IsNil(o.VmCategoryWorkload) {
		toSerialize["vm_category_workload"] = o.VmCategoryWorkload
	}
...
func (o *Workload) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkload)
	...
	*o = Workload(varWorkload)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "adjusted_workload")
		delete(additionalProperties, "sql_workload")
		delete(additionalProperties, "workload_name")
		delete(additionalProperties, "exchange_workload")
		delete(additionalProperties, "to_remove")
		delete(additionalProperties, "enabled")
		delete(additionalProperties, "splunk_workload")
		delete(additionalProperties, "vdi_workload")
		delete(additionalProperties, "vm_workload")
		delete(additionalProperties, "workload_type")
		delete(additionalProperties, "resource_requirement")
		delete(additionalProperties, "schedule_timestamp_sec")
		delete(additionalProperties, "xen_workload")
		delete(additionalProperties, "virtual_server_workload")
		delete(additionalProperties, "vm_category_workload")
