...
// checks if the InternalOpenLdapConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InternalOpenLdapConfig{}

// InternalOpenLdapConfig Internal OpenLdap config
type InternalOpenLdapConfig struct {
	...
	GroupMemberAttributeValue *string `json:"group_member_attribute_value,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _InternalOpenLdapConfig InternalOpenLdapConfig
...
// GetUserSearchBase returns the UserSearchBase field value if set, zero value otherwise.
func (o *InternalOpenLdapConfig) GetUserSearchBase() string {
	if o == nil || IsNil(o.UserSearchBase) {
		var ret string
		return ret
	}
	return *o.UserSearchBase
}

// GetUserSearchBaseOk returns a tuple with the UserSearchBase field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InternalOpenLdapConfig) GetUserSearchBaseOk() (*string, bool) {
	if o == nil || IsNil(o.UserSearchBase) {
		return nil, false
	}
	return o.UserSearchBase, true
}
...
// SetUserSearchBase gets a reference to the given string and assigns it to the UserSearchBase field.
func (o *InternalOpenLdapConfig) SetUserSearchBase(v string) {
	o.UserSearchBase = &v
}

// GetGroupMemberAttributeValue returns the GroupMemberAttributeValue field value if set, zero value otherwise.
func (o *InternalOpenLdapConfig) GetGroupMemberAttributeValue() string {
	if o == nil || IsNil(o.GroupMemberAttributeValue) {
		var ret string
		return ret
	}
...
// GetGroupMemberAttributeValueOk returns a tuple with the GroupMemberAttributeValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetGroupMemberAttributeValue gets a reference to the given string and assigns it to the GroupMemberAttributeValue field.
func (o *InternalOpenLdapConfig) SetGroupMemberAttributeValue(v string) {
	o.GroupMemberAttributeValue = &v
}

func (o InternalOpenLdapConfig) MarshalJSON() ([]byte, error) {
...
func (o InternalOpenLdapConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UserSearchBase) {
		toSerialize["user_search_base"] = o.UserSearchBase
	}
	if !IsNil(o.GroupMemberAttributeValue) {
...
func (o *InternalOpenLdapConfig) UnmarshalJSON(data []byte) (err error) {
	varInternalOpenLdapConfig := _InternalOpenLdapConfig{}

	err = json.Unmarshal(data, &varInternalOpenLdapConfig)

	if err != nil {
		return err
	}

	*o = InternalOpenLdapConfig(varInternalOpenLdapConfig)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "user_object_class")
		delete(additionalProperties, "username_attribute")
		delete(additionalProperties, "user_search_base")
...
type NullableInternalOpenLdapConfig struct {
	value *InternalOpenLdapConfig
	isSet bool
}

func (v NullableInternalOpenLdapConfig) Get() *InternalOpenLdapConfig {
	return v.value
}

func (v *NullableInternalOpenLdapConfig) Set(val *InternalOpenLdapConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableInternalOpenLdapConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableInternalOpenLdapConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInternalOpenLdapConfig(val *InternalOpenLdapConfig) *NullableInternalOpenLdapConfig {
	return &NullableInternalOpenLdapConfig{value: val, isSet: true}
}

func (v NullableInternalOpenLdapConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInternalOpenLdapConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
