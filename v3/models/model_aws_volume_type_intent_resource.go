...
// checks if the AwsVolumeTypeIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVolumeTypeIntentResource{}

// AwsVolumeTypeIntentResource aws_volume_type entity
type AwsVolumeTypeIntentResource struct {
	Status *AwsVolumeTypeDefStatus `json:"status,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsVolumeTypeMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsVolumeTypeIntentResource AwsVolumeTypeIntentResource
...
func NewAwsVolumeTypeIntentResource(apiVersion string, metadata AwsVolumeTypeMetadata) *AwsVolumeTypeIntentResource {
	this := AwsVolumeTypeIntentResource{}
...
func (o *AwsVolumeTypeIntentResource) GetStatus() AwsVolumeTypeDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret AwsVolumeTypeDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given AwsVolumeTypeDefStatus and assigns it to the Status field.
...
func (o AwsVolumeTypeIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsVolumeTypeIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVolumeTypeIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVolumeTypeIntentResource := _AwsVolumeTypeIntentResource{}

	err = json.Unmarshal(data, &varAwsVolumeTypeIntentResource)

	if err != nil {
		return err
	}

	*o = AwsVolumeTypeIntentResource(varAwsVolumeTypeIntentResource)
...
type NullableAwsVolumeTypeIntentResource struct {
	value *AwsVolumeTypeIntentResource
	isSet bool
}

func (v NullableAwsVolumeTypeIntentResource) Get() *AwsVolumeTypeIntentResource {
	return v.value
}

func (v *NullableAwsVolumeTypeIntentResource) Set(val *AwsVolumeTypeIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVolumeTypeIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVolumeTypeIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVolumeTypeIntentResource(val *AwsVolumeTypeIntentResource) *NullableAwsVolumeTypeIntentResource {
	return &NullableAwsVolumeTypeIntentResource{value: val, isSet: true}
}

func (v NullableAwsVolumeTypeIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVolumeTypeIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
