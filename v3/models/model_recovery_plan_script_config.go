...
type _RecoveryPlanScriptConfig RecoveryPlanScriptConfig
...
func NewRecoveryPlanScriptConfig(enableScriptExec bool) *RecoveryPlanScriptConfig {
	this := RecoveryPlanScriptConfig{}
	this.EnableScriptExec = enableScriptExec
	return &this
}
...
// GetEnableScriptExec returns the EnableScriptExec field value
func (o *RecoveryPlanScriptConfig) GetEnableScriptExec() bool {
	...
	return o.EnableScriptExec
}

// GetEnableScriptExecOk returns a tuple with the EnableScriptExec field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanScriptConfig) GetEnableScriptExecOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.EnableScriptExec, true
}

// SetEnableScriptExec sets field value
func (o *RecoveryPlanScriptConfig) SetEnableScriptExec(v bool) {
	o.EnableScriptExec = v
}
...
func (o RecoveryPlanScriptConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanScriptConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["enable_script_exec"] = o.EnableScriptExec
	if !IsNil(o.Timeout) {
...
func (o *RecoveryPlanScriptConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanScriptConfig := _RecoveryPlanScriptConfig{}

	err = json.Unmarshal(data, &varRecoveryPlanScriptConfig)

	if err != nil {
		return err
	}

	*o = RecoveryPlanScriptConfig(varRecoveryPlanScriptConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "enable_script_exec")
...
type NullableRecoveryPlanScriptConfig struct {
	value *RecoveryPlanScriptConfig
	isSet bool
}

func (v NullableRecoveryPlanScriptConfig) Get() *RecoveryPlanScriptConfig {
	return v.value
}

func (v *NullableRecoveryPlanScriptConfig) Set(val *RecoveryPlanScriptConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanScriptConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanScriptConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanScriptConfig(val *RecoveryPlanScriptConfig) *NullableRecoveryPlanScriptConfig {
	return &NullableRecoveryPlanScriptConfig{value: val, isSet: true}
}

func (v NullableRecoveryPlanScriptConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanScriptConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
