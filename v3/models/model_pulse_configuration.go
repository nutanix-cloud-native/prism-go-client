...
// checks if the PulseConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PulseConfiguration{}
...
type PulseConfiguration struct {
	...
	EnableDefaultNutanixEmail bool `json:"enable_default_nutanix_email"`
	// List of default email contacts.
	EmailContactList []string `json:"email_contact_list,omitempty"`
	// Indicates if pulse should be enabled.
	EnablePulse bool `json:"enable_pulse"`
	AdditionalProperties map[string]interface{}
}

type _PulseConfiguration PulseConfiguration
...
func NewPulseConfiguration(enableDefaultNutanixEmail bool, enablePulse bool) *PulseConfiguration {
	this := PulseConfiguration{}
	this.EnableDefaultNutanixEmail = enableDefaultNutanixEmail
...
func NewPulseConfigurationWithDefaults() *PulseConfiguration {
	this := PulseConfiguration{}
	var enableDefaultNutanixEmail bool = true
	this.EnableDefaultNutanixEmail = enableDefaultNutanixEmail
...
// GetEnableDefaultNutanixEmail returns the EnableDefaultNutanixEmail field value
func (o *PulseConfiguration) GetEnableDefaultNutanixEmail() bool {
	...
	return o.EnableDefaultNutanixEmail
}

// GetEnableDefaultNutanixEmailOk returns a tuple with the EnableDefaultNutanixEmail field value
// and a boolean to check if the value has been set.
func (o *PulseConfiguration) GetEnableDefaultNutanixEmailOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.EnableDefaultNutanixEmail, true
}

// SetEnableDefaultNutanixEmail sets field value
func (o *PulseConfiguration) SetEnableDefaultNutanixEmail(v bool) {
	o.EnableDefaultNutanixEmail = v
}

// GetEmailContactList returns the EmailContactList field value if set, zero value otherwise.
func (o *PulseConfiguration) GetEmailContactList() []string {
	if o == nil || IsNil(o.EmailContactList) {
		var ret []string
		return ret
	}
	return o.EmailContactList
}

// GetEmailContactListOk returns a tuple with the EmailContactList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PulseConfiguration) GetEmailContactListOk() ([]string, bool) {
	if o == nil || IsNil(o.EmailContactList) {
		return nil, false
	}
	return o.EmailContactList, true
}
...
// SetEmailContactList gets a reference to the given []string and assigns it to the EmailContactList field.
func (o *PulseConfiguration) SetEmailContactList(v []string) {
	o.EmailContactList = v
}

// GetEnablePulse returns the EnablePulse field value
func (o *PulseConfiguration) GetEnablePulse() bool {
	...
	return o.EnablePulse
}

// GetEnablePulseOk returns a tuple with the EnablePulse field value
// and a boolean to check if the value has been set.
func (o *PulseConfiguration) GetEnablePulseOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.EnablePulse, true
}

// SetEnablePulse sets field value
func (o *PulseConfiguration) SetEnablePulse(v bool) {
	o.EnablePulse = v
}

func (o PulseConfiguration) MarshalJSON() ([]byte, error) {
...
func (o PulseConfiguration) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["enable_default_nutanix_email"] = o.EnableDefaultNutanixEmail
	if !IsNil(o.EmailContactList) {
		toSerialize["email_contact_list"] = o.EmailContactList
	}
	toSerialize["enable_pulse"] = o.EnablePulse
...
func (o *PulseConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varPulseConfiguration := _PulseConfiguration{}

	err = json.Unmarshal(data, &varPulseConfiguration)

	if err != nil {
		return err
	}

	*o = PulseConfiguration(varPulseConfiguration)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "enable_default_nutanix_email")
		delete(additionalProperties, "email_contact_list")
		delete(additionalProperties, "enable_pulse")
...
type NullablePulseConfiguration struct {
	value *PulseConfiguration
	isSet bool
}

func (v NullablePulseConfiguration) Get() *PulseConfiguration {
	return v.value
}

func (v *NullablePulseConfiguration) Set(val *PulseConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullablePulseConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullablePulseConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePulseConfiguration(val *PulseConfiguration) *NullablePulseConfiguration {
	return &NullablePulseConfiguration{value: val, isSet: true}
}

func (v NullablePulseConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePulseConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
