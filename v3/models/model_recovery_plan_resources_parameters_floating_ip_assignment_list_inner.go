...
// checks if the RecoveryPlanResourcesParametersFloatingIpAssignmentListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanResourcesParametersFloatingIpAssignmentListInner{}

// RecoveryPlanResourcesParametersFloatingIpAssignmentListInner struct for RecoveryPlanResourcesParametersFloatingIpAssignmentListInner
type RecoveryPlanResourcesParametersFloatingIpAssignmentListInner struct {
	...
	VmIpAssignmentList []RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner `json:"vm_ip_assignment_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanResourcesParametersFloatingIpAssignmentListInner RecoveryPlanResourcesParametersFloatingIpAssignmentListInner
...
func NewRecoveryPlanResourcesParametersFloatingIpAssignmentListInner(availabilityZoneUrl string) *RecoveryPlanResourcesParametersFloatingIpAssignmentListInner {
	this := RecoveryPlanResourcesParametersFloatingIpAssignmentListInner{}
...
// GetVmIpAssignmentList returns the VmIpAssignmentList field value if set, zero value otherwise.
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInner) GetVmIpAssignmentList() []RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner {
	if o == nil || IsNil(o.VmIpAssignmentList) {
		var ret []RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner
		return ret
	}
	return o.VmIpAssignmentList
}

// GetVmIpAssignmentListOk returns a tuple with the VmIpAssignmentList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInner) GetVmIpAssignmentListOk() ([]RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner, bool) {
	...
	return o.VmIpAssignmentList, true
}
...
// SetVmIpAssignmentList gets a reference to the given []RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner and assigns it to the VmIpAssignmentList field.
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInner) SetVmIpAssignmentList(v []RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) {
	o.VmIpAssignmentList = v
}

func (o RecoveryPlanResourcesParametersFloatingIpAssignmentListInner) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanResourcesParametersFloatingIpAssignmentListInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["availability_zone_url"] = o.AvailabilityZoneUrl
	if !IsNil(o.VmIpAssignmentList) {
		toSerialize["vm_ip_assignment_list"] = o.VmIpAssignmentList
	}
...
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanResourcesParametersFloatingIpAssignmentListInner := _RecoveryPlanResourcesParametersFloatingIpAssignmentListInner{}

	err = json.Unmarshal(data, &varRecoveryPlanResourcesParametersFloatingIpAssignmentListInner)

	if err != nil {
		return err
	}

	*o = RecoveryPlanResourcesParametersFloatingIpAssignmentListInner(varRecoveryPlanResourcesParametersFloatingIpAssignmentListInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "availability_zone_url")
		delete(additionalProperties, "vm_ip_assignment_list")
...
type NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInner struct {
	value *RecoveryPlanResourcesParametersFloatingIpAssignmentListInner
	isSet bool
}

func (v NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInner) Get() *RecoveryPlanResourcesParametersFloatingIpAssignmentListInner {
	return v.value
}

func (v *NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInner) Set(val *RecoveryPlanResourcesParametersFloatingIpAssignmentListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInner(val *RecoveryPlanResourcesParametersFloatingIpAssignmentListInner) *NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInner {
	return &NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInner{value: val, isSet: true}
}

func (v NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
