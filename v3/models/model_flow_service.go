...
// checks if the FlowService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlowService{}

// FlowService The ports, protocol and icmp codes for the service.
...
func (o FlowService) MarshalJSON() ([]byte, error) {
...
func (o FlowService) ToMap() (map[string]interface{}, error) {
...
func (o *FlowService) UnmarshalJSON(data []byte) (err error) {
	varFlowService := _FlowService{}

	err = json.Unmarshal(data, &varFlowService)

	if err != nil {
		return err
	}

	*o = FlowService(varFlowService)
...
type NullableFlowService struct {
	value *FlowService
	isSet bool
}

func (v NullableFlowService) Get() *FlowService {
	return v.value
}

func (v *NullableFlowService) Set(val *FlowService) {
	v.value = val
	v.isSet = true
}

func (v NullableFlowService) IsSet() bool {
	return v.isSet
}

func (v *NullableFlowService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlowService(val *FlowService) *NullableFlowService {
	return &NullableFlowService{value: val, isSet: true}
}

func (v NullableFlowService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlowService) UnmarshalJSON(src []byte) error {
	v.isSet = true
