...
// checks if the InternalDirectoryServiceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InternalDirectoryServiceConfig{}

// InternalDirectoryServiceConfig Internal directory service config
type InternalDirectoryServiceConfig struct {
	OpenldapConfig *InternalOpenLdapConfig `json:"openldap_config,omitempty"`
	...
	ServiceAccountConfig *InternalServiceAccountConfig `json:"service_account_config,omitempty"`
	// Search group recursively
	...
	// Name of the directory service configuration.
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _InternalDirectoryServiceConfig InternalDirectoryServiceConfig
...
func NewInternalDirectoryServiceConfig() *InternalDirectoryServiceConfig {
	this := InternalDirectoryServiceConfig{}
	return &this
}
...
// GetOpenldapConfig returns the OpenldapConfig field value if set, zero value otherwise.
func (o *InternalDirectoryServiceConfig) GetOpenldapConfig() InternalOpenLdapConfig {
	if o == nil || IsNil(o.OpenldapConfig) {
		var ret InternalOpenLdapConfig
		return ret
	}
	return *o.OpenldapConfig
}

// GetOpenldapConfigOk returns a tuple with the OpenldapConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InternalDirectoryServiceConfig) GetOpenldapConfigOk() (*InternalOpenLdapConfig, bool) {
	if o == nil || IsNil(o.OpenldapConfig) {
		return nil, false
	}
	return o.OpenldapConfig, true
}
...
// SetOpenldapConfig gets a reference to the given InternalOpenLdapConfig and assigns it to the OpenldapConfig field.
...
// GetServiceAccountConfig returns the ServiceAccountConfig field value if set, zero value otherwise.
func (o *InternalDirectoryServiceConfig) GetServiceAccountConfig() InternalServiceAccountConfig {
	if o == nil || IsNil(o.ServiceAccountConfig) {
		var ret InternalServiceAccountConfig
		return ret
	}
	return *o.ServiceAccountConfig
}

// GetServiceAccountConfigOk returns a tuple with the ServiceAccountConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InternalDirectoryServiceConfig) GetServiceAccountConfigOk() (*InternalServiceAccountConfig, bool) {
	if o == nil || IsNil(o.ServiceAccountConfig) {
		return nil, false
	}
	return o.ServiceAccountConfig, true
}
...
// SetServiceAccountConfig gets a reference to the given InternalServiceAccountConfig and assigns it to the ServiceAccountConfig field.
func (o *InternalDirectoryServiceConfig) SetServiceAccountConfig(v InternalServiceAccountConfig) {
	o.ServiceAccountConfig = &v
}

// GetRecursiveGroupSearch returns the RecursiveGroupSearch field value if set, zero value otherwise.
func (o *InternalDirectoryServiceConfig) GetRecursiveGroupSearch() bool {
	if o == nil || IsNil(o.RecursiveGroupSearch) {
		var ret bool
		return ret
	}
	return *o.RecursiveGroupSearch
}

// GetRecursiveGroupSearchOk returns a tuple with the RecursiveGroupSearch field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InternalDirectoryServiceConfig) GetRecursiveGroupSearchOk() (*bool, bool) {
	if o == nil || IsNil(o.RecursiveGroupSearch) {
		return nil, false
	}
	return o.RecursiveGroupSearch, true
}
...
// SetRecursiveGroupSearch gets a reference to the given bool and assigns it to the RecursiveGroupSearch field.
func (o *InternalDirectoryServiceConfig) SetRecursiveGroupSearch(v bool) {
	o.RecursiveGroupSearch = &v
}

// GetDomainDisplayName returns the DomainDisplayName field value if set, zero value otherwise.
func (o *InternalDirectoryServiceConfig) GetDomainDisplayName() string {
	if o == nil || IsNil(o.DomainDisplayName) {
		var ret string
		return ret
	}
	return *o.DomainDisplayName
}

// GetDomainDisplayNameOk returns a tuple with the DomainDisplayName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InternalDirectoryServiceConfig) GetDomainDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.DomainDisplayName) {
		return nil, false
	}
	return o.DomainDisplayName, true
}
...
// SetDomainDisplayName gets a reference to the given string and assigns it to the DomainDisplayName field.
func (o *InternalDirectoryServiceConfig) SetDomainDisplayName(v string) {
	o.DomainDisplayName = &v
}
...
func (o InternalDirectoryServiceConfig) MarshalJSON() ([]byte, error) {
...
func (o InternalDirectoryServiceConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.OpenldapConfig) {
		toSerialize["openldap_config"] = o.OpenldapConfig
	}
	if !IsNil(o.UUID) {
	...
	if !IsNil(o.ServiceAccountConfig) {
		toSerialize["service_account_config"] = o.ServiceAccountConfig
	}
	if !IsNil(o.RecursiveGroupSearch) {
		toSerialize["recursive_group_search"] = o.RecursiveGroupSearch
	}
	if !IsNil(o.DomainDisplayName) {
		toSerialize["domain_display_name"] = o.DomainDisplayName
	}
	if !IsNil(o.Name) {
...
func (o *InternalDirectoryServiceConfig) UnmarshalJSON(data []byte) (err error) {
	varInternalDirectoryServiceConfig := _InternalDirectoryServiceConfig{}

	err = json.Unmarshal(data, &varInternalDirectoryServiceConfig)

	if err != nil {
		return err
	}

	*o = InternalDirectoryServiceConfig(varInternalDirectoryServiceConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "openldap_config")
		delete(additionalProperties, "uuid")
		delete(additionalProperties, "url")
		delete(additionalProperties, "directory_type")
		delete(additionalProperties, "domain_name")
		delete(additionalProperties, "service_account_config")
		delete(additionalProperties, "recursive_group_search")
		delete(additionalProperties, "domain_display_name")
...
type NullableInternalDirectoryServiceConfig struct {
	value *InternalDirectoryServiceConfig
	isSet bool
}

func (v NullableInternalDirectoryServiceConfig) Get() *InternalDirectoryServiceConfig {
	return v.value
}

func (v *NullableInternalDirectoryServiceConfig) Set(val *InternalDirectoryServiceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableInternalDirectoryServiceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableInternalDirectoryServiceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInternalDirectoryServiceConfig(val *InternalDirectoryServiceConfig) *NullableInternalDirectoryServiceConfig {
	return &NullableInternalDirectoryServiceConfig{value: val, isSet: true}
}

func (v NullableInternalDirectoryServiceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInternalDirectoryServiceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
