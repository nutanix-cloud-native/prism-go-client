...
// checks if the ImageStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageStatus{}

// ImageStatus The status of a REST API call. Only used when there is a failure to report. 
...
func (o ImageStatus) MarshalJSON() ([]byte, error) {
...
func (o ImageStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ImageStatus) UnmarshalJSON(data []byte) (err error) {
	varImageStatus := _ImageStatus{}

	err = json.Unmarshal(data, &varImageStatus)

	if err != nil {
		return err
	}

	*o = ImageStatus(varImageStatus)
