...
// checks if the ExchangeWorkload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExchangeWorkload{}

// ExchangeWorkload Exchange workload Object.
type ExchangeWorkload struct {
	NumMailboxes *int32 `json:"num_mailboxes,omitempty"`
	UserType *string `json:"user_type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ExchangeWorkload ExchangeWorkload
...
// GetNumMailboxes returns the NumMailboxes field value if set, zero value otherwise.
func (o *ExchangeWorkload) GetNumMailboxes() int32 {
	if o == nil || IsNil(o.NumMailboxes) {
		var ret int32
		return ret
	}
	return *o.NumMailboxes
}

// GetNumMailboxesOk returns a tuple with the NumMailboxes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExchangeWorkload) GetNumMailboxesOk() (*int32, bool) {
	if o == nil || IsNil(o.NumMailboxes) {
		return nil, false
	}
	return o.NumMailboxes, true
}
...
// SetNumMailboxes gets a reference to the given int32 and assigns it to the NumMailboxes field.
...
func (o ExchangeWorkload) MarshalJSON() ([]byte, error) {
...
func (o ExchangeWorkload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.NumMailboxes) {
		toSerialize["num_mailboxes"] = o.NumMailboxes
	}
	if !IsNil(o.UserType) {
...
func (o *ExchangeWorkload) UnmarshalJSON(data []byte) (err error) {
	varExchangeWorkload := _ExchangeWorkload{}

	err = json.Unmarshal(data, &varExchangeWorkload)

	if err != nil {
		return err
	}

	*o = ExchangeWorkload(varExchangeWorkload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "num_mailboxes")
...
type NullableExchangeWorkload struct {
	value *ExchangeWorkload
	isSet bool
}

func (v NullableExchangeWorkload) Get() *ExchangeWorkload {
	return v.value
}

func (v *NullableExchangeWorkload) Set(val *ExchangeWorkload) {
	v.value = val
	v.isSet = true
}

func (v NullableExchangeWorkload) IsSet() bool {
	return v.isSet
}

func (v *NullableExchangeWorkload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExchangeWorkload(val *ExchangeWorkload) *NullableExchangeWorkload {
	return &NullableExchangeWorkload{value: val, isSet: true}
}

func (v NullableExchangeWorkload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExchangeWorkload) UnmarshalJSON(src []byte) error {
	v.isSet = true
