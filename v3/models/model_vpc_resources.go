...
// checks if the VpcResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcResources{}
...
type _VpcResources VpcResources
...
func (o VpcResources) MarshalJSON() ([]byte, error) {
...
func (o VpcResources) ToMap() (map[string]interface{}, error) {
...
func (o *VpcResources) UnmarshalJSON(data []byte) (err error) {
	varVpcResources := _VpcResources{}

	err = json.Unmarshal(data, &varVpcResources)

	if err != nil {
		return err
	}

	*o = VpcResources(varVpcResources)
...
type NullableVpcResources struct {
	value *VpcResources
	isSet bool
}

func (v NullableVpcResources) Get() *VpcResources {
	return v.value
}

func (v *NullableVpcResources) Set(val *VpcResources) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcResources) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcResources(val *VpcResources) *NullableVpcResources {
	return &NullableVpcResources{value: val, isSet: true}
}

func (v NullableVpcResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
