...
// checks if the CloudTenant type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTenant{}

// CloudTenant An intentful representation of a cloud_tenant spec
...
func (o CloudTenant) MarshalJSON() ([]byte, error) {
...
func (o CloudTenant) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTenant) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTenant := _CloudTenant{}

	err = json.Unmarshal(data, &varCloudTenant)

	if err != nil {
		return err
	}

	*o = CloudTenant(varCloudTenant)
...
type NullableCloudTenant struct {
	value *CloudTenant
	isSet bool
}

func (v NullableCloudTenant) Get() *CloudTenant {
	return v.value
}

func (v *NullableCloudTenant) Set(val *CloudTenant) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTenant) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTenant) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTenant(val *CloudTenant) *NullableCloudTenant {
	return &NullableCloudTenant{value: val, isSet: true}
}

func (v NullableCloudTenant) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTenant) UnmarshalJSON(src []byte) error {
	v.isSet = true
