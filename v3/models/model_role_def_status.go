...
// checks if the RoleDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleDefStatus{}

// RoleDefStatus Role status definition.
type RoleDefStatus struct {
	...
	Resources RoleResources1 `json:"resources"`
	// A description or user annotation for the role.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RoleDefStatus RoleDefStatus
...
func (o RoleDefStatus) MarshalJSON() ([]byte, error) {
...
func (o RoleDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RoleDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleDefStatus := _RoleDefStatus{}

	err = json.Unmarshal(data, &varRoleDefStatus)

	if err != nil {
		return err
	}

	*o = RoleDefStatus(varRoleDefStatus)
...
type NullableRoleDefStatus struct {
	value *RoleDefStatus
	isSet bool
}

func (v NullableRoleDefStatus) Get() *RoleDefStatus {
	return v.value
}

func (v *NullableRoleDefStatus) Set(val *RoleDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleDefStatus(val *RoleDefStatus) *NullableRoleDefStatus {
	return &NullableRoleDefStatus{value: val, isSet: true}
}

func (v NullableRoleDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
