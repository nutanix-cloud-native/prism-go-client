...
// checks if the AvailabilityZoneResourcesSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneResourcesSpec{}

// AvailabilityZoneResourcesSpec Availability Zone resources
type AvailabilityZoneResourcesSpec struct {
	...
	Credentials *AvailabilityZoneResourcesSpecCredentials `json:"credentials,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AvailabilityZoneResourcesSpec AvailabilityZoneResourcesSpec
...
func NewAvailabilityZoneResourcesSpec(managementPlaneType string) *AvailabilityZoneResourcesSpec {
	this := AvailabilityZoneResourcesSpec{}
	this.ManagementPlaneType = managementPlaneType
	return &this
}
...
// GetManagementPlaneType returns the ManagementPlaneType field value
func (o *AvailabilityZoneResourcesSpec) GetManagementPlaneType() string {
	...
	return o.ManagementPlaneType
}

// GetManagementPlaneTypeOk returns a tuple with the ManagementPlaneType field value
// and a boolean to check if the value has been set.
func (o *AvailabilityZoneResourcesSpec) GetManagementPlaneTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ManagementPlaneType, true
}

// SetManagementPlaneType sets field value
func (o *AvailabilityZoneResourcesSpec) SetManagementPlaneType(v string) {
	o.ManagementPlaneType = v
}
...
func (o *AvailabilityZoneResourcesSpec) GetCredentials() AvailabilityZoneResourcesSpecCredentials {
	if o == nil || IsNil(o.Credentials) {
		var ret AvailabilityZoneResourcesSpecCredentials
		return ret
	}
...
// SetCredentials gets a reference to the given AvailabilityZoneResourcesSpecCredentials and assigns it to the Credentials field.
func (o *AvailabilityZoneResourcesSpec) SetCredentials(v AvailabilityZoneResourcesSpecCredentials) {
	o.Credentials = &v
}

func (o AvailabilityZoneResourcesSpec) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneResourcesSpec) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["management_plane_type"] = o.ManagementPlaneType
...
func (o *AvailabilityZoneResourcesSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varAvailabilityZoneResourcesSpec := _AvailabilityZoneResourcesSpec{}

	err = json.Unmarshal(data, &varAvailabilityZoneResourcesSpec)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneResourcesSpec(varAvailabilityZoneResourcesSpec)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "management_plane_type")
...
type NullableAvailabilityZoneResourcesSpec struct {
	value *AvailabilityZoneResourcesSpec
	isSet bool
}

func (v NullableAvailabilityZoneResourcesSpec) Get() *AvailabilityZoneResourcesSpec {
	return v.value
}

func (v *NullableAvailabilityZoneResourcesSpec) Set(val *AvailabilityZoneResourcesSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneResourcesSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneResourcesSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneResourcesSpec(val *AvailabilityZoneResourcesSpec) *NullableAvailabilityZoneResourcesSpec {
	return &NullableAvailabilityZoneResourcesSpec{value: val, isSet: true}
}

func (v NullableAvailabilityZoneResourcesSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneResourcesSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
