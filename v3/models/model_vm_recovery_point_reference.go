...
// checks if the VmRecoveryPointReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPointReference{}

// VmRecoveryPointReference The reference to a vm_recovery_point
type VmRecoveryPointReference struct {
	// The kind name
...
type _VmRecoveryPointReference VmRecoveryPointReference
...
func (o VmRecoveryPointReference) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPointReference) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPointReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVmRecoveryPointReference := _VmRecoveryPointReference{}

	err = json.Unmarshal(data, &varVmRecoveryPointReference)

	if err != nil {
		return err
	}

	*o = VmRecoveryPointReference(varVmRecoveryPointReference)
...
type NullableVmRecoveryPointReference struct {
	value *VmRecoveryPointReference
	isSet bool
}

func (v NullableVmRecoveryPointReference) Get() *VmRecoveryPointReference {
	return v.value
}

func (v *NullableVmRecoveryPointReference) Set(val *VmRecoveryPointReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPointReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPointReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPointReference(val *VmRecoveryPointReference) *NullableVmRecoveryPointReference {
	return &NullableVmRecoveryPointReference{value: val, isSet: true}
}

func (v NullableVmRecoveryPointReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPointReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
