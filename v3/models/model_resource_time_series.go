...
// checks if the ResourceTimeSeries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceTimeSeries{}

// ResourceTimeSeries TimeSeries Object.
type ResourceTimeSeries struct {
	StartTimeSec *int64 `json:"start_time_sec,omitempty"`
	CapacityList []float32 `json:"capacity_list,omitempty"`
	EndTimeSec *int64 `json:"end_time_sec,omitempty"`
	Name *string `json:"name,omitempty"`
	SamplingIntervalSec *int64 `json:"sampling_interval_sec,omitempty"`
	UsageList []float32 `json:"usage_list,omitempty"`
	EffectiveCapacityList []float32 `json:"effective_capacity_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ResourceTimeSeries ResourceTimeSeries
...
// SetStartTimeSec gets a reference to the given int64 and assigns it to the StartTimeSec field.
func (o *ResourceTimeSeries) SetStartTimeSec(v int64) {
	o.StartTimeSec = &v
}

// GetCapacityList returns the CapacityList field value if set, zero value otherwise.
func (o *ResourceTimeSeries) GetCapacityList() []float32 {
	if o == nil || IsNil(o.CapacityList) {
		var ret []float32
		return ret
	}
	return o.CapacityList
}

// GetCapacityListOk returns a tuple with the CapacityList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResourceTimeSeries) GetCapacityListOk() ([]float32, bool) {
	if o == nil || IsNil(o.CapacityList) {
		return nil, false
	}
	return o.CapacityList, true
}
...
// SetCapacityList gets a reference to the given []float32 and assigns it to the CapacityList field.
...
// SetEndTimeSec gets a reference to the given int64 and assigns it to the EndTimeSec field.
...
// GetSamplingIntervalSec returns the SamplingIntervalSec field value if set, zero value otherwise.
func (o *ResourceTimeSeries) GetSamplingIntervalSec() int64 {
	if o == nil || IsNil(o.SamplingIntervalSec) {
		var ret int64
		return ret
	}
	return *o.SamplingIntervalSec
}

// GetSamplingIntervalSecOk returns a tuple with the SamplingIntervalSec field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResourceTimeSeries) GetSamplingIntervalSecOk() (*int64, bool) {
	if o == nil || IsNil(o.SamplingIntervalSec) {
		return nil, false
	}
	return o.SamplingIntervalSec, true
}
...
// SetSamplingIntervalSec gets a reference to the given int64 and assigns it to the SamplingIntervalSec field.
func (o *ResourceTimeSeries) SetSamplingIntervalSec(v int64) {
	o.SamplingIntervalSec = &v
}

// GetUsageList returns the UsageList field value if set, zero value otherwise.
func (o *ResourceTimeSeries) GetUsageList() []float32 {
	if o == nil || IsNil(o.UsageList) {
		var ret []float32
		return ret
	}
	return o.UsageList
...
// GetUsageListOk returns a tuple with the UsageList field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetUsageList gets a reference to the given []float32 and assigns it to the UsageList field.
func (o *ResourceTimeSeries) SetUsageList(v []float32) {
	o.UsageList = v
}

// GetEffectiveCapacityList returns the EffectiveCapacityList field value if set, zero value otherwise.
func (o *ResourceTimeSeries) GetEffectiveCapacityList() []float32 {
	if o == nil || IsNil(o.EffectiveCapacityList) {
		var ret []float32
		return ret
	}
	return o.EffectiveCapacityList
}

// GetEffectiveCapacityListOk returns a tuple with the EffectiveCapacityList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResourceTimeSeries) GetEffectiveCapacityListOk() ([]float32, bool) {
	if o == nil || IsNil(o.EffectiveCapacityList) {
		return nil, false
	}
	return o.EffectiveCapacityList, true
}
...
// SetEffectiveCapacityList gets a reference to the given []float32 and assigns it to the EffectiveCapacityList field.
func (o *ResourceTimeSeries) SetEffectiveCapacityList(v []float32) {
	o.EffectiveCapacityList = v
}

func (o ResourceTimeSeries) MarshalJSON() ([]byte, error) {
...
func (o ResourceTimeSeries) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.StartTimeSec) {
		toSerialize["start_time_sec"] = o.StartTimeSec
	}
	if !IsNil(o.CapacityList) {
		toSerialize["capacity_list"] = o.CapacityList
	}
	...
	if !IsNil(o.SamplingIntervalSec) {
		toSerialize["sampling_interval_sec"] = o.SamplingIntervalSec
	}
	if !IsNil(o.UsageList) {
		toSerialize["usage_list"] = o.UsageList
	}
	if !IsNil(o.EffectiveCapacityList) {
		toSerialize["effective_capacity_list"] = o.EffectiveCapacityList
	}
...
func (o *ResourceTimeSeries) UnmarshalJSON(data []byte) (err error) {
	varResourceTimeSeries := _ResourceTimeSeries{}

	err = json.Unmarshal(data, &varResourceTimeSeries)

	if err != nil {
		return err
	}

	*o = ResourceTimeSeries(varResourceTimeSeries)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "start_time_sec")
		delete(additionalProperties, "capacity_list")
		delete(additionalProperties, "end_time_sec")
		delete(additionalProperties, "name")
		delete(additionalProperties, "sampling_interval_sec")
		delete(additionalProperties, "usage_list")
		delete(additionalProperties, "effective_capacity_list")
...
type NullableResourceTimeSeries struct {
	value *ResourceTimeSeries
	isSet bool
}

func (v NullableResourceTimeSeries) Get() *ResourceTimeSeries {
	return v.value
}

func (v *NullableResourceTimeSeries) Set(val *ResourceTimeSeries) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceTimeSeries) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceTimeSeries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceTimeSeries(val *ResourceTimeSeries) *NullableResourceTimeSeries {
	return &NullableResourceTimeSeries{value: val, isSet: true}
}

func (v NullableResourceTimeSeries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceTimeSeries) UnmarshalJSON(src []byte) error {
	v.isSet = true
