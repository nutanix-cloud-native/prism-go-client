...
// checks if the BasicCredential type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BasicCredential{}

// BasicCredential Basic Credentials to connect with remote endpoint
type BasicCredential struct {
	// username of authorized user on remote cluster, must for BASIC auth_type 
	Username *string `json:"username,omitempty"`
	// password of authorized user on remote cluster, must for BASIC auth_type 
	Password *string `json:"password,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _BasicCredential BasicCredential
...
func (o BasicCredential) MarshalJSON() ([]byte, error) {
...
func (o BasicCredential) ToMap() (map[string]interface{}, error) {
...
func (o *BasicCredential) UnmarshalJSON(data []byte) (err error) {
	varBasicCredential := _BasicCredential{}

	err = json.Unmarshal(data, &varBasicCredential)

	if err != nil {
		return err
	}

	*o = BasicCredential(varBasicCredential)
...
type NullableBasicCredential struct {
	value *BasicCredential
	isSet bool
}

func (v NullableBasicCredential) Get() *BasicCredential {
	return v.value
}

func (v *NullableBasicCredential) Set(val *BasicCredential) {
	v.value = val
	v.isSet = true
}

func (v NullableBasicCredential) IsSet() bool {
	return v.isSet
}

func (v *NullableBasicCredential) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBasicCredential(val *BasicCredential) *NullableBasicCredential {
	return &NullableBasicCredential{value: val, isSet: true}
}

func (v NullableBasicCredential) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBasicCredential) UnmarshalJSON(src []byte) error {
	v.isSet = true
