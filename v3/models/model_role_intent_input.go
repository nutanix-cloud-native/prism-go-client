...
// checks if the RoleIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleIntentInput{}

// RoleIntentInput An intentful representation of a role
...
type _RoleIntentInput RoleIntentInput
...
func (o RoleIntentInput) MarshalJSON() ([]byte, error) {
...
func (o RoleIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *RoleIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleIntentInput := _RoleIntentInput{}

	err = json.Unmarshal(data, &varRoleIntentInput)

	if err != nil {
		return err
	}

	*o = RoleIntentInput(varRoleIntentInput)
...
type NullableRoleIntentInput struct {
	value *RoleIntentInput
	isSet bool
}

func (v NullableRoleIntentInput) Get() *RoleIntentInput {
	return v.value
}

func (v *NullableRoleIntentInput) Set(val *RoleIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleIntentInput(val *RoleIntentInput) *NullableRoleIntentInput {
	return &NullableRoleIntentInput{value: val, isSet: true}
}

func (v NullableRoleIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
