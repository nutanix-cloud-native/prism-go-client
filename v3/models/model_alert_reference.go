...
// checks if the AlertReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertReference{}

// AlertReference The reference to a alert
...
type _AlertReference AlertReference
...
func (o AlertReference) MarshalJSON() ([]byte, error) {
...
func (o AlertReference) ToMap() (map[string]interface{}, error) {
...
func (o *AlertReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertReference := _AlertReference{}

	err = json.Unmarshal(data, &varAlertReference)

	if err != nil {
		return err
	}

	*o = AlertReference(varAlertReference)
...
type NullableAlertReference struct {
	value *AlertReference
	isSet bool
}

func (v NullableAlertReference) Get() *AlertReference {
	return v.value
}

func (v *NullableAlertReference) Set(val *AlertReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertReference(val *AlertReference) *NullableAlertReference {
	return &NullableAlertReference{value: val, isSet: true}
}

func (v NullableAlertReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
