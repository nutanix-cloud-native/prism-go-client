...
// checks if the AppCostInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCostInput{}

// AppCostInput Cost definition for Application
type AppCostInput struct {
	// 
...
type _AppCostInput AppCostInput
...
func (o AppCostInput) MarshalJSON() ([]byte, error) {
...
func (o AppCostInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppCostInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCostInput := _AppCostInput{}

	err = json.Unmarshal(data, &varAppCostInput)

	if err != nil {
		return err
	}

	*o = AppCostInput(varAppCostInput)
...
type NullableAppCostInput struct {
	value *AppCostInput
	isSet bool
}

func (v NullableAppCostInput) Get() *AppCostInput {
	return v.value
}

func (v *NullableAppCostInput) Set(val *AppCostInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCostInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCostInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCostInput(val *AppCostInput) *NullableAppCostInput {
	return &NullableAppCostInput{value: val, isSet: true}
}

func (v NullableAppCostInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCostInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
