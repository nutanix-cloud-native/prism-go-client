...
// checks if the RecoveryPlanJobReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobReference{}

// RecoveryPlanJobReference The reference to a recovery_plan_job
type RecoveryPlanJobReference struct {
	// The kind name
...
type _RecoveryPlanJobReference RecoveryPlanJobReference
...
func (o RecoveryPlanJobReference) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobReference) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobReference) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobReference := _RecoveryPlanJobReference{}

	err = json.Unmarshal(data, &varRecoveryPlanJobReference)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobReference(varRecoveryPlanJobReference)
...
type NullableRecoveryPlanJobReference struct {
	value *RecoveryPlanJobReference
	isSet bool
}

func (v NullableRecoveryPlanJobReference) Get() *RecoveryPlanJobReference {
	return v.value
}

func (v *NullableRecoveryPlanJobReference) Set(val *RecoveryPlanJobReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobReference) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobReference(val *RecoveryPlanJobReference) *NullableRecoveryPlanJobReference {
	return &NullableRecoveryPlanJobReference{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
