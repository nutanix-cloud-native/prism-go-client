...
// checks if the SupportCaseResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseResources{}

// SupportCaseResources Support case resources definition.
type SupportCaseResources struct {
	ContactDetails ContactInformation `json:"contact_details"`
...
type _SupportCaseResources SupportCaseResources
...
func (o SupportCaseResources) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseResources) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseResources) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseResources := _SupportCaseResources{}

	err = json.Unmarshal(data, &varSupportCaseResources)

	if err != nil {
		return err
	}

	*o = SupportCaseResources(varSupportCaseResources)
...
type NullableSupportCaseResources struct {
	value *SupportCaseResources
	isSet bool
}

func (v NullableSupportCaseResources) Get() *SupportCaseResources {
	return v.value
}

func (v *NullableSupportCaseResources) Set(val *SupportCaseResources) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseResources) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseResources(val *SupportCaseResources) *NullableSupportCaseResources {
	return &NullableSupportCaseResources{value: val, isSet: true}
}

func (v NullableSupportCaseResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
