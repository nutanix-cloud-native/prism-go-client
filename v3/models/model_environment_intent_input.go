...
// checks if the EnvironmentIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentIntentInput{}

// EnvironmentIntentInput An intentful representation of a environment
type EnvironmentIntentInput struct {
...
type _EnvironmentIntentInput EnvironmentIntentInput
...
func (o EnvironmentIntentInput) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *EnvironmentIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvironmentIntentInput := _EnvironmentIntentInput{}

	err = json.Unmarshal(data, &varEnvironmentIntentInput)

	if err != nil {
		return err
	}

	*o = EnvironmentIntentInput(varEnvironmentIntentInput)
...
type NullableEnvironmentIntentInput struct {
	value *EnvironmentIntentInput
	isSet bool
}

func (v NullableEnvironmentIntentInput) Get() *EnvironmentIntentInput {
	return v.value
}

func (v *NullableEnvironmentIntentInput) Set(val *EnvironmentIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentIntentInput(val *EnvironmentIntentInput) *NullableEnvironmentIntentInput {
	return &NullableEnvironmentIntentInput{value: val, isSet: true}
}

func (v NullableEnvironmentIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
