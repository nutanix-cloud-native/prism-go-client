...
// checks if the UserListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserListMetadataOutput{}

// UserListMetadataOutput All api calls that return a list will have this metadata block 
...
type _UserListMetadataOutput UserListMetadataOutput
...
// and a boolean to check if the value has been set.
func (o *UserListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o UserListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o UserListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *UserListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varUserListMetadataOutput := _UserListMetadataOutput{}

	err = json.Unmarshal(data, &varUserListMetadataOutput)

	if err != nil {
		return err
	}

	*o = UserListMetadataOutput(varUserListMetadataOutput)
...
type NullableUserListMetadataOutput struct {
	value *UserListMetadataOutput
	isSet bool
}

func (v NullableUserListMetadataOutput) Get() *UserListMetadataOutput {
	return v.value
}

func (v *NullableUserListMetadataOutput) Set(val *UserListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableUserListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableUserListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserListMetadataOutput(val *UserListMetadataOutput) *NullableUserListMetadataOutput {
	return &NullableUserListMetadataOutput{value: val, isSet: true}
}

func (v NullableUserListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
