...
// checks if the AppDeploymentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppDeploymentResponse{}

// AppDeploymentResponse Deployment definition for Application.
type AppDeploymentResponse struct {
	...
	PublishedServiceList []AppPublishedServiceInput `json:"published_service_list,omitempty"`
	// 
	...
	ElementList []AppDeploymentElement `json:"element_list"`
	// List of references for services
	ServiceList []AppServiceResponse `json:"service_list,omitempty"`
	SubstrateConfiguration AppSubstrateResponse `json:"substrate_configuration"`
	// 
	DependsOnList []EntityReference `json:"depends_on_list,omitempty"`
	// List of references for the packages
	PackageList []AppPackageResponse `json:"package_list,omitempty"`
	...
	ConfigReference *AppBlueprintDeploymentReference `json:"config_reference,omitempty"`
	// 
...
type _AppDeploymentResponse AppDeploymentResponse
...
func NewAppDeploymentResponse(elementList []AppDeploymentElement, substrateConfiguration AppSubstrateResponse, minReplicas string, state string, currentReplicas int32, maxReplicas string, messageList []MessageResource, name string, uUID string) *AppDeploymentResponse {
	this := AppDeploymentResponse{}
	this.ElementList = elementList
	this.SubstrateConfiguration = substrateConfiguration
...
// GetPublishedServiceList returns the PublishedServiceList field value if set, zero value otherwise.
func (o *AppDeploymentResponse) GetPublishedServiceList() []AppPublishedServiceInput {
	if o == nil || IsNil(o.PublishedServiceList) {
		var ret []AppPublishedServiceInput
		return ret
	}
	return o.PublishedServiceList
}

// GetPublishedServiceListOk returns a tuple with the PublishedServiceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppDeploymentResponse) GetPublishedServiceListOk() ([]AppPublishedServiceInput, bool) {
	if o == nil || IsNil(o.PublishedServiceList) {
		return nil, false
	}
	return o.PublishedServiceList, true
}
...
// SetPublishedServiceList gets a reference to the given []AppPublishedServiceInput and assigns it to the PublishedServiceList field.
func (o *AppDeploymentResponse) SetPublishedServiceList(v []AppPublishedServiceInput) {
	o.PublishedServiceList = v
}
...
// GetElementList returns the ElementList field value
func (o *AppDeploymentResponse) GetElementList() []AppDeploymentElement {
	if o == nil {
		var ret []AppDeploymentElement
		return ret
	}

	return o.ElementList
}

// GetElementListOk returns a tuple with the ElementList field value
// and a boolean to check if the value has been set.
func (o *AppDeploymentResponse) GetElementListOk() ([]AppDeploymentElement, bool) {
	if o == nil {
		return nil, false
	}
	return o.ElementList, true
}

// SetElementList sets field value
func (o *AppDeploymentResponse) SetElementList(v []AppDeploymentElement) {
	o.ElementList = v
}

// GetServiceList returns the ServiceList field value if set, zero value otherwise.
...
// SetServiceList gets a reference to the given []AppServiceResponse and assigns it to the ServiceList field.
func (o *AppDeploymentResponse) SetServiceList(v []AppServiceResponse) {
	o.ServiceList = v
}

// GetSubstrateConfiguration returns the SubstrateConfiguration field value
func (o *AppDeploymentResponse) GetSubstrateConfiguration() AppSubstrateResponse {
	...
	return o.SubstrateConfiguration
}

// GetSubstrateConfigurationOk returns a tuple with the SubstrateConfiguration field value
// and a boolean to check if the value has been set.
func (o *AppDeploymentResponse) GetSubstrateConfigurationOk() (*AppSubstrateResponse, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SubstrateConfiguration, true
}

// SetSubstrateConfiguration sets field value
func (o *AppDeploymentResponse) SetSubstrateConfiguration(v AppSubstrateResponse) {
	o.SubstrateConfiguration = v
}
...
// SetPackageList gets a reference to the given []AppPackageResponse and assigns it to the PackageList field.
...
// GetConfigReference returns the ConfigReference field value if set, zero value otherwise.
func (o *AppDeploymentResponse) GetConfigReference() AppBlueprintDeploymentReference {
	if o == nil || IsNil(o.ConfigReference) {
		var ret AppBlueprintDeploymentReference
		return ret
	}
	return *o.ConfigReference
}

// GetConfigReferenceOk returns a tuple with the ConfigReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppDeploymentResponse) GetConfigReferenceOk() (*AppBlueprintDeploymentReference, bool) {
	if o == nil || IsNil(o.ConfigReference) {
		return nil, false
	}
	return o.ConfigReference, true
}
...
// SetConfigReference gets a reference to the given AppBlueprintDeploymentReference and assigns it to the ConfigReference field.
...
func (o AppDeploymentResponse) MarshalJSON() ([]byte, error) {
...
func (o AppDeploymentResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PercentFaultTolerance) {
		toSerialize["percent_fault_tolerance"] = o.PercentFaultTolerance
	}
	if !IsNil(o.PublishedServiceList) {
		toSerialize["published_service_list"] = o.PublishedServiceList
	}
	...
	toSerialize["element_list"] = o.ElementList
	if !IsNil(o.ServiceList) {
		toSerialize["service_list"] = o.ServiceList
	}
	toSerialize["substrate_configuration"] = o.SubstrateConfiguration
	...
	toSerialize["current_replicas"] = o.CurrentReplicas
	toSerialize["max_replicas"] = o.MaxReplicas
	toSerialize["message_list"] = o.MessageList
	if !IsNil(o.ConfigReference) {
		toSerialize["config_reference"] = o.ConfigReference
	}
...
func (o *AppDeploymentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppDeploymentResponse := _AppDeploymentResponse{}

	err = json.Unmarshal(data, &varAppDeploymentResponse)

	if err != nil {
		return err
	}

	*o = AppDeploymentResponse(varAppDeploymentResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "percent_fault_tolerance")
		delete(additionalProperties, "published_service_list")
		delete(additionalProperties, "fault_domain_scope")
		delete(additionalProperties, "description")
		delete(additionalProperties, "action_list")
		delete(additionalProperties, "element_list")
		delete(additionalProperties, "service_list")
		delete(additionalProperties, "substrate_configuration")
		...
		delete(additionalProperties, "current_replicas")
		delete(additionalProperties, "max_replicas")
		delete(additionalProperties, "message_list")
		delete(additionalProperties, "config_reference")
...
type NullableAppDeploymentResponse struct {
	value *AppDeploymentResponse
	isSet bool
}

func (v NullableAppDeploymentResponse) Get() *AppDeploymentResponse {
	return v.value
}

func (v *NullableAppDeploymentResponse) Set(val *AppDeploymentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppDeploymentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppDeploymentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppDeploymentResponse(val *AppDeploymentResponse) *NullableAppDeploymentResponse {
	return &NullableAppDeploymentResponse{value: val, isSet: true}
}

func (v NullableAppDeploymentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppDeploymentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
