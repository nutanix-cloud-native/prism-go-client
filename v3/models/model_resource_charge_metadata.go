...
// checks if the ResourceChargeMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceChargeMetadata{}

// ResourceChargeMetadata The resource_charge kind metadata
type ResourceChargeMetadata struct {
	...
	// Categories for the resource_charge. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the resource_charge. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _ResourceChargeMetadata ResourceChargeMetadata
...
func (o ResourceChargeMetadata) MarshalJSON() ([]byte, error) {
...
func (o ResourceChargeMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceChargeMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varResourceChargeMetadata := _ResourceChargeMetadata{}

	err = json.Unmarshal(data, &varResourceChargeMetadata)

	if err != nil {
		return err
	}

	*o = ResourceChargeMetadata(varResourceChargeMetadata)
...
type NullableResourceChargeMetadata struct {
	value *ResourceChargeMetadata
	isSet bool
}

func (v NullableResourceChargeMetadata) Get() *ResourceChargeMetadata {
	return v.value
}

func (v *NullableResourceChargeMetadata) Set(val *ResourceChargeMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceChargeMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceChargeMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceChargeMetadata(val *ResourceChargeMetadata) *NullableResourceChargeMetadata {
	return &NullableResourceChargeMetadata{value: val, isSet: true}
}

func (v NullableResourceChargeMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceChargeMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
