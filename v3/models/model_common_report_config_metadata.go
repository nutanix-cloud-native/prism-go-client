...
// checks if the CommonReportConfigMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigMetadata{}

// CommonReportConfigMetadata The common_report_config kind metadata
type CommonReportConfigMetadata struct {
	...
	// Categories for the common_report_config. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the common_report_config. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// common_report_config name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CommonReportConfigMetadata CommonReportConfigMetadata
...
func NewCommonReportConfigMetadata(kind string) *CommonReportConfigMetadata {
	this := CommonReportConfigMetadata{}
...
func (o *CommonReportConfigMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *CommonReportConfigMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *CommonReportConfigMetadata) SetName(v string) {
	o.Name = &v
}

func (o CommonReportConfigMetadata) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfigMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonReportConfigMetadata := _CommonReportConfigMetadata{}

	err = json.Unmarshal(data, &varCommonReportConfigMetadata)

	if err != nil {
		return err
	}

	*o = CommonReportConfigMetadata(varCommonReportConfigMetadata)
...
type NullableCommonReportConfigMetadata struct {
	value *CommonReportConfigMetadata
	isSet bool
}

func (v NullableCommonReportConfigMetadata) Get() *CommonReportConfigMetadata {
	return v.value
}

func (v *NullableCommonReportConfigMetadata) Set(val *CommonReportConfigMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigMetadata(val *CommonReportConfigMetadata) *NullableCommonReportConfigMetadata {
	return &NullableCommonReportConfigMetadata{value: val, isSet: true}
}

func (v NullableCommonReportConfigMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
