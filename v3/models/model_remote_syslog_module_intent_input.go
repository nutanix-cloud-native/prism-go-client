...
// checks if the RemoteSyslogModuleIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogModuleIntentInput{}

// RemoteSyslogModuleIntentInput An intentful representation of a remote_syslog_module
type RemoteSyslogModuleIntentInput struct {
	Spec RemoteSyslogModule `json:"spec"`
...
type _RemoteSyslogModuleIntentInput RemoteSyslogModuleIntentInput
...
func NewRemoteSyslogModuleIntentInput(spec RemoteSyslogModule, metadata RemoteSyslogModuleMetadata) *RemoteSyslogModuleIntentInput {
	this := RemoteSyslogModuleIntentInput{}
	this.Spec = spec
...
func (o RemoteSyslogModuleIntentInput) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogModuleIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogModuleIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogModuleIntentInput := _RemoteSyslogModuleIntentInput{}

	err = json.Unmarshal(data, &varRemoteSyslogModuleIntentInput)

	if err != nil {
		return err
	}

	*o = RemoteSyslogModuleIntentInput(varRemoteSyslogModuleIntentInput)
...
type NullableRemoteSyslogModuleIntentInput struct {
	value *RemoteSyslogModuleIntentInput
	isSet bool
}

func (v NullableRemoteSyslogModuleIntentInput) Get() *RemoteSyslogModuleIntentInput {
	return v.value
}

func (v *NullableRemoteSyslogModuleIntentInput) Set(val *RemoteSyslogModuleIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogModuleIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogModuleIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogModuleIntentInput(val *RemoteSyslogModuleIntentInput) *NullableRemoteSyslogModuleIntentInput {
	return &NullableRemoteSyslogModuleIntentInput{value: val, isSet: true}
}

func (v NullableRemoteSyslogModuleIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogModuleIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
