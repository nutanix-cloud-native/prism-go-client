...
// checks if the VpnConnectionIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionIntentResponse{}

// VpnConnectionIntentResponse Response object for intentful operations on a vpn_connection
type VpnConnectionIntentResponse struct {
	Status *VpnConnectionDefStatus `json:"status,omitempty"`
	Spec *VpnConnection `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata VpnConnectionMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VpnConnectionIntentResponse VpnConnectionIntentResponse
...
func NewVpnConnectionIntentResponse(apiVersion string, metadata VpnConnectionMetadata) *VpnConnectionIntentResponse {
	this := VpnConnectionIntentResponse{}
...
func (o *VpnConnectionIntentResponse) GetStatus() VpnConnectionDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret VpnConnectionDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given VpnConnectionDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given VpnConnection and assigns it to the Spec field.
...
func (o VpnConnectionIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnectionIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnConnectionIntentResponse := _VpnConnectionIntentResponse{}

	err = json.Unmarshal(data, &varVpnConnectionIntentResponse)

	if err != nil {
		return err
	}

	*o = VpnConnectionIntentResponse(varVpnConnectionIntentResponse)
...
type NullableVpnConnectionIntentResponse struct {
	value *VpnConnectionIntentResponse
	isSet bool
}

func (v NullableVpnConnectionIntentResponse) Get() *VpnConnectionIntentResponse {
	return v.value
}

func (v *NullableVpnConnectionIntentResponse) Set(val *VpnConnectionIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionIntentResponse(val *VpnConnectionIntentResponse) *NullableVpnConnectionIntentResponse {
	return &NullableVpnConnectionIntentResponse{value: val, isSet: true}
}

func (v NullableVpnConnectionIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
