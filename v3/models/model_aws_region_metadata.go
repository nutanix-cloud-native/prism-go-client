...
// checks if the AwsRegionMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRegionMetadata{}

// AwsRegionMetadata The aws_region kind metadata
type AwsRegionMetadata struct {
...
type _AwsRegionMetadata AwsRegionMetadata
...
func (o AwsRegionMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsRegionMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRegionMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsRegionMetadata := _AwsRegionMetadata{}

	err = json.Unmarshal(data, &varAwsRegionMetadata)

	if err != nil {
		return err
	}

	*o = AwsRegionMetadata(varAwsRegionMetadata)
...
type NullableAwsRegionMetadata struct {
	value *AwsRegionMetadata
	isSet bool
}

func (v NullableAwsRegionMetadata) Get() *AwsRegionMetadata {
	return v.value
}

func (v *NullableAwsRegionMetadata) Set(val *AwsRegionMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRegionMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRegionMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRegionMetadata(val *AwsRegionMetadata) *NullableAwsRegionMetadata {
	return &NullableAwsRegionMetadata{value: val, isSet: true}
}

func (v NullableAwsRegionMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRegionMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
