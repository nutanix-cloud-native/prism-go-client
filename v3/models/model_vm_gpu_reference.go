...
// checks if the VmGpuReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmGpuReference{}

// VmGpuReference The reference to a vm_gpu
...
type _VmGpuReference VmGpuReference
...
func (o VmGpuReference) MarshalJSON() ([]byte, error) {
...
func (o VmGpuReference) ToMap() (map[string]interface{}, error) {
...
func (o *VmGpuReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVmGpuReference := _VmGpuReference{}

	err = json.Unmarshal(data, &varVmGpuReference)

	if err != nil {
		return err
	}

	*o = VmGpuReference(varVmGpuReference)
...
type NullableVmGpuReference struct {
	value *VmGpuReference
	isSet bool
}

func (v NullableVmGpuReference) Get() *VmGpuReference {
	return v.value
}

func (v *NullableVmGpuReference) Set(val *VmGpuReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVmGpuReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVmGpuReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmGpuReference(val *VmGpuReference) *NullableVmGpuReference {
	return &NullableVmGpuReference{value: val, isSet: true}
}

func (v NullableVmGpuReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmGpuReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
