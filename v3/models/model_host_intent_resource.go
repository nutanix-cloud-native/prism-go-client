...
// checks if the HostIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostIntentResource{}

// HostIntentResource Response object for intentful operations on a host
...
type _HostIntentResource HostIntentResource
...
// SetStatus gets a reference to the given HostDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Host and assigns it to the Spec field.
...
func (o HostIntentResource) MarshalJSON() ([]byte, error) {
...
func (o HostIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *HostIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varHostIntentResource := _HostIntentResource{}

	err = json.Unmarshal(data, &varHostIntentResource)

	if err != nil {
		return err
	}

	*o = HostIntentResource(varHostIntentResource)
...
type NullableHostIntentResource struct {
	value *HostIntentResource
	isSet bool
}

func (v NullableHostIntentResource) Get() *HostIntentResource {
	return v.value
}

func (v *NullableHostIntentResource) Set(val *HostIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableHostIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableHostIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostIntentResource(val *HostIntentResource) *NullableHostIntentResource {
	return &NullableHostIntentResource{value: val, isSet: true}
}

func (v NullableHostIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
