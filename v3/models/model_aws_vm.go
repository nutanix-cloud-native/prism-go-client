...
// checks if the AwsVm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVm{}

// AwsVm An intentful representation of a aws_vm spec
type AwsVm struct {
	// aws_vm Name.
	...
	Resources AwsVmResources `json:"resources"`
...
func (o AwsVm) MarshalJSON() ([]byte, error) {
...
func (o AwsVm) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVm) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAwsVm)
...
type NullableAwsVm struct {
	value *AwsVm
	isSet bool
}

func (v NullableAwsVm) Get() *AwsVm {
	return v.value
}

func (v *NullableAwsVm) Set(val *AwsVm) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVm) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVm(val *AwsVm) *NullableAwsVm {
	return &NullableAwsVm{value: val, isSet: true}
}

func (v NullableAwsVm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVm) UnmarshalJSON(src []byte) error {
	v.isSet = true
