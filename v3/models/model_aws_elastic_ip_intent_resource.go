...
// checks if the AwsElasticIpIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsElasticIpIntentResource{}

// AwsElasticIpIntentResource aws_elastic_ip entity
type AwsElasticIpIntentResource struct {
	Status *AwsElasticIpDefStatus `json:"status,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsElasticIpMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsElasticIpIntentResource AwsElasticIpIntentResource
...
func NewAwsElasticIpIntentResource(apiVersion string, metadata AwsElasticIpMetadata) *AwsElasticIpIntentResource {
	this := AwsElasticIpIntentResource{}
...
// SetStatus gets a reference to the given AwsElasticIpDefStatus and assigns it to the Status field.
...
func (o AwsElasticIpIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsElasticIpIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsElasticIpIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsElasticIpIntentResource := _AwsElasticIpIntentResource{}

	err = json.Unmarshal(data, &varAwsElasticIpIntentResource)

	if err != nil {
		return err
	}

	*o = AwsElasticIpIntentResource(varAwsElasticIpIntentResource)
...
type NullableAwsElasticIpIntentResource struct {
	value *AwsElasticIpIntentResource
	isSet bool
}

func (v NullableAwsElasticIpIntentResource) Get() *AwsElasticIpIntentResource {
	return v.value
}

func (v *NullableAwsElasticIpIntentResource) Set(val *AwsElasticIpIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsElasticIpIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsElasticIpIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsElasticIpIntentResource(val *AwsElasticIpIntentResource) *NullableAwsElasticIpIntentResource {
	return &NullableAwsElasticIpIntentResource{value: val, isSet: true}
}

func (v NullableAwsElasticIpIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsElasticIpIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
