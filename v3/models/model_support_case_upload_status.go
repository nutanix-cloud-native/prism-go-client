...
// checks if the SupportCaseUploadStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseUploadStatus{}

// SupportCaseUploadStatus The status of a REST API call. Only used when there is a failure to report. 
type SupportCaseUploadStatus struct {
	// The kind name
...
type _SupportCaseUploadStatus SupportCaseUploadStatus
...
func (o SupportCaseUploadStatus) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseUploadStatus) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseUploadStatus) UnmarshalJSON(data []byte) (err error) {
	varSupportCaseUploadStatus := _SupportCaseUploadStatus{}

	err = json.Unmarshal(data, &varSupportCaseUploadStatus)

	if err != nil {
		return err
	}

	*o = SupportCaseUploadStatus(varSupportCaseUploadStatus)
...
type NullableSupportCaseUploadStatus struct {
	value *SupportCaseUploadStatus
	isSet bool
}

func (v NullableSupportCaseUploadStatus) Get() *SupportCaseUploadStatus {
	return v.value
}

func (v *NullableSupportCaseUploadStatus) Set(val *SupportCaseUploadStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseUploadStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseUploadStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseUploadStatus(val *SupportCaseUploadStatus) *NullableSupportCaseUploadStatus {
	return &NullableSupportCaseUploadStatus{value: val, isSet: true}
}

func (v NullableSupportCaseUploadStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseUploadStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
