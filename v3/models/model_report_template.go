...
// checks if the ReportTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportTemplate{}

// ReportTemplate Report Template.
type ReportTemplate struct {
	ReportCustomization *ReportCustomization `json:"report_customization,omitempty"`
	// List of template rows.
	TemplateRows []TemplateRow `json:"template_rows"`
	// List of sections.
...
type _ReportTemplate ReportTemplate
...
// GetTemplateRows returns the TemplateRows field value
func (o *ReportTemplate) GetTemplateRows() []TemplateRow {
	...
	return o.TemplateRows
}

// GetTemplateRowsOk returns a tuple with the TemplateRows field value
// and a boolean to check if the value has been set.
func (o *ReportTemplate) GetTemplateRowsOk() ([]TemplateRow, bool) {
	if o == nil {
		return nil, false
	}
	return o.TemplateRows, true
}

// SetTemplateRows sets field value
...
func (o ReportTemplate) MarshalJSON() ([]byte, error) {
...
func (o ReportTemplate) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ReportCustomization) {
		toSerialize["report_customization"] = o.ReportCustomization
	}
	toSerialize["template_rows"] = o.TemplateRows
	if !IsNil(o.Sections) {
...
func (o *ReportTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varReportTemplate := _ReportTemplate{}

	err = json.Unmarshal(data, &varReportTemplate)

	if err != nil {
		return err
	}

	*o = ReportTemplate(varReportTemplate)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "report_customization")
		delete(additionalProperties, "template_rows")
...
type NullableReportTemplate struct {
	value *ReportTemplate
	isSet bool
}

func (v NullableReportTemplate) Get() *ReportTemplate {
	return v.value
}

func (v *NullableReportTemplate) Set(val *ReportTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableReportTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableReportTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportTemplate(val *ReportTemplate) *NullableReportTemplate {
	return &NullableReportTemplate{value: val, isSet: true}
}

func (v NullableReportTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
