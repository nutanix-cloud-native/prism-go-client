...
// checks if the RemoteConnectionListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionListMetadataOutput{}

// RemoteConnectionListMetadataOutput All api calls that return a list will have this metadata block 
type RemoteConnectionListMetadataOutput struct {
	// The kind name
...
type _RemoteConnectionListMetadataOutput RemoteConnectionListMetadataOutput
...
func NewRemoteConnectionListMetadataOutput() *RemoteConnectionListMetadataOutput {
	this := RemoteConnectionListMetadataOutput{}
	var kind string = "remote_connection"
	this.Kind = &kind
	return &this
}
...
func (o RemoteConnectionListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteConnectionListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varRemoteConnectionListMetadataOutput := _RemoteConnectionListMetadataOutput{}

	err = json.Unmarshal(data, &varRemoteConnectionListMetadataOutput)

	if err != nil {
		return err
	}

	*o = RemoteConnectionListMetadataOutput(varRemoteConnectionListMetadataOutput)
...
type NullableRemoteConnectionListMetadataOutput struct {
	value *RemoteConnectionListMetadataOutput
	isSet bool
}

func (v NullableRemoteConnectionListMetadataOutput) Get() *RemoteConnectionListMetadataOutput {
	return v.value
}

func (v *NullableRemoteConnectionListMetadataOutput) Set(val *RemoteConnectionListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionListMetadataOutput(val *RemoteConnectionListMetadataOutput) *NullableRemoteConnectionListMetadataOutput {
	return &NullableRemoteConnectionListMetadataOutput{value: val, isSet: true}
}

func (v NullableRemoteConnectionListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
