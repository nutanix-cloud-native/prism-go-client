...
// checks if the RecoveryPlanJobResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobResources{}

// RecoveryPlanJobResources Recovery Plan Job resources definition.
type RecoveryPlanJobResources struct {
	RecoveryPlanReference RecoveryPlanReference `json:"recovery_plan_reference"`
	ExecutionParameters RecoveryPlanJobResourcesExecutionParameters `json:"execution_parameters"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanJobResources RecoveryPlanJobResources
...
func NewRecoveryPlanJobResources(recoveryPlanReference RecoveryPlanReference, executionParameters RecoveryPlanJobResourcesExecutionParameters) *RecoveryPlanJobResources {
	this := RecoveryPlanJobResources{}
	this.RecoveryPlanReference = recoveryPlanReference
...
// GetRecoveryPlanReference returns the RecoveryPlanReference field value
func (o *RecoveryPlanJobResources) GetRecoveryPlanReference() RecoveryPlanReference {
	if o == nil {
		var ret RecoveryPlanReference
		return ret
	}

	return o.RecoveryPlanReference
}

// GetRecoveryPlanReferenceOk returns a tuple with the RecoveryPlanReference field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobResources) GetRecoveryPlanReferenceOk() (*RecoveryPlanReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RecoveryPlanReference, true
}

// SetRecoveryPlanReference sets field value
func (o *RecoveryPlanJobResources) SetRecoveryPlanReference(v RecoveryPlanReference) {
	o.RecoveryPlanReference = v
}

// GetExecutionParameters returns the ExecutionParameters field value
func (o *RecoveryPlanJobResources) GetExecutionParameters() RecoveryPlanJobResourcesExecutionParameters {
	if o == nil {
		var ret RecoveryPlanJobResourcesExecutionParameters
		return ret
	}

	return o.ExecutionParameters
}

// GetExecutionParametersOk returns a tuple with the ExecutionParameters field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobResources) GetExecutionParametersOk() (*RecoveryPlanJobResourcesExecutionParameters, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ExecutionParameters, true
}

// SetExecutionParameters sets field value
func (o *RecoveryPlanJobResources) SetExecutionParameters(v RecoveryPlanJobResourcesExecutionParameters) {
	o.ExecutionParameters = v
}

func (o RecoveryPlanJobResources) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["recovery_plan_reference"] = o.RecoveryPlanReference
	toSerialize["execution_parameters"] = o.ExecutionParameters
...
func (o *RecoveryPlanJobResources) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobResources := _RecoveryPlanJobResources{}

	err = json.Unmarshal(data, &varRecoveryPlanJobResources)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobResources(varRecoveryPlanJobResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "recovery_plan_reference")
		delete(additionalProperties, "execution_parameters")
...
type NullableRecoveryPlanJobResources struct {
	value *RecoveryPlanJobResources
	isSet bool
}

func (v NullableRecoveryPlanJobResources) Get() *RecoveryPlanJobResources {
	return v.value
}

func (v *NullableRecoveryPlanJobResources) Set(val *RecoveryPlanJobResources) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobResources) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobResources(val *RecoveryPlanJobResources) *NullableRecoveryPlanJobResources {
	return &NullableRecoveryPlanJobResources{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
