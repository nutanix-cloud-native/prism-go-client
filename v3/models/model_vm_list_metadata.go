...
// checks if the VmListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmListMetadata{}
...
type _VmListMetadata VmListMetadata
...
func (o VmListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVmListMetadata := _VmListMetadata{}

	err = json.Unmarshal(data, &varVmListMetadata)

	if err != nil {
		return err
	}

	*o = VmListMetadata(varVmListMetadata)
...
type NullableVmListMetadata struct {
	value *VmListMetadata
	isSet bool
}

func (v NullableVmListMetadata) Get() *VmListMetadata {
	return v.value
}

func (v *NullableVmListMetadata) Set(val *VmListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmListMetadata(val *VmListMetadata) *NullableVmListMetadata {
	return &NullableVmListMetadata{value: val, isSet: true}
}

func (v NullableVmListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
