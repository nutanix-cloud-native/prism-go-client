...
// checks if the EnvironmentIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentIntentResponse{}

// EnvironmentIntentResponse Response object for intentful operations on a environment
type EnvironmentIntentResponse struct {
	Status *EnvironmentDefStatus `json:"status,omitempty"`
...
type _EnvironmentIntentResponse EnvironmentIntentResponse
...
func NewEnvironmentIntentResponse(apiVersion string, metadata EnvironmentMetadata) *EnvironmentIntentResponse {
	this := EnvironmentIntentResponse{}
...
// SetStatus gets a reference to the given EnvironmentDefStatus and assigns it to the Status field.
...
func (o EnvironmentIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EnvironmentIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvironmentIntentResponse := _EnvironmentIntentResponse{}

	err = json.Unmarshal(data, &varEnvironmentIntentResponse)

	if err != nil {
		return err
	}

	*o = EnvironmentIntentResponse(varEnvironmentIntentResponse)
...
type NullableEnvironmentIntentResponse struct {
	value *EnvironmentIntentResponse
	isSet bool
}

func (v NullableEnvironmentIntentResponse) Get() *EnvironmentIntentResponse {
	return v.value
}

func (v *NullableEnvironmentIntentResponse) Set(val *EnvironmentIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentIntentResponse(val *EnvironmentIntentResponse) *NullableEnvironmentIntentResponse {
	return &NullableEnvironmentIntentResponse{value: val, isSet: true}
}

func (v NullableEnvironmentIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
