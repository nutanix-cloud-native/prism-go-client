...
// checks if the ImageListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageListIntentResponse{}

// ImageListIntentResponse Response object for intentful operation of images
...
type _ImageListIntentResponse ImageListIntentResponse
...
// SetEntities gets a reference to the given []ImageIntentResource and assigns it to the Entities field.
...
func (o *ImageListIntentResponse) GetMetadata() ImageListMetadataOutput {
	if o == nil {
		var ret ImageListMetadataOutput
		return ret
	}
...
func (o ImageListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ImageListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ImageListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varImageListIntentResponse := _ImageListIntentResponse{}

	err = json.Unmarshal(data, &varImageListIntentResponse)

	if err != nil {
		return err
	}

	*o = ImageListIntentResponse(varImageListIntentResponse)
...
type NullableImageListIntentResponse struct {
	value *ImageListIntentResponse
	isSet bool
}

func (v NullableImageListIntentResponse) Get() *ImageListIntentResponse {
	return v.value
}

func (v *NullableImageListIntentResponse) Set(val *ImageListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableImageListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableImageListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageListIntentResponse(val *ImageListIntentResponse) *NullableImageListIntentResponse {
	return &NullableImageListIntentResponse{value: val, isSet: true}
}

func (v NullableImageListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
