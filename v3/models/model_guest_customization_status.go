...
// checks if the GuestCustomizationStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestCustomizationStatus{}
...
type _GuestCustomizationStatus GuestCustomizationStatus
...
func (o *GuestCustomizationStatus) GetCloudInit() GuestCustomizationStatusCloudInit {
	if o == nil || IsNil(o.CloudInit) {
		var ret GuestCustomizationStatusCloudInit
		return ret
	}
	return *o.CloudInit
}
...
// SetCloudInit gets a reference to the given GuestCustomizationStatusCloudInit and assigns it to the CloudInit field.
func (o *GuestCustomizationStatus) SetCloudInit(v GuestCustomizationStatusCloudInit) {
	o.CloudInit = &v
}

// GetIsOverridable returns the IsOverridable field value if set, zero value otherwise.
func (o *GuestCustomizationStatus) GetIsOverridable() bool {
	if o == nil || IsNil(o.IsOverridable) {
		var ret bool
		return ret
	}
	return *o.IsOverridable
}

// GetIsOverridableOk returns a tuple with the IsOverridable field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GuestCustomizationStatus) GetIsOverridableOk() (*bool, bool) {
	if o == nil || IsNil(o.IsOverridable) {
		return nil, false
	}
	return o.IsOverridable, true
}
...
// SetIsOverridable gets a reference to the given bool and assigns it to the IsOverridable field.
...
func (o *GuestCustomizationStatus) GetSysprep() GuestCustomizationStatusSysprep {
	if o == nil || IsNil(o.Sysprep) {
		var ret GuestCustomizationStatusSysprep
		return ret
	}
	return *o.Sysprep
}
...
// SetSysprep gets a reference to the given GuestCustomizationStatusSysprep and assigns it to the Sysprep field.
func (o *GuestCustomizationStatus) SetSysprep(v GuestCustomizationStatusSysprep) {
	o.Sysprep = &v
}

func (o GuestCustomizationStatus) MarshalJSON() ([]byte, error) {
...
func (o GuestCustomizationStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CloudInit) {
		toSerialize["cloud_init"] = o.CloudInit
	}
	if !IsNil(o.IsOverridable) {
		toSerialize["is_overridable"] = o.IsOverridable
	}
	if !IsNil(o.Sysprep) {
...
func (o *GuestCustomizationStatus) UnmarshalJSON(data []byte) (err error) {
	varGuestCustomizationStatus := _GuestCustomizationStatus{}

	err = json.Unmarshal(data, &varGuestCustomizationStatus)

	if err != nil {
		return err
	}

	*o = GuestCustomizationStatus(varGuestCustomizationStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "cloud_init")
		delete(additionalProperties, "is_overridable")
		delete(additionalProperties, "sysprep")
...
type NullableGuestCustomizationStatus struct {
	value *GuestCustomizationStatus
	isSet bool
}

func (v NullableGuestCustomizationStatus) Get() *GuestCustomizationStatus {
	return v.value
}

func (v *NullableGuestCustomizationStatus) Set(val *GuestCustomizationStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestCustomizationStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestCustomizationStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestCustomizationStatus(val *GuestCustomizationStatus) *NullableGuestCustomizationStatus {
	return &NullableGuestCustomizationStatus{value: val, isSet: true}
}

func (v NullableGuestCustomizationStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestCustomizationStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
