...
// checks if the CategoryKeyListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryKeyListResponse{}

// CategoryKeyListResponse Category key list response.
...
type _CategoryKeyListResponse CategoryKeyListResponse
...
// SetEntities gets a reference to the given []CategoryKeyStatus and assigns it to the Entities field.
...
func (o CategoryKeyListResponse) MarshalJSON() ([]byte, error) {
...
func (o CategoryKeyListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryKeyListResponse) UnmarshalJSON(data []byte) (err error) {
	varCategoryKeyListResponse := _CategoryKeyListResponse{}

	err = json.Unmarshal(data, &varCategoryKeyListResponse)

	if err != nil {
		return err
	}

	*o = CategoryKeyListResponse(varCategoryKeyListResponse)
...
type NullableCategoryKeyListResponse struct {
	value *CategoryKeyListResponse
	isSet bool
}

func (v NullableCategoryKeyListResponse) Get() *CategoryKeyListResponse {
	return v.value
}

func (v *NullableCategoryKeyListResponse) Set(val *CategoryKeyListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryKeyListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryKeyListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryKeyListResponse(val *CategoryKeyListResponse) *NullableCategoryKeyListResponse {
	return &NullableCategoryKeyListResponse{value: val, isSet: true}
}

func (v NullableCategoryKeyListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryKeyListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
