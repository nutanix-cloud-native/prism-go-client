...
// checks if the ActionRuleResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResources{}

// ActionRuleResources Action rule entity definition
type ActionRuleResources struct {
	// is the rule enabled or disabled.
	IsEnabled *bool `json:"is_enabled,omitempty"`
	// The rule should be validated or not.  If True, then, the rule will be validated before saving.  If the validation failed, the spec status message list will have errors. 
	ShouldValidate *bool `json:"should_validate,omitempty"`
	// The only trigger that the rule has.
	TriggerList []TriggerInstanceObject `json:"trigger_list"`
	// The action rule name
	Name *string `json:"name,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
	ExecutionUserReference *UserReference `json:"execution_user_reference,omitempty"`
	// Action rule types associated with this rule.
	RuleType *string `json:"rule_type,omitempty"`
	// Ordered list of the actions to be executed in the end.
	PostExecutionActionList []ActionInstanceObject `json:"post_execution_action_list,omitempty"`
	// Ordered list of the actions to execute in this rule.
	ActionList []ActionInstanceObject `json:"action_list"`
	// If it is true, the rule action execution at the schedueled time will check if the original trigger is still valid.  If not set, default to True. 
	CheckTriggerValidity *bool `json:"check_trigger_validity,omitempty"`
	// The rule level global parameter descriptors. This is provided by the system. 
	GlobalParameters *map[string]ParamDescriptor `json:"global_parameters,omitempty"`
	XPilotParams *ActionRuleXPilotParams `json:"x_pilot_params,omitempty"`
	// Errors identified in this rule.
	ErrorList []ComponentError `json:"error_list,omitempty"`
	// Is this been validated to trur or not.
...
type _ActionRuleResources ActionRuleResources
...
// GetShouldValidate returns the ShouldValidate field value if set, zero value otherwise.
func (o *ActionRuleResources) GetShouldValidate() bool {
	if o == nil || IsNil(o.ShouldValidate) {
		var ret bool
		return ret
	}
	return *o.ShouldValidate
}

// GetShouldValidateOk returns a tuple with the ShouldValidate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleResources) GetShouldValidateOk() (*bool, bool) {
	if o == nil || IsNil(o.ShouldValidate) {
		return nil, false
	}
	return o.ShouldValidate, true
}
...
// SetShouldValidate gets a reference to the given bool and assigns it to the ShouldValidate field.
func (o *ActionRuleResources) SetShouldValidate(v bool) {
	o.ShouldValidate = &v
}

// GetTriggerList returns the TriggerList field value
func (o *ActionRuleResources) GetTriggerList() []TriggerInstanceObject {
	if o == nil {
		var ret []TriggerInstanceObject
		return ret
	}

	return o.TriggerList
}

// GetTriggerListOk returns a tuple with the TriggerList field value
// and a boolean to check if the value has been set.
func (o *ActionRuleResources) GetTriggerListOk() ([]TriggerInstanceObject, bool) {
	if o == nil {
		return nil, false
	}
	return o.TriggerList, true
}

// SetTriggerList sets field value
...
// GetExecutionUserReference returns the ExecutionUserReference field value if set, zero value otherwise.
func (o *ActionRuleResources) GetExecutionUserReference() UserReference {
	if o == nil || IsNil(o.ExecutionUserReference) {
		var ret UserReference
		return ret
	}
	return *o.ExecutionUserReference
}

// GetExecutionUserReferenceOk returns a tuple with the ExecutionUserReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleResources) GetExecutionUserReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.ExecutionUserReference) {
		return nil, false
	}
	return o.ExecutionUserReference, true
}
...
// SetExecutionUserReference gets a reference to the given UserReference and assigns it to the ExecutionUserReference field.
func (o *ActionRuleResources) SetExecutionUserReference(v UserReference) {
	o.ExecutionUserReference = &v
}
...
// GetPostExecutionActionList returns the PostExecutionActionList field value if set, zero value otherwise.
func (o *ActionRuleResources) GetPostExecutionActionList() []ActionInstanceObject {
	if o == nil || IsNil(o.PostExecutionActionList) {
		var ret []ActionInstanceObject
		return ret
	}
	return o.PostExecutionActionList
}

// GetPostExecutionActionListOk returns a tuple with the PostExecutionActionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleResources) GetPostExecutionActionListOk() ([]ActionInstanceObject, bool) {
	if o == nil || IsNil(o.PostExecutionActionList) {
		return nil, false
	}
	return o.PostExecutionActionList, true
}
...
// SetPostExecutionActionList gets a reference to the given []ActionInstanceObject and assigns it to the PostExecutionActionList field.
func (o *ActionRuleResources) SetPostExecutionActionList(v []ActionInstanceObject) {
	o.PostExecutionActionList = v
}
...
// GetCheckTriggerValidity returns the CheckTriggerValidity field value if set, zero value otherwise.
func (o *ActionRuleResources) GetCheckTriggerValidity() bool {
	if o == nil || IsNil(o.CheckTriggerValidity) {
		var ret bool
		return ret
	}
	return *o.CheckTriggerValidity
}

// GetCheckTriggerValidityOk returns a tuple with the CheckTriggerValidity field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleResources) GetCheckTriggerValidityOk() (*bool, bool) {
	if o == nil || IsNil(o.CheckTriggerValidity) {
		return nil, false
	}
	return o.CheckTriggerValidity, true
}
...
// SetCheckTriggerValidity gets a reference to the given bool and assigns it to the CheckTriggerValidity field.
func (o *ActionRuleResources) SetCheckTriggerValidity(v bool) {
	o.CheckTriggerValidity = &v
}

// GetGlobalParameters returns the GlobalParameters field value if set, zero value otherwise.
func (o *ActionRuleResources) GetGlobalParameters() map[string]ParamDescriptor {
	if o == nil || IsNil(o.GlobalParameters) {
		var ret map[string]ParamDescriptor
		return ret
	}
	return *o.GlobalParameters
}

// GetGlobalParametersOk returns a tuple with the GlobalParameters field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleResources) GetGlobalParametersOk() (*map[string]ParamDescriptor, bool) {
	if o == nil || IsNil(o.GlobalParameters) {
		return nil, false
	}
	return o.GlobalParameters, true
}
...
// SetGlobalParameters gets a reference to the given map[string]ParamDescriptor and assigns it to the GlobalParameters field.
func (o *ActionRuleResources) SetGlobalParameters(v map[string]ParamDescriptor) {
	o.GlobalParameters = &v
}

// GetXPilotParams returns the XPilotParams field value if set, zero value otherwise.
func (o *ActionRuleResources) GetXPilotParams() ActionRuleXPilotParams {
	if o == nil || IsNil(o.XPilotParams) {
		var ret ActionRuleXPilotParams
		return ret
	}
	return *o.XPilotParams
}

// GetXPilotParamsOk returns a tuple with the XPilotParams field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleResources) GetXPilotParamsOk() (*ActionRuleXPilotParams, bool) {
	if o == nil || IsNil(o.XPilotParams) {
		return nil, false
	}
	return o.XPilotParams, true
}
...
// SetXPilotParams gets a reference to the given ActionRuleXPilotParams and assigns it to the XPilotParams field.
...
// SetErrorList gets a reference to the given []ComponentError and assigns it to the ErrorList field.
...
func (o ActionRuleResources) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IsEnabled) {
		toSerialize["is_enabled"] = o.IsEnabled
	}
	if !IsNil(o.ShouldValidate) {
		toSerialize["should_validate"] = o.ShouldValidate
	}
	toSerialize["trigger_list"] = o.TriggerList
	if !IsNil(o.Name) {
		toSerialize["name"] = o.Name
	}
	if !IsNil(o.ExecutionUserReference) {
		toSerialize["execution_user_reference"] = o.ExecutionUserReference
	}
	if !IsNil(o.RuleType) {
		toSerialize["rule_type"] = o.RuleType
	}
	if !IsNil(o.PostExecutionActionList) {
		toSerialize["post_execution_action_list"] = o.PostExecutionActionList
	}
	toSerialize["action_list"] = o.ActionList
	if !IsNil(o.CheckTriggerValidity) {
		toSerialize["check_trigger_validity"] = o.CheckTriggerValidity
	}
	if !IsNil(o.GlobalParameters) {
		toSerialize["global_parameters"] = o.GlobalParameters
	}
	if !IsNil(o.XPilotParams) {
		toSerialize["x_pilot_params"] = o.XPilotParams
	}
...
func (o *ActionRuleResources) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleResources := _ActionRuleResources{}

	err = json.Unmarshal(data, &varActionRuleResources)

	if err != nil {
		return err
	}

	*o = ActionRuleResources(varActionRuleResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "is_enabled")
		delete(additionalProperties, "should_validate")
		delete(additionalProperties, "trigger_list")
		delete(additionalProperties, "name")
		delete(additionalProperties, "execution_user_reference")
		delete(additionalProperties, "rule_type")
		delete(additionalProperties, "post_execution_action_list")
		delete(additionalProperties, "action_list")
		delete(additionalProperties, "check_trigger_validity")
		delete(additionalProperties, "global_parameters")
		delete(additionalProperties, "x_pilot_params")
		delete(additionalProperties, "error_list")
...
type NullableActionRuleResources struct {
	value *ActionRuleResources
	isSet bool
}

func (v NullableActionRuleResources) Get() *ActionRuleResources {
	return v.value
}

func (v *NullableActionRuleResources) Set(val *ActionRuleResources) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResources) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResources(val *ActionRuleResources) *NullableActionRuleResources {
	return &NullableActionRuleResources{value: val, isSet: true}
}

func (v NullableActionRuleResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
