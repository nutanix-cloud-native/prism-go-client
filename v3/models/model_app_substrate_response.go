...
// checks if the AppSubstrateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSubstrateResponse{}

// AppSubstrateResponse Substrate info for deployment
type AppSubstrateResponse struct {
	// 
	...
	ConfigReference *AppSubstrateReference `json:"config_reference,omitempty"`
	// 
...
type _AppSubstrateResponse AppSubstrateResponse
...
// SetConfigReference gets a reference to the given AppSubstrateReference and assigns it to the ConfigReference field.
...
func (o AppSubstrateResponse) MarshalJSON() ([]byte, error) {
...
func (o AppSubstrateResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppSubstrateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppSubstrateResponse := _AppSubstrateResponse{}

	err = json.Unmarshal(data, &varAppSubstrateResponse)

	if err != nil {
		return err
	}

	*o = AppSubstrateResponse(varAppSubstrateResponse)
...
type NullableAppSubstrateResponse struct {
	value *AppSubstrateResponse
	isSet bool
}

func (v NullableAppSubstrateResponse) Get() *AppSubstrateResponse {
	return v.value
}

func (v *NullableAppSubstrateResponse) Set(val *AppSubstrateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppSubstrateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppSubstrateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppSubstrateResponse(val *AppSubstrateResponse) *NullableAppSubstrateResponse {
	return &NullableAppSubstrateResponse{value: val, isSet: true}
}

func (v NullableAppSubstrateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppSubstrateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
