...
// checks if the SupportCaseStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseStatus{}

// SupportCaseStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _SupportCaseStatus SupportCaseStatus
...
func (o SupportCaseStatus) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseStatus) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseStatus) UnmarshalJSON(data []byte) (err error) {
	varSupportCaseStatus := _SupportCaseStatus{}

	err = json.Unmarshal(data, &varSupportCaseStatus)

	if err != nil {
		return err
	}

	*o = SupportCaseStatus(varSupportCaseStatus)
...
type NullableSupportCaseStatus struct {
	value *SupportCaseStatus
	isSet bool
}

func (v NullableSupportCaseStatus) Get() *SupportCaseStatus {
	return v.value
}

func (v *NullableSupportCaseStatus) Set(val *SupportCaseStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseStatus(val *SupportCaseStatus) *NullableSupportCaseStatus {
	return &NullableSupportCaseStatus{value: val, isSet: true}
}

func (v NullableSupportCaseStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
