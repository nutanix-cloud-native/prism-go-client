...
// checks if the NgtPolicyListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicyListIntentResponse{}

// NgtPolicyListIntentResponse Response object for intentful operation of ngt_policys
type NgtPolicyListIntentResponse struct {
	Entities []NgtPolicyIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata NgtPolicyListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _NgtPolicyListIntentResponse NgtPolicyListIntentResponse
...
func NewNgtPolicyListIntentResponse(apiVersion string, metadata NgtPolicyListMetadataOutput) *NgtPolicyListIntentResponse {
	this := NgtPolicyListIntentResponse{}
...
func (o *NgtPolicyListIntentResponse) GetEntities() []NgtPolicyIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []NgtPolicyIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []NgtPolicyIntentResource and assigns it to the Entities field.
...
func (o *NgtPolicyListIntentResponse) GetMetadata() NgtPolicyListMetadataOutput {
	if o == nil {
		var ret NgtPolicyListMetadataOutput
		return ret
	}
...
func (o NgtPolicyListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicyListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicyListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtPolicyListIntentResponse := _NgtPolicyListIntentResponse{}

	err = json.Unmarshal(data, &varNgtPolicyListIntentResponse)

	if err != nil {
		return err
	}

	*o = NgtPolicyListIntentResponse(varNgtPolicyListIntentResponse)
...
type NullableNgtPolicyListIntentResponse struct {
	value *NgtPolicyListIntentResponse
	isSet bool
}

func (v NullableNgtPolicyListIntentResponse) Get() *NgtPolicyListIntentResponse {
	return v.value
}

func (v *NullableNgtPolicyListIntentResponse) Set(val *NgtPolicyListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicyListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicyListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicyListIntentResponse(val *NgtPolicyListIntentResponse) *NullableNgtPolicyListIntentResponse {
	return &NullableNgtPolicyListIntentResponse{value: val, isSet: true}
}

func (v NullableNgtPolicyListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicyListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
