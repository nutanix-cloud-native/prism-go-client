...
// checks if the VgRecoveryPointReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VgRecoveryPointReference{}

// VgRecoveryPointReference The reference to a vg_recovery_point
type VgRecoveryPointReference struct {
	// The kind name
...
type _VgRecoveryPointReference VgRecoveryPointReference
...
func (o VgRecoveryPointReference) MarshalJSON() ([]byte, error) {
...
func (o VgRecoveryPointReference) ToMap() (map[string]interface{}, error) {
...
func (o *VgRecoveryPointReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVgRecoveryPointReference := _VgRecoveryPointReference{}

	err = json.Unmarshal(data, &varVgRecoveryPointReference)

	if err != nil {
		return err
	}

	*o = VgRecoveryPointReference(varVgRecoveryPointReference)
...
type NullableVgRecoveryPointReference struct {
	value *VgRecoveryPointReference
	isSet bool
}

func (v NullableVgRecoveryPointReference) Get() *VgRecoveryPointReference {
	return v.value
}

func (v *NullableVgRecoveryPointReference) Set(val *VgRecoveryPointReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVgRecoveryPointReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVgRecoveryPointReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVgRecoveryPointReference(val *VgRecoveryPointReference) *NullableVgRecoveryPointReference {
	return &NullableVgRecoveryPointReference{value: val, isSet: true}
}

func (v NullableVgRecoveryPointReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVgRecoveryPointReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
