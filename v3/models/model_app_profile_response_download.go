...
// checks if the AppProfileResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppProfileResponseDownload{}

// AppProfileResponseDownload App profile resources
type AppProfileResponseDownload struct {
	// 
	DeploymentCreateList []BlueprintDeploymentResponseDownload `json:"deployment_create_list,omitempty"`
	// 
	...
	DependencyList []BlueprintDependencyList `json:"dependency_list"`
	// 
...
type _AppProfileResponseDownload AppProfileResponseDownload
...
func NewAppProfileResponseDownload(name string, state string, messageList []MessageResource, dependencyList []BlueprintDependencyList) *AppProfileResponseDownload {
	this := AppProfileResponseDownload{}
	this.Name = name
	this.State = state
...
// GetDeploymentCreateList returns the DeploymentCreateList field value if set, zero value otherwise.
func (o *AppProfileResponseDownload) GetDeploymentCreateList() []BlueprintDeploymentResponseDownload {
	if o == nil || IsNil(o.DeploymentCreateList) {
		var ret []BlueprintDeploymentResponseDownload
		return ret
	}
	return o.DeploymentCreateList
}

// GetDeploymentCreateListOk returns a tuple with the DeploymentCreateList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppProfileResponseDownload) GetDeploymentCreateListOk() ([]BlueprintDeploymentResponseDownload, bool) {
	if o == nil || IsNil(o.DeploymentCreateList) {
		return nil, false
	}
	return o.DeploymentCreateList, true
}
...
// SetDeploymentCreateList gets a reference to the given []BlueprintDeploymentResponseDownload and assigns it to the DeploymentCreateList field.
func (o *AppProfileResponseDownload) SetDeploymentCreateList(v []BlueprintDeploymentResponseDownload) {
	o.DeploymentCreateList = v
}
...
// GetDependencyList returns the DependencyList field value
...
// GetDependencyListOk returns a tuple with the DependencyList field value
// and a boolean to check if the value has been set.
...
// SetDependencyList sets field value
...
func (o AppProfileResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o AppProfileResponseDownload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DeploymentCreateList) {
		toSerialize["deployment_create_list"] = o.DeploymentCreateList
	}
...
func (o *AppProfileResponseDownload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppProfileResponseDownload := _AppProfileResponseDownload{}

	err = json.Unmarshal(data, &varAppProfileResponseDownload)

	if err != nil {
		return err
	}

	*o = AppProfileResponseDownload(varAppProfileResponseDownload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "deployment_create_list")
...
type NullableAppProfileResponseDownload struct {
	value *AppProfileResponseDownload
	isSet bool
}

func (v NullableAppProfileResponseDownload) Get() *AppProfileResponseDownload {
	return v.value
}

func (v *NullableAppProfileResponseDownload) Set(val *AppProfileResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppProfileResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppProfileResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppProfileResponseDownload(val *AppProfileResponseDownload) *NullableAppProfileResponseDownload {
	return &NullableAppProfileResponseDownload{value: val, isSet: true}
}

func (v NullableAppProfileResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppProfileResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
