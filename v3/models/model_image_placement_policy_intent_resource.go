...
// checks if the ImagePlacementPolicyIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyIntentResource{}

// ImagePlacementPolicyIntentResource Response object for intentful operations on a image_placement_policy
type ImagePlacementPolicyIntentResource struct {
	Status *ImagePlacementPolicyDefStatus `json:"status,omitempty"`
	Spec *ImagePlacementPolicy `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata ImagePlacementPolicyMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ImagePlacementPolicyIntentResource ImagePlacementPolicyIntentResource
...
func NewImagePlacementPolicyIntentResource(metadata ImagePlacementPolicyMetadata) *ImagePlacementPolicyIntentResource {
	this := ImagePlacementPolicyIntentResource{}
...
func (o *ImagePlacementPolicyIntentResource) GetStatus() ImagePlacementPolicyDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret ImagePlacementPolicyDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ImagePlacementPolicyDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given ImagePlacementPolicy and assigns it to the Spec field.
...
func (o *ImagePlacementPolicyIntentResource) GetMetadata() ImagePlacementPolicyMetadata {
	if o == nil {
		var ret ImagePlacementPolicyMetadata
		return ret
	}
...
func (o ImagePlacementPolicyIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicyIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varImagePlacementPolicyIntentResource := _ImagePlacementPolicyIntentResource{}

	err = json.Unmarshal(data, &varImagePlacementPolicyIntentResource)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyIntentResource(varImagePlacementPolicyIntentResource)
...
type NullableImagePlacementPolicyIntentResource struct {
	value *ImagePlacementPolicyIntentResource
	isSet bool
}

func (v NullableImagePlacementPolicyIntentResource) Get() *ImagePlacementPolicyIntentResource {
	return v.value
}

func (v *NullableImagePlacementPolicyIntentResource) Set(val *ImagePlacementPolicyIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyIntentResource(val *ImagePlacementPolicyIntentResource) *NullableImagePlacementPolicyIntentResource {
	return &NullableImagePlacementPolicyIntentResource{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
