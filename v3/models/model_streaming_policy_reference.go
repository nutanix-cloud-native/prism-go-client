...
// checks if the StreamingPolicyReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyReference{}

// StreamingPolicyReference The reference to a streaming_policy
type StreamingPolicyReference struct {
	// The kind name
...
type _StreamingPolicyReference StreamingPolicyReference
...
func (o StreamingPolicyReference) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyReference) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicyReference) UnmarshalJSON(data []byte) (err error) {
	...
	varStreamingPolicyReference := _StreamingPolicyReference{}

	err = json.Unmarshal(data, &varStreamingPolicyReference)

	if err != nil {
		return err
	}

	*o = StreamingPolicyReference(varStreamingPolicyReference)
...
type NullableStreamingPolicyReference struct {
	value *StreamingPolicyReference
	isSet bool
}

func (v NullableStreamingPolicyReference) Get() *StreamingPolicyReference {
	return v.value
}

func (v *NullableStreamingPolicyReference) Set(val *StreamingPolicyReference) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyReference) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyReference(val *StreamingPolicyReference) *NullableStreamingPolicyReference {
	return &NullableStreamingPolicyReference{value: val, isSet: true}
}

func (v NullableStreamingPolicyReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
