...
// checks if the CloudTenantIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTenantIntentInput{}

// CloudTenantIntentInput An intentful representation of a cloud_tenant
type CloudTenantIntentInput struct {
	Spec CloudTenant `json:"spec"`
...
type _CloudTenantIntentInput CloudTenantIntentInput
...
func (o CloudTenantIntentInput) MarshalJSON() ([]byte, error) {
...
func (o CloudTenantIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTenantIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTenantIntentInput := _CloudTenantIntentInput{}

	err = json.Unmarshal(data, &varCloudTenantIntentInput)

	if err != nil {
		return err
	}

	*o = CloudTenantIntentInput(varCloudTenantIntentInput)
...
type NullableCloudTenantIntentInput struct {
	value *CloudTenantIntentInput
	isSet bool
}

func (v NullableCloudTenantIntentInput) Get() *CloudTenantIntentInput {
	return v.value
}

func (v *NullableCloudTenantIntentInput) Set(val *CloudTenantIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTenantIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTenantIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTenantIntentInput(val *CloudTenantIntentInput) *NullableCloudTenantIntentInput {
	return &NullableCloudTenantIntentInput{value: val, isSet: true}
}

func (v NullableCloudTenantIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTenantIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
