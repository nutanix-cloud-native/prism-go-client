...
// checks if the VirtualNetworkListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkListMetadata{}

// VirtualNetworkListMetadata All api calls that return a list will have this metadata block as input 
type VirtualNetworkListMetadata struct {
	// The kind name
...
type _VirtualNetworkListMetadata VirtualNetworkListMetadata
...
func NewVirtualNetworkListMetadata() *VirtualNetworkListMetadata {
	this := VirtualNetworkListMetadata{}
...
func (o VirtualNetworkListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualNetworkListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVirtualNetworkListMetadata := _VirtualNetworkListMetadata{}

	err = json.Unmarshal(data, &varVirtualNetworkListMetadata)

	if err != nil {
		return err
	}

	*o = VirtualNetworkListMetadata(varVirtualNetworkListMetadata)
...
type NullableVirtualNetworkListMetadata struct {
	value *VirtualNetworkListMetadata
	isSet bool
}

func (v NullableVirtualNetworkListMetadata) Get() *VirtualNetworkListMetadata {
	return v.value
}

func (v *NullableVirtualNetworkListMetadata) Set(val *VirtualNetworkListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkListMetadata(val *VirtualNetworkListMetadata) *NullableVirtualNetworkListMetadata {
	return &NullableVirtualNetworkListMetadata{value: val, isSet: true}
}

func (v NullableVirtualNetworkListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
