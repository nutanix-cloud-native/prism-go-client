...
// checks if the MhVmListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmListMetadata{}

// MhVmListMetadata All api calls that return a list will have this metadata block as input 
type MhVmListMetadata struct {
	// The kind name
...
type _MhVmListMetadata MhVmListMetadata
...
func (o MhVmListMetadata) MarshalJSON() ([]byte, error) {
...
func (o MhVmListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmListMetadata) UnmarshalJSON(data []byte) (err error) {
	varMhVmListMetadata := _MhVmListMetadata{}

	err = json.Unmarshal(data, &varMhVmListMetadata)

	if err != nil {
		return err
	}

	*o = MhVmListMetadata(varMhVmListMetadata)
...
type NullableMhVmListMetadata struct {
	value *MhVmListMetadata
	isSet bool
}

func (v NullableMhVmListMetadata) Get() *MhVmListMetadata {
	return v.value
}

func (v *NullableMhVmListMetadata) Set(val *MhVmListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmListMetadata(val *MhVmListMetadata) *NullableMhVmListMetadata {
	return &NullableMhVmListMetadata{value: val, isSet: true}
}

func (v NullableMhVmListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
