...
// checks if the VpnGatewayIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayIntentInput{}

// VpnGatewayIntentInput An intentful representation of a vpn_gateway
type VpnGatewayIntentInput struct {
	Spec VpnGateway `json:"spec"`
...
type _VpnGatewayIntentInput VpnGatewayIntentInput
...
func (o VpnGatewayIntentInput) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *VpnGatewayIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnGatewayIntentInput := _VpnGatewayIntentInput{}

	err = json.Unmarshal(data, &varVpnGatewayIntentInput)

	if err != nil {
		return err
	}

	*o = VpnGatewayIntentInput(varVpnGatewayIntentInput)
...
type NullableVpnGatewayIntentInput struct {
	value *VpnGatewayIntentInput
	isSet bool
}

func (v NullableVpnGatewayIntentInput) Get() *VpnGatewayIntentInput {
	return v.value
}

func (v *NullableVpnGatewayIntentInput) Set(val *VpnGatewayIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayIntentInput(val *VpnGatewayIntentInput) *NullableVpnGatewayIntentInput {
	return &NullableVpnGatewayIntentInput{value: val, isSet: true}
}

func (v NullableVpnGatewayIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
