...
// checks if the MhVmIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmIntentResponse{}

// MhVmIntentResponse Response object for intentful operations on a mh_vm
type MhVmIntentResponse struct {
...
type _MhVmIntentResponse MhVmIntentResponse
...
func (o MhVmIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o MhVmIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMhVmIntentResponse := _MhVmIntentResponse{}

	err = json.Unmarshal(data, &varMhVmIntentResponse)

	if err != nil {
		return err
	}

	*o = MhVmIntentResponse(varMhVmIntentResponse)
...
type NullableMhVmIntentResponse struct {
	value *MhVmIntentResponse
	isSet bool
}

func (v NullableMhVmIntentResponse) Get() *MhVmIntentResponse {
	return v.value
}

func (v *NullableMhVmIntentResponse) Set(val *MhVmIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmIntentResponse(val *MhVmIntentResponse) *NullableMhVmIntentResponse {
	return &NullableMhVmIntentResponse{value: val, isSet: true}
}

func (v NullableMhVmIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
