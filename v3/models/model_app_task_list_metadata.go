...
// checks if the AppTaskListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskListMetadata{}

// AppTaskListMetadata All api calls that return a list will have this metadata block as input 
type AppTaskListMetadata struct {
	// The kind name
...
type _AppTaskListMetadata AppTaskListMetadata
...
func (o AppTaskListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AppTaskListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAppTaskListMetadata := _AppTaskListMetadata{}

	err = json.Unmarshal(data, &varAppTaskListMetadata)

	if err != nil {
		return err
	}

	*o = AppTaskListMetadata(varAppTaskListMetadata)
...
type NullableAppTaskListMetadata struct {
	value *AppTaskListMetadata
	isSet bool
}

func (v NullableAppTaskListMetadata) Get() *AppTaskListMetadata {
	return v.value
}

func (v *NullableAppTaskListMetadata) Set(val *AppTaskListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskListMetadata(val *AppTaskListMetadata) *NullableAppTaskListMetadata {
	return &NullableAppTaskListMetadata{value: val, isSet: true}
}

func (v NullableAppTaskListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
