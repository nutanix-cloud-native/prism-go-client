...
// checks if the AppTaskIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskIntentInput{}

// AppTaskIntentInput An intentful representation of a app_task
type AppTaskIntentInput struct {
	Spec AppTask `json:"spec"`
...
type _AppTaskIntentInput AppTaskIntentInput
...
func (o AppTaskIntentInput) MarshalJSON() ([]byte, error) {
...
func (o AppTaskIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskIntentInput := _AppTaskIntentInput{}

	err = json.Unmarshal(data, &varAppTaskIntentInput)

	if err != nil {
		return err
	}

	*o = AppTaskIntentInput(varAppTaskIntentInput)
...
type NullableAppTaskIntentInput struct {
	value *AppTaskIntentInput
	isSet bool
}

func (v NullableAppTaskIntentInput) Get() *AppTaskIntentInput {
	return v.value
}

func (v *NullableAppTaskIntentInput) Set(val *AppTaskIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskIntentInput(val *AppTaskIntentInput) *NullableAppTaskIntentInput {
	return &NullableAppTaskIntentInput{value: val, isSet: true}
}

func (v NullableAppTaskIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
