...
// checks if the CloudCredentialsIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCredentialsIntentInput{}

// CloudCredentialsIntentInput An intentful representation of a cloud_credentials
type CloudCredentialsIntentInput struct {
	Spec CloudCredentials `json:"spec"`
...
type _CloudCredentialsIntentInput CloudCredentialsIntentInput
...
func NewCloudCredentialsIntentInput(spec CloudCredentials, metadata CloudCredentialsMetadata) *CloudCredentialsIntentInput {
	this := CloudCredentialsIntentInput{}
	this.Spec = spec
...
func (o CloudCredentialsIntentInput) MarshalJSON() ([]byte, error) {
...
func (o CloudCredentialsIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *CloudCredentialsIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudCredentialsIntentInput := _CloudCredentialsIntentInput{}

	err = json.Unmarshal(data, &varCloudCredentialsIntentInput)

	if err != nil {
		return err
	}

	*o = CloudCredentialsIntentInput(varCloudCredentialsIntentInput)
...
type NullableCloudCredentialsIntentInput struct {
	value *CloudCredentialsIntentInput
	isSet bool
}

func (v NullableCloudCredentialsIntentInput) Get() *CloudCredentialsIntentInput {
	return v.value
}

func (v *NullableCloudCredentialsIntentInput) Set(val *CloudCredentialsIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCredentialsIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCredentialsIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCredentialsIntentInput(val *CloudCredentialsIntentInput) *NullableCloudCredentialsIntentInput {
	return &NullableCloudCredentialsIntentInput{value: val, isSet: true}
}

func (v NullableCloudCredentialsIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCredentialsIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
