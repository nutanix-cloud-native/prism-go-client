...
// checks if the DirectConnectReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectReference{}

// DirectConnectReference The reference to a direct_connect
type DirectConnectReference struct {
	// The kind name
...
type _DirectConnectReference DirectConnectReference
...
func (o DirectConnectReference) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectReference) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectReference) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectReference := _DirectConnectReference{}

	err = json.Unmarshal(data, &varDirectConnectReference)

	if err != nil {
		return err
	}

	*o = DirectConnectReference(varDirectConnectReference)
...
type NullableDirectConnectReference struct {
	value *DirectConnectReference
	isSet bool
}

func (v NullableDirectConnectReference) Get() *DirectConnectReference {
	return v.value
}

func (v *NullableDirectConnectReference) Set(val *DirectConnectReference) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectReference) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectReference(val *DirectConnectReference) *NullableDirectConnectReference {
	return &NullableDirectConnectReference{value: val, isSet: true}
}

func (v NullableDirectConnectReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
