...
// checks if the RemoteSyslogServerIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogServerIntentResource{}

// RemoteSyslogServerIntentResource Response object for intentful operations on a remote_syslog_server
type RemoteSyslogServerIntentResource struct {
...
type _RemoteSyslogServerIntentResource RemoteSyslogServerIntentResource
...
func NewRemoteSyslogServerIntentResource(metadata RemoteSyslogServerMetadata) *RemoteSyslogServerIntentResource {
	this := RemoteSyslogServerIntentResource{}
...
func (o RemoteSyslogServerIntentResource) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogServerIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogServerIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogServerIntentResource := _RemoteSyslogServerIntentResource{}

	err = json.Unmarshal(data, &varRemoteSyslogServerIntentResource)

	if err != nil {
		return err
	}

	*o = RemoteSyslogServerIntentResource(varRemoteSyslogServerIntentResource)
...
type NullableRemoteSyslogServerIntentResource struct {
	value *RemoteSyslogServerIntentResource
	isSet bool
}

func (v NullableRemoteSyslogServerIntentResource) Get() *RemoteSyslogServerIntentResource {
	return v.value
}

func (v *NullableRemoteSyslogServerIntentResource) Set(val *RemoteSyslogServerIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogServerIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogServerIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogServerIntentResource(val *RemoteSyslogServerIntentResource) *NullableRemoteSyslogServerIntentResource {
	return &NullableRemoteSyslogServerIntentResource{value: val, isSet: true}
}

func (v NullableRemoteSyslogServerIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogServerIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
