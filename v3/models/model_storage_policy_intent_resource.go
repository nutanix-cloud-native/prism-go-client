...
// checks if the StoragePolicyIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyIntentResource{}

// StoragePolicyIntentResource Response object for intentful operations on a storage_policy
type StoragePolicyIntentResource struct {
	Status *StoragePolicyDefStatus `json:"status,omitempty"`
	Spec *StoragePolicy `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata StoragePolicyMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _StoragePolicyIntentResource StoragePolicyIntentResource
...
func NewStoragePolicyIntentResource(metadata StoragePolicyMetadata) *StoragePolicyIntentResource {
	this := StoragePolicyIntentResource{}
...
func (o *StoragePolicyIntentResource) GetStatus() StoragePolicyDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret StoragePolicyDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given StoragePolicyDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given StoragePolicy and assigns it to the Spec field.
...
func (o StoragePolicyIntentResource) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePolicyIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varStoragePolicyIntentResource := _StoragePolicyIntentResource{}

	err = json.Unmarshal(data, &varStoragePolicyIntentResource)

	if err != nil {
		return err
	}

	*o = StoragePolicyIntentResource(varStoragePolicyIntentResource)
...
type NullableStoragePolicyIntentResource struct {
	value *StoragePolicyIntentResource
	isSet bool
}

func (v NullableStoragePolicyIntentResource) Get() *StoragePolicyIntentResource {
	return v.value
}

func (v *NullableStoragePolicyIntentResource) Set(val *StoragePolicyIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyIntentResource(val *StoragePolicyIntentResource) *NullableStoragePolicyIntentResource {
	return &NullableStoragePolicyIntentResource{value: val, isSet: true}
}

func (v NullableStoragePolicyIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
