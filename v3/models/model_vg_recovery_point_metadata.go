...
// checks if the VgRecoveryPointMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VgRecoveryPointMetadata{}

// VgRecoveryPointMetadata The vg_recovery_point kind metadata
type VgRecoveryPointMetadata struct {
	// UTC date and time in RFC-3339 format when vg_recovery_point was last updated 
	...
	// UTC date and time in RFC-3339 format when vg_recovery_point was created 
	...
	// Categories for the vg_recovery_point. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the vg_recovery_point. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// vg_recovery_point name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VgRecoveryPointMetadata VgRecoveryPointMetadata
...
func (o *VgRecoveryPointMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *VgRecoveryPointMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *VgRecoveryPointMetadata) SetName(v string) {
	o.Name = &v
}

func (o VgRecoveryPointMetadata) MarshalJSON() ([]byte, error) {
...
func (o VgRecoveryPointMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VgRecoveryPointMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVgRecoveryPointMetadata := _VgRecoveryPointMetadata{}

	err = json.Unmarshal(data, &varVgRecoveryPointMetadata)

	if err != nil {
		return err
	}

	*o = VgRecoveryPointMetadata(varVgRecoveryPointMetadata)
...
type NullableVgRecoveryPointMetadata struct {
	value *VgRecoveryPointMetadata
	isSet bool
}

func (v NullableVgRecoveryPointMetadata) Get() *VgRecoveryPointMetadata {
	return v.value
}

func (v *NullableVgRecoveryPointMetadata) Set(val *VgRecoveryPointMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVgRecoveryPointMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVgRecoveryPointMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVgRecoveryPointMetadata(val *VgRecoveryPointMetadata) *NullableVgRecoveryPointMetadata {
	return &NullableVgRecoveryPointMetadata{value: val, isSet: true}
}

func (v NullableVgRecoveryPointMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVgRecoveryPointMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
