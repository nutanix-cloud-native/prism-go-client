...
// checks if the DirectoryServiceSearchResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceSearchResponse{}
...
type DirectoryServiceSearchResponse struct {
	SearchResultList []Entity `json:"search_result_list,omitempty"`
	// The domain name of the directory service.
	DomainName *string `json:"domain_name,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata *DirectoryServiceSearchMetadata `json:"metadata,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DirectoryServiceSearchResponse DirectoryServiceSearchResponse
...
func NewDirectoryServiceSearchResponse() *DirectoryServiceSearchResponse {
	this := DirectoryServiceSearchResponse{}
	return &this
}
...
// GetSearchResultList returns the SearchResultList field value if set, zero value otherwise.
func (o *DirectoryServiceSearchResponse) GetSearchResultList() []Entity {
	if o == nil || IsNil(o.SearchResultList) {
		var ret []Entity
		return ret
	}
	return o.SearchResultList
}

// GetSearchResultListOk returns a tuple with the SearchResultList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectoryServiceSearchResponse) GetSearchResultListOk() ([]Entity, bool) {
	if o == nil || IsNil(o.SearchResultList) {
		return nil, false
	}
	return o.SearchResultList, true
}
...
// SetSearchResultList gets a reference to the given []Entity and assigns it to the SearchResultList field.
func (o *DirectoryServiceSearchResponse) SetSearchResultList(v []Entity) {
	o.SearchResultList = v
}
...
func (o *DirectoryServiceSearchResponse) GetMetadata() DirectoryServiceSearchMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret DirectoryServiceSearchMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given DirectoryServiceSearchMetadata and assigns it to the Metadata field.
func (o *DirectoryServiceSearchResponse) SetMetadata(v DirectoryServiceSearchMetadata) {
	o.Metadata = &v
}

func (o DirectoryServiceSearchResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceSearchResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SearchResultList) {
		toSerialize["search_result_list"] = o.SearchResultList
	}
...
func (o *DirectoryServiceSearchResponse) UnmarshalJSON(data []byte) (err error) {
	varDirectoryServiceSearchResponse := _DirectoryServiceSearchResponse{}

	err = json.Unmarshal(data, &varDirectoryServiceSearchResponse)

	if err != nil {
		return err
	}

	*o = DirectoryServiceSearchResponse(varDirectoryServiceSearchResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "search_result_list")
...
type NullableDirectoryServiceSearchResponse struct {
	value *DirectoryServiceSearchResponse
	isSet bool
}

func (v NullableDirectoryServiceSearchResponse) Get() *DirectoryServiceSearchResponse {
	return v.value
}

func (v *NullableDirectoryServiceSearchResponse) Set(val *DirectoryServiceSearchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceSearchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceSearchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceSearchResponse(val *DirectoryServiceSearchResponse) *NullableDirectoryServiceSearchResponse {
	return &NullableDirectoryServiceSearchResponse{value: val, isSet: true}
}

func (v NullableDirectoryServiceSearchResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceSearchResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
