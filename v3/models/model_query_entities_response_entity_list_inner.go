...
// checks if the QueryEntitiesResponseEntityListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryEntitiesResponseEntityListInner{}

// QueryEntitiesResponseEntityListInner struct for QueryEntitiesResponseEntityListInner
type QueryEntitiesResponseEntityListInner struct {
	// List of errors because of which protection of entity is not possible. 
	ErrorReasonList []QueryEntitiesResponseEntityListInnerErrorReasonListInner `json:"error_reason_list,omitempty"`
	EntityReference *Reference `json:"entity_reference,omitempty"`
	// Protection status of the entity. CAN_BE_PROTECTED would mean that there are no errors for this entity and it can be protected. PROTECTED status would mean that the entity is protected by the same protection policy passed in the arg. PARTIALLY_PROTECTED would mean that the entity is protected by the same protection policy passed in the arg but also has some errors or warnings associated with it. CANNOT_BE_PROTECTED would mean that the entities aren't protected by the protection policy passed in the arg and have errors associated with it. CAN_BE_PARTIALLY_PROTECTED would mean that entity can be protected but has some warnings associated with it. 
	ProtectionStatus *string `json:"protection_status,omitempty"`
	ProtectionRuleReference *ProtectionRuleReference `json:"protection_rule_reference,omitempty"`
	// List of warnings associated with the entity that needs to be protected. 
	WarningReasonList []QueryEntitiesResponseEntityListInnerWarningReasonListInner `json:"warning_reason_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QueryEntitiesResponseEntityListInner QueryEntitiesResponseEntityListInner
...
func NewQueryEntitiesResponseEntityListInner() *QueryEntitiesResponseEntityListInner {
	this := QueryEntitiesResponseEntityListInner{}
	return &this
}
...
// GetErrorReasonList returns the ErrorReasonList field value if set, zero value otherwise.
func (o *QueryEntitiesResponseEntityListInner) GetErrorReasonList() []QueryEntitiesResponseEntityListInnerErrorReasonListInner {
	if o == nil || IsNil(o.ErrorReasonList) {
		var ret []QueryEntitiesResponseEntityListInnerErrorReasonListInner
		return ret
	}
	return o.ErrorReasonList
}

// GetErrorReasonListOk returns a tuple with the ErrorReasonList field value if set, nil otherwise
...
// SetErrorReasonList gets a reference to the given []QueryEntitiesResponseEntityListInnerErrorReasonListInner and assigns it to the ErrorReasonList field.
...
// GetProtectionRuleReference returns the ProtectionRuleReference field value if set, zero value otherwise.
func (o *QueryEntitiesResponseEntityListInner) GetProtectionRuleReference() ProtectionRuleReference {
	if o == nil || IsNil(o.ProtectionRuleReference) {
		var ret ProtectionRuleReference
		return ret
	}
	return *o.ProtectionRuleReference
}

// GetProtectionRuleReferenceOk returns a tuple with the ProtectionRuleReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QueryEntitiesResponseEntityListInner) GetProtectionRuleReferenceOk() (*ProtectionRuleReference, bool) {
	if o == nil || IsNil(o.ProtectionRuleReference) {
		return nil, false
	}
	return o.ProtectionRuleReference, true
}
...
// SetProtectionRuleReference gets a reference to the given ProtectionRuleReference and assigns it to the ProtectionRuleReference field.
func (o *QueryEntitiesResponseEntityListInner) SetProtectionRuleReference(v ProtectionRuleReference) {
	o.ProtectionRuleReference = &v
}

// GetWarningReasonList returns the WarningReasonList field value if set, zero value otherwise.
func (o *QueryEntitiesResponseEntityListInner) GetWarningReasonList() []QueryEntitiesResponseEntityListInnerWarningReasonListInner {
	if o == nil || IsNil(o.WarningReasonList) {
		var ret []QueryEntitiesResponseEntityListInnerWarningReasonListInner
		return ret
	}
	return o.WarningReasonList
}

// GetWarningReasonListOk returns a tuple with the WarningReasonList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QueryEntitiesResponseEntityListInner) GetWarningReasonListOk() ([]QueryEntitiesResponseEntityListInnerWarningReasonListInner, bool) {
	...
	return o.WarningReasonList, true
}
...
// SetWarningReasonList gets a reference to the given []QueryEntitiesResponseEntityListInnerWarningReasonListInner and assigns it to the WarningReasonList field.
func (o *QueryEntitiesResponseEntityListInner) SetWarningReasonList(v []QueryEntitiesResponseEntityListInnerWarningReasonListInner) {
	o.WarningReasonList = v
}

func (o QueryEntitiesResponseEntityListInner) MarshalJSON() ([]byte, error) {
...
func (o QueryEntitiesResponseEntityListInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ErrorReasonList) {
		toSerialize["error_reason_list"] = o.ErrorReasonList
	}
	...
	if !IsNil(o.ProtectionRuleReference) {
		toSerialize["protection_rule_reference"] = o.ProtectionRuleReference
	}
	if !IsNil(o.WarningReasonList) {
		toSerialize["warning_reason_list"] = o.WarningReasonList
	}
...
func (o *QueryEntitiesResponseEntityListInner) UnmarshalJSON(data []byte) (err error) {
	varQueryEntitiesResponseEntityListInner := _QueryEntitiesResponseEntityListInner{}

	err = json.Unmarshal(data, &varQueryEntitiesResponseEntityListInner)

	if err != nil {
		return err
	}

	*o = QueryEntitiesResponseEntityListInner(varQueryEntitiesResponseEntityListInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "error_reason_list")
		delete(additionalProperties, "entity_reference")
		delete(additionalProperties, "protection_status")
		delete(additionalProperties, "protection_rule_reference")
		delete(additionalProperties, "warning_reason_list")
...
type NullableQueryEntitiesResponseEntityListInner struct {
	value *QueryEntitiesResponseEntityListInner
	isSet bool
}

func (v NullableQueryEntitiesResponseEntityListInner) Get() *QueryEntitiesResponseEntityListInner {
	return v.value
}

func (v *NullableQueryEntitiesResponseEntityListInner) Set(val *QueryEntitiesResponseEntityListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryEntitiesResponseEntityListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryEntitiesResponseEntityListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryEntitiesResponseEntityListInner(val *QueryEntitiesResponseEntityListInner) *NullableQueryEntitiesResponseEntityListInner {
	return &NullableQueryEntitiesResponseEntityListInner{value: val, isSet: true}
}

func (v NullableQueryEntitiesResponseEntityListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryEntitiesResponseEntityListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
