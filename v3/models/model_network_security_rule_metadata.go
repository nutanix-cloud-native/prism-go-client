...
// checks if the NetworkSecurityRuleMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleMetadata{}

// NetworkSecurityRuleMetadata The network_security_rule kind metadata
type NetworkSecurityRuleMetadata struct {
	...
	// Categories for the network_security_rule. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the network_security_rule. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// network_security_rule name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NetworkSecurityRuleMetadata NetworkSecurityRuleMetadata
...
func NewNetworkSecurityRuleMetadata(kind string) *NetworkSecurityRuleMetadata {
	this := NetworkSecurityRuleMetadata{}
...
func (o NetworkSecurityRuleMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRuleMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkSecurityRuleMetadata := _NetworkSecurityRuleMetadata{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleMetadata)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleMetadata(varNetworkSecurityRuleMetadata)
...
type NullableNetworkSecurityRuleMetadata struct {
	value *NetworkSecurityRuleMetadata
	isSet bool
}

func (v NullableNetworkSecurityRuleMetadata) Get() *NetworkSecurityRuleMetadata {
	return v.value
}

func (v *NullableNetworkSecurityRuleMetadata) Set(val *NetworkSecurityRuleMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleMetadata(val *NetworkSecurityRuleMetadata) *NullableNetworkSecurityRuleMetadata {
	return &NullableNetworkSecurityRuleMetadata{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
