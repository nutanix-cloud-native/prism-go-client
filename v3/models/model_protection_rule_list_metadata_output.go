...
// checks if the ProtectionRuleListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleListMetadataOutput{}

// ProtectionRuleListMetadataOutput All api calls that return a list will have this metadata block 
type ProtectionRuleListMetadataOutput struct {
	// The kind name
...
type _ProtectionRuleListMetadataOutput ProtectionRuleListMetadataOutput
...
func NewProtectionRuleListMetadataOutput() *ProtectionRuleListMetadataOutput {
	this := ProtectionRuleListMetadataOutput{}
	var kind string = "protection_rule"
	this.Kind = &kind
	return &this
}
...
func (o ProtectionRuleListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionRuleListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varProtectionRuleListMetadataOutput := _ProtectionRuleListMetadataOutput{}

	err = json.Unmarshal(data, &varProtectionRuleListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ProtectionRuleListMetadataOutput(varProtectionRuleListMetadataOutput)
...
type NullableProtectionRuleListMetadataOutput struct {
	value *ProtectionRuleListMetadataOutput
	isSet bool
}

func (v NullableProtectionRuleListMetadataOutput) Get() *ProtectionRuleListMetadataOutput {
	return v.value
}

func (v *NullableProtectionRuleListMetadataOutput) Set(val *ProtectionRuleListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleListMetadataOutput(val *ProtectionRuleListMetadataOutput) *NullableProtectionRuleListMetadataOutput {
	return &NullableProtectionRuleListMetadataOutput{value: val, isSet: true}
}

func (v NullableProtectionRuleListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
