...
// checks if the BlueprintMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintMetadata{}

// BlueprintMetadata The blueprint kind metadata
type BlueprintMetadata struct {
	...
	// Categories for the blueprint. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the blueprint. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _BlueprintMetadata BlueprintMetadata
...
func (o *BlueprintMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *BlueprintMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *BlueprintMetadata) SetName(v string) {
	o.Name = &v
}

func (o BlueprintMetadata) MarshalJSON() ([]byte, error) {
...
func (o BlueprintMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintMetadata := _BlueprintMetadata{}

	err = json.Unmarshal(data, &varBlueprintMetadata)

	if err != nil {
		return err
	}

	*o = BlueprintMetadata(varBlueprintMetadata)
...
type NullableBlueprintMetadata struct {
	value *BlueprintMetadata
	isSet bool
}

func (v NullableBlueprintMetadata) Get() *BlueprintMetadata {
	return v.value
}

func (v *NullableBlueprintMetadata) Set(val *BlueprintMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintMetadata(val *BlueprintMetadata) *NullableBlueprintMetadata {
	return &NullableBlueprintMetadata{value: val, isSet: true}
}

func (v NullableBlueprintMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
