...
// checks if the DirectConnectStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectStatus{}

// DirectConnectStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _DirectConnectStatus DirectConnectStatus
...
func (o DirectConnectStatus) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectStatus) UnmarshalJSON(data []byte) (err error) {
	varDirectConnectStatus := _DirectConnectStatus{}

	err = json.Unmarshal(data, &varDirectConnectStatus)

	if err != nil {
		return err
	}

	*o = DirectConnectStatus(varDirectConnectStatus)
...
type NullableDirectConnectStatus struct {
	value *DirectConnectStatus
	isSet bool
}

func (v NullableDirectConnectStatus) Get() *DirectConnectStatus {
	return v.value
}

func (v *NullableDirectConnectStatus) Set(val *DirectConnectStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectStatus(val *DirectConnectStatus) *NullableDirectConnectStatus {
	return &NullableDirectConnectStatus{value: val, isSet: true}
}

func (v NullableDirectConnectStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
