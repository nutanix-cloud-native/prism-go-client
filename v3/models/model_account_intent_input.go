...
// checks if the AccountIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountIntentInput{}

// AccountIntentInput An intentful representation of a account
type AccountIntentInput struct {
	Spec Account `json:"spec"`
...
type _AccountIntentInput AccountIntentInput
...
func (o AccountIntentInput) MarshalJSON() ([]byte, error) {
...
func (o AccountIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *AccountIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountIntentInput := _AccountIntentInput{}

	err = json.Unmarshal(data, &varAccountIntentInput)

	if err != nil {
		return err
	}

	*o = AccountIntentInput(varAccountIntentInput)
...
type NullableAccountIntentInput struct {
	value *AccountIntentInput
	isSet bool
}

func (v NullableAccountIntentInput) Get() *AccountIntentInput {
	return v.value
}

func (v *NullableAccountIntentInput) Set(val *AccountIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountIntentInput(val *AccountIntentInput) *NullableAccountIntentInput {
	return &NullableAccountIntentInput{value: val, isSet: true}
}

func (v NullableAccountIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
