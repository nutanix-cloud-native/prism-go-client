...
type IpConfig struct {
	...
	// Subnet IP address.
	SubnetIp *string `json:"subnet_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
...
// GetDhcpServerAddress returns the DhcpServerAddress field value if set, zero value otherwise.
func (o *IpConfig) GetDhcpServerAddress() Address {
	if o == nil || IsNil(o.DhcpServerAddress) {
		var ret Address
		return ret
	}
	return *o.DhcpServerAddress
}

// GetDhcpServerAddressOk returns a tuple with the DhcpServerAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpConfig) GetDhcpServerAddressOk() (*Address, bool) {
	if o == nil || IsNil(o.DhcpServerAddress) {
		return nil, false
	}
	return o.DhcpServerAddress, true
}
...
// SetDhcpServerAddress gets a reference to the given Address and assigns it to the DhcpServerAddress field.
func (o *IpConfig) SetDhcpServerAddress(v Address) {
	o.DhcpServerAddress = &v
}
...
// SetPoolList gets a reference to the given []IpPool and assigns it to the PoolList field.
...
// SetDhcpOptions gets a reference to the given DhcpOptions and assigns it to the DhcpOptions field.
...
func (o IpConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DhcpServerAddress) {
		toSerialize["dhcp_server_address"] = o.DhcpServerAddress
	}
	if !IsNil(o.PoolList) {
...
func (o *IpConfig) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIpConfig)
	...
	*o = IpConfig(varIpConfig)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "dhcp_server_address")
		delete(additionalProperties, "pool_list")
		delete(additionalProperties, "prefix_length")
		delete(additionalProperties, "subnet_ip")
