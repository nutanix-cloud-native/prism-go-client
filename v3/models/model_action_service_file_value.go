...
// checks if the ActionServiceFileValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionServiceFileValue{}

// ActionServiceFileValue File value
type ActionServiceFileValue struct {
	// File data
	FileData *string `json:"file_data,omitempty"`
	// File name
	FileName *string `json:"file_name,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
	AdditionalProperties map[string]interface{}
}

type _ActionServiceFileValue ActionServiceFileValue
...
func (o ActionServiceFileValue) MarshalJSON() ([]byte, error) {
...
func (o ActionServiceFileValue) ToMap() (map[string]interface{}, error) {
...
func (o *ActionServiceFileValue) UnmarshalJSON(data []byte) (err error) {
	varActionServiceFileValue := _ActionServiceFileValue{}

	err = json.Unmarshal(data, &varActionServiceFileValue)

	if err != nil {
		return err
	}

	*o = ActionServiceFileValue(varActionServiceFileValue)
...
type NullableActionServiceFileValue struct {
	value *ActionServiceFileValue
	isSet bool
}

func (v NullableActionServiceFileValue) Get() *ActionServiceFileValue {
	return v.value
}

func (v *NullableActionServiceFileValue) Set(val *ActionServiceFileValue) {
	v.value = val
	v.isSet = true
}

func (v NullableActionServiceFileValue) IsSet() bool {
	return v.isSet
}

func (v *NullableActionServiceFileValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionServiceFileValue(val *ActionServiceFileValue) *NullableActionServiceFileValue {
	return &NullableActionServiceFileValue{value: val, isSet: true}
}

func (v NullableActionServiceFileValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionServiceFileValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
