...
// checks if the DiskMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskMetadata{}

// DiskMetadata The disk kind metadata
type DiskMetadata struct {
	...
	// Categories for the disk. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the disk. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _DiskMetadata DiskMetadata
...
func (o *DiskMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *DiskMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *DiskMetadata) SetName(v string) {
	o.Name = &v
}
...
func (o DiskMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DiskMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varDiskMetadata := _DiskMetadata{}

	err = json.Unmarshal(data, &varDiskMetadata)

	if err != nil {
		return err
	}

	*o = DiskMetadata(varDiskMetadata)
