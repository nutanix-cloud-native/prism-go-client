...
// checks if the CustomizationSpecListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomizationSpecListMetadataOutput{}

// CustomizationSpecListMetadataOutput All api calls that return a list will have this metadata block 
type CustomizationSpecListMetadataOutput struct {
	// The kind name
...
type _CustomizationSpecListMetadataOutput CustomizationSpecListMetadataOutput
...
func NewCustomizationSpecListMetadataOutput() *CustomizationSpecListMetadataOutput {
	this := CustomizationSpecListMetadataOutput{}
	var kind string = "customization_spec"
	this.Kind = &kind
	return &this
}
...
func (o *CustomizationSpecListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *CustomizationSpecListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o CustomizationSpecListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o CustomizationSpecListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *CustomizationSpecListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varCustomizationSpecListMetadataOutput := _CustomizationSpecListMetadataOutput{}

	err = json.Unmarshal(data, &varCustomizationSpecListMetadataOutput)

	if err != nil {
		return err
	}

	*o = CustomizationSpecListMetadataOutput(varCustomizationSpecListMetadataOutput)
...
type NullableCustomizationSpecListMetadataOutput struct {
	value *CustomizationSpecListMetadataOutput
	isSet bool
}

func (v NullableCustomizationSpecListMetadataOutput) Get() *CustomizationSpecListMetadataOutput {
	return v.value
}

func (v *NullableCustomizationSpecListMetadataOutput) Set(val *CustomizationSpecListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomizationSpecListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomizationSpecListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomizationSpecListMetadataOutput(val *CustomizationSpecListMetadataOutput) *NullableCustomizationSpecListMetadataOutput {
	return &NullableCustomizationSpecListMetadataOutput{value: val, isSet: true}
}

func (v NullableCustomizationSpecListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomizationSpecListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
