...
// checks if the NetworkSecurityRuleResourcesStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleResourcesStatus{}

// NetworkSecurityRuleResourcesStatus Network security rule resources
type NetworkSecurityRuleResourcesStatus struct {
...
type _NetworkSecurityRuleResourcesStatus NetworkSecurityRuleResourcesStatus
...
func NewNetworkSecurityRuleResourcesStatus() *NetworkSecurityRuleResourcesStatus {
	this := NetworkSecurityRuleResourcesStatus{}
	return &this
}
...
// GetAllowIpv6Traffic returns the AllowIpv6Traffic field value if set, zero value otherwise.
func (o *NetworkSecurityRuleResourcesStatus) GetAllowIpv6Traffic() bool {
	if o == nil || IsNil(o.AllowIpv6Traffic) {
		var ret bool
		return ret
	}
	return *o.AllowIpv6Traffic
}

// GetAllowIpv6TrafficOk returns a tuple with the AllowIpv6Traffic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkSecurityRuleResourcesStatus) GetAllowIpv6TrafficOk() (*bool, bool) {
	if o == nil || IsNil(o.AllowIpv6Traffic) {
		return nil, false
	}
	return o.AllowIpv6Traffic, true
}
...
// SetAllowIpv6Traffic gets a reference to the given bool and assigns it to the AllowIpv6Traffic field.
func (o *NetworkSecurityRuleResourcesStatus) SetAllowIpv6Traffic(v bool) {
	o.AllowIpv6Traffic = &v
}

// GetIsPolicyHitlogEnabled returns the IsPolicyHitlogEnabled field value if set, zero value otherwise.
func (o *NetworkSecurityRuleResourcesStatus) GetIsPolicyHitlogEnabled() bool {
	if o == nil || IsNil(o.IsPolicyHitlogEnabled) {
		var ret bool
		return ret
	}
	return *o.IsPolicyHitlogEnabled
}

// GetIsPolicyHitlogEnabledOk returns a tuple with the IsPolicyHitlogEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkSecurityRuleResourcesStatus) GetIsPolicyHitlogEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPolicyHitlogEnabled) {
		return nil, false
	}
	return o.IsPolicyHitlogEnabled, true
}
...
// SetIsPolicyHitlogEnabled gets a reference to the given bool and assigns it to the IsPolicyHitlogEnabled field.
func (o *NetworkSecurityRuleResourcesStatus) SetIsPolicyHitlogEnabled(v bool) {
	o.IsPolicyHitlogEnabled = &v
}

// GetQuarantineRule returns the QuarantineRule field value if set, zero value otherwise.
func (o *NetworkSecurityRuleResourcesStatus) GetQuarantineRule() QuarantineRule {
	if o == nil || IsNil(o.QuarantineRule) {
		var ret QuarantineRule
		return ret
	}
	return *o.QuarantineRule
}

// GetQuarantineRuleOk returns a tuple with the QuarantineRule field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkSecurityRuleResourcesStatus) GetQuarantineRuleOk() (*QuarantineRule, bool) {
	if o == nil || IsNil(o.QuarantineRule) {
		return nil, false
	}
	return o.QuarantineRule, true
}
...
// SetQuarantineRule gets a reference to the given QuarantineRule and assigns it to the QuarantineRule field.
func (o *NetworkSecurityRuleResourcesStatus) SetQuarantineRule(v QuarantineRule) {
	o.QuarantineRule = &v
}

// GetIsolationRule returns the IsolationRule field value if set, zero value otherwise.
func (o *NetworkSecurityRuleResourcesStatus) GetIsolationRule() IsolationRule {
	if o == nil || IsNil(o.IsolationRule) {
		var ret IsolationRule
		return ret
	}
	return *o.IsolationRule
}

// GetIsolationRuleOk returns a tuple with the IsolationRule field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkSecurityRuleResourcesStatus) GetIsolationRuleOk() (*IsolationRule, bool) {
	if o == nil || IsNil(o.IsolationRule) {
		return nil, false
	}
	return o.IsolationRule, true
}
...
// SetIsolationRule gets a reference to the given IsolationRule and assigns it to the IsolationRule field.
func (o *NetworkSecurityRuleResourcesStatus) SetIsolationRule(v IsolationRule) {
	o.IsolationRule = &v
}

// GetAppRule returns the AppRule field value if set, zero value otherwise.
func (o *NetworkSecurityRuleResourcesStatus) GetAppRule() AppRule {
	if o == nil || IsNil(o.AppRule) {
		var ret AppRule
		return ret
	}
	return *o.AppRule
...
// GetAppRuleOk returns a tuple with the AppRule field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkSecurityRuleResourcesStatus) GetAppRuleOk() (*AppRule, bool) {
	if o == nil || IsNil(o.AppRule) {
		return nil, false
	}
	return o.AppRule, true
}
...
// SetAppRule gets a reference to the given AppRule and assigns it to the AppRule field.
func (o *NetworkSecurityRuleResourcesStatus) SetAppRule(v AppRule) {
	o.AppRule = &v
}

// GetAdRule returns the AdRule field value if set, zero value otherwise.
func (o *NetworkSecurityRuleResourcesStatus) GetAdRule() ADRule {
	if o == nil || IsNil(o.AdRule) {
		var ret ADRule
		return ret
	}
	return *o.AdRule
...
// GetAdRuleOk returns a tuple with the AdRule field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkSecurityRuleResourcesStatus) GetAdRuleOk() (*ADRule, bool) {
	if o == nil || IsNil(o.AdRule) {
		return nil, false
	}
	return o.AdRule, true
}
...
// SetAdRule gets a reference to the given ADRule and assigns it to the AdRule field.
func (o *NetworkSecurityRuleResourcesStatus) SetAdRule(v ADRule) {
	o.AdRule = &v
}

func (o NetworkSecurityRuleResourcesStatus) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleResourcesStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AllowIpv6Traffic) {
		toSerialize["allow_ipv6_traffic"] = o.AllowIpv6Traffic
	}
	if !IsNil(o.IsPolicyHitlogEnabled) {
		toSerialize["is_policy_hitlog_enabled"] = o.IsPolicyHitlogEnabled
	}
	if !IsNil(o.QuarantineRule) {
		toSerialize["quarantine_rule"] = o.QuarantineRule
	}
	if !IsNil(o.IsolationRule) {
		toSerialize["isolation_rule"] = o.IsolationRule
	}
	if !IsNil(o.AppRule) {
		toSerialize["app_rule"] = o.AppRule
	}
	if !IsNil(o.AdRule) {
		toSerialize["ad_rule"] = o.AdRule
	}
...
func (o *NetworkSecurityRuleResourcesStatus) UnmarshalJSON(data []byte) (err error) {
	varNetworkSecurityRuleResourcesStatus := _NetworkSecurityRuleResourcesStatus{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleResourcesStatus)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleResourcesStatus(varNetworkSecurityRuleResourcesStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "allow_ipv6_traffic")
		delete(additionalProperties, "is_policy_hitlog_enabled")
		delete(additionalProperties, "quarantine_rule")
		delete(additionalProperties, "isolation_rule")
		delete(additionalProperties, "app_rule")
		delete(additionalProperties, "ad_rule")
...
type NullableNetworkSecurityRuleResourcesStatus struct {
	value *NetworkSecurityRuleResourcesStatus
	isSet bool
}

func (v NullableNetworkSecurityRuleResourcesStatus) Get() *NetworkSecurityRuleResourcesStatus {
	return v.value
}

func (v *NullableNetworkSecurityRuleResourcesStatus) Set(val *NetworkSecurityRuleResourcesStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleResourcesStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleResourcesStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleResourcesStatus(val *NetworkSecurityRuleResourcesStatus) *NullableNetworkSecurityRuleResourcesStatus {
	return &NullableNetworkSecurityRuleResourcesStatus{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleResourcesStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleResourcesStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
