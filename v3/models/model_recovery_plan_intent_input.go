...
// checks if the RecoveryPlanIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanIntentInput{}

// RecoveryPlanIntentInput An intentful representation of a recovery_plan
...
type _RecoveryPlanIntentInput RecoveryPlanIntentInput
...
func (o RecoveryPlanIntentInput) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanIntentInput := _RecoveryPlanIntentInput{}

	err = json.Unmarshal(data, &varRecoveryPlanIntentInput)

	if err != nil {
		return err
	}

	*o = RecoveryPlanIntentInput(varRecoveryPlanIntentInput)
...
type NullableRecoveryPlanIntentInput struct {
	value *RecoveryPlanIntentInput
	isSet bool
}

func (v NullableRecoveryPlanIntentInput) Get() *RecoveryPlanIntentInput {
	return v.value
}

func (v *NullableRecoveryPlanIntentInput) Set(val *RecoveryPlanIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanIntentInput(val *RecoveryPlanIntentInput) *NullableRecoveryPlanIntentInput {
	return &NullableRecoveryPlanIntentInput{value: val, isSet: true}
}

func (v NullableRecoveryPlanIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
