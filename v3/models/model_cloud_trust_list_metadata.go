...
// checks if the CloudTrustListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustListMetadata{}

// CloudTrustListMetadata All api calls that return a list will have this metadata block as input 
type CloudTrustListMetadata struct {
	// The kind name
...
type _CloudTrustListMetadata CloudTrustListMetadata
...
func (o CloudTrustListMetadata) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrustListMetadata) UnmarshalJSON(data []byte) (err error) {
	varCloudTrustListMetadata := _CloudTrustListMetadata{}

	err = json.Unmarshal(data, &varCloudTrustListMetadata)

	if err != nil {
		return err
	}

	*o = CloudTrustListMetadata(varCloudTrustListMetadata)
...
type NullableCloudTrustListMetadata struct {
	value *CloudTrustListMetadata
	isSet bool
}

func (v NullableCloudTrustListMetadata) Get() *CloudTrustListMetadata {
	return v.value
}

func (v *NullableCloudTrustListMetadata) Set(val *CloudTrustListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustListMetadata(val *CloudTrustListMetadata) *NullableCloudTrustListMetadata {
	return &NullableCloudTrustListMetadata{value: val, isSet: true}
}

func (v NullableCloudTrustListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
