...
// checks if the AccessControlPolicyListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyListMetadataOutput{}

// AccessControlPolicyListMetadataOutput All api calls that return a list will have this metadata block 
type AccessControlPolicyListMetadataOutput struct {
	// The kind name
...
type _AccessControlPolicyListMetadataOutput AccessControlPolicyListMetadataOutput
...
func NewAccessControlPolicyListMetadataOutput() *AccessControlPolicyListMetadataOutput {
	this := AccessControlPolicyListMetadataOutput{}
	var kind string = "access_control_policy"
	this.Kind = &kind
	return &this
}
...
func (o *AccessControlPolicyListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *AccessControlPolicyListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o AccessControlPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AccessControlPolicyListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAccessControlPolicyListMetadataOutput := _AccessControlPolicyListMetadataOutput{}

	err = json.Unmarshal(data, &varAccessControlPolicyListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyListMetadataOutput(varAccessControlPolicyListMetadataOutput)
...
type NullableAccessControlPolicyListMetadataOutput struct {
	value *AccessControlPolicyListMetadataOutput
	isSet bool
}

func (v NullableAccessControlPolicyListMetadataOutput) Get() *AccessControlPolicyListMetadataOutput {
	return v.value
}

func (v *NullableAccessControlPolicyListMetadataOutput) Set(val *AccessControlPolicyListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyListMetadataOutput(val *AccessControlPolicyListMetadataOutput) *NullableAccessControlPolicyListMetadataOutput {
	return &NullableAccessControlPolicyListMetadataOutput{value: val, isSet: true}
}

func (v NullableAccessControlPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
