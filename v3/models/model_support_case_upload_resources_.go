...
// checks if the SupportCaseUploadResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseUploadResources{}

// SupportCaseUploadResources Support Case upload resource definition.
type SupportCaseUploadResources struct {
	// Generic key value pair used for custom attributes.
	PortalRequestParams *map[string]string `json:"portal_request_params,omitempty"`
...
type _SupportCaseUploadResources SupportCaseUploadResources
...
func NewSupportCaseUploadResources() *SupportCaseUploadResources {
	this := SupportCaseUploadResources{}
	return &this
}
...
// GetPortalRequestParams returns the PortalRequestParams field value if set, zero value otherwise.
func (o *SupportCaseUploadResources) GetPortalRequestParams() map[string]string {
	if o == nil || IsNil(o.PortalRequestParams) {
		var ret map[string]string
		return ret
	}
	return *o.PortalRequestParams
}

// GetPortalRequestParamsOk returns a tuple with the PortalRequestParams field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SupportCaseUploadResources) GetPortalRequestParamsOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.PortalRequestParams) {
		return nil, false
	}
	return o.PortalRequestParams, true
}
...
// SetPortalRequestParams gets a reference to the given map[string]string and assigns it to the PortalRequestParams field.
func (o *SupportCaseUploadResources) SetPortalRequestParams(v map[string]string) {
	o.PortalRequestParams = &v
}
...
func (o SupportCaseUploadResources) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseUploadResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PortalRequestParams) {
		toSerialize["portal_request_params"] = o.PortalRequestParams
	}
...
func (o *SupportCaseUploadResources) UnmarshalJSON(data []byte) (err error) {
	varSupportCaseUploadResources := _SupportCaseUploadResources{}

	err = json.Unmarshal(data, &varSupportCaseUploadResources)

	if err != nil {
		return err
	}

	*o = SupportCaseUploadResources(varSupportCaseUploadResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "portal_request_params")
...
type NullableSupportCaseUploadResources struct {
	value *SupportCaseUploadResources
	isSet bool
}

func (v NullableSupportCaseUploadResources) Get() *SupportCaseUploadResources {
	return v.value
}

func (v *NullableSupportCaseUploadResources) Set(val *SupportCaseUploadResources) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseUploadResources) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseUploadResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseUploadResources(val *SupportCaseUploadResources) *NullableSupportCaseUploadResources {
	return &NullableSupportCaseUploadResources{value: val, isSet: true}
}

func (v NullableSupportCaseUploadResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseUploadResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
