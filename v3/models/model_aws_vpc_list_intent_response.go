...
// checks if the AwsVpcListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVpcListIntentResponse{}

// AwsVpcListIntentResponse AWS VPC entity list.
type AwsVpcListIntentResponse struct {
	Entities []AwsVpcIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsVpcListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsVpcListIntentResponse AwsVpcListIntentResponse
...
// SetEntities gets a reference to the given []AwsVpcIntentResource and assigns it to the Entities field.
...
func (o *AwsVpcListIntentResponse) GetMetadata() AwsVpcListMetadataOutput {
	if o == nil {
		var ret AwsVpcListMetadataOutput
		return ret
	}
...
func (o AwsVpcListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsVpcListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVpcListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVpcListIntentResponse := _AwsVpcListIntentResponse{}

	err = json.Unmarshal(data, &varAwsVpcListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsVpcListIntentResponse(varAwsVpcListIntentResponse)
...
type NullableAwsVpcListIntentResponse struct {
	value *AwsVpcListIntentResponse
	isSet bool
}

func (v NullableAwsVpcListIntentResponse) Get() *AwsVpcListIntentResponse {
	return v.value
}

func (v *NullableAwsVpcListIntentResponse) Set(val *AwsVpcListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVpcListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVpcListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVpcListIntentResponse(val *AwsVpcListIntentResponse) *NullableAwsVpcListIntentResponse {
	return &NullableAwsVpcListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsVpcListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVpcListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
