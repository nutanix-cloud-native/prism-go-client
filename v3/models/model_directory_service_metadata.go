...
// checks if the DirectoryServiceMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceMetadata{}

// DirectoryServiceMetadata The directory_service kind metadata
type DirectoryServiceMetadata struct {
	...
	// Categories for the directory_service. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the directory_service. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _DirectoryServiceMetadata DirectoryServiceMetadata
...
func (o *DirectoryServiceMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *DirectoryServiceMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *DirectoryServiceMetadata) SetName(v string) {
	o.Name = &v
}

func (o DirectoryServiceMetadata) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryServiceMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectoryServiceMetadata := _DirectoryServiceMetadata{}

	err = json.Unmarshal(data, &varDirectoryServiceMetadata)

	if err != nil {
		return err
	}

	*o = DirectoryServiceMetadata(varDirectoryServiceMetadata)
...
type NullableDirectoryServiceMetadata struct {
	value *DirectoryServiceMetadata
	isSet bool
}

func (v NullableDirectoryServiceMetadata) Get() *DirectoryServiceMetadata {
	return v.value
}

func (v *NullableDirectoryServiceMetadata) Set(val *DirectoryServiceMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceMetadata(val *DirectoryServiceMetadata) *NullableDirectoryServiceMetadata {
	return &NullableDirectoryServiceMetadata{value: val, isSet: true}
}

func (v NullableDirectoryServiceMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
