...
// checks if the ActionTemplateIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTemplateIntentInput{}

// ActionTemplateIntentInput An intentful representation of a action_template
type ActionTemplateIntentInput struct {
	Spec ActionTemplate `json:"spec"`
...
type _ActionTemplateIntentInput ActionTemplateIntentInput
...
func NewActionTemplateIntentInput(spec ActionTemplate, metadata ActionTemplateMetadata) *ActionTemplateIntentInput {
	this := ActionTemplateIntentInput{}
	this.Spec = spec
...
func (o ActionTemplateIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ActionTemplateIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTemplateIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTemplateIntentInput := _ActionTemplateIntentInput{}

	err = json.Unmarshal(data, &varActionTemplateIntentInput)

	if err != nil {
		return err
	}

	*o = ActionTemplateIntentInput(varActionTemplateIntentInput)
...
type NullableActionTemplateIntentInput struct {
	value *ActionTemplateIntentInput
	isSet bool
}

func (v NullableActionTemplateIntentInput) Get() *ActionTemplateIntentInput {
	return v.value
}

func (v *NullableActionTemplateIntentInput) Set(val *ActionTemplateIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTemplateIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTemplateIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTemplateIntentInput(val *ActionTemplateIntentInput) *NullableActionTemplateIntentInput {
	return &NullableActionTemplateIntentInput{value: val, isSet: true}
}

func (v NullableActionTemplateIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTemplateIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
