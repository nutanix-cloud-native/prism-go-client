...
// checks if the CategoryMappingIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingIntentResource{}

// CategoryMappingIntentResource Response object for intentful operations on a category_mapping
type CategoryMappingIntentResource struct {
	Status *CategoryMappingDefStatus `json:"status,omitempty"`
	Spec *CategoryMapping `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata CategoryMappingMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _CategoryMappingIntentResource CategoryMappingIntentResource
...
func NewCategoryMappingIntentResource(metadata CategoryMappingMetadata) *CategoryMappingIntentResource {
	this := CategoryMappingIntentResource{}
...
func (o *CategoryMappingIntentResource) GetStatus() CategoryMappingDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret CategoryMappingDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CategoryMappingDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given CategoryMapping and assigns it to the Spec field.
...
func (o *CategoryMappingIntentResource) GetMetadata() CategoryMappingMetadata {
	if o == nil {
		var ret CategoryMappingMetadata
		return ret
	}
...
func (o CategoryMappingIntentResource) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryMappingIntentResource := _CategoryMappingIntentResource{}

	err = json.Unmarshal(data, &varCategoryMappingIntentResource)

	if err != nil {
		return err
	}

	*o = CategoryMappingIntentResource(varCategoryMappingIntentResource)
...
type NullableCategoryMappingIntentResource struct {
	value *CategoryMappingIntentResource
	isSet bool
}

func (v NullableCategoryMappingIntentResource) Get() *CategoryMappingIntentResource {
	return v.value
}

func (v *NullableCategoryMappingIntentResource) Set(val *CategoryMappingIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingIntentResource(val *CategoryMappingIntentResource) *NullableCategoryMappingIntentResource {
	return &NullableCategoryMappingIntentResource{value: val, isSet: true}
}

func (v NullableCategoryMappingIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
