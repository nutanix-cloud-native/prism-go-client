...
// checks if the DockerRegistryMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryMetadata{}

// DockerRegistryMetadata The docker_registry kind metadata
type DockerRegistryMetadata struct {
	...
	// Categories for the docker_registry. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the docker_registry. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _DockerRegistryMetadata DockerRegistryMetadata
...
func (o DockerRegistryMetadata) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerRegistryMetadata := _DockerRegistryMetadata{}

	err = json.Unmarshal(data, &varDockerRegistryMetadata)

	if err != nil {
		return err
	}

	*o = DockerRegistryMetadata(varDockerRegistryMetadata)
...
type NullableDockerRegistryMetadata struct {
	value *DockerRegistryMetadata
	isSet bool
}

func (v NullableDockerRegistryMetadata) Get() *DockerRegistryMetadata {
	return v.value
}

func (v *NullableDockerRegistryMetadata) Set(val *DockerRegistryMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryMetadata(val *DockerRegistryMetadata) *NullableDockerRegistryMetadata {
	return &NullableDockerRegistryMetadata{value: val, isSet: true}
}

func (v NullableDockerRegistryMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
