...
// checks if the VmDiskReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDiskReference{}

// VmDiskReference The reference to a vm_disk
...
type _VmDiskReference VmDiskReference
...
func (o VmDiskReference) MarshalJSON() ([]byte, error) {
...
func (o VmDiskReference) ToMap() (map[string]interface{}, error) {
...
func (o *VmDiskReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVmDiskReference := _VmDiskReference{}

	err = json.Unmarshal(data, &varVmDiskReference)

	if err != nil {
		return err
	}

	*o = VmDiskReference(varVmDiskReference)
...
type NullableVmDiskReference struct {
	value *VmDiskReference
	isSet bool
}

func (v NullableVmDiskReference) Get() *VmDiskReference {
	return v.value
}

func (v *NullableVmDiskReference) Set(val *VmDiskReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVmDiskReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVmDiskReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmDiskReference(val *VmDiskReference) *NullableVmDiskReference {
	return &NullableVmDiskReference{value: val, isSet: true}
}

func (v NullableVmDiskReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmDiskReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
