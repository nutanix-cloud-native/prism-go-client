...
// checks if the CaCert type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CaCert{}
...
func (o CaCert) MarshalJSON() ([]byte, error) {
...
func (o CaCert) ToMap() (map[string]interface{}, error) {
...
func (o *CaCert) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCaCert)
...
type NullableCaCert struct {
	value *CaCert
	isSet bool
}

func (v NullableCaCert) Get() *CaCert {
	return v.value
}

func (v *NullableCaCert) Set(val *CaCert) {
	v.value = val
	v.isSet = true
}

func (v NullableCaCert) IsSet() bool {
	return v.isSet
}

func (v *NullableCaCert) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCaCert(val *CaCert) *NullableCaCert {
	return &NullableCaCert{value: val, isSet: true}
}

func (v NullableCaCert) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCaCert) UnmarshalJSON(src []byte) error {
	v.isSet = true
