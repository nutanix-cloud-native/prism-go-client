...
// checks if the UserStatusResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserStatusResource{}

// UserStatusResource User Resource Definition.
type UserStatusResource struct {
	// List of ACP references.
	AccessControlPolicyReferenceList []AccessControlPolicyReference `json:"access_control_policy_reference_list,omitempty"`
	// The display name of the user (common name) provided by the directory service. 
	DisplayName *string `json:"display_name,omitempty"`
	UserType *string `json:"user_type,omitempty"`
	ResourceUsageSummary *UserStatusResourceResourceUsageSummary `json:"resource_usage_summary,omitempty"`
	// A list of projects the user is part of.
	ProjectsReferenceList []ProjectReference `json:"projects_reference_list,omitempty"`
	IdentityProviderUser *IdentityProviderUser `json:"identity_provider_user,omitempty"`
	DirectoryServiceUser *DirectoryServiceUserStatus `json:"directory_service_user,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UserStatusResource UserStatusResource
...
// GetAccessControlPolicyReferenceList returns the AccessControlPolicyReferenceList field value if set, zero value otherwise.
func (o *UserStatusResource) GetAccessControlPolicyReferenceList() []AccessControlPolicyReference {
	if o == nil || IsNil(o.AccessControlPolicyReferenceList) {
		var ret []AccessControlPolicyReference
		return ret
	}
	return o.AccessControlPolicyReferenceList
}

// GetAccessControlPolicyReferenceListOk returns a tuple with the AccessControlPolicyReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserStatusResource) GetAccessControlPolicyReferenceListOk() ([]AccessControlPolicyReference, bool) {
	if o == nil || IsNil(o.AccessControlPolicyReferenceList) {
		return nil, false
	}
	return o.AccessControlPolicyReferenceList, true
}
...
// SetAccessControlPolicyReferenceList gets a reference to the given []AccessControlPolicyReference and assigns it to the AccessControlPolicyReferenceList field.
func (o *UserStatusResource) SetAccessControlPolicyReferenceList(v []AccessControlPolicyReference) {
	o.AccessControlPolicyReferenceList = v
}
...
// GetResourceUsageSummary returns the ResourceUsageSummary field value if set, zero value otherwise.
func (o *UserStatusResource) GetResourceUsageSummary() UserStatusResourceResourceUsageSummary {
	if o == nil || IsNil(o.ResourceUsageSummary) {
		var ret UserStatusResourceResourceUsageSummary
		return ret
	}
	return *o.ResourceUsageSummary
}

// GetResourceUsageSummaryOk returns a tuple with the ResourceUsageSummary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserStatusResource) GetResourceUsageSummaryOk() (*UserStatusResourceResourceUsageSummary, bool) {
	if o == nil || IsNil(o.ResourceUsageSummary) {
		return nil, false
	}
	return o.ResourceUsageSummary, true
}
...
// SetResourceUsageSummary gets a reference to the given UserStatusResourceResourceUsageSummary and assigns it to the ResourceUsageSummary field.
func (o *UserStatusResource) SetResourceUsageSummary(v UserStatusResourceResourceUsageSummary) {
	o.ResourceUsageSummary = &v
}

// GetProjectsReferenceList returns the ProjectsReferenceList field value if set, zero value otherwise.
func (o *UserStatusResource) GetProjectsReferenceList() []ProjectReference {
	if o == nil || IsNil(o.ProjectsReferenceList) {
		var ret []ProjectReference
		return ret
	}
	return o.ProjectsReferenceList
}

// GetProjectsReferenceListOk returns a tuple with the ProjectsReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserStatusResource) GetProjectsReferenceListOk() ([]ProjectReference, bool) {
	if o == nil || IsNil(o.ProjectsReferenceList) {
		return nil, false
	}
	return o.ProjectsReferenceList, true
}
...
// SetProjectsReferenceList gets a reference to the given []ProjectReference and assigns it to the ProjectsReferenceList field.
func (o *UserStatusResource) SetProjectsReferenceList(v []ProjectReference) {
	o.ProjectsReferenceList = v
}

// GetIdentityProviderUser returns the IdentityProviderUser field value if set, zero value otherwise.
func (o *UserStatusResource) GetIdentityProviderUser() IdentityProviderUser {
	if o == nil || IsNil(o.IdentityProviderUser) {
		var ret IdentityProviderUser
		return ret
	}
	return *o.IdentityProviderUser
}

// GetIdentityProviderUserOk returns a tuple with the IdentityProviderUser field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserStatusResource) GetIdentityProviderUserOk() (*IdentityProviderUser, bool) {
	if o == nil || IsNil(o.IdentityProviderUser) {
		return nil, false
	}
	return o.IdentityProviderUser, true
}
...
// SetIdentityProviderUser gets a reference to the given IdentityProviderUser and assigns it to the IdentityProviderUser field.
func (o *UserStatusResource) SetIdentityProviderUser(v IdentityProviderUser) {
	o.IdentityProviderUser = &v
}

// GetDirectoryServiceUser returns the DirectoryServiceUser field value if set, zero value otherwise.
func (o *UserStatusResource) GetDirectoryServiceUser() DirectoryServiceUserStatus {
	if o == nil || IsNil(o.DirectoryServiceUser) {
		var ret DirectoryServiceUserStatus
		return ret
	}
	return *o.DirectoryServiceUser
}

// GetDirectoryServiceUserOk returns a tuple with the DirectoryServiceUser field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserStatusResource) GetDirectoryServiceUserOk() (*DirectoryServiceUserStatus, bool) {
	if o == nil || IsNil(o.DirectoryServiceUser) {
		return nil, false
	}
	return o.DirectoryServiceUser, true
}
...
// SetDirectoryServiceUser gets a reference to the given DirectoryServiceUserStatus and assigns it to the DirectoryServiceUser field.
func (o *UserStatusResource) SetDirectoryServiceUser(v DirectoryServiceUserStatus) {
	o.DirectoryServiceUser = &v
}

func (o UserStatusResource) MarshalJSON() ([]byte, error) {
...
func (o UserStatusResource) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AccessControlPolicyReferenceList) {
		toSerialize["access_control_policy_reference_list"] = o.AccessControlPolicyReferenceList
	}
	...
	if !IsNil(o.ResourceUsageSummary) {
		toSerialize["resource_usage_summary"] = o.ResourceUsageSummary
	}
	if !IsNil(o.ProjectsReferenceList) {
		toSerialize["projects_reference_list"] = o.ProjectsReferenceList
	}
	if !IsNil(o.IdentityProviderUser) {
		toSerialize["identity_provider_user"] = o.IdentityProviderUser
	}
	if !IsNil(o.DirectoryServiceUser) {
		toSerialize["directory_service_user"] = o.DirectoryServiceUser
	}
...
func (o *UserStatusResource) UnmarshalJSON(data []byte) (err error) {
	varUserStatusResource := _UserStatusResource{}

	err = json.Unmarshal(data, &varUserStatusResource)

	if err != nil {
		return err
	}

	*o = UserStatusResource(varUserStatusResource)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "access_control_policy_reference_list")
		delete(additionalProperties, "display_name")
		delete(additionalProperties, "user_type")
		delete(additionalProperties, "resource_usage_summary")
		delete(additionalProperties, "projects_reference_list")
		delete(additionalProperties, "identity_provider_user")
		delete(additionalProperties, "directory_service_user")
...
type NullableUserStatusResource struct {
	value *UserStatusResource
	isSet bool
}

func (v NullableUserStatusResource) Get() *UserStatusResource {
	return v.value
}

func (v *NullableUserStatusResource) Set(val *UserStatusResource) {
	v.value = val
	v.isSet = true
}

func (v NullableUserStatusResource) IsSet() bool {
	return v.isSet
}

func (v *NullableUserStatusResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserStatusResource(val *UserStatusResource) *NullableUserStatusResource {
	return &NullableUserStatusResource{value: val, isSet: true}
}

func (v NullableUserStatusResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserStatusResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
