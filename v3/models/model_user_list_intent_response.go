...
// checks if the UserListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserListIntentResponse{}

// UserListIntentResponse Response object for intentful operation of users
type UserListIntentResponse struct {
	Entities []UserIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata UserListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _UserListIntentResponse UserListIntentResponse
...
// SetEntities gets a reference to the given []UserIntentResource and assigns it to the Entities field.
...
func (o *UserListIntentResponse) GetMetadata() UserListMetadataOutput {
	if o == nil {
		var ret UserListMetadataOutput
		return ret
	}
...
func (o UserListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o UserListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *UserListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUserListIntentResponse := _UserListIntentResponse{}

	err = json.Unmarshal(data, &varUserListIntentResponse)

	if err != nil {
		return err
	}

	*o = UserListIntentResponse(varUserListIntentResponse)
...
type NullableUserListIntentResponse struct {
	value *UserListIntentResponse
	isSet bool
}

func (v NullableUserListIntentResponse) Get() *UserListIntentResponse {
	return v.value
}

func (v *NullableUserListIntentResponse) Set(val *UserListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUserListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUserListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserListIntentResponse(val *UserListIntentResponse) *NullableUserListIntentResponse {
	return &NullableUserListIntentResponse{value: val, isSet: true}
}

func (v NullableUserListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
