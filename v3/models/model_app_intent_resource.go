...
// checks if the AppIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppIntentResource{}

// AppIntentResource Response object for intentful operations on a app
type AppIntentResource struct {
	Status *AppDefStatus `json:"status,omitempty"`
	Spec *App `json:"spec,omitempty"`
...
type _AppIntentResource AppIntentResource
...
// SetStatus gets a reference to the given AppDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given App and assigns it to the Spec field.
...
func (o AppIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AppIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AppIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAppIntentResource := _AppIntentResource{}

	err = json.Unmarshal(data, &varAppIntentResource)

	if err != nil {
		return err
	}

	*o = AppIntentResource(varAppIntentResource)
...
type NullableAppIntentResource struct {
	value *AppIntentResource
	isSet bool
}

func (v NullableAppIntentResource) Get() *AppIntentResource {
	return v.value
}

func (v *NullableAppIntentResource) Set(val *AppIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAppIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAppIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppIntentResource(val *AppIntentResource) *NullableAppIntentResource {
	return &NullableAppIntentResource{value: val, isSet: true}
}

func (v NullableAppIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
