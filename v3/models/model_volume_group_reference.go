...
// checks if the VolumeGroupReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupReference{}

// VolumeGroupReference The reference to a volume_group
...
type _VolumeGroupReference VolumeGroupReference
...
func (o VolumeGroupReference) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupReference) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeGroupReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumeGroupReference := _VolumeGroupReference{}

	err = json.Unmarshal(data, &varVolumeGroupReference)

	if err != nil {
		return err
	}

	*o = VolumeGroupReference(varVolumeGroupReference)
...
type NullableVolumeGroupReference struct {
	value *VolumeGroupReference
	isSet bool
}

func (v NullableVolumeGroupReference) Get() *VolumeGroupReference {
	return v.value
}

func (v *NullableVolumeGroupReference) Set(val *VolumeGroupReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupReference(val *VolumeGroupReference) *NullableVolumeGroupReference {
	return &NullableVolumeGroupReference{value: val, isSet: true}
}

func (v NullableVolumeGroupReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
