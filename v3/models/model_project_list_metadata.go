...
// checks if the ProjectListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectListMetadata{}
...
type _ProjectListMetadata ProjectListMetadata
...
func (o ProjectListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ProjectListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectListMetadata) UnmarshalJSON(data []byte) (err error) {
	varProjectListMetadata := _ProjectListMetadata{}

	err = json.Unmarshal(data, &varProjectListMetadata)

	if err != nil {
		return err
	}

	*o = ProjectListMetadata(varProjectListMetadata)
...
type NullableProjectListMetadata struct {
	value *ProjectListMetadata
	isSet bool
}

func (v NullableProjectListMetadata) Get() *ProjectListMetadata {
	return v.value
}

func (v *NullableProjectListMetadata) Set(val *ProjectListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectListMetadata(val *ProjectListMetadata) *NullableProjectListMetadata {
	return &NullableProjectListMetadata{value: val, isSet: true}
}

func (v NullableProjectListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
