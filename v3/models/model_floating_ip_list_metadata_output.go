...
// checks if the FloatingIpListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpListMetadataOutput{}

// FloatingIpListMetadataOutput All api calls that return a list will have this metadata block 
type FloatingIpListMetadataOutput struct {
	// The kind name
...
type _FloatingIpListMetadataOutput FloatingIpListMetadataOutput
...
func NewFloatingIpListMetadataOutput() *FloatingIpListMetadataOutput {
	this := FloatingIpListMetadataOutput{}
	var kind string = "floating_ip"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *FloatingIpListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o FloatingIpListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *FloatingIpListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varFloatingIpListMetadataOutput := _FloatingIpListMetadataOutput{}

	err = json.Unmarshal(data, &varFloatingIpListMetadataOutput)

	if err != nil {
		return err
	}

	*o = FloatingIpListMetadataOutput(varFloatingIpListMetadataOutput)
...
type NullableFloatingIpListMetadataOutput struct {
	value *FloatingIpListMetadataOutput
	isSet bool
}

func (v NullableFloatingIpListMetadataOutput) Get() *FloatingIpListMetadataOutput {
	return v.value
}

func (v *NullableFloatingIpListMetadataOutput) Set(val *FloatingIpListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpListMetadataOutput(val *FloatingIpListMetadataOutput) *NullableFloatingIpListMetadataOutput {
	return &NullableFloatingIpListMetadataOutput{value: val, isSet: true}
}

func (v NullableFloatingIpListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
