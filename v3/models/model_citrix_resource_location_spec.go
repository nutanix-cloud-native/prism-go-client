...
// checks if the CitrixResourceLocationSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CitrixResourceLocationSpec{}

// CitrixResourceLocationSpec Resource Location on Citrix Cloud.
...
type _CitrixResourceLocationSpec CitrixResourceLocationSpec
...
func NewCitrixResourceLocationSpec() *CitrixResourceLocationSpec {
	this := CitrixResourceLocationSpec{}
	return &this
}
...
func (o CitrixResourceLocationSpec) MarshalJSON() ([]byte, error) {
...
func (o CitrixResourceLocationSpec) ToMap() (map[string]interface{}, error) {
...
func (o *CitrixResourceLocationSpec) UnmarshalJSON(data []byte) (err error) {
	varCitrixResourceLocationSpec := _CitrixResourceLocationSpec{}

	err = json.Unmarshal(data, &varCitrixResourceLocationSpec)

	if err != nil {
		return err
	}

	*o = CitrixResourceLocationSpec(varCitrixResourceLocationSpec)
...
type NullableCitrixResourceLocationSpec struct {
	value *CitrixResourceLocationSpec
	isSet bool
}

func (v NullableCitrixResourceLocationSpec) Get() *CitrixResourceLocationSpec {
	return v.value
}

func (v *NullableCitrixResourceLocationSpec) Set(val *CitrixResourceLocationSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableCitrixResourceLocationSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableCitrixResourceLocationSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCitrixResourceLocationSpec(val *CitrixResourceLocationSpec) *NullableCitrixResourceLocationSpec {
	return &NullableCitrixResourceLocationSpec{value: val, isSet: true}
}

func (v NullableCitrixResourceLocationSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCitrixResourceLocationSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
