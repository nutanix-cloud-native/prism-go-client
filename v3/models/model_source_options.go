...
// checks if the SourceOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceOptions{}

// SourceOptions Options while accessing image source. 
type SourceOptions struct {
	// allow_insecure_connection is an option for the user to ignore the server certificate verification while accessing source_uri (image location). If it has value = true, it ignores server certificate verification. If it has value = false, it does regular server certificate verification. 
	AllowInsecureConnection *bool `json:"allow_insecure_connection,omitempty"`
	BasicAuth *Credentials `json:"basic_auth,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SourceOptions SourceOptions
...
// GetAllowInsecureConnection returns the AllowInsecureConnection field value if set, zero value otherwise.
func (o *SourceOptions) GetAllowInsecureConnection() bool {
	if o == nil || IsNil(o.AllowInsecureConnection) {
		var ret bool
		return ret
	}
	return *o.AllowInsecureConnection
}

// GetAllowInsecureConnectionOk returns a tuple with the AllowInsecureConnection field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SourceOptions) GetAllowInsecureConnectionOk() (*bool, bool) {
	if o == nil || IsNil(o.AllowInsecureConnection) {
		return nil, false
	}
	return o.AllowInsecureConnection, true
}
...
// SetAllowInsecureConnection gets a reference to the given bool and assigns it to the AllowInsecureConnection field.
func (o *SourceOptions) SetAllowInsecureConnection(v bool) {
	o.AllowInsecureConnection = &v
}
...
// SetBasicAuth gets a reference to the given Credentials and assigns it to the BasicAuth field.
...
func (o SourceOptions) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AllowInsecureConnection) {
		toSerialize["allow_insecure_connection"] = o.AllowInsecureConnection
	}
...
func (o *SourceOptions) UnmarshalJSON(data []byte) (err error) {
	varSourceOptions := _SourceOptions{}

	err = json.Unmarshal(data, &varSourceOptions)

	if err != nil {
		return err
	}

	*o = SourceOptions(varSourceOptions)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "allow_insecure_connection")
...
type NullableSourceOptions struct {
	value *SourceOptions
	isSet bool
}

func (v NullableSourceOptions) Get() *SourceOptions {
	return v.value
}

func (v *NullableSourceOptions) Set(val *SourceOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceOptions(val *SourceOptions) *NullableSourceOptions {
	return &NullableSourceOptions{value: val, isSet: true}
}

func (v NullableSourceOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
