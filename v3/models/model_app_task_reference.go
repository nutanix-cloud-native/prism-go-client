...
// checks if the AppTaskReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskReference{}

// AppTaskReference The reference to a app_task
type AppTaskReference struct {
	// The kind name
...
type _AppTaskReference AppTaskReference
...
func (o AppTaskReference) MarshalJSON() ([]byte, error) {
...
func (o AppTaskReference) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskReference := _AppTaskReference{}

	err = json.Unmarshal(data, &varAppTaskReference)

	if err != nil {
		return err
	}

	*o = AppTaskReference(varAppTaskReference)
...
type NullableAppTaskReference struct {
	value *AppTaskReference
	isSet bool
}

func (v NullableAppTaskReference) Get() *AppTaskReference {
	return v.value
}

func (v *NullableAppTaskReference) Set(val *AppTaskReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskReference(val *AppTaskReference) *NullableAppTaskReference {
	return &NullableAppTaskReference{value: val, isSet: true}
}

func (v NullableAppTaskReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
