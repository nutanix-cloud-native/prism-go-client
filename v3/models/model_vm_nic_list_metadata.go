...
// checks if the VmNicListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmNicListMetadata{}

// VmNicListMetadata All api calls that return a list will have this metadata block as input 
...
type _VmNicListMetadata VmNicListMetadata
...
func (o VmNicListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmNicListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmNicListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVmNicListMetadata := _VmNicListMetadata{}

	err = json.Unmarshal(data, &varVmNicListMetadata)

	if err != nil {
		return err
	}

	*o = VmNicListMetadata(varVmNicListMetadata)
...
type NullableVmNicListMetadata struct {
	value *VmNicListMetadata
	isSet bool
}

func (v NullableVmNicListMetadata) Get() *VmNicListMetadata {
	return v.value
}

func (v *NullableVmNicListMetadata) Set(val *VmNicListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmNicListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmNicListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmNicListMetadata(val *VmNicListMetadata) *NullableVmNicListMetadata {
	return &NullableVmNicListMetadata{value: val, isSet: true}
}

func (v NullableVmNicListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmNicListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
