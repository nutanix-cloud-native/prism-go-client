...
// checks if the DirectConnectVirtualInterfaceListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterfaceListIntentResponse{}

// DirectConnectVirtualInterfaceListIntentResponse Response object for intentful operation of direct_connect_virtual_interfaces
type DirectConnectVirtualInterfaceListIntentResponse struct {
	Entities []DirectConnectVirtualInterfaceIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata DirectConnectVirtualInterfaceListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _DirectConnectVirtualInterfaceListIntentResponse DirectConnectVirtualInterfaceListIntentResponse
...
func NewDirectConnectVirtualInterfaceListIntentResponse(apiVersion string, metadata DirectConnectVirtualInterfaceListMetadataOutput) *DirectConnectVirtualInterfaceListIntentResponse {
	this := DirectConnectVirtualInterfaceListIntentResponse{}
...
func (o *DirectConnectVirtualInterfaceListIntentResponse) GetEntities() []DirectConnectVirtualInterfaceIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []DirectConnectVirtualInterfaceIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []DirectConnectVirtualInterfaceIntentResource and assigns it to the Entities field.
...
func (o *DirectConnectVirtualInterfaceListIntentResponse) GetMetadata() DirectConnectVirtualInterfaceListMetadataOutput {
	if o == nil {
		var ret DirectConnectVirtualInterfaceListMetadataOutput
		return ret
	}
...
func (o DirectConnectVirtualInterfaceListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterfaceListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectVirtualInterfaceListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectVirtualInterfaceListIntentResponse := _DirectConnectVirtualInterfaceListIntentResponse{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterfaceListIntentResponse)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterfaceListIntentResponse(varDirectConnectVirtualInterfaceListIntentResponse)
...
type NullableDirectConnectVirtualInterfaceListIntentResponse struct {
	value *DirectConnectVirtualInterfaceListIntentResponse
	isSet bool
}

func (v NullableDirectConnectVirtualInterfaceListIntentResponse) Get() *DirectConnectVirtualInterfaceListIntentResponse {
	return v.value
}

func (v *NullableDirectConnectVirtualInterfaceListIntentResponse) Set(val *DirectConnectVirtualInterfaceListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterfaceListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterfaceListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterfaceListIntentResponse(val *DirectConnectVirtualInterfaceListIntentResponse) *NullableDirectConnectVirtualInterfaceListIntentResponse {
	return &NullableDirectConnectVirtualInterfaceListIntentResponse{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterfaceListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterfaceListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
