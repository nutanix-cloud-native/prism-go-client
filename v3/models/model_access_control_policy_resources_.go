...
// checks if the AccessControlPolicyResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyResources{}

// AccessControlPolicyResources struct for AccessControlPolicyResources
type AccessControlPolicyResources struct {
	...
	FilterList *AccessControlPolicyDetailFilterList `json:"filter_list,omitempty"`
	// The User group(s) being assigned a given role.
	UserGroupReferenceList []UserGroupReference `json:"user_group_reference_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AccessControlPolicyResources AccessControlPolicyResources
...
func NewAccessControlPolicyResources() *AccessControlPolicyResources {
	this := AccessControlPolicyResources{}
	return &this
}
...
// GetRoleReference returns the RoleReference field value if set, zero value otherwise.
func (o *AccessControlPolicyResources) GetRoleReference() RoleReference {
	if o == nil || IsNil(o.RoleReference) {
		var ret RoleReference
		return ret
	}
	return *o.RoleReference
}

// GetRoleReferenceOk returns a tuple with the RoleReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AccessControlPolicyResources) GetRoleReferenceOk() (*RoleReference, bool) {
	if o == nil || IsNil(o.RoleReference) {
		return nil, false
	}
	return o.RoleReference, true
}
...
// SetRoleReference gets a reference to the given RoleReference and assigns it to the RoleReference field.
...
func (o *AccessControlPolicyResources) GetFilterList() AccessControlPolicyDetailFilterList {
	if o == nil || IsNil(o.FilterList) {
		var ret AccessControlPolicyDetailFilterList
		return ret
	}
	return *o.FilterList
}
...
// SetFilterList gets a reference to the given AccessControlPolicyDetailFilterList and assigns it to the FilterList field.
func (o *AccessControlPolicyResources) SetFilterList(v AccessControlPolicyDetailFilterList) {
	o.FilterList = &v
}

// GetUserGroupReferenceList returns the UserGroupReferenceList field value if set, zero value otherwise.
func (o *AccessControlPolicyResources) GetUserGroupReferenceList() []UserGroupReference {
	if o == nil || IsNil(o.UserGroupReferenceList) {
		var ret []UserGroupReference
		return ret
	}
	return o.UserGroupReferenceList
}

// GetUserGroupReferenceListOk returns a tuple with the UserGroupReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AccessControlPolicyResources) GetUserGroupReferenceListOk() ([]UserGroupReference, bool) {
	if o == nil || IsNil(o.UserGroupReferenceList) {
		return nil, false
	}
	return o.UserGroupReferenceList, true
}
...
// SetUserGroupReferenceList gets a reference to the given []UserGroupReference and assigns it to the UserGroupReferenceList field.
func (o *AccessControlPolicyResources) SetUserGroupReferenceList(v []UserGroupReference) {
	o.UserGroupReferenceList = v
}

func (o AccessControlPolicyResources) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RoleReference) {
		toSerialize["role_reference"] = o.RoleReference
	}
	...
	if !IsNil(o.UserGroupReferenceList) {
		toSerialize["user_group_reference_list"] = o.UserGroupReferenceList
	}
...
func (o *AccessControlPolicyResources) UnmarshalJSON(data []byte) (err error) {
	varAccessControlPolicyResources := _AccessControlPolicyResources{}

	err = json.Unmarshal(data, &varAccessControlPolicyResources)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyResources(varAccessControlPolicyResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "role_reference")
		delete(additionalProperties, "user_reference_list")
		delete(additionalProperties, "filter_list")
		delete(additionalProperties, "user_group_reference_list")
...
type NullableAccessControlPolicyResources struct {
	value *AccessControlPolicyResources
	isSet bool
}

func (v NullableAccessControlPolicyResources) Get() *AccessControlPolicyResources {
	return v.value
}

func (v *NullableAccessControlPolicyResources) Set(val *AccessControlPolicyResources) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyResources) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyResources(val *AccessControlPolicyResources) *NullableAccessControlPolicyResources {
	return &NullableAccessControlPolicyResources{value: val, isSet: true}
}

func (v NullableAccessControlPolicyResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
