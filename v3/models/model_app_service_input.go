...
// AppServiceInput Service definition for Application
...
type _AppServiceInput AppServiceInput
...
func (o *AppServiceInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppServiceInput := _AppServiceInput{}

	err = json.Unmarshal(data, &varAppServiceInput)

	if err != nil {
		return err
	}

	*o = AppServiceInput(varAppServiceInput)
