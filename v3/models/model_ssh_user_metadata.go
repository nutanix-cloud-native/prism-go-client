...
// checks if the SshUserMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserMetadata{}

// SshUserMetadata The ssh_user kind metadata
type SshUserMetadata struct {
	...
	// Categories for the ssh_user. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the ssh_user. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _SshUserMetadata SshUserMetadata
...
func (o *SshUserMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *SshUserMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *SshUserMetadata) SetName(v string) {
	o.Name = &v
}

func (o SshUserMetadata) MarshalJSON() ([]byte, error) {
...
func (o SshUserMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varSshUserMetadata := _SshUserMetadata{}

	err = json.Unmarshal(data, &varSshUserMetadata)

	if err != nil {
		return err
	}

	*o = SshUserMetadata(varSshUserMetadata)
...
type NullableSshUserMetadata struct {
	value *SshUserMetadata
	isSet bool
}

func (v NullableSshUserMetadata) Get() *SshUserMetadata {
	return v.value
}

func (v *NullableSshUserMetadata) Set(val *SshUserMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserMetadata(val *SshUserMetadata) *NullableSshUserMetadata {
	return &NullableSshUserMetadata{value: val, isSet: true}
}

func (v NullableSshUserMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
