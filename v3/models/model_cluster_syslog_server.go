...
// checks if the ClusterSyslogServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterSyslogServer{}

// ClusterSyslogServer Cluster Remote Syslog server definition.
type ClusterSyslogServer struct {
	RsyslogServerList []SyslogServerResources `json:"rsyslog_server_list,omitempty"`
	ClusterVersion *string `json:"cluster_version,omitempty"`
	ClusterReference *ClusterReference `json:"cluster_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ClusterSyslogServer ClusterSyslogServer
...
// GetRsyslogServerList returns the RsyslogServerList field value if set, zero value otherwise.
func (o *ClusterSyslogServer) GetRsyslogServerList() []SyslogServerResources {
	if o == nil || IsNil(o.RsyslogServerList) {
		var ret []SyslogServerResources
		return ret
	}
	return o.RsyslogServerList
}

// GetRsyslogServerListOk returns a tuple with the RsyslogServerList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterSyslogServer) GetRsyslogServerListOk() ([]SyslogServerResources, bool) {
	if o == nil || IsNil(o.RsyslogServerList) {
		return nil, false
	}
	return o.RsyslogServerList, true
}
...
// SetRsyslogServerList gets a reference to the given []SyslogServerResources and assigns it to the RsyslogServerList field.
func (o *ClusterSyslogServer) SetRsyslogServerList(v []SyslogServerResources) {
	o.RsyslogServerList = v
}
...
func (o ClusterSyslogServer) MarshalJSON() ([]byte, error) {
...
func (o ClusterSyslogServer) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RsyslogServerList) {
		toSerialize["rsyslog_server_list"] = o.RsyslogServerList
	}
	if !IsNil(o.ClusterVersion) {
		toSerialize["cluster_version"] = o.ClusterVersion
	}
...
func (o *ClusterSyslogServer) UnmarshalJSON(data []byte) (err error) {
	varClusterSyslogServer := _ClusterSyslogServer{}

	err = json.Unmarshal(data, &varClusterSyslogServer)

	if err != nil {
		return err
	}

	*o = ClusterSyslogServer(varClusterSyslogServer)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "rsyslog_server_list")
		delete(additionalProperties, "cluster_version")
...
type NullableClusterSyslogServer struct {
	value *ClusterSyslogServer
	isSet bool
}

func (v NullableClusterSyslogServer) Get() *ClusterSyslogServer {
	return v.value
}

func (v *NullableClusterSyslogServer) Set(val *ClusterSyslogServer) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterSyslogServer) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterSyslogServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterSyslogServer(val *ClusterSyslogServer) *NullableClusterSyslogServer {
	return &NullableClusterSyslogServer{value: val, isSet: true}
}

func (v NullableClusterSyslogServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterSyslogServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
