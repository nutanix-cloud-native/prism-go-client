...
// checks if the AccessControlPolicyInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyInput{}

// AccessControlPolicyInput An Access Control Policy resource.
type AccessControlPolicyInput struct {
	// Name of the Access Control Policy.
	Name *string `json:"name,omitempty"`
	Resources AccessControlPolicyResources1 `json:"resources"`
	// The description of the association of a role to a user in a given context. 
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AccessControlPolicyInput AccessControlPolicyInput
...
func (o *AccessControlPolicyInput) GetResources() AccessControlPolicyResources1 {
	if o == nil {
		var ret AccessControlPolicyResources1
		return ret
	}
...
func (o AccessControlPolicyInput) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyInput) ToMap() (map[string]interface{}, error) {
...
func (o *AccessControlPolicyInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessControlPolicyInput := _AccessControlPolicyInput{}

	err = json.Unmarshal(data, &varAccessControlPolicyInput)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyInput(varAccessControlPolicyInput)
...
type NullableAccessControlPolicyInput struct {
	value *AccessControlPolicyInput
	isSet bool
}

func (v NullableAccessControlPolicyInput) Get() *AccessControlPolicyInput {
	return v.value
}

func (v *NullableAccessControlPolicyInput) Set(val *AccessControlPolicyInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyInput(val *AccessControlPolicyInput) *NullableAccessControlPolicyInput {
	return &NullableAccessControlPolicyInput{value: val, isSet: true}
}

func (v NullableAccessControlPolicyInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
