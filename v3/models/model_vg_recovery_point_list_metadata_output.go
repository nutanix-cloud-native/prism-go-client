...
// checks if the VgRecoveryPointListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VgRecoveryPointListMetadataOutput{}

// VgRecoveryPointListMetadataOutput All api calls that return a list will have this metadata block 
type VgRecoveryPointListMetadataOutput struct {
	// The kind name
...
type _VgRecoveryPointListMetadataOutput VgRecoveryPointListMetadataOutput
...
func NewVgRecoveryPointListMetadataOutput() *VgRecoveryPointListMetadataOutput {
	this := VgRecoveryPointListMetadataOutput{}
	var kind string = "vg_recovery_point"
	this.Kind = &kind
	return &this
}
...
func (o VgRecoveryPointListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VgRecoveryPointListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VgRecoveryPointListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVgRecoveryPointListMetadataOutput := _VgRecoveryPointListMetadataOutput{}

	err = json.Unmarshal(data, &varVgRecoveryPointListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VgRecoveryPointListMetadataOutput(varVgRecoveryPointListMetadataOutput)
...
type NullableVgRecoveryPointListMetadataOutput struct {
	value *VgRecoveryPointListMetadataOutput
	isSet bool
}

func (v NullableVgRecoveryPointListMetadataOutput) Get() *VgRecoveryPointListMetadataOutput {
	return v.value
}

func (v *NullableVgRecoveryPointListMetadataOutput) Set(val *VgRecoveryPointListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVgRecoveryPointListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVgRecoveryPointListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVgRecoveryPointListMetadataOutput(val *VgRecoveryPointListMetadataOutput) *NullableVgRecoveryPointListMetadataOutput {
	return &NullableVgRecoveryPointListMetadataOutput{value: val, isSet: true}
}

func (v NullableVgRecoveryPointListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVgRecoveryPointListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
