...
// checks if the AppDeploymentElement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppDeploymentElement{}

// AppDeploymentElement Deployment definition for Application
type AppDeploymentElement struct {
	// 
	State *string `json:"state,omitempty"`
	// Additional deployment options
	Options map[string]interface{} `json:"options,omitempty"`
	// List of references for packages
	PackageElementLocalReferenceList []AppPackageReference `json:"package_element_local_reference_list,omitempty"`
	SubstrateElementLocalReference AppSubstrateReference `json:"substrate_element_local_reference"`
	AdditionalProperties map[string]interface{}
}

type _AppDeploymentElement AppDeploymentElement
...
func NewAppDeploymentElement(substrateElementLocalReference AppSubstrateReference) *AppDeploymentElement {
	this := AppDeploymentElement{}
	this.SubstrateElementLocalReference = substrateElementLocalReference
	return &this
}
...
// GetPackageElementLocalReferenceList returns the PackageElementLocalReferenceList field value if set, zero value otherwise.
func (o *AppDeploymentElement) GetPackageElementLocalReferenceList() []AppPackageReference {
	if o == nil || IsNil(o.PackageElementLocalReferenceList) {
		var ret []AppPackageReference
		return ret
	}
	return o.PackageElementLocalReferenceList
}

// GetPackageElementLocalReferenceListOk returns a tuple with the PackageElementLocalReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppDeploymentElement) GetPackageElementLocalReferenceListOk() ([]AppPackageReference, bool) {
	if o == nil || IsNil(o.PackageElementLocalReferenceList) {
		return nil, false
	}
	return o.PackageElementLocalReferenceList, true
}
...
// SetPackageElementLocalReferenceList gets a reference to the given []AppPackageReference and assigns it to the PackageElementLocalReferenceList field.
func (o *AppDeploymentElement) SetPackageElementLocalReferenceList(v []AppPackageReference) {
	o.PackageElementLocalReferenceList = v
}

// GetSubstrateElementLocalReference returns the SubstrateElementLocalReference field value
func (o *AppDeploymentElement) GetSubstrateElementLocalReference() AppSubstrateReference {
	...
	return o.SubstrateElementLocalReference
}

// GetSubstrateElementLocalReferenceOk returns a tuple with the SubstrateElementLocalReference field value
// and a boolean to check if the value has been set.
func (o *AppDeploymentElement) GetSubstrateElementLocalReferenceOk() (*AppSubstrateReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SubstrateElementLocalReference, true
}

// SetSubstrateElementLocalReference sets field value
func (o *AppDeploymentElement) SetSubstrateElementLocalReference(v AppSubstrateReference) {
	o.SubstrateElementLocalReference = v
}

func (o AppDeploymentElement) MarshalJSON() ([]byte, error) {
...
func (o AppDeploymentElement) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PackageElementLocalReferenceList) {
		toSerialize["package_element_local_reference_list"] = o.PackageElementLocalReferenceList
	}
	toSerialize["substrate_element_local_reference"] = o.SubstrateElementLocalReference
...
func (o *AppDeploymentElement) UnmarshalJSON(data []byte) (err error) {
	...
	varAppDeploymentElement := _AppDeploymentElement{}

	err = json.Unmarshal(data, &varAppDeploymentElement)

	if err != nil {
		return err
	}

	*o = AppDeploymentElement(varAppDeploymentElement)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "package_element_local_reference_list")
		delete(additionalProperties, "substrate_element_local_reference")
...
type NullableAppDeploymentElement struct {
	value *AppDeploymentElement
	isSet bool
}

func (v NullableAppDeploymentElement) Get() *AppDeploymentElement {
	return v.value
}

func (v *NullableAppDeploymentElement) Set(val *AppDeploymentElement) {
	v.value = val
	v.isSet = true
}

func (v NullableAppDeploymentElement) IsSet() bool {
	return v.isSet
}

func (v *NullableAppDeploymentElement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppDeploymentElement(val *AppDeploymentElement) *NullableAppDeploymentElement {
	return &NullableAppDeploymentElement{value: val, isSet: true}
}

func (v NullableAppDeploymentElement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppDeploymentElement) UnmarshalJSON(src []byte) error {
	v.isSet = true
