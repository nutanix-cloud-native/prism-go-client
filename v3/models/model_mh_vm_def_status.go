...
// checks if the MhVmDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmDefStatus{}

// MhVmDefStatus An intentful representation of a mh_vm status
type MhVmDefStatus struct {
	// mh_vm Name.
	Name string `json:"name"`
	// The state of the mh_vm.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the mh_vm, if in an error state.
	...
	Resources MhVmResourcesDefStatus `json:"resources"`
	// A description for mh_vm.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MhVmDefStatus MhVmDefStatus
...
func (o *MhVmDefStatus) GetResources() MhVmResourcesDefStatus {
	if o == nil {
		var ret MhVmResourcesDefStatus
		return ret
	}
...
func (o MhVmDefStatus) MarshalJSON() ([]byte, error) {
...
func (o MhVmDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varMhVmDefStatus := _MhVmDefStatus{}

	err = json.Unmarshal(data, &varMhVmDefStatus)

	if err != nil {
		return err
	}

	*o = MhVmDefStatus(varMhVmDefStatus)
...
type NullableMhVmDefStatus struct {
	value *MhVmDefStatus
	isSet bool
}

func (v NullableMhVmDefStatus) Get() *MhVmDefStatus {
	return v.value
}

func (v *NullableMhVmDefStatus) Set(val *MhVmDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmDefStatus(val *MhVmDefStatus) *NullableMhVmDefStatus {
	return &NullableMhVmDefStatus{value: val, isSet: true}
}

func (v NullableMhVmDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
