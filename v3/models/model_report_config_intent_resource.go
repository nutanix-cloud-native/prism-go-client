...
// checks if the ReportConfigIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigIntentResource{}

// ReportConfigIntentResource Response object for intentful operations on a report_config
type ReportConfigIntentResource struct {
...
type _ReportConfigIntentResource ReportConfigIntentResource
...
func NewReportConfigIntentResource(metadata ReportConfigMetadata) *ReportConfigIntentResource {
	this := ReportConfigIntentResource{}
...
func (o ReportConfigIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfigIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varReportConfigIntentResource := _ReportConfigIntentResource{}

	err = json.Unmarshal(data, &varReportConfigIntentResource)

	if err != nil {
		return err
	}

	*o = ReportConfigIntentResource(varReportConfigIntentResource)
...
type NullableReportConfigIntentResource struct {
	value *ReportConfigIntentResource
	isSet bool
}

func (v NullableReportConfigIntentResource) Get() *ReportConfigIntentResource {
	return v.value
}

func (v *NullableReportConfigIntentResource) Set(val *ReportConfigIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigIntentResource(val *ReportConfigIntentResource) *NullableReportConfigIntentResource {
	return &NullableReportConfigIntentResource{value: val, isSet: true}
}

func (v NullableReportConfigIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
