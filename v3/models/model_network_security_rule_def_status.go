...
// checks if the NetworkSecurityRuleDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleDefStatus{}
...
type NetworkSecurityRuleDefStatus struct {
	...
	Resources *NetworkSecurityRuleResourcesStatus `json:"resources,omitempty"`
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NetworkSecurityRuleDefStatus NetworkSecurityRuleDefStatus
...
func NewNetworkSecurityRuleDefStatus() *NetworkSecurityRuleDefStatus {
	this := NetworkSecurityRuleDefStatus{}
	return &this
}
...
func (o *NetworkSecurityRuleDefStatus) GetResources() NetworkSecurityRuleResourcesStatus {
	if o == nil || IsNil(o.Resources) {
		var ret NetworkSecurityRuleResourcesStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given NetworkSecurityRuleResourcesStatus and assigns it to the Resources field.
...
func (o NetworkSecurityRuleDefStatus) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRuleDefStatus) UnmarshalJSON(data []byte) (err error) {
	varNetworkSecurityRuleDefStatus := _NetworkSecurityRuleDefStatus{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleDefStatus)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleDefStatus(varNetworkSecurityRuleDefStatus)
...
type NullableNetworkSecurityRuleDefStatus struct {
	value *NetworkSecurityRuleDefStatus
	isSet bool
}

func (v NullableNetworkSecurityRuleDefStatus) Get() *NetworkSecurityRuleDefStatus {
	return v.value
}

func (v *NullableNetworkSecurityRuleDefStatus) Set(val *NetworkSecurityRuleDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleDefStatus(val *NetworkSecurityRuleDefStatus) *NullableNetworkSecurityRuleDefStatus {
	return &NullableNetworkSecurityRuleDefStatus{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
