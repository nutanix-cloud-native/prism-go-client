...
// checks if the AwsSubnetMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSubnetMetadata{}

// AwsSubnetMetadata The aws_subnet kind metadata
type AwsSubnetMetadata struct {
...
type _AwsSubnetMetadata AwsSubnetMetadata
...
func (o *AwsSubnetMetadata) SetLastUpdateTime(v time.Time) {
	o.LastUpdateTime = &v
}
...
func (o *AwsSubnetMetadata) GetProjectReference() ProjectReference {
...
// and a boolean to check if the value has been set.
func (o *AwsSubnetMetadata) GetSpecVersionOk() (*int32, bool) {
	if o == nil || IsNil(o.SpecVersion) {
		return nil, false
	}
...
func (o *AwsSubnetMetadata) SetCategories(v map[string]string) {
	o.Categories = &v
}
...
func (o AwsSubnetMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsSubnetMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSubnetMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsSubnetMetadata := _AwsSubnetMetadata{}

	err = json.Unmarshal(data, &varAwsSubnetMetadata)

	if err != nil {
		return err
	}

	*o = AwsSubnetMetadata(varAwsSubnetMetadata)
...
type NullableAwsSubnetMetadata struct {
	value *AwsSubnetMetadata
	isSet bool
}

func (v NullableAwsSubnetMetadata) Get() *AwsSubnetMetadata {
	return v.value
}

func (v *NullableAwsSubnetMetadata) Set(val *AwsSubnetMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSubnetMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSubnetMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSubnetMetadata(val *AwsSubnetMetadata) *NullableAwsSubnetMetadata {
	return &NullableAwsSubnetMetadata{value: val, isSet: true}
}

func (v NullableAwsSubnetMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSubnetMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
