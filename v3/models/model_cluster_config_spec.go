...
type _ClusterConfigSpec ClusterConfigSpec
...
func (o *ClusterConfigSpec) GetExternalConfigurations() ExternalConfigurationsSpec {
	if o == nil || IsNil(o.ExternalConfigurations) {
		var ret ExternalConfigurationsSpec
		return ret
	}
...
// SetExternalConfigurations gets a reference to the given ExternalConfigurationsSpec and assigns it to the ExternalConfigurations field.
...
func (o *ClusterConfigSpec) UnmarshalJSON(data []byte) (err error) {
	varClusterConfigSpec := _ClusterConfigSpec{}

	err = json.Unmarshal(data, &varClusterConfigSpec)

	if err != nil {
		return err
	}

	*o = ClusterConfigSpec(varClusterConfigSpec)
