...
// checks if the AccountListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountListIntentResponse{}

// AccountListIntentResponse Response object for intentful operation of accounts
type AccountListIntentResponse struct {
	Entities []AccountIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AccountListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AccountListIntentResponse AccountListIntentResponse
...
func NewAccountListIntentResponse(apiVersion string, metadata AccountListMetadataOutput) *AccountListIntentResponse {
	this := AccountListIntentResponse{}
...
// SetEntities gets a reference to the given []AccountIntentResource and assigns it to the Entities field.
...
func (o *AccountListIntentResponse) GetMetadata() AccountListMetadataOutput {
	if o == nil {
		var ret AccountListMetadataOutput
		return ret
	}
...
func (o AccountListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AccountListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AccountListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountListIntentResponse := _AccountListIntentResponse{}

	err = json.Unmarshal(data, &varAccountListIntentResponse)

	if err != nil {
		return err
	}

	*o = AccountListIntentResponse(varAccountListIntentResponse)
...
type NullableAccountListIntentResponse struct {
	value *AccountListIntentResponse
	isSet bool
}

func (v NullableAccountListIntentResponse) Get() *AccountListIntentResponse {
	return v.value
}

func (v *NullableAccountListIntentResponse) Set(val *AccountListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountListIntentResponse(val *AccountListIntentResponse) *NullableAccountListIntentResponse {
	return &NullableAccountListIntentResponse{value: val, isSet: true}
}

func (v NullableAccountListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
