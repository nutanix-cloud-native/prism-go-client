...
// checks if the NusightsProxyListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NusightsProxyListMetadata{}

// NusightsProxyListMetadata All api calls that return a list will have this metadata block as input 
type NusightsProxyListMetadata struct {
	// The kind name
...
type _NusightsProxyListMetadata NusightsProxyListMetadata
...
func NewNusightsProxyListMetadata() *NusightsProxyListMetadata {
	this := NusightsProxyListMetadata{}
...
func (o NusightsProxyListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NusightsProxyListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NusightsProxyListMetadata) UnmarshalJSON(data []byte) (err error) {
	varNusightsProxyListMetadata := _NusightsProxyListMetadata{}

	err = json.Unmarshal(data, &varNusightsProxyListMetadata)

	if err != nil {
		return err
	}

	*o = NusightsProxyListMetadata(varNusightsProxyListMetadata)
...
type NullableNusightsProxyListMetadata struct {
	value *NusightsProxyListMetadata
	isSet bool
}

func (v NullableNusightsProxyListMetadata) Get() *NusightsProxyListMetadata {
	return v.value
}

func (v *NullableNusightsProxyListMetadata) Set(val *NusightsProxyListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNusightsProxyListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNusightsProxyListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNusightsProxyListMetadata(val *NusightsProxyListMetadata) *NullableNusightsProxyListMetadata {
	return &NullableNusightsProxyListMetadata{value: val, isSet: true}
}

func (v NullableNusightsProxyListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNusightsProxyListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
