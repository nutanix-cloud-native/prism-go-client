...
// checks if the GroupsGetEntitiesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupsGetEntitiesResponse{}
...
type _GroupsGetEntitiesResponse GroupsGetEntitiesResponse
...
func NewGroupsGetEntitiesResponse() *GroupsGetEntitiesResponse {
	this := GroupsGetEntitiesResponse{}
	return &this
}
...
// GetFilteredGroupCount returns the FilteredGroupCount field value if set, zero value otherwise.
func (o *GroupsGetEntitiesResponse) GetFilteredGroupCount() int64 {
	if o == nil || IsNil(o.FilteredGroupCount) {
		var ret int64
		return ret
	}
	return *o.FilteredGroupCount
}

// GetFilteredGroupCountOk returns a tuple with the FilteredGroupCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GroupsGetEntitiesResponse) GetFilteredGroupCountOk() (*int64, bool) {
	if o == nil || IsNil(o.FilteredGroupCount) {
		return nil, false
	}
	return o.FilteredGroupCount, true
}
...
// SetFilteredGroupCount gets a reference to the given int64 and assigns it to the FilteredGroupCount field.
func (o *GroupsGetEntitiesResponse) SetFilteredGroupCount(v int64) {
	o.FilteredGroupCount = &v
}
...
func (o *GroupsGetEntitiesResponse) GetTotalEntityCount() int64 {
	if o == nil || IsNil(o.TotalEntityCount) {
		var ret int64
		return ret
	}
...
// SetTotalEntityCount gets a reference to the given int64 and assigns it to the TotalEntityCount field.
func (o *GroupsGetEntitiesResponse) SetTotalEntityCount(v int64) {
	o.TotalEntityCount = &v
}

// GetFilteredEntityCount returns the FilteredEntityCount field value if set, zero value otherwise.
func (o *GroupsGetEntitiesResponse) GetFilteredEntityCount() int64 {
	if o == nil || IsNil(o.FilteredEntityCount) {
		var ret int64
		return ret
	}
	return *o.FilteredEntityCount
}

// GetFilteredEntityCountOk returns a tuple with the FilteredEntityCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GroupsGetEntitiesResponse) GetFilteredEntityCountOk() (*int64, bool) {
	if o == nil || IsNil(o.FilteredEntityCount) {
		return nil, false
	}
	return o.FilteredEntityCount, true
}
...
// SetFilteredEntityCount gets a reference to the given int64 and assigns it to the FilteredEntityCount field.
func (o *GroupsGetEntitiesResponse) SetFilteredEntityCount(v int64) {
	o.FilteredEntityCount = &v
}

// GetGroupResults returns the GroupResults field value if set, zero value otherwise.
func (o *GroupsGetEntitiesResponse) GetGroupResults() []GroupsGroupResult {
	if o == nil || IsNil(o.GroupResults) {
		var ret []GroupsGroupResult
		return ret
	}
	return o.GroupResults
}

// GetGroupResultsOk returns a tuple with the GroupResults field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GroupsGetEntitiesResponse) GetGroupResultsOk() ([]GroupsGroupResult, bool) {
	if o == nil || IsNil(o.GroupResults) {
		return nil, false
	}
	return o.GroupResults, true
}
...
// SetGroupResults gets a reference to the given []GroupsGroupResult and assigns it to the GroupResults field.
func (o *GroupsGetEntitiesResponse) SetGroupResults(v []GroupsGroupResult) {
	o.GroupResults = v
}

// GetTotalGroupCount returns the TotalGroupCount field value if set, zero value otherwise.
func (o *GroupsGetEntitiesResponse) GetTotalGroupCount() int64 {
	if o == nil || IsNil(o.TotalGroupCount) {
		var ret int64
		return ret
	}
	return *o.TotalGroupCount
}

// GetTotalGroupCountOk returns a tuple with the TotalGroupCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GroupsGetEntitiesResponse) GetTotalGroupCountOk() (*int64, bool) {
	if o == nil || IsNil(o.TotalGroupCount) {
		return nil, false
	}
	return o.TotalGroupCount, true
}
...
// SetTotalGroupCount gets a reference to the given int64 and assigns it to the TotalGroupCount field.
func (o *GroupsGetEntitiesResponse) SetTotalGroupCount(v int64) {
	o.TotalGroupCount = &v
}

func (o GroupsGetEntitiesResponse) MarshalJSON() ([]byte, error) {
...
func (o GroupsGetEntitiesResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.EntityType) {
		toSerialize["entity_type"] = o.EntityType
	}
	if !IsNil(o.FilteredGroupCount) {
		toSerialize["filtered_group_count"] = o.FilteredGroupCount
	}
	if !IsNil(o.TotalEntityCount) {
		toSerialize["total_entity_count"] = o.TotalEntityCount
	}
	if !IsNil(o.FilteredEntityCount) {
		toSerialize["filtered_entity_count"] = o.FilteredEntityCount
	}
	if !IsNil(o.GroupResults) {
		toSerialize["group_results"] = o.GroupResults
	}
	if !IsNil(o.TotalGroupCount) {
		toSerialize["total_group_count"] = o.TotalGroupCount
	}
...
func (o *GroupsGetEntitiesResponse) UnmarshalJSON(data []byte) (err error) {
	varGroupsGetEntitiesResponse := _GroupsGetEntitiesResponse{}

	err = json.Unmarshal(data, &varGroupsGetEntitiesResponse)

	if err != nil {
		return err
	}

	*o = GroupsGetEntitiesResponse(varGroupsGetEntitiesResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "entity_type")
		delete(additionalProperties, "filtered_group_count")
		delete(additionalProperties, "total_entity_count")
		delete(additionalProperties, "filtered_entity_count")
		delete(additionalProperties, "group_results")
		delete(additionalProperties, "total_group_count")
...
type NullableGroupsGetEntitiesResponse struct {
	value *GroupsGetEntitiesResponse
	isSet bool
}

func (v NullableGroupsGetEntitiesResponse) Get() *GroupsGetEntitiesResponse {
	return v.value
}

func (v *NullableGroupsGetEntitiesResponse) Set(val *GroupsGetEntitiesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupsGetEntitiesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupsGetEntitiesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupsGetEntitiesResponse(val *GroupsGetEntitiesResponse) *NullableGroupsGetEntitiesResponse {
	return &NullableGroupsGetEntitiesResponse{value: val, isSet: true}
}

func (v NullableGroupsGetEntitiesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupsGetEntitiesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
