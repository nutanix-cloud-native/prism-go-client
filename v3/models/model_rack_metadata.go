...
// checks if the RackMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackMetadata{}

// RackMetadata The rack kind metadata
type RackMetadata struct {
	...
	// Categories for the rack. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the rack. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _RackMetadata RackMetadata
...
func (o RackMetadata) MarshalJSON() ([]byte, error) {
...
func (o RackMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RackMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varRackMetadata := _RackMetadata{}

	err = json.Unmarshal(data, &varRackMetadata)

	if err != nil {
		return err
	}

	*o = RackMetadata(varRackMetadata)
...
type NullableRackMetadata struct {
	value *RackMetadata
	isSet bool
}

func (v NullableRackMetadata) Get() *RackMetadata {
	return v.value
}

func (v *NullableRackMetadata) Set(val *RackMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRackMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRackMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackMetadata(val *RackMetadata) *NullableRackMetadata {
	return &NullableRackMetadata{value: val, isSet: true}
}

func (v NullableRackMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
