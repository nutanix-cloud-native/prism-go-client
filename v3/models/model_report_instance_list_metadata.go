...
// checks if the ReportInstanceListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstanceListMetadata{}

// ReportInstanceListMetadata All api calls that return a list will have this metadata block as input 
type ReportInstanceListMetadata struct {
	// The kind name
...
type _ReportInstanceListMetadata ReportInstanceListMetadata
...
func NewReportInstanceListMetadata() *ReportInstanceListMetadata {
	this := ReportInstanceListMetadata{}
...
func (o ReportInstanceListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ReportInstanceListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ReportInstanceListMetadata) UnmarshalJSON(data []byte) (err error) {
	varReportInstanceListMetadata := _ReportInstanceListMetadata{}

	err = json.Unmarshal(data, &varReportInstanceListMetadata)

	if err != nil {
		return err
	}

	*o = ReportInstanceListMetadata(varReportInstanceListMetadata)
...
type NullableReportInstanceListMetadata struct {
	value *ReportInstanceListMetadata
	isSet bool
}

func (v NullableReportInstanceListMetadata) Get() *ReportInstanceListMetadata {
	return v.value
}

func (v *NullableReportInstanceListMetadata) Set(val *ReportInstanceListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstanceListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstanceListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstanceListMetadata(val *ReportInstanceListMetadata) *NullableReportInstanceListMetadata {
	return &NullableReportInstanceListMetadata{value: val, isSet: true}
}

func (v NullableReportInstanceListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstanceListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
