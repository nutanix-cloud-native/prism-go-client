...
// checks if the TenantListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantListMetadataOutput{}

// TenantListMetadataOutput All api calls that return a list will have this metadata block 
type TenantListMetadataOutput struct {
	// The kind name
...
type _TenantListMetadataOutput TenantListMetadataOutput
...
func NewTenantListMetadataOutput() *TenantListMetadataOutput {
	this := TenantListMetadataOutput{}
	var kind string = "tenant"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *TenantListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o TenantListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o TenantListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *TenantListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varTenantListMetadataOutput := _TenantListMetadataOutput{}

	err = json.Unmarshal(data, &varTenantListMetadataOutput)

	if err != nil {
		return err
	}

	*o = TenantListMetadataOutput(varTenantListMetadataOutput)
...
type NullableTenantListMetadataOutput struct {
	value *TenantListMetadataOutput
	isSet bool
}

func (v NullableTenantListMetadataOutput) Get() *TenantListMetadataOutput {
	return v.value
}

func (v *NullableTenantListMetadataOutput) Set(val *TenantListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantListMetadataOutput(val *TenantListMetadataOutput) *NullableTenantListMetadataOutput {
	return &NullableTenantListMetadataOutput{value: val, isSet: true}
}

func (v NullableTenantListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
