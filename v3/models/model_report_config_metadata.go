...
// checks if the ReportConfigMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigMetadata{}

// ReportConfigMetadata The report_config kind metadata
type ReportConfigMetadata struct {
	...
	// Categories for the report_config. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the report_config. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _ReportConfigMetadata ReportConfigMetadata
...
func (o ReportConfigMetadata) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfigMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varReportConfigMetadata := _ReportConfigMetadata{}

	err = json.Unmarshal(data, &varReportConfigMetadata)

	if err != nil {
		return err
	}

	*o = ReportConfigMetadata(varReportConfigMetadata)
...
type NullableReportConfigMetadata struct {
	value *ReportConfigMetadata
	isSet bool
}

func (v NullableReportConfigMetadata) Get() *ReportConfigMetadata {
	return v.value
}

func (v *NullableReportConfigMetadata) Set(val *ReportConfigMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigMetadata(val *ReportConfigMetadata) *NullableReportConfigMetadata {
	return &NullableReportConfigMetadata{value: val, isSet: true}
}

func (v NullableReportConfigMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
