...
// checks if the AwsImageDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsImageDefStatus{}

// AwsImageDefStatus aws_image resources status
type AwsImageDefStatus struct {
	State *string `json:"state,omitempty"`
	// aws_image name.
	Name *string `json:"name,omitempty"`
	Resources *AwsImageResourcesDefStatus `json:"resources,omitempty"`
	// A description for aws_image.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsImageDefStatus AwsImageDefStatus
...
func (o *AwsImageDefStatus) GetResources() AwsImageResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret AwsImageResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given AwsImageResourcesDefStatus and assigns it to the Resources field.
...
func (o AwsImageDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsImageDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsImageDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsImageDefStatus := _AwsImageDefStatus{}

	err = json.Unmarshal(data, &varAwsImageDefStatus)

	if err != nil {
		return err
	}

	*o = AwsImageDefStatus(varAwsImageDefStatus)
...
type NullableAwsImageDefStatus struct {
	value *AwsImageDefStatus
	isSet bool
}

func (v NullableAwsImageDefStatus) Get() *AwsImageDefStatus {
	return v.value
}

func (v *NullableAwsImageDefStatus) Set(val *AwsImageDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsImageDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsImageDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsImageDefStatus(val *AwsImageDefStatus) *NullableAwsImageDefStatus {
	return &NullableAwsImageDefStatus{value: val, isSet: true}
}

func (v NullableAwsImageDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsImageDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
