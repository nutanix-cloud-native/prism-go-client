...
// checks if the PhysicalAvailabilityZoneReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalAvailabilityZoneReference{}

// PhysicalAvailabilityZoneReference The reference to a physical_availability_zone
type PhysicalAvailabilityZoneReference struct {
	// The kind name
...
type _PhysicalAvailabilityZoneReference PhysicalAvailabilityZoneReference
...
func NewPhysicalAvailabilityZoneReference(kind string, uUID string) *PhysicalAvailabilityZoneReference {
	this := PhysicalAvailabilityZoneReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o PhysicalAvailabilityZoneReference) MarshalJSON() ([]byte, error) {
...
func (o PhysicalAvailabilityZoneReference) ToMap() (map[string]interface{}, error) {
...
func (o *PhysicalAvailabilityZoneReference) UnmarshalJSON(data []byte) (err error) {
	...
	varPhysicalAvailabilityZoneReference := _PhysicalAvailabilityZoneReference{}

	err = json.Unmarshal(data, &varPhysicalAvailabilityZoneReference)

	if err != nil {
		return err
	}

	*o = PhysicalAvailabilityZoneReference(varPhysicalAvailabilityZoneReference)
...
type NullablePhysicalAvailabilityZoneReference struct {
	value *PhysicalAvailabilityZoneReference
	isSet bool
}

func (v NullablePhysicalAvailabilityZoneReference) Get() *PhysicalAvailabilityZoneReference {
	return v.value
}

func (v *NullablePhysicalAvailabilityZoneReference) Set(val *PhysicalAvailabilityZoneReference) {
	v.value = val
	v.isSet = true
}

func (v NullablePhysicalAvailabilityZoneReference) IsSet() bool {
	return v.isSet
}

func (v *NullablePhysicalAvailabilityZoneReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhysicalAvailabilityZoneReference(val *PhysicalAvailabilityZoneReference) *NullablePhysicalAvailabilityZoneReference {
	return &NullablePhysicalAvailabilityZoneReference{value: val, isSet: true}
}

func (v NullablePhysicalAvailabilityZoneReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhysicalAvailabilityZoneReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
