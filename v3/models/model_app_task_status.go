...
// checks if the AppTaskStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskStatus{}

// AppTaskStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _AppTaskStatus AppTaskStatus
...
func (o AppTaskStatus) MarshalJSON() ([]byte, error) {
...
func (o AppTaskStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskStatus) UnmarshalJSON(data []byte) (err error) {
	varAppTaskStatus := _AppTaskStatus{}

	err = json.Unmarshal(data, &varAppTaskStatus)

	if err != nil {
		return err
	}

	*o = AppTaskStatus(varAppTaskStatus)
...
type NullableAppTaskStatus struct {
	value *AppTaskStatus
	isSet bool
}

func (v NullableAppTaskStatus) Get() *AppTaskStatus {
	return v.value
}

func (v *NullableAppTaskStatus) Set(val *AppTaskStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskStatus(val *AppTaskStatus) *NullableAppTaskStatus {
	return &NullableAppTaskStatus{value: val, isSet: true}
}

func (v NullableAppTaskStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
