...
// checks if the ClusterListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterListIntentResponse{}

// ClusterListIntentResponse Response object for intentful operation of clusters
...
type _ClusterListIntentResponse ClusterListIntentResponse
...
func NewClusterListIntentResponse(apiVersion string, metadata ClusterListMetadataOutput) *ClusterListIntentResponse {
	this := ClusterListIntentResponse{}
...
// SetEntities gets a reference to the given []ClusterIntentResource and assigns it to the Entities field.
...
func (o *ClusterListIntentResponse) GetMetadata() ClusterListMetadataOutput {
	if o == nil {
		var ret ClusterListMetadataOutput
		return ret
	}
...
func (o ClusterListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ClusterListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterListIntentResponse := _ClusterListIntentResponse{}

	err = json.Unmarshal(data, &varClusterListIntentResponse)

	if err != nil {
		return err
	}

	*o = ClusterListIntentResponse(varClusterListIntentResponse)
...
type NullableClusterListIntentResponse struct {
	value *ClusterListIntentResponse
	isSet bool
}

func (v NullableClusterListIntentResponse) Get() *ClusterListIntentResponse {
	return v.value
}

func (v *NullableClusterListIntentResponse) Set(val *ClusterListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterListIntentResponse(val *ClusterListIntentResponse) *NullableClusterListIntentResponse {
	return &NullableClusterListIntentResponse{value: val, isSet: true}
}

func (v NullableClusterListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
