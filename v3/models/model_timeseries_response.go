...
// TimeseriesResponse Timeseries response object defintion.
type TimeseriesResponse struct {
	// Type of the timeseries response.
	Type *string `json:"type,omitempty"`
	// Group query object definition. Making it opaque in the first release. This will have the details of the parameters which are present in group query. 
	Result map[string]interface{} `json:"result,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _TimeseriesResponse TimeseriesResponse
...
func (o *TimeseriesResponse) UnmarshalJSON(data []byte) (err error) {
	varTimeseriesResponse := _TimeseriesResponse{}

	err = json.Unmarshal(data, &varTimeseriesResponse)

	if err != nil {
		return err
	}

	*o = TimeseriesResponse(varTimeseriesResponse)
