...
// checks if the ReportInstanceStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstanceStatus{}

// ReportInstanceStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _ReportInstanceStatus ReportInstanceStatus
...
func (o ReportInstanceStatus) MarshalJSON() ([]byte, error) {
...
func (o ReportInstanceStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ReportInstanceStatus) UnmarshalJSON(data []byte) (err error) {
	varReportInstanceStatus := _ReportInstanceStatus{}

	err = json.Unmarshal(data, &varReportInstanceStatus)

	if err != nil {
		return err
	}

	*o = ReportInstanceStatus(varReportInstanceStatus)
...
type NullableReportInstanceStatus struct {
	value *ReportInstanceStatus
	isSet bool
}

func (v NullableReportInstanceStatus) Get() *ReportInstanceStatus {
	return v.value
}

func (v *NullableReportInstanceStatus) Set(val *ReportInstanceStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstanceStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstanceStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstanceStatus(val *ReportInstanceStatus) *NullableReportInstanceStatus {
	return &NullableReportInstanceStatus{value: val, isSet: true}
}

func (v NullableReportInstanceStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstanceStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
