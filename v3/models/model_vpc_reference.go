...
// checks if the VpcReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcReference{}

// VpcReference The reference to a vpc
...
type _VpcReference VpcReference
...
func (o VpcReference) MarshalJSON() ([]byte, error) {
...
func (o VpcReference) ToMap() (map[string]interface{}, error) {
...
func (o *VpcReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVpcReference := _VpcReference{}

	err = json.Unmarshal(data, &varVpcReference)

	if err != nil {
		return err
	}

	*o = VpcReference(varVpcReference)
...
type NullableVpcReference struct {
	value *VpcReference
	isSet bool
}

func (v NullableVpcReference) Get() *VpcReference {
	return v.value
}

func (v *NullableVpcReference) Set(val *VpcReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcReference(val *VpcReference) *NullableVpcReference {
	return &NullableVpcReference{value: val, isSet: true}
}

func (v NullableVpcReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
