...
// checks if the StretchStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StretchStatus{}

// StretchStatus Layer2 stretch status.
...
type _StretchStatus StretchStatus
...
func (o StretchStatus) MarshalJSON() ([]byte, error) {
...
func (o StretchStatus) ToMap() (map[string]interface{}, error) {
...
func (o *StretchStatus) UnmarshalJSON(data []byte) (err error) {
	varStretchStatus := _StretchStatus{}

	err = json.Unmarshal(data, &varStretchStatus)

	if err != nil {
		return err
	}

	*o = StretchStatus(varStretchStatus)
...
type NullableStretchStatus struct {
	value *StretchStatus
	isSet bool
}

func (v NullableStretchStatus) Get() *StretchStatus {
	return v.value
}

func (v *NullableStretchStatus) Set(val *StretchStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableStretchStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableStretchStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStretchStatus(val *StretchStatus) *NullableStretchStatus {
	return &NullableStretchStatus{value: val, isSet: true}
}

func (v NullableStretchStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStretchStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
