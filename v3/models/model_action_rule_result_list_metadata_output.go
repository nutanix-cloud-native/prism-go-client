...
// checks if the ActionRuleResultListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResultListMetadataOutput{}

// ActionRuleResultListMetadataOutput All api calls that return a list will have this metadata block 
type ActionRuleResultListMetadataOutput struct {
	// The kind name
...
type _ActionRuleResultListMetadataOutput ActionRuleResultListMetadataOutput
...
func NewActionRuleResultListMetadataOutput() *ActionRuleResultListMetadataOutput {
	this := ActionRuleResultListMetadataOutput{}
	var kind string = "action_rule_result"
	this.Kind = &kind
	return &this
}
...
func (o ActionRuleResultListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResultListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleResultListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varActionRuleResultListMetadataOutput := _ActionRuleResultListMetadataOutput{}

	err = json.Unmarshal(data, &varActionRuleResultListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ActionRuleResultListMetadataOutput(varActionRuleResultListMetadataOutput)
...
type NullableActionRuleResultListMetadataOutput struct {
	value *ActionRuleResultListMetadataOutput
	isSet bool
}

func (v NullableActionRuleResultListMetadataOutput) Get() *ActionRuleResultListMetadataOutput {
	return v.value
}

func (v *NullableActionRuleResultListMetadataOutput) Set(val *ActionRuleResultListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResultListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResultListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResultListMetadataOutput(val *ActionRuleResultListMetadataOutput) *NullableActionRuleResultListMetadataOutput {
	return &NullableActionRuleResultListMetadataOutput{value: val, isSet: true}
}

func (v NullableActionRuleResultListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResultListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
