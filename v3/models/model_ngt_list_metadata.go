...
// checks if the NgtListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtListMetadata{}

// NgtListMetadata All api calls that return a list will have this metadata block as input 
type NgtListMetadata struct {
	// The kind name
...
type _NgtListMetadata NgtListMetadata
...
func (o NgtListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NgtListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NgtListMetadata) UnmarshalJSON(data []byte) (err error) {
	varNgtListMetadata := _NgtListMetadata{}

	err = json.Unmarshal(data, &varNgtListMetadata)

	if err != nil {
		return err
	}

	*o = NgtListMetadata(varNgtListMetadata)
...
type NullableNgtListMetadata struct {
	value *NgtListMetadata
	isSet bool
}

func (v NullableNgtListMetadata) Get() *NgtListMetadata {
	return v.value
}

func (v *NullableNgtListMetadata) Set(val *NgtListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtListMetadata(val *NgtListMetadata) *NullableNgtListMetadata {
	return &NullableNgtListMetadata{value: val, isSet: true}
}

func (v NullableNgtListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
