...
// checks if the AwsElasticIpResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsElasticIpResourcesDefStatus{}

// AwsElasticIpResourcesDefStatus AWS elastic IP creation/modification status.
type AwsElasticIpResourcesDefStatus struct {
	// Indicates whether the address is an EC2 or VPC address.
	...
	// The allocation AWS ID for the address (only for VPC)
	AllocationId *string `json:"allocation_id,omitempty"`
	// The AWS ID of the instance the address is associated with. 
	InstanceId *string `json:"instance_id,omitempty" validate:"regexp=^i-[a-f0-9]{1,17}$"`
	// The association AWS ID for the address (only for VPC)
	AssociationId *string `json:"association_id,omitempty"`
	// The network interface (if any) that the address is associated with (only for VPC). 
	NetworkInterfaceId *string `json:"network_interface_id,omitempty"`
	// The private IP address associated with the Elastic IP (only for VPC) 
	...
	// The owner AWS ID (only for VPC).
	NetworkInterfaceOwnerId *string `json:"network_interface_owner_id,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsElasticIpResourcesDefStatus AwsElasticIpResourcesDefStatus
...
func NewAwsElasticIpResourcesDefStatus() *AwsElasticIpResourcesDefStatus {
	this := AwsElasticIpResourcesDefStatus{}
	return &this
}
...
// GetNetworkInterfaceId returns the NetworkInterfaceId field value if set, zero value otherwise.
func (o *AwsElasticIpResourcesDefStatus) GetNetworkInterfaceId() string {
	if o == nil || IsNil(o.NetworkInterfaceId) {
		var ret string
		return ret
	}
	return *o.NetworkInterfaceId
}
...
func (o *AwsElasticIpResourcesDefStatus) GetNetworkInterfaceIdOk() (*string, bool) {
	...
	return o.NetworkInterfaceId, true
}
...
// SetNetworkInterfaceId gets a reference to the given string and assigns it to the NetworkInterfaceId field.
func (o *AwsElasticIpResourcesDefStatus) SetNetworkInterfaceId(v string) {
	o.NetworkInterfaceId = &v
}
...
// GetNetworkInterfaceOwnerId returns the NetworkInterfaceOwnerId field value if set, zero value otherwise.
func (o *AwsElasticIpResourcesDefStatus) GetNetworkInterfaceOwnerId() string {
	if o == nil || IsNil(o.NetworkInterfaceOwnerId) {
		var ret string
		return ret
	}
	return *o.NetworkInterfaceOwnerId
}

// GetNetworkInterfaceOwnerIdOk returns a tuple with the NetworkInterfaceOwnerId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AwsElasticIpResourcesDefStatus) GetNetworkInterfaceOwnerIdOk() (*string, bool) {
	if o == nil || IsNil(o.NetworkInterfaceOwnerId) {
		return nil, false
	}
	return o.NetworkInterfaceOwnerId, true
}
...
// SetNetworkInterfaceOwnerId gets a reference to the given string and assigns it to the NetworkInterfaceOwnerId field.
func (o *AwsElasticIpResourcesDefStatus) SetNetworkInterfaceOwnerId(v string) {
	o.NetworkInterfaceOwnerId = &v
}

func (o AwsElasticIpResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsElasticIpResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NetworkInterfaceId) {
		toSerialize["network_interface_id"] = o.NetworkInterfaceId
	}
	if !IsNil(o.PrivateIpAddress) {
		toSerialize["private_ip_address"] = o.PrivateIpAddress
	}
	if !IsNil(o.NetworkInterfaceOwnerId) {
		toSerialize["network_interface_owner_id"] = o.NetworkInterfaceOwnerId
	}
...
func (o *AwsElasticIpResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsElasticIpResourcesDefStatus := _AwsElasticIpResourcesDefStatus{}

	err = json.Unmarshal(data, &varAwsElasticIpResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = AwsElasticIpResourcesDefStatus(varAwsElasticIpResourcesDefStatus)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "allocation_id")
		...
		delete(additionalProperties, "network_interface_owner_id")
...
type NullableAwsElasticIpResourcesDefStatus struct {
	value *AwsElasticIpResourcesDefStatus
	isSet bool
}

func (v NullableAwsElasticIpResourcesDefStatus) Get() *AwsElasticIpResourcesDefStatus {
	return v.value
}

func (v *NullableAwsElasticIpResourcesDefStatus) Set(val *AwsElasticIpResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsElasticIpResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsElasticIpResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsElasticIpResourcesDefStatus(val *AwsElasticIpResourcesDefStatus) *NullableAwsElasticIpResourcesDefStatus {
	return &NullableAwsElasticIpResourcesDefStatus{value: val, isSet: true}
}

func (v NullableAwsElasticIpResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsElasticIpResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
