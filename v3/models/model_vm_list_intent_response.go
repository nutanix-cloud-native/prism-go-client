...
// checks if the VmListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmListIntentResponse{}
...
type _VmListIntentResponse VmListIntentResponse
...
// SetEntities gets a reference to the given []VmIntentResource and assigns it to the Entities field.
...
func (o VmListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VmListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VmListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVmListIntentResponse := _VmListIntentResponse{}

	err = json.Unmarshal(data, &varVmListIntentResponse)

	if err != nil {
		return err
	}

	*o = VmListIntentResponse(varVmListIntentResponse)
...
type NullableVmListIntentResponse struct {
	value *VmListIntentResponse
	isSet bool
}

func (v NullableVmListIntentResponse) Get() *VmListIntentResponse {
	return v.value
}

func (v *NullableVmListIntentResponse) Set(val *VmListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVmListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVmListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmListIntentResponse(val *VmListIntentResponse) *NullableVmListIntentResponse {
	return &NullableVmListIntentResponse{value: val, isSet: true}
}

func (v NullableVmListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
