...
// checks if the CloudTenantDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTenantDefStatus{}

// CloudTenantDefStatus An intentful representation of a cloud_tenant status
type CloudTenantDefStatus struct {
	// cloud_tenant Name.
	Name string `json:"name"`
	// The state of the cloud_tenant.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the cloud_tenant, if in an error state.
	...
	Resources CloudTenantResourcesDefStatus `json:"resources"`
	// A description for cloud_tenant.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CloudTenantDefStatus CloudTenantDefStatus
...
func (o *CloudTenantDefStatus) GetResources() CloudTenantResourcesDefStatus {
	if o == nil {
		var ret CloudTenantResourcesDefStatus
		return ret
	}
...
func (o CloudTenantDefStatus) MarshalJSON() ([]byte, error) {
...
func (o CloudTenantDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTenantDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTenantDefStatus := _CloudTenantDefStatus{}

	err = json.Unmarshal(data, &varCloudTenantDefStatus)

	if err != nil {
		return err
	}

	*o = CloudTenantDefStatus(varCloudTenantDefStatus)
...
type NullableCloudTenantDefStatus struct {
	value *CloudTenantDefStatus
	isSet bool
}

func (v NullableCloudTenantDefStatus) Get() *CloudTenantDefStatus {
	return v.value
}

func (v *NullableCloudTenantDefStatus) Set(val *CloudTenantDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTenantDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTenantDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTenantDefStatus(val *CloudTenantDefStatus) *NullableCloudTenantDefStatus {
	return &NullableCloudTenantDefStatus{value: val, isSet: true}
}

func (v NullableCloudTenantDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTenantDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
