...
// checks if the StoragePolicyStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyStatus{}

// StoragePolicyStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _StoragePolicyStatus StoragePolicyStatus
...
func (o StoragePolicyStatus) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyStatus) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePolicyStatus) UnmarshalJSON(data []byte) (err error) {
	varStoragePolicyStatus := _StoragePolicyStatus{}

	err = json.Unmarshal(data, &varStoragePolicyStatus)

	if err != nil {
		return err
	}

	*o = StoragePolicyStatus(varStoragePolicyStatus)
...
type NullableStoragePolicyStatus struct {
	value *StoragePolicyStatus
	isSet bool
}

func (v NullableStoragePolicyStatus) Get() *StoragePolicyStatus {
	return v.value
}

func (v *NullableStoragePolicyStatus) Set(val *StoragePolicyStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyStatus(val *StoragePolicyStatus) *NullableStoragePolicyStatus {
	return &NullableStoragePolicyStatus{value: val, isSet: true}
}

func (v NullableStoragePolicyStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
