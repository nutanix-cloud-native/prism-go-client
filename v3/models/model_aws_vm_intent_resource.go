...
// checks if the AwsVmIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVmIntentResource{}

// AwsVmIntentResource Response object for intentful operations on a aws_vm
type AwsVmIntentResource struct {
	Status *AwsVmDefStatus `json:"status,omitempty"`
	Spec *AwsVm `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata AwsVmMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsVmIntentResource AwsVmIntentResource
...
// SetStatus gets a reference to the given AwsVmDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given AwsVm and assigns it to the Spec field.
...
func (o AwsVmIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsVmIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVmIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVmIntentResource := _AwsVmIntentResource{}

	err = json.Unmarshal(data, &varAwsVmIntentResource)

	if err != nil {
		return err
	}

	*o = AwsVmIntentResource(varAwsVmIntentResource)
...
type NullableAwsVmIntentResource struct {
	value *AwsVmIntentResource
	isSet bool
}

func (v NullableAwsVmIntentResource) Get() *AwsVmIntentResource {
	return v.value
}

func (v *NullableAwsVmIntentResource) Set(val *AwsVmIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVmIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVmIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVmIntentResource(val *AwsVmIntentResource) *NullableAwsVmIntentResource {
	return &NullableAwsVmIntentResource{value: val, isSet: true}
}

func (v NullableAwsVmIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVmIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
