...
// checks if the AwsRoleListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRoleListMetadataOutput{}

// AwsRoleListMetadataOutput All api calls that return a list will have this metadata block 
type AwsRoleListMetadataOutput struct {
	// The kind name
...
type _AwsRoleListMetadataOutput AwsRoleListMetadataOutput
...
func NewAwsRoleListMetadataOutput() *AwsRoleListMetadataOutput {
	this := AwsRoleListMetadataOutput{}
	var kind string = "aws_role"
	this.Kind = &kind
	return &this
}
...
func (o AwsRoleListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsRoleListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRoleListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsRoleListMetadataOutput := _AwsRoleListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsRoleListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsRoleListMetadataOutput(varAwsRoleListMetadataOutput)
...
type NullableAwsRoleListMetadataOutput struct {
	value *AwsRoleListMetadataOutput
	isSet bool
}

func (v NullableAwsRoleListMetadataOutput) Get() *AwsRoleListMetadataOutput {
	return v.value
}

func (v *NullableAwsRoleListMetadataOutput) Set(val *AwsRoleListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRoleListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRoleListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRoleListMetadataOutput(val *AwsRoleListMetadataOutput) *NullableAwsRoleListMetadataOutput {
	return &NullableAwsRoleListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsRoleListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRoleListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
