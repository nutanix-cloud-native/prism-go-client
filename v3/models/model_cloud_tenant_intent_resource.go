...
// checks if the CloudTenantIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTenantIntentResource{}

// CloudTenantIntentResource Response object for intentful operations on a cloud_tenant
type CloudTenantIntentResource struct {
	Status *CloudTenantDefStatus `json:"status,omitempty"`
	Spec *CloudTenant `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata CloudTenantMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _CloudTenantIntentResource CloudTenantIntentResource
...
func NewCloudTenantIntentResource(metadata CloudTenantMetadata) *CloudTenantIntentResource {
	this := CloudTenantIntentResource{}
...
// SetStatus gets a reference to the given CloudTenantDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given CloudTenant and assigns it to the Spec field.
...
func (o CloudTenantIntentResource) MarshalJSON() ([]byte, error) {
...
func (o CloudTenantIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTenantIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTenantIntentResource := _CloudTenantIntentResource{}

	err = json.Unmarshal(data, &varCloudTenantIntentResource)

	if err != nil {
		return err
	}

	*o = CloudTenantIntentResource(varCloudTenantIntentResource)
...
type NullableCloudTenantIntentResource struct {
	value *CloudTenantIntentResource
	isSet bool
}

func (v NullableCloudTenantIntentResource) Get() *CloudTenantIntentResource {
	return v.value
}

func (v *NullableCloudTenantIntentResource) Set(val *CloudTenantIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTenantIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTenantIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTenantIntentResource(val *CloudTenantIntentResource) *NullableCloudTenantIntentResource {
	return &NullableCloudTenantIntentResource{value: val, isSet: true}
}

func (v NullableCloudTenantIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTenantIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
