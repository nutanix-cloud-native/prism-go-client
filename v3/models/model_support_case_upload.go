...
// checks if the SupportCaseUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseUpload{}

// SupportCaseUpload Definition of support case.
type SupportCaseUpload struct {
...
type _SupportCaseUpload SupportCaseUpload
...
func (o SupportCaseUpload) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseUpload) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseUpload) UnmarshalJSON(data []byte) (err error) {
	varSupportCaseUpload := _SupportCaseUpload{}

	err = json.Unmarshal(data, &varSupportCaseUpload)

	if err != nil {
		return err
	}

	*o = SupportCaseUpload(varSupportCaseUpload)
...
type NullableSupportCaseUpload struct {
	value *SupportCaseUpload
	isSet bool
}

func (v NullableSupportCaseUpload) Get() *SupportCaseUpload {
	return v.value
}

func (v *NullableSupportCaseUpload) Set(val *SupportCaseUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseUpload(val *SupportCaseUpload) *NullableSupportCaseUpload {
	return &NullableSupportCaseUpload{value: val, isSet: true}
}

func (v NullableSupportCaseUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
