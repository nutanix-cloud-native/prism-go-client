...
// SetWindowsDomain gets a reference to the given WindowsDomain and assigns it to the WindowsDomain field.
func (o *HostResources) SetWindowsDomain(v WindowsDomain) {
	o.WindowsDomain = &v
}

// GetControllerVm returns the ControllerVm field value if set, zero value otherwise.
func (o *HostResources) GetControllerVm() ControllerVm {
	if o == nil || IsNil(o.ControllerVm) {
		var ret ControllerVm
		return ret
	}
	return *o.ControllerVm
}

// GetControllerVmOk returns a tuple with the ControllerVm field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HostResources) GetControllerVmOk() (*ControllerVm, bool) {
	if o == nil || IsNil(o.ControllerVm) {
		return nil, false
	}
	return o.ControllerVm, true
}
...
// SetControllerVm gets a reference to the given ControllerVm and assigns it to the ControllerVm field.
func (o *HostResources) SetControllerVm(v ControllerVm) {
	o.ControllerVm = &v
}

// GetFailoverCluster returns the FailoverCluster field value if set, zero value otherwise.
func (o *HostResources) GetFailoverCluster() FailoverCluster {
	if o == nil || IsNil(o.FailoverCluster) {
		var ret FailoverCluster
		return ret
	}
	return *o.FailoverCluster
}

// GetFailoverClusterOk returns a tuple with the FailoverCluster field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HostResources) GetFailoverClusterOk() (*FailoverCluster, bool) {
	if o == nil || IsNil(o.FailoverCluster) {
		return nil, false
	}
	return o.FailoverCluster, true
}
...
// SetFailoverCluster gets a reference to the given FailoverCluster and assigns it to the FailoverCluster field.
...
func (o HostResources) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.WindowsDomain) {
		toSerialize["windows_domain"] = o.WindowsDomain
	}
	if !IsNil(o.ControllerVm) {
		toSerialize["controller_vm"] = o.ControllerVm
	}
	if !IsNil(o.FailoverCluster) {
		toSerialize["failover_cluster"] = o.FailoverCluster
	}
...
func (o *HostResources) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHostResources)
	...
	*o = HostResources(varHostResources)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "windows_domain")
		delete(additionalProperties, "controller_vm")
		delete(additionalProperties, "failover_cluster")
