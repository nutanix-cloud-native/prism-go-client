...
// checks if the CommonReportConfigResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigResources{}

// CommonReportConfigResources Common report config resources definition.
type CommonReportConfigResources struct {
	ReportCustomization *ReportCustomization `json:"report_customization,omitempty"`
...
type _CommonReportConfigResources CommonReportConfigResources

// NewCommonReportConfigResources instantiates a new CommonReportConfigResources object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCommonReportConfigResources() *CommonReportConfigResources {
	this := CommonReportConfigResources{}
	return &this
}

// NewCommonReportConfigResourcesWithDefaults instantiates a new CommonReportConfigResources object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCommonReportConfigResourcesWithDefaults() *CommonReportConfigResources {
	this := CommonReportConfigResources{}
	return &this
}

// GetReportCustomization returns the ReportCustomization field value if set, zero value otherwise.
func (o *CommonReportConfigResources) GetReportCustomization() ReportCustomization {
	if o == nil || IsNil(o.ReportCustomization) {
		var ret ReportCustomization
		return ret
	}
	return *o.ReportCustomization
}

// GetReportCustomizationOk returns a tuple with the ReportCustomization field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CommonReportConfigResources) GetReportCustomizationOk() (*ReportCustomization, bool) {
	if o == nil || IsNil(o.ReportCustomization) {
		return nil, false
	}
	return o.ReportCustomization, true
}

// HasReportCustomization returns a boolean if a field has been set.
func (o *CommonReportConfigResources) HasReportCustomization() bool {
	if o != nil && !IsNil(o.ReportCustomization) {
		return true
	}
...
// SetReportCustomization gets a reference to the given ReportCustomization and assigns it to the ReportCustomization field.
func (o *CommonReportConfigResources) SetReportCustomization(v ReportCustomization) {
	o.ReportCustomization = &v
}

// GetRetentionPolicy returns the RetentionPolicy field value if set, zero value otherwise.
func (o *CommonReportConfigResources) GetRetentionPolicy() RetentionPolicy {
...
// and a boolean to check if the value has been set.
func (o *CommonReportConfigResources) GetRetentionPolicyOk() (*RetentionPolicy, bool) {
	if o == nil || IsNil(o.RetentionPolicy) {
		return nil, false
	}
...
func (o *CommonReportConfigResources) HasRetentionPolicy() bool {
	if o != nil && !IsNil(o.RetentionPolicy) {
		return true
	}
...
func (o *CommonReportConfigResources) SetRetentionPolicy(v RetentionPolicy) {
	o.RetentionPolicy = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *CommonReportConfigResources) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *CommonReportConfigResources) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *CommonReportConfigResources) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *CommonReportConfigResources) SetDescription(v string) {
	o.Description = &v
}

// GetNotificationPolicy returns the NotificationPolicy field value if set, zero value otherwise.
func (o *CommonReportConfigResources) GetNotificationPolicy() NotificationPolicy {
...
// and a boolean to check if the value has been set.
func (o *CommonReportConfigResources) GetNotificationPolicyOk() (*NotificationPolicy, bool) {
	if o == nil || IsNil(o.NotificationPolicy) {
		return nil, false
	}
...
func (o *CommonReportConfigResources) HasNotificationPolicy() bool {
	if o != nil && !IsNil(o.NotificationPolicy) {
		return true
	}
...
func (o *CommonReportConfigResources) SetNotificationPolicy(v NotificationPolicy) {
	o.NotificationPolicy = &v
}

func (o CommonReportConfigResources) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ReportCustomization) {
		toSerialize["report_customization"] = o.ReportCustomization
	}
...
func (o *CommonReportConfigResources) UnmarshalJSON(data []byte) (err error) {
	varCommonReportConfigResources := _CommonReportConfigResources{}

	err = json.Unmarshal(data, &varCommonReportConfigResources)

	if err != nil {
		return err
	}

	*o = CommonReportConfigResources(varCommonReportConfigResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "report_customization")
...
type NullableCommonReportConfigResources struct {
	value *CommonReportConfigResources
	isSet bool
}

func (v NullableCommonReportConfigResources) Get() *CommonReportConfigResources {
	return v.value
}

func (v *NullableCommonReportConfigResources) Set(val *CommonReportConfigResources) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigResources) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigResources(val *CommonReportConfigResources) *NullableCommonReportConfigResources {
	return &NullableCommonReportConfigResources{value: val, isSet: true}
}

func (v NullableCommonReportConfigResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
