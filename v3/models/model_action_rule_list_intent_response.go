...
// checks if the ActionRuleListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleListIntentResponse{}

// ActionRuleListIntentResponse Response object for intentful operation of action_rules
type ActionRuleListIntentResponse struct {
	Entities []ActionRuleIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ActionRuleListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ActionRuleListIntentResponse ActionRuleListIntentResponse
...
func NewActionRuleListIntentResponse(apiVersion string, metadata ActionRuleListMetadataOutput) *ActionRuleListIntentResponse {
	this := ActionRuleListIntentResponse{}
...
func (o *ActionRuleListIntentResponse) GetEntities() []ActionRuleIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []ActionRuleIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []ActionRuleIntentResource and assigns it to the Entities field.
...
func (o *ActionRuleListIntentResponse) GetMetadata() ActionRuleListMetadataOutput {
	if o == nil {
		var ret ActionRuleListMetadataOutput
		return ret
	}
...
func (o ActionRuleListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleListIntentResponse := _ActionRuleListIntentResponse{}

	err = json.Unmarshal(data, &varActionRuleListIntentResponse)

	if err != nil {
		return err
	}

	*o = ActionRuleListIntentResponse(varActionRuleListIntentResponse)
...
type NullableActionRuleListIntentResponse struct {
	value *ActionRuleListIntentResponse
	isSet bool
}

func (v NullableActionRuleListIntentResponse) Get() *ActionRuleListIntentResponse {
	return v.value
}

func (v *NullableActionRuleListIntentResponse) Set(val *ActionRuleListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleListIntentResponse(val *ActionRuleListIntentResponse) *NullableActionRuleListIntentResponse {
	return &NullableActionRuleListIntentResponse{value: val, isSet: true}
}

func (v NullableActionRuleListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
