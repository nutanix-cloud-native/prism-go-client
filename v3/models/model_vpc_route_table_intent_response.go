...
// checks if the VpcRouteTableIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcRouteTableIntentResponse{}

// VpcRouteTableIntentResponse Response object for intentful operations on a vpc_route_table
type VpcRouteTableIntentResponse struct {
	Status *VpcRouteTableDefStatus `json:"status,omitempty"`
	Spec *VpcRouteTable `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata VpcRouteTableMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VpcRouteTableIntentResponse VpcRouteTableIntentResponse
...
func NewVpcRouteTableIntentResponse(apiVersion string, metadata VpcRouteTableMetadata) *VpcRouteTableIntentResponse {
	this := VpcRouteTableIntentResponse{}
...
func (o *VpcRouteTableIntentResponse) GetStatus() VpcRouteTableDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret VpcRouteTableDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given VpcRouteTableDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given VpcRouteTable and assigns it to the Spec field.
...
func (o VpcRouteTableIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VpcRouteTableIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VpcRouteTableIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVpcRouteTableIntentResponse := _VpcRouteTableIntentResponse{}

	err = json.Unmarshal(data, &varVpcRouteTableIntentResponse)

	if err != nil {
		return err
	}

	*o = VpcRouteTableIntentResponse(varVpcRouteTableIntentResponse)
...
type NullableVpcRouteTableIntentResponse struct {
	value *VpcRouteTableIntentResponse
	isSet bool
}

func (v NullableVpcRouteTableIntentResponse) Get() *VpcRouteTableIntentResponse {
	return v.value
}

func (v *NullableVpcRouteTableIntentResponse) Set(val *VpcRouteTableIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcRouteTableIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcRouteTableIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcRouteTableIntentResponse(val *VpcRouteTableIntentResponse) *NullableVpcRouteTableIntentResponse {
	return &NullableVpcRouteTableIntentResponse{value: val, isSet: true}
}

func (v NullableVpcRouteTableIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcRouteTableIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
