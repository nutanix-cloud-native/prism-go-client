...
// checks if the RemoteSyslogServerReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogServerReference{}

// RemoteSyslogServerReference The reference to a remote_syslog_server
type RemoteSyslogServerReference struct {
	// The kind name
...
type _RemoteSyslogServerReference RemoteSyslogServerReference
...
func NewRemoteSyslogServerReference(kind string, uUID string) *RemoteSyslogServerReference {
	this := RemoteSyslogServerReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o RemoteSyslogServerReference) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogServerReference) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogServerReference) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogServerReference := _RemoteSyslogServerReference{}

	err = json.Unmarshal(data, &varRemoteSyslogServerReference)

	if err != nil {
		return err
	}

	*o = RemoteSyslogServerReference(varRemoteSyslogServerReference)
...
type NullableRemoteSyslogServerReference struct {
	value *RemoteSyslogServerReference
	isSet bool
}

func (v NullableRemoteSyslogServerReference) Get() *RemoteSyslogServerReference {
	return v.value
}

func (v *NullableRemoteSyslogServerReference) Set(val *RemoteSyslogServerReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogServerReference) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogServerReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogServerReference(val *RemoteSyslogServerReference) *NullableRemoteSyslogServerReference {
	return &NullableRemoteSyslogServerReference{value: val, isSet: true}
}

func (v NullableRemoteSyslogServerReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogServerReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
