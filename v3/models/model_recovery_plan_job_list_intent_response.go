...
// checks if the RecoveryPlanJobListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobListIntentResponse{}

// RecoveryPlanJobListIntentResponse Response object for intentful operation of recovery_plan_jobs
type RecoveryPlanJobListIntentResponse struct {
	Entities []RecoveryPlanJobIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata RecoveryPlanJobListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanJobListIntentResponse RecoveryPlanJobListIntentResponse
...
func NewRecoveryPlanJobListIntentResponse(apiVersion string, metadata RecoveryPlanJobListMetadataOutput) *RecoveryPlanJobListIntentResponse {
	this := RecoveryPlanJobListIntentResponse{}
...
func (o *RecoveryPlanJobListIntentResponse) GetEntities() []RecoveryPlanJobIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []RecoveryPlanJobIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []RecoveryPlanJobIntentResource and assigns it to the Entities field.
...
func (o *RecoveryPlanJobListIntentResponse) GetMetadata() RecoveryPlanJobListMetadataOutput {
	if o == nil {
		var ret RecoveryPlanJobListMetadataOutput
		return ret
	}
...
func (o RecoveryPlanJobListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobListIntentResponse := _RecoveryPlanJobListIntentResponse{}

	err = json.Unmarshal(data, &varRecoveryPlanJobListIntentResponse)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobListIntentResponse(varRecoveryPlanJobListIntentResponse)
...
type NullableRecoveryPlanJobListIntentResponse struct {
	value *RecoveryPlanJobListIntentResponse
	isSet bool
}

func (v NullableRecoveryPlanJobListIntentResponse) Get() *RecoveryPlanJobListIntentResponse {
	return v.value
}

func (v *NullableRecoveryPlanJobListIntentResponse) Set(val *RecoveryPlanJobListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobListIntentResponse(val *RecoveryPlanJobListIntentResponse) *NullableRecoveryPlanJobListIntentResponse {
	return &NullableRecoveryPlanJobListIntentResponse{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
