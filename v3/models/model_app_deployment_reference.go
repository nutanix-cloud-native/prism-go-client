...
// checks if the AppDeploymentReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppDeploymentReference{}

// AppDeploymentReference The reference to a app_deployment
type AppDeploymentReference struct {
	// The kind name
...
type _AppDeploymentReference AppDeploymentReference
...
func (o AppDeploymentReference) MarshalJSON() ([]byte, error) {
...
func (o AppDeploymentReference) ToMap() (map[string]interface{}, error) {
...
func (o *AppDeploymentReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAppDeploymentReference := _AppDeploymentReference{}

	err = json.Unmarshal(data, &varAppDeploymentReference)

	if err != nil {
		return err
	}

	*o = AppDeploymentReference(varAppDeploymentReference)
...
type NullableAppDeploymentReference struct {
	value *AppDeploymentReference
	isSet bool
}

func (v NullableAppDeploymentReference) Get() *AppDeploymentReference {
	return v.value
}

func (v *NullableAppDeploymentReference) Set(val *AppDeploymentReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAppDeploymentReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAppDeploymentReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppDeploymentReference(val *AppDeploymentReference) *NullableAppDeploymentReference {
	return &NullableAppDeploymentReference{value: val, isSet: true}
}

func (v NullableAppDeploymentReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppDeploymentReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
