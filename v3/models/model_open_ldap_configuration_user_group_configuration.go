...
// checks if the OpenLdapConfigurationUserGroupConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenLdapConfigurationUserGroupConfiguration{}

// OpenLdapConfigurationUserGroupConfiguration struct for OpenLdapConfigurationUserGroupConfiguration
type OpenLdapConfigurationUserGroupConfiguration struct {
...
type _OpenLdapConfigurationUserGroupConfiguration OpenLdapConfigurationUserGroupConfiguration
...
func NewOpenLdapConfigurationUserGroupConfiguration(groupSearchBase string, groupMemberAttribute string, groupObjectClass string, groupMemberAttributeValue string) *OpenLdapConfigurationUserGroupConfiguration {
	this := OpenLdapConfigurationUserGroupConfiguration{}
...
func (o OpenLdapConfigurationUserGroupConfiguration) MarshalJSON() ([]byte, error) {
...
func (o OpenLdapConfigurationUserGroupConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *OpenLdapConfigurationUserGroupConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenLdapConfigurationUserGroupConfiguration := _OpenLdapConfigurationUserGroupConfiguration{}

	err = json.Unmarshal(data, &varOpenLdapConfigurationUserGroupConfiguration)

	if err != nil {
		return err
	}

	*o = OpenLdapConfigurationUserGroupConfiguration(varOpenLdapConfigurationUserGroupConfiguration)
...
type NullableOpenLdapConfigurationUserGroupConfiguration struct {
	value *OpenLdapConfigurationUserGroupConfiguration
	isSet bool
}

func (v NullableOpenLdapConfigurationUserGroupConfiguration) Get() *OpenLdapConfigurationUserGroupConfiguration {
	return v.value
}

func (v *NullableOpenLdapConfigurationUserGroupConfiguration) Set(val *OpenLdapConfigurationUserGroupConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenLdapConfigurationUserGroupConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenLdapConfigurationUserGroupConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenLdapConfigurationUserGroupConfiguration(val *OpenLdapConfigurationUserGroupConfiguration) *NullableOpenLdapConfigurationUserGroupConfiguration {
	return &NullableOpenLdapConfigurationUserGroupConfiguration{value: val, isSet: true}
}

func (v NullableOpenLdapConfigurationUserGroupConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenLdapConfigurationUserGroupConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
