...
// checks if the AppRunbookResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunbookResponse{}

// AppRunbookResponse Runbook definition for Application
type AppRunbookResponse struct {
	// 
	TaskDefinitionList []AppTaskResponse `json:"task_definition_list,omitempty"`
	// 
	...
	MainTaskLocalReference *AppTaskReference `json:"main_task_local_reference,omitempty"`
	// Message list
...
type _AppRunbookResponse AppRunbookResponse
...
// SetTaskDefinitionList gets a reference to the given []AppTaskResponse and assigns it to the TaskDefinitionList field.
...
// SetMainTaskLocalReference gets a reference to the given AppTaskReference and assigns it to the MainTaskLocalReference field.
...
func (o AppRunbookResponse) MarshalJSON() ([]byte, error) {
...
func (o AppRunbookResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunbookResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRunbookResponse := _AppRunbookResponse{}

	err = json.Unmarshal(data, &varAppRunbookResponse)

	if err != nil {
		return err
	}

	*o = AppRunbookResponse(varAppRunbookResponse)
...
type NullableAppRunbookResponse struct {
	value *AppRunbookResponse
	isSet bool
}

func (v NullableAppRunbookResponse) Get() *AppRunbookResponse {
	return v.value
}

func (v *NullableAppRunbookResponse) Set(val *AppRunbookResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunbookResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunbookResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunbookResponse(val *AppRunbookResponse) *NullableAppRunbookResponse {
	return &NullableAppRunbookResponse{value: val, isSet: true}
}

func (v NullableAppRunbookResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunbookResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
