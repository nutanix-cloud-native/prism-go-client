...
// checks if the ImagePlacementPolicyState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyState{}

// ImagePlacementPolicyState State of enforced policy on an entity.
type ImagePlacementPolicyState struct {
	PolicyReference Reference `json:"policy_reference"`
	PolicyInfo *ImagePlacementInfo `json:"policy_info,omitempty"`
	...
	ErrorMessageList []MessageResource `json:"error_message_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ImagePlacementPolicyState ImagePlacementPolicyState
...
func NewImagePlacementPolicyState(policyReference Reference, complianceStatus string, enforcementMode string) *ImagePlacementPolicyState {
	this := ImagePlacementPolicyState{}
...
// GetPolicyReference returns the PolicyReference field value
func (o *ImagePlacementPolicyState) GetPolicyReference() Reference {
	...
	return o.PolicyReference
}

// GetPolicyReferenceOk returns a tuple with the PolicyReference field value
// and a boolean to check if the value has been set.
func (o *ImagePlacementPolicyState) GetPolicyReferenceOk() (*Reference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PolicyReference, true
}

// SetPolicyReference sets field value
...
// SetPolicyInfo gets a reference to the given ImagePlacementInfo and assigns it to the PolicyInfo field.
...
// GetEnforcementMode returns the EnforcementMode field value
...
// GetEnforcementModeOk returns a tuple with the EnforcementMode field value
// and a boolean to check if the value has been set.
...
// SetEnforcementMode sets field value
...
// SetErrorMessageList gets a reference to the given []MessageResource and assigns it to the ErrorMessageList field.
func (o *ImagePlacementPolicyState) SetErrorMessageList(v []MessageResource) {
	o.ErrorMessageList = v
}

func (o ImagePlacementPolicyState) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyState) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["policy_reference"] = o.PolicyReference
	if !IsNil(o.PolicyInfo) {
		toSerialize["policy_info"] = o.PolicyInfo
	}
	toSerialize["compliance_status"] = o.ComplianceStatus
	toSerialize["enforcement_mode"] = o.EnforcementMode
...
func (o *ImagePlacementPolicyState) UnmarshalJSON(data []byte) (err error) {
	...
	varImagePlacementPolicyState := _ImagePlacementPolicyState{}

	err = json.Unmarshal(data, &varImagePlacementPolicyState)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyState(varImagePlacementPolicyState)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "policy_reference")
		delete(additionalProperties, "policy_info")
		delete(additionalProperties, "compliance_status")
		delete(additionalProperties, "enforcement_mode")
...
type NullableImagePlacementPolicyState struct {
	value *ImagePlacementPolicyState
	isSet bool
}

func (v NullableImagePlacementPolicyState) Get() *ImagePlacementPolicyState {
	return v.value
}

func (v *NullableImagePlacementPolicyState) Set(val *ImagePlacementPolicyState) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyState) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyState) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyState(val *ImagePlacementPolicyState) *NullableImagePlacementPolicyState {
	return &NullableImagePlacementPolicyState{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyState) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyState) UnmarshalJSON(src []byte) error {
	v.isSet = true
