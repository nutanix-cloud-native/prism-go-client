...
// checks if the SubnetListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubnetListMetadataOutput{}
...
type _SubnetListMetadataOutput SubnetListMetadataOutput
...
func NewSubnetListMetadataOutput() *SubnetListMetadataOutput {
	this := SubnetListMetadataOutput{}
	var kind string = "subnet"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *SubnetListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o SubnetListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o SubnetListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *SubnetListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varSubnetListMetadataOutput := _SubnetListMetadataOutput{}

	err = json.Unmarshal(data, &varSubnetListMetadataOutput)

	if err != nil {
		return err
	}

	*o = SubnetListMetadataOutput(varSubnetListMetadataOutput)
...
type NullableSubnetListMetadataOutput struct {
	value *SubnetListMetadataOutput
	isSet bool
}

func (v NullableSubnetListMetadataOutput) Get() *SubnetListMetadataOutput {
	return v.value
}

func (v *NullableSubnetListMetadataOutput) Set(val *SubnetListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableSubnetListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableSubnetListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubnetListMetadataOutput(val *SubnetListMetadataOutput) *NullableSubnetListMetadataOutput {
	return &NullableSubnetListMetadataOutput{value: val, isSet: true}
}

func (v NullableSubnetListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubnetListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
