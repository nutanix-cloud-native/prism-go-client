...
// checks if the AppProfileInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppProfileInputUpload{}

// AppProfileInputUpload App profile resources
type AppProfileInputUpload struct {
	// 
	DeploymentCreateList []BlueprintDeploymentInputUpload `json:"deployment_create_list,omitempty"`
	// 
...
type _AppProfileInputUpload AppProfileInputUpload
...
func (o *AppProfileInputUpload) GetDeploymentCreateList() []BlueprintDeploymentInputUpload {
	if o == nil || IsNil(o.DeploymentCreateList) {
		var ret []BlueprintDeploymentInputUpload
		return ret
	}
...
// SetDeploymentCreateList gets a reference to the given []BlueprintDeploymentInputUpload and assigns it to the DeploymentCreateList field.
...
func (o AppProfileInputUpload) MarshalJSON() ([]byte, error) {
...
func (o AppProfileInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppProfileInputUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppProfileInputUpload := _AppProfileInputUpload{}

	err = json.Unmarshal(data, &varAppProfileInputUpload)

	if err != nil {
		return err
	}

	*o = AppProfileInputUpload(varAppProfileInputUpload)
...
type NullableAppProfileInputUpload struct {
	value *AppProfileInputUpload
	isSet bool
}

func (v NullableAppProfileInputUpload) Get() *AppProfileInputUpload {
	return v.value
}

func (v *NullableAppProfileInputUpload) Set(val *AppProfileInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppProfileInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppProfileInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppProfileInputUpload(val *AppProfileInputUpload) *NullableAppProfileInputUpload {
	return &NullableAppProfileInputUpload{value: val, isSet: true}
}

func (v NullableAppProfileInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppProfileInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
