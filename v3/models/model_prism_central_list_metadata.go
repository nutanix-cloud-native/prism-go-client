...
// checks if the PrismCentralListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralListMetadata{}

// PrismCentralListMetadata All api calls that return a list will have this metadata block as input 
...
type _PrismCentralListMetadata PrismCentralListMetadata
...
func (o PrismCentralListMetadata) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *PrismCentralListMetadata) UnmarshalJSON(data []byte) (err error) {
	varPrismCentralListMetadata := _PrismCentralListMetadata{}

	err = json.Unmarshal(data, &varPrismCentralListMetadata)

	if err != nil {
		return err
	}

	*o = PrismCentralListMetadata(varPrismCentralListMetadata)
...
type NullablePrismCentralListMetadata struct {
	value *PrismCentralListMetadata
	isSet bool
}

func (v NullablePrismCentralListMetadata) Get() *PrismCentralListMetadata {
	return v.value
}

func (v *NullablePrismCentralListMetadata) Set(val *PrismCentralListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralListMetadata(val *PrismCentralListMetadata) *NullablePrismCentralListMetadata {
	return &NullablePrismCentralListMetadata{value: val, isSet: true}
}

func (v NullablePrismCentralListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
