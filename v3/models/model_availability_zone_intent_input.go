...
// checks if the AvailabilityZoneIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneIntentInput{}

// AvailabilityZoneIntentInput An intentful representation of a availability_zone
type AvailabilityZoneIntentInput struct {
	Spec AvailabilityZone `json:"spec"`
...
type _AvailabilityZoneIntentInput AvailabilityZoneIntentInput
...
func NewAvailabilityZoneIntentInput(spec AvailabilityZone, metadata AvailabilityZoneMetadata) *AvailabilityZoneIntentInput {
	this := AvailabilityZoneIntentInput{}
	this.Spec = spec
...
func (o AvailabilityZoneIntentInput) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAvailabilityZoneIntentInput := _AvailabilityZoneIntentInput{}

	err = json.Unmarshal(data, &varAvailabilityZoneIntentInput)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneIntentInput(varAvailabilityZoneIntentInput)
...
type NullableAvailabilityZoneIntentInput struct {
	value *AvailabilityZoneIntentInput
	isSet bool
}

func (v NullableAvailabilityZoneIntentInput) Get() *AvailabilityZoneIntentInput {
	return v.value
}

func (v *NullableAvailabilityZoneIntentInput) Set(val *AvailabilityZoneIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneIntentInput(val *AvailabilityZoneIntentInput) *NullableAvailabilityZoneIntentInput {
	return &NullableAvailabilityZoneIntentInput{value: val, isSet: true}
}

func (v NullableAvailabilityZoneIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
