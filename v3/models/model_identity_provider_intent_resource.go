...
// checks if the IdentityProviderIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderIntentResource{}

// IdentityProviderIntentResource Response object for intentful operations on a identity_provider
type IdentityProviderIntentResource struct {
...
type _IdentityProviderIntentResource IdentityProviderIntentResource
...
func NewIdentityProviderIntentResource(metadata IdentityProviderMetadata) *IdentityProviderIntentResource {
	this := IdentityProviderIntentResource{}
...
func (o IdentityProviderIntentResource) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProviderIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varIdentityProviderIntentResource := _IdentityProviderIntentResource{}

	err = json.Unmarshal(data, &varIdentityProviderIntentResource)

	if err != nil {
		return err
	}

	*o = IdentityProviderIntentResource(varIdentityProviderIntentResource)
...
type NullableIdentityProviderIntentResource struct {
	value *IdentityProviderIntentResource
	isSet bool
}

func (v NullableIdentityProviderIntentResource) Get() *IdentityProviderIntentResource {
	return v.value
}

func (v *NullableIdentityProviderIntentResource) Set(val *IdentityProviderIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderIntentResource(val *IdentityProviderIntentResource) *NullableIdentityProviderIntentResource {
	return &NullableIdentityProviderIntentResource{value: val, isSet: true}
}

func (v NullableIdentityProviderIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
