...
// checks if the CloudTrustReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustReference{}

// CloudTrustReference The reference to a cloud_trust
type CloudTrustReference struct {
	// The kind name
...
type _CloudTrustReference CloudTrustReference
...
func (o CloudTrustReference) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustReference) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrustReference) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTrustReference := _CloudTrustReference{}

	err = json.Unmarshal(data, &varCloudTrustReference)

	if err != nil {
		return err
	}

	*o = CloudTrustReference(varCloudTrustReference)
...
type NullableCloudTrustReference struct {
	value *CloudTrustReference
	isSet bool
}

func (v NullableCloudTrustReference) Get() *CloudTrustReference {
	return v.value
}

func (v *NullableCloudTrustReference) Set(val *CloudTrustReference) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustReference) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustReference(val *CloudTrustReference) *NullableCloudTrustReference {
	return &NullableCloudTrustReference{value: val, isSet: true}
}

func (v NullableCloudTrustReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
