...
// checks if the ClusterDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterDefStatus{}
...
type _ClusterDefStatus ClusterDefStatus
...
func (o *ClusterDefStatus) GetResources() ClusterDefStatusResources {
	if o == nil {
		var ret ClusterDefStatusResources
		return ret
	}
...
func (o ClusterDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ClusterDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterDefStatus := _ClusterDefStatus{}

	err = json.Unmarshal(data, &varClusterDefStatus)

	if err != nil {
		return err
	}

	*o = ClusterDefStatus(varClusterDefStatus)
...
type NullableClusterDefStatus struct {
	value *ClusterDefStatus
	isSet bool
}

func (v NullableClusterDefStatus) Get() *ClusterDefStatus {
	return v.value
}

func (v *NullableClusterDefStatus) Set(val *ClusterDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterDefStatus(val *ClusterDefStatus) *NullableClusterDefStatus {
	return &NullableClusterDefStatus{value: val, isSet: true}
}

func (v NullableClusterDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
