...
// checks if the ResourceDomainStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceDomainStatus{}

// ResourceDomainStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _ResourceDomainStatus ResourceDomainStatus
...
func (o ResourceDomainStatus) MarshalJSON() ([]byte, error) {
...
func (o ResourceDomainStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceDomainStatus) UnmarshalJSON(data []byte) (err error) {
	varResourceDomainStatus := _ResourceDomainStatus{}

	err = json.Unmarshal(data, &varResourceDomainStatus)

	if err != nil {
		return err
	}

	*o = ResourceDomainStatus(varResourceDomainStatus)
...
type NullableResourceDomainStatus struct {
	value *ResourceDomainStatus
	isSet bool
}

func (v NullableResourceDomainStatus) Get() *ResourceDomainStatus {
	return v.value
}

func (v *NullableResourceDomainStatus) Set(val *ResourceDomainStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceDomainStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceDomainStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceDomainStatus(val *ResourceDomainStatus) *NullableResourceDomainStatus {
	return &NullableResourceDomainStatus{value: val, isSet: true}
}

func (v NullableResourceDomainStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceDomainStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
