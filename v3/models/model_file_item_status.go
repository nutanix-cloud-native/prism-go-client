...
// checks if the FileItemStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemStatus{}

// FileItemStatus The status of a REST API call. Only used when there is a failure to report. 
type FileItemStatus struct {
	// The kind name
...
type _FileItemStatus FileItemStatus
...
func (o FileItemStatus) MarshalJSON() ([]byte, error) {
...
func (o FileItemStatus) ToMap() (map[string]interface{}, error) {
...
func (o *FileItemStatus) UnmarshalJSON(data []byte) (err error) {
	varFileItemStatus := _FileItemStatus{}

	err = json.Unmarshal(data, &varFileItemStatus)

	if err != nil {
		return err
	}

	*o = FileItemStatus(varFileItemStatus)
...
type NullableFileItemStatus struct {
	value *FileItemStatus
	isSet bool
}

func (v NullableFileItemStatus) Get() *FileItemStatus {
	return v.value
}

func (v *NullableFileItemStatus) Set(val *FileItemStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemStatus(val *FileItemStatus) *NullableFileItemStatus {
	return &NullableFileItemStatus{value: val, isSet: true}
}

func (v NullableFileItemStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
