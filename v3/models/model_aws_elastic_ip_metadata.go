...
// checks if the AwsElasticIpMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsElasticIpMetadata{}

// AwsElasticIpMetadata The aws_elastic_ip kind metadata
type AwsElasticIpMetadata struct {
	...
	// Categories for the aws_elastic_ip
...
type _AwsElasticIpMetadata AwsElasticIpMetadata
...
func (o AwsElasticIpMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsElasticIpMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsElasticIpMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsElasticIpMetadata := _AwsElasticIpMetadata{}

	err = json.Unmarshal(data, &varAwsElasticIpMetadata)

	if err != nil {
		return err
	}

	*o = AwsElasticIpMetadata(varAwsElasticIpMetadata)
...
type NullableAwsElasticIpMetadata struct {
	value *AwsElasticIpMetadata
	isSet bool
}

func (v NullableAwsElasticIpMetadata) Get() *AwsElasticIpMetadata {
	return v.value
}

func (v *NullableAwsElasticIpMetadata) Set(val *AwsElasticIpMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsElasticIpMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsElasticIpMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsElasticIpMetadata(val *AwsElasticIpMetadata) *NullableAwsElasticIpMetadata {
	return &NullableAwsElasticIpMetadata{value: val, isSet: true}
}

func (v NullableAwsElasticIpMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsElasticIpMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
