...
// checks if the AppServiceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppServiceResponse{}

// AppServiceResponse Service definition for Application
type AppServiceResponse struct {
	...
	ConfigReference *AppServiceReference `json:"config_reference,omitempty"`
	// 
...
type _AppServiceResponse AppServiceResponse
...
// SetConfigReference gets a reference to the given AppServiceReference and assigns it to the ConfigReference field.
...
func (o AppServiceResponse) MarshalJSON() ([]byte, error) {
...
func (o AppServiceResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppServiceResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppServiceResponse := _AppServiceResponse{}

	err = json.Unmarshal(data, &varAppServiceResponse)

	if err != nil {
		return err
	}

	*o = AppServiceResponse(varAppServiceResponse)
...
type NullableAppServiceResponse struct {
	value *AppServiceResponse
	isSet bool
}

func (v NullableAppServiceResponse) Get() *AppServiceResponse {
	return v.value
}

func (v *NullableAppServiceResponse) Set(val *AppServiceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppServiceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppServiceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppServiceResponse(val *AppServiceResponse) *NullableAppServiceResponse {
	return &NullableAppServiceResponse{value: val, isSet: true}
}

func (v NullableAppServiceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppServiceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
