...
// checks if the StretchSiteParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StretchSiteParams{}

// StretchSiteParams Site parameters for layer2 stretch.
type StretchSiteParams struct {
	StretchSubnetReference *SubnetReference `json:"stretch_subnet_reference,omitempty"`
	VpnInterfaceIp *string `json:"vpn_interface_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	VpnConnectionReference *VpnConnectionReference `json:"vpn_connection_reference,omitempty"`
	...
	// Prefix length of the subnet being stretched.
	SubnetPrefixLength *int32 `json:"subnet_prefix_length,omitempty"`
	PcClusterReference *ClusterReference `json:"pc_cluster_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _StretchSiteParams StretchSiteParams
...
// GetStretchSubnetReference returns the StretchSubnetReference field value if set, zero value otherwise.
func (o *StretchSiteParams) GetStretchSubnetReference() SubnetReference {
	if o == nil || IsNil(o.StretchSubnetReference) {
		var ret SubnetReference
		return ret
	}
	return *o.StretchSubnetReference
}

// GetStretchSubnetReferenceOk returns a tuple with the StretchSubnetReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StretchSiteParams) GetStretchSubnetReferenceOk() (*SubnetReference, bool) {
	if o == nil || IsNil(o.StretchSubnetReference) {
		return nil, false
	}
	return o.StretchSubnetReference, true
}
...
// SetStretchSubnetReference gets a reference to the given SubnetReference and assigns it to the StretchSubnetReference field.
func (o *StretchSiteParams) SetStretchSubnetReference(v SubnetReference) {
	o.StretchSubnetReference = &v
}

// GetVpnInterfaceIp returns the VpnInterfaceIp field value if set, zero value otherwise.
func (o *StretchSiteParams) GetVpnInterfaceIp() string {
	if o == nil || IsNil(o.VpnInterfaceIp) {
		var ret string
		return ret
	}
	return *o.VpnInterfaceIp
}

// GetVpnInterfaceIpOk returns a tuple with the VpnInterfaceIp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StretchSiteParams) GetVpnInterfaceIpOk() (*string, bool) {
	if o == nil || IsNil(o.VpnInterfaceIp) {
		return nil, false
	}
	return o.VpnInterfaceIp, true
}
...
// SetVpnInterfaceIp gets a reference to the given string and assigns it to the VpnInterfaceIp field.
func (o *StretchSiteParams) SetVpnInterfaceIp(v string) {
	o.VpnInterfaceIp = &v
}

// GetVpnConnectionReference returns the VpnConnectionReference field value if set, zero value otherwise.
func (o *StretchSiteParams) GetVpnConnectionReference() VpnConnectionReference {
	if o == nil || IsNil(o.VpnConnectionReference) {
		var ret VpnConnectionReference
		return ret
	}
	return *o.VpnConnectionReference
}

// GetVpnConnectionReferenceOk returns a tuple with the VpnConnectionReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StretchSiteParams) GetVpnConnectionReferenceOk() (*VpnConnectionReference, bool) {
	if o == nil || IsNil(o.VpnConnectionReference) {
		return nil, false
	}
	return o.VpnConnectionReference, true
}
...
// SetVpnConnectionReference gets a reference to the given VpnConnectionReference and assigns it to the VpnConnectionReference field.
func (o *StretchSiteParams) SetVpnConnectionReference(v VpnConnectionReference) {
	o.VpnConnectionReference = &v
}
...
// GetSubnetPrefixLength returns the SubnetPrefixLength field value if set, zero value otherwise.
func (o *StretchSiteParams) GetSubnetPrefixLength() int32 {
	if o == nil || IsNil(o.SubnetPrefixLength) {
		var ret int32
		return ret
	}
	return *o.SubnetPrefixLength
}

// GetSubnetPrefixLengthOk returns a tuple with the SubnetPrefixLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StretchSiteParams) GetSubnetPrefixLengthOk() (*int32, bool) {
	if o == nil || IsNil(o.SubnetPrefixLength) {
		return nil, false
	}
	return o.SubnetPrefixLength, true
}
...
// SetSubnetPrefixLength gets a reference to the given int32 and assigns it to the SubnetPrefixLength field.
func (o *StretchSiteParams) SetSubnetPrefixLength(v int32) {
	o.SubnetPrefixLength = &v
}

// GetPcClusterReference returns the PcClusterReference field value if set, zero value otherwise.
func (o *StretchSiteParams) GetPcClusterReference() ClusterReference {
	if o == nil || IsNil(o.PcClusterReference) {
		var ret ClusterReference
		return ret
	}
	return *o.PcClusterReference
}

// GetPcClusterReferenceOk returns a tuple with the PcClusterReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StretchSiteParams) GetPcClusterReferenceOk() (*ClusterReference, bool) {
	if o == nil || IsNil(o.PcClusterReference) {
		return nil, false
	}
	return o.PcClusterReference, true
}
...
// SetPcClusterReference gets a reference to the given ClusterReference and assigns it to the PcClusterReference field.
func (o *StretchSiteParams) SetPcClusterReference(v ClusterReference) {
	o.PcClusterReference = &v
}

func (o StretchSiteParams) MarshalJSON() ([]byte, error) {
...
func (o StretchSiteParams) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.StretchSubnetReference) {
		toSerialize["stretch_subnet_reference"] = o.StretchSubnetReference
	}
	if !IsNil(o.VpnInterfaceIp) {
		toSerialize["vpn_interface_ip"] = o.VpnInterfaceIp
	}
	if !IsNil(o.VpnConnectionReference) {
		toSerialize["vpn_connection_reference"] = o.VpnConnectionReference
	}
	if !IsNil(o.DefaultGatewayIp) {
		toSerialize["default_gateway_ip"] = o.DefaultGatewayIp
	}
	if !IsNil(o.SubnetPrefixLength) {
		toSerialize["subnet_prefix_length"] = o.SubnetPrefixLength
	}
	if !IsNil(o.PcClusterReference) {
		toSerialize["pc_cluster_reference"] = o.PcClusterReference
	}
...
func (o *StretchSiteParams) UnmarshalJSON(data []byte) (err error) {
	varStretchSiteParams := _StretchSiteParams{}

	err = json.Unmarshal(data, &varStretchSiteParams)

	if err != nil {
		return err
	}

	*o = StretchSiteParams(varStretchSiteParams)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "stretch_subnet_reference")
		delete(additionalProperties, "vpn_interface_ip")
		delete(additionalProperties, "vpn_connection_reference")
		delete(additionalProperties, "default_gateway_ip")
		delete(additionalProperties, "subnet_prefix_length")
		delete(additionalProperties, "pc_cluster_reference")
...
type NullableStretchSiteParams struct {
	value *StretchSiteParams
	isSet bool
}

func (v NullableStretchSiteParams) Get() *StretchSiteParams {
	return v.value
}

func (v *NullableStretchSiteParams) Set(val *StretchSiteParams) {
	v.value = val
	v.isSet = true
}

func (v NullableStretchSiteParams) IsSet() bool {
	return v.isSet
}

func (v *NullableStretchSiteParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStretchSiteParams(val *StretchSiteParams) *NullableStretchSiteParams {
	return &NullableStretchSiteParams{value: val, isSet: true}
}

func (v NullableStretchSiteParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStretchSiteParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
