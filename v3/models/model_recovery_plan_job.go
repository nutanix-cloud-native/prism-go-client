...
// checks if the RecoveryPlanJob type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJob{}

// RecoveryPlanJob Resources for Recovery Plan Job creation.
...
type _RecoveryPlanJob RecoveryPlanJob
...
func (o RecoveryPlanJob) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJob) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJob) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJob := _RecoveryPlanJob{}

	err = json.Unmarshal(data, &varRecoveryPlanJob)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJob(varRecoveryPlanJob)
...
type NullableRecoveryPlanJob struct {
	value *RecoveryPlanJob
	isSet bool
}

func (v NullableRecoveryPlanJob) Get() *RecoveryPlanJob {
	return v.value
}

func (v *NullableRecoveryPlanJob) Set(val *RecoveryPlanJob) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJob) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJob) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJob(val *RecoveryPlanJob) *NullableRecoveryPlanJob {
	return &NullableRecoveryPlanJob{value: val, isSet: true}
}

func (v NullableRecoveryPlanJob) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJob) UnmarshalJSON(src []byte) error {
	v.isSet = true
