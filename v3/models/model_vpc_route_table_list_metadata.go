...
// checks if the VpcRouteTableListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcRouteTableListMetadata{}

// VpcRouteTableListMetadata All api calls that return a list will have this metadata block as input 
type VpcRouteTableListMetadata struct {
	// The kind name
...
type _VpcRouteTableListMetadata VpcRouteTableListMetadata
...
func NewVpcRouteTableListMetadata() *VpcRouteTableListMetadata {
	this := VpcRouteTableListMetadata{}
...
func (o VpcRouteTableListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VpcRouteTableListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VpcRouteTableListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVpcRouteTableListMetadata := _VpcRouteTableListMetadata{}

	err = json.Unmarshal(data, &varVpcRouteTableListMetadata)

	if err != nil {
		return err
	}

	*o = VpcRouteTableListMetadata(varVpcRouteTableListMetadata)
...
type NullableVpcRouteTableListMetadata struct {
	value *VpcRouteTableListMetadata
	isSet bool
}

func (v NullableVpcRouteTableListMetadata) Get() *VpcRouteTableListMetadata {
	return v.value
}

func (v *NullableVpcRouteTableListMetadata) Set(val *VpcRouteTableListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcRouteTableListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcRouteTableListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcRouteTableListMetadata(val *VpcRouteTableListMetadata) *NullableVpcRouteTableListMetadata {
	return &NullableVpcRouteTableListMetadata{value: val, isSet: true}
}

func (v NullableVpcRouteTableListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcRouteTableListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
