...
// checks if the RecoveryPlanJobExecutionStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobExecutionStatus{}

// RecoveryPlanJobExecutionStatus Execution of the Recovery Plan is done in three phases Preprocessing, Operation and Postprocessing. 
...
type _RecoveryPlanJobExecutionStatus RecoveryPlanJobExecutionStatus
...
func NewRecoveryPlanJobExecutionStatus() *RecoveryPlanJobExecutionStatus {
	this := RecoveryPlanJobExecutionStatus{}
	return &this
}
...
func (o *RecoveryPlanJobExecutionStatus) GetPostprocessingStatus() RecoveryPlanJobPhaseExecutionStatus {
	if o == nil || IsNil(o.PostprocessingStatus) {
		var ret RecoveryPlanJobPhaseExecutionStatus
		return ret
	}
...
// SetPostprocessingStatus gets a reference to the given RecoveryPlanJobPhaseExecutionStatus and assigns it to the PostprocessingStatus field.
...
// SetOperationStatus gets a reference to the given RecoveryPlanJobPhaseExecutionStatus and assigns it to the OperationStatus field.
...
// SetPreprocessingStatus gets a reference to the given RecoveryPlanJobPhaseExecutionStatus and assigns it to the PreprocessingStatus field.
...
func (o RecoveryPlanJobExecutionStatus) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobExecutionStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobExecutionStatus) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanJobExecutionStatus := _RecoveryPlanJobExecutionStatus{}

	err = json.Unmarshal(data, &varRecoveryPlanJobExecutionStatus)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobExecutionStatus(varRecoveryPlanJobExecutionStatus)
...
type NullableRecoveryPlanJobExecutionStatus struct {
	value *RecoveryPlanJobExecutionStatus
	isSet bool
}

func (v NullableRecoveryPlanJobExecutionStatus) Get() *RecoveryPlanJobExecutionStatus {
	return v.value
}

func (v *NullableRecoveryPlanJobExecutionStatus) Set(val *RecoveryPlanJobExecutionStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobExecutionStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobExecutionStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobExecutionStatus(val *RecoveryPlanJobExecutionStatus) *NullableRecoveryPlanJobExecutionStatus {
	return &NullableRecoveryPlanJobExecutionStatus{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobExecutionStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobExecutionStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
