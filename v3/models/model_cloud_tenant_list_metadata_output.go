...
// checks if the CloudTenantListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTenantListMetadataOutput{}

// CloudTenantListMetadataOutput All api calls that return a list will have this metadata block 
type CloudTenantListMetadataOutput struct {
	// The kind name
...
type _CloudTenantListMetadataOutput CloudTenantListMetadataOutput
...
func NewCloudTenantListMetadataOutput() *CloudTenantListMetadataOutput {
	this := CloudTenantListMetadataOutput{}
	var kind string = "cloud_tenant"
	this.Kind = &kind
	return &this
}
...
func (o CloudTenantListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o CloudTenantListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTenantListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varCloudTenantListMetadataOutput := _CloudTenantListMetadataOutput{}

	err = json.Unmarshal(data, &varCloudTenantListMetadataOutput)

	if err != nil {
		return err
	}

	*o = CloudTenantListMetadataOutput(varCloudTenantListMetadataOutput)
...
type NullableCloudTenantListMetadataOutput struct {
	value *CloudTenantListMetadataOutput
	isSet bool
}

func (v NullableCloudTenantListMetadataOutput) Get() *CloudTenantListMetadataOutput {
	return v.value
}

func (v *NullableCloudTenantListMetadataOutput) Set(val *CloudTenantListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTenantListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTenantListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTenantListMetadataOutput(val *CloudTenantListMetadataOutput) *NullableCloudTenantListMetadataOutput {
	return &NullableCloudTenantListMetadataOutput{value: val, isSet: true}
}

func (v NullableCloudTenantListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTenantListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
