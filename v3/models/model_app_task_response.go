...
// checks if the AppTaskResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskResponse{}

// AppTaskResponse Task definition for Application.
...
type _AppTaskResponse AppTaskResponse
...
func (o AppTaskResponse) MarshalJSON() ([]byte, error) {
...
func (o AppTaskResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskResponse := _AppTaskResponse{}

	err = json.Unmarshal(data, &varAppTaskResponse)

	if err != nil {
		return err
	}

	*o = AppTaskResponse(varAppTaskResponse)
...
type NullableAppTaskResponse struct {
	value *AppTaskResponse
	isSet bool
}

func (v NullableAppTaskResponse) Get() *AppTaskResponse {
	return v.value
}

func (v *NullableAppTaskResponse) Set(val *AppTaskResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskResponse(val *AppTaskResponse) *NullableAppTaskResponse {
	return &NullableAppTaskResponse{value: val, isSet: true}
}

func (v NullableAppTaskResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
