...
// checks if the CategoryMappingIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingIntentInput{}

// CategoryMappingIntentInput An intentful representation of a category_mapping
type CategoryMappingIntentInput struct {
	Spec CategoryMapping `json:"spec"`
...
type _CategoryMappingIntentInput CategoryMappingIntentInput
...
func NewCategoryMappingIntentInput(spec CategoryMapping, metadata CategoryMappingMetadata) *CategoryMappingIntentInput {
	this := CategoryMappingIntentInput{}
	this.Spec = spec
...
func (o CategoryMappingIntentInput) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryMappingIntentInput := _CategoryMappingIntentInput{}

	err = json.Unmarshal(data, &varCategoryMappingIntentInput)

	if err != nil {
		return err
	}

	*o = CategoryMappingIntentInput(varCategoryMappingIntentInput)
...
type NullableCategoryMappingIntentInput struct {
	value *CategoryMappingIntentInput
	isSet bool
}

func (v NullableCategoryMappingIntentInput) Get() *CategoryMappingIntentInput {
	return v.value
}

func (v *NullableCategoryMappingIntentInput) Set(val *CategoryMappingIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingIntentInput(val *CategoryMappingIntentInput) *NullableCategoryMappingIntentInput {
	return &NullableCategoryMappingIntentInput{value: val, isSet: true}
}

func (v NullableCategoryMappingIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
