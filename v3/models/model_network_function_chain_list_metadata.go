...
// checks if the NetworkFunctionChainListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionChainListMetadata{}

// NetworkFunctionChainListMetadata All api calls that return a list will have this metadata block as input 
...
type _NetworkFunctionChainListMetadata NetworkFunctionChainListMetadata
...
func NewNetworkFunctionChainListMetadata() *NetworkFunctionChainListMetadata {
	this := NetworkFunctionChainListMetadata{}
...
func (o NetworkFunctionChainListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionChainListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionChainListMetadata) UnmarshalJSON(data []byte) (err error) {
	varNetworkFunctionChainListMetadata := _NetworkFunctionChainListMetadata{}

	err = json.Unmarshal(data, &varNetworkFunctionChainListMetadata)

	if err != nil {
		return err
	}

	*o = NetworkFunctionChainListMetadata(varNetworkFunctionChainListMetadata)
...
type NullableNetworkFunctionChainListMetadata struct {
	value *NetworkFunctionChainListMetadata
	isSet bool
}

func (v NullableNetworkFunctionChainListMetadata) Get() *NetworkFunctionChainListMetadata {
	return v.value
}

func (v *NullableNetworkFunctionChainListMetadata) Set(val *NetworkFunctionChainListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionChainListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionChainListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionChainListMetadata(val *NetworkFunctionChainListMetadata) *NullableNetworkFunctionChainListMetadata {
	return &NullableNetworkFunctionChainListMetadata{value: val, isSet: true}
}

func (v NullableNetworkFunctionChainListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionChainListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
