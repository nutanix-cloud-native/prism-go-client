...
// AppMetadata The app kind metadata
type AppMetadata struct {
	...
	// Categories for the app. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the app. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
func (o *AppMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *AppMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *AppMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAppMetadata := _AppMetadata{}

	err = json.Unmarshal(data, &varAppMetadata)

	if err != nil {
		return err
	}

	*o = AppMetadata(varAppMetadata)
