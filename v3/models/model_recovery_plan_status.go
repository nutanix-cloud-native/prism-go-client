...
// checks if the RecoveryPlanStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanStatus{}

// RecoveryPlanStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _RecoveryPlanStatus RecoveryPlanStatus
...
func (o RecoveryPlanStatus) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanStatus) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanStatus := _RecoveryPlanStatus{}

	err = json.Unmarshal(data, &varRecoveryPlanStatus)

	if err != nil {
		return err
	}

	*o = RecoveryPlanStatus(varRecoveryPlanStatus)
...
type NullableRecoveryPlanStatus struct {
	value *RecoveryPlanStatus
	isSet bool
}

func (v NullableRecoveryPlanStatus) Get() *RecoveryPlanStatus {
	return v.value
}

func (v *NullableRecoveryPlanStatus) Set(val *RecoveryPlanStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanStatus(val *RecoveryPlanStatus) *NullableRecoveryPlanStatus {
	return &NullableRecoveryPlanStatus{value: val, isSet: true}
}

func (v NullableRecoveryPlanStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
