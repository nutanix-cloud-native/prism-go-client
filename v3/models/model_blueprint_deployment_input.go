...
// checks if the BlueprintDeploymentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintDeploymentInput{}

// BlueprintDeploymentInput Deployment definition for Application.
type BlueprintDeploymentInput struct {
	// 
	...
	ActionList []AppActionInput `json:"action_list,omitempty"`
	...
	// 
	VariableList []AppVariableInput `json:"variable_list,omitempty"`
...
type _BlueprintDeploymentInput BlueprintDeploymentInput
...
// SetActionList gets a reference to the given []AppActionInput and assigns it to the ActionList field.
...
// SetVariableList gets a reference to the given []AppVariableInput and assigns it to the VariableList field.
...
func (o BlueprintDeploymentInput) MarshalJSON() ([]byte, error) {
...
func (o BlueprintDeploymentInput) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintDeploymentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintDeploymentInput := _BlueprintDeploymentInput{}

	err = json.Unmarshal(data, &varBlueprintDeploymentInput)

	if err != nil {
		return err
	}

	*o = BlueprintDeploymentInput(varBlueprintDeploymentInput)
...
type NullableBlueprintDeploymentInput struct {
	value *BlueprintDeploymentInput
	isSet bool
}

func (v NullableBlueprintDeploymentInput) Get() *BlueprintDeploymentInput {
	return v.value
}

func (v *NullableBlueprintDeploymentInput) Set(val *BlueprintDeploymentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintDeploymentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintDeploymentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintDeploymentInput(val *BlueprintDeploymentInput) *NullableBlueprintDeploymentInput {
	return &NullableBlueprintDeploymentInput{value: val, isSet: true}
}

func (v NullableBlueprintDeploymentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintDeploymentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
