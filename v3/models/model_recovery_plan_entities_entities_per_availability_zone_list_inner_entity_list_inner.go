...
// checks if the RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner{}

// RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner struct for RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner
type RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner struct {
	// Protection status of the entity.
	ProtectionStatus *string `json:"protection_status,omitempty"`
	Recoverability *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInnerRecoverability `json:"recoverability,omitempty"`
	// Index of recovery Availability Zone order for this entity in availability_zone_order_list. Index starts at 0. 
	RecoveryAvailabilityZoneOrderIndex *int32 `json:"recovery_availability_zone_order_index,omitempty"`
	// On the Availability Zone, whether the live entity is present or the Recovery Points for the entity are present. This will be set to true, only if the Recovery Points for the entity are present on the Availability Zone and not the live entity. 
	IsRecoveryPoint bool `json:"is_recovery_point"`
	// Replication status of the entity for which synchronous replication is enabled. 
	ReplicationStatus *string `json:"replication_status,omitempty"`
	AnyEntityReference Reference `json:"any_entity_reference"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner
...
func NewRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner(isRecoveryPoint bool, anyEntityReference Reference) *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner {
	this := RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner{}
	this.IsRecoveryPoint = isRecoveryPoint
	this.AnyEntityReference = anyEntityReference
	return &this
}
...
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) GetRecoverability() RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInnerRecoverability {
	if o == nil || IsNil(o.Recoverability) {
		var ret RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInnerRecoverability
		return ret
	}
...
// SetRecoverability gets a reference to the given RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInnerRecoverability and assigns it to the Recoverability field.
...
// GetRecoveryAvailabilityZoneOrderIndex returns the RecoveryAvailabilityZoneOrderIndex field value if set, zero value otherwise.
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) GetRecoveryAvailabilityZoneOrderIndex() int32 {
	if o == nil || IsNil(o.RecoveryAvailabilityZoneOrderIndex) {
		var ret int32
		return ret
	}
	return *o.RecoveryAvailabilityZoneOrderIndex
}

// GetRecoveryAvailabilityZoneOrderIndexOk returns a tuple with the RecoveryAvailabilityZoneOrderIndex field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) GetRecoveryAvailabilityZoneOrderIndexOk() (*int32, bool) {
	...
	return o.RecoveryAvailabilityZoneOrderIndex, true
}
...
// SetRecoveryAvailabilityZoneOrderIndex gets a reference to the given int32 and assigns it to the RecoveryAvailabilityZoneOrderIndex field.
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) SetRecoveryAvailabilityZoneOrderIndex(v int32) {
	o.RecoveryAvailabilityZoneOrderIndex = &v
}

// GetIsRecoveryPoint returns the IsRecoveryPoint field value
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) GetIsRecoveryPoint() bool {
	...
	return o.IsRecoveryPoint
}

// GetIsRecoveryPointOk returns a tuple with the IsRecoveryPoint field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) GetIsRecoveryPointOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsRecoveryPoint, true
}

// SetIsRecoveryPoint sets field value
...
// GetAnyEntityReference returns the AnyEntityReference field value
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) GetAnyEntityReference() Reference {
	...
	return o.AnyEntityReference
}

// GetAnyEntityReferenceOk returns a tuple with the AnyEntityReference field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) GetAnyEntityReferenceOk() (*Reference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AnyEntityReference, true
}

// SetAnyEntityReference sets field value
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) SetAnyEntityReference(v Reference) {
	o.AnyEntityReference = v
}

func (o RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RecoveryAvailabilityZoneOrderIndex) {
		toSerialize["recovery_availability_zone_order_index"] = o.RecoveryAvailabilityZoneOrderIndex
	}
	toSerialize["is_recovery_point"] = o.IsRecoveryPoint
	if !IsNil(o.ReplicationStatus) {
		toSerialize["replication_status"] = o.ReplicationStatus
	}
	toSerialize["any_entity_reference"] = o.AnyEntityReference
...
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner := _RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner{}

	err = json.Unmarshal(data, &varRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner)

	if err != nil {
		return err
	}

	*o = RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner(varRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "recovery_availability_zone_order_index")
		delete(additionalProperties, "is_recovery_point")
		delete(additionalProperties, "replication_status")
		delete(additionalProperties, "any_entity_reference")
...
type NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner struct {
	value *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner
	isSet bool
}

func (v NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) Get() *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner {
	return v.value
}

func (v *NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) Set(val *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner(val *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) *NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner {
	return &NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner{value: val, isSet: true}
}

func (v NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
