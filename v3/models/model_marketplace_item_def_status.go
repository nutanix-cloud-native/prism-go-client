...
// checks if the MarketplaceItemDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemDefStatus{}

// MarketplaceItemDefStatus Detailed information about marketplace item
type MarketplaceItemDefStatus struct {
	// The state of the entity
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	// Marketplace item name
	Name string `json:"name"`
	Resources MarketplaceItemOutputResources `json:"resources"`
	// Marketplace item description
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MarketplaceItemDefStatus MarketplaceItemDefStatus
...
func (o *MarketplaceItemDefStatus) GetResources() MarketplaceItemOutputResources {
	if o == nil {
		var ret MarketplaceItemOutputResources
		return ret
	}
...
func (o MarketplaceItemDefStatus) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItemDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceItemDefStatus := _MarketplaceItemDefStatus{}

	err = json.Unmarshal(data, &varMarketplaceItemDefStatus)

	if err != nil {
		return err
	}

	*o = MarketplaceItemDefStatus(varMarketplaceItemDefStatus)
...
type NullableMarketplaceItemDefStatus struct {
	value *MarketplaceItemDefStatus
	isSet bool
}

func (v NullableMarketplaceItemDefStatus) Get() *MarketplaceItemDefStatus {
	return v.value
}

func (v *NullableMarketplaceItemDefStatus) Set(val *MarketplaceItemDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemDefStatus(val *MarketplaceItemDefStatus) *NullableMarketplaceItemDefStatus {
	return &NullableMarketplaceItemDefStatus{value: val, isSet: true}
}

func (v NullableMarketplaceItemDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
