...
// checks if the EnvironmentListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentListMetadata{}

// EnvironmentListMetadata All api calls that return a list will have this metadata block as input 
type EnvironmentListMetadata struct {
	// The kind name
...
type _EnvironmentListMetadata EnvironmentListMetadata
...
func (o EnvironmentListMetadata) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *EnvironmentListMetadata) UnmarshalJSON(data []byte) (err error) {
	varEnvironmentListMetadata := _EnvironmentListMetadata{}

	err = json.Unmarshal(data, &varEnvironmentListMetadata)

	if err != nil {
		return err
	}

	*o = EnvironmentListMetadata(varEnvironmentListMetadata)
...
type NullableEnvironmentListMetadata struct {
	value *EnvironmentListMetadata
	isSet bool
}

func (v NullableEnvironmentListMetadata) Get() *EnvironmentListMetadata {
	return v.value
}

func (v *NullableEnvironmentListMetadata) Set(val *EnvironmentListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentListMetadata(val *EnvironmentListMetadata) *NullableEnvironmentListMetadata {
	return &NullableEnvironmentListMetadata{value: val, isSet: true}
}

func (v NullableEnvironmentListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
