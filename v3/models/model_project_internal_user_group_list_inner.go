...
// checks if the ProjectInternalUserGroupListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectInternalUserGroupListInner{}

// ProjectInternalUserGroupListInner The details of the user group 
type ProjectInternalUserGroupListInner struct {
...
type _ProjectInternalUserGroupListInner ProjectInternalUserGroupListInner
...
func NewProjectInternalUserGroupListInner(operation string, metadata ProjectInternalAccessControlPolicyListInnerMetadata, userGroup UserGroup) *ProjectInternalUserGroupListInner {
	this := ProjectInternalUserGroupListInner{}
...
func (o ProjectInternalUserGroupListInner) MarshalJSON() ([]byte, error) {
...
func (o ProjectInternalUserGroupListInner) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectInternalUserGroupListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectInternalUserGroupListInner := _ProjectInternalUserGroupListInner{}

	err = json.Unmarshal(data, &varProjectInternalUserGroupListInner)

	if err != nil {
		return err
	}

	*o = ProjectInternalUserGroupListInner(varProjectInternalUserGroupListInner)
...
type NullableProjectInternalUserGroupListInner struct {
	value *ProjectInternalUserGroupListInner
	isSet bool
}

func (v NullableProjectInternalUserGroupListInner) Get() *ProjectInternalUserGroupListInner {
	return v.value
}

func (v *NullableProjectInternalUserGroupListInner) Set(val *ProjectInternalUserGroupListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectInternalUserGroupListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectInternalUserGroupListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectInternalUserGroupListInner(val *ProjectInternalUserGroupListInner) *NullableProjectInternalUserGroupListInner {
	return &NullableProjectInternalUserGroupListInner{value: val, isSet: true}
}

func (v NullableProjectInternalUserGroupListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectInternalUserGroupListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
