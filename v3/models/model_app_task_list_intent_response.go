...
// checks if the AppTaskListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskListIntentResponse{}

// AppTaskListIntentResponse Response object for intentful operation of app_tasks
type AppTaskListIntentResponse struct {
	Entities []AppTaskIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AppTaskListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AppTaskListIntentResponse AppTaskListIntentResponse
...
func NewAppTaskListIntentResponse(apiVersion string, metadata AppTaskListMetadataOutput) *AppTaskListIntentResponse {
	this := AppTaskListIntentResponse{}
...
// SetEntities gets a reference to the given []AppTaskIntentResource and assigns it to the Entities field.
...
func (o *AppTaskListIntentResponse) GetMetadata() AppTaskListMetadataOutput {
	if o == nil {
		var ret AppTaskListMetadataOutput
		return ret
	}
...
func (o AppTaskListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AppTaskListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskListIntentResponse := _AppTaskListIntentResponse{}

	err = json.Unmarshal(data, &varAppTaskListIntentResponse)

	if err != nil {
		return err
	}

	*o = AppTaskListIntentResponse(varAppTaskListIntentResponse)
...
type NullableAppTaskListIntentResponse struct {
	value *AppTaskListIntentResponse
	isSet bool
}

func (v NullableAppTaskListIntentResponse) Get() *AppTaskListIntentResponse {
	return v.value
}

func (v *NullableAppTaskListIntentResponse) Set(val *AppTaskListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskListIntentResponse(val *AppTaskListIntentResponse) *NullableAppTaskListIntentResponse {
	return &NullableAppTaskListIntentResponse{value: val, isSet: true}
}

func (v NullableAppTaskListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
