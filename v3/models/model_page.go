...
type Page struct {
	...
	DisplayInfo *EntityMetadata `json:"display_info,omitempty"`
	// Type of the page.
	Type *string `json:"type,omitempty"`
	// List of child pages of this page. Page is being referred here. 
...
// SetDisplayInfo gets a reference to the given EntityMetadata and assigns it to the DisplayInfo field.
...
// GetPageMetadata returns the PageMetadata field value if set, zero value otherwise.
func (o *Page) GetPageMetadata() PageMetadata {
	if o == nil || IsNil(o.PageMetadata) {
		var ret PageMetadata
		return ret
	}
	return *o.PageMetadata
}

// GetPageMetadataOk returns a tuple with the PageMetadata field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Page) GetPageMetadataOk() (*PageMetadata, bool) {
	if o == nil || IsNil(o.PageMetadata) {
		return nil, false
	}
	return o.PageMetadata, true
}
...
// SetPageMetadata gets a reference to the given PageMetadata and assigns it to the PageMetadata field.
...
func (o Page) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PageMetadata) {
		toSerialize["page_metadata"] = o.PageMetadata
	}
	if !IsNil(o.Name) {
...
func (o *Page) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Page(varPage)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "display_info")
		delete(additionalProperties, "type")
		delete(additionalProperties, "children")
		delete(additionalProperties, "page_metadata")
