...
// checks if the CloudTenantListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTenantListMetadata{}

// CloudTenantListMetadata All api calls that return a list will have this metadata block as input 
type CloudTenantListMetadata struct {
	// The kind name
...
type _CloudTenantListMetadata CloudTenantListMetadata
...
func (o CloudTenantListMetadata) MarshalJSON() ([]byte, error) {
...
func (o CloudTenantListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTenantListMetadata) UnmarshalJSON(data []byte) (err error) {
	varCloudTenantListMetadata := _CloudTenantListMetadata{}

	err = json.Unmarshal(data, &varCloudTenantListMetadata)

	if err != nil {
		return err
	}

	*o = CloudTenantListMetadata(varCloudTenantListMetadata)
...
type NullableCloudTenantListMetadata struct {
	value *CloudTenantListMetadata
	isSet bool
}

func (v NullableCloudTenantListMetadata) Get() *CloudTenantListMetadata {
	return v.value
}

func (v *NullableCloudTenantListMetadata) Set(val *CloudTenantListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTenantListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTenantListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTenantListMetadata(val *CloudTenantListMetadata) *NullableCloudTenantListMetadata {
	return &NullableCloudTenantListMetadata{value: val, isSet: true}
}

func (v NullableCloudTenantListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTenantListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
