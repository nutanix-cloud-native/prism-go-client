...
// checks if the SoftwareListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareListIntentResponse{}

// SoftwareListIntentResponse Available software on Nutanix portal
type SoftwareListIntentResponse struct {
	...
	Metadata SoftwareListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _SoftwareListIntentResponse SoftwareListIntentResponse
...
func NewSoftwareListIntentResponse(entities []PortalSoftware, metadata SoftwareListMetadataOutput) *SoftwareListIntentResponse {
	this := SoftwareListIntentResponse{}
...
func (o *SoftwareListIntentResponse) GetMetadata() SoftwareListMetadataOutput {
	if o == nil {
		var ret SoftwareListMetadataOutput
		return ret
	}
...
func (o SoftwareListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o SoftwareListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SoftwareListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSoftwareListIntentResponse := _SoftwareListIntentResponse{}

	err = json.Unmarshal(data, &varSoftwareListIntentResponse)

	if err != nil {
		return err
	}

	*o = SoftwareListIntentResponse(varSoftwareListIntentResponse)
...
type NullableSoftwareListIntentResponse struct {
	value *SoftwareListIntentResponse
	isSet bool
}

func (v NullableSoftwareListIntentResponse) Get() *SoftwareListIntentResponse {
	return v.value
}

func (v *NullableSoftwareListIntentResponse) Set(val *SoftwareListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareListIntentResponse(val *SoftwareListIntentResponse) *NullableSoftwareListIntentResponse {
	return &NullableSoftwareListIntentResponse{value: val, isSet: true}
}

func (v NullableSoftwareListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
