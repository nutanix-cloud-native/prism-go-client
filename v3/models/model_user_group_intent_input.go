...
// checks if the UserGroupIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupIntentInput{}

// UserGroupIntentInput An intentful representation of a user_group
type UserGroupIntentInput struct {
	Spec UserGroup `json:"spec"`
...
type _UserGroupIntentInput UserGroupIntentInput
...
func (o UserGroupIntentInput) MarshalJSON() ([]byte, error) {
...
func (o UserGroupIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *UserGroupIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varUserGroupIntentInput := _UserGroupIntentInput{}

	err = json.Unmarshal(data, &varUserGroupIntentInput)

	if err != nil {
		return err
	}

	*o = UserGroupIntentInput(varUserGroupIntentInput)
...
type NullableUserGroupIntentInput struct {
	value *UserGroupIntentInput
	isSet bool
}

func (v NullableUserGroupIntentInput) Get() *UserGroupIntentInput {
	return v.value
}

func (v *NullableUserGroupIntentInput) Set(val *UserGroupIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupIntentInput(val *UserGroupIntentInput) *NullableUserGroupIntentInput {
	return &NullableUserGroupIntentInput{value: val, isSet: true}
}

func (v NullableUserGroupIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
