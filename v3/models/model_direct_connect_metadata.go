...
// checks if the DirectConnectMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectMetadata{}

// DirectConnectMetadata The direct_connect kind metadata
type DirectConnectMetadata struct {
	...
	// Categories for the direct_connect. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the direct_connect. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _DirectConnectMetadata DirectConnectMetadata
...
func (o *DirectConnectMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *DirectConnectMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *DirectConnectMetadata) SetName(v string) {
	o.Name = &v
}

func (o DirectConnectMetadata) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectMetadata := _DirectConnectMetadata{}

	err = json.Unmarshal(data, &varDirectConnectMetadata)

	if err != nil {
		return err
	}

	*o = DirectConnectMetadata(varDirectConnectMetadata)
...
type NullableDirectConnectMetadata struct {
	value *DirectConnectMetadata
	isSet bool
}

func (v NullableDirectConnectMetadata) Get() *DirectConnectMetadata {
	return v.value
}

func (v *NullableDirectConnectMetadata) Set(val *DirectConnectMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectMetadata(val *DirectConnectMetadata) *NullableDirectConnectMetadata {
	return &NullableDirectConnectMetadata{value: val, isSet: true}
}

func (v NullableDirectConnectMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
