...
// checks if the CategoryQueryResponseResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryQueryResponseResultsInner{}

// CategoryQueryResponseResultsInner struct for CategoryQueryResponseResultsInner
type CategoryQueryResponseResultsInner struct {
	...
	KindReferenceList []EntityReference `json:"kind_reference_list,omitempty"`
	// Total number of the matched results.
	TotalEntityCount *int64 `json:"total_entity_count,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CategoryQueryResponseResultsInner CategoryQueryResponseResultsInner
...
func NewCategoryQueryResponseResultsInner() *CategoryQueryResponseResultsInner {
	this := CategoryQueryResponseResultsInner{}
	return &this
}
...
// GetKindReferenceList returns the KindReferenceList field value if set, zero value otherwise.
func (o *CategoryQueryResponseResultsInner) GetKindReferenceList() []EntityReference {
	if o == nil || IsNil(o.KindReferenceList) {
		var ret []EntityReference
		return ret
	}
	return o.KindReferenceList
}

// GetKindReferenceListOk returns a tuple with the KindReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CategoryQueryResponseResultsInner) GetKindReferenceListOk() ([]EntityReference, bool) {
	if o == nil || IsNil(o.KindReferenceList) {
		return nil, false
	}
	return o.KindReferenceList, true
}
...
// SetKindReferenceList gets a reference to the given []EntityReference and assigns it to the KindReferenceList field.
func (o *CategoryQueryResponseResultsInner) SetKindReferenceList(v []EntityReference) {
	o.KindReferenceList = v
}
...
func (o CategoryQueryResponseResultsInner) MarshalJSON() ([]byte, error) {
...
func (o CategoryQueryResponseResultsInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.KindReferenceList) {
		toSerialize["kind_reference_list"] = o.KindReferenceList
	}
...
func (o *CategoryQueryResponseResultsInner) UnmarshalJSON(data []byte) (err error) {
	varCategoryQueryResponseResultsInner := _CategoryQueryResponseResultsInner{}

	err = json.Unmarshal(data, &varCategoryQueryResponseResultsInner)

	if err != nil {
		return err
	}

	*o = CategoryQueryResponseResultsInner(varCategoryQueryResponseResultsInner)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "kind_reference_list")
...
type NullableCategoryQueryResponseResultsInner struct {
	value *CategoryQueryResponseResultsInner
	isSet bool
}

func (v NullableCategoryQueryResponseResultsInner) Get() *CategoryQueryResponseResultsInner {
	return v.value
}

func (v *NullableCategoryQueryResponseResultsInner) Set(val *CategoryQueryResponseResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryQueryResponseResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryQueryResponseResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryQueryResponseResultsInner(val *CategoryQueryResponseResultsInner) *NullableCategoryQueryResponseResultsInner {
	return &NullableCategoryQueryResponseResultsInner{value: val, isSet: true}
}

func (v NullableCategoryQueryResponseResultsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryQueryResponseResultsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
