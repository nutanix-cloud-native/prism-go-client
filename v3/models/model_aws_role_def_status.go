...
// checks if the AwsRoleDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRoleDefStatus{}

// AwsRoleDefStatus aws_role resources status
type AwsRoleDefStatus struct {
	State *string `json:"state,omitempty"`
	// aws_role name.
	Name *string `json:"name,omitempty"`
	Resources *AwsRoleResourcesDefStatus `json:"resources,omitempty"`
	// A description for aws_role.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsRoleDefStatus AwsRoleDefStatus
...
func (o *AwsRoleDefStatus) GetResources() AwsRoleResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret AwsRoleResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given AwsRoleResourcesDefStatus and assigns it to the Resources field.
...
func (o AwsRoleDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsRoleDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRoleDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsRoleDefStatus := _AwsRoleDefStatus{}

	err = json.Unmarshal(data, &varAwsRoleDefStatus)

	if err != nil {
		return err
	}

	*o = AwsRoleDefStatus(varAwsRoleDefStatus)
...
type NullableAwsRoleDefStatus struct {
	value *AwsRoleDefStatus
	isSet bool
}

func (v NullableAwsRoleDefStatus) Get() *AwsRoleDefStatus {
	return v.value
}

func (v *NullableAwsRoleDefStatus) Set(val *AwsRoleDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRoleDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRoleDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRoleDefStatus(val *AwsRoleDefStatus) *NullableAwsRoleDefStatus {
	return &NullableAwsRoleDefStatus{value: val, isSet: true}
}

func (v NullableAwsRoleDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRoleDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
