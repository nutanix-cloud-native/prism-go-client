...
// checks if the CategoryMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMapping{}

// CategoryMapping An intentful representation of a category_mapping spec
type CategoryMapping struct {
	...
	Resources CategoryMappingResources `json:"resources"`
	// category_mapping Name.
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _CategoryMapping CategoryMapping
...
func (o *CategoryMapping) GetResources() CategoryMappingResources {
	if o == nil {
		var ret CategoryMappingResources
		return ret
	}
...
func (o CategoryMapping) MarshalJSON() ([]byte, error) {
...
func (o CategoryMapping) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMapping) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryMapping := _CategoryMapping{}

	err = json.Unmarshal(data, &varCategoryMapping)

	if err != nil {
		return err
	}

	*o = CategoryMapping(varCategoryMapping)
...
type NullableCategoryMapping struct {
	value *CategoryMapping
	isSet bool
}

func (v NullableCategoryMapping) Get() *CategoryMapping {
	return v.value
}

func (v *NullableCategoryMapping) Set(val *CategoryMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMapping(val *CategoryMapping) *NullableCategoryMapping {
	return &NullableCategoryMapping{value: val, isSet: true}
}

func (v NullableCategoryMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
