...
// checks if the ConfigurationInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigurationInfo{}

// ConfigurationInfo Information needed by the caller before they enable the service 
type ConfigurationInfo struct {
	// Original memory (in bytes)
	OriginalMemoryBytes *float64 `json:"original_memory_bytes,omitempty"`
	// Additional vcpu required to enable the service
	AdditionalVcpu *int64 `json:"additional_vcpu,omitempty"`
	// Additional memory (in GiB) required to enable the service
	AdditionalMemory *int64 `json:"additional_memory,omitempty"`
	// Additional memory (in bytes) required to enable the service
	AdditionalMemoryBytes *float64 `json:"additional_memory_bytes,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ConfigurationInfo ConfigurationInfo
...
// GetOriginalMemoryBytes returns the OriginalMemoryBytes field value if set, zero value otherwise.
func (o *ConfigurationInfo) GetOriginalMemoryBytes() float64 {
	if o == nil || IsNil(o.OriginalMemoryBytes) {
		var ret float64
		return ret
	}
	return *o.OriginalMemoryBytes
}

// GetOriginalMemoryBytesOk returns a tuple with the OriginalMemoryBytes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigurationInfo) GetOriginalMemoryBytesOk() (*float64, bool) {
	if o == nil || IsNil(o.OriginalMemoryBytes) {
		return nil, false
	}
	return o.OriginalMemoryBytes, true
}
...
// SetOriginalMemoryBytes gets a reference to the given float64 and assigns it to the OriginalMemoryBytes field.
func (o *ConfigurationInfo) SetOriginalMemoryBytes(v float64) {
	o.OriginalMemoryBytes = &v
}

// GetAdditionalVcpu returns the AdditionalVcpu field value if set, zero value otherwise.
func (o *ConfigurationInfo) GetAdditionalVcpu() int64 {
	if o == nil || IsNil(o.AdditionalVcpu) {
		var ret int64
		return ret
	}
	return *o.AdditionalVcpu
}

// GetAdditionalVcpuOk returns a tuple with the AdditionalVcpu field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigurationInfo) GetAdditionalVcpuOk() (*int64, bool) {
	if o == nil || IsNil(o.AdditionalVcpu) {
		return nil, false
	}
	return o.AdditionalVcpu, true
}
...
// SetAdditionalVcpu gets a reference to the given int64 and assigns it to the AdditionalVcpu field.
func (o *ConfigurationInfo) SetAdditionalVcpu(v int64) {
	o.AdditionalVcpu = &v
}

// GetAdditionalMemory returns the AdditionalMemory field value if set, zero value otherwise.
func (o *ConfigurationInfo) GetAdditionalMemory() int64 {
	if o == nil || IsNil(o.AdditionalMemory) {
		var ret int64
		return ret
	}
	return *o.AdditionalMemory
}

// GetAdditionalMemoryOk returns a tuple with the AdditionalMemory field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigurationInfo) GetAdditionalMemoryOk() (*int64, bool) {
	if o == nil || IsNil(o.AdditionalMemory) {
		return nil, false
	}
	return o.AdditionalMemory, true
}
...
// SetAdditionalMemory gets a reference to the given int64 and assigns it to the AdditionalMemory field.
func (o *ConfigurationInfo) SetAdditionalMemory(v int64) {
	o.AdditionalMemory = &v
}

// GetAdditionalMemoryBytes returns the AdditionalMemoryBytes field value if set, zero value otherwise.
func (o *ConfigurationInfo) GetAdditionalMemoryBytes() float64 {
	if o == nil || IsNil(o.AdditionalMemoryBytes) {
		var ret float64
		return ret
	}
	return *o.AdditionalMemoryBytes
}

// GetAdditionalMemoryBytesOk returns a tuple with the AdditionalMemoryBytes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigurationInfo) GetAdditionalMemoryBytesOk() (*float64, bool) {
	if o == nil || IsNil(o.AdditionalMemoryBytes) {
		return nil, false
	}
	return o.AdditionalMemoryBytes, true
}
...
// SetAdditionalMemoryBytes gets a reference to the given float64 and assigns it to the AdditionalMemoryBytes field.
func (o *ConfigurationInfo) SetAdditionalMemoryBytes(v float64) {
	o.AdditionalMemoryBytes = &v
}

func (o ConfigurationInfo) MarshalJSON() ([]byte, error) {
...
func (o ConfigurationInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.OriginalMemoryBytes) {
		toSerialize["original_memory_bytes"] = o.OriginalMemoryBytes
	}
	if !IsNil(o.AdditionalVcpu) {
		toSerialize["additional_vcpu"] = o.AdditionalVcpu
	}
	if !IsNil(o.AdditionalMemory) {
		toSerialize["additional_memory"] = o.AdditionalMemory
	}
	if !IsNil(o.AdditionalMemoryBytes) {
		toSerialize["additional_memory_bytes"] = o.AdditionalMemoryBytes
	}
...
func (o *ConfigurationInfo) UnmarshalJSON(data []byte) (err error) {
	varConfigurationInfo := _ConfigurationInfo{}

	err = json.Unmarshal(data, &varConfigurationInfo)

	if err != nil {
		return err
	}

	*o = ConfigurationInfo(varConfigurationInfo)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "original_memory_bytes")
		delete(additionalProperties, "additional_vcpu")
		delete(additionalProperties, "additional_memory")
		delete(additionalProperties, "additional_memory_bytes")
...
type NullableConfigurationInfo struct {
	value *ConfigurationInfo
	isSet bool
}

func (v NullableConfigurationInfo) Get() *ConfigurationInfo {
	return v.value
}

func (v *NullableConfigurationInfo) Set(val *ConfigurationInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigurationInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigurationInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigurationInfo(val *ConfigurationInfo) *NullableConfigurationInfo {
	return &NullableConfigurationInfo{value: val, isSet: true}
}

func (v NullableConfigurationInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigurationInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
