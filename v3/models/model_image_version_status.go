...
// checks if the ImageVersionStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageVersionStatus{}

// ImageVersionStatus The image version, which is composed of a product name and product version. 
...
type _ImageVersionStatus ImageVersionStatus
...
func (o ImageVersionStatus) MarshalJSON() ([]byte, error) {
...
func (o ImageVersionStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ImageVersionStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varImageVersionStatus := _ImageVersionStatus{}

	err = json.Unmarshal(data, &varImageVersionStatus)

	if err != nil {
		return err
	}

	*o = ImageVersionStatus(varImageVersionStatus)
