...
// checks if the EnvironmentListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentListIntentResponse{}

// EnvironmentListIntentResponse Response object for intentful operation of environments
type EnvironmentListIntentResponse struct {
	Entities []EnvironmentIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata EnvironmentListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _EnvironmentListIntentResponse EnvironmentListIntentResponse
...
func NewEnvironmentListIntentResponse(apiVersion string, metadata EnvironmentListMetadataOutput) *EnvironmentListIntentResponse {
	this := EnvironmentListIntentResponse{}
...
func (o *EnvironmentListIntentResponse) GetEntities() []EnvironmentIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []EnvironmentIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []EnvironmentIntentResource and assigns it to the Entities field.
...
func (o *EnvironmentListIntentResponse) GetMetadata() EnvironmentListMetadataOutput {
	if o == nil {
		var ret EnvironmentListMetadataOutput
		return ret
	}
...
func (o EnvironmentListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EnvironmentListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvironmentListIntentResponse := _EnvironmentListIntentResponse{}

	err = json.Unmarshal(data, &varEnvironmentListIntentResponse)

	if err != nil {
		return err
	}

	*o = EnvironmentListIntentResponse(varEnvironmentListIntentResponse)
...
type NullableEnvironmentListIntentResponse struct {
	value *EnvironmentListIntentResponse
	isSet bool
}

func (v NullableEnvironmentListIntentResponse) Get() *EnvironmentListIntentResponse {
	return v.value
}

func (v *NullableEnvironmentListIntentResponse) Set(val *EnvironmentListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentListIntentResponse(val *EnvironmentListIntentResponse) *NullableEnvironmentListIntentResponse {
	return &NullableEnvironmentListIntentResponse{value: val, isSet: true}
}

func (v NullableEnvironmentListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
