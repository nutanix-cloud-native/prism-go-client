...
// checks if the ActionRuleValidationInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleValidationInput{}

// ActionRuleValidationInput Input for validating the playbook
type ActionRuleValidationInput struct {
	ActionRuleReference *ActionRuleReference `json:"action_rule_reference,omitempty"`
	Resources ActionRuleResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _ActionRuleValidationInput ActionRuleValidationInput
...
func NewActionRuleValidationInput(resources ActionRuleResources) *ActionRuleValidationInput {
	this := ActionRuleValidationInput{}
...
// GetActionRuleReference returns the ActionRuleReference field value if set, zero value otherwise.
func (o *ActionRuleValidationInput) GetActionRuleReference() ActionRuleReference {
	if o == nil || IsNil(o.ActionRuleReference) {
...
// GetActionRuleReferenceOk returns a tuple with the ActionRuleReference field value if set, nil otherwise
...
// SetActionRuleReference gets a reference to the given ActionRuleReference and assigns it to the ActionRuleReference field.
...
func (o ActionRuleValidationInput) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleValidationInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ActionRuleReference) {
...
func (o *ActionRuleValidationInput) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleValidationInput := _ActionRuleValidationInput{}

	err = json.Unmarshal(data, &varActionRuleValidationInput)

	if err != nil {
		return err
	}

	*o = ActionRuleValidationInput(varActionRuleValidationInput)
...
type NullableActionRuleValidationInput struct {
	value *ActionRuleValidationInput
	isSet bool
}

func (v NullableActionRuleValidationInput) Get() *ActionRuleValidationInput {
	return v.value
}

func (v *NullableActionRuleValidationInput) Set(val *ActionRuleValidationInput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleValidationInput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleValidationInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleValidationInput(val *ActionRuleValidationInput) *NullableActionRuleValidationInput {
	return &NullableActionRuleValidationInput{value: val, isSet: true}
}

func (v NullableActionRuleValidationInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleValidationInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
