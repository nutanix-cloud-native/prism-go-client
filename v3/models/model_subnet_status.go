...
// checks if the SubnetStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubnetStatus{}

// SubnetStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _SubnetStatus SubnetStatus
...
func (o SubnetStatus) MarshalJSON() ([]byte, error) {
...
func (o SubnetStatus) ToMap() (map[string]interface{}, error) {
...
func (o *SubnetStatus) UnmarshalJSON(data []byte) (err error) {
	varSubnetStatus := _SubnetStatus{}

	err = json.Unmarshal(data, &varSubnetStatus)

	if err != nil {
		return err
	}

	*o = SubnetStatus(varSubnetStatus)
