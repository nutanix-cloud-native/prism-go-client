...
// checks if the VmDiskDeviceProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDiskDeviceProperties{}

// VmDiskDeviceProperties struct for VmDiskDeviceProperties
...
type _VmDiskDeviceProperties VmDiskDeviceProperties
...
func (o VmDiskDeviceProperties) MarshalJSON() ([]byte, error) {
...
func (o VmDiskDeviceProperties) ToMap() (map[string]interface{}, error) {
...
func (o *VmDiskDeviceProperties) UnmarshalJSON(data []byte) (err error) {
	varVmDiskDeviceProperties := _VmDiskDeviceProperties{}

	err = json.Unmarshal(data, &varVmDiskDeviceProperties)

	if err != nil {
		return err
	}

	*o = VmDiskDeviceProperties(varVmDiskDeviceProperties)
...
type NullableVmDiskDeviceProperties struct {
	value *VmDiskDeviceProperties
	isSet bool
}

func (v NullableVmDiskDeviceProperties) Get() *VmDiskDeviceProperties {
	return v.value
}

func (v *NullableVmDiskDeviceProperties) Set(val *VmDiskDeviceProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableVmDiskDeviceProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableVmDiskDeviceProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmDiskDeviceProperties(val *VmDiskDeviceProperties) *NullableVmDiskDeviceProperties {
	return &NullableVmDiskDeviceProperties{value: val, isSet: true}
}

func (v NullableVmDiskDeviceProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmDiskDeviceProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
