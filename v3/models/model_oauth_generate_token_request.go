...
// checks if the OauthGenerateTokenRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthGenerateTokenRequest{}
...
type _OauthGenerateTokenRequest OauthGenerateTokenRequest
...
func NewOauthGenerateTokenRequest(scopes []string, clientName string, clientDescription string) *OauthGenerateTokenRequest {
	this := OauthGenerateTokenRequest{}
	this.Scopes = scopes
...
// GetClientDescription returns the ClientDescription field value
...
// GetClientDescriptionOk returns a tuple with the ClientDescription field value
// and a boolean to check if the value has been set.
...
// SetClientDescription sets field value
...
func (o OauthGenerateTokenRequest) MarshalJSON() ([]byte, error) {
...
func (o OauthGenerateTokenRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["scopes"] = o.Scopes
	toSerialize["client_name"] = o.ClientName
	toSerialize["client_description"] = o.ClientDescription
...
func (o *OauthGenerateTokenRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varOauthGenerateTokenRequest := _OauthGenerateTokenRequest{}

	err = json.Unmarshal(data, &varOauthGenerateTokenRequest)

	if err != nil {
		return err
	}

	*o = OauthGenerateTokenRequest(varOauthGenerateTokenRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "client_description")
...
type NullableOauthGenerateTokenRequest struct {
	value *OauthGenerateTokenRequest
	isSet bool
}

func (v NullableOauthGenerateTokenRequest) Get() *OauthGenerateTokenRequest {
	return v.value
}

func (v *NullableOauthGenerateTokenRequest) Set(val *OauthGenerateTokenRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthGenerateTokenRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthGenerateTokenRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthGenerateTokenRequest(val *OauthGenerateTokenRequest) *NullableOauthGenerateTokenRequest {
	return &NullableOauthGenerateTokenRequest{value: val, isSet: true}
}

func (v NullableOauthGenerateTokenRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthGenerateTokenRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
