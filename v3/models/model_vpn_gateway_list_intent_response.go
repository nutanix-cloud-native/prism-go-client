...
// checks if the VpnGatewayListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayListIntentResponse{}

// VpnGatewayListIntentResponse Response object for intentful operation of vpn_gateways
type VpnGatewayListIntentResponse struct {
	Entities []VpnGatewayIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata VpnGatewayListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VpnGatewayListIntentResponse VpnGatewayListIntentResponse
...
func NewVpnGatewayListIntentResponse(apiVersion string, metadata VpnGatewayListMetadataOutput) *VpnGatewayListIntentResponse {
	this := VpnGatewayListIntentResponse{}
...
func (o *VpnGatewayListIntentResponse) GetEntities() []VpnGatewayIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []VpnGatewayIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []VpnGatewayIntentResource and assigns it to the Entities field.
...
func (o *VpnGatewayListIntentResponse) GetMetadata() VpnGatewayListMetadataOutput {
	if o == nil {
		var ret VpnGatewayListMetadataOutput
		return ret
	}
...
func (o VpnGatewayListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VpnGatewayListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnGatewayListIntentResponse := _VpnGatewayListIntentResponse{}

	err = json.Unmarshal(data, &varVpnGatewayListIntentResponse)

	if err != nil {
		return err
	}

	*o = VpnGatewayListIntentResponse(varVpnGatewayListIntentResponse)
...
type NullableVpnGatewayListIntentResponse struct {
	value *VpnGatewayListIntentResponse
	isSet bool
}

func (v NullableVpnGatewayListIntentResponse) Get() *VpnGatewayListIntentResponse {
	return v.value
}

func (v *NullableVpnGatewayListIntentResponse) Set(val *VpnGatewayListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayListIntentResponse(val *VpnGatewayListIntentResponse) *NullableVpnGatewayListIntentResponse {
	return &NullableVpnGatewayListIntentResponse{value: val, isSet: true}
}

func (v NullableVpnGatewayListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
