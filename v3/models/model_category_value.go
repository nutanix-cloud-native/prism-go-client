...
// checks if the CategoryValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryValue{}
...
type _CategoryValue CategoryValue
...
func (o CategoryValue) MarshalJSON() ([]byte, error) {
...
func (o CategoryValue) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryValue) UnmarshalJSON(data []byte) (err error) {
	varCategoryValue := _CategoryValue{}

	err = json.Unmarshal(data, &varCategoryValue)

	if err != nil {
		return err
	}

	*o = CategoryValue(varCategoryValue)
...
type NullableCategoryValue struct {
	value *CategoryValue
	isSet bool
}

func (v NullableCategoryValue) Get() *CategoryValue {
	return v.value
}

func (v *NullableCategoryValue) Set(val *CategoryValue) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryValue) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryValue(val *CategoryValue) *NullableCategoryValue {
	return &NullableCategoryValue{value: val, isSet: true}
}

func (v NullableCategoryValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
