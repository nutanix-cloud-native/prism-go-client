...
// checks if the VpnGatewayListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayListMetadata{}

// VpnGatewayListMetadata All api calls that return a list will have this metadata block as input 
type VpnGatewayListMetadata struct {
	// The kind name
...
type _VpnGatewayListMetadata VpnGatewayListMetadata
...
func (o VpnGatewayListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VpnGatewayListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVpnGatewayListMetadata := _VpnGatewayListMetadata{}

	err = json.Unmarshal(data, &varVpnGatewayListMetadata)

	if err != nil {
		return err
	}

	*o = VpnGatewayListMetadata(varVpnGatewayListMetadata)
...
type NullableVpnGatewayListMetadata struct {
	value *VpnGatewayListMetadata
	isSet bool
}

func (v NullableVpnGatewayListMetadata) Get() *VpnGatewayListMetadata {
	return v.value
}

func (v *NullableVpnGatewayListMetadata) Set(val *VpnGatewayListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayListMetadata(val *VpnGatewayListMetadata) *NullableVpnGatewayListMetadata {
	return &NullableVpnGatewayListMetadata{value: val, isSet: true}
}

func (v NullableVpnGatewayListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
