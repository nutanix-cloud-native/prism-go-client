...
// checks if the DockerRegistryImageStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryImageStatus{}
...
type DockerRegistryImageStatus struct {
	...
	TagList []DockerRegistryImageTag `json:"tag_list"`
...
type _DockerRegistryImageStatus DockerRegistryImageStatus
...
func NewDockerRegistryImageStatus(owner string, isOfficial bool, tagList []DockerRegistryImageTag, name string) *DockerRegistryImageStatus {
	this := DockerRegistryImageStatus{}
	this.Owner = owner
...
// GetIsOfficial returns the IsOfficial field value
...
// GetIsOfficialOk returns a tuple with the IsOfficial field value
// and a boolean to check if the value has been set.
...
// GetTagListOk returns a tuple with the TagList field value
// and a boolean to check if the value has been set.
...
func (o DockerRegistryImageStatus) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryImageStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryImageStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerRegistryImageStatus := _DockerRegistryImageStatus{}

	err = json.Unmarshal(data, &varDockerRegistryImageStatus)

	if err != nil {
		return err
	}

	*o = DockerRegistryImageStatus(varDockerRegistryImageStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "owner")
		delete(additionalProperties, "is_official")
...
type NullableDockerRegistryImageStatus struct {
	value *DockerRegistryImageStatus
	isSet bool
}

func (v NullableDockerRegistryImageStatus) Get() *DockerRegistryImageStatus {
	return v.value
}

func (v *NullableDockerRegistryImageStatus) Set(val *DockerRegistryImageStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryImageStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryImageStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryImageStatus(val *DockerRegistryImageStatus) *NullableDockerRegistryImageStatus {
	return &NullableDockerRegistryImageStatus{value: val, isSet: true}
}

func (v NullableDockerRegistryImageStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryImageStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
