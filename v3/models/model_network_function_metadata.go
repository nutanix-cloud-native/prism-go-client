...
// checks if the NetworkFunctionMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionMetadata{}

// NetworkFunctionMetadata The network_function kind metadata
type NetworkFunctionMetadata struct {
	...
	// Categories for the network_function. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the network_function. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _NetworkFunctionMetadata NetworkFunctionMetadata
...
func (o NetworkFunctionMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkFunctionMetadata := _NetworkFunctionMetadata{}

	err = json.Unmarshal(data, &varNetworkFunctionMetadata)

	if err != nil {
		return err
	}

	*o = NetworkFunctionMetadata(varNetworkFunctionMetadata)
...
type NullableNetworkFunctionMetadata struct {
	value *NetworkFunctionMetadata
	isSet bool
}

func (v NullableNetworkFunctionMetadata) Get() *NetworkFunctionMetadata {
	return v.value
}

func (v *NullableNetworkFunctionMetadata) Set(val *NetworkFunctionMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionMetadata(val *NetworkFunctionMetadata) *NullableNetworkFunctionMetadata {
	return &NullableNetworkFunctionMetadata{value: val, isSet: true}
}

func (v NullableNetworkFunctionMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
