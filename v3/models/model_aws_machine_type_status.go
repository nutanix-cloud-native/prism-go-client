...
// checks if the AwsMachineTypeStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsMachineTypeStatus{}

// AwsMachineTypeStatus The status of a REST API call. Only used when there is a failure to report. 
type AwsMachineTypeStatus struct {
	// The kind name
...
type _AwsMachineTypeStatus AwsMachineTypeStatus
...
func (o AwsMachineTypeStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsMachineTypeStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsMachineTypeStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsMachineTypeStatus := _AwsMachineTypeStatus{}

	err = json.Unmarshal(data, &varAwsMachineTypeStatus)

	if err != nil {
		return err
	}

	*o = AwsMachineTypeStatus(varAwsMachineTypeStatus)
...
type NullableAwsMachineTypeStatus struct {
	value *AwsMachineTypeStatus
	isSet bool
}

func (v NullableAwsMachineTypeStatus) Get() *AwsMachineTypeStatus {
	return v.value
}

func (v *NullableAwsMachineTypeStatus) Set(val *AwsMachineTypeStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsMachineTypeStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsMachineTypeStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsMachineTypeStatus(val *AwsMachineTypeStatus) *NullableAwsMachineTypeStatus {
	return &NullableAwsMachineTypeStatus{value: val, isSet: true}
}

func (v NullableAwsMachineTypeStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsMachineTypeStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
