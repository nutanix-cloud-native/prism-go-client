...
// checks if the IpfixExporterReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpfixExporterReference{}

// IpfixExporterReference The reference to a ipfix_exporter
type IpfixExporterReference struct {
	// The kind name
...
type _IpfixExporterReference IpfixExporterReference
...
func (o IpfixExporterReference) MarshalJSON() ([]byte, error) {
...
func (o IpfixExporterReference) ToMap() (map[string]interface{}, error) {
...
func (o *IpfixExporterReference) UnmarshalJSON(data []byte) (err error) {
	...
	varIpfixExporterReference := _IpfixExporterReference{}

	err = json.Unmarshal(data, &varIpfixExporterReference)

	if err != nil {
		return err
	}

	*o = IpfixExporterReference(varIpfixExporterReference)
...
type NullableIpfixExporterReference struct {
	value *IpfixExporterReference
	isSet bool
}

func (v NullableIpfixExporterReference) Get() *IpfixExporterReference {
	return v.value
}

func (v *NullableIpfixExporterReference) Set(val *IpfixExporterReference) {
	v.value = val
	v.isSet = true
}

func (v NullableIpfixExporterReference) IsSet() bool {
	return v.isSet
}

func (v *NullableIpfixExporterReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpfixExporterReference(val *IpfixExporterReference) *NullableIpfixExporterReference {
	return &NullableIpfixExporterReference{value: val, isSet: true}
}

func (v NullableIpfixExporterReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpfixExporterReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
