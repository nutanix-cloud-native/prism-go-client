...
// checks if the ActionTemplateIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTemplateIntentResource{}

// ActionTemplateIntentResource Response object for intentful operations on a action_template
type ActionTemplateIntentResource struct {
	Status *ActionTemplateDefStatus `json:"status,omitempty"`
	Spec *ActionTemplate `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata ActionTemplateMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ActionTemplateIntentResource ActionTemplateIntentResource
...
func NewActionTemplateIntentResource(metadata ActionTemplateMetadata) *ActionTemplateIntentResource {
	this := ActionTemplateIntentResource{}
...
func (o *ActionTemplateIntentResource) GetStatus() ActionTemplateDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret ActionTemplateDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ActionTemplateDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given ActionTemplate and assigns it to the Spec field.
...
func (o *ActionTemplateIntentResource) GetMetadata() ActionTemplateMetadata {
	if o == nil {
		var ret ActionTemplateMetadata
		return ret
	}
...
func (o ActionTemplateIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ActionTemplateIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTemplateIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTemplateIntentResource := _ActionTemplateIntentResource{}

	err = json.Unmarshal(data, &varActionTemplateIntentResource)

	if err != nil {
		return err
	}

	*o = ActionTemplateIntentResource(varActionTemplateIntentResource)
...
type NullableActionTemplateIntentResource struct {
	value *ActionTemplateIntentResource
	isSet bool
}

func (v NullableActionTemplateIntentResource) Get() *ActionTemplateIntentResource {
	return v.value
}

func (v *NullableActionTemplateIntentResource) Set(val *ActionTemplateIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTemplateIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTemplateIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTemplateIntentResource(val *ActionTemplateIntentResource) *NullableActionTemplateIntentResource {
	return &NullableActionTemplateIntentResource{value: val, isSet: true}
}

func (v NullableActionTemplateIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTemplateIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
