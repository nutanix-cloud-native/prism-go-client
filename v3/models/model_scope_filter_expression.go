...
// checks if the ScopeFilterExpression type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScopeFilterExpression{}

// ScopeFilterExpression The Scope filter expression is a combination of LHS-Operator-RHS. This type of filter expression helps express the \"Context\" part of a Filter. Example1 - To express a context = Belonging to Project P1 or Project P2   left_hand_side = PROJECT   operator = IN   right_hand_side = [\"P1\", \"P2\"] Example2 - To express Belonging to 2 categories   left_hand_side = CATEGORY   operator = IN_ALL   right_hand_side = [\"location:nyc\", \"env:prod\"] 
type ScopeFilterExpression struct {
	// The operator of the filter expression.
	Operator string `json:"operator"`
	RightHandSide ScopeRightHandSide `json:"right_hand_side"`
	// The LHS of the filter expression - the scope type. Following is the list of supported values - * CATEGORY * PROJECT * CLUSTER * VPC * CONNECTIVITY_TYPE 
	LeftHandSide string `json:"left_hand_side"`
	AdditionalProperties map[string]interface{}
}

type _ScopeFilterExpression ScopeFilterExpression
...
// GetRightHandSide returns the RightHandSide field value
func (o *ScopeFilterExpression) GetRightHandSide() ScopeRightHandSide {
	if o == nil {
		var ret ScopeRightHandSide
		return ret
	}

	return o.RightHandSide
}

// GetRightHandSideOk returns a tuple with the RightHandSide field value
// and a boolean to check if the value has been set.
func (o *ScopeFilterExpression) GetRightHandSideOk() (*ScopeRightHandSide, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RightHandSide, true
}

// SetRightHandSide sets field value
func (o *ScopeFilterExpression) SetRightHandSide(v ScopeRightHandSide) {
	o.RightHandSide = v
}

// GetLeftHandSide returns the LeftHandSide field value
func (o *ScopeFilterExpression) GetLeftHandSide() string {
	...
	return o.LeftHandSide
}

// GetLeftHandSideOk returns a tuple with the LeftHandSide field value
// and a boolean to check if the value has been set.
func (o *ScopeFilterExpression) GetLeftHandSideOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.LeftHandSide, true
}

// SetLeftHandSide sets field value
func (o *ScopeFilterExpression) SetLeftHandSide(v string) {
	o.LeftHandSide = v
}

func (o ScopeFilterExpression) MarshalJSON() ([]byte, error) {
...
func (o ScopeFilterExpression) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["operator"] = o.Operator
	toSerialize["right_hand_side"] = o.RightHandSide
	toSerialize["left_hand_side"] = o.LeftHandSide
...
func (o *ScopeFilterExpression) UnmarshalJSON(data []byte) (err error) {
	...
	varScopeFilterExpression := _ScopeFilterExpression{}

	err = json.Unmarshal(data, &varScopeFilterExpression)

	if err != nil {
		return err
	}

	*o = ScopeFilterExpression(varScopeFilterExpression)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "operator")
		delete(additionalProperties, "right_hand_side")
		delete(additionalProperties, "left_hand_side")
...
type NullableScopeFilterExpression struct {
	value *ScopeFilterExpression
	isSet bool
}

func (v NullableScopeFilterExpression) Get() *ScopeFilterExpression {
	return v.value
}

func (v *NullableScopeFilterExpression) Set(val *ScopeFilterExpression) {
	v.value = val
	v.isSet = true
}

func (v NullableScopeFilterExpression) IsSet() bool {
	return v.isSet
}

func (v *NullableScopeFilterExpression) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScopeFilterExpression(val *ScopeFilterExpression) *NullableScopeFilterExpression {
	return &NullableScopeFilterExpression{value: val, isSet: true}
}

func (v NullableScopeFilterExpression) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScopeFilterExpression) UnmarshalJSON(src []byte) error {
	v.isSet = true
