...
// checks if the ChangedRegionsReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangedRegionsReference{}

// ChangedRegionsReference The reference to a changed_regions
...
type _ChangedRegionsReference ChangedRegionsReference
...
func (o ChangedRegionsReference) MarshalJSON() ([]byte, error) {
...
func (o ChangedRegionsReference) ToMap() (map[string]interface{}, error) {
...
func (o *ChangedRegionsReference) UnmarshalJSON(data []byte) (err error) {
	...
	varChangedRegionsReference := _ChangedRegionsReference{}

	err = json.Unmarshal(data, &varChangedRegionsReference)

	if err != nil {
		return err
	}

	*o = ChangedRegionsReference(varChangedRegionsReference)
...
type NullableChangedRegionsReference struct {
	value *ChangedRegionsReference
	isSet bool
}

func (v NullableChangedRegionsReference) Get() *ChangedRegionsReference {
	return v.value
}

func (v *NullableChangedRegionsReference) Set(val *ChangedRegionsReference) {
	v.value = val
	v.isSet = true
}

func (v NullableChangedRegionsReference) IsSet() bool {
	return v.isSet
}

func (v *NullableChangedRegionsReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangedRegionsReference(val *ChangedRegionsReference) *NullableChangedRegionsReference {
	return &NullableChangedRegionsReference{value: val, isSet: true}
}

func (v NullableChangedRegionsReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangedRegionsReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
