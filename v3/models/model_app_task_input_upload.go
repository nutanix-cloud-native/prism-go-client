...
// checks if the AppTaskInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskInputUpload{}

// AppTaskInputUpload Task definition for Application.
type AppTaskInputUpload struct {
...
type _AppTaskInputUpload AppTaskInputUpload
...
func (o AppTaskInputUpload) MarshalJSON() ([]byte, error) {
...
func (o AppTaskInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskInputUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskInputUpload := _AppTaskInputUpload{}

	err = json.Unmarshal(data, &varAppTaskInputUpload)

	if err != nil {
		return err
	}

	*o = AppTaskInputUpload(varAppTaskInputUpload)
...
type NullableAppTaskInputUpload struct {
	value *AppTaskInputUpload
	isSet bool
}

func (v NullableAppTaskInputUpload) Get() *AppTaskInputUpload {
	return v.value
}

func (v *NullableAppTaskInputUpload) Set(val *AppTaskInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskInputUpload(val *AppTaskInputUpload) *NullableAppTaskInputUpload {
	return &NullableAppTaskInputUpload{value: val, isSet: true}
}

func (v NullableAppTaskInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
