...
// checks if the AppPackageInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPackageInputUpload{}

// AppPackageInputUpload Package definition for Application
type AppPackageInputUpload struct {
	...
	ServiceLocalReferenceList []AppServiceReferenceUpload `json:"service_local_reference_list,omitempty"`
	// 
...
type _AppPackageInputUpload AppPackageInputUpload
...
// SetServiceLocalReferenceList gets a reference to the given []AppServiceReferenceUpload and assigns it to the ServiceLocalReferenceList field.
...
func (o AppPackageInputUpload) MarshalJSON() ([]byte, error) {
...
func (o AppPackageInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppPackageInputUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPackageInputUpload := _AppPackageInputUpload{}

	err = json.Unmarshal(data, &varAppPackageInputUpload)

	if err != nil {
		return err
	}

	*o = AppPackageInputUpload(varAppPackageInputUpload)
...
type NullableAppPackageInputUpload struct {
	value *AppPackageInputUpload
	isSet bool
}

func (v NullableAppPackageInputUpload) Get() *AppPackageInputUpload {
	return v.value
}

func (v *NullableAppPackageInputUpload) Set(val *AppPackageInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPackageInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPackageInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPackageInputUpload(val *AppPackageInputUpload) *NullableAppPackageInputUpload {
	return &NullableAppPackageInputUpload{value: val, isSet: true}
}

func (v NullableAppPackageInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPackageInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
