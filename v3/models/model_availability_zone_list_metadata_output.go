...
// checks if the AvailabilityZoneListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneListMetadataOutput{}

// AvailabilityZoneListMetadataOutput All api calls that return a list will have this metadata block 
type AvailabilityZoneListMetadataOutput struct {
	// The kind name
...
type _AvailabilityZoneListMetadataOutput AvailabilityZoneListMetadataOutput
...
func NewAvailabilityZoneListMetadataOutput() *AvailabilityZoneListMetadataOutput {
	this := AvailabilityZoneListMetadataOutput{}
	var kind string = "availability_zone"
	this.Kind = &kind
	return &this
}
...
func (o AvailabilityZoneListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAvailabilityZoneListMetadataOutput := _AvailabilityZoneListMetadataOutput{}

	err = json.Unmarshal(data, &varAvailabilityZoneListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneListMetadataOutput(varAvailabilityZoneListMetadataOutput)
...
type NullableAvailabilityZoneListMetadataOutput struct {
	value *AvailabilityZoneListMetadataOutput
	isSet bool
}

func (v NullableAvailabilityZoneListMetadataOutput) Get() *AvailabilityZoneListMetadataOutput {
	return v.value
}

func (v *NullableAvailabilityZoneListMetadataOutput) Set(val *AvailabilityZoneListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneListMetadataOutput(val *AvailabilityZoneListMetadataOutput) *NullableAvailabilityZoneListMetadataOutput {
	return &NullableAvailabilityZoneListMetadataOutput{value: val, isSet: true}
}

func (v NullableAvailabilityZoneListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
