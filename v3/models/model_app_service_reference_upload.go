...
// checks if the AppServiceReferenceUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppServiceReferenceUpload{}

// AppServiceReferenceUpload The reference to a app_service
type AppServiceReferenceUpload struct {
	// The kind name
...
type _AppServiceReferenceUpload AppServiceReferenceUpload
...
func NewAppServiceReferenceUpload(kind string, name string) *AppServiceReferenceUpload {
	this := AppServiceReferenceUpload{}
	this.Kind = kind
	this.Name = name
	return &this
}
...
func (o AppServiceReferenceUpload) MarshalJSON() ([]byte, error) {
...
func (o AppServiceReferenceUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppServiceReferenceUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppServiceReferenceUpload := _AppServiceReferenceUpload{}

	err = json.Unmarshal(data, &varAppServiceReferenceUpload)

	if err != nil {
		return err
	}

	*o = AppServiceReferenceUpload(varAppServiceReferenceUpload)
...
type NullableAppServiceReferenceUpload struct {
	value *AppServiceReferenceUpload
	isSet bool
}

func (v NullableAppServiceReferenceUpload) Get() *AppServiceReferenceUpload {
	return v.value
}

func (v *NullableAppServiceReferenceUpload) Set(val *AppServiceReferenceUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppServiceReferenceUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppServiceReferenceUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppServiceReferenceUpload(val *AppServiceReferenceUpload) *NullableAppServiceReferenceUpload {
	return &NullableAppServiceReferenceUpload{value: val, isSet: true}
}

func (v NullableAppServiceReferenceUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppServiceReferenceUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
