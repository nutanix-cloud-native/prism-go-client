...
// checks if the AppPublishedServiceElement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPublishedServiceElement{}

// AppPublishedServiceElement Published service element
type AppPublishedServiceElement struct {
...
type _AppPublishedServiceElement AppPublishedServiceElement
...
func NewAppPublishedServiceElement(uUID string, actionList []AppActionResponse, name string, state string, variableList []AppVariableResponse) *AppPublishedServiceElement {
	this := AppPublishedServiceElement{}
...
func (o AppPublishedServiceElement) MarshalJSON() ([]byte, error) {
...
func (o AppPublishedServiceElement) ToMap() (map[string]interface{}, error) {
...
func (o *AppPublishedServiceElement) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPublishedServiceElement := _AppPublishedServiceElement{}

	err = json.Unmarshal(data, &varAppPublishedServiceElement)

	if err != nil {
		return err
	}

	*o = AppPublishedServiceElement(varAppPublishedServiceElement)
...
type NullableAppPublishedServiceElement struct {
	value *AppPublishedServiceElement
	isSet bool
}

func (v NullableAppPublishedServiceElement) Get() *AppPublishedServiceElement {
	return v.value
}

func (v *NullableAppPublishedServiceElement) Set(val *AppPublishedServiceElement) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPublishedServiceElement) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPublishedServiceElement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPublishedServiceElement(val *AppPublishedServiceElement) *NullableAppPublishedServiceElement {
	return &NullableAppPublishedServiceElement{value: val, isSet: true}
}

func (v NullableAppPublishedServiceElement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPublishedServiceElement) UnmarshalJSON(src []byte) error {
	v.isSet = true
