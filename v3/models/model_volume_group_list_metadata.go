...
// checks if the VolumeGroupListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupListMetadata{}

// VolumeGroupListMetadata All api calls that return a list will have this metadata block as input 
...
type _VolumeGroupListMetadata VolumeGroupListMetadata
...
func (o VolumeGroupListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeGroupListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVolumeGroupListMetadata := _VolumeGroupListMetadata{}

	err = json.Unmarshal(data, &varVolumeGroupListMetadata)

	if err != nil {
		return err
	}

	*o = VolumeGroupListMetadata(varVolumeGroupListMetadata)
...
type NullableVolumeGroupListMetadata struct {
	value *VolumeGroupListMetadata
	isSet bool
}

func (v NullableVolumeGroupListMetadata) Get() *VolumeGroupListMetadata {
	return v.value
}

func (v *NullableVolumeGroupListMetadata) Set(val *VolumeGroupListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupListMetadata(val *VolumeGroupListMetadata) *NullableVolumeGroupListMetadata {
	return &NullableVolumeGroupListMetadata{value: val, isSet: true}
}

func (v NullableVolumeGroupListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
