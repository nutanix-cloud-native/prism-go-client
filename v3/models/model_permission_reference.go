...
// checks if the PermissionReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionReference{}

// PermissionReference The reference to a permission
...
type _PermissionReference PermissionReference
...
func (o PermissionReference) MarshalJSON() ([]byte, error) {
...
func (o PermissionReference) ToMap() (map[string]interface{}, error) {
...
func (o *PermissionReference) UnmarshalJSON(data []byte) (err error) {
	...
	varPermissionReference := _PermissionReference{}

	err = json.Unmarshal(data, &varPermissionReference)

	if err != nil {
		return err
	}

	*o = PermissionReference(varPermissionReference)
...
type NullablePermissionReference struct {
	value *PermissionReference
	isSet bool
}

func (v NullablePermissionReference) Get() *PermissionReference {
	return v.value
}

func (v *NullablePermissionReference) Set(val *PermissionReference) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionReference) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionReference(val *PermissionReference) *NullablePermissionReference {
	return &NullablePermissionReference{value: val, isSet: true}
}

func (v NullablePermissionReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
