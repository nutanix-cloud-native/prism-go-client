...
// checks if the FileItemListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemListMetadata{}

// FileItemListMetadata All api calls that return a list will have this metadata block as input 
type FileItemListMetadata struct {
	// The kind name
...
type _FileItemListMetadata FileItemListMetadata
...
func (o FileItemListMetadata) MarshalJSON() ([]byte, error) {
...
func (o FileItemListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *FileItemListMetadata) UnmarshalJSON(data []byte) (err error) {
	varFileItemListMetadata := _FileItemListMetadata{}

	err = json.Unmarshal(data, &varFileItemListMetadata)

	if err != nil {
		return err
	}

	*o = FileItemListMetadata(varFileItemListMetadata)
...
type NullableFileItemListMetadata struct {
	value *FileItemListMetadata
	isSet bool
}

func (v NullableFileItemListMetadata) Get() *FileItemListMetadata {
	return v.value
}

func (v *NullableFileItemListMetadata) Set(val *FileItemListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemListMetadata(val *FileItemListMetadata) *NullableFileItemListMetadata {
	return &NullableFileItemListMetadata{value: val, isSet: true}
}

func (v NullableFileItemListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
