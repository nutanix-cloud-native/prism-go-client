...
// checks if the EntitySyncRuleDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySyncRuleDefStatus{}

// EntitySyncRuleDefStatus Entity sync rule creation/modification status.
type EntitySyncRuleDefStatus struct {
	// Entity sync rule name.
	Name string `json:"name"`
	Resources EntitySyncRuleResources `json:"resources"`
	// A description or user annotation for the entity sync rule.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _EntitySyncRuleDefStatus EntitySyncRuleDefStatus
...
func (o *EntitySyncRuleDefStatus) GetResources() EntitySyncRuleResources {
	if o == nil {
		var ret EntitySyncRuleResources
		return ret
	}
...
func (o EntitySyncRuleDefStatus) MarshalJSON() ([]byte, error) {
...
func (o EntitySyncRuleDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *EntitySyncRuleDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varEntitySyncRuleDefStatus := _EntitySyncRuleDefStatus{}

	err = json.Unmarshal(data, &varEntitySyncRuleDefStatus)

	if err != nil {
		return err
	}

	*o = EntitySyncRuleDefStatus(varEntitySyncRuleDefStatus)
...
type NullableEntitySyncRuleDefStatus struct {
	value *EntitySyncRuleDefStatus
	isSet bool
}

func (v NullableEntitySyncRuleDefStatus) Get() *EntitySyncRuleDefStatus {
	return v.value
}

func (v *NullableEntitySyncRuleDefStatus) Set(val *EntitySyncRuleDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySyncRuleDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySyncRuleDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySyncRuleDefStatus(val *EntitySyncRuleDefStatus) *NullableEntitySyncRuleDefStatus {
	return &NullableEntitySyncRuleDefStatus{value: val, isSet: true}
}

func (v NullableEntitySyncRuleDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySyncRuleDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
