...
// checks if the AwsRoleIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRoleIntentResource{}

// AwsRoleIntentResource aws_role entity
type AwsRoleIntentResource struct {
	Status *AwsRoleDefStatus `json:"status,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsRoleMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsRoleIntentResource AwsRoleIntentResource
...
// SetStatus gets a reference to the given AwsRoleDefStatus and assigns it to the Status field.
...
func (o AwsRoleIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsRoleIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRoleIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsRoleIntentResource := _AwsRoleIntentResource{}

	err = json.Unmarshal(data, &varAwsRoleIntentResource)

	if err != nil {
		return err
	}

	*o = AwsRoleIntentResource(varAwsRoleIntentResource)
...
type NullableAwsRoleIntentResource struct {
	value *AwsRoleIntentResource
	isSet bool
}

func (v NullableAwsRoleIntentResource) Get() *AwsRoleIntentResource {
	return v.value
}

func (v *NullableAwsRoleIntentResource) Set(val *AwsRoleIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRoleIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRoleIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRoleIntentResource(val *AwsRoleIntentResource) *NullableAwsRoleIntentResource {
	return &NullableAwsRoleIntentResource{value: val, isSet: true}
}

func (v NullableAwsRoleIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRoleIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
