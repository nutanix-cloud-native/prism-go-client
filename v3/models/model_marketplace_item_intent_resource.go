...
// checks if the MarketplaceItemIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemIntentResource{}

// MarketplaceItemIntentResource Response object for intentful operations on a marketplace_item
type MarketplaceItemIntentResource struct {
...
type _MarketplaceItemIntentResource MarketplaceItemIntentResource
...
func NewMarketplaceItemIntentResource(metadata MarketplaceItemMetadata) *MarketplaceItemIntentResource {
	this := MarketplaceItemIntentResource{}
...
func (o MarketplaceItemIntentResource) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItemIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceItemIntentResource := _MarketplaceItemIntentResource{}

	err = json.Unmarshal(data, &varMarketplaceItemIntentResource)

	if err != nil {
		return err
	}

	*o = MarketplaceItemIntentResource(varMarketplaceItemIntentResource)
...
type NullableMarketplaceItemIntentResource struct {
	value *MarketplaceItemIntentResource
	isSet bool
}

func (v NullableMarketplaceItemIntentResource) Get() *MarketplaceItemIntentResource {
	return v.value
}

func (v *NullableMarketplaceItemIntentResource) Set(val *MarketplaceItemIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemIntentResource(val *MarketplaceItemIntentResource) *NullableMarketplaceItemIntentResource {
	return &NullableMarketplaceItemIntentResource{value: val, isSet: true}
}

func (v NullableMarketplaceItemIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
