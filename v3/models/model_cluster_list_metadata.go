...
// checks if the ClusterListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterListMetadata{}

// ClusterListMetadata All api calls that return a list will have this metadata block as input 
...
type _ClusterListMetadata ClusterListMetadata
...
func (o ClusterListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ClusterListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterListMetadata) UnmarshalJSON(data []byte) (err error) {
	varClusterListMetadata := _ClusterListMetadata{}

	err = json.Unmarshal(data, &varClusterListMetadata)

	if err != nil {
		return err
	}

	*o = ClusterListMetadata(varClusterListMetadata)
...
type NullableClusterListMetadata struct {
	value *ClusterListMetadata
	isSet bool
}

func (v NullableClusterListMetadata) Get() *ClusterListMetadata {
	return v.value
}

func (v *NullableClusterListMetadata) Set(val *ClusterListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterListMetadata(val *ClusterListMetadata) *NullableClusterListMetadata {
	return &NullableClusterListMetadata{value: val, isSet: true}
}

func (v NullableClusterListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
