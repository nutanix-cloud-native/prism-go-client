...
// checks if the VmVtpmStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmVtpmStatus{}

// VmVtpmStatus Current status of the vTPM configuration. 
...
type _VmVtpmStatus VmVtpmStatus
...
func (o VmVtpmStatus) MarshalJSON() ([]byte, error) {
...
func (o VmVtpmStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VmVtpmStatus) UnmarshalJSON(data []byte) (err error) {
	varVmVtpmStatus := _VmVtpmStatus{}

	err = json.Unmarshal(data, &varVmVtpmStatus)

	if err != nil {
		return err
	}

	*o = VmVtpmStatus(varVmVtpmStatus)
...
type NullableVmVtpmStatus struct {
	value *VmVtpmStatus
	isSet bool
}

func (v NullableVmVtpmStatus) Get() *VmVtpmStatus {
	return v.value
}

func (v *NullableVmVtpmStatus) Set(val *VmVtpmStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVmVtpmStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVmVtpmStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmVtpmStatus(val *VmVtpmStatus) *NullableVmVtpmStatus {
	return &NullableVmVtpmStatus{value: val, isSet: true}
}

func (v NullableVmVtpmStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmVtpmStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
