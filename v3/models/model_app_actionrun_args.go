...
// checks if the AppActionrunArgs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppActionrunArgs{}

// AppActionrunArgs Argument format for action run
type AppActionrunArgs struct {
	// Name of the Argument field.
	Name *string `json:"name,omitempty"`
	// Value of the Argument field.
	Value *string `json:"value,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AppActionrunArgs AppActionrunArgs
...
func (o AppActionrunArgs) MarshalJSON() ([]byte, error) {
...
func (o AppActionrunArgs) ToMap() (map[string]interface{}, error) {
...
func (o *AppActionrunArgs) UnmarshalJSON(data []byte) (err error) {
	varAppActionrunArgs := _AppActionrunArgs{}

	err = json.Unmarshal(data, &varAppActionrunArgs)

	if err != nil {
		return err
	}

	*o = AppActionrunArgs(varAppActionrunArgs)
...
type NullableAppActionrunArgs struct {
	value *AppActionrunArgs
	isSet bool
}

func (v NullableAppActionrunArgs) Get() *AppActionrunArgs {
	return v.value
}

func (v *NullableAppActionrunArgs) Set(val *AppActionrunArgs) {
	v.value = val
	v.isSet = true
}

func (v NullableAppActionrunArgs) IsSet() bool {
	return v.isSet
}

func (v *NullableAppActionrunArgs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppActionrunArgs(val *AppActionrunArgs) *NullableAppActionrunArgs {
	return &NullableAppActionrunArgs{value: val, isSet: true}
}

func (v NullableAppActionrunArgs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppActionrunArgs) UnmarshalJSON(src []byte) error {
	v.isSet = true
