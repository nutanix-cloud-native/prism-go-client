...
// checks if the VmHostAffinityLegacyPolicyListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityLegacyPolicyListMetadata{}

// VmHostAffinityLegacyPolicyListMetadata API call for  that returns a list will have this metadata block as input. 
type VmHostAffinityLegacyPolicyListMetadata struct {
	// The kind name.
...
type _VmHostAffinityLegacyPolicyListMetadata VmHostAffinityLegacyPolicyListMetadata
...
func NewVmHostAffinityLegacyPolicyListMetadata() *VmHostAffinityLegacyPolicyListMetadata {
	this := VmHostAffinityLegacyPolicyListMetadata{}
...
func (o VmHostAffinityLegacyPolicyListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityLegacyPolicyListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmHostAffinityLegacyPolicyListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVmHostAffinityLegacyPolicyListMetadata := _VmHostAffinityLegacyPolicyListMetadata{}

	err = json.Unmarshal(data, &varVmHostAffinityLegacyPolicyListMetadata)

	if err != nil {
		return err
	}

	*o = VmHostAffinityLegacyPolicyListMetadata(varVmHostAffinityLegacyPolicyListMetadata)
...
type NullableVmHostAffinityLegacyPolicyListMetadata struct {
	value *VmHostAffinityLegacyPolicyListMetadata
	isSet bool
}

func (v NullableVmHostAffinityLegacyPolicyListMetadata) Get() *VmHostAffinityLegacyPolicyListMetadata {
	return v.value
}

func (v *NullableVmHostAffinityLegacyPolicyListMetadata) Set(val *VmHostAffinityLegacyPolicyListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityLegacyPolicyListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityLegacyPolicyListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityLegacyPolicyListMetadata(val *VmHostAffinityLegacyPolicyListMetadata) *NullableVmHostAffinityLegacyPolicyListMetadata {
	return &NullableVmHostAffinityLegacyPolicyListMetadata{value: val, isSet: true}
}

func (v NullableVmHostAffinityLegacyPolicyListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityLegacyPolicyListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
