...
// checks if the EntitySyncRuleStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySyncRuleStatus{}

// EntitySyncRuleStatus The status of a REST API call. Only used when there is a failure to report. 
type EntitySyncRuleStatus struct {
	// The kind name
...
type _EntitySyncRuleStatus EntitySyncRuleStatus
...
func (o EntitySyncRuleStatus) MarshalJSON() ([]byte, error) {
...
func (o EntitySyncRuleStatus) ToMap() (map[string]interface{}, error) {
...
func (o *EntitySyncRuleStatus) UnmarshalJSON(data []byte) (err error) {
	varEntitySyncRuleStatus := _EntitySyncRuleStatus{}

	err = json.Unmarshal(data, &varEntitySyncRuleStatus)

	if err != nil {
		return err
	}

	*o = EntitySyncRuleStatus(varEntitySyncRuleStatus)
...
type NullableEntitySyncRuleStatus struct {
	value *EntitySyncRuleStatus
	isSet bool
}

func (v NullableEntitySyncRuleStatus) Get() *EntitySyncRuleStatus {
	return v.value
}

func (v *NullableEntitySyncRuleStatus) Set(val *EntitySyncRuleStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySyncRuleStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySyncRuleStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySyncRuleStatus(val *EntitySyncRuleStatus) *NullableEntitySyncRuleStatus {
	return &NullableEntitySyncRuleStatus{value: val, isSet: true}
}

func (v NullableEntitySyncRuleStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySyncRuleStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
