...
// checks if the RemoteSyslogServerIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogServerIntentResponse{}

// RemoteSyslogServerIntentResponse Response object for intentful operations on a remote_syslog_server
type RemoteSyslogServerIntentResponse struct {
	Status *RemoteSyslogServerDefStatus `json:"status,omitempty"`
	Spec *RemoteSyslogServer `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata RemoteSyslogServerMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RemoteSyslogServerIntentResponse RemoteSyslogServerIntentResponse
...
func NewRemoteSyslogServerIntentResponse(apiVersion string, metadata RemoteSyslogServerMetadata) *RemoteSyslogServerIntentResponse {
	this := RemoteSyslogServerIntentResponse{}
...
func (o *RemoteSyslogServerIntentResponse) GetStatus() RemoteSyslogServerDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret RemoteSyslogServerDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given RemoteSyslogServerDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given RemoteSyslogServer and assigns it to the Spec field.
...
func (o *RemoteSyslogServerIntentResponse) GetMetadata() RemoteSyslogServerMetadata {
	if o == nil {
		var ret RemoteSyslogServerMetadata
		return ret
	}
...
func (o RemoteSyslogServerIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogServerIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogServerIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogServerIntentResponse := _RemoteSyslogServerIntentResponse{}

	err = json.Unmarshal(data, &varRemoteSyslogServerIntentResponse)

	if err != nil {
		return err
	}

	*o = RemoteSyslogServerIntentResponse(varRemoteSyslogServerIntentResponse)
...
type NullableRemoteSyslogServerIntentResponse struct {
	value *RemoteSyslogServerIntentResponse
	isSet bool
}

func (v NullableRemoteSyslogServerIntentResponse) Get() *RemoteSyslogServerIntentResponse {
	return v.value
}

func (v *NullableRemoteSyslogServerIntentResponse) Set(val *RemoteSyslogServerIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogServerIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogServerIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogServerIntentResponse(val *RemoteSyslogServerIntentResponse) *NullableRemoteSyslogServerIntentResponse {
	return &NullableRemoteSyslogServerIntentResponse{value: val, isSet: true}
}

func (v NullableRemoteSyslogServerIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogServerIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
