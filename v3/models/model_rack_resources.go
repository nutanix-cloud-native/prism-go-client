...
// checks if the RackResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackResources{}

// RackResources Rack entity definition
type RackResources struct {
	CellReference *CellReference `json:"cell_reference,omitempty"`
	// The rack location
	Location *string `json:"location,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RackResources RackResources
...
// GetCellReference returns the CellReference field value if set, zero value otherwise.
func (o *RackResources) GetCellReference() CellReference {
	if o == nil || IsNil(o.CellReference) {
		var ret CellReference
		return ret
	}
	return *o.CellReference
}

// GetCellReferenceOk returns a tuple with the CellReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RackResources) GetCellReferenceOk() (*CellReference, bool) {
	if o == nil || IsNil(o.CellReference) {
		return nil, false
	}
	return o.CellReference, true
}
...
// SetCellReference gets a reference to the given CellReference and assigns it to the CellReference field.
...
func (o RackResources) MarshalJSON() ([]byte, error) {
...
func (o RackResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CellReference) {
		toSerialize["cell_reference"] = o.CellReference
	}
	if !IsNil(o.Location) {
...
func (o *RackResources) UnmarshalJSON(data []byte) (err error) {
	varRackResources := _RackResources{}

	err = json.Unmarshal(data, &varRackResources)

	if err != nil {
		return err
	}

	*o = RackResources(varRackResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "cell_reference")
...
type NullableRackResources struct {
	value *RackResources
	isSet bool
}

func (v NullableRackResources) Get() *RackResources {
	return v.value
}

func (v *NullableRackResources) Set(val *RackResources) {
	v.value = val
	v.isSet = true
}

func (v NullableRackResources) IsSet() bool {
	return v.isSet
}

func (v *NullableRackResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackResources(val *RackResources) *NullableRackResources {
	return &NullableRackResources{value: val, isSet: true}
}

func (v NullableRackResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
