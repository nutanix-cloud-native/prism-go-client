...
// checks if the UserGroupListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupListIntentResponse{}

// UserGroupListIntentResponse Response object for intentful operation of user_groups
type UserGroupListIntentResponse struct {
	Entities []UserGroupIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata UserGroupListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _UserGroupListIntentResponse UserGroupListIntentResponse
...
func NewUserGroupListIntentResponse(apiVersion string, metadata UserGroupListMetadataOutput) *UserGroupListIntentResponse {
	this := UserGroupListIntentResponse{}
...
func (o *UserGroupListIntentResponse) GetEntities() []UserGroupIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []UserGroupIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []UserGroupIntentResource and assigns it to the Entities field.
...
func (o *UserGroupListIntentResponse) GetMetadata() UserGroupListMetadataOutput {
	if o == nil {
		var ret UserGroupListMetadataOutput
		return ret
	}
...
func (o UserGroupListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o UserGroupListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *UserGroupListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUserGroupListIntentResponse := _UserGroupListIntentResponse{}

	err = json.Unmarshal(data, &varUserGroupListIntentResponse)

	if err != nil {
		return err
	}

	*o = UserGroupListIntentResponse(varUserGroupListIntentResponse)
...
type NullableUserGroupListIntentResponse struct {
	value *UserGroupListIntentResponse
	isSet bool
}

func (v NullableUserGroupListIntentResponse) Get() *UserGroupListIntentResponse {
	return v.value
}

func (v *NullableUserGroupListIntentResponse) Set(val *UserGroupListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupListIntentResponse(val *UserGroupListIntentResponse) *NullableUserGroupListIntentResponse {
	return &NullableUserGroupListIntentResponse{value: val, isSet: true}
}

func (v NullableUserGroupListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
