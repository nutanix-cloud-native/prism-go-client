...
// checks if the VmMetadataOverride type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmMetadataOverride{}

// VmMetadataOverride Allowed vm metadata overrides.
type VmMetadataOverride struct {
	// Categories for the vm. This allows setting up multiple values from a single key. 
...
type _VmMetadataOverride VmMetadataOverride
...
func (o VmMetadataOverride) MarshalJSON() ([]byte, error) {
...
func (o VmMetadataOverride) ToMap() (map[string]interface{}, error) {
...
func (o *VmMetadataOverride) UnmarshalJSON(data []byte) (err error) {
	varVmMetadataOverride := _VmMetadataOverride{}

	err = json.Unmarshal(data, &varVmMetadataOverride)

	if err != nil {
		return err
	}

	*o = VmMetadataOverride(varVmMetadataOverride)
...
type NullableVmMetadataOverride struct {
	value *VmMetadataOverride
	isSet bool
}

func (v NullableVmMetadataOverride) Get() *VmMetadataOverride {
	return v.value
}

func (v *NullableVmMetadataOverride) Set(val *VmMetadataOverride) {
	v.value = val
	v.isSet = true
}

func (v NullableVmMetadataOverride) IsSet() bool {
	return v.isSet
}

func (v *NullableVmMetadataOverride) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmMetadataOverride(val *VmMetadataOverride) *NullableVmMetadataOverride {
	return &NullableVmMetadataOverride{value: val, isSet: true}
}

func (v NullableVmMetadataOverride) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmMetadataOverride) UnmarshalJSON(src []byte) error {
	v.isSet = true
