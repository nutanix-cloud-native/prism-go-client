...
// checks if the VpcRouteTableDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcRouteTableDefStatus{}

// VpcRouteTableDefStatus An intentful representation of a vpc_route_table status
type VpcRouteTableDefStatus struct {
	...
	// Any error messages for the vpc_route_table, if in an error state.
	...
	Resources VpcRouteTableResourcesDefStatus `json:"resources"`
	// A description for vpc_route_table.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VpcRouteTableDefStatus VpcRouteTableDefStatus
...
func (o *VpcRouteTableDefStatus) GetResources() VpcRouteTableResourcesDefStatus {
	if o == nil {
		var ret VpcRouteTableResourcesDefStatus
		return ret
	}
...
func (o VpcRouteTableDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VpcRouteTableDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VpcRouteTableDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varVpcRouteTableDefStatus := _VpcRouteTableDefStatus{}

	err = json.Unmarshal(data, &varVpcRouteTableDefStatus)

	if err != nil {
		return err
	}

	*o = VpcRouteTableDefStatus(varVpcRouteTableDefStatus)
...
type NullableVpcRouteTableDefStatus struct {
	value *VpcRouteTableDefStatus
	isSet bool
}

func (v NullableVpcRouteTableDefStatus) Get() *VpcRouteTableDefStatus {
	return v.value
}

func (v *NullableVpcRouteTableDefStatus) Set(val *VpcRouteTableDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcRouteTableDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcRouteTableDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcRouteTableDefStatus(val *VpcRouteTableDefStatus) *NullableVpcRouteTableDefStatus {
	return &NullableVpcRouteTableDefStatus{value: val, isSet: true}
}

func (v NullableVpcRouteTableDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcRouteTableDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
