...
// checks if the VirtualNetworkResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkResourcesDefStatus{}

// VirtualNetworkResourcesDefStatus Virtual network resources status
type VirtualNetworkResourcesDefStatus struct {
	...
	ExternalSubnetList []ExternalSubnetDefStatus `json:"external_subnet_list,omitempty"`
	...
	NatIpList []string `json:"nat_ip_list,omitempty"`
...
type _VirtualNetworkResourcesDefStatus VirtualNetworkResourcesDefStatus
...
func NewVirtualNetworkResourcesDefStatus() *VirtualNetworkResourcesDefStatus {
	this := VirtualNetworkResourcesDefStatus{}
	return &this
}
...
// GetCommonDomainNameServerIpList returns the CommonDomainNameServerIpList field value if set, zero value otherwise.
func (o *VirtualNetworkResourcesDefStatus) GetCommonDomainNameServerIpList() []Address {
	if o == nil || IsNil(o.CommonDomainNameServerIpList) {
		var ret []Address
		return ret
	}
	return o.CommonDomainNameServerIpList
}

// GetCommonDomainNameServerIpListOk returns a tuple with the CommonDomainNameServerIpList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VirtualNetworkResourcesDefStatus) GetCommonDomainNameServerIpListOk() ([]Address, bool) {
	if o == nil || IsNil(o.CommonDomainNameServerIpList) {
		return nil, false
	}
	return o.CommonDomainNameServerIpList, true
}
...
// SetCommonDomainNameServerIpList gets a reference to the given []Address and assigns it to the CommonDomainNameServerIpList field.
func (o *VirtualNetworkResourcesDefStatus) SetCommonDomainNameServerIpList(v []Address) {
	o.CommonDomainNameServerIpList = v
}

// GetExternalSubnetList returns the ExternalSubnetList field value if set, zero value otherwise.
func (o *VirtualNetworkResourcesDefStatus) GetExternalSubnetList() []ExternalSubnetDefStatus {
	if o == nil || IsNil(o.ExternalSubnetList) {
		var ret []ExternalSubnetDefStatus
		return ret
	}
	return o.ExternalSubnetList
}

// GetExternalSubnetListOk returns a tuple with the ExternalSubnetList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VirtualNetworkResourcesDefStatus) GetExternalSubnetListOk() ([]ExternalSubnetDefStatus, bool) {
	if o == nil || IsNil(o.ExternalSubnetList) {
		return nil, false
	}
	return o.ExternalSubnetList, true
}
...
// SetExternalSubnetList gets a reference to the given []ExternalSubnetDefStatus and assigns it to the ExternalSubnetList field.
func (o *VirtualNetworkResourcesDefStatus) SetExternalSubnetList(v []ExternalSubnetDefStatus) {
	o.ExternalSubnetList = v
}
...
// GetNatIpList returns the NatIpList field value if set, zero value otherwise.
func (o *VirtualNetworkResourcesDefStatus) GetNatIpList() []string {
	if o == nil || IsNil(o.NatIpList) {
		var ret []string
		return ret
	}
	return o.NatIpList
...
// GetNatIpListOk returns a tuple with the NatIpList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VirtualNetworkResourcesDefStatus) GetNatIpListOk() ([]string, bool) {
	if o == nil || IsNil(o.NatIpList) {
		return nil, false
	}
	return o.NatIpList, true
}
...
// SetNatIpList gets a reference to the given []string and assigns it to the NatIpList field.
...
// GetExternallyRoutablePrefixList returns the ExternallyRoutablePrefixList field value if set, zero value otherwise.
func (o *VirtualNetworkResourcesDefStatus) GetExternallyRoutablePrefixList() []IpSubnet {
	if o == nil || IsNil(o.ExternallyRoutablePrefixList) {
		var ret []IpSubnet
		return ret
	}
	return o.ExternallyRoutablePrefixList
}

// GetExternallyRoutablePrefixListOk returns a tuple with the ExternallyRoutablePrefixList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VirtualNetworkResourcesDefStatus) GetExternallyRoutablePrefixListOk() ([]IpSubnet, bool) {
	if o == nil || IsNil(o.ExternallyRoutablePrefixList) {
		return nil, false
	}
	return o.ExternallyRoutablePrefixList, true
}
...
// SetExternallyRoutablePrefixList gets a reference to the given []IpSubnet and assigns it to the ExternallyRoutablePrefixList field.
func (o *VirtualNetworkResourcesDefStatus) SetExternallyRoutablePrefixList(v []IpSubnet) {
	o.ExternallyRoutablePrefixList = v
}

func (o VirtualNetworkResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CommonDomainNameServerIpList) {
		toSerialize["common_domain_name_server_ip_list"] = o.CommonDomainNameServerIpList
	}
	if !IsNil(o.ExternalSubnetList) {
		toSerialize["external_subnet_list"] = o.ExternalSubnetList
	}
	if !IsNil(o.VpnConfig) {
		toSerialize["vpn_config"] = o.VpnConfig
	}
	if !IsNil(o.NatIpList) {
		toSerialize["nat_ip_list"] = o.NatIpList
	}
	if !IsNil(o.AvailabilityZoneReferenceList) {
		toSerialize["availability_zone_reference_list"] = o.AvailabilityZoneReferenceList
	}
	if !IsNil(o.VpcType) {
		toSerialize["vpc_type"] = o.VpcType
	}
	if !IsNil(o.ExternallyRoutablePrefixList) {
		toSerialize["externally_routable_prefix_list"] = o.ExternallyRoutablePrefixList
	}
...
func (o *VirtualNetworkResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varVirtualNetworkResourcesDefStatus := _VirtualNetworkResourcesDefStatus{}

	err = json.Unmarshal(data, &varVirtualNetworkResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = VirtualNetworkResourcesDefStatus(varVirtualNetworkResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "common_domain_name_server_ip_list")
		delete(additionalProperties, "external_subnet_list")
		delete(additionalProperties, "vpn_config")
		delete(additionalProperties, "nat_ip_list")
		delete(additionalProperties, "availability_zone_reference_list")
		delete(additionalProperties, "vpc_type")
		delete(additionalProperties, "externally_routable_prefix_list")
...
type NullableVirtualNetworkResourcesDefStatus struct {
	value *VirtualNetworkResourcesDefStatus
	isSet bool
}

func (v NullableVirtualNetworkResourcesDefStatus) Get() *VirtualNetworkResourcesDefStatus {
	return v.value
}

func (v *NullableVirtualNetworkResourcesDefStatus) Set(val *VirtualNetworkResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkResourcesDefStatus(val *VirtualNetworkResourcesDefStatus) *NullableVirtualNetworkResourcesDefStatus {
	return &NullableVirtualNetworkResourcesDefStatus{value: val, isSet: true}
}

func (v NullableVirtualNetworkResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
