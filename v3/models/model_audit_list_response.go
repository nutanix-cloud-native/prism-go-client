...
// checks if the AuditListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditListResponse{}

// AuditListResponse Response object for audit list operations
type AuditListResponse struct {
	Entities []AuditResponse `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata *AuditListMetadataOutput `json:"metadata,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AuditListResponse AuditListResponse
...
// SetEntities gets a reference to the given []AuditResponse and assigns it to the Entities field.
...
func (o *AuditListResponse) GetMetadata() AuditListMetadataOutput {
	if o == nil || IsNil(o.Metadata) {
		var ret AuditListMetadataOutput
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given AuditListMetadataOutput and assigns it to the Metadata field.
func (o *AuditListResponse) SetMetadata(v AuditListMetadataOutput) {
	o.Metadata = &v
}

func (o AuditListResponse) MarshalJSON() ([]byte, error) {
...
func (o AuditListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AuditListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditListResponse := _AuditListResponse{}

	err = json.Unmarshal(data, &varAuditListResponse)

	if err != nil {
		return err
	}

	*o = AuditListResponse(varAuditListResponse)
...
type NullableAuditListResponse struct {
	value *AuditListResponse
	isSet bool
}

func (v NullableAuditListResponse) Get() *AuditListResponse {
	return v.value
}

func (v *NullableAuditListResponse) Set(val *AuditListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditListResponse(val *AuditListResponse) *NullableAuditListResponse {
	return &NullableAuditListResponse{value: val, isSet: true}
}

func (v NullableAuditListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
