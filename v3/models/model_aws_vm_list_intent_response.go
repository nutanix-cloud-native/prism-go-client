...
// checks if the AwsVmListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVmListIntentResponse{}

// AwsVmListIntentResponse Response object for intentful operation of aws_vms
type AwsVmListIntentResponse struct {
	Entities []AwsVmIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsVmListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsVmListIntentResponse AwsVmListIntentResponse
...
// SetEntities gets a reference to the given []AwsVmIntentResource and assigns it to the Entities field.
...
func (o *AwsVmListIntentResponse) GetMetadata() AwsVmListMetadataOutput {
	if o == nil {
		var ret AwsVmListMetadataOutput
		return ret
	}
...
func (o AwsVmListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsVmListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVmListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVmListIntentResponse := _AwsVmListIntentResponse{}

	err = json.Unmarshal(data, &varAwsVmListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsVmListIntentResponse(varAwsVmListIntentResponse)
...
type NullableAwsVmListIntentResponse struct {
	value *AwsVmListIntentResponse
	isSet bool
}

func (v NullableAwsVmListIntentResponse) Get() *AwsVmListIntentResponse {
	return v.value
}

func (v *NullableAwsVmListIntentResponse) Set(val *AwsVmListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVmListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVmListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVmListIntentResponse(val *AwsVmListIntentResponse) *NullableAwsVmListIntentResponse {
	return &NullableAwsVmListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsVmListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVmListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
