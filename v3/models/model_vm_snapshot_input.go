...
// checks if the VmSnapshotInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmSnapshotInput{}
...
type _VmSnapshotInput VmSnapshotInput
...
func (o VmSnapshotInput) MarshalJSON() ([]byte, error) {
...
func (o VmSnapshotInput) ToMap() (map[string]interface{}, error) {
...
func (o *VmSnapshotInput) UnmarshalJSON(data []byte) (err error) {
	varVmSnapshotInput := _VmSnapshotInput{}

	err = json.Unmarshal(data, &varVmSnapshotInput)

	if err != nil {
		return err
	}

	*o = VmSnapshotInput(varVmSnapshotInput)
...
type NullableVmSnapshotInput struct {
	value *VmSnapshotInput
	isSet bool
}

func (v NullableVmSnapshotInput) Get() *VmSnapshotInput {
	return v.value
}

func (v *NullableVmSnapshotInput) Set(val *VmSnapshotInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmSnapshotInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmSnapshotInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmSnapshotInput(val *VmSnapshotInput) *NullableVmSnapshotInput {
	return &NullableVmSnapshotInput{value: val, isSet: true}
}

func (v NullableVmSnapshotInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmSnapshotInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
