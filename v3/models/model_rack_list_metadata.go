...
// checks if the RackListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackListMetadata{}

// RackListMetadata All api calls that return a list will have this metadata block as input 
type RackListMetadata struct {
	// The kind name
...
type _RackListMetadata RackListMetadata
...
func (o RackListMetadata) MarshalJSON() ([]byte, error) {
...
func (o RackListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RackListMetadata) UnmarshalJSON(data []byte) (err error) {
	varRackListMetadata := _RackListMetadata{}

	err = json.Unmarshal(data, &varRackListMetadata)

	if err != nil {
		return err
	}

	*o = RackListMetadata(varRackListMetadata)
...
type NullableRackListMetadata struct {
	value *RackListMetadata
	isSet bool
}

func (v NullableRackListMetadata) Get() *RackListMetadata {
	return v.value
}

func (v *NullableRackListMetadata) Set(val *RackListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRackListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRackListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackListMetadata(val *RackListMetadata) *NullableRackListMetadata {
	return &NullableRackListMetadata{value: val, isSet: true}
}

func (v NullableRackListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
