...
// checks if the VpcMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcMetadata{}

// VpcMetadata The vpc kind metadata
type VpcMetadata struct {
	// UTC date and time in RFC-3339 format when vpc was last updated 
	...
	// UTC date and time in RFC-3339 format when vpc was created 
	...
	// Categories for the vpc. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the vpc. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
func (o *VpcMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *VpcMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *VpcMetadata) SetName(v string) {
	o.Name = &v
}

func (o VpcMetadata) MarshalJSON() ([]byte, error) {
...
func (o VpcMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VpcMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVpcMetadata := _VpcMetadata{}

	err = json.Unmarshal(data, &varVpcMetadata)

	if err != nil {
		return err
	}

	*o = VpcMetadata(varVpcMetadata)
...
type NullableVpcMetadata struct {
	value *VpcMetadata
	isSet bool
}

func (v NullableVpcMetadata) Get() *VpcMetadata {
	return v.value
}

func (v *NullableVpcMetadata) Set(val *VpcMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcMetadata(val *VpcMetadata) *NullableVpcMetadata {
	return &NullableVpcMetadata{value: val, isSet: true}
}

func (v NullableVpcMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
