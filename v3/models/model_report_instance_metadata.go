...
// checks if the ReportInstanceMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstanceMetadata{}

// ReportInstanceMetadata The report_instance kind metadata
type ReportInstanceMetadata struct {
	...
	// Categories for the report_instance. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the report_instance. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// report_instance name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ReportInstanceMetadata ReportInstanceMetadata
...
func (o *ReportInstanceMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *ReportInstanceMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *ReportInstanceMetadata) SetName(v string) {
	o.Name = &v
}

func (o ReportInstanceMetadata) MarshalJSON() ([]byte, error) {
...
func (o ReportInstanceMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ReportInstanceMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varReportInstanceMetadata := _ReportInstanceMetadata{}

	err = json.Unmarshal(data, &varReportInstanceMetadata)

	if err != nil {
		return err
	}

	*o = ReportInstanceMetadata(varReportInstanceMetadata)
...
type NullableReportInstanceMetadata struct {
	value *ReportInstanceMetadata
	isSet bool
}

func (v NullableReportInstanceMetadata) Get() *ReportInstanceMetadata {
	return v.value
}

func (v *NullableReportInstanceMetadata) Set(val *ReportInstanceMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstanceMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstanceMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstanceMetadata(val *ReportInstanceMetadata) *NullableReportInstanceMetadata {
	return &NullableReportInstanceMetadata{value: val, isSet: true}
}

func (v NullableReportInstanceMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstanceMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
