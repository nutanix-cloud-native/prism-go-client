...
// checks if the BlueprintPendingLaunchesListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintPendingLaunchesListResponse{}

// BlueprintPendingLaunchesListResponse Response containing all the bp launch requests which have not completed
type BlueprintPendingLaunchesListResponse struct {
	Entites []BlueprintPendingLaunchesResource `json:"entites,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata BlueprintListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _BlueprintPendingLaunchesListResponse BlueprintPendingLaunchesListResponse
...
func NewBlueprintPendingLaunchesListResponse(apiVersion string, metadata BlueprintListMetadataOutput) *BlueprintPendingLaunchesListResponse {
	this := BlueprintPendingLaunchesListResponse{}
...
// GetEntites returns the Entites field value if set, zero value otherwise.
func (o *BlueprintPendingLaunchesListResponse) GetEntites() []BlueprintPendingLaunchesResource {
	if o == nil || IsNil(o.Entites) {
		var ret []BlueprintPendingLaunchesResource
		return ret
	}
	return o.Entites
}

// GetEntitesOk returns a tuple with the Entites field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintPendingLaunchesListResponse) GetEntitesOk() ([]BlueprintPendingLaunchesResource, bool) {
	if o == nil || IsNil(o.Entites) {
		return nil, false
	}
	return o.Entites, true
}
...
// SetEntites gets a reference to the given []BlueprintPendingLaunchesResource and assigns it to the Entites field.
...
func (o *BlueprintPendingLaunchesListResponse) GetMetadata() BlueprintListMetadataOutput {
	if o == nil {
		var ret BlueprintListMetadataOutput
		return ret
	}
...
func (o BlueprintPendingLaunchesListResponse) MarshalJSON() ([]byte, error) {
...
func (o BlueprintPendingLaunchesListResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Entites) {
		toSerialize["entites"] = o.Entites
	}
...
func (o *BlueprintPendingLaunchesListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintPendingLaunchesListResponse := _BlueprintPendingLaunchesListResponse{}

	err = json.Unmarshal(data, &varBlueprintPendingLaunchesListResponse)

	if err != nil {
		return err
	}

	*o = BlueprintPendingLaunchesListResponse(varBlueprintPendingLaunchesListResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "entites")
...
type NullableBlueprintPendingLaunchesListResponse struct {
	value *BlueprintPendingLaunchesListResponse
	isSet bool
}

func (v NullableBlueprintPendingLaunchesListResponse) Get() *BlueprintPendingLaunchesListResponse {
	return v.value
}

func (v *NullableBlueprintPendingLaunchesListResponse) Set(val *BlueprintPendingLaunchesListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintPendingLaunchesListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintPendingLaunchesListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintPendingLaunchesListResponse(val *BlueprintPendingLaunchesListResponse) *NullableBlueprintPendingLaunchesListResponse {
	return &NullableBlueprintPendingLaunchesListResponse{value: val, isSet: true}
}

func (v NullableBlueprintPendingLaunchesListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintPendingLaunchesListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
