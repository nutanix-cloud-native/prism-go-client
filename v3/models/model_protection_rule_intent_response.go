...
// checks if the ProtectionRuleIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleIntentResponse{}

// ProtectionRuleIntentResponse Response object for intentful operations on a protection_rule
type ProtectionRuleIntentResponse struct {
	Status *ProtectionRuleDefStatus `json:"status,omitempty"`
	Spec *ProtectionRule `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ProtectionRuleMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ProtectionRuleIntentResponse ProtectionRuleIntentResponse
...
func NewProtectionRuleIntentResponse(apiVersion string, metadata ProtectionRuleMetadata) *ProtectionRuleIntentResponse {
	this := ProtectionRuleIntentResponse{}
...
func (o *ProtectionRuleIntentResponse) GetStatus() ProtectionRuleDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret ProtectionRuleDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ProtectionRuleDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given ProtectionRule and assigns it to the Spec field.
...
func (o *ProtectionRuleIntentResponse) GetMetadata() ProtectionRuleMetadata {
	if o == nil {
		var ret ProtectionRuleMetadata
		return ret
	}
...
func (o ProtectionRuleIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionRuleIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varProtectionRuleIntentResponse := _ProtectionRuleIntentResponse{}

	err = json.Unmarshal(data, &varProtectionRuleIntentResponse)

	if err != nil {
		return err
	}

	*o = ProtectionRuleIntentResponse(varProtectionRuleIntentResponse)
...
type NullableProtectionRuleIntentResponse struct {
	value *ProtectionRuleIntentResponse
	isSet bool
}

func (v NullableProtectionRuleIntentResponse) Get() *ProtectionRuleIntentResponse {
	return v.value
}

func (v *NullableProtectionRuleIntentResponse) Set(val *ProtectionRuleIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleIntentResponse(val *ProtectionRuleIntentResponse) *NullableProtectionRuleIntentResponse {
	return &NullableProtectionRuleIntentResponse{value: val, isSet: true}
}

func (v NullableProtectionRuleIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
