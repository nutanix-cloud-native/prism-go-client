...
// checks if the AccessControlPolicyIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyIntentResponse{}

// AccessControlPolicyIntentResponse Response object for intentful operations on a access_control_policy
type AccessControlPolicyIntentResponse struct {
...
type _AccessControlPolicyIntentResponse AccessControlPolicyIntentResponse
...
func NewAccessControlPolicyIntentResponse(apiVersion string, metadata AccessControlPolicyMetadata) *AccessControlPolicyIntentResponse {
	this := AccessControlPolicyIntentResponse{}
...
func (o AccessControlPolicyIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AccessControlPolicyIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessControlPolicyIntentResponse := _AccessControlPolicyIntentResponse{}

	err = json.Unmarshal(data, &varAccessControlPolicyIntentResponse)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyIntentResponse(varAccessControlPolicyIntentResponse)
...
type NullableAccessControlPolicyIntentResponse struct {
	value *AccessControlPolicyIntentResponse
	isSet bool
}

func (v NullableAccessControlPolicyIntentResponse) Get() *AccessControlPolicyIntentResponse {
	return v.value
}

func (v *NullableAccessControlPolicyIntentResponse) Set(val *AccessControlPolicyIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyIntentResponse(val *AccessControlPolicyIntentResponse) *NullableAccessControlPolicyIntentResponse {
	return &NullableAccessControlPolicyIntentResponse{value: val, isSet: true}
}

func (v NullableAccessControlPolicyIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
