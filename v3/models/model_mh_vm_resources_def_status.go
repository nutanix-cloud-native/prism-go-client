...
// checks if the MhVmResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmResourcesDefStatus{}

// MhVmResourcesDefStatus VM Resources Status Definition.
type MhVmResourcesDefStatus struct {
	// The hypervisor specific ID of the VM. 
	HypervisorSpecificId *string `json:"hypervisor_specific_id,omitempty"`
	...
	StorageConfig *MhVmStorageConfigStatus `json:"storage_config,omitempty"`
...
type _MhVmResourcesDefStatus MhVmResourcesDefStatus
...
// GetHypervisorSpecificId returns the HypervisorSpecificId field value if set, zero value otherwise.
func (o *MhVmResourcesDefStatus) GetHypervisorSpecificId() string {
	if o == nil || IsNil(o.HypervisorSpecificId) {
		var ret string
		return ret
	}
	return *o.HypervisorSpecificId
}

// GetHypervisorSpecificIdOk returns a tuple with the HypervisorSpecificId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MhVmResourcesDefStatus) GetHypervisorSpecificIdOk() (*string, bool) {
	if o == nil || IsNil(o.HypervisorSpecificId) {
		return nil, false
	}
	return o.HypervisorSpecificId, true
}
...
// SetHypervisorSpecificId gets a reference to the given string and assigns it to the HypervisorSpecificId field.
func (o *MhVmResourcesDefStatus) SetHypervisorSpecificId(v string) {
	o.HypervisorSpecificId = &v
}
...
func (o *MhVmResourcesDefStatus) GetStorageConfig() MhVmStorageConfigStatus {
	if o == nil || IsNil(o.StorageConfig) {
		var ret MhVmStorageConfigStatus
		return ret
	}
...
// SetStorageConfig gets a reference to the given MhVmStorageConfigStatus and assigns it to the StorageConfig field.
...
func (o MhVmResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o MhVmResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.HypervisorSpecificId) {
		toSerialize["hypervisor_specific_id"] = o.HypervisorSpecificId
	}
...
func (o *MhVmResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varMhVmResourcesDefStatus := _MhVmResourcesDefStatus{}

	err = json.Unmarshal(data, &varMhVmResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = MhVmResourcesDefStatus(varMhVmResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "hypervisor_specific_id")
...
type NullableMhVmResourcesDefStatus struct {
	value *MhVmResourcesDefStatus
	isSet bool
}

func (v NullableMhVmResourcesDefStatus) Get() *MhVmResourcesDefStatus {
	return v.value
}

func (v *NullableMhVmResourcesDefStatus) Set(val *MhVmResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmResourcesDefStatus(val *MhVmResourcesDefStatus) *NullableMhVmResourcesDefStatus {
	return &NullableMhVmResourcesDefStatus{value: val, isSet: true}
}

func (v NullableMhVmResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
