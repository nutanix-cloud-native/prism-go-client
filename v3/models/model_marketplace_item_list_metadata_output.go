...
// checks if the MarketplaceItemListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemListMetadataOutput{}

// MarketplaceItemListMetadataOutput All api calls that return a list will have this metadata block 
type MarketplaceItemListMetadataOutput struct {
	// The kind name
...
type _MarketplaceItemListMetadataOutput MarketplaceItemListMetadataOutput
...
func NewMarketplaceItemListMetadataOutput() *MarketplaceItemListMetadataOutput {
	this := MarketplaceItemListMetadataOutput{}
	var kind string = "marketplace_item"
	this.Kind = &kind
	return &this
}
...
func (o MarketplaceItemListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItemListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varMarketplaceItemListMetadataOutput := _MarketplaceItemListMetadataOutput{}

	err = json.Unmarshal(data, &varMarketplaceItemListMetadataOutput)

	if err != nil {
		return err
	}

	*o = MarketplaceItemListMetadataOutput(varMarketplaceItemListMetadataOutput)
...
type NullableMarketplaceItemListMetadataOutput struct {
	value *MarketplaceItemListMetadataOutput
	isSet bool
}

func (v NullableMarketplaceItemListMetadataOutput) Get() *MarketplaceItemListMetadataOutput {
	return v.value
}

func (v *NullableMarketplaceItemListMetadataOutput) Set(val *MarketplaceItemListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemListMetadataOutput(val *MarketplaceItemListMetadataOutput) *NullableMarketplaceItemListMetadataOutput {
	return &NullableMarketplaceItemListMetadataOutput{value: val, isSet: true}
}

func (v NullableMarketplaceItemListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
