...
// checks if the CustomizationSpecStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomizationSpecStatus{}

// CustomizationSpecStatus The status of a REST API call. Only used when there is a failure to report. 
type CustomizationSpecStatus struct {
	// The kind name
...
type _CustomizationSpecStatus CustomizationSpecStatus
...
func (o CustomizationSpecStatus) MarshalJSON() ([]byte, error) {
...
func (o CustomizationSpecStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CustomizationSpecStatus) UnmarshalJSON(data []byte) (err error) {
	varCustomizationSpecStatus := _CustomizationSpecStatus{}

	err = json.Unmarshal(data, &varCustomizationSpecStatus)

	if err != nil {
		return err
	}

	*o = CustomizationSpecStatus(varCustomizationSpecStatus)
...
type NullableCustomizationSpecStatus struct {
	value *CustomizationSpecStatus
	isSet bool
}

func (v NullableCustomizationSpecStatus) Get() *CustomizationSpecStatus {
	return v.value
}

func (v *NullableCustomizationSpecStatus) Set(val *CustomizationSpecStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomizationSpecStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomizationSpecStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomizationSpecStatus(val *CustomizationSpecStatus) *NullableCustomizationSpecStatus {
	return &NullableCustomizationSpecStatus{value: val, isSet: true}
}

func (v NullableCustomizationSpecStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomizationSpecStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
