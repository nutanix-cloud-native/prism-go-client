...
// checks if the OauthClientMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthClientMetadata{}

// OauthClientMetadata The oauth_client kind metadata
type OauthClientMetadata struct {
	...
	// Categories for the oauth_client. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the oauth_client. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _OauthClientMetadata OauthClientMetadata
...
func (o OauthClientMetadata) MarshalJSON() ([]byte, error) {
...
func (o OauthClientMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *OauthClientMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varOauthClientMetadata := _OauthClientMetadata{}

	err = json.Unmarshal(data, &varOauthClientMetadata)

	if err != nil {
		return err
	}

	*o = OauthClientMetadata(varOauthClientMetadata)
...
type NullableOauthClientMetadata struct {
	value *OauthClientMetadata
	isSet bool
}

func (v NullableOauthClientMetadata) Get() *OauthClientMetadata {
	return v.value
}

func (v *NullableOauthClientMetadata) Set(val *OauthClientMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthClientMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthClientMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthClientMetadata(val *OauthClientMetadata) *NullableOauthClientMetadata {
	return &NullableOauthClientMetadata{value: val, isSet: true}
}

func (v NullableOauthClientMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthClientMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
