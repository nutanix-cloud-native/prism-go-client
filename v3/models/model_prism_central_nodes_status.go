...
// checks if the PrismCentralNodesStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralNodesStatus{}

// PrismCentralNodesStatus The status of a REST API call. Only used when there is a failure to report. 
type PrismCentralNodesStatus struct {
	// The kind name
...
type _PrismCentralNodesStatus PrismCentralNodesStatus
...
func (o PrismCentralNodesStatus) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralNodesStatus) ToMap() (map[string]interface{}, error) {
...
func (o *PrismCentralNodesStatus) UnmarshalJSON(data []byte) (err error) {
	varPrismCentralNodesStatus := _PrismCentralNodesStatus{}

	err = json.Unmarshal(data, &varPrismCentralNodesStatus)

	if err != nil {
		return err
	}

	*o = PrismCentralNodesStatus(varPrismCentralNodesStatus)
...
type NullablePrismCentralNodesStatus struct {
	value *PrismCentralNodesStatus
	isSet bool
}

func (v NullablePrismCentralNodesStatus) Get() *PrismCentralNodesStatus {
	return v.value
}

func (v *NullablePrismCentralNodesStatus) Set(val *PrismCentralNodesStatus) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralNodesStatus) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralNodesStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralNodesStatus(val *PrismCentralNodesStatus) *NullablePrismCentralNodesStatus {
	return &NullablePrismCentralNodesStatus{value: val, isSet: true}
}

func (v NullablePrismCentralNodesStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralNodesStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
