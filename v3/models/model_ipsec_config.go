...
// checks if the IpsecConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpsecConfig{}

// IpsecConfig IPSEC related configuration spec for the VPN connections.
...
func (o IpsecConfig) MarshalJSON() ([]byte, error) {
...
func (o IpsecConfig) ToMap() (map[string]interface{}, error) {
...
func (o *IpsecConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varIpsecConfig := _IpsecConfig{}

	err = json.Unmarshal(data, &varIpsecConfig)

	if err != nil {
		return err
	}

	*o = IpsecConfig(varIpsecConfig)
...
type NullableIpsecConfig struct {
	value *IpsecConfig
	isSet bool
}

func (v NullableIpsecConfig) Get() *IpsecConfig {
	return v.value
}

func (v *NullableIpsecConfig) Set(val *IpsecConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableIpsecConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableIpsecConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpsecConfig(val *IpsecConfig) *NullableIpsecConfig {
	return &NullableIpsecConfig{value: val, isSet: true}
}

func (v NullableIpsecConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpsecConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
