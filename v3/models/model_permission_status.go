...
// checks if the PermissionStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionStatus{}

// PermissionStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _PermissionStatus PermissionStatus
...
func (o PermissionStatus) MarshalJSON() ([]byte, error) {
...
func (o PermissionStatus) ToMap() (map[string]interface{}, error) {
...
func (o *PermissionStatus) UnmarshalJSON(data []byte) (err error) {
	varPermissionStatus := _PermissionStatus{}

	err = json.Unmarshal(data, &varPermissionStatus)

	if err != nil {
		return err
	}

	*o = PermissionStatus(varPermissionStatus)
...
type NullablePermissionStatus struct {
	value *PermissionStatus
	isSet bool
}

func (v NullablePermissionStatus) Get() *PermissionStatus {
	return v.value
}

func (v *NullablePermissionStatus) Set(val *PermissionStatus) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionStatus) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionStatus(val *PermissionStatus) *NullablePermissionStatus {
	return &NullablePermissionStatus{value: val, isSet: true}
}

func (v NullablePermissionStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
