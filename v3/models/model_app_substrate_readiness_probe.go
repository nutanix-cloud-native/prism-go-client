...
// checks if the AppSubstrateReadinessProbe type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSubstrateReadinessProbe{}

// AppSubstrateReadinessProbe Readiness probe for substrate
type AppSubstrateReadinessProbe struct {
	// 
	...
	LoginCredentialLocalReference *AppCredentialReference `json:"login_credential_local_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AppSubstrateReadinessProbe AppSubstrateReadinessProbe
...
func NewAppSubstrateReadinessProbe() *AppSubstrateReadinessProbe {
	this := AppSubstrateReadinessProbe{}
...
// SetLoginCredentialLocalReference gets a reference to the given AppCredentialReference and assigns it to the LoginCredentialLocalReference field.
...
func (o AppSubstrateReadinessProbe) MarshalJSON() ([]byte, error) {
...
func (o AppSubstrateReadinessProbe) ToMap() (map[string]interface{}, error) {
...
func (o *AppSubstrateReadinessProbe) UnmarshalJSON(data []byte) (err error) {
	varAppSubstrateReadinessProbe := _AppSubstrateReadinessProbe{}

	err = json.Unmarshal(data, &varAppSubstrateReadinessProbe)

	if err != nil {
		return err
	}

	*o = AppSubstrateReadinessProbe(varAppSubstrateReadinessProbe)
...
type NullableAppSubstrateReadinessProbe struct {
	value *AppSubstrateReadinessProbe
	isSet bool
}

func (v NullableAppSubstrateReadinessProbe) Get() *AppSubstrateReadinessProbe {
	return v.value
}

func (v *NullableAppSubstrateReadinessProbe) Set(val *AppSubstrateReadinessProbe) {
	v.value = val
	v.isSet = true
}

func (v NullableAppSubstrateReadinessProbe) IsSet() bool {
	return v.isSet
}

func (v *NullableAppSubstrateReadinessProbe) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppSubstrateReadinessProbe(val *AppSubstrateReadinessProbe) *NullableAppSubstrateReadinessProbe {
	return &NullableAppSubstrateReadinessProbe{value: val, isSet: true}
}

func (v NullableAppSubstrateReadinessProbe) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppSubstrateReadinessProbe) UnmarshalJSON(src []byte) error {
	v.isSet = true
