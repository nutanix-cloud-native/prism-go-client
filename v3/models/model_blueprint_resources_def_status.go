...
// checks if the BlueprintResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintResourcesDefStatus{}

// BlueprintResourcesDefStatus Status of the Blueprint.
type BlueprintResourcesDefStatus struct {
	// Data needed for clients.
	ClientAttrs map[string]interface{} `json:"client_attrs,omitempty"`
	// Service definitions for Blueprint.
	ServiceDefinitionList []AppServiceResponse `json:"service_definition_list,omitempty"`
	// Substrate definitions for Blueprint.
	SubstrateDefinitionList []AppSubstrateResponse `json:"substrate_definition_list,omitempty"`
	// Credential definitions for Blueprint.
	CredentialDefinitionList []AppCredentialResponse `json:"credential_definition_list,omitempty"`
	// Package definitions for Blueprint.
	PackageDefinitionList []AppPackageResponse `json:"package_definition_list,omitempty"`
	// App profile definitions for Blueprint.
	AppProfileList []AppProfileResponse `json:"app_profile_list,omitempty"`
	// Published service definitions for Blueprint.
	PublishedServiceDefinitionList []AppPublishedServiceResponse `json:"published_service_definition_list,omitempty"`
	DefaultCredentialLocalReference *AppCredentialReference `json:"default_credential_local_reference,omitempty"`
	// 
...
type _BlueprintResourcesDefStatus BlueprintResourcesDefStatus
...
func NewBlueprintResourcesDefStatus() *BlueprintResourcesDefStatus {
	this := BlueprintResourcesDefStatus{}
...
// SetServiceDefinitionList gets a reference to the given []AppServiceResponse and assigns it to the ServiceDefinitionList field.
...
// SetSubstrateDefinitionList gets a reference to the given []AppSubstrateResponse and assigns it to the SubstrateDefinitionList field.
...
// SetCredentialDefinitionList gets a reference to the given []AppCredentialResponse and assigns it to the CredentialDefinitionList field.
...
// SetPackageDefinitionList gets a reference to the given []AppPackageResponse and assigns it to the PackageDefinitionList field.
...
// SetAppProfileList gets a reference to the given []AppProfileResponse and assigns it to the AppProfileList field.
...
func (o *BlueprintResourcesDefStatus) GetPublishedServiceDefinitionList() []AppPublishedServiceResponse {
	if o == nil || IsNil(o.PublishedServiceDefinitionList) {
		var ret []AppPublishedServiceResponse
		return ret
	}
...
// SetPublishedServiceDefinitionList gets a reference to the given []AppPublishedServiceResponse and assigns it to the PublishedServiceDefinitionList field.
...
func (o *BlueprintResourcesDefStatus) GetDefaultCredentialLocalReference() AppCredentialReference {
	if o == nil || IsNil(o.DefaultCredentialLocalReference) {
		var ret AppCredentialReference
		return ret
	}
...
// SetDefaultCredentialLocalReference gets a reference to the given AppCredentialReference and assigns it to the DefaultCredentialLocalReference field.
...
func (o BlueprintResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o BlueprintResourcesDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varBlueprintResourcesDefStatus := _BlueprintResourcesDefStatus{}

	err = json.Unmarshal(data, &varBlueprintResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = BlueprintResourcesDefStatus(varBlueprintResourcesDefStatus)
...
type NullableBlueprintResourcesDefStatus struct {
	value *BlueprintResourcesDefStatus
	isSet bool
}

func (v NullableBlueprintResourcesDefStatus) Get() *BlueprintResourcesDefStatus {
	return v.value
}

func (v *NullableBlueprintResourcesDefStatus) Set(val *BlueprintResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintResourcesDefStatus(val *BlueprintResourcesDefStatus) *NullableBlueprintResourcesDefStatus {
	return &NullableBlueprintResourcesDefStatus{value: val, isSet: true}
}

func (v NullableBlueprintResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
