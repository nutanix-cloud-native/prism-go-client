...
// checks if the FailoverCluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailoverCluster{}
...
type _FailoverCluster FailoverCluster
...
func (o FailoverCluster) MarshalJSON() ([]byte, error) {
...
func (o FailoverCluster) ToMap() (map[string]interface{}, error) {
...
func (o *FailoverCluster) UnmarshalJSON(data []byte) (err error) {
	...
	varFailoverCluster := _FailoverCluster{}

	err = json.Unmarshal(data, &varFailoverCluster)

	if err != nil {
		return err
	}

	*o = FailoverCluster(varFailoverCluster)
...
type NullableFailoverCluster struct {
	value *FailoverCluster
	isSet bool
}

func (v NullableFailoverCluster) Get() *FailoverCluster {
	return v.value
}

func (v *NullableFailoverCluster) Set(val *FailoverCluster) {
	v.value = val
	v.isSet = true
}

func (v NullableFailoverCluster) IsSet() bool {
	return v.isSet
}

func (v *NullableFailoverCluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFailoverCluster(val *FailoverCluster) *NullableFailoverCluster {
	return &NullableFailoverCluster{value: val, isSet: true}
}

func (v NullableFailoverCluster) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFailoverCluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
