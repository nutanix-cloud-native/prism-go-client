...
// checks if the AwsRoleStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRoleStatus{}

// AwsRoleStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _AwsRoleStatus AwsRoleStatus
...
func (o AwsRoleStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsRoleStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRoleStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsRoleStatus := _AwsRoleStatus{}

	err = json.Unmarshal(data, &varAwsRoleStatus)

	if err != nil {
		return err
	}

	*o = AwsRoleStatus(varAwsRoleStatus)
...
type NullableAwsRoleStatus struct {
	value *AwsRoleStatus
	isSet bool
}

func (v NullableAwsRoleStatus) Get() *AwsRoleStatus {
	return v.value
}

func (v *NullableAwsRoleStatus) Set(val *AwsRoleStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRoleStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRoleStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRoleStatus(val *AwsRoleStatus) *NullableAwsRoleStatus {
	return &NullableAwsRoleStatus{value: val, isSet: true}
}

func (v NullableAwsRoleStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRoleStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
