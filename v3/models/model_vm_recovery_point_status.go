...
// checks if the VmRecoveryPointStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPointStatus{}

// VmRecoveryPointStatus The status of a REST API call. Only used when there is a failure to report. 
type VmRecoveryPointStatus struct {
	// The kind name
...
type _VmRecoveryPointStatus VmRecoveryPointStatus
...
func (o VmRecoveryPointStatus) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPointStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPointStatus) UnmarshalJSON(data []byte) (err error) {
	varVmRecoveryPointStatus := _VmRecoveryPointStatus{}

	err = json.Unmarshal(data, &varVmRecoveryPointStatus)

	if err != nil {
		return err
	}

	*o = VmRecoveryPointStatus(varVmRecoveryPointStatus)
...
type NullableVmRecoveryPointStatus struct {
	value *VmRecoveryPointStatus
	isSet bool
}

func (v NullableVmRecoveryPointStatus) Get() *VmRecoveryPointStatus {
	return v.value
}

func (v *NullableVmRecoveryPointStatus) Set(val *VmRecoveryPointStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPointStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPointStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPointStatus(val *VmRecoveryPointStatus) *NullableVmRecoveryPointStatus {
	return &NullableVmRecoveryPointStatus{value: val, isSet: true}
}

func (v NullableVmRecoveryPointStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPointStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
