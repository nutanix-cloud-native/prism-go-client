...
// checks if the CategoryMappingResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingResourcesDefStatus{}

// CategoryMappingResourcesDefStatus A mapping from an object to a category value. 
type CategoryMappingResourcesDefStatus struct {
	// The value for the category that this mapping is for.
	CategoryValue *string `json:"category_value,omitempty"`
	AdMapping *CategoryMappingResourcesDefStatusAdMapping `json:"ad_mapping,omitempty"`
	// The name for the category that this mapping is for.
	CategoryName *string `json:"category_name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CategoryMappingResourcesDefStatus CategoryMappingResourcesDefStatus
...
func NewCategoryMappingResourcesDefStatus() *CategoryMappingResourcesDefStatus {
	this := CategoryMappingResourcesDefStatus{}
	return &this
}
...
// GetCategoryValue returns the CategoryValue field value if set, zero value otherwise.
func (o *CategoryMappingResourcesDefStatus) GetCategoryValue() string {
	if o == nil || IsNil(o.CategoryValue) {
		var ret string
		return ret
	}
	return *o.CategoryValue
}

// GetCategoryValueOk returns a tuple with the CategoryValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CategoryMappingResourcesDefStatus) GetCategoryValueOk() (*string, bool) {
	if o == nil || IsNil(o.CategoryValue) {
		return nil, false
	}
	return o.CategoryValue, true
}
...
// SetCategoryValue gets a reference to the given string and assigns it to the CategoryValue field.
func (o *CategoryMappingResourcesDefStatus) SetCategoryValue(v string) {
	o.CategoryValue = &v
}

// GetAdMapping returns the AdMapping field value if set, zero value otherwise.
func (o *CategoryMappingResourcesDefStatus) GetAdMapping() CategoryMappingResourcesDefStatusAdMapping {
	if o == nil || IsNil(o.AdMapping) {
		var ret CategoryMappingResourcesDefStatusAdMapping
		return ret
	}
	return *o.AdMapping
}
...
// SetAdMapping gets a reference to the given CategoryMappingResourcesDefStatusAdMapping and assigns it to the AdMapping field.
...
func (o CategoryMappingResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CategoryValue) {
		toSerialize["category_value"] = o.CategoryValue
	}
	if !IsNil(o.AdMapping) {
		toSerialize["ad_mapping"] = o.AdMapping
	}
...
func (o *CategoryMappingResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varCategoryMappingResourcesDefStatus := _CategoryMappingResourcesDefStatus{}

	err = json.Unmarshal(data, &varCategoryMappingResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = CategoryMappingResourcesDefStatus(varCategoryMappingResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "category_value")
		delete(additionalProperties, "ad_mapping")
...
type NullableCategoryMappingResourcesDefStatus struct {
	value *CategoryMappingResourcesDefStatus
	isSet bool
}

func (v NullableCategoryMappingResourcesDefStatus) Get() *CategoryMappingResourcesDefStatus {
	return v.value
}

func (v *NullableCategoryMappingResourcesDefStatus) Set(val *CategoryMappingResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingResourcesDefStatus(val *CategoryMappingResourcesDefStatus) *NullableCategoryMappingResourcesDefStatus {
	return &NullableCategoryMappingResourcesDefStatus{value: val, isSet: true}
}

func (v NullableCategoryMappingResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
