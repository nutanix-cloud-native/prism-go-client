...
// checks if the AwsImageMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsImageMetadata{}

// AwsImageMetadata The aws_image kind metadata
type AwsImageMetadata struct {
...
type _AwsImageMetadata AwsImageMetadata
...
func (o AwsImageMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsImageMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsImageMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsImageMetadata := _AwsImageMetadata{}

	err = json.Unmarshal(data, &varAwsImageMetadata)

	if err != nil {
		return err
	}

	*o = AwsImageMetadata(varAwsImageMetadata)
...
type NullableAwsImageMetadata struct {
	value *AwsImageMetadata
	isSet bool
}

func (v NullableAwsImageMetadata) Get() *AwsImageMetadata {
	return v.value
}

func (v *NullableAwsImageMetadata) Set(val *AwsImageMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsImageMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsImageMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsImageMetadata(val *AwsImageMetadata) *NullableAwsImageMetadata {
	return &NullableAwsImageMetadata{value: val, isSet: true}
}

func (v NullableAwsImageMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsImageMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
