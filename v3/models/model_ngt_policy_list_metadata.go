...
// checks if the NgtPolicyListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicyListMetadata{}

// NgtPolicyListMetadata All api calls that return a list will have this metadata block as input 
type NgtPolicyListMetadata struct {
	// The kind name
...
type _NgtPolicyListMetadata NgtPolicyListMetadata
...
func (o NgtPolicyListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicyListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicyListMetadata) UnmarshalJSON(data []byte) (err error) {
	varNgtPolicyListMetadata := _NgtPolicyListMetadata{}

	err = json.Unmarshal(data, &varNgtPolicyListMetadata)

	if err != nil {
		return err
	}

	*o = NgtPolicyListMetadata(varNgtPolicyListMetadata)
...
type NullableNgtPolicyListMetadata struct {
	value *NgtPolicyListMetadata
	isSet bool
}

func (v NullableNgtPolicyListMetadata) Get() *NgtPolicyListMetadata {
	return v.value
}

func (v *NullableNgtPolicyListMetadata) Set(val *NgtPolicyListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicyListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicyListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicyListMetadata(val *NgtPolicyListMetadata) *NullableNgtPolicyListMetadata {
	return &NullableNgtPolicyListMetadata{value: val, isSet: true}
}

func (v NullableNgtPolicyListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicyListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
