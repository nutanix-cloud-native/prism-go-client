...
// checks if the UserGroupListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupListMetadata{}

// UserGroupListMetadata All api calls that return a list will have this metadata block as input 
type UserGroupListMetadata struct {
	// The kind name
...
type _UserGroupListMetadata UserGroupListMetadata
...
func (o UserGroupListMetadata) MarshalJSON() ([]byte, error) {
...
func (o UserGroupListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *UserGroupListMetadata) UnmarshalJSON(data []byte) (err error) {
	varUserGroupListMetadata := _UserGroupListMetadata{}

	err = json.Unmarshal(data, &varUserGroupListMetadata)

	if err != nil {
		return err
	}

	*o = UserGroupListMetadata(varUserGroupListMetadata)
...
type NullableUserGroupListMetadata struct {
	value *UserGroupListMetadata
	isSet bool
}

func (v NullableUserGroupListMetadata) Get() *UserGroupListMetadata {
	return v.value
}

func (v *NullableUserGroupListMetadata) Set(val *UserGroupListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupListMetadata(val *UserGroupListMetadata) *NullableUserGroupListMetadata {
	return &NullableUserGroupListMetadata{value: val, isSet: true}
}

func (v NullableUserGroupListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
