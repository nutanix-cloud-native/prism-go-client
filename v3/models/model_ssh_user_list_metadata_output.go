...
// checks if the SshUserListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserListMetadataOutput{}

// SshUserListMetadataOutput All api calls that return a list will have this metadata block 
type SshUserListMetadataOutput struct {
	// The kind name
...
type _SshUserListMetadataOutput SshUserListMetadataOutput
...
func NewSshUserListMetadataOutput() *SshUserListMetadataOutput {
	this := SshUserListMetadataOutput{}
	var kind string = "ssh_user"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *SshUserListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o SshUserListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o SshUserListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varSshUserListMetadataOutput := _SshUserListMetadataOutput{}

	err = json.Unmarshal(data, &varSshUserListMetadataOutput)

	if err != nil {
		return err
	}

	*o = SshUserListMetadataOutput(varSshUserListMetadataOutput)
...
type NullableSshUserListMetadataOutput struct {
	value *SshUserListMetadataOutput
	isSet bool
}

func (v NullableSshUserListMetadataOutput) Get() *SshUserListMetadataOutput {
	return v.value
}

func (v *NullableSshUserListMetadataOutput) Set(val *SshUserListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserListMetadataOutput(val *SshUserListMetadataOutput) *NullableSshUserListMetadataOutput {
	return &NullableSshUserListMetadataOutput{value: val, isSet: true}
}

func (v NullableSshUserListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
