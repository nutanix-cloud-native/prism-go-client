...
// checks if the VpnConnectionResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionResources{}

// VpnConnectionResources VPN connection creation/modification spec.
type VpnConnectionResources struct {
	// Local gateway role (acceptor or initiator) in the connection. 
	LocalGatewayRole string `json:"local_gateway_role"`
	QosConfig *QosConfig `json:"qos_config,omitempty"`
	RemoteGatewayReference VpnGatewayReference `json:"remote_gateway_reference"`
	IpsecConfig IpsecConfig `json:"ipsec_config"`
	...
	LocalGatewayReference VpnGatewayReference `json:"local_gateway_reference"`
	DpdConfig *DpdConfig `json:"dpd_config,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VpnConnectionResources VpnConnectionResources
...
// GetLocalGatewayRole returns the LocalGatewayRole field value
...
// GetLocalGatewayRoleOk returns a tuple with the LocalGatewayRole field value
...
// SetLocalGatewayRole sets field value
...
// SetQosConfig gets a reference to the given QosConfig and assigns it to the QosConfig field.
func (o *VpnConnectionResources) SetQosConfig(v QosConfig) {
	o.QosConfig = &v
}

// GetRemoteGatewayReference returns the RemoteGatewayReference field value
...
// GetRemoteGatewayReferenceOk returns a tuple with the RemoteGatewayReference field value
// and a boolean to check if the value has been set.
...
// GetIpsecConfigOk returns a tuple with the IpsecConfig field value
// and a boolean to check if the value has been set.
...
// SetIpsecConfig sets field value
...
// GetLocalGatewayReference returns the LocalGatewayReference field value
...
// GetLocalGatewayReferenceOk returns a tuple with the LocalGatewayReference field value
// and a boolean to check if the value has been set.
...
// SetLocalGatewayReference sets field value
...
// SetDpdConfig gets a reference to the given DpdConfig and assigns it to the DpdConfig field.
func (o *VpnConnectionResources) SetDpdConfig(v DpdConfig) {
	o.DpdConfig = &v
}

func (o VpnConnectionResources) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionResources) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnectionResources) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnConnectionResources := _VpnConnectionResources{}

	err = json.Unmarshal(data, &varVpnConnectionResources)

	if err != nil {
		return err
	}

	*o = VpnConnectionResources(varVpnConnectionResources)
...
type NullableVpnConnectionResources struct {
	value *VpnConnectionResources
	isSet bool
}

func (v NullableVpnConnectionResources) Get() *VpnConnectionResources {
	return v.value
}

func (v *NullableVpnConnectionResources) Set(val *VpnConnectionResources) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionResources) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionResources(val *VpnConnectionResources) *NullableVpnConnectionResources {
	return &NullableVpnConnectionResources{value: val, isSet: true}
}

func (v NullableVpnConnectionResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
