...
// QueryResult Query result object definition. This holds the response for the search request. 
type QueryResult struct {
	// A description of the interpretation done by the search engine. 
	QueryExplaination *string `json:"query_explaination,omitempty"`
	// List of all the autocompletions for a given user query. 
	AutoCompletionList []AutoCompletion `json:"auto_completion_list,omitempty"`
	...
	PlainTextQuery *bool `json:"plain_text_query,omitempty"`
...
// GetQueryExplaination returns the QueryExplaination field value if set, zero value otherwise.
func (o *QueryResult) GetQueryExplaination() string {
	if o == nil || IsNil(o.QueryExplaination) {
		var ret string
		return ret
	}
	return *o.QueryExplaination
}

// GetQueryExplainationOk returns a tuple with the QueryExplaination field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QueryResult) GetQueryExplainationOk() (*string, bool) {
	if o == nil || IsNil(o.QueryExplaination) {
		return nil, false
	}
	return o.QueryExplaination, true
}
...
// SetQueryExplaination gets a reference to the given string and assigns it to the QueryExplaination field.
func (o *QueryResult) SetQueryExplaination(v string) {
	o.QueryExplaination = &v
}

// GetAutoCompletionList returns the AutoCompletionList field value if set, zero value otherwise.
func (o *QueryResult) GetAutoCompletionList() []AutoCompletion {
	if o == nil || IsNil(o.AutoCompletionList) {
		var ret []AutoCompletion
		return ret
	}
	return o.AutoCompletionList
}

// GetAutoCompletionListOk returns a tuple with the AutoCompletionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QueryResult) GetAutoCompletionListOk() ([]AutoCompletion, bool) {
	if o == nil || IsNil(o.AutoCompletionList) {
		return nil, false
	}
	return o.AutoCompletionList, true
}
...
// SetAutoCompletionList gets a reference to the given []AutoCompletion and assigns it to the AutoCompletionList field.
func (o *QueryResult) SetAutoCompletionList(v []AutoCompletion) {
	o.AutoCompletionList = v
}
...
// GetPlainTextQuery returns the PlainTextQuery field value if set, zero value otherwise.
func (o *QueryResult) GetPlainTextQuery() bool {
	if o == nil || IsNil(o.PlainTextQuery) {
		var ret bool
		return ret
	}
	return *o.PlainTextQuery
}

// GetPlainTextQueryOk returns a tuple with the PlainTextQuery field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QueryResult) GetPlainTextQueryOk() (*bool, bool) {
	if o == nil || IsNil(o.PlainTextQuery) {
		return nil, false
	}
	return o.PlainTextQuery, true
}
...
// SetPlainTextQuery gets a reference to the given bool and assigns it to the PlainTextQuery field.
...
func (o QueryResult) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.QueryExplaination) {
		toSerialize["query_explaination"] = o.QueryExplaination
	}
	if !IsNil(o.AutoCompletionList) {
		toSerialize["auto_completion_list"] = o.AutoCompletionList
	}
	...
	if !IsNil(o.PlainTextQuery) {
		toSerialize["plain_text_query"] = o.PlainTextQuery
	}
...
func (o *QueryResult) UnmarshalJSON(data []byte) (err error) {
	...
	*o = QueryResult(varQueryResult)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "query_explaination")
		delete(additionalProperties, "auto_completion_list")
		...
		delete(additionalProperties, "plain_text_query")
