...
// SearchRequest Search Query Object definitions.
type SearchRequest struct {
	...
	ExplicitQuery *bool `json:"explicit_query,omitempty"`
	// Flag to specify  if user is interested only in autocompletions. 
	GenerateAutocompletionsOnly *bool `json:"generate_autocompletions_only,omitempty"`
	...
	QueryTermList []QueryTerm `json:"query_term_list,omitempty"`
	// Flag to indicate the user selected an autocomplete. Helpful for tracking concrete autocomplete selections. 
	IsAutocompleteSelection *bool `json:"is_autocomplete_selection,omitempty"`
	...
	WidgetIdList []string `json:"widget_id_list,omitempty"`
...
// SetQueryContext gets a reference to the given string and assigns it to the QueryContext field.
func (o *SearchRequest) SetQueryContext(v string) {
	o.QueryContext = &v
}

// GetExplicitQuery returns the ExplicitQuery field value if set, zero value otherwise.
func (o *SearchRequest) GetExplicitQuery() bool {
	if o == nil || IsNil(o.ExplicitQuery) {
		var ret bool
		return ret
	}
	return *o.ExplicitQuery
}

// GetExplicitQueryOk returns a tuple with the ExplicitQuery field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchRequest) GetExplicitQueryOk() (*bool, bool) {
	if o == nil || IsNil(o.ExplicitQuery) {
		return nil, false
	}
	return o.ExplicitQuery, true
}
...
// SetExplicitQuery gets a reference to the given bool and assigns it to the ExplicitQuery field.
func (o *SearchRequest) SetExplicitQuery(v bool) {
	o.ExplicitQuery = &v
}

// GetGenerateAutocompletionsOnly returns the GenerateAutocompletionsOnly field value if set, zero value otherwise.
func (o *SearchRequest) GetGenerateAutocompletionsOnly() bool {
	if o == nil || IsNil(o.GenerateAutocompletionsOnly) {
		var ret bool
		return ret
	}
	return *o.GenerateAutocompletionsOnly
}

// GetGenerateAutocompletionsOnlyOk returns a tuple with the GenerateAutocompletionsOnly field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchRequest) GetGenerateAutocompletionsOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.GenerateAutocompletionsOnly) {
		return nil, false
	}
	return o.GenerateAutocompletionsOnly, true
}
...
// SetGenerateAutocompletionsOnly gets a reference to the given bool and assigns it to the GenerateAutocompletionsOnly field.
func (o *SearchRequest) SetGenerateAutocompletionsOnly(v bool) {
	o.GenerateAutocompletionsOnly = &v
}

// GetQueryTermList returns the QueryTermList field value if set, zero value otherwise.
func (o *SearchRequest) GetQueryTermList() []QueryTerm {
	if o == nil || IsNil(o.QueryTermList) {
		var ret []QueryTerm
		return ret
	}
	return o.QueryTermList
}

// GetQueryTermListOk returns a tuple with the QueryTermList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchRequest) GetQueryTermListOk() ([]QueryTerm, bool) {
	if o == nil || IsNil(o.QueryTermList) {
		return nil, false
	}
	return o.QueryTermList, true
}
...
// SetQueryTermList gets a reference to the given []QueryTerm and assigns it to the QueryTermList field.
func (o *SearchRequest) SetQueryTermList(v []QueryTerm) {
	o.QueryTermList = v
}

// GetIsAutocompleteSelection returns the IsAutocompleteSelection field value if set, zero value otherwise.
func (o *SearchRequest) GetIsAutocompleteSelection() bool {
	if o == nil || IsNil(o.IsAutocompleteSelection) {
		var ret bool
		return ret
	}
	return *o.IsAutocompleteSelection
}

// GetIsAutocompleteSelectionOk returns a tuple with the IsAutocompleteSelection field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchRequest) GetIsAutocompleteSelectionOk() (*bool, bool) {
	if o == nil || IsNil(o.IsAutocompleteSelection) {
		return nil, false
	}
	return o.IsAutocompleteSelection, true
}
...
// SetIsAutocompleteSelection gets a reference to the given bool and assigns it to the IsAutocompleteSelection field.
func (o *SearchRequest) SetIsAutocompleteSelection(v bool) {
	o.IsAutocompleteSelection = &v
}
...
// GetWidgetIdList returns the WidgetIdList field value if set, zero value otherwise.
func (o *SearchRequest) GetWidgetIdList() []string {
	if o == nil || IsNil(o.WidgetIdList) {
		var ret []string
		return ret
	}
	return o.WidgetIdList
}

// GetWidgetIdListOk returns a tuple with the WidgetIdList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchRequest) GetWidgetIdListOk() ([]string, bool) {
	if o == nil || IsNil(o.WidgetIdList) {
		return nil, false
	}
	return o.WidgetIdList, true
}
...
// SetWidgetIdList gets a reference to the given []string and assigns it to the WidgetIdList field.
...
func (o SearchRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.QueryContext) {
		toSerialize["query_context"] = o.QueryContext
	}
	if !IsNil(o.ExplicitQuery) {
		toSerialize["explicit_query"] = o.ExplicitQuery
	}
	if !IsNil(o.GenerateAutocompletionsOnly) {
		toSerialize["generate_autocompletions_only"] = o.GenerateAutocompletionsOnly
	}
	if !IsNil(o.QueryTermList) {
		toSerialize["query_term_list"] = o.QueryTermList
	}
	if !IsNil(o.IsAutocompleteSelection) {
		toSerialize["is_autocomplete_selection"] = o.IsAutocompleteSelection
	}
	if !IsNil(o.Timezone) {
	...
	if !IsNil(o.WidgetIdList) {
		toSerialize["widget_id_list"] = o.WidgetIdList
	}
...
func (o *SearchRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = SearchRequest(varSearchRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "query_context")
		delete(additionalProperties, "explicit_query")
		delete(additionalProperties, "generate_autocompletions_only")
		delete(additionalProperties, "query_term_list")
		delete(additionalProperties, "is_autocomplete_selection")
		delete(additionalProperties, "timezone")
		delete(additionalProperties, "user_query")
		delete(additionalProperties, "widget_id_list")
