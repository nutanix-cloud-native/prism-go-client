...
// checks if the VmBootConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmBootConfig{}
...
type _VmBootConfig VmBootConfig
...
// GetBootDeviceOrderList returns the BootDeviceOrderList field value if set, zero value otherwise.
func (o *VmBootConfig) GetBootDeviceOrderList() []string {
	if o == nil || IsNil(o.BootDeviceOrderList) {
		var ret []string
		return ret
	}
	return o.BootDeviceOrderList
}

// GetBootDeviceOrderListOk returns a tuple with the BootDeviceOrderList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmBootConfig) GetBootDeviceOrderListOk() ([]string, bool) {
	if o == nil || IsNil(o.BootDeviceOrderList) {
		return nil, false
	}
	return o.BootDeviceOrderList, true
}
...
// SetBootDeviceOrderList gets a reference to the given []string and assigns it to the BootDeviceOrderList field.
func (o *VmBootConfig) SetBootDeviceOrderList(v []string) {
	o.BootDeviceOrderList = v
}

// GetBootDevice returns the BootDevice field value if set, zero value otherwise.
func (o *VmBootConfig) GetBootDevice() VmBootDevice {
	if o == nil || IsNil(o.BootDevice) {
		var ret VmBootDevice
		return ret
	}
	return *o.BootDevice
}

// GetBootDeviceOk returns a tuple with the BootDevice field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmBootConfig) GetBootDeviceOk() (*VmBootDevice, bool) {
	if o == nil || IsNil(o.BootDevice) {
		return nil, false
	}
	return o.BootDevice, true
}
...
// SetBootDevice gets a reference to the given VmBootDevice and assigns it to the BootDevice field.
...
func (o VmBootConfig) MarshalJSON() ([]byte, error) {
...
func (o VmBootConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.BootDeviceOrderList) {
		toSerialize["boot_device_order_list"] = o.BootDeviceOrderList
	}
	if !IsNil(o.BootDevice) {
		toSerialize["boot_device"] = o.BootDevice
	}
	if !IsNil(o.DataSourceReference) {
		toSerialize["data_source_reference"] = o.DataSourceReference
	}
	if !IsNil(o.BootType) {
		toSerialize["boot_type"] = o.BootType
	}
...
func (o *VmBootConfig) UnmarshalJSON(data []byte) (err error) {
	varVmBootConfig := _VmBootConfig{}

	err = json.Unmarshal(data, &varVmBootConfig)

	if err != nil {
		return err
	}

	*o = VmBootConfig(varVmBootConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "boot_device_order_list")
		delete(additionalProperties, "boot_device")
		delete(additionalProperties, "data_source_reference")
		delete(additionalProperties, "boot_type")
...
type NullableVmBootConfig struct {
	value *VmBootConfig
	isSet bool
}

func (v NullableVmBootConfig) Get() *VmBootConfig {
	return v.value
}

func (v *NullableVmBootConfig) Set(val *VmBootConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableVmBootConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableVmBootConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmBootConfig(val *VmBootConfig) *NullableVmBootConfig {
	return &NullableVmBootConfig{value: val, isSet: true}
}

func (v NullableVmBootConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmBootConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
