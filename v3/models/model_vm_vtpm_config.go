...
// checks if the VmVtpmConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmVtpmConfig{}

// VmVtpmConfig Indicates how VM vTPM should be configured. 
...
type _VmVtpmConfig VmVtpmConfig
...
// GetVtpmSecret returns the VtpmSecret field value if set, zero value otherwise.
func (o *VmVtpmConfig) GetVtpmSecret() string {
	if o == nil || IsNil(o.VtpmSecret) {
		var ret string
		return ret
	}
	return *o.VtpmSecret
...
// GetVtpmSecretOk returns a tuple with the VtpmSecret field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmVtpmConfig) GetVtpmSecretOk() (*string, bool) {
	if o == nil || IsNil(o.VtpmSecret) {
		return nil, false
	}
	return o.VtpmSecret, true
}
...
// SetVtpmSecret gets a reference to the given string and assigns it to the VtpmSecret field.
func (o *VmVtpmConfig) SetVtpmSecret(v string) {
	o.VtpmSecret = &v
}

func (o VmVtpmConfig) MarshalJSON() ([]byte, error) {
...
func (o VmVtpmConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VtpmEnabled) {
		toSerialize["vtpm_enabled"] = o.VtpmEnabled
	}
	if !IsNil(o.DataSourceReference) {
		toSerialize["data_source_reference"] = o.DataSourceReference
	}
	if !IsNil(o.VtpmSecret) {
		toSerialize["vtpm_secret"] = o.VtpmSecret
	}
...
func (o *VmVtpmConfig) UnmarshalJSON(data []byte) (err error) {
	varVmVtpmConfig := _VmVtpmConfig{}

	err = json.Unmarshal(data, &varVmVtpmConfig)

	if err != nil {
		return err
	}

	*o = VmVtpmConfig(varVmVtpmConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vtpm_enabled")
		delete(additionalProperties, "data_source_reference")
		delete(additionalProperties, "vtpm_secret")
...
type NullableVmVtpmConfig struct {
	value *VmVtpmConfig
	isSet bool
}

func (v NullableVmVtpmConfig) Get() *VmVtpmConfig {
	return v.value
}

func (v *NullableVmVtpmConfig) Set(val *VmVtpmConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableVmVtpmConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableVmVtpmConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmVtpmConfig(val *VmVtpmConfig) *NullableVmVtpmConfig {
	return &NullableVmVtpmConfig{value: val, isSet: true}
}

func (v NullableVmVtpmConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmVtpmConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
