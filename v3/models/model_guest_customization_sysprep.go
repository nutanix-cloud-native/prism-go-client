...
// checks if the GuestCustomizationSysprep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestCustomizationSysprep{}
...
type _GuestCustomizationSysprep GuestCustomizationSysprep
...
func NewGuestCustomizationSysprep() *GuestCustomizationSysprep {
	this := GuestCustomizationSysprep{}
...
func (o GuestCustomizationSysprep) MarshalJSON() ([]byte, error) {
...
func (o GuestCustomizationSysprep) ToMap() (map[string]interface{}, error) {
...
func (o *GuestCustomizationSysprep) UnmarshalJSON(data []byte) (err error) {
	varGuestCustomizationSysprep := _GuestCustomizationSysprep{}

	err = json.Unmarshal(data, &varGuestCustomizationSysprep)

	if err != nil {
		return err
	}

	*o = GuestCustomizationSysprep(varGuestCustomizationSysprep)
...
type NullableGuestCustomizationSysprep struct {
	value *GuestCustomizationSysprep
	isSet bool
}

func (v NullableGuestCustomizationSysprep) Get() *GuestCustomizationSysprep {
	return v.value
}

func (v *NullableGuestCustomizationSysprep) Set(val *GuestCustomizationSysprep) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestCustomizationSysprep) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestCustomizationSysprep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestCustomizationSysprep(val *GuestCustomizationSysprep) *NullableGuestCustomizationSysprep {
	return &NullableGuestCustomizationSysprep{value: val, isSet: true}
}

func (v NullableGuestCustomizationSysprep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestCustomizationSysprep) UnmarshalJSON(src []byte) error {
	v.isSet = true
