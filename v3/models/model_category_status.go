...
// CategoryStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _CategoryStatus CategoryStatus
...
func (o *CategoryStatus) UnmarshalJSON(data []byte) (err error) {
	varCategoryStatus := _CategoryStatus{}

	err = json.Unmarshal(data, &varCategoryStatus)

	if err != nil {
		return err
	}

	*o = CategoryStatus(varCategoryStatus)
