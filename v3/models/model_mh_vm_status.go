...
// checks if the MhVmStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmStatus{}

// MhVmStatus The status of a REST API call. Only used when there is a failure to report. 
type MhVmStatus struct {
	// The kind name
...
func (o MhVmStatus) MarshalJSON() ([]byte, error) {
...
func (o MhVmStatus) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmStatus) UnmarshalJSON(data []byte) (err error) {
	varMhVmStatus := _MhVmStatus{}

	err = json.Unmarshal(data, &varMhVmStatus)

	if err != nil {
		return err
	}

	*o = MhVmStatus(varMhVmStatus)
...
type NullableMhVmStatus struct {
	value *MhVmStatus
	isSet bool
}

func (v NullableMhVmStatus) Get() *MhVmStatus {
	return v.value
}

func (v *NullableMhVmStatus) Set(val *MhVmStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmStatus(val *MhVmStatus) *NullableMhVmStatus {
	return &NullableMhVmStatus{value: val, isSet: true}
}

func (v NullableMhVmStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
