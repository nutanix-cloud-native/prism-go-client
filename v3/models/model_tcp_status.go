...
// checks if the TcpStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TcpStatus{}

// TcpStatus TCP parameters to be matched in routing policy.
type TcpStatus struct {
	// List of ranges of TCP destination ports.
	DestinationPortRangeList []PortRangeStatus `json:"destination_port_range_list,omitempty"`
	SourcePortRange *PortRangeStatus `json:"source_port_range,omitempty"`
	// List of ranges of TCP source ports.
	SourcePortRangeList []PortRangeStatus `json:"source_port_range_list,omitempty"`
	DestinationPortRange *PortRangeStatus `json:"destination_port_range,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _TcpStatus TcpStatus
...
// GetDestinationPortRangeList returns the DestinationPortRangeList field value if set, zero value otherwise.
func (o *TcpStatus) GetDestinationPortRangeList() []PortRangeStatus {
	if o == nil || IsNil(o.DestinationPortRangeList) {
		var ret []PortRangeStatus
		return ret
	}
	return o.DestinationPortRangeList
}

// GetDestinationPortRangeListOk returns a tuple with the DestinationPortRangeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TcpStatus) GetDestinationPortRangeListOk() ([]PortRangeStatus, bool) {
	if o == nil || IsNil(o.DestinationPortRangeList) {
		return nil, false
	}
	return o.DestinationPortRangeList, true
}
...
// SetDestinationPortRangeList gets a reference to the given []PortRangeStatus and assigns it to the DestinationPortRangeList field.
func (o *TcpStatus) SetDestinationPortRangeList(v []PortRangeStatus) {
	o.DestinationPortRangeList = v
}
...
// SetSourcePortRange gets a reference to the given PortRangeStatus and assigns it to the SourcePortRange field.
func (o *TcpStatus) SetSourcePortRange(v PortRangeStatus) {
	o.SourcePortRange = &v
}

// GetSourcePortRangeList returns the SourcePortRangeList field value if set, zero value otherwise.
func (o *TcpStatus) GetSourcePortRangeList() []PortRangeStatus {
	if o == nil || IsNil(o.SourcePortRangeList) {
		var ret []PortRangeStatus
		return ret
	}
	return o.SourcePortRangeList
}

// GetSourcePortRangeListOk returns a tuple with the SourcePortRangeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TcpStatus) GetSourcePortRangeListOk() ([]PortRangeStatus, bool) {
	if o == nil || IsNil(o.SourcePortRangeList) {
		return nil, false
	}
	return o.SourcePortRangeList, true
}
...
// SetSourcePortRangeList gets a reference to the given []PortRangeStatus and assigns it to the SourcePortRangeList field.
func (o *TcpStatus) SetSourcePortRangeList(v []PortRangeStatus) {
	o.SourcePortRangeList = v
}
...
// SetDestinationPortRange gets a reference to the given PortRangeStatus and assigns it to the DestinationPortRange field.
func (o *TcpStatus) SetDestinationPortRange(v PortRangeStatus) {
	o.DestinationPortRange = &v
}

func (o TcpStatus) MarshalJSON() ([]byte, error) {
...
func (o TcpStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DestinationPortRangeList) {
		toSerialize["destination_port_range_list"] = o.DestinationPortRangeList
	}
	if !IsNil(o.SourcePortRange) {
		toSerialize["source_port_range"] = o.SourcePortRange
	}
	if !IsNil(o.SourcePortRangeList) {
		toSerialize["source_port_range_list"] = o.SourcePortRangeList
	}
	if !IsNil(o.DestinationPortRange) {
		toSerialize["destination_port_range"] = o.DestinationPortRange
	}
...
func (o *TcpStatus) UnmarshalJSON(data []byte) (err error) {
	varTcpStatus := _TcpStatus{}

	err = json.Unmarshal(data, &varTcpStatus)

	if err != nil {
		return err
	}

	*o = TcpStatus(varTcpStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "destination_port_range_list")
		delete(additionalProperties, "source_port_range")
		delete(additionalProperties, "source_port_range_list")
		delete(additionalProperties, "destination_port_range")
...
type NullableTcpStatus struct {
	value *TcpStatus
	isSet bool
}

func (v NullableTcpStatus) Get() *TcpStatus {
	return v.value
}

func (v *NullableTcpStatus) Set(val *TcpStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableTcpStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableTcpStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTcpStatus(val *TcpStatus) *NullableTcpStatus {
	return &NullableTcpStatus{value: val, isSet: true}
}

func (v NullableTcpStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTcpStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
