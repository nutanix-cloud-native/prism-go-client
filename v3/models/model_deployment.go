...
// Deployment Deployment related config for this gateway.
type Deployment struct {
	...
	// The software image to install on the gateway appliance. If set, \"installed_software_version\" must be omitted. 
	...
	// The software version to install on the gateway appliance. If set, \"image_source_url\" must be omitted. 
	InstalledSoftwareVersion *string `json:"installed_software_version,omitempty"`
	// The on-prem VLAN to deploy the VPN gateway on. This is not needed if the subnet_reference is provided. 
