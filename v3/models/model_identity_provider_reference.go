...
// checks if the IdentityProviderReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderReference{}

// IdentityProviderReference The reference to a identity_provider
...
type _IdentityProviderReference IdentityProviderReference
...
func NewIdentityProviderReference(kind string, uUID string) *IdentityProviderReference {
	this := IdentityProviderReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o IdentityProviderReference) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderReference) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProviderReference) UnmarshalJSON(data []byte) (err error) {
	...
	varIdentityProviderReference := _IdentityProviderReference{}

	err = json.Unmarshal(data, &varIdentityProviderReference)

	if err != nil {
		return err
	}

	*o = IdentityProviderReference(varIdentityProviderReference)
...
type NullableIdentityProviderReference struct {
	value *IdentityProviderReference
	isSet bool
}

func (v NullableIdentityProviderReference) Get() *IdentityProviderReference {
	return v.value
}

func (v *NullableIdentityProviderReference) Set(val *IdentityProviderReference) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderReference) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderReference(val *IdentityProviderReference) *NullableIdentityProviderReference {
	return &NullableIdentityProviderReference{value: val, isSet: true}
}

func (v NullableIdentityProviderReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
