...
// checks if the PermissionResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionResources{}

// PermissionResources Permission resources definition.
type PermissionResources struct {
	Fields *TheFieldsThatCanBeAllowedOrDisallowedDuringAnOperation `json:"fields,omitempty"`
	// The operation that is being performed on a given kind.
	Operation string `json:"operation"`
	// The kind on which the operation is being performed.
	Kind string `json:"kind"`
	AdditionalProperties map[string]interface{}
}

type _PermissionResources PermissionResources
...
func (o *PermissionResources) GetFields() TheFieldsThatCanBeAllowedOrDisallowedDuringAnOperation {
	if o == nil || IsNil(o.Fields) {
		var ret TheFieldsThatCanBeAllowedOrDisallowedDuringAnOperation
		return ret
	}
	return *o.Fields
}
...
// SetFields gets a reference to the given TheFieldsThatCanBeAllowedOrDisallowedDuringAnOperation and assigns it to the Fields field.
...
func (o PermissionResources) MarshalJSON() ([]byte, error) {
...
func (o PermissionResources) ToMap() (map[string]interface{}, error) {
...
func (o *PermissionResources) UnmarshalJSON(data []byte) (err error) {
	...
	varPermissionResources := _PermissionResources{}

	err = json.Unmarshal(data, &varPermissionResources)

	if err != nil {
		return err
	}

	*o = PermissionResources(varPermissionResources)
...
type NullablePermissionResources struct {
	value *PermissionResources
	isSet bool
}

func (v NullablePermissionResources) Get() *PermissionResources {
	return v.value
}

func (v *NullablePermissionResources) Set(val *PermissionResources) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionResources) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionResources(val *PermissionResources) *NullablePermissionResources {
	return &NullablePermissionResources{value: val, isSet: true}
}

func (v NullablePermissionResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
