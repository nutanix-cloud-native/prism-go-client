...
// checks if the AwsVolumeTypeListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVolumeTypeListIntentResponse{}

// AwsVolumeTypeListIntentResponse AWS VPC entity list.
type AwsVolumeTypeListIntentResponse struct {
	Entities []AwsVolumeTypeIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsVolumeTypeListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsVolumeTypeListIntentResponse AwsVolumeTypeListIntentResponse
...
func NewAwsVolumeTypeListIntentResponse(apiVersion string, metadata AwsVolumeTypeListMetadataOutput) *AwsVolumeTypeListIntentResponse {
	this := AwsVolumeTypeListIntentResponse{}
...
func (o *AwsVolumeTypeListIntentResponse) GetEntities() []AwsVolumeTypeIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []AwsVolumeTypeIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []AwsVolumeTypeIntentResource and assigns it to the Entities field.
...
func (o *AwsVolumeTypeListIntentResponse) GetMetadata() AwsVolumeTypeListMetadataOutput {
	if o == nil {
		var ret AwsVolumeTypeListMetadataOutput
		return ret
	}
...
func (o AwsVolumeTypeListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsVolumeTypeListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVolumeTypeListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVolumeTypeListIntentResponse := _AwsVolumeTypeListIntentResponse{}

	err = json.Unmarshal(data, &varAwsVolumeTypeListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsVolumeTypeListIntentResponse(varAwsVolumeTypeListIntentResponse)
...
type NullableAwsVolumeTypeListIntentResponse struct {
	value *AwsVolumeTypeListIntentResponse
	isSet bool
}

func (v NullableAwsVolumeTypeListIntentResponse) Get() *AwsVolumeTypeListIntentResponse {
	return v.value
}

func (v *NullableAwsVolumeTypeListIntentResponse) Set(val *AwsVolumeTypeListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVolumeTypeListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVolumeTypeListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVolumeTypeListIntentResponse(val *AwsVolumeTypeListIntentResponse) *NullableAwsVolumeTypeListIntentResponse {
	return &NullableAwsVolumeTypeListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsVolumeTypeListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVolumeTypeListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
