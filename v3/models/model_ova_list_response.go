...
// checks if the OvaListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OvaListResponse{}

// OvaListResponse Response object for list operation of OVAs
type OvaListResponse struct {
	Entities []OvaGetResponse `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata OvaListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _OvaListResponse OvaListResponse
...
// SetEntities gets a reference to the given []OvaGetResponse and assigns it to the Entities field.
...
func (o OvaListResponse) MarshalJSON() ([]byte, error) {
...
func (o OvaListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OvaListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varOvaListResponse := _OvaListResponse{}

	err = json.Unmarshal(data, &varOvaListResponse)

	if err != nil {
		return err
	}

	*o = OvaListResponse(varOvaListResponse)
...
type NullableOvaListResponse struct {
	value *OvaListResponse
	isSet bool
}

func (v NullableOvaListResponse) Get() *OvaListResponse {
	return v.value
}

func (v *NullableOvaListResponse) Set(val *OvaListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOvaListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOvaListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOvaListResponse(val *OvaListResponse) *NullableOvaListResponse {
	return &NullableOvaListResponse{value: val, isSet: true}
}

func (v NullableOvaListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOvaListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
