...
// checks if the AppCostResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCostResponse{}

// AppCostResponse Cost definition for Application
...
type _AppCostResponse AppCostResponse
...
func (o AppCostResponse) MarshalJSON() ([]byte, error) {
...
func (o AppCostResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppCostResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCostResponse := _AppCostResponse{}

	err = json.Unmarshal(data, &varAppCostResponse)

	if err != nil {
		return err
	}

	*o = AppCostResponse(varAppCostResponse)
...
type NullableAppCostResponse struct {
	value *AppCostResponse
	isSet bool
}

func (v NullableAppCostResponse) Get() *AppCostResponse {
	return v.value
}

func (v *NullableAppCostResponse) Set(val *AppCostResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCostResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCostResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCostResponse(val *AppCostResponse) *NullableAppCostResponse {
	return &NullableAppCostResponse{value: val, isSet: true}
}

func (v NullableAppCostResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCostResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
