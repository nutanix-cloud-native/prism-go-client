...
// checks if the CountsPertainingToRespectivePolicies type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CountsPertainingToRespectivePolicies{}

// CountsPertainingToRespectivePolicies The object represents whether the total number of realized entities being governed by the policy need to be computed. It also tracks whether individual counts of COMPLIANT, NON_COMPLIANT and IN_PROGRESS entities with the policy. 
type CountsPertainingToRespectivePolicies struct {
	VmCountsInput *EntityCountsInput `json:"vm_counts_input,omitempty"`
	...
	VgCountsInput *EntityCountsInput `json:"vg_counts_input,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CountsPertainingToRespectivePolicies CountsPertainingToRespectivePolicies
...
func NewCountsPertainingToRespectivePolicies() *CountsPertainingToRespectivePolicies {
	this := CountsPertainingToRespectivePolicies{}
	return &this
}
...
// GetVmCountsInput returns the VmCountsInput field value if set, zero value otherwise.
func (o *CountsPertainingToRespectivePolicies) GetVmCountsInput() EntityCountsInput {
	if o == nil || IsNil(o.VmCountsInput) {
		var ret EntityCountsInput
		return ret
	}
	return *o.VmCountsInput
}

// GetVmCountsInputOk returns a tuple with the VmCountsInput field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CountsPertainingToRespectivePolicies) GetVmCountsInputOk() (*EntityCountsInput, bool) {
	if o == nil || IsNil(o.VmCountsInput) {
		return nil, false
	}
	return o.VmCountsInput, true
}
...
// SetVmCountsInput gets a reference to the given EntityCountsInput and assigns it to the VmCountsInput field.
...
// GetVgCountsInput returns the VgCountsInput field value if set, zero value otherwise.
func (o *CountsPertainingToRespectivePolicies) GetVgCountsInput() EntityCountsInput {
	if o == nil || IsNil(o.VgCountsInput) {
		var ret EntityCountsInput
		return ret
	}
	return *o.VgCountsInput
}

// GetVgCountsInputOk returns a tuple with the VgCountsInput field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CountsPertainingToRespectivePolicies) GetVgCountsInputOk() (*EntityCountsInput, bool) {
	if o == nil || IsNil(o.VgCountsInput) {
		return nil, false
	}
	return o.VgCountsInput, true
}
...
// SetVgCountsInput gets a reference to the given EntityCountsInput and assigns it to the VgCountsInput field.
func (o *CountsPertainingToRespectivePolicies) SetVgCountsInput(v EntityCountsInput) {
	o.VgCountsInput = &v
}

func (o CountsPertainingToRespectivePolicies) MarshalJSON() ([]byte, error) {
...
func (o CountsPertainingToRespectivePolicies) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VmCountsInput) {
		toSerialize["vm_counts_input"] = o.VmCountsInput
	}
	if !IsNil(o.StoragePolicyUuid) {
		toSerialize["storage_policy_uuid"] = o.StoragePolicyUuid
	}
	if !IsNil(o.VgCountsInput) {
		toSerialize["vg_counts_input"] = o.VgCountsInput
	}
...
func (o *CountsPertainingToRespectivePolicies) UnmarshalJSON(data []byte) (err error) {
	varCountsPertainingToRespectivePolicies := _CountsPertainingToRespectivePolicies{}

	err = json.Unmarshal(data, &varCountsPertainingToRespectivePolicies)

	if err != nil {
		return err
	}

	*o = CountsPertainingToRespectivePolicies(varCountsPertainingToRespectivePolicies)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vm_counts_input")
		delete(additionalProperties, "storage_policy_uuid")
		delete(additionalProperties, "vg_counts_input")
...
type NullableCountsPertainingToRespectivePolicies struct {
	value *CountsPertainingToRespectivePolicies
	isSet bool
}

func (v NullableCountsPertainingToRespectivePolicies) Get() *CountsPertainingToRespectivePolicies {
	return v.value
}

func (v *NullableCountsPertainingToRespectivePolicies) Set(val *CountsPertainingToRespectivePolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableCountsPertainingToRespectivePolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableCountsPertainingToRespectivePolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCountsPertainingToRespectivePolicies(val *CountsPertainingToRespectivePolicies) *NullableCountsPertainingToRespectivePolicies {
	return &NullableCountsPertainingToRespectivePolicies{value: val, isSet: true}
}

func (v NullableCountsPertainingToRespectivePolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCountsPertainingToRespectivePolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
