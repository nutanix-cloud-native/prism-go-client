...
// checks if the StoragePolicyResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyResourcesDefStatus{}

// StoragePolicyResourcesDefStatus Storage Policy Resources Status Definition
type StoragePolicyResourcesDefStatus struct {
	Qos *StorageQoSParametersForTheEntities `json:"qos,omitempty"`
	Compression *CompressionParametersForTheEntities `json:"compression,omitempty"`
	Encryption *EncryptionParametersForTheEntities `json:"encryption,omitempty"`
	FaultTolerance *FaultToleranceParametersForTheEntities `json:"fault_tolerance,omitempty"`
	// Regex for entities on which the policy has been applied
	FilterList []Filter `json:"filter_list,omitempty"`
	// Creator of the storage policy
	Type *string `json:"type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _StoragePolicyResourcesDefStatus StoragePolicyResourcesDefStatus
...
func NewStoragePolicyResourcesDefStatus() *StoragePolicyResourcesDefStatus {
	this := StoragePolicyResourcesDefStatus{}
...
func (o *StoragePolicyResourcesDefStatus) GetQos() StorageQoSParametersForTheEntities {
	if o == nil || IsNil(o.Qos) {
		var ret StorageQoSParametersForTheEntities
		return ret
	}
	return *o.Qos
}
...
// SetQos gets a reference to the given StorageQoSParametersForTheEntities and assigns it to the Qos field.
...
func (o *StoragePolicyResourcesDefStatus) GetCompression() CompressionParametersForTheEntities {
	if o == nil || IsNil(o.Compression) {
		var ret CompressionParametersForTheEntities
		return ret
	}
...
// SetCompression gets a reference to the given CompressionParametersForTheEntities and assigns it to the Compression field.
...
func (o *StoragePolicyResourcesDefStatus) GetEncryption() EncryptionParametersForTheEntities {
	if o == nil || IsNil(o.Encryption) {
		var ret EncryptionParametersForTheEntities
		return ret
	}
	return *o.Encryption
}
...
// SetEncryption gets a reference to the given EncryptionParametersForTheEntities and assigns it to the Encryption field.
func (o *StoragePolicyResourcesDefStatus) SetEncryption(v EncryptionParametersForTheEntities) {
	o.Encryption = &v
}

// GetFaultTolerance returns the FaultTolerance field value if set, zero value otherwise.
func (o *StoragePolicyResourcesDefStatus) GetFaultTolerance() FaultToleranceParametersForTheEntities {
	if o == nil || IsNil(o.FaultTolerance) {
		var ret FaultToleranceParametersForTheEntities
		return ret
	}
	return *o.FaultTolerance
}

// GetFaultToleranceOk returns a tuple with the FaultTolerance field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StoragePolicyResourcesDefStatus) GetFaultToleranceOk() (*FaultToleranceParametersForTheEntities, bool) {
	if o == nil || IsNil(o.FaultTolerance) {
		return nil, false
	}
	return o.FaultTolerance, true
}
...
// SetFaultTolerance gets a reference to the given FaultToleranceParametersForTheEntities and assigns it to the FaultTolerance field.
...
// SetFilterList gets a reference to the given []Filter and assigns it to the FilterList field.
...
func (o StoragePolicyResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FaultTolerance) {
		toSerialize["fault_tolerance"] = o.FaultTolerance
	}
...
func (o *StoragePolicyResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varStoragePolicyResourcesDefStatus := _StoragePolicyResourcesDefStatus{}

	err = json.Unmarshal(data, &varStoragePolicyResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = StoragePolicyResourcesDefStatus(varStoragePolicyResourcesDefStatus)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "fault_tolerance")
...
type NullableStoragePolicyResourcesDefStatus struct {
	value *StoragePolicyResourcesDefStatus
	isSet bool
}

func (v NullableStoragePolicyResourcesDefStatus) Get() *StoragePolicyResourcesDefStatus {
	return v.value
}

func (v *NullableStoragePolicyResourcesDefStatus) Set(val *StoragePolicyResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyResourcesDefStatus(val *StoragePolicyResourcesDefStatus) *NullableStoragePolicyResourcesDefStatus {
	return &NullableStoragePolicyResourcesDefStatus{value: val, isSet: true}
}

func (v NullableStoragePolicyResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
