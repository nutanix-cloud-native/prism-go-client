...
// checks if the AwsSubnetListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSubnetListIntentResponse{}

// AwsSubnetListIntentResponse AWS VPC entity list.
type AwsSubnetListIntentResponse struct {
	Entities []AwsSubnetIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsSubnetListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsSubnetListIntentResponse AwsSubnetListIntentResponse
...
func NewAwsSubnetListIntentResponse(apiVersion string, metadata AwsSubnetListMetadataOutput) *AwsSubnetListIntentResponse {
	this := AwsSubnetListIntentResponse{}
...
func (o *AwsSubnetListIntentResponse) GetEntities() []AwsSubnetIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []AwsSubnetIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []AwsSubnetIntentResource and assigns it to the Entities field.
...
func (o *AwsSubnetListIntentResponse) GetMetadata() AwsSubnetListMetadataOutput {
	if o == nil {
		var ret AwsSubnetListMetadataOutput
		return ret
	}
...
func (o AwsSubnetListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsSubnetListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSubnetListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsSubnetListIntentResponse := _AwsSubnetListIntentResponse{}

	err = json.Unmarshal(data, &varAwsSubnetListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsSubnetListIntentResponse(varAwsSubnetListIntentResponse)
...
type NullableAwsSubnetListIntentResponse struct {
	value *AwsSubnetListIntentResponse
	isSet bool
}

func (v NullableAwsSubnetListIntentResponse) Get() *AwsSubnetListIntentResponse {
	return v.value
}

func (v *NullableAwsSubnetListIntentResponse) Set(val *AwsSubnetListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSubnetListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSubnetListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSubnetListIntentResponse(val *AwsSubnetListIntentResponse) *NullableAwsSubnetListIntentResponse {
	return &NullableAwsSubnetListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsSubnetListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSubnetListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
