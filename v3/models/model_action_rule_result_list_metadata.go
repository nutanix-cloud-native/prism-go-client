...
// checks if the ActionRuleResultListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResultListMetadata{}

// ActionRuleResultListMetadata All api calls that return a list will have this metadata block as input 
type ActionRuleResultListMetadata struct {
	// The kind name
...
type _ActionRuleResultListMetadata ActionRuleResultListMetadata
...
func NewActionRuleResultListMetadata() *ActionRuleResultListMetadata {
	this := ActionRuleResultListMetadata{}
...
func (o ActionRuleResultListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResultListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleResultListMetadata) UnmarshalJSON(data []byte) (err error) {
	varActionRuleResultListMetadata := _ActionRuleResultListMetadata{}

	err = json.Unmarshal(data, &varActionRuleResultListMetadata)

	if err != nil {
		return err
	}

	*o = ActionRuleResultListMetadata(varActionRuleResultListMetadata)
...
type NullableActionRuleResultListMetadata struct {
	value *ActionRuleResultListMetadata
	isSet bool
}

func (v NullableActionRuleResultListMetadata) Get() *ActionRuleResultListMetadata {
	return v.value
}

func (v *NullableActionRuleResultListMetadata) Set(val *ActionRuleResultListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResultListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResultListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResultListMetadata(val *ActionRuleResultListMetadata) *NullableActionRuleResultListMetadata {
	return &NullableActionRuleResultListMetadata{value: val, isSet: true}
}

func (v NullableActionRuleResultListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResultListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
