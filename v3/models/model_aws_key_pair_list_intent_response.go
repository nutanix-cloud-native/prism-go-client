...
// checks if the AwsKeyPairListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsKeyPairListIntentResponse{}

// AwsKeyPairListIntentResponse AWS VPC entity list.
type AwsKeyPairListIntentResponse struct {
	Entities []AwsKeyPairIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsKeyPairListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsKeyPairListIntentResponse AwsKeyPairListIntentResponse
...
func NewAwsKeyPairListIntentResponse(apiVersion string, metadata AwsKeyPairListMetadataOutput) *AwsKeyPairListIntentResponse {
	this := AwsKeyPairListIntentResponse{}
...
func (o *AwsKeyPairListIntentResponse) GetEntities() []AwsKeyPairIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []AwsKeyPairIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []AwsKeyPairIntentResource and assigns it to the Entities field.
...
func (o *AwsKeyPairListIntentResponse) GetMetadata() AwsKeyPairListMetadataOutput {
	if o == nil {
		var ret AwsKeyPairListMetadataOutput
		return ret
	}
...
func (o AwsKeyPairListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsKeyPairListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsKeyPairListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsKeyPairListIntentResponse := _AwsKeyPairListIntentResponse{}

	err = json.Unmarshal(data, &varAwsKeyPairListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsKeyPairListIntentResponse(varAwsKeyPairListIntentResponse)
...
type NullableAwsKeyPairListIntentResponse struct {
	value *AwsKeyPairListIntentResponse
	isSet bool
}

func (v NullableAwsKeyPairListIntentResponse) Get() *AwsKeyPairListIntentResponse {
	return v.value
}

func (v *NullableAwsKeyPairListIntentResponse) Set(val *AwsKeyPairListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsKeyPairListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsKeyPairListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsKeyPairListIntentResponse(val *AwsKeyPairListIntentResponse) *NullableAwsKeyPairListIntentResponse {
	return &NullableAwsKeyPairListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsKeyPairListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsKeyPairListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
