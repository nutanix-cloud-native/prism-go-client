...
// checks if the AppRunlogListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunlogListMetadata{}

// AppRunlogListMetadata All api calls that return a list will have this metadata block as input 
type AppRunlogListMetadata struct {
	// The kind name
...
type _AppRunlogListMetadata AppRunlogListMetadata
...
func (o AppRunlogListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AppRunlogListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunlogListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAppRunlogListMetadata := _AppRunlogListMetadata{}

	err = json.Unmarshal(data, &varAppRunlogListMetadata)

	if err != nil {
		return err
	}

	*o = AppRunlogListMetadata(varAppRunlogListMetadata)
...
type NullableAppRunlogListMetadata struct {
	value *AppRunlogListMetadata
	isSet bool
}

func (v NullableAppRunlogListMetadata) Get() *AppRunlogListMetadata {
	return v.value
}

func (v *NullableAppRunlogListMetadata) Set(val *AppRunlogListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunlogListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunlogListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunlogListMetadata(val *AppRunlogListMetadata) *NullableAppRunlogListMetadata {
	return &NullableAppRunlogListMetadata{value: val, isSet: true}
}

func (v NullableAppRunlogListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunlogListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
