...
// checks if the AwsVmDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVmDefStatus{}

// AwsVmDefStatus An intentful representation of a aws_vm status
type AwsVmDefStatus struct {
	// aws_vm Name.
	Name string `json:"name"`
	// The state of the aws_vm.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the aws_vm, if in an error state.
	...
	Resources AwsVmResourcesDefStatus `json:"resources"`
	// A description for aws_vm.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsVmDefStatus AwsVmDefStatus
...
func (o *AwsVmDefStatus) GetResources() AwsVmResourcesDefStatus {
	if o == nil {
		var ret AwsVmResourcesDefStatus
		return ret
	}
...
func (o AwsVmDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsVmDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVmDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVmDefStatus := _AwsVmDefStatus{}

	err = json.Unmarshal(data, &varAwsVmDefStatus)

	if err != nil {
		return err
	}

	*o = AwsVmDefStatus(varAwsVmDefStatus)
...
type NullableAwsVmDefStatus struct {
	value *AwsVmDefStatus
	isSet bool
}

func (v NullableAwsVmDefStatus) Get() *AwsVmDefStatus {
	return v.value
}

func (v *NullableAwsVmDefStatus) Set(val *AwsVmDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVmDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVmDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVmDefStatus(val *AwsVmDefStatus) *NullableAwsVmDefStatus {
	return &NullableAwsVmDefStatus{value: val, isSet: true}
}

func (v NullableAwsVmDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVmDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
