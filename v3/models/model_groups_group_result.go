...
// checks if the GroupsGroupResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupsGroupResult{}
...
type GroupsGroupResult struct {
	...
	GroupSummaries *map[string]GroupsFieldData `json:"group_summaries,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _GroupsGroupResult GroupsGroupResult
...
// GetEntityResults returns the EntityResults field value if set, zero value otherwise.
func (o *GroupsGroupResult) GetEntityResults() []GroupsEntity {
	if o == nil || IsNil(o.EntityResults) {
		var ret []GroupsEntity
		return ret
	}
	return o.EntityResults
}

// GetEntityResultsOk returns a tuple with the EntityResults field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GroupsGroupResult) GetEntityResultsOk() ([]GroupsEntity, bool) {
	if o == nil || IsNil(o.EntityResults) {
		return nil, false
	}
	return o.EntityResults, true
}
...
// SetEntityResults gets a reference to the given []GroupsEntity and assigns it to the EntityResults field.
func (o *GroupsGroupResult) SetEntityResults(v []GroupsEntity) {
	o.EntityResults = v
}

// GetGroupByColumnValue returns the GroupByColumnValue field value if set, zero value otherwise.
func (o *GroupsGroupResult) GetGroupByColumnValue() string {
	if o == nil || IsNil(o.GroupByColumnValue) {
		var ret string
		return ret
	}
	return *o.GroupByColumnValue
}

// GetGroupByColumnValueOk returns a tuple with the GroupByColumnValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GroupsGroupResult) GetGroupByColumnValueOk() (*string, bool) {
	if o == nil || IsNil(o.GroupByColumnValue) {
		return nil, false
	}
	return o.GroupByColumnValue, true
}
...
// SetGroupByColumnValue gets a reference to the given string and assigns it to the GroupByColumnValue field.
func (o *GroupsGroupResult) SetGroupByColumnValue(v string) {
	o.GroupByColumnValue = &v
}
...
// GetGroupSummaries returns the GroupSummaries field value if set, zero value otherwise.
func (o *GroupsGroupResult) GetGroupSummaries() map[string]GroupsFieldData {
	if o == nil || IsNil(o.GroupSummaries) {
		var ret map[string]GroupsFieldData
		return ret
	}
	return *o.GroupSummaries
}

// GetGroupSummariesOk returns a tuple with the GroupSummaries field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GroupsGroupResult) GetGroupSummariesOk() (*map[string]GroupsFieldData, bool) {
	if o == nil || IsNil(o.GroupSummaries) {
		return nil, false
	}
	return o.GroupSummaries, true
}
...
// SetGroupSummaries gets a reference to the given map[string]GroupsFieldData and assigns it to the GroupSummaries field.
func (o *GroupsGroupResult) SetGroupSummaries(v map[string]GroupsFieldData) {
	o.GroupSummaries = &v
}

func (o GroupsGroupResult) MarshalJSON() ([]byte, error) {
...
func (o GroupsGroupResult) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.EntityResults) {
		toSerialize["entity_results"] = o.EntityResults
	}
	if !IsNil(o.GroupByColumnValue) {
		toSerialize["group_by_column_value"] = o.GroupByColumnValue
	}
	if !IsNil(o.TotalEntityCount) {
		toSerialize["total_entity_count"] = o.TotalEntityCount
	}
	if !IsNil(o.GroupSummaries) {
		toSerialize["group_summaries"] = o.GroupSummaries
	}
...
func (o *GroupsGroupResult) UnmarshalJSON(data []byte) (err error) {
	varGroupsGroupResult := _GroupsGroupResult{}

	err = json.Unmarshal(data, &varGroupsGroupResult)

	if err != nil {
		return err
	}

	*o = GroupsGroupResult(varGroupsGroupResult)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "entity_results")
		delete(additionalProperties, "group_by_column_value")
		delete(additionalProperties, "total_entity_count")
		delete(additionalProperties, "group_summaries")
...
type NullableGroupsGroupResult struct {
	value *GroupsGroupResult
	isSet bool
}

func (v NullableGroupsGroupResult) Get() *GroupsGroupResult {
	return v.value
}

func (v *NullableGroupsGroupResult) Set(val *GroupsGroupResult) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupsGroupResult) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupsGroupResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupsGroupResult(val *GroupsGroupResult) *NullableGroupsGroupResult {
	return &NullableGroupsGroupResult{value: val, isSet: true}
}

func (v NullableGroupsGroupResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupsGroupResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
