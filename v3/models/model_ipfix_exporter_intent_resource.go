...
// checks if the IpfixExporterIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpfixExporterIntentResource{}

// IpfixExporterIntentResource Response object for intentful operations on a ipfix_exporter
type IpfixExporterIntentResource struct {
	Status *IpfixExporterDefStatus `json:"status,omitempty"`
	Spec *IpfixExporter `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata IpfixExporterMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _IpfixExporterIntentResource IpfixExporterIntentResource
...
func NewIpfixExporterIntentResource(metadata IpfixExporterMetadata) *IpfixExporterIntentResource {
	this := IpfixExporterIntentResource{}
...
func (o *IpfixExporterIntentResource) GetStatus() IpfixExporterDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret IpfixExporterDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given IpfixExporterDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given IpfixExporter and assigns it to the Spec field.
...
func (o IpfixExporterIntentResource) MarshalJSON() ([]byte, error) {
...
func (o IpfixExporterIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *IpfixExporterIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varIpfixExporterIntentResource := _IpfixExporterIntentResource{}

	err = json.Unmarshal(data, &varIpfixExporterIntentResource)

	if err != nil {
		return err
	}

	*o = IpfixExporterIntentResource(varIpfixExporterIntentResource)
...
type NullableIpfixExporterIntentResource struct {
	value *IpfixExporterIntentResource
	isSet bool
}

func (v NullableIpfixExporterIntentResource) Get() *IpfixExporterIntentResource {
	return v.value
}

func (v *NullableIpfixExporterIntentResource) Set(val *IpfixExporterIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableIpfixExporterIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableIpfixExporterIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpfixExporterIntentResource(val *IpfixExporterIntentResource) *NullableIpfixExporterIntentResource {
	return &NullableIpfixExporterIntentResource{value: val, isSet: true}
}

func (v NullableIpfixExporterIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpfixExporterIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
