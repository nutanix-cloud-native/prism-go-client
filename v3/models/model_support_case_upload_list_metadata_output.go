...
// checks if the SupportCaseUploadListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseUploadListMetadataOutput{}

// SupportCaseUploadListMetadataOutput All api calls that return a list will have this metadata block 
type SupportCaseUploadListMetadataOutput struct {
	// The kind name
...
type _SupportCaseUploadListMetadataOutput SupportCaseUploadListMetadataOutput
...
func NewSupportCaseUploadListMetadataOutput() *SupportCaseUploadListMetadataOutput {
	this := SupportCaseUploadListMetadataOutput{}
	var kind string = "support_case_upload"
	this.Kind = &kind
	return &this
}
...
func (o *SupportCaseUploadListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *SupportCaseUploadListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o SupportCaseUploadListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseUploadListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseUploadListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varSupportCaseUploadListMetadataOutput := _SupportCaseUploadListMetadataOutput{}

	err = json.Unmarshal(data, &varSupportCaseUploadListMetadataOutput)

	if err != nil {
		return err
	}

	*o = SupportCaseUploadListMetadataOutput(varSupportCaseUploadListMetadataOutput)
...
type NullableSupportCaseUploadListMetadataOutput struct {
	value *SupportCaseUploadListMetadataOutput
	isSet bool
}

func (v NullableSupportCaseUploadListMetadataOutput) Get() *SupportCaseUploadListMetadataOutput {
	return v.value
}

func (v *NullableSupportCaseUploadListMetadataOutput) Set(val *SupportCaseUploadListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseUploadListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseUploadListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseUploadListMetadataOutput(val *SupportCaseUploadListMetadataOutput) *NullableSupportCaseUploadListMetadataOutput {
	return &NullableSupportCaseUploadListMetadataOutput{value: val, isSet: true}
}

func (v NullableSupportCaseUploadListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseUploadListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
