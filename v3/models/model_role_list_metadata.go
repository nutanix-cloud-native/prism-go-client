...
// checks if the RoleListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleListMetadata{}

// RoleListMetadata All api calls that return a list will have this metadata block as input 
...
type _RoleListMetadata RoleListMetadata
...
func (o RoleListMetadata) MarshalJSON() ([]byte, error) {
...
func (o RoleListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RoleListMetadata) UnmarshalJSON(data []byte) (err error) {
	varRoleListMetadata := _RoleListMetadata{}

	err = json.Unmarshal(data, &varRoleListMetadata)

	if err != nil {
		return err
	}

	*o = RoleListMetadata(varRoleListMetadata)
...
type NullableRoleListMetadata struct {
	value *RoleListMetadata
	isSet bool
}

func (v NullableRoleListMetadata) Get() *RoleListMetadata {
	return v.value
}

func (v *NullableRoleListMetadata) Set(val *RoleListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleListMetadata(val *RoleListMetadata) *NullableRoleListMetadata {
	return &NullableRoleListMetadata{value: val, isSet: true}
}

func (v NullableRoleListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
