...
// ActionResult The execution of a single action instance from an action rule. It includes input and output parameters, as well as properties such as execution start time and any errors during execution. 
type ActionResult struct {
	// Index of action instance in action rule.
	ActionInstanceIndex *int64 `json:"action_instance_index,omitempty"`
	ActionTypeReference ActionTypeReference `json:"action_type_reference"`
	// The trigger or action required input parameter value map, or the output parameters. 
	OutputParameterValues *map[string]string `json:"output_parameter_values,omitempty"`
	// the display name
	ActionTypeDisplayName *string `json:"action_type_display_name,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
	...
	InfoMessageList []string `json:"info_message_list,omitempty"`
	// Denotes the timestamp when the action is invoked.
	ExecutionStartTime time.Time `json:"execution_start_time"`
	// The trigger or action required input parameter value map, or the output parameters. 
	InputParameterValues *map[string]string `json:"input_parameter_values,omitempty"`
...
func NewActionResult(actionTypeReference ActionTypeReference, executionStatus string, executionStartTime time.Time) *ActionResult {
	this := ActionResult{}
	this.ActionTypeReference = actionTypeReference
...
// GetActionInstanceIndex returns the ActionInstanceIndex field value if set, zero value otherwise.
func (o *ActionResult) GetActionInstanceIndex() int64 {
	if o == nil || IsNil(o.ActionInstanceIndex) {
		var ret int64
		return ret
	}
	return *o.ActionInstanceIndex
}

// GetActionInstanceIndexOk returns a tuple with the ActionInstanceIndex field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionResult) GetActionInstanceIndexOk() (*int64, bool) {
	if o == nil || IsNil(o.ActionInstanceIndex) {
		return nil, false
	}
	return o.ActionInstanceIndex, true
}
...
// SetActionInstanceIndex gets a reference to the given int64 and assigns it to the ActionInstanceIndex field.
func (o *ActionResult) SetActionInstanceIndex(v int64) {
	o.ActionInstanceIndex = &v
}

// GetActionTypeReference returns the ActionTypeReference field value
func (o *ActionResult) GetActionTypeReference() ActionTypeReference {
	if o == nil {
		var ret ActionTypeReference
		return ret
	}

	return o.ActionTypeReference
}

// GetActionTypeReferenceOk returns a tuple with the ActionTypeReference field value
// and a boolean to check if the value has been set.
func (o *ActionResult) GetActionTypeReferenceOk() (*ActionTypeReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActionTypeReference, true
}

// SetActionTypeReference sets field value
func (o *ActionResult) SetActionTypeReference(v ActionTypeReference) {
	o.ActionTypeReference = v
}

// GetOutputParameterValues returns the OutputParameterValues field value if set, zero value otherwise.
func (o *ActionResult) GetOutputParameterValues() map[string]string {
	if o == nil || IsNil(o.OutputParameterValues) {
		var ret map[string]string
		return ret
	}
	return *o.OutputParameterValues
}

// GetOutputParameterValuesOk returns a tuple with the OutputParameterValues field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionResult) GetOutputParameterValuesOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.OutputParameterValues) {
		return nil, false
	}
	return o.OutputParameterValues, true
}
...
// SetOutputParameterValues gets a reference to the given map[string]string and assigns it to the OutputParameterValues field.
func (o *ActionResult) SetOutputParameterValues(v map[string]string) {
	o.OutputParameterValues = &v
}

// GetActionTypeDisplayName returns the ActionTypeDisplayName field value if set, zero value otherwise.
func (o *ActionResult) GetActionTypeDisplayName() string {
	if o == nil || IsNil(o.ActionTypeDisplayName) {
		var ret string
		return ret
	}
	return *o.ActionTypeDisplayName
}

// GetActionTypeDisplayNameOk returns a tuple with the ActionTypeDisplayName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionResult) GetActionTypeDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.ActionTypeDisplayName) {
		return nil, false
	}
	return o.ActionTypeDisplayName, true
}
...
// SetActionTypeDisplayName gets a reference to the given string and assigns it to the ActionTypeDisplayName field.
func (o *ActionResult) SetActionTypeDisplayName(v string) {
	o.ActionTypeDisplayName = &v
}

// GetErrorMessageList returns the ErrorMessageList field value if set, zero value otherwise.
func (o *ActionResult) GetErrorMessageList() []string {
	if o == nil || IsNil(o.ErrorMessageList) {
		var ret []string
		return ret
	}
	return o.ErrorMessageList
}

// GetErrorMessageListOk returns a tuple with the ErrorMessageList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionResult) GetErrorMessageListOk() ([]string, bool) {
	if o == nil || IsNil(o.ErrorMessageList) {
		return nil, false
	}
	return o.ErrorMessageList, true
}
...
// SetErrorMessageList gets a reference to the given []string and assigns it to the ErrorMessageList field.
func (o *ActionResult) SetErrorMessageList(v []string) {
	o.ErrorMessageList = v
}
...
// GetInfoMessageList returns the InfoMessageList field value if set, zero value otherwise.
func (o *ActionResult) GetInfoMessageList() []string {
	if o == nil || IsNil(o.InfoMessageList) {
		var ret []string
		return ret
	}
	return o.InfoMessageList
}

// GetInfoMessageListOk returns a tuple with the InfoMessageList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionResult) GetInfoMessageListOk() ([]string, bool) {
	if o == nil || IsNil(o.InfoMessageList) {
		return nil, false
	}
	return o.InfoMessageList, true
}
...
// SetInfoMessageList gets a reference to the given []string and assigns it to the InfoMessageList field.
func (o *ActionResult) SetInfoMessageList(v []string) {
	o.InfoMessageList = v
}

// GetExecutionStartTime returns the ExecutionStartTime field value
...
// GetExecutionStartTimeOk returns a tuple with the ExecutionStartTime field value
// and a boolean to check if the value has been set.
...
// SetExecutionStartTime sets field value
func (o *ActionResult) SetExecutionStartTime(v time.Time) {
	o.ExecutionStartTime = v
}

// GetInputParameterValues returns the InputParameterValues field value if set, zero value otherwise.
func (o *ActionResult) GetInputParameterValues() map[string]string {
	if o == nil || IsNil(o.InputParameterValues) {
		var ret map[string]string
		return ret
	}
	return *o.InputParameterValues
}

// GetInputParameterValuesOk returns a tuple with the InputParameterValues field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionResult) GetInputParameterValuesOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.InputParameterValues) {
		return nil, false
	}
	return o.InputParameterValues, true
}
...
// SetInputParameterValues gets a reference to the given map[string]string and assigns it to the InputParameterValues field.
func (o *ActionResult) SetInputParameterValues(v map[string]string) {
	o.InputParameterValues = &v
}
...
func (o ActionResult) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ActionInstanceIndex) {
		toSerialize["action_instance_index"] = o.ActionInstanceIndex
	}
	toSerialize["action_type_reference"] = o.ActionTypeReference
	if !IsNil(o.OutputParameterValues) {
		toSerialize["output_parameter_values"] = o.OutputParameterValues
	}
	if !IsNil(o.ActionTypeDisplayName) {
		toSerialize["action_type_display_name"] = o.ActionTypeDisplayName
	}
	if !IsNil(o.ErrorMessageList) {
		toSerialize["error_message_list"] = o.ErrorMessageList
	}
	toSerialize["execution_status"] = o.ExecutionStatus
	if !IsNil(o.InfoMessageList) {
		toSerialize["info_message_list"] = o.InfoMessageList
	}
	toSerialize["execution_start_time"] = o.ExecutionStartTime
	if !IsNil(o.InputParameterValues) {
		toSerialize["input_parameter_values"] = o.InputParameterValues
	}
...
func (o *ActionResult) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ActionResult(varActionResult)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "action_instance_index")
		delete(additionalProperties, "action_type_reference")
		delete(additionalProperties, "output_parameter_values")
		delete(additionalProperties, "action_type_display_name")
		delete(additionalProperties, "error_message_list")
		delete(additionalProperties, "execution_status")
		delete(additionalProperties, "info_message_list")
		delete(additionalProperties, "execution_start_time")
		delete(additionalProperties, "input_parameter_values")
