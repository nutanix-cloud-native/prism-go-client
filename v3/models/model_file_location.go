...
// FileLocation The reference to a ndfs file location in a cluster
...
type _FileLocation FileLocation
...
func (o *FileLocation) UnmarshalJSON(data []byte) (err error) {
	...
	varFileLocation := _FileLocation{}

	err = json.Unmarshal(data, &varFileLocation)

	if err != nil {
		return err
	}

	*o = FileLocation(varFileLocation)
