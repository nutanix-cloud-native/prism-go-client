...
// Entity The response returned for directory service search operation.
type Entity struct {
	// User or group or OU in the directory service.
	Type *string `json:"type,omitempty"`
	// The name of the entity in canonical format.
	Name *string `json:"name,omitempty"`
	AttributeList []Attribute `json:"attribute_list,omitempty"`
...
// SetAttributeList gets a reference to the given []Attribute and assigns it to the AttributeList field.
...
func (o *Entity) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Entity(varEntity)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "attribute_list")
