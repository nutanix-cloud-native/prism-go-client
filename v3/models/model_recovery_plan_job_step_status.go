...
// checks if the RecoveryPlanJobStepStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobStepStatus{}

// RecoveryPlanJobStepStatus Status of a step in the Recovery Plan Job execution.
type RecoveryPlanJobStepStatus struct {
	// State of a step.
	Status string `json:"status"`
	// Percentage completed for a step.
	PercentageComplete int32 `json:"percentage_complete"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanJobStepStatus RecoveryPlanJobStepStatus
...
func NewRecoveryPlanJobStepStatus(status string, percentageComplete int32) *RecoveryPlanJobStepStatus {
	this := RecoveryPlanJobStepStatus{}
	this.Status = status
...
func (o RecoveryPlanJobStepStatus) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobStepStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobStepStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobStepStatus := _RecoveryPlanJobStepStatus{}

	err = json.Unmarshal(data, &varRecoveryPlanJobStepStatus)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobStepStatus(varRecoveryPlanJobStepStatus)
...
type NullableRecoveryPlanJobStepStatus struct {
	value *RecoveryPlanJobStepStatus
	isSet bool
}

func (v NullableRecoveryPlanJobStepStatus) Get() *RecoveryPlanJobStepStatus {
	return v.value
}

func (v *NullableRecoveryPlanJobStepStatus) Set(val *RecoveryPlanJobStepStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobStepStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobStepStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobStepStatus(val *RecoveryPlanJobStepStatus) *NullableRecoveryPlanJobStepStatus {
	return &NullableRecoveryPlanJobStepStatus{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobStepStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobStepStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
