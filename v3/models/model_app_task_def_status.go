...
// checks if the AppTaskDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskDefStatus{}

// AppTaskDefStatus An intentful representation of a app_task status
type AppTaskDefStatus struct {
	// app_task Name.
	Name string `json:"name"`
	// The state of the app_task.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the app_task, if in an error state.
	...
	Resources AppTaskResourcesDefStatus `json:"resources"`
	// A description for app_task.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AppTaskDefStatus AppTaskDefStatus
...
func (o *AppTaskDefStatus) GetResources() AppTaskResourcesDefStatus {
	if o == nil {
		var ret AppTaskResourcesDefStatus
		return ret
	}
...
func (o AppTaskDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AppTaskDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskDefStatus := _AppTaskDefStatus{}

	err = json.Unmarshal(data, &varAppTaskDefStatus)

	if err != nil {
		return err
	}

	*o = AppTaskDefStatus(varAppTaskDefStatus)
...
type NullableAppTaskDefStatus struct {
	value *AppTaskDefStatus
	isSet bool
}

func (v NullableAppTaskDefStatus) Get() *AppTaskDefStatus {
	return v.value
}

func (v *NullableAppTaskDefStatus) Set(val *AppTaskDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskDefStatus(val *AppTaskDefStatus) *NullableAppTaskDefStatus {
	return &NullableAppTaskDefStatus{value: val, isSet: true}
}

func (v NullableAppTaskDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
