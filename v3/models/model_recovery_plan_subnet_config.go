...
// checks if the RecoveryPlanSubnetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanSubnetConfig{}

// RecoveryPlanSubnetConfig Subnet configuration for network mapping in the Recovery Plan. 
type RecoveryPlanSubnetConfig struct {
	// Configurations for creating Layer2 stretches for the subnet. 
	L2StretchConfig []RecoveryPlanL2StretchConfig `json:"l2_stretch_config,omitempty"`
	...
	GatewayIp string `json:"gateway_ip" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// Prefix length for the subnet. 
	PrefixLength int32 `json:"prefix_length"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanSubnetConfig RecoveryPlanSubnetConfig
...
// GetL2StretchConfig returns the L2StretchConfig field value if set, zero value otherwise.
func (o *RecoveryPlanSubnetConfig) GetL2StretchConfig() []RecoveryPlanL2StretchConfig {
	if o == nil || IsNil(o.L2StretchConfig) {
		var ret []RecoveryPlanL2StretchConfig
		return ret
	}
	return o.L2StretchConfig
}

// GetL2StretchConfigOk returns a tuple with the L2StretchConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanSubnetConfig) GetL2StretchConfigOk() ([]RecoveryPlanL2StretchConfig, bool) {
	if o == nil || IsNil(o.L2StretchConfig) {
		return nil, false
	}
	return o.L2StretchConfig, true
}
...
// SetL2StretchConfig gets a reference to the given []RecoveryPlanL2StretchConfig and assigns it to the L2StretchConfig field.
...
func (o RecoveryPlanSubnetConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanSubnetConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.L2StretchConfig) {
		toSerialize["l2_stretch_config"] = o.L2StretchConfig
	}
...
func (o *RecoveryPlanSubnetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanSubnetConfig := _RecoveryPlanSubnetConfig{}

	err = json.Unmarshal(data, &varRecoveryPlanSubnetConfig)

	if err != nil {
		return err
	}

	*o = RecoveryPlanSubnetConfig(varRecoveryPlanSubnetConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "l2_stretch_config")
...
type NullableRecoveryPlanSubnetConfig struct {
	value *RecoveryPlanSubnetConfig
	isSet bool
}

func (v NullableRecoveryPlanSubnetConfig) Get() *RecoveryPlanSubnetConfig {
	return v.value
}

func (v *NullableRecoveryPlanSubnetConfig) Set(val *RecoveryPlanSubnetConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanSubnetConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanSubnetConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanSubnetConfig(val *RecoveryPlanSubnetConfig) *NullableRecoveryPlanSubnetConfig {
	return &NullableRecoveryPlanSubnetConfig{value: val, isSet: true}
}

func (v NullableRecoveryPlanSubnetConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanSubnetConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
