...
// checks if the VmHostAffinityLegacyPolicyListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityLegacyPolicyListMetadataOutput{}

// VmHostAffinityLegacyPolicyListMetadataOutput All API calls that return a list will have this metadata block. 
type VmHostAffinityLegacyPolicyListMetadataOutput struct {
	// Total matches found.
	TotalMatches *int64 `json:"total_matches,omitempty"`
	// The kind name.
	Kind *string `json:"kind,omitempty"`
	// Number of records retrieved relative to the offset.
...
type _VmHostAffinityLegacyPolicyListMetadataOutput VmHostAffinityLegacyPolicyListMetadataOutput
...
func NewVmHostAffinityLegacyPolicyListMetadataOutput() *VmHostAffinityLegacyPolicyListMetadataOutput {
	this := VmHostAffinityLegacyPolicyListMetadataOutput{}
	var kind string = "vm_host_affinity_legacy_policy"
	this.Kind = &kind
	return &this
}
...
// SetTotalMatches gets a reference to the given int64 and assigns it to the TotalMatches field.
...
func (o VmHostAffinityLegacyPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityLegacyPolicyListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VmHostAffinityLegacyPolicyListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVmHostAffinityLegacyPolicyListMetadataOutput := _VmHostAffinityLegacyPolicyListMetadataOutput{}

	err = json.Unmarshal(data, &varVmHostAffinityLegacyPolicyListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VmHostAffinityLegacyPolicyListMetadataOutput(varVmHostAffinityLegacyPolicyListMetadataOutput)
...
type NullableVmHostAffinityLegacyPolicyListMetadataOutput struct {
	value *VmHostAffinityLegacyPolicyListMetadataOutput
	isSet bool
}

func (v NullableVmHostAffinityLegacyPolicyListMetadataOutput) Get() *VmHostAffinityLegacyPolicyListMetadataOutput {
	return v.value
}

func (v *NullableVmHostAffinityLegacyPolicyListMetadataOutput) Set(val *VmHostAffinityLegacyPolicyListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityLegacyPolicyListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityLegacyPolicyListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityLegacyPolicyListMetadataOutput(val *VmHostAffinityLegacyPolicyListMetadataOutput) *NullableVmHostAffinityLegacyPolicyListMetadataOutput {
	return &NullableVmHostAffinityLegacyPolicyListMetadataOutput{value: val, isSet: true}
}

func (v NullableVmHostAffinityLegacyPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityLegacyPolicyListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
