...
// checks if the ResourceChargeListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceChargeListMetadataOutput{}

// ResourceChargeListMetadataOutput All api calls that return a list will have this metadata block 
...
type _ResourceChargeListMetadataOutput ResourceChargeListMetadataOutput
...
func NewResourceChargeListMetadataOutput() *ResourceChargeListMetadataOutput {
	this := ResourceChargeListMetadataOutput{}
	var kind string = "resource_charge"
	this.Kind = &kind
	return &this
}
...
func (o ResourceChargeListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ResourceChargeListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceChargeListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varResourceChargeListMetadataOutput := _ResourceChargeListMetadataOutput{}

	err = json.Unmarshal(data, &varResourceChargeListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ResourceChargeListMetadataOutput(varResourceChargeListMetadataOutput)
...
type NullableResourceChargeListMetadataOutput struct {
	value *ResourceChargeListMetadataOutput
	isSet bool
}

func (v NullableResourceChargeListMetadataOutput) Get() *ResourceChargeListMetadataOutput {
	return v.value
}

func (v *NullableResourceChargeListMetadataOutput) Set(val *ResourceChargeListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceChargeListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceChargeListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceChargeListMetadataOutput(val *ResourceChargeListMetadataOutput) *NullableResourceChargeListMetadataOutput {
	return &NullableResourceChargeListMetadataOutput{value: val, isSet: true}
}

func (v NullableResourceChargeListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceChargeListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
