...
// checks if the PrismCentralNodesMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralNodesMetadata{}

// PrismCentralNodesMetadata The prism_central_nodes kind metadata
type PrismCentralNodesMetadata struct {
	...
	// Categories for the prism_central_nodes. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the prism_central_nodes. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// prism_central_nodes name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PrismCentralNodesMetadata PrismCentralNodesMetadata
...
func NewPrismCentralNodesMetadata(kind string) *PrismCentralNodesMetadata {
	this := PrismCentralNodesMetadata{}
...
func (o *PrismCentralNodesMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *PrismCentralNodesMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *PrismCentralNodesMetadata) SetName(v string) {
	o.Name = &v
}

func (o PrismCentralNodesMetadata) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralNodesMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *PrismCentralNodesMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varPrismCentralNodesMetadata := _PrismCentralNodesMetadata{}

	err = json.Unmarshal(data, &varPrismCentralNodesMetadata)

	if err != nil {
		return err
	}

	*o = PrismCentralNodesMetadata(varPrismCentralNodesMetadata)
...
type NullablePrismCentralNodesMetadata struct {
	value *PrismCentralNodesMetadata
	isSet bool
}

func (v NullablePrismCentralNodesMetadata) Get() *PrismCentralNodesMetadata {
	return v.value
}

func (v *NullablePrismCentralNodesMetadata) Set(val *PrismCentralNodesMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralNodesMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralNodesMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralNodesMetadata(val *PrismCentralNodesMetadata) *NullablePrismCentralNodesMetadata {
	return &NullablePrismCentralNodesMetadata{value: val, isSet: true}
}

func (v NullablePrismCentralNodesMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralNodesMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
