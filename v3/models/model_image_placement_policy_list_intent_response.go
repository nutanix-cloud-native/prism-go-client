...
// checks if the ImagePlacementPolicyListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyListIntentResponse{}

// ImagePlacementPolicyListIntentResponse Response object for intentful operation of image_placement_policys
type ImagePlacementPolicyListIntentResponse struct {
	Entities []ImagePlacementPolicyIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ImagePlacementPolicyListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ImagePlacementPolicyListIntentResponse ImagePlacementPolicyListIntentResponse
...
func NewImagePlacementPolicyListIntentResponse(apiVersion string, metadata ImagePlacementPolicyListMetadataOutput) *ImagePlacementPolicyListIntentResponse {
	this := ImagePlacementPolicyListIntentResponse{}
...
func (o *ImagePlacementPolicyListIntentResponse) GetEntities() []ImagePlacementPolicyIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []ImagePlacementPolicyIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []ImagePlacementPolicyIntentResource and assigns it to the Entities field.
...
func (o *ImagePlacementPolicyListIntentResponse) GetMetadata() ImagePlacementPolicyListMetadataOutput {
	if o == nil {
		var ret ImagePlacementPolicyListMetadataOutput
		return ret
	}
...
func (o ImagePlacementPolicyListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicyListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varImagePlacementPolicyListIntentResponse := _ImagePlacementPolicyListIntentResponse{}

	err = json.Unmarshal(data, &varImagePlacementPolicyListIntentResponse)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyListIntentResponse(varImagePlacementPolicyListIntentResponse)
...
type NullableImagePlacementPolicyListIntentResponse struct {
	value *ImagePlacementPolicyListIntentResponse
	isSet bool
}

func (v NullableImagePlacementPolicyListIntentResponse) Get() *ImagePlacementPolicyListIntentResponse {
	return v.value
}

func (v *NullableImagePlacementPolicyListIntentResponse) Set(val *ImagePlacementPolicyListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyListIntentResponse(val *ImagePlacementPolicyListIntentResponse) *NullableImagePlacementPolicyListIntentResponse {
	return &NullableImagePlacementPolicyListIntentResponse{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
