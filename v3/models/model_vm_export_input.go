...
// checks if the VmExportInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmExportInput{}

// VmExportInput Input object for the create OVA API. 
type VmExportInput struct {
	// Name of the OVA.
	Name string `json:"name"`
	// File format of disk in OVA.
	DiskFileFormat string `json:"disk_file_format"`
	AdditionalProperties map[string]interface{}
}

type _VmExportInput VmExportInput
...
// GetDiskFileFormat returns the DiskFileFormat field value
func (o *VmExportInput) GetDiskFileFormat() string {
	...
	return o.DiskFileFormat
}

// GetDiskFileFormatOk returns a tuple with the DiskFileFormat field value
// and a boolean to check if the value has been set.
func (o *VmExportInput) GetDiskFileFormatOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DiskFileFormat, true
}

// SetDiskFileFormat sets field value
func (o *VmExportInput) SetDiskFileFormat(v string) {
	o.DiskFileFormat = v
}

func (o VmExportInput) MarshalJSON() ([]byte, error) {
...
func (o VmExportInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	toSerialize["disk_file_format"] = o.DiskFileFormat
...
func (o *VmExportInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVmExportInput := _VmExportInput{}

	err = json.Unmarshal(data, &varVmExportInput)

	if err != nil {
		return err
	}

	*o = VmExportInput(varVmExportInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "name")
		delete(additionalProperties, "disk_file_format")
...
type NullableVmExportInput struct {
	value *VmExportInput
	isSet bool
}

func (v NullableVmExportInput) Get() *VmExportInput {
	return v.value
}

func (v *NullableVmExportInput) Set(val *VmExportInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmExportInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmExportInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmExportInput(val *VmExportInput) *NullableVmExportInput {
	return &NullableVmExportInput{value: val, isSet: true}
}

func (v NullableVmExportInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmExportInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
