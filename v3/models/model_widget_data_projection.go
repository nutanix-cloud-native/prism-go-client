...
// checks if the WidgetDataProjection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WidgetDataProjection{}

// WidgetDataProjection Filtering, sorting and limit properties for the data to collected.
type WidgetDataProjection struct {
...
type _WidgetDataProjection WidgetDataProjection
...
func (o WidgetDataProjection) MarshalJSON() ([]byte, error) {
...
func (o WidgetDataProjection) ToMap() (map[string]interface{}, error) {
...
func (o *WidgetDataProjection) UnmarshalJSON(data []byte) (err error) {
	varWidgetDataProjection := _WidgetDataProjection{}

	err = json.Unmarshal(data, &varWidgetDataProjection)

	if err != nil {
		return err
	}

	*o = WidgetDataProjection(varWidgetDataProjection)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "sort_column")
...
type NullableWidgetDataProjection struct {
	value *WidgetDataProjection
	isSet bool
}

func (v NullableWidgetDataProjection) Get() *WidgetDataProjection {
	return v.value
}

func (v *NullableWidgetDataProjection) Set(val *WidgetDataProjection) {
	v.value = val
	v.isSet = true
}

func (v NullableWidgetDataProjection) IsSet() bool {
	return v.isSet
}

func (v *NullableWidgetDataProjection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWidgetDataProjection(val *WidgetDataProjection) *NullableWidgetDataProjection {
	return &NullableWidgetDataProjection{value: val, isSet: true}
}

func (v NullableWidgetDataProjection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWidgetDataProjection) UnmarshalJSON(src []byte) error {
	v.isSet = true
