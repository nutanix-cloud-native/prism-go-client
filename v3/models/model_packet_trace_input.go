...
// checks if the PacketTraceInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PacketTraceInput{}

// PacketTraceInput Input parameters to run the packet trace. Required parameters are the source IP Address and destination IP Address. Optional parameters include the source port, destination port, the L4 protocol(TCP/UDP/ICMP), and the ICMP type and ICMP code if the L4 protocol for the trace is ICMP. 
type PacketTraceInput struct {
	// ICMP code
	IcmpCode *int32 `json:"icmp_code,omitempty"`
	// Destination IP Address
	DestinationIp string `json:"destination_ip" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// L4 Protocol
	Protocol *int32 `json:"protocol,omitempty"`
	// Source IP Address
	SourceIp string `json:"source_ip" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// Source port
...
type _PacketTraceInput PacketTraceInput
...
func (o PacketTraceInput) MarshalJSON() ([]byte, error) {
...
func (o PacketTraceInput) ToMap() (map[string]interface{}, error) {
...
func (o *PacketTraceInput) UnmarshalJSON(data []byte) (err error) {
	...
	varPacketTraceInput := _PacketTraceInput{}

	err = json.Unmarshal(data, &varPacketTraceInput)

	if err != nil {
		return err
	}

	*o = PacketTraceInput(varPacketTraceInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "icmp_code")
		...
		delete(additionalProperties, "icmp_type")
...
type NullablePacketTraceInput struct {
	value *PacketTraceInput
	isSet bool
}

func (v NullablePacketTraceInput) Get() *PacketTraceInput {
	return v.value
}

func (v *NullablePacketTraceInput) Set(val *PacketTraceInput) {
	v.value = val
	v.isSet = true
}

func (v NullablePacketTraceInput) IsSet() bool {
	return v.isSet
}

func (v *NullablePacketTraceInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePacketTraceInput(val *PacketTraceInput) *NullablePacketTraceInput {
	return &NullablePacketTraceInput{value: val, isSet: true}
}

func (v NullablePacketTraceInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePacketTraceInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
