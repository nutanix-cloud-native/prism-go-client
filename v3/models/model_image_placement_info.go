...
// checks if the ImagePlacementInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementInfo{}

// ImagePlacementInfo Information about state of the policy
type ImagePlacementInfo struct {
	// The complete list of clusters where the image should ideally be placed as part of this policy. 
	CompletePolicyClusterReferenceList []ClusterReference `json:"complete_policy_cluster_reference_list,omitempty"`
	// The list of clusters where the image has been placed as part of enforcing this policy. 
	EnforcedPolicyClusterReferenceList []ClusterReference `json:"enforced_policy_cluster_reference_list,omitempty"`
	// List of policies that conflict with this policy.
	ConflictingImagePlacementPolicyReferenceList []ImagePlacementPolicyReference `json:"conflicting_image_placement_policy_reference_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ImagePlacementInfo ImagePlacementInfo
...
// GetCompletePolicyClusterReferenceList returns the CompletePolicyClusterReferenceList field value if set, zero value otherwise.
func (o *ImagePlacementInfo) GetCompletePolicyClusterReferenceList() []ClusterReference {
	if o == nil || IsNil(o.CompletePolicyClusterReferenceList) {
		var ret []ClusterReference
		return ret
	}
	return o.CompletePolicyClusterReferenceList
}

// GetCompletePolicyClusterReferenceListOk returns a tuple with the CompletePolicyClusterReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImagePlacementInfo) GetCompletePolicyClusterReferenceListOk() ([]ClusterReference, bool) {
	if o == nil || IsNil(o.CompletePolicyClusterReferenceList) {
		return nil, false
	}
	return o.CompletePolicyClusterReferenceList, true
}
...
// SetCompletePolicyClusterReferenceList gets a reference to the given []ClusterReference and assigns it to the CompletePolicyClusterReferenceList field.
func (o *ImagePlacementInfo) SetCompletePolicyClusterReferenceList(v []ClusterReference) {
	o.CompletePolicyClusterReferenceList = v
}

// GetEnforcedPolicyClusterReferenceList returns the EnforcedPolicyClusterReferenceList field value if set, zero value otherwise.
func (o *ImagePlacementInfo) GetEnforcedPolicyClusterReferenceList() []ClusterReference {
	if o == nil || IsNil(o.EnforcedPolicyClusterReferenceList) {
		var ret []ClusterReference
		return ret
	}
	return o.EnforcedPolicyClusterReferenceList
}

// GetEnforcedPolicyClusterReferenceListOk returns a tuple with the EnforcedPolicyClusterReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImagePlacementInfo) GetEnforcedPolicyClusterReferenceListOk() ([]ClusterReference, bool) {
	if o == nil || IsNil(o.EnforcedPolicyClusterReferenceList) {
		return nil, false
	}
	return o.EnforcedPolicyClusterReferenceList, true
}
...
// SetEnforcedPolicyClusterReferenceList gets a reference to the given []ClusterReference and assigns it to the EnforcedPolicyClusterReferenceList field.
func (o *ImagePlacementInfo) SetEnforcedPolicyClusterReferenceList(v []ClusterReference) {
	o.EnforcedPolicyClusterReferenceList = v
}

// GetConflictingImagePlacementPolicyReferenceList returns the ConflictingImagePlacementPolicyReferenceList field value if set, zero value otherwise.
func (o *ImagePlacementInfo) GetConflictingImagePlacementPolicyReferenceList() []ImagePlacementPolicyReference {
	if o == nil || IsNil(o.ConflictingImagePlacementPolicyReferenceList) {
		var ret []ImagePlacementPolicyReference
		return ret
	}
	return o.ConflictingImagePlacementPolicyReferenceList
}

// GetConflictingImagePlacementPolicyReferenceListOk returns a tuple with the ConflictingImagePlacementPolicyReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImagePlacementInfo) GetConflictingImagePlacementPolicyReferenceListOk() ([]ImagePlacementPolicyReference, bool) {
	if o == nil || IsNil(o.ConflictingImagePlacementPolicyReferenceList) {
		return nil, false
	}
	return o.ConflictingImagePlacementPolicyReferenceList, true
}
...
// SetConflictingImagePlacementPolicyReferenceList gets a reference to the given []ImagePlacementPolicyReference and assigns it to the ConflictingImagePlacementPolicyReferenceList field.
func (o *ImagePlacementInfo) SetConflictingImagePlacementPolicyReferenceList(v []ImagePlacementPolicyReference) {
	o.ConflictingImagePlacementPolicyReferenceList = v
}

func (o ImagePlacementInfo) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CompletePolicyClusterReferenceList) {
		toSerialize["complete_policy_cluster_reference_list"] = o.CompletePolicyClusterReferenceList
	}
	if !IsNil(o.EnforcedPolicyClusterReferenceList) {
		toSerialize["enforced_policy_cluster_reference_list"] = o.EnforcedPolicyClusterReferenceList
	}
	if !IsNil(o.ConflictingImagePlacementPolicyReferenceList) {
		toSerialize["conflicting_image_placement_policy_reference_list"] = o.ConflictingImagePlacementPolicyReferenceList
	}
...
func (o *ImagePlacementInfo) UnmarshalJSON(data []byte) (err error) {
	varImagePlacementInfo := _ImagePlacementInfo{}

	err = json.Unmarshal(data, &varImagePlacementInfo)

	if err != nil {
		return err
	}

	*o = ImagePlacementInfo(varImagePlacementInfo)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "complete_policy_cluster_reference_list")
		delete(additionalProperties, "enforced_policy_cluster_reference_list")
		delete(additionalProperties, "conflicting_image_placement_policy_reference_list")
...
type NullableImagePlacementInfo struct {
	value *ImagePlacementInfo
	isSet bool
}

func (v NullableImagePlacementInfo) Get() *ImagePlacementInfo {
	return v.value
}

func (v *NullableImagePlacementInfo) Set(val *ImagePlacementInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementInfo(val *ImagePlacementInfo) *NullableImagePlacementInfo {
	return &NullableImagePlacementInfo{value: val, isSet: true}
}

func (v NullableImagePlacementInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
