...
// checks if the CategoryMappingDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingDefStatus{}

// CategoryMappingDefStatus An intentful representation of a category_mapping status
type CategoryMappingDefStatus struct {
	// category_mapping Name.
	Name string `json:"name"`
	// The state of the category_mapping.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the category_mapping, if in an error state.
	...
	Resources CategoryMappingResourcesDefStatus `json:"resources"`
	// A description for category_mapping.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CategoryMappingDefStatus CategoryMappingDefStatus
...
func (o *CategoryMappingDefStatus) GetResources() CategoryMappingResourcesDefStatus {
	if o == nil {
		var ret CategoryMappingResourcesDefStatus
		return ret
	}
...
func (o CategoryMappingDefStatus) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryMappingDefStatus := _CategoryMappingDefStatus{}

	err = json.Unmarshal(data, &varCategoryMappingDefStatus)

	if err != nil {
		return err
	}

	*o = CategoryMappingDefStatus(varCategoryMappingDefStatus)
...
type NullableCategoryMappingDefStatus struct {
	value *CategoryMappingDefStatus
	isSet bool
}

func (v NullableCategoryMappingDefStatus) Get() *CategoryMappingDefStatus {
	return v.value
}

func (v *NullableCategoryMappingDefStatus) Set(val *CategoryMappingDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingDefStatus(val *CategoryMappingDefStatus) *NullableCategoryMappingDefStatus {
	return &NullableCategoryMappingDefStatus{value: val, isSet: true}
}

func (v NullableCategoryMappingDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
