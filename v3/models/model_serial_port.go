...
// checks if the SerialPort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SerialPort{}

// SerialPort Indicates the configuration of serial ports of the VM. 
...
func (o SerialPort) MarshalJSON() ([]byte, error) {
...
func (o SerialPort) ToMap() (map[string]interface{}, error) {
...
func (o *SerialPort) UnmarshalJSON(data []byte) (err error) {
	varSerialPort := _SerialPort{}

	err = json.Unmarshal(data, &varSerialPort)

	if err != nil {
		return err
	}

	*o = SerialPort(varSerialPort)
...
type NullableSerialPort struct {
	value *SerialPort
	isSet bool
}

func (v NullableSerialPort) Get() *SerialPort {
	return v.value
}

func (v *NullableSerialPort) Set(val *SerialPort) {
	v.value = val
	v.isSet = true
}

func (v NullableSerialPort) IsSet() bool {
	return v.isSet
}

func (v *NullableSerialPort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSerialPort(val *SerialPort) *NullableSerialPort {
	return &NullableSerialPort{value: val, isSet: true}
}

func (v NullableSerialPort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSerialPort) UnmarshalJSON(src []byte) error {
	v.isSet = true
