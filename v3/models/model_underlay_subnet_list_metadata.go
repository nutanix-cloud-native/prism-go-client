...
// checks if the UnderlaySubnetListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnetListMetadata{}

// UnderlaySubnetListMetadata All api calls that return a list will have this metadata block as input 
type UnderlaySubnetListMetadata struct {
	// The kind name
...
type _UnderlaySubnetListMetadata UnderlaySubnetListMetadata
...
func NewUnderlaySubnetListMetadata() *UnderlaySubnetListMetadata {
	this := UnderlaySubnetListMetadata{}
...
func (o UnderlaySubnetListMetadata) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnetListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *UnderlaySubnetListMetadata) UnmarshalJSON(data []byte) (err error) {
	varUnderlaySubnetListMetadata := _UnderlaySubnetListMetadata{}

	err = json.Unmarshal(data, &varUnderlaySubnetListMetadata)

	if err != nil {
		return err
	}

	*o = UnderlaySubnetListMetadata(varUnderlaySubnetListMetadata)
...
type NullableUnderlaySubnetListMetadata struct {
	value *UnderlaySubnetListMetadata
	isSet bool
}

func (v NullableUnderlaySubnetListMetadata) Get() *UnderlaySubnetListMetadata {
	return v.value
}

func (v *NullableUnderlaySubnetListMetadata) Set(val *UnderlaySubnetListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnetListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnetListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnetListMetadata(val *UnderlaySubnetListMetadata) *NullableUnderlaySubnetListMetadata {
	return &NullableUnderlaySubnetListMetadata{value: val, isSet: true}
}

func (v NullableUnderlaySubnetListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnetListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
