...
// StoragePolicy An intentful representation of storage policy spec
type StoragePolicy struct {
	// Storage policy name
	Name string `json:"name"`
	Resources StoragePolicyResources `json:"resources"`
...
func (o *StoragePolicy) GetResources() StoragePolicyResources {
	if o == nil {
		var ret StoragePolicyResources
		return ret
	}
...
func (o *StoragePolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStoragePolicy)
