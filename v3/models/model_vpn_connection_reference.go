...
// checks if the VpnConnectionReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionReference{}

// VpnConnectionReference The reference to a vpn_connection
...
type _VpnConnectionReference VpnConnectionReference
...
func (o VpnConnectionReference) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionReference) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnectionReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnConnectionReference := _VpnConnectionReference{}

	err = json.Unmarshal(data, &varVpnConnectionReference)

	if err != nil {
		return err
	}

	*o = VpnConnectionReference(varVpnConnectionReference)
...
type NullableVpnConnectionReference struct {
	value *VpnConnectionReference
	isSet bool
}

func (v NullableVpnConnectionReference) Get() *VpnConnectionReference {
	return v.value
}

func (v *NullableVpnConnectionReference) Set(val *VpnConnectionReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionReference(val *VpnConnectionReference) *NullableVpnConnectionReference {
	return &NullableVpnConnectionReference{value: val, isSet: true}
}

func (v NullableVpnConnectionReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
