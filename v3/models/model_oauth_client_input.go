...
// checks if the OauthClientInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthClientInput{}
...
type _OauthClientInput OauthClientInput
...
// GetDefaultScopes returns the DefaultScopes field value
...
// GetDefaultScopesOk returns a tuple with the DefaultScopes field value
// and a boolean to check if the value has been set.
...
// SetDefaultScopes sets field value
func (o *OauthClientInput) SetDefaultScopes(v []string) {
	o.DefaultScopes = v
}

func (o OauthClientInput) MarshalJSON() ([]byte, error) {
...
func (o OauthClientInput) ToMap() (map[string]interface{}, error) {
...
func (o *OauthClientInput) UnmarshalJSON(data []byte) (err error) {
	...
	varOauthClientInput := _OauthClientInput{}

	err = json.Unmarshal(data, &varOauthClientInput)

	if err != nil {
		return err
	}

	*o = OauthClientInput(varOauthClientInput)
...
type NullableOauthClientInput struct {
	value *OauthClientInput
	isSet bool
}

func (v NullableOauthClientInput) Get() *OauthClientInput {
	return v.value
}

func (v *NullableOauthClientInput) Set(val *OauthClientInput) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthClientInput) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthClientInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthClientInput(val *OauthClientInput) *NullableOauthClientInput {
	return &NullableOauthClientInput{value: val, isSet: true}
}

func (v NullableOauthClientInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthClientInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
