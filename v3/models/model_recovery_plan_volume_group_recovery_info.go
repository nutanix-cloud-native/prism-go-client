...
// checks if the RecoveryPlanVolumeGroupRecoveryInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanVolumeGroupRecoveryInfo{}

// RecoveryPlanVolumeGroupRecoveryInfo Information about Volume Groups to be recovered.
type RecoveryPlanVolumeGroupRecoveryInfo struct {
	...
	VolumeGroupConfigInfoList []RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner `json:"volume_group_config_info_list,omitempty"`
...
type _RecoveryPlanVolumeGroupRecoveryInfo RecoveryPlanVolumeGroupRecoveryInfo
...
func NewRecoveryPlanVolumeGroupRecoveryInfo() *RecoveryPlanVolumeGroupRecoveryInfo {
	this := RecoveryPlanVolumeGroupRecoveryInfo{}
	return &this
}
...
// GetVolumeGroupConfigInfoList returns the VolumeGroupConfigInfoList field value if set, zero value otherwise.
func (o *RecoveryPlanVolumeGroupRecoveryInfo) GetVolumeGroupConfigInfoList() []RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner {
	if o == nil || IsNil(o.VolumeGroupConfigInfoList) {
		var ret []RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner
		return ret
	}
	return o.VolumeGroupConfigInfoList
}

// GetVolumeGroupConfigInfoListOk returns a tuple with the VolumeGroupConfigInfoList field value if set, nil otherwise
...
func (o *RecoveryPlanVolumeGroupRecoveryInfo) GetVolumeGroupConfigInfoListOk() ([]RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner, bool) {
	...
	return o.VolumeGroupConfigInfoList, true
}
...
// SetVolumeGroupConfigInfoList gets a reference to the given []RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner and assigns it to the VolumeGroupConfigInfoList field.
...
// SetVolumeGroupReference gets a reference to the given VolumeGroupReference and assigns it to the VolumeGroupReference field.
func (o *RecoveryPlanVolumeGroupRecoveryInfo) SetVolumeGroupReference(v VolumeGroupReference) {
	o.VolumeGroupReference = &v
}

func (o RecoveryPlanVolumeGroupRecoveryInfo) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanVolumeGroupRecoveryInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VolumeGroupConfigInfoList) {
		toSerialize["volume_group_config_info_list"] = o.VolumeGroupConfigInfoList
	}
...
func (o *RecoveryPlanVolumeGroupRecoveryInfo) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanVolumeGroupRecoveryInfo := _RecoveryPlanVolumeGroupRecoveryInfo{}

	err = json.Unmarshal(data, &varRecoveryPlanVolumeGroupRecoveryInfo)

	if err != nil {
		return err
	}

	*o = RecoveryPlanVolumeGroupRecoveryInfo(varRecoveryPlanVolumeGroupRecoveryInfo)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "volume_group_config_info_list")
...
type NullableRecoveryPlanVolumeGroupRecoveryInfo struct {
	value *RecoveryPlanVolumeGroupRecoveryInfo
	isSet bool
}

func (v NullableRecoveryPlanVolumeGroupRecoveryInfo) Get() *RecoveryPlanVolumeGroupRecoveryInfo {
	return v.value
}

func (v *NullableRecoveryPlanVolumeGroupRecoveryInfo) Set(val *RecoveryPlanVolumeGroupRecoveryInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanVolumeGroupRecoveryInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanVolumeGroupRecoveryInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanVolumeGroupRecoveryInfo(val *RecoveryPlanVolumeGroupRecoveryInfo) *NullableRecoveryPlanVolumeGroupRecoveryInfo {
	return &NullableRecoveryPlanVolumeGroupRecoveryInfo{value: val, isSet: true}
}

func (v NullableRecoveryPlanVolumeGroupRecoveryInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanVolumeGroupRecoveryInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
