...
// checks if the GenericResourceSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenericResourceSpec{}

// GenericResourceSpec ResourceSpec Object.
type GenericResourceSpec struct {
	SsdGb *float32 `json:"ssd_gb,omitempty"`
	HddGb *float32 `json:"hdd_gb,omitempty"`
...
type _GenericResourceSpec GenericResourceSpec
...
// GetSsdGb returns the SsdGb field value if set, zero value otherwise.
func (o *GenericResourceSpec) GetSsdGb() float32 {
	if o == nil || IsNil(o.SsdGb) {
		var ret float32
		return ret
	}
	return *o.SsdGb
...
// GetSsdGbOk returns a tuple with the SsdGb field value if set, nil otherwise
...
// SetSsdGb gets a reference to the given float32 and assigns it to the SsdGb field.
func (o *GenericResourceSpec) SetSsdGb(v float32) {
	o.SsdGb = &v
}

// GetHddGb returns the HddGb field value if set, zero value otherwise.
func (o *GenericResourceSpec) GetHddGb() float32 {
	if o == nil || IsNil(o.HddGb) {
		var ret float32
		return ret
	}
	return *o.HddGb
...
// GetHddGbOk returns a tuple with the HddGb field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetHddGb gets a reference to the given float32 and assigns it to the HddGb field.
func (o *GenericResourceSpec) SetHddGb(v float32) {
	o.HddGb = &v
}

// GetCpuGhz returns the CpuGhz field value if set, zero value otherwise.
func (o *GenericResourceSpec) GetCpuGhz() float32 {
	if o == nil || IsNil(o.CpuGhz) {
		var ret float32
		return ret
	}
	return *o.CpuGhz
...
// GetCpuGhzOk returns a tuple with the CpuGhz field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GenericResourceSpec) GetCpuGhzOk() (*float32, bool) {
	if o == nil || IsNil(o.CpuGhz) {
		return nil, false
	}
	return o.CpuGhz, true
}
...
// SetCpuGhz gets a reference to the given float32 and assigns it to the CpuGhz field.
...
func (o GenericResourceSpec) MarshalJSON() ([]byte, error) {
...
func (o GenericResourceSpec) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SsdGb) {
		toSerialize["ssd_gb"] = o.SsdGb
	}
	if !IsNil(o.HddGb) {
		toSerialize["hdd_gb"] = o.HddGb
	}
	if !IsNil(o.CpuGhz) {
		toSerialize["cpu_ghz"] = o.CpuGhz
	}
	if !IsNil(o.RamGb) {
...
func (o *GenericResourceSpec) UnmarshalJSON(data []byte) (err error) {
	varGenericResourceSpec := _GenericResourceSpec{}

	err = json.Unmarshal(data, &varGenericResourceSpec)

	if err != nil {
		return err
	}

	*o = GenericResourceSpec(varGenericResourceSpec)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "ssd_gb")
		delete(additionalProperties, "hdd_gb")
		delete(additionalProperties, "cpu_ghz")
		delete(additionalProperties, "ram_gb")
...
type NullableGenericResourceSpec struct {
	value *GenericResourceSpec
	isSet bool
}

func (v NullableGenericResourceSpec) Get() *GenericResourceSpec {
	return v.value
}

func (v *NullableGenericResourceSpec) Set(val *GenericResourceSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableGenericResourceSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableGenericResourceSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenericResourceSpec(val *GenericResourceSpec) *NullableGenericResourceSpec {
	return &NullableGenericResourceSpec{value: val, isSet: true}
}

func (v NullableGenericResourceSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenericResourceSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
