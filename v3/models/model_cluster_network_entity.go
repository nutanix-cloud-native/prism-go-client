...
// checks if the ClusterNetworkEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterNetworkEntity{}

// ClusterNetworkEntity This defines a generic network entity on the cluster, which includes it's address, authentication details, and related metadata. 
...
type _ClusterNetworkEntity ClusterNetworkEntity
...
// GetProxyTypeList returns the ProxyTypeList field value if set, zero value otherwise.
func (o *ClusterNetworkEntity) GetProxyTypeList() []string {
	if o == nil || IsNil(o.ProxyTypeList) {
		var ret []string
		return ret
	}
	return o.ProxyTypeList
}

// GetProxyTypeListOk returns a tuple with the ProxyTypeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterNetworkEntity) GetProxyTypeListOk() ([]string, bool) {
	if o == nil || IsNil(o.ProxyTypeList) {
		return nil, false
	}
	return o.ProxyTypeList, true
}
...
// SetProxyTypeList gets a reference to the given []string and assigns it to the ProxyTypeList field.
...
func (o ClusterNetworkEntity) MarshalJSON() ([]byte, error) {
...
func (o ClusterNetworkEntity) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ProxyTypeList) {
		toSerialize["proxy_type_list"] = o.ProxyTypeList
	}
...
func (o *ClusterNetworkEntity) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterNetworkEntity := _ClusterNetworkEntity{}

	err = json.Unmarshal(data, &varClusterNetworkEntity)

	if err != nil {
		return err
	}

	*o = ClusterNetworkEntity(varClusterNetworkEntity)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "proxy_type_list")
...
type NullableClusterNetworkEntity struct {
	value *ClusterNetworkEntity
	isSet bool
}

func (v NullableClusterNetworkEntity) Get() *ClusterNetworkEntity {
	return v.value
}

func (v *NullableClusterNetworkEntity) Set(val *ClusterNetworkEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterNetworkEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterNetworkEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterNetworkEntity(val *ClusterNetworkEntity) *NullableClusterNetworkEntity {
	return &NullableClusterNetworkEntity{value: val, isSet: true}
}

func (v NullableClusterNetworkEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterNetworkEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
