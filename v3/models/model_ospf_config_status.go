...
// checks if the OspfConfigStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OspfConfigStatus{}

// OspfConfigStatus OSPF configuration status for route peering with internal routers. 
type OspfConfigStatus struct {
	// OSPF authentication type.
	AuthenticationType *string `json:"authentication_type,omitempty"`
	// OSPF area id of this gateway.
	AreaId *string `json:"area_id,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
...
type _OspfConfigStatus OspfConfigStatus
...
func (o OspfConfigStatus) MarshalJSON() ([]byte, error) {
...
func (o OspfConfigStatus) ToMap() (map[string]interface{}, error) {
...
func (o *OspfConfigStatus) UnmarshalJSON(data []byte) (err error) {
	varOspfConfigStatus := _OspfConfigStatus{}

	err = json.Unmarshal(data, &varOspfConfigStatus)

	if err != nil {
		return err
	}

	*o = OspfConfigStatus(varOspfConfigStatus)
...
type NullableOspfConfigStatus struct {
	value *OspfConfigStatus
	isSet bool
}

func (v NullableOspfConfigStatus) Get() *OspfConfigStatus {
	return v.value
}

func (v *NullableOspfConfigStatus) Set(val *OspfConfigStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableOspfConfigStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableOspfConfigStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOspfConfigStatus(val *OspfConfigStatus) *NullableOspfConfigStatus {
	return &NullableOspfConfigStatus{value: val, isSet: true}
}

func (v NullableOspfConfigStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOspfConfigStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
