...
// checks if the PortRangeStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PortRangeStatus{}

// PortRangeStatus Range of TCP/UDP ports.
...
type _PortRangeStatus PortRangeStatus
...
func (o PortRangeStatus) MarshalJSON() ([]byte, error) {
...
func (o PortRangeStatus) ToMap() (map[string]interface{}, error) {
...
func (o *PortRangeStatus) UnmarshalJSON(data []byte) (err error) {
	varPortRangeStatus := _PortRangeStatus{}

	err = json.Unmarshal(data, &varPortRangeStatus)

	if err != nil {
		return err
	}

	*o = PortRangeStatus(varPortRangeStatus)
...
type NullablePortRangeStatus struct {
	value *PortRangeStatus
	isSet bool
}

func (v NullablePortRangeStatus) Get() *PortRangeStatus {
	return v.value
}

func (v *NullablePortRangeStatus) Set(val *PortRangeStatus) {
	v.value = val
	v.isSet = true
}

func (v NullablePortRangeStatus) IsSet() bool {
	return v.isSet
}

func (v *NullablePortRangeStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePortRangeStatus(val *PortRangeStatus) *NullablePortRangeStatus {
	return &NullablePortRangeStatus{value: val, isSet: true}
}

func (v NullablePortRangeStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePortRangeStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
