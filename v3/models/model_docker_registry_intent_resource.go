...
// checks if the DockerRegistryIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryIntentResource{}

// DockerRegistryIntentResource Response object for intentful operations on a docker_registry
...
type _DockerRegistryIntentResource DockerRegistryIntentResource
...
func NewDockerRegistryIntentResource(metadata DockerRegistryMetadata) *DockerRegistryIntentResource {
	this := DockerRegistryIntentResource{}
...
func (o DockerRegistryIntentResource) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerRegistryIntentResource := _DockerRegistryIntentResource{}

	err = json.Unmarshal(data, &varDockerRegistryIntentResource)

	if err != nil {
		return err
	}

	*o = DockerRegistryIntentResource(varDockerRegistryIntentResource)
...
type NullableDockerRegistryIntentResource struct {
	value *DockerRegistryIntentResource
	isSet bool
}

func (v NullableDockerRegistryIntentResource) Get() *DockerRegistryIntentResource {
	return v.value
}

func (v *NullableDockerRegistryIntentResource) Set(val *DockerRegistryIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryIntentResource(val *DockerRegistryIntentResource) *NullableDockerRegistryIntentResource {
	return &NullableDockerRegistryIntentResource{value: val, isSet: true}
}

func (v NullableDockerRegistryIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
