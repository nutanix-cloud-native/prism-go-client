...
// checks if the Icmp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Icmp{}

// Icmp ICMP parameters to be matched in routing policy.
type Icmp struct {
...
func (o Icmp) MarshalJSON() ([]byte, error) {
...
func (o Icmp) ToMap() (map[string]interface{}, error) {
...
func (o *Icmp) UnmarshalJSON(data []byte) (err error) {
	varIcmp := _Icmp{}

	err = json.Unmarshal(data, &varIcmp)
...
type NullableIcmp struct {
	value *Icmp
	isSet bool
}

func (v NullableIcmp) Get() *Icmp {
	return v.value
}

func (v *NullableIcmp) Set(val *Icmp) {
	v.value = val
	v.isSet = true
}

func (v NullableIcmp) IsSet() bool {
	return v.isSet
}

func (v *NullableIcmp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIcmp(val *Icmp) *NullableIcmp {
	return &NullableIcmp{value: val, isSet: true}
}

func (v NullableIcmp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIcmp) UnmarshalJSON(src []byte) error {
	v.isSet = true
