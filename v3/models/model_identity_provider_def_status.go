...
// checks if the IdentityProviderDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderDefStatus{}

// IdentityProviderDefStatus Details of the identity provider.
type IdentityProviderDefStatus struct {
	// Identity Provider name.
	Name string `json:"name"`
	Resources IdentityProviderDefStatusResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _IdentityProviderDefStatus IdentityProviderDefStatus
...
func NewIdentityProviderDefStatus(name string, resources IdentityProviderDefStatusResources) *IdentityProviderDefStatus {
	this := IdentityProviderDefStatus{}
	this.Name = name
...
func (o *IdentityProviderDefStatus) GetResources() IdentityProviderDefStatusResources {
	if o == nil {
		var ret IdentityProviderDefStatusResources
		return ret
	}
...
func (o IdentityProviderDefStatus) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProviderDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varIdentityProviderDefStatus := _IdentityProviderDefStatus{}

	err = json.Unmarshal(data, &varIdentityProviderDefStatus)

	if err != nil {
		return err
	}

	*o = IdentityProviderDefStatus(varIdentityProviderDefStatus)
...
type NullableIdentityProviderDefStatus struct {
	value *IdentityProviderDefStatus
	isSet bool
}

func (v NullableIdentityProviderDefStatus) Get() *IdentityProviderDefStatus {
	return v.value
}

func (v *NullableIdentityProviderDefStatus) Set(val *IdentityProviderDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderDefStatus(val *IdentityProviderDefStatus) *NullableIdentityProviderDefStatus {
	return &NullableIdentityProviderDefStatus{value: val, isSet: true}
}

func (v NullableIdentityProviderDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
