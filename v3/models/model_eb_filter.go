...
// checks if the EbFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EbFilter{}

// EbFilter Entitybrowser filter object definition.
type EbFilter struct {
	// Right hand side of the filter expression.
	Rhs *string `json:"rhs,omitempty"`
	// Alias for LHS of the filter expression. Used for Backend to tell UI if the filter name UI use to do group does not equal to actual one showing search bar and filter panel. 
	AliasForLhs *string `json:"alias_for_lhs,omitempty"`
	...
	// Display for RHS value of the filter expression.
	DisplayForRhs *string `json:"display_for_rhs,omitempty"`
	// Filter Display name.
	FilterName *string `json:"filter_name,omitempty"`
	// Operator that is being used in filter.
	Operator *string `json:"operator,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _EbFilter EbFilter
...
// GetRhs returns the Rhs field value if set, zero value otherwise.
func (o *EbFilter) GetRhs() string {
	if o == nil || IsNil(o.Rhs) {
		var ret string
		return ret
	}
	return *o.Rhs
...
// GetRhsOk returns a tuple with the Rhs field value if set, nil otherwise
...
// SetRhs gets a reference to the given string and assigns it to the Rhs field.
func (o *EbFilter) SetRhs(v string) {
	o.Rhs = &v
}

// GetAliasForLhs returns the AliasForLhs field value if set, zero value otherwise.
func (o *EbFilter) GetAliasForLhs() string {
	if o == nil || IsNil(o.AliasForLhs) {
		var ret string
		return ret
	}
	return *o.AliasForLhs
}

// GetAliasForLhsOk returns a tuple with the AliasForLhs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EbFilter) GetAliasForLhsOk() (*string, bool) {
	if o == nil || IsNil(o.AliasForLhs) {
		return nil, false
	}
	return o.AliasForLhs, true
}
...
// SetAliasForLhs gets a reference to the given string and assigns it to the AliasForLhs field.
func (o *EbFilter) SetAliasForLhs(v string) {
	o.AliasForLhs = &v
}

// GetDisplayForOperator returns the DisplayForOperator field value if set, zero value otherwise.
func (o *EbFilter) GetDisplayForOperator() string {
	if o == nil || IsNil(o.DisplayForOperator) {
		var ret string
		return ret
	}
	return *o.DisplayForOperator
}

// GetDisplayForOperatorOk returns a tuple with the DisplayForOperator field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EbFilter) GetDisplayForOperatorOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayForOperator) {
		return nil, false
	}
	return o.DisplayForOperator, true
}
...
// SetDisplayForOperator gets a reference to the given string and assigns it to the DisplayForOperator field.
func (o *EbFilter) SetDisplayForOperator(v string) {
	o.DisplayForOperator = &v
}

// GetLhs returns the Lhs field value if set, zero value otherwise.
func (o *EbFilter) GetLhs() string {
	if o == nil || IsNil(o.Lhs) {
		var ret string
		return ret
	}
	return *o.Lhs
...
// GetLhsOk returns a tuple with the Lhs field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetLhs gets a reference to the given string and assigns it to the Lhs field.
func (o *EbFilter) SetLhs(v string) {
	o.Lhs = &v
}

// GetDisplayForRhs returns the DisplayForRhs field value if set, zero value otherwise.
func (o *EbFilter) GetDisplayForRhs() string {
	if o == nil || IsNil(o.DisplayForRhs) {
		var ret string
		return ret
	}
	return *o.DisplayForRhs
}

// GetDisplayForRhsOk returns a tuple with the DisplayForRhs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EbFilter) GetDisplayForRhsOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayForRhs) {
		return nil, false
	}
	return o.DisplayForRhs, true
}
...
// SetDisplayForRhs gets a reference to the given string and assigns it to the DisplayForRhs field.
...
func (o EbFilter) MarshalJSON() ([]byte, error) {
...
func (o EbFilter) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Rhs) {
		toSerialize["rhs"] = o.Rhs
	}
	if !IsNil(o.AliasForLhs) {
		toSerialize["alias_for_lhs"] = o.AliasForLhs
	}
	if !IsNil(o.DisplayForOperator) {
		toSerialize["display_for_operator"] = o.DisplayForOperator
	}
	if !IsNil(o.Lhs) {
		toSerialize["lhs"] = o.Lhs
	}
	if !IsNil(o.DisplayForRhs) {
		toSerialize["display_for_rhs"] = o.DisplayForRhs
	}
...
func (o *EbFilter) UnmarshalJSON(data []byte) (err error) {
	varEbFilter := _EbFilter{}

	err = json.Unmarshal(data, &varEbFilter)

	if err != nil {
		return err
	}

	*o = EbFilter(varEbFilter)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "rhs")
		delete(additionalProperties, "alias_for_lhs")
		delete(additionalProperties, "display_for_operator")
		delete(additionalProperties, "lhs")
		delete(additionalProperties, "display_for_rhs")
		delete(additionalProperties, "filter_name")
...
type NullableEbFilter struct {
	value *EbFilter
	isSet bool
}

func (v NullableEbFilter) Get() *EbFilter {
	return v.value
}

func (v *NullableEbFilter) Set(val *EbFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableEbFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableEbFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEbFilter(val *EbFilter) *NullableEbFilter {
	return &NullableEbFilter{value: val, isSet: true}
}

func (v NullableEbFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEbFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
