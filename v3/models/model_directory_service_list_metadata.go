...
// checks if the DirectoryServiceListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceListMetadata{}
...
type _DirectoryServiceListMetadata DirectoryServiceListMetadata
...
func NewDirectoryServiceListMetadata() *DirectoryServiceListMetadata {
	this := DirectoryServiceListMetadata{}
...
func (o DirectoryServiceListMetadata) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryServiceListMetadata) UnmarshalJSON(data []byte) (err error) {
	varDirectoryServiceListMetadata := _DirectoryServiceListMetadata{}

	err = json.Unmarshal(data, &varDirectoryServiceListMetadata)

	if err != nil {
		return err
	}

	*o = DirectoryServiceListMetadata(varDirectoryServiceListMetadata)
...
type NullableDirectoryServiceListMetadata struct {
	value *DirectoryServiceListMetadata
	isSet bool
}

func (v NullableDirectoryServiceListMetadata) Get() *DirectoryServiceListMetadata {
	return v.value
}

func (v *NullableDirectoryServiceListMetadata) Set(val *DirectoryServiceListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceListMetadata(val *DirectoryServiceListMetadata) *NullableDirectoryServiceListMetadata {
	return &NullableDirectoryServiceListMetadata{value: val, isSet: true}
}

func (v NullableDirectoryServiceListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
