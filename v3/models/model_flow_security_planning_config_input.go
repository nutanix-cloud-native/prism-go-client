...
// checks if the FlowSecurityPlanningConfigInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlowSecurityPlanningConfigInput{}

// FlowSecurityPlanningConfigInput Input to configure Security Planning.
type FlowSecurityPlanningConfigInput struct {
	DataCollectorConfig *DataCollectorConfig `json:"data_collector_config,omitempty"`
	// The desired state of Security Planning.
	State *string `json:"state,omitempty"`
	EpochConfig *EpochConfig `json:"epoch_config,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FlowSecurityPlanningConfigInput FlowSecurityPlanningConfigInput
...
func NewFlowSecurityPlanningConfigInput() *FlowSecurityPlanningConfigInput {
	this := FlowSecurityPlanningConfigInput{}
	return &this
}
...
// GetDataCollectorConfig returns the DataCollectorConfig field value if set, zero value otherwise.
func (o *FlowSecurityPlanningConfigInput) GetDataCollectorConfig() DataCollectorConfig {
	if o == nil || IsNil(o.DataCollectorConfig) {
		var ret DataCollectorConfig
		return ret
	}
	return *o.DataCollectorConfig
}

// GetDataCollectorConfigOk returns a tuple with the DataCollectorConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlowSecurityPlanningConfigInput) GetDataCollectorConfigOk() (*DataCollectorConfig, bool) {
	if o == nil || IsNil(o.DataCollectorConfig) {
		return nil, false
	}
	return o.DataCollectorConfig, true
}
...
// SetDataCollectorConfig gets a reference to the given DataCollectorConfig and assigns it to the DataCollectorConfig field.
func (o *FlowSecurityPlanningConfigInput) SetDataCollectorConfig(v DataCollectorConfig) {
	o.DataCollectorConfig = &v
}
...
// GetEpochConfig returns the EpochConfig field value if set, zero value otherwise.
func (o *FlowSecurityPlanningConfigInput) GetEpochConfig() EpochConfig {
	if o == nil || IsNil(o.EpochConfig) {
		var ret EpochConfig
		return ret
	}
	return *o.EpochConfig
}

// GetEpochConfigOk returns a tuple with the EpochConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlowSecurityPlanningConfigInput) GetEpochConfigOk() (*EpochConfig, bool) {
	if o == nil || IsNil(o.EpochConfig) {
		return nil, false
	}
	return o.EpochConfig, true
}
...
// SetEpochConfig gets a reference to the given EpochConfig and assigns it to the EpochConfig field.
func (o *FlowSecurityPlanningConfigInput) SetEpochConfig(v EpochConfig) {
	o.EpochConfig = &v
}

func (o FlowSecurityPlanningConfigInput) MarshalJSON() ([]byte, error) {
...
func (o FlowSecurityPlanningConfigInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DataCollectorConfig) {
		toSerialize["data_collector_config"] = o.DataCollectorConfig
	}
	if !IsNil(o.State) {
		toSerialize["state"] = o.State
	}
	if !IsNil(o.EpochConfig) {
		toSerialize["epoch_config"] = o.EpochConfig
	}
...
func (o *FlowSecurityPlanningConfigInput) UnmarshalJSON(data []byte) (err error) {
	varFlowSecurityPlanningConfigInput := _FlowSecurityPlanningConfigInput{}

	err = json.Unmarshal(data, &varFlowSecurityPlanningConfigInput)

	if err != nil {
		return err
	}

	*o = FlowSecurityPlanningConfigInput(varFlowSecurityPlanningConfigInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "data_collector_config")
		delete(additionalProperties, "state")
		delete(additionalProperties, "epoch_config")
...
type NullableFlowSecurityPlanningConfigInput struct {
	value *FlowSecurityPlanningConfigInput
	isSet bool
}

func (v NullableFlowSecurityPlanningConfigInput) Get() *FlowSecurityPlanningConfigInput {
	return v.value
}

func (v *NullableFlowSecurityPlanningConfigInput) Set(val *FlowSecurityPlanningConfigInput) {
	v.value = val
	v.isSet = true
}

func (v NullableFlowSecurityPlanningConfigInput) IsSet() bool {
	return v.isSet
}

func (v *NullableFlowSecurityPlanningConfigInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlowSecurityPlanningConfigInput(val *FlowSecurityPlanningConfigInput) *NullableFlowSecurityPlanningConfigInput {
	return &NullableFlowSecurityPlanningConfigInput{value: val, isSet: true}
}

func (v NullableFlowSecurityPlanningConfigInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlowSecurityPlanningConfigInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
