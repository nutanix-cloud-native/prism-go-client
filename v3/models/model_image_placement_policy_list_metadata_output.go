...
// checks if the ImagePlacementPolicyListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyListMetadataOutput{}

// ImagePlacementPolicyListMetadataOutput All api calls that return a list will have this metadata block 
type ImagePlacementPolicyListMetadataOutput struct {
	// The kind name
...
type _ImagePlacementPolicyListMetadataOutput ImagePlacementPolicyListMetadataOutput
...
func NewImagePlacementPolicyListMetadataOutput() *ImagePlacementPolicyListMetadataOutput {
	this := ImagePlacementPolicyListMetadataOutput{}
	var kind string = "image_placement_policy"
	this.Kind = &kind
	return &this
}
...
func (o *ImagePlacementPolicyListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *ImagePlacementPolicyListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o ImagePlacementPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicyListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varImagePlacementPolicyListMetadataOutput := _ImagePlacementPolicyListMetadataOutput{}

	err = json.Unmarshal(data, &varImagePlacementPolicyListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyListMetadataOutput(varImagePlacementPolicyListMetadataOutput)
...
type NullableImagePlacementPolicyListMetadataOutput struct {
	value *ImagePlacementPolicyListMetadataOutput
	isSet bool
}

func (v NullableImagePlacementPolicyListMetadataOutput) Get() *ImagePlacementPolicyListMetadataOutput {
	return v.value
}

func (v *NullableImagePlacementPolicyListMetadataOutput) Set(val *ImagePlacementPolicyListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyListMetadataOutput(val *ImagePlacementPolicyListMetadataOutput) *NullableImagePlacementPolicyListMetadataOutput {
	return &NullableImagePlacementPolicyListMetadataOutput{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
