...
// checks if the AppSubstrateResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSubstrateResponseDownload{}

// AppSubstrateResponseDownload Substrate info for deployment
type AppSubstrateResponseDownload struct {
	// 
	...
	// 
	ElementList []AppSubstrateElement `json:"element_list,omitempty"`
	// 
	...
	ReadinessProbe *AppSubstrateReadinessProbe `json:"readiness_probe,omitempty"`
	...
	ConfigReference *AppSubstrateReferenceUpload `json:"config_reference,omitempty"`
	// 
	OsType *string `json:"os_type,omitempty"`
	// 
	Type string `json:"type"`
	// Spec of the substrate
	CreateSpec map[string]interface{} `json:"create_spec,omitempty"`
	// List of variables
	VariableList []AppVariableResponse `json:"variable_list"`
	// 
	InstancePowerState *string `json:"instance_power_state,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AppSubstrateResponseDownload AppSubstrateResponseDownload
...
func NewAppSubstrateResponseDownload(actionList []AppActionResponse, uUID string, name string, state string, type_ string, variableList []AppVariableResponse) *AppSubstrateResponseDownload {
	this := AppSubstrateResponseDownload{}
...
// SetPlatformData gets a reference to the given string and assigns it to the PlatformData field.
...
// SetElementList gets a reference to the given []AppSubstrateElement and assigns it to the ElementList field.
...
func (o *AppSubstrateResponseDownload) GetReadinessProbe() AppSubstrateReadinessProbe {
	if o == nil || IsNil(o.ReadinessProbe) {
		var ret AppSubstrateReadinessProbe
		return ret
	}
...
// SetReadinessProbe gets a reference to the given AppSubstrateReadinessProbe and assigns it to the ReadinessProbe field.
...
// SetConfigReference gets a reference to the given AppSubstrateReferenceUpload and assigns it to the ConfigReference field.
...
// SetCreateSpec gets a reference to the given map[string]interface{} and assigns it to the CreateSpec field.
...
// GetInstancePowerState returns the InstancePowerState field value if set, zero value otherwise.
func (o *AppSubstrateResponseDownload) GetInstancePowerState() string {
	if o == nil || IsNil(o.InstancePowerState) {
		var ret string
		return ret
	}
	return *o.InstancePowerState
}

// GetInstancePowerStateOk returns a tuple with the InstancePowerState field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppSubstrateResponseDownload) GetInstancePowerStateOk() (*string, bool) {
	if o == nil || IsNil(o.InstancePowerState) {
		return nil, false
	}
	return o.InstancePowerState, true
}
...
// SetInstancePowerState gets a reference to the given string and assigns it to the InstancePowerState field.
func (o *AppSubstrateResponseDownload) SetInstancePowerState(v string) {
	o.InstancePowerState = &v
}

func (o AppSubstrateResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o AppSubstrateResponseDownload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PlatformData) {
		toSerialize["platform_data"] = o.PlatformData
	}
	if !IsNil(o.InstanceAddress) {
		toSerialize["instance_address"] = o.InstanceAddress
	}
	...
	if !IsNil(o.CreateSpec) {
		toSerialize["create_spec"] = o.CreateSpec
	}
	toSerialize["variable_list"] = o.VariableList
	if !IsNil(o.InstancePowerState) {
		toSerialize["instance_power_state"] = o.InstancePowerState
	}
...
func (o *AppSubstrateResponseDownload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppSubstrateResponseDownload := _AppSubstrateResponseDownload{}

	err = json.Unmarshal(data, &varAppSubstrateResponseDownload)

	if err != nil {
		return err
	}

	*o = AppSubstrateResponseDownload(varAppSubstrateResponseDownload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "platform_data")
		delete(additionalProperties, "instance_address")
		...
		delete(additionalProperties, "create_spec")
		delete(additionalProperties, "variable_list")
		delete(additionalProperties, "instance_power_state")
...
type NullableAppSubstrateResponseDownload struct {
	value *AppSubstrateResponseDownload
	isSet bool
}

func (v NullableAppSubstrateResponseDownload) Get() *AppSubstrateResponseDownload {
	return v.value
}

func (v *NullableAppSubstrateResponseDownload) Set(val *AppSubstrateResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppSubstrateResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppSubstrateResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppSubstrateResponseDownload(val *AppSubstrateResponseDownload) *NullableAppSubstrateResponseDownload {
	return &NullableAppSubstrateResponseDownload{value: val, isSet: true}
}

func (v NullableAppSubstrateResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppSubstrateResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
