...
// checks if the CustomizationSpecMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomizationSpecMetadata{}

// CustomizationSpecMetadata The customization_spec kind metadata
type CustomizationSpecMetadata struct {
	...
	// Categories for the customization_spec. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the customization_spec. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// customization_spec name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CustomizationSpecMetadata CustomizationSpecMetadata
...
func NewCustomizationSpecMetadata(kind string) *CustomizationSpecMetadata {
	this := CustomizationSpecMetadata{}
...
func (o *CustomizationSpecMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *CustomizationSpecMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *CustomizationSpecMetadata) SetName(v string) {
	o.Name = &v
}

func (o CustomizationSpecMetadata) MarshalJSON() ([]byte, error) {
...
func (o CustomizationSpecMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CustomizationSpecMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomizationSpecMetadata := _CustomizationSpecMetadata{}

	err = json.Unmarshal(data, &varCustomizationSpecMetadata)

	if err != nil {
		return err
	}

	*o = CustomizationSpecMetadata(varCustomizationSpecMetadata)
...
type NullableCustomizationSpecMetadata struct {
	value *CustomizationSpecMetadata
	isSet bool
}

func (v NullableCustomizationSpecMetadata) Get() *CustomizationSpecMetadata {
	return v.value
}

func (v *NullableCustomizationSpecMetadata) Set(val *CustomizationSpecMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomizationSpecMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomizationSpecMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomizationSpecMetadata(val *CustomizationSpecMetadata) *NullableCustomizationSpecMetadata {
	return &NullableCustomizationSpecMetadata{value: val, isSet: true}
}

func (v NullableCustomizationSpecMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomizationSpecMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
