...
// checks if the AwsVpcListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVpcListMetadata{}

// AwsVpcListMetadata All api calls that return a list will have this metadata block as input 
type AwsVpcListMetadata struct {
	// The kind name
...
type _AwsVpcListMetadata AwsVpcListMetadata
...
func (o AwsVpcListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsVpcListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVpcListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsVpcListMetadata := _AwsVpcListMetadata{}

	err = json.Unmarshal(data, &varAwsVpcListMetadata)

	if err != nil {
		return err
	}

	*o = AwsVpcListMetadata(varAwsVpcListMetadata)
...
type NullableAwsVpcListMetadata struct {
	value *AwsVpcListMetadata
	isSet bool
}

func (v NullableAwsVpcListMetadata) Get() *AwsVpcListMetadata {
	return v.value
}

func (v *NullableAwsVpcListMetadata) Set(val *AwsVpcListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVpcListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVpcListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVpcListMetadata(val *AwsVpcListMetadata) *NullableAwsVpcListMetadata {
	return &NullableAwsVpcListMetadata{value: val, isSet: true}
}

func (v NullableAwsVpcListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVpcListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
