...
// checks if the HostReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostReference{}

// HostReference The reference to a host
...
type _HostReference HostReference
...
func (o HostReference) MarshalJSON() ([]byte, error) {
...
func (o HostReference) ToMap() (map[string]interface{}, error) {
...
func (o *HostReference) UnmarshalJSON(data []byte) (err error) {
	...
	varHostReference := _HostReference{}

	err = json.Unmarshal(data, &varHostReference)

	if err != nil {
		return err
	}

	*o = HostReference(varHostReference)
...
type NullableHostReference struct {
	value *HostReference
	isSet bool
}

func (v NullableHostReference) Get() *HostReference {
	return v.value
}

func (v *NullableHostReference) Set(val *HostReference) {
	v.value = val
	v.isSet = true
}

func (v NullableHostReference) IsSet() bool {
	return v.isSet
}

func (v *NullableHostReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostReference(val *HostReference) *NullableHostReference {
	return &NullableHostReference{value: val, isSet: true}
}

func (v NullableHostReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
