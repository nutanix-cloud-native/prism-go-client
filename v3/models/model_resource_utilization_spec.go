...
// checks if the ResourceUtilizationSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceUtilizationSpec{}

// ResourceUtilizationSpec specify the limits and units for a resource type
...
type _ResourceUtilizationSpec ResourceUtilizationSpec
...
func (o ResourceUtilizationSpec) MarshalJSON() ([]byte, error) {
...
func (o ResourceUtilizationSpec) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceUtilizationSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varResourceUtilizationSpec := _ResourceUtilizationSpec{}

	err = json.Unmarshal(data, &varResourceUtilizationSpec)

	if err != nil {
		return err
	}

	*o = ResourceUtilizationSpec(varResourceUtilizationSpec)
...
type NullableResourceUtilizationSpec struct {
	value *ResourceUtilizationSpec
	isSet bool
}

func (v NullableResourceUtilizationSpec) Get() *ResourceUtilizationSpec {
	return v.value
}

func (v *NullableResourceUtilizationSpec) Set(val *ResourceUtilizationSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceUtilizationSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceUtilizationSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceUtilizationSpec(val *ResourceUtilizationSpec) *NullableResourceUtilizationSpec {
	return &NullableResourceUtilizationSpec{value: val, isSet: true}
}

func (v NullableResourceUtilizationSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceUtilizationSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
