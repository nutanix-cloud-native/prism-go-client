...
// checks if the StoragePolicyDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyDefStatus{}

// StoragePolicyDefStatus An intentful representation of storage policy status
type StoragePolicyDefStatus struct {
	// The state of the storage policy
	State *string `json:"state,omitempty"`
	// Storage policy name
	Name string `json:"name"`
	Resources StoragePolicyResourcesDefStatus `json:"resources"`
	// A description for storage policy
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _StoragePolicyDefStatus StoragePolicyDefStatus
...
func (o *StoragePolicyDefStatus) GetResources() StoragePolicyResourcesDefStatus {
	if o == nil {
		var ret StoragePolicyResourcesDefStatus
		return ret
	}
...
func (o StoragePolicyDefStatus) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePolicyDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varStoragePolicyDefStatus := _StoragePolicyDefStatus{}

	err = json.Unmarshal(data, &varStoragePolicyDefStatus)

	if err != nil {
		return err
	}

	*o = StoragePolicyDefStatus(varStoragePolicyDefStatus)
...
type NullableStoragePolicyDefStatus struct {
	value *StoragePolicyDefStatus
	isSet bool
}

func (v NullableStoragePolicyDefStatus) Get() *StoragePolicyDefStatus {
	return v.value
}

func (v *NullableStoragePolicyDefStatus) Set(val *StoragePolicyDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyDefStatus(val *StoragePolicyDefStatus) *NullableStoragePolicyDefStatus {
	return &NullableStoragePolicyDefStatus{value: val, isSet: true}
}

func (v NullableStoragePolicyDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
