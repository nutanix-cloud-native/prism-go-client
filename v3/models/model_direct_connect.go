...
// DirectConnect An intentful representation of a direct_connect spec
type DirectConnect struct {
	...
	Resources DirectConnectResources `json:"resources"`
	// direct_connect Name.
...
func (o *DirectConnect) GetResources() DirectConnectResources {
	if o == nil {
		var ret DirectConnectResources
		return ret
	}
...
func (o *DirectConnect) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varDirectConnect)
