...
// checks if the NetworkFunctionChain type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionChain{}

// NetworkFunctionChain network function chain Input Definition.
...
type _NetworkFunctionChain NetworkFunctionChain
...
func (o NetworkFunctionChain) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionChain) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionChain) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkFunctionChain := _NetworkFunctionChain{}

	err = json.Unmarshal(data, &varNetworkFunctionChain)

	if err != nil {
		return err
	}

	*o = NetworkFunctionChain(varNetworkFunctionChain)
...
type NullableNetworkFunctionChain struct {
	value *NetworkFunctionChain
	isSet bool
}

func (v NullableNetworkFunctionChain) Get() *NetworkFunctionChain {
	return v.value
}

func (v *NullableNetworkFunctionChain) Set(val *NetworkFunctionChain) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionChain) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionChain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionChain(val *NetworkFunctionChain) *NullableNetworkFunctionChain {
	return &NullableNetworkFunctionChain{value: val, isSet: true}
}

func (v NullableNetworkFunctionChain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionChain) UnmarshalJSON(src []byte) error {
	v.isSet = true
