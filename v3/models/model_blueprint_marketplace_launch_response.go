...
// checks if the BlueprintMarketplaceLaunchResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintMarketplaceLaunchResponse{}

// BlueprintMarketplaceLaunchResponse Response containing the uuid of the newly created app blueprint object
type BlueprintMarketplaceLaunchResponse struct {
	Status BlueprintMarketplaceLaunchResponseStatus `json:"status"`
	Spec BlueprintMarketplaceLaunchSpec `json:"spec"`
...
type _BlueprintMarketplaceLaunchResponse BlueprintMarketplaceLaunchResponse
...
func NewBlueprintMarketplaceLaunchResponse(status BlueprintMarketplaceLaunchResponseStatus, spec BlueprintMarketplaceLaunchSpec, apiVersion string, metadata BlueprintMetadata) *BlueprintMarketplaceLaunchResponse {
	this := BlueprintMarketplaceLaunchResponse{}
	this.Status = status
	this.Spec = spec
...
func (o *BlueprintMarketplaceLaunchResponse) GetStatus() BlueprintMarketplaceLaunchResponseStatus {
	if o == nil {
		var ret BlueprintMarketplaceLaunchResponseStatus
		return ret
	}
...
func (o *BlueprintMarketplaceLaunchResponse) GetSpec() BlueprintMarketplaceLaunchSpec {
	if o == nil {
		var ret BlueprintMarketplaceLaunchSpec
		return ret
	}
...
func (o BlueprintMarketplaceLaunchResponse) MarshalJSON() ([]byte, error) {
...
func (o BlueprintMarketplaceLaunchResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintMarketplaceLaunchResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintMarketplaceLaunchResponse := _BlueprintMarketplaceLaunchResponse{}

	err = json.Unmarshal(data, &varBlueprintMarketplaceLaunchResponse)

	if err != nil {
		return err
	}

	*o = BlueprintMarketplaceLaunchResponse(varBlueprintMarketplaceLaunchResponse)
...
type NullableBlueprintMarketplaceLaunchResponse struct {
	value *BlueprintMarketplaceLaunchResponse
	isSet bool
}

func (v NullableBlueprintMarketplaceLaunchResponse) Get() *BlueprintMarketplaceLaunchResponse {
	return v.value
}

func (v *NullableBlueprintMarketplaceLaunchResponse) Set(val *BlueprintMarketplaceLaunchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintMarketplaceLaunchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintMarketplaceLaunchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintMarketplaceLaunchResponse(val *BlueprintMarketplaceLaunchResponse) *NullableBlueprintMarketplaceLaunchResponse {
	return &NullableBlueprintMarketplaceLaunchResponse{value: val, isSet: true}
}

func (v NullableBlueprintMarketplaceLaunchResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintMarketplaceLaunchResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
