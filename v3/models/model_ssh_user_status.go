...
// checks if the SshUserStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserStatus{}

// SshUserStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _SshUserStatus SshUserStatus
...
func (o SshUserStatus) MarshalJSON() ([]byte, error) {
...
func (o SshUserStatus) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserStatus) UnmarshalJSON(data []byte) (err error) {
	varSshUserStatus := _SshUserStatus{}

	err = json.Unmarshal(data, &varSshUserStatus)

	if err != nil {
		return err
	}

	*o = SshUserStatus(varSshUserStatus)
...
type NullableSshUserStatus struct {
	value *SshUserStatus
	isSet bool
}

func (v NullableSshUserStatus) Get() *SshUserStatus {
	return v.value
}

func (v *NullableSshUserStatus) Set(val *SshUserStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserStatus(val *SshUserStatus) *NullableSshUserStatus {
	return &NullableSshUserStatus{value: val, isSet: true}
}

func (v NullableSshUserStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
