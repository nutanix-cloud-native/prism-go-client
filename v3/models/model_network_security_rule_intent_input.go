...
// checks if the NetworkSecurityRuleIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleIntentInput{}
...
type _NetworkSecurityRuleIntentInput NetworkSecurityRuleIntentInput
...
func NewNetworkSecurityRuleIntentInput(spec NetworkSecurityRule, metadata NetworkSecurityRuleMetadata) *NetworkSecurityRuleIntentInput {
	this := NetworkSecurityRuleIntentInput{}
	this.Spec = spec
...
func (o NetworkSecurityRuleIntentInput) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRuleIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkSecurityRuleIntentInput := _NetworkSecurityRuleIntentInput{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleIntentInput)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleIntentInput(varNetworkSecurityRuleIntentInput)
...
type NullableNetworkSecurityRuleIntentInput struct {
	value *NetworkSecurityRuleIntentInput
	isSet bool
}

func (v NullableNetworkSecurityRuleIntentInput) Get() *NetworkSecurityRuleIntentInput {
	return v.value
}

func (v *NullableNetworkSecurityRuleIntentInput) Set(val *NetworkSecurityRuleIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleIntentInput(val *NetworkSecurityRuleIntentInput) *NullableNetworkSecurityRuleIntentInput {
	return &NullableNetworkSecurityRuleIntentInput{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
