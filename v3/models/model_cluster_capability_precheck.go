...
// checks if the ClusterCapabilityPrecheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterCapabilityPrecheck{}

// ClusterCapabilityPrecheck Check to be done apart from AOS and AHV versions
type ClusterCapabilityPrecheck struct {
	// Name of the check
	CheckName *string `json:"check_name,omitempty"`
	// Whether this precheck has passed
	HasPassed *bool `json:"has_passed,omitempty"`
	// Reason of failed validation. Will only be populated when validation fails. 
	Reason *string `json:"reason,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ClusterCapabilityPrecheck ClusterCapabilityPrecheck
...
func NewClusterCapabilityPrecheck() *ClusterCapabilityPrecheck {
	this := ClusterCapabilityPrecheck{}
	return &this
}
...
func (o ClusterCapabilityPrecheck) MarshalJSON() ([]byte, error) {
...
func (o ClusterCapabilityPrecheck) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterCapabilityPrecheck) UnmarshalJSON(data []byte) (err error) {
	varClusterCapabilityPrecheck := _ClusterCapabilityPrecheck{}

	err = json.Unmarshal(data, &varClusterCapabilityPrecheck)

	if err != nil {
		return err
	}

	*o = ClusterCapabilityPrecheck(varClusterCapabilityPrecheck)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "check_name")
...
type NullableClusterCapabilityPrecheck struct {
	value *ClusterCapabilityPrecheck
	isSet bool
}

func (v NullableClusterCapabilityPrecheck) Get() *ClusterCapabilityPrecheck {
	return v.value
}

func (v *NullableClusterCapabilityPrecheck) Set(val *ClusterCapabilityPrecheck) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterCapabilityPrecheck) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterCapabilityPrecheck) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterCapabilityPrecheck(val *ClusterCapabilityPrecheck) *NullableClusterCapabilityPrecheck {
	return &NullableClusterCapabilityPrecheck{value: val, isSet: true}
}

func (v NullableClusterCapabilityPrecheck) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterCapabilityPrecheck) UnmarshalJSON(src []byte) error {
	v.isSet = true
