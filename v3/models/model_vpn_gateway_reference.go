...
// checks if the VpnGatewayReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayReference{}

// VpnGatewayReference The reference to a vpn_gateway
...
type _VpnGatewayReference VpnGatewayReference
...
func (o VpnGatewayReference) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayReference) ToMap() (map[string]interface{}, error) {
...
func (o *VpnGatewayReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnGatewayReference := _VpnGatewayReference{}

	err = json.Unmarshal(data, &varVpnGatewayReference)

	if err != nil {
		return err
	}

	*o = VpnGatewayReference(varVpnGatewayReference)
...
type NullableVpnGatewayReference struct {
	value *VpnGatewayReference
	isSet bool
}

func (v NullableVpnGatewayReference) Get() *VpnGatewayReference {
	return v.value
}

func (v *NullableVpnGatewayReference) Set(val *VpnGatewayReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayReference(val *VpnGatewayReference) *NullableVpnGatewayReference {
	return &NullableVpnGatewayReference{value: val, isSet: true}
}

func (v NullableVpnGatewayReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
