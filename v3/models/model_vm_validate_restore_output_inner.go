...
// checks if the VmValidateRestoreOutputInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmValidateRestoreOutputInner{}

// VmValidateRestoreOutputInner struct for VmValidateRestoreOutputInner
type VmValidateRestoreOutputInner struct {
	// Warning due to which vm may not be fully recoverable from the vm recovery point. 
	WarningCode *string `json:"warning_code,omitempty"`
	// Detailed message which describes unrecoverability warning or error. 
	UnrecoverabilityDetail *string `json:"unrecoverability_detail,omitempty"`
	// Error due to which vm will not be unrecoverable from the vm recovery point. 
	ErrorCode *string `json:"error_code,omitempty"`
	// Detailed message which describes the resolution for warning or error. 
	Resolution *string `json:"resolution,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VmValidateRestoreOutputInner VmValidateRestoreOutputInner
...
func NewVmValidateRestoreOutputInner() *VmValidateRestoreOutputInner {
	this := VmValidateRestoreOutputInner{}
	return &this
}
...
// GetUnrecoverabilityDetail returns the UnrecoverabilityDetail field value if set, zero value otherwise.
func (o *VmValidateRestoreOutputInner) GetUnrecoverabilityDetail() string {
	if o == nil || IsNil(o.UnrecoverabilityDetail) {
		var ret string
		return ret
	}
	return *o.UnrecoverabilityDetail
}

// GetUnrecoverabilityDetailOk returns a tuple with the UnrecoverabilityDetail field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmValidateRestoreOutputInner) GetUnrecoverabilityDetailOk() (*string, bool) {
	if o == nil || IsNil(o.UnrecoverabilityDetail) {
		return nil, false
	}
	return o.UnrecoverabilityDetail, true
}
...
// SetUnrecoverabilityDetail gets a reference to the given string and assigns it to the UnrecoverabilityDetail field.
func (o *VmValidateRestoreOutputInner) SetUnrecoverabilityDetail(v string) {
	o.UnrecoverabilityDetail = &v
}
...
func (o VmValidateRestoreOutputInner) MarshalJSON() ([]byte, error) {
...
func (o VmValidateRestoreOutputInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.WarningCode) {
		toSerialize["warning_code"] = o.WarningCode
	}
	if !IsNil(o.UnrecoverabilityDetail) {
		toSerialize["unrecoverability_detail"] = o.UnrecoverabilityDetail
	}
...
func (o *VmValidateRestoreOutputInner) UnmarshalJSON(data []byte) (err error) {
	varVmValidateRestoreOutputInner := _VmValidateRestoreOutputInner{}

	err = json.Unmarshal(data, &varVmValidateRestoreOutputInner)

	if err != nil {
		return err
	}

	*o = VmValidateRestoreOutputInner(varVmValidateRestoreOutputInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "warning_code")
		delete(additionalProperties, "unrecoverability_detail")
...
type NullableVmValidateRestoreOutputInner struct {
	value *VmValidateRestoreOutputInner
	isSet bool
}

func (v NullableVmValidateRestoreOutputInner) Get() *VmValidateRestoreOutputInner {
	return v.value
}

func (v *NullableVmValidateRestoreOutputInner) Set(val *VmValidateRestoreOutputInner) {
	v.value = val
	v.isSet = true
}

func (v NullableVmValidateRestoreOutputInner) IsSet() bool {
	return v.isSet
}

func (v *NullableVmValidateRestoreOutputInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmValidateRestoreOutputInner(val *VmValidateRestoreOutputInner) *NullableVmValidateRestoreOutputInner {
	return &NullableVmValidateRestoreOutputInner{value: val, isSet: true}
}

func (v NullableVmValidateRestoreOutputInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmValidateRestoreOutputInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
