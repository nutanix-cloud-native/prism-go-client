...
// checks if the ResourceChargeListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceChargeListMetadata{}

// ResourceChargeListMetadata All api calls that return a list will have this metadata block as input 
...
type _ResourceChargeListMetadata ResourceChargeListMetadata
...
func NewResourceChargeListMetadata() *ResourceChargeListMetadata {
	this := ResourceChargeListMetadata{}
...
func (o ResourceChargeListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ResourceChargeListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceChargeListMetadata) UnmarshalJSON(data []byte) (err error) {
	varResourceChargeListMetadata := _ResourceChargeListMetadata{}

	err = json.Unmarshal(data, &varResourceChargeListMetadata)

	if err != nil {
		return err
	}

	*o = ResourceChargeListMetadata(varResourceChargeListMetadata)
...
type NullableResourceChargeListMetadata struct {
	value *ResourceChargeListMetadata
	isSet bool
}

func (v NullableResourceChargeListMetadata) Get() *ResourceChargeListMetadata {
	return v.value
}

func (v *NullableResourceChargeListMetadata) Set(val *ResourceChargeListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceChargeListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceChargeListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceChargeListMetadata(val *ResourceChargeListMetadata) *NullableResourceChargeListMetadata {
	return &NullableResourceChargeListMetadata{value: val, isSet: true}
}

func (v NullableResourceChargeListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceChargeListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
