...
// checks if the RoleIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleIntentResponse{}

// RoleIntentResponse Response object for intentful operations on a role
type RoleIntentResponse struct {
	Status *RoleDefStatus `json:"status,omitempty"`
	Spec *Role `json:"spec,omitempty"`
...
type _RoleIntentResponse RoleIntentResponse
...
// SetStatus gets a reference to the given RoleDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Role and assigns it to the Spec field.
...
func (o RoleIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RoleIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RoleIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleIntentResponse := _RoleIntentResponse{}

	err = json.Unmarshal(data, &varRoleIntentResponse)

	if err != nil {
		return err
	}

	*o = RoleIntentResponse(varRoleIntentResponse)
...
type NullableRoleIntentResponse struct {
	value *RoleIntentResponse
	isSet bool
}

func (v NullableRoleIntentResponse) Get() *RoleIntentResponse {
	return v.value
}

func (v *NullableRoleIntentResponse) Set(val *RoleIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleIntentResponse(val *RoleIntentResponse) *NullableRoleIntentResponse {
	return &NullableRoleIntentResponse{value: val, isSet: true}
}

func (v NullableRoleIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
