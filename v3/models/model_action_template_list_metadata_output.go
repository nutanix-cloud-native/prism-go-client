...
// checks if the ActionTemplateListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTemplateListMetadataOutput{}

// ActionTemplateListMetadataOutput All api calls that return a list will have this metadata block 
type ActionTemplateListMetadataOutput struct {
	// The kind name
...
type _ActionTemplateListMetadataOutput ActionTemplateListMetadataOutput
...
func NewActionTemplateListMetadataOutput() *ActionTemplateListMetadataOutput {
	this := ActionTemplateListMetadataOutput{}
	var kind string = "action_template"
	this.Kind = &kind
	return &this
}
...
func (o ActionTemplateListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ActionTemplateListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTemplateListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varActionTemplateListMetadataOutput := _ActionTemplateListMetadataOutput{}

	err = json.Unmarshal(data, &varActionTemplateListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ActionTemplateListMetadataOutput(varActionTemplateListMetadataOutput)
...
type NullableActionTemplateListMetadataOutput struct {
	value *ActionTemplateListMetadataOutput
	isSet bool
}

func (v NullableActionTemplateListMetadataOutput) Get() *ActionTemplateListMetadataOutput {
	return v.value
}

func (v *NullableActionTemplateListMetadataOutput) Set(val *ActionTemplateListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTemplateListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTemplateListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTemplateListMetadataOutput(val *ActionTemplateListMetadataOutput) *NullableActionTemplateListMetadataOutput {
	return &NullableActionTemplateListMetadataOutput{value: val, isSet: true}
}

func (v NullableActionTemplateListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTemplateListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
