...
// checks if the RackableUnitStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackableUnitStatus{}

// RackableUnitStatus The status of a REST API call. Only used when there is a failure to report. 
type RackableUnitStatus struct {
	// The kind name
...
type _RackableUnitStatus RackableUnitStatus
...
func (o RackableUnitStatus) MarshalJSON() ([]byte, error) {
...
func (o RackableUnitStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RackableUnitStatus) UnmarshalJSON(data []byte) (err error) {
	varRackableUnitStatus := _RackableUnitStatus{}

	err = json.Unmarshal(data, &varRackableUnitStatus)

	if err != nil {
		return err
	}

	*o = RackableUnitStatus(varRackableUnitStatus)
...
type NullableRackableUnitStatus struct {
	value *RackableUnitStatus
	isSet bool
}

func (v NullableRackableUnitStatus) Get() *RackableUnitStatus {
	return v.value
}

func (v *NullableRackableUnitStatus) Set(val *RackableUnitStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRackableUnitStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRackableUnitStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackableUnitStatus(val *RackableUnitStatus) *NullableRackableUnitStatus {
	return &NullableRackableUnitStatus{value: val, isSet: true}
}

func (v NullableRackableUnitStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackableUnitStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
