...
// checks if the EnvironmentListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentListMetadataOutput{}

// EnvironmentListMetadataOutput All api calls that return a list will have this metadata block 
type EnvironmentListMetadataOutput struct {
	// The kind name
...
type _EnvironmentListMetadataOutput EnvironmentListMetadataOutput
...
func NewEnvironmentListMetadataOutput() *EnvironmentListMetadataOutput {
	this := EnvironmentListMetadataOutput{}
	var kind string = "environment"
	this.Kind = &kind
	return &this
}
...
func (o EnvironmentListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *EnvironmentListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varEnvironmentListMetadataOutput := _EnvironmentListMetadataOutput{}

	err = json.Unmarshal(data, &varEnvironmentListMetadataOutput)

	if err != nil {
		return err
	}

	*o = EnvironmentListMetadataOutput(varEnvironmentListMetadataOutput)
...
type NullableEnvironmentListMetadataOutput struct {
	value *EnvironmentListMetadataOutput
	isSet bool
}

func (v NullableEnvironmentListMetadataOutput) Get() *EnvironmentListMetadataOutput {
	return v.value
}

func (v *NullableEnvironmentListMetadataOutput) Set(val *EnvironmentListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentListMetadataOutput(val *EnvironmentListMetadataOutput) *NullableEnvironmentListMetadataOutput {
	return &NullableEnvironmentListMetadataOutput{value: val, isSet: true}
}

func (v NullableEnvironmentListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
