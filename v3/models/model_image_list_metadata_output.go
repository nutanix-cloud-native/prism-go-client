...
// checks if the ImageListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageListMetadataOutput{}

// ImageListMetadataOutput All api calls that return a list will have this metadata block 
...
type _ImageListMetadataOutput ImageListMetadataOutput
...
// and a boolean to check if the value has been set.
func (o *ImageListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o ImageListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ImageListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ImageListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varImageListMetadataOutput := _ImageListMetadataOutput{}

	err = json.Unmarshal(data, &varImageListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ImageListMetadataOutput(varImageListMetadataOutput)
...
type NullableImageListMetadataOutput struct {
	value *ImageListMetadataOutput
	isSet bool
}

func (v NullableImageListMetadataOutput) Get() *ImageListMetadataOutput {
	return v.value
}

func (v *NullableImageListMetadataOutput) Set(val *ImageListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableImageListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableImageListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageListMetadataOutput(val *ImageListMetadataOutput) *NullableImageListMetadataOutput {
	return &NullableImageListMetadataOutput{value: val, isSet: true}
}

func (v NullableImageListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
