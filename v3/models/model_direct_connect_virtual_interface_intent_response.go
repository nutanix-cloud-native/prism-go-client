...
// checks if the DirectConnectVirtualInterfaceIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterfaceIntentResponse{}

// DirectConnectVirtualInterfaceIntentResponse Response object for intentful operations on a direct_connect_virtual_interface
type DirectConnectVirtualInterfaceIntentResponse struct {
	Status *DirectConnectVirtualInterfaceDefStatus `json:"status,omitempty"`
	Spec *DirectConnectVirtualInterface `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata DirectConnectVirtualInterfaceMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _DirectConnectVirtualInterfaceIntentResponse DirectConnectVirtualInterfaceIntentResponse
...
func NewDirectConnectVirtualInterfaceIntentResponse(apiVersion string, metadata DirectConnectVirtualInterfaceMetadata) *DirectConnectVirtualInterfaceIntentResponse {
	this := DirectConnectVirtualInterfaceIntentResponse{}
...
func (o *DirectConnectVirtualInterfaceIntentResponse) GetStatus() DirectConnectVirtualInterfaceDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret DirectConnectVirtualInterfaceDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given DirectConnectVirtualInterfaceDefStatus and assigns it to the Status field.
...
func (o *DirectConnectVirtualInterfaceIntentResponse) GetSpec() DirectConnectVirtualInterface {
	if o == nil || IsNil(o.Spec) {
		var ret DirectConnectVirtualInterface
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given DirectConnectVirtualInterface and assigns it to the Spec field.
...
func (o *DirectConnectVirtualInterfaceIntentResponse) GetMetadata() DirectConnectVirtualInterfaceMetadata {
	if o == nil {
		var ret DirectConnectVirtualInterfaceMetadata
		return ret
	}
...
func (o DirectConnectVirtualInterfaceIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterfaceIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectVirtualInterfaceIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectVirtualInterfaceIntentResponse := _DirectConnectVirtualInterfaceIntentResponse{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterfaceIntentResponse)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterfaceIntentResponse(varDirectConnectVirtualInterfaceIntentResponse)
...
type NullableDirectConnectVirtualInterfaceIntentResponse struct {
	value *DirectConnectVirtualInterfaceIntentResponse
	isSet bool
}

func (v NullableDirectConnectVirtualInterfaceIntentResponse) Get() *DirectConnectVirtualInterfaceIntentResponse {
	return v.value
}

func (v *NullableDirectConnectVirtualInterfaceIntentResponse) Set(val *DirectConnectVirtualInterfaceIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterfaceIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterfaceIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterfaceIntentResponse(val *DirectConnectVirtualInterfaceIntentResponse) *NullableDirectConnectVirtualInterfaceIntentResponse {
	return &NullableDirectConnectVirtualInterfaceIntentResponse{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterfaceIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterfaceIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
