...
// checks if the Layer2StretchListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchListIntentResponse{}

// Layer2StretchListIntentResponse Response object for intentful operation of layer2_stretchs
type Layer2StretchListIntentResponse struct {
	Entities []Layer2StretchIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata Layer2StretchListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _Layer2StretchListIntentResponse Layer2StretchListIntentResponse
...
func NewLayer2StretchListIntentResponse(apiVersion string, metadata Layer2StretchListMetadataOutput) *Layer2StretchListIntentResponse {
	this := Layer2StretchListIntentResponse{}
...
func (o *Layer2StretchListIntentResponse) GetEntities() []Layer2StretchIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []Layer2StretchIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []Layer2StretchIntentResource and assigns it to the Entities field.
...
func (o *Layer2StretchListIntentResponse) GetMetadata() Layer2StretchListMetadataOutput {
	if o == nil {
		var ret Layer2StretchListMetadataOutput
		return ret
	}
...
func (o Layer2StretchListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varLayer2StretchListIntentResponse := _Layer2StretchListIntentResponse{}

	err = json.Unmarshal(data, &varLayer2StretchListIntentResponse)

	if err != nil {
		return err
	}

	*o = Layer2StretchListIntentResponse(varLayer2StretchListIntentResponse)
...
type NullableLayer2StretchListIntentResponse struct {
	value *Layer2StretchListIntentResponse
	isSet bool
}

func (v NullableLayer2StretchListIntentResponse) Get() *Layer2StretchListIntentResponse {
	return v.value
}

func (v *NullableLayer2StretchListIntentResponse) Set(val *Layer2StretchListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchListIntentResponse(val *Layer2StretchListIntentResponse) *NullableLayer2StretchListIntentResponse {
	return &NullableLayer2StretchListIntentResponse{value: val, isSet: true}
}

func (v NullableLayer2StretchListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
