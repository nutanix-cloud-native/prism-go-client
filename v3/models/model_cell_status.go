...
// checks if the CellStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CellStatus{}

// CellStatus The status of a REST API call. Only used when there is a failure to report. 
...
func (o CellStatus) MarshalJSON() ([]byte, error) {
...
func (o CellStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CellStatus) UnmarshalJSON(data []byte) (err error) {
	varCellStatus := _CellStatus{}

	err = json.Unmarshal(data, &varCellStatus)

	if err != nil {
		return err
	}

	*o = CellStatus(varCellStatus)
...
type NullableCellStatus struct {
	value *CellStatus
	isSet bool
}

func (v NullableCellStatus) Get() *CellStatus {
	return v.value
}

func (v *NullableCellStatus) Set(val *CellStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCellStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCellStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCellStatus(val *CellStatus) *NullableCellStatus {
	return &NullableCellStatus{value: val, isSet: true}
}

func (v NullableCellStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCellStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
