...
// checks if the VmHostAffinityLegacyPolicyListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityLegacyPolicyListResponse{}

// VmHostAffinityLegacyPolicyListResponse Response object for list operation of VM Host Affinity Legacy Policy.
type VmHostAffinityLegacyPolicyListResponse struct {
	Entities []VmHostAffinityLegacyPolicyInfo `json:"entities,omitempty"`
	Metadata VmHostAffinityLegacyPolicyListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VmHostAffinityLegacyPolicyListResponse VmHostAffinityLegacyPolicyListResponse
...
func NewVmHostAffinityLegacyPolicyListResponse(metadata VmHostAffinityLegacyPolicyListMetadataOutput) *VmHostAffinityLegacyPolicyListResponse {
	this := VmHostAffinityLegacyPolicyListResponse{}
...
func (o *VmHostAffinityLegacyPolicyListResponse) GetEntities() []VmHostAffinityLegacyPolicyInfo {
	if o == nil || IsNil(o.Entities) {
		var ret []VmHostAffinityLegacyPolicyInfo
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []VmHostAffinityLegacyPolicyInfo and assigns it to the Entities field.
...
func (o *VmHostAffinityLegacyPolicyListResponse) GetMetadata() VmHostAffinityLegacyPolicyListMetadataOutput {
	if o == nil {
		var ret VmHostAffinityLegacyPolicyListMetadataOutput
		return ret
	}
...
func (o VmHostAffinityLegacyPolicyListResponse) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityLegacyPolicyListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VmHostAffinityLegacyPolicyListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVmHostAffinityLegacyPolicyListResponse := _VmHostAffinityLegacyPolicyListResponse{}

	err = json.Unmarshal(data, &varVmHostAffinityLegacyPolicyListResponse)

	if err != nil {
		return err
	}

	*o = VmHostAffinityLegacyPolicyListResponse(varVmHostAffinityLegacyPolicyListResponse)
...
type NullableVmHostAffinityLegacyPolicyListResponse struct {
	value *VmHostAffinityLegacyPolicyListResponse
	isSet bool
}

func (v NullableVmHostAffinityLegacyPolicyListResponse) Get() *VmHostAffinityLegacyPolicyListResponse {
	return v.value
}

func (v *NullableVmHostAffinityLegacyPolicyListResponse) Set(val *VmHostAffinityLegacyPolicyListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityLegacyPolicyListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityLegacyPolicyListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityLegacyPolicyListResponse(val *VmHostAffinityLegacyPolicyListResponse) *NullableVmHostAffinityLegacyPolicyListResponse {
	return &NullableVmHostAffinityLegacyPolicyListResponse{value: val, isSet: true}
}

func (v NullableVmHostAffinityLegacyPolicyListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityLegacyPolicyListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
