...
// checks if the ActionRuleStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleStatus{}

// ActionRuleStatus The status of a REST API call. Only used when there is a failure to report. 
type ActionRuleStatus struct {
	// The kind name
...
type _ActionRuleStatus ActionRuleStatus
...
func (o ActionRuleStatus) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleStatus) UnmarshalJSON(data []byte) (err error) {
	varActionRuleStatus := _ActionRuleStatus{}

	err = json.Unmarshal(data, &varActionRuleStatus)

	if err != nil {
		return err
	}

	*o = ActionRuleStatus(varActionRuleStatus)
...
type NullableActionRuleStatus struct {
	value *ActionRuleStatus
	isSet bool
}

func (v NullableActionRuleStatus) Get() *ActionRuleStatus {
	return v.value
}

func (v *NullableActionRuleStatus) Set(val *ActionRuleStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleStatus(val *ActionRuleStatus) *NullableActionRuleStatus {
	return &NullableActionRuleStatus{value: val, isSet: true}
}

func (v NullableActionRuleStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
