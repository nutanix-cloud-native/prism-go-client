...
// checks if the AppRunlogStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunlogStatus{}

// AppRunlogStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _AppRunlogStatus AppRunlogStatus
...
func (o AppRunlogStatus) MarshalJSON() ([]byte, error) {
...
func (o AppRunlogStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunlogStatus) UnmarshalJSON(data []byte) (err error) {
	varAppRunlogStatus := _AppRunlogStatus{}

	err = json.Unmarshal(data, &varAppRunlogStatus)

	if err != nil {
		return err
	}

	*o = AppRunlogStatus(varAppRunlogStatus)
...
type NullableAppRunlogStatus struct {
	value *AppRunlogStatus
	isSet bool
}

func (v NullableAppRunlogStatus) Get() *AppRunlogStatus {
	return v.value
}

func (v *NullableAppRunlogStatus) Set(val *AppRunlogStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunlogStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunlogStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunlogStatus(val *AppRunlogStatus) *NullableAppRunlogStatus {
	return &NullableAppRunlogStatus{value: val, isSet: true}
}

func (v NullableAppRunlogStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunlogStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
