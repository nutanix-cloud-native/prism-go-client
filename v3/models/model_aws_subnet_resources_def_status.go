...
// checks if the AwsSubnetResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSubnetResourcesDefStatus{}

// AwsSubnetResourcesDefStatus AWS Subnet creation/modification status.
type AwsSubnetResourcesDefStatus struct {
	// The AWS ID of the VPC the subnet is in.
	...
	Id *string `json:"id,omitempty" validate:"regexp=^subnet-[a-f0-9]{1,17}$"`
	// State of the AWS resource
	State *string `json:"state,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsSubnetResourcesDefStatus AwsSubnetResourcesDefStatus
...
func NewAwsSubnetResourcesDefStatus() *AwsSubnetResourcesDefStatus {
	this := AwsSubnetResourcesDefStatus{}
	return &this
}
...
func (o AwsSubnetResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsSubnetResourcesDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSubnetResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsSubnetResourcesDefStatus := _AwsSubnetResourcesDefStatus{}

	err = json.Unmarshal(data, &varAwsSubnetResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = AwsSubnetResourcesDefStatus(varAwsSubnetResourcesDefStatus)
...
type NullableAwsSubnetResourcesDefStatus struct {
	value *AwsSubnetResourcesDefStatus
	isSet bool
}

func (v NullableAwsSubnetResourcesDefStatus) Get() *AwsSubnetResourcesDefStatus {
	return v.value
}

func (v *NullableAwsSubnetResourcesDefStatus) Set(val *AwsSubnetResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSubnetResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSubnetResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSubnetResourcesDefStatus(val *AwsSubnetResourcesDefStatus) *NullableAwsSubnetResourcesDefStatus {
	return &NullableAwsSubnetResourcesDefStatus{value: val, isSet: true}
}

func (v NullableAwsSubnetResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSubnetResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
