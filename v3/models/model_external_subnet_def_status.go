...
// checks if the ExternalSubnetDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalSubnetDefStatus{}

// ExternalSubnetDefStatus External subnet status.
type ExternalSubnetDefStatus struct {
	ExternalSubnetReference *SubnetReference `json:"external_subnet_reference,omitempty"`
	// List of IP addresses for SNAT or Gateway IP Addresses. 
...
type _ExternalSubnetDefStatus ExternalSubnetDefStatus
...
// GetExternalIpList returns the ExternalIpList field value if set, zero value otherwise.
func (o *ExternalSubnetDefStatus) GetExternalIpList() []string {
	if o == nil || IsNil(o.ExternalIpList) {
		var ret []string
		return ret
	}
	return o.ExternalIpList
}

// GetExternalIpListOk returns a tuple with the ExternalIpList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExternalSubnetDefStatus) GetExternalIpListOk() ([]string, bool) {
	if o == nil || IsNil(o.ExternalIpList) {
		return nil, false
	}
	return o.ExternalIpList, true
}
...
// SetExternalIpList gets a reference to the given []string and assigns it to the ExternalIpList field.
func (o *ExternalSubnetDefStatus) SetExternalIpList(v []string) {
	o.ExternalIpList = v
}

// GetGatewayNodeUuidList returns the GatewayNodeUuidList field value if set, zero value otherwise.
func (o *ExternalSubnetDefStatus) GetGatewayNodeUuidList() []string {
	if o == nil || IsNil(o.GatewayNodeUuidList) {
		var ret []string
		return ret
	}
	return o.GatewayNodeUuidList
}

// GetGatewayNodeUuidListOk returns a tuple with the GatewayNodeUuidList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExternalSubnetDefStatus) GetGatewayNodeUuidListOk() ([]string, bool) {
	if o == nil || IsNil(o.GatewayNodeUuidList) {
		return nil, false
	}
	return o.GatewayNodeUuidList, true
}
...
// SetGatewayNodeUuidList gets a reference to the given []string and assigns it to the GatewayNodeUuidList field.
func (o *ExternalSubnetDefStatus) SetGatewayNodeUuidList(v []string) {
	o.GatewayNodeUuidList = v
}

// GetActiveGatewayNode returns the ActiveGatewayNode field value if set, zero value otherwise.
func (o *ExternalSubnetDefStatus) GetActiveGatewayNode() Node {
	if o == nil || IsNil(o.ActiveGatewayNode) {
		var ret Node
		return ret
	}
	return *o.ActiveGatewayNode
}

// GetActiveGatewayNodeOk returns a tuple with the ActiveGatewayNode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExternalSubnetDefStatus) GetActiveGatewayNodeOk() (*Node, bool) {
	if o == nil || IsNil(o.ActiveGatewayNode) {
		return nil, false
	}
	return o.ActiveGatewayNode, true
}
...
// SetActiveGatewayNode gets a reference to the given Node and assigns it to the ActiveGatewayNode field.
func (o *ExternalSubnetDefStatus) SetActiveGatewayNode(v Node) {
	o.ActiveGatewayNode = &v
}

func (o ExternalSubnetDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ExternalSubnetDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ExternalSubnetReference) {
		toSerialize["external_subnet_reference"] = o.ExternalSubnetReference
	}
	if !IsNil(o.ExternalIpList) {
		toSerialize["external_ip_list"] = o.ExternalIpList
	}
	if !IsNil(o.GatewayNodeUuidList) {
		toSerialize["gateway_node_uuid_list"] = o.GatewayNodeUuidList
	}
	if !IsNil(o.ActiveGatewayNode) {
		toSerialize["active_gateway_node"] = o.ActiveGatewayNode
	}
...
func (o *ExternalSubnetDefStatus) UnmarshalJSON(data []byte) (err error) {
	varExternalSubnetDefStatus := _ExternalSubnetDefStatus{}

	err = json.Unmarshal(data, &varExternalSubnetDefStatus)

	if err != nil {
		return err
	}

	*o = ExternalSubnetDefStatus(varExternalSubnetDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "external_subnet_reference")
		delete(additionalProperties, "external_ip_list")
		delete(additionalProperties, "gateway_node_uuid_list")
		delete(additionalProperties, "active_gateway_node")
...
type NullableExternalSubnetDefStatus struct {
	value *ExternalSubnetDefStatus
	isSet bool
}

func (v NullableExternalSubnetDefStatus) Get() *ExternalSubnetDefStatus {
	return v.value
}

func (v *NullableExternalSubnetDefStatus) Set(val *ExternalSubnetDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalSubnetDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalSubnetDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalSubnetDefStatus(val *ExternalSubnetDefStatus) *NullableExternalSubnetDefStatus {
	return &NullableExternalSubnetDefStatus{value: val, isSet: true}
}

func (v NullableExternalSubnetDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalSubnetDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
