...
// AuditResponse Response object for audit operations
type AuditResponse struct {
	Status *AuditDef `json:"status,omitempty"`
...
type _AuditResponse AuditResponse
...
// SetStatus gets a reference to the given AuditDef and assigns it to the Status field.
...
// SetMetadata gets a reference to the given AuditMetadata and assigns it to the Metadata field.
...
func (o *AuditResponse) UnmarshalJSON(data []byte) (err error) {
	varAuditResponse := _AuditResponse{}

	err = json.Unmarshal(data, &varAuditResponse)

	if err != nil {
		return err
	}

	*o = AuditResponse(varAuditResponse)
