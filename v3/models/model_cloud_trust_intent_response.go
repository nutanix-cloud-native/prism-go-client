...
// checks if the CloudTrustIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustIntentResponse{}

// CloudTrustIntentResponse Response object for intentful operations on a cloud_trust
type CloudTrustIntentResponse struct {
	Status *CloudTrustDefStatus `json:"status,omitempty"`
	Spec *CloudTrust `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata CloudTrustMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _CloudTrustIntentResponse CloudTrustIntentResponse
...
// SetStatus gets a reference to the given CloudTrustDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given CloudTrust and assigns it to the Spec field.
...
func (o CloudTrustIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrustIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTrustIntentResponse := _CloudTrustIntentResponse{}

	err = json.Unmarshal(data, &varCloudTrustIntentResponse)

	if err != nil {
		return err
	}

	*o = CloudTrustIntentResponse(varCloudTrustIntentResponse)
...
type NullableCloudTrustIntentResponse struct {
	value *CloudTrustIntentResponse
	isSet bool
}

func (v NullableCloudTrustIntentResponse) Get() *CloudTrustIntentResponse {
	return v.value
}

func (v *NullableCloudTrustIntentResponse) Set(val *CloudTrustIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustIntentResponse(val *CloudTrustIntentResponse) *NullableCloudTrustIntentResponse {
	return &NullableCloudTrustIntentResponse{value: val, isSet: true}
}

func (v NullableCloudTrustIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
