...
// checks if the CloudTrustResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustResources{}

// CloudTrustResources Cloud trusts resources definition.
type CloudTrustResources struct {
...
type _CloudTrustResources CloudTrustResources
...
func (o CloudTrustResources) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustResources) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrustResources) UnmarshalJSON(data []byte) (err error) {
	varCloudTrustResources := _CloudTrustResources{}

	err = json.Unmarshal(data, &varCloudTrustResources)

	if err != nil {
		return err
	}

	*o = CloudTrustResources(varCloudTrustResources)
...
type NullableCloudTrustResources struct {
	value *CloudTrustResources
	isSet bool
}

func (v NullableCloudTrustResources) Get() *CloudTrustResources {
	return v.value
}

func (v *NullableCloudTrustResources) Set(val *CloudTrustResources) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustResources) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustResources(val *CloudTrustResources) *NullableCloudTrustResources {
	return &NullableCloudTrustResources{value: val, isSet: true}
}

func (v NullableCloudTrustResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
