...
// checks if the FileItemResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemResourcesDefStatus{}

// FileItemResourcesDefStatus File item object
type FileItemResourcesDefStatus struct {
	// List of URIs where the raw file_item data can be accessed.
	RetrievalUriList []string `json:"retrieval_uri_list,omitempty"`
	Checksum *Checksum `json:"checksum,omitempty"`
	// URI that points at the file to create the file_item from.
...
type _FileItemResourcesDefStatus FileItemResourcesDefStatus
...
func NewFileItemResourcesDefStatus() *FileItemResourcesDefStatus {
	this := FileItemResourcesDefStatus{}
	return &this
}
...
// GetSourceAuth returns the SourceAuth field value if set, zero value otherwise.
func (o *FileItemResourcesDefStatus) GetSourceAuth() SourceAuth {
	if o == nil || IsNil(o.SourceAuth) {
		var ret SourceAuth
		return ret
	}
	return *o.SourceAuth
...
// GetSourceAuthOk returns a tuple with the SourceAuth field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FileItemResourcesDefStatus) GetSourceAuthOk() (*SourceAuth, bool) {
	if o == nil || IsNil(o.SourceAuth) {
		return nil, false
	}
	return o.SourceAuth, true
}
...
// SetSourceAuth gets a reference to the given SourceAuth and assigns it to the SourceAuth field.
...
func (o FileItemResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o FileItemResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SourceAuth) {
		toSerialize["source_auth"] = o.SourceAuth
	}
...
func (o *FileItemResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varFileItemResourcesDefStatus := _FileItemResourcesDefStatus{}

	err = json.Unmarshal(data, &varFileItemResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = FileItemResourcesDefStatus(varFileItemResourcesDefStatus)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "source_auth")
...
type NullableFileItemResourcesDefStatus struct {
	value *FileItemResourcesDefStatus
	isSet bool
}

func (v NullableFileItemResourcesDefStatus) Get() *FileItemResourcesDefStatus {
	return v.value
}

func (v *NullableFileItemResourcesDefStatus) Set(val *FileItemResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemResourcesDefStatus(val *FileItemResourcesDefStatus) *NullableFileItemResourcesDefStatus {
	return &NullableFileItemResourcesDefStatus{value: val, isSet: true}
}

func (v NullableFileItemResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
