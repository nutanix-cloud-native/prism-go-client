...
// CloudCredentialsMetadata The cloud_credentials kind metadata
type CloudCredentialsMetadata struct {
	...
	// Categories for the cloud_credentials. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the cloud_credentials. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
func (o *CloudCredentialsMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *CloudCredentialsMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *CloudCredentialsMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCloudCredentialsMetadata)
