...
// checks if the CategoryMappingStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingStatus{}

// CategoryMappingStatus The status of a REST API call. Only used when there is a failure to report. 
type CategoryMappingStatus struct {
	// The kind name
...
type _CategoryMappingStatus CategoryMappingStatus
...
func (o CategoryMappingStatus) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingStatus) UnmarshalJSON(data []byte) (err error) {
	varCategoryMappingStatus := _CategoryMappingStatus{}

	err = json.Unmarshal(data, &varCategoryMappingStatus)

	if err != nil {
		return err
	}

	*o = CategoryMappingStatus(varCategoryMappingStatus)
...
type NullableCategoryMappingStatus struct {
	value *CategoryMappingStatus
	isSet bool
}

func (v NullableCategoryMappingStatus) Get() *CategoryMappingStatus {
	return v.value
}

func (v *NullableCategoryMappingStatus) Set(val *CategoryMappingStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingStatus(val *CategoryMappingStatus) *NullableCategoryMappingStatus {
	return &NullableCategoryMappingStatus{value: val, isSet: true}
}

func (v NullableCategoryMappingStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
