...
// checks if the AlertIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertIntentInput{}

// AlertIntentInput An intentful representation of a alert
type AlertIntentInput struct {
	Spec Alert `json:"spec"`
...
type _AlertIntentInput AlertIntentInput
...
func (o AlertIntentInput) MarshalJSON() ([]byte, error) {
...
func (o AlertIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *AlertIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertIntentInput := _AlertIntentInput{}

	err = json.Unmarshal(data, &varAlertIntentInput)

	if err != nil {
		return err
	}

	*o = AlertIntentInput(varAlertIntentInput)
...
type NullableAlertIntentInput struct {
	value *AlertIntentInput
	isSet bool
}

func (v NullableAlertIntentInput) Get() *AlertIntentInput {
	return v.value
}

func (v *NullableAlertIntentInput) Set(val *AlertIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertIntentInput(val *AlertIntentInput) *NullableAlertIntentInput {
	return &NullableAlertIntentInput{value: val, isSet: true}
}

func (v NullableAlertIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
