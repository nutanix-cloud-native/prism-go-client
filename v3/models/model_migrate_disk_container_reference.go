...
// checks if the MigrateDiskContainerReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MigrateDiskContainerReference{}

// MigrateDiskContainerReference Specifies the disk and the target container
type MigrateDiskContainerReference struct {
	// The VM disks to be migrated
	DiskUuidList []string `json:"disk_uuid_list"`
	TargetContainerReference Reference `json:"target_container_reference"`
	AdditionalProperties map[string]interface{}
}

type _MigrateDiskContainerReference MigrateDiskContainerReference
...
func NewMigrateDiskContainerReference(diskUuidList []string, targetContainerReference Reference) *MigrateDiskContainerReference {
	this := MigrateDiskContainerReference{}
	this.DiskUuidList = diskUuidList
	this.TargetContainerReference = targetContainerReference
	return &this
}
...
// GetDiskUuidList returns the DiskUuidList field value
func (o *MigrateDiskContainerReference) GetDiskUuidList() []string {
	...
	return o.DiskUuidList
}

// GetDiskUuidListOk returns a tuple with the DiskUuidList field value
// and a boolean to check if the value has been set.
func (o *MigrateDiskContainerReference) GetDiskUuidListOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.DiskUuidList, true
}

// SetDiskUuidList sets field value
func (o *MigrateDiskContainerReference) SetDiskUuidList(v []string) {
	o.DiskUuidList = v
}

// GetTargetContainerReference returns the TargetContainerReference field value
func (o *MigrateDiskContainerReference) GetTargetContainerReference() Reference {
	...
	return o.TargetContainerReference
}

// GetTargetContainerReferenceOk returns a tuple with the TargetContainerReference field value
// and a boolean to check if the value has been set.
func (o *MigrateDiskContainerReference) GetTargetContainerReferenceOk() (*Reference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TargetContainerReference, true
}

// SetTargetContainerReference sets field value
func (o *MigrateDiskContainerReference) SetTargetContainerReference(v Reference) {
	o.TargetContainerReference = v
}

func (o MigrateDiskContainerReference) MarshalJSON() ([]byte, error) {
...
func (o MigrateDiskContainerReference) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["disk_uuid_list"] = o.DiskUuidList
	toSerialize["target_container_reference"] = o.TargetContainerReference
...
func (o *MigrateDiskContainerReference) UnmarshalJSON(data []byte) (err error) {
	...
	varMigrateDiskContainerReference := _MigrateDiskContainerReference{}

	err = json.Unmarshal(data, &varMigrateDiskContainerReference)

	if err != nil {
		return err
	}

	*o = MigrateDiskContainerReference(varMigrateDiskContainerReference)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "disk_uuid_list")
		delete(additionalProperties, "target_container_reference")
...
type NullableMigrateDiskContainerReference struct {
	value *MigrateDiskContainerReference
	isSet bool
}

func (v NullableMigrateDiskContainerReference) Get() *MigrateDiskContainerReference {
	return v.value
}

func (v *NullableMigrateDiskContainerReference) Set(val *MigrateDiskContainerReference) {
	v.value = val
	v.isSet = true
}

func (v NullableMigrateDiskContainerReference) IsSet() bool {
	return v.isSet
}

func (v *NullableMigrateDiskContainerReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMigrateDiskContainerReference(val *MigrateDiskContainerReference) *NullableMigrateDiskContainerReference {
	return &NullableMigrateDiskContainerReference{value: val, isSet: true}
}

func (v NullableMigrateDiskContainerReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMigrateDiskContainerReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
