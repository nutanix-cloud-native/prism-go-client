...
// checks if the GuestCustomizationCloudInit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestCustomizationCloudInit{}
...
type _GuestCustomizationCloudInit GuestCustomizationCloudInit
...
func NewGuestCustomizationCloudInit() *GuestCustomizationCloudInit {
	this := GuestCustomizationCloudInit{}
	return &this
}
...
func (o GuestCustomizationCloudInit) MarshalJSON() ([]byte, error) {
...
func (o GuestCustomizationCloudInit) ToMap() (map[string]interface{}, error) {
...
func (o *GuestCustomizationCloudInit) UnmarshalJSON(data []byte) (err error) {
	varGuestCustomizationCloudInit := _GuestCustomizationCloudInit{}

	err = json.Unmarshal(data, &varGuestCustomizationCloudInit)

	if err != nil {
		return err
	}

	*o = GuestCustomizationCloudInit(varGuestCustomizationCloudInit)
...
type NullableGuestCustomizationCloudInit struct {
	value *GuestCustomizationCloudInit
	isSet bool
}

func (v NullableGuestCustomizationCloudInit) Get() *GuestCustomizationCloudInit {
	return v.value
}

func (v *NullableGuestCustomizationCloudInit) Set(val *GuestCustomizationCloudInit) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestCustomizationCloudInit) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestCustomizationCloudInit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestCustomizationCloudInit(val *GuestCustomizationCloudInit) *NullableGuestCustomizationCloudInit {
	return &NullableGuestCustomizationCloudInit{value: val, isSet: true}
}

func (v NullableGuestCustomizationCloudInit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestCustomizationCloudInit) UnmarshalJSON(src []byte) error {
	v.isSet = true
