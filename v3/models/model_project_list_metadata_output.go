...
// checks if the ProjectListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectListMetadataOutput{}

// ProjectListMetadataOutput All api calls that return a list will have this metadata block 
...
type _ProjectListMetadataOutput ProjectListMetadataOutput
...
func NewProjectListMetadataOutput() *ProjectListMetadataOutput {
	this := ProjectListMetadataOutput{}
...
// and a boolean to check if the value has been set.
func (o *ProjectListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o ProjectListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ProjectListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varProjectListMetadataOutput := _ProjectListMetadataOutput{}

	err = json.Unmarshal(data, &varProjectListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ProjectListMetadataOutput(varProjectListMetadataOutput)
...
type NullableProjectListMetadataOutput struct {
	value *ProjectListMetadataOutput
	isSet bool
}

func (v NullableProjectListMetadataOutput) Get() *ProjectListMetadataOutput {
	return v.value
}

func (v *NullableProjectListMetadataOutput) Set(val *ProjectListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectListMetadataOutput(val *ProjectListMetadataOutput) *NullableProjectListMetadataOutput {
	return &NullableProjectListMetadataOutput{value: val, isSet: true}
}

func (v NullableProjectListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
