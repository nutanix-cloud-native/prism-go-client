...
// checks if the RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner{}

// RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner struct for RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner
type RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner struct {
	...
	VmNicInformation RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInnerVmNicInformation `json:"vm_nic_information"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner
...
func NewRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner(vmReference VmReference, vmNicInformation RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInnerVmNicInformation) *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner {
	this := RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner{}
	this.VmReference = vmReference
	this.VmNicInformation = vmNicInformation
	return &this
}
...
// GetTestFloatingIpConfig returns the TestFloatingIpConfig field value if set, zero value otherwise.
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) GetTestFloatingIpConfig() RecoveryPlanFloatingIpConfig {
	if o == nil || IsNil(o.TestFloatingIpConfig) {
		var ret RecoveryPlanFloatingIpConfig
		return ret
	}
	return *o.TestFloatingIpConfig
}

// GetTestFloatingIpConfigOk returns a tuple with the TestFloatingIpConfig field value if set, nil otherwise
...
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) GetTestFloatingIpConfigOk() (*RecoveryPlanFloatingIpConfig, bool) {
	...
	return o.TestFloatingIpConfig, true
}
...
// SetTestFloatingIpConfig gets a reference to the given RecoveryPlanFloatingIpConfig and assigns it to the TestFloatingIpConfig field.
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) SetTestFloatingIpConfig(v RecoveryPlanFloatingIpConfig) {
	o.TestFloatingIpConfig = &v
}

// GetRecoveryFloatingIpConfig returns the RecoveryFloatingIpConfig field value if set, zero value otherwise.
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) GetRecoveryFloatingIpConfig() RecoveryPlanFloatingIpConfig {
	if o == nil || IsNil(o.RecoveryFloatingIpConfig) {
		var ret RecoveryPlanFloatingIpConfig
		return ret
	}
	return *o.RecoveryFloatingIpConfig
}

// GetRecoveryFloatingIpConfigOk returns a tuple with the RecoveryFloatingIpConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) GetRecoveryFloatingIpConfigOk() (*RecoveryPlanFloatingIpConfig, bool) {
	...
	return o.RecoveryFloatingIpConfig, true
}
...
// SetRecoveryFloatingIpConfig gets a reference to the given RecoveryPlanFloatingIpConfig and assigns it to the RecoveryFloatingIpConfig field.
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) SetRecoveryFloatingIpConfig(v RecoveryPlanFloatingIpConfig) {
	o.RecoveryFloatingIpConfig = &v
}

// GetVmReference returns the VmReference field value
...
// GetVmReferenceOk returns a tuple with the VmReference field value
// and a boolean to check if the value has been set.
...
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) GetVmNicInformation() RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInnerVmNicInformation {
	if o == nil {
		var ret RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInnerVmNicInformation
		return ret
	}

	return o.VmNicInformation
}

// GetVmNicInformationOk returns a tuple with the VmNicInformation field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) GetVmNicInformationOk() (*RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInnerVmNicInformation, bool) {
	...
	return &o.VmNicInformation, true
}

// SetVmNicInformation sets field value
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) SetVmNicInformation(v RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInnerVmNicInformation) {
	o.VmNicInformation = v
}

func (o RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TestFloatingIpConfig) {
		toSerialize["test_floating_ip_config"] = o.TestFloatingIpConfig
	}
	if !IsNil(o.RecoveryFloatingIpConfig) {
		toSerialize["recovery_floating_ip_config"] = o.RecoveryFloatingIpConfig
	}
	toSerialize["vm_reference"] = o.VmReference
	toSerialize["vm_nic_information"] = o.VmNicInformation
...
func (o *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner := _RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner{}

	err = json.Unmarshal(data, &varRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner)

	if err != nil {
		return err
	}

	*o = RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner(varRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "test_floating_ip_config")
		delete(additionalProperties, "recovery_floating_ip_config")
		delete(additionalProperties, "vm_reference")
		delete(additionalProperties, "vm_nic_information")
...
type NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner struct {
	value *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner
	isSet bool
}

func (v NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) Get() *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner {
	return v.value
}

func (v *NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) Set(val *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner(val *RecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) *NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner {
	return &NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner{value: val, isSet: true}
}

func (v NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanResourcesParametersFloatingIpAssignmentListInnerVmIpAssignmentListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
