...
// SourceAuth File item source authentication object.
type SourceAuth struct {
	AwsAuth *AwsCredentials `json:"aws_auth,omitempty"`
...
// SetAwsAuth gets a reference to the given AwsCredentials and assigns it to the AwsAuth field.
...
func (o *SourceAuth) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSourceAuth)
