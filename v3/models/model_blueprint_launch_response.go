...
// checks if the BlueprintLaunchResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintLaunchResponse{}

// BlueprintLaunchResponse Response containing the application uuid and create action and runlog uuid
type BlueprintLaunchResponse struct {
	Status BlueprintLaunchResponseStatus `json:"status"`
	Spec BlueprintLaunchSpec `json:"spec"`
...
type _BlueprintLaunchResponse BlueprintLaunchResponse
...
func (o *BlueprintLaunchResponse) GetStatus() BlueprintLaunchResponseStatus {
	if o == nil {
		var ret BlueprintLaunchResponseStatus
		return ret
	}
...
func (o BlueprintLaunchResponse) MarshalJSON() ([]byte, error) {
...
func (o BlueprintLaunchResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintLaunchResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintLaunchResponse := _BlueprintLaunchResponse{}

	err = json.Unmarshal(data, &varBlueprintLaunchResponse)

	if err != nil {
		return err
	}

	*o = BlueprintLaunchResponse(varBlueprintLaunchResponse)
...
type NullableBlueprintLaunchResponse struct {
	value *BlueprintLaunchResponse
	isSet bool
}

func (v NullableBlueprintLaunchResponse) Get() *BlueprintLaunchResponse {
	return v.value
}

func (v *NullableBlueprintLaunchResponse) Set(val *BlueprintLaunchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintLaunchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintLaunchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintLaunchResponse(val *BlueprintLaunchResponse) *NullableBlueprintLaunchResponse {
	return &NullableBlueprintLaunchResponse{value: val, isSet: true}
}

func (v NullableBlueprintLaunchResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintLaunchResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
