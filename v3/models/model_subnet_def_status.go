...
// checks if the SubnetDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubnetDefStatus{}
...
type _SubnetDefStatus SubnetDefStatus
...
func (o *SubnetDefStatus) GetResources() SubnetResourcesDefStatus {
	if o == nil {
		var ret SubnetResourcesDefStatus
		return ret
	}
...
func (o SubnetDefStatus) MarshalJSON() ([]byte, error) {
...
func (o SubnetDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *SubnetDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varSubnetDefStatus := _SubnetDefStatus{}

	err = json.Unmarshal(data, &varSubnetDefStatus)

	if err != nil {
		return err
	}

	*o = SubnetDefStatus(varSubnetDefStatus)
...
type NullableSubnetDefStatus struct {
	value *SubnetDefStatus
	isSet bool
}

func (v NullableSubnetDefStatus) Get() *SubnetDefStatus {
	return v.value
}

func (v *NullableSubnetDefStatus) Set(val *SubnetDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableSubnetDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableSubnetDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubnetDefStatus(val *SubnetDefStatus) *NullableSubnetDefStatus {
	return &NullableSubnetDefStatus{value: val, isSet: true}
}

func (v NullableSubnetDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubnetDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
