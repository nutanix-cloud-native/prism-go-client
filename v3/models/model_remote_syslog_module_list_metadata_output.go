...
// checks if the RemoteSyslogModuleListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogModuleListMetadataOutput{}

// RemoteSyslogModuleListMetadataOutput All api calls that return a list will have this metadata block 
type RemoteSyslogModuleListMetadataOutput struct {
	// The kind name
...
type _RemoteSyslogModuleListMetadataOutput RemoteSyslogModuleListMetadataOutput
...
func NewRemoteSyslogModuleListMetadataOutput() *RemoteSyslogModuleListMetadataOutput {
	this := RemoteSyslogModuleListMetadataOutput{}
	var kind string = "remote_syslog_module"
	this.Kind = &kind
	return &this
}
...
func (o *RemoteSyslogModuleListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *RemoteSyslogModuleListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o RemoteSyslogModuleListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogModuleListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogModuleListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varRemoteSyslogModuleListMetadataOutput := _RemoteSyslogModuleListMetadataOutput{}

	err = json.Unmarshal(data, &varRemoteSyslogModuleListMetadataOutput)

	if err != nil {
		return err
	}

	*o = RemoteSyslogModuleListMetadataOutput(varRemoteSyslogModuleListMetadataOutput)
...
type NullableRemoteSyslogModuleListMetadataOutput struct {
	value *RemoteSyslogModuleListMetadataOutput
	isSet bool
}

func (v NullableRemoteSyslogModuleListMetadataOutput) Get() *RemoteSyslogModuleListMetadataOutput {
	return v.value
}

func (v *NullableRemoteSyslogModuleListMetadataOutput) Set(val *RemoteSyslogModuleListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogModuleListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogModuleListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogModuleListMetadataOutput(val *RemoteSyslogModuleListMetadataOutput) *NullableRemoteSyslogModuleListMetadataOutput {
	return &NullableRemoteSyslogModuleListMetadataOutput{value: val, isSet: true}
}

func (v NullableRemoteSyslogModuleListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogModuleListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
