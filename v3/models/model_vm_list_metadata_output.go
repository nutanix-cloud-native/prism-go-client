...
// checks if the VmListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmListMetadataOutput{}
...
type _VmListMetadataOutput VmListMetadataOutput
...
// and a boolean to check if the value has been set.
func (o *VmListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o VmListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VmListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VmListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVmListMetadataOutput := _VmListMetadataOutput{}

	err = json.Unmarshal(data, &varVmListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VmListMetadataOutput(varVmListMetadataOutput)
...
type NullableVmListMetadataOutput struct {
	value *VmListMetadataOutput
	isSet bool
}

func (v NullableVmListMetadataOutput) Get() *VmListMetadataOutput {
	return v.value
}

func (v *NullableVmListMetadataOutput) Set(val *VmListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmListMetadataOutput(val *VmListMetadataOutput) *NullableVmListMetadataOutput {
	return &NullableVmListMetadataOutput{value: val, isSet: true}
}

func (v NullableVmListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
