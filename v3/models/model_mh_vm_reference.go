...
// checks if the MhVmReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmReference{}

// MhVmReference The reference to a mh_vm
type MhVmReference struct {
	// The kind name
...
type _MhVmReference MhVmReference
...
func (o MhVmReference) MarshalJSON() ([]byte, error) {
...
func (o MhVmReference) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmReference) UnmarshalJSON(data []byte) (err error) {
	...
	varMhVmReference := _MhVmReference{}

	err = json.Unmarshal(data, &varMhVmReference)

	if err != nil {
		return err
	}

	*o = MhVmReference(varMhVmReference)
...
type NullableMhVmReference struct {
	value *MhVmReference
	isSet bool
}

func (v NullableMhVmReference) Get() *MhVmReference {
	return v.value
}

func (v *NullableMhVmReference) Set(val *MhVmReference) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmReference) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmReference(val *MhVmReference) *NullableMhVmReference {
	return &NullableMhVmReference{value: val, isSet: true}
}

func (v NullableMhVmReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
