...
// ProtocolParameters Routing policy IP protocol parameters
...
// SetUdp gets a reference to the given Udp and assigns it to the Udp field.
...
// SetIcmp gets a reference to the given Icmp and assigns it to the Icmp field.
...
// SetTcp gets a reference to the given Tcp and assigns it to the Tcp field.
...
func (o *ProtocolParameters) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varProtocolParameters)
