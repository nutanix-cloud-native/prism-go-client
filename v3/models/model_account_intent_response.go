...
// checks if the AccountIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountIntentResponse{}

// AccountIntentResponse Response object for intentful operations on a account
type AccountIntentResponse struct {
...
type _AccountIntentResponse AccountIntentResponse
...
func (o AccountIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AccountIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AccountIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountIntentResponse := _AccountIntentResponse{}

	err = json.Unmarshal(data, &varAccountIntentResponse)

	if err != nil {
		return err
	}

	*o = AccountIntentResponse(varAccountIntentResponse)
...
type NullableAccountIntentResponse struct {
	value *AccountIntentResponse
	isSet bool
}

func (v NullableAccountIntentResponse) Get() *AccountIntentResponse {
	return v.value
}

func (v *NullableAccountIntentResponse) Set(val *AccountIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountIntentResponse(val *AccountIntentResponse) *NullableAccountIntentResponse {
	return &NullableAccountIntentResponse{value: val, isSet: true}
}

func (v NullableAccountIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
