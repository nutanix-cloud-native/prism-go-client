...
// checks if the AwsImageListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsImageListIntentResponse{}

// AwsImageListIntentResponse AWS VPC entity list.
type AwsImageListIntentResponse struct {
	Entities []AwsImageIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsImageListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsImageListIntentResponse AwsImageListIntentResponse
...
func NewAwsImageListIntentResponse(apiVersion string, metadata AwsImageListMetadataOutput) *AwsImageListIntentResponse {
	this := AwsImageListIntentResponse{}
...
func (o *AwsImageListIntentResponse) GetEntities() []AwsImageIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []AwsImageIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []AwsImageIntentResource and assigns it to the Entities field.
...
func (o *AwsImageListIntentResponse) GetMetadata() AwsImageListMetadataOutput {
	if o == nil {
		var ret AwsImageListMetadataOutput
		return ret
	}
...
func (o AwsImageListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsImageListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsImageListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsImageListIntentResponse := _AwsImageListIntentResponse{}

	err = json.Unmarshal(data, &varAwsImageListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsImageListIntentResponse(varAwsImageListIntentResponse)
...
type NullableAwsImageListIntentResponse struct {
	value *AwsImageListIntentResponse
	isSet bool
}

func (v NullableAwsImageListIntentResponse) Get() *AwsImageListIntentResponse {
	return v.value
}

func (v *NullableAwsImageListIntentResponse) Set(val *AwsImageListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsImageListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsImageListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsImageListIntentResponse(val *AwsImageListIntentResponse) *NullableAwsImageListIntentResponse {
	return &NullableAwsImageListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsImageListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsImageListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
