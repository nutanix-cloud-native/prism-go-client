...
// checks if the AppCredentialResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCredentialResponseDownload{}

// AppCredentialResponseDownload Credential definition for Application
type AppCredentialResponseDownload struct {
	// 
	...
	// Credential passphrase object associated with the provided key
	Passphrase map[string]interface{} `json:"passphrase,omitempty"`
	// 
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AppCredentialResponseDownload AppCredentialResponseDownload
...
func NewAppCredentialResponseDownload(username string, name string, secret map[string]interface{}, type_ string) *AppCredentialResponseDownload {
	this := AppCredentialResponseDownload{}
...
// SetPassphrase gets a reference to the given map[string]interface{} and assigns it to the Passphrase field.
...
func (o AppCredentialResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o AppCredentialResponseDownload) ToMap() (map[string]interface{}, error) {
...
func (o *AppCredentialResponseDownload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCredentialResponseDownload := _AppCredentialResponseDownload{}

	err = json.Unmarshal(data, &varAppCredentialResponseDownload)

	if err != nil {
		return err
	}

	*o = AppCredentialResponseDownload(varAppCredentialResponseDownload)
...
type NullableAppCredentialResponseDownload struct {
	value *AppCredentialResponseDownload
	isSet bool
}

func (v NullableAppCredentialResponseDownload) Get() *AppCredentialResponseDownload {
	return v.value
}

func (v *NullableAppCredentialResponseDownload) Set(val *AppCredentialResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCredentialResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCredentialResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCredentialResponseDownload(val *AppCredentialResponseDownload) *NullableAppCredentialResponseDownload {
	return &NullableAppCredentialResponseDownload{value: val, isSet: true}
}

func (v NullableAppCredentialResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCredentialResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
