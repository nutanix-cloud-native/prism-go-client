...
// checks if the AppActionrunResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppActionrunResponse{}

// AppActionrunResponse Response object for action_run, contains action_run_log
type AppActionrunResponse struct {
	Status AppActionrunStatus `json:"status"`
	Spec AppActionrunSpec `json:"spec"`
...
type _AppActionrunResponse AppActionrunResponse
...
func (o AppActionrunResponse) MarshalJSON() ([]byte, error) {
...
func (o AppActionrunResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppActionrunResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppActionrunResponse := _AppActionrunResponse{}

	err = json.Unmarshal(data, &varAppActionrunResponse)

	if err != nil {
		return err
	}

	*o = AppActionrunResponse(varAppActionrunResponse)
...
type NullableAppActionrunResponse struct {
	value *AppActionrunResponse
	isSet bool
}

func (v NullableAppActionrunResponse) Get() *AppActionrunResponse {
	return v.value
}

func (v *NullableAppActionrunResponse) Set(val *AppActionrunResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppActionrunResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppActionrunResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppActionrunResponse(val *AppActionrunResponse) *NullableAppActionrunResponse {
	return &NullableAppActionrunResponse{value: val, isSet: true}
}

func (v NullableAppActionrunResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppActionrunResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
