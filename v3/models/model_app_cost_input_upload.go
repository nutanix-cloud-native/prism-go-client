...
// checks if the AppCostInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCostInputUpload{}

// AppCostInputUpload Cost definition for Application
type AppCostInputUpload struct {
	// 
...
type _AppCostInputUpload AppCostInputUpload
...
func (o AppCostInputUpload) MarshalJSON() ([]byte, error) {
...
func (o AppCostInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppCostInputUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCostInputUpload := _AppCostInputUpload{}

	err = json.Unmarshal(data, &varAppCostInputUpload)

	if err != nil {
		return err
	}

	*o = AppCostInputUpload(varAppCostInputUpload)
...
type NullableAppCostInputUpload struct {
	value *AppCostInputUpload
	isSet bool
}

func (v NullableAppCostInputUpload) Get() *AppCostInputUpload {
	return v.value
}

func (v *NullableAppCostInputUpload) Set(val *AppCostInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCostInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCostInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCostInputUpload(val *AppCostInputUpload) *NullableAppCostInputUpload {
	return &NullableAppCostInputUpload{value: val, isSet: true}
}

func (v NullableAppCostInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCostInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
