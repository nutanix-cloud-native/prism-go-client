...
// checks if the ActionTypeReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTypeReference{}

// ActionTypeReference The reference to a action_type
type ActionTypeReference struct {
	// The kind name
...
type _ActionTypeReference ActionTypeReference
...
func (o ActionTypeReference) MarshalJSON() ([]byte, error) {
...
func (o ActionTypeReference) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTypeReference) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTypeReference := _ActionTypeReference{}

	err = json.Unmarshal(data, &varActionTypeReference)

	if err != nil {
		return err
	}

	*o = ActionTypeReference(varActionTypeReference)
...
type NullableActionTypeReference struct {
	value *ActionTypeReference
	isSet bool
}

func (v NullableActionTypeReference) Get() *ActionTypeReference {
	return v.value
}

func (v *NullableActionTypeReference) Set(val *ActionTypeReference) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTypeReference) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTypeReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTypeReference(val *ActionTypeReference) *NullableActionTypeReference {
	return &NullableActionTypeReference{value: val, isSet: true}
}

func (v NullableActionTypeReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTypeReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
