...
// checks if the BlueprintLaunchInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintLaunchInput{}

// BlueprintLaunchInput Launch Blueprint request.
type BlueprintLaunchInput struct {
...
type _BlueprintLaunchInput BlueprintLaunchInput
...
func (o BlueprintLaunchInput) MarshalJSON() ([]byte, error) {
...
func (o BlueprintLaunchInput) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintLaunchInput) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintLaunchInput := _BlueprintLaunchInput{}

	err = json.Unmarshal(data, &varBlueprintLaunchInput)

	if err != nil {
		return err
	}

	*o = BlueprintLaunchInput(varBlueprintLaunchInput)
...
type NullableBlueprintLaunchInput struct {
	value *BlueprintLaunchInput
	isSet bool
}

func (v NullableBlueprintLaunchInput) Get() *BlueprintLaunchInput {
	return v.value
}

func (v *NullableBlueprintLaunchInput) Set(val *BlueprintLaunchInput) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintLaunchInput) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintLaunchInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintLaunchInput(val *BlueprintLaunchInput) *NullableBlueprintLaunchInput {
	return &NullableBlueprintLaunchInput{value: val, isSet: true}
}

func (v NullableBlueprintLaunchInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintLaunchInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
