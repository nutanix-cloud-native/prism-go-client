...
// checks if the ReportConfigDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigDefStatus{}

// ReportConfigDefStatus Report Config creation/modification spec.
type ReportConfigDefStatus struct {
	// The state of the report config entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	// Name of the report config.
	Name string `json:"name"`
	Resources ReportConfigResources1 `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _ReportConfigDefStatus ReportConfigDefStatus
...
func (o *ReportConfigDefStatus) GetResources() ReportConfigResources1 {
	if o == nil {
		var ret ReportConfigResources1
		return ret
	}
...
func (o ReportConfigDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfigDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varReportConfigDefStatus := _ReportConfigDefStatus{}

	err = json.Unmarshal(data, &varReportConfigDefStatus)

	if err != nil {
		return err
	}

	*o = ReportConfigDefStatus(varReportConfigDefStatus)
...
type NullableReportConfigDefStatus struct {
	value *ReportConfigDefStatus
	isSet bool
}

func (v NullableReportConfigDefStatus) Get() *ReportConfigDefStatus {
	return v.value
}

func (v *NullableReportConfigDefStatus) Set(val *ReportConfigDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigDefStatus(val *ReportConfigDefStatus) *NullableReportConfigDefStatus {
	return &NullableReportConfigDefStatus{value: val, isSet: true}
}

func (v NullableReportConfigDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
