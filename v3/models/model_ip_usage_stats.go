...
// checks if the IpUsageStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpUsageStats{}
...
type IpUsageStats struct {
	...
	IpPoolsStats []PoolStats `json:"ip_pools_stats,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _IpUsageStats IpUsageStats
...
// GetNumFreeIps returns the NumFreeIps field value if set, zero value otherwise.
func (o *IpUsageStats) GetNumFreeIps() int32 {
	if o == nil || IsNil(o.NumFreeIps) {
		var ret int32
		return ret
	}
	return *o.NumFreeIps
...
// GetNumFreeIpsOk returns a tuple with the NumFreeIps field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpUsageStats) GetNumFreeIpsOk() (*int32, bool) {
	if o == nil || IsNil(o.NumFreeIps) {
		return nil, false
	}
	return o.NumFreeIps, true
}
...
// SetNumFreeIps gets a reference to the given int32 and assigns it to the NumFreeIps field.
func (o *IpUsageStats) SetNumFreeIps(v int32) {
	o.NumFreeIps = &v
}

// GetNumMacs returns the NumMacs field value if set, zero value otherwise.
func (o *IpUsageStats) GetNumMacs() int32 {
	if o == nil || IsNil(o.NumMacs) {
		var ret int32
		return ret
	}
	return *o.NumMacs
...
// GetNumMacsOk returns a tuple with the NumMacs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpUsageStats) GetNumMacsOk() (*int32, bool) {
	if o == nil || IsNil(o.NumMacs) {
		return nil, false
	}
	return o.NumMacs, true
}
...
// SetNumMacs gets a reference to the given int32 and assigns it to the NumMacs field.
func (o *IpUsageStats) SetNumMacs(v int32) {
	o.NumMacs = &v
}

// GetNumAssignedIps returns the NumAssignedIps field value if set, zero value otherwise.
func (o *IpUsageStats) GetNumAssignedIps() int32 {
	if o == nil || IsNil(o.NumAssignedIps) {
		var ret int32
		return ret
	}
	return *o.NumAssignedIps
}

// GetNumAssignedIpsOk returns a tuple with the NumAssignedIps field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpUsageStats) GetNumAssignedIpsOk() (*int32, bool) {
	if o == nil || IsNil(o.NumAssignedIps) {
		return nil, false
	}
	return o.NumAssignedIps, true
}
...
// SetNumAssignedIps gets a reference to the given int32 and assigns it to the NumAssignedIps field.
func (o *IpUsageStats) SetNumAssignedIps(v int32) {
	o.NumAssignedIps = &v
}

// GetIpPoolsStats returns the IpPoolsStats field value if set, zero value otherwise.
func (o *IpUsageStats) GetIpPoolsStats() []PoolStats {
	if o == nil || IsNil(o.IpPoolsStats) {
		var ret []PoolStats
		return ret
	}
	return o.IpPoolsStats
}

// GetIpPoolsStatsOk returns a tuple with the IpPoolsStats field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpUsageStats) GetIpPoolsStatsOk() ([]PoolStats, bool) {
	if o == nil || IsNil(o.IpPoolsStats) {
		return nil, false
	}
	return o.IpPoolsStats, true
}
...
// SetIpPoolsStats gets a reference to the given []PoolStats and assigns it to the IpPoolsStats field.
func (o *IpUsageStats) SetIpPoolsStats(v []PoolStats) {
	o.IpPoolsStats = v
}

func (o IpUsageStats) MarshalJSON() ([]byte, error) {
...
func (o IpUsageStats) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.NumFreeIps) {
		toSerialize["num_free_ips"] = o.NumFreeIps
	}
	if !IsNil(o.NumMacs) {
		toSerialize["num_macs"] = o.NumMacs
	}
	if !IsNil(o.NumAssignedIps) {
		toSerialize["num_assigned_ips"] = o.NumAssignedIps
	}
	if !IsNil(o.IpPoolsStats) {
		toSerialize["ip_pools_stats"] = o.IpPoolsStats
	}
...
func (o *IpUsageStats) UnmarshalJSON(data []byte) (err error) {
	varIpUsageStats := _IpUsageStats{}

	err = json.Unmarshal(data, &varIpUsageStats)

	if err != nil {
		return err
	}

	*o = IpUsageStats(varIpUsageStats)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "num_free_ips")
		delete(additionalProperties, "num_macs")
		delete(additionalProperties, "num_assigned_ips")
		delete(additionalProperties, "ip_pools_stats")
...
type NullableIpUsageStats struct {
	value *IpUsageStats
	isSet bool
}

func (v NullableIpUsageStats) Get() *IpUsageStats {
	return v.value
}

func (v *NullableIpUsageStats) Set(val *IpUsageStats) {
	v.value = val
	v.isSet = true
}

func (v NullableIpUsageStats) IsSet() bool {
	return v.isSet
}

func (v *NullableIpUsageStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpUsageStats(val *IpUsageStats) *NullableIpUsageStats {
	return &NullableIpUsageStats{value: val, isSet: true}
}

func (v NullableIpUsageStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpUsageStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
