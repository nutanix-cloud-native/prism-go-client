...
// checks if the CommonReportConfigResources1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigResources1{}

// CommonReportConfigResources1 Common report config resources definition.
type CommonReportConfigResources1 struct {
...
type _CommonReportConfigResources1 CommonReportConfigResources1
...
func NewCommonReportConfigResources1() *CommonReportConfigResources1 {
	this := CommonReportConfigResources1{}
	return &this
}
...
func (o CommonReportConfigResources1) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigResources1) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfigResources1) UnmarshalJSON(data []byte) (err error) {
	varCommonReportConfigResources1 := _CommonReportConfigResources1{}

	err = json.Unmarshal(data, &varCommonReportConfigResources1)

	if err != nil {
		return err
	}

	*o = CommonReportConfigResources1(varCommonReportConfigResources1)
...
type NullableCommonReportConfigResources1 struct {
	value *CommonReportConfigResources1
	isSet bool
}

func (v NullableCommonReportConfigResources1) Get() *CommonReportConfigResources1 {
	return v.value
}

func (v *NullableCommonReportConfigResources1) Set(val *CommonReportConfigResources1) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigResources1) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigResources1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigResources1(val *CommonReportConfigResources1) *NullableCommonReportConfigResources1 {
	return &NullableCommonReportConfigResources1{value: val, isSet: true}
}

func (v NullableCommonReportConfigResources1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigResources1) UnmarshalJSON(src []byte) error {
	v.isSet = true
