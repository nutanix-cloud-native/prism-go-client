...
// checks if the AppSubstrateInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSubstrateInput{}

// AppSubstrateInput Substrate definition
type AppSubstrateInput struct {
	// 
...
type _AppSubstrateInput AppSubstrateInput
...
func (o AppSubstrateInput) MarshalJSON() ([]byte, error) {
...
func (o AppSubstrateInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppSubstrateInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppSubstrateInput := _AppSubstrateInput{}

	err = json.Unmarshal(data, &varAppSubstrateInput)

	if err != nil {
		return err
	}

	*o = AppSubstrateInput(varAppSubstrateInput)
...
type NullableAppSubstrateInput struct {
	value *AppSubstrateInput
	isSet bool
}

func (v NullableAppSubstrateInput) Get() *AppSubstrateInput {
	return v.value
}

func (v *NullableAppSubstrateInput) Set(val *AppSubstrateInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppSubstrateInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppSubstrateInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppSubstrateInput(val *AppSubstrateInput) *NullableAppSubstrateInput {
	return &NullableAppSubstrateInput{value: val, isSet: true}
}

func (v NullableAppSubstrateInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppSubstrateInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
