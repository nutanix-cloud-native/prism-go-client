...
// checks if the FloatingIpListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpListIntentResponse{}

// FloatingIpListIntentResponse Response object for intentful operation of floating_ips
type FloatingIpListIntentResponse struct {
	Entities []FloatingIpIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata FloatingIpListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _FloatingIpListIntentResponse FloatingIpListIntentResponse
...
func NewFloatingIpListIntentResponse(apiVersion string, metadata FloatingIpListMetadataOutput) *FloatingIpListIntentResponse {
	this := FloatingIpListIntentResponse{}
...
func (o *FloatingIpListIntentResponse) GetEntities() []FloatingIpIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []FloatingIpIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []FloatingIpIntentResource and assigns it to the Entities field.
...
func (o *FloatingIpListIntentResponse) GetMetadata() FloatingIpListMetadataOutput {
	if o == nil {
		var ret FloatingIpListMetadataOutput
		return ret
	}
...
func (o FloatingIpListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *FloatingIpListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varFloatingIpListIntentResponse := _FloatingIpListIntentResponse{}

	err = json.Unmarshal(data, &varFloatingIpListIntentResponse)

	if err != nil {
		return err
	}

	*o = FloatingIpListIntentResponse(varFloatingIpListIntentResponse)
...
type NullableFloatingIpListIntentResponse struct {
	value *FloatingIpListIntentResponse
	isSet bool
}

func (v NullableFloatingIpListIntentResponse) Get() *FloatingIpListIntentResponse {
	return v.value
}

func (v *NullableFloatingIpListIntentResponse) Set(val *FloatingIpListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpListIntentResponse(val *FloatingIpListIntentResponse) *NullableFloatingIpListIntentResponse {
	return &NullableFloatingIpListIntentResponse{value: val, isSet: true}
}

func (v NullableFloatingIpListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
