...
// checks if the RackIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackIntentInput{}

// RackIntentInput An intentful representation of a rack
type RackIntentInput struct {
	Spec Rack `json:"spec"`
...
type _RackIntentInput RackIntentInput
...
func (o RackIntentInput) MarshalJSON() ([]byte, error) {
...
func (o RackIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *RackIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varRackIntentInput := _RackIntentInput{}

	err = json.Unmarshal(data, &varRackIntentInput)

	if err != nil {
		return err
	}

	*o = RackIntentInput(varRackIntentInput)
...
type NullableRackIntentInput struct {
	value *RackIntentInput
	isSet bool
}

func (v NullableRackIntentInput) Get() *RackIntentInput {
	return v.value
}

func (v *NullableRackIntentInput) Set(val *RackIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableRackIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableRackIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackIntentInput(val *RackIntentInput) *NullableRackIntentInput {
	return &NullableRackIntentInput{value: val, isSet: true}
}

func (v NullableRackIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
