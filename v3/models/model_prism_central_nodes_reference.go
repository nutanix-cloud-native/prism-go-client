...
// checks if the PrismCentralNodesReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralNodesReference{}

// PrismCentralNodesReference The reference to a prism_central_nodes
type PrismCentralNodesReference struct {
	// The kind name
...
type _PrismCentralNodesReference PrismCentralNodesReference

// NewPrismCentralNodesReference instantiates a new PrismCentralNodesReference object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPrismCentralNodesReference(kind string, uUID string) *PrismCentralNodesReference {
	this := PrismCentralNodesReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}

// NewPrismCentralNodesReferenceWithDefaults instantiates a new PrismCentralNodesReference object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPrismCentralNodesReferenceWithDefaults() *PrismCentralNodesReference {
	this := PrismCentralNodesReference{}
	return &this
}

// GetKind returns the Kind field value
func (o *PrismCentralNodesReference) GetKind() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *PrismCentralNodesReference) GetKindOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Kind, true
...
func (o *PrismCentralNodesReference) SetKind(v string) {
	o.Kind = v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *PrismCentralNodesReference) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *PrismCentralNodesReference) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *PrismCentralNodesReference) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *PrismCentralNodesReference) SetName(v string) {
	o.Name = &v
}

// GetUUID returns the UUID field value
func (o *PrismCentralNodesReference) GetUUID() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PrismCentralNodesReference) GetUUIDOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UUID, true
...
func (o *PrismCentralNodesReference) SetUUID(v string) {
	o.UUID = v
}

func (o PrismCentralNodesReference) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralNodesReference) ToMap() (map[string]interface{}, error) {
...
func (o *PrismCentralNodesReference) UnmarshalJSON(data []byte) (err error) {
	...
	varPrismCentralNodesReference := _PrismCentralNodesReference{}

	err = json.Unmarshal(data, &varPrismCentralNodesReference)

	if err != nil {
		return err
	}

	*o = PrismCentralNodesReference(varPrismCentralNodesReference)
...
type NullablePrismCentralNodesReference struct {
	value *PrismCentralNodesReference
	isSet bool
}

func (v NullablePrismCentralNodesReference) Get() *PrismCentralNodesReference {
	return v.value
}

func (v *NullablePrismCentralNodesReference) Set(val *PrismCentralNodesReference) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralNodesReference) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralNodesReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralNodesReference(val *PrismCentralNodesReference) *NullablePrismCentralNodesReference {
	return &NullablePrismCentralNodesReference{value: val, isSet: true}
}

func (v NullablePrismCentralNodesReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralNodesReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
