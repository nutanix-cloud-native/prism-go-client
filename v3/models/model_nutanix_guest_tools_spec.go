...
// checks if the NutanixGuestToolsSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NutanixGuestToolsSpec{}
...
type _NutanixGuestToolsSpec NutanixGuestToolsSpec
...
func (o NutanixGuestToolsSpec) MarshalJSON() ([]byte, error) {
...
func (o NutanixGuestToolsSpec) ToMap() (map[string]interface{}, error) {
...
func (o *NutanixGuestToolsSpec) UnmarshalJSON(data []byte) (err error) {
	varNutanixGuestToolsSpec := _NutanixGuestToolsSpec{}

	err = json.Unmarshal(data, &varNutanixGuestToolsSpec)

	if err != nil {
		return err
	}

	*o = NutanixGuestToolsSpec(varNutanixGuestToolsSpec)
...
type NullableNutanixGuestToolsSpec struct {
	value *NutanixGuestToolsSpec
	isSet bool
}

func (v NullableNutanixGuestToolsSpec) Get() *NutanixGuestToolsSpec {
	return v.value
}

func (v *NullableNutanixGuestToolsSpec) Set(val *NutanixGuestToolsSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableNutanixGuestToolsSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableNutanixGuestToolsSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNutanixGuestToolsSpec(val *NutanixGuestToolsSpec) *NullableNutanixGuestToolsSpec {
	return &NullableNutanixGuestToolsSpec{value: val, isSet: true}
}

func (v NullableNutanixGuestToolsSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNutanixGuestToolsSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
