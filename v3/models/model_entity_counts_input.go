...
// checks if the EntityCountsInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntityCountsInput{}

// EntityCountsInput The object dictates whether counts of realized entities, COMPLIANT entities, NON_COMPLIANT entities and IN_PROGRESS entities need to be computed. 
type EntityCountsInput struct {
	// Whether to compute counts of realized entities.
	RealizedCount *bool `json:"realized_count,omitempty"`
	// Whether to compute individual counts of entities which are COMPLIANT, NON_COMPLIANT and IN_PROGRESS. 
	ComplianceCount *bool `json:"compliance_count,omitempty"`
	// Whether to compute counts of unrealized entities.
	UnrealizedCount *bool `json:"unrealized_count,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _EntityCountsInput EntityCountsInput
...
func NewEntityCountsInput() *EntityCountsInput {
	this := EntityCountsInput{}
	var realizedCount bool = false
	this.RealizedCount = &realizedCount
	var complianceCount bool = false
	this.ComplianceCount = &complianceCount
	var unrealizedCount bool = false
	this.UnrealizedCount = &unrealizedCount
	return &this
}
...
// GetRealizedCount returns the RealizedCount field value if set, zero value otherwise.
func (o *EntityCountsInput) GetRealizedCount() bool {
	if o == nil || IsNil(o.RealizedCount) {
		var ret bool
		return ret
	}
	return *o.RealizedCount
}

// GetRealizedCountOk returns a tuple with the RealizedCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EntityCountsInput) GetRealizedCountOk() (*bool, bool) {
	if o == nil || IsNil(o.RealizedCount) {
		return nil, false
	}
	return o.RealizedCount, true
}
...
// SetRealizedCount gets a reference to the given bool and assigns it to the RealizedCount field.
...
// SetComplianceCount gets a reference to the given bool and assigns it to the ComplianceCount field.
func (o *EntityCountsInput) SetComplianceCount(v bool) {
	o.ComplianceCount = &v
}

// GetUnrealizedCount returns the UnrealizedCount field value if set, zero value otherwise.
func (o *EntityCountsInput) GetUnrealizedCount() bool {
	if o == nil || IsNil(o.UnrealizedCount) {
		var ret bool
		return ret
	}
	return *o.UnrealizedCount
}

// GetUnrealizedCountOk returns a tuple with the UnrealizedCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EntityCountsInput) GetUnrealizedCountOk() (*bool, bool) {
	if o == nil || IsNil(o.UnrealizedCount) {
		return nil, false
	}
	return o.UnrealizedCount, true
}
...
// SetUnrealizedCount gets a reference to the given bool and assigns it to the UnrealizedCount field.
func (o *EntityCountsInput) SetUnrealizedCount(v bool) {
	o.UnrealizedCount = &v
}

func (o EntityCountsInput) MarshalJSON() ([]byte, error) {
...
func (o EntityCountsInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RealizedCount) {
		toSerialize["realized_count"] = o.RealizedCount
	}
	if !IsNil(o.ComplianceCount) {
		toSerialize["compliance_count"] = o.ComplianceCount
	}
	if !IsNil(o.UnrealizedCount) {
		toSerialize["unrealized_count"] = o.UnrealizedCount
	}
...
func (o *EntityCountsInput) UnmarshalJSON(data []byte) (err error) {
	varEntityCountsInput := _EntityCountsInput{}

	err = json.Unmarshal(data, &varEntityCountsInput)

	if err != nil {
		return err
	}

	*o = EntityCountsInput(varEntityCountsInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "realized_count")
		delete(additionalProperties, "compliance_count")
		delete(additionalProperties, "unrealized_count")
...
type NullableEntityCountsInput struct {
	value *EntityCountsInput
	isSet bool
}

func (v NullableEntityCountsInput) Get() *EntityCountsInput {
	return v.value
}

func (v *NullableEntityCountsInput) Set(val *EntityCountsInput) {
	v.value = val
	v.isSet = true
}

func (v NullableEntityCountsInput) IsSet() bool {
	return v.isSet
}

func (v *NullableEntityCountsInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntityCountsInput(val *EntityCountsInput) *NullableEntityCountsInput {
	return &NullableEntityCountsInput{value: val, isSet: true}
}

func (v NullableEntityCountsInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntityCountsInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
