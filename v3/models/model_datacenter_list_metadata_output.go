...
// checks if the DatacenterListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterListMetadataOutput{}

// DatacenterListMetadataOutput All api calls that return a list will have this metadata block 
type DatacenterListMetadataOutput struct {
	// The kind name
...
type _DatacenterListMetadataOutput DatacenterListMetadataOutput
...
func NewDatacenterListMetadataOutput() *DatacenterListMetadataOutput {
	this := DatacenterListMetadataOutput{}
	var kind string = "datacenter"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *DatacenterListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o DatacenterListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o DatacenterListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *DatacenterListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varDatacenterListMetadataOutput := _DatacenterListMetadataOutput{}

	err = json.Unmarshal(data, &varDatacenterListMetadataOutput)

	if err != nil {
		return err
	}

	*o = DatacenterListMetadataOutput(varDatacenterListMetadataOutput)
...
type NullableDatacenterListMetadataOutput struct {
	value *DatacenterListMetadataOutput
	isSet bool
}

func (v NullableDatacenterListMetadataOutput) Get() *DatacenterListMetadataOutput {
	return v.value
}

func (v *NullableDatacenterListMetadataOutput) Set(val *DatacenterListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterListMetadataOutput(val *DatacenterListMetadataOutput) *NullableDatacenterListMetadataOutput {
	return &NullableDatacenterListMetadataOutput{value: val, isSet: true}
}

func (v NullableDatacenterListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
