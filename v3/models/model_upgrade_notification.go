...
// checks if the UpgradeNotification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpgradeNotification{}

// UpgradeNotification Pre upgrade notification
type UpgradeNotification struct {
	ProceedMessage *string `json:"proceed_message,omitempty"`
	CancelMessage *string `json:"cancel_message,omitempty"`
	// Description items of the notification
	DescriptionItemList []DescriptionItem `json:"description_item_list,omitempty"`
	// Title of the notification
	Title *string `json:"title,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UpgradeNotification UpgradeNotification
...
// GetProceedMessage returns the ProceedMessage field value if set, zero value otherwise.
func (o *UpgradeNotification) GetProceedMessage() string {
	if o == nil || IsNil(o.ProceedMessage) {
		var ret string
		return ret
	}
	return *o.ProceedMessage
}

// GetProceedMessageOk returns a tuple with the ProceedMessage field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpgradeNotification) GetProceedMessageOk() (*string, bool) {
	if o == nil || IsNil(o.ProceedMessage) {
		return nil, false
	}
	return o.ProceedMessage, true
}
...
// SetProceedMessage gets a reference to the given string and assigns it to the ProceedMessage field.
...
// GetDescriptionItemList returns the DescriptionItemList field value if set, zero value otherwise.
func (o *UpgradeNotification) GetDescriptionItemList() []DescriptionItem {
	if o == nil || IsNil(o.DescriptionItemList) {
		var ret []DescriptionItem
		return ret
	}
	return o.DescriptionItemList
}

// GetDescriptionItemListOk returns a tuple with the DescriptionItemList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpgradeNotification) GetDescriptionItemListOk() ([]DescriptionItem, bool) {
	if o == nil || IsNil(o.DescriptionItemList) {
		return nil, false
	}
	return o.DescriptionItemList, true
}
...
// SetDescriptionItemList gets a reference to the given []DescriptionItem and assigns it to the DescriptionItemList field.
func (o *UpgradeNotification) SetDescriptionItemList(v []DescriptionItem) {
	o.DescriptionItemList = v
}
...
func (o UpgradeNotification) MarshalJSON() ([]byte, error) {
...
func (o UpgradeNotification) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ProceedMessage) {
		toSerialize["proceed_message"] = o.ProceedMessage
	}
	if !IsNil(o.CancelMessage) {
		toSerialize["cancel_message"] = o.CancelMessage
	}
	if !IsNil(o.DescriptionItemList) {
		toSerialize["description_item_list"] = o.DescriptionItemList
	}
	if !IsNil(o.Title) {
...
func (o *UpgradeNotification) UnmarshalJSON(data []byte) (err error) {
	varUpgradeNotification := _UpgradeNotification{}

	err = json.Unmarshal(data, &varUpgradeNotification)

	if err != nil {
		return err
	}

	*o = UpgradeNotification(varUpgradeNotification)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "proceed_message")
		delete(additionalProperties, "cancel_message")
		delete(additionalProperties, "description_item_list")
...
type NullableUpgradeNotification struct {
	value *UpgradeNotification
	isSet bool
}

func (v NullableUpgradeNotification) Get() *UpgradeNotification {
	return v.value
}

func (v *NullableUpgradeNotification) Set(val *UpgradeNotification) {
	v.value = val
	v.isSet = true
}

func (v NullableUpgradeNotification) IsSet() bool {
	return v.isSet
}

func (v *NullableUpgradeNotification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpgradeNotification(val *UpgradeNotification) *NullableUpgradeNotification {
	return &NullableUpgradeNotification{value: val, isSet: true}
}

func (v NullableUpgradeNotification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpgradeNotification) UnmarshalJSON(src []byte) error {
	v.isSet = true
