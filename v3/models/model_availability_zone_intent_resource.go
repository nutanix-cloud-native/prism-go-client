...
// checks if the AvailabilityZoneIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneIntentResource{}

// AvailabilityZoneIntentResource Response object for intentful operations on a availability_zone
type AvailabilityZoneIntentResource struct {
...
type _AvailabilityZoneIntentResource AvailabilityZoneIntentResource
...
func NewAvailabilityZoneIntentResource(metadata AvailabilityZoneMetadata) *AvailabilityZoneIntentResource {
	this := AvailabilityZoneIntentResource{}
...
func (o *AvailabilityZoneIntentResource) GetStatus() AvailabilityZoneDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret AvailabilityZoneDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given AvailabilityZoneDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given AvailabilityZone and assigns it to the Spec field.
...
func (o *AvailabilityZoneIntentResource) GetMetadata() AvailabilityZoneMetadata {
	if o == nil {
		var ret AvailabilityZoneMetadata
		return ret
	}
...
func (o AvailabilityZoneIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAvailabilityZoneIntentResource := _AvailabilityZoneIntentResource{}

	err = json.Unmarshal(data, &varAvailabilityZoneIntentResource)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneIntentResource(varAvailabilityZoneIntentResource)
...
type NullableAvailabilityZoneIntentResource struct {
	value *AvailabilityZoneIntentResource
	isSet bool
}

func (v NullableAvailabilityZoneIntentResource) Get() *AvailabilityZoneIntentResource {
	return v.value
}

func (v *NullableAvailabilityZoneIntentResource) Set(val *AvailabilityZoneIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneIntentResource(val *AvailabilityZoneIntentResource) *NullableAvailabilityZoneIntentResource {
	return &NullableAvailabilityZoneIntentResource{value: val, isSet: true}
}

func (v NullableAvailabilityZoneIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
