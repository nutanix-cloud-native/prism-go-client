...
// checks if the ReportConfigListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigListMetadata{}

// ReportConfigListMetadata All api calls that return a list will have this metadata block as input 
type ReportConfigListMetadata struct {
	// The kind name
...
type _ReportConfigListMetadata ReportConfigListMetadata
...
func (o ReportConfigListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfigListMetadata) UnmarshalJSON(data []byte) (err error) {
	varReportConfigListMetadata := _ReportConfigListMetadata{}

	err = json.Unmarshal(data, &varReportConfigListMetadata)

	if err != nil {
		return err
	}

	*o = ReportConfigListMetadata(varReportConfigListMetadata)
...
type NullableReportConfigListMetadata struct {
	value *ReportConfigListMetadata
	isSet bool
}

func (v NullableReportConfigListMetadata) Get() *ReportConfigListMetadata {
	return v.value
}

func (v *NullableReportConfigListMetadata) Set(val *ReportConfigListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigListMetadata(val *ReportConfigListMetadata) *NullableReportConfigListMetadata {
	return &NullableReportConfigListMetadata{value: val, isSet: true}
}

func (v NullableReportConfigListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
