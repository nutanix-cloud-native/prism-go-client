...
// checks if the MigrateInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MigrateInput{}

// MigrateInput Input object for the generic migrate API. It contains the details of the entities which need to be migrated. 
type MigrateInput struct {
	SourceAvailabilityZoneReference AvailabilityZoneReference `json:"source_availability_zone_reference"`
	VmList []MigrateInputVmListInner `json:"vm_list"`
	TargetClusterReference *ClusterReference `json:"target_cluster_reference,omitempty"`
	TargetAvailabilityZoneReference AvailabilityZoneReference `json:"target_availability_zone_reference"`
	// Whether to do live migration of the entity. This is applicable only when the entity is protected with sync protection policy. 
	IsLiveMigration *bool `json:"is_live_migration,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MigrateInput MigrateInput
...
func NewMigrateInput(sourceAvailabilityZoneReference AvailabilityZoneReference, vmList []MigrateInputVmListInner, targetAvailabilityZoneReference AvailabilityZoneReference) *MigrateInput {
	this := MigrateInput{}
	this.SourceAvailabilityZoneReference = sourceAvailabilityZoneReference
	this.VmList = vmList
	this.TargetAvailabilityZoneReference = targetAvailabilityZoneReference
	return &this
}
...
// GetSourceAvailabilityZoneReference returns the SourceAvailabilityZoneReference field value
...
// GetSourceAvailabilityZoneReferenceOk returns a tuple with the SourceAvailabilityZoneReference field value
...
// GetVmListOk returns a tuple with the VmList field value
// and a boolean to check if the value has been set.
func (o *MigrateInput) GetVmListOk() ([]MigrateInputVmListInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.VmList, true
}

// SetVmList sets field value
func (o *MigrateInput) SetVmList(v []MigrateInputVmListInner) {
	o.VmList = v
}

// GetTargetClusterReference returns the TargetClusterReference field value if set, zero value otherwise.
func (o *MigrateInput) GetTargetClusterReference() ClusterReference {
	if o == nil || IsNil(o.TargetClusterReference) {
		var ret ClusterReference
		return ret
	}
	return *o.TargetClusterReference
}

// GetTargetClusterReferenceOk returns a tuple with the TargetClusterReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MigrateInput) GetTargetClusterReferenceOk() (*ClusterReference, bool) {
	if o == nil || IsNil(o.TargetClusterReference) {
		return nil, false
	}
	return o.TargetClusterReference, true
}
...
// SetTargetClusterReference gets a reference to the given ClusterReference and assigns it to the TargetClusterReference field.
func (o *MigrateInput) SetTargetClusterReference(v ClusterReference) {
	o.TargetClusterReference = &v
}

// GetTargetAvailabilityZoneReference returns the TargetAvailabilityZoneReference field value
func (o *MigrateInput) GetTargetAvailabilityZoneReference() AvailabilityZoneReference {
	...
	return o.TargetAvailabilityZoneReference
}

// GetTargetAvailabilityZoneReferenceOk returns a tuple with the TargetAvailabilityZoneReference field value
// and a boolean to check if the value has been set.
func (o *MigrateInput) GetTargetAvailabilityZoneReferenceOk() (*AvailabilityZoneReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TargetAvailabilityZoneReference, true
}

// SetTargetAvailabilityZoneReference sets field value
func (o *MigrateInput) SetTargetAvailabilityZoneReference(v AvailabilityZoneReference) {
	o.TargetAvailabilityZoneReference = v
}

// GetIsLiveMigration returns the IsLiveMigration field value if set, zero value otherwise.
func (o *MigrateInput) GetIsLiveMigration() bool {
	if o == nil || IsNil(o.IsLiveMigration) {
		var ret bool
		return ret
	}
	return *o.IsLiveMigration
}

// GetIsLiveMigrationOk returns a tuple with the IsLiveMigration field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MigrateInput) GetIsLiveMigrationOk() (*bool, bool) {
	if o == nil || IsNil(o.IsLiveMigration) {
		return nil, false
	}
	return o.IsLiveMigration, true
}
...
// SetIsLiveMigration gets a reference to the given bool and assigns it to the IsLiveMigration field.
func (o *MigrateInput) SetIsLiveMigration(v bool) {
	o.IsLiveMigration = &v
}

func (o MigrateInput) MarshalJSON() ([]byte, error) {
...
func (o MigrateInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["source_availability_zone_reference"] = o.SourceAvailabilityZoneReference
	toSerialize["vm_list"] = o.VmList
	if !IsNil(o.TargetClusterReference) {
		toSerialize["target_cluster_reference"] = o.TargetClusterReference
	}
	toSerialize["target_availability_zone_reference"] = o.TargetAvailabilityZoneReference
	if !IsNil(o.IsLiveMigration) {
		toSerialize["is_live_migration"] = o.IsLiveMigration
	}
...
func (o *MigrateInput) UnmarshalJSON(data []byte) (err error) {
	...
	varMigrateInput := _MigrateInput{}

	err = json.Unmarshal(data, &varMigrateInput)

	if err != nil {
		return err
	}

	*o = MigrateInput(varMigrateInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "source_availability_zone_reference")
		delete(additionalProperties, "vm_list")
		delete(additionalProperties, "target_cluster_reference")
		delete(additionalProperties, "target_availability_zone_reference")
		delete(additionalProperties, "is_live_migration")
...
type NullableMigrateInput struct {
	value *MigrateInput
	isSet bool
}

func (v NullableMigrateInput) Get() *MigrateInput {
	return v.value
}

func (v *NullableMigrateInput) Set(val *MigrateInput) {
	v.value = val
	v.isSet = true
}

func (v NullableMigrateInput) IsSet() bool {
	return v.isSet
}

func (v *NullableMigrateInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMigrateInput(val *MigrateInput) *NullableMigrateInput {
	return &NullableMigrateInput{value: val, isSet: true}
}

func (v NullableMigrateInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMigrateInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
