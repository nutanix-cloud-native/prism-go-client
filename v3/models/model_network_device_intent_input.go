...
// checks if the NetworkDeviceIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDeviceIntentInput{}

// NetworkDeviceIntentInput An intentful representation of a network_device
type NetworkDeviceIntentInput struct {
	Spec NetworkDevice `json:"spec"`
...
type _NetworkDeviceIntentInput NetworkDeviceIntentInput
...
func (o NetworkDeviceIntentInput) MarshalJSON() ([]byte, error) {
...
func (o NetworkDeviceIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkDeviceIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkDeviceIntentInput := _NetworkDeviceIntentInput{}

	err = json.Unmarshal(data, &varNetworkDeviceIntentInput)

	if err != nil {
		return err
	}

	*o = NetworkDeviceIntentInput(varNetworkDeviceIntentInput)
...
type NullableNetworkDeviceIntentInput struct {
	value *NetworkDeviceIntentInput
	isSet bool
}

func (v NullableNetworkDeviceIntentInput) Get() *NetworkDeviceIntentInput {
	return v.value
}

func (v *NullableNetworkDeviceIntentInput) Set(val *NetworkDeviceIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDeviceIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDeviceIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDeviceIntentInput(val *NetworkDeviceIntentInput) *NullableNetworkDeviceIntentInput {
	return &NullableNetworkDeviceIntentInput{value: val, isSet: true}
}

func (v NullableNetworkDeviceIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDeviceIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
