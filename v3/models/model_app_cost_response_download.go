...
// checks if the AppCostResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCostResponseDownload{}

// AppCostResponseDownload Cost definition for Application
type AppCostResponseDownload struct {
	// 
...
type _AppCostResponseDownload AppCostResponseDownload
...
func (o AppCostResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o AppCostResponseDownload) ToMap() (map[string]interface{}, error) {
...
func (o *AppCostResponseDownload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCostResponseDownload := _AppCostResponseDownload{}

	err = json.Unmarshal(data, &varAppCostResponseDownload)

	if err != nil {
		return err
	}

	*o = AppCostResponseDownload(varAppCostResponseDownload)
...
type NullableAppCostResponseDownload struct {
	value *AppCostResponseDownload
	isSet bool
}

func (v NullableAppCostResponseDownload) Get() *AppCostResponseDownload {
	return v.value
}

func (v *NullableAppCostResponseDownload) Set(val *AppCostResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCostResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCostResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCostResponseDownload(val *AppCostResponseDownload) *NullableAppCostResponseDownload {
	return &NullableAppCostResponseDownload{value: val, isSet: true}
}

func (v NullableAppCostResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCostResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
