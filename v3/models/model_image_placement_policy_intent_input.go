...
// checks if the ImagePlacementPolicyIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyIntentInput{}

// ImagePlacementPolicyIntentInput An intentful representation of a image_placement_policy
type ImagePlacementPolicyIntentInput struct {
	Spec ImagePlacementPolicy `json:"spec"`
...
type _ImagePlacementPolicyIntentInput ImagePlacementPolicyIntentInput
...
func NewImagePlacementPolicyIntentInput(spec ImagePlacementPolicy, metadata ImagePlacementPolicyMetadata) *ImagePlacementPolicyIntentInput {
	this := ImagePlacementPolicyIntentInput{}
	this.Spec = spec
...
func (o ImagePlacementPolicyIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicyIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varImagePlacementPolicyIntentInput := _ImagePlacementPolicyIntentInput{}

	err = json.Unmarshal(data, &varImagePlacementPolicyIntentInput)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyIntentInput(varImagePlacementPolicyIntentInput)
...
type NullableImagePlacementPolicyIntentInput struct {
	value *ImagePlacementPolicyIntentInput
	isSet bool
}

func (v NullableImagePlacementPolicyIntentInput) Get() *ImagePlacementPolicyIntentInput {
	return v.value
}

func (v *NullableImagePlacementPolicyIntentInput) Set(val *ImagePlacementPolicyIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyIntentInput(val *ImagePlacementPolicyIntentInput) *NullableImagePlacementPolicyIntentInput {
	return &NullableImagePlacementPolicyIntentInput{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
