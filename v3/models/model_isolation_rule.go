...
// checks if the IsolationRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IsolationRule{}

// IsolationRule These rules are used for environmental isolation.
...
type _IsolationRule IsolationRule
...
// GetFirstEntityFilter returns the FirstEntityFilter field value if set, zero value otherwise.
func (o *IsolationRule) GetFirstEntityFilter() CategoryFilter {
	if o == nil || IsNil(o.FirstEntityFilter) {
		var ret CategoryFilter
		return ret
	}
	return *o.FirstEntityFilter
}

// GetFirstEntityFilterOk returns a tuple with the FirstEntityFilter field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IsolationRule) GetFirstEntityFilterOk() (*CategoryFilter, bool) {
	if o == nil || IsNil(o.FirstEntityFilter) {
		return nil, false
	}
	return o.FirstEntityFilter, true
}
...
// SetFirstEntityFilter gets a reference to the given CategoryFilter and assigns it to the FirstEntityFilter field.
func (o *IsolationRule) SetFirstEntityFilter(v CategoryFilter) {
	o.FirstEntityFilter = &v
}

// GetSecondEntityFilter returns the SecondEntityFilter field value if set, zero value otherwise.
func (o *IsolationRule) GetSecondEntityFilter() CategoryFilter {
	if o == nil || IsNil(o.SecondEntityFilter) {
		var ret CategoryFilter
		return ret
	}
	return *o.SecondEntityFilter
}

// GetSecondEntityFilterOk returns a tuple with the SecondEntityFilter field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IsolationRule) GetSecondEntityFilterOk() (*CategoryFilter, bool) {
	if o == nil || IsNil(o.SecondEntityFilter) {
		return nil, false
	}
	return o.SecondEntityFilter, true
}
...
// SetSecondEntityFilter gets a reference to the given CategoryFilter and assigns it to the SecondEntityFilter field.
func (o *IsolationRule) SetSecondEntityFilter(v CategoryFilter) {
	o.SecondEntityFilter = &v
}

func (o IsolationRule) MarshalJSON() ([]byte, error) {
...
func (o IsolationRule) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Action) {
		toSerialize["action"] = o.Action
	}
	if !IsNil(o.FirstEntityFilter) {
		toSerialize["first_entity_filter"] = o.FirstEntityFilter
	}
	if !IsNil(o.SecondEntityFilter) {
		toSerialize["second_entity_filter"] = o.SecondEntityFilter
	}
...
func (o *IsolationRule) UnmarshalJSON(data []byte) (err error) {
	varIsolationRule := _IsolationRule{}

	err = json.Unmarshal(data, &varIsolationRule)

	if err != nil {
		return err
	}

	*o = IsolationRule(varIsolationRule)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "action")
		delete(additionalProperties, "first_entity_filter")
		delete(additionalProperties, "second_entity_filter")
...
type NullableIsolationRule struct {
	value *IsolationRule
	isSet bool
}

func (v NullableIsolationRule) Get() *IsolationRule {
	return v.value
}

func (v *NullableIsolationRule) Set(val *IsolationRule) {
	v.value = val
	v.isSet = true
}

func (v NullableIsolationRule) IsSet() bool {
	return v.isSet
}

func (v *NullableIsolationRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIsolationRule(val *IsolationRule) *NullableIsolationRule {
	return &NullableIsolationRule{value: val, isSet: true}
}

func (v NullableIsolationRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIsolationRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
