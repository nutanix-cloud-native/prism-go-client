...
// checks if the RightHandSide type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RightHandSide{}

// RightHandSide The right hand side of an expression.
...
type _RightHandSide RightHandSide
...
func (o RightHandSide) MarshalJSON() ([]byte, error) {
...
func (o RightHandSide) ToMap() (map[string]interface{}, error) {
...
func (o *RightHandSide) UnmarshalJSON(data []byte) (err error) {
	varRightHandSide := _RightHandSide{}

	err = json.Unmarshal(data, &varRightHandSide)

	if err != nil {
		return err
	}

	*o = RightHandSide(varRightHandSide)
...
type NullableRightHandSide struct {
	value *RightHandSide
	isSet bool
}

func (v NullableRightHandSide) Get() *RightHandSide {
	return v.value
}

func (v *NullableRightHandSide) Set(val *RightHandSide) {
	v.value = val
	v.isSet = true
}

func (v NullableRightHandSide) IsSet() bool {
	return v.isSet
}

func (v *NullableRightHandSide) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRightHandSide(val *RightHandSide) *NullableRightHandSide {
	return &NullableRightHandSide{value: val, isSet: true}
}

func (v NullableRightHandSide) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRightHandSide) UnmarshalJSON(src []byte) error {
	v.isSet = true
