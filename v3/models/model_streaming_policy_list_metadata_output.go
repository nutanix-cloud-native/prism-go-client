...
// checks if the StreamingPolicyListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyListMetadataOutput{}

// StreamingPolicyListMetadataOutput All api calls that return a list will have this metadata block 
type StreamingPolicyListMetadataOutput struct {
	// The kind name
...
type _StreamingPolicyListMetadataOutput StreamingPolicyListMetadataOutput
...
func NewStreamingPolicyListMetadataOutput() *StreamingPolicyListMetadataOutput {
	this := StreamingPolicyListMetadataOutput{}
	var kind string = "streaming_policy"
	this.Kind = &kind
	return &this
}
...
func (o StreamingPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicyListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varStreamingPolicyListMetadataOutput := _StreamingPolicyListMetadataOutput{}

	err = json.Unmarshal(data, &varStreamingPolicyListMetadataOutput)

	if err != nil {
		return err
	}

	*o = StreamingPolicyListMetadataOutput(varStreamingPolicyListMetadataOutput)
...
type NullableStreamingPolicyListMetadataOutput struct {
	value *StreamingPolicyListMetadataOutput
	isSet bool
}

func (v NullableStreamingPolicyListMetadataOutput) Get() *StreamingPolicyListMetadataOutput {
	return v.value
}

func (v *NullableStreamingPolicyListMetadataOutput) Set(val *StreamingPolicyListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyListMetadataOutput(val *StreamingPolicyListMetadataOutput) *NullableStreamingPolicyListMetadataOutput {
	return &NullableStreamingPolicyListMetadataOutput{value: val, isSet: true}
}

func (v NullableStreamingPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
