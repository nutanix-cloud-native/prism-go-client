...
// checks if the RepetitionCriteria type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RepetitionCriteria{}

// RepetitionCriteria Criteria for repeating a widget/section.
type RepetitionCriteria struct {
	// Rule based on which the widget/section will be repeating.
	RepetitionRule *string `json:"repetition_rule,omitempty"`
	// Type of the entity.
	EntityType string `json:"entity_type"`
	AdditionalProperties map[string]interface{}
}

type _RepetitionCriteria RepetitionCriteria
...
// GetRepetitionRule returns the RepetitionRule field value if set, zero value otherwise.
func (o *RepetitionCriteria) GetRepetitionRule() string {
	if o == nil || IsNil(o.RepetitionRule) {
		var ret string
		return ret
	}
	return *o.RepetitionRule
}

// GetRepetitionRuleOk returns a tuple with the RepetitionRule field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RepetitionCriteria) GetRepetitionRuleOk() (*string, bool) {
	if o == nil || IsNil(o.RepetitionRule) {
		return nil, false
	}
	return o.RepetitionRule, true
}
...
// SetRepetitionRule gets a reference to the given string and assigns it to the RepetitionRule field.
...
func (o RepetitionCriteria) MarshalJSON() ([]byte, error) {
...
func (o RepetitionCriteria) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RepetitionRule) {
		toSerialize["repetition_rule"] = o.RepetitionRule
	}
...
func (o *RepetitionCriteria) UnmarshalJSON(data []byte) (err error) {
	...
	varRepetitionCriteria := _RepetitionCriteria{}

	err = json.Unmarshal(data, &varRepetitionCriteria)

	if err != nil {
		return err
	}

	*o = RepetitionCriteria(varRepetitionCriteria)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "repetition_rule")
...
type NullableRepetitionCriteria struct {
	value *RepetitionCriteria
	isSet bool
}

func (v NullableRepetitionCriteria) Get() *RepetitionCriteria {
	return v.value
}

func (v *NullableRepetitionCriteria) Set(val *RepetitionCriteria) {
	v.value = val
	v.isSet = true
}

func (v NullableRepetitionCriteria) IsSet() bool {
	return v.isSet
}

func (v *NullableRepetitionCriteria) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRepetitionCriteria(val *RepetitionCriteria) *NullableRepetitionCriteria {
	return &NullableRepetitionCriteria{value: val, isSet: true}
}

func (v NullableRepetitionCriteria) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRepetitionCriteria) UnmarshalJSON(src []byte) error {
	v.isSet = true
