...
// checks if the ImagePlacementPolicyReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyReference{}

// ImagePlacementPolicyReference The reference to a image_placement_policy
type ImagePlacementPolicyReference struct {
	// The kind name
...
type _ImagePlacementPolicyReference ImagePlacementPolicyReference
...
func NewImagePlacementPolicyReference(kind string, uUID string) *ImagePlacementPolicyReference {
	this := ImagePlacementPolicyReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o ImagePlacementPolicyReference) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyReference) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicyReference) UnmarshalJSON(data []byte) (err error) {
	...
	varImagePlacementPolicyReference := _ImagePlacementPolicyReference{}

	err = json.Unmarshal(data, &varImagePlacementPolicyReference)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyReference(varImagePlacementPolicyReference)
...
type NullableImagePlacementPolicyReference struct {
	value *ImagePlacementPolicyReference
	isSet bool
}

func (v NullableImagePlacementPolicyReference) Get() *ImagePlacementPolicyReference {
	return v.value
}

func (v *NullableImagePlacementPolicyReference) Set(val *ImagePlacementPolicyReference) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyReference) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyReference(val *ImagePlacementPolicyReference) *NullableImagePlacementPolicyReference {
	return &NullableImagePlacementPolicyReference{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
