...
// checks if the SyslogModule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogModule{}

// SyslogModule Remote Syslog Module definition
type SyslogModule struct {
	// Name of the Remote Syslog module
	ModuleName *string `json:"module_name,omitempty"`
	// Severity level of the logs
	LogSeverityLevel *int32 `json:"log_severity_level,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SyslogModule SyslogModule
...
// GetLogSeverityLevel returns the LogSeverityLevel field value if set, zero value otherwise.
func (o *SyslogModule) GetLogSeverityLevel() int32 {
	if o == nil || IsNil(o.LogSeverityLevel) {
		var ret int32
		return ret
	}
	return *o.LogSeverityLevel
}

// GetLogSeverityLevelOk returns a tuple with the LogSeverityLevel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SyslogModule) GetLogSeverityLevelOk() (*int32, bool) {
	if o == nil || IsNil(o.LogSeverityLevel) {
		return nil, false
	}
	return o.LogSeverityLevel, true
}
...
// SetLogSeverityLevel gets a reference to the given int32 and assigns it to the LogSeverityLevel field.
func (o *SyslogModule) SetLogSeverityLevel(v int32) {
	o.LogSeverityLevel = &v
}

func (o SyslogModule) MarshalJSON() ([]byte, error) {
...
func (o SyslogModule) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ModuleName) {
		toSerialize["module_name"] = o.ModuleName
	}
	if !IsNil(o.LogSeverityLevel) {
		toSerialize["log_severity_level"] = o.LogSeverityLevel
	}
...
func (o *SyslogModule) UnmarshalJSON(data []byte) (err error) {
	varSyslogModule := _SyslogModule{}

	err = json.Unmarshal(data, &varSyslogModule)

	if err != nil {
		return err
	}

	*o = SyslogModule(varSyslogModule)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "module_name")
		delete(additionalProperties, "log_severity_level")
...
type NullableSyslogModule struct {
	value *SyslogModule
	isSet bool
}

func (v NullableSyslogModule) Get() *SyslogModule {
	return v.value
}

func (v *NullableSyslogModule) Set(val *SyslogModule) {
	v.value = val
	v.isSet = true
}

func (v NullableSyslogModule) IsSet() bool {
	return v.isSet
}

func (v *NullableSyslogModule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyslogModule(val *SyslogModule) *NullableSyslogModule {
	return &NullableSyslogModule{value: val, isSet: true}
}

func (v NullableSyslogModule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyslogModule) UnmarshalJSON(src []byte) error {
	v.isSet = true
