...
// checks if the DirectConnectListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectListMetadataOutput{}

// DirectConnectListMetadataOutput All api calls that return a list will have this metadata block 
type DirectConnectListMetadataOutput struct {
	// The kind name
...
type _DirectConnectListMetadataOutput DirectConnectListMetadataOutput
...
func NewDirectConnectListMetadataOutput() *DirectConnectListMetadataOutput {
	this := DirectConnectListMetadataOutput{}
	var kind string = "direct_connect"
	this.Kind = &kind
	return &this
}
...
func (o DirectConnectListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varDirectConnectListMetadataOutput := _DirectConnectListMetadataOutput{}

	err = json.Unmarshal(data, &varDirectConnectListMetadataOutput)

	if err != nil {
		return err
	}

	*o = DirectConnectListMetadataOutput(varDirectConnectListMetadataOutput)
...
type NullableDirectConnectListMetadataOutput struct {
	value *DirectConnectListMetadataOutput
	isSet bool
}

func (v NullableDirectConnectListMetadataOutput) Get() *DirectConnectListMetadataOutput {
	return v.value
}

func (v *NullableDirectConnectListMetadataOutput) Set(val *DirectConnectListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectListMetadataOutput(val *DirectConnectListMetadataOutput) *NullableDirectConnectListMetadataOutput {
	return &NullableDirectConnectListMetadataOutput{value: val, isSet: true}
}

func (v NullableDirectConnectListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
