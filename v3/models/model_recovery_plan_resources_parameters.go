...
// checks if the RecoveryPlanResourcesParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanResourcesParameters{}
...
type RecoveryPlanResourcesParameters struct {
	...
	NetworkMappingList []RecoveryPlanResourcesParametersNetworkMappingListInner `json:"network_mapping_list,omitempty"`
	// IP address mappings for attaching Volume Groups to VMs upon failover. 
	DataServiceIpMappingList []RecoveryPlanResourcesParametersDataServiceIpMappingListInner `json:"data_service_ip_mapping_list,omitempty"`
	// A list containing information about primary and secondary Availability zones. 
	AvailabilityZoneList []AvailabilityZoneInformation `json:"availability_zone_list,omitempty"`
	...
	PrimaryLocationIndex *int32 `json:"primary_location_index,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanResourcesParameters RecoveryPlanResourcesParameters
...
func NewRecoveryPlanResourcesParameters() *RecoveryPlanResourcesParameters {
	this := RecoveryPlanResourcesParameters{}
	return &this
}
...
// GetFloatingIpAssignmentList returns the FloatingIpAssignmentList field value if set, zero value otherwise.
func (o *RecoveryPlanResourcesParameters) GetFloatingIpAssignmentList() []RecoveryPlanResourcesParametersFloatingIpAssignmentListInner {
	if o == nil || IsNil(o.FloatingIpAssignmentList) {
		var ret []RecoveryPlanResourcesParametersFloatingIpAssignmentListInner
		return ret
	}
	return o.FloatingIpAssignmentList
}

// GetFloatingIpAssignmentListOk returns a tuple with the FloatingIpAssignmentList field value if set, nil otherwise
...
func (o *RecoveryPlanResourcesParameters) GetFloatingIpAssignmentListOk() ([]RecoveryPlanResourcesParametersFloatingIpAssignmentListInner, bool) {
	...
	return o.FloatingIpAssignmentList, true
}
...
// SetFloatingIpAssignmentList gets a reference to the given []RecoveryPlanResourcesParametersFloatingIpAssignmentListInner and assigns it to the FloatingIpAssignmentList field.
func (o *RecoveryPlanResourcesParameters) SetFloatingIpAssignmentList(v []RecoveryPlanResourcesParametersFloatingIpAssignmentListInner) {
	o.FloatingIpAssignmentList = v
}

// GetWitnessConfigurationList returns the WitnessConfigurationList field value if set, zero value otherwise.
func (o *RecoveryPlanResourcesParameters) GetWitnessConfigurationList() []WitnessConfiguration {
	if o == nil || IsNil(o.WitnessConfigurationList) {
		var ret []WitnessConfiguration
		return ret
	}
	return o.WitnessConfigurationList
}

// GetWitnessConfigurationListOk returns a tuple with the WitnessConfigurationList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanResourcesParameters) GetWitnessConfigurationListOk() ([]WitnessConfiguration, bool) {
	if o == nil || IsNil(o.WitnessConfigurationList) {
		return nil, false
	}
	return o.WitnessConfigurationList, true
}
...
// SetWitnessConfigurationList gets a reference to the given []WitnessConfiguration and assigns it to the WitnessConfigurationList field.
func (o *RecoveryPlanResourcesParameters) SetWitnessConfigurationList(v []WitnessConfiguration) {
	o.WitnessConfigurationList = v
}

// GetCutoverMode returns the CutoverMode field value if set, zero value otherwise.
func (o *RecoveryPlanResourcesParameters) GetCutoverMode() string {
	if o == nil || IsNil(o.CutoverMode) {
		var ret string
		return ret
	}
	return *o.CutoverMode
}

// GetCutoverModeOk returns a tuple with the CutoverMode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanResourcesParameters) GetCutoverModeOk() (*string, bool) {
	if o == nil || IsNil(o.CutoverMode) {
		return nil, false
	}
	return o.CutoverMode, true
}
...
// SetCutoverMode gets a reference to the given string and assigns it to the CutoverMode field.
func (o *RecoveryPlanResourcesParameters) SetCutoverMode(v string) {
	o.CutoverMode = &v
}

// GetNetworkMappingList returns the NetworkMappingList field value if set, zero value otherwise.
func (o *RecoveryPlanResourcesParameters) GetNetworkMappingList() []RecoveryPlanResourcesParametersNetworkMappingListInner {
	if o == nil || IsNil(o.NetworkMappingList) {
		var ret []RecoveryPlanResourcesParametersNetworkMappingListInner
		return ret
	}
	return o.NetworkMappingList
}

// GetNetworkMappingListOk returns a tuple with the NetworkMappingList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanResourcesParameters) GetNetworkMappingListOk() ([]RecoveryPlanResourcesParametersNetworkMappingListInner, bool) {
	...
	return o.NetworkMappingList, true
}
...
// SetNetworkMappingList gets a reference to the given []RecoveryPlanResourcesParametersNetworkMappingListInner and assigns it to the NetworkMappingList field.
func (o *RecoveryPlanResourcesParameters) SetNetworkMappingList(v []RecoveryPlanResourcesParametersNetworkMappingListInner) {
	o.NetworkMappingList = v
}

// GetDataServiceIpMappingList returns the DataServiceIpMappingList field value if set, zero value otherwise.
func (o *RecoveryPlanResourcesParameters) GetDataServiceIpMappingList() []RecoveryPlanResourcesParametersDataServiceIpMappingListInner {
	if o == nil || IsNil(o.DataServiceIpMappingList) {
		var ret []RecoveryPlanResourcesParametersDataServiceIpMappingListInner
		return ret
	}
	return o.DataServiceIpMappingList
}

// GetDataServiceIpMappingListOk returns a tuple with the DataServiceIpMappingList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanResourcesParameters) GetDataServiceIpMappingListOk() ([]RecoveryPlanResourcesParametersDataServiceIpMappingListInner, bool) {
	...
	return o.DataServiceIpMappingList, true
}
...
// SetDataServiceIpMappingList gets a reference to the given []RecoveryPlanResourcesParametersDataServiceIpMappingListInner and assigns it to the DataServiceIpMappingList field.
func (o *RecoveryPlanResourcesParameters) SetDataServiceIpMappingList(v []RecoveryPlanResourcesParametersDataServiceIpMappingListInner) {
	o.DataServiceIpMappingList = v
}

// GetAvailabilityZoneList returns the AvailabilityZoneList field value if set, zero value otherwise.
func (o *RecoveryPlanResourcesParameters) GetAvailabilityZoneList() []AvailabilityZoneInformation {
	if o == nil || IsNil(o.AvailabilityZoneList) {
		var ret []AvailabilityZoneInformation
		return ret
	}
	return o.AvailabilityZoneList
}

// GetAvailabilityZoneListOk returns a tuple with the AvailabilityZoneList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanResourcesParameters) GetAvailabilityZoneListOk() ([]AvailabilityZoneInformation, bool) {
	if o == nil || IsNil(o.AvailabilityZoneList) {
		return nil, false
	}
	return o.AvailabilityZoneList, true
}
...
// SetAvailabilityZoneList gets a reference to the given []AvailabilityZoneInformation and assigns it to the AvailabilityZoneList field.
func (o *RecoveryPlanResourcesParameters) SetAvailabilityZoneList(v []AvailabilityZoneInformation) {
	o.AvailabilityZoneList = v
}

// GetPrimaryLocationIndex returns the PrimaryLocationIndex field value if set, zero value otherwise.
func (o *RecoveryPlanResourcesParameters) GetPrimaryLocationIndex() int32 {
	if o == nil || IsNil(o.PrimaryLocationIndex) {
		var ret int32
		return ret
	}
	return *o.PrimaryLocationIndex
}

// GetPrimaryLocationIndexOk returns a tuple with the PrimaryLocationIndex field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanResourcesParameters) GetPrimaryLocationIndexOk() (*int32, bool) {
	if o == nil || IsNil(o.PrimaryLocationIndex) {
		return nil, false
	}
	return o.PrimaryLocationIndex, true
}
...
// SetPrimaryLocationIndex gets a reference to the given int32 and assigns it to the PrimaryLocationIndex field.
func (o *RecoveryPlanResourcesParameters) SetPrimaryLocationIndex(v int32) {
	o.PrimaryLocationIndex = &v
}

func (o RecoveryPlanResourcesParameters) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanResourcesParameters) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.FloatingIpAssignmentList) {
		toSerialize["floating_ip_assignment_list"] = o.FloatingIpAssignmentList
	}
	if !IsNil(o.WitnessConfigurationList) {
		toSerialize["witness_configuration_list"] = o.WitnessConfigurationList
	}
	if !IsNil(o.CutoverMode) {
		toSerialize["cutover_mode"] = o.CutoverMode
	}
	if !IsNil(o.NetworkMappingList) {
		toSerialize["network_mapping_list"] = o.NetworkMappingList
	}
	if !IsNil(o.DataServiceIpMappingList) {
		toSerialize["data_service_ip_mapping_list"] = o.DataServiceIpMappingList
	}
	if !IsNil(o.AvailabilityZoneList) {
		toSerialize["availability_zone_list"] = o.AvailabilityZoneList
	}
	if !IsNil(o.PrimaryLocationIndex) {
		toSerialize["primary_location_index"] = o.PrimaryLocationIndex
	}
...
func (o *RecoveryPlanResourcesParameters) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanResourcesParameters := _RecoveryPlanResourcesParameters{}

	err = json.Unmarshal(data, &varRecoveryPlanResourcesParameters)

	if err != nil {
		return err
	}

	*o = RecoveryPlanResourcesParameters(varRecoveryPlanResourcesParameters)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "floating_ip_assignment_list")
		delete(additionalProperties, "witness_configuration_list")
		delete(additionalProperties, "cutover_mode")
		delete(additionalProperties, "network_mapping_list")
		delete(additionalProperties, "data_service_ip_mapping_list")
		delete(additionalProperties, "availability_zone_list")
		delete(additionalProperties, "primary_location_index")
...
type NullableRecoveryPlanResourcesParameters struct {
	value *RecoveryPlanResourcesParameters
	isSet bool
}

func (v NullableRecoveryPlanResourcesParameters) Get() *RecoveryPlanResourcesParameters {
	return v.value
}

func (v *NullableRecoveryPlanResourcesParameters) Set(val *RecoveryPlanResourcesParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanResourcesParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanResourcesParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanResourcesParameters(val *RecoveryPlanResourcesParameters) *NullableRecoveryPlanResourcesParameters {
	return &NullableRecoveryPlanResourcesParameters{value: val, isSet: true}
}

func (v NullableRecoveryPlanResourcesParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanResourcesParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
