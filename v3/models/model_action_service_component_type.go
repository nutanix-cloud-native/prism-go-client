...
// checks if the ActionServiceComponentType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionServiceComponentType{}

// ActionServiceComponentType This is the generic construct for both action type and trigger type. 
type ActionServiceComponentType struct {
	// Action service component display name.
	DisplayName string `json:"display_name" validate:"regexp=^[^&<>'\\/\\"]*$"`
	...
	InputParameters *map[string]ParamDescriptor `json:"input_parameters,omitempty"`
	...
	AdditionalInfoSeverity *string `json:"additional_info_severity,omitempty"`
	...
	LocalParameters *map[string]ParamDescriptor `json:"local_parameters,omitempty"`
	// The component output parameter descriptors. The key is the parameter name. 
	OutputParameters *map[string]ParamDescriptor `json:"output_parameters,omitempty"`
	// The metadata of form fields/params required for UI to render params. 
	UiMetadata []DisplayMetadata `json:"ui_metadata,omitempty"`
	// Additional information about the action/trigger type.
	AdditionalInfo *string `json:"additional_info,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
	// A preconfigured, or dynamically created component type.
	Name string `json:"name" validate:"regexp=^[^&<>'\\/\\"]*$"`
	AdditionalProperties map[string]interface{}
}

type _ActionServiceComponentType ActionServiceComponentType
...
func NewActionServiceComponentType(displayName string, description string, name string) *ActionServiceComponentType {
	this := ActionServiceComponentType{}
...
// SetInputParameters gets a reference to the given map[string]ParamDescriptor and assigns it to the InputParameters field.
...
// GetAdditionalInfoSeverity returns the AdditionalInfoSeverity field value if set, zero value otherwise.
func (o *ActionServiceComponentType) GetAdditionalInfoSeverity() string {
	if o == nil || IsNil(o.AdditionalInfoSeverity) {
		var ret string
		return ret
	}
	return *o.AdditionalInfoSeverity
}

// GetAdditionalInfoSeverityOk returns a tuple with the AdditionalInfoSeverity field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionServiceComponentType) GetAdditionalInfoSeverityOk() (*string, bool) {
	if o == nil || IsNil(o.AdditionalInfoSeverity) {
		return nil, false
	}
	return o.AdditionalInfoSeverity, true
}
...
// SetAdditionalInfoSeverity gets a reference to the given string and assigns it to the AdditionalInfoSeverity field.
func (o *ActionServiceComponentType) SetAdditionalInfoSeverity(v string) {
	o.AdditionalInfoSeverity = &v
}
...
// GetLocalParameters returns the LocalParameters field value if set, zero value otherwise.
func (o *ActionServiceComponentType) GetLocalParameters() map[string]ParamDescriptor {
	if o == nil || IsNil(o.LocalParameters) {
		var ret map[string]ParamDescriptor
		return ret
	}
	return *o.LocalParameters
}

// GetLocalParametersOk returns a tuple with the LocalParameters field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionServiceComponentType) GetLocalParametersOk() (*map[string]ParamDescriptor, bool) {
	if o == nil || IsNil(o.LocalParameters) {
		return nil, false
	}
	return o.LocalParameters, true
}
...
// SetLocalParameters gets a reference to the given map[string]ParamDescriptor and assigns it to the LocalParameters field.
...
// SetOutputParameters gets a reference to the given map[string]ParamDescriptor and assigns it to the OutputParameters field.
func (o *ActionServiceComponentType) SetOutputParameters(v map[string]ParamDescriptor) {
	o.OutputParameters = &v
}

// GetUiMetadata returns the UiMetadata field value if set, zero value otherwise.
func (o *ActionServiceComponentType) GetUiMetadata() []DisplayMetadata {
	if o == nil || IsNil(o.UiMetadata) {
		var ret []DisplayMetadata
		return ret
	}
	return o.UiMetadata
}

// GetUiMetadataOk returns a tuple with the UiMetadata field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionServiceComponentType) GetUiMetadataOk() ([]DisplayMetadata, bool) {
	if o == nil || IsNil(o.UiMetadata) {
		return nil, false
	}
	return o.UiMetadata, true
}
...
// SetUiMetadata gets a reference to the given []DisplayMetadata and assigns it to the UiMetadata field.
...
func (o ActionServiceComponentType) MarshalJSON() ([]byte, error) {
...
func (o ActionServiceComponentType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InputParameters) {
		toSerialize["input_parameters"] = o.InputParameters
	}
	if !IsNil(o.IsDisabled) {
		toSerialize["is_disabled"] = o.IsDisabled
	}
	toSerialize["description"] = o.Description
	if !IsNil(o.AdditionalInfoSeverity) {
		toSerialize["additional_info_severity"] = o.AdditionalInfoSeverity
	}
	if !IsNil(o.GroupList) {
		toSerialize["group_list"] = o.GroupList
	}
	if !IsNil(o.LocalParameters) {
		toSerialize["local_parameters"] = o.LocalParameters
	}
	if !IsNil(o.OutputParameters) {
		toSerialize["output_parameters"] = o.OutputParameters
	}
	if !IsNil(o.UiMetadata) {
		toSerialize["ui_metadata"] = o.UiMetadata
	}
...
func (o *ActionServiceComponentType) UnmarshalJSON(data []byte) (err error) {
	...
	varActionServiceComponentType := _ActionServiceComponentType{}

	err = json.Unmarshal(data, &varActionServiceComponentType)

	if err != nil {
		return err
	}

	*o = ActionServiceComponentType(varActionServiceComponentType)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "input_parameters")
		delete(additionalProperties, "is_disabled")
		delete(additionalProperties, "description")
		delete(additionalProperties, "additional_info_severity")
		delete(additionalProperties, "group_list")
		delete(additionalProperties, "local_parameters")
		delete(additionalProperties, "output_parameters")
		delete(additionalProperties, "ui_metadata")
...
type NullableActionServiceComponentType struct {
	value *ActionServiceComponentType
	isSet bool
}

func (v NullableActionServiceComponentType) Get() *ActionServiceComponentType {
	return v.value
}

func (v *NullableActionServiceComponentType) Set(val *ActionServiceComponentType) {
	v.value = val
	v.isSet = true
}

func (v NullableActionServiceComponentType) IsSet() bool {
	return v.isSet
}

func (v *NullableActionServiceComponentType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionServiceComponentType(val *ActionServiceComponentType) *NullableActionServiceComponentType {
	return &NullableActionServiceComponentType{value: val, isSet: true}
}

func (v NullableActionServiceComponentType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionServiceComponentType) UnmarshalJSON(src []byte) error {
	v.isSet = true
