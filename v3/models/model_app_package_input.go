...
// checks if the AppPackageInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPackageInput{}

// AppPackageInput Package definition for Application
...
type _AppPackageInput AppPackageInput
...
func (o AppPackageInput) MarshalJSON() ([]byte, error) {
...
func (o AppPackageInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppPackageInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPackageInput := _AppPackageInput{}

	err = json.Unmarshal(data, &varAppPackageInput)

	if err != nil {
		return err
	}

	*o = AppPackageInput(varAppPackageInput)
...
type NullableAppPackageInput struct {
	value *AppPackageInput
	isSet bool
}

func (v NullableAppPackageInput) Get() *AppPackageInput {
	return v.value
}

func (v *NullableAppPackageInput) Set(val *AppPackageInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPackageInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPackageInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPackageInput(val *AppPackageInput) *NullableAppPackageInput {
	return &NullableAppPackageInput{value: val, isSet: true}
}

func (v NullableAppPackageInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPackageInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
