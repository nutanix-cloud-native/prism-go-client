...
// checks if the MarketplaceItemIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemIntentInput{}

// MarketplaceItemIntentInput An intentful representation of a marketplace_item
type MarketplaceItemIntentInput struct {
	Spec MarketplaceItem `json:"spec"`
...
type _MarketplaceItemIntentInput MarketplaceItemIntentInput
...
func NewMarketplaceItemIntentInput(spec MarketplaceItem, metadata MarketplaceItemMetadata) *MarketplaceItemIntentInput {
	this := MarketplaceItemIntentInput{}
	this.Spec = spec
...
func (o MarketplaceItemIntentInput) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItemIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceItemIntentInput := _MarketplaceItemIntentInput{}

	err = json.Unmarshal(data, &varMarketplaceItemIntentInput)

	if err != nil {
		return err
	}

	*o = MarketplaceItemIntentInput(varMarketplaceItemIntentInput)
...
type NullableMarketplaceItemIntentInput struct {
	value *MarketplaceItemIntentInput
	isSet bool
}

func (v NullableMarketplaceItemIntentInput) Get() *MarketplaceItemIntentInput {
	return v.value
}

func (v *NullableMarketplaceItemIntentInput) Set(val *MarketplaceItemIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemIntentInput(val *MarketplaceItemIntentInput) *NullableMarketplaceItemIntentInput {
	return &NullableMarketplaceItemIntentInput{value: val, isSet: true}
}

func (v NullableMarketplaceItemIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
