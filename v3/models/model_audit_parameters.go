...
// checks if the AuditParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditParameters{}

// AuditParameters Parameters associated with the operation captured in the audit.
...
type _AuditParameters AuditParameters
...
// SetValue gets a reference to the given ParamValue and assigns it to the Value field.
func (o *AuditParameters) SetValue(v ParamValue) {
	o.Value = &v
}

func (o AuditParameters) MarshalJSON() ([]byte, error) {
...
func (o AuditParameters) ToMap() (map[string]interface{}, error) {
...
func (o *AuditParameters) UnmarshalJSON(data []byte) (err error) {
	varAuditParameters := _AuditParameters{}

	err = json.Unmarshal(data, &varAuditParameters)

	if err != nil {
		return err
	}

	*o = AuditParameters(varAuditParameters)
...
type NullableAuditParameters struct {
	value *AuditParameters
	isSet bool
}

func (v NullableAuditParameters) Get() *AuditParameters {
	return v.value
}

func (v *NullableAuditParameters) Set(val *AuditParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditParameters(val *AuditParameters) *NullableAuditParameters {
	return &NullableAuditParameters{value: val, isSet: true}
}

func (v NullableAuditParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
