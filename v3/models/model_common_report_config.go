...
// checks if the CommonReportConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfig{}

// CommonReportConfig Common Report Config creation/modification spec.
type CommonReportConfig struct {
	// Name of the common report config.
	Name string `json:"name"`
	Resources CommonReportConfigResources1 `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _CommonReportConfig CommonReportConfig
...
func (o *CommonReportConfig) GetResources() CommonReportConfigResources1 {
	if o == nil {
		var ret CommonReportConfigResources1
		return ret
	}
...
func (o CommonReportConfig) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfig) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonReportConfig := _CommonReportConfig{}

	err = json.Unmarshal(data, &varCommonReportConfig)

	if err != nil {
		return err
	}

	*o = CommonReportConfig(varCommonReportConfig)
...
type NullableCommonReportConfig struct {
	value *CommonReportConfig
	isSet bool
}

func (v NullableCommonReportConfig) Get() *CommonReportConfig {
	return v.value
}

func (v *NullableCommonReportConfig) Set(val *CommonReportConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfig(val *CommonReportConfig) *NullableCommonReportConfig {
	return &NullableCommonReportConfig{value: val, isSet: true}
}

func (v NullableCommonReportConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
