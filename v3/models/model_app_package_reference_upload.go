...
// checks if the AppPackageReferenceUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPackageReferenceUpload{}

// AppPackageReferenceUpload The reference to a app_package
type AppPackageReferenceUpload struct {
	// The kind name
...
type _AppPackageReferenceUpload AppPackageReferenceUpload
...
func NewAppPackageReferenceUpload(kind string, name string) *AppPackageReferenceUpload {
	this := AppPackageReferenceUpload{}
	this.Kind = kind
	this.Name = name
	return &this
}
...
func (o AppPackageReferenceUpload) MarshalJSON() ([]byte, error) {
...
func (o AppPackageReferenceUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppPackageReferenceUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPackageReferenceUpload := _AppPackageReferenceUpload{}

	err = json.Unmarshal(data, &varAppPackageReferenceUpload)

	if err != nil {
		return err
	}

	*o = AppPackageReferenceUpload(varAppPackageReferenceUpload)
...
type NullableAppPackageReferenceUpload struct {
	value *AppPackageReferenceUpload
	isSet bool
}

func (v NullableAppPackageReferenceUpload) Get() *AppPackageReferenceUpload {
	return v.value
}

func (v *NullableAppPackageReferenceUpload) Set(val *AppPackageReferenceUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPackageReferenceUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPackageReferenceUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPackageReferenceUpload(val *AppPackageReferenceUpload) *NullableAppPackageReferenceUpload {
	return &NullableAppPackageReferenceUpload{value: val, isSet: true}
}

func (v NullableAppPackageReferenceUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPackageReferenceUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
