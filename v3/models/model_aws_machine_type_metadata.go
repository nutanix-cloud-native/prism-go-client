...
// checks if the AwsMachineTypeMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsMachineTypeMetadata{}

// AwsMachineTypeMetadata The aws_machine_type kind metadata
type AwsMachineTypeMetadata struct {
	// UTC date and time in RFC-3339 format when aws_machine_type was last updated 
	LastUpdateTime *time.Time `json:"last_update_time,omitempty"`
	// The kind name
	Kind string `json:"kind"`
	// aws_machine_type uuid
	...
	// Categories for the aws_machine_type
	Categories *map[string]string `json:"categories,omitempty"`
	// aws_machine_type name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsMachineTypeMetadata AwsMachineTypeMetadata
...
func (o AwsMachineTypeMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsMachineTypeMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsMachineTypeMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsMachineTypeMetadata := _AwsMachineTypeMetadata{}

	err = json.Unmarshal(data, &varAwsMachineTypeMetadata)

	if err != nil {
		return err
	}

	*o = AwsMachineTypeMetadata(varAwsMachineTypeMetadata)
...
type NullableAwsMachineTypeMetadata struct {
	value *AwsMachineTypeMetadata
	isSet bool
}

func (v NullableAwsMachineTypeMetadata) Get() *AwsMachineTypeMetadata {
	return v.value
}

func (v *NullableAwsMachineTypeMetadata) Set(val *AwsMachineTypeMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsMachineTypeMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsMachineTypeMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsMachineTypeMetadata(val *AwsMachineTypeMetadata) *NullableAwsMachineTypeMetadata {
	return &NullableAwsMachineTypeMetadata{value: val, isSet: true}
}

func (v NullableAwsMachineTypeMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsMachineTypeMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
