...
// checks if the NgtPolicyStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicyStatus{}

// NgtPolicyStatus The status of a REST API call. Only used when there is a failure to report. 
type NgtPolicyStatus struct {
	// The kind name
...
type _NgtPolicyStatus NgtPolicyStatus
...
func (o NgtPolicyStatus) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicyStatus) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicyStatus) UnmarshalJSON(data []byte) (err error) {
	varNgtPolicyStatus := _NgtPolicyStatus{}

	err = json.Unmarshal(data, &varNgtPolicyStatus)

	if err != nil {
		return err
	}

	*o = NgtPolicyStatus(varNgtPolicyStatus)
...
type NullableNgtPolicyStatus struct {
	value *NgtPolicyStatus
	isSet bool
}

func (v NullableNgtPolicyStatus) Get() *NgtPolicyStatus {
	return v.value
}

func (v *NullableNgtPolicyStatus) Set(val *NgtPolicyStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicyStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicyStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicyStatus(val *NgtPolicyStatus) *NullableNgtPolicyStatus {
	return &NullableNgtPolicyStatus{value: val, isSet: true}
}

func (v NullableNgtPolicyStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicyStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
