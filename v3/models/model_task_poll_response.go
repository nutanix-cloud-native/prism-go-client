...
// checks if the TaskPollResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskPollResponse{}
...
type TaskPollResponse struct {
	...
	HasPollTimedOut *bool `json:"has_poll_timed_out,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _TaskPollResponse TaskPollResponse
...
// SetEntities gets a reference to the given []Task and assigns it to the Entities field.
func (o *TaskPollResponse) SetEntities(v []Task) {
	o.Entities = v
}

// GetHasPollTimedOut returns the HasPollTimedOut field value if set, zero value otherwise.
func (o *TaskPollResponse) GetHasPollTimedOut() bool {
	if o == nil || IsNil(o.HasPollTimedOut) {
		var ret bool
		return ret
	}
	return *o.HasPollTimedOut
}

// GetHasPollTimedOutOk returns a tuple with the HasPollTimedOut field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TaskPollResponse) GetHasPollTimedOutOk() (*bool, bool) {
	if o == nil || IsNil(o.HasPollTimedOut) {
		return nil, false
	}
	return o.HasPollTimedOut, true
}
...
// SetHasPollTimedOut gets a reference to the given bool and assigns it to the HasPollTimedOut field.
func (o *TaskPollResponse) SetHasPollTimedOut(v bool) {
	o.HasPollTimedOut = &v
}

func (o TaskPollResponse) MarshalJSON() ([]byte, error) {
...
func (o TaskPollResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Entities) {
		toSerialize["entities"] = o.Entities
	}
	if !IsNil(o.HasPollTimedOut) {
		toSerialize["has_poll_timed_out"] = o.HasPollTimedOut
	}
...
func (o *TaskPollResponse) UnmarshalJSON(data []byte) (err error) {
	varTaskPollResponse := _TaskPollResponse{}

	err = json.Unmarshal(data, &varTaskPollResponse)

	if err != nil {
		return err
	}

	*o = TaskPollResponse(varTaskPollResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "entities")
		delete(additionalProperties, "has_poll_timed_out")
...
type NullableTaskPollResponse struct {
	value *TaskPollResponse
	isSet bool
}

func (v NullableTaskPollResponse) Get() *TaskPollResponse {
	return v.value
}

func (v *NullableTaskPollResponse) Set(val *TaskPollResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskPollResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskPollResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskPollResponse(val *TaskPollResponse) *NullableTaskPollResponse {
	return &NullableTaskPollResponse{value: val, isSet: true}
}

func (v NullableTaskPollResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskPollResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
