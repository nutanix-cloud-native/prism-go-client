...
// checks if the VmNicOutputStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmNicOutputStatus{}

// VmNicOutputStatus Virtual Machine NIC Status.
type VmNicOutputStatus struct {
	// List of DNS IP addresses.
	DnsIpAddressesList []string `json:"dns_ip_addresses_list,omitempty"`
	...
	SecondaryIpAddressList []string `json:"secondary_ip_address_list,omitempty"`
	// The Floating IP associated with the vnic.
	FloatingIp *string `json:"floating_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	...
	DefaultGatewayAddressList []string `json:"default_gateway_address_list,omitempty"`
	// IP address of the DHCP server.
	DhcpServerIp *string `json:"dhcp_server_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	...
	TrunkedVlanList []int32 `json:"trunked_vlan_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VmNicOutputStatus VmNicOutputStatus
...
// GetDnsIpAddressesList returns the DnsIpAddressesList field value if set, zero value otherwise.
func (o *VmNicOutputStatus) GetDnsIpAddressesList() []string {
	if o == nil || IsNil(o.DnsIpAddressesList) {
		var ret []string
		return ret
	}
	return o.DnsIpAddressesList
}

// GetDnsIpAddressesListOk returns a tuple with the DnsIpAddressesList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmNicOutputStatus) GetDnsIpAddressesListOk() ([]string, bool) {
	if o == nil || IsNil(o.DnsIpAddressesList) {
		return nil, false
	}
	return o.DnsIpAddressesList, true
}
...
// SetDnsIpAddressesList gets a reference to the given []string and assigns it to the DnsIpAddressesList field.
func (o *VmNicOutputStatus) SetDnsIpAddressesList(v []string) {
	o.DnsIpAddressesList = v
}
...
// GetIpEndpointList returns the IpEndpointList field value if set, zero value otherwise.
func (o *VmNicOutputStatus) GetIpEndpointList() []IpAddress {
	if o == nil || IsNil(o.IpEndpointList) {
		var ret []IpAddress
		return ret
	}
	return o.IpEndpointList
}

// GetIpEndpointListOk returns a tuple with the IpEndpointList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmNicOutputStatus) GetIpEndpointListOk() ([]IpAddress, bool) {
	if o == nil || IsNil(o.IpEndpointList) {
		return nil, false
	}
	return o.IpEndpointList, true
}
...
// SetIpEndpointList gets a reference to the given []IpAddress and assigns it to the IpEndpointList field.
...
// GetSecondaryIpAddressList returns the SecondaryIpAddressList field value if set, zero value otherwise.
func (o *VmNicOutputStatus) GetSecondaryIpAddressList() []string {
	if o == nil || IsNil(o.SecondaryIpAddressList) {
		var ret []string
		return ret
	}
	return o.SecondaryIpAddressList
}

// GetSecondaryIpAddressListOk returns a tuple with the SecondaryIpAddressList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmNicOutputStatus) GetSecondaryIpAddressListOk() ([]string, bool) {
	if o == nil || IsNil(o.SecondaryIpAddressList) {
		return nil, false
	}
	return o.SecondaryIpAddressList, true
}
...
// SetSecondaryIpAddressList gets a reference to the given []string and assigns it to the SecondaryIpAddressList field.
func (o *VmNicOutputStatus) SetSecondaryIpAddressList(v []string) {
	o.SecondaryIpAddressList = v
}
...
// GetDefaultGatewayAddressList returns the DefaultGatewayAddressList field value if set, zero value otherwise.
func (o *VmNicOutputStatus) GetDefaultGatewayAddressList() []string {
	if o == nil || IsNil(o.DefaultGatewayAddressList) {
		var ret []string
		return ret
	}
	return o.DefaultGatewayAddressList
}

// GetDefaultGatewayAddressListOk returns a tuple with the DefaultGatewayAddressList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmNicOutputStatus) GetDefaultGatewayAddressListOk() ([]string, bool) {
	if o == nil || IsNil(o.DefaultGatewayAddressList) {
		return nil, false
	}
	return o.DefaultGatewayAddressList, true
}
...
// SetDefaultGatewayAddressList gets a reference to the given []string and assigns it to the DefaultGatewayAddressList field.
func (o *VmNicOutputStatus) SetDefaultGatewayAddressList(v []string) {
	o.DefaultGatewayAddressList = v
}
...
// GetTrunkedVlanList returns the TrunkedVlanList field value if set, zero value otherwise.
func (o *VmNicOutputStatus) GetTrunkedVlanList() []int32 {
	if o == nil || IsNil(o.TrunkedVlanList) {
		var ret []int32
		return ret
	}
	return o.TrunkedVlanList
}

// GetTrunkedVlanListOk returns a tuple with the TrunkedVlanList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmNicOutputStatus) GetTrunkedVlanListOk() ([]int32, bool) {
	if o == nil || IsNil(o.TrunkedVlanList) {
		return nil, false
	}
	return o.TrunkedVlanList, true
}
...
// SetTrunkedVlanList gets a reference to the given []int32 and assigns it to the TrunkedVlanList field.
func (o *VmNicOutputStatus) SetTrunkedVlanList(v []int32) {
	o.TrunkedVlanList = v
}

func (o VmNicOutputStatus) MarshalJSON() ([]byte, error) {
...
func (o VmNicOutputStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DnsIpAddressesList) {
		toSerialize["dns_ip_addresses_list"] = o.DnsIpAddressesList
	}
	if !IsNil(o.NicType) {
		toSerialize["nic_type"] = o.NicType
	}
	...
	if !IsNil(o.IpEndpointList) {
		toSerialize["ip_endpoint_list"] = o.IpEndpointList
	}
	if !IsNil(o.NetworkFunctionChainReference) {
		toSerialize["network_function_chain_reference"] = o.NetworkFunctionChainReference
	}
	if !IsNil(o.SecondaryIpAddressList) {
		toSerialize["secondary_ip_address_list"] = o.SecondaryIpAddressList
	}
	...
	if !IsNil(o.NetworkFunctionNicType) {
		toSerialize["network_function_nic_type"] = o.NetworkFunctionNicType
	}
	if !IsNil(o.VlanMode) {
		toSerialize["vlan_mode"] = o.VlanMode
	}
	if !IsNil(o.NumQueues) {
		toSerialize["num_queues"] = o.NumQueues
	}
	if !IsNil(o.DefaultGatewayAddressList) {
		toSerialize["default_gateway_address_list"] = o.DefaultGatewayAddressList
	}
	...
	if !IsNil(o.TrunkedVlanList) {
		toSerialize["trunked_vlan_list"] = o.TrunkedVlanList
	}
...
func (o *VmNicOutputStatus) UnmarshalJSON(data []byte) (err error) {
	varVmNicOutputStatus := _VmNicOutputStatus{}

	err = json.Unmarshal(data, &varVmNicOutputStatus)

	if err != nil {
		return err
	}

	*o = VmNicOutputStatus(varVmNicOutputStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "dns_ip_addresses_list")
		delete(additionalProperties, "nic_type")
		delete(additionalProperties, "subnet_reference")
		delete(additionalProperties, "uuid")
		delete(additionalProperties, "ip_endpoint_list")
		delete(additionalProperties, "network_function_chain_reference")
		delete(additionalProperties, "secondary_ip_address_list")
		delete(additionalProperties, "floating_ip")
		delete(additionalProperties, "mac_address")
		delete(additionalProperties, "network_function_nic_type")
		delete(additionalProperties, "vlan_mode")
		delete(additionalProperties, "num_queues")
		delete(additionalProperties, "default_gateway_address_list")
		delete(additionalProperties, "dhcp_server_ip")
		delete(additionalProperties, "model")
		delete(additionalProperties, "is_connected")
		delete(additionalProperties, "trunked_vlan_list")
...
type NullableVmNicOutputStatus struct {
	value *VmNicOutputStatus
	isSet bool
}

func (v NullableVmNicOutputStatus) Get() *VmNicOutputStatus {
	return v.value
}

func (v *NullableVmNicOutputStatus) Set(val *VmNicOutputStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVmNicOutputStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVmNicOutputStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmNicOutputStatus(val *VmNicOutputStatus) *NullableVmNicOutputStatus {
	return &NullableVmNicOutputStatus{value: val, isSet: true}
}

func (v NullableVmNicOutputStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmNicOutputStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
