...
// checks if the VpcDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcDefStatus{}

// VpcDefStatus VPC output status
...
type _VpcDefStatus VpcDefStatus
...
// SetResources gets a reference to the given VpcResourcesDefStatus and assigns it to the Resources field.
...
func (o VpcDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VpcDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VpcDefStatus) UnmarshalJSON(data []byte) (err error) {
	varVpcDefStatus := _VpcDefStatus{}

	err = json.Unmarshal(data, &varVpcDefStatus)

	if err != nil {
		return err
	}

	*o = VpcDefStatus(varVpcDefStatus)
...
type NullableVpcDefStatus struct {
	value *VpcDefStatus
	isSet bool
}

func (v NullableVpcDefStatus) Get() *VpcDefStatus {
	return v.value
}

func (v *NullableVpcDefStatus) Set(val *VpcDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcDefStatus(val *VpcDefStatus) *NullableVpcDefStatus {
	return &NullableVpcDefStatus{value: val, isSet: true}
}

func (v NullableVpcDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
