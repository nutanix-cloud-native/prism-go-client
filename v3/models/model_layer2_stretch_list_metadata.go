...
// checks if the Layer2StretchListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchListMetadata{}

// Layer2StretchListMetadata All api calls that return a list will have this metadata block as input 
type Layer2StretchListMetadata struct {
	// The kind name
...
type _Layer2StretchListMetadata Layer2StretchListMetadata
...
func NewLayer2StretchListMetadata() *Layer2StretchListMetadata {
	this := Layer2StretchListMetadata{}
...
func (o Layer2StretchListMetadata) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchListMetadata) UnmarshalJSON(data []byte) (err error) {
	varLayer2StretchListMetadata := _Layer2StretchListMetadata{}

	err = json.Unmarshal(data, &varLayer2StretchListMetadata)

	if err != nil {
		return err
	}

	*o = Layer2StretchListMetadata(varLayer2StretchListMetadata)
...
type NullableLayer2StretchListMetadata struct {
	value *Layer2StretchListMetadata
	isSet bool
}

func (v NullableLayer2StretchListMetadata) Get() *Layer2StretchListMetadata {
	return v.value
}

func (v *NullableLayer2StretchListMetadata) Set(val *Layer2StretchListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchListMetadata(val *Layer2StretchListMetadata) *NullableLayer2StretchListMetadata {
	return &NullableLayer2StretchListMetadata{value: val, isSet: true}
}

func (v NullableLayer2StretchListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
