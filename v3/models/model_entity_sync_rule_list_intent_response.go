...
// checks if the EntitySyncRuleListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySyncRuleListIntentResponse{}

// EntitySyncRuleListIntentResponse Response object for intentful operation of entity_sync_rules
type EntitySyncRuleListIntentResponse struct {
	Entities []EntitySyncRuleIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata EntitySyncRuleListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _EntitySyncRuleListIntentResponse EntitySyncRuleListIntentResponse
...
func NewEntitySyncRuleListIntentResponse(apiVersion string, metadata EntitySyncRuleListMetadataOutput) *EntitySyncRuleListIntentResponse {
	this := EntitySyncRuleListIntentResponse{}
...
func (o *EntitySyncRuleListIntentResponse) GetEntities() []EntitySyncRuleIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []EntitySyncRuleIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []EntitySyncRuleIntentResource and assigns it to the Entities field.
...
func (o *EntitySyncRuleListIntentResponse) GetMetadata() EntitySyncRuleListMetadataOutput {
	if o == nil {
		var ret EntitySyncRuleListMetadataOutput
		return ret
	}
...
func (o EntitySyncRuleListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o EntitySyncRuleListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EntitySyncRuleListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEntitySyncRuleListIntentResponse := _EntitySyncRuleListIntentResponse{}

	err = json.Unmarshal(data, &varEntitySyncRuleListIntentResponse)

	if err != nil {
		return err
	}

	*o = EntitySyncRuleListIntentResponse(varEntitySyncRuleListIntentResponse)
...
type NullableEntitySyncRuleListIntentResponse struct {
	value *EntitySyncRuleListIntentResponse
	isSet bool
}

func (v NullableEntitySyncRuleListIntentResponse) Get() *EntitySyncRuleListIntentResponse {
	return v.value
}

func (v *NullableEntitySyncRuleListIntentResponse) Set(val *EntitySyncRuleListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySyncRuleListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySyncRuleListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySyncRuleListIntentResponse(val *EntitySyncRuleListIntentResponse) *NullableEntitySyncRuleListIntentResponse {
	return &NullableEntitySyncRuleListIntentResponse{value: val, isSet: true}
}

func (v NullableEntitySyncRuleListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySyncRuleListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
