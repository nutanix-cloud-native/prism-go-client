...
// checks if the AppListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppListIntentResponse{}

// AppListIntentResponse Response object for intentful operation of apps
type AppListIntentResponse struct {
	Entities []AppIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AppListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AppListIntentResponse AppListIntentResponse
...
// SetEntities gets a reference to the given []AppIntentResource and assigns it to the Entities field.
...
func (o AppListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AppListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppListIntentResponse := _AppListIntentResponse{}

	err = json.Unmarshal(data, &varAppListIntentResponse)

	if err != nil {
		return err
	}

	*o = AppListIntentResponse(varAppListIntentResponse)
...
type NullableAppListIntentResponse struct {
	value *AppListIntentResponse
	isSet bool
}

func (v NullableAppListIntentResponse) Get() *AppListIntentResponse {
	return v.value
}

func (v *NullableAppListIntentResponse) Set(val *AppListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppListIntentResponse(val *AppListIntentResponse) *NullableAppListIntentResponse {
	return &NullableAppListIntentResponse{value: val, isSet: true}
}

func (v NullableAppListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
