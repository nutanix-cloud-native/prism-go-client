...
// checks if the RackListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackListMetadataOutput{}

// RackListMetadataOutput All api calls that return a list will have this metadata block 
type RackListMetadataOutput struct {
	// The kind name
...
type _RackListMetadataOutput RackListMetadataOutput
...
func NewRackListMetadataOutput() *RackListMetadataOutput {
	this := RackListMetadataOutput{}
	var kind string = "rack"
	this.Kind = &kind
	return &this
}
...
func (o RackListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o RackListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *RackListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varRackListMetadataOutput := _RackListMetadataOutput{}

	err = json.Unmarshal(data, &varRackListMetadataOutput)

	if err != nil {
		return err
	}

	*o = RackListMetadataOutput(varRackListMetadataOutput)
...
type NullableRackListMetadataOutput struct {
	value *RackListMetadataOutput
	isSet bool
}

func (v NullableRackListMetadataOutput) Get() *RackListMetadataOutput {
	return v.value
}

func (v *NullableRackListMetadataOutput) Set(val *RackListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableRackListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableRackListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackListMetadataOutput(val *RackListMetadataOutput) *NullableRackListMetadataOutput {
	return &NullableRackListMetadataOutput{value: val, isSet: true}
}

func (v NullableRackListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
