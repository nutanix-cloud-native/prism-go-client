...
// checks if the DirectoryServiceListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceListMetadataOutput{}

// DirectoryServiceListMetadataOutput All api calls that return a list will have this metadata block 
...
type _DirectoryServiceListMetadataOutput DirectoryServiceListMetadataOutput
...
func NewDirectoryServiceListMetadataOutput() *DirectoryServiceListMetadataOutput {
	this := DirectoryServiceListMetadataOutput{}
	var kind string = "directory_service"
	this.Kind = &kind
	return &this
}
...
func (o DirectoryServiceListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryServiceListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varDirectoryServiceListMetadataOutput := _DirectoryServiceListMetadataOutput{}

	err = json.Unmarshal(data, &varDirectoryServiceListMetadataOutput)

	if err != nil {
		return err
	}

	*o = DirectoryServiceListMetadataOutput(varDirectoryServiceListMetadataOutput)
...
type NullableDirectoryServiceListMetadataOutput struct {
	value *DirectoryServiceListMetadataOutput
	isSet bool
}

func (v NullableDirectoryServiceListMetadataOutput) Get() *DirectoryServiceListMetadataOutput {
	return v.value
}

func (v *NullableDirectoryServiceListMetadataOutput) Set(val *DirectoryServiceListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceListMetadataOutput(val *DirectoryServiceListMetadataOutput) *NullableDirectoryServiceListMetadataOutput {
	return &NullableDirectoryServiceListMetadataOutput{value: val, isSet: true}
}

func (v NullableDirectoryServiceListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
