...
// checks if the MulticlusterConfigListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MulticlusterConfigListMetadataOutput{}

// MulticlusterConfigListMetadataOutput All api calls that return a list will have this metadata block 
type MulticlusterConfigListMetadataOutput struct {
	// The kind name
...
type _MulticlusterConfigListMetadataOutput MulticlusterConfigListMetadataOutput
...
func NewMulticlusterConfigListMetadataOutput() *MulticlusterConfigListMetadataOutput {
	this := MulticlusterConfigListMetadataOutput{}
	var kind string = "multicluster_config"
	this.Kind = &kind
	return &this
}
...
func (o *MulticlusterConfigListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *MulticlusterConfigListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o MulticlusterConfigListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o MulticlusterConfigListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *MulticlusterConfigListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varMulticlusterConfigListMetadataOutput := _MulticlusterConfigListMetadataOutput{}

	err = json.Unmarshal(data, &varMulticlusterConfigListMetadataOutput)

	if err != nil {
		return err
	}

	*o = MulticlusterConfigListMetadataOutput(varMulticlusterConfigListMetadataOutput)
...
type NullableMulticlusterConfigListMetadataOutput struct {
	value *MulticlusterConfigListMetadataOutput
	isSet bool
}

func (v NullableMulticlusterConfigListMetadataOutput) Get() *MulticlusterConfigListMetadataOutput {
	return v.value
}

func (v *NullableMulticlusterConfigListMetadataOutput) Set(val *MulticlusterConfigListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableMulticlusterConfigListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableMulticlusterConfigListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMulticlusterConfigListMetadataOutput(val *MulticlusterConfigListMetadataOutput) *NullableMulticlusterConfigListMetadataOutput {
	return &NullableMulticlusterConfigListMetadataOutput{value: val, isSet: true}
}

func (v NullableMulticlusterConfigListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMulticlusterConfigListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
