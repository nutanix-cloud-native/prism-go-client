...
// checks if the AwsElasticIpListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsElasticIpListMetadata{}

// AwsElasticIpListMetadata All api calls that return a list will have this metadata block as input 
type AwsElasticIpListMetadata struct {
	// The kind name
...
type _AwsElasticIpListMetadata AwsElasticIpListMetadata
...
func (o AwsElasticIpListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsElasticIpListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsElasticIpListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsElasticIpListMetadata := _AwsElasticIpListMetadata{}

	err = json.Unmarshal(data, &varAwsElasticIpListMetadata)

	if err != nil {
		return err
	}

	*o = AwsElasticIpListMetadata(varAwsElasticIpListMetadata)
...
type NullableAwsElasticIpListMetadata struct {
	value *AwsElasticIpListMetadata
	isSet bool
}

func (v NullableAwsElasticIpListMetadata) Get() *AwsElasticIpListMetadata {
	return v.value
}

func (v *NullableAwsElasticIpListMetadata) Set(val *AwsElasticIpListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsElasticIpListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsElasticIpListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsElasticIpListMetadata(val *AwsElasticIpListMetadata) *NullableAwsElasticIpListMetadata {
	return &NullableAwsElasticIpListMetadata{value: val, isSet: true}
}

func (v NullableAwsElasticIpListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsElasticIpListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
