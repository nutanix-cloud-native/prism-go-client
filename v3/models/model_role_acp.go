...
// checks if the RoleAcp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleAcp{}

// RoleAcp Role Input Definition.
type RoleAcp struct {
	// The list of Permissions.
	PermissionUuidList []string `json:"permission_uuid_list,omitempty"`
	// Role name.
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _RoleAcp RoleAcp
...
// GetPermissionUuidList returns the PermissionUuidList field value if set, zero value otherwise.
func (o *RoleAcp) GetPermissionUuidList() []string {
	if o == nil || IsNil(o.PermissionUuidList) {
		var ret []string
		return ret
	}
	return o.PermissionUuidList
}

// GetPermissionUuidListOk returns a tuple with the PermissionUuidList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoleAcp) GetPermissionUuidListOk() ([]string, bool) {
	if o == nil || IsNil(o.PermissionUuidList) {
		return nil, false
	}
	return o.PermissionUuidList, true
}
...
// SetPermissionUuidList gets a reference to the given []string and assigns it to the PermissionUuidList field.
func (o *RoleAcp) SetPermissionUuidList(v []string) {
	o.PermissionUuidList = v
}
...
func (o RoleAcp) MarshalJSON() ([]byte, error) {
...
func (o RoleAcp) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PermissionUuidList) {
		toSerialize["permission_uuid_list"] = o.PermissionUuidList
	}
...
func (o *RoleAcp) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRoleAcp)

	if err != nil {
		return err
	}

	*o = RoleAcp(varRoleAcp)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "permission_uuid_list")
...
type NullableRoleAcp struct {
	value *RoleAcp
	isSet bool
}

func (v NullableRoleAcp) Get() *RoleAcp {
	return v.value
}

func (v *NullableRoleAcp) Set(val *RoleAcp) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleAcp) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleAcp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleAcp(val *RoleAcp) *NullableRoleAcp {
	return &NullableRoleAcp{value: val, isSet: true}
}

func (v NullableRoleAcp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleAcp) UnmarshalJSON(src []byte) error {
	v.isSet = true
