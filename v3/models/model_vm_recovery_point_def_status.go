...
// checks if the VmRecoveryPointDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPointDefStatus{}

// VmRecoveryPointDefStatus The output object that defines a vm recovery point
type VmRecoveryPointDefStatus struct {
	...
	Resources *RecoveryPointResources1 `json:"resources,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VmRecoveryPointDefStatus VmRecoveryPointDefStatus
...
func (o *VmRecoveryPointDefStatus) GetResources() RecoveryPointResources1 {
	if o == nil || IsNil(o.Resources) {
		var ret RecoveryPointResources1
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given RecoveryPointResources1 and assigns it to the Resources field.
func (o *VmRecoveryPointDefStatus) SetResources(v RecoveryPointResources1) {
	o.Resources = &v
}

func (o VmRecoveryPointDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPointDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPointDefStatus) UnmarshalJSON(data []byte) (err error) {
	varVmRecoveryPointDefStatus := _VmRecoveryPointDefStatus{}

	err = json.Unmarshal(data, &varVmRecoveryPointDefStatus)

	if err != nil {
		return err
	}

	*o = VmRecoveryPointDefStatus(varVmRecoveryPointDefStatus)
...
type NullableVmRecoveryPointDefStatus struct {
	value *VmRecoveryPointDefStatus
	isSet bool
}

func (v NullableVmRecoveryPointDefStatus) Get() *VmRecoveryPointDefStatus {
	return v.value
}

func (v *NullableVmRecoveryPointDefStatus) Set(val *VmRecoveryPointDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPointDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPointDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPointDefStatus(val *VmRecoveryPointDefStatus) *NullableVmRecoveryPointDefStatus {
	return &NullableVmRecoveryPointDefStatus{value: val, isSet: true}
}

func (v NullableVmRecoveryPointDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPointDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
