...
// checks if the TunnelReferenceUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TunnelReferenceUpload{}

// TunnelReferenceUpload The reference to a tunnel
type TunnelReferenceUpload struct {
	// The kind name
...
type _TunnelReferenceUpload TunnelReferenceUpload
...
func (o TunnelReferenceUpload) MarshalJSON() ([]byte, error) {
...
func (o TunnelReferenceUpload) ToMap() (map[string]interface{}, error) {
...
func (o *TunnelReferenceUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varTunnelReferenceUpload := _TunnelReferenceUpload{}

	err = json.Unmarshal(data, &varTunnelReferenceUpload)

	if err != nil {
		return err
	}

	*o = TunnelReferenceUpload(varTunnelReferenceUpload)
...
type NullableTunnelReferenceUpload struct {
	value *TunnelReferenceUpload
	isSet bool
}

func (v NullableTunnelReferenceUpload) Get() *TunnelReferenceUpload {
	return v.value
}

func (v *NullableTunnelReferenceUpload) Set(val *TunnelReferenceUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableTunnelReferenceUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableTunnelReferenceUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTunnelReferenceUpload(val *TunnelReferenceUpload) *NullableTunnelReferenceUpload {
	return &NullableTunnelReferenceUpload{value: val, isSet: true}
}

func (v NullableTunnelReferenceUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTunnelReferenceUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
