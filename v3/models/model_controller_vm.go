...
// checks if the ControllerVm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ControllerVm{}

// ControllerVm Host controller vm information.
type ControllerVm struct {
	// Controller VM IP address.
	Ip string `json:"ip" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// Controller VM NAT IP address.
	NatIp *string `json:"nat_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
...
type _ControllerVm ControllerVm
...
// GetOplogUsage returns the OplogUsage field value if set, zero value otherwise.
func (o *ControllerVm) GetOplogUsage() OplogUsage {
	if o == nil || IsNil(o.OplogUsage) {
		var ret OplogUsage
		return ret
	}
	return *o.OplogUsage
...
// GetOplogUsageOk returns a tuple with the OplogUsage field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ControllerVm) GetOplogUsageOk() (*OplogUsage, bool) {
	if o == nil || IsNil(o.OplogUsage) {
		return nil, false
	}
	return o.OplogUsage, true
}
...
// SetOplogUsage gets a reference to the given OplogUsage and assigns it to the OplogUsage field.
func (o *ControllerVm) SetOplogUsage(v OplogUsage) {
	o.OplogUsage = &v
}

// GetNatPort returns the NatPort field value if set, zero value otherwise.
func (o *ControllerVm) GetNatPort() int32 {
	if o == nil || IsNil(o.NatPort) {
		var ret int32
		return ret
	}
	return *o.NatPort
...
// GetNatPortOk returns a tuple with the NatPort field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ControllerVm) GetNatPortOk() (*int32, bool) {
	if o == nil || IsNil(o.NatPort) {
		return nil, false
	}
	return o.NatPort, true
}
...
// SetNatPort gets a reference to the given int32 and assigns it to the NatPort field.
func (o *ControllerVm) SetNatPort(v int32) {
	o.NatPort = &v
}

func (o ControllerVm) MarshalJSON() ([]byte, error) {
...
func (o ControllerVm) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["ip"] = o.Ip
	if !IsNil(o.NatIp) {
		toSerialize["nat_ip"] = o.NatIp
	}
	if !IsNil(o.OplogUsage) {
		toSerialize["oplog_usage"] = o.OplogUsage
	}
	if !IsNil(o.NatPort) {
		toSerialize["nat_port"] = o.NatPort
	}
...
func (o *ControllerVm) UnmarshalJSON(data []byte) (err error) {
	...
	varControllerVm := _ControllerVm{}

	err = json.Unmarshal(data, &varControllerVm)

	if err != nil {
		return err
	}

	*o = ControllerVm(varControllerVm)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "oplog_usage")
		delete(additionalProperties, "nat_port")
...
type NullableControllerVm struct {
	value *ControllerVm
	isSet bool
}

func (v NullableControllerVm) Get() *ControllerVm {
	return v.value
}

func (v *NullableControllerVm) Set(val *ControllerVm) {
	v.value = val
	v.isSet = true
}

func (v NullableControllerVm) IsSet() bool {
	return v.isSet
}

func (v *NullableControllerVm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableControllerVm(val *ControllerVm) *NullableControllerVm {
	return &NullableControllerVm{value: val, isSet: true}
}

func (v NullableControllerVm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableControllerVm) UnmarshalJSON(src []byte) error {
	v.isSet = true
