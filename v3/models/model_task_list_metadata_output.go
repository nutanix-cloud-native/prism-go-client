...
// checks if the TaskListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskListMetadataOutput{}

// TaskListMetadataOutput All api calls that return a list will have this metadata block 
type TaskListMetadataOutput struct {
	// The kind name
...
type _TaskListMetadataOutput TaskListMetadataOutput
...
func (o TaskListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o TaskListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *TaskListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varTaskListMetadataOutput := _TaskListMetadataOutput{}

	err = json.Unmarshal(data, &varTaskListMetadataOutput)

	if err != nil {
		return err
	}

	*o = TaskListMetadataOutput(varTaskListMetadataOutput)
...
type NullableTaskListMetadataOutput struct {
	value *TaskListMetadataOutput
	isSet bool
}

func (v NullableTaskListMetadataOutput) Get() *TaskListMetadataOutput {
	return v.value
}

func (v *NullableTaskListMetadataOutput) Set(val *TaskListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskListMetadataOutput(val *TaskListMetadataOutput) *NullableTaskListMetadataOutput {
	return &NullableTaskListMetadataOutput{value: val, isSet: true}
}

func (v NullableTaskListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
