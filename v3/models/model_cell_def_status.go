...
// checks if the CellDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CellDefStatus{}

// CellDefStatus Cell entity status definition
type CellDefStatus struct {
	// Name of the cell
	Name string `json:"name"`
	Resources CellResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _CellDefStatus CellDefStatus
...
func (o CellDefStatus) MarshalJSON() ([]byte, error) {
...
func (o CellDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CellDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varCellDefStatus := _CellDefStatus{}

	err = json.Unmarshal(data, &varCellDefStatus)

	if err != nil {
		return err
	}

	*o = CellDefStatus(varCellDefStatus)
...
type NullableCellDefStatus struct {
	value *CellDefStatus
	isSet bool
}

func (v NullableCellDefStatus) Get() *CellDefStatus {
	return v.value
}

func (v *NullableCellDefStatus) Set(val *CellDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCellDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCellDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCellDefStatus(val *CellDefStatus) *NullableCellDefStatus {
	return &NullableCellDefStatus{value: val, isSet: true}
}

func (v NullableCellDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCellDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
