...
// checks if the ActionTypeStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTypeStatus{}

// ActionTypeStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _ActionTypeStatus ActionTypeStatus
...
func (o ActionTypeStatus) MarshalJSON() ([]byte, error) {
...
func (o ActionTypeStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTypeStatus) UnmarshalJSON(data []byte) (err error) {
	varActionTypeStatus := _ActionTypeStatus{}

	err = json.Unmarshal(data, &varActionTypeStatus)

	if err != nil {
		return err
	}

	*o = ActionTypeStatus(varActionTypeStatus)
...
type NullableActionTypeStatus struct {
	value *ActionTypeStatus
	isSet bool
}

func (v NullableActionTypeStatus) Get() *ActionTypeStatus {
	return v.value
}

func (v *NullableActionTypeStatus) Set(val *ActionTypeStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTypeStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTypeStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTypeStatus(val *ActionTypeStatus) *NullableActionTypeStatus {
	return &NullableActionTypeStatus{value: val, isSet: true}
}

func (v NullableActionTypeStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTypeStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
