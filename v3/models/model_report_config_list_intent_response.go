...
// checks if the ReportConfigListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigListIntentResponse{}

// ReportConfigListIntentResponse Response object for intentful operation of report_configs
type ReportConfigListIntentResponse struct {
	Entities []ReportConfigIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ReportConfigListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ReportConfigListIntentResponse ReportConfigListIntentResponse
...
func NewReportConfigListIntentResponse(apiVersion string, metadata ReportConfigListMetadataOutput) *ReportConfigListIntentResponse {
	this := ReportConfigListIntentResponse{}
...
func (o *ReportConfigListIntentResponse) GetEntities() []ReportConfigIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []ReportConfigIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []ReportConfigIntentResource and assigns it to the Entities field.
...
func (o *ReportConfigListIntentResponse) GetMetadata() ReportConfigListMetadataOutput {
	if o == nil {
		var ret ReportConfigListMetadataOutput
		return ret
	}
...
func (o ReportConfigListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfigListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varReportConfigListIntentResponse := _ReportConfigListIntentResponse{}

	err = json.Unmarshal(data, &varReportConfigListIntentResponse)

	if err != nil {
		return err
	}

	*o = ReportConfigListIntentResponse(varReportConfigListIntentResponse)
...
type NullableReportConfigListIntentResponse struct {
	value *ReportConfigListIntentResponse
	isSet bool
}

func (v NullableReportConfigListIntentResponse) Get() *ReportConfigListIntentResponse {
	return v.value
}

func (v *NullableReportConfigListIntentResponse) Set(val *ReportConfigListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigListIntentResponse(val *ReportConfigListIntentResponse) *NullableReportConfigListIntentResponse {
	return &NullableReportConfigListIntentResponse{value: val, isSet: true}
}

func (v NullableReportConfigListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
