...
// checks if the CaChainSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CaChainSpec{}
...
func (o CaChainSpec) MarshalJSON() ([]byte, error) {
...
func (o CaChainSpec) ToMap() (map[string]interface{}, error) {
...
func (o *CaChainSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varCaChainSpec := _CaChainSpec{}

	err = json.Unmarshal(data, &varCaChainSpec)

	if err != nil {
		return err
	}

	*o = CaChainSpec(varCaChainSpec)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "ca_chain")
...
type NullableCaChainSpec struct {
	value *CaChainSpec
	isSet bool
}

func (v NullableCaChainSpec) Get() *CaChainSpec {
	return v.value
}

func (v *NullableCaChainSpec) Set(val *CaChainSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableCaChainSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableCaChainSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCaChainSpec(val *CaChainSpec) *NullableCaChainSpec {
	return &NullableCaChainSpec{value: val, isSet: true}
}

func (v NullableCaChainSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCaChainSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
