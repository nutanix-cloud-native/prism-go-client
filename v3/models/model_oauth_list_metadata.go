...
// checks if the OauthListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthListMetadata{}

// OauthListMetadata All api calls that return a list will have this metadata block as input 
...
type _OauthListMetadata OauthListMetadata
...
func (o OauthListMetadata) MarshalJSON() ([]byte, error) {
...
func (o OauthListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *OauthListMetadata) UnmarshalJSON(data []byte) (err error) {
	varOauthListMetadata := _OauthListMetadata{}

	err = json.Unmarshal(data, &varOauthListMetadata)

	if err != nil {
		return err
	}

	*o = OauthListMetadata(varOauthListMetadata)
...
type NullableOauthListMetadata struct {
	value *OauthListMetadata
	isSet bool
}

func (v NullableOauthListMetadata) Get() *OauthListMetadata {
	return v.value
}

func (v *NullableOauthListMetadata) Set(val *OauthListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthListMetadata(val *OauthListMetadata) *NullableOauthListMetadata {
	return &NullableOauthListMetadata{value: val, isSet: true}
}

func (v NullableOauthListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
