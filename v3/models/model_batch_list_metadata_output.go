...
// checks if the BatchListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchListMetadataOutput{}

// BatchListMetadataOutput All api calls that return a list will have this metadata block 
...
type _BatchListMetadataOutput BatchListMetadataOutput
...
func NewBatchListMetadataOutput() *BatchListMetadataOutput {
	this := BatchListMetadataOutput{}
	var kind string = "batch"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *BatchListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o BatchListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o BatchListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *BatchListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varBatchListMetadataOutput := _BatchListMetadataOutput{}

	err = json.Unmarshal(data, &varBatchListMetadataOutput)

	if err != nil {
		return err
	}

	*o = BatchListMetadataOutput(varBatchListMetadataOutput)
...
type NullableBatchListMetadataOutput struct {
	value *BatchListMetadataOutput
	isSet bool
}

func (v NullableBatchListMetadataOutput) Get() *BatchListMetadataOutput {
	return v.value
}

func (v *NullableBatchListMetadataOutput) Set(val *BatchListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchListMetadataOutput(val *BatchListMetadataOutput) *NullableBatchListMetadataOutput {
	return &NullableBatchListMetadataOutput{value: val, isSet: true}
}

func (v NullableBatchListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
