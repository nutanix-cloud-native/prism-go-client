...
// checks if the QosConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QosConfig{}

// QosConfig Quality of Service configuration for the VPN IPSec tunnel.
...
func (o QosConfig) MarshalJSON() ([]byte, error) {
...
func (o QosConfig) ToMap() (map[string]interface{}, error) {
...
func (o *QosConfig) UnmarshalJSON(data []byte) (err error) {
	varQosConfig := _QosConfig{}

	err = json.Unmarshal(data, &varQosConfig)

	if err != nil {
		return err
	}

	*o = QosConfig(varQosConfig)
...
type NullableQosConfig struct {
	value *QosConfig
	isSet bool
}

func (v NullableQosConfig) Get() *QosConfig {
	return v.value
}

func (v *NullableQosConfig) Set(val *QosConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableQosConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableQosConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQosConfig(val *QosConfig) *NullableQosConfig {
	return &NullableQosConfig{value: val, isSet: true}
}

func (v NullableQosConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQosConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
