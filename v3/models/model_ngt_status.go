...
// checks if the NgtStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtStatus{}

// NgtStatus The status of a REST API call. Only used when there is a failure to report. 
...
func (o NgtStatus) MarshalJSON() ([]byte, error) {
...
func (o NgtStatus) ToMap() (map[string]interface{}, error) {
...
func (o *NgtStatus) UnmarshalJSON(data []byte) (err error) {
	varNgtStatus := _NgtStatus{}

	err = json.Unmarshal(data, &varNgtStatus)

	if err != nil {
		return err
	}

	*o = NgtStatus(varNgtStatus)
...
type NullableNgtStatus struct {
	value *NgtStatus
	isSet bool
}

func (v NullableNgtStatus) Get() *NgtStatus {
	return v.value
}

func (v *NullableNgtStatus) Set(val *NgtStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtStatus(val *NgtStatus) *NullableNgtStatus {
	return &NullableNgtStatus{value: val, isSet: true}
}

func (v NullableNgtStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
