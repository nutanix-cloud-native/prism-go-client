...
// checks if the VMResources1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VMResources1{}

// VMResources1 VM Resources Definition.
type VMResources1 struct {
	VnumaConfig *VmVnumaConfig `json:"vnuma_config,omitempty"`
	// List of Virtual NICs to be attached to the VM.
...
type _VMResources1 VMResources1
...
// SetGpuList gets a reference to the given []VmGpu and assigns it to the GpuList field.
func (o *VMResources1) SetGpuList(v []VmGpu) {
	o.GpuList = v
}

func (o VMResources1) MarshalJSON() ([]byte, error) {
...
func (o VMResources1) ToMap() (map[string]interface{}, error) {
...
func (o *VMResources1) UnmarshalJSON(data []byte) (err error) {
	varVMResources1 := _VMResources1{}

	err = json.Unmarshal(data, &varVMResources1)

	if err != nil {
		return err
	}

	*o = VMResources1(varVMResources1)
...
type NullableVMResources1 struct {
	value *VMResources1
	isSet bool
}

func (v NullableVMResources1) Get() *VMResources1 {
	return v.value
}

func (v *NullableVMResources1) Set(val *VMResources1) {
	v.value = val
	v.isSet = true
}

func (v NullableVMResources1) IsSet() bool {
	return v.isSet
}

func (v *NullableVMResources1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVMResources1(val *VMResources1) *NullableVMResources1 {
	return &NullableVMResources1{value: val, isSet: true}
}

func (v NullableVMResources1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVMResources1) UnmarshalJSON(src []byte) error {
	v.isSet = true
