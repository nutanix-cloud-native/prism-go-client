...
// checks if the OvaListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OvaListMetadataOutput{}

// OvaListMetadataOutput All api calls that return a list will have this metadata block 
type OvaListMetadataOutput struct {
	// The kind name
...
type _OvaListMetadataOutput OvaListMetadataOutput
...
func (o OvaListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o OvaListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *OvaListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varOvaListMetadataOutput := _OvaListMetadataOutput{}

	err = json.Unmarshal(data, &varOvaListMetadataOutput)

	if err != nil {
		return err
	}

	*o = OvaListMetadataOutput(varOvaListMetadataOutput)
...
type NullableOvaListMetadataOutput struct {
	value *OvaListMetadataOutput
	isSet bool
}

func (v NullableOvaListMetadataOutput) Get() *OvaListMetadataOutput {
	return v.value
}

func (v *NullableOvaListMetadataOutput) Set(val *OvaListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableOvaListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableOvaListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOvaListMetadataOutput(val *OvaListMetadataOutput) *NullableOvaListMetadataOutput {
	return &NullableOvaListMetadataOutput{value: val, isSet: true}
}

func (v NullableOvaListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOvaListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
