...
// checks if the DirectConnectDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectDefStatus{}

// DirectConnectDefStatus An intentful representation of a direct_connect status
type DirectConnectDefStatus struct {
	// direct_connect Name.
	Name string `json:"name"`
	// The state of the direct_connect.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the direct_connect, if in an error state.
	...
	Resources DirectConnectResourcesDefStatus `json:"resources"`
	// A description for direct_connect.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DirectConnectDefStatus DirectConnectDefStatus
...
func (o *DirectConnectDefStatus) GetResources() DirectConnectResourcesDefStatus {
	if o == nil {
		var ret DirectConnectResourcesDefStatus
		return ret
	}
...
func (o DirectConnectDefStatus) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectDefStatus := _DirectConnectDefStatus{}

	err = json.Unmarshal(data, &varDirectConnectDefStatus)

	if err != nil {
		return err
	}

	*o = DirectConnectDefStatus(varDirectConnectDefStatus)
...
type NullableDirectConnectDefStatus struct {
	value *DirectConnectDefStatus
	isSet bool
}

func (v NullableDirectConnectDefStatus) Get() *DirectConnectDefStatus {
	return v.value
}

func (v *NullableDirectConnectDefStatus) Set(val *DirectConnectDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectDefStatus(val *DirectConnectDefStatus) *NullableDirectConnectDefStatus {
	return &NullableDirectConnectDefStatus{value: val, isSet: true}
}

func (v NullableDirectConnectDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
