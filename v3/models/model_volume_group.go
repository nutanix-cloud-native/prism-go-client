...
func (o *VolumeGroup) GetResources() VolumeGroupResourcesInput {
	if o == nil {
		var ret VolumeGroupResourcesInput
		return ret
	}
...
func (o *VolumeGroup) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumeGroup := _VolumeGroup{}

	err = json.Unmarshal(data, &varVolumeGroup)

	if err != nil {
		return err
	}

	*o = VolumeGroup(varVolumeGroup)
