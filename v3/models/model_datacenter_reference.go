...
// checks if the DatacenterReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterReference{}

// DatacenterReference The reference to a datacenter
...
type _DatacenterReference DatacenterReference
...
func (o DatacenterReference) MarshalJSON() ([]byte, error) {
...
func (o DatacenterReference) ToMap() (map[string]interface{}, error) {
...
func (o *DatacenterReference) UnmarshalJSON(data []byte) (err error) {
	...
	varDatacenterReference := _DatacenterReference{}

	err = json.Unmarshal(data, &varDatacenterReference)

	if err != nil {
		return err
	}

	*o = DatacenterReference(varDatacenterReference)
...
type NullableDatacenterReference struct {
	value *DatacenterReference
	isSet bool
}

func (v NullableDatacenterReference) Get() *DatacenterReference {
	return v.value
}

func (v *NullableDatacenterReference) Set(val *DatacenterReference) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterReference) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterReference(val *DatacenterReference) *NullableDatacenterReference {
	return &NullableDatacenterReference{value: val, isSet: true}
}

func (v NullableDatacenterReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
