...
// checks if the OvaInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OvaInfo{}

// OvaInfo Information about OVA
type OvaInfo struct {
	ParentVmReference *VmReference `json:"parent_vm_reference,omitempty"`
	// List of clusters where OVA is currently present.
	CurrentClusterReferenceList []ClusterReference `json:"current_cluster_reference_list,omitempty"`
	// OVA disk format.
...
// SetCurrentClusterReferenceList gets a reference to the given []ClusterReference and assigns it to the CurrentClusterReferenceList field.
...
func (o OvaInfo) MarshalJSON() ([]byte, error) {
...
func (o OvaInfo) ToMap() (map[string]interface{}, error) {
...
func (o *OvaInfo) UnmarshalJSON(data []byte) (err error) {
	varOvaInfo := _OvaInfo{}

	err = json.Unmarshal(data, &varOvaInfo)

	if err != nil {
		return err
	}

	*o = OvaInfo(varOvaInfo)
...
type NullableOvaInfo struct {
	value *OvaInfo
	isSet bool
}

func (v NullableOvaInfo) Get() *OvaInfo {
	return v.value
}

func (v *NullableOvaInfo) Set(val *OvaInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableOvaInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableOvaInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOvaInfo(val *OvaInfo) *NullableOvaInfo {
	return &NullableOvaInfo{value: val, isSet: true}
}

func (v NullableOvaInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOvaInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
