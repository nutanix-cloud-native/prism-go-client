...
// checks if the VmHostAffinityPolicyVmsListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityPolicyVmsListResponse{}

// VmHostAffinityPolicyVmsListResponse Response object for list operation of VMs which are part of input policy. 
type VmHostAffinityPolicyVmsListResponse struct {
	Entities []VmHostAffinityPolicyVmsInfo `json:"entities,omitempty"`
	Metadata VmHostAffinityPolicyVmsListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VmHostAffinityPolicyVmsListResponse VmHostAffinityPolicyVmsListResponse
...
func NewVmHostAffinityPolicyVmsListResponse(metadata VmHostAffinityPolicyVmsListMetadataOutput) *VmHostAffinityPolicyVmsListResponse {
	this := VmHostAffinityPolicyVmsListResponse{}
...
func (o *VmHostAffinityPolicyVmsListResponse) GetEntities() []VmHostAffinityPolicyVmsInfo {
	if o == nil || IsNil(o.Entities) {
		var ret []VmHostAffinityPolicyVmsInfo
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []VmHostAffinityPolicyVmsInfo and assigns it to the Entities field.
...
func (o *VmHostAffinityPolicyVmsListResponse) GetMetadata() VmHostAffinityPolicyVmsListMetadataOutput {
	if o == nil {
		var ret VmHostAffinityPolicyVmsListMetadataOutput
		return ret
	}
...
func (o VmHostAffinityPolicyVmsListResponse) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityPolicyVmsListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VmHostAffinityPolicyVmsListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVmHostAffinityPolicyVmsListResponse := _VmHostAffinityPolicyVmsListResponse{}

	err = json.Unmarshal(data, &varVmHostAffinityPolicyVmsListResponse)

	if err != nil {
		return err
	}

	*o = VmHostAffinityPolicyVmsListResponse(varVmHostAffinityPolicyVmsListResponse)
...
type NullableVmHostAffinityPolicyVmsListResponse struct {
	value *VmHostAffinityPolicyVmsListResponse
	isSet bool
}

func (v NullableVmHostAffinityPolicyVmsListResponse) Get() *VmHostAffinityPolicyVmsListResponse {
	return v.value
}

func (v *NullableVmHostAffinityPolicyVmsListResponse) Set(val *VmHostAffinityPolicyVmsListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityPolicyVmsListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityPolicyVmsListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityPolicyVmsListResponse(val *VmHostAffinityPolicyVmsListResponse) *NullableVmHostAffinityPolicyVmsListResponse {
	return &NullableVmHostAffinityPolicyVmsListResponse{value: val, isSet: true}
}

func (v NullableVmHostAffinityPolicyVmsListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityPolicyVmsListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
