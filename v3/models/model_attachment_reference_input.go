...
// checks if the AttachmentReferenceInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttachmentReferenceInput{}

// AttachmentReferenceInput Attached iSCSI initiators.
type AttachmentReferenceInput struct {
	// Ip address of the external client.
	IscsiInitiatorNetworkId *string `json:"iscsi_initiator_network_id,omitempty"`
	// Client secret for CHAP authentication.
...
type _AttachmentReferenceInput AttachmentReferenceInput
...
func (o AttachmentReferenceInput) MarshalJSON() ([]byte, error) {
...
func (o AttachmentReferenceInput) ToMap() (map[string]interface{}, error) {
...
func (o *AttachmentReferenceInput) UnmarshalJSON(data []byte) (err error) {
	varAttachmentReferenceInput := _AttachmentReferenceInput{}

	err = json.Unmarshal(data, &varAttachmentReferenceInput)

	if err != nil {
		return err
	}

	*o = AttachmentReferenceInput(varAttachmentReferenceInput)
...
type NullableAttachmentReferenceInput struct {
	value *AttachmentReferenceInput
	isSet bool
}

func (v NullableAttachmentReferenceInput) Get() *AttachmentReferenceInput {
	return v.value
}

func (v *NullableAttachmentReferenceInput) Set(val *AttachmentReferenceInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAttachmentReferenceInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAttachmentReferenceInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttachmentReferenceInput(val *AttachmentReferenceInput) *NullableAttachmentReferenceInput {
	return &NullableAttachmentReferenceInput{value: val, isSet: true}
}

func (v NullableAttachmentReferenceInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttachmentReferenceInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
