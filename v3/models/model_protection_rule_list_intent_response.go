...
// checks if the ProtectionRuleListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleListIntentResponse{}

// ProtectionRuleListIntentResponse Response object for intentful operation of protection_rules
type ProtectionRuleListIntentResponse struct {
	Entities []ProtectionRuleIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ProtectionRuleListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ProtectionRuleListIntentResponse ProtectionRuleListIntentResponse
...
func NewProtectionRuleListIntentResponse(apiVersion string, metadata ProtectionRuleListMetadataOutput) *ProtectionRuleListIntentResponse {
	this := ProtectionRuleListIntentResponse{}
...
func (o *ProtectionRuleListIntentResponse) GetEntities() []ProtectionRuleIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []ProtectionRuleIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []ProtectionRuleIntentResource and assigns it to the Entities field.
...
func (o *ProtectionRuleListIntentResponse) GetMetadata() ProtectionRuleListMetadataOutput {
	if o == nil {
		var ret ProtectionRuleListMetadataOutput
		return ret
	}
...
func (o ProtectionRuleListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionRuleListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varProtectionRuleListIntentResponse := _ProtectionRuleListIntentResponse{}

	err = json.Unmarshal(data, &varProtectionRuleListIntentResponse)

	if err != nil {
		return err
	}

	*o = ProtectionRuleListIntentResponse(varProtectionRuleListIntentResponse)
...
type NullableProtectionRuleListIntentResponse struct {
	value *ProtectionRuleListIntentResponse
	isSet bool
}

func (v NullableProtectionRuleListIntentResponse) Get() *ProtectionRuleListIntentResponse {
	return v.value
}

func (v *NullableProtectionRuleListIntentResponse) Set(val *ProtectionRuleListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleListIntentResponse(val *ProtectionRuleListIntentResponse) *NullableProtectionRuleListIntentResponse {
	return &NullableProtectionRuleListIntentResponse{value: val, isSet: true}
}

func (v NullableProtectionRuleListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
