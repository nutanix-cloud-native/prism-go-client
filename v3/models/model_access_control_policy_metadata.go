...
// checks if the AccessControlPolicyMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyMetadata{}

// AccessControlPolicyMetadata The access_control_policy kind metadata
type AccessControlPolicyMetadata struct {
	...
	// Categories for the access_control_policy. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the access_control_policy. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// access_control_policy name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AccessControlPolicyMetadata AccessControlPolicyMetadata
...
func NewAccessControlPolicyMetadata(kind string) *AccessControlPolicyMetadata {
	this := AccessControlPolicyMetadata{}
...
func (o *AccessControlPolicyMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *AccessControlPolicyMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *AccessControlPolicyMetadata) SetName(v string) {
	o.Name = &v
}

func (o AccessControlPolicyMetadata) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AccessControlPolicyMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessControlPolicyMetadata := _AccessControlPolicyMetadata{}

	err = json.Unmarshal(data, &varAccessControlPolicyMetadata)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyMetadata(varAccessControlPolicyMetadata)
...
type NullableAccessControlPolicyMetadata struct {
	value *AccessControlPolicyMetadata
	isSet bool
}

func (v NullableAccessControlPolicyMetadata) Get() *AccessControlPolicyMetadata {
	return v.value
}

func (v *NullableAccessControlPolicyMetadata) Set(val *AccessControlPolicyMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyMetadata(val *AccessControlPolicyMetadata) *NullableAccessControlPolicyMetadata {
	return &NullableAccessControlPolicyMetadata{value: val, isSet: true}
}

func (v NullableAccessControlPolicyMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
