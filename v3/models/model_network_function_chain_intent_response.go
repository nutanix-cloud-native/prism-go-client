...
// checks if the NetworkFunctionChainIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionChainIntentResponse{}
...
type _NetworkFunctionChainIntentResponse NetworkFunctionChainIntentResponse
...
func NewNetworkFunctionChainIntentResponse(apiVersion string, metadata NetworkFunctionChainMetadata) *NetworkFunctionChainIntentResponse {
	this := NetworkFunctionChainIntentResponse{}
...
func (o NetworkFunctionChainIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionChainIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionChainIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkFunctionChainIntentResponse := _NetworkFunctionChainIntentResponse{}

	err = json.Unmarshal(data, &varNetworkFunctionChainIntentResponse)

	if err != nil {
		return err
	}

	*o = NetworkFunctionChainIntentResponse(varNetworkFunctionChainIntentResponse)
...
type NullableNetworkFunctionChainIntentResponse struct {
	value *NetworkFunctionChainIntentResponse
	isSet bool
}

func (v NullableNetworkFunctionChainIntentResponse) Get() *NetworkFunctionChainIntentResponse {
	return v.value
}

func (v *NullableNetworkFunctionChainIntentResponse) Set(val *NetworkFunctionChainIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionChainIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionChainIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionChainIntentResponse(val *NetworkFunctionChainIntentResponse) *NullableNetworkFunctionChainIntentResponse {
	return &NullableNetworkFunctionChainIntentResponse{value: val, isSet: true}
}

func (v NullableNetworkFunctionChainIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionChainIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
