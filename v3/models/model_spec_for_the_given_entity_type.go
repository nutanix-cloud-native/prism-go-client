...
// checks if the SpecForTheGivenEntityType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpecForTheGivenEntityType{}

// SpecForTheGivenEntityType Spec based on the type
type SpecForTheGivenEntityType struct {
	VmReferenceWithCustomization *VmReferenceWithCustomization `json:"vm_reference_with_customization,omitempty"`
	VmReference *VmReference `json:"vm_reference,omitempty"`
	ImageReference *ImageReference `json:"image_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SpecForTheGivenEntityType SpecForTheGivenEntityType
...
func NewSpecForTheGivenEntityType() *SpecForTheGivenEntityType {
	this := SpecForTheGivenEntityType{}
	return &this
}
...
// GetVmReferenceWithCustomization returns the VmReferenceWithCustomization field value if set, zero value otherwise.
func (o *SpecForTheGivenEntityType) GetVmReferenceWithCustomization() VmReferenceWithCustomization {
	if o == nil || IsNil(o.VmReferenceWithCustomization) {
		var ret VmReferenceWithCustomization
		return ret
	}
	return *o.VmReferenceWithCustomization
}

// GetVmReferenceWithCustomizationOk returns a tuple with the VmReferenceWithCustomization field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SpecForTheGivenEntityType) GetVmReferenceWithCustomizationOk() (*VmReferenceWithCustomization, bool) {
	if o == nil || IsNil(o.VmReferenceWithCustomization) {
		return nil, false
	}
	return o.VmReferenceWithCustomization, true
}
...
// SetVmReferenceWithCustomization gets a reference to the given VmReferenceWithCustomization and assigns it to the VmReferenceWithCustomization field.
func (o *SpecForTheGivenEntityType) SetVmReferenceWithCustomization(v VmReferenceWithCustomization) {
	o.VmReferenceWithCustomization = &v
}
...
// GetImageReference returns the ImageReference field value if set, zero value otherwise.
func (o *SpecForTheGivenEntityType) GetImageReference() ImageReference {
	if o == nil || IsNil(o.ImageReference) {
...
// SetImageReference gets a reference to the given ImageReference and assigns it to the ImageReference field.
func (o *SpecForTheGivenEntityType) SetImageReference(v ImageReference) {
	o.ImageReference = &v
}

func (o SpecForTheGivenEntityType) MarshalJSON() ([]byte, error) {
...
func (o SpecForTheGivenEntityType) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VmReferenceWithCustomization) {
		toSerialize["vm_reference_with_customization"] = o.VmReferenceWithCustomization
	}
	if !IsNil(o.VmReference) {
		toSerialize["vm_reference"] = o.VmReference
	}
	if !IsNil(o.ImageReference) {
		toSerialize["image_reference"] = o.ImageReference
	}
...
func (o *SpecForTheGivenEntityType) UnmarshalJSON(data []byte) (err error) {
	varSpecForTheGivenEntityType := _SpecForTheGivenEntityType{}

	err = json.Unmarshal(data, &varSpecForTheGivenEntityType)

	if err != nil {
		return err
	}

	*o = SpecForTheGivenEntityType(varSpecForTheGivenEntityType)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vm_reference_with_customization")
		delete(additionalProperties, "vm_reference")
		delete(additionalProperties, "image_reference")
...
type NullableSpecForTheGivenEntityType struct {
	value *SpecForTheGivenEntityType
	isSet bool
}

func (v NullableSpecForTheGivenEntityType) Get() *SpecForTheGivenEntityType {
	return v.value
}

func (v *NullableSpecForTheGivenEntityType) Set(val *SpecForTheGivenEntityType) {
	v.value = val
	v.isSet = true
}

func (v NullableSpecForTheGivenEntityType) IsSet() bool {
	return v.isSet
}

func (v *NullableSpecForTheGivenEntityType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpecForTheGivenEntityType(val *SpecForTheGivenEntityType) *NullableSpecForTheGivenEntityType {
	return &NullableSpecForTheGivenEntityType{value: val, isSet: true}
}

func (v NullableSpecForTheGivenEntityType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpecForTheGivenEntityType) UnmarshalJSON(src []byte) error {
	v.isSet = true
