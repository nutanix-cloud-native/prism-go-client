...
// checks if the AlertNotificationInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertNotificationInput{}

// AlertNotificationInput The information required for creating an alert.
type AlertNotificationInput struct {
	// The notification definition for this type of alerts.
	NotificationType string `json:"notification_type"`
	SourceEntity *Reference `json:"source_entity,omitempty"`
	// Alert severity
...
type _AlertNotificationInput AlertNotificationInput
...
// SetSourceEntity gets a reference to the given Reference and assigns it to the SourceEntity field.
...
func (o AlertNotificationInput) MarshalJSON() ([]byte, error) {
...
func (o AlertNotificationInput) ToMap() (map[string]interface{}, error) {
...
func (o *AlertNotificationInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertNotificationInput := _AlertNotificationInput{}

	err = json.Unmarshal(data, &varAlertNotificationInput)

	if err != nil {
		return err
	}

	*o = AlertNotificationInput(varAlertNotificationInput)
...
type NullableAlertNotificationInput struct {
	value *AlertNotificationInput
	isSet bool
}

func (v NullableAlertNotificationInput) Get() *AlertNotificationInput {
	return v.value
}

func (v *NullableAlertNotificationInput) Set(val *AlertNotificationInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertNotificationInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertNotificationInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertNotificationInput(val *AlertNotificationInput) *NullableAlertNotificationInput {
	return &NullableAlertNotificationInput{value: val, isSet: true}
}

func (v NullableAlertNotificationInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertNotificationInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
