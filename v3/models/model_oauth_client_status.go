...
// checks if the OauthClientStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthClientStatus{}

// OauthClientStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _OauthClientStatus OauthClientStatus
...
func (o OauthClientStatus) MarshalJSON() ([]byte, error) {
...
func (o OauthClientStatus) ToMap() (map[string]interface{}, error) {
...
func (o *OauthClientStatus) UnmarshalJSON(data []byte) (err error) {
	varOauthClientStatus := _OauthClientStatus{}

	err = json.Unmarshal(data, &varOauthClientStatus)

	if err != nil {
		return err
	}

	*o = OauthClientStatus(varOauthClientStatus)
