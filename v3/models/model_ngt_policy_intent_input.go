...
// checks if the NgtPolicyIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicyIntentInput{}

// NgtPolicyIntentInput An intentful representation of a ngt_policy
type NgtPolicyIntentInput struct {
	Spec NgtPolicy `json:"spec"`
...
type _NgtPolicyIntentInput NgtPolicyIntentInput
...
func (o NgtPolicyIntentInput) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicyIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicyIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtPolicyIntentInput := _NgtPolicyIntentInput{}

	err = json.Unmarshal(data, &varNgtPolicyIntentInput)

	if err != nil {
		return err
	}

	*o = NgtPolicyIntentInput(varNgtPolicyIntentInput)
...
type NullableNgtPolicyIntentInput struct {
	value *NgtPolicyIntentInput
	isSet bool
}

func (v NullableNgtPolicyIntentInput) Get() *NgtPolicyIntentInput {
	return v.value
}

func (v *NullableNgtPolicyIntentInput) Set(val *NgtPolicyIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicyIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicyIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicyIntentInput(val *NgtPolicyIntentInput) *NullableNgtPolicyIntentInput {
	return &NullableNgtPolicyIntentInput{value: val, isSet: true}
}

func (v NullableNgtPolicyIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicyIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
