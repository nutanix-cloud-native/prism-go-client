...
// checks if the NetworkAddressStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkAddressStatus{}

// NetworkAddressStatus Address (source/destination) of an IP packet. > This could be either an ip prefix or a special category like \"INTERNET\".
...
type _NetworkAddressStatus NetworkAddressStatus
...
func (o NetworkAddressStatus) MarshalJSON() ([]byte, error) {
...
func (o NetworkAddressStatus) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkAddressStatus) UnmarshalJSON(data []byte) (err error) {
	varNetworkAddressStatus := _NetworkAddressStatus{}

	err = json.Unmarshal(data, &varNetworkAddressStatus)

	if err != nil {
		return err
	}

	*o = NetworkAddressStatus(varNetworkAddressStatus)
...
type NullableNetworkAddressStatus struct {
	value *NetworkAddressStatus
	isSet bool
}

func (v NullableNetworkAddressStatus) Get() *NetworkAddressStatus {
	return v.value
}

func (v *NullableNetworkAddressStatus) Set(val *NetworkAddressStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkAddressStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkAddressStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkAddressStatus(val *NetworkAddressStatus) *NullableNetworkAddressStatus {
	return &NullableNetworkAddressStatus{value: val, isSet: true}
}

func (v NullableNetworkAddressStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkAddressStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
