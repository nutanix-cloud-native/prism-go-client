...
// checks if the HostMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostMetadata{}

// HostMetadata The host kind metadata
type HostMetadata struct {
	...
	// Categories for the host. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the host. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _HostMetadata HostMetadata
...
func (o HostMetadata) MarshalJSON() ([]byte, error) {
...
func (o HostMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *HostMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varHostMetadata := _HostMetadata{}

	err = json.Unmarshal(data, &varHostMetadata)

	if err != nil {
		return err
	}

	*o = HostMetadata(varHostMetadata)
...
type NullableHostMetadata struct {
	value *HostMetadata
	isSet bool
}

func (v NullableHostMetadata) Get() *HostMetadata {
	return v.value
}

func (v *NullableHostMetadata) Set(val *HostMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableHostMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableHostMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostMetadata(val *HostMetadata) *NullableHostMetadata {
	return &NullableHostMetadata{value: val, isSet: true}
}

func (v NullableHostMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
