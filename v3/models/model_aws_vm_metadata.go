...
// checks if the AwsVmMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVmMetadata{}

// AwsVmMetadata The aws_vm kind metadata
type AwsVmMetadata struct {
	...
	// Categories for the aws_vm. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the aws_vm. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _AwsVmMetadata AwsVmMetadata
...
func (o *AwsVmMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *AwsVmMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *AwsVmMetadata) SetName(v string) {
	o.Name = &v
}

func (o AwsVmMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsVmMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVmMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVmMetadata := _AwsVmMetadata{}

	err = json.Unmarshal(data, &varAwsVmMetadata)

	if err != nil {
		return err
	}

	*o = AwsVmMetadata(varAwsVmMetadata)
...
type NullableAwsVmMetadata struct {
	value *AwsVmMetadata
	isSet bool
}

func (v NullableAwsVmMetadata) Get() *AwsVmMetadata {
	return v.value
}

func (v *NullableAwsVmMetadata) Set(val *AwsVmMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVmMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVmMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVmMetadata(val *AwsVmMetadata) *NullableAwsVmMetadata {
	return &NullableAwsVmMetadata{value: val, isSet: true}
}

func (v NullableAwsVmMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVmMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
