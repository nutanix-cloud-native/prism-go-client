...
// checks if the BlackoutDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackoutDefStatus{}

// BlackoutDefStatus Blackout entity status
type BlackoutDefStatus struct {
	// The state of the entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	Resources BlackoutResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _BlackoutDefStatus BlackoutDefStatus
...
func (o BlackoutDefStatus) MarshalJSON() ([]byte, error) {
...
func (o BlackoutDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *BlackoutDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varBlackoutDefStatus := _BlackoutDefStatus{}

	err = json.Unmarshal(data, &varBlackoutDefStatus)

	if err != nil {
		return err
	}

	*o = BlackoutDefStatus(varBlackoutDefStatus)
...
type NullableBlackoutDefStatus struct {
	value *BlackoutDefStatus
	isSet bool
}

func (v NullableBlackoutDefStatus) Get() *BlackoutDefStatus {
	return v.value
}

func (v *NullableBlackoutDefStatus) Set(val *BlackoutDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableBlackoutDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableBlackoutDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlackoutDefStatus(val *BlackoutDefStatus) *NullableBlackoutDefStatus {
	return &NullableBlackoutDefStatus{value: val, isSet: true}
}

func (v NullableBlackoutDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlackoutDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
