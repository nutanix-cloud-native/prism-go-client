...
// checks if the MarketplaceIcon type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceIcon{}

// MarketplaceIcon Description of icon used by app
type MarketplaceIcon struct {
	IconReference FileItemReference `json:"icon_reference"`
	IconType string `json:"icon_type"`
	AdditionalProperties map[string]interface{}
}

type _MarketplaceIcon MarketplaceIcon
...
// GetIconReference returns the IconReference field value
func (o *MarketplaceIcon) GetIconReference() FileItemReference {
	if o == nil {
		var ret FileItemReference
		return ret
	}

	return o.IconReference
}

// GetIconReferenceOk returns a tuple with the IconReference field value
// and a boolean to check if the value has been set.
func (o *MarketplaceIcon) GetIconReferenceOk() (*FileItemReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IconReference, true
}

// SetIconReference sets field value
...
func (o MarketplaceIcon) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceIcon) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["icon_reference"] = o.IconReference
	toSerialize["icon_type"] = o.IconType
...
func (o *MarketplaceIcon) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceIcon := _MarketplaceIcon{}

	err = json.Unmarshal(data, &varMarketplaceIcon)

	if err != nil {
		return err
	}

	*o = MarketplaceIcon(varMarketplaceIcon)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "icon_reference")
		delete(additionalProperties, "icon_type")
...
type NullableMarketplaceIcon struct {
	value *MarketplaceIcon
	isSet bool
}

func (v NullableMarketplaceIcon) Get() *MarketplaceIcon {
	return v.value
}

func (v *NullableMarketplaceIcon) Set(val *MarketplaceIcon) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceIcon) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceIcon) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceIcon(val *MarketplaceIcon) *NullableMarketplaceIcon {
	return &NullableMarketplaceIcon{value: val, isSet: true}
}

func (v NullableMarketplaceIcon) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceIcon) UnmarshalJSON(src []byte) error {
	v.isSet = true
