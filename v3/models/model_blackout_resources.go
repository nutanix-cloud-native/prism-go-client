...
// checks if the BlackoutResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackoutResources{}

// BlackoutResources Blackout object definition
type BlackoutResources struct {
	// The list of 1) entity type, or 2) entity type + uuid_list, will define the targeted entities.  Any entities contained inside the targeted entities are affected by this blackout schedule. If it is case 1), where the uuid_list is empty, then, it means the blackout applies to all the entities of this entity_type.  For example, blackout for all clusters, the entity_type = \"cluster\", the uuid_list will be empty.  If the uuid_list is not empty, then, the blackout is applied to only these entities in the uuid_list. 
	ScopeEntityList []BlackoutResourcesScopeEntityListInner `json:"scope_entity_list"`
	// A list of time schedules for the blackout.  For example, if the blackout is for every Monday and Friday, 10:00 - 11:00 am, 3:00-5:00 pm, then, there will be 2 items:   schedule1: day_of_week = Monday,Friday, Time = 10:00 - 11:00 am   schedule2: day_of_week = Monday,Friday, 3:00 - 5:00 pm 
	ScheduleList []Schedule `json:"schedule_list"`
	// A list of features that this blackout is applied to.
	FeatureList []string `json:"feature_list"`
	AdditionalProperties map[string]interface{}
}

type _BlackoutResources BlackoutResources
...
func NewBlackoutResources(scopeEntityList []BlackoutResourcesScopeEntityListInner, scheduleList []Schedule, featureList []string) *BlackoutResources {
	this := BlackoutResources{}
	this.ScopeEntityList = scopeEntityList
...
// GetScopeEntityList returns the ScopeEntityList field value
func (o *BlackoutResources) GetScopeEntityList() []BlackoutResourcesScopeEntityListInner {
	if o == nil {
		var ret []BlackoutResourcesScopeEntityListInner
		return ret
	}

	return o.ScopeEntityList
}

// GetScopeEntityListOk returns a tuple with the ScopeEntityList field value
// and a boolean to check if the value has been set.
func (o *BlackoutResources) GetScopeEntityListOk() ([]BlackoutResourcesScopeEntityListInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.ScopeEntityList, true
}

// SetScopeEntityList sets field value
...
// GetFeatureList returns the FeatureList field value
...
// GetFeatureListOk returns a tuple with the FeatureList field value
// and a boolean to check if the value has been set.
...
// SetFeatureList sets field value
func (o *BlackoutResources) SetFeatureList(v []string) {
	o.FeatureList = v
}

func (o BlackoutResources) MarshalJSON() ([]byte, error) {
...
func (o BlackoutResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["scope_entity_list"] = o.ScopeEntityList
	toSerialize["schedule_list"] = o.ScheduleList
...
func (o *BlackoutResources) UnmarshalJSON(data []byte) (err error) {
	...
	varBlackoutResources := _BlackoutResources{}

	err = json.Unmarshal(data, &varBlackoutResources)

	if err != nil {
		return err
	}

	*o = BlackoutResources(varBlackoutResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "scope_entity_list")
		delete(additionalProperties, "schedule_list")
		delete(additionalProperties, "feature_list")
...
type NullableBlackoutResources struct {
	value *BlackoutResources
	isSet bool
}

func (v NullableBlackoutResources) Get() *BlackoutResources {
	return v.value
}

func (v *NullableBlackoutResources) Set(val *BlackoutResources) {
	v.value = val
	v.isSet = true
}

func (v NullableBlackoutResources) IsSet() bool {
	return v.isSet
}

func (v *NullableBlackoutResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlackoutResources(val *BlackoutResources) *NullableBlackoutResources {
	return &NullableBlackoutResources{value: val, isSet: true}
}

func (v NullableBlackoutResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlackoutResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
