...
// checks if the VmGpuStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmGpuStatus{}

// VmGpuStatus The status of a REST API call. Only used when there is a failure to report. 
...
func (o VmGpuStatus) MarshalJSON() ([]byte, error) {
...
func (o VmGpuStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VmGpuStatus) UnmarshalJSON(data []byte) (err error) {
	varVmGpuStatus := _VmGpuStatus{}

	err = json.Unmarshal(data, &varVmGpuStatus)

	if err != nil {
		return err
	}

	*o = VmGpuStatus(varVmGpuStatus)
...
type NullableVmGpuStatus struct {
	value *VmGpuStatus
	isSet bool
}

func (v NullableVmGpuStatus) Get() *VmGpuStatus {
	return v.value
}

func (v *NullableVmGpuStatus) Set(val *VmGpuStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVmGpuStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVmGpuStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmGpuStatus(val *VmGpuStatus) *NullableVmGpuStatus {
	return &NullableVmGpuStatus{value: val, isSet: true}
}

func (v NullableVmGpuStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmGpuStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
