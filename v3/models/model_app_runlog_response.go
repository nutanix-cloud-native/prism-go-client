...
// checks if the AppRunlogResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunlogResponse{}

// AppRunlogResponse Response containing the current state of the runlog
type AppRunlogResponse struct {
	Status AppRunlogResources `json:"status"`
...
type _AppRunlogResponse AppRunlogResponse
...
func (o AppRunlogResponse) MarshalJSON() ([]byte, error) {
...
func (o AppRunlogResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunlogResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRunlogResponse := _AppRunlogResponse{}

	err = json.Unmarshal(data, &varAppRunlogResponse)

	if err != nil {
		return err
	}

	*o = AppRunlogResponse(varAppRunlogResponse)
...
type NullableAppRunlogResponse struct {
	value *AppRunlogResponse
	isSet bool
}

func (v NullableAppRunlogResponse) Get() *AppRunlogResponse {
	return v.value
}

func (v *NullableAppRunlogResponse) Set(val *AppRunlogResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunlogResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunlogResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunlogResponse(val *AppRunlogResponse) *NullableAppRunlogResponse {
	return &NullableAppRunlogResponse{value: val, isSet: true}
}

func (v NullableAppRunlogResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunlogResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
