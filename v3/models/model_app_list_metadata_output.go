...
// checks if the AppListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppListMetadataOutput{}

// AppListMetadataOutput All api calls that return a list will have this metadata block 
type AppListMetadataOutput struct {
	// The kind name
...
type _AppListMetadataOutput AppListMetadataOutput
...
func (o AppListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AppListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AppListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAppListMetadataOutput := _AppListMetadataOutput{}

	err = json.Unmarshal(data, &varAppListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AppListMetadataOutput(varAppListMetadataOutput)
...
type NullableAppListMetadataOutput struct {
	value *AppListMetadataOutput
	isSet bool
}

func (v NullableAppListMetadataOutput) Get() *AppListMetadataOutput {
	return v.value
}

func (v *NullableAppListMetadataOutput) Set(val *AppListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppListMetadataOutput(val *AppListMetadataOutput) *NullableAppListMetadataOutput {
	return &NullableAppListMetadataOutput{value: val, isSet: true}
}

func (v NullableAppListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
