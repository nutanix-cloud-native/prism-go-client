...
// checks if the SubnetReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubnetReference{}

// SubnetReference The reference to a subnet
...
type _SubnetReference SubnetReference
...
func (o SubnetReference) MarshalJSON() ([]byte, error) {
...
func (o SubnetReference) ToMap() (map[string]interface{}, error) {
...
func (o *SubnetReference) UnmarshalJSON(data []byte) (err error) {
	...
	varSubnetReference := _SubnetReference{}

	err = json.Unmarshal(data, &varSubnetReference)

	if err != nil {
		return err
	}

	*o = SubnetReference(varSubnetReference)
...
type NullableSubnetReference struct {
	value *SubnetReference
	isSet bool
}

func (v NullableSubnetReference) Get() *SubnetReference {
	return v.value
}

func (v *NullableSubnetReference) Set(val *SubnetReference) {
	v.value = val
	v.isSet = true
}

func (v NullableSubnetReference) IsSet() bool {
	return v.isSet
}

func (v *NullableSubnetReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubnetReference(val *SubnetReference) *NullableSubnetReference {
	return &NullableSubnetReference{value: val, isSet: true}
}

func (v NullableSubnetReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubnetReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
