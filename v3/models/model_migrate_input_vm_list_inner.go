...
// checks if the MigrateInputVmListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MigrateInputVmListInner{}

// MigrateInputVmListInner Properties of VM which are overridable.
type MigrateInputVmListInner struct {
	MhVmSpec *MhVmSpecOverride `json:"mh_vm_spec,omitempty"`
	VmSpec *VmSpecOverride `json:"vm_spec,omitempty"`
	Metadata VmMetadataOverride `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _MigrateInputVmListInner MigrateInputVmListInner
...
func (o MigrateInputVmListInner) MarshalJSON() ([]byte, error) {
...
func (o MigrateInputVmListInner) ToMap() (map[string]interface{}, error) {
...
func (o *MigrateInputVmListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varMigrateInputVmListInner := _MigrateInputVmListInner{}

	err = json.Unmarshal(data, &varMigrateInputVmListInner)

	if err != nil {
		return err
	}

	*o = MigrateInputVmListInner(varMigrateInputVmListInner)
...
type NullableMigrateInputVmListInner struct {
	value *MigrateInputVmListInner
	isSet bool
}

func (v NullableMigrateInputVmListInner) Get() *MigrateInputVmListInner {
	return v.value
}

func (v *NullableMigrateInputVmListInner) Set(val *MigrateInputVmListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableMigrateInputVmListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableMigrateInputVmListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMigrateInputVmListInner(val *MigrateInputVmListInner) *NullableMigrateInputVmListInner {
	return &NullableMigrateInputVmListInner{value: val, isSet: true}
}

func (v NullableMigrateInputVmListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMigrateInputVmListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
