...
// checks if the DirectoryServiceSearchMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceSearchMetadata{}
...
type DirectoryServiceSearchMetadata struct {
	...
	SearchedAttributeList []string `json:"searched_attribute_list,omitempty"`
	// The attributes the search operation returns. If not available, a list of default attributes is returned. 
	ReturnedAttributeList []string `json:"returned_attribute_list,omitempty"`
	// The attribute that tells if the query is a wildcard match or exact match query. 
	IsWildcardSearch *bool `json:"is_wildcard_search,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DirectoryServiceSearchMetadata DirectoryServiceSearchMetadata
...
func NewDirectoryServiceSearchMetadata(query string) *DirectoryServiceSearchMetadata {
	this := DirectoryServiceSearchMetadata{}
	this.Query = query
	var isWildcardSearch bool = true
...
// GetSearchedAttributeList returns the SearchedAttributeList field value if set, zero value otherwise.
func (o *DirectoryServiceSearchMetadata) GetSearchedAttributeList() []string {
	if o == nil || IsNil(o.SearchedAttributeList) {
		var ret []string
		return ret
	}
	return o.SearchedAttributeList
}

// GetSearchedAttributeListOk returns a tuple with the SearchedAttributeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectoryServiceSearchMetadata) GetSearchedAttributeListOk() ([]string, bool) {
	if o == nil || IsNil(o.SearchedAttributeList) {
		return nil, false
	}
	return o.SearchedAttributeList, true
}
...
// SetSearchedAttributeList gets a reference to the given []string and assigns it to the SearchedAttributeList field.
func (o *DirectoryServiceSearchMetadata) SetSearchedAttributeList(v []string) {
	o.SearchedAttributeList = v
}

// GetReturnedAttributeList returns the ReturnedAttributeList field value if set, zero value otherwise.
func (o *DirectoryServiceSearchMetadata) GetReturnedAttributeList() []string {
	if o == nil || IsNil(o.ReturnedAttributeList) {
		var ret []string
		return ret
	}
	return o.ReturnedAttributeList
}

// GetReturnedAttributeListOk returns a tuple with the ReturnedAttributeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectoryServiceSearchMetadata) GetReturnedAttributeListOk() ([]string, bool) {
	if o == nil || IsNil(o.ReturnedAttributeList) {
		return nil, false
	}
	return o.ReturnedAttributeList, true
}
...
// SetReturnedAttributeList gets a reference to the given []string and assigns it to the ReturnedAttributeList field.
func (o *DirectoryServiceSearchMetadata) SetReturnedAttributeList(v []string) {
	o.ReturnedAttributeList = v
}

// GetIsWildcardSearch returns the IsWildcardSearch field value if set, zero value otherwise.
func (o *DirectoryServiceSearchMetadata) GetIsWildcardSearch() bool {
	if o == nil || IsNil(o.IsWildcardSearch) {
		var ret bool
		return ret
	}
	return *o.IsWildcardSearch
}

// GetIsWildcardSearchOk returns a tuple with the IsWildcardSearch field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectoryServiceSearchMetadata) GetIsWildcardSearchOk() (*bool, bool) {
	if o == nil || IsNil(o.IsWildcardSearch) {
		return nil, false
	}
	return o.IsWildcardSearch, true
}
...
// SetIsWildcardSearch gets a reference to the given bool and assigns it to the IsWildcardSearch field.
func (o *DirectoryServiceSearchMetadata) SetIsWildcardSearch(v bool) {
	o.IsWildcardSearch = &v
}

func (o DirectoryServiceSearchMetadata) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceSearchMetadata) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["query"] = o.Query
	if !IsNil(o.SearchedAttributeList) {
		toSerialize["searched_attribute_list"] = o.SearchedAttributeList
	}
	if !IsNil(o.ReturnedAttributeList) {
		toSerialize["returned_attribute_list"] = o.ReturnedAttributeList
	}
	if !IsNil(o.IsWildcardSearch) {
		toSerialize["is_wildcard_search"] = o.IsWildcardSearch
	}
...
func (o *DirectoryServiceSearchMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectoryServiceSearchMetadata := _DirectoryServiceSearchMetadata{}

	err = json.Unmarshal(data, &varDirectoryServiceSearchMetadata)

	if err != nil {
		return err
	}

	*o = DirectoryServiceSearchMetadata(varDirectoryServiceSearchMetadata)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "query")
		delete(additionalProperties, "searched_attribute_list")
		delete(additionalProperties, "returned_attribute_list")
		delete(additionalProperties, "is_wildcard_search")
...
type NullableDirectoryServiceSearchMetadata struct {
	value *DirectoryServiceSearchMetadata
	isSet bool
}

func (v NullableDirectoryServiceSearchMetadata) Get() *DirectoryServiceSearchMetadata {
	return v.value
}

func (v *NullableDirectoryServiceSearchMetadata) Set(val *DirectoryServiceSearchMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceSearchMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceSearchMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceSearchMetadata(val *DirectoryServiceSearchMetadata) *NullableDirectoryServiceSearchMetadata {
	return &NullableDirectoryServiceSearchMetadata{value: val, isSet: true}
}

func (v NullableDirectoryServiceSearchMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceSearchMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
