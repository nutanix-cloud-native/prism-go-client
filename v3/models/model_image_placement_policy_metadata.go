...
// checks if the ImagePlacementPolicyMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyMetadata{}

// ImagePlacementPolicyMetadata The image_placement_policy kind metadata
type ImagePlacementPolicyMetadata struct {
	// UTC date and time in RFC-3339 format when image_placement_policy was last updated 
	...
	// UTC date and time in RFC-3339 format when image_placement_policy was created 
	...
	// Categories for the image_placement_policy. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the image_placement_policy. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// image_placement_policy name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ImagePlacementPolicyMetadata ImagePlacementPolicyMetadata
...
func NewImagePlacementPolicyMetadata(kind string) *ImagePlacementPolicyMetadata {
	this := ImagePlacementPolicyMetadata{}
...
func (o *ImagePlacementPolicyMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *ImagePlacementPolicyMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *ImagePlacementPolicyMetadata) SetName(v string) {
	o.Name = &v
}

func (o ImagePlacementPolicyMetadata) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicyMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varImagePlacementPolicyMetadata := _ImagePlacementPolicyMetadata{}

	err = json.Unmarshal(data, &varImagePlacementPolicyMetadata)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyMetadata(varImagePlacementPolicyMetadata)
...
type NullableImagePlacementPolicyMetadata struct {
	value *ImagePlacementPolicyMetadata
	isSet bool
}

func (v NullableImagePlacementPolicyMetadata) Get() *ImagePlacementPolicyMetadata {
	return v.value
}

func (v *NullableImagePlacementPolicyMetadata) Set(val *ImagePlacementPolicyMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyMetadata(val *ImagePlacementPolicyMetadata) *NullableImagePlacementPolicyMetadata {
	return &NullableImagePlacementPolicyMetadata{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
