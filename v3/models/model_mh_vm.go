...
// checks if the MhVm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVm{}

// MhVm An intentful representation of a mh_vm spec
type MhVm struct {
	ClusterReference *ClusterReference `json:"cluster_reference,omitempty"`
	Resources MhVmResources `json:"resources"`
...
func (o MhVm) MarshalJSON() ([]byte, error) {
...
func (o MhVm) ToMap() (map[string]interface{}, error) {
...
func (o *MhVm) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varMhVm)
...
type NullableMhVm struct {
	value *MhVm
	isSet bool
}

func (v NullableMhVm) Get() *MhVm {
	return v.value
}

func (v *NullableMhVm) Set(val *MhVm) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVm) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVm(val *MhVm) *NullableMhVm {
	return &NullableMhVm{value: val, isSet: true}
}

func (v NullableMhVm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVm) UnmarshalJSON(src []byte) error {
	v.isSet = true
