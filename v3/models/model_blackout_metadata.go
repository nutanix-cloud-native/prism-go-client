...
// BlackoutMetadata The blackout kind metadata
type BlackoutMetadata struct {
	...
	SpecVersion *int32 `json:"spec_version,omitempty"`
	// Hash of the spec. This will be returned from server. 
	SpecHash *string `json:"spec_hash,omitempty"`
	// Categories for the blackout. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the blackout. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _BlackoutMetadata BlackoutMetadata

// NewBlackoutMetadata instantiates a new BlackoutMetadata object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBlackoutMetadata(kind string) *BlackoutMetadata {
	this := BlackoutMetadata{}
	var useCategoriesMapping bool = false
	this.UseCategoriesMapping = &useCategoriesMapping
	this.Kind = kind
	return &this
}
...
func (o *BlackoutMetadata) GetLastUpdateTime() time.Time {
...
func (o *BlackoutMetadata) GetLastUpdateTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LastUpdateTime) {
		return nil, false
	}
...
func (o *BlackoutMetadata) HasLastUpdateTime() bool {
	if o != nil && !IsNil(o.LastUpdateTime) {
		return true
	}
...
func (o *BlackoutMetadata) SetLastUpdateTime(v time.Time) {
	o.LastUpdateTime = &v
}

// GetUseCategoriesMapping returns the UseCategoriesMapping field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetUseCategoriesMapping() bool {
	if o == nil || IsNil(o.UseCategoriesMapping) {
		var ret bool
		return ret
	}
	return *o.UseCategoriesMapping
}

// GetUseCategoriesMappingOk returns a tuple with the UseCategoriesMapping field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetUseCategoriesMappingOk() (*bool, bool) {
	if o == nil || IsNil(o.UseCategoriesMapping) {
		return nil, false
	}
	return o.UseCategoriesMapping, true
}

// HasUseCategoriesMapping returns a boolean if a field has been set.
func (o *BlackoutMetadata) HasUseCategoriesMapping() bool {
	if o != nil && !IsNil(o.UseCategoriesMapping) {
		return true
	}
...
// SetUseCategoriesMapping gets a reference to the given bool and assigns it to the UseCategoriesMapping field.
func (o *BlackoutMetadata) SetUseCategoriesMapping(v bool) {
	o.UseCategoriesMapping = &v
}

// GetKind returns the Kind field value
func (o *BlackoutMetadata) GetKind() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetKindOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Kind, true
...
func (o *BlackoutMetadata) SetKind(v string) {
	o.Kind = v
}

// GetUUID returns the UUID field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetUUID() string {
...
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetUUIDOk() (*string, bool) {
	if o == nil || IsNil(o.UUID) {
		return nil, false
	}
	return o.UUID, true
...
func (o *BlackoutMetadata) HasUUID() bool {
	if o != nil && !IsNil(o.UUID) {
		return true
	}
...
func (o *BlackoutMetadata) SetUUID(v string) {
	o.UUID = &v
}

// GetProjectReference returns the ProjectReference field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetProjectReference() ProjectReference {
	if o == nil || IsNil(o.ProjectReference) {
		var ret ProjectReference
		return ret
	}
	return *o.ProjectReference
}

// GetProjectReferenceOk returns a tuple with the ProjectReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetProjectReferenceOk() (*ProjectReference, bool) {
	if o == nil || IsNil(o.ProjectReference) {
		return nil, false
	}
	return o.ProjectReference, true
}

// HasProjectReference returns a boolean if a field has been set.
func (o *BlackoutMetadata) HasProjectReference() bool {
	if o != nil && !IsNil(o.ProjectReference) {
		return true
	}
...
// SetProjectReference gets a reference to the given ProjectReference and assigns it to the ProjectReference field.
func (o *BlackoutMetadata) SetProjectReference(v ProjectReference) {
	o.ProjectReference = &v
}

// GetCreationTime returns the CreationTime field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetCreationTime() time.Time {
...
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetCreationTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreationTime) {
		return nil, false
	}
...
func (o *BlackoutMetadata) HasCreationTime() bool {
	if o != nil && !IsNil(o.CreationTime) {
		return true
	}
...
func (o *BlackoutMetadata) SetCreationTime(v time.Time) {
	o.CreationTime = &v
}

// GetSpecVersion returns the SpecVersion field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetSpecVersion() int32 {
...
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetSpecVersionOk() (*int32, bool) {
	if o == nil || IsNil(o.SpecVersion) {
		return nil, false
	}
...
func (o *BlackoutMetadata) HasSpecVersion() bool {
	if o != nil && !IsNil(o.SpecVersion) {
		return true
	}
...
// SetSpecVersion gets a reference to the given int32 and assigns it to the SpecVersion field.
func (o *BlackoutMetadata) SetSpecVersion(v int32) {
	o.SpecVersion = &v
}

// GetSpecHash returns the SpecHash field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetSpecHash() string {
	if o == nil || IsNil(o.SpecHash) {
		var ret string
		return ret
	}
	return *o.SpecHash
...
// GetSpecHashOk returns a tuple with the SpecHash field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetSpecHashOk() (*string, bool) {
	if o == nil || IsNil(o.SpecHash) {
		return nil, false
	}
	return o.SpecHash, true
}

// HasSpecHash returns a boolean if a field has been set.
func (o *BlackoutMetadata) HasSpecHash() bool {
	if o != nil && !IsNil(o.SpecHash) {
		return true
	}
...
// SetSpecHash gets a reference to the given string and assigns it to the SpecHash field.
func (o *BlackoutMetadata) SetSpecHash(v string) {
	o.SpecHash = &v
}

// GetCategoriesMapping returns the CategoriesMapping field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetCategoriesMapping() map[string][]string {
	if o == nil || IsNil(o.CategoriesMapping) {
		var ret map[string][]string
		return ret
	}
	return *o.CategoriesMapping
}

// GetCategoriesMappingOk returns a tuple with the CategoriesMapping field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetCategoriesMappingOk() (*map[string][]string, bool) {
	if o == nil || IsNil(o.CategoriesMapping) {
		return nil, false
	}
	return o.CategoriesMapping, true
}

// HasCategoriesMapping returns a boolean if a field has been set.
func (o *BlackoutMetadata) HasCategoriesMapping() bool {
	if o != nil && !IsNil(o.CategoriesMapping) {
		return true
	}
...
// SetCategoriesMapping gets a reference to the given map[string][]string and assigns it to the CategoriesMapping field.
func (o *BlackoutMetadata) SetCategoriesMapping(v map[string][]string) {
	o.CategoriesMapping = &v
}

// GetShouldForceTranslate returns the ShouldForceTranslate field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetShouldForceTranslate() bool {
	if o == nil || IsNil(o.ShouldForceTranslate) {
		var ret bool
		return ret
	}
	return *o.ShouldForceTranslate
}

// GetShouldForceTranslateOk returns a tuple with the ShouldForceTranslate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetShouldForceTranslateOk() (*bool, bool) {
	if o == nil || IsNil(o.ShouldForceTranslate) {
		return nil, false
	}
	return o.ShouldForceTranslate, true
}

// HasShouldForceTranslate returns a boolean if a field has been set.
func (o *BlackoutMetadata) HasShouldForceTranslate() bool {
	if o != nil && !IsNil(o.ShouldForceTranslate) {
		return true
	}
...
// SetShouldForceTranslate gets a reference to the given bool and assigns it to the ShouldForceTranslate field.
func (o *BlackoutMetadata) SetShouldForceTranslate(v bool) {
	o.ShouldForceTranslate = &v
}

// GetEntityVersion returns the EntityVersion field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetEntityVersion() string {
...
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetEntityVersionOk() (*string, bool) {
	if o == nil || IsNil(o.EntityVersion) {
		return nil, false
	}
...
func (o *BlackoutMetadata) HasEntityVersion() bool {
	if o != nil && !IsNil(o.EntityVersion) {
		return true
	}
...
// SetEntityVersion gets a reference to the given string and assigns it to the EntityVersion field.
func (o *BlackoutMetadata) SetEntityVersion(v string) {
	o.EntityVersion = &v
}

// GetOwnerReference returns the OwnerReference field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetOwnerReference() UserReference {
	if o == nil || IsNil(o.OwnerReference) {
...
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *BlackoutMetadata) HasOwnerReference() bool {
	if o != nil && !IsNil(o.OwnerReference) {
		return true
	}
...
// SetOwnerReference gets a reference to the given UserReference and assigns it to the OwnerReference field.
func (o *BlackoutMetadata) SetOwnerReference(v UserReference) {
	o.OwnerReference = &v
}

// GetCategories returns the Categories field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetCategories() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetCategoriesOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.Categories) {
		return nil, false
	}
...
func (o *BlackoutMetadata) HasCategories() bool {
	if o != nil && !IsNil(o.Categories) {
		return true
	}
...
func (o *BlackoutMetadata) SetCategories(v map[string]string) {
	o.Categories = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *BlackoutMetadata) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *BlackoutMetadata) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *BlackoutMetadata) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BlackoutMetadata) SetName(v string) {
	o.Name = &v
}
...
func (o BlackoutMetadata) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UseCategoriesMapping) {
		toSerialize["use_categories_mapping"] = o.UseCategoriesMapping
	}
	toSerialize["kind"] = o.Kind
	if !IsNil(o.UUID) {
		toSerialize["uuid"] = o.UUID
	}
	if !IsNil(o.ProjectReference) {
		toSerialize["project_reference"] = o.ProjectReference
	}
	...
	if !IsNil(o.SpecHash) {
		toSerialize["spec_hash"] = o.SpecHash
	}
	if !IsNil(o.CategoriesMapping) {
		toSerialize["categories_mapping"] = o.CategoriesMapping
	}
	if !IsNil(o.ShouldForceTranslate) {
		toSerialize["should_force_translate"] = o.ShouldForceTranslate
	}
	if !IsNil(o.EntityVersion) {
		toSerialize["entity_version"] = o.EntityVersion
	}
	if !IsNil(o.OwnerReference) {
		toSerialize["owner_reference"] = o.OwnerReference
	}
...
func (o *BlackoutMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varBlackoutMetadata := _BlackoutMetadata{}

	err = json.Unmarshal(data, &varBlackoutMetadata)

	if err != nil {
		return err
	}

	*o = BlackoutMetadata(varBlackoutMetadata)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "last_update_time")
		delete(additionalProperties, "use_categories_mapping")
		delete(additionalProperties, "kind")
		delete(additionalProperties, "uuid")
		delete(additionalProperties, "project_reference")
		delete(additionalProperties, "creation_time")
		delete(additionalProperties, "spec_version")
		delete(additionalProperties, "spec_hash")
		delete(additionalProperties, "categories_mapping")
		delete(additionalProperties, "should_force_translate")
		delete(additionalProperties, "entity_version")
		delete(additionalProperties, "owner_reference")
