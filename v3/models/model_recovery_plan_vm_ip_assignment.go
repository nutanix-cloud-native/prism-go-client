...
// checks if the RecoveryPlanVmIpAssignment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanVmIpAssignment{}

// RecoveryPlanVmIpAssignment IP configuration to be applied to a VM. 
type RecoveryPlanVmIpAssignment struct {
	// List of IP configurations for a VM. 
	IpConfigList []RecoveryPlanVmIpAssignmentIpConfigListInner `json:"ip_config_list"`
	VmReference VmReference `json:"vm_reference"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanVmIpAssignment RecoveryPlanVmIpAssignment
...
func NewRecoveryPlanVmIpAssignment(ipConfigList []RecoveryPlanVmIpAssignmentIpConfigListInner, vmReference VmReference) *RecoveryPlanVmIpAssignment {
	this := RecoveryPlanVmIpAssignment{}
...
// GetIpConfigList returns the IpConfigList field value
func (o *RecoveryPlanVmIpAssignment) GetIpConfigList() []RecoveryPlanVmIpAssignmentIpConfigListInner {
	if o == nil {
		var ret []RecoveryPlanVmIpAssignmentIpConfigListInner
		return ret
	}

	return o.IpConfigList
}

// GetIpConfigListOk returns a tuple with the IpConfigList field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanVmIpAssignment) GetIpConfigListOk() ([]RecoveryPlanVmIpAssignmentIpConfigListInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.IpConfigList, true
}

// SetIpConfigList sets field value
...
func (o RecoveryPlanVmIpAssignment) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanVmIpAssignment) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["ip_config_list"] = o.IpConfigList
...
func (o *RecoveryPlanVmIpAssignment) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanVmIpAssignment := _RecoveryPlanVmIpAssignment{}

	err = json.Unmarshal(data, &varRecoveryPlanVmIpAssignment)

	if err != nil {
		return err
	}

	*o = RecoveryPlanVmIpAssignment(varRecoveryPlanVmIpAssignment)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "ip_config_list")
...
type NullableRecoveryPlanVmIpAssignment struct {
	value *RecoveryPlanVmIpAssignment
	isSet bool
}

func (v NullableRecoveryPlanVmIpAssignment) Get() *RecoveryPlanVmIpAssignment {
	return v.value
}

func (v *NullableRecoveryPlanVmIpAssignment) Set(val *RecoveryPlanVmIpAssignment) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanVmIpAssignment) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanVmIpAssignment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanVmIpAssignment(val *RecoveryPlanVmIpAssignment) *NullableRecoveryPlanVmIpAssignment {
	return &NullableRecoveryPlanVmIpAssignment{value: val, isSet: true}
}

func (v NullableRecoveryPlanVmIpAssignment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanVmIpAssignment) UnmarshalJSON(src []byte) error {
	v.isSet = true
