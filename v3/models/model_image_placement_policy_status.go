...
// checks if the ImagePlacementPolicyStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyStatus{}

// ImagePlacementPolicyStatus The status of a REST API call. Only used when there is a failure to report. 
type ImagePlacementPolicyStatus struct {
	// The kind name
...
type _ImagePlacementPolicyStatus ImagePlacementPolicyStatus
...
func NewImagePlacementPolicyStatus() *ImagePlacementPolicyStatus {
	this := ImagePlacementPolicyStatus{}
	return &this
}
...
func (o ImagePlacementPolicyStatus) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicyStatus) UnmarshalJSON(data []byte) (err error) {
	varImagePlacementPolicyStatus := _ImagePlacementPolicyStatus{}

	err = json.Unmarshal(data, &varImagePlacementPolicyStatus)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyStatus(varImagePlacementPolicyStatus)
...
type NullableImagePlacementPolicyStatus struct {
	value *ImagePlacementPolicyStatus
	isSet bool
}

func (v NullableImagePlacementPolicyStatus) Get() *ImagePlacementPolicyStatus {
	return v.value
}

func (v *NullableImagePlacementPolicyStatus) Set(val *ImagePlacementPolicyStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyStatus(val *ImagePlacementPolicyStatus) *NullableImagePlacementPolicyStatus {
	return &NullableImagePlacementPolicyStatus{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
