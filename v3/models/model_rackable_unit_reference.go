...
// checks if the RackableUnitReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackableUnitReference{}
...
type _RackableUnitReference RackableUnitReference
...
func (o RackableUnitReference) MarshalJSON() ([]byte, error) {
...
func (o RackableUnitReference) ToMap() (map[string]interface{}, error) {
...
func (o *RackableUnitReference) UnmarshalJSON(data []byte) (err error) {
	...
	varRackableUnitReference := _RackableUnitReference{}

	err = json.Unmarshal(data, &varRackableUnitReference)

	if err != nil {
		return err
	}

	*o = RackableUnitReference(varRackableUnitReference)
...
type NullableRackableUnitReference struct {
	value *RackableUnitReference
	isSet bool
}

func (v NullableRackableUnitReference) Get() *RackableUnitReference {
	return v.value
}

func (v *NullableRackableUnitReference) Set(val *RackableUnitReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRackableUnitReference) IsSet() bool {
	return v.isSet
}

func (v *NullableRackableUnitReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackableUnitReference(val *RackableUnitReference) *NullableRackableUnitReference {
	return &NullableRackableUnitReference{value: val, isSet: true}
}

func (v NullableRackableUnitReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackableUnitReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
