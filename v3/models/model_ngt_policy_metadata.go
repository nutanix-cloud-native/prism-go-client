...
// checks if the NgtPolicyMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicyMetadata{}

// NgtPolicyMetadata The ngt_policy kind metadata
type NgtPolicyMetadata struct {
	...
	// Categories for the ngt_policy. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the ngt_policy. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _NgtPolicyMetadata NgtPolicyMetadata
...
func (o NgtPolicyMetadata) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicyMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicyMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtPolicyMetadata := _NgtPolicyMetadata{}

	err = json.Unmarshal(data, &varNgtPolicyMetadata)

	if err != nil {
		return err
	}

	*o = NgtPolicyMetadata(varNgtPolicyMetadata)
...
type NullableNgtPolicyMetadata struct {
	value *NgtPolicyMetadata
	isSet bool
}

func (v NullableNgtPolicyMetadata) Get() *NgtPolicyMetadata {
	return v.value
}

func (v *NullableNgtPolicyMetadata) Set(val *NgtPolicyMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicyMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicyMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicyMetadata(val *NgtPolicyMetadata) *NullableNgtPolicyMetadata {
	return &NullableNgtPolicyMetadata{value: val, isSet: true}
}

func (v NullableNgtPolicyMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicyMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
