...
// checks if the RemoteSyslogServerListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogServerListMetadataOutput{}

// RemoteSyslogServerListMetadataOutput All api calls that return a list will have this metadata block 
type RemoteSyslogServerListMetadataOutput struct {
	// The kind name
...
type _RemoteSyslogServerListMetadataOutput RemoteSyslogServerListMetadataOutput
...
func NewRemoteSyslogServerListMetadataOutput() *RemoteSyslogServerListMetadataOutput {
	this := RemoteSyslogServerListMetadataOutput{}
	var kind string = "remote_syslog_server"
	this.Kind = &kind
	return &this
}
...
func (o *RemoteSyslogServerListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *RemoteSyslogServerListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o RemoteSyslogServerListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogServerListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogServerListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varRemoteSyslogServerListMetadataOutput := _RemoteSyslogServerListMetadataOutput{}

	err = json.Unmarshal(data, &varRemoteSyslogServerListMetadataOutput)

	if err != nil {
		return err
	}

	*o = RemoteSyslogServerListMetadataOutput(varRemoteSyslogServerListMetadataOutput)
...
type NullableRemoteSyslogServerListMetadataOutput struct {
	value *RemoteSyslogServerListMetadataOutput
	isSet bool
}

func (v NullableRemoteSyslogServerListMetadataOutput) Get() *RemoteSyslogServerListMetadataOutput {
	return v.value
}

func (v *NullableRemoteSyslogServerListMetadataOutput) Set(val *RemoteSyslogServerListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogServerListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogServerListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogServerListMetadataOutput(val *RemoteSyslogServerListMetadataOutput) *NullableRemoteSyslogServerListMetadataOutput {
	return &NullableRemoteSyslogServerListMetadataOutput{value: val, isSet: true}
}

func (v NullableRemoteSyslogServerListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogServerListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
