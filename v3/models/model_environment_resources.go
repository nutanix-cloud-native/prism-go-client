...
// EnvironmentResources Resources for Environment.
...
type _EnvironmentResources EnvironmentResources
...
func (o *EnvironmentResources) UnmarshalJSON(data []byte) (err error) {
	varEnvironmentResources := _EnvironmentResources{}

	err = json.Unmarshal(data, &varEnvironmentResources)

	if err != nil {
		return err
	}

	*o = EnvironmentResources(varEnvironmentResources)
