...
// checks if the RackableUnitMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackableUnitMetadata{}

// RackableUnitMetadata The rackable_unit kind metadata
type RackableUnitMetadata struct {
	...
	// Categories for the rackable_unit. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the rackable_unit. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _RackableUnitMetadata RackableUnitMetadata
...
func (o RackableUnitMetadata) MarshalJSON() ([]byte, error) {
...
func (o RackableUnitMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RackableUnitMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varRackableUnitMetadata := _RackableUnitMetadata{}

	err = json.Unmarshal(data, &varRackableUnitMetadata)

	if err != nil {
		return err
	}

	*o = RackableUnitMetadata(varRackableUnitMetadata)
...
type NullableRackableUnitMetadata struct {
	value *RackableUnitMetadata
	isSet bool
}

func (v NullableRackableUnitMetadata) Get() *RackableUnitMetadata {
	return v.value
}

func (v *NullableRackableUnitMetadata) Set(val *RackableUnitMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRackableUnitMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRackableUnitMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackableUnitMetadata(val *RackableUnitMetadata) *NullableRackableUnitMetadata {
	return &NullableRackableUnitMetadata{value: val, isSet: true}
}

func (v NullableRackableUnitMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackableUnitMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
