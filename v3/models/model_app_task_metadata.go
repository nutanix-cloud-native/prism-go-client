...
// checks if the AppTaskMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskMetadata{}

// AppTaskMetadata The app_task kind metadata
type AppTaskMetadata struct {
	// UTC date and time in RFC-3339 format when app_task was last updated 
	...
	// UTC date and time in RFC-3339 format when app_task was created 
	...
	// Categories for the app_task. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the app_task. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _AppTaskMetadata AppTaskMetadata
...
func (o *AppTaskMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *AppTaskMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *AppTaskMetadata) SetName(v string) {
	o.Name = &v
}

func (o AppTaskMetadata) MarshalJSON() ([]byte, error) {
...
func (o AppTaskMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskMetadata := _AppTaskMetadata{}

	err = json.Unmarshal(data, &varAppTaskMetadata)

	if err != nil {
		return err
	}

	*o = AppTaskMetadata(varAppTaskMetadata)
...
type NullableAppTaskMetadata struct {
	value *AppTaskMetadata
	isSet bool
}

func (v NullableAppTaskMetadata) Get() *AppTaskMetadata {
	return v.value
}

func (v *NullableAppTaskMetadata) Set(val *AppTaskMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskMetadata(val *AppTaskMetadata) *NullableAppTaskMetadata {
	return &NullableAppTaskMetadata{value: val, isSet: true}
}

func (v NullableAppTaskMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
