...
// checks if the VmGpuListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmGpuListMetadata{}

// VmGpuListMetadata All api calls that return a list will have this metadata block as input 
...
type _VmGpuListMetadata VmGpuListMetadata
...
func (o VmGpuListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmGpuListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmGpuListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVmGpuListMetadata := _VmGpuListMetadata{}

	err = json.Unmarshal(data, &varVmGpuListMetadata)

	if err != nil {
		return err
	}

	*o = VmGpuListMetadata(varVmGpuListMetadata)
...
type NullableVmGpuListMetadata struct {
	value *VmGpuListMetadata
	isSet bool
}

func (v NullableVmGpuListMetadata) Get() *VmGpuListMetadata {
	return v.value
}

func (v *NullableVmGpuListMetadata) Set(val *VmGpuListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmGpuListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmGpuListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmGpuListMetadata(val *VmGpuListMetadata) *NullableVmGpuListMetadata {
	return &NullableVmGpuListMetadata{value: val, isSet: true}
}

func (v NullableVmGpuListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmGpuListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
