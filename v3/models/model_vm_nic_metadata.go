...
// checks if the VmNicMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmNicMetadata{}

// VmNicMetadata The vm_nic kind metadata
type VmNicMetadata struct {
	...
	// Categories for the vm_nic. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the vm_nic. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _VmNicMetadata VmNicMetadata
...
func (o *VmNicMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *VmNicMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *VmNicMetadata) SetName(v string) {
	o.Name = &v
}

func (o VmNicMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmNicMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmNicMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVmNicMetadata := _VmNicMetadata{}

	err = json.Unmarshal(data, &varVmNicMetadata)

	if err != nil {
		return err
	}

	*o = VmNicMetadata(varVmNicMetadata)
...
type NullableVmNicMetadata struct {
	value *VmNicMetadata
	isSet bool
}

func (v NullableVmNicMetadata) Get() *VmNicMetadata {
	return v.value
}

func (v *NullableVmNicMetadata) Set(val *VmNicMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmNicMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmNicMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmNicMetadata(val *VmNicMetadata) *NullableVmNicMetadata {
	return &NullableVmNicMetadata{value: val, isSet: true}
}

func (v NullableVmNicMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmNicMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
