...
// checks if the AppIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppIntentResponse{}

// AppIntentResponse Response object for intentful operations on a app
...
type _AppIntentResponse AppIntentResponse
...
func (o AppIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AppIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppIntentResponse := _AppIntentResponse{}

	err = json.Unmarshal(data, &varAppIntentResponse)

	if err != nil {
		return err
	}

	*o = AppIntentResponse(varAppIntentResponse)
...
type NullableAppIntentResponse struct {
	value *AppIntentResponse
	isSet bool
}

func (v NullableAppIntentResponse) Get() *AppIntentResponse {
	return v.value
}

func (v *NullableAppIntentResponse) Set(val *AppIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppIntentResponse(val *AppIntentResponse) *NullableAppIntentResponse {
	return &NullableAppIntentResponse{value: val, isSet: true}
}

func (v NullableAppIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
