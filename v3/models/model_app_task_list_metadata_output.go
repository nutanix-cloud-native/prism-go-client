...
// checks if the AppTaskListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskListMetadataOutput{}

// AppTaskListMetadataOutput All api calls that return a list will have this metadata block 
type AppTaskListMetadataOutput struct {
	// The kind name
...
type _AppTaskListMetadataOutput AppTaskListMetadataOutput
...
func NewAppTaskListMetadataOutput() *AppTaskListMetadataOutput {
	this := AppTaskListMetadataOutput{}
	var kind string = "app_task"
	this.Kind = &kind
	return &this
}
...
func (o AppTaskListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AppTaskListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAppTaskListMetadataOutput := _AppTaskListMetadataOutput{}

	err = json.Unmarshal(data, &varAppTaskListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AppTaskListMetadataOutput(varAppTaskListMetadataOutput)
...
type NullableAppTaskListMetadataOutput struct {
	value *AppTaskListMetadataOutput
	isSet bool
}

func (v NullableAppTaskListMetadataOutput) Get() *AppTaskListMetadataOutput {
	return v.value
}

func (v *NullableAppTaskListMetadataOutput) Set(val *AppTaskListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskListMetadataOutput(val *AppTaskListMetadataOutput) *NullableAppTaskListMetadataOutput {
	return &NullableAppTaskListMetadataOutput{value: val, isSet: true}
}

func (v NullableAppTaskListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
