...
// checks if the VolumeDiskResourceOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeDiskResourceOutput{}

// VolumeDiskResourceOutput Volume disk configuration.
type VolumeDiskResourceOutput struct {
	// Index of the volume disk in the group.
	Index *int32 `json:"index,omitempty"`
	// Storage container UUID on which the disk has been created.
...
type _VolumeDiskResourceOutput VolumeDiskResourceOutput
...
func (o VolumeDiskResourceOutput) MarshalJSON() ([]byte, error) {
...
func (o VolumeDiskResourceOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeDiskResourceOutput) UnmarshalJSON(data []byte) (err error) {
	varVolumeDiskResourceOutput := _VolumeDiskResourceOutput{}

	err = json.Unmarshal(data, &varVolumeDiskResourceOutput)

	if err != nil {
		return err
	}

	*o = VolumeDiskResourceOutput(varVolumeDiskResourceOutput)
...
type NullableVolumeDiskResourceOutput struct {
	value *VolumeDiskResourceOutput
	isSet bool
}

func (v NullableVolumeDiskResourceOutput) Get() *VolumeDiskResourceOutput {
	return v.value
}

func (v *NullableVolumeDiskResourceOutput) Set(val *VolumeDiskResourceOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeDiskResourceOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeDiskResourceOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeDiskResourceOutput(val *VolumeDiskResourceOutput) *NullableVolumeDiskResourceOutput {
	return &NullableVolumeDiskResourceOutput{value: val, isSet: true}
}

func (v NullableVolumeDiskResourceOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeDiskResourceOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
