...
// checks if the IpsecConfigStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpsecConfigStatus{}

// IpsecConfigStatus IPSEC related configuration status for the VPN connections.
type IpsecConfigStatus struct {
	// Virtual tunnel interface IP of the remote VPN gateway.
	RemoteVtiIp *string `json:"remote_vti_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	NegotiatedProposal *IpsecConfigStatusNegotiatedProposal `json:"negotiated_proposal,omitempty"`
	// IKE Authentication ID of the remote peer.
	RemoteAuthenticationId *string `json:"remote_authentication_id,omitempty"`
	// Virtual tunnel interface IP of the local VPN gateway.
	LocalVtiIp *string `json:"local_vti_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// IKE lifetime (in seconds)
	IkeLifetimeSecs *int32 `json:"ike_lifetime_secs,omitempty"`
	// Diffie-Hellman group configured for Perfect Forward Secrecy (PFS). Supported DH groups are 14, 19 and 20. 
	EspPfsDhGroupNumber *int32 `json:"esp_pfs_dh_group_number,omitempty"`
	// Local IKE authentication ID used for this connection.
	LocalAuthenticationId *string `json:"local_authentication_id,omitempty"`
	// IPSec lifetime (in seconds)
	IpsecLifetimeSecs *int32 `json:"ipsec_lifetime_secs,omitempty"`
	// IP prefix length of the virtual tunnel interface.
	VtiIpPrefixLength *int32 `json:"vti_ip_prefix_length,omitempty"`
	// Shared secret for authentication between gateway peers. Note that the clear-text secret value specfied in the input spec is never revealed in the status. Use this field only as means to verify if the secret is currently set or not. 
	PreSharedKey *string `json:"pre_shared_key,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _IpsecConfigStatus IpsecConfigStatus
...
// GetRemoteVtiIp returns the RemoteVtiIp field value if set, zero value otherwise.
func (o *IpsecConfigStatus) GetRemoteVtiIp() string {
	if o == nil || IsNil(o.RemoteVtiIp) {
		var ret string
		return ret
	}
	return *o.RemoteVtiIp
}

// GetRemoteVtiIpOk returns a tuple with the RemoteVtiIp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpsecConfigStatus) GetRemoteVtiIpOk() (*string, bool) {
	if o == nil || IsNil(o.RemoteVtiIp) {
		return nil, false
	}
	return o.RemoteVtiIp, true
}
...
// SetRemoteVtiIp gets a reference to the given string and assigns it to the RemoteVtiIp field.
func (o *IpsecConfigStatus) SetRemoteVtiIp(v string) {
	o.RemoteVtiIp = &v
}

// GetNegotiatedProposal returns the NegotiatedProposal field value if set, zero value otherwise.
func (o *IpsecConfigStatus) GetNegotiatedProposal() IpsecConfigStatusNegotiatedProposal {
	if o == nil || IsNil(o.NegotiatedProposal) {
		var ret IpsecConfigStatusNegotiatedProposal
		return ret
	}
	return *o.NegotiatedProposal
}

// GetNegotiatedProposalOk returns a tuple with the NegotiatedProposal field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpsecConfigStatus) GetNegotiatedProposalOk() (*IpsecConfigStatusNegotiatedProposal, bool) {
	if o == nil || IsNil(o.NegotiatedProposal) {
		return nil, false
	}
	return o.NegotiatedProposal, true
}
...
// SetNegotiatedProposal gets a reference to the given IpsecConfigStatusNegotiatedProposal and assigns it to the NegotiatedProposal field.
func (o *IpsecConfigStatus) SetNegotiatedProposal(v IpsecConfigStatusNegotiatedProposal) {
	o.NegotiatedProposal = &v
}

// GetRemoteAuthenticationId returns the RemoteAuthenticationId field value if set, zero value otherwise.
func (o *IpsecConfigStatus) GetRemoteAuthenticationId() string {
	if o == nil || IsNil(o.RemoteAuthenticationId) {
		var ret string
		return ret
	}
	return *o.RemoteAuthenticationId
}

// GetRemoteAuthenticationIdOk returns a tuple with the RemoteAuthenticationId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpsecConfigStatus) GetRemoteAuthenticationIdOk() (*string, bool) {
	if o == nil || IsNil(o.RemoteAuthenticationId) {
		return nil, false
	}
	return o.RemoteAuthenticationId, true
}
...
// SetRemoteAuthenticationId gets a reference to the given string and assigns it to the RemoteAuthenticationId field.
func (o *IpsecConfigStatus) SetRemoteAuthenticationId(v string) {
	o.RemoteAuthenticationId = &v
}

// GetLocalVtiIp returns the LocalVtiIp field value if set, zero value otherwise.
func (o *IpsecConfigStatus) GetLocalVtiIp() string {
	if o == nil || IsNil(o.LocalVtiIp) {
		var ret string
		return ret
	}
	return *o.LocalVtiIp
...
// GetLocalVtiIpOk returns a tuple with the LocalVtiIp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpsecConfigStatus) GetLocalVtiIpOk() (*string, bool) {
	if o == nil || IsNil(o.LocalVtiIp) {
		return nil, false
	}
	return o.LocalVtiIp, true
}
...
// SetLocalVtiIp gets a reference to the given string and assigns it to the LocalVtiIp field.
func (o *IpsecConfigStatus) SetLocalVtiIp(v string) {
	o.LocalVtiIp = &v
}

// GetIkeLifetimeSecs returns the IkeLifetimeSecs field value if set, zero value otherwise.
func (o *IpsecConfigStatus) GetIkeLifetimeSecs() int32 {
	if o == nil || IsNil(o.IkeLifetimeSecs) {
		var ret int32
		return ret
	}
	return *o.IkeLifetimeSecs
}

// GetIkeLifetimeSecsOk returns a tuple with the IkeLifetimeSecs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpsecConfigStatus) GetIkeLifetimeSecsOk() (*int32, bool) {
	if o == nil || IsNil(o.IkeLifetimeSecs) {
		return nil, false
	}
	return o.IkeLifetimeSecs, true
}
...
// SetIkeLifetimeSecs gets a reference to the given int32 and assigns it to the IkeLifetimeSecs field.
func (o *IpsecConfigStatus) SetIkeLifetimeSecs(v int32) {
	o.IkeLifetimeSecs = &v
}

// GetEspPfsDhGroupNumber returns the EspPfsDhGroupNumber field value if set, zero value otherwise.
func (o *IpsecConfigStatus) GetEspPfsDhGroupNumber() int32 {
	if o == nil || IsNil(o.EspPfsDhGroupNumber) {
		var ret int32
		return ret
	}
	return *o.EspPfsDhGroupNumber
}

// GetEspPfsDhGroupNumberOk returns a tuple with the EspPfsDhGroupNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpsecConfigStatus) GetEspPfsDhGroupNumberOk() (*int32, bool) {
	if o == nil || IsNil(o.EspPfsDhGroupNumber) {
		return nil, false
	}
	return o.EspPfsDhGroupNumber, true
}
...
// SetEspPfsDhGroupNumber gets a reference to the given int32 and assigns it to the EspPfsDhGroupNumber field.
func (o *IpsecConfigStatus) SetEspPfsDhGroupNumber(v int32) {
	o.EspPfsDhGroupNumber = &v
}

// GetLocalAuthenticationId returns the LocalAuthenticationId field value if set, zero value otherwise.
func (o *IpsecConfigStatus) GetLocalAuthenticationId() string {
	if o == nil || IsNil(o.LocalAuthenticationId) {
		var ret string
		return ret
	}
	return *o.LocalAuthenticationId
}

// GetLocalAuthenticationIdOk returns a tuple with the LocalAuthenticationId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpsecConfigStatus) GetLocalAuthenticationIdOk() (*string, bool) {
	if o == nil || IsNil(o.LocalAuthenticationId) {
		return nil, false
	}
	return o.LocalAuthenticationId, true
}
...
// SetLocalAuthenticationId gets a reference to the given string and assigns it to the LocalAuthenticationId field.
func (o *IpsecConfigStatus) SetLocalAuthenticationId(v string) {
	o.LocalAuthenticationId = &v
}

// GetIpsecLifetimeSecs returns the IpsecLifetimeSecs field value if set, zero value otherwise.
func (o *IpsecConfigStatus) GetIpsecLifetimeSecs() int32 {
	if o == nil || IsNil(o.IpsecLifetimeSecs) {
		var ret int32
		return ret
	}
	return *o.IpsecLifetimeSecs
}

// GetIpsecLifetimeSecsOk returns a tuple with the IpsecLifetimeSecs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpsecConfigStatus) GetIpsecLifetimeSecsOk() (*int32, bool) {
	if o == nil || IsNil(o.IpsecLifetimeSecs) {
		return nil, false
	}
	return o.IpsecLifetimeSecs, true
}
...
// SetIpsecLifetimeSecs gets a reference to the given int32 and assigns it to the IpsecLifetimeSecs field.
func (o *IpsecConfigStatus) SetIpsecLifetimeSecs(v int32) {
	o.IpsecLifetimeSecs = &v
}

// GetVtiIpPrefixLength returns the VtiIpPrefixLength field value if set, zero value otherwise.
func (o *IpsecConfigStatus) GetVtiIpPrefixLength() int32 {
	if o == nil || IsNil(o.VtiIpPrefixLength) {
		var ret int32
		return ret
	}
	return *o.VtiIpPrefixLength
}

// GetVtiIpPrefixLengthOk returns a tuple with the VtiIpPrefixLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpsecConfigStatus) GetVtiIpPrefixLengthOk() (*int32, bool) {
	if o == nil || IsNil(o.VtiIpPrefixLength) {
		return nil, false
	}
	return o.VtiIpPrefixLength, true
}
...
// SetVtiIpPrefixLength gets a reference to the given int32 and assigns it to the VtiIpPrefixLength field.
func (o *IpsecConfigStatus) SetVtiIpPrefixLength(v int32) {
	o.VtiIpPrefixLength = &v
}
...
func (o IpsecConfigStatus) MarshalJSON() ([]byte, error) {
...
func (o IpsecConfigStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RemoteVtiIp) {
		toSerialize["remote_vti_ip"] = o.RemoteVtiIp
	}
	if !IsNil(o.NegotiatedProposal) {
		toSerialize["negotiated_proposal"] = o.NegotiatedProposal
	}
	if !IsNil(o.RemoteAuthenticationId) {
		toSerialize["remote_authentication_id"] = o.RemoteAuthenticationId
	}
	if !IsNil(o.LocalVtiIp) {
		toSerialize["local_vti_ip"] = o.LocalVtiIp
	}
	if !IsNil(o.IkeLifetimeSecs) {
		toSerialize["ike_lifetime_secs"] = o.IkeLifetimeSecs
	}
	if !IsNil(o.EspPfsDhGroupNumber) {
		toSerialize["esp_pfs_dh_group_number"] = o.EspPfsDhGroupNumber
	}
	if !IsNil(o.LocalAuthenticationId) {
		toSerialize["local_authentication_id"] = o.LocalAuthenticationId
	}
	if !IsNil(o.IpsecLifetimeSecs) {
		toSerialize["ipsec_lifetime_secs"] = o.IpsecLifetimeSecs
	}
	if !IsNil(o.VtiIpPrefixLength) {
		toSerialize["vti_ip_prefix_length"] = o.VtiIpPrefixLength
	}
...
func (o *IpsecConfigStatus) UnmarshalJSON(data []byte) (err error) {
	varIpsecConfigStatus := _IpsecConfigStatus{}

	err = json.Unmarshal(data, &varIpsecConfigStatus)

	if err != nil {
		return err
	}

	*o = IpsecConfigStatus(varIpsecConfigStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "remote_vti_ip")
		delete(additionalProperties, "negotiated_proposal")
		delete(additionalProperties, "remote_authentication_id")
		delete(additionalProperties, "local_vti_ip")
		delete(additionalProperties, "ike_lifetime_secs")
		delete(additionalProperties, "esp_pfs_dh_group_number")
		delete(additionalProperties, "local_authentication_id")
		delete(additionalProperties, "ipsec_lifetime_secs")
		delete(additionalProperties, "vti_ip_prefix_length")
...
type NullableIpsecConfigStatus struct {
	value *IpsecConfigStatus
	isSet bool
}

func (v NullableIpsecConfigStatus) Get() *IpsecConfigStatus {
	return v.value
}

func (v *NullableIpsecConfigStatus) Set(val *IpsecConfigStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableIpsecConfigStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableIpsecConfigStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpsecConfigStatus(val *IpsecConfigStatus) *NullableIpsecConfigStatus {
	return &NullableIpsecConfigStatus{value: val, isSet: true}
}

func (v NullableIpsecConfigStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpsecConfigStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
