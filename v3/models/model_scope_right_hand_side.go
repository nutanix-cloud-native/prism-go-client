...
// checks if the ScopeRightHandSide type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScopeRightHandSide{}

// ScopeRightHandSide The right hand side of an scope expression.
type ScopeRightHandSide struct {
	// The explicit list of values for the given kind.
...
type _ScopeRightHandSide ScopeRightHandSide
...
func (o ScopeRightHandSide) MarshalJSON() ([]byte, error) {
...
func (o ScopeRightHandSide) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ValueList) {
		toSerialize["value_list"] = o.ValueList
	}
...
func (o *ScopeRightHandSide) UnmarshalJSON(data []byte) (err error) {
	varScopeRightHandSide := _ScopeRightHandSide{}

	err = json.Unmarshal(data, &varScopeRightHandSide)

	if err != nil {
		return err
	}

	*o = ScopeRightHandSide(varScopeRightHandSide)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "value_list")
...
type NullableScopeRightHandSide struct {
	value *ScopeRightHandSide
	isSet bool
}

func (v NullableScopeRightHandSide) Get() *ScopeRightHandSide {
	return v.value
}

func (v *NullableScopeRightHandSide) Set(val *ScopeRightHandSide) {
	v.value = val
	v.isSet = true
}

func (v NullableScopeRightHandSide) IsSet() bool {
	return v.isSet
}

func (v *NullableScopeRightHandSide) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScopeRightHandSide(val *ScopeRightHandSide) *NullableScopeRightHandSide {
	return &NullableScopeRightHandSide{value: val, isSet: true}
}

func (v NullableScopeRightHandSide) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScopeRightHandSide) UnmarshalJSON(src []byte) error {
	v.isSet = true
