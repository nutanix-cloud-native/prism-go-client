...
// checks if the BatchStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchStatus{}

// BatchStatus The status of a REST API call. Only used when there is a failure to report. 
...
func (o BatchStatus) MarshalJSON() ([]byte, error) {
...
func (o BatchStatus) ToMap() (map[string]interface{}, error) {
...
func (o *BatchStatus) UnmarshalJSON(data []byte) (err error) {
	varBatchStatus := _BatchStatus{}

	err = json.Unmarshal(data, &varBatchStatus)

	if err != nil {
		return err
	}

	*o = BatchStatus(varBatchStatus)
