...
// checks if the AwsMachineTypeListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsMachineTypeListMetadata{}

// AwsMachineTypeListMetadata All api calls that return a list will have this metadata block as input 
type AwsMachineTypeListMetadata struct {
	// The kind name
...
type _AwsMachineTypeListMetadata AwsMachineTypeListMetadata
...
func NewAwsMachineTypeListMetadata() *AwsMachineTypeListMetadata {
	this := AwsMachineTypeListMetadata{}
...
func (o AwsMachineTypeListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsMachineTypeListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsMachineTypeListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsMachineTypeListMetadata := _AwsMachineTypeListMetadata{}

	err = json.Unmarshal(data, &varAwsMachineTypeListMetadata)

	if err != nil {
		return err
	}

	*o = AwsMachineTypeListMetadata(varAwsMachineTypeListMetadata)
...
type NullableAwsMachineTypeListMetadata struct {
	value *AwsMachineTypeListMetadata
	isSet bool
}

func (v NullableAwsMachineTypeListMetadata) Get() *AwsMachineTypeListMetadata {
	return v.value
}

func (v *NullableAwsMachineTypeListMetadata) Set(val *AwsMachineTypeListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsMachineTypeListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsMachineTypeListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsMachineTypeListMetadata(val *AwsMachineTypeListMetadata) *NullableAwsMachineTypeListMetadata {
	return &NullableAwsMachineTypeListMetadata{value: val, isSet: true}
}

func (v NullableAwsMachineTypeListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsMachineTypeListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
