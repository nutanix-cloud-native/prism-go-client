...
// checks if the VmSpecOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmSpecOutput{}

// VmSpecOutput VM spec generated from an OVA that can be used to create a VM. 
type VmSpecOutput struct {
	VmSpec *VmIntentInput `json:"vm_spec,omitempty"`
	Warnings []VmSpecWarning `json:"warnings,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VmSpecOutput VmSpecOutput
...
// SetVmSpec gets a reference to the given VmIntentInput and assigns it to the VmSpec field.
...
// SetWarnings gets a reference to the given []VmSpecWarning and assigns it to the Warnings field.
func (o *VmSpecOutput) SetWarnings(v []VmSpecWarning) {
	o.Warnings = v
}

func (o VmSpecOutput) MarshalJSON() ([]byte, error) {
...
func (o VmSpecOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VmSpecOutput) UnmarshalJSON(data []byte) (err error) {
	varVmSpecOutput := _VmSpecOutput{}

	err = json.Unmarshal(data, &varVmSpecOutput)

	if err != nil {
		return err
	}

	*o = VmSpecOutput(varVmSpecOutput)
...
type NullableVmSpecOutput struct {
	value *VmSpecOutput
	isSet bool
}

func (v NullableVmSpecOutput) Get() *VmSpecOutput {
	return v.value
}

func (v *NullableVmSpecOutput) Set(val *VmSpecOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmSpecOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmSpecOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmSpecOutput(val *VmSpecOutput) *NullableVmSpecOutput {
	return &NullableVmSpecOutput{value: val, isSet: true}
}

func (v NullableVmSpecOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmSpecOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
