...
// checks if the BatchListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchListMetadata{}

// BatchListMetadata All api calls that return a list will have this metadata block as input 
...
type _BatchListMetadata BatchListMetadata
...
func (o BatchListMetadata) MarshalJSON() ([]byte, error) {
...
func (o BatchListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *BatchListMetadata) UnmarshalJSON(data []byte) (err error) {
	varBatchListMetadata := _BatchListMetadata{}

	err = json.Unmarshal(data, &varBatchListMetadata)

	if err != nil {
		return err
	}

	*o = BatchListMetadata(varBatchListMetadata)
...
type NullableBatchListMetadata struct {
	value *BatchListMetadata
	isSet bool
}

func (v NullableBatchListMetadata) Get() *BatchListMetadata {
	return v.value
}

func (v *NullableBatchListMetadata) Set(val *BatchListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchListMetadata(val *BatchListMetadata) *NullableBatchListMetadata {
	return &NullableBatchListMetadata{value: val, isSet: true}
}

func (v NullableBatchListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
