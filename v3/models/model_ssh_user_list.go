...
// checks if the SshUserList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserList{}

// SshUserList SSH User list
type SshUserList struct {
	Entities []SshUserDetails `json:"entities"`
	Metadata SshUserListMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _SshUserList SshUserList
...
func (o SshUserList) MarshalJSON() ([]byte, error) {
...
func (o SshUserList) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserList) UnmarshalJSON(data []byte) (err error) {
	...
	varSshUserList := _SshUserList{}

	err = json.Unmarshal(data, &varSshUserList)

	if err != nil {
		return err
	}

	*o = SshUserList(varSshUserList)
...
type NullableSshUserList struct {
	value *SshUserList
	isSet bool
}

func (v NullableSshUserList) Get() *SshUserList {
	return v.value
}

func (v *NullableSshUserList) Set(val *SshUserList) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserList) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserList(val *SshUserList) *NullableSshUserList {
	return &NullableSshUserList{value: val, isSet: true}
}

func (v NullableSshUserList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserList) UnmarshalJSON(src []byte) error {
	v.isSet = true
