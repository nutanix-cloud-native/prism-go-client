...
// checks if the SupportCaseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseResponse{}

// SupportCaseResponse Support case Resources definition.
type SupportCaseResponse struct {
	// Status of the case.
	Status *string `json:"status,omitempty"`
	LogCollector *LogCollectorSupportCaseUpload `json:"log_collector,omitempty"`
	ContactDetails *ContactInformation `json:"contact_details,omitempty"`
	NccChecksPc *NccChecksSupportCaseUpload `json:"ncc_checks_pc,omitempty"`
	...
	// Date on which the case was created.
	...
	// Support Case Id. This is the id to be used to query support details. Example \"500W0000003w3FEIAY\" 
	...
	AdditionalNotificationList []ContactInformation `json:"additional_notification_list,omitempty"`
	LogCollectorPc *LogCollectorSupportCaseUpload `json:"log_collector_pc,omitempty"`
	ClusterReference *ClusterReference `json:"cluster_reference,omitempty"`
	NccChecks *NccChecksSupportCaseUpload `json:"ncc_checks,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SupportCaseResponse SupportCaseResponse
...
// GetLogCollector returns the LogCollector field value if set, zero value otherwise.
func (o *SupportCaseResponse) GetLogCollector() LogCollectorSupportCaseUpload {
	if o == nil || IsNil(o.LogCollector) {
		var ret LogCollectorSupportCaseUpload
		return ret
	}
	return *o.LogCollector
}

// GetLogCollectorOk returns a tuple with the LogCollector field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SupportCaseResponse) GetLogCollectorOk() (*LogCollectorSupportCaseUpload, bool) {
	if o == nil || IsNil(o.LogCollector) {
		return nil, false
	}
	return o.LogCollector, true
}
...
// SetLogCollector gets a reference to the given LogCollectorSupportCaseUpload and assigns it to the LogCollector field.
...
// SetContactDetails gets a reference to the given ContactInformation and assigns it to the ContactDetails field.
func (o *SupportCaseResponse) SetContactDetails(v ContactInformation) {
	o.ContactDetails = &v
}

// GetNccChecksPc returns the NccChecksPc field value if set, zero value otherwise.
func (o *SupportCaseResponse) GetNccChecksPc() NccChecksSupportCaseUpload {
	if o == nil || IsNil(o.NccChecksPc) {
		var ret NccChecksSupportCaseUpload
		return ret
	}
	return *o.NccChecksPc
}

// GetNccChecksPcOk returns a tuple with the NccChecksPc field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SupportCaseResponse) GetNccChecksPcOk() (*NccChecksSupportCaseUpload, bool) {
	if o == nil || IsNil(o.NccChecksPc) {
		return nil, false
	}
	return o.NccChecksPc, true
}
...
// SetNccChecksPc gets a reference to the given NccChecksSupportCaseUpload and assigns it to the NccChecksPc field.
...
// GetNosVersion returns the NosVersion field value if set, zero value otherwise.
func (o *SupportCaseResponse) GetNosVersion() string {
	if o == nil || IsNil(o.NosVersion) {
		var ret string
		return ret
	}
	return *o.NosVersion
...
// GetNosVersionOk returns a tuple with the NosVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SupportCaseResponse) GetNosVersionOk() (*string, bool) {
	if o == nil || IsNil(o.NosVersion) {
		return nil, false
	}
	return o.NosVersion, true
}
...
// SetNosVersion gets a reference to the given string and assigns it to the NosVersion field.
...
// GetCustomKeyValues returns the CustomKeyValues field value if set, zero value otherwise.
func (o *SupportCaseResponse) GetCustomKeyValues() map[string]string {
	if o == nil || IsNil(o.CustomKeyValues) {
		var ret map[string]string
		return ret
	}
	return *o.CustomKeyValues
}

// GetCustomKeyValuesOk returns a tuple with the CustomKeyValues field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SupportCaseResponse) GetCustomKeyValuesOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.CustomKeyValues) {
		return nil, false
	}
	return o.CustomKeyValues, true
}
...
// SetCustomKeyValues gets a reference to the given map[string]string and assigns it to the CustomKeyValues field.
...
// GetAdditionalNotificationList returns the AdditionalNotificationList field value if set, zero value otherwise.
func (o *SupportCaseResponse) GetAdditionalNotificationList() []ContactInformation {
	if o == nil || IsNil(o.AdditionalNotificationList) {
		var ret []ContactInformation
		return ret
	}
	return o.AdditionalNotificationList
}

// GetAdditionalNotificationListOk returns a tuple with the AdditionalNotificationList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SupportCaseResponse) GetAdditionalNotificationListOk() ([]ContactInformation, bool) {
	if o == nil || IsNil(o.AdditionalNotificationList) {
		return nil, false
	}
	return o.AdditionalNotificationList, true
}
...
// SetAdditionalNotificationList gets a reference to the given []ContactInformation and assigns it to the AdditionalNotificationList field.
func (o *SupportCaseResponse) SetAdditionalNotificationList(v []ContactInformation) {
	o.AdditionalNotificationList = v
}

// GetLogCollectorPc returns the LogCollectorPc field value if set, zero value otherwise.
func (o *SupportCaseResponse) GetLogCollectorPc() LogCollectorSupportCaseUpload {
	if o == nil || IsNil(o.LogCollectorPc) {
		var ret LogCollectorSupportCaseUpload
		return ret
	}
	return *o.LogCollectorPc
}

// GetLogCollectorPcOk returns a tuple with the LogCollectorPc field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SupportCaseResponse) GetLogCollectorPcOk() (*LogCollectorSupportCaseUpload, bool) {
	if o == nil || IsNil(o.LogCollectorPc) {
		return nil, false
	}
	return o.LogCollectorPc, true
}
...
// SetLogCollectorPc gets a reference to the given LogCollectorSupportCaseUpload and assigns it to the LogCollectorPc field.
...
// GetNccChecks returns the NccChecks field value if set, zero value otherwise.
func (o *SupportCaseResponse) GetNccChecks() NccChecksSupportCaseUpload {
	if o == nil || IsNil(o.NccChecks) {
		var ret NccChecksSupportCaseUpload
		return ret
	}
	return *o.NccChecks
...
// GetNccChecksOk returns a tuple with the NccChecks field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SupportCaseResponse) GetNccChecksOk() (*NccChecksSupportCaseUpload, bool) {
	if o == nil || IsNil(o.NccChecks) {
		return nil, false
	}
	return o.NccChecks, true
}
...
// SetNccChecks gets a reference to the given NccChecksSupportCaseUpload and assigns it to the NccChecks field.
func (o *SupportCaseResponse) SetNccChecks(v NccChecksSupportCaseUpload) {
	o.NccChecks = &v
}

func (o SupportCaseResponse) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Status) {
		toSerialize["status"] = o.Status
	}
	if !IsNil(o.LogCollector) {
		toSerialize["log_collector"] = o.LogCollector
	}
	if !IsNil(o.ContactDetails) {
		toSerialize["contact_details"] = o.ContactDetails
	}
	if !IsNil(o.NccChecksPc) {
		toSerialize["ncc_checks_pc"] = o.NccChecksPc
	}
	...
	if !IsNil(o.NosVersion) {
		toSerialize["nos_version"] = o.NosVersion
	}
	...
	if !IsNil(o.HypervisorVersion) {
		toSerialize["hypervisor_version"] = o.HypervisorVersion
	}
	if !IsNil(o.CaseType) {
		toSerialize["case_type"] = o.CaseType
	}
	if !IsNil(o.CaseId) {
		toSerialize["case_id"] = o.CaseId
	}
	if !IsNil(o.CustomKeyValues) {
		toSerialize["custom_key_values"] = o.CustomKeyValues
	}
	if !IsNil(o.Owner) {
	...
	if !IsNil(o.AdditionalNotificationList) {
		toSerialize["additional_notification_list"] = o.AdditionalNotificationList
	}
	if !IsNil(o.LogCollectorPc) {
		toSerialize["log_collector_pc"] = o.LogCollectorPc
	}
	if !IsNil(o.ClusterReference) {
		toSerialize["cluster_reference"] = o.ClusterReference
	}
	if !IsNil(o.NccChecks) {
		toSerialize["ncc_checks"] = o.NccChecks
	}
...
func (o *SupportCaseResponse) UnmarshalJSON(data []byte) (err error) {
	varSupportCaseResponse := _SupportCaseResponse{}

	err = json.Unmarshal(data, &varSupportCaseResponse)

	if err != nil {
		return err
	}

	*o = SupportCaseResponse(varSupportCaseResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "status")
		delete(additionalProperties, "log_collector")
		delete(additionalProperties, "contact_details")
		delete(additionalProperties, "ncc_checks_pc")
		delete(additionalProperties, "creator_name")
		delete(additionalProperties, "case_number")
		delete(additionalProperties, "nos_version")
		delete(additionalProperties, "creation_date")
		delete(additionalProperties, "priority")
		delete(additionalProperties, "hypervisor_version")
		delete(additionalProperties, "case_type")
		delete(additionalProperties, "case_id")
		delete(additionalProperties, "custom_key_values")
		delete(additionalProperties, "owner")
		delete(additionalProperties, "serial_number")
		delete(additionalProperties, "additional_notification_list")
		delete(additionalProperties, "log_collector_pc")
		delete(additionalProperties, "cluster_reference")
		delete(additionalProperties, "ncc_checks")
...
type NullableSupportCaseResponse struct {
	value *SupportCaseResponse
	isSet bool
}

func (v NullableSupportCaseResponse) Get() *SupportCaseResponse {
	return v.value
}

func (v *NullableSupportCaseResponse) Set(val *SupportCaseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseResponse(val *SupportCaseResponse) *NullableSupportCaseResponse {
	return &NullableSupportCaseResponse{value: val, isSet: true}
}

func (v NullableSupportCaseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
