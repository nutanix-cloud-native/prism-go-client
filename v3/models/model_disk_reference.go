...
// checks if the DiskReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskReference{}

// DiskReference The reference to a disk
...
type _DiskReference DiskReference
...
func (o DiskReference) MarshalJSON() ([]byte, error) {
...
func (o DiskReference) ToMap() (map[string]interface{}, error) {
...
func (o *DiskReference) UnmarshalJSON(data []byte) (err error) {
	...
	varDiskReference := _DiskReference{}

	err = json.Unmarshal(data, &varDiskReference)

	if err != nil {
		return err
	}

	*o = DiskReference(varDiskReference)
...
type NullableDiskReference struct {
	value *DiskReference
	isSet bool
}

func (v NullableDiskReference) Get() *DiskReference {
	return v.value
}

func (v *NullableDiskReference) Set(val *DiskReference) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskReference) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskReference(val *DiskReference) *NullableDiskReference {
	return &NullableDiskReference{value: val, isSet: true}
}

func (v NullableDiskReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
