...
// checks if the MhVmResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmResources{}

// MhVmResources VM Resources Definition.
type MhVmResources struct {
	StorageConfig *MhVmStorageConfig `json:"storage_config,omitempty"`
	ParentReference *Reference `json:"parent_reference,omitempty"`
	GuestTools *GuestToolsSpec `json:"guest_tools,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MhVmResources MhVmResources
...
// SetStorageConfig gets a reference to the given MhVmStorageConfig and assigns it to the StorageConfig field.
...
// SetGuestTools gets a reference to the given GuestToolsSpec and assigns it to the GuestTools field.
func (o *MhVmResources) SetGuestTools(v GuestToolsSpec) {
	o.GuestTools = &v
}

func (o MhVmResources) MarshalJSON() ([]byte, error) {
...
func (o MhVmResources) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmResources) UnmarshalJSON(data []byte) (err error) {
	varMhVmResources := _MhVmResources{}

	err = json.Unmarshal(data, &varMhVmResources)

	if err != nil {
		return err
	}

	*o = MhVmResources(varMhVmResources)
...
type NullableMhVmResources struct {
	value *MhVmResources
	isSet bool
}

func (v NullableMhVmResources) Get() *MhVmResources {
	return v.value
}

func (v *NullableMhVmResources) Set(val *MhVmResources) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmResources) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmResources(val *MhVmResources) *NullableMhVmResources {
	return &NullableMhVmResources{value: val, isSet: true}
}

func (v NullableMhVmResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
