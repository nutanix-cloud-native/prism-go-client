...
// checks if the CategoryValueListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryValueListResponse{}

// CategoryValueListResponse Category Value list response.
...
type _CategoryValueListResponse CategoryValueListResponse
...
func NewCategoryValueListResponse() *CategoryValueListResponse {
	this := CategoryValueListResponse{}
	return &this
}
...
// SetEntities gets a reference to the given []CategoryValueStatus and assigns it to the Entities field.
...
// SetMetadata gets a reference to the given CategoryListMetadata and assigns it to the Metadata field.
func (o *CategoryValueListResponse) SetMetadata(v CategoryListMetadata) {
	o.Metadata = &v
}

func (o CategoryValueListResponse) MarshalJSON() ([]byte, error) {
...
func (o CategoryValueListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryValueListResponse) UnmarshalJSON(data []byte) (err error) {
	varCategoryValueListResponse := _CategoryValueListResponse{}

	err = json.Unmarshal(data, &varCategoryValueListResponse)

	if err != nil {
		return err
	}

	*o = CategoryValueListResponse(varCategoryValueListResponse)
...
type NullableCategoryValueListResponse struct {
	value *CategoryValueListResponse
	isSet bool
}

func (v NullableCategoryValueListResponse) Get() *CategoryValueListResponse {
	return v.value
}

func (v *NullableCategoryValueListResponse) Set(val *CategoryValueListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryValueListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryValueListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryValueListResponse(val *CategoryValueListResponse) *NullableCategoryValueListResponse {
	return &NullableCategoryValueListResponse{value: val, isSet: true}
}

func (v NullableCategoryValueListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryValueListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
