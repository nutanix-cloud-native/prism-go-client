...
// checks if the ProtectionRuleDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleDefStatus{}

// ProtectionRuleDefStatus Protection Rule creation/modification status
type ProtectionRuleDefStatus struct {
	// The state of the protection rule.
	...
	Resources ProtectionRuleResources `json:"resources"`
	// A description for the protection rule.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ProtectionRuleDefStatus ProtectionRuleDefStatus
...
func (o *ProtectionRuleDefStatus) GetResources() ProtectionRuleResources {
	if o == nil {
		var ret ProtectionRuleResources
		return ret
	}
...
func (o ProtectionRuleDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionRuleDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varProtectionRuleDefStatus := _ProtectionRuleDefStatus{}

	err = json.Unmarshal(data, &varProtectionRuleDefStatus)

	if err != nil {
		return err
	}

	*o = ProtectionRuleDefStatus(varProtectionRuleDefStatus)
...
type NullableProtectionRuleDefStatus struct {
	value *ProtectionRuleDefStatus
	isSet bool
}

func (v NullableProtectionRuleDefStatus) Get() *ProtectionRuleDefStatus {
	return v.value
}

func (v *NullableProtectionRuleDefStatus) Set(val *ProtectionRuleDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleDefStatus(val *ProtectionRuleDefStatus) *NullableProtectionRuleDefStatus {
	return &NullableProtectionRuleDefStatus{value: val, isSet: true}
}

func (v NullableProtectionRuleDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
