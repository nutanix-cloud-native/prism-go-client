...
// checks if the RoutingPolicyListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyListIntentResponse{}

// RoutingPolicyListIntentResponse Response object for intentful operation of routing_policys
type RoutingPolicyListIntentResponse struct {
	Entities []RoutingPolicyIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata RoutingPolicyListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RoutingPolicyListIntentResponse RoutingPolicyListIntentResponse
...
func NewRoutingPolicyListIntentResponse(apiVersion string, metadata RoutingPolicyListMetadataOutput) *RoutingPolicyListIntentResponse {
	this := RoutingPolicyListIntentResponse{}
...
func (o *RoutingPolicyListIntentResponse) GetEntities() []RoutingPolicyIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []RoutingPolicyIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []RoutingPolicyIntentResource and assigns it to the Entities field.
...
func (o *RoutingPolicyListIntentResponse) GetMetadata() RoutingPolicyListMetadataOutput {
	if o == nil {
		var ret RoutingPolicyListMetadataOutput
		return ret
	}
...
func (o RoutingPolicyListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingPolicyListIntentResponse := _RoutingPolicyListIntentResponse{}

	err = json.Unmarshal(data, &varRoutingPolicyListIntentResponse)

	if err != nil {
		return err
	}

	*o = RoutingPolicyListIntentResponse(varRoutingPolicyListIntentResponse)
...
type NullableRoutingPolicyListIntentResponse struct {
	value *RoutingPolicyListIntentResponse
	isSet bool
}

func (v NullableRoutingPolicyListIntentResponse) Get() *RoutingPolicyListIntentResponse {
	return v.value
}

func (v *NullableRoutingPolicyListIntentResponse) Set(val *RoutingPolicyListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyListIntentResponse(val *RoutingPolicyListIntentResponse) *NullableRoutingPolicyListIntentResponse {
	return &NullableRoutingPolicyListIntentResponse{value: val, isSet: true}
}

func (v NullableRoutingPolicyListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
