...
// checks if the AppPackageResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPackageResponse{}

// AppPackageResponse Package definition for Application
type AppPackageResponse struct {
	...
	ConfigReference *AppPackageReference `json:"config_reference,omitempty"`
	// 
...
type _AppPackageResponse AppPackageResponse
...
// SetAccountReference gets a reference to the given AccountReference and assigns it to the AccountReference field.
...
// SetConfigReference gets a reference to the given AppPackageReference and assigns it to the ConfigReference field.
...
func (o AppPackageResponse) MarshalJSON() ([]byte, error) {
...
func (o AppPackageResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppPackageResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPackageResponse := _AppPackageResponse{}

	err = json.Unmarshal(data, &varAppPackageResponse)

	if err != nil {
		return err
	}

	*o = AppPackageResponse(varAppPackageResponse)
...
type NullableAppPackageResponse struct {
	value *AppPackageResponse
	isSet bool
}

func (v NullableAppPackageResponse) Get() *AppPackageResponse {
	return v.value
}

func (v *NullableAppPackageResponse) Set(val *AppPackageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPackageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPackageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPackageResponse(val *AppPackageResponse) *NullableAppPackageResponse {
	return &NullableAppPackageResponse{value: val, isSet: true}
}

func (v NullableAppPackageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPackageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
