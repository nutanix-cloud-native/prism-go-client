...
// checks if the AwsRoleListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRoleListMetadata{}

// AwsRoleListMetadata All api calls that return a list will have this metadata block as input 
type AwsRoleListMetadata struct {
	// The kind name
...
type _AwsRoleListMetadata AwsRoleListMetadata
...
func (o AwsRoleListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsRoleListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRoleListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsRoleListMetadata := _AwsRoleListMetadata{}

	err = json.Unmarshal(data, &varAwsRoleListMetadata)

	if err != nil {
		return err
	}

	*o = AwsRoleListMetadata(varAwsRoleListMetadata)
...
type NullableAwsRoleListMetadata struct {
	value *AwsRoleListMetadata
	isSet bool
}

func (v NullableAwsRoleListMetadata) Get() *AwsRoleListMetadata {
	return v.value
}

func (v *NullableAwsRoleListMetadata) Set(val *AwsRoleListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRoleListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRoleListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRoleListMetadata(val *AwsRoleListMetadata) *NullableAwsRoleListMetadata {
	return &NullableAwsRoleListMetadata{value: val, isSet: true}
}

func (v NullableAwsRoleListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRoleListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
