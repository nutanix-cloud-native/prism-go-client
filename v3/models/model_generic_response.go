...
// GenericResponse Generic response object definition.
type GenericResponse struct {
	// Type of the response.
	Type *string `json:"type,omitempty"`
	// ID of this response. This can be used further by the client to request data for only these widgets for refreshing results or for performance reasons (async loading). 
	WidgetId *string `json:"widget_id,omitempty"`
	// Entities with metrics result object defintion. Making it opaque in the first release conciously. This will have contain the details of entity metadata and metrics. 
...
func (o *GenericResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varGenericResponse)
