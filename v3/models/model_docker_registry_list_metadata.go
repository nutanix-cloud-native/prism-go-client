...
// checks if the DockerRegistryListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryListMetadata{}
...
type _DockerRegistryListMetadata DockerRegistryListMetadata
...
func NewDockerRegistryListMetadata() *DockerRegistryListMetadata {
	this := DockerRegistryListMetadata{}
...
func (o DockerRegistryListMetadata) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryListMetadata) UnmarshalJSON(data []byte) (err error) {
	varDockerRegistryListMetadata := _DockerRegistryListMetadata{}

	err = json.Unmarshal(data, &varDockerRegistryListMetadata)

	if err != nil {
		return err
	}

	*o = DockerRegistryListMetadata(varDockerRegistryListMetadata)
...
type NullableDockerRegistryListMetadata struct {
	value *DockerRegistryListMetadata
	isSet bool
}

func (v NullableDockerRegistryListMetadata) Get() *DockerRegistryListMetadata {
	return v.value
}

func (v *NullableDockerRegistryListMetadata) Set(val *DockerRegistryListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryListMetadata(val *DockerRegistryListMetadata) *NullableDockerRegistryListMetadata {
	return &NullableDockerRegistryListMetadata{value: val, isSet: true}
}

func (v NullableDockerRegistryListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
