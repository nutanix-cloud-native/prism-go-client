...
// checks if the AppSubstrateElement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSubstrateElement{}

// AppSubstrateElement Substrate element definition for Application
type AppSubstrateElement struct {
	// 
...
type _AppSubstrateElement AppSubstrateElement
...
func (o AppSubstrateElement) MarshalJSON() ([]byte, error) {
...
func (o AppSubstrateElement) ToMap() (map[string]interface{}, error) {
...
func (o *AppSubstrateElement) UnmarshalJSON(data []byte) (err error) {
	...
	varAppSubstrateElement := _AppSubstrateElement{}

	err = json.Unmarshal(data, &varAppSubstrateElement)

	if err != nil {
		return err
	}

	*o = AppSubstrateElement(varAppSubstrateElement)
...
type NullableAppSubstrateElement struct {
	value *AppSubstrateElement
	isSet bool
}

func (v NullableAppSubstrateElement) Get() *AppSubstrateElement {
	return v.value
}

func (v *NullableAppSubstrateElement) Set(val *AppSubstrateElement) {
	v.value = val
	v.isSet = true
}

func (v NullableAppSubstrateElement) IsSet() bool {
	return v.isSet
}

func (v *NullableAppSubstrateElement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppSubstrateElement(val *AppSubstrateElement) *NullableAppSubstrateElement {
	return &NullableAppSubstrateElement{value: val, isSet: true}
}

func (v NullableAppSubstrateElement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppSubstrateElement) UnmarshalJSON(src []byte) error {
	v.isSet = true
