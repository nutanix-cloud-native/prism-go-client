...
// checks if the NetworkDeviceIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDeviceIntentResource{}

// NetworkDeviceIntentResource Response object for intentful operations on a network_device
type NetworkDeviceIntentResource struct {
...
type _NetworkDeviceIntentResource NetworkDeviceIntentResource
...
func NewNetworkDeviceIntentResource(metadata NetworkDeviceMetadata) *NetworkDeviceIntentResource {
	this := NetworkDeviceIntentResource{}
...
func (o NetworkDeviceIntentResource) MarshalJSON() ([]byte, error) {
...
func (o NetworkDeviceIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkDeviceIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkDeviceIntentResource := _NetworkDeviceIntentResource{}

	err = json.Unmarshal(data, &varNetworkDeviceIntentResource)

	if err != nil {
		return err
	}

	*o = NetworkDeviceIntentResource(varNetworkDeviceIntentResource)
...
type NullableNetworkDeviceIntentResource struct {
	value *NetworkDeviceIntentResource
	isSet bool
}

func (v NullableNetworkDeviceIntentResource) Get() *NetworkDeviceIntentResource {
	return v.value
}

func (v *NullableNetworkDeviceIntentResource) Set(val *NetworkDeviceIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDeviceIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDeviceIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDeviceIntentResource(val *NetworkDeviceIntentResource) *NullableNetworkDeviceIntentResource {
	return &NullableNetworkDeviceIntentResource{value: val, isSet: true}
}

func (v NullableNetworkDeviceIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDeviceIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
