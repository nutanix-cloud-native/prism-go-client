...
// checks if the ExecutionSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExecutionSchedule{}

// ExecutionSchedule Execution schedule for requests.
type ExecutionSchedule struct {
	// Start time to execute a request.
	StartTime time.Time `json:"start_time"`
	// Name of specified time zone.
	TimeZone *string `json:"time_zone,omitempty"`
	// Time out in seconds for a request execution.
	TimeoutSecs *int64 `json:"timeout_secs,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ExecutionSchedule ExecutionSchedule
...
func (o ExecutionSchedule) MarshalJSON() ([]byte, error) {
...
func (o ExecutionSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *ExecutionSchedule) UnmarshalJSON(data []byte) (err error) {
	...
	varExecutionSchedule := _ExecutionSchedule{}

	err = json.Unmarshal(data, &varExecutionSchedule)

	if err != nil {
		return err
	}

	*o = ExecutionSchedule(varExecutionSchedule)
...
type NullableExecutionSchedule struct {
	value *ExecutionSchedule
	isSet bool
}

func (v NullableExecutionSchedule) Get() *ExecutionSchedule {
	return v.value
}

func (v *NullableExecutionSchedule) Set(val *ExecutionSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableExecutionSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableExecutionSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExecutionSchedule(val *ExecutionSchedule) *NullableExecutionSchedule {
	return &NullableExecutionSchedule{value: val, isSet: true}
}

func (v NullableExecutionSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExecutionSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
