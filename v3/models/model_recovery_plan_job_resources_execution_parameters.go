...
// checks if the RecoveryPlanJobResourcesExecutionParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobResourcesExecutionParameters{}

// RecoveryPlanJobResourcesExecutionParameters Parameters for execution of the Recovery Plan Job. 
type RecoveryPlanJobResourcesExecutionParameters struct {
	// Availability Zones wherein entities need to be recovered. 
	RecoveryAvailabilityZoneList []AvailabilityZoneInformation `json:"recovery_availability_zone_list"`
	// Availability Zones that have failed. 
	FailedAvailabilityZoneList []AvailabilityZoneInformation `json:"failed_availability_zone_list"`
...
type _RecoveryPlanJobResourcesExecutionParameters RecoveryPlanJobResourcesExecutionParameters
...
func NewRecoveryPlanJobResourcesExecutionParameters(recoveryAvailabilityZoneList []AvailabilityZoneInformation, failedAvailabilityZoneList []AvailabilityZoneInformation, actionType string) *RecoveryPlanJobResourcesExecutionParameters {
	this := RecoveryPlanJobResourcesExecutionParameters{}
	this.RecoveryAvailabilityZoneList = recoveryAvailabilityZoneList
	this.FailedAvailabilityZoneList = failedAvailabilityZoneList
	this.ActionType = actionType
	var shouldContinueOnValidationFailure bool = false
	this.ShouldContinueOnValidationFailure = &shouldContinueOnValidationFailure
	return &this
}
...
// GetRecoveryAvailabilityZoneList returns the RecoveryAvailabilityZoneList field value
func (o *RecoveryPlanJobResourcesExecutionParameters) GetRecoveryAvailabilityZoneList() []AvailabilityZoneInformation {
	...
	return o.RecoveryAvailabilityZoneList
}

// GetRecoveryAvailabilityZoneListOk returns a tuple with the RecoveryAvailabilityZoneList field value
...
func (o *RecoveryPlanJobResourcesExecutionParameters) GetRecoveryAvailabilityZoneListOk() ([]AvailabilityZoneInformation, bool) {
	...
	return o.RecoveryAvailabilityZoneList, true
}

// SetRecoveryAvailabilityZoneList sets field value
func (o *RecoveryPlanJobResourcesExecutionParameters) SetRecoveryAvailabilityZoneList(v []AvailabilityZoneInformation) {
	o.RecoveryAvailabilityZoneList = v
}

// GetFailedAvailabilityZoneList returns the FailedAvailabilityZoneList field value
func (o *RecoveryPlanJobResourcesExecutionParameters) GetFailedAvailabilityZoneList() []AvailabilityZoneInformation {
	...
	return o.FailedAvailabilityZoneList
}

// GetFailedAvailabilityZoneListOk returns a tuple with the FailedAvailabilityZoneList field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobResourcesExecutionParameters) GetFailedAvailabilityZoneListOk() ([]AvailabilityZoneInformation, bool) {
	if o == nil {
		return nil, false
	}
	return o.FailedAvailabilityZoneList, true
}

// SetFailedAvailabilityZoneList sets field value
func (o *RecoveryPlanJobResourcesExecutionParameters) SetFailedAvailabilityZoneList(v []AvailabilityZoneInformation) {
	o.FailedAvailabilityZoneList = v
}

// GetRecoveryReferenceTime returns the RecoveryReferenceTime field value if set, zero value otherwise.
func (o *RecoveryPlanJobResourcesExecutionParameters) GetRecoveryReferenceTime() time.Time {
	if o == nil || IsNil(o.RecoveryReferenceTime) {
		var ret time.Time
		return ret
	}
	return *o.RecoveryReferenceTime
}

// GetRecoveryReferenceTimeOk returns a tuple with the RecoveryReferenceTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobResourcesExecutionParameters) GetRecoveryReferenceTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.RecoveryReferenceTime) {
		return nil, false
	}
	return o.RecoveryReferenceTime, true
}
...
// SetRecoveryReferenceTime gets a reference to the given time.Time and assigns it to the RecoveryReferenceTime field.
func (o *RecoveryPlanJobResourcesExecutionParameters) SetRecoveryReferenceTime(v time.Time) {
	o.RecoveryReferenceTime = &v
}
...
// GetShouldContinueOnValidationFailure returns the ShouldContinueOnValidationFailure field value if set, zero value otherwise.
func (o *RecoveryPlanJobResourcesExecutionParameters) GetShouldContinueOnValidationFailure() bool {
	if o == nil || IsNil(o.ShouldContinueOnValidationFailure) {
		var ret bool
		return ret
	}
	return *o.ShouldContinueOnValidationFailure
}

// GetShouldContinueOnValidationFailureOk returns a tuple with the ShouldContinueOnValidationFailure field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobResourcesExecutionParameters) GetShouldContinueOnValidationFailureOk() (*bool, bool) {
	if o == nil || IsNil(o.ShouldContinueOnValidationFailure) {
		return nil, false
	}
	return o.ShouldContinueOnValidationFailure, true
}
...
// SetShouldContinueOnValidationFailure gets a reference to the given bool and assigns it to the ShouldContinueOnValidationFailure field.
func (o *RecoveryPlanJobResourcesExecutionParameters) SetShouldContinueOnValidationFailure(v bool) {
	o.ShouldContinueOnValidationFailure = &v
}

func (o RecoveryPlanJobResourcesExecutionParameters) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobResourcesExecutionParameters) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["recovery_availability_zone_list"] = o.RecoveryAvailabilityZoneList
	toSerialize["failed_availability_zone_list"] = o.FailedAvailabilityZoneList
	if !IsNil(o.RecoveryReferenceTime) {
		toSerialize["recovery_reference_time"] = o.RecoveryReferenceTime
	}
	toSerialize["action_type"] = o.ActionType
	if !IsNil(o.ShouldContinueOnValidationFailure) {
		toSerialize["should_continue_on_validation_failure"] = o.ShouldContinueOnValidationFailure
	}
...
func (o *RecoveryPlanJobResourcesExecutionParameters) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobResourcesExecutionParameters := _RecoveryPlanJobResourcesExecutionParameters{}

	err = json.Unmarshal(data, &varRecoveryPlanJobResourcesExecutionParameters)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobResourcesExecutionParameters(varRecoveryPlanJobResourcesExecutionParameters)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "recovery_availability_zone_list")
		delete(additionalProperties, "failed_availability_zone_list")
		delete(additionalProperties, "recovery_reference_time")
		delete(additionalProperties, "action_type")
		delete(additionalProperties, "should_continue_on_validation_failure")
...
type NullableRecoveryPlanJobResourcesExecutionParameters struct {
	value *RecoveryPlanJobResourcesExecutionParameters
	isSet bool
}

func (v NullableRecoveryPlanJobResourcesExecutionParameters) Get() *RecoveryPlanJobResourcesExecutionParameters {
	return v.value
}

func (v *NullableRecoveryPlanJobResourcesExecutionParameters) Set(val *RecoveryPlanJobResourcesExecutionParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobResourcesExecutionParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobResourcesExecutionParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobResourcesExecutionParameters(val *RecoveryPlanJobResourcesExecutionParameters) *NullableRecoveryPlanJobResourcesExecutionParameters {
	return &NullableRecoveryPlanJobResourcesExecutionParameters{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobResourcesExecutionParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobResourcesExecutionParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
