...
// checks if the AppRunlogOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunlogOutput{}

// AppRunlogOutput Response of app runlog response output
type AppRunlogOutput struct {
	TrlId *string `json:"trl_id,omitempty"`
	Output *string `json:"output,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AppRunlogOutput AppRunlogOutput
...
// GetTrlId returns the TrlId field value if set, zero value otherwise.
func (o *AppRunlogOutput) GetTrlId() string {
	if o == nil || IsNil(o.TrlId) {
		var ret string
		return ret
	}
	return *o.TrlId
...
// GetTrlIdOk returns a tuple with the TrlId field value if set, nil otherwise
...
// SetTrlId gets a reference to the given string and assigns it to the TrlId field.
...
func (o AppRunlogOutput) MarshalJSON() ([]byte, error) {
...
func (o AppRunlogOutput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TrlId) {
		toSerialize["trl_id"] = o.TrlId
	}
	if !IsNil(o.Output) {
...
func (o *AppRunlogOutput) UnmarshalJSON(data []byte) (err error) {
	varAppRunlogOutput := _AppRunlogOutput{}

	err = json.Unmarshal(data, &varAppRunlogOutput)

	if err != nil {
		return err
	}

	*o = AppRunlogOutput(varAppRunlogOutput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "trl_id")
...
type NullableAppRunlogOutput struct {
	value *AppRunlogOutput
	isSet bool
}

func (v NullableAppRunlogOutput) Get() *AppRunlogOutput {
	return v.value
}

func (v *NullableAppRunlogOutput) Set(val *AppRunlogOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunlogOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunlogOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunlogOutput(val *AppRunlogOutput) *NullableAppRunlogOutput {
	return &NullableAppRunlogOutput{value: val, isSet: true}
}

func (v NullableAppRunlogOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunlogOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
