...
// checks if the VmHostAffinityPolicyListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityPolicyListMetadata{}

// VmHostAffinityPolicyListMetadata API call for VM Host Affinity Policy that returns a list will have this metadata block as input. 
type VmHostAffinityPolicyListMetadata struct {
	// The kind name.
...
type _VmHostAffinityPolicyListMetadata VmHostAffinityPolicyListMetadata
...
func NewVmHostAffinityPolicyListMetadata() *VmHostAffinityPolicyListMetadata {
	this := VmHostAffinityPolicyListMetadata{}
...
func (o VmHostAffinityPolicyListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityPolicyListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmHostAffinityPolicyListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVmHostAffinityPolicyListMetadata := _VmHostAffinityPolicyListMetadata{}

	err = json.Unmarshal(data, &varVmHostAffinityPolicyListMetadata)

	if err != nil {
		return err
	}

	*o = VmHostAffinityPolicyListMetadata(varVmHostAffinityPolicyListMetadata)
...
type NullableVmHostAffinityPolicyListMetadata struct {
	value *VmHostAffinityPolicyListMetadata
	isSet bool
}

func (v NullableVmHostAffinityPolicyListMetadata) Get() *VmHostAffinityPolicyListMetadata {
	return v.value
}

func (v *NullableVmHostAffinityPolicyListMetadata) Set(val *VmHostAffinityPolicyListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityPolicyListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityPolicyListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityPolicyListMetadata(val *VmHostAffinityPolicyListMetadata) *NullableVmHostAffinityPolicyListMetadata {
	return &NullableVmHostAffinityPolicyListMetadata{value: val, isSet: true}
}

func (v NullableVmHostAffinityPolicyListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityPolicyListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
