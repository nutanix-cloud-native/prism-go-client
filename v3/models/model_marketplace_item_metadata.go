...
// checks if the MarketplaceItemMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemMetadata{}

// MarketplaceItemMetadata The marketplace_item kind metadata
type MarketplaceItemMetadata struct {
	...
	// Categories for the marketplace_item. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the marketplace_item. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _MarketplaceItemMetadata MarketplaceItemMetadata
...
func (o *MarketplaceItemMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *MarketplaceItemMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *MarketplaceItemMetadata) SetName(v string) {
	o.Name = &v
}

func (o MarketplaceItemMetadata) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItemMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceItemMetadata := _MarketplaceItemMetadata{}

	err = json.Unmarshal(data, &varMarketplaceItemMetadata)

	if err != nil {
		return err
	}

	*o = MarketplaceItemMetadata(varMarketplaceItemMetadata)
...
type NullableMarketplaceItemMetadata struct {
	value *MarketplaceItemMetadata
	isSet bool
}

func (v NullableMarketplaceItemMetadata) Get() *MarketplaceItemMetadata {
	return v.value
}

func (v *NullableMarketplaceItemMetadata) Set(val *MarketplaceItemMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemMetadata(val *MarketplaceItemMetadata) *NullableMarketplaceItemMetadata {
	return &NullableMarketplaceItemMetadata{value: val, isSet: true}
}

func (v NullableMarketplaceItemMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
