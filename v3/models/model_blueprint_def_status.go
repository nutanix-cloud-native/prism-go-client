...
// checks if the BlueprintDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintDefStatus{}

// BlueprintDefStatus An intentful representation of a blueprint status
type BlueprintDefStatus struct {
	// blueprint Name.
	...
	// Any error messages for the blueprint, if in an error state.
	...
	Resources BlueprintResourcesDefStatus `json:"resources"`
	// A description for blueprint.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _BlueprintDefStatus BlueprintDefStatus
...
func (o BlueprintDefStatus) MarshalJSON() ([]byte, error) {
...
func (o BlueprintDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintDefStatus := _BlueprintDefStatus{}

	err = json.Unmarshal(data, &varBlueprintDefStatus)

	if err != nil {
		return err
	}

	*o = BlueprintDefStatus(varBlueprintDefStatus)
...
type NullableBlueprintDefStatus struct {
	value *BlueprintDefStatus
	isSet bool
}

func (v NullableBlueprintDefStatus) Get() *BlueprintDefStatus {
	return v.value
}

func (v *NullableBlueprintDefStatus) Set(val *BlueprintDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintDefStatus(val *BlueprintDefStatus) *NullableBlueprintDefStatus {
	return &NullableBlueprintDefStatus{value: val, isSet: true}
}

func (v NullableBlueprintDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
