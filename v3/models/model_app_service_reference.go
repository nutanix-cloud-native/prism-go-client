...
// checks if the AppServiceReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppServiceReference{}

// AppServiceReference The reference to a app_service
type AppServiceReference struct {
	// The kind name
...
type _AppServiceReference AppServiceReference
...
func (o AppServiceReference) MarshalJSON() ([]byte, error) {
...
func (o AppServiceReference) ToMap() (map[string]interface{}, error) {
...
func (o *AppServiceReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAppServiceReference := _AppServiceReference{}

	err = json.Unmarshal(data, &varAppServiceReference)

	if err != nil {
		return err
	}

	*o = AppServiceReference(varAppServiceReference)
...
type NullableAppServiceReference struct {
	value *AppServiceReference
	isSet bool
}

func (v NullableAppServiceReference) Get() *AppServiceReference {
	return v.value
}

func (v *NullableAppServiceReference) Set(val *AppServiceReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAppServiceReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAppServiceReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppServiceReference(val *AppServiceReference) *NullableAppServiceReference {
	return &NullableAppServiceReference{value: val, isSet: true}
}

func (v NullableAppServiceReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppServiceReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
