...
// checks if the FloatingIpStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpStatus{}

// FloatingIpStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _FloatingIpStatus FloatingIpStatus
...
func (o FloatingIpStatus) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpStatus) ToMap() (map[string]interface{}, error) {
...
func (o *FloatingIpStatus) UnmarshalJSON(data []byte) (err error) {
	varFloatingIpStatus := _FloatingIpStatus{}

	err = json.Unmarshal(data, &varFloatingIpStatus)

	if err != nil {
		return err
	}

	*o = FloatingIpStatus(varFloatingIpStatus)
...
type NullableFloatingIpStatus struct {
	value *FloatingIpStatus
	isSet bool
}

func (v NullableFloatingIpStatus) Get() *FloatingIpStatus {
	return v.value
}

func (v *NullableFloatingIpStatus) Set(val *FloatingIpStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpStatus(val *FloatingIpStatus) *NullableFloatingIpStatus {
	return &NullableFloatingIpStatus{value: val, isSet: true}
}

func (v NullableFloatingIpStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
