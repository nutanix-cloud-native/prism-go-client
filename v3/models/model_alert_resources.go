...
// checks if the AlertResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertResources{}

// AlertResources Alert entity definition.
type AlertResources struct {
	// The last time this alert was updated.  System sets this.
	LastUpdateTime *time.Time `json:"last_update_time,omitempty"`
	SourceEntity *AlertResourcesSourceEntity `json:"source_entity,omitempty"`
	// List of cause and resolution object from alert RCA metadata.
	RcaMetadataList []RcaMetadata `json:"rca_metadata_list,omitempty"`
	// A list of entities causing and/or related to this alert. 
	AffectedEntityList []EntityInfo `json:"affected_entity_list,omitempty"`
	// Alert severity
	...
	ResolutionStatus *AlertState `json:"resolution_status,omitempty"`
	// The symptoms that caused this alert
	IndicatorList []Indicator `json:"indicator_list,omitempty"`
	AcknowledgedStatus *AlertState `json:"acknowledged_status,omitempty"`
	...
	SeverityTrailList []AlertResourcesSeverityTrailListInner `json:"severity_trail_list,omitempty"`
	// Component classification
	ClassificationList []string `json:"classification_list,omitempty"`
	// An ordered list of the possible causes and resolutions for the alert. 
	PossibleCauseList []CauseAnalysis `json:"possible_cause_list,omitempty"`
	// The area this alert could impact. 
	ImpactTypeList []string `json:"impact_type_list,omitempty"`
	...
	ImpactList []string `json:"impact_list,omitempty"`
	...
	LatestOccurrenceTime *time.Time `json:"latest_occurrence_time,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AlertResources AlertResources
...
func (o *AlertResources) GetSourceEntity() AlertResourcesSourceEntity {
	if o == nil || IsNil(o.SourceEntity) {
		var ret AlertResourcesSourceEntity
		return ret
	}
...
// SetSourceEntity gets a reference to the given AlertResourcesSourceEntity and assigns it to the SourceEntity field.
func (o *AlertResources) SetSourceEntity(v AlertResourcesSourceEntity) {
	o.SourceEntity = &v
}

// GetRcaMetadataList returns the RcaMetadataList field value if set, zero value otherwise.
func (o *AlertResources) GetRcaMetadataList() []RcaMetadata {
	if o == nil || IsNil(o.RcaMetadataList) {
		var ret []RcaMetadata
		return ret
	}
	return o.RcaMetadataList
}

// GetRcaMetadataListOk returns a tuple with the RcaMetadataList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertResources) GetRcaMetadataListOk() ([]RcaMetadata, bool) {
	if o == nil || IsNil(o.RcaMetadataList) {
		return nil, false
	}
	return o.RcaMetadataList, true
}
...
// SetRcaMetadataList gets a reference to the given []RcaMetadata and assigns it to the RcaMetadataList field.
func (o *AlertResources) SetRcaMetadataList(v []RcaMetadata) {
	o.RcaMetadataList = v
}

// GetAffectedEntityList returns the AffectedEntityList field value if set, zero value otherwise.
func (o *AlertResources) GetAffectedEntityList() []EntityInfo {
	if o == nil || IsNil(o.AffectedEntityList) {
		var ret []EntityInfo
		return ret
	}
	return o.AffectedEntityList
}

// GetAffectedEntityListOk returns a tuple with the AffectedEntityList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertResources) GetAffectedEntityListOk() ([]EntityInfo, bool) {
	if o == nil || IsNil(o.AffectedEntityList) {
		return nil, false
	}
	return o.AffectedEntityList, true
}
...
// SetAffectedEntityList gets a reference to the given []EntityInfo and assigns it to the AffectedEntityList field.
func (o *AlertResources) SetAffectedEntityList(v []EntityInfo) {
	o.AffectedEntityList = v
}
...
// SetResolutionStatus gets a reference to the given AlertState and assigns it to the ResolutionStatus field.
func (o *AlertResources) SetResolutionStatus(v AlertState) {
	o.ResolutionStatus = &v
}

// GetIndicatorList returns the IndicatorList field value if set, zero value otherwise.
func (o *AlertResources) GetIndicatorList() []Indicator {
	if o == nil || IsNil(o.IndicatorList) {
		var ret []Indicator
		return ret
	}
	return o.IndicatorList
}

// GetIndicatorListOk returns a tuple with the IndicatorList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertResources) GetIndicatorListOk() ([]Indicator, bool) {
	if o == nil || IsNil(o.IndicatorList) {
		return nil, false
	}
	return o.IndicatorList, true
}
...
// SetIndicatorList gets a reference to the given []Indicator and assigns it to the IndicatorList field.
func (o *AlertResources) SetIndicatorList(v []Indicator) {
	o.IndicatorList = v
}

// GetAcknowledgedStatus returns the AcknowledgedStatus field value if set, zero value otherwise.
func (o *AlertResources) GetAcknowledgedStatus() AlertState {
	if o == nil || IsNil(o.AcknowledgedStatus) {
		var ret AlertState
		return ret
	}
	return *o.AcknowledgedStatus
}

// GetAcknowledgedStatusOk returns a tuple with the AcknowledgedStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertResources) GetAcknowledgedStatusOk() (*AlertState, bool) {
	if o == nil || IsNil(o.AcknowledgedStatus) {
		return nil, false
	}
	return o.AcknowledgedStatus, true
}
...
// SetAcknowledgedStatus gets a reference to the given AlertState and assigns it to the AcknowledgedStatus field.
func (o *AlertResources) SetAcknowledgedStatus(v AlertState) {
	o.AcknowledgedStatus = &v
}
...
// GetSeverityTrailList returns the SeverityTrailList field value if set, zero value otherwise.
func (o *AlertResources) GetSeverityTrailList() []AlertResourcesSeverityTrailListInner {
	if o == nil || IsNil(o.SeverityTrailList) {
		var ret []AlertResourcesSeverityTrailListInner
		return ret
	}
	return o.SeverityTrailList
}

// GetSeverityTrailListOk returns a tuple with the SeverityTrailList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertResources) GetSeverityTrailListOk() ([]AlertResourcesSeverityTrailListInner, bool) {
	if o == nil || IsNil(o.SeverityTrailList) {
		return nil, false
	}
	return o.SeverityTrailList, true
}
...
// SetSeverityTrailList gets a reference to the given []AlertResourcesSeverityTrailListInner and assigns it to the SeverityTrailList field.
func (o *AlertResources) SetSeverityTrailList(v []AlertResourcesSeverityTrailListInner) {
	o.SeverityTrailList = v
}

// GetClassificationList returns the ClassificationList field value if set, zero value otherwise.
func (o *AlertResources) GetClassificationList() []string {
	if o == nil || IsNil(o.ClassificationList) {
		var ret []string
		return ret
	}
	return o.ClassificationList
}

// GetClassificationListOk returns a tuple with the ClassificationList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertResources) GetClassificationListOk() ([]string, bool) {
	if o == nil || IsNil(o.ClassificationList) {
		return nil, false
	}
	return o.ClassificationList, true
}
...
// SetClassificationList gets a reference to the given []string and assigns it to the ClassificationList field.
func (o *AlertResources) SetClassificationList(v []string) {
	o.ClassificationList = v
}

// GetPossibleCauseList returns the PossibleCauseList field value if set, zero value otherwise.
func (o *AlertResources) GetPossibleCauseList() []CauseAnalysis {
	if o == nil || IsNil(o.PossibleCauseList) {
		var ret []CauseAnalysis
		return ret
	}
	return o.PossibleCauseList
}

// GetPossibleCauseListOk returns a tuple with the PossibleCauseList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertResources) GetPossibleCauseListOk() ([]CauseAnalysis, bool) {
	if o == nil || IsNil(o.PossibleCauseList) {
		return nil, false
	}
	return o.PossibleCauseList, true
}
...
// SetPossibleCauseList gets a reference to the given []CauseAnalysis and assigns it to the PossibleCauseList field.
func (o *AlertResources) SetPossibleCauseList(v []CauseAnalysis) {
	o.PossibleCauseList = v
}

// GetImpactTypeList returns the ImpactTypeList field value if set, zero value otherwise.
func (o *AlertResources) GetImpactTypeList() []string {
	if o == nil || IsNil(o.ImpactTypeList) {
		var ret []string
		return ret
	}
	return o.ImpactTypeList
}

// GetImpactTypeListOk returns a tuple with the ImpactTypeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertResources) GetImpactTypeListOk() ([]string, bool) {
	if o == nil || IsNil(o.ImpactTypeList) {
		return nil, false
	}
	return o.ImpactTypeList, true
}
...
// SetImpactTypeList gets a reference to the given []string and assigns it to the ImpactTypeList field.
...
// SetParameters gets a reference to the given map[string]ParamValue and assigns it to the Parameters field.
...
// GetImpactList returns the ImpactList field value if set, zero value otherwise.
func (o *AlertResources) GetImpactList() []string {
	if o == nil || IsNil(o.ImpactList) {
		var ret []string
		return ret
	}
	return o.ImpactList
...
// GetImpactListOk returns a tuple with the ImpactList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertResources) GetImpactListOk() ([]string, bool) {
	if o == nil || IsNil(o.ImpactList) {
		return nil, false
	}
	return o.ImpactList, true
}
...
// SetImpactList gets a reference to the given []string and assigns it to the ImpactList field.
func (o *AlertResources) SetImpactList(v []string) {
	o.ImpactList = v
}

// GetLatestOccurrenceTime returns the LatestOccurrenceTime field value if set, zero value otherwise.
func (o *AlertResources) GetLatestOccurrenceTime() time.Time {
	if o == nil || IsNil(o.LatestOccurrenceTime) {
		var ret time.Time
		return ret
	}
	return *o.LatestOccurrenceTime
}

// GetLatestOccurrenceTimeOk returns a tuple with the LatestOccurrenceTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertResources) GetLatestOccurrenceTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LatestOccurrenceTime) {
		return nil, false
	}
	return o.LatestOccurrenceTime, true
}
...
// SetLatestOccurrenceTime gets a reference to the given time.Time and assigns it to the LatestOccurrenceTime field.
func (o *AlertResources) SetLatestOccurrenceTime(v time.Time) {
	o.LatestOccurrenceTime = &v
}

func (o AlertResources) MarshalJSON() ([]byte, error) {
...
func (o AlertResources) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RcaMetadataList) {
		toSerialize["rca_metadata_list"] = o.RcaMetadataList
	}
	if !IsNil(o.AffectedEntityList) {
		toSerialize["affected_entity_list"] = o.AffectedEntityList
	}
	...
	if !IsNil(o.IndicatorList) {
		toSerialize["indicator_list"] = o.IndicatorList
	}
	if !IsNil(o.AcknowledgedStatus) {
		toSerialize["acknowledged_status"] = o.AcknowledgedStatus
	}
	if !IsNil(o.IsUserDefined) {
		toSerialize["is_user_defined"] = o.IsUserDefined
	}
	if !IsNil(o.SeverityTrailList) {
		toSerialize["severity_trail_list"] = o.SeverityTrailList
	}
	if !IsNil(o.ClassificationList) {
		toSerialize["classification_list"] = o.ClassificationList
	}
	if !IsNil(o.PossibleCauseList) {
		toSerialize["possible_cause_list"] = o.PossibleCauseList
	}
	if !IsNil(o.ImpactTypeList) {
		toSerialize["impact_type_list"] = o.ImpactTypeList
	}
	if !IsNil(o.Parameters) {
		toSerialize["parameters"] = o.Parameters
	}
	toSerialize["type"] = o.Type
	if !IsNil(o.ImpactList) {
		toSerialize["impact_list"] = o.ImpactList
	}
	if !IsNil(o.LatestOccurrenceTime) {
		toSerialize["latest_occurrence_time"] = o.LatestOccurrenceTime
	}
...
func (o *AlertResources) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertResources := _AlertResources{}

	err = json.Unmarshal(data, &varAlertResources)

	if err != nil {
		return err
	}

	*o = AlertResources(varAlertResources)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "rca_metadata_list")
		delete(additionalProperties, "affected_entity_list")
		delete(additionalProperties, "severity")
		delete(additionalProperties, "title")
		delete(additionalProperties, "default_message")
		delete(additionalProperties, "creation_time")
		delete(additionalProperties, "resolution_status")
		delete(additionalProperties, "indicator_list")
		delete(additionalProperties, "acknowledged_status")
		delete(additionalProperties, "is_user_defined")
		delete(additionalProperties, "severity_trail_list")
		delete(additionalProperties, "classification_list")
		delete(additionalProperties, "possible_cause_list")
		delete(additionalProperties, "impact_type_list")
		delete(additionalProperties, "parameters")
		delete(additionalProperties, "type")
		delete(additionalProperties, "impact_list")
		delete(additionalProperties, "latest_occurrence_time")
...
type NullableAlertResources struct {
	value *AlertResources
	isSet bool
}

func (v NullableAlertResources) Get() *AlertResources {
	return v.value
}

func (v *NullableAlertResources) Set(val *AlertResources) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertResources) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertResources(val *AlertResources) *NullableAlertResources {
	return &NullableAlertResources{value: val, isSet: true}
}

func (v NullableAlertResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
