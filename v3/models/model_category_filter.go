...
// GetKindList returns the KindList field value if set, zero value otherwise.
func (o *CategoryFilter) GetKindList() []string {
	if o == nil || IsNil(o.KindList) {
		var ret []string
		return ret
	}
	return o.KindList
...
// GetKindListOk returns a tuple with the KindList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CategoryFilter) GetKindListOk() ([]string, bool) {
	if o == nil || IsNil(o.KindList) {
		return nil, false
	}
	return o.KindList, true
}
...
// SetKindList gets a reference to the given []string and assigns it to the KindList field.
...
func (o CategoryFilter) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.KindList) {
		toSerialize["kind_list"] = o.KindList
	}
	if !IsNil(o.Type) {
...
func (o *CategoryFilter) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CategoryFilter(varCategoryFilter)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "kind_list")
