...
// checks if the MhVmStorageConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmStorageConfig{}

// MhVmStorageConfig User inputs of different storage parameters
type MhVmStorageConfig struct {
...
type _MhVmStorageConfig MhVmStorageConfig
...
func (o *MhVmStorageConfig) GetQosPolicy() StorageQosPolicyConfigInput {
	if o == nil || IsNil(o.QosPolicy) {
		var ret StorageQosPolicyConfigInput
		return ret
	}
	return *o.QosPolicy
}
...
// SetQosPolicy gets a reference to the given StorageQosPolicyConfigInput and assigns it to the QosPolicy field.
...
func (o MhVmStorageConfig) MarshalJSON() ([]byte, error) {
...
func (o MhVmStorageConfig) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmStorageConfig) UnmarshalJSON(data []byte) (err error) {
	varMhVmStorageConfig := _MhVmStorageConfig{}

	err = json.Unmarshal(data, &varMhVmStorageConfig)

	if err != nil {
		return err
	}

	*o = MhVmStorageConfig(varMhVmStorageConfig)
...
type NullableMhVmStorageConfig struct {
	value *MhVmStorageConfig
	isSet bool
}

func (v NullableMhVmStorageConfig) Get() *MhVmStorageConfig {
	return v.value
}

func (v *NullableMhVmStorageConfig) Set(val *MhVmStorageConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmStorageConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmStorageConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmStorageConfig(val *MhVmStorageConfig) *NullableMhVmStorageConfig {
	return &NullableMhVmStorageConfig{value: val, isSet: true}
}

func (v NullableMhVmStorageConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmStorageConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
