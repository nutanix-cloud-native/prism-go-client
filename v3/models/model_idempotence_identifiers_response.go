...
// checks if the IdempotenceIdentifiersResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdempotenceIdentifiersResponse{}
...
type _IdempotenceIdentifiersResponse IdempotenceIdentifiersResponse
...
func NewIdempotenceIdentifiersResponse(count int32, uuidList []string) *IdempotenceIdentifiersResponse {
	this := IdempotenceIdentifiersResponse{}
	this.Count = count
...
// GetUuidList returns the UuidList field value
...
// GetUuidListOk returns a tuple with the UuidList field value
// and a boolean to check if the value has been set.
...
// SetUuidList sets field value
func (o *IdempotenceIdentifiersResponse) SetUuidList(v []string) {
	o.UuidList = v
}

func (o IdempotenceIdentifiersResponse) MarshalJSON() ([]byte, error) {
...
func (o IdempotenceIdentifiersResponse) ToMap() (map[string]interface{}, error) {
...
func (o *IdempotenceIdentifiersResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varIdempotenceIdentifiersResponse := _IdempotenceIdentifiersResponse{}

	err = json.Unmarshal(data, &varIdempotenceIdentifiersResponse)

	if err != nil {
		return err
	}

	*o = IdempotenceIdentifiersResponse(varIdempotenceIdentifiersResponse)
...
type NullableIdempotenceIdentifiersResponse struct {
	value *IdempotenceIdentifiersResponse
	isSet bool
}

func (v NullableIdempotenceIdentifiersResponse) Get() *IdempotenceIdentifiersResponse {
	return v.value
}

func (v *NullableIdempotenceIdentifiersResponse) Set(val *IdempotenceIdentifiersResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIdempotenceIdentifiersResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIdempotenceIdentifiersResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdempotenceIdentifiersResponse(val *IdempotenceIdentifiersResponse) *NullableIdempotenceIdentifiersResponse {
	return &NullableIdempotenceIdentifiersResponse{value: val, isSet: true}
}

func (v NullableIdempotenceIdentifiersResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdempotenceIdentifiersResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
