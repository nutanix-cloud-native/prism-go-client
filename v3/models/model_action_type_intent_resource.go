...
// checks if the ActionTypeIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTypeIntentResource{}

// ActionTypeIntentResource Response object for intentful operations on a action_type
type ActionTypeIntentResource struct {
...
type _ActionTypeIntentResource ActionTypeIntentResource
...
func (o ActionTypeIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ActionTypeIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTypeIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTypeIntentResource := _ActionTypeIntentResource{}

	err = json.Unmarshal(data, &varActionTypeIntentResource)

	if err != nil {
		return err
	}

	*o = ActionTypeIntentResource(varActionTypeIntentResource)
...
type NullableActionTypeIntentResource struct {
	value *ActionTypeIntentResource
	isSet bool
}

func (v NullableActionTypeIntentResource) Get() *ActionTypeIntentResource {
	return v.value
}

func (v *NullableActionTypeIntentResource) Set(val *ActionTypeIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTypeIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTypeIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTypeIntentResource(val *ActionTypeIntentResource) *NullableActionTypeIntentResource {
	return &NullableActionTypeIntentResource{value: val, isSet: true}
}

func (v NullableActionTypeIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTypeIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
