...
// checks if the AppCredentialReferenceUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCredentialReferenceUpload{}

// AppCredentialReferenceUpload The reference to a app_credential
type AppCredentialReferenceUpload struct {
	// The kind name
...
type _AppCredentialReferenceUpload AppCredentialReferenceUpload
...
func NewAppCredentialReferenceUpload(kind string, name string) *AppCredentialReferenceUpload {
	this := AppCredentialReferenceUpload{}
	this.Kind = kind
	this.Name = name
	return &this
}
...
func (o AppCredentialReferenceUpload) MarshalJSON() ([]byte, error) {
...
func (o AppCredentialReferenceUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppCredentialReferenceUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCredentialReferenceUpload := _AppCredentialReferenceUpload{}

	err = json.Unmarshal(data, &varAppCredentialReferenceUpload)

	if err != nil {
		return err
	}

	*o = AppCredentialReferenceUpload(varAppCredentialReferenceUpload)
...
type NullableAppCredentialReferenceUpload struct {
	value *AppCredentialReferenceUpload
	isSet bool
}

func (v NullableAppCredentialReferenceUpload) Get() *AppCredentialReferenceUpload {
	return v.value
}

func (v *NullableAppCredentialReferenceUpload) Set(val *AppCredentialReferenceUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCredentialReferenceUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCredentialReferenceUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCredentialReferenceUpload(val *AppCredentialReferenceUpload) *NullableAppCredentialReferenceUpload {
	return &NullableAppCredentialReferenceUpload{value: val, isSet: true}
}

func (v NullableAppCredentialReferenceUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCredentialReferenceUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
