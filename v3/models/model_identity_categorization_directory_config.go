...
// checks if the IdentityCategorizationDirectoryConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityCategorizationDirectoryConfig{}

// IdentityCategorizationDirectoryConfig Identity categorization directory config.
type IdentityCategorizationDirectoryConfig struct {
	// The matching criteria used to determine whether an entity will be affected by identity categorization. If not provided, no entity will be affected. Only a single entry in this list is supported today. 
	MatchingCriteriaList []IdCategorizationMatchingCriteria `json:"matching_criteria_list,omitempty"`
	// List of domain controllers to be used for event scraping.
	DomainControllerList []IdCategorizationDomainController `json:"domain_controller_list,omitempty"`
	DirectoryServiceReference DirectoryServiceReference `json:"directory_service_reference"`
	AdditionalProperties map[string]interface{}
}

type _IdentityCategorizationDirectoryConfig IdentityCategorizationDirectoryConfig
...
func NewIdentityCategorizationDirectoryConfig(directoryServiceReference DirectoryServiceReference) *IdentityCategorizationDirectoryConfig {
	this := IdentityCategorizationDirectoryConfig{}
...
// GetMatchingCriteriaList returns the MatchingCriteriaList field value if set, zero value otherwise.
func (o *IdentityCategorizationDirectoryConfig) GetMatchingCriteriaList() []IdCategorizationMatchingCriteria {
	if o == nil || IsNil(o.MatchingCriteriaList) {
		var ret []IdCategorizationMatchingCriteria
		return ret
	}
	return o.MatchingCriteriaList
}

// GetMatchingCriteriaListOk returns a tuple with the MatchingCriteriaList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdentityCategorizationDirectoryConfig) GetMatchingCriteriaListOk() ([]IdCategorizationMatchingCriteria, bool) {
	if o == nil || IsNil(o.MatchingCriteriaList) {
		return nil, false
	}
	return o.MatchingCriteriaList, true
}
...
// SetMatchingCriteriaList gets a reference to the given []IdCategorizationMatchingCriteria and assigns it to the MatchingCriteriaList field.
func (o *IdentityCategorizationDirectoryConfig) SetMatchingCriteriaList(v []IdCategorizationMatchingCriteria) {
	o.MatchingCriteriaList = v
}

// GetDomainControllerList returns the DomainControllerList field value if set, zero value otherwise.
func (o *IdentityCategorizationDirectoryConfig) GetDomainControllerList() []IdCategorizationDomainController {
	if o == nil || IsNil(o.DomainControllerList) {
		var ret []IdCategorizationDomainController
		return ret
	}
	return o.DomainControllerList
}

// GetDomainControllerListOk returns a tuple with the DomainControllerList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdentityCategorizationDirectoryConfig) GetDomainControllerListOk() ([]IdCategorizationDomainController, bool) {
	if o == nil || IsNil(o.DomainControllerList) {
		return nil, false
	}
	return o.DomainControllerList, true
}
...
// SetDomainControllerList gets a reference to the given []IdCategorizationDomainController and assigns it to the DomainControllerList field.
func (o *IdentityCategorizationDirectoryConfig) SetDomainControllerList(v []IdCategorizationDomainController) {
	o.DomainControllerList = v
}

// GetDirectoryServiceReference returns the DirectoryServiceReference field value
func (o *IdentityCategorizationDirectoryConfig) GetDirectoryServiceReference() DirectoryServiceReference {
	if o == nil {
		var ret DirectoryServiceReference
		return ret
	}

	return o.DirectoryServiceReference
}

// GetDirectoryServiceReferenceOk returns a tuple with the DirectoryServiceReference field value
// and a boolean to check if the value has been set.
func (o *IdentityCategorizationDirectoryConfig) GetDirectoryServiceReferenceOk() (*DirectoryServiceReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DirectoryServiceReference, true
}

// SetDirectoryServiceReference sets field value
func (o *IdentityCategorizationDirectoryConfig) SetDirectoryServiceReference(v DirectoryServiceReference) {
	o.DirectoryServiceReference = v
}

func (o IdentityCategorizationDirectoryConfig) MarshalJSON() ([]byte, error) {
...
func (o IdentityCategorizationDirectoryConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.MatchingCriteriaList) {
		toSerialize["matching_criteria_list"] = o.MatchingCriteriaList
	}
	if !IsNil(o.DomainControllerList) {
		toSerialize["domain_controller_list"] = o.DomainControllerList
	}
	toSerialize["directory_service_reference"] = o.DirectoryServiceReference
...
func (o *IdentityCategorizationDirectoryConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varIdentityCategorizationDirectoryConfig := _IdentityCategorizationDirectoryConfig{}

	err = json.Unmarshal(data, &varIdentityCategorizationDirectoryConfig)

	if err != nil {
		return err
	}

	*o = IdentityCategorizationDirectoryConfig(varIdentityCategorizationDirectoryConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "matching_criteria_list")
		delete(additionalProperties, "domain_controller_list")
		delete(additionalProperties, "directory_service_reference")
...
type NullableIdentityCategorizationDirectoryConfig struct {
	value *IdentityCategorizationDirectoryConfig
	isSet bool
}

func (v NullableIdentityCategorizationDirectoryConfig) Get() *IdentityCategorizationDirectoryConfig {
	return v.value
}

func (v *NullableIdentityCategorizationDirectoryConfig) Set(val *IdentityCategorizationDirectoryConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityCategorizationDirectoryConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityCategorizationDirectoryConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityCategorizationDirectoryConfig(val *IdentityCategorizationDirectoryConfig) *NullableIdentityCategorizationDirectoryConfig {
	return &NullableIdentityCategorizationDirectoryConfig{value: val, isSet: true}
}

func (v NullableIdentityCategorizationDirectoryConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityCategorizationDirectoryConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
