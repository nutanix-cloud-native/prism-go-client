...
// checks if the AppPackageReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPackageReference{}

// AppPackageReference The reference to a app_package
...
type _AppPackageReference AppPackageReference
...
func (o AppPackageReference) MarshalJSON() ([]byte, error) {
...
func (o AppPackageReference) ToMap() (map[string]interface{}, error) {
...
func (o *AppPackageReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPackageReference := _AppPackageReference{}

	err = json.Unmarshal(data, &varAppPackageReference)

	if err != nil {
		return err
	}

	*o = AppPackageReference(varAppPackageReference)
...
type NullableAppPackageReference struct {
	value *AppPackageReference
	isSet bool
}

func (v NullableAppPackageReference) Get() *AppPackageReference {
	return v.value
}

func (v *NullableAppPackageReference) Set(val *AppPackageReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPackageReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPackageReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPackageReference(val *AppPackageReference) *NullableAppPackageReference {
	return &NullableAppPackageReference{value: val, isSet: true}
}

func (v NullableAppPackageReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPackageReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
