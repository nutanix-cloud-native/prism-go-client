...
// checks if the VirtualNetworkReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkReference{}

// VirtualNetworkReference The reference to a virtual_network
...
type _VirtualNetworkReference VirtualNetworkReference
...
func (o VirtualNetworkReference) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkReference) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualNetworkReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualNetworkReference := _VirtualNetworkReference{}

	err = json.Unmarshal(data, &varVirtualNetworkReference)

	if err != nil {
		return err
	}

	*o = VirtualNetworkReference(varVirtualNetworkReference)
...
type NullableVirtualNetworkReference struct {
	value *VirtualNetworkReference
	isSet bool
}

func (v NullableVirtualNetworkReference) Get() *VirtualNetworkReference {
	return v.value
}

func (v *NullableVirtualNetworkReference) Set(val *VirtualNetworkReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkReference(val *VirtualNetworkReference) *NullableVirtualNetworkReference {
	return &NullableVirtualNetworkReference{value: val, isSet: true}
}

func (v NullableVirtualNetworkReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
