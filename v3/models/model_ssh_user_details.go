...
// checks if the SshUserDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserDetails{}

// SshUserDetails SSH User details
type SshUserDetails struct {
	// SSH User name
	...
	// List of IP addresses to the entity which the user requested access to
	EntityList []SshUserDetailsEntityListInner `json:"entity_list"`
	AdditionalProperties map[string]interface{}
}

type _SshUserDetails SshUserDetails
...
func (o *SshUserDetails) GetEntityList() []SshUserDetailsEntityListInner {
	if o == nil {
		var ret []SshUserDetailsEntityListInner
		return ret
	}
...
func (o SshUserDetails) MarshalJSON() ([]byte, error) {
...
func (o SshUserDetails) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varSshUserDetails := _SshUserDetails{}

	err = json.Unmarshal(data, &varSshUserDetails)

	if err != nil {
		return err
	}

	*o = SshUserDetails(varSshUserDetails)
...
type NullableSshUserDetails struct {
	value *SshUserDetails
	isSet bool
}

func (v NullableSshUserDetails) Get() *SshUserDetails {
	return v.value
}

func (v *NullableSshUserDetails) Set(val *SshUserDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserDetails(val *SshUserDetails) *NullableSshUserDetails {
	return &NullableSshUserDetails{value: val, isSet: true}
}

func (v NullableSshUserDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
