...
// checks if the AwsKeyPairDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsKeyPairDefStatus{}

// AwsKeyPairDefStatus aws_key_pair resources status
type AwsKeyPairDefStatus struct {
	State *string `json:"state,omitempty"`
	// aws_key_pair name.
	Name *string `json:"name,omitempty"`
	Resources *AwsKeyPairResourcesDefStatus `json:"resources,omitempty"`
	// A description for aws_key_pair.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsKeyPairDefStatus AwsKeyPairDefStatus
...
func (o *AwsKeyPairDefStatus) GetResources() AwsKeyPairResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret AwsKeyPairResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given AwsKeyPairResourcesDefStatus and assigns it to the Resources field.
...
func (o AwsKeyPairDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsKeyPairDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsKeyPairDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsKeyPairDefStatus := _AwsKeyPairDefStatus{}

	err = json.Unmarshal(data, &varAwsKeyPairDefStatus)

	if err != nil {
		return err
	}

	*o = AwsKeyPairDefStatus(varAwsKeyPairDefStatus)
...
type NullableAwsKeyPairDefStatus struct {
	value *AwsKeyPairDefStatus
	isSet bool
}

func (v NullableAwsKeyPairDefStatus) Get() *AwsKeyPairDefStatus {
	return v.value
}

func (v *NullableAwsKeyPairDefStatus) Set(val *AwsKeyPairDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsKeyPairDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsKeyPairDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsKeyPairDefStatus(val *AwsKeyPairDefStatus) *NullableAwsKeyPairDefStatus {
	return &NullableAwsKeyPairDefStatus{value: val, isSet: true}
}

func (v NullableAwsKeyPairDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsKeyPairDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
