...
// checks if the AwsImageResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsImageResourcesDefStatus{}

// AwsImageResourcesDefStatus AWS image resources
type AwsImageResourcesDefStatus struct {
	// Root device type (e.g. ebs, instance-store)
	RootDeviceType *string `json:"root_device_type,omitempty"`
	// Kernal AWS ID of the image.
	KernelId *string `json:"kernel_id,omitempty"`
	// The supported hypervisor.
	Hypervisor *string `json:"hypervisor,omitempty"`
	// The AWS ID of the AMI.
	Id *string `json:"id,omitempty" validate:"regexp=^ami-[a-f0-9]{1,17}$"`
	// Platform of the image (e.g. Windows)
	Platform *string `json:"platform,omitempty"`
	// Architecture of the AWS image (e.g. i386, x86_64)
	Architecture *string `json:"architecture,omitempty"`
	// The AWS Tags associated with any AWS resource
	TagList []AwsTagListInner `json:"tag_list,omitempty"`
	// Type of virtualization supported.
	VirtualizationType *string `json:"virtualization_type,omitempty"`
	// Root device name (e.g. /dev/sda1, /dev/sda2)
	RootDeviceName *string `json:"root_device_name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsImageResourcesDefStatus AwsImageResourcesDefStatus
...
func NewAwsImageResourcesDefStatus() *AwsImageResourcesDefStatus {
	this := AwsImageResourcesDefStatus{}
	return &this
}
...
func (o AwsImageResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsImageResourcesDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsImageResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsImageResourcesDefStatus := _AwsImageResourcesDefStatus{}

	err = json.Unmarshal(data, &varAwsImageResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = AwsImageResourcesDefStatus(varAwsImageResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "root_device_type")
		delete(additionalProperties, "kernel_id")
...
type NullableAwsImageResourcesDefStatus struct {
	value *AwsImageResourcesDefStatus
	isSet bool
}

func (v NullableAwsImageResourcesDefStatus) Get() *AwsImageResourcesDefStatus {
	return v.value
}

func (v *NullableAwsImageResourcesDefStatus) Set(val *AwsImageResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsImageResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsImageResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsImageResourcesDefStatus(val *AwsImageResourcesDefStatus) *NullableAwsImageResourcesDefStatus {
	return &NullableAwsImageResourcesDefStatus{value: val, isSet: true}
}

func (v NullableAwsImageResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsImageResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
