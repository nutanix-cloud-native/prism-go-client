...
// checks if the StreamingPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicy{}

// StreamingPolicy Streaming Policy Entity
type StreamingPolicy struct {
	// Policy name
	Name string `json:"name"`
	Resources StreamingPolicyRequestDetails `json:"resources"`
	// Policy description
	Description string `json:"description"`
	AdditionalProperties map[string]interface{}
}

type _StreamingPolicy StreamingPolicy
...
func (o *StreamingPolicy) GetResources() StreamingPolicyRequestDetails {
	if o == nil {
		var ret StreamingPolicyRequestDetails
		return ret
	}
...
func (o StreamingPolicy) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varStreamingPolicy := _StreamingPolicy{}

	err = json.Unmarshal(data, &varStreamingPolicy)

	if err != nil {
		return err
	}

	*o = StreamingPolicy(varStreamingPolicy)
...
type NullableStreamingPolicy struct {
	value *StreamingPolicy
	isSet bool
}

func (v NullableStreamingPolicy) Get() *StreamingPolicy {
	return v.value
}

func (v *NullableStreamingPolicy) Set(val *StreamingPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicy(val *StreamingPolicy) *NullableStreamingPolicy {
	return &NullableStreamingPolicy{value: val, isSet: true}
}

func (v NullableStreamingPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
