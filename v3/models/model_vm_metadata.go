...
// checks if the VmMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmMetadata{}

// VmMetadata The vm kind metadata
type VmMetadata struct {
	...
	// Categories for the vm. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the vm. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
func (o VmMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVmMetadata := _VmMetadata{}

	err = json.Unmarshal(data, &varVmMetadata)

	if err != nil {
		return err
	}

	*o = VmMetadata(varVmMetadata)
...
type NullableVmMetadata struct {
	value *VmMetadata
	isSet bool
}

func (v NullableVmMetadata) Get() *VmMetadata {
	return v.value
}

func (v *NullableVmMetadata) Set(val *VmMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmMetadata(val *VmMetadata) *NullableVmMetadata {
	return &NullableVmMetadata{value: val, isSet: true}
}

func (v NullableVmMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
