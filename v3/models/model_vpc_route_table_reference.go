...
// checks if the VpcRouteTableReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcRouteTableReference{}

// VpcRouteTableReference The reference to a vpc_route_table
type VpcRouteTableReference struct {
	// The kind name
...
type _VpcRouteTableReference VpcRouteTableReference
...
func (o VpcRouteTableReference) MarshalJSON() ([]byte, error) {
...
func (o VpcRouteTableReference) ToMap() (map[string]interface{}, error) {
...
func (o *VpcRouteTableReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVpcRouteTableReference := _VpcRouteTableReference{}

	err = json.Unmarshal(data, &varVpcRouteTableReference)

	if err != nil {
		return err
	}

	*o = VpcRouteTableReference(varVpcRouteTableReference)
...
type NullableVpcRouteTableReference struct {
	value *VpcRouteTableReference
	isSet bool
}

func (v NullableVpcRouteTableReference) Get() *VpcRouteTableReference {
	return v.value
}

func (v *NullableVpcRouteTableReference) Set(val *VpcRouteTableReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcRouteTableReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcRouteTableReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcRouteTableReference(val *VpcRouteTableReference) *NullableVpcRouteTableReference {
	return &NullableVpcRouteTableReference{value: val, isSet: true}
}

func (v NullableVpcRouteTableReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcRouteTableReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
