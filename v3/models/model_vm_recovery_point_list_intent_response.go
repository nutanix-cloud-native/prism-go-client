...
// checks if the VmRecoveryPointListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPointListIntentResponse{}
...
type VmRecoveryPointListIntentResponse struct {
	Entities []VmRecoveryPointIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata VmRecoveryPointListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VmRecoveryPointListIntentResponse VmRecoveryPointListIntentResponse
...
func NewVmRecoveryPointListIntentResponse(apiVersion string, metadata VmRecoveryPointListMetadataOutput) *VmRecoveryPointListIntentResponse {
	this := VmRecoveryPointListIntentResponse{}
...
func (o *VmRecoveryPointListIntentResponse) GetEntities() []VmRecoveryPointIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []VmRecoveryPointIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []VmRecoveryPointIntentResource and assigns it to the Entities field.
...
func (o *VmRecoveryPointListIntentResponse) GetMetadata() VmRecoveryPointListMetadataOutput {
	if o == nil {
		var ret VmRecoveryPointListMetadataOutput
		return ret
	}
...
func (o VmRecoveryPointListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPointListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPointListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVmRecoveryPointListIntentResponse := _VmRecoveryPointListIntentResponse{}

	err = json.Unmarshal(data, &varVmRecoveryPointListIntentResponse)

	if err != nil {
		return err
	}

	*o = VmRecoveryPointListIntentResponse(varVmRecoveryPointListIntentResponse)
...
type NullableVmRecoveryPointListIntentResponse struct {
	value *VmRecoveryPointListIntentResponse
	isSet bool
}

func (v NullableVmRecoveryPointListIntentResponse) Get() *VmRecoveryPointListIntentResponse {
	return v.value
}

func (v *NullableVmRecoveryPointListIntentResponse) Set(val *VmRecoveryPointListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPointListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPointListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPointListIntentResponse(val *VmRecoveryPointListIntentResponse) *NullableVmRecoveryPointListIntentResponse {
	return &NullableVmRecoveryPointListIntentResponse{value: val, isSet: true}
}

func (v NullableVmRecoveryPointListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPointListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
