...
// checks if the DatacenterMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterMetadata{}

// DatacenterMetadata The datacenter kind metadata
type DatacenterMetadata struct {
	...
	// Categories for the datacenter. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the datacenter. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _DatacenterMetadata DatacenterMetadata
...
func (o *DatacenterMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *DatacenterMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *DatacenterMetadata) SetName(v string) {
	o.Name = &v
}

func (o DatacenterMetadata) MarshalJSON() ([]byte, error) {
...
func (o DatacenterMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DatacenterMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varDatacenterMetadata := _DatacenterMetadata{}

	err = json.Unmarshal(data, &varDatacenterMetadata)

	if err != nil {
		return err
	}

	*o = DatacenterMetadata(varDatacenterMetadata)
...
type NullableDatacenterMetadata struct {
	value *DatacenterMetadata
	isSet bool
}

func (v NullableDatacenterMetadata) Get() *DatacenterMetadata {
	return v.value
}

func (v *NullableDatacenterMetadata) Set(val *DatacenterMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterMetadata(val *DatacenterMetadata) *NullableDatacenterMetadata {
	return &NullableDatacenterMetadata{value: val, isSet: true}
}

func (v NullableDatacenterMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
