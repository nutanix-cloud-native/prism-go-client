...
// checks if the SubnetIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubnetIntentResource{}

// SubnetIntentResource Response object for intentful operations on a subnet
...
type _SubnetIntentResource SubnetIntentResource
...
// SetStatus gets a reference to the given SubnetDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Subnet and assigns it to the Spec field.
...
func (o SubnetIntentResource) MarshalJSON() ([]byte, error) {
...
func (o SubnetIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *SubnetIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varSubnetIntentResource := _SubnetIntentResource{}

	err = json.Unmarshal(data, &varSubnetIntentResource)

	if err != nil {
		return err
	}

	*o = SubnetIntentResource(varSubnetIntentResource)
...
type NullableSubnetIntentResource struct {
	value *SubnetIntentResource
	isSet bool
}

func (v NullableSubnetIntentResource) Get() *SubnetIntentResource {
	return v.value
}

func (v *NullableSubnetIntentResource) Set(val *SubnetIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableSubnetIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableSubnetIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubnetIntentResource(val *SubnetIntentResource) *NullableSubnetIntentResource {
	return &NullableSubnetIntentResource{value: val, isSet: true}
}

func (v NullableSubnetIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubnetIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
