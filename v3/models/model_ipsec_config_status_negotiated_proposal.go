...
// checks if the IpsecConfigStatusNegotiatedProposal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpsecConfigStatusNegotiatedProposal{}

// IpsecConfigStatusNegotiatedProposal Describes the proposal (encryption and authentication algorithms) that was negotiated for this VPN connection. 
type IpsecConfigStatusNegotiatedProposal struct {
	// Authentication algorithm used in IPSEC.
	IpsecAuthenticationAlgorithm *string `json:"ipsec_authentication_algorithm,omitempty"`
	// Encryption algorithm used in IPSEC.
	IpsecEncryptionAlgorithm *string `json:"ipsec_encryption_algorithm,omitempty"`
	// Encryption algorithm used in IKE.
	IkeEncryptionAlgorithm *string `json:"ike_encryption_algorithm,omitempty"`
	// Authentication algorithm used in IKE.
	IkeAuthenticationAlgorithm *string `json:"ike_authentication_algorithm,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _IpsecConfigStatusNegotiatedProposal IpsecConfigStatusNegotiatedProposal
...
func NewIpsecConfigStatusNegotiatedProposal() *IpsecConfigStatusNegotiatedProposal {
	this := IpsecConfigStatusNegotiatedProposal{}
	return &this
}
...
func (o IpsecConfigStatusNegotiatedProposal) MarshalJSON() ([]byte, error) {
...
func (o IpsecConfigStatusNegotiatedProposal) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IpsecAuthenticationAlgorithm) {
		toSerialize["ipsec_authentication_algorithm"] = o.IpsecAuthenticationAlgorithm
	}
	if !IsNil(o.IpsecEncryptionAlgorithm) {
		toSerialize["ipsec_encryption_algorithm"] = o.IpsecEncryptionAlgorithm
	}
	if !IsNil(o.IkeEncryptionAlgorithm) {
		toSerialize["ike_encryption_algorithm"] = o.IkeEncryptionAlgorithm
	}
	if !IsNil(o.IkeAuthenticationAlgorithm) {
		toSerialize["ike_authentication_algorithm"] = o.IkeAuthenticationAlgorithm
	}
...
func (o *IpsecConfigStatusNegotiatedProposal) UnmarshalJSON(data []byte) (err error) {
	varIpsecConfigStatusNegotiatedProposal := _IpsecConfigStatusNegotiatedProposal{}

	err = json.Unmarshal(data, &varIpsecConfigStatusNegotiatedProposal)

	if err != nil {
		return err
	}

	*o = IpsecConfigStatusNegotiatedProposal(varIpsecConfigStatusNegotiatedProposal)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "ipsec_authentication_algorithm")
		delete(additionalProperties, "ipsec_encryption_algorithm")
		delete(additionalProperties, "ike_encryption_algorithm")
		delete(additionalProperties, "ike_authentication_algorithm")
...
type NullableIpsecConfigStatusNegotiatedProposal struct {
	value *IpsecConfigStatusNegotiatedProposal
	isSet bool
}

func (v NullableIpsecConfigStatusNegotiatedProposal) Get() *IpsecConfigStatusNegotiatedProposal {
	return v.value
}

func (v *NullableIpsecConfigStatusNegotiatedProposal) Set(val *IpsecConfigStatusNegotiatedProposal) {
	v.value = val
	v.isSet = true
}

func (v NullableIpsecConfigStatusNegotiatedProposal) IsSet() bool {
	return v.isSet
}

func (v *NullableIpsecConfigStatusNegotiatedProposal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpsecConfigStatusNegotiatedProposal(val *IpsecConfigStatusNegotiatedProposal) *NullableIpsecConfigStatusNegotiatedProposal {
	return &NullableIpsecConfigStatusNegotiatedProposal{value: val, isSet: true}
}

func (v NullableIpsecConfigStatusNegotiatedProposal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpsecConfigStatusNegotiatedProposal) UnmarshalJSON(src []byte) error {
	v.isSet = true
