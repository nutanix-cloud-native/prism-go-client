...
// checks if the CommonReportConfigListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigListMetadataOutput{}

// CommonReportConfigListMetadataOutput All api calls that return a list will have this metadata block 
type CommonReportConfigListMetadataOutput struct {
	// The kind name
...
type _CommonReportConfigListMetadataOutput CommonReportConfigListMetadataOutput
...
func NewCommonReportConfigListMetadataOutput() *CommonReportConfigListMetadataOutput {
	this := CommonReportConfigListMetadataOutput{}
	var kind string = "common_report_config"
	this.Kind = &kind
	return &this
}
...
func (o *CommonReportConfigListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *CommonReportConfigListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o CommonReportConfigListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfigListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varCommonReportConfigListMetadataOutput := _CommonReportConfigListMetadataOutput{}

	err = json.Unmarshal(data, &varCommonReportConfigListMetadataOutput)

	if err != nil {
		return err
	}

	*o = CommonReportConfigListMetadataOutput(varCommonReportConfigListMetadataOutput)
...
type NullableCommonReportConfigListMetadataOutput struct {
	value *CommonReportConfigListMetadataOutput
	isSet bool
}

func (v NullableCommonReportConfigListMetadataOutput) Get() *CommonReportConfigListMetadataOutput {
	return v.value
}

func (v *NullableCommonReportConfigListMetadataOutput) Set(val *CommonReportConfigListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigListMetadataOutput(val *CommonReportConfigListMetadataOutput) *NullableCommonReportConfigListMetadataOutput {
	return &NullableCommonReportConfigListMetadataOutput{value: val, isSet: true}
}

func (v NullableCommonReportConfigListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
