...
// checks if the AppDeploymentReferenceUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppDeploymentReferenceUpload{}

// AppDeploymentReferenceUpload The reference to a app_deployment
type AppDeploymentReferenceUpload struct {
	// The kind name
...
type _AppDeploymentReferenceUpload AppDeploymentReferenceUpload
...
func NewAppDeploymentReferenceUpload(kind string, name string) *AppDeploymentReferenceUpload {
	this := AppDeploymentReferenceUpload{}
	this.Kind = kind
	this.Name = name
	return &this
}
...
func (o AppDeploymentReferenceUpload) MarshalJSON() ([]byte, error) {
...
func (o AppDeploymentReferenceUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppDeploymentReferenceUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppDeploymentReferenceUpload := _AppDeploymentReferenceUpload{}

	err = json.Unmarshal(data, &varAppDeploymentReferenceUpload)

	if err != nil {
		return err
	}

	*o = AppDeploymentReferenceUpload(varAppDeploymentReferenceUpload)
...
type NullableAppDeploymentReferenceUpload struct {
	value *AppDeploymentReferenceUpload
	isSet bool
}

func (v NullableAppDeploymentReferenceUpload) Get() *AppDeploymentReferenceUpload {
	return v.value
}

func (v *NullableAppDeploymentReferenceUpload) Set(val *AppDeploymentReferenceUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppDeploymentReferenceUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppDeploymentReferenceUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppDeploymentReferenceUpload(val *AppDeploymentReferenceUpload) *NullableAppDeploymentReferenceUpload {
	return &NullableAppDeploymentReferenceUpload{value: val, isSet: true}
}

func (v NullableAppDeploymentReferenceUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppDeploymentReferenceUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
