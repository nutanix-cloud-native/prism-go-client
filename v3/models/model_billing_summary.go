...
// checks if the BillingSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingSummary{}

// BillingSummary Usage details for the current tenant grouped by aggregation unit defined in grouped_by. 
type BillingSummary struct {
	ChargeGroupList []BillingSummaryChargeGroup `json:"charge_group_list,omitempty"`
	// Aggregation unit based on which charges are grouped by.
	GroupedBy *string `json:"grouped_by,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _BillingSummary BillingSummary
...
// GetChargeGroupList returns the ChargeGroupList field value if set, zero value otherwise.
func (o *BillingSummary) GetChargeGroupList() []BillingSummaryChargeGroup {
	if o == nil || IsNil(o.ChargeGroupList) {
		var ret []BillingSummaryChargeGroup
		return ret
	}
	return o.ChargeGroupList
}

// GetChargeGroupListOk returns a tuple with the ChargeGroupList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BillingSummary) GetChargeGroupListOk() ([]BillingSummaryChargeGroup, bool) {
	if o == nil || IsNil(o.ChargeGroupList) {
		return nil, false
	}
	return o.ChargeGroupList, true
}
...
// SetChargeGroupList gets a reference to the given []BillingSummaryChargeGroup and assigns it to the ChargeGroupList field.
...
// SetGroupedBy gets a reference to the given string and assigns it to the GroupedBy field.
func (o *BillingSummary) SetGroupedBy(v string) {
	o.GroupedBy = &v
}

func (o BillingSummary) MarshalJSON() ([]byte, error) {
...
func (o BillingSummary) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ChargeGroupList) {
		toSerialize["charge_group_list"] = o.ChargeGroupList
	}
...
func (o *BillingSummary) UnmarshalJSON(data []byte) (err error) {
	varBillingSummary := _BillingSummary{}

	err = json.Unmarshal(data, &varBillingSummary)

	if err != nil {
		return err
	}

	*o = BillingSummary(varBillingSummary)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "charge_group_list")
		delete(additionalProperties, "grouped_by")
...
type NullableBillingSummary struct {
	value *BillingSummary
	isSet bool
}

func (v NullableBillingSummary) Get() *BillingSummary {
	return v.value
}

func (v *NullableBillingSummary) Set(val *BillingSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingSummary(val *BillingSummary) *NullableBillingSummary {
	return &NullableBillingSummary{value: val, isSet: true}
}

func (v NullableBillingSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
