...
// checks if the EntitySyncRuleListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySyncRuleListMetadataOutput{}

// EntitySyncRuleListMetadataOutput All api calls that return a list will have this metadata block 
type EntitySyncRuleListMetadataOutput struct {
	// The kind name
...
type _EntitySyncRuleListMetadataOutput EntitySyncRuleListMetadataOutput
...
func NewEntitySyncRuleListMetadataOutput() *EntitySyncRuleListMetadataOutput {
	this := EntitySyncRuleListMetadataOutput{}
	var kind string = "entity_sync_rule"
	this.Kind = &kind
	return &this
}
...
func (o EntitySyncRuleListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o EntitySyncRuleListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *EntitySyncRuleListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varEntitySyncRuleListMetadataOutput := _EntitySyncRuleListMetadataOutput{}

	err = json.Unmarshal(data, &varEntitySyncRuleListMetadataOutput)

	if err != nil {
		return err
	}

	*o = EntitySyncRuleListMetadataOutput(varEntitySyncRuleListMetadataOutput)
...
type NullableEntitySyncRuleListMetadataOutput struct {
	value *EntitySyncRuleListMetadataOutput
	isSet bool
}

func (v NullableEntitySyncRuleListMetadataOutput) Get() *EntitySyncRuleListMetadataOutput {
	return v.value
}

func (v *NullableEntitySyncRuleListMetadataOutput) Set(val *EntitySyncRuleListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySyncRuleListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySyncRuleListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySyncRuleListMetadataOutput(val *EntitySyncRuleListMetadataOutput) *NullableEntitySyncRuleListMetadataOutput {
	return &NullableEntitySyncRuleListMetadataOutput{value: val, isSet: true}
}

func (v NullableEntitySyncRuleListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySyncRuleListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
