...
// checks if the ActionTriggerTypeMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTriggerTypeMetadata{}

// ActionTriggerTypeMetadata The action_trigger_type kind metadata
type ActionTriggerTypeMetadata struct {
	...
	// Categories for the action_trigger_type. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the action_trigger_type. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _ActionTriggerTypeMetadata ActionTriggerTypeMetadata
...
func NewActionTriggerTypeMetadata(kind string) *ActionTriggerTypeMetadata {
	this := ActionTriggerTypeMetadata{}
...
func (o ActionTriggerTypeMetadata) MarshalJSON() ([]byte, error) {
...
func (o ActionTriggerTypeMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTriggerTypeMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTriggerTypeMetadata := _ActionTriggerTypeMetadata{}

	err = json.Unmarshal(data, &varActionTriggerTypeMetadata)

	if err != nil {
		return err
	}

	*o = ActionTriggerTypeMetadata(varActionTriggerTypeMetadata)
...
type NullableActionTriggerTypeMetadata struct {
	value *ActionTriggerTypeMetadata
	isSet bool
}

func (v NullableActionTriggerTypeMetadata) Get() *ActionTriggerTypeMetadata {
	return v.value
}

func (v *NullableActionTriggerTypeMetadata) Set(val *ActionTriggerTypeMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTriggerTypeMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTriggerTypeMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTriggerTypeMetadata(val *ActionTriggerTypeMetadata) *NullableActionTriggerTypeMetadata {
	return &NullableActionTriggerTypeMetadata{value: val, isSet: true}
}

func (v NullableActionTriggerTypeMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTriggerTypeMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
