...
// checks if the CloudTenantReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTenantReference{}

// CloudTenantReference The reference to a cloud_tenant
type CloudTenantReference struct {
	// The kind name
...
type _CloudTenantReference CloudTenantReference
...
func (o CloudTenantReference) MarshalJSON() ([]byte, error) {
...
func (o CloudTenantReference) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTenantReference) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTenantReference := _CloudTenantReference{}

	err = json.Unmarshal(data, &varCloudTenantReference)

	if err != nil {
		return err
	}

	*o = CloudTenantReference(varCloudTenantReference)
...
type NullableCloudTenantReference struct {
	value *CloudTenantReference
	isSet bool
}

func (v NullableCloudTenantReference) Get() *CloudTenantReference {
	return v.value
}

func (v *NullableCloudTenantReference) Set(val *CloudTenantReference) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTenantReference) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTenantReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTenantReference(val *CloudTenantReference) *NullableCloudTenantReference {
	return &NullableCloudTenantReference{value: val, isSet: true}
}

func (v NullableCloudTenantReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTenantReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
