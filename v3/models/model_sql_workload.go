...
// checks if the SqlWorkload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SqlWorkload{}

// SqlWorkload SQL workload Object.
type SqlWorkload struct {
	TransactionType *string `json:"transaction_type,omitempty"`
	BusinessCritical *bool `json:"business_critical,omitempty"`
	SqlProfileType *string `json:"sql_profile_type,omitempty"`
	NumDb *int32 `json:"num_db,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SqlWorkload SqlWorkload
...
// GetBusinessCritical returns the BusinessCritical field value if set, zero value otherwise.
func (o *SqlWorkload) GetBusinessCritical() bool {
	if o == nil || IsNil(o.BusinessCritical) {
		var ret bool
		return ret
	}
	return *o.BusinessCritical
}

// GetBusinessCriticalOk returns a tuple with the BusinessCritical field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SqlWorkload) GetBusinessCriticalOk() (*bool, bool) {
	if o == nil || IsNil(o.BusinessCritical) {
		return nil, false
	}
	return o.BusinessCritical, true
}
...
// SetBusinessCritical gets a reference to the given bool and assigns it to the BusinessCritical field.
func (o *SqlWorkload) SetBusinessCritical(v bool) {
	o.BusinessCritical = &v
}

// GetSqlProfileType returns the SqlProfileType field value if set, zero value otherwise.
func (o *SqlWorkload) GetSqlProfileType() string {
	if o == nil || IsNil(o.SqlProfileType) {
		var ret string
		return ret
	}
	return *o.SqlProfileType
}

// GetSqlProfileTypeOk returns a tuple with the SqlProfileType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SqlWorkload) GetSqlProfileTypeOk() (*string, bool) {
	if o == nil || IsNil(o.SqlProfileType) {
		return nil, false
	}
	return o.SqlProfileType, true
}
...
// SetSqlProfileType gets a reference to the given string and assigns it to the SqlProfileType field.
func (o *SqlWorkload) SetSqlProfileType(v string) {
	o.SqlProfileType = &v
}

// GetNumDb returns the NumDb field value if set, zero value otherwise.
func (o *SqlWorkload) GetNumDb() int32 {
	if o == nil || IsNil(o.NumDb) {
		var ret int32
		return ret
	}
	return *o.NumDb
...
// GetNumDbOk returns a tuple with the NumDb field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetNumDb gets a reference to the given int32 and assigns it to the NumDb field.
func (o *SqlWorkload) SetNumDb(v int32) {
	o.NumDb = &v
}

func (o SqlWorkload) MarshalJSON() ([]byte, error) {
...
func (o SqlWorkload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TransactionType) {
		toSerialize["transaction_type"] = o.TransactionType
	}
	if !IsNil(o.BusinessCritical) {
		toSerialize["business_critical"] = o.BusinessCritical
	}
	if !IsNil(o.SqlProfileType) {
		toSerialize["sql_profile_type"] = o.SqlProfileType
	}
	if !IsNil(o.NumDb) {
		toSerialize["num_db"] = o.NumDb
	}
...
func (o *SqlWorkload) UnmarshalJSON(data []byte) (err error) {
	varSqlWorkload := _SqlWorkload{}

	err = json.Unmarshal(data, &varSqlWorkload)

	if err != nil {
		return err
	}

	*o = SqlWorkload(varSqlWorkload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "transaction_type")
		delete(additionalProperties, "business_critical")
		delete(additionalProperties, "sql_profile_type")
		delete(additionalProperties, "num_db")
...
type NullableSqlWorkload struct {
	value *SqlWorkload
	isSet bool
}

func (v NullableSqlWorkload) Get() *SqlWorkload {
	return v.value
}

func (v *NullableSqlWorkload) Set(val *SqlWorkload) {
	v.value = val
	v.isSet = true
}

func (v NullableSqlWorkload) IsSet() bool {
	return v.isSet
}

func (v *NullableSqlWorkload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSqlWorkload(val *SqlWorkload) *NullableSqlWorkload {
	return &NullableSqlWorkload{value: val, isSet: true}
}

func (v NullableSqlWorkload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSqlWorkload) UnmarshalJSON(src []byte) error {
	v.isSet = true
