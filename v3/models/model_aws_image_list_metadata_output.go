...
// checks if the AwsImageListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsImageListMetadataOutput{}

// AwsImageListMetadataOutput All api calls that return a list will have this metadata block 
type AwsImageListMetadataOutput struct {
	// The kind name
...
type _AwsImageListMetadataOutput AwsImageListMetadataOutput
...
func NewAwsImageListMetadataOutput() *AwsImageListMetadataOutput {
	this := AwsImageListMetadataOutput{}
	var kind string = "aws_image"
	this.Kind = &kind
	return &this
}
...
func (o AwsImageListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsImageListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsImageListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsImageListMetadataOutput := _AwsImageListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsImageListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsImageListMetadataOutput(varAwsImageListMetadataOutput)
...
type NullableAwsImageListMetadataOutput struct {
	value *AwsImageListMetadataOutput
	isSet bool
}

func (v NullableAwsImageListMetadataOutput) Get() *AwsImageListMetadataOutput {
	return v.value
}

func (v *NullableAwsImageListMetadataOutput) Set(val *AwsImageListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsImageListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsImageListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsImageListMetadataOutput(val *AwsImageListMetadataOutput) *NullableAwsImageListMetadataOutput {
	return &NullableAwsImageListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsImageListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsImageListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
