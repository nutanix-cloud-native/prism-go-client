...
// checks if the DirectoryServiceIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceIntentInput{}

// DirectoryServiceIntentInput An intentful representation of a directory_service
type DirectoryServiceIntentInput struct {
	Spec DirectoryService `json:"spec"`
...
type _DirectoryServiceIntentInput DirectoryServiceIntentInput
...
func NewDirectoryServiceIntentInput(spec DirectoryService, metadata DirectoryServiceMetadata) *DirectoryServiceIntentInput {
	this := DirectoryServiceIntentInput{}
	this.Spec = spec
...
func (o DirectoryServiceIntentInput) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryServiceIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectoryServiceIntentInput := _DirectoryServiceIntentInput{}

	err = json.Unmarshal(data, &varDirectoryServiceIntentInput)

	if err != nil {
		return err
	}

	*o = DirectoryServiceIntentInput(varDirectoryServiceIntentInput)
...
type NullableDirectoryServiceIntentInput struct {
	value *DirectoryServiceIntentInput
	isSet bool
}

func (v NullableDirectoryServiceIntentInput) Get() *DirectoryServiceIntentInput {
	return v.value
}

func (v *NullableDirectoryServiceIntentInput) Set(val *DirectoryServiceIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceIntentInput(val *DirectoryServiceIntentInput) *NullableDirectoryServiceIntentInput {
	return &NullableDirectoryServiceIntentInput{value: val, isSet: true}
}

func (v NullableDirectoryServiceIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
