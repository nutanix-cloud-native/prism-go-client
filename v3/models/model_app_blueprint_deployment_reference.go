...
// checks if the AppBlueprintDeploymentReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppBlueprintDeploymentReference{}

// AppBlueprintDeploymentReference The reference to a app_blueprint_deployment
type AppBlueprintDeploymentReference struct {
	// The kind name
...
type _AppBlueprintDeploymentReference AppBlueprintDeploymentReference
...
func NewAppBlueprintDeploymentReference(kind string, uUID string) *AppBlueprintDeploymentReference {
	this := AppBlueprintDeploymentReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o AppBlueprintDeploymentReference) MarshalJSON() ([]byte, error) {
...
func (o AppBlueprintDeploymentReference) ToMap() (map[string]interface{}, error) {
...
func (o *AppBlueprintDeploymentReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAppBlueprintDeploymentReference := _AppBlueprintDeploymentReference{}

	err = json.Unmarshal(data, &varAppBlueprintDeploymentReference)

	if err != nil {
		return err
	}

	*o = AppBlueprintDeploymentReference(varAppBlueprintDeploymentReference)
...
type NullableAppBlueprintDeploymentReference struct {
	value *AppBlueprintDeploymentReference
	isSet bool
}

func (v NullableAppBlueprintDeploymentReference) Get() *AppBlueprintDeploymentReference {
	return v.value
}

func (v *NullableAppBlueprintDeploymentReference) Set(val *AppBlueprintDeploymentReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAppBlueprintDeploymentReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAppBlueprintDeploymentReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppBlueprintDeploymentReference(val *AppBlueprintDeploymentReference) *NullableAppBlueprintDeploymentReference {
	return &NullableAppBlueprintDeploymentReference{value: val, isSet: true}
}

func (v NullableAppBlueprintDeploymentReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppBlueprintDeploymentReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
