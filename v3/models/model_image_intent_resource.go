...
// checks if the ImageIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageIntentResource{}

// ImageIntentResource Response object for intentful operations on a image
...
type _ImageIntentResource ImageIntentResource
...
// SetStatus gets a reference to the given ImageDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Image and assigns it to the Spec field.
...
func (o ImageIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ImageIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ImageIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varImageIntentResource := _ImageIntentResource{}

	err = json.Unmarshal(data, &varImageIntentResource)

	if err != nil {
		return err
	}

	*o = ImageIntentResource(varImageIntentResource)
...
type NullableImageIntentResource struct {
	value *ImageIntentResource
	isSet bool
}

func (v NullableImageIntentResource) Get() *ImageIntentResource {
	return v.value
}

func (v *NullableImageIntentResource) Set(val *ImageIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableImageIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableImageIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageIntentResource(val *ImageIntentResource) *NullableImageIntentResource {
	return &NullableImageIntentResource{value: val, isSet: true}
}

func (v NullableImageIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
