...
// checks if the RemoteSyslogServerListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogServerListIntentResponse{}

// RemoteSyslogServerListIntentResponse Response object for intentful operation of remote_syslog_servers
type RemoteSyslogServerListIntentResponse struct {
	Entities []RemoteSyslogServerIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata RemoteSyslogServerListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RemoteSyslogServerListIntentResponse RemoteSyslogServerListIntentResponse
...
func NewRemoteSyslogServerListIntentResponse(apiVersion string, metadata RemoteSyslogServerListMetadataOutput) *RemoteSyslogServerListIntentResponse {
	this := RemoteSyslogServerListIntentResponse{}
...
func (o *RemoteSyslogServerListIntentResponse) GetEntities() []RemoteSyslogServerIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []RemoteSyslogServerIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []RemoteSyslogServerIntentResource and assigns it to the Entities field.
...
func (o *RemoteSyslogServerListIntentResponse) GetMetadata() RemoteSyslogServerListMetadataOutput {
	if o == nil {
		var ret RemoteSyslogServerListMetadataOutput
		return ret
	}
...
func (o RemoteSyslogServerListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogServerListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogServerListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogServerListIntentResponse := _RemoteSyslogServerListIntentResponse{}

	err = json.Unmarshal(data, &varRemoteSyslogServerListIntentResponse)

	if err != nil {
		return err
	}

	*o = RemoteSyslogServerListIntentResponse(varRemoteSyslogServerListIntentResponse)
...
type NullableRemoteSyslogServerListIntentResponse struct {
	value *RemoteSyslogServerListIntentResponse
	isSet bool
}

func (v NullableRemoteSyslogServerListIntentResponse) Get() *RemoteSyslogServerListIntentResponse {
	return v.value
}

func (v *NullableRemoteSyslogServerListIntentResponse) Set(val *RemoteSyslogServerListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogServerListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogServerListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogServerListIntentResponse(val *RemoteSyslogServerListIntentResponse) *NullableRemoteSyslogServerListIntentResponse {
	return &NullableRemoteSyslogServerListIntentResponse{value: val, isSet: true}
}

func (v NullableRemoteSyslogServerListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogServerListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
