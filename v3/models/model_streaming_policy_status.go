...
// checks if the StreamingPolicyStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyStatus{}

// StreamingPolicyStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _StreamingPolicyStatus StreamingPolicyStatus
...
func (o StreamingPolicyStatus) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyStatus) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicyStatus) UnmarshalJSON(data []byte) (err error) {
	varStreamingPolicyStatus := _StreamingPolicyStatus{}

	err = json.Unmarshal(data, &varStreamingPolicyStatus)

	if err != nil {
		return err
	}

	*o = StreamingPolicyStatus(varStreamingPolicyStatus)
...
type NullableStreamingPolicyStatus struct {
	value *StreamingPolicyStatus
	isSet bool
}

func (v NullableStreamingPolicyStatus) Get() *StreamingPolicyStatus {
	return v.value
}

func (v *NullableStreamingPolicyStatus) Set(val *StreamingPolicyStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyStatus(val *StreamingPolicyStatus) *NullableStreamingPolicyStatus {
	return &NullableStreamingPolicyStatus{value: val, isSet: true}
}

func (v NullableStreamingPolicyStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
