...
// checks if the VmGpuOutputStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmGpuOutputStatus{}
...
type _VmGpuOutputStatus VmGpuOutputStatus
...
func (o VmGpuOutputStatus) MarshalJSON() ([]byte, error) {
...
func (o VmGpuOutputStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VmGpuOutputStatus) UnmarshalJSON(data []byte) (err error) {
	varVmGpuOutputStatus := _VmGpuOutputStatus{}

	err = json.Unmarshal(data, &varVmGpuOutputStatus)

	if err != nil {
		return err
	}

	*o = VmGpuOutputStatus(varVmGpuOutputStatus)
...
type NullableVmGpuOutputStatus struct {
	value *VmGpuOutputStatus
	isSet bool
}

func (v NullableVmGpuOutputStatus) Get() *VmGpuOutputStatus {
	return v.value
}

func (v *NullableVmGpuOutputStatus) Set(val *VmGpuOutputStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVmGpuOutputStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVmGpuOutputStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmGpuOutputStatus(val *VmGpuOutputStatus) *NullableVmGpuOutputStatus {
	return &NullableVmGpuOutputStatus{value: val, isSet: true}
}

func (v NullableVmGpuOutputStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmGpuOutputStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
