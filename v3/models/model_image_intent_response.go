...
// checks if the ImageIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageIntentResponse{}
...
type _ImageIntentResponse ImageIntentResponse
...
func (o ImageIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ImageIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ImageIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varImageIntentResponse := _ImageIntentResponse{}

	err = json.Unmarshal(data, &varImageIntentResponse)

	if err != nil {
		return err
	}

	*o = ImageIntentResponse(varImageIntentResponse)
...
type NullableImageIntentResponse struct {
	value *ImageIntentResponse
	isSet bool
}

func (v NullableImageIntentResponse) Get() *ImageIntentResponse {
	return v.value
}

func (v *NullableImageIntentResponse) Set(val *ImageIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableImageIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableImageIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageIntentResponse(val *ImageIntentResponse) *NullableImageIntentResponse {
	return &NullableImageIntentResponse{value: val, isSet: true}
}

func (v NullableImageIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
