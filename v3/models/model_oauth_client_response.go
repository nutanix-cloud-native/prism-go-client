...
type _OauthClientResponse OauthClientResponse
...
func (o *OauthClientResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varOauthClientResponse := _OauthClientResponse{}

	err = json.Unmarshal(data, &varOauthClientResponse)

	if err != nil {
		return err
	}

	*o = OauthClientResponse(varOauthClientResponse)
