...
// checks if the CloudCredentialsListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCredentialsListIntentResponse{}

// CloudCredentialsListIntentResponse Response object for intentful operation of cloud_credentialss
type CloudCredentialsListIntentResponse struct {
	...
	Metadata CloudCredentialsListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _CloudCredentialsListIntentResponse CloudCredentialsListIntentResponse
...
func NewCloudCredentialsListIntentResponse(apiVersion string, metadata CloudCredentialsListMetadataOutput) *CloudCredentialsListIntentResponse {
	this := CloudCredentialsListIntentResponse{}
...
func (o *CloudCredentialsListIntentResponse) GetEntities() []CloudCredentialsIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []CloudCredentialsIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []CloudCredentialsIntentResource and assigns it to the Entities field.
...
func (o *CloudCredentialsListIntentResponse) GetMetadata() CloudCredentialsListMetadataOutput {
	if o == nil {
		var ret CloudCredentialsListMetadataOutput
		return ret
	}
...
func (o CloudCredentialsListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CloudCredentialsListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CloudCredentialsListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudCredentialsListIntentResponse := _CloudCredentialsListIntentResponse{}

	err = json.Unmarshal(data, &varCloudCredentialsListIntentResponse)

	if err != nil {
		return err
	}

	*o = CloudCredentialsListIntentResponse(varCloudCredentialsListIntentResponse)
...
type NullableCloudCredentialsListIntentResponse struct {
	value *CloudCredentialsListIntentResponse
	isSet bool
}

func (v NullableCloudCredentialsListIntentResponse) Get() *CloudCredentialsListIntentResponse {
	return v.value
}

func (v *NullableCloudCredentialsListIntentResponse) Set(val *CloudCredentialsListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCredentialsListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCredentialsListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCredentialsListIntentResponse(val *CloudCredentialsListIntentResponse) *NullableCloudCredentialsListIntentResponse {
	return &NullableCloudCredentialsListIntentResponse{value: val, isSet: true}
}

func (v NullableCloudCredentialsListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCredentialsListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
