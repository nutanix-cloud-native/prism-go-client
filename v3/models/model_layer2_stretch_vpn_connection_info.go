...
// checks if the Layer2StretchVpnConnectionInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchVpnConnectionInfo{}

// Layer2StretchVpnConnectionInfo Layer2 stretch related entities vpn connection info.
type Layer2StretchVpnConnectionInfo struct {
	PeerConnectionReference *VpnConnectionReference `json:"peer_connection_reference,omitempty"`
	LocalVtiIp *string `json:"local_vti_ip,omitempty"`
	ConnectionReference *VpnConnectionReference `json:"connection_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _Layer2StretchVpnConnectionInfo Layer2StretchVpnConnectionInfo
...
func NewLayer2StretchVpnConnectionInfo() *Layer2StretchVpnConnectionInfo {
	this := Layer2StretchVpnConnectionInfo{}
	return &this
}
...
// GetPeerConnectionReference returns the PeerConnectionReference field value if set, zero value otherwise.
func (o *Layer2StretchVpnConnectionInfo) GetPeerConnectionReference() VpnConnectionReference {
	if o == nil || IsNil(o.PeerConnectionReference) {
		var ret VpnConnectionReference
		return ret
	}
	return *o.PeerConnectionReference
}

// GetPeerConnectionReferenceOk returns a tuple with the PeerConnectionReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Layer2StretchVpnConnectionInfo) GetPeerConnectionReferenceOk() (*VpnConnectionReference, bool) {
	if o == nil || IsNil(o.PeerConnectionReference) {
		return nil, false
	}
	return o.PeerConnectionReference, true
}
...
// SetPeerConnectionReference gets a reference to the given VpnConnectionReference and assigns it to the PeerConnectionReference field.
func (o *Layer2StretchVpnConnectionInfo) SetPeerConnectionReference(v VpnConnectionReference) {
	o.PeerConnectionReference = &v
}
...
// GetConnectionReference returns the ConnectionReference field value if set, zero value otherwise.
func (o *Layer2StretchVpnConnectionInfo) GetConnectionReference() VpnConnectionReference {
	if o == nil || IsNil(o.ConnectionReference) {
		var ret VpnConnectionReference
		return ret
	}
	return *o.ConnectionReference
}

// GetConnectionReferenceOk returns a tuple with the ConnectionReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Layer2StretchVpnConnectionInfo) GetConnectionReferenceOk() (*VpnConnectionReference, bool) {
	if o == nil || IsNil(o.ConnectionReference) {
		return nil, false
	}
	return o.ConnectionReference, true
}
...
// SetConnectionReference gets a reference to the given VpnConnectionReference and assigns it to the ConnectionReference field.
func (o *Layer2StretchVpnConnectionInfo) SetConnectionReference(v VpnConnectionReference) {
	o.ConnectionReference = &v
}

func (o Layer2StretchVpnConnectionInfo) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchVpnConnectionInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PeerConnectionReference) {
		toSerialize["peer_connection_reference"] = o.PeerConnectionReference
	}
	if !IsNil(o.LocalVtiIp) {
		toSerialize["local_vti_ip"] = o.LocalVtiIp
	}
	if !IsNil(o.ConnectionReference) {
		toSerialize["connection_reference"] = o.ConnectionReference
	}
...
func (o *Layer2StretchVpnConnectionInfo) UnmarshalJSON(data []byte) (err error) {
	varLayer2StretchVpnConnectionInfo := _Layer2StretchVpnConnectionInfo{}

	err = json.Unmarshal(data, &varLayer2StretchVpnConnectionInfo)

	if err != nil {
		return err
	}

	*o = Layer2StretchVpnConnectionInfo(varLayer2StretchVpnConnectionInfo)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "peer_connection_reference")
		delete(additionalProperties, "local_vti_ip")
		delete(additionalProperties, "connection_reference")
...
type NullableLayer2StretchVpnConnectionInfo struct {
	value *Layer2StretchVpnConnectionInfo
	isSet bool
}

func (v NullableLayer2StretchVpnConnectionInfo) Get() *Layer2StretchVpnConnectionInfo {
	return v.value
}

func (v *NullableLayer2StretchVpnConnectionInfo) Set(val *Layer2StretchVpnConnectionInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchVpnConnectionInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchVpnConnectionInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchVpnConnectionInfo(val *Layer2StretchVpnConnectionInfo) *NullableLayer2StretchVpnConnectionInfo {
	return &NullableLayer2StretchVpnConnectionInfo{value: val, isSet: true}
}

func (v NullableLayer2StretchVpnConnectionInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchVpnConnectionInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
