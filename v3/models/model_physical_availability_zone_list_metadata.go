...
// checks if the PhysicalAvailabilityZoneListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalAvailabilityZoneListMetadata{}

// PhysicalAvailabilityZoneListMetadata All api calls that return a list will have this metadata block as input 
type PhysicalAvailabilityZoneListMetadata struct {
	// The kind name
...
type _PhysicalAvailabilityZoneListMetadata PhysicalAvailabilityZoneListMetadata
...
func NewPhysicalAvailabilityZoneListMetadata() *PhysicalAvailabilityZoneListMetadata {
	this := PhysicalAvailabilityZoneListMetadata{}
...
func (o PhysicalAvailabilityZoneListMetadata) MarshalJSON() ([]byte, error) {
...
func (o PhysicalAvailabilityZoneListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *PhysicalAvailabilityZoneListMetadata) UnmarshalJSON(data []byte) (err error) {
	varPhysicalAvailabilityZoneListMetadata := _PhysicalAvailabilityZoneListMetadata{}

	err = json.Unmarshal(data, &varPhysicalAvailabilityZoneListMetadata)

	if err != nil {
		return err
	}

	*o = PhysicalAvailabilityZoneListMetadata(varPhysicalAvailabilityZoneListMetadata)
...
type NullablePhysicalAvailabilityZoneListMetadata struct {
	value *PhysicalAvailabilityZoneListMetadata
	isSet bool
}

func (v NullablePhysicalAvailabilityZoneListMetadata) Get() *PhysicalAvailabilityZoneListMetadata {
	return v.value
}

func (v *NullablePhysicalAvailabilityZoneListMetadata) Set(val *PhysicalAvailabilityZoneListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullablePhysicalAvailabilityZoneListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullablePhysicalAvailabilityZoneListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhysicalAvailabilityZoneListMetadata(val *PhysicalAvailabilityZoneListMetadata) *NullablePhysicalAvailabilityZoneListMetadata {
	return &NullablePhysicalAvailabilityZoneListMetadata{value: val, isSet: true}
}

func (v NullablePhysicalAvailabilityZoneListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhysicalAvailabilityZoneListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
