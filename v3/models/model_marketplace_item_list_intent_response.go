...
// checks if the MarketplaceItemListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemListIntentResponse{}

// MarketplaceItemListIntentResponse Response object for intentful operation of marketplace_items
type MarketplaceItemListIntentResponse struct {
	Entities []MarketplaceItemIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata MarketplaceItemListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _MarketplaceItemListIntentResponse MarketplaceItemListIntentResponse
...
func NewMarketplaceItemListIntentResponse(apiVersion string, metadata MarketplaceItemListMetadataOutput) *MarketplaceItemListIntentResponse {
	this := MarketplaceItemListIntentResponse{}
...
func (o *MarketplaceItemListIntentResponse) GetEntities() []MarketplaceItemIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []MarketplaceItemIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []MarketplaceItemIntentResource and assigns it to the Entities field.
...
func (o *MarketplaceItemListIntentResponse) GetMetadata() MarketplaceItemListMetadataOutput {
	if o == nil {
		var ret MarketplaceItemListMetadataOutput
		return ret
	}
...
func (o MarketplaceItemListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItemListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceItemListIntentResponse := _MarketplaceItemListIntentResponse{}

	err = json.Unmarshal(data, &varMarketplaceItemListIntentResponse)

	if err != nil {
		return err
	}

	*o = MarketplaceItemListIntentResponse(varMarketplaceItemListIntentResponse)
...
type NullableMarketplaceItemListIntentResponse struct {
	value *MarketplaceItemListIntentResponse
	isSet bool
}

func (v NullableMarketplaceItemListIntentResponse) Get() *MarketplaceItemListIntentResponse {
	return v.value
}

func (v *NullableMarketplaceItemListIntentResponse) Set(val *MarketplaceItemListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemListIntentResponse(val *MarketplaceItemListIntentResponse) *NullableMarketplaceItemListIntentResponse {
	return &NullableMarketplaceItemListIntentResponse{value: val, isSet: true}
}

func (v NullableMarketplaceItemListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
