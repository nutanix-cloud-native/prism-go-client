...
// checks if the ProviderOauthToken type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProviderOauthToken{}
...
type _ProviderOauthToken ProviderOauthToken
...
func (o ProviderOauthToken) MarshalJSON() ([]byte, error) {
...
func (o ProviderOauthToken) ToMap() (map[string]interface{}, error) {
...
func (o *ProviderOauthToken) UnmarshalJSON(data []byte) (err error) {
	...
	varProviderOauthToken := _ProviderOauthToken{}

	err = json.Unmarshal(data, &varProviderOauthToken)

	if err != nil {
		return err
	}

	*o = ProviderOauthToken(varProviderOauthToken)
...
type NullableProviderOauthToken struct {
	value *ProviderOauthToken
	isSet bool
}

func (v NullableProviderOauthToken) Get() *ProviderOauthToken {
	return v.value
}

func (v *NullableProviderOauthToken) Set(val *ProviderOauthToken) {
	v.value = val
	v.isSet = true
}

func (v NullableProviderOauthToken) IsSet() bool {
	return v.isSet
}

func (v *NullableProviderOauthToken) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProviderOauthToken(val *ProviderOauthToken) *NullableProviderOauthToken {
	return &NullableProviderOauthToken{value: val, isSet: true}
}

func (v NullableProviderOauthToken) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProviderOauthToken) UnmarshalJSON(src []byte) error {
	v.isSet = true
