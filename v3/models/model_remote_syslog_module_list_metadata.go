...
// checks if the RemoteSyslogModuleListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogModuleListMetadata{}

// RemoteSyslogModuleListMetadata All api calls that return a list will have this metadata block as input 
type RemoteSyslogModuleListMetadata struct {
	// The kind name
...
type _RemoteSyslogModuleListMetadata RemoteSyslogModuleListMetadata
...
func NewRemoteSyslogModuleListMetadata() *RemoteSyslogModuleListMetadata {
	this := RemoteSyslogModuleListMetadata{}
...
func (o RemoteSyslogModuleListMetadata) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogModuleListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogModuleListMetadata) UnmarshalJSON(data []byte) (err error) {
	varRemoteSyslogModuleListMetadata := _RemoteSyslogModuleListMetadata{}

	err = json.Unmarshal(data, &varRemoteSyslogModuleListMetadata)

	if err != nil {
		return err
	}

	*o = RemoteSyslogModuleListMetadata(varRemoteSyslogModuleListMetadata)
...
type NullableRemoteSyslogModuleListMetadata struct {
	value *RemoteSyslogModuleListMetadata
	isSet bool
}

func (v NullableRemoteSyslogModuleListMetadata) Get() *RemoteSyslogModuleListMetadata {
	return v.value
}

func (v *NullableRemoteSyslogModuleListMetadata) Set(val *RemoteSyslogModuleListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogModuleListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogModuleListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogModuleListMetadata(val *RemoteSyslogModuleListMetadata) *NullableRemoteSyslogModuleListMetadata {
	return &NullableRemoteSyslogModuleListMetadata{value: val, isSet: true}
}

func (v NullableRemoteSyslogModuleListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogModuleListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
