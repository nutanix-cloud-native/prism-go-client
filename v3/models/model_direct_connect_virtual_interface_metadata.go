...
// checks if the DirectConnectVirtualInterfaceMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterfaceMetadata{}

// DirectConnectVirtualInterfaceMetadata The direct_connect_virtual_interface kind metadata
type DirectConnectVirtualInterfaceMetadata struct {
	...
	// direct_connect_virtual_interface uuid
	...
	// Categories for the direct_connect_virtual_interface. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the direct_connect_virtual_interface. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// direct_connect_virtual_interface name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DirectConnectVirtualInterfaceMetadata DirectConnectVirtualInterfaceMetadata
...
func NewDirectConnectVirtualInterfaceMetadata(kind string) *DirectConnectVirtualInterfaceMetadata {
	this := DirectConnectVirtualInterfaceMetadata{}
...
func (o DirectConnectVirtualInterfaceMetadata) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterfaceMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectVirtualInterfaceMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectVirtualInterfaceMetadata := _DirectConnectVirtualInterfaceMetadata{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterfaceMetadata)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterfaceMetadata(varDirectConnectVirtualInterfaceMetadata)
...
type NullableDirectConnectVirtualInterfaceMetadata struct {
	value *DirectConnectVirtualInterfaceMetadata
	isSet bool
}

func (v NullableDirectConnectVirtualInterfaceMetadata) Get() *DirectConnectVirtualInterfaceMetadata {
	return v.value
}

func (v *NullableDirectConnectVirtualInterfaceMetadata) Set(val *DirectConnectVirtualInterfaceMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterfaceMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterfaceMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterfaceMetadata(val *DirectConnectVirtualInterfaceMetadata) *NullableDirectConnectVirtualInterfaceMetadata {
	return &NullableDirectConnectVirtualInterfaceMetadata{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterfaceMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterfaceMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
