...
// checks if the IdentityProviderIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderIntentResponse{}

// IdentityProviderIntentResponse Response object for intentful operations on a identity_provider
type IdentityProviderIntentResponse struct {
	Status *IdentityProviderDefStatus `json:"status,omitempty"`
	Spec *IdentityProvider `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata IdentityProviderMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _IdentityProviderIntentResponse IdentityProviderIntentResponse
...
func NewIdentityProviderIntentResponse(apiVersion string, metadata IdentityProviderMetadata) *IdentityProviderIntentResponse {
	this := IdentityProviderIntentResponse{}
...
func (o *IdentityProviderIntentResponse) GetStatus() IdentityProviderDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret IdentityProviderDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given IdentityProviderDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given IdentityProvider and assigns it to the Spec field.
...
func (o *IdentityProviderIntentResponse) GetMetadata() IdentityProviderMetadata {
	if o == nil {
		var ret IdentityProviderMetadata
		return ret
	}
...
func (o IdentityProviderIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProviderIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varIdentityProviderIntentResponse := _IdentityProviderIntentResponse{}

	err = json.Unmarshal(data, &varIdentityProviderIntentResponse)

	if err != nil {
		return err
	}

	*o = IdentityProviderIntentResponse(varIdentityProviderIntentResponse)
...
type NullableIdentityProviderIntentResponse struct {
	value *IdentityProviderIntentResponse
	isSet bool
}

func (v NullableIdentityProviderIntentResponse) Get() *IdentityProviderIntentResponse {
	return v.value
}

func (v *NullableIdentityProviderIntentResponse) Set(val *IdentityProviderIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderIntentResponse(val *IdentityProviderIntentResponse) *NullableIdentityProviderIntentResponse {
	return &NullableIdentityProviderIntentResponse{value: val, isSet: true}
}

func (v NullableIdentityProviderIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
