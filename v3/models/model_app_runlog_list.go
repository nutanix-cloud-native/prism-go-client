...
// checks if the AppRunlogList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunlogList{}

// AppRunlogList Runlog entity list of the app
type AppRunlogList struct {
	Entities []AppRunlogResponse `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AppRunlogListMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AppRunlogList AppRunlogList
...
// SetEntities gets a reference to the given []AppRunlogResponse and assigns it to the Entities field.
...
func (o AppRunlogList) MarshalJSON() ([]byte, error) {
...
func (o AppRunlogList) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunlogList) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRunlogList := _AppRunlogList{}

	err = json.Unmarshal(data, &varAppRunlogList)

	if err != nil {
		return err
	}

	*o = AppRunlogList(varAppRunlogList)
...
type NullableAppRunlogList struct {
	value *AppRunlogList
	isSet bool
}

func (v NullableAppRunlogList) Get() *AppRunlogList {
	return v.value
}

func (v *NullableAppRunlogList) Set(val *AppRunlogList) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunlogList) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunlogList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunlogList(val *AppRunlogList) *NullableAppRunlogList {
	return &NullableAppRunlogList{value: val, isSet: true}
}

func (v NullableAppRunlogList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunlogList) UnmarshalJSON(src []byte) error {
	v.isSet = true
