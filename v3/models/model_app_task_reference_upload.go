...
// checks if the AppTaskReferenceUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskReferenceUpload{}

// AppTaskReferenceUpload The reference to a app_task
type AppTaskReferenceUpload struct {
	// The kind name
...
type _AppTaskReferenceUpload AppTaskReferenceUpload
...
func (o AppTaskReferenceUpload) MarshalJSON() ([]byte, error) {
...
func (o AppTaskReferenceUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskReferenceUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskReferenceUpload := _AppTaskReferenceUpload{}

	err = json.Unmarshal(data, &varAppTaskReferenceUpload)

	if err != nil {
		return err
	}

	*o = AppTaskReferenceUpload(varAppTaskReferenceUpload)
...
type NullableAppTaskReferenceUpload struct {
	value *AppTaskReferenceUpload
	isSet bool
}

func (v NullableAppTaskReferenceUpload) Get() *AppTaskReferenceUpload {
	return v.value
}

func (v *NullableAppTaskReferenceUpload) Set(val *AppTaskReferenceUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskReferenceUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskReferenceUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskReferenceUpload(val *AppTaskReferenceUpload) *NullableAppTaskReferenceUpload {
	return &NullableAppTaskReferenceUpload{value: val, isSet: true}
}

func (v NullableAppTaskReferenceUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskReferenceUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
