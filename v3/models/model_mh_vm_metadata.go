...
// checks if the MhVmMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmMetadata{}

// MhVmMetadata The mh_vm kind metadata
type MhVmMetadata struct {
	...
	// Categories for the mh_vm. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the mh_vm. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _MhVmMetadata MhVmMetadata
...
func (o MhVmMetadata) MarshalJSON() ([]byte, error) {
...
func (o MhVmMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varMhVmMetadata := _MhVmMetadata{}

	err = json.Unmarshal(data, &varMhVmMetadata)

	if err != nil {
		return err
	}

	*o = MhVmMetadata(varMhVmMetadata)
...
type NullableMhVmMetadata struct {
	value *MhVmMetadata
	isSet bool
}

func (v NullableMhVmMetadata) Get() *MhVmMetadata {
	return v.value
}

func (v *NullableMhVmMetadata) Set(val *MhVmMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmMetadata(val *MhVmMetadata) *NullableMhVmMetadata {
	return &NullableMhVmMetadata{value: val, isSet: true}
}

func (v NullableMhVmMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
