...
// checks if the VmRecoveryPointIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPointIntentInput{}

// VmRecoveryPointIntentInput An intentful representation of a vm_recovery_point
...
type _VmRecoveryPointIntentInput VmRecoveryPointIntentInput
...
func NewVmRecoveryPointIntentInput(spec VmRecoveryPoint, metadata VmRecoveryPointMetadata) *VmRecoveryPointIntentInput {
	this := VmRecoveryPointIntentInput{}
	this.Spec = spec
...
func (o VmRecoveryPointIntentInput) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPointIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPointIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVmRecoveryPointIntentInput := _VmRecoveryPointIntentInput{}

	err = json.Unmarshal(data, &varVmRecoveryPointIntentInput)

	if err != nil {
		return err
	}

	*o = VmRecoveryPointIntentInput(varVmRecoveryPointIntentInput)
...
type NullableVmRecoveryPointIntentInput struct {
	value *VmRecoveryPointIntentInput
	isSet bool
}

func (v NullableVmRecoveryPointIntentInput) Get() *VmRecoveryPointIntentInput {
	return v.value
}

func (v *NullableVmRecoveryPointIntentInput) Set(val *VmRecoveryPointIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPointIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPointIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPointIntentInput(val *VmRecoveryPointIntentInput) *NullableVmRecoveryPointIntentInput {
	return &NullableVmRecoveryPointIntentInput{value: val, isSet: true}
}

func (v NullableVmRecoveryPointIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPointIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
