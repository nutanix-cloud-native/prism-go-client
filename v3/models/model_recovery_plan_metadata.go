...
// checks if the RecoveryPlanMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanMetadata{}

// RecoveryPlanMetadata The recovery_plan kind metadata
type RecoveryPlanMetadata struct {
	...
	// Categories for the recovery_plan. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the recovery_plan. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _RecoveryPlanMetadata RecoveryPlanMetadata
...
func (o RecoveryPlanMetadata) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanMetadata := _RecoveryPlanMetadata{}

	err = json.Unmarshal(data, &varRecoveryPlanMetadata)

	if err != nil {
		return err
	}

	*o = RecoveryPlanMetadata(varRecoveryPlanMetadata)
...
type NullableRecoveryPlanMetadata struct {
	value *RecoveryPlanMetadata
	isSet bool
}

func (v NullableRecoveryPlanMetadata) Get() *RecoveryPlanMetadata {
	return v.value
}

func (v *NullableRecoveryPlanMetadata) Set(val *RecoveryPlanMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanMetadata(val *RecoveryPlanMetadata) *NullableRecoveryPlanMetadata {
	return &NullableRecoveryPlanMetadata{value: val, isSet: true}
}

func (v NullableRecoveryPlanMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
