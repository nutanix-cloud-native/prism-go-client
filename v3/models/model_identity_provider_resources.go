...
// checks if the IdentityProviderResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderResources{}

// IdentityProviderResources Urls and other info about the IDP.
type IdentityProviderResources struct {
...
type _IdentityProviderResources IdentityProviderResources
...
func NewIdentityProviderResources() *IdentityProviderResources {
	this := IdentityProviderResources{}
	return &this
}
...
func (o IdentityProviderResources) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderResources) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProviderResources) UnmarshalJSON(data []byte) (err error) {
	varIdentityProviderResources := _IdentityProviderResources{}

	err = json.Unmarshal(data, &varIdentityProviderResources)

	if err != nil {
		return err
	}

	*o = IdentityProviderResources(varIdentityProviderResources)
...
type NullableIdentityProviderResources struct {
	value *IdentityProviderResources
	isSet bool
}

func (v NullableIdentityProviderResources) Get() *IdentityProviderResources {
	return v.value
}

func (v *NullableIdentityProviderResources) Set(val *IdentityProviderResources) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderResources) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderResources(val *IdentityProviderResources) *NullableIdentityProviderResources {
	return &NullableIdentityProviderResources{value: val, isSet: true}
}

func (v NullableIdentityProviderResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
