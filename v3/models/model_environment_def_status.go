...
// checks if the EnvironmentDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentDefStatus{}

// EnvironmentDefStatus An intentful representation of a environment status
type EnvironmentDefStatus struct {
	// environment Name.
	Name string `json:"name"`
	// The state of the environment.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the environment, if in an error state.
	...
	Resources EnvironmentResourcesDefStatus `json:"resources"`
	// A description for environment.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _EnvironmentDefStatus EnvironmentDefStatus
...
func (o *EnvironmentDefStatus) GetResources() EnvironmentResourcesDefStatus {
	if o == nil {
		var ret EnvironmentResourcesDefStatus
		return ret
	}
...
func (o EnvironmentDefStatus) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *EnvironmentDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvironmentDefStatus := _EnvironmentDefStatus{}

	err = json.Unmarshal(data, &varEnvironmentDefStatus)

	if err != nil {
		return err
	}

	*o = EnvironmentDefStatus(varEnvironmentDefStatus)
...
type NullableEnvironmentDefStatus struct {
	value *EnvironmentDefStatus
	isSet bool
}

func (v NullableEnvironmentDefStatus) Get() *EnvironmentDefStatus {
	return v.value
}

func (v *NullableEnvironmentDefStatus) Set(val *EnvironmentDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentDefStatus(val *EnvironmentDefStatus) *NullableEnvironmentDefStatus {
	return &NullableEnvironmentDefStatus{value: val, isSet: true}
}

func (v NullableEnvironmentDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
