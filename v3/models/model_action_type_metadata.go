...
// checks if the ActionTypeMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTypeMetadata{}

// ActionTypeMetadata The action_type kind metadata
type ActionTypeMetadata struct {
	...
	// Categories for the action_type. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the action_type. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _ActionTypeMetadata ActionTypeMetadata
...
func (o ActionTypeMetadata) MarshalJSON() ([]byte, error) {
...
func (o ActionTypeMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTypeMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTypeMetadata := _ActionTypeMetadata{}

	err = json.Unmarshal(data, &varActionTypeMetadata)

	if err != nil {
		return err
	}

	*o = ActionTypeMetadata(varActionTypeMetadata)
...
type NullableActionTypeMetadata struct {
	value *ActionTypeMetadata
	isSet bool
}

func (v NullableActionTypeMetadata) Get() *ActionTypeMetadata {
	return v.value
}

func (v *NullableActionTypeMetadata) Set(val *ActionTypeMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTypeMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTypeMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTypeMetadata(val *ActionTypeMetadata) *NullableActionTypeMetadata {
	return &NullableActionTypeMetadata{value: val, isSet: true}
}

func (v NullableActionTypeMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTypeMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
