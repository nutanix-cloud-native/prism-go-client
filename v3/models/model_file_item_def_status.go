...
// checks if the FileItemDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemDefStatus{}

// FileItemDefStatus An intentful representation of a file_item status
type FileItemDefStatus struct {
	// file_item Name.
	Name string `json:"name"`
	// The state of the file_item.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the file_item, if in an error state.
	...
	Resources FileItemResourcesDefStatus `json:"resources"`
	// A description for file_item.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FileItemDefStatus FileItemDefStatus
...
func (o *FileItemDefStatus) GetResources() FileItemResourcesDefStatus {
	if o == nil {
		var ret FileItemResourcesDefStatus
		return ret
	}
...
func (o FileItemDefStatus) MarshalJSON() ([]byte, error) {
...
func (o FileItemDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *FileItemDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varFileItemDefStatus := _FileItemDefStatus{}

	err = json.Unmarshal(data, &varFileItemDefStatus)

	if err != nil {
		return err
	}

	*o = FileItemDefStatus(varFileItemDefStatus)
...
type NullableFileItemDefStatus struct {
	value *FileItemDefStatus
	isSet bool
}

func (v NullableFileItemDefStatus) Get() *FileItemDefStatus {
	return v.value
}

func (v *NullableFileItemDefStatus) Set(val *FileItemDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemDefStatus(val *FileItemDefStatus) *NullableFileItemDefStatus {
	return &NullableFileItemDefStatus{value: val, isSet: true}
}

func (v NullableFileItemDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
