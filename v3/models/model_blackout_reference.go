...
// checks if the BlackoutReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackoutReference{}

// BlackoutReference The reference to a blackout
type BlackoutReference struct {
	// The kind name
...
type _BlackoutReference BlackoutReference
...
func (o BlackoutReference) MarshalJSON() ([]byte, error) {
...
func (o BlackoutReference) ToMap() (map[string]interface{}, error) {
...
func (o *BlackoutReference) UnmarshalJSON(data []byte) (err error) {
	...
	varBlackoutReference := _BlackoutReference{}

	err = json.Unmarshal(data, &varBlackoutReference)

	if err != nil {
		return err
	}

	*o = BlackoutReference(varBlackoutReference)
...
type NullableBlackoutReference struct {
	value *BlackoutReference
	isSet bool
}

func (v NullableBlackoutReference) Get() *BlackoutReference {
	return v.value
}

func (v *NullableBlackoutReference) Set(val *BlackoutReference) {
	v.value = val
	v.isSet = true
}

func (v NullableBlackoutReference) IsSet() bool {
	return v.isSet
}

func (v *NullableBlackoutReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlackoutReference(val *BlackoutReference) *NullableBlackoutReference {
	return &NullableBlackoutReference{value: val, isSet: true}
}

func (v NullableBlackoutReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlackoutReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
