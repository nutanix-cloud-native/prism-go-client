...
// checks if the OvaDiskInfoDeviceProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OvaDiskInfoDeviceProperties{}

// OvaDiskInfoDeviceProperties struct for OvaDiskInfoDeviceProperties
type OvaDiskInfoDeviceProperties struct {
	DeviceType *string `json:"device_type,omitempty"`
	DiskAddress *DiskAddress `json:"disk_address,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _OvaDiskInfoDeviceProperties OvaDiskInfoDeviceProperties
...
func NewOvaDiskInfoDeviceProperties() *OvaDiskInfoDeviceProperties {
	this := OvaDiskInfoDeviceProperties{}
	var deviceType string = "DISK"
...
// GetDiskAddress returns the DiskAddress field value if set, zero value otherwise.
func (o *OvaDiskInfoDeviceProperties) GetDiskAddress() DiskAddress {
	if o == nil || IsNil(o.DiskAddress) {
		var ret DiskAddress
		return ret
	}
	return *o.DiskAddress
}

// GetDiskAddressOk returns a tuple with the DiskAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OvaDiskInfoDeviceProperties) GetDiskAddressOk() (*DiskAddress, bool) {
	if o == nil || IsNil(o.DiskAddress) {
		return nil, false
	}
	return o.DiskAddress, true
}
...
// SetDiskAddress gets a reference to the given DiskAddress and assigns it to the DiskAddress field.
func (o *OvaDiskInfoDeviceProperties) SetDiskAddress(v DiskAddress) {
	o.DiskAddress = &v
}

func (o OvaDiskInfoDeviceProperties) MarshalJSON() ([]byte, error) {
...
func (o OvaDiskInfoDeviceProperties) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DeviceType) {
		toSerialize["device_type"] = o.DeviceType
	}
	if !IsNil(o.DiskAddress) {
		toSerialize["disk_address"] = o.DiskAddress
	}
...
func (o *OvaDiskInfoDeviceProperties) UnmarshalJSON(data []byte) (err error) {
	varOvaDiskInfoDeviceProperties := _OvaDiskInfoDeviceProperties{}

	err = json.Unmarshal(data, &varOvaDiskInfoDeviceProperties)

	if err != nil {
		return err
	}

	*o = OvaDiskInfoDeviceProperties(varOvaDiskInfoDeviceProperties)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "device_type")
		delete(additionalProperties, "disk_address")
...
type NullableOvaDiskInfoDeviceProperties struct {
	value *OvaDiskInfoDeviceProperties
	isSet bool
}

func (v NullableOvaDiskInfoDeviceProperties) Get() *OvaDiskInfoDeviceProperties {
	return v.value
}

func (v *NullableOvaDiskInfoDeviceProperties) Set(val *OvaDiskInfoDeviceProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableOvaDiskInfoDeviceProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableOvaDiskInfoDeviceProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOvaDiskInfoDeviceProperties(val *OvaDiskInfoDeviceProperties) *NullableOvaDiskInfoDeviceProperties {
	return &NullableOvaDiskInfoDeviceProperties{value: val, isSet: true}
}

func (v NullableOvaDiskInfoDeviceProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOvaDiskInfoDeviceProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
