...
// checks if the CloudTenantIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTenantIntentResponse{}

// CloudTenantIntentResponse Response object for intentful operations on a cloud_tenant
type CloudTenantIntentResponse struct {
...
type _CloudTenantIntentResponse CloudTenantIntentResponse
...
func NewCloudTenantIntentResponse(apiVersion string, metadata CloudTenantMetadata) *CloudTenantIntentResponse {
	this := CloudTenantIntentResponse{}
...
func (o CloudTenantIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CloudTenantIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTenantIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTenantIntentResponse := _CloudTenantIntentResponse{}

	err = json.Unmarshal(data, &varCloudTenantIntentResponse)

	if err != nil {
		return err
	}

	*o = CloudTenantIntentResponse(varCloudTenantIntentResponse)
...
type NullableCloudTenantIntentResponse struct {
	value *CloudTenantIntentResponse
	isSet bool
}

func (v NullableCloudTenantIntentResponse) Get() *CloudTenantIntentResponse {
	return v.value
}

func (v *NullableCloudTenantIntentResponse) Set(val *CloudTenantIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTenantIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTenantIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTenantIntentResponse(val *CloudTenantIntentResponse) *NullableCloudTenantIntentResponse {
	return &NullableCloudTenantIntentResponse{value: val, isSet: true}
}

func (v NullableCloudTenantIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTenantIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
