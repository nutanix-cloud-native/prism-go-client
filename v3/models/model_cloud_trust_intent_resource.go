...
// checks if the CloudTrustIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustIntentResource{}

// CloudTrustIntentResource Response object for intentful operations on a cloud_trust
type CloudTrustIntentResource struct {
...
type _CloudTrustIntentResource CloudTrustIntentResource
...
func (o CloudTrustIntentResource) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrustIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTrustIntentResource := _CloudTrustIntentResource{}

	err = json.Unmarshal(data, &varCloudTrustIntentResource)

	if err != nil {
		return err
	}

	*o = CloudTrustIntentResource(varCloudTrustIntentResource)
...
type NullableCloudTrustIntentResource struct {
	value *CloudTrustIntentResource
	isSet bool
}

func (v NullableCloudTrustIntentResource) Get() *CloudTrustIntentResource {
	return v.value
}

func (v *NullableCloudTrustIntentResource) Set(val *CloudTrustIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustIntentResource(val *CloudTrustIntentResource) *NullableCloudTrustIntentResource {
	return &NullableCloudTrustIntentResource{value: val, isSet: true}
}

func (v NullableCloudTrustIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
