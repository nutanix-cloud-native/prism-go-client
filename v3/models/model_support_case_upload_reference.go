...
// checks if the SupportCaseUploadReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseUploadReference{}

// SupportCaseUploadReference The reference to a support_case_upload
type SupportCaseUploadReference struct {
	// The kind name
...
type _SupportCaseUploadReference SupportCaseUploadReference
...
func NewSupportCaseUploadReference(kind string, uUID string) *SupportCaseUploadReference {
	this := SupportCaseUploadReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o SupportCaseUploadReference) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseUploadReference) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseUploadReference) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseUploadReference := _SupportCaseUploadReference{}

	err = json.Unmarshal(data, &varSupportCaseUploadReference)

	if err != nil {
		return err
	}

	*o = SupportCaseUploadReference(varSupportCaseUploadReference)
...
type NullableSupportCaseUploadReference struct {
	value *SupportCaseUploadReference
	isSet bool
}

func (v NullableSupportCaseUploadReference) Get() *SupportCaseUploadReference {
	return v.value
}

func (v *NullableSupportCaseUploadReference) Set(val *SupportCaseUploadReference) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseUploadReference) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseUploadReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseUploadReference(val *SupportCaseUploadReference) *NullableSupportCaseUploadReference {
	return &NullableSupportCaseUploadReference{value: val, isSet: true}
}

func (v NullableSupportCaseUploadReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseUploadReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
