...
// checks if the ReportConfigReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigReference{}

// ReportConfigReference The reference to a report_config
type ReportConfigReference struct {
	// The kind name
...
type _ReportConfigReference ReportConfigReference
...
func (o ReportConfigReference) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigReference) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfigReference) UnmarshalJSON(data []byte) (err error) {
	...
	varReportConfigReference := _ReportConfigReference{}

	err = json.Unmarshal(data, &varReportConfigReference)

	if err != nil {
		return err
	}

	*o = ReportConfigReference(varReportConfigReference)
...
type NullableReportConfigReference struct {
	value *ReportConfigReference
	isSet bool
}

func (v NullableReportConfigReference) Get() *ReportConfigReference {
	return v.value
}

func (v *NullableReportConfigReference) Set(val *ReportConfigReference) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigReference) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigReference(val *ReportConfigReference) *NullableReportConfigReference {
	return &NullableReportConfigReference{value: val, isSet: true}
}

func (v NullableReportConfigReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
