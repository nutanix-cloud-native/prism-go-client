...
// checks if the EnvironmentReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentReference{}

// EnvironmentReference The reference to a environment
...
type _EnvironmentReference EnvironmentReference
...
func (o EnvironmentReference) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentReference) ToMap() (map[string]interface{}, error) {
...
func (o *EnvironmentReference) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvironmentReference := _EnvironmentReference{}

	err = json.Unmarshal(data, &varEnvironmentReference)

	if err != nil {
		return err
	}

	*o = EnvironmentReference(varEnvironmentReference)
...
type NullableEnvironmentReference struct {
	value *EnvironmentReference
	isSet bool
}

func (v NullableEnvironmentReference) Get() *EnvironmentReference {
	return v.value
}

func (v *NullableEnvironmentReference) Set(val *EnvironmentReference) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentReference) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentReference(val *EnvironmentReference) *NullableEnvironmentReference {
	return &NullableEnvironmentReference{value: val, isSet: true}
}

func (v NullableEnvironmentReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
