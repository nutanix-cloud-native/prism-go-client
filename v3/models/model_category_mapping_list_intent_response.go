...
// checks if the CategoryMappingListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingListIntentResponse{}

// CategoryMappingListIntentResponse Response object for intentful operation of category_mappings
type CategoryMappingListIntentResponse struct {
	Entities []CategoryMappingIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata CategoryMappingListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _CategoryMappingListIntentResponse CategoryMappingListIntentResponse
...
func NewCategoryMappingListIntentResponse(apiVersion string, metadata CategoryMappingListMetadataOutput) *CategoryMappingListIntentResponse {
	this := CategoryMappingListIntentResponse{}
...
func (o *CategoryMappingListIntentResponse) GetEntities() []CategoryMappingIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []CategoryMappingIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []CategoryMappingIntentResource and assigns it to the Entities field.
...
func (o *CategoryMappingListIntentResponse) GetMetadata() CategoryMappingListMetadataOutput {
	if o == nil {
		var ret CategoryMappingListMetadataOutput
		return ret
	}
...
func (o CategoryMappingListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryMappingListIntentResponse := _CategoryMappingListIntentResponse{}

	err = json.Unmarshal(data, &varCategoryMappingListIntentResponse)

	if err != nil {
		return err
	}

	*o = CategoryMappingListIntentResponse(varCategoryMappingListIntentResponse)
...
type NullableCategoryMappingListIntentResponse struct {
	value *CategoryMappingListIntentResponse
	isSet bool
}

func (v NullableCategoryMappingListIntentResponse) Get() *CategoryMappingListIntentResponse {
	return v.value
}

func (v *NullableCategoryMappingListIntentResponse) Set(val *CategoryMappingListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingListIntentResponse(val *CategoryMappingListIntentResponse) *NullableCategoryMappingListIntentResponse {
	return &NullableCategoryMappingListIntentResponse{value: val, isSet: true}
}

func (v NullableCategoryMappingListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
