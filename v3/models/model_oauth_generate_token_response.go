...
// checks if the OauthGenerateTokenResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthGenerateTokenResponse{}
...
type _OauthGenerateTokenResponse OauthGenerateTokenResponse
...
func NewOauthGenerateTokenResponse(clientSecret string, oauthToken OauthToken, clientId string) *OauthGenerateTokenResponse {
	this := OauthGenerateTokenResponse{}
...
// GetOauthToken returns the OauthToken field value
...
// GetOauthTokenOk returns a tuple with the OauthToken field value
// and a boolean to check if the value has been set.
...
// SetOauthToken sets field value
...
func (o OauthGenerateTokenResponse) MarshalJSON() ([]byte, error) {
...
func (o OauthGenerateTokenResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OauthGenerateTokenResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varOauthGenerateTokenResponse := _OauthGenerateTokenResponse{}

	err = json.Unmarshal(data, &varOauthGenerateTokenResponse)

	if err != nil {
		return err
	}

	*o = OauthGenerateTokenResponse(varOauthGenerateTokenResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "client_secret")
		delete(additionalProperties, "oauth_token")
...
type NullableOauthGenerateTokenResponse struct {
	value *OauthGenerateTokenResponse
	isSet bool
}

func (v NullableOauthGenerateTokenResponse) Get() *OauthGenerateTokenResponse {
	return v.value
}

func (v *NullableOauthGenerateTokenResponse) Set(val *OauthGenerateTokenResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthGenerateTokenResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthGenerateTokenResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthGenerateTokenResponse(val *OauthGenerateTokenResponse) *NullableOauthGenerateTokenResponse {
	return &NullableOauthGenerateTokenResponse{value: val, isSet: true}
}

func (v NullableOauthGenerateTokenResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthGenerateTokenResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
