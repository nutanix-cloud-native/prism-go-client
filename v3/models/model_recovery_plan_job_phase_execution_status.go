...
type RecoveryPlanJobPhaseExecutionStatus struct {
	...
	// List of execution status of steps for a phase of the Recovery Plan Job execution. 
	StepExecutionStatusList []RecoveryPlanJobStepExecutionStatus `json:"step_execution_status_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanJobPhaseExecutionStatus RecoveryPlanJobPhaseExecutionStatus
...
func NewRecoveryPlanJobPhaseExecutionStatus() *RecoveryPlanJobPhaseExecutionStatus {
	this := RecoveryPlanJobPhaseExecutionStatus{}
	return &this
}
...
// GetStepExecutionStatusList returns the StepExecutionStatusList field value if set, zero value otherwise.
func (o *RecoveryPlanJobPhaseExecutionStatus) GetStepExecutionStatusList() []RecoveryPlanJobStepExecutionStatus {
	if o == nil || IsNil(o.StepExecutionStatusList) {
		var ret []RecoveryPlanJobStepExecutionStatus
		return ret
	}
	return o.StepExecutionStatusList
}

// GetStepExecutionStatusListOk returns a tuple with the StepExecutionStatusList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobPhaseExecutionStatus) GetStepExecutionStatusListOk() ([]RecoveryPlanJobStepExecutionStatus, bool) {
	if o == nil || IsNil(o.StepExecutionStatusList) {
		return nil, false
	}
	return o.StepExecutionStatusList, true
}
...
// SetStepExecutionStatusList gets a reference to the given []RecoveryPlanJobStepExecutionStatus and assigns it to the StepExecutionStatusList field.
func (o *RecoveryPlanJobPhaseExecutionStatus) SetStepExecutionStatusList(v []RecoveryPlanJobStepExecutionStatus) {
	o.StepExecutionStatusList = v
}

func (o RecoveryPlanJobPhaseExecutionStatus) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobPhaseExecutionStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.StepExecutionStatusList) {
		toSerialize["step_execution_status_list"] = o.StepExecutionStatusList
	}
...
func (o *RecoveryPlanJobPhaseExecutionStatus) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanJobPhaseExecutionStatus := _RecoveryPlanJobPhaseExecutionStatus{}

	err = json.Unmarshal(data, &varRecoveryPlanJobPhaseExecutionStatus)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobPhaseExecutionStatus(varRecoveryPlanJobPhaseExecutionStatus)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "step_execution_status_list")
...
type NullableRecoveryPlanJobPhaseExecutionStatus struct {
	value *RecoveryPlanJobPhaseExecutionStatus
	isSet bool
}

func (v NullableRecoveryPlanJobPhaseExecutionStatus) Get() *RecoveryPlanJobPhaseExecutionStatus {
	return v.value
}

func (v *NullableRecoveryPlanJobPhaseExecutionStatus) Set(val *RecoveryPlanJobPhaseExecutionStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobPhaseExecutionStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobPhaseExecutionStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobPhaseExecutionStatus(val *RecoveryPlanJobPhaseExecutionStatus) *NullableRecoveryPlanJobPhaseExecutionStatus {
	return &NullableRecoveryPlanJobPhaseExecutionStatus{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobPhaseExecutionStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobPhaseExecutionStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
