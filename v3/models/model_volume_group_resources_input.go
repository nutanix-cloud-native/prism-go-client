...
// checks if the VolumeGroupResourcesInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupResourcesInput{}

// VolumeGroupResourcesInput Volume group resources.
type VolumeGroupResourcesInput struct {
	// Flash Mode, if enabled all volume disks of the VG will be pinned to SSD tier. 
	FlashMode *string `json:"flash_mode,omitempty"`
	// Whether to enable volume group load balancing.
	...
	IscsiTargetPrefix *string `json:"iscsi_target_prefix,omitempty" validate:"regexp=^[\\\\da-zA-Z:\\\\.\\\\-]+$"`
	...
	AttachmentList []AttachmentReferenceInput `json:"attachment_list,omitempty"`
	// Expected usage type for the volume group.
	UsageType *string `json:"usage_type,omitempty"`
	// Target Secret in case of CHAP authentication.
	...
	DiskList []VolumeDiskResourceInput `json:"disk_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VolumeGroupResourcesInput VolumeGroupResourcesInput
...
func NewVolumeGroupResourcesInput() *VolumeGroupResourcesInput {
	this := VolumeGroupResourcesInput{}
	return &this
}
...
func (o *VolumeGroupResourcesInput) GetAttachmentList() []AttachmentReferenceInput {
	if o == nil || IsNil(o.AttachmentList) {
		var ret []AttachmentReferenceInput
		return ret
	}
...
// SetAttachmentList gets a reference to the given []AttachmentReferenceInput and assigns it to the AttachmentList field.
...
func (o *VolumeGroupResourcesInput) GetDiskList() []VolumeDiskResourceInput {
	if o == nil || IsNil(o.DiskList) {
		var ret []VolumeDiskResourceInput
		return ret
	}
	return o.DiskList
}
...
// SetDiskList gets a reference to the given []VolumeDiskResourceInput and assigns it to the DiskList field.
func (o *VolumeGroupResourcesInput) SetDiskList(v []VolumeDiskResourceInput) {
	o.DiskList = v
}

func (o VolumeGroupResourcesInput) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupResourcesInput) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeGroupResourcesInput) UnmarshalJSON(data []byte) (err error) {
	varVolumeGroupResourcesInput := _VolumeGroupResourcesInput{}

	err = json.Unmarshal(data, &varVolumeGroupResourcesInput)

	if err != nil {
		return err
	}

	*o = VolumeGroupResourcesInput(varVolumeGroupResourcesInput)
...
type NullableVolumeGroupResourcesInput struct {
	value *VolumeGroupResourcesInput
	isSet bool
}

func (v NullableVolumeGroupResourcesInput) Get() *VolumeGroupResourcesInput {
	return v.value
}

func (v *NullableVolumeGroupResourcesInput) Set(val *VolumeGroupResourcesInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupResourcesInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupResourcesInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupResourcesInput(val *VolumeGroupResourcesInput) *NullableVolumeGroupResourcesInput {
	return &NullableVolumeGroupResourcesInput{value: val, isSet: true}
}

func (v NullableVolumeGroupResourcesInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupResourcesInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
