...
// GetGatewayAddressList returns the GatewayAddressList field value if set, zero value otherwise.
func (o *IpAddress) GetGatewayAddressList() []string {
	if o == nil || IsNil(o.GatewayAddressList) {
		var ret []string
		return ret
	}
	return o.GatewayAddressList
}

// GetGatewayAddressListOk returns a tuple with the GatewayAddressList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpAddress) GetGatewayAddressListOk() ([]string, bool) {
	if o == nil || IsNil(o.GatewayAddressList) {
		return nil, false
	}
	return o.GatewayAddressList, true
}
...
// SetGatewayAddressList gets a reference to the given []string and assigns it to the GatewayAddressList field.
func (o *IpAddress) SetGatewayAddressList(v []string) {
	o.GatewayAddressList = v
}
...
func (o IpAddress) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GatewayAddressList) {
		toSerialize["gateway_address_list"] = o.GatewayAddressList
	}
...
func (o *IpAddress) UnmarshalJSON(data []byte) (err error) {
	...
	*o = IpAddress(varIpAddress)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "gateway_address_list")
