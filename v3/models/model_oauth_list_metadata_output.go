...
// checks if the OauthListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthListMetadataOutput{}

// OauthListMetadataOutput All api calls that return a list will have this metadata block 
type OauthListMetadataOutput struct {
	// The kind name
...
type _OauthListMetadataOutput OauthListMetadataOutput
...
func NewOauthListMetadataOutput() *OauthListMetadataOutput {
	this := OauthListMetadataOutput{}
	var kind string = "oauth"
	this.Kind = &kind
	return &this
}
...
func (o OauthListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o OauthListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *OauthListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varOauthListMetadataOutput := _OauthListMetadataOutput{}

	err = json.Unmarshal(data, &varOauthListMetadataOutput)

	if err != nil {
		return err
	}

	*o = OauthListMetadataOutput(varOauthListMetadataOutput)
...
type NullableOauthListMetadataOutput struct {
	value *OauthListMetadataOutput
	isSet bool
}

func (v NullableOauthListMetadataOutput) Get() *OauthListMetadataOutput {
	return v.value
}

func (v *NullableOauthListMetadataOutput) Set(val *OauthListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthListMetadataOutput(val *OauthListMetadataOutput) *NullableOauthListMetadataOutput {
	return &NullableOauthListMetadataOutput{value: val, isSet: true}
}

func (v NullableOauthListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
