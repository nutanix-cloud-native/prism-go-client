...
// checks if the IcmpStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IcmpStatus{}

// IcmpStatus ICMP parameters to be matched in routing policy.
...
func (o IcmpStatus) MarshalJSON() ([]byte, error) {
...
func (o IcmpStatus) ToMap() (map[string]interface{}, error) {
...
func (o *IcmpStatus) UnmarshalJSON(data []byte) (err error) {
	varIcmpStatus := _IcmpStatus{}

	err = json.Unmarshal(data, &varIcmpStatus)

	if err != nil {
		return err
	}

	*o = IcmpStatus(varIcmpStatus)
...
type NullableIcmpStatus struct {
	value *IcmpStatus
	isSet bool
}

func (v NullableIcmpStatus) Get() *IcmpStatus {
	return v.value
}

func (v *NullableIcmpStatus) Set(val *IcmpStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableIcmpStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableIcmpStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIcmpStatus(val *IcmpStatus) *NullableIcmpStatus {
	return &NullableIcmpStatus{value: val, isSet: true}
}

func (v NullableIcmpStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIcmpStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
