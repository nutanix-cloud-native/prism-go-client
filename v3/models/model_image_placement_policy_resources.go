...
// checks if the ImagePlacementPolicyResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyResources{}

// ImagePlacementPolicyResources Describes the image placement policy spec resource object
type ImagePlacementPolicyResources struct {
	ClusterEntityFilter PlacementEntityFilter `json:"cluster_entity_filter"`
	ImageEntityFilter PlacementEntityFilter `json:"image_entity_filter"`
...
type _ImagePlacementPolicyResources ImagePlacementPolicyResources
...
func NewImagePlacementPolicyResources(clusterEntityFilter PlacementEntityFilter, imageEntityFilter PlacementEntityFilter) *ImagePlacementPolicyResources {
	this := ImagePlacementPolicyResources{}
...
// GetClusterEntityFilter returns the ClusterEntityFilter field value
...
// GetClusterEntityFilterOk returns a tuple with the ClusterEntityFilter field value
...
// GetImageEntityFilterOk returns a tuple with the ImageEntityFilter field value
// and a boolean to check if the value has been set.
...
// SetImageEntityFilter sets field value
...
func (o ImagePlacementPolicyResources) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyResources) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicyResources) UnmarshalJSON(data []byte) (err error) {
	...
	varImagePlacementPolicyResources := _ImagePlacementPolicyResources{}

	err = json.Unmarshal(data, &varImagePlacementPolicyResources)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyResources(varImagePlacementPolicyResources)
...
type NullableImagePlacementPolicyResources struct {
	value *ImagePlacementPolicyResources
	isSet bool
}

func (v NullableImagePlacementPolicyResources) Get() *ImagePlacementPolicyResources {
	return v.value
}

func (v *NullableImagePlacementPolicyResources) Set(val *ImagePlacementPolicyResources) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyResources) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyResources(val *ImagePlacementPolicyResources) *NullableImagePlacementPolicyResources {
	return &NullableImagePlacementPolicyResources{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
