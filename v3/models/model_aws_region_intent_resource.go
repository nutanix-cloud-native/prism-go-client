...
// checks if the AwsRegionIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRegionIntentResource{}

// AwsRegionIntentResource aws_region entity
type AwsRegionIntentResource struct {
	Status *AwsRegionDefStatus `json:"status,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsRegionMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsRegionIntentResource AwsRegionIntentResource
...
// SetStatus gets a reference to the given AwsRegionDefStatus and assigns it to the Status field.
...
func (o AwsRegionIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsRegionIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRegionIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsRegionIntentResource := _AwsRegionIntentResource{}

	err = json.Unmarshal(data, &varAwsRegionIntentResource)

	if err != nil {
		return err
	}

	*o = AwsRegionIntentResource(varAwsRegionIntentResource)
...
type NullableAwsRegionIntentResource struct {
	value *AwsRegionIntentResource
	isSet bool
}

func (v NullableAwsRegionIntentResource) Get() *AwsRegionIntentResource {
	return v.value
}

func (v *NullableAwsRegionIntentResource) Set(val *AwsRegionIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRegionIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRegionIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRegionIntentResource(val *AwsRegionIntentResource) *NullableAwsRegionIntentResource {
	return &NullableAwsRegionIntentResource{value: val, isSet: true}
}

func (v NullableAwsRegionIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRegionIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
