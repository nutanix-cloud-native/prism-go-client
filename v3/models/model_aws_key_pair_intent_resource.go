...
// checks if the AwsKeyPairIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsKeyPairIntentResource{}

// AwsKeyPairIntentResource aws_key_pair entity
type AwsKeyPairIntentResource struct {
	Status *AwsKeyPairDefStatus `json:"status,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsKeyPairMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsKeyPairIntentResource AwsKeyPairIntentResource
...
// SetStatus gets a reference to the given AwsKeyPairDefStatus and assigns it to the Status field.
...
func (o AwsKeyPairIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsKeyPairIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsKeyPairIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsKeyPairIntentResource := _AwsKeyPairIntentResource{}

	err = json.Unmarshal(data, &varAwsKeyPairIntentResource)

	if err != nil {
		return err
	}

	*o = AwsKeyPairIntentResource(varAwsKeyPairIntentResource)
...
type NullableAwsKeyPairIntentResource struct {
	value *AwsKeyPairIntentResource
	isSet bool
}

func (v NullableAwsKeyPairIntentResource) Get() *AwsKeyPairIntentResource {
	return v.value
}

func (v *NullableAwsKeyPairIntentResource) Set(val *AwsKeyPairIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsKeyPairIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsKeyPairIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsKeyPairIntentResource(val *AwsKeyPairIntentResource) *NullableAwsKeyPairIntentResource {
	return &NullableAwsKeyPairIntentResource{value: val, isSet: true}
}

func (v NullableAwsKeyPairIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsKeyPairIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
