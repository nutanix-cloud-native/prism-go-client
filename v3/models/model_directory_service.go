...
// DirectoryService The configuration details of the directory service.
type DirectoryService struct {
	// The name of the directory service.
	Name string `json:"name"`
	Resources DirectoryServiceResources1 `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _DirectoryService DirectoryService
...
func (o *DirectoryService) GetResources() DirectoryServiceResources1 {
	if o == nil {
		var ret DirectoryServiceResources1
		return ret
	}
...
func (o *DirectoryService) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectoryService := _DirectoryService{}

	err = json.Unmarshal(data, &varDirectoryService)

	if err != nil {
		return err
	}

	*o = DirectoryService(varDirectoryService)
