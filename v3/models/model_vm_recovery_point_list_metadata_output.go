...
// checks if the VmRecoveryPointListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPointListMetadataOutput{}

// VmRecoveryPointListMetadataOutput All api calls that return a list will have this metadata block 
type VmRecoveryPointListMetadataOutput struct {
	// The kind name
...
type _VmRecoveryPointListMetadataOutput VmRecoveryPointListMetadataOutput
...
func NewVmRecoveryPointListMetadataOutput() *VmRecoveryPointListMetadataOutput {
	this := VmRecoveryPointListMetadataOutput{}
	var kind string = "vm_recovery_point"
	this.Kind = &kind
	return &this
}
...
func (o VmRecoveryPointListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPointListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPointListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVmRecoveryPointListMetadataOutput := _VmRecoveryPointListMetadataOutput{}

	err = json.Unmarshal(data, &varVmRecoveryPointListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VmRecoveryPointListMetadataOutput(varVmRecoveryPointListMetadataOutput)
...
type NullableVmRecoveryPointListMetadataOutput struct {
	value *VmRecoveryPointListMetadataOutput
	isSet bool
}

func (v NullableVmRecoveryPointListMetadataOutput) Get() *VmRecoveryPointListMetadataOutput {
	return v.value
}

func (v *NullableVmRecoveryPointListMetadataOutput) Set(val *VmRecoveryPointListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPointListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPointListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPointListMetadataOutput(val *VmRecoveryPointListMetadataOutput) *NullableVmRecoveryPointListMetadataOutput {
	return &NullableVmRecoveryPointListMetadataOutput{value: val, isSet: true}
}

func (v NullableVmRecoveryPointListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPointListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
