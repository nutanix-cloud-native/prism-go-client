...
// checks if the HostIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostIntentInput{}

// HostIntentInput An intentful representation of a host
...
type _HostIntentInput HostIntentInput
...
func (o HostIntentInput) MarshalJSON() ([]byte, error) {
...
func (o HostIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *HostIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varHostIntentInput := _HostIntentInput{}

	err = json.Unmarshal(data, &varHostIntentInput)

	if err != nil {
		return err
	}

	*o = HostIntentInput(varHostIntentInput)
...
type NullableHostIntentInput struct {
	value *HostIntentInput
	isSet bool
}

func (v NullableHostIntentInput) Get() *HostIntentInput {
	return v.value
}

func (v *NullableHostIntentInput) Set(val *HostIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableHostIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableHostIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostIntentInput(val *HostIntentInput) *NullableHostIntentInput {
	return &NullableHostIntentInput{value: val, isSet: true}
}

func (v NullableHostIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
