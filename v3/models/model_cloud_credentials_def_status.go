...
// checks if the CloudCredentialsDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCredentialsDefStatus{}
...
type CloudCredentialsDefStatus struct {
	...
	// ID to uniquely identify cloud credentials
	Id int64 `json:"id"`
	Resources CloudCredentialsResources `json:"resources"`
	// Credentials name.
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _CloudCredentialsDefStatus CloudCredentialsDefStatus
...
func NewCloudCredentialsDefStatus(id int64, resources CloudCredentialsResources, name string) *CloudCredentialsDefStatus {
	this := CloudCredentialsDefStatus{}
	this.Id = id
...
func (o *CloudCredentialsDefStatus) GetResources() CloudCredentialsResources {
	if o == nil {
		var ret CloudCredentialsResources
		return ret
	}
...
func (o CloudCredentialsDefStatus) MarshalJSON() ([]byte, error) {
...
func (o CloudCredentialsDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CloudCredentialsDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudCredentialsDefStatus := _CloudCredentialsDefStatus{}

	err = json.Unmarshal(data, &varCloudCredentialsDefStatus)

	if err != nil {
		return err
	}

	*o = CloudCredentialsDefStatus(varCloudCredentialsDefStatus)
...
type NullableCloudCredentialsDefStatus struct {
	value *CloudCredentialsDefStatus
	isSet bool
}

func (v NullableCloudCredentialsDefStatus) Get() *CloudCredentialsDefStatus {
	return v.value
}

func (v *NullableCloudCredentialsDefStatus) Set(val *CloudCredentialsDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCredentialsDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCredentialsDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCredentialsDefStatus(val *CloudCredentialsDefStatus) *NullableCloudCredentialsDefStatus {
	return &NullableCloudCredentialsDefStatus{value: val, isSet: true}
}

func (v NullableCloudCredentialsDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCredentialsDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
