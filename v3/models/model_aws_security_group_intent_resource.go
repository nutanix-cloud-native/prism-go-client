...
// checks if the AwsSecurityGroupIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSecurityGroupIntentResource{}

// AwsSecurityGroupIntentResource aws_security_group entity
type AwsSecurityGroupIntentResource struct {
	Status *AwsSecurityGroupDefStatus `json:"status,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsSecurityGroupMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsSecurityGroupIntentResource AwsSecurityGroupIntentResource
...
func NewAwsSecurityGroupIntentResource(apiVersion string, metadata AwsSecurityGroupMetadata) *AwsSecurityGroupIntentResource {
	this := AwsSecurityGroupIntentResource{}
...
func (o *AwsSecurityGroupIntentResource) GetStatus() AwsSecurityGroupDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret AwsSecurityGroupDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given AwsSecurityGroupDefStatus and assigns it to the Status field.
...
func (o *AwsSecurityGroupIntentResource) GetMetadata() AwsSecurityGroupMetadata {
	if o == nil {
		var ret AwsSecurityGroupMetadata
		return ret
	}
...
func (o AwsSecurityGroupIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsSecurityGroupIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSecurityGroupIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsSecurityGroupIntentResource := _AwsSecurityGroupIntentResource{}

	err = json.Unmarshal(data, &varAwsSecurityGroupIntentResource)

	if err != nil {
		return err
	}

	*o = AwsSecurityGroupIntentResource(varAwsSecurityGroupIntentResource)
...
type NullableAwsSecurityGroupIntentResource struct {
	value *AwsSecurityGroupIntentResource
	isSet bool
}

func (v NullableAwsSecurityGroupIntentResource) Get() *AwsSecurityGroupIntentResource {
	return v.value
}

func (v *NullableAwsSecurityGroupIntentResource) Set(val *AwsSecurityGroupIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSecurityGroupIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSecurityGroupIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSecurityGroupIntentResource(val *AwsSecurityGroupIntentResource) *NullableAwsSecurityGroupIntentResource {
	return &NullableAwsSecurityGroupIntentResource{value: val, isSet: true}
}

func (v NullableAwsSecurityGroupIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSecurityGroupIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
