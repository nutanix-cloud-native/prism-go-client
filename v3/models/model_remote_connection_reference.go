...
// checks if the RemoteConnectionReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionReference{}

// RemoteConnectionReference The reference to a remote_connection
type RemoteConnectionReference struct {
	// The kind name
...
type _RemoteConnectionReference RemoteConnectionReference
...
func NewRemoteConnectionReference(kind string, uUID string) *RemoteConnectionReference {
	this := RemoteConnectionReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o RemoteConnectionReference) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionReference) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteConnectionReference) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteConnectionReference := _RemoteConnectionReference{}

	err = json.Unmarshal(data, &varRemoteConnectionReference)

	if err != nil {
		return err
	}

	*o = RemoteConnectionReference(varRemoteConnectionReference)
...
type NullableRemoteConnectionReference struct {
	value *RemoteConnectionReference
	isSet bool
}

func (v NullableRemoteConnectionReference) Get() *RemoteConnectionReference {
	return v.value
}

func (v *NullableRemoteConnectionReference) Set(val *RemoteConnectionReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionReference) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionReference(val *RemoteConnectionReference) *NullableRemoteConnectionReference {
	return &NullableRemoteConnectionReference{value: val, isSet: true}
}

func (v NullableRemoteConnectionReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
