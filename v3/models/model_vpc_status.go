...
// checks if the VpcStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcStatus{}

// VpcStatus The status of a REST API call. Only used when there is a failure to report. 
...
func (o VpcStatus) MarshalJSON() ([]byte, error) {
...
func (o VpcStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VpcStatus) UnmarshalJSON(data []byte) (err error) {
	varVpcStatus := _VpcStatus{}

	err = json.Unmarshal(data, &varVpcStatus)

	if err != nil {
		return err
	}

	*o = VpcStatus(varVpcStatus)
