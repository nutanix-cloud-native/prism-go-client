...
// checks if the CommonReportConfigIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigIntentResponse{}

// CommonReportConfigIntentResponse Response object for intentful operations on a common_report_config
type CommonReportConfigIntentResponse struct {
...
type _CommonReportConfigIntentResponse CommonReportConfigIntentResponse
...
func NewCommonReportConfigIntentResponse(apiVersion string, metadata CommonReportConfigMetadata) *CommonReportConfigIntentResponse {
	this := CommonReportConfigIntentResponse{}
...
func (o CommonReportConfigIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfigIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonReportConfigIntentResponse := _CommonReportConfigIntentResponse{}

	err = json.Unmarshal(data, &varCommonReportConfigIntentResponse)

	if err != nil {
		return err
	}

	*o = CommonReportConfigIntentResponse(varCommonReportConfigIntentResponse)
...
type NullableCommonReportConfigIntentResponse struct {
	value *CommonReportConfigIntentResponse
	isSet bool
}

func (v NullableCommonReportConfigIntentResponse) Get() *CommonReportConfigIntentResponse {
	return v.value
}

func (v *NullableCommonReportConfigIntentResponse) Set(val *CommonReportConfigIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigIntentResponse(val *CommonReportConfigIntentResponse) *NullableCommonReportConfigIntentResponse {
	return &NullableCommonReportConfigIntentResponse{value: val, isSet: true}
}

func (v NullableCommonReportConfigIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
