...
// checks if the DirectConnectVirtualInterfaceListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterfaceListMetadataOutput{}

// DirectConnectVirtualInterfaceListMetadataOutput All api calls that return a list will have this metadata block 
type DirectConnectVirtualInterfaceListMetadataOutput struct {
	// The kind name
...
type _DirectConnectVirtualInterfaceListMetadataOutput DirectConnectVirtualInterfaceListMetadataOutput
...
func NewDirectConnectVirtualInterfaceListMetadataOutput() *DirectConnectVirtualInterfaceListMetadataOutput {
	this := DirectConnectVirtualInterfaceListMetadataOutput{}
	var kind string = "direct_connect_virtual_interface"
	this.Kind = &kind
	return &this
}
...
func (o *DirectConnectVirtualInterfaceListMetadataOutput) GetSortOrder() string {
...
func (o DirectConnectVirtualInterfaceListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterfaceListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectVirtualInterfaceListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varDirectConnectVirtualInterfaceListMetadataOutput := _DirectConnectVirtualInterfaceListMetadataOutput{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterfaceListMetadataOutput)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterfaceListMetadataOutput(varDirectConnectVirtualInterfaceListMetadataOutput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "kind")
		delete(additionalProperties, "total_matches")
...
type NullableDirectConnectVirtualInterfaceListMetadataOutput struct {
	value *DirectConnectVirtualInterfaceListMetadataOutput
	isSet bool
}

func (v NullableDirectConnectVirtualInterfaceListMetadataOutput) Get() *DirectConnectVirtualInterfaceListMetadataOutput {
	return v.value
}

func (v *NullableDirectConnectVirtualInterfaceListMetadataOutput) Set(val *DirectConnectVirtualInterfaceListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterfaceListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterfaceListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterfaceListMetadataOutput(val *DirectConnectVirtualInterfaceListMetadataOutput) *NullableDirectConnectVirtualInterfaceListMetadataOutput {
	return &NullableDirectConnectVirtualInterfaceListMetadataOutput{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterfaceListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterfaceListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
