...
// checks if the AuditStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditStatus{}

// AuditStatus The status of a REST API call. Only used when there is a failure to report. 
...
func (o AuditStatus) MarshalJSON() ([]byte, error) {
...
func (o AuditStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AuditStatus) UnmarshalJSON(data []byte) (err error) {
	varAuditStatus := _AuditStatus{}

	err = json.Unmarshal(data, &varAuditStatus)

	if err != nil {
		return err
	}

	*o = AuditStatus(varAuditStatus)
...
type NullableAuditStatus struct {
	value *AuditStatus
	isSet bool
}

func (v NullableAuditStatus) Get() *AuditStatus {
	return v.value
}

func (v *NullableAuditStatus) Set(val *AuditStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditStatus(val *AuditStatus) *NullableAuditStatus {
	return &NullableAuditStatus{value: val, isSet: true}
}

func (v NullableAuditStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
