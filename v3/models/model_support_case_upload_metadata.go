...
// checks if the SupportCaseUploadMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseUploadMetadata{}

// SupportCaseUploadMetadata The support_case_upload kind metadata
type SupportCaseUploadMetadata struct {
	...
	// Categories for the support_case_upload. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the support_case_upload. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// support_case_upload name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SupportCaseUploadMetadata SupportCaseUploadMetadata
...
func NewSupportCaseUploadMetadata(kind string) *SupportCaseUploadMetadata {
	this := SupportCaseUploadMetadata{}
...
func (o *SupportCaseUploadMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *SupportCaseUploadMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *SupportCaseUploadMetadata) SetName(v string) {
	o.Name = &v
}

func (o SupportCaseUploadMetadata) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseUploadMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseUploadMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseUploadMetadata := _SupportCaseUploadMetadata{}

	err = json.Unmarshal(data, &varSupportCaseUploadMetadata)

	if err != nil {
		return err
	}

	*o = SupportCaseUploadMetadata(varSupportCaseUploadMetadata)
...
type NullableSupportCaseUploadMetadata struct {
	value *SupportCaseUploadMetadata
	isSet bool
}

func (v NullableSupportCaseUploadMetadata) Get() *SupportCaseUploadMetadata {
	return v.value
}

func (v *NullableSupportCaseUploadMetadata) Set(val *SupportCaseUploadMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseUploadMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseUploadMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseUploadMetadata(val *SupportCaseUploadMetadata) *NullableSupportCaseUploadMetadata {
	return &NullableSupportCaseUploadMetadata{value: val, isSet: true}
}

func (v NullableSupportCaseUploadMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseUploadMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
