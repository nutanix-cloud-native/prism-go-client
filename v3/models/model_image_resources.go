...
// checks if the ImageResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageResources{}
...
type _ImageResources ImageResources
...
// SetVersion gets a reference to the given ImageVersionResources and assigns it to the Version field.
...
func (o ImageResources) MarshalJSON() ([]byte, error) {
...
func (o ImageResources) ToMap() (map[string]interface{}, error) {
...
func (o *ImageResources) UnmarshalJSON(data []byte) (err error) {
	varImageResources := _ImageResources{}

	err = json.Unmarshal(data, &varImageResources)

	if err != nil {
		return err
	}

	*o = ImageResources(varImageResources)
...
type NullableImageResources struct {
	value *ImageResources
	isSet bool
}

func (v NullableImageResources) Get() *ImageResources {
	return v.value
}

func (v *NullableImageResources) Set(val *ImageResources) {
	v.value = val
	v.isSet = true
}

func (v NullableImageResources) IsSet() bool {
	return v.isSet
}

func (v *NullableImageResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageResources(val *ImageResources) *NullableImageResources {
	return &NullableImageResources{value: val, isSet: true}
}

func (v NullableImageResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
