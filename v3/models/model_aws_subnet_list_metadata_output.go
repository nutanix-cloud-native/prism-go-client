...
// checks if the AwsSubnetListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSubnetListMetadataOutput{}

// AwsSubnetListMetadataOutput All api calls that return a list will have this metadata block 
type AwsSubnetListMetadataOutput struct {
	// The kind name
...
type _AwsSubnetListMetadataOutput AwsSubnetListMetadataOutput
...
func NewAwsSubnetListMetadataOutput() *AwsSubnetListMetadataOutput {
	this := AwsSubnetListMetadataOutput{}
	var kind string = "aws_subnet"
	this.Kind = &kind
	return &this
}
...
func (o AwsSubnetListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsSubnetListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSubnetListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsSubnetListMetadataOutput := _AwsSubnetListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsSubnetListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsSubnetListMetadataOutput(varAwsSubnetListMetadataOutput)
...
type NullableAwsSubnetListMetadataOutput struct {
	value *AwsSubnetListMetadataOutput
	isSet bool
}

func (v NullableAwsSubnetListMetadataOutput) Get() *AwsSubnetListMetadataOutput {
	return v.value
}

func (v *NullableAwsSubnetListMetadataOutput) Set(val *AwsSubnetListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSubnetListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSubnetListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSubnetListMetadataOutput(val *AwsSubnetListMetadataOutput) *NullableAwsSubnetListMetadataOutput {
	return &NullableAwsSubnetListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsSubnetListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSubnetListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
