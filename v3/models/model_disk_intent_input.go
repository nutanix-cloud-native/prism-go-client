...
// checks if the DiskIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskIntentInput{}

// DiskIntentInput An intentful representation of a disk
...
type _DiskIntentInput DiskIntentInput
...
func (o DiskIntentInput) MarshalJSON() ([]byte, error) {
...
func (o DiskIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *DiskIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varDiskIntentInput := _DiskIntentInput{}

	err = json.Unmarshal(data, &varDiskIntentInput)

	if err != nil {
		return err
	}

	*o = DiskIntentInput(varDiskIntentInput)
...
type NullableDiskIntentInput struct {
	value *DiskIntentInput
	isSet bool
}

func (v NullableDiskIntentInput) Get() *DiskIntentInput {
	return v.value
}

func (v *NullableDiskIntentInput) Set(val *DiskIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskIntentInput(val *DiskIntentInput) *NullableDiskIntentInput {
	return &NullableDiskIntentInput{value: val, isSet: true}
}

func (v NullableDiskIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
