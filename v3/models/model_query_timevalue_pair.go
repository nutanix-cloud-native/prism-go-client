...
// checks if the QueryTimevaluePair type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryTimevaluePair{}

// QueryTimevaluePair Time-Value pairs in each grid cell.
type QueryTimevaluePair struct {
	Value *QueryValue `json:"value,omitempty"`
	Time *int64 `json:"time,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QueryTimevaluePair QueryTimevaluePair
...
// SetValue gets a reference to the given QueryValue and assigns it to the Value field.
...
func (o QueryTimevaluePair) MarshalJSON() ([]byte, error) {
...
func (o QueryTimevaluePair) ToMap() (map[string]interface{}, error) {
...
func (o *QueryTimevaluePair) UnmarshalJSON(data []byte) (err error) {
	varQueryTimevaluePair := _QueryTimevaluePair{}

	err = json.Unmarshal(data, &varQueryTimevaluePair)

	if err != nil {
		return err
	}

	*o = QueryTimevaluePair(varQueryTimevaluePair)
...
type NullableQueryTimevaluePair struct {
	value *QueryTimevaluePair
	isSet bool
}

func (v NullableQueryTimevaluePair) Get() *QueryTimevaluePair {
	return v.value
}

func (v *NullableQueryTimevaluePair) Set(val *QueryTimevaluePair) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryTimevaluePair) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryTimevaluePair) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryTimevaluePair(val *QueryTimevaluePair) *NullableQueryTimevaluePair {
	return &NullableQueryTimevaluePair{value: val, isSet: true}
}

func (v NullableQueryTimevaluePair) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryTimevaluePair) UnmarshalJSON(src []byte) error {
	v.isSet = true
