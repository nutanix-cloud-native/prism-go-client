...
// checks if the VmHostAffinityPolicyVmsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityPolicyVmsInfo{}

// VmHostAffinityPolicyVmsInfo VMs information which are part of VM Host Affinity Policy.
type VmHostAffinityPolicyVmsInfo struct {
	// Compliance status.
	...
	// VM categories across whom current affinity policy is defined. 
	VmCategories *map[string][]string `json:"vm_categories,omitempty"`
...
type _VmHostAffinityPolicyVmsInfo VmHostAffinityPolicyVmsInfo
...
func NewVmHostAffinityPolicyVmsInfo() *VmHostAffinityPolicyVmsInfo {
	this := VmHostAffinityPolicyVmsInfo{}
	return &this
}
...
// SetHostReference gets a reference to the given HostReference and assigns it to the HostReference field.
...
// GetVmCategories returns the VmCategories field value if set, zero value otherwise.
func (o *VmHostAffinityPolicyVmsInfo) GetVmCategories() map[string][]string {
	if o == nil || IsNil(o.VmCategories) {
		var ret map[string][]string
		return ret
	}
	return *o.VmCategories
}

// GetVmCategoriesOk returns a tuple with the VmCategories field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmHostAffinityPolicyVmsInfo) GetVmCategoriesOk() (*map[string][]string, bool) {
	if o == nil || IsNil(o.VmCategories) {
		return nil, false
	}
	return o.VmCategories, true
}
...
// SetVmCategories gets a reference to the given map[string][]string and assigns it to the VmCategories field.
...
func (o VmHostAffinityPolicyVmsInfo) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityPolicyVmsInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.VmCategories) {
		toSerialize["vm_categories"] = o.VmCategories
	}
	if !IsNil(o.Reason) {
...
func (o *VmHostAffinityPolicyVmsInfo) UnmarshalJSON(data []byte) (err error) {
	varVmHostAffinityPolicyVmsInfo := _VmHostAffinityPolicyVmsInfo{}

	err = json.Unmarshal(data, &varVmHostAffinityPolicyVmsInfo)

	if err != nil {
		return err
	}

	*o = VmHostAffinityPolicyVmsInfo(varVmHostAffinityPolicyVmsInfo)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "vm_categories")
...
type NullableVmHostAffinityPolicyVmsInfo struct {
	value *VmHostAffinityPolicyVmsInfo
	isSet bool
}

func (v NullableVmHostAffinityPolicyVmsInfo) Get() *VmHostAffinityPolicyVmsInfo {
	return v.value
}

func (v *NullableVmHostAffinityPolicyVmsInfo) Set(val *VmHostAffinityPolicyVmsInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityPolicyVmsInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityPolicyVmsInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityPolicyVmsInfo(val *VmHostAffinityPolicyVmsInfo) *NullableVmHostAffinityPolicyVmsInfo {
	return &NullableVmHostAffinityPolicyVmsInfo{value: val, isSet: true}
}

func (v NullableVmHostAffinityPolicyVmsInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityPolicyVmsInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
