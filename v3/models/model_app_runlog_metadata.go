...
// checks if the AppRunlogMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunlogMetadata{}

// AppRunlogMetadata The app_runlog kind metadata
type AppRunlogMetadata struct {
	...
	// Categories for the app_runlog. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the app_runlog. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _AppRunlogMetadata AppRunlogMetadata
...
func (o AppRunlogMetadata) MarshalJSON() ([]byte, error) {
...
func (o AppRunlogMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunlogMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRunlogMetadata := _AppRunlogMetadata{}

	err = json.Unmarshal(data, &varAppRunlogMetadata)

	if err != nil {
		return err
	}

	*o = AppRunlogMetadata(varAppRunlogMetadata)
...
type NullableAppRunlogMetadata struct {
	value *AppRunlogMetadata
	isSet bool
}

func (v NullableAppRunlogMetadata) Get() *AppRunlogMetadata {
	return v.value
}

func (v *NullableAppRunlogMetadata) Set(val *AppRunlogMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunlogMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunlogMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunlogMetadata(val *AppRunlogMetadata) *NullableAppRunlogMetadata {
	return &NullableAppRunlogMetadata{value: val, isSet: true}
}

func (v NullableAppRunlogMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunlogMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
