...
// checks if the CloudCredentialsResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCredentialsResources{}

// CloudCredentialsResources Cloud credentials resources
...
type _CloudCredentialsResources CloudCredentialsResources
...
func NewCloudCredentialsResources(cloudType string) *CloudCredentialsResources {
	this := CloudCredentialsResources{}
...
// GetSecureId returns the SecureId field value if set, zero value otherwise.
func (o *CloudCredentialsResources) GetSecureId() string {
	if o == nil || IsNil(o.SecureId) {
		var ret string
		return ret
	}
	return *o.SecureId
...
// GetSecureIdOk returns a tuple with the SecureId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CloudCredentialsResources) GetSecureIdOk() (*string, bool) {
	if o == nil || IsNil(o.SecureId) {
		return nil, false
	}
	return o.SecureId, true
}
...
// SetSecureId gets a reference to the given string and assigns it to the SecureId field.
func (o *CloudCredentialsResources) SetSecureId(v string) {
	o.SecureId = &v
}

func (o CloudCredentialsResources) MarshalJSON() ([]byte, error) {
...
func (o CloudCredentialsResources) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SecureId) {
		toSerialize["secure_id"] = o.SecureId
	}
...
func (o *CloudCredentialsResources) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudCredentialsResources := _CloudCredentialsResources{}

	err = json.Unmarshal(data, &varCloudCredentialsResources)

	if err != nil {
		return err
	}

	*o = CloudCredentialsResources(varCloudCredentialsResources)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "secure_id")
...
type NullableCloudCredentialsResources struct {
	value *CloudCredentialsResources
	isSet bool
}

func (v NullableCloudCredentialsResources) Get() *CloudCredentialsResources {
	return v.value
}

func (v *NullableCloudCredentialsResources) Set(val *CloudCredentialsResources) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCredentialsResources) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCredentialsResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCredentialsResources(val *CloudCredentialsResources) *NullableCloudCredentialsResources {
	return &NullableCloudCredentialsResources{value: val, isSet: true}
}

func (v NullableCloudCredentialsResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCredentialsResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
