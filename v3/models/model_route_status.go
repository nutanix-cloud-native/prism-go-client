...
// checks if the RouteStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RouteStatus{}

// RouteStatus Route directing network traffic through a link to another site or the Internet. 
type RouteStatus struct {
	// The preference value assigned to this route. A higher value means greater preference. 
	Priority int32 `json:"priority"`
	Nexthop RouteNexthopStatus `json:"nexthop"`
	// The destination subnet of this route.
	Destination string `json:"destination" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(\\/(\\\\d|[1-2]\\\\d|3[0-2]))$"`
	// Whether this route is currently active.
	IsActive bool `json:"is_active"`
	AdditionalProperties map[string]interface{}
}

type _RouteStatus RouteStatus
...
func (o RouteStatus) MarshalJSON() ([]byte, error) {
...
func (o RouteStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RouteStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varRouteStatus := _RouteStatus{}

	err = json.Unmarshal(data, &varRouteStatus)

	if err != nil {
		return err
	}

	*o = RouteStatus(varRouteStatus)
...
type NullableRouteStatus struct {
	value *RouteStatus
	isSet bool
}

func (v NullableRouteStatus) Get() *RouteStatus {
	return v.value
}

func (v *NullableRouteStatus) Set(val *RouteStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRouteStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRouteStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRouteStatus(val *RouteStatus) *NullableRouteStatus {
	return &NullableRouteStatus{value: val, isSet: true}
}

func (v NullableRouteStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRouteStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
