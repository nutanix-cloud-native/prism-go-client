...
// checks if the VmHostAffinityPolicyInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityPolicyInfo{}

// VmHostAffinityPolicyInfo The information of VM Host Affinity Policy.
type VmHostAffinityPolicyInfo struct {
	// Total number of applicable Hosts.
	HostsCount *int64 `json:"hosts_count,omitempty"`
	// Total number of applicable VMs.
	VmsCount *int64 `json:"vms_count,omitempty"`
	Config *VmHostAffinityPolicyConfig `json:"config,omitempty"`
	// Total number of VMs which are non-compliant with the policy.
	NonCompliantVmsCount *int64 `json:"non_compliant_vms_count,omitempty"`
	// Total number of VMs which are compliant with the policy.
	CompliantVmsCount *int64 `json:"compliant_vms_count,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VmHostAffinityPolicyInfo VmHostAffinityPolicyInfo
...
// GetHostsCount returns the HostsCount field value if set, zero value otherwise.
func (o *VmHostAffinityPolicyInfo) GetHostsCount() int64 {
	if o == nil || IsNil(o.HostsCount) {
		var ret int64
		return ret
	}
	return *o.HostsCount
...
// GetHostsCountOk returns a tuple with the HostsCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmHostAffinityPolicyInfo) GetHostsCountOk() (*int64, bool) {
	if o == nil || IsNil(o.HostsCount) {
		return nil, false
	}
	return o.HostsCount, true
}
...
// SetHostsCount gets a reference to the given int64 and assigns it to the HostsCount field.
...
// SetVmsCount gets a reference to the given int64 and assigns it to the VmsCount field.
...
func (o *VmHostAffinityPolicyInfo) GetConfig() VmHostAffinityPolicyConfig {
	if o == nil || IsNil(o.Config) {
		var ret VmHostAffinityPolicyConfig
		return ret
	}
	return *o.Config
}
...
// SetConfig gets a reference to the given VmHostAffinityPolicyConfig and assigns it to the Config field.
func (o *VmHostAffinityPolicyInfo) SetConfig(v VmHostAffinityPolicyConfig) {
	o.Config = &v
}

// GetNonCompliantVmsCount returns the NonCompliantVmsCount field value if set, zero value otherwise.
func (o *VmHostAffinityPolicyInfo) GetNonCompliantVmsCount() int64 {
	if o == nil || IsNil(o.NonCompliantVmsCount) {
		var ret int64
		return ret
	}
	return *o.NonCompliantVmsCount
}

// GetNonCompliantVmsCountOk returns a tuple with the NonCompliantVmsCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmHostAffinityPolicyInfo) GetNonCompliantVmsCountOk() (*int64, bool) {
	if o == nil || IsNil(o.NonCompliantVmsCount) {
		return nil, false
	}
	return o.NonCompliantVmsCount, true
}
...
// SetNonCompliantVmsCount gets a reference to the given int64 and assigns it to the NonCompliantVmsCount field.
func (o *VmHostAffinityPolicyInfo) SetNonCompliantVmsCount(v int64) {
	o.NonCompliantVmsCount = &v
}

// GetCompliantVmsCount returns the CompliantVmsCount field value if set, zero value otherwise.
func (o *VmHostAffinityPolicyInfo) GetCompliantVmsCount() int64 {
	if o == nil || IsNil(o.CompliantVmsCount) {
		var ret int64
		return ret
	}
	return *o.CompliantVmsCount
}

// GetCompliantVmsCountOk returns a tuple with the CompliantVmsCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmHostAffinityPolicyInfo) GetCompliantVmsCountOk() (*int64, bool) {
	if o == nil || IsNil(o.CompliantVmsCount) {
		return nil, false
	}
	return o.CompliantVmsCount, true
}
...
// SetCompliantVmsCount gets a reference to the given int64 and assigns it to the CompliantVmsCount field.
func (o *VmHostAffinityPolicyInfo) SetCompliantVmsCount(v int64) {
	o.CompliantVmsCount = &v
}

func (o VmHostAffinityPolicyInfo) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityPolicyInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.HostsCount) {
		toSerialize["hosts_count"] = o.HostsCount
	}
	if !IsNil(o.VmsCount) {
		toSerialize["vms_count"] = o.VmsCount
	}
	if !IsNil(o.Config) {
		toSerialize["config"] = o.Config
	}
	if !IsNil(o.NonCompliantVmsCount) {
		toSerialize["non_compliant_vms_count"] = o.NonCompliantVmsCount
	}
	if !IsNil(o.CompliantVmsCount) {
		toSerialize["compliant_vms_count"] = o.CompliantVmsCount
	}
...
func (o *VmHostAffinityPolicyInfo) UnmarshalJSON(data []byte) (err error) {
	varVmHostAffinityPolicyInfo := _VmHostAffinityPolicyInfo{}

	err = json.Unmarshal(data, &varVmHostAffinityPolicyInfo)

	if err != nil {
		return err
	}

	*o = VmHostAffinityPolicyInfo(varVmHostAffinityPolicyInfo)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "hosts_count")
		delete(additionalProperties, "vms_count")
		delete(additionalProperties, "config")
		delete(additionalProperties, "non_compliant_vms_count")
		delete(additionalProperties, "compliant_vms_count")
...
type NullableVmHostAffinityPolicyInfo struct {
	value *VmHostAffinityPolicyInfo
	isSet bool
}

func (v NullableVmHostAffinityPolicyInfo) Get() *VmHostAffinityPolicyInfo {
	return v.value
}

func (v *NullableVmHostAffinityPolicyInfo) Set(val *VmHostAffinityPolicyInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityPolicyInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityPolicyInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityPolicyInfo(val *VmHostAffinityPolicyInfo) *NullableVmHostAffinityPolicyInfo {
	return &NullableVmHostAffinityPolicyInfo{value: val, isSet: true}
}

func (v NullableVmHostAffinityPolicyInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityPolicyInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
