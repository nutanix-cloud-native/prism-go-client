...
// checks if the NusightsProxyReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NusightsProxyReference{}

// NusightsProxyReference The reference to a nusights_proxy
type NusightsProxyReference struct {
	// The kind name
...
type _NusightsProxyReference NusightsProxyReference
...
func (o NusightsProxyReference) MarshalJSON() ([]byte, error) {
...
func (o NusightsProxyReference) ToMap() (map[string]interface{}, error) {
...
func (o *NusightsProxyReference) UnmarshalJSON(data []byte) (err error) {
	...
	varNusightsProxyReference := _NusightsProxyReference{}

	err = json.Unmarshal(data, &varNusightsProxyReference)

	if err != nil {
		return err
	}

	*o = NusightsProxyReference(varNusightsProxyReference)
...
type NullableNusightsProxyReference struct {
	value *NusightsProxyReference
	isSet bool
}

func (v NullableNusightsProxyReference) Get() *NusightsProxyReference {
	return v.value
}

func (v *NullableNusightsProxyReference) Set(val *NusightsProxyReference) {
	v.value = val
	v.isSet = true
}

func (v NullableNusightsProxyReference) IsSet() bool {
	return v.isSet
}

func (v *NullableNusightsProxyReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNusightsProxyReference(val *NusightsProxyReference) *NullableNusightsProxyReference {
	return &NullableNusightsProxyReference{value: val, isSet: true}
}

func (v NullableNusightsProxyReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNusightsProxyReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
