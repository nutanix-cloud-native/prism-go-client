...
// checks if the DirectConnectVirtualInterfaceDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterfaceDefStatus{}

// DirectConnectVirtualInterfaceDefStatus An intentful representation of a direct_connect_virtual_interface status
type DirectConnectVirtualInterfaceDefStatus struct {
	// direct_connect_virtual_interface Name.
	Name string `json:"name"`
	// The state of the direct_connect_virtual_interface.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the direct_connect_virtual_interface, if in an error state.
	...
	Resources DirectConnectVirtualInterfaceResourcesDefStatus `json:"resources"`
	// A description for direct_connect_virtual_interface.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DirectConnectVirtualInterfaceDefStatus DirectConnectVirtualInterfaceDefStatus
...
func NewDirectConnectVirtualInterfaceDefStatus(name string, resources DirectConnectVirtualInterfaceResourcesDefStatus) *DirectConnectVirtualInterfaceDefStatus {
	this := DirectConnectVirtualInterfaceDefStatus{}
	this.Name = name
...
// GetAvailabilityZoneReference returns the AvailabilityZoneReference field value if set, zero value otherwise.
func (o *DirectConnectVirtualInterfaceDefStatus) GetAvailabilityZoneReference() AvailabilityZoneReference {
	if o == nil || IsNil(o.AvailabilityZoneReference) {
...
// GetAvailabilityZoneReferenceOk returns a tuple with the AvailabilityZoneReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAvailabilityZoneReference gets a reference to the given AvailabilityZoneReference and assigns it to the AvailabilityZoneReference field.
...
func (o *DirectConnectVirtualInterfaceDefStatus) HasClusterReference() bool {
	if o != nil && !IsNil(o.ClusterReference) {
		return true
	}
...
func (o *DirectConnectVirtualInterfaceDefStatus) GetResources() DirectConnectVirtualInterfaceResourcesDefStatus {
	if o == nil {
		var ret DirectConnectVirtualInterfaceResourcesDefStatus
		return ret
	}
...
func (o DirectConnectVirtualInterfaceDefStatus) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterfaceDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	if !IsNil(o.State) {
		toSerialize["state"] = o.State
	}
	if !IsNil(o.AvailabilityZoneReference) {
...
func (o *DirectConnectVirtualInterfaceDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectVirtualInterfaceDefStatus := _DirectConnectVirtualInterfaceDefStatus{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterfaceDefStatus)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterfaceDefStatus(varDirectConnectVirtualInterfaceDefStatus)
...
type NullableDirectConnectVirtualInterfaceDefStatus struct {
	value *DirectConnectVirtualInterfaceDefStatus
	isSet bool
}

func (v NullableDirectConnectVirtualInterfaceDefStatus) Get() *DirectConnectVirtualInterfaceDefStatus {
	return v.value
}

func (v *NullableDirectConnectVirtualInterfaceDefStatus) Set(val *DirectConnectVirtualInterfaceDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterfaceDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterfaceDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterfaceDefStatus(val *DirectConnectVirtualInterfaceDefStatus) *NullableDirectConnectVirtualInterfaceDefStatus {
	return &NullableDirectConnectVirtualInterfaceDefStatus{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterfaceDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterfaceDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
