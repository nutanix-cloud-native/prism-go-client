...
// checks if the CapabilityValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityValue{}

// CapabilityValue Value of capability
type CapabilityValue struct {
	CapStringValueList []string `json:"cap_string_value_list,omitempty"`
	// True if the capability value could not be retrieved or inferred. 
	Unknown *bool `json:"unknown,omitempty"`
	CapDoubleValue *float32 `json:"cap_double_value,omitempty"`
	CapBoolValue *bool `json:"cap_bool_value,omitempty"`
	CapIntValue *int32 `json:"cap_int_value,omitempty"`
	CapStringValue *string `json:"cap_string_value,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CapabilityValue CapabilityValue
...
// GetCapStringValueList returns the CapStringValueList field value if set, zero value otherwise.
func (o *CapabilityValue) GetCapStringValueList() []string {
	if o == nil || IsNil(o.CapStringValueList) {
		var ret []string
		return ret
	}
	return o.CapStringValueList
}

// GetCapStringValueListOk returns a tuple with the CapStringValueList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CapabilityValue) GetCapStringValueListOk() ([]string, bool) {
	if o == nil || IsNil(o.CapStringValueList) {
		return nil, false
	}
	return o.CapStringValueList, true
}
...
// SetCapStringValueList gets a reference to the given []string and assigns it to the CapStringValueList field.
func (o *CapabilityValue) SetCapStringValueList(v []string) {
	o.CapStringValueList = v
}
...
// GetCapDoubleValue returns the CapDoubleValue field value if set, zero value otherwise.
func (o *CapabilityValue) GetCapDoubleValue() float32 {
	if o == nil || IsNil(o.CapDoubleValue) {
		var ret float32
		return ret
	}
	return *o.CapDoubleValue
}

// GetCapDoubleValueOk returns a tuple with the CapDoubleValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CapabilityValue) GetCapDoubleValueOk() (*float32, bool) {
	if o == nil || IsNil(o.CapDoubleValue) {
		return nil, false
	}
	return o.CapDoubleValue, true
}
...
// SetCapDoubleValue gets a reference to the given float32 and assigns it to the CapDoubleValue field.
func (o *CapabilityValue) SetCapDoubleValue(v float32) {
	o.CapDoubleValue = &v
}

// GetCapBoolValue returns the CapBoolValue field value if set, zero value otherwise.
func (o *CapabilityValue) GetCapBoolValue() bool {
	if o == nil || IsNil(o.CapBoolValue) {
		var ret bool
		return ret
	}
	return *o.CapBoolValue
}

// GetCapBoolValueOk returns a tuple with the CapBoolValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CapabilityValue) GetCapBoolValueOk() (*bool, bool) {
	if o == nil || IsNil(o.CapBoolValue) {
		return nil, false
	}
	return o.CapBoolValue, true
}
...
// SetCapBoolValue gets a reference to the given bool and assigns it to the CapBoolValue field.
func (o *CapabilityValue) SetCapBoolValue(v bool) {
	o.CapBoolValue = &v
}

// GetCapIntValue returns the CapIntValue field value if set, zero value otherwise.
func (o *CapabilityValue) GetCapIntValue() int32 {
	if o == nil || IsNil(o.CapIntValue) {
		var ret int32
		return ret
	}
	return *o.CapIntValue
}

// GetCapIntValueOk returns a tuple with the CapIntValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CapabilityValue) GetCapIntValueOk() (*int32, bool) {
	if o == nil || IsNil(o.CapIntValue) {
		return nil, false
	}
	return o.CapIntValue, true
}
...
// SetCapIntValue gets a reference to the given int32 and assigns it to the CapIntValue field.
func (o *CapabilityValue) SetCapIntValue(v int32) {
	o.CapIntValue = &v
}

// GetCapStringValue returns the CapStringValue field value if set, zero value otherwise.
func (o *CapabilityValue) GetCapStringValue() string {
	if o == nil || IsNil(o.CapStringValue) {
		var ret string
		return ret
	}
	return *o.CapStringValue
}

// GetCapStringValueOk returns a tuple with the CapStringValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CapabilityValue) GetCapStringValueOk() (*string, bool) {
	if o == nil || IsNil(o.CapStringValue) {
		return nil, false
	}
	return o.CapStringValue, true
}
...
// SetCapStringValue gets a reference to the given string and assigns it to the CapStringValue field.
func (o *CapabilityValue) SetCapStringValue(v string) {
	o.CapStringValue = &v
}

func (o CapabilityValue) MarshalJSON() ([]byte, error) {
...
func (o CapabilityValue) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CapStringValueList) {
		toSerialize["cap_string_value_list"] = o.CapStringValueList
	}
	if !IsNil(o.Unknown) {
		toSerialize["unknown"] = o.Unknown
	}
	if !IsNil(o.CapDoubleValue) {
		toSerialize["cap_double_value"] = o.CapDoubleValue
	}
	if !IsNil(o.CapBoolValue) {
		toSerialize["cap_bool_value"] = o.CapBoolValue
	}
	if !IsNil(o.CapIntValue) {
		toSerialize["cap_int_value"] = o.CapIntValue
	}
	if !IsNil(o.CapStringValue) {
		toSerialize["cap_string_value"] = o.CapStringValue
	}
...
func (o *CapabilityValue) UnmarshalJSON(data []byte) (err error) {
	varCapabilityValue := _CapabilityValue{}

	err = json.Unmarshal(data, &varCapabilityValue)

	if err != nil {
		return err
	}

	*o = CapabilityValue(varCapabilityValue)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "cap_string_value_list")
		delete(additionalProperties, "unknown")
		delete(additionalProperties, "cap_double_value")
		delete(additionalProperties, "cap_bool_value")
		delete(additionalProperties, "cap_int_value")
		delete(additionalProperties, "cap_string_value")
...
type NullableCapabilityValue struct {
	value *CapabilityValue
	isSet bool
}

func (v NullableCapabilityValue) Get() *CapabilityValue {
	return v.value
}

func (v *NullableCapabilityValue) Set(val *CapabilityValue) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilityValue) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilityValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilityValue(val *CapabilityValue) *NullableCapabilityValue {
	return &NullableCapabilityValue{value: val, isSet: true}
}

func (v NullableCapabilityValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilityValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
