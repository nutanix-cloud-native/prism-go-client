...
// checks if the RecoveryPlanInfoRecoverability type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanInfoRecoverability{}
...
type _RecoveryPlanInfoRecoverability RecoveryPlanInfoRecoverability
...
func NewRecoveryPlanInfoRecoverability() *RecoveryPlanInfoRecoverability {
	this := RecoveryPlanInfoRecoverability{}
	return &this
}
...
func (o RecoveryPlanInfoRecoverability) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanInfoRecoverability) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanInfoRecoverability) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanInfoRecoverability := _RecoveryPlanInfoRecoverability{}

	err = json.Unmarshal(data, &varRecoveryPlanInfoRecoverability)

	if err != nil {
		return err
	}

	*o = RecoveryPlanInfoRecoverability(varRecoveryPlanInfoRecoverability)
...
type NullableRecoveryPlanInfoRecoverability struct {
	value *RecoveryPlanInfoRecoverability
	isSet bool
}

func (v NullableRecoveryPlanInfoRecoverability) Get() *RecoveryPlanInfoRecoverability {
	return v.value
}

func (v *NullableRecoveryPlanInfoRecoverability) Set(val *RecoveryPlanInfoRecoverability) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanInfoRecoverability) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanInfoRecoverability) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanInfoRecoverability(val *RecoveryPlanInfoRecoverability) *NullableRecoveryPlanInfoRecoverability {
	return &NullableRecoveryPlanInfoRecoverability{value: val, isSet: true}
}

func (v NullableRecoveryPlanInfoRecoverability) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanInfoRecoverability) UnmarshalJSON(src []byte) error {
	v.isSet = true
