...
// checks if the QueryEntitiesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryEntitiesResponse{}

// QueryEntitiesResponse List of entities with their protection status. 
type QueryEntitiesResponse struct {
	...
	EntityList []QueryEntitiesResponseEntityListInner `json:"entity_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QueryEntitiesResponse QueryEntitiesResponse
...
func (o *QueryEntitiesResponse) GetEntityList() []QueryEntitiesResponseEntityListInner {
	if o == nil || IsNil(o.EntityList) {
		var ret []QueryEntitiesResponseEntityListInner
		return ret
	}
	return o.EntityList
}
...
// SetEntityList gets a reference to the given []QueryEntitiesResponseEntityListInner and assigns it to the EntityList field.
func (o *QueryEntitiesResponse) SetEntityList(v []QueryEntitiesResponseEntityListInner) {
	o.EntityList = v
}

func (o QueryEntitiesResponse) MarshalJSON() ([]byte, error) {
...
func (o QueryEntitiesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *QueryEntitiesResponse) UnmarshalJSON(data []byte) (err error) {
	varQueryEntitiesResponse := _QueryEntitiesResponse{}

	err = json.Unmarshal(data, &varQueryEntitiesResponse)

	if err != nil {
		return err
	}

	*o = QueryEntitiesResponse(varQueryEntitiesResponse)
...
type NullableQueryEntitiesResponse struct {
	value *QueryEntitiesResponse
	isSet bool
}

func (v NullableQueryEntitiesResponse) Get() *QueryEntitiesResponse {
	return v.value
}

func (v *NullableQueryEntitiesResponse) Set(val *QueryEntitiesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryEntitiesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryEntitiesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryEntitiesResponse(val *QueryEntitiesResponse) *NullableQueryEntitiesResponse {
	return &NullableQueryEntitiesResponse{value: val, isSet: true}
}

func (v NullableQueryEntitiesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryEntitiesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
