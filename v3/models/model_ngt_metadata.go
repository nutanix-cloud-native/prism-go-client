...
// checks if the NgtMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtMetadata{}

// NgtMetadata The ngt kind metadata
type NgtMetadata struct {
	// UTC date and time in RFC-3339 format when ngt was last updated 
	...
	// UTC date and time in RFC-3339 format when ngt was created 
	...
	// Categories for the ngt. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the ngt. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
func (o NgtMetadata) MarshalJSON() ([]byte, error) {
...
func (o NgtMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NgtMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtMetadata := _NgtMetadata{}

	err = json.Unmarshal(data, &varNgtMetadata)

	if err != nil {
		return err
	}

	*o = NgtMetadata(varNgtMetadata)
...
type NullableNgtMetadata struct {
	value *NgtMetadata
	isSet bool
}

func (v NullableNgtMetadata) Get() *NgtMetadata {
	return v.value
}

func (v *NullableNgtMetadata) Set(val *NgtMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtMetadata(val *NgtMetadata) *NullableNgtMetadata {
	return &NullableNgtMetadata{value: val, isSet: true}
}

func (v NullableNgtMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
