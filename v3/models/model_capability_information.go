...
// checks if the CapabilityInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityInformation{}

// CapabilityInformation Contains capability name and description
...
type _CapabilityInformation CapabilityInformation
...
func (o CapabilityInformation) MarshalJSON() ([]byte, error) {
...
func (o CapabilityInformation) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilityInformation) UnmarshalJSON(data []byte) (err error) {
	...
	varCapabilityInformation := _CapabilityInformation{}

	err = json.Unmarshal(data, &varCapabilityInformation)

	if err != nil {
		return err
	}

	*o = CapabilityInformation(varCapabilityInformation)
...
type NullableCapabilityInformation struct {
	value *CapabilityInformation
	isSet bool
}

func (v NullableCapabilityInformation) Get() *CapabilityInformation {
	return v.value
}

func (v *NullableCapabilityInformation) Set(val *CapabilityInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilityInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilityInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilityInformation(val *CapabilityInformation) *NullableCapabilityInformation {
	return &NullableCapabilityInformation{value: val, isSet: true}
}

func (v NullableCapabilityInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilityInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
