...
// checks if the ValueInfoMinimum type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValueInfoMinimum{}

// ValueInfoMinimum The minimum value (or the length, if the value data type is string). 
type ValueInfoMinimum struct {
	DoubleValue *float64 `json:"double_value,omitempty"`
	LongValue *int64 `json:"long_value,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ValueInfoMinimum ValueInfoMinimum
...
func (o ValueInfoMinimum) MarshalJSON() ([]byte, error) {
...
func (o ValueInfoMinimum) ToMap() (map[string]interface{}, error) {
...
func (o *ValueInfoMinimum) UnmarshalJSON(data []byte) (err error) {
	varValueInfoMinimum := _ValueInfoMinimum{}

	err = json.Unmarshal(data, &varValueInfoMinimum)

	if err != nil {
		return err
	}

	*o = ValueInfoMinimum(varValueInfoMinimum)
...
type NullableValueInfoMinimum struct {
	value *ValueInfoMinimum
	isSet bool
}

func (v NullableValueInfoMinimum) Get() *ValueInfoMinimum {
	return v.value
}

func (v *NullableValueInfoMinimum) Set(val *ValueInfoMinimum) {
	v.value = val
	v.isSet = true
}

func (v NullableValueInfoMinimum) IsSet() bool {
	return v.isSet
}

func (v *NullableValueInfoMinimum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValueInfoMinimum(val *ValueInfoMinimum) *NullableValueInfoMinimum {
	return &NullableValueInfoMinimum{value: val, isSet: true}
}

func (v NullableValueInfoMinimum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValueInfoMinimum) UnmarshalJSON(src []byte) error {
	v.isSet = true
