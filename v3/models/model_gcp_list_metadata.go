...
// checks if the GcpListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GcpListMetadata{}

// GcpListMetadata All GCP list calls will have this metadata block as input
type GcpListMetadata struct {
...
type _GcpListMetadata GcpListMetadata
...
func (o GcpListMetadata) MarshalJSON() ([]byte, error) {
...
func (o GcpListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *GcpListMetadata) UnmarshalJSON(data []byte) (err error) {
	varGcpListMetadata := _GcpListMetadata{}

	err = json.Unmarshal(data, &varGcpListMetadata)

	if err != nil {
		return err
	}

	*o = GcpListMetadata(varGcpListMetadata)
...
type NullableGcpListMetadata struct {
	value *GcpListMetadata
	isSet bool
}

func (v NullableGcpListMetadata) Get() *GcpListMetadata {
	return v.value
}

func (v *NullableGcpListMetadata) Set(val *GcpListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableGcpListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableGcpListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGcpListMetadata(val *GcpListMetadata) *NullableGcpListMetadata {
	return &NullableGcpListMetadata{value: val, isSet: true}
}

func (v NullableGcpListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGcpListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
