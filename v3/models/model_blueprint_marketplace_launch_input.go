...
// checks if the BlueprintMarketplaceLaunchInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintMarketplaceLaunchInput{}

// BlueprintMarketplaceLaunchInput Launch Blueprint request.
type BlueprintMarketplaceLaunchInput struct {
...
type _BlueprintMarketplaceLaunchInput BlueprintMarketplaceLaunchInput
...
func NewBlueprintMarketplaceLaunchInput(spec BlueprintMarketplaceLaunchSpec, apiVersion string, metadata BlueprintMetadata) *BlueprintMarketplaceLaunchInput {
	this := BlueprintMarketplaceLaunchInput{}
	this.Spec = spec
...
func (o BlueprintMarketplaceLaunchInput) MarshalJSON() ([]byte, error) {
...
func (o BlueprintMarketplaceLaunchInput) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintMarketplaceLaunchInput) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintMarketplaceLaunchInput := _BlueprintMarketplaceLaunchInput{}

	err = json.Unmarshal(data, &varBlueprintMarketplaceLaunchInput)

	if err != nil {
		return err
	}

	*o = BlueprintMarketplaceLaunchInput(varBlueprintMarketplaceLaunchInput)
...
type NullableBlueprintMarketplaceLaunchInput struct {
	value *BlueprintMarketplaceLaunchInput
	isSet bool
}

func (v NullableBlueprintMarketplaceLaunchInput) Get() *BlueprintMarketplaceLaunchInput {
	return v.value
}

func (v *NullableBlueprintMarketplaceLaunchInput) Set(val *BlueprintMarketplaceLaunchInput) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintMarketplaceLaunchInput) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintMarketplaceLaunchInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintMarketplaceLaunchInput(val *BlueprintMarketplaceLaunchInput) *NullableBlueprintMarketplaceLaunchInput {
	return &NullableBlueprintMarketplaceLaunchInput{value: val, isSet: true}
}

func (v NullableBlueprintMarketplaceLaunchInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintMarketplaceLaunchInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
