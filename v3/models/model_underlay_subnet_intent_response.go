...
// checks if the UnderlaySubnetIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnetIntentResponse{}

// UnderlaySubnetIntentResponse Response object for intentful operations on a underlay_subnet
type UnderlaySubnetIntentResponse struct {
...
type _UnderlaySubnetIntentResponse UnderlaySubnetIntentResponse
...
func NewUnderlaySubnetIntentResponse(apiVersion string, metadata UnderlaySubnetMetadata) *UnderlaySubnetIntentResponse {
	this := UnderlaySubnetIntentResponse{}
...
func (o UnderlaySubnetIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnetIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *UnderlaySubnetIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUnderlaySubnetIntentResponse := _UnderlaySubnetIntentResponse{}

	err = json.Unmarshal(data, &varUnderlaySubnetIntentResponse)

	if err != nil {
		return err
	}

	*o = UnderlaySubnetIntentResponse(varUnderlaySubnetIntentResponse)
...
type NullableUnderlaySubnetIntentResponse struct {
	value *UnderlaySubnetIntentResponse
	isSet bool
}

func (v NullableUnderlaySubnetIntentResponse) Get() *UnderlaySubnetIntentResponse {
	return v.value
}

func (v *NullableUnderlaySubnetIntentResponse) Set(val *UnderlaySubnetIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnetIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnetIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnetIntentResponse(val *UnderlaySubnetIntentResponse) *NullableUnderlaySubnetIntentResponse {
	return &NullableUnderlaySubnetIntentResponse{value: val, isSet: true}
}

func (v NullableUnderlaySubnetIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnetIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
