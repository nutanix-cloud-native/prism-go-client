...
// checks if the AwsAvailabilityZoneMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsAvailabilityZoneMetadata{}

// AwsAvailabilityZoneMetadata The aws_availability_zone kind metadata
type AwsAvailabilityZoneMetadata struct {
	// UTC date and time in RFC-3339 format when aws_availability_zone was last updated 
	LastUpdateTime *time.Time `json:"last_update_time,omitempty"`
	// The kind name
	Kind string `json:"kind"`
	// aws_availability_zone uuid
	...
	// Categories for the aws_availability_zone
	Categories *map[string]string `json:"categories,omitempty"`
	// aws_availability_zone name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsAvailabilityZoneMetadata AwsAvailabilityZoneMetadata
...
func NewAwsAvailabilityZoneMetadata(kind string) *AwsAvailabilityZoneMetadata {
	this := AwsAvailabilityZoneMetadata{}
	this.Kind = kind
	return &this
}
...
func (o AwsAvailabilityZoneMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsAvailabilityZoneMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsAvailabilityZoneMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsAvailabilityZoneMetadata := _AwsAvailabilityZoneMetadata{}

	err = json.Unmarshal(data, &varAwsAvailabilityZoneMetadata)

	if err != nil {
		return err
	}

	*o = AwsAvailabilityZoneMetadata(varAwsAvailabilityZoneMetadata)
...
type NullableAwsAvailabilityZoneMetadata struct {
	value *AwsAvailabilityZoneMetadata
	isSet bool
}

func (v NullableAwsAvailabilityZoneMetadata) Get() *AwsAvailabilityZoneMetadata {
	return v.value
}

func (v *NullableAwsAvailabilityZoneMetadata) Set(val *AwsAvailabilityZoneMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsAvailabilityZoneMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsAvailabilityZoneMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsAvailabilityZoneMetadata(val *AwsAvailabilityZoneMetadata) *NullableAwsAvailabilityZoneMetadata {
	return &NullableAwsAvailabilityZoneMetadata{value: val, isSet: true}
}

func (v NullableAwsAvailabilityZoneMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsAvailabilityZoneMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
