...
// checks if the ImageDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageDefStatus{}

// ImageDefStatus An intentful representation of a image status
...
type _ImageDefStatus ImageDefStatus
...
func (o *ImageDefStatus) GetResources() ImageResourcesDefStatus {
	if o == nil {
		var ret ImageResourcesDefStatus
		return ret
	}
...
func (o ImageDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ImageDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ImageDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varImageDefStatus := _ImageDefStatus{}

	err = json.Unmarshal(data, &varImageDefStatus)

	if err != nil {
		return err
	}

	*o = ImageDefStatus(varImageDefStatus)
...
type NullableImageDefStatus struct {
	value *ImageDefStatus
	isSet bool
}

func (v NullableImageDefStatus) Get() *ImageDefStatus {
	return v.value
}

func (v *NullableImageDefStatus) Set(val *ImageDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableImageDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableImageDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageDefStatus(val *ImageDefStatus) *NullableImageDefStatus {
	return &NullableImageDefStatus{value: val, isSet: true}
}

func (v NullableImageDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
