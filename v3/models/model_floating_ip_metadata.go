...
// checks if the FloatingIpMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpMetadata{}

// FloatingIpMetadata The floating_ip kind metadata
type FloatingIpMetadata struct {
	...
	// Categories for the floating_ip. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the floating_ip. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _FloatingIpMetadata FloatingIpMetadata
...
func (o FloatingIpMetadata) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *FloatingIpMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varFloatingIpMetadata := _FloatingIpMetadata{}

	err = json.Unmarshal(data, &varFloatingIpMetadata)

	if err != nil {
		return err
	}

	*o = FloatingIpMetadata(varFloatingIpMetadata)
...
type NullableFloatingIpMetadata struct {
	value *FloatingIpMetadata
	isSet bool
}

func (v NullableFloatingIpMetadata) Get() *FloatingIpMetadata {
	return v.value
}

func (v *NullableFloatingIpMetadata) Set(val *FloatingIpMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpMetadata(val *FloatingIpMetadata) *NullableFloatingIpMetadata {
	return &NullableFloatingIpMetadata{value: val, isSet: true}
}

func (v NullableFloatingIpMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
