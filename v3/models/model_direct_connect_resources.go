...
// checks if the DirectConnectResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectResources{}

// DirectConnectResources Direct connect spec
type DirectConnectResources struct {
	VpcReference *VpcReference `json:"vpc_reference,omitempty"`
	// The name of the service provider to be utilized for this direct connnect. 
...
type _DirectConnectResources DirectConnectResources
...
// GetBandwidthMbps returns the BandwidthMbps field value
...
// GetBandwidthMbpsOk returns a tuple with the BandwidthMbps field value
// and a boolean to check if the value has been set.
...
// SetBandwidthMbps sets field value
func (o *DirectConnectResources) SetBandwidthMbps(v int32) {
	o.BandwidthMbps = v
}

func (o DirectConnectResources) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectResources) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectResources) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectResources := _DirectConnectResources{}

	err = json.Unmarshal(data, &varDirectConnectResources)

	if err != nil {
		return err
	}

	*o = DirectConnectResources(varDirectConnectResources)
...
type NullableDirectConnectResources struct {
	value *DirectConnectResources
	isSet bool
}

func (v NullableDirectConnectResources) Get() *DirectConnectResources {
	return v.value
}

func (v *NullableDirectConnectResources) Set(val *DirectConnectResources) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectResources) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectResources(val *DirectConnectResources) *NullableDirectConnectResources {
	return &NullableDirectConnectResources{value: val, isSet: true}
}

func (v NullableDirectConnectResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
