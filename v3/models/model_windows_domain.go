...
// checks if the WindowsDomain type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WindowsDomain{}

// WindowsDomain Hyper-V node domain.
type WindowsDomain struct {
	...
	NameServerIp *string `json:"name_server_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	AdditionalProperties map[string]interface{}
}

type _WindowsDomain WindowsDomain
...
// GetDomainCredential returns the DomainCredential field value
func (o *WindowsDomain) GetDomainCredential() Credentials {
	...
	return o.DomainCredential
}

// GetDomainCredentialOk returns a tuple with the DomainCredential field value
// and a boolean to check if the value has been set.
func (o *WindowsDomain) GetDomainCredentialOk() (*Credentials, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DomainCredential, true
}

// SetDomainCredential sets field value
func (o *WindowsDomain) SetDomainCredential(v Credentials) {
	o.DomainCredential = v
}

// GetOrganizationUnitPath returns the OrganizationUnitPath field value if set, zero value otherwise.
func (o *WindowsDomain) GetOrganizationUnitPath() string {
	if o == nil || IsNil(o.OrganizationUnitPath) {
		var ret string
		return ret
	}
	return *o.OrganizationUnitPath
}
...
func (o *WindowsDomain) GetOrganizationUnitPathOk() (*string, bool) {
	...
	return o.OrganizationUnitPath, true
}
...
// SetOrganizationUnitPath gets a reference to the given string and assigns it to the OrganizationUnitPath field.
func (o *WindowsDomain) SetOrganizationUnitPath(v string) {
	o.OrganizationUnitPath = &v
}
...
// GetNameServerIp returns the NameServerIp field value if set, zero value otherwise.
func (o *WindowsDomain) GetNameServerIp() string {
	if o == nil || IsNil(o.NameServerIp) {
		var ret string
		return ret
	}
	return *o.NameServerIp
}

// GetNameServerIpOk returns a tuple with the NameServerIp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WindowsDomain) GetNameServerIpOk() (*string, bool) {
	if o == nil || IsNil(o.NameServerIp) {
		return nil, false
	}
	return o.NameServerIp, true
}
...
// SetNameServerIp gets a reference to the given string and assigns it to the NameServerIp field.
func (o *WindowsDomain) SetNameServerIp(v string) {
	o.NameServerIp = &v
}

func (o WindowsDomain) MarshalJSON() ([]byte, error) {
...
func (o WindowsDomain) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["domain_credential"] = o.DomainCredential
	if !IsNil(o.OrganizationUnitPath) {
		toSerialize["organization_unit_path"] = o.OrganizationUnitPath
	}
	if !IsNil(o.NamePrefix) {
		toSerialize["name_prefix"] = o.NamePrefix
	}
	if !IsNil(o.NameServerIp) {
		toSerialize["name_server_ip"] = o.NameServerIp
	}
...
func (o *WindowsDomain) UnmarshalJSON(data []byte) (err error) {
	...
	varWindowsDomain := _WindowsDomain{}

	err = json.Unmarshal(data, &varWindowsDomain)

	if err != nil {
		return err
	}

	*o = WindowsDomain(varWindowsDomain)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "domain_credential")
		delete(additionalProperties, "organization_unit_path")
		delete(additionalProperties, "name_prefix")
		delete(additionalProperties, "name_server_ip")
...
type NullableWindowsDomain struct {
	value *WindowsDomain
	isSet bool
}

func (v NullableWindowsDomain) Get() *WindowsDomain {
	return v.value
}

func (v *NullableWindowsDomain) Set(val *WindowsDomain) {
	v.value = val
	v.isSet = true
}

func (v NullableWindowsDomain) IsSet() bool {
	return v.isSet
}

func (v *NullableWindowsDomain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWindowsDomain(val *WindowsDomain) *NullableWindowsDomain {
	return &NullableWindowsDomain{value: val, isSet: true}
}

func (v NullableWindowsDomain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWindowsDomain) UnmarshalJSON(src []byte) error {
	v.isSet = true
