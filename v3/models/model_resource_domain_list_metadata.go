...
// checks if the ResourceDomainListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceDomainListMetadata{}

// ResourceDomainListMetadata All api calls that return a list will have this metadata block as input 
...
type _ResourceDomainListMetadata ResourceDomainListMetadata
...
func NewResourceDomainListMetadata() *ResourceDomainListMetadata {
	this := ResourceDomainListMetadata{}
...
func (o ResourceDomainListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ResourceDomainListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceDomainListMetadata) UnmarshalJSON(data []byte) (err error) {
	varResourceDomainListMetadata := _ResourceDomainListMetadata{}

	err = json.Unmarshal(data, &varResourceDomainListMetadata)

	if err != nil {
		return err
	}

	*o = ResourceDomainListMetadata(varResourceDomainListMetadata)
...
type NullableResourceDomainListMetadata struct {
	value *ResourceDomainListMetadata
	isSet bool
}

func (v NullableResourceDomainListMetadata) Get() *ResourceDomainListMetadata {
	return v.value
}

func (v *NullableResourceDomainListMetadata) Set(val *ResourceDomainListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceDomainListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceDomainListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceDomainListMetadata(val *ResourceDomainListMetadata) *NullableResourceDomainListMetadata {
	return &NullableResourceDomainListMetadata{value: val, isSet: true}
}

func (v NullableResourceDomainListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceDomainListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
