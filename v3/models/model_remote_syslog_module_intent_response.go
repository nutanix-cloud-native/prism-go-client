...
// checks if the RemoteSyslogModuleIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogModuleIntentResponse{}

// RemoteSyslogModuleIntentResponse Response object for intentful operations on a remote_syslog_module
type RemoteSyslogModuleIntentResponse struct {
...
type _RemoteSyslogModuleIntentResponse RemoteSyslogModuleIntentResponse
...
func NewRemoteSyslogModuleIntentResponse(apiVersion string, metadata RemoteSyslogModuleMetadata) *RemoteSyslogModuleIntentResponse {
	this := RemoteSyslogModuleIntentResponse{}
...
func (o RemoteSyslogModuleIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogModuleIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogModuleIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogModuleIntentResponse := _RemoteSyslogModuleIntentResponse{}

	err = json.Unmarshal(data, &varRemoteSyslogModuleIntentResponse)

	if err != nil {
		return err
	}

	*o = RemoteSyslogModuleIntentResponse(varRemoteSyslogModuleIntentResponse)
...
type NullableRemoteSyslogModuleIntentResponse struct {
	value *RemoteSyslogModuleIntentResponse
	isSet bool
}

func (v NullableRemoteSyslogModuleIntentResponse) Get() *RemoteSyslogModuleIntentResponse {
	return v.value
}

func (v *NullableRemoteSyslogModuleIntentResponse) Set(val *RemoteSyslogModuleIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogModuleIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogModuleIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogModuleIntentResponse(val *RemoteSyslogModuleIntentResponse) *NullableRemoteSyslogModuleIntentResponse {
	return &NullableRemoteSyslogModuleIntentResponse{value: val, isSet: true}
}

func (v NullableRemoteSyslogModuleIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogModuleIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
