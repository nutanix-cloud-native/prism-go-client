...
// checks if the OvaListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OvaListMetadata{}

// OvaListMetadata API call for OVA that returns a list will have this metadata block as input 
type OvaListMetadata struct {
	// The kind name
...
type _OvaListMetadata OvaListMetadata
...
func (o OvaListMetadata) MarshalJSON() ([]byte, error) {
...
func (o OvaListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *OvaListMetadata) UnmarshalJSON(data []byte) (err error) {
	varOvaListMetadata := _OvaListMetadata{}

	err = json.Unmarshal(data, &varOvaListMetadata)

	if err != nil {
		return err
	}

	*o = OvaListMetadata(varOvaListMetadata)
...
type NullableOvaListMetadata struct {
	value *OvaListMetadata
	isSet bool
}

func (v NullableOvaListMetadata) Get() *OvaListMetadata {
	return v.value
}

func (v *NullableOvaListMetadata) Set(val *OvaListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableOvaListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableOvaListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOvaListMetadata(val *OvaListMetadata) *NullableOvaListMetadata {
	return &NullableOvaListMetadata{value: val, isSet: true}
}

func (v NullableOvaListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOvaListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
