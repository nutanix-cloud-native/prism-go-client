...
// checks if the MhVmSnapshotInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmSnapshotInput{}

// MhVmSnapshotInput Input object for the snapshot API. User can provide optional UUID of the vm_recovery_point that will be created as a result of this operation. 
type MhVmSnapshotInput struct {
...
type _MhVmSnapshotInput MhVmSnapshotInput
...
func (o MhVmSnapshotInput) MarshalJSON() ([]byte, error) {
...
func (o MhVmSnapshotInput) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmSnapshotInput) UnmarshalJSON(data []byte) (err error) {
	varMhVmSnapshotInput := _MhVmSnapshotInput{}

	err = json.Unmarshal(data, &varMhVmSnapshotInput)

	if err != nil {
		return err
	}

	*o = MhVmSnapshotInput(varMhVmSnapshotInput)
...
type NullableMhVmSnapshotInput struct {
	value *MhVmSnapshotInput
	isSet bool
}

func (v NullableMhVmSnapshotInput) Get() *MhVmSnapshotInput {
	return v.value
}

func (v *NullableMhVmSnapshotInput) Set(val *MhVmSnapshotInput) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmSnapshotInput) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmSnapshotInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmSnapshotInput(val *MhVmSnapshotInput) *NullableMhVmSnapshotInput {
	return &NullableMhVmSnapshotInput{value: val, isSet: true}
}

func (v NullableMhVmSnapshotInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmSnapshotInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
