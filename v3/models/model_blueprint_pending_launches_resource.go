...
// checks if the BlueprintPendingLaunchesResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintPendingLaunchesResource{}

// BlueprintPendingLaunchesResource Response object for the launches in progress for app blueprints
type BlueprintPendingLaunchesResource struct {
	Status *BlueprintPendingLaunchesStatus `json:"status,omitempty"`
...
type _BlueprintPendingLaunchesResource BlueprintPendingLaunchesResource
...
func NewBlueprintPendingLaunchesResource(metadata BlueprintMetadata) *BlueprintPendingLaunchesResource {
	this := BlueprintPendingLaunchesResource{}
...
func (o *BlueprintPendingLaunchesResource) GetStatus() BlueprintPendingLaunchesStatus {
	if o == nil || IsNil(o.Status) {
		var ret BlueprintPendingLaunchesStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given BlueprintPendingLaunchesStatus and assigns it to the Status field.
...
func (o BlueprintPendingLaunchesResource) MarshalJSON() ([]byte, error) {
...
func (o BlueprintPendingLaunchesResource) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintPendingLaunchesResource) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintPendingLaunchesResource := _BlueprintPendingLaunchesResource{}

	err = json.Unmarshal(data, &varBlueprintPendingLaunchesResource)

	if err != nil {
		return err
	}

	*o = BlueprintPendingLaunchesResource(varBlueprintPendingLaunchesResource)
...
type NullableBlueprintPendingLaunchesResource struct {
	value *BlueprintPendingLaunchesResource
	isSet bool
}

func (v NullableBlueprintPendingLaunchesResource) Get() *BlueprintPendingLaunchesResource {
	return v.value
}

func (v *NullableBlueprintPendingLaunchesResource) Set(val *BlueprintPendingLaunchesResource) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintPendingLaunchesResource) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintPendingLaunchesResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintPendingLaunchesResource(val *BlueprintPendingLaunchesResource) *NullableBlueprintPendingLaunchesResource {
	return &NullableBlueprintPendingLaunchesResource{value: val, isSet: true}
}

func (v NullableBlueprintPendingLaunchesResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintPendingLaunchesResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
