...
// GetDefaultInternalPolicy returns the DefaultInternalPolicy field value if set, zero value otherwise.
func (o *TargetGroup) GetDefaultInternalPolicy() string {
	if o == nil || IsNil(o.DefaultInternalPolicy) {
		var ret string
		return ret
	}
	return *o.DefaultInternalPolicy
}

// GetDefaultInternalPolicyOk returns a tuple with the DefaultInternalPolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TargetGroup) GetDefaultInternalPolicyOk() (*string, bool) {
	if o == nil || IsNil(o.DefaultInternalPolicy) {
		return nil, false
	}
	return o.DefaultInternalPolicy, true
}
...
// SetDefaultInternalPolicy gets a reference to the given string and assigns it to the DefaultInternalPolicy field.
func (o *TargetGroup) SetDefaultInternalPolicy(v string) {
	o.DefaultInternalPolicy = &v
}
...
func (o TargetGroup) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DefaultInternalPolicy) {
		toSerialize["default_internal_policy"] = o.DefaultInternalPolicy
	}
...
func (o *TargetGroup) UnmarshalJSON(data []byte) (err error) {
	...
	*o = TargetGroup(varTargetGroup)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "default_internal_policy")
