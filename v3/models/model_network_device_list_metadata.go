...
// checks if the NetworkDeviceListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDeviceListMetadata{}

// NetworkDeviceListMetadata All api calls that return a list will have this metadata block as input 
type NetworkDeviceListMetadata struct {
	// The kind name
...
type _NetworkDeviceListMetadata NetworkDeviceListMetadata
...
func NewNetworkDeviceListMetadata() *NetworkDeviceListMetadata {
	this := NetworkDeviceListMetadata{}
...
func (o NetworkDeviceListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkDeviceListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkDeviceListMetadata) UnmarshalJSON(data []byte) (err error) {
	varNetworkDeviceListMetadata := _NetworkDeviceListMetadata{}

	err = json.Unmarshal(data, &varNetworkDeviceListMetadata)

	if err != nil {
		return err
	}

	*o = NetworkDeviceListMetadata(varNetworkDeviceListMetadata)
...
type NullableNetworkDeviceListMetadata struct {
	value *NetworkDeviceListMetadata
	isSet bool
}

func (v NullableNetworkDeviceListMetadata) Get() *NetworkDeviceListMetadata {
	return v.value
}

func (v *NullableNetworkDeviceListMetadata) Set(val *NetworkDeviceListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDeviceListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDeviceListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDeviceListMetadata(val *NetworkDeviceListMetadata) *NullableNetworkDeviceListMetadata {
	return &NullableNetworkDeviceListMetadata{value: val, isSet: true}
}

func (v NullableNetworkDeviceListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDeviceListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
