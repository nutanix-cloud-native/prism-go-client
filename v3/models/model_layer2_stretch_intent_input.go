...
// checks if the Layer2StretchIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchIntentInput{}

// Layer2StretchIntentInput An intentful representation of a layer2_stretch
type Layer2StretchIntentInput struct {
	Spec Layer2Stretch `json:"spec"`
...
type _Layer2StretchIntentInput Layer2StretchIntentInput
...
func (o Layer2StretchIntentInput) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varLayer2StretchIntentInput := _Layer2StretchIntentInput{}

	err = json.Unmarshal(data, &varLayer2StretchIntentInput)

	if err != nil {
		return err
	}

	*o = Layer2StretchIntentInput(varLayer2StretchIntentInput)
...
type NullableLayer2StretchIntentInput struct {
	value *Layer2StretchIntentInput
	isSet bool
}

func (v NullableLayer2StretchIntentInput) Get() *Layer2StretchIntentInput {
	return v.value
}

func (v *NullableLayer2StretchIntentInput) Set(val *Layer2StretchIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchIntentInput(val *Layer2StretchIntentInput) *NullableLayer2StretchIntentInput {
	return &NullableLayer2StretchIntentInput{value: val, isSet: true}
}

func (v NullableLayer2StretchIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
