...
// checks if the NetworkSecurityRuleIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleIntentResource{}
...
type _NetworkSecurityRuleIntentResource NetworkSecurityRuleIntentResource
...
func NewNetworkSecurityRuleIntentResource(metadata NetworkSecurityRuleMetadata) *NetworkSecurityRuleIntentResource {
	this := NetworkSecurityRuleIntentResource{}
...
func (o NetworkSecurityRuleIntentResource) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRuleIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkSecurityRuleIntentResource := _NetworkSecurityRuleIntentResource{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleIntentResource)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleIntentResource(varNetworkSecurityRuleIntentResource)
...
type NullableNetworkSecurityRuleIntentResource struct {
	value *NetworkSecurityRuleIntentResource
	isSet bool
}

func (v NullableNetworkSecurityRuleIntentResource) Get() *NetworkSecurityRuleIntentResource {
	return v.value
}

func (v *NullableNetworkSecurityRuleIntentResource) Set(val *NetworkSecurityRuleIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleIntentResource(val *NetworkSecurityRuleIntentResource) *NullableNetworkSecurityRuleIntentResource {
	return &NullableNetworkSecurityRuleIntentResource{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
