...
// checks if the ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner{}

// ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner struct for ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner
type ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner struct {
	// Type of the sync operation
	OperationType *string `json:"operation_type,omitempty"`
	// Sync state of the entity.
	SyncStatus *string `json:"sync_status,omitempty"`
	TargetAvailabilityZoneReference *AvailabilityZoneReference `json:"target_availability_zone_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner
...
func NewListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner() *ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner {
	this := ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner{}
	return &this
}
...
// GetTargetAvailabilityZoneReference returns the TargetAvailabilityZoneReference field value if set, zero value otherwise.
func (o *ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) GetTargetAvailabilityZoneReference() AvailabilityZoneReference {
	if o == nil || IsNil(o.TargetAvailabilityZoneReference) {
...
// GetTargetAvailabilityZoneReferenceOk returns a tuple with the TargetAvailabilityZoneReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTargetAvailabilityZoneReference gets a reference to the given AvailabilityZoneReference and assigns it to the TargetAvailabilityZoneReference field.
...
func (o ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) MarshalJSON() ([]byte, error) {
...
func (o ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TargetAvailabilityZoneReference) {
...
func (o *ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) UnmarshalJSON(data []byte) (err error) {
	varListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner := _ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner{}

	err = json.Unmarshal(data, &varListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner)

	if err != nil {
		return err
	}

	*o = ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner(varListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner)
...
type NullableListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner struct {
	value *ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner
	isSet bool
}

func (v NullableListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) Get() *ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner {
	return v.value
}

func (v *NullableListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) Set(val *ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner(val *ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) *NullableListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner {
	return &NullableListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner{value: val, isSet: true}
}

func (v NullableListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
