...
// checks if the AppActionInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppActionInputUpload{}

// AppActionInputUpload Action definition for Application
type AppActionInputUpload struct {
	// 
	...
	Runbook *AppRunbookInputUpload `json:"runbook,omitempty"`
	// 
...
type _AppActionInputUpload AppActionInputUpload
...
// SetRunbook gets a reference to the given AppRunbookInputUpload and assigns it to the Runbook field.
...
func (o AppActionInputUpload) MarshalJSON() ([]byte, error) {
...
func (o AppActionInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppActionInputUpload) UnmarshalJSON(data []byte) (err error) {
	varAppActionInputUpload := _AppActionInputUpload{}

	err = json.Unmarshal(data, &varAppActionInputUpload)

	if err != nil {
		return err
	}

	*o = AppActionInputUpload(varAppActionInputUpload)
...
type NullableAppActionInputUpload struct {
	value *AppActionInputUpload
	isSet bool
}

func (v NullableAppActionInputUpload) Get() *AppActionInputUpload {
	return v.value
}

func (v *NullableAppActionInputUpload) Set(val *AppActionInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppActionInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppActionInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppActionInputUpload(val *AppActionInputUpload) *NullableAppActionInputUpload {
	return &NullableAppActionInputUpload{value: val, isSet: true}
}

func (v NullableAppActionInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppActionInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
