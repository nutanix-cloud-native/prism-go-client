...
// checks if the VolumeGroupStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupStatus{}

// VolumeGroupStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _VolumeGroupStatus VolumeGroupStatus
...
func (o VolumeGroupStatus) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeGroupStatus) UnmarshalJSON(data []byte) (err error) {
	varVolumeGroupStatus := _VolumeGroupStatus{}

	err = json.Unmarshal(data, &varVolumeGroupStatus)

	if err != nil {
		return err
	}

	*o = VolumeGroupStatus(varVolumeGroupStatus)
...
type NullableVolumeGroupStatus struct {
	value *VolumeGroupStatus
	isSet bool
}

func (v NullableVolumeGroupStatus) Get() *VolumeGroupStatus {
	return v.value
}

func (v *NullableVolumeGroupStatus) Set(val *VolumeGroupStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupStatus(val *VolumeGroupStatus) *NullableVolumeGroupStatus {
	return &NullableVolumeGroupStatus{value: val, isSet: true}
}

func (v NullableVolumeGroupStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
