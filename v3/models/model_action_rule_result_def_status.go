...
// checks if the ActionRuleResultDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResultDefStatus{}

// ActionRuleResultDefStatus Action type entity status definition
type ActionRuleResultDefStatus struct {
	// The state of the entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	Resources ActionRuleResultResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _ActionRuleResultDefStatus ActionRuleResultDefStatus
...
func NewActionRuleResultDefStatus(resources ActionRuleResultResources) *ActionRuleResultDefStatus {
	this := ActionRuleResultDefStatus{}
...
func (o *ActionRuleResultDefStatus) GetResources() ActionRuleResultResources {
	if o == nil {
		var ret ActionRuleResultResources
		return ret
	}
...
func (o ActionRuleResultDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResultDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleResultDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleResultDefStatus := _ActionRuleResultDefStatus{}

	err = json.Unmarshal(data, &varActionRuleResultDefStatus)

	if err != nil {
		return err
	}

	*o = ActionRuleResultDefStatus(varActionRuleResultDefStatus)
...
type NullableActionRuleResultDefStatus struct {
	value *ActionRuleResultDefStatus
	isSet bool
}

func (v NullableActionRuleResultDefStatus) Get() *ActionRuleResultDefStatus {
	return v.value
}

func (v *NullableActionRuleResultDefStatus) Set(val *ActionRuleResultDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResultDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResultDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResultDefStatus(val *ActionRuleResultDefStatus) *NullableActionRuleResultDefStatus {
	return &NullableActionRuleResultDefStatus{value: val, isSet: true}
}

func (v NullableActionRuleResultDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResultDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
