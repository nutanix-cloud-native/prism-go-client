...
// ParameterError error associated with the parameter
type ParameterError struct {
	// type of error like ValidationError
	ErrorType *string `json:"error_type,omitempty"`
	ErrorObject *ErrorMessageObject `json:"error_object,omitempty"`
	// name of the parameter.
	ParameterName *string `json:"parameter_name,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
...
// GetErrorObject returns the ErrorObject field value if set, zero value otherwise.
func (o *ParameterError) GetErrorObject() ErrorMessageObject {
	if o == nil || IsNil(o.ErrorObject) {
...
// GetErrorObjectOk returns a tuple with the ErrorObject field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ParameterError) GetErrorObjectOk() (*ErrorMessageObject, bool) {
	if o == nil || IsNil(o.ErrorObject) {
		return nil, false
	}
	return o.ErrorObject, true
}
...
// SetErrorObject gets a reference to the given ErrorMessageObject and assigns it to the ErrorObject field.
...
func (o ParameterError) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ErrorObject) {
		toSerialize["error_object"] = o.ErrorObject
	}
...
func (o *ParameterError) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varParameterError)
	...
	*o = ParameterError(varParameterError)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "error_object")
