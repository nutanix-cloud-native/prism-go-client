...
// checks if the ClusterReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterReference{}

// ClusterReference The reference to a cluster
...
type _ClusterReference ClusterReference
...
func (o ClusterReference) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterReference) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterReference := _ClusterReference{}

	err = json.Unmarshal(data, &varClusterReference)

	if err != nil {
		return err
	}

	*o = ClusterReference(varClusterReference)
