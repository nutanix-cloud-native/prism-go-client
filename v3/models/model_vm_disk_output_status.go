...
// checks if the VmDiskOutputStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDiskOutputStatus{}
...
type _VmDiskOutputStatus VmDiskOutputStatus
...
func NewVmDiskOutputStatus() *VmDiskOutputStatus {
	this := VmDiskOutputStatus{}
	var isEncryptionInProgress bool = false
	this.IsEncryptionInProgress = &isEncryptionInProgress
...
// GetIsEncryptionInProgress returns the IsEncryptionInProgress field value if set, zero value otherwise.
func (o *VmDiskOutputStatus) GetIsEncryptionInProgress() bool {
	if o == nil || IsNil(o.IsEncryptionInProgress) {
		var ret bool
		return ret
	}
	return *o.IsEncryptionInProgress
}

// GetIsEncryptionInProgressOk returns a tuple with the IsEncryptionInProgress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmDiskOutputStatus) GetIsEncryptionInProgressOk() (*bool, bool) {
	if o == nil || IsNil(o.IsEncryptionInProgress) {
		return nil, false
	}
	return o.IsEncryptionInProgress, true
}
...
// SetIsEncryptionInProgress gets a reference to the given bool and assigns it to the IsEncryptionInProgress field.
func (o *VmDiskOutputStatus) SetIsEncryptionInProgress(v bool) {
	o.IsEncryptionInProgress = &v
}
...
// SetStorageConfig gets a reference to the given DiskStorageConfig and assigns it to the StorageConfig field.
...
func (o *VmDiskOutputStatus) GetDeviceProperties() VmDiskDeviceProperties {
	if o == nil || IsNil(o.DeviceProperties) {
		var ret VmDiskDeviceProperties
		return ret
	}
...
// SetDeviceProperties gets a reference to the given VmDiskDeviceProperties and assigns it to the DeviceProperties field.
...
func (o *VmDiskOutputStatus) GetDataSourceReference() VmDiskOutputStatusDataSourceReference {
	if o == nil || IsNil(o.DataSourceReference) {
		var ret VmDiskOutputStatusDataSourceReference
		return ret
	}
...
// SetDataSourceReference gets a reference to the given VmDiskOutputStatusDataSourceReference and assigns it to the DataSourceReference field.
func (o *VmDiskOutputStatus) SetDataSourceReference(v VmDiskOutputStatusDataSourceReference) {
	o.DataSourceReference = &v
}

// GetDiskSizeMib returns the DiskSizeMib field value if set, zero value otherwise.
func (o *VmDiskOutputStatus) GetDiskSizeMib() int32 {
	if o == nil || IsNil(o.DiskSizeMib) {
		var ret int32
		return ret
	}
	return *o.DiskSizeMib
}

// GetDiskSizeMibOk returns a tuple with the DiskSizeMib field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmDiskOutputStatus) GetDiskSizeMibOk() (*int32, bool) {
	if o == nil || IsNil(o.DiskSizeMib) {
		return nil, false
	}
	return o.DiskSizeMib, true
}
...
// SetDiskSizeMib gets a reference to the given int32 and assigns it to the DiskSizeMib field.
func (o *VmDiskOutputStatus) SetDiskSizeMib(v int32) {
	o.DiskSizeMib = &v
}

// GetVolumeGroupReference returns the VolumeGroupReference field value if set, zero value otherwise.
func (o *VmDiskOutputStatus) GetVolumeGroupReference() Reference {
	if o == nil || IsNil(o.VolumeGroupReference) {
		var ret Reference
		return ret
	}
	return *o.VolumeGroupReference
}

// GetVolumeGroupReferenceOk returns a tuple with the VolumeGroupReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmDiskOutputStatus) GetVolumeGroupReferenceOk() (*Reference, bool) {
	if o == nil || IsNil(o.VolumeGroupReference) {
		return nil, false
	}
	return o.VolumeGroupReference, true
}
...
// SetVolumeGroupReference gets a reference to the given Reference and assigns it to the VolumeGroupReference field.
func (o *VmDiskOutputStatus) SetVolumeGroupReference(v Reference) {
	o.VolumeGroupReference = &v
}

func (o VmDiskOutputStatus) MarshalJSON() ([]byte, error) {
...
func (o VmDiskOutputStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.UUID) {
		toSerialize["uuid"] = o.UUID
	}
	if !IsNil(o.IsEncryptionInProgress) {
		toSerialize["is_encryption_in_progress"] = o.IsEncryptionInProgress
	}
	if !IsNil(o.IsMigrationInProgress) {
		toSerialize["is_migration_in_progress"] = o.IsMigrationInProgress
	}
	...
	if !IsNil(o.DiskSizeMib) {
		toSerialize["disk_size_mib"] = o.DiskSizeMib
	}
	if !IsNil(o.VolumeGroupReference) {
		toSerialize["volume_group_reference"] = o.VolumeGroupReference
	}
...
func (o *VmDiskOutputStatus) UnmarshalJSON(data []byte) (err error) {
	varVmDiskOutputStatus := _VmDiskOutputStatus{}

	err = json.Unmarshal(data, &varVmDiskOutputStatus)

	if err != nil {
		return err
	}

	*o = VmDiskOutputStatus(varVmDiskOutputStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "uuid")
		delete(additionalProperties, "is_encryption_in_progress")
		delete(additionalProperties, "is_migration_in_progress")
		delete(additionalProperties, "disk_size_bytes")
		delete(additionalProperties, "storage_config")
		delete(additionalProperties, "device_properties")
		delete(additionalProperties, "data_source_reference")
		delete(additionalProperties, "disk_size_mib")
		delete(additionalProperties, "volume_group_reference")
...
type NullableVmDiskOutputStatus struct {
	value *VmDiskOutputStatus
	isSet bool
}

func (v NullableVmDiskOutputStatus) Get() *VmDiskOutputStatus {
	return v.value
}

func (v *NullableVmDiskOutputStatus) Set(val *VmDiskOutputStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVmDiskOutputStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVmDiskOutputStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmDiskOutputStatus(val *VmDiskOutputStatus) *NullableVmDiskOutputStatus {
	return &NullableVmDiskOutputStatus{value: val, isSet: true}
}

func (v NullableVmDiskOutputStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmDiskOutputStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
