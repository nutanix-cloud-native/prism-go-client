...
// checks if the DirectConnectIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectIntentInput{}

// DirectConnectIntentInput An intentful representation of a direct_connect
type DirectConnectIntentInput struct {
	Spec DirectConnect `json:"spec"`
...
type _DirectConnectIntentInput DirectConnectIntentInput
...
func (o DirectConnectIntentInput) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectIntentInput := _DirectConnectIntentInput{}

	err = json.Unmarshal(data, &varDirectConnectIntentInput)

	if err != nil {
		return err
	}

	*o = DirectConnectIntentInput(varDirectConnectIntentInput)
...
type NullableDirectConnectIntentInput struct {
	value *DirectConnectIntentInput
	isSet bool
}

func (v NullableDirectConnectIntentInput) Get() *DirectConnectIntentInput {
	return v.value
}

func (v *NullableDirectConnectIntentInput) Set(val *DirectConnectIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectIntentInput(val *DirectConnectIntentInput) *NullableDirectConnectIntentInput {
	return &NullableDirectConnectIntentInput{value: val, isSet: true}
}

func (v NullableDirectConnectIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
