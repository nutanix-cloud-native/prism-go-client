...
// AccessControlPolicy Access Control Policy Input Definition.
...
type _AccessControlPolicy AccessControlPolicy
...
func (o *AccessControlPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessControlPolicy := _AccessControlPolicy{}

	err = json.Unmarshal(data, &varAccessControlPolicy)

	if err != nil {
		return err
	}

	*o = AccessControlPolicy(varAccessControlPolicy)
