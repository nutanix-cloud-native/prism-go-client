...
// checks if the VmHostAffinityPolicyGetMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityPolicyGetMetadataOutput{}

// VmHostAffinityPolicyGetMetadataOutput Metadata for VM Host Affinity Policy.
type VmHostAffinityPolicyGetMetadataOutput struct {
	// UTC date and time in RFC-3339 format when vm_host_affinity_policy was last updated.
	...
	// UTC date and time in RFC-3339 format when vm_host_affinity_policy was created.
	CreationTime *time.Time `json:"creation_time,omitempty"`
	CreatedBy *UserReference `json:"created_by,omitempty"`
	LastUpdatedBy *UserReference `json:"last_updated_by,omitempty"`
	// Logical timestamp of VM Host Affinity Policy.
	EntityVersion *int64 `json:"entity_version,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VmHostAffinityPolicyGetMetadataOutput VmHostAffinityPolicyGetMetadataOutput
...
func NewVmHostAffinityPolicyGetMetadataOutput() *VmHostAffinityPolicyGetMetadataOutput {
	this := VmHostAffinityPolicyGetMetadataOutput{}
	var kind string = "vm_host_affinity_policy"
	this.Kind = &kind
	return &this
}
...
// SetCreatedBy gets a reference to the given UserReference and assigns it to the CreatedBy field.
...
// SetLastUpdatedBy gets a reference to the given UserReference and assigns it to the LastUpdatedBy field.
...
// SetEntityVersion gets a reference to the given int64 and assigns it to the EntityVersion field.
func (o *VmHostAffinityPolicyGetMetadataOutput) SetEntityVersion(v int64) {
	o.EntityVersion = &v
}

func (o VmHostAffinityPolicyGetMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityPolicyGetMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VmHostAffinityPolicyGetMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVmHostAffinityPolicyGetMetadataOutput := _VmHostAffinityPolicyGetMetadataOutput{}

	err = json.Unmarshal(data, &varVmHostAffinityPolicyGetMetadataOutput)

	if err != nil {
		return err
	}

	*o = VmHostAffinityPolicyGetMetadataOutput(varVmHostAffinityPolicyGetMetadataOutput)
...
type NullableVmHostAffinityPolicyGetMetadataOutput struct {
	value *VmHostAffinityPolicyGetMetadataOutput
	isSet bool
}

func (v NullableVmHostAffinityPolicyGetMetadataOutput) Get() *VmHostAffinityPolicyGetMetadataOutput {
	return v.value
}

func (v *NullableVmHostAffinityPolicyGetMetadataOutput) Set(val *VmHostAffinityPolicyGetMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityPolicyGetMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityPolicyGetMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityPolicyGetMetadataOutput(val *VmHostAffinityPolicyGetMetadataOutput) *NullableVmHostAffinityPolicyGetMetadataOutput {
	return &NullableVmHostAffinityPolicyGetMetadataOutput{value: val, isSet: true}
}

func (v NullableVmHostAffinityPolicyGetMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityPolicyGetMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
