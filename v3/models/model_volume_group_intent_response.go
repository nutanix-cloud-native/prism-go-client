...
// checks if the VolumeGroupIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupIntentResponse{}

// VolumeGroupIntentResponse Response object for intentful operations on a volume_group
...
type _VolumeGroupIntentResponse VolumeGroupIntentResponse
...
func NewVolumeGroupIntentResponse(apiVersion string, metadata VolumeGroupMetadata) *VolumeGroupIntentResponse {
	this := VolumeGroupIntentResponse{}
...
func (o VolumeGroupIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeGroupIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumeGroupIntentResponse := _VolumeGroupIntentResponse{}

	err = json.Unmarshal(data, &varVolumeGroupIntentResponse)

	if err != nil {
		return err
	}

	*o = VolumeGroupIntentResponse(varVolumeGroupIntentResponse)
...
type NullableVolumeGroupIntentResponse struct {
	value *VolumeGroupIntentResponse
	isSet bool
}

func (v NullableVolumeGroupIntentResponse) Get() *VolumeGroupIntentResponse {
	return v.value
}

func (v *NullableVolumeGroupIntentResponse) Set(val *VolumeGroupIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupIntentResponse(val *VolumeGroupIntentResponse) *NullableVolumeGroupIntentResponse {
	return &NullableVolumeGroupIntentResponse{value: val, isSet: true}
}

func (v NullableVolumeGroupIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
