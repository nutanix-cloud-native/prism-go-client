...
// Expression Expression object definition. This holds the context about the token. 
type Expression struct {
	// If the term is a filter (LHS operator RHS), then this represents the operator. 
	Operator *string `json:"operator,omitempty"`
	// Whether the term is an attribute, metric, action.
	PropertyType *string `json:"property_type,omitempty"`
	// In case of a filter, this represents the RHS.
	Value *string `json:"value,omitempty"`
	// Name of the attribute, metric, action.
	PropertyName *string `json:"property_name,omitempty"`
	// The entity type that the term represents.
