...
// checks if the IdempotenceIdentifiersMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdempotenceIdentifiersMetadata{}

// IdempotenceIdentifiersMetadata The idempotence_identifiers kind metadata
type IdempotenceIdentifiersMetadata struct {
	...
	// Categories for the idempotence_identifiers. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the idempotence_identifiers. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _IdempotenceIdentifiersMetadata IdempotenceIdentifiersMetadata
...
func NewIdempotenceIdentifiersMetadata(kind string) *IdempotenceIdentifiersMetadata {
	this := IdempotenceIdentifiersMetadata{}
...
func (o *IdempotenceIdentifiersMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *IdempotenceIdentifiersMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *IdempotenceIdentifiersMetadata) SetName(v string) {
	o.Name = &v
}

func (o IdempotenceIdentifiersMetadata) MarshalJSON() ([]byte, error) {
...
func (o IdempotenceIdentifiersMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *IdempotenceIdentifiersMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varIdempotenceIdentifiersMetadata := _IdempotenceIdentifiersMetadata{}

	err = json.Unmarshal(data, &varIdempotenceIdentifiersMetadata)

	if err != nil {
		return err
	}

	*o = IdempotenceIdentifiersMetadata(varIdempotenceIdentifiersMetadata)
...
type NullableIdempotenceIdentifiersMetadata struct {
	value *IdempotenceIdentifiersMetadata
	isSet bool
}

func (v NullableIdempotenceIdentifiersMetadata) Get() *IdempotenceIdentifiersMetadata {
	return v.value
}

func (v *NullableIdempotenceIdentifiersMetadata) Set(val *IdempotenceIdentifiersMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIdempotenceIdentifiersMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIdempotenceIdentifiersMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdempotenceIdentifiersMetadata(val *IdempotenceIdentifiersMetadata) *NullableIdempotenceIdentifiersMetadata {
	return &NullableIdempotenceIdentifiersMetadata{value: val, isSet: true}
}

func (v NullableIdempotenceIdentifiersMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdempotenceIdentifiersMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
