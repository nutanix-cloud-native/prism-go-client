...
// AccountReference The reference to a account
...
type _AccountReference AccountReference
...
func (o *AccountReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountReference := _AccountReference{}

	err = json.Unmarshal(data, &varAccountReference)

	if err != nil {
		return err
	}

	*o = AccountReference(varAccountReference)
