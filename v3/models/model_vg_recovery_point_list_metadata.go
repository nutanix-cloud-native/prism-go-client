...
// checks if the VgRecoveryPointListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VgRecoveryPointListMetadata{}

// VgRecoveryPointListMetadata All api calls that return a list will have this metadata block as input 
type VgRecoveryPointListMetadata struct {
	// The kind name
...
type _VgRecoveryPointListMetadata VgRecoveryPointListMetadata
...
func NewVgRecoveryPointListMetadata() *VgRecoveryPointListMetadata {
	this := VgRecoveryPointListMetadata{}
...
func (o VgRecoveryPointListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VgRecoveryPointListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VgRecoveryPointListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVgRecoveryPointListMetadata := _VgRecoveryPointListMetadata{}

	err = json.Unmarshal(data, &varVgRecoveryPointListMetadata)

	if err != nil {
		return err
	}

	*o = VgRecoveryPointListMetadata(varVgRecoveryPointListMetadata)
...
type NullableVgRecoveryPointListMetadata struct {
	value *VgRecoveryPointListMetadata
	isSet bool
}

func (v NullableVgRecoveryPointListMetadata) Get() *VgRecoveryPointListMetadata {
	return v.value
}

func (v *NullableVgRecoveryPointListMetadata) Set(val *VgRecoveryPointListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVgRecoveryPointListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVgRecoveryPointListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVgRecoveryPointListMetadata(val *VgRecoveryPointListMetadata) *NullableVgRecoveryPointListMetadata {
	return &NullableVgRecoveryPointListMetadata{value: val, isSet: true}
}

func (v NullableVgRecoveryPointListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVgRecoveryPointListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
