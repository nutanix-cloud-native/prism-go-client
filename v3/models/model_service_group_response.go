...
// checks if the ServiceGroupResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceGroupResponse{}

// ServiceGroupResponse Service group response object for GET calls. This can have an associated policies list in the future.
...
type _ServiceGroupResponse ServiceGroupResponse
...
func (o ServiceGroupResponse) MarshalJSON() ([]byte, error) {
...
func (o ServiceGroupResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ServiceGroupResponse) UnmarshalJSON(data []byte) (err error) {
	varServiceGroupResponse := _ServiceGroupResponse{}

	err = json.Unmarshal(data, &varServiceGroupResponse)

	if err != nil {
		return err
	}

	*o = ServiceGroupResponse(varServiceGroupResponse)
...
type NullableServiceGroupResponse struct {
	value *ServiceGroupResponse
	isSet bool
}

func (v NullableServiceGroupResponse) Get() *ServiceGroupResponse {
	return v.value
}

func (v *NullableServiceGroupResponse) Set(val *ServiceGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceGroupResponse(val *ServiceGroupResponse) *NullableServiceGroupResponse {
	return &NullableServiceGroupResponse{value: val, isSet: true}
}

func (v NullableServiceGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
