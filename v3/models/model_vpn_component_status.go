...
// checks if the VpnComponentStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnComponentStatus{}

// VpnComponentStatus Object to capture status of various aspects of the VPN connection. 
type VpnComponentStatus struct {
...
type _VpnComponentStatus VpnComponentStatus
...
func (o VpnComponentStatus) MarshalJSON() ([]byte, error) {
...
func (o VpnComponentStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VpnComponentStatus) UnmarshalJSON(data []byte) (err error) {
	varVpnComponentStatus := _VpnComponentStatus{}

	err = json.Unmarshal(data, &varVpnComponentStatus)

	if err != nil {
		return err
	}

	*o = VpnComponentStatus(varVpnComponentStatus)
...
type NullableVpnComponentStatus struct {
	value *VpnComponentStatus
	isSet bool
}

func (v NullableVpnComponentStatus) Get() *VpnComponentStatus {
	return v.value
}

func (v *NullableVpnComponentStatus) Set(val *VpnComponentStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnComponentStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnComponentStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnComponentStatus(val *VpnComponentStatus) *NullableVpnComponentStatus {
	return &NullableVpnComponentStatus{value: val, isSet: true}
}

func (v NullableVpnComponentStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnComponentStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
