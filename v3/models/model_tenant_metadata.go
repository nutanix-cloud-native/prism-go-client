...
// TenantMetadata The tenant kind metadata
type TenantMetadata struct {
	...
	// Categories for the tenant. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the tenant. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _TenantMetadata TenantMetadata
...
func (o *TenantMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *TenantMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *TenantMetadata) SetName(v string) {
	o.Name = &v
}
...
func (o *TenantMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varTenantMetadata := _TenantMetadata{}

	err = json.Unmarshal(data, &varTenantMetadata)

	if err != nil {
		return err
	}

	*o = TenantMetadata(varTenantMetadata)
