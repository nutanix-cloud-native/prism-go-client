...
// checks if the PermissionListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionListIntentResponse{}

// PermissionListIntentResponse Response object for intentful operation of permissions
type PermissionListIntentResponse struct {
	Entities []PermissionIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata PermissionListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _PermissionListIntentResponse PermissionListIntentResponse
...
func NewPermissionListIntentResponse(apiVersion string, metadata PermissionListMetadataOutput) *PermissionListIntentResponse {
	this := PermissionListIntentResponse{}
...
func (o *PermissionListIntentResponse) GetEntities() []PermissionIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []PermissionIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []PermissionIntentResource and assigns it to the Entities field.
...
func (o *PermissionListIntentResponse) GetMetadata() PermissionListMetadataOutput {
	if o == nil {
		var ret PermissionListMetadataOutput
		return ret
	}
...
func (o PermissionListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o PermissionListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PermissionListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPermissionListIntentResponse := _PermissionListIntentResponse{}

	err = json.Unmarshal(data, &varPermissionListIntentResponse)

	if err != nil {
		return err
	}

	*o = PermissionListIntentResponse(varPermissionListIntentResponse)
...
type NullablePermissionListIntentResponse struct {
	value *PermissionListIntentResponse
	isSet bool
}

func (v NullablePermissionListIntentResponse) Get() *PermissionListIntentResponse {
	return v.value
}

func (v *NullablePermissionListIntentResponse) Set(val *PermissionListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionListIntentResponse(val *PermissionListIntentResponse) *NullablePermissionListIntentResponse {
	return &NullablePermissionListIntentResponse{value: val, isSet: true}
}

func (v NullablePermissionListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
