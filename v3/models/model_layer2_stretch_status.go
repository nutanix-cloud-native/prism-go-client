...
// checks if the Layer2StretchStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchStatus{}

// Layer2StretchStatus The status of a REST API call. Only used when there is a failure to report. 
type Layer2StretchStatus struct {
	// The kind name
...
type _Layer2StretchStatus Layer2StretchStatus
...
func (o Layer2StretchStatus) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchStatus) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchStatus) UnmarshalJSON(data []byte) (err error) {
	varLayer2StretchStatus := _Layer2StretchStatus{}

	err = json.Unmarshal(data, &varLayer2StretchStatus)

	if err != nil {
		return err
	}

	*o = Layer2StretchStatus(varLayer2StretchStatus)
...
type NullableLayer2StretchStatus struct {
	value *Layer2StretchStatus
	isSet bool
}

func (v NullableLayer2StretchStatus) Get() *Layer2StretchStatus {
	return v.value
}

func (v *NullableLayer2StretchStatus) Set(val *Layer2StretchStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchStatus(val *Layer2StretchStatus) *NullableLayer2StretchStatus {
	return &NullableLayer2StretchStatus{value: val, isSet: true}
}

func (v NullableLayer2StretchStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
