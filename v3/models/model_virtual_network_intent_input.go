...
// checks if the VirtualNetworkIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkIntentInput{}

// VirtualNetworkIntentInput An intentful representation of a virtual_network
type VirtualNetworkIntentInput struct {
	Spec VirtualNetwork `json:"spec"`
...
type _VirtualNetworkIntentInput VirtualNetworkIntentInput
...
func NewVirtualNetworkIntentInput(spec VirtualNetwork, metadata VirtualNetworkMetadata) *VirtualNetworkIntentInput {
	this := VirtualNetworkIntentInput{}
	this.Spec = spec
...
func (o VirtualNetworkIntentInput) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualNetworkIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualNetworkIntentInput := _VirtualNetworkIntentInput{}

	err = json.Unmarshal(data, &varVirtualNetworkIntentInput)

	if err != nil {
		return err
	}

	*o = VirtualNetworkIntentInput(varVirtualNetworkIntentInput)
...
type NullableVirtualNetworkIntentInput struct {
	value *VirtualNetworkIntentInput
	isSet bool
}

func (v NullableVirtualNetworkIntentInput) Get() *VirtualNetworkIntentInput {
	return v.value
}

func (v *NullableVirtualNetworkIntentInput) Set(val *VirtualNetworkIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkIntentInput(val *VirtualNetworkIntentInput) *NullableVirtualNetworkIntentInput {
	return &NullableVirtualNetworkIntentInput{value: val, isSet: true}
}

func (v NullableVirtualNetworkIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
