...
// checks if the HostGpu type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostGpu{}
...
type HostGpu struct {
	...
	NumVgpusAllocated *int32 `json:"num_vgpus_allocated,omitempty"`
	ConsumerReference *Reference `json:"consumer_reference,omitempty"`
...
// SetLicenseList gets a reference to the given []string and assigns it to the LicenseList field.
...
// GetNumVgpusAllocated returns the NumVgpusAllocated field value if set, zero value otherwise.
func (o *HostGpu) GetNumVgpusAllocated() int32 {
	if o == nil || IsNil(o.NumVgpusAllocated) {
		var ret int32
		return ret
	}
	return *o.NumVgpusAllocated
}

// GetNumVgpusAllocatedOk returns a tuple with the NumVgpusAllocated field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HostGpu) GetNumVgpusAllocatedOk() (*int32, bool) {
	if o == nil || IsNil(o.NumVgpusAllocated) {
		return nil, false
	}
	return o.NumVgpusAllocated, true
}
...
// SetNumVgpusAllocated gets a reference to the given int32 and assigns it to the NumVgpusAllocated field.
func (o *HostGpu) SetNumVgpusAllocated(v int32) {
	o.NumVgpusAllocated = &v
}
...
// SetConsumerReference gets a reference to the given Reference and assigns it to the ConsumerReference field.
...
// GetFrameBufferSizeMib returns the FrameBufferSizeMib field value if set, zero value otherwise.
func (o *HostGpu) GetFrameBufferSizeMib() int64 {
	if o == nil || IsNil(o.FrameBufferSizeMib) {
		var ret int64
		return ret
	}
	return *o.FrameBufferSizeMib
}

// GetFrameBufferSizeMibOk returns a tuple with the FrameBufferSizeMib field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HostGpu) GetFrameBufferSizeMibOk() (*int64, bool) {
	if o == nil || IsNil(o.FrameBufferSizeMib) {
		return nil, false
	}
	return o.FrameBufferSizeMib, true
}
...
// SetFrameBufferSizeMib gets a reference to the given int64 and assigns it to the FrameBufferSizeMib field.
func (o *HostGpu) SetFrameBufferSizeMib(v int64) {
	o.FrameBufferSizeMib = &v
}
...
func (o HostGpu) MarshalJSON() ([]byte, error) {
...
func (o HostGpu) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LicenseList) {
		toSerialize["license_list"] = o.LicenseList
	}
	if !IsNil(o.NumaNode) {
	...
	if !IsNil(o.NumVgpusAllocated) {
		toSerialize["num_vgpus_allocated"] = o.NumVgpusAllocated
	}
	if !IsNil(o.ConsumerReference) {
		toSerialize["consumer_reference"] = o.ConsumerReference
	}
	...
	if !IsNil(o.NumVirtualDisplayHeads) {
		toSerialize["num_virtual_display_heads"] = o.NumVirtualDisplayHeads
	}
	if !IsNil(o.GuestDriverVersion) {
		toSerialize["guest_driver_version"] = o.GuestDriverVersion
	}
	if !IsNil(o.FrameBufferSizeMib) {
		toSerialize["frame_buffer_size_mib"] = o.FrameBufferSizeMib
	}
	if !IsNil(o.DeviceId) {
		toSerialize["device_id"] = o.DeviceId
	}
	if !IsNil(o.MaxInstancesPerVm) {
		toSerialize["max_instances_per_vm"] = o.MaxInstancesPerVm
	}
	if !IsNil(o.UUID) {
...
func (o *HostGpu) UnmarshalJSON(data []byte) (err error) {
	varHostGpu := _HostGpu{}

	err = json.Unmarshal(data, &varHostGpu)

	if err != nil {
		return err
	}

	*o = HostGpu(varHostGpu)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "license_list")
		delete(additionalProperties, "numa_node")
		delete(additionalProperties, "max_resolution")
		delete(additionalProperties, "num_vgpus_allocated")
		delete(additionalProperties, "consumer_reference")
		delete(additionalProperties, "pci_address")
		delete(additionalProperties, "fraction")
		delete(additionalProperties, "mode")
		delete(additionalProperties, "num_virtual_display_heads")
		delete(additionalProperties, "guest_driver_version")
		delete(additionalProperties, "frame_buffer_size_mib")
		delete(additionalProperties, "device_id")
		delete(additionalProperties, "max_instances_per_vm")
...
type NullableHostGpu struct {
	value *HostGpu
	isSet bool
}

func (v NullableHostGpu) Get() *HostGpu {
	return v.value
}

func (v *NullableHostGpu) Set(val *HostGpu) {
	v.value = val
	v.isSet = true
}

func (v NullableHostGpu) IsSet() bool {
	return v.isSet
}

func (v *NullableHostGpu) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostGpu(val *HostGpu) *NullableHostGpu {
	return &NullableHostGpu{value: val, isSet: true}
}

func (v NullableHostGpu) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostGpu) UnmarshalJSON(src []byte) error {
	v.isSet = true
