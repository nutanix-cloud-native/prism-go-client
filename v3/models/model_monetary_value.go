...
// checks if the MonetaryValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonetaryValue{}

// MonetaryValue Monetary value along with currency details.
...
type _MonetaryValue MonetaryValue
...
func (o MonetaryValue) MarshalJSON() ([]byte, error) {
...
func (o MonetaryValue) ToMap() (map[string]interface{}, error) {
...
func (o *MonetaryValue) UnmarshalJSON(data []byte) (err error) {
	varMonetaryValue := _MonetaryValue{}

	err = json.Unmarshal(data, &varMonetaryValue)

	if err != nil {
		return err
	}

	*o = MonetaryValue(varMonetaryValue)
...
type NullableMonetaryValue struct {
	value *MonetaryValue
	isSet bool
}

func (v NullableMonetaryValue) Get() *MonetaryValue {
	return v.value
}

func (v *NullableMonetaryValue) Set(val *MonetaryValue) {
	v.value = val
	v.isSet = true
}

func (v NullableMonetaryValue) IsSet() bool {
	return v.isSet
}

func (v *NullableMonetaryValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonetaryValue(val *MonetaryValue) *NullableMonetaryValue {
	return &NullableMonetaryValue{value: val, isSet: true}
}

func (v NullableMonetaryValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonetaryValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
