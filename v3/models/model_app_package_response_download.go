...
// checks if the AppPackageResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPackageResponseDownload{}

// AppPackageResponseDownload Package definition for Application
type AppPackageResponseDownload struct {
	// Additional properties for k8s image spec
	ImageSpec map[string]interface{} `json:"image_spec,omitempty"`
	// 
	Description *string `json:"description,omitempty"`
	// List of references to action 
	ActionList []AppActionResponse `json:"action_list,omitempty"`
	// 
	ElementList []AppPackageElement `json:"element_list,omitempty"`
	// Message list for package
	MessageList []MessageResource `json:"message_list,omitempty"`
	// References of the service.
	ServiceLocalReferenceList []AppServiceReference `json:"service_local_reference_list,omitempty"`
	AccountReference *AccountReferenceUpload `json:"account_reference,omitempty"`
	// 
	...
	// 
	ServiceElementLocalReferenceList []AppServiceElement `json:"service_element_local_reference_list,omitempty"`
	...
	ConfigReference *AppPackageReferenceUpload `json:"config_reference,omitempty"`
	// 
...
type _AppPackageResponseDownload AppPackageResponseDownload
...
func NewAppPackageResponseDownload(name string, state string, type_ string, uUID string) *AppPackageResponseDownload {
	this := AppPackageResponseDownload{}
	this.Name = name
	this.State = state
	this.Type = type_
	this.UUID = uUID
...
// SetImageSpec gets a reference to the given map[string]interface{} and assigns it to the ImageSpec field.
...
// GetElementList returns the ElementList field value if set, zero value otherwise.
func (o *AppPackageResponseDownload) GetElementList() []AppPackageElement {
	if o == nil || IsNil(o.ElementList) {
		var ret []AppPackageElement
		return ret
	}
	return o.ElementList
}

// GetElementListOk returns a tuple with the ElementList field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetElementList gets a reference to the given []AppPackageElement and assigns it to the ElementList field.
...
// GetServiceLocalReferenceList returns the ServiceLocalReferenceList field value if set, zero value otherwise.
func (o *AppPackageResponseDownload) GetServiceLocalReferenceList() []AppServiceReference {
	if o == nil || IsNil(o.ServiceLocalReferenceList) {
		var ret []AppServiceReference
		return ret
	}
	return o.ServiceLocalReferenceList
}

// GetServiceLocalReferenceListOk returns a tuple with the ServiceLocalReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppPackageResponseDownload) GetServiceLocalReferenceListOk() ([]AppServiceReference, bool) {
	if o == nil || IsNil(o.ServiceLocalReferenceList) {
		return nil, false
	}
	return o.ServiceLocalReferenceList, true
}
...
// SetServiceLocalReferenceList gets a reference to the given []AppServiceReference and assigns it to the ServiceLocalReferenceList field.
func (o *AppPackageResponseDownload) SetServiceLocalReferenceList(v []AppServiceReference) {
	o.ServiceLocalReferenceList = v
}
...
func (o *AppPackageResponseDownload) GetAccountReference() AccountReferenceUpload {
	if o == nil || IsNil(o.AccountReference) {
		var ret AccountReferenceUpload
		return ret
	}
...
// SetAccountReference gets a reference to the given AccountReferenceUpload and assigns it to the AccountReference field.
...
// GetServiceElementLocalReferenceList returns the ServiceElementLocalReferenceList field value if set, zero value otherwise.
func (o *AppPackageResponseDownload) GetServiceElementLocalReferenceList() []AppServiceElement {
	if o == nil || IsNil(o.ServiceElementLocalReferenceList) {
		var ret []AppServiceElement
		return ret
	}
	return o.ServiceElementLocalReferenceList
}

// GetServiceElementLocalReferenceListOk returns a tuple with the ServiceElementLocalReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppPackageResponseDownload) GetServiceElementLocalReferenceListOk() ([]AppServiceElement, bool) {
	if o == nil || IsNil(o.ServiceElementLocalReferenceList) {
		return nil, false
	}
	return o.ServiceElementLocalReferenceList, true
}
...
// SetServiceElementLocalReferenceList gets a reference to the given []AppServiceElement and assigns it to the ServiceElementLocalReferenceList field.
func (o *AppPackageResponseDownload) SetServiceElementLocalReferenceList(v []AppServiceElement) {
	o.ServiceElementLocalReferenceList = v
}
...
// SetConfigReference gets a reference to the given AppPackageReferenceUpload and assigns it to the ConfigReference field.
...
func (o AppPackageResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o AppPackageResponseDownload) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ElementList) {
		toSerialize["element_list"] = o.ElementList
	}
	if !IsNil(o.MessageList) {
		toSerialize["message_list"] = o.MessageList
	}
	if !IsNil(o.ServiceLocalReferenceList) {
		toSerialize["service_local_reference_list"] = o.ServiceLocalReferenceList
	}
	if !IsNil(o.AccountReference) {
		toSerialize["account_reference"] = o.AccountReference
	}
	...
	if !IsNil(o.ServiceElementLocalReferenceList) {
		toSerialize["service_element_local_reference_list"] = o.ServiceElementLocalReferenceList
	}
...
func (o *AppPackageResponseDownload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPackageResponseDownload := _AppPackageResponseDownload{}

	err = json.Unmarshal(data, &varAppPackageResponseDownload)

	if err != nil {
		return err
	}

	*o = AppPackageResponseDownload(varAppPackageResponseDownload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "image_spec")
		...
		delete(additionalProperties, "service_local_reference_list")
		delete(additionalProperties, "account_reference")
		delete(additionalProperties, "name")
		delete(additionalProperties, "state")
		delete(additionalProperties, "version")
		delete(additionalProperties, "service_element_local_reference_list")
...
type NullableAppPackageResponseDownload struct {
	value *AppPackageResponseDownload
	isSet bool
}

func (v NullableAppPackageResponseDownload) Get() *AppPackageResponseDownload {
	return v.value
}

func (v *NullableAppPackageResponseDownload) Set(val *AppPackageResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPackageResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPackageResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPackageResponseDownload(val *AppPackageResponseDownload) *NullableAppPackageResponseDownload {
	return &NullableAppPackageResponseDownload{value: val, isSet: true}
}

func (v NullableAppPackageResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPackageResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
