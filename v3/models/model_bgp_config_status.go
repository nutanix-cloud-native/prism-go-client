...
// checks if the BgpConfigStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BgpConfigStatus{}

// BgpConfigStatus BGP configuration status for route peering with another router.
type BgpConfigStatus struct {
	// ASN used in BGP.
	Asn *int32 `json:"asn,omitempty"`
	// Password for authentication. Note that the clear-text password value specfied in the input spec is never revealed in the status. Use this field only as means to verify if the password is currently set or not. 
	Password *string `json:"password,omitempty"`
	// Boolean flag to indicate users choice on whether connected routes must be redistributed over eBGP. (Applicable to VLAN backed gateways only) 
	DistributeConnected *bool `json:"distribute_connected,omitempty"`
	// IP address of the peer.
	PeerIp *string `json:"peer_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	AdditionalProperties map[string]interface{}
}

type _BgpConfigStatus BgpConfigStatus
...
// GetDistributeConnected returns the DistributeConnected field value if set, zero value otherwise.
func (o *BgpConfigStatus) GetDistributeConnected() bool {
	if o == nil || IsNil(o.DistributeConnected) {
		var ret bool
		return ret
	}
	return *o.DistributeConnected
}

// GetDistributeConnectedOk returns a tuple with the DistributeConnected field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BgpConfigStatus) GetDistributeConnectedOk() (*bool, bool) {
	if o == nil || IsNil(o.DistributeConnected) {
		return nil, false
	}
	return o.DistributeConnected, true
}
...
// SetDistributeConnected gets a reference to the given bool and assigns it to the DistributeConnected field.
func (o *BgpConfigStatus) SetDistributeConnected(v bool) {
	o.DistributeConnected = &v
}
...
func (o BgpConfigStatus) MarshalJSON() ([]byte, error) {
...
func (o BgpConfigStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DistributeConnected) {
		toSerialize["distribute_connected"] = o.DistributeConnected
	}
	if !IsNil(o.PeerIp) {
...
func (o *BgpConfigStatus) UnmarshalJSON(data []byte) (err error) {
	varBgpConfigStatus := _BgpConfigStatus{}

	err = json.Unmarshal(data, &varBgpConfigStatus)

	if err != nil {
		return err
	}

	*o = BgpConfigStatus(varBgpConfigStatus)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "distribute_connected")
