...
// checks if the AwsRegionResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRegionResourcesDefStatus{}

// AwsRegionResourcesDefStatus aws_region resources
type AwsRegionResourcesDefStatus struct {
...
type _AwsRegionResourcesDefStatus AwsRegionResourcesDefStatus
...
func NewAwsRegionResourcesDefStatus() *AwsRegionResourcesDefStatus {
	this := AwsRegionResourcesDefStatus{}
	return &this
}
...
func (o AwsRegionResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsRegionResourcesDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRegionResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsRegionResourcesDefStatus := _AwsRegionResourcesDefStatus{}

	err = json.Unmarshal(data, &varAwsRegionResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = AwsRegionResourcesDefStatus(varAwsRegionResourcesDefStatus)
...
type NullableAwsRegionResourcesDefStatus struct {
	value *AwsRegionResourcesDefStatus
	isSet bool
}

func (v NullableAwsRegionResourcesDefStatus) Get() *AwsRegionResourcesDefStatus {
	return v.value
}

func (v *NullableAwsRegionResourcesDefStatus) Set(val *AwsRegionResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRegionResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRegionResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRegionResourcesDefStatus(val *AwsRegionResourcesDefStatus) *NullableAwsRegionResourcesDefStatus {
	return &NullableAwsRegionResourcesDefStatus{value: val, isSet: true}
}

func (v NullableAwsRegionResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRegionResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
