...
func NewBatchRequest(apiRequestList []ApiRequest) *BatchRequest {
	this := BatchRequest{}
	var executionOrder string = "SEQUENTIAL"
	this.ExecutionOrder = &executionOrder
	var actionOnFailure string = "CONTINUE"
...
// GetApiRequestList returns the ApiRequestList field value
func (o *BatchRequest) GetApiRequestList() []ApiRequest {
	...
	return o.ApiRequestList
}

// GetApiRequestListOk returns a tuple with the ApiRequestList field value
// and a boolean to check if the value has been set.
func (o *BatchRequest) GetApiRequestListOk() ([]ApiRequest, bool) {
	if o == nil {
		return nil, false
	}
	return o.ApiRequestList, true
}

// SetApiRequestList sets field value
...
func (o BatchRequest) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["api_request_list"] = o.ApiRequestList
...
func (o *BatchRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = BatchRequest(varBatchRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "execution_order")
		delete(additionalProperties, "action_on_failure")
		delete(additionalProperties, "api_request_list")
