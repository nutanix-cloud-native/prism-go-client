...
// checks if the NgtPolicyResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicyResources{}

// NgtPolicyResources NGT policy resources definition.
type NgtPolicyResources struct {
	// The type of ngt policy.
	Type string `json:"type"`
	Parameters *NgtPolicyResourcesParameters `json:"parameters,omitempty"`
	// List of entities on which the policy is to be applied.
	FilterList []Filter `json:"filter_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NgtPolicyResources NgtPolicyResources
...
func (o *NgtPolicyResources) GetParameters() NgtPolicyResourcesParameters {
	if o == nil || IsNil(o.Parameters) {
		var ret NgtPolicyResourcesParameters
		return ret
	}
	return *o.Parameters
}
...
// SetParameters gets a reference to the given NgtPolicyResourcesParameters and assigns it to the Parameters field.
...
func (o NgtPolicyResources) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicyResources) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicyResources) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtPolicyResources := _NgtPolicyResources{}

	err = json.Unmarshal(data, &varNgtPolicyResources)

	if err != nil {
		return err
	}

	*o = NgtPolicyResources(varNgtPolicyResources)
...
type NullableNgtPolicyResources struct {
	value *NgtPolicyResources
	isSet bool
}

func (v NullableNgtPolicyResources) Get() *NgtPolicyResources {
	return v.value
}

func (v *NullableNgtPolicyResources) Set(val *NgtPolicyResources) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicyResources) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicyResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicyResources(val *NgtPolicyResources) *NullableNgtPolicyResources {
	return &NullableNgtPolicyResources{value: val, isSet: true}
}

func (v NullableNgtPolicyResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicyResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
