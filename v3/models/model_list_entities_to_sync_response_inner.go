...
// checks if the ListEntitiesToSyncResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListEntitiesToSyncResponseInner{}

// ListEntitiesToSyncResponseInner struct for ListEntitiesToSyncResponseInner
type ListEntitiesToSyncResponseInner struct {
	AvailabilityZoneSyncDetails []ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner `json:"availability_zone_sync_details,omitempty"`
	EntityReference *Reference `json:"entity_reference,omitempty"`
	// Category name and a list of values that will be synced. 
	CategoryReference *map[string][]string `json:"category_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ListEntitiesToSyncResponseInner ListEntitiesToSyncResponseInner
...
func NewListEntitiesToSyncResponseInner() *ListEntitiesToSyncResponseInner {
	this := ListEntitiesToSyncResponseInner{}
	return &this
}
...
// GetAvailabilityZoneSyncDetails returns the AvailabilityZoneSyncDetails field value if set, zero value otherwise.
func (o *ListEntitiesToSyncResponseInner) GetAvailabilityZoneSyncDetails() []ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner {
	if o == nil || IsNil(o.AvailabilityZoneSyncDetails) {
		var ret []ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner
		return ret
	}
	return o.AvailabilityZoneSyncDetails
}

// GetAvailabilityZoneSyncDetailsOk returns a tuple with the AvailabilityZoneSyncDetails field value if set, nil otherwise
...
func (o *ListEntitiesToSyncResponseInner) GetAvailabilityZoneSyncDetailsOk() ([]ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner, bool) {
	...
	return o.AvailabilityZoneSyncDetails, true
}
...
// SetAvailabilityZoneSyncDetails gets a reference to the given []ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner and assigns it to the AvailabilityZoneSyncDetails field.
func (o *ListEntitiesToSyncResponseInner) SetAvailabilityZoneSyncDetails(v []ListEntitiesToSyncResponseInnerAvailabilityZoneSyncDetailsInner) {
	o.AvailabilityZoneSyncDetails = v
}
...
// GetCategoryReference returns the CategoryReference field value if set, zero value otherwise.
func (o *ListEntitiesToSyncResponseInner) GetCategoryReference() map[string][]string {
	if o == nil || IsNil(o.CategoryReference) {
		var ret map[string][]string
		return ret
	}
	return *o.CategoryReference
}

// GetCategoryReferenceOk returns a tuple with the CategoryReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ListEntitiesToSyncResponseInner) GetCategoryReferenceOk() (*map[string][]string, bool) {
	if o == nil || IsNil(o.CategoryReference) {
		return nil, false
	}
	return o.CategoryReference, true
}
...
// SetCategoryReference gets a reference to the given map[string][]string and assigns it to the CategoryReference field.
func (o *ListEntitiesToSyncResponseInner) SetCategoryReference(v map[string][]string) {
	o.CategoryReference = &v
}

func (o ListEntitiesToSyncResponseInner) MarshalJSON() ([]byte, error) {
...
func (o ListEntitiesToSyncResponseInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AvailabilityZoneSyncDetails) {
		toSerialize["availability_zone_sync_details"] = o.AvailabilityZoneSyncDetails
	}
	if !IsNil(o.EntityReference) {
		toSerialize["entity_reference"] = o.EntityReference
	}
	if !IsNil(o.CategoryReference) {
		toSerialize["category_reference"] = o.CategoryReference
	}
...
func (o *ListEntitiesToSyncResponseInner) UnmarshalJSON(data []byte) (err error) {
	varListEntitiesToSyncResponseInner := _ListEntitiesToSyncResponseInner{}

	err = json.Unmarshal(data, &varListEntitiesToSyncResponseInner)

	if err != nil {
		return err
	}

	*o = ListEntitiesToSyncResponseInner(varListEntitiesToSyncResponseInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "availability_zone_sync_details")
		delete(additionalProperties, "entity_reference")
		delete(additionalProperties, "category_reference")
...
type NullableListEntitiesToSyncResponseInner struct {
	value *ListEntitiesToSyncResponseInner
	isSet bool
}

func (v NullableListEntitiesToSyncResponseInner) Get() *ListEntitiesToSyncResponseInner {
	return v.value
}

func (v *NullableListEntitiesToSyncResponseInner) Set(val *ListEntitiesToSyncResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListEntitiesToSyncResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListEntitiesToSyncResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListEntitiesToSyncResponseInner(val *ListEntitiesToSyncResponseInner) *NullableListEntitiesToSyncResponseInner {
	return &NullableListEntitiesToSyncResponseInner{value: val, isSet: true}
}

func (v NullableListEntitiesToSyncResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListEntitiesToSyncResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
