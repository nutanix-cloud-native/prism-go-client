...
// checks if the SshUserIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserIntentInput{}

// SshUserIntentInput An intentful representation of a ssh_user
type SshUserIntentInput struct {
	Spec SshUser `json:"spec"`
...
type _SshUserIntentInput SshUserIntentInput
...
func (o SshUserIntentInput) MarshalJSON() ([]byte, error) {
...
func (o SshUserIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varSshUserIntentInput := _SshUserIntentInput{}

	err = json.Unmarshal(data, &varSshUserIntentInput)

	if err != nil {
		return err
	}

	*o = SshUserIntentInput(varSshUserIntentInput)
...
type NullableSshUserIntentInput struct {
	value *SshUserIntentInput
	isSet bool
}

func (v NullableSshUserIntentInput) Get() *SshUserIntentInput {
	return v.value
}

func (v *NullableSshUserIntentInput) Set(val *SshUserIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserIntentInput(val *SshUserIntentInput) *NullableSshUserIntentInput {
	return &NullableSshUserIntentInput{value: val, isSet: true}
}

func (v NullableSshUserIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
