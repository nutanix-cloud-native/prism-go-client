...
// checks if the AwsRegionStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRegionStatus{}

// AwsRegionStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _AwsRegionStatus AwsRegionStatus
...
func (o AwsRegionStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsRegionStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRegionStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsRegionStatus := _AwsRegionStatus{}

	err = json.Unmarshal(data, &varAwsRegionStatus)

	if err != nil {
		return err
	}

	*o = AwsRegionStatus(varAwsRegionStatus)
...
type NullableAwsRegionStatus struct {
	value *AwsRegionStatus
	isSet bool
}

func (v NullableAwsRegionStatus) Get() *AwsRegionStatus {
	return v.value
}

func (v *NullableAwsRegionStatus) Set(val *AwsRegionStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRegionStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRegionStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRegionStatus(val *AwsRegionStatus) *NullableAwsRegionStatus {
	return &NullableAwsRegionStatus{value: val, isSet: true}
}

func (v NullableAwsRegionStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRegionStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
