...
// checks if the NetworkDeviceMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDeviceMetadata{}

// NetworkDeviceMetadata The network_device kind metadata
type NetworkDeviceMetadata struct {
	...
	// Categories for the network_device. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the network_device. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _NetworkDeviceMetadata NetworkDeviceMetadata
...
func (o *NetworkDeviceMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *NetworkDeviceMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *NetworkDeviceMetadata) SetName(v string) {
	o.Name = &v
}

func (o NetworkDeviceMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkDeviceMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkDeviceMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkDeviceMetadata := _NetworkDeviceMetadata{}

	err = json.Unmarshal(data, &varNetworkDeviceMetadata)

	if err != nil {
		return err
	}

	*o = NetworkDeviceMetadata(varNetworkDeviceMetadata)
...
type NullableNetworkDeviceMetadata struct {
	value *NetworkDeviceMetadata
	isSet bool
}

func (v NullableNetworkDeviceMetadata) Get() *NetworkDeviceMetadata {
	return v.value
}

func (v *NullableNetworkDeviceMetadata) Set(val *NetworkDeviceMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDeviceMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDeviceMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDeviceMetadata(val *NetworkDeviceMetadata) *NullableNetworkDeviceMetadata {
	return &NullableNetworkDeviceMetadata{value: val, isSet: true}
}

func (v NullableNetworkDeviceMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDeviceMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
