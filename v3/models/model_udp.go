...
// Udp UDP parameters to be matched in routing policy
type Udp struct {
...
// SetDestinationPortRangeList gets a reference to the given []PortRange and assigns it to the DestinationPortRangeList field.
...
// SetSourcePortRange gets a reference to the given PortRange and assigns it to the SourcePortRange field.
...
// SetSourcePortRangeList gets a reference to the given []PortRange and assigns it to the SourcePortRangeList field.
...
// SetDestinationPortRange gets a reference to the given PortRange and assigns it to the DestinationPortRange field.
...
func (o *Udp) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varUdp)
