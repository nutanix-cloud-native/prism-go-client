...
type VMMetadata struct {
	...
	// Categories for the vm. This allows assigning one value
	// of a key to any entity. Changes done in this will be reflected in
	// the categories_mapping field.
	//
	Categories map[string]string `json:"categories,omitempty"`

	// Categories for the vm. This allows setting up multiple
...
func (m *VMMetadata) validateCreationTime(formats strfmt.Registry) error {
...
func (m *VMMetadata) validateLastUpdateTime(formats strfmt.Registry) error {
...
func (m *VMMetadata) validateProjectReference(formats strfmt.Registry) error {
...
// ContextValidate validate this vm metadata based on the context it is used
...
func (m *VMMetadata) contextValidateCreationTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMMetadata) contextValidateEntityVersion(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMMetadata) contextValidateKind(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMMetadata) contextValidateLastUpdateTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMMetadata) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMMetadata) contextValidateOwnerReference(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMMetadata) contextValidateProjectReference(ctx context.Context, formats strfmt.Registry) error {
