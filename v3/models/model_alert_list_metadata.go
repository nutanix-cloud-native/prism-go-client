...
// checks if the AlertListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertListMetadata{}

// AlertListMetadata All api calls that return a list will have this metadata block as input 
type AlertListMetadata struct {
	// The kind name
...
type _AlertListMetadata AlertListMetadata
...
func (o AlertListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AlertListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AlertListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAlertListMetadata := _AlertListMetadata{}

	err = json.Unmarshal(data, &varAlertListMetadata)

	if err != nil {
		return err
	}

	*o = AlertListMetadata(varAlertListMetadata)
...
type NullableAlertListMetadata struct {
	value *AlertListMetadata
	isSet bool
}

func (v NullableAlertListMetadata) Get() *AlertListMetadata {
	return v.value
}

func (v *NullableAlertListMetadata) Set(val *AlertListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertListMetadata(val *AlertListMetadata) *NullableAlertListMetadata {
	return &NullableAlertListMetadata{value: val, isSet: true}
}

func (v NullableAlertListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
