...
// checks if the AppActionInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppActionInput{}

// AppActionInput Action definition for Application
type AppActionInput struct {
	...
	Runbook *AppRunbookInput `json:"runbook,omitempty"`
	// 
...
type _AppActionInput AppActionInput
...
// SetRunbook gets a reference to the given AppRunbookInput and assigns it to the Runbook field.
...
func (o AppActionInput) MarshalJSON() ([]byte, error) {
...
func (o AppActionInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppActionInput) UnmarshalJSON(data []byte) (err error) {
	varAppActionInput := _AppActionInput{}

	err = json.Unmarshal(data, &varAppActionInput)

	if err != nil {
		return err
	}

	*o = AppActionInput(varAppActionInput)
...
type NullableAppActionInput struct {
	value *AppActionInput
	isSet bool
}

func (v NullableAppActionInput) Get() *AppActionInput {
	return v.value
}

func (v *NullableAppActionInput) Set(val *AppActionInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppActionInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppActionInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppActionInput(val *AppActionInput) *NullableAppActionInput {
	return &NullableAppActionInput{value: val, isSet: true}
}

func (v NullableAppActionInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppActionInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
