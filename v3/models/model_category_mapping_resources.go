...
// checks if the CategoryMappingResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingResources{}

// CategoryMappingResources A mapping from an object to a category value. 
type CategoryMappingResources struct {
	// The value for the category that this mapping is for.
	CategoryValue string `json:"category_value"`
	AdMapping CategoryMappingResourcesAdMapping `json:"ad_mapping"`
	// The name for the category that this mapping is for.
	CategoryName string `json:"category_name"`
	AdditionalProperties map[string]interface{}
}

type _CategoryMappingResources CategoryMappingResources
...
// GetCategoryValue returns the CategoryValue field value
...
// GetCategoryValueOk returns a tuple with the CategoryValue field value
...
// GetAdMappingOk returns a tuple with the AdMapping field value
// and a boolean to check if the value has been set.
...
func (o CategoryMappingResources) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingResources) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingResources) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryMappingResources := _CategoryMappingResources{}

	err = json.Unmarshal(data, &varCategoryMappingResources)

	if err != nil {
		return err
	}

	*o = CategoryMappingResources(varCategoryMappingResources)
...
type NullableCategoryMappingResources struct {
	value *CategoryMappingResources
	isSet bool
}

func (v NullableCategoryMappingResources) Get() *CategoryMappingResources {
	return v.value
}

func (v *NullableCategoryMappingResources) Set(val *CategoryMappingResources) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingResources) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingResources(val *CategoryMappingResources) *NullableCategoryMappingResources {
	return &NullableCategoryMappingResources{value: val, isSet: true}
}

func (v NullableCategoryMappingResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
