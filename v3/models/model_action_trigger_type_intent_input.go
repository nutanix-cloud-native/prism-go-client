...
// checks if the ActionTriggerTypeIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTriggerTypeIntentInput{}

// ActionTriggerTypeIntentInput An intentful representation of a action_trigger_type
type ActionTriggerTypeIntentInput struct {
	Spec ActionTriggerType `json:"spec"`
...
type _ActionTriggerTypeIntentInput ActionTriggerTypeIntentInput
...
func NewActionTriggerTypeIntentInput(spec ActionTriggerType, metadata ActionTriggerTypeMetadata) *ActionTriggerTypeIntentInput {
	this := ActionTriggerTypeIntentInput{}
	this.Spec = spec
...
func (o ActionTriggerTypeIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ActionTriggerTypeIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTriggerTypeIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTriggerTypeIntentInput := _ActionTriggerTypeIntentInput{}

	err = json.Unmarshal(data, &varActionTriggerTypeIntentInput)

	if err != nil {
		return err
	}

	*o = ActionTriggerTypeIntentInput(varActionTriggerTypeIntentInput)
...
type NullableActionTriggerTypeIntentInput struct {
	value *ActionTriggerTypeIntentInput
	isSet bool
}

func (v NullableActionTriggerTypeIntentInput) Get() *ActionTriggerTypeIntentInput {
	return v.value
}

func (v *NullableActionTriggerTypeIntentInput) Set(val *ActionTriggerTypeIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTriggerTypeIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTriggerTypeIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTriggerTypeIntentInput(val *ActionTriggerTypeIntentInput) *NullableActionTriggerTypeIntentInput {
	return &NullableActionTriggerTypeIntentInput{value: val, isSet: true}
}

func (v NullableActionTriggerTypeIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTriggerTypeIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
