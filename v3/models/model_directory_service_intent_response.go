...
// checks if the DirectoryServiceIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceIntentResponse{}

// DirectoryServiceIntentResponse Response object for intentful operations on a directory_service
...
type _DirectoryServiceIntentResponse DirectoryServiceIntentResponse
...
func NewDirectoryServiceIntentResponse(apiVersion string, metadata DirectoryServiceMetadata) *DirectoryServiceIntentResponse {
	this := DirectoryServiceIntentResponse{}
...
func (o DirectoryServiceIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryServiceIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectoryServiceIntentResponse := _DirectoryServiceIntentResponse{}

	err = json.Unmarshal(data, &varDirectoryServiceIntentResponse)

	if err != nil {
		return err
	}

	*o = DirectoryServiceIntentResponse(varDirectoryServiceIntentResponse)
...
type NullableDirectoryServiceIntentResponse struct {
	value *DirectoryServiceIntentResponse
	isSet bool
}

func (v NullableDirectoryServiceIntentResponse) Get() *DirectoryServiceIntentResponse {
	return v.value
}

func (v *NullableDirectoryServiceIntentResponse) Set(val *DirectoryServiceIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceIntentResponse(val *DirectoryServiceIntentResponse) *NullableDirectoryServiceIntentResponse {
	return &NullableDirectoryServiceIntentResponse{value: val, isSet: true}
}

func (v NullableDirectoryServiceIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
