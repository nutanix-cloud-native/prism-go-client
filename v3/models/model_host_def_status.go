...
// checks if the HostDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostDefStatus{}

// HostDefStatus Host Status definition.
...
type _HostDefStatus HostDefStatus
...
// SetClusterReference gets a reference to the given Reference and assigns it to the ClusterReference field.
func (o *HostDefStatus) SetClusterReference(v Reference) {
	o.ClusterReference = &v
}

func (o HostDefStatus) MarshalJSON() ([]byte, error) {
...
func (o HostDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *HostDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varHostDefStatus := _HostDefStatus{}

	err = json.Unmarshal(data, &varHostDefStatus)

	if err != nil {
		return err
	}

	*o = HostDefStatus(varHostDefStatus)
...
type NullableHostDefStatus struct {
	value *HostDefStatus
	isSet bool
}

func (v NullableHostDefStatus) Get() *HostDefStatus {
	return v.value
}

func (v *NullableHostDefStatus) Set(val *HostDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableHostDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableHostDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostDefStatus(val *HostDefStatus) *NullableHostDefStatus {
	return &NullableHostDefStatus{value: val, isSet: true}
}

func (v NullableHostDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
