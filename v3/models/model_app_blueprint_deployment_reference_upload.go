...
// checks if the AppBlueprintDeploymentReferenceUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppBlueprintDeploymentReferenceUpload{}

// AppBlueprintDeploymentReferenceUpload The reference to a app_blueprint_deployment
type AppBlueprintDeploymentReferenceUpload struct {
	// The kind name
...
type _AppBlueprintDeploymentReferenceUpload AppBlueprintDeploymentReferenceUpload
...
func NewAppBlueprintDeploymentReferenceUpload(kind string, name string) *AppBlueprintDeploymentReferenceUpload {
	this := AppBlueprintDeploymentReferenceUpload{}
	this.Kind = kind
	this.Name = name
	return &this
}
...
func (o AppBlueprintDeploymentReferenceUpload) MarshalJSON() ([]byte, error) {
...
func (o AppBlueprintDeploymentReferenceUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppBlueprintDeploymentReferenceUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppBlueprintDeploymentReferenceUpload := _AppBlueprintDeploymentReferenceUpload{}

	err = json.Unmarshal(data, &varAppBlueprintDeploymentReferenceUpload)

	if err != nil {
		return err
	}

	*o = AppBlueprintDeploymentReferenceUpload(varAppBlueprintDeploymentReferenceUpload)
...
type NullableAppBlueprintDeploymentReferenceUpload struct {
	value *AppBlueprintDeploymentReferenceUpload
	isSet bool
}

func (v NullableAppBlueprintDeploymentReferenceUpload) Get() *AppBlueprintDeploymentReferenceUpload {
	return v.value
}

func (v *NullableAppBlueprintDeploymentReferenceUpload) Set(val *AppBlueprintDeploymentReferenceUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppBlueprintDeploymentReferenceUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppBlueprintDeploymentReferenceUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppBlueprintDeploymentReferenceUpload(val *AppBlueprintDeploymentReferenceUpload) *NullableAppBlueprintDeploymentReferenceUpload {
	return &NullableAppBlueprintDeploymentReferenceUpload{value: val, isSet: true}
}

func (v NullableAppBlueprintDeploymentReferenceUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppBlueprintDeploymentReferenceUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
