...
// checks if the FloatingIpResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpResourcesDefStatus{}

// FloatingIpResourcesDefStatus Floating IP allocation status.
type FloatingIpResourcesDefStatus struct {
	...
	VmNicReference *VmNicReference `json:"vm_nic_reference,omitempty"`
	// Private IP with which the floating IP is associated.
	PrivateIp *string `json:"private_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	AdditionalProperties map[string]interface{}
}

type _FloatingIpResourcesDefStatus FloatingIpResourcesDefStatus
...
func NewFloatingIpResourcesDefStatus() *FloatingIpResourcesDefStatus {
	this := FloatingIpResourcesDefStatus{}
	return &this
}
...
// GetVmNicReference returns the VmNicReference field value if set, zero value otherwise.
func (o *FloatingIpResourcesDefStatus) GetVmNicReference() VmNicReference {
	if o == nil || IsNil(o.VmNicReference) {
		var ret VmNicReference
		return ret
	}
	return *o.VmNicReference
}

// GetVmNicReferenceOk returns a tuple with the VmNicReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FloatingIpResourcesDefStatus) GetVmNicReferenceOk() (*VmNicReference, bool) {
	if o == nil || IsNil(o.VmNicReference) {
		return nil, false
	}
	return o.VmNicReference, true
}
...
// SetVmNicReference gets a reference to the given VmNicReference and assigns it to the VmNicReference field.
...
func (o FloatingIpResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.VmNicReference) {
		toSerialize["vm_nic_reference"] = o.VmNicReference
	}
...
func (o *FloatingIpResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varFloatingIpResourcesDefStatus := _FloatingIpResourcesDefStatus{}

	err = json.Unmarshal(data, &varFloatingIpResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = FloatingIpResourcesDefStatus(varFloatingIpResourcesDefStatus)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "vm_nic_reference")
...
type NullableFloatingIpResourcesDefStatus struct {
	value *FloatingIpResourcesDefStatus
	isSet bool
}

func (v NullableFloatingIpResourcesDefStatus) Get() *FloatingIpResourcesDefStatus {
	return v.value
}

func (v *NullableFloatingIpResourcesDefStatus) Set(val *FloatingIpResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpResourcesDefStatus(val *FloatingIpResourcesDefStatus) *NullableFloatingIpResourcesDefStatus {
	return &NullableFloatingIpResourcesDefStatus{value: val, isSet: true}
}

func (v NullableFloatingIpResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
