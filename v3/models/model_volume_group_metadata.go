...
// checks if the VolumeGroupMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupMetadata{}

// VolumeGroupMetadata The volume_group kind metadata
type VolumeGroupMetadata struct {
	...
	// Categories for the volume_group. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the volume_group. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _VolumeGroupMetadata VolumeGroupMetadata
...
func (o *VolumeGroupMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *VolumeGroupMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *VolumeGroupMetadata) SetName(v string) {
	o.Name = &v
}

func (o VolumeGroupMetadata) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeGroupMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumeGroupMetadata := _VolumeGroupMetadata{}

	err = json.Unmarshal(data, &varVolumeGroupMetadata)

	if err != nil {
		return err
	}

	*o = VolumeGroupMetadata(varVolumeGroupMetadata)
...
type NullableVolumeGroupMetadata struct {
	value *VolumeGroupMetadata
	isSet bool
}

func (v NullableVolumeGroupMetadata) Get() *VolumeGroupMetadata {
	return v.value
}

func (v *NullableVolumeGroupMetadata) Set(val *VolumeGroupMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupMetadata(val *VolumeGroupMetadata) *NullableVolumeGroupMetadata {
	return &NullableVolumeGroupMetadata{value: val, isSet: true}
}

func (v NullableVolumeGroupMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
