...
// checks if the NetworkFunctionChainDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionChainDefStatus{}

// NetworkFunctionChainDefStatus Network function chain status definition.
type NetworkFunctionChainDefStatus struct {
	// A description for the network function chain.
	...
	Resources NetworkFunctionChainResource `json:"resources"`
	// Network function chain name.
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _NetworkFunctionChainDefStatus NetworkFunctionChainDefStatus
...
func NewNetworkFunctionChainDefStatus(resources NetworkFunctionChainResource, name string) *NetworkFunctionChainDefStatus {
	this := NetworkFunctionChainDefStatus{}
...
func (o *NetworkFunctionChainDefStatus) GetResources() NetworkFunctionChainResource {
	if o == nil {
		var ret NetworkFunctionChainResource
		return ret
	}
...
func (o NetworkFunctionChainDefStatus) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionChainDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionChainDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkFunctionChainDefStatus := _NetworkFunctionChainDefStatus{}

	err = json.Unmarshal(data, &varNetworkFunctionChainDefStatus)

	if err != nil {
		return err
	}

	*o = NetworkFunctionChainDefStatus(varNetworkFunctionChainDefStatus)
...
type NullableNetworkFunctionChainDefStatus struct {
	value *NetworkFunctionChainDefStatus
	isSet bool
}

func (v NullableNetworkFunctionChainDefStatus) Get() *NetworkFunctionChainDefStatus {
	return v.value
}

func (v *NullableNetworkFunctionChainDefStatus) Set(val *NetworkFunctionChainDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionChainDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionChainDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionChainDefStatus(val *NetworkFunctionChainDefStatus) *NullableNetworkFunctionChainDefStatus {
	return &NullableNetworkFunctionChainDefStatus{value: val, isSet: true}
}

func (v NullableNetworkFunctionChainDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionChainDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
