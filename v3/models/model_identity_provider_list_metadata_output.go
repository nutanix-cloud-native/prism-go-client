...
// checks if the IdentityProviderListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderListMetadataOutput{}

// IdentityProviderListMetadataOutput All api calls that return a list will have this metadata block 
type IdentityProviderListMetadataOutput struct {
	// The kind name
...
type _IdentityProviderListMetadataOutput IdentityProviderListMetadataOutput
...
func NewIdentityProviderListMetadataOutput() *IdentityProviderListMetadataOutput {
	this := IdentityProviderListMetadataOutput{}
	var kind string = "identity_provider"
	this.Kind = &kind
	return &this
}
...
func (o IdentityProviderListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProviderListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varIdentityProviderListMetadataOutput := _IdentityProviderListMetadataOutput{}

	err = json.Unmarshal(data, &varIdentityProviderListMetadataOutput)

	if err != nil {
		return err
	}

	*o = IdentityProviderListMetadataOutput(varIdentityProviderListMetadataOutput)
...
type NullableIdentityProviderListMetadataOutput struct {
	value *IdentityProviderListMetadataOutput
	isSet bool
}

func (v NullableIdentityProviderListMetadataOutput) Get() *IdentityProviderListMetadataOutput {
	return v.value
}

func (v *NullableIdentityProviderListMetadataOutput) Set(val *IdentityProviderListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderListMetadataOutput(val *IdentityProviderListMetadataOutput) *NullableIdentityProviderListMetadataOutput {
	return &NullableIdentityProviderListMetadataOutput{value: val, isSet: true}
}

func (v NullableIdentityProviderListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
