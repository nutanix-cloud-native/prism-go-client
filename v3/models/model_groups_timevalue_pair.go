...
// checks if the GroupsTimevaluePair type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupsTimevaluePair{}

// GroupsTimevaluePair Time-Value Pair Data.
...
type _GroupsTimevaluePair GroupsTimevaluePair
...
func (o GroupsTimevaluePair) MarshalJSON() ([]byte, error) {
...
func (o GroupsTimevaluePair) ToMap() (map[string]interface{}, error) {
...
func (o *GroupsTimevaluePair) UnmarshalJSON(data []byte) (err error) {
	varGroupsTimevaluePair := _GroupsTimevaluePair{}

	err = json.Unmarshal(data, &varGroupsTimevaluePair)

	if err != nil {
		return err
	}

	*o = GroupsTimevaluePair(varGroupsTimevaluePair)
...
type NullableGroupsTimevaluePair struct {
	value *GroupsTimevaluePair
	isSet bool
}

func (v NullableGroupsTimevaluePair) Get() *GroupsTimevaluePair {
	return v.value
}

func (v *NullableGroupsTimevaluePair) Set(val *GroupsTimevaluePair) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupsTimevaluePair) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupsTimevaluePair) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupsTimevaluePair(val *GroupsTimevaluePair) *NullableGroupsTimevaluePair {
	return &NullableGroupsTimevaluePair{value: val, isSet: true}
}

func (v NullableGroupsTimevaluePair) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupsTimevaluePair) UnmarshalJSON(src []byte) error {
	v.isSet = true
