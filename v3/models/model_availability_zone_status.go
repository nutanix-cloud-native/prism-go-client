...
// checks if the AvailabilityZoneStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneStatus{}

// AvailabilityZoneStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _AvailabilityZoneStatus AvailabilityZoneStatus
...
func (o AvailabilityZoneStatus) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneStatus) UnmarshalJSON(data []byte) (err error) {
	varAvailabilityZoneStatus := _AvailabilityZoneStatus{}

	err = json.Unmarshal(data, &varAvailabilityZoneStatus)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneStatus(varAvailabilityZoneStatus)
...
type NullableAvailabilityZoneStatus struct {
	value *AvailabilityZoneStatus
	isSet bool
}

func (v NullableAvailabilityZoneStatus) Get() *AvailabilityZoneStatus {
	return v.value
}

func (v *NullableAvailabilityZoneStatus) Set(val *AvailabilityZoneStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneStatus(val *AvailabilityZoneStatus) *NullableAvailabilityZoneStatus {
	return &NullableAvailabilityZoneStatus{value: val, isSet: true}
}

func (v NullableAvailabilityZoneStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
