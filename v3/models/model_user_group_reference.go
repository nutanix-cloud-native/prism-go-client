...
// checks if the UserGroupReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupReference{}

// UserGroupReference The reference to a user_group
...
type _UserGroupReference UserGroupReference
...
func (o UserGroupReference) MarshalJSON() ([]byte, error) {
...
func (o UserGroupReference) ToMap() (map[string]interface{}, error) {
...
func (o *UserGroupReference) UnmarshalJSON(data []byte) (err error) {
	...
	varUserGroupReference := _UserGroupReference{}

	err = json.Unmarshal(data, &varUserGroupReference)

	if err != nil {
		return err
	}

	*o = UserGroupReference(varUserGroupReference)
...
type NullableUserGroupReference struct {
	value *UserGroupReference
	isSet bool
}

func (v NullableUserGroupReference) Get() *UserGroupReference {
	return v.value
}

func (v *NullableUserGroupReference) Set(val *UserGroupReference) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupReference) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupReference(val *UserGroupReference) *NullableUserGroupReference {
	return &NullableUserGroupReference{value: val, isSet: true}
}

func (v NullableUserGroupReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
