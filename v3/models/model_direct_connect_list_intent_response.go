...
// checks if the DirectConnectListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectListIntentResponse{}

// DirectConnectListIntentResponse Response object for intentful operation of direct_connects
type DirectConnectListIntentResponse struct {
	Entities []DirectConnectIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata DirectConnectListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _DirectConnectListIntentResponse DirectConnectListIntentResponse
...
func NewDirectConnectListIntentResponse(apiVersion string, metadata DirectConnectListMetadataOutput) *DirectConnectListIntentResponse {
	this := DirectConnectListIntentResponse{}
...
func (o *DirectConnectListIntentResponse) GetEntities() []DirectConnectIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []DirectConnectIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []DirectConnectIntentResource and assigns it to the Entities field.
...
func (o *DirectConnectListIntentResponse) GetMetadata() DirectConnectListMetadataOutput {
	if o == nil {
		var ret DirectConnectListMetadataOutput
		return ret
	}
...
func (o DirectConnectListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectListIntentResponse := _DirectConnectListIntentResponse{}

	err = json.Unmarshal(data, &varDirectConnectListIntentResponse)

	if err != nil {
		return err
	}

	*o = DirectConnectListIntentResponse(varDirectConnectListIntentResponse)
...
type NullableDirectConnectListIntentResponse struct {
	value *DirectConnectListIntentResponse
	isSet bool
}

func (v NullableDirectConnectListIntentResponse) Get() *DirectConnectListIntentResponse {
	return v.value
}

func (v *NullableDirectConnectListIntentResponse) Set(val *DirectConnectListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectListIntentResponse(val *DirectConnectListIntentResponse) *NullableDirectConnectListIntentResponse {
	return &NullableDirectConnectListIntentResponse{value: val, isSet: true}
}

func (v NullableDirectConnectListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
