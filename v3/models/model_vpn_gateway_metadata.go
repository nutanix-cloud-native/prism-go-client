...
// checks if the VpnGatewayMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayMetadata{}

// VpnGatewayMetadata The vpn_gateway kind metadata
type VpnGatewayMetadata struct {
	...
	// Categories for the vpn_gateway. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the vpn_gateway. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _VpnGatewayMetadata VpnGatewayMetadata
...
func (o VpnGatewayMetadata) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VpnGatewayMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnGatewayMetadata := _VpnGatewayMetadata{}

	err = json.Unmarshal(data, &varVpnGatewayMetadata)

	if err != nil {
		return err
	}

	*o = VpnGatewayMetadata(varVpnGatewayMetadata)
...
type NullableVpnGatewayMetadata struct {
	value *VpnGatewayMetadata
	isSet bool
}

func (v NullableVpnGatewayMetadata) Get() *VpnGatewayMetadata {
	return v.value
}

func (v *NullableVpnGatewayMetadata) Set(val *VpnGatewayMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayMetadata(val *VpnGatewayMetadata) *NullableVpnGatewayMetadata {
	return &NullableVpnGatewayMetadata{value: val, isSet: true}
}

func (v NullableVpnGatewayMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
