...
// checks if the AwsVmReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVmReference{}

// AwsVmReference The reference to a aws_vm
type AwsVmReference struct {
	// The kind name
...
type _AwsVmReference AwsVmReference
...
func (o AwsVmReference) MarshalJSON() ([]byte, error) {
...
func (o AwsVmReference) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVmReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVmReference := _AwsVmReference{}

	err = json.Unmarshal(data, &varAwsVmReference)

	if err != nil {
		return err
	}

	*o = AwsVmReference(varAwsVmReference)
...
type NullableAwsVmReference struct {
	value *AwsVmReference
	isSet bool
}

func (v NullableAwsVmReference) Get() *AwsVmReference {
	return v.value
}

func (v *NullableAwsVmReference) Set(val *AwsVmReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVmReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVmReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVmReference(val *AwsVmReference) *NullableAwsVmReference {
	return &NullableAwsVmReference{value: val, isSet: true}
}

func (v NullableAwsVmReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVmReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
