...
// checks if the DockerRegistryStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryStatus{}

// DockerRegistryStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _DockerRegistryStatus DockerRegistryStatus
...
func (o DockerRegistryStatus) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryStatus) UnmarshalJSON(data []byte) (err error) {
	varDockerRegistryStatus := _DockerRegistryStatus{}

	err = json.Unmarshal(data, &varDockerRegistryStatus)

	if err != nil {
		return err
	}

	*o = DockerRegistryStatus(varDockerRegistryStatus)
...
type NullableDockerRegistryStatus struct {
	value *DockerRegistryStatus
	isSet bool
}

func (v NullableDockerRegistryStatus) Get() *DockerRegistryStatus {
	return v.value
}

func (v *NullableDockerRegistryStatus) Set(val *DockerRegistryStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryStatus(val *DockerRegistryStatus) *NullableDockerRegistryStatus {
	return &NullableDockerRegistryStatus{value: val, isSet: true}
}

func (v NullableDockerRegistryStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
