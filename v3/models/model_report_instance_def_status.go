...
// checks if the ReportInstanceDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstanceDefStatus{}

// ReportInstanceDefStatus Report instance creation/modification spec.
type ReportInstanceDefStatus struct {
	// The state of the cluster entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	// Report instance name.
	Name string `json:"name"`
	Resources ReportInstance1 `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _ReportInstanceDefStatus ReportInstanceDefStatus
...
func (o ReportInstanceDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ReportInstanceDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ReportInstanceDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varReportInstanceDefStatus := _ReportInstanceDefStatus{}

	err = json.Unmarshal(data, &varReportInstanceDefStatus)

	if err != nil {
		return err
	}

	*o = ReportInstanceDefStatus(varReportInstanceDefStatus)
...
type NullableReportInstanceDefStatus struct {
	value *ReportInstanceDefStatus
	isSet bool
}

func (v NullableReportInstanceDefStatus) Get() *ReportInstanceDefStatus {
	return v.value
}

func (v *NullableReportInstanceDefStatus) Set(val *ReportInstanceDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstanceDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstanceDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstanceDefStatus(val *ReportInstanceDefStatus) *NullableReportInstanceDefStatus {
	return &NullableReportInstanceDefStatus{value: val, isSet: true}
}

func (v NullableReportInstanceDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstanceDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
