...
// checks if the VpcIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcIntentResponse{}

// VpcIntentResponse Response object for intentful operations on a vpc
...
type _VpcIntentResponse VpcIntentResponse
...
func (o VpcIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VpcIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VpcIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVpcIntentResponse := _VpcIntentResponse{}

	err = json.Unmarshal(data, &varVpcIntentResponse)

	if err != nil {
		return err
	}

	*o = VpcIntentResponse(varVpcIntentResponse)
...
type NullableVpcIntentResponse struct {
	value *VpcIntentResponse
	isSet bool
}

func (v NullableVpcIntentResponse) Get() *VpcIntentResponse {
	return v.value
}

func (v *NullableVpcIntentResponse) Set(val *VpcIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcIntentResponse(val *VpcIntentResponse) *NullableVpcIntentResponse {
	return &NullableVpcIntentResponse{value: val, isSet: true}
}

func (v NullableVpcIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
