...
// checks if the ActionRuleResultIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResultIntentResource{}

// ActionRuleResultIntentResource Response object for intentful operations on a action_rule_result
type ActionRuleResultIntentResource struct {
	Status *ActionRuleResultDefStatus `json:"status,omitempty"`
	Spec *ActionRuleResult `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata ActionRuleResultMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ActionRuleResultIntentResource ActionRuleResultIntentResource
...
func NewActionRuleResultIntentResource(metadata ActionRuleResultMetadata) *ActionRuleResultIntentResource {
	this := ActionRuleResultIntentResource{}
...
func (o *ActionRuleResultIntentResource) GetStatus() ActionRuleResultDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret ActionRuleResultDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ActionRuleResultDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given ActionRuleResult and assigns it to the Spec field.
...
func (o *ActionRuleResultIntentResource) GetMetadata() ActionRuleResultMetadata {
	if o == nil {
		var ret ActionRuleResultMetadata
		return ret
	}
...
func (o ActionRuleResultIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResultIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleResultIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleResultIntentResource := _ActionRuleResultIntentResource{}

	err = json.Unmarshal(data, &varActionRuleResultIntentResource)

	if err != nil {
		return err
	}

	*o = ActionRuleResultIntentResource(varActionRuleResultIntentResource)
...
type NullableActionRuleResultIntentResource struct {
	value *ActionRuleResultIntentResource
	isSet bool
}

func (v NullableActionRuleResultIntentResource) Get() *ActionRuleResultIntentResource {
	return v.value
}

func (v *NullableActionRuleResultIntentResource) Set(val *ActionRuleResultIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResultIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResultIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResultIntentResource(val *ActionRuleResultIntentResource) *NullableActionRuleResultIntentResource {
	return &NullableActionRuleResultIntentResource{value: val, isSet: true}
}

func (v NullableActionRuleResultIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResultIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
