...
// checks if the AppPublishedServiceReferenceUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPublishedServiceReferenceUpload{}

// AppPublishedServiceReferenceUpload The reference to a app_published_service
type AppPublishedServiceReferenceUpload struct {
	// The kind name
...
type _AppPublishedServiceReferenceUpload AppPublishedServiceReferenceUpload
...
func NewAppPublishedServiceReferenceUpload(kind string, name string) *AppPublishedServiceReferenceUpload {
	this := AppPublishedServiceReferenceUpload{}
	this.Kind = kind
	this.Name = name
	return &this
}
...
func (o AppPublishedServiceReferenceUpload) MarshalJSON() ([]byte, error) {
...
func (o AppPublishedServiceReferenceUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppPublishedServiceReferenceUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPublishedServiceReferenceUpload := _AppPublishedServiceReferenceUpload{}

	err = json.Unmarshal(data, &varAppPublishedServiceReferenceUpload)

	if err != nil {
		return err
	}

	*o = AppPublishedServiceReferenceUpload(varAppPublishedServiceReferenceUpload)
...
type NullableAppPublishedServiceReferenceUpload struct {
	value *AppPublishedServiceReferenceUpload
	isSet bool
}

func (v NullableAppPublishedServiceReferenceUpload) Get() *AppPublishedServiceReferenceUpload {
	return v.value
}

func (v *NullableAppPublishedServiceReferenceUpload) Set(val *AppPublishedServiceReferenceUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPublishedServiceReferenceUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPublishedServiceReferenceUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPublishedServiceReferenceUpload(val *AppPublishedServiceReferenceUpload) *NullableAppPublishedServiceReferenceUpload {
	return &NullableAppPublishedServiceReferenceUpload{value: val, isSet: true}
}

func (v NullableAppPublishedServiceReferenceUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPublishedServiceReferenceUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
