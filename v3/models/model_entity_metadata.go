...
// checks if the EntityMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntityMetadata{}

// EntityMetadata Entity metadata object definition.
type EntityMetadata struct {
	// Cluster uuid on which the entity is present.
...
type _EntityMetadata EntityMetadata
...
func (o EntityMetadata) MarshalJSON() ([]byte, error) {
...
func (o EntityMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *EntityMetadata) UnmarshalJSON(data []byte) (err error) {
	varEntityMetadata := _EntityMetadata{}

	err = json.Unmarshal(data, &varEntityMetadata)

	if err != nil {
		return err
	}

	*o = EntityMetadata(varEntityMetadata)
...
type NullableEntityMetadata struct {
	value *EntityMetadata
	isSet bool
}

func (v NullableEntityMetadata) Get() *EntityMetadata {
	return v.value
}

func (v *NullableEntityMetadata) Set(val *EntityMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableEntityMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableEntityMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntityMetadata(val *EntityMetadata) *NullableEntityMetadata {
	return &NullableEntityMetadata{value: val, isSet: true}
}

func (v NullableEntityMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntityMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
