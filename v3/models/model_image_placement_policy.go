...
// checks if the ImagePlacementPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicy{}

// ImagePlacementPolicy Image placement policy
type ImagePlacementPolicy struct {
	// Image placement policy name.
	Name string `json:"name"`
	Resources ImagePlacementPolicyResources `json:"resources"`
	// A description for Image placement policy.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ImagePlacementPolicy ImagePlacementPolicy
...
func (o *ImagePlacementPolicy) GetResources() ImagePlacementPolicyResources {
	if o == nil {
		var ret ImagePlacementPolicyResources
		return ret
	}
...
func (o ImagePlacementPolicy) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varImagePlacementPolicy := _ImagePlacementPolicy{}

	err = json.Unmarshal(data, &varImagePlacementPolicy)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicy(varImagePlacementPolicy)
...
type NullableImagePlacementPolicy struct {
	value *ImagePlacementPolicy
	isSet bool
}

func (v NullableImagePlacementPolicy) Get() *ImagePlacementPolicy {
	return v.value
}

func (v *NullableImagePlacementPolicy) Set(val *ImagePlacementPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicy(val *ImagePlacementPolicy) *NullableImagePlacementPolicy {
	return &NullableImagePlacementPolicy{value: val, isSet: true}
}

func (v NullableImagePlacementPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
