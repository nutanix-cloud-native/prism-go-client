...
// checks if the AwsKeyPairStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsKeyPairStatus{}

// AwsKeyPairStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _AwsKeyPairStatus AwsKeyPairStatus
...
func (o AwsKeyPairStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsKeyPairStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsKeyPairStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsKeyPairStatus := _AwsKeyPairStatus{}

	err = json.Unmarshal(data, &varAwsKeyPairStatus)

	if err != nil {
		return err
	}

	*o = AwsKeyPairStatus(varAwsKeyPairStatus)
...
type NullableAwsKeyPairStatus struct {
	value *AwsKeyPairStatus
	isSet bool
}

func (v NullableAwsKeyPairStatus) Get() *AwsKeyPairStatus {
	return v.value
}

func (v *NullableAwsKeyPairStatus) Set(val *AwsKeyPairStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsKeyPairStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsKeyPairStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsKeyPairStatus(val *AwsKeyPairStatus) *NullableAwsKeyPairStatus {
	return &NullableAwsKeyPairStatus{value: val, isSet: true}
}

func (v NullableAwsKeyPairStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsKeyPairStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
