...
// checks if the AppSubstrateReferenceUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSubstrateReferenceUpload{}

// AppSubstrateReferenceUpload The reference to a app_substrate
type AppSubstrateReferenceUpload struct {
	// The kind name
...
type _AppSubstrateReferenceUpload AppSubstrateReferenceUpload
...
func NewAppSubstrateReferenceUpload(kind string, name string) *AppSubstrateReferenceUpload {
	this := AppSubstrateReferenceUpload{}
	this.Kind = kind
	this.Name = name
	return &this
}
...
func (o AppSubstrateReferenceUpload) MarshalJSON() ([]byte, error) {
...
func (o AppSubstrateReferenceUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppSubstrateReferenceUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppSubstrateReferenceUpload := _AppSubstrateReferenceUpload{}

	err = json.Unmarshal(data, &varAppSubstrateReferenceUpload)

	if err != nil {
		return err
	}

	*o = AppSubstrateReferenceUpload(varAppSubstrateReferenceUpload)
...
type NullableAppSubstrateReferenceUpload struct {
	value *AppSubstrateReferenceUpload
	isSet bool
}

func (v NullableAppSubstrateReferenceUpload) Get() *AppSubstrateReferenceUpload {
	return v.value
}

func (v *NullableAppSubstrateReferenceUpload) Set(val *AppSubstrateReferenceUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppSubstrateReferenceUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppSubstrateReferenceUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppSubstrateReferenceUpload(val *AppSubstrateReferenceUpload) *NullableAppSubstrateReferenceUpload {
	return &NullableAppSubstrateReferenceUpload{value: val, isSet: true}
}

func (v NullableAppSubstrateReferenceUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppSubstrateReferenceUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
