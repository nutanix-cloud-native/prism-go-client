...
// checks if the VirtualNetworkMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkMetadata{}

// VirtualNetworkMetadata The virtual_network kind metadata
type VirtualNetworkMetadata struct {
	...
	// Categories for the virtual_network. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the virtual_network. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _VirtualNetworkMetadata VirtualNetworkMetadata
...
func (o VirtualNetworkMetadata) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualNetworkMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualNetworkMetadata := _VirtualNetworkMetadata{}

	err = json.Unmarshal(data, &varVirtualNetworkMetadata)

	if err != nil {
		return err
	}

	*o = VirtualNetworkMetadata(varVirtualNetworkMetadata)
...
type NullableVirtualNetworkMetadata struct {
	value *VirtualNetworkMetadata
	isSet bool
}

func (v NullableVirtualNetworkMetadata) Get() *VirtualNetworkMetadata {
	return v.value
}

func (v *NullableVirtualNetworkMetadata) Set(val *VirtualNetworkMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkMetadata(val *VirtualNetworkMetadata) *NullableVirtualNetworkMetadata {
	return &NullableVirtualNetworkMetadata{value: val, isSet: true}
}

func (v NullableVirtualNetworkMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
