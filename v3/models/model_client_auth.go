...
func (o *ClientAuth) UnmarshalJSON(data []byte) (err error) {
	...
	varClientAuth := _ClientAuth{}

	err = json.Unmarshal(data, &varClientAuth)

	if err != nil {
		return err
	}

	*o = ClientAuth(varClientAuth)
