...
type QueryRequest struct {
	...
	GroupMemberAttributes []GroupRequestedAttribute `json:"group_member_attributes,omitempty"`
...
func (o *QueryRequest) GetGroupMemberAttributes() []GroupRequestedAttribute {
	if o == nil || IsNil(o.GroupMemberAttributes) {
		var ret []GroupRequestedAttribute
		return ret
	}
...
// SetGroupMemberAttributes gets a reference to the given []GroupRequestedAttribute and assigns it to the GroupMemberAttributes field.
...
func (o *QueryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varQueryRequest)
