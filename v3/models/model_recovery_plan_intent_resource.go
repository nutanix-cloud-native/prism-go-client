...
// checks if the RecoveryPlanIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanIntentResource{}

// RecoveryPlanIntentResource Response object for intentful operations on a recovery_plan
...
type _RecoveryPlanIntentResource RecoveryPlanIntentResource
...
func NewRecoveryPlanIntentResource(metadata RecoveryPlanMetadata) *RecoveryPlanIntentResource {
	this := RecoveryPlanIntentResource{}
...
// SetStatus gets a reference to the given RecoveryPlanDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given RecoveryPlan and assigns it to the Spec field.
...
func (o RecoveryPlanIntentResource) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanIntentResource := _RecoveryPlanIntentResource{}

	err = json.Unmarshal(data, &varRecoveryPlanIntentResource)

	if err != nil {
		return err
	}

	*o = RecoveryPlanIntentResource(varRecoveryPlanIntentResource)
...
type NullableRecoveryPlanIntentResource struct {
	value *RecoveryPlanIntentResource
	isSet bool
}

func (v NullableRecoveryPlanIntentResource) Get() *RecoveryPlanIntentResource {
	return v.value
}

func (v *NullableRecoveryPlanIntentResource) Set(val *RecoveryPlanIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanIntentResource(val *RecoveryPlanIntentResource) *NullableRecoveryPlanIntentResource {
	return &NullableRecoveryPlanIntentResource{value: val, isSet: true}
}

func (v NullableRecoveryPlanIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
