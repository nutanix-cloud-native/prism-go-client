...
// checks if the RackableUnitIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackableUnitIntentInput{}

// RackableUnitIntentInput An intentful representation of a rackable_unit
type RackableUnitIntentInput struct {
	Spec RackableUnit `json:"spec"`
...
type _RackableUnitIntentInput RackableUnitIntentInput
...
func (o RackableUnitIntentInput) MarshalJSON() ([]byte, error) {
...
func (o RackableUnitIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *RackableUnitIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varRackableUnitIntentInput := _RackableUnitIntentInput{}

	err = json.Unmarshal(data, &varRackableUnitIntentInput)

	if err != nil {
		return err
	}

	*o = RackableUnitIntentInput(varRackableUnitIntentInput)
...
type NullableRackableUnitIntentInput struct {
	value *RackableUnitIntentInput
	isSet bool
}

func (v NullableRackableUnitIntentInput) Get() *RackableUnitIntentInput {
	return v.value
}

func (v *NullableRackableUnitIntentInput) Set(val *RackableUnitIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableRackableUnitIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableRackableUnitIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackableUnitIntentInput(val *RackableUnitIntentInput) *NullableRackableUnitIntentInput {
	return &NullableRackableUnitIntentInput{value: val, isSet: true}
}

func (v NullableRackableUnitIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackableUnitIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
