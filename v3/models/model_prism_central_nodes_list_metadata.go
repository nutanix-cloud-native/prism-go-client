...
// checks if the PrismCentralNodesListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralNodesListMetadata{}

// PrismCentralNodesListMetadata All api calls that return a list will have this metadata block as input 
type PrismCentralNodesListMetadata struct {
	// The kind name
...
type _PrismCentralNodesListMetadata PrismCentralNodesListMetadata
...
func NewPrismCentralNodesListMetadata() *PrismCentralNodesListMetadata {
	this := PrismCentralNodesListMetadata{}
...
func (o PrismCentralNodesListMetadata) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralNodesListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *PrismCentralNodesListMetadata) UnmarshalJSON(data []byte) (err error) {
	varPrismCentralNodesListMetadata := _PrismCentralNodesListMetadata{}

	err = json.Unmarshal(data, &varPrismCentralNodesListMetadata)

	if err != nil {
		return err
	}

	*o = PrismCentralNodesListMetadata(varPrismCentralNodesListMetadata)
...
type NullablePrismCentralNodesListMetadata struct {
	value *PrismCentralNodesListMetadata
	isSet bool
}

func (v NullablePrismCentralNodesListMetadata) Get() *PrismCentralNodesListMetadata {
	return v.value
}

func (v *NullablePrismCentralNodesListMetadata) Set(val *PrismCentralNodesListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralNodesListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralNodesListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralNodesListMetadata(val *PrismCentralNodesListMetadata) *NullablePrismCentralNodesListMetadata {
	return &NullablePrismCentralNodesListMetadata{value: val, isSet: true}
}

func (v NullablePrismCentralNodesListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralNodesListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
