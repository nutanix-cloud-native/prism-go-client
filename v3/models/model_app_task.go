...
// checks if the AppTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTask{}

// AppTask An intentful representation of a app_task spec
type AppTask struct {
	// app_task Name.
...
func (o AppTask) MarshalJSON() ([]byte, error) {
...
func (o AppTask) ToMap() (map[string]interface{}, error) {
...
func (o *AppTask) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAppTask)

	if err != nil {
		return err
	}

	*o = AppTask(varAppTask)
...
type NullableAppTask struct {
	value *AppTask
	isSet bool
}

func (v NullableAppTask) Get() *AppTask {
	return v.value
}

func (v *NullableAppTask) Set(val *AppTask) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTask) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTask(val *AppTask) *NullableAppTask {
	return &NullableAppTask{value: val, isSet: true}
}

func (v NullableAppTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
