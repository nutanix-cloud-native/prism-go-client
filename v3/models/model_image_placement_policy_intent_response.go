...
// checks if the ImagePlacementPolicyIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyIntentResponse{}

// ImagePlacementPolicyIntentResponse Response object for intentful operations on a image_placement_policy
type ImagePlacementPolicyIntentResponse struct {
...
type _ImagePlacementPolicyIntentResponse ImagePlacementPolicyIntentResponse
...
func NewImagePlacementPolicyIntentResponse(apiVersion string, metadata ImagePlacementPolicyMetadata) *ImagePlacementPolicyIntentResponse {
	this := ImagePlacementPolicyIntentResponse{}
...
func (o ImagePlacementPolicyIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicyIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varImagePlacementPolicyIntentResponse := _ImagePlacementPolicyIntentResponse{}

	err = json.Unmarshal(data, &varImagePlacementPolicyIntentResponse)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyIntentResponse(varImagePlacementPolicyIntentResponse)
...
type NullableImagePlacementPolicyIntentResponse struct {
	value *ImagePlacementPolicyIntentResponse
	isSet bool
}

func (v NullableImagePlacementPolicyIntentResponse) Get() *ImagePlacementPolicyIntentResponse {
	return v.value
}

func (v *NullableImagePlacementPolicyIntentResponse) Set(val *ImagePlacementPolicyIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyIntentResponse(val *ImagePlacementPolicyIntentResponse) *NullableImagePlacementPolicyIntentResponse {
	return &NullableImagePlacementPolicyIntentResponse{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
