...
// checks if the RackIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackIntentResource{}

// RackIntentResource Response object for intentful operations on a rack
type RackIntentResource struct {
	Status *RackDefStatus `json:"status,omitempty"`
	Spec *Rack `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata RackMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RackIntentResource RackIntentResource
...
// SetStatus gets a reference to the given RackDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Rack and assigns it to the Spec field.
...
func (o RackIntentResource) MarshalJSON() ([]byte, error) {
...
func (o RackIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *RackIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varRackIntentResource := _RackIntentResource{}

	err = json.Unmarshal(data, &varRackIntentResource)

	if err != nil {
		return err
	}

	*o = RackIntentResource(varRackIntentResource)
...
type NullableRackIntentResource struct {
	value *RackIntentResource
	isSet bool
}

func (v NullableRackIntentResource) Get() *RackIntentResource {
	return v.value
}

func (v *NullableRackIntentResource) Set(val *RackIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableRackIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableRackIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackIntentResource(val *RackIntentResource) *NullableRackIntentResource {
	return &NullableRackIntentResource{value: val, isSet: true}
}

func (v NullableRackIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
