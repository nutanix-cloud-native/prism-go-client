...
// checks if the VpnGatewayIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayIntentResponse{}

// VpnGatewayIntentResponse Response object for intentful operations on a vpn_gateway
type VpnGatewayIntentResponse struct {
...
type _VpnGatewayIntentResponse VpnGatewayIntentResponse
...
func (o VpnGatewayIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VpnGatewayIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnGatewayIntentResponse := _VpnGatewayIntentResponse{}

	err = json.Unmarshal(data, &varVpnGatewayIntentResponse)

	if err != nil {
		return err
	}

	*o = VpnGatewayIntentResponse(varVpnGatewayIntentResponse)
...
type NullableVpnGatewayIntentResponse struct {
	value *VpnGatewayIntentResponse
	isSet bool
}

func (v NullableVpnGatewayIntentResponse) Get() *VpnGatewayIntentResponse {
	return v.value
}

func (v *NullableVpnGatewayIntentResponse) Set(val *VpnGatewayIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayIntentResponse(val *VpnGatewayIntentResponse) *NullableVpnGatewayIntentResponse {
	return &NullableVpnGatewayIntentResponse{value: val, isSet: true}
}

func (v NullableVpnGatewayIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
