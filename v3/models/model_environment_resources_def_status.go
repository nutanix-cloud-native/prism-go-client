...
// checks if the EnvironmentResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentResourcesDefStatus{}

// EnvironmentResourcesDefStatus Status of the environment
type EnvironmentResourcesDefStatus struct {
	ProjectReference *ProjectReference `json:"project_reference,omitempty"`
	// Substrate definitions for Environment.
	...
	// Credential definitions for Environment.
	CredentialDefinitionList []AppCredentialResponse `json:"credential_definition_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _EnvironmentResourcesDefStatus EnvironmentResourcesDefStatus
...
func NewEnvironmentResourcesDefStatus() *EnvironmentResourcesDefStatus {
	this := EnvironmentResourcesDefStatus{}
	return &this
}
...
func (o EnvironmentResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentResourcesDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *EnvironmentResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varEnvironmentResourcesDefStatus := _EnvironmentResourcesDefStatus{}

	err = json.Unmarshal(data, &varEnvironmentResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = EnvironmentResourcesDefStatus(varEnvironmentResourcesDefStatus)
...
type NullableEnvironmentResourcesDefStatus struct {
	value *EnvironmentResourcesDefStatus
	isSet bool
}

func (v NullableEnvironmentResourcesDefStatus) Get() *EnvironmentResourcesDefStatus {
	return v.value
}

func (v *NullableEnvironmentResourcesDefStatus) Set(val *EnvironmentResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentResourcesDefStatus(val *EnvironmentResourcesDefStatus) *NullableEnvironmentResourcesDefStatus {
	return &NullableEnvironmentResourcesDefStatus{value: val, isSet: true}
}

func (v NullableEnvironmentResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
