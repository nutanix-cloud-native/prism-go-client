...
// checks if the CategoryKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryKey{}

// CategoryKey Category key definition.
...
func (o CategoryKey) MarshalJSON() ([]byte, error) {
...
func (o CategoryKey) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryKey) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryKey := _CategoryKey{}

	err = json.Unmarshal(data, &varCategoryKey)

	if err != nil {
		return err
	}

	*o = CategoryKey(varCategoryKey)
...
type NullableCategoryKey struct {
	value *CategoryKey
	isSet bool
}

func (v NullableCategoryKey) Get() *CategoryKey {
	return v.value
}

func (v *NullableCategoryKey) Set(val *CategoryKey) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryKey) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryKey(val *CategoryKey) *NullableCategoryKey {
	return &NullableCategoryKey{value: val, isSet: true}
}

func (v NullableCategoryKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
