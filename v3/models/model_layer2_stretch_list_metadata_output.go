...
// checks if the Layer2StretchListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchListMetadataOutput{}

// Layer2StretchListMetadataOutput All api calls that return a list will have this metadata block 
type Layer2StretchListMetadataOutput struct {
	// The kind name
...
type _Layer2StretchListMetadataOutput Layer2StretchListMetadataOutput
...
func NewLayer2StretchListMetadataOutput() *Layer2StretchListMetadataOutput {
	this := Layer2StretchListMetadataOutput{}
	var kind string = "layer2_stretch"
	this.Kind = &kind
	return &this
}
...
func (o Layer2StretchListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varLayer2StretchListMetadataOutput := _Layer2StretchListMetadataOutput{}

	err = json.Unmarshal(data, &varLayer2StretchListMetadataOutput)

	if err != nil {
		return err
	}

	*o = Layer2StretchListMetadataOutput(varLayer2StretchListMetadataOutput)
...
type NullableLayer2StretchListMetadataOutput struct {
	value *Layer2StretchListMetadataOutput
	isSet bool
}

func (v NullableLayer2StretchListMetadataOutput) Get() *Layer2StretchListMetadataOutput {
	return v.value
}

func (v *NullableLayer2StretchListMetadataOutput) Set(val *Layer2StretchListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchListMetadataOutput(val *Layer2StretchListMetadataOutput) *NullableLayer2StretchListMetadataOutput {
	return &NullableLayer2StretchListMetadataOutput{value: val, isSet: true}
}

func (v NullableLayer2StretchListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
