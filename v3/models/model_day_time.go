...
// checks if the DayTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DayTime{}

// DayTime Day and Time at which NGT policy should be triggered.
type DayTime struct {
	// Day of week the policy has to take effect.
...
func (o DayTime) MarshalJSON() ([]byte, error) {
...
func (o DayTime) ToMap() (map[string]interface{}, error) {
...
func (o *DayTime) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varDayTime)

	if err != nil {
		return err
	}

	*o = DayTime(varDayTime)
...
type NullableDayTime struct {
	value *DayTime
	isSet bool
}

func (v NullableDayTime) Get() *DayTime {
	return v.value
}

func (v *NullableDayTime) Set(val *DayTime) {
	v.value = val
	v.isSet = true
}

func (v NullableDayTime) IsSet() bool {
	return v.isSet
}

func (v *NullableDayTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDayTime(val *DayTime) *NullableDayTime {
	return &NullableDayTime{value: val, isSet: true}
}

func (v NullableDayTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDayTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
