...
// checks if the AwsSecurityGroupDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSecurityGroupDefStatus{}

// AwsSecurityGroupDefStatus aws_security_group resources status
type AwsSecurityGroupDefStatus struct {
	State *string `json:"state,omitempty"`
	// aws_security_group name.
	Name *string `json:"name,omitempty"`
	Resources *AwsSecurityGroupResourcesDefStatus `json:"resources,omitempty"`
	// A description for aws_security_group.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsSecurityGroupDefStatus AwsSecurityGroupDefStatus
...
func NewAwsSecurityGroupDefStatus() *AwsSecurityGroupDefStatus {
	this := AwsSecurityGroupDefStatus{}
	return &this
}
...
func (o *AwsSecurityGroupDefStatus) GetResources() AwsSecurityGroupResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret AwsSecurityGroupResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given AwsSecurityGroupResourcesDefStatus and assigns it to the Resources field.
...
func (o AwsSecurityGroupDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsSecurityGroupDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSecurityGroupDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsSecurityGroupDefStatus := _AwsSecurityGroupDefStatus{}

	err = json.Unmarshal(data, &varAwsSecurityGroupDefStatus)

	if err != nil {
		return err
	}

	*o = AwsSecurityGroupDefStatus(varAwsSecurityGroupDefStatus)
...
type NullableAwsSecurityGroupDefStatus struct {
	value *AwsSecurityGroupDefStatus
	isSet bool
}

func (v NullableAwsSecurityGroupDefStatus) Get() *AwsSecurityGroupDefStatus {
	return v.value
}

func (v *NullableAwsSecurityGroupDefStatus) Set(val *AwsSecurityGroupDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSecurityGroupDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSecurityGroupDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSecurityGroupDefStatus(val *AwsSecurityGroupDefStatus) *NullableAwsSecurityGroupDefStatus {
	return &NullableAwsSecurityGroupDefStatus{value: val, isSet: true}
}

func (v NullableAwsSecurityGroupDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSecurityGroupDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
