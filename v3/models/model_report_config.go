...
// checks if the ReportConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfig{}

// ReportConfig Report Config creation/modification spec.
type ReportConfig struct {
	// Name of the report config.
	Name string `json:"name"`
	Resources ReportConfigResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _ReportConfig ReportConfig
...
func (o ReportConfig) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varReportConfig := _ReportConfig{}

	err = json.Unmarshal(data, &varReportConfig)

	if err != nil {
		return err
	}

	*o = ReportConfig(varReportConfig)
