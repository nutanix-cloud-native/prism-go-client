...
// checks if the VpnConnectionMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionMetadata{}

// VpnConnectionMetadata The vpn_connection kind metadata
...
type _VpnConnectionMetadata VpnConnectionMetadata
...
func (o VpnConnectionMetadata) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnectionMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnConnectionMetadata := _VpnConnectionMetadata{}

	err = json.Unmarshal(data, &varVpnConnectionMetadata)

	if err != nil {
		return err
	}

	*o = VpnConnectionMetadata(varVpnConnectionMetadata)
...
type NullableVpnConnectionMetadata struct {
	value *VpnConnectionMetadata
	isSet bool
}

func (v NullableVpnConnectionMetadata) Get() *VpnConnectionMetadata {
	return v.value
}

func (v *NullableVpnConnectionMetadata) Set(val *VpnConnectionMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionMetadata(val *VpnConnectionMetadata) *NullableVpnConnectionMetadata {
	return &NullableVpnConnectionMetadata{value: val, isSet: true}
}

func (v NullableVpnConnectionMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
