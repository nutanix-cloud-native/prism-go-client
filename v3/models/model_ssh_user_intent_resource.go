...
// checks if the SshUserIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserIntentResource{}

// SshUserIntentResource Response object for intentful operations on a ssh_user
type SshUserIntentResource struct {
	Status *SshUserDefStatus `json:"status,omitempty"`
	Spec *SshUser `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata SshUserMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _SshUserIntentResource SshUserIntentResource
...
// SetStatus gets a reference to the given SshUserDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given SshUser and assigns it to the Spec field.
...
func (o SshUserIntentResource) MarshalJSON() ([]byte, error) {
...
func (o SshUserIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varSshUserIntentResource := _SshUserIntentResource{}

	err = json.Unmarshal(data, &varSshUserIntentResource)

	if err != nil {
		return err
	}

	*o = SshUserIntentResource(varSshUserIntentResource)
...
type NullableSshUserIntentResource struct {
	value *SshUserIntentResource
	isSet bool
}

func (v NullableSshUserIntentResource) Get() *SshUserIntentResource {
	return v.value
}

func (v *NullableSshUserIntentResource) Set(val *SshUserIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserIntentResource(val *SshUserIntentResource) *NullableSshUserIntentResource {
	return &NullableSshUserIntentResource{value: val, isSet: true}
}

func (v NullableSshUserIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
