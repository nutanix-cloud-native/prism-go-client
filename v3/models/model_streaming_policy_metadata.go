...
// checks if the StreamingPolicyMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyMetadata{}

// StreamingPolicyMetadata The streaming_policy kind metadata
type StreamingPolicyMetadata struct {
	...
	// Categories for the streaming_policy. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the streaming_policy. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// streaming_policy name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _StreamingPolicyMetadata StreamingPolicyMetadata
...
func (o StreamingPolicyMetadata) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicyMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varStreamingPolicyMetadata := _StreamingPolicyMetadata{}

	err = json.Unmarshal(data, &varStreamingPolicyMetadata)

	if err != nil {
		return err
	}

	*o = StreamingPolicyMetadata(varStreamingPolicyMetadata)
...
type NullableStreamingPolicyMetadata struct {
	value *StreamingPolicyMetadata
	isSet bool
}

func (v NullableStreamingPolicyMetadata) Get() *StreamingPolicyMetadata {
	return v.value
}

func (v *NullableStreamingPolicyMetadata) Set(val *StreamingPolicyMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyMetadata(val *StreamingPolicyMetadata) *NullableStreamingPolicyMetadata {
	return &NullableStreamingPolicyMetadata{value: val, isSet: true}
}

func (v NullableStreamingPolicyMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
