...
// checks if the ActionTriggerTypeReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTriggerTypeReference{}

// ActionTriggerTypeReference The reference to a action_trigger_type
type ActionTriggerTypeReference struct {
	// The kind name
...
type _ActionTriggerTypeReference ActionTriggerTypeReference
...
func NewActionTriggerTypeReference(kind string, uUID string) *ActionTriggerTypeReference {
	this := ActionTriggerTypeReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o ActionTriggerTypeReference) MarshalJSON() ([]byte, error) {
...
func (o ActionTriggerTypeReference) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTriggerTypeReference) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTriggerTypeReference := _ActionTriggerTypeReference{}

	err = json.Unmarshal(data, &varActionTriggerTypeReference)

	if err != nil {
		return err
	}

	*o = ActionTriggerTypeReference(varActionTriggerTypeReference)
...
type NullableActionTriggerTypeReference struct {
	value *ActionTriggerTypeReference
	isSet bool
}

func (v NullableActionTriggerTypeReference) Get() *ActionTriggerTypeReference {
	return v.value
}

func (v *NullableActionTriggerTypeReference) Set(val *ActionTriggerTypeReference) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTriggerTypeReference) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTriggerTypeReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTriggerTypeReference(val *ActionTriggerTypeReference) *NullableActionTriggerTypeReference {
	return &NullableActionTriggerTypeReference{value: val, isSet: true}
}

func (v NullableActionTriggerTypeReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTriggerTypeReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
