...
// checks if the NetworkSecurityRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRule{}

// NetworkSecurityRule Network security rule
type NetworkSecurityRule struct {
	Name string `json:"name"`
	Resources NetworkSecurityRuleResources `json:"resources"`
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NetworkSecurityRule NetworkSecurityRule
...
func (o *NetworkSecurityRule) GetResources() NetworkSecurityRuleResources {
	if o == nil {
		var ret NetworkSecurityRuleResources
		return ret
	}
...
func (o NetworkSecurityRule) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRule) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRule) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkSecurityRule := _NetworkSecurityRule{}

	err = json.Unmarshal(data, &varNetworkSecurityRule)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRule(varNetworkSecurityRule)
...
type NullableNetworkSecurityRule struct {
	value *NetworkSecurityRule
	isSet bool
}

func (v NullableNetworkSecurityRule) Get() *NetworkSecurityRule {
	return v.value
}

func (v *NullableNetworkSecurityRule) Set(val *NetworkSecurityRule) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRule) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRule(val *NetworkSecurityRule) *NullableNetworkSecurityRule {
	return &NullableNetworkSecurityRule{value: val, isSet: true}
}

func (v NullableNetworkSecurityRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
