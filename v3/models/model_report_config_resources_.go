...
// checks if the ReportConfigResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigResources{}

// ReportConfigResources Report config resources definition.
type ReportConfigResources struct {
	RetentionPolicy *RetentionPolicy `json:"retention_policy,omitempty"`
	// Description of the common report config.
	Description *string `json:"description,omitempty"`
	// End time for data collection during report generation.
	...
	// Start time for data collection during report generation.
...
type _ReportConfigResources ReportConfigResources
...
func (o ReportConfigResources) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigResources) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfigResources) UnmarshalJSON(data []byte) (err error) {
	...
	varReportConfigResources := _ReportConfigResources{}

	err = json.Unmarshal(data, &varReportConfigResources)

	if err != nil {
		return err
	}

	*o = ReportConfigResources(varReportConfigResources)
...
type NullableReportConfigResources struct {
	value *ReportConfigResources
	isSet bool
}

func (v NullableReportConfigResources) Get() *ReportConfigResources {
	return v.value
}

func (v *NullableReportConfigResources) Set(val *ReportConfigResources) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigResources) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigResources(val *ReportConfigResources) *NullableReportConfigResources {
	return &NullableReportConfigResources{value: val, isSet: true}
}

func (v NullableReportConfigResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
