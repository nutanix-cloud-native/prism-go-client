...
// checks if the AppPublishedServiceResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPublishedServiceResponseDownload{}

// AppPublishedServiceResponseDownload Published service definition
type AppPublishedServiceResponseDownload struct {
	...
	// 
	ElementList []AppPublishedServiceElement `json:"element_list,omitempty"`
	...
	ConfigReference *AppPublishedServiceReferenceUpload `json:"config_reference,omitempty"`
	// 
...
type _AppPublishedServiceResponseDownload AppPublishedServiceResponseDownload
...
func NewAppPublishedServiceResponseDownload(actionList []AppActionResponse, name string, state string, variableList []AppVariableResponse, uUID string) *AppPublishedServiceResponseDownload {
	this := AppPublishedServiceResponseDownload{}
	var singleton bool = false
	this.Singleton = &singleton
	this.ActionList = actionList
	var type_ string = "K8S_SERVICE"
	this.Type = &type_
	this.Name = name
	this.State = state
...
func (o *AppPublishedServiceResponseDownload) GetElementList() []AppPublishedServiceElement {
	if o == nil || IsNil(o.ElementList) {
		var ret []AppPublishedServiceElement
		return ret
	}
...
// SetElementList gets a reference to the given []AppPublishedServiceElement and assigns it to the ElementList field.
...
// SetConfigReference gets a reference to the given AppPublishedServiceReferenceUpload and assigns it to the ConfigReference field.
...
func (o AppPublishedServiceResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o AppPublishedServiceResponseDownload) ToMap() (map[string]interface{}, error) {
...
func (o *AppPublishedServiceResponseDownload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPublishedServiceResponseDownload := _AppPublishedServiceResponseDownload{}

	err = json.Unmarshal(data, &varAppPublishedServiceResponseDownload)

	if err != nil {
		return err
	}

	*o = AppPublishedServiceResponseDownload(varAppPublishedServiceResponseDownload)
...
type NullableAppPublishedServiceResponseDownload struct {
	value *AppPublishedServiceResponseDownload
	isSet bool
}

func (v NullableAppPublishedServiceResponseDownload) Get() *AppPublishedServiceResponseDownload {
	return v.value
}

func (v *NullableAppPublishedServiceResponseDownload) Set(val *AppPublishedServiceResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPublishedServiceResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPublishedServiceResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPublishedServiceResponseDownload(val *AppPublishedServiceResponseDownload) *NullableAppPublishedServiceResponseDownload {
	return &NullableAppPublishedServiceResponseDownload{value: val, isSet: true}
}

func (v NullableAppPublishedServiceResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPublishedServiceResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
