...
// checks if the AlertIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertIntentResponse{}

// AlertIntentResponse Response object for intentful operations on a alert
type AlertIntentResponse struct {
	Status *AlertDefStatus `json:"status,omitempty"`
	Spec *Alert `json:"spec,omitempty"`
...
type _AlertIntentResponse AlertIntentResponse
...
// SetSpec gets a reference to the given Alert and assigns it to the Spec field.
...
func (o AlertIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AlertIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AlertIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertIntentResponse := _AlertIntentResponse{}

	err = json.Unmarshal(data, &varAlertIntentResponse)

	if err != nil {
		return err
	}

	*o = AlertIntentResponse(varAlertIntentResponse)
...
type NullableAlertIntentResponse struct {
	value *AlertIntentResponse
	isSet bool
}

func (v NullableAlertIntentResponse) Get() *AlertIntentResponse {
	return v.value
}

func (v *NullableAlertIntentResponse) Set(val *AlertIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertIntentResponse(val *AlertIntentResponse) *NullableAlertIntentResponse {
	return &NullableAlertIntentResponse{value: val, isSet: true}
}

func (v NullableAlertIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
