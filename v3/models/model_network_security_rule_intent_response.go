...
// checks if the NetworkSecurityRuleIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleIntentResponse{}
...
type NetworkSecurityRuleIntentResponse struct {
	...
	Metadata NetworkSecurityRuleMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _NetworkSecurityRuleIntentResponse NetworkSecurityRuleIntentResponse
...
func NewNetworkSecurityRuleIntentResponse(apiVersion string, metadata NetworkSecurityRuleMetadata) *NetworkSecurityRuleIntentResponse {
	this := NetworkSecurityRuleIntentResponse{}
...
func (o *NetworkSecurityRuleIntentResponse) GetStatus() NetworkSecurityRuleDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret NetworkSecurityRuleDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given NetworkSecurityRuleDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given NetworkSecurityRule and assigns it to the Spec field.
...
func (o *NetworkSecurityRuleIntentResponse) GetMetadata() NetworkSecurityRuleMetadata {
	if o == nil {
		var ret NetworkSecurityRuleMetadata
		return ret
	}
...
func (o NetworkSecurityRuleIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRuleIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkSecurityRuleIntentResponse := _NetworkSecurityRuleIntentResponse{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleIntentResponse)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleIntentResponse(varNetworkSecurityRuleIntentResponse)
...
type NullableNetworkSecurityRuleIntentResponse struct {
	value *NetworkSecurityRuleIntentResponse
	isSet bool
}

func (v NullableNetworkSecurityRuleIntentResponse) Get() *NetworkSecurityRuleIntentResponse {
	return v.value
}

func (v *NullableNetworkSecurityRuleIntentResponse) Set(val *NetworkSecurityRuleIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleIntentResponse(val *NetworkSecurityRuleIntentResponse) *NullableNetworkSecurityRuleIntentResponse {
	return &NullableNetworkSecurityRuleIntentResponse{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
