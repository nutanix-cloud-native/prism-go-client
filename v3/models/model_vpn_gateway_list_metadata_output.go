...
// checks if the VpnGatewayListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayListMetadataOutput{}

// VpnGatewayListMetadataOutput All api calls that return a list will have this metadata block 
type VpnGatewayListMetadataOutput struct {
	// The kind name
...
type _VpnGatewayListMetadataOutput VpnGatewayListMetadataOutput
...
func NewVpnGatewayListMetadataOutput() *VpnGatewayListMetadataOutput {
	this := VpnGatewayListMetadataOutput{}
	var kind string = "vpn_gateway"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *VpnGatewayListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o VpnGatewayListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VpnGatewayListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVpnGatewayListMetadataOutput := _VpnGatewayListMetadataOutput{}

	err = json.Unmarshal(data, &varVpnGatewayListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VpnGatewayListMetadataOutput(varVpnGatewayListMetadataOutput)
...
type NullableVpnGatewayListMetadataOutput struct {
	value *VpnGatewayListMetadataOutput
	isSet bool
}

func (v NullableVpnGatewayListMetadataOutput) Get() *VpnGatewayListMetadataOutput {
	return v.value
}

func (v *NullableVpnGatewayListMetadataOutput) Set(val *VpnGatewayListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayListMetadataOutput(val *VpnGatewayListMetadataOutput) *NullableVpnGatewayListMetadataOutput {
	return &NullableVpnGatewayListMetadataOutput{value: val, isSet: true}
}

func (v NullableVpnGatewayListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
