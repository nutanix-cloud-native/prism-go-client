...
// checks if the ResourceDomainMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceDomainMetadata{}

// ResourceDomainMetadata The resource_domain kind metadata
type ResourceDomainMetadata struct {
	...
	// Categories for the resource_domain. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the resource_domain. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _ResourceDomainMetadata ResourceDomainMetadata
...
func (o *ResourceDomainMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *ResourceDomainMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *ResourceDomainMetadata) SetName(v string) {
	o.Name = &v
}

func (o ResourceDomainMetadata) MarshalJSON() ([]byte, error) {
...
func (o ResourceDomainMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceDomainMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varResourceDomainMetadata := _ResourceDomainMetadata{}

	err = json.Unmarshal(data, &varResourceDomainMetadata)

	if err != nil {
		return err
	}

	*o = ResourceDomainMetadata(varResourceDomainMetadata)
...
type NullableResourceDomainMetadata struct {
	value *ResourceDomainMetadata
	isSet bool
}

func (v NullableResourceDomainMetadata) Get() *ResourceDomainMetadata {
	return v.value
}

func (v *NullableResourceDomainMetadata) Set(val *ResourceDomainMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceDomainMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceDomainMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceDomainMetadata(val *ResourceDomainMetadata) *NullableResourceDomainMetadata {
	return &NullableResourceDomainMetadata{value: val, isSet: true}
}

func (v NullableResourceDomainMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceDomainMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
