...
// checks if the AwsVolumeTypeMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVolumeTypeMetadata{}

// AwsVolumeTypeMetadata The aws_volume_type kind metadata
type AwsVolumeTypeMetadata struct {
	// UTC date and time in RFC-3339 format when aws_volume_type was last updated 
	LastUpdateTime *time.Time `json:"last_update_time,omitempty"`
	// The kind name
	Kind string `json:"kind"`
	// aws_volume_type uuid
	...
	// Categories for the aws_volume_type
	Categories *map[string]string `json:"categories,omitempty"`
	// aws_volume_type name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsVolumeTypeMetadata AwsVolumeTypeMetadata
...
func (o AwsVolumeTypeMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsVolumeTypeMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVolumeTypeMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVolumeTypeMetadata := _AwsVolumeTypeMetadata{}

	err = json.Unmarshal(data, &varAwsVolumeTypeMetadata)

	if err != nil {
		return err
	}

	*o = AwsVolumeTypeMetadata(varAwsVolumeTypeMetadata)
...
type NullableAwsVolumeTypeMetadata struct {
	value *AwsVolumeTypeMetadata
	isSet bool
}

func (v NullableAwsVolumeTypeMetadata) Get() *AwsVolumeTypeMetadata {
	return v.value
}

func (v *NullableAwsVolumeTypeMetadata) Set(val *AwsVolumeTypeMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVolumeTypeMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVolumeTypeMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVolumeTypeMetadata(val *AwsVolumeTypeMetadata) *NullableAwsVolumeTypeMetadata {
	return &NullableAwsVolumeTypeMetadata{value: val, isSet: true}
}

func (v NullableAwsVolumeTypeMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVolumeTypeMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
