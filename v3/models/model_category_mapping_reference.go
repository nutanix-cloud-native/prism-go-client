...
// checks if the CategoryMappingReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingReference{}

// CategoryMappingReference The reference to a category_mapping
type CategoryMappingReference struct {
	// The kind name
...
type _CategoryMappingReference CategoryMappingReference
...
func (o CategoryMappingReference) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingReference) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingReference) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryMappingReference := _CategoryMappingReference{}

	err = json.Unmarshal(data, &varCategoryMappingReference)

	if err != nil {
		return err
	}

	*o = CategoryMappingReference(varCategoryMappingReference)
...
type NullableCategoryMappingReference struct {
	value *CategoryMappingReference
	isSet bool
}

func (v NullableCategoryMappingReference) Get() *CategoryMappingReference {
	return v.value
}

func (v *NullableCategoryMappingReference) Set(val *CategoryMappingReference) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingReference) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingReference(val *CategoryMappingReference) *NullableCategoryMappingReference {
	return &NullableCategoryMappingReference{value: val, isSet: true}
}

func (v NullableCategoryMappingReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
