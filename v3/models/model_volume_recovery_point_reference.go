...
// checks if the VolumeRecoveryPointReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeRecoveryPointReference{}

// VolumeRecoveryPointReference The reference to a volume_recovery_point
type VolumeRecoveryPointReference struct {
	// The kind name
...
type _VolumeRecoveryPointReference VolumeRecoveryPointReference
...
func NewVolumeRecoveryPointReference(kind string, uUID string) *VolumeRecoveryPointReference {
	this := VolumeRecoveryPointReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o VolumeRecoveryPointReference) MarshalJSON() ([]byte, error) {
...
func (o VolumeRecoveryPointReference) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeRecoveryPointReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumeRecoveryPointReference := _VolumeRecoveryPointReference{}

	err = json.Unmarshal(data, &varVolumeRecoveryPointReference)

	if err != nil {
		return err
	}

	*o = VolumeRecoveryPointReference(varVolumeRecoveryPointReference)
...
type NullableVolumeRecoveryPointReference struct {
	value *VolumeRecoveryPointReference
	isSet bool
}

func (v NullableVolumeRecoveryPointReference) Get() *VolumeRecoveryPointReference {
	return v.value
}

func (v *NullableVolumeRecoveryPointReference) Set(val *VolumeRecoveryPointReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeRecoveryPointReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeRecoveryPointReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeRecoveryPointReference(val *VolumeRecoveryPointReference) *NullableVolumeRecoveryPointReference {
	return &NullableVolumeRecoveryPointReference{value: val, isSet: true}
}

func (v NullableVolumeRecoveryPointReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeRecoveryPointReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
