...
// checks if the RackableUnitListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackableUnitListMetadata{}

// RackableUnitListMetadata All api calls that return a list will have this metadata block as input 
type RackableUnitListMetadata struct {
	// The kind name
...
type _RackableUnitListMetadata RackableUnitListMetadata
...
func (o RackableUnitListMetadata) MarshalJSON() ([]byte, error) {
...
func (o RackableUnitListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RackableUnitListMetadata) UnmarshalJSON(data []byte) (err error) {
	varRackableUnitListMetadata := _RackableUnitListMetadata{}

	err = json.Unmarshal(data, &varRackableUnitListMetadata)

	if err != nil {
		return err
	}

	*o = RackableUnitListMetadata(varRackableUnitListMetadata)
...
type NullableRackableUnitListMetadata struct {
	value *RackableUnitListMetadata
	isSet bool
}

func (v NullableRackableUnitListMetadata) Get() *RackableUnitListMetadata {
	return v.value
}

func (v *NullableRackableUnitListMetadata) Set(val *RackableUnitListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRackableUnitListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRackableUnitListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackableUnitListMetadata(val *RackableUnitListMetadata) *NullableRackableUnitListMetadata {
	return &NullableRackableUnitListMetadata{value: val, isSet: true}
}

func (v NullableRackableUnitListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackableUnitListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
