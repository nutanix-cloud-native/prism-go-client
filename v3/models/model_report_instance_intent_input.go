...
// checks if the ReportInstanceIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstanceIntentInput{}

// ReportInstanceIntentInput An intentful representation of a report_instance
type ReportInstanceIntentInput struct {
	Spec ReportInstance `json:"spec"`
...
type _ReportInstanceIntentInput ReportInstanceIntentInput
...
func NewReportInstanceIntentInput(spec ReportInstance, metadata ReportInstanceMetadata) *ReportInstanceIntentInput {
	this := ReportInstanceIntentInput{}
	this.Spec = spec
...
func (o ReportInstanceIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ReportInstanceIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ReportInstanceIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varReportInstanceIntentInput := _ReportInstanceIntentInput{}

	err = json.Unmarshal(data, &varReportInstanceIntentInput)

	if err != nil {
		return err
	}

	*o = ReportInstanceIntentInput(varReportInstanceIntentInput)
...
type NullableReportInstanceIntentInput struct {
	value *ReportInstanceIntentInput
	isSet bool
}

func (v NullableReportInstanceIntentInput) Get() *ReportInstanceIntentInput {
	return v.value
}

func (v *NullableReportInstanceIntentInput) Set(val *ReportInstanceIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstanceIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstanceIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstanceIntentInput(val *ReportInstanceIntentInput) *NullableReportInstanceIntentInput {
	return &NullableReportInstanceIntentInput{value: val, isSet: true}
}

func (v NullableReportInstanceIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstanceIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
