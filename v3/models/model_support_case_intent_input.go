...
// checks if the SupportCaseIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseIntentInput{}

// SupportCaseIntentInput An intentful representation of a support_case
type SupportCaseIntentInput struct {
	Spec SupportCase `json:"spec"`
...
type _SupportCaseIntentInput SupportCaseIntentInput
...
func (o SupportCaseIntentInput) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseIntentInput := _SupportCaseIntentInput{}

	err = json.Unmarshal(data, &varSupportCaseIntentInput)

	if err != nil {
		return err
	}

	*o = SupportCaseIntentInput(varSupportCaseIntentInput)
...
type NullableSupportCaseIntentInput struct {
	value *SupportCaseIntentInput
	isSet bool
}

func (v NullableSupportCaseIntentInput) Get() *SupportCaseIntentInput {
	return v.value
}

func (v *NullableSupportCaseIntentInput) Set(val *SupportCaseIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseIntentInput(val *SupportCaseIntentInput) *NullableSupportCaseIntentInput {
	return &NullableSupportCaseIntentInput{value: val, isSet: true}
}

func (v NullableSupportCaseIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
