...
// checks if the IpfixExporterListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpfixExporterListIntentResponse{}

// IpfixExporterListIntentResponse Response object for intentful operation of ipfix_exporters
type IpfixExporterListIntentResponse struct {
	Entities []IpfixExporterIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata IpfixExporterListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _IpfixExporterListIntentResponse IpfixExporterListIntentResponse
...
func NewIpfixExporterListIntentResponse(apiVersion string, metadata IpfixExporterListMetadataOutput) *IpfixExporterListIntentResponse {
	this := IpfixExporterListIntentResponse{}
...
func (o *IpfixExporterListIntentResponse) GetEntities() []IpfixExporterIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []IpfixExporterIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []IpfixExporterIntentResource and assigns it to the Entities field.
...
func (o *IpfixExporterListIntentResponse) GetMetadata() IpfixExporterListMetadataOutput {
	if o == nil {
		var ret IpfixExporterListMetadataOutput
		return ret
	}
...
func (o IpfixExporterListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o IpfixExporterListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *IpfixExporterListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varIpfixExporterListIntentResponse := _IpfixExporterListIntentResponse{}

	err = json.Unmarshal(data, &varIpfixExporterListIntentResponse)

	if err != nil {
		return err
	}

	*o = IpfixExporterListIntentResponse(varIpfixExporterListIntentResponse)
...
type NullableIpfixExporterListIntentResponse struct {
	value *IpfixExporterListIntentResponse
	isSet bool
}

func (v NullableIpfixExporterListIntentResponse) Get() *IpfixExporterListIntentResponse {
	return v.value
}

func (v *NullableIpfixExporterListIntentResponse) Set(val *IpfixExporterListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIpfixExporterListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIpfixExporterListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpfixExporterListIntentResponse(val *IpfixExporterListIntentResponse) *NullableIpfixExporterListIntentResponse {
	return &NullableIpfixExporterListIntentResponse{value: val, isSet: true}
}

func (v NullableIpfixExporterListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpfixExporterListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
