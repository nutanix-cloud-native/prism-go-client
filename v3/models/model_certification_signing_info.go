...
// checks if the CertificationSigningInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificationSigningInfo{}
...
type _CertificationSigningInfo CertificationSigningInfo
...
// GetCommonNameSuffix returns the CommonNameSuffix field value if set, zero value otherwise.
func (o *CertificationSigningInfo) GetCommonNameSuffix() string {
	if o == nil || IsNil(o.CommonNameSuffix) {
		var ret string
		return ret
	}
	return *o.CommonNameSuffix
}

// GetCommonNameSuffixOk returns a tuple with the CommonNameSuffix field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CertificationSigningInfo) GetCommonNameSuffixOk() (*string, bool) {
	if o == nil || IsNil(o.CommonNameSuffix) {
		return nil, false
	}
	return o.CommonNameSuffix, true
}
...
// SetCommonNameSuffix gets a reference to the given string and assigns it to the CommonNameSuffix field.
func (o *CertificationSigningInfo) SetCommonNameSuffix(v string) {
	o.CommonNameSuffix = &v
}
...
func (o CertificationSigningInfo) MarshalJSON() ([]byte, error) {
...
func (o CertificationSigningInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.City) {
		toSerialize["city"] = o.City
	}
	if !IsNil(o.CommonNameSuffix) {
		toSerialize["common_name_suffix"] = o.CommonNameSuffix
	}
	if !IsNil(o.State) {
...
func (o *CertificationSigningInfo) UnmarshalJSON(data []byte) (err error) {
	varCertificationSigningInfo := _CertificationSigningInfo{}

	err = json.Unmarshal(data, &varCertificationSigningInfo)

	if err != nil {
		return err
	}

	*o = CertificationSigningInfo(varCertificationSigningInfo)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "city")
		delete(additionalProperties, "common_name_suffix")
...
type NullableCertificationSigningInfo struct {
	value *CertificationSigningInfo
	isSet bool
}

func (v NullableCertificationSigningInfo) Get() *CertificationSigningInfo {
	return v.value
}

func (v *NullableCertificationSigningInfo) Set(val *CertificationSigningInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificationSigningInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificationSigningInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificationSigningInfo(val *CertificationSigningInfo) *NullableCertificationSigningInfo {
	return &NullableCertificationSigningInfo{value: val, isSet: true}
}

func (v NullableCertificationSigningInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificationSigningInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
