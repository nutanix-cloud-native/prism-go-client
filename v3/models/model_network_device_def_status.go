...
// checks if the NetworkDeviceDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDeviceDefStatus{}

// NetworkDeviceDefStatus Network device entity status definition
type NetworkDeviceDefStatus struct {
	// An optional name for the device
	Name *string `json:"name,omitempty"`
	Resources NetworkDeviceResources `json:"resources"`
	// An optional description for the device
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NetworkDeviceDefStatus NetworkDeviceDefStatus
...
func (o *NetworkDeviceDefStatus) GetResources() NetworkDeviceResources {
	if o == nil {
		var ret NetworkDeviceResources
		return ret
	}
...
func (o NetworkDeviceDefStatus) MarshalJSON() ([]byte, error) {
...
func (o NetworkDeviceDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkDeviceDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkDeviceDefStatus := _NetworkDeviceDefStatus{}

	err = json.Unmarshal(data, &varNetworkDeviceDefStatus)

	if err != nil {
		return err
	}

	*o = NetworkDeviceDefStatus(varNetworkDeviceDefStatus)
...
type NullableNetworkDeviceDefStatus struct {
	value *NetworkDeviceDefStatus
	isSet bool
}

func (v NullableNetworkDeviceDefStatus) Get() *NetworkDeviceDefStatus {
	return v.value
}

func (v *NullableNetworkDeviceDefStatus) Set(val *NetworkDeviceDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDeviceDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDeviceDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDeviceDefStatus(val *NetworkDeviceDefStatus) *NullableNetworkDeviceDefStatus {
	return &NullableNetworkDeviceDefStatus{value: val, isSet: true}
}

func (v NullableNetworkDeviceDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDeviceDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
