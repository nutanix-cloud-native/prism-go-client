...
// checks if the DescriptionItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescriptionItem{}

// DescriptionItem Description item of upgrade notification
type DescriptionItem struct {
	// Earlier releases to which the notification applies.
	AffectedReleaseList []string `json:"affected_release_list,omitempty"`
	Message *string `json:"message,omitempty"`
	SeverityLevel *string `json:"severity_level,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DescriptionItem DescriptionItem
...
// GetAffectedReleaseList returns the AffectedReleaseList field value if set, zero value otherwise.
func (o *DescriptionItem) GetAffectedReleaseList() []string {
	if o == nil || IsNil(o.AffectedReleaseList) {
		var ret []string
		return ret
	}
	return o.AffectedReleaseList
}

// GetAffectedReleaseListOk returns a tuple with the AffectedReleaseList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DescriptionItem) GetAffectedReleaseListOk() ([]string, bool) {
	if o == nil || IsNil(o.AffectedReleaseList) {
		return nil, false
	}
	return o.AffectedReleaseList, true
}
...
// SetAffectedReleaseList gets a reference to the given []string and assigns it to the AffectedReleaseList field.
func (o *DescriptionItem) SetAffectedReleaseList(v []string) {
	o.AffectedReleaseList = v
}
...
func (o DescriptionItem) MarshalJSON() ([]byte, error) {
...
func (o DescriptionItem) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AffectedReleaseList) {
		toSerialize["affected_release_list"] = o.AffectedReleaseList
	}
	if !IsNil(o.Message) {
...
func (o *DescriptionItem) UnmarshalJSON(data []byte) (err error) {
	varDescriptionItem := _DescriptionItem{}

	err = json.Unmarshal(data, &varDescriptionItem)

	if err != nil {
		return err
	}

	*o = DescriptionItem(varDescriptionItem)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "affected_release_list")
		delete(additionalProperties, "message")
		delete(additionalProperties, "severity_level")
...
type NullableDescriptionItem struct {
	value *DescriptionItem
	isSet bool
}

func (v NullableDescriptionItem) Get() *DescriptionItem {
	return v.value
}

func (v *NullableDescriptionItem) Set(val *DescriptionItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDescriptionItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDescriptionItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescriptionItem(val *DescriptionItem) *NullableDescriptionItem {
	return &NullableDescriptionItem{value: val, isSet: true}
}

func (v NullableDescriptionItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescriptionItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
