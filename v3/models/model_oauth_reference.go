...
// checks if the OauthReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthReference{}

// OauthReference The reference to a oauth
...
type _OauthReference OauthReference
...
func (o OauthReference) MarshalJSON() ([]byte, error) {
...
func (o OauthReference) ToMap() (map[string]interface{}, error) {
...
func (o *OauthReference) UnmarshalJSON(data []byte) (err error) {
	...
	varOauthReference := _OauthReference{}

	err = json.Unmarshal(data, &varOauthReference)

	if err != nil {
		return err
	}

	*o = OauthReference(varOauthReference)
...
type NullableOauthReference struct {
	value *OauthReference
	isSet bool
}

func (v NullableOauthReference) Get() *OauthReference {
	return v.value
}

func (v *NullableOauthReference) Set(val *OauthReference) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthReference) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthReference(val *OauthReference) *NullableOauthReference {
	return &NullableOauthReference{value: val, isSet: true}
}

func (v NullableOauthReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
