...
type _RoutingPolicyResources RoutingPolicyResources
...
// SetProtocolParameters gets a reference to the given ProtocolParameters and assigns it to the ProtocolParameters field.
...
func (o RoutingPolicyResources) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyResources) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyResources) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingPolicyResources := _RoutingPolicyResources{}

	err = json.Unmarshal(data, &varRoutingPolicyResources)

	if err != nil {
		return err
	}

	*o = RoutingPolicyResources(varRoutingPolicyResources)
...
type NullableRoutingPolicyResources struct {
	value *RoutingPolicyResources
	isSet bool
}

func (v NullableRoutingPolicyResources) Get() *RoutingPolicyResources {
	return v.value
}

func (v *NullableRoutingPolicyResources) Set(val *RoutingPolicyResources) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyResources) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyResources(val *RoutingPolicyResources) *NullableRoutingPolicyResources {
	return &NullableRoutingPolicyResources{value: val, isSet: true}
}

func (v NullableRoutingPolicyResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
