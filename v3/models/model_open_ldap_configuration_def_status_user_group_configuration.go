...
// checks if the OpenLdapConfigurationDefStatusUserGroupConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenLdapConfigurationDefStatusUserGroupConfiguration{}

// OpenLdapConfigurationDefStatusUserGroupConfiguration struct for OpenLdapConfigurationDefStatusUserGroupConfiguration
type OpenLdapConfigurationDefStatusUserGroupConfiguration struct {
...
type _OpenLdapConfigurationDefStatusUserGroupConfiguration OpenLdapConfigurationDefStatusUserGroupConfiguration
...
func NewOpenLdapConfigurationDefStatusUserGroupConfiguration(groupSearchBase string, groupMemberAttribute string, groupObjectClass string, groupMemberAttributeValue string) *OpenLdapConfigurationDefStatusUserGroupConfiguration {
	this := OpenLdapConfigurationDefStatusUserGroupConfiguration{}
...
// GetGroupSearchBase returns the GroupSearchBase field value
...
// GetGroupSearchBaseOk returns a tuple with the GroupSearchBase field value
...
// SetGroupSearchBase sets field value
func (o *OpenLdapConfigurationDefStatusUserGroupConfiguration) SetGroupSearchBase(v string) {
	o.GroupSearchBase = v
}

// GetGroupMemberAttribute returns the GroupMemberAttribute field value
...
// GetGroupMemberAttributeOk returns a tuple with the GroupMemberAttribute field value
// and a boolean to check if the value has been set.
...
// SetGroupMemberAttribute sets field value
...
// GetGroupMemberAttributeValue returns the GroupMemberAttributeValue field value
func (o *OpenLdapConfigurationDefStatusUserGroupConfiguration) GetGroupMemberAttributeValue() string {
	...
	return o.GroupMemberAttributeValue
}

// GetGroupMemberAttributeValueOk returns a tuple with the GroupMemberAttributeValue field value
// and a boolean to check if the value has been set.
func (o *OpenLdapConfigurationDefStatusUserGroupConfiguration) GetGroupMemberAttributeValueOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.GroupMemberAttributeValue, true
}

// SetGroupMemberAttributeValue sets field value
func (o *OpenLdapConfigurationDefStatusUserGroupConfiguration) SetGroupMemberAttributeValue(v string) {
	o.GroupMemberAttributeValue = v
}

func (o OpenLdapConfigurationDefStatusUserGroupConfiguration) MarshalJSON() ([]byte, error) {
...
func (o OpenLdapConfigurationDefStatusUserGroupConfiguration) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["group_search_base"] = o.GroupSearchBase
	toSerialize["group_member_attribute"] = o.GroupMemberAttribute
	toSerialize["group_object_class"] = o.GroupObjectClass
	toSerialize["group_member_attribute_value"] = o.GroupMemberAttributeValue
...
func (o *OpenLdapConfigurationDefStatusUserGroupConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenLdapConfigurationDefStatusUserGroupConfiguration := _OpenLdapConfigurationDefStatusUserGroupConfiguration{}

	err = json.Unmarshal(data, &varOpenLdapConfigurationDefStatusUserGroupConfiguration)

	if err != nil {
		return err
	}

	*o = OpenLdapConfigurationDefStatusUserGroupConfiguration(varOpenLdapConfigurationDefStatusUserGroupConfiguration)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "group_search_base")
		delete(additionalProperties, "group_member_attribute")
		delete(additionalProperties, "group_object_class")
		delete(additionalProperties, "group_member_attribute_value")
...
type NullableOpenLdapConfigurationDefStatusUserGroupConfiguration struct {
	value *OpenLdapConfigurationDefStatusUserGroupConfiguration
	isSet bool
}

func (v NullableOpenLdapConfigurationDefStatusUserGroupConfiguration) Get() *OpenLdapConfigurationDefStatusUserGroupConfiguration {
	return v.value
}

func (v *NullableOpenLdapConfigurationDefStatusUserGroupConfiguration) Set(val *OpenLdapConfigurationDefStatusUserGroupConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenLdapConfigurationDefStatusUserGroupConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenLdapConfigurationDefStatusUserGroupConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenLdapConfigurationDefStatusUserGroupConfiguration(val *OpenLdapConfigurationDefStatusUserGroupConfiguration) *NullableOpenLdapConfigurationDefStatusUserGroupConfiguration {
	return &NullableOpenLdapConfigurationDefStatusUserGroupConfiguration{value: val, isSet: true}
}

func (v NullableOpenLdapConfigurationDefStatusUserGroupConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenLdapConfigurationDefStatusUserGroupConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
