...
// checks if the NameIdentifierMap type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NameIdentifierMap{}

// NameIdentifierMap A mapping of name to the generated / salted UUID5.
type NameIdentifierMap struct {
	Identifier *string `json:"identifier,omitempty" validate:"regexp=^[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-5[0-9a-f]{3}-[a-fA-F0-9]{4}-[a-fA-F0-9]{12}$"`
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NameIdentifierMap NameIdentifierMap
...
func (o NameIdentifierMap) MarshalJSON() ([]byte, error) {
...
func (o NameIdentifierMap) ToMap() (map[string]interface{}, error) {
...
func (o *NameIdentifierMap) UnmarshalJSON(data []byte) (err error) {
	varNameIdentifierMap := _NameIdentifierMap{}

	err = json.Unmarshal(data, &varNameIdentifierMap)

	if err != nil {
		return err
	}

	*o = NameIdentifierMap(varNameIdentifierMap)
...
type NullableNameIdentifierMap struct {
	value *NameIdentifierMap
	isSet bool
}

func (v NullableNameIdentifierMap) Get() *NameIdentifierMap {
	return v.value
}

func (v *NullableNameIdentifierMap) Set(val *NameIdentifierMap) {
	v.value = val
	v.isSet = true
}

func (v NullableNameIdentifierMap) IsSet() bool {
	return v.isSet
}

func (v *NullableNameIdentifierMap) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNameIdentifierMap(val *NameIdentifierMap) *NullableNameIdentifierMap {
	return &NullableNameIdentifierMap{value: val, isSet: true}
}

func (v NullableNameIdentifierMap) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNameIdentifierMap) UnmarshalJSON(src []byte) error {
	v.isSet = true
