...
// checks if the ReportConfigIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigIntentResponse{}

// ReportConfigIntentResponse Response object for intentful operations on a report_config
type ReportConfigIntentResponse struct {
	Status *ReportConfigDefStatus `json:"status,omitempty"`
	Spec *ReportConfig `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ReportConfigMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ReportConfigIntentResponse ReportConfigIntentResponse
...
func NewReportConfigIntentResponse(apiVersion string, metadata ReportConfigMetadata) *ReportConfigIntentResponse {
	this := ReportConfigIntentResponse{}
...
// SetStatus gets a reference to the given ReportConfigDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given ReportConfig and assigns it to the Spec field.
...
func (o ReportConfigIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfigIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varReportConfigIntentResponse := _ReportConfigIntentResponse{}

	err = json.Unmarshal(data, &varReportConfigIntentResponse)

	if err != nil {
		return err
	}

	*o = ReportConfigIntentResponse(varReportConfigIntentResponse)
...
type NullableReportConfigIntentResponse struct {
	value *ReportConfigIntentResponse
	isSet bool
}

func (v NullableReportConfigIntentResponse) Get() *ReportConfigIntentResponse {
	return v.value
}

func (v *NullableReportConfigIntentResponse) Set(val *ReportConfigIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigIntentResponse(val *ReportConfigIntentResponse) *NullableReportConfigIntentResponse {
	return &NullableReportConfigIntentResponse{value: val, isSet: true}
}

func (v NullableReportConfigIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
