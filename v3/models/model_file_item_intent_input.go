...
// checks if the FileItemIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemIntentInput{}

// FileItemIntentInput An intentful representation of a file_item
type FileItemIntentInput struct {
	Spec FileItem `json:"spec"`
...
type _FileItemIntentInput FileItemIntentInput
...
func (o FileItemIntentInput) MarshalJSON() ([]byte, error) {
...
func (o FileItemIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *FileItemIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varFileItemIntentInput := _FileItemIntentInput{}

	err = json.Unmarshal(data, &varFileItemIntentInput)

	if err != nil {
		return err
	}

	*o = FileItemIntentInput(varFileItemIntentInput)
...
type NullableFileItemIntentInput struct {
	value *FileItemIntentInput
	isSet bool
}

func (v NullableFileItemIntentInput) Get() *FileItemIntentInput {
	return v.value
}

func (v *NullableFileItemIntentInput) Set(val *FileItemIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemIntentInput(val *FileItemIntentInput) *NullableFileItemIntentInput {
	return &NullableFileItemIntentInput{value: val, isSet: true}
}

func (v NullableFileItemIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
