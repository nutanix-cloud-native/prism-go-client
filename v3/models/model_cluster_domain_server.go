...
// checks if the ClusterDomainServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterDomainServer{}

// ClusterDomainServer Cluster domain server. Only applied to the cluster with all Hyper-V hosts. 
...
type _ClusterDomainServer ClusterDomainServer
...
// SetDomainCredentials gets a reference to the given Credentials and assigns it to the DomainCredentials field.
func (o *ClusterDomainServer) SetDomainCredentials(v Credentials) {
	o.DomainCredentials = &v
}

func (o ClusterDomainServer) MarshalJSON() ([]byte, error) {
...
func (o ClusterDomainServer) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterDomainServer) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterDomainServer := _ClusterDomainServer{}

	err = json.Unmarshal(data, &varClusterDomainServer)

	if err != nil {
		return err
	}

	*o = ClusterDomainServer(varClusterDomainServer)
...
type NullableClusterDomainServer struct {
	value *ClusterDomainServer
	isSet bool
}

func (v NullableClusterDomainServer) Get() *ClusterDomainServer {
	return v.value
}

func (v *NullableClusterDomainServer) Set(val *ClusterDomainServer) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterDomainServer) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterDomainServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterDomainServer(val *ClusterDomainServer) *NullableClusterDomainServer {
	return &NullableClusterDomainServer{value: val, isSet: true}
}

func (v NullableClusterDomainServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterDomainServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
