...
// checks if the VmNicReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmNicReference{}

// VmNicReference The reference to a vm_nic
...
type _VmNicReference VmNicReference
...
func (o VmNicReference) MarshalJSON() ([]byte, error) {
...
func (o VmNicReference) ToMap() (map[string]interface{}, error) {
...
func (o *VmNicReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVmNicReference := _VmNicReference{}

	err = json.Unmarshal(data, &varVmNicReference)

	if err != nil {
		return err
	}

	*o = VmNicReference(varVmNicReference)
...
type NullableVmNicReference struct {
	value *VmNicReference
	isSet bool
}

func (v NullableVmNicReference) Get() *VmNicReference {
	return v.value
}

func (v *NullableVmNicReference) Set(val *VmNicReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVmNicReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVmNicReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmNicReference(val *VmNicReference) *NullableVmNicReference {
	return &NullableVmNicReference{value: val, isSet: true}
}

func (v NullableVmNicReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmNicReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
