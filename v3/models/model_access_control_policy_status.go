...
// checks if the AccessControlPolicyStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyStatus{}

// AccessControlPolicyStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _AccessControlPolicyStatus AccessControlPolicyStatus
...
func NewAccessControlPolicyStatus() *AccessControlPolicyStatus {
	this := AccessControlPolicyStatus{}
	return &this
}
...
func (o AccessControlPolicyStatus) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AccessControlPolicyStatus) UnmarshalJSON(data []byte) (err error) {
	varAccessControlPolicyStatus := _AccessControlPolicyStatus{}

	err = json.Unmarshal(data, &varAccessControlPolicyStatus)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyStatus(varAccessControlPolicyStatus)
...
type NullableAccessControlPolicyStatus struct {
	value *AccessControlPolicyStatus
	isSet bool
}

func (v NullableAccessControlPolicyStatus) Get() *AccessControlPolicyStatus {
	return v.value
}

func (v *NullableAccessControlPolicyStatus) Set(val *AccessControlPolicyStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyStatus(val *AccessControlPolicyStatus) *NullableAccessControlPolicyStatus {
	return &NullableAccessControlPolicyStatus{value: val, isSet: true}
}

func (v NullableAccessControlPolicyStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
