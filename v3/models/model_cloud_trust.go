...
// checks if the CloudTrust type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrust{}

// CloudTrust Cloud Pairing creation/modification spec.
type CloudTrust struct {
	// Cloud Trust name.
	Name *string `json:"name,omitempty"`
	Resources CloudTrustResources `json:"resources"`
	// A description or user annotation for the cloud trust.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CloudTrust CloudTrust
...
func (o CloudTrust) MarshalJSON() ([]byte, error) {
...
func (o CloudTrust) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrust) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTrust := _CloudTrust{}

	err = json.Unmarshal(data, &varCloudTrust)

	if err != nil {
		return err
	}

	*o = CloudTrust(varCloudTrust)
...
type NullableCloudTrust struct {
	value *CloudTrust
	isSet bool
}

func (v NullableCloudTrust) Get() *CloudTrust {
	return v.value
}

func (v *NullableCloudTrust) Set(val *CloudTrust) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrust) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrust) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrust(val *CloudTrust) *NullableCloudTrust {
	return &NullableCloudTrust{value: val, isSet: true}
}

func (v NullableCloudTrust) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrust) UnmarshalJSON(src []byte) error {
	v.isSet = true
