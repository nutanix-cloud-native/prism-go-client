...
// checks if the RoutingPolicyReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyReference{}

// RoutingPolicyReference The reference to a routing_policy
...
type _RoutingPolicyReference RoutingPolicyReference
...
func (o RoutingPolicyReference) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyReference) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyReference) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingPolicyReference := _RoutingPolicyReference{}

	err = json.Unmarshal(data, &varRoutingPolicyReference)

	if err != nil {
		return err
	}

	*o = RoutingPolicyReference(varRoutingPolicyReference)
...
type NullableRoutingPolicyReference struct {
	value *RoutingPolicyReference
	isSet bool
}

func (v NullableRoutingPolicyReference) Get() *RoutingPolicyReference {
	return v.value
}

func (v *NullableRoutingPolicyReference) Set(val *RoutingPolicyReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyReference) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyReference(val *RoutingPolicyReference) *NullableRoutingPolicyReference {
	return &NullableRoutingPolicyReference{value: val, isSet: true}
}

func (v NullableRoutingPolicyReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
