...
// checks if the CellIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CellIntentResponse{}

// CellIntentResponse Response object for intentful operations on a cell
type CellIntentResponse struct {
...
type _CellIntentResponse CellIntentResponse
...
func (o CellIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CellIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CellIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCellIntentResponse := _CellIntentResponse{}

	err = json.Unmarshal(data, &varCellIntentResponse)

	if err != nil {
		return err
	}

	*o = CellIntentResponse(varCellIntentResponse)
...
type NullableCellIntentResponse struct {
	value *CellIntentResponse
	isSet bool
}

func (v NullableCellIntentResponse) Get() *CellIntentResponse {
	return v.value
}

func (v *NullableCellIntentResponse) Set(val *CellIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCellIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCellIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCellIntentResponse(val *CellIntentResponse) *NullableCellIntentResponse {
	return &NullableCellIntentResponse{value: val, isSet: true}
}

func (v NullableCellIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCellIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
