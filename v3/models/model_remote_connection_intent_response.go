...
// checks if the RemoteConnectionIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionIntentResponse{}

// RemoteConnectionIntentResponse Response object for intentful operations on a remote_connection
type RemoteConnectionIntentResponse struct {
...
type _RemoteConnectionIntentResponse RemoteConnectionIntentResponse
...
func NewRemoteConnectionIntentResponse(apiVersion string, metadata RemoteConnectionMetadata) *RemoteConnectionIntentResponse {
	this := RemoteConnectionIntentResponse{}
...
func (o RemoteConnectionIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteConnectionIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteConnectionIntentResponse := _RemoteConnectionIntentResponse{}

	err = json.Unmarshal(data, &varRemoteConnectionIntentResponse)

	if err != nil {
		return err
	}

	*o = RemoteConnectionIntentResponse(varRemoteConnectionIntentResponse)
...
type NullableRemoteConnectionIntentResponse struct {
	value *RemoteConnectionIntentResponse
	isSet bool
}

func (v NullableRemoteConnectionIntentResponse) Get() *RemoteConnectionIntentResponse {
	return v.value
}

func (v *NullableRemoteConnectionIntentResponse) Set(val *RemoteConnectionIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionIntentResponse(val *RemoteConnectionIntentResponse) *NullableRemoteConnectionIntentResponse {
	return &NullableRemoteConnectionIntentResponse{value: val, isSet: true}
}

func (v NullableRemoteConnectionIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
