...
// checks if the BlueprintDownloadResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintDownloadResourcesDefStatus{}

// BlueprintDownloadResourcesDefStatus Status of the Blueprint.
type BlueprintDownloadResourcesDefStatus struct {
	// Data needed for clients.
	ClientAttrs map[string]interface{} `json:"client_attrs,omitempty"`
	// Service definitions for Blueprint.
	ServiceDefinitionList []AppServiceResponseDownload `json:"service_definition_list,omitempty"`
	// Substrate definitions for Blueprint.
	SubstrateDefinitionList []AppSubstrateResponseDownload `json:"substrate_definition_list,omitempty"`
	// Credential definitions for Blueprint.
	CredentialDefinitionList []AppCredentialResponseDownload `json:"credential_definition_list,omitempty"`
	// Package definitions for Blueprint.
	PackageDefinitionList []AppPackageResponseDownload `json:"package_definition_list,omitempty"`
	// App profile definitions for Blueprint.
	AppProfileList []AppProfileResponseDownload `json:"app_profile_list,omitempty"`
	// Published service definitions for Blueprint.
	PublishedServiceDefinitionList []AppPublishedServiceResponseDownload `json:"published_service_definition_list,omitempty"`
	DefaultCredentialLocalReference *AppCredentialReferenceUpload `json:"default_credential_local_reference,omitempty"`
	// 
	...
	// Cloned or original blueprint
	IsCloned *bool `json:"is_cloned,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _BlueprintDownloadResourcesDefStatus BlueprintDownloadResourcesDefStatus
...
func NewBlueprintDownloadResourcesDefStatus() *BlueprintDownloadResourcesDefStatus {
	this := BlueprintDownloadResourcesDefStatus{}
...
// GetClientAttrs returns the ClientAttrs field value if set, zero value otherwise.
func (o *BlueprintDownloadResourcesDefStatus) GetClientAttrs() map[string]interface{} {
	if o == nil || IsNil(o.ClientAttrs) {
		var ret map[string]interface{}
		return ret
	}
	return o.ClientAttrs
}

// GetClientAttrsOk returns a tuple with the ClientAttrs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDownloadResourcesDefStatus) GetClientAttrsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.ClientAttrs) {
		return map[string]interface{}{}, false
	}
	return o.ClientAttrs, true
}
...
// SetClientAttrs gets a reference to the given map[string]interface{} and assigns it to the ClientAttrs field.
func (o *BlueprintDownloadResourcesDefStatus) SetClientAttrs(v map[string]interface{}) {
	o.ClientAttrs = v
}

// GetServiceDefinitionList returns the ServiceDefinitionList field value if set, zero value otherwise.
func (o *BlueprintDownloadResourcesDefStatus) GetServiceDefinitionList() []AppServiceResponseDownload {
	if o == nil || IsNil(o.ServiceDefinitionList) {
		var ret []AppServiceResponseDownload
		return ret
	}
	return o.ServiceDefinitionList
}

// GetServiceDefinitionListOk returns a tuple with the ServiceDefinitionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDownloadResourcesDefStatus) GetServiceDefinitionListOk() ([]AppServiceResponseDownload, bool) {
	if o == nil || IsNil(o.ServiceDefinitionList) {
		return nil, false
	}
	return o.ServiceDefinitionList, true
}
...
// SetServiceDefinitionList gets a reference to the given []AppServiceResponseDownload and assigns it to the ServiceDefinitionList field.
func (o *BlueprintDownloadResourcesDefStatus) SetServiceDefinitionList(v []AppServiceResponseDownload) {
	o.ServiceDefinitionList = v
}

// GetSubstrateDefinitionList returns the SubstrateDefinitionList field value if set, zero value otherwise.
func (o *BlueprintDownloadResourcesDefStatus) GetSubstrateDefinitionList() []AppSubstrateResponseDownload {
	if o == nil || IsNil(o.SubstrateDefinitionList) {
		var ret []AppSubstrateResponseDownload
		return ret
	}
	return o.SubstrateDefinitionList
}

// GetSubstrateDefinitionListOk returns a tuple with the SubstrateDefinitionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDownloadResourcesDefStatus) GetSubstrateDefinitionListOk() ([]AppSubstrateResponseDownload, bool) {
	if o == nil || IsNil(o.SubstrateDefinitionList) {
		return nil, false
	}
	return o.SubstrateDefinitionList, true
}
...
// SetSubstrateDefinitionList gets a reference to the given []AppSubstrateResponseDownload and assigns it to the SubstrateDefinitionList field.
func (o *BlueprintDownloadResourcesDefStatus) SetSubstrateDefinitionList(v []AppSubstrateResponseDownload) {
	o.SubstrateDefinitionList = v
}

// GetCredentialDefinitionList returns the CredentialDefinitionList field value if set, zero value otherwise.
func (o *BlueprintDownloadResourcesDefStatus) GetCredentialDefinitionList() []AppCredentialResponseDownload {
	if o == nil || IsNil(o.CredentialDefinitionList) {
		var ret []AppCredentialResponseDownload
		return ret
	}
	return o.CredentialDefinitionList
}

// GetCredentialDefinitionListOk returns a tuple with the CredentialDefinitionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDownloadResourcesDefStatus) GetCredentialDefinitionListOk() ([]AppCredentialResponseDownload, bool) {
	if o == nil || IsNil(o.CredentialDefinitionList) {
		return nil, false
	}
	return o.CredentialDefinitionList, true
}
...
// SetCredentialDefinitionList gets a reference to the given []AppCredentialResponseDownload and assigns it to the CredentialDefinitionList field.
func (o *BlueprintDownloadResourcesDefStatus) SetCredentialDefinitionList(v []AppCredentialResponseDownload) {
	o.CredentialDefinitionList = v
}

// GetPackageDefinitionList returns the PackageDefinitionList field value if set, zero value otherwise.
func (o *BlueprintDownloadResourcesDefStatus) GetPackageDefinitionList() []AppPackageResponseDownload {
	if o == nil || IsNil(o.PackageDefinitionList) {
		var ret []AppPackageResponseDownload
		return ret
	}
	return o.PackageDefinitionList
}

// GetPackageDefinitionListOk returns a tuple with the PackageDefinitionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDownloadResourcesDefStatus) GetPackageDefinitionListOk() ([]AppPackageResponseDownload, bool) {
	if o == nil || IsNil(o.PackageDefinitionList) {
		return nil, false
	}
	return o.PackageDefinitionList, true
}
...
// SetPackageDefinitionList gets a reference to the given []AppPackageResponseDownload and assigns it to the PackageDefinitionList field.
func (o *BlueprintDownloadResourcesDefStatus) SetPackageDefinitionList(v []AppPackageResponseDownload) {
	o.PackageDefinitionList = v
}

// GetAppProfileList returns the AppProfileList field value if set, zero value otherwise.
func (o *BlueprintDownloadResourcesDefStatus) GetAppProfileList() []AppProfileResponseDownload {
	if o == nil || IsNil(o.AppProfileList) {
		var ret []AppProfileResponseDownload
		return ret
	}
	return o.AppProfileList
}

// GetAppProfileListOk returns a tuple with the AppProfileList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDownloadResourcesDefStatus) GetAppProfileListOk() ([]AppProfileResponseDownload, bool) {
	if o == nil || IsNil(o.AppProfileList) {
		return nil, false
	}
	return o.AppProfileList, true
}
...
// SetAppProfileList gets a reference to the given []AppProfileResponseDownload and assigns it to the AppProfileList field.
func (o *BlueprintDownloadResourcesDefStatus) SetAppProfileList(v []AppProfileResponseDownload) {
	o.AppProfileList = v
}

// GetPublishedServiceDefinitionList returns the PublishedServiceDefinitionList field value if set, zero value otherwise.
func (o *BlueprintDownloadResourcesDefStatus) GetPublishedServiceDefinitionList() []AppPublishedServiceResponseDownload {
	if o == nil || IsNil(o.PublishedServiceDefinitionList) {
		var ret []AppPublishedServiceResponseDownload
		return ret
	}
	return o.PublishedServiceDefinitionList
}

// GetPublishedServiceDefinitionListOk returns a tuple with the PublishedServiceDefinitionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDownloadResourcesDefStatus) GetPublishedServiceDefinitionListOk() ([]AppPublishedServiceResponseDownload, bool) {
	if o == nil || IsNil(o.PublishedServiceDefinitionList) {
		return nil, false
	}
	return o.PublishedServiceDefinitionList, true
}
...
// SetPublishedServiceDefinitionList gets a reference to the given []AppPublishedServiceResponseDownload and assigns it to the PublishedServiceDefinitionList field.
func (o *BlueprintDownloadResourcesDefStatus) SetPublishedServiceDefinitionList(v []AppPublishedServiceResponseDownload) {
	o.PublishedServiceDefinitionList = v
}

// GetDefaultCredentialLocalReference returns the DefaultCredentialLocalReference field value if set, zero value otherwise.
func (o *BlueprintDownloadResourcesDefStatus) GetDefaultCredentialLocalReference() AppCredentialReferenceUpload {
	if o == nil || IsNil(o.DefaultCredentialLocalReference) {
		var ret AppCredentialReferenceUpload
		return ret
	}
	return *o.DefaultCredentialLocalReference
}

// GetDefaultCredentialLocalReferenceOk returns a tuple with the DefaultCredentialLocalReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDownloadResourcesDefStatus) GetDefaultCredentialLocalReferenceOk() (*AppCredentialReferenceUpload, bool) {
	if o == nil || IsNil(o.DefaultCredentialLocalReference) {
		return nil, false
	}
	return o.DefaultCredentialLocalReference, true
}
...
// SetDefaultCredentialLocalReference gets a reference to the given AppCredentialReferenceUpload and assigns it to the DefaultCredentialLocalReference field.
func (o *BlueprintDownloadResourcesDefStatus) SetDefaultCredentialLocalReference(v AppCredentialReferenceUpload) {
	o.DefaultCredentialLocalReference = &v
}
...
// GetMessageList returns the MessageList field value if set, zero value otherwise.
func (o *BlueprintDownloadResourcesDefStatus) GetMessageList() []MessageResource {
	if o == nil || IsNil(o.MessageList) {
...
// GetMessageListOk returns a tuple with the MessageList field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMessageList gets a reference to the given []MessageResource and assigns it to the MessageList field.
func (o *BlueprintDownloadResourcesDefStatus) SetMessageList(v []MessageResource) {
	o.MessageList = v
}

// GetIsCloned returns the IsCloned field value if set, zero value otherwise.
func (o *BlueprintDownloadResourcesDefStatus) GetIsCloned() bool {
	if o == nil || IsNil(o.IsCloned) {
		var ret bool
		return ret
	}
	return *o.IsCloned
...
// GetIsClonedOk returns a tuple with the IsCloned field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDownloadResourcesDefStatus) GetIsClonedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsCloned) {
		return nil, false
	}
	return o.IsCloned, true
}
...
// SetIsCloned gets a reference to the given bool and assigns it to the IsCloned field.
func (o *BlueprintDownloadResourcesDefStatus) SetIsCloned(v bool) {
	o.IsCloned = &v
}

func (o BlueprintDownloadResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o BlueprintDownloadResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ClientAttrs) {
		toSerialize["client_attrs"] = o.ClientAttrs
	}
	if !IsNil(o.ServiceDefinitionList) {
		toSerialize["service_definition_list"] = o.ServiceDefinitionList
	}
	if !IsNil(o.SubstrateDefinitionList) {
		toSerialize["substrate_definition_list"] = o.SubstrateDefinitionList
	}
	if !IsNil(o.CredentialDefinitionList) {
		toSerialize["credential_definition_list"] = o.CredentialDefinitionList
	}
	if !IsNil(o.PackageDefinitionList) {
		toSerialize["package_definition_list"] = o.PackageDefinitionList
	}
	if !IsNil(o.AppProfileList) {
		toSerialize["app_profile_list"] = o.AppProfileList
	}
	if !IsNil(o.PublishedServiceDefinitionList) {
		toSerialize["published_service_definition_list"] = o.PublishedServiceDefinitionList
	}
	if !IsNil(o.DefaultCredentialLocalReference) {
		toSerialize["default_credential_local_reference"] = o.DefaultCredentialLocalReference
	}
	if !IsNil(o.State) {
	...
	if !IsNil(o.MessageList) {
		toSerialize["message_list"] = o.MessageList
	}
	if !IsNil(o.IsCloned) {
		toSerialize["is_cloned"] = o.IsCloned
	}
...
func (o *BlueprintDownloadResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varBlueprintDownloadResourcesDefStatus := _BlueprintDownloadResourcesDefStatus{}

	err = json.Unmarshal(data, &varBlueprintDownloadResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = BlueprintDownloadResourcesDefStatus(varBlueprintDownloadResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "client_attrs")
		delete(additionalProperties, "service_definition_list")
		delete(additionalProperties, "substrate_definition_list")
		delete(additionalProperties, "credential_definition_list")
		delete(additionalProperties, "package_definition_list")
		delete(additionalProperties, "app_profile_list")
		delete(additionalProperties, "published_service_definition_list")
		delete(additionalProperties, "default_credential_local_reference")
		delete(additionalProperties, "state")
		delete(additionalProperties, "type")
		delete(additionalProperties, "message_list")
		delete(additionalProperties, "is_cloned")
...
type NullableBlueprintDownloadResourcesDefStatus struct {
	value *BlueprintDownloadResourcesDefStatus
	isSet bool
}

func (v NullableBlueprintDownloadResourcesDefStatus) Get() *BlueprintDownloadResourcesDefStatus {
	return v.value
}

func (v *NullableBlueprintDownloadResourcesDefStatus) Set(val *BlueprintDownloadResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintDownloadResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintDownloadResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintDownloadResourcesDefStatus(val *BlueprintDownloadResourcesDefStatus) *NullableBlueprintDownloadResourcesDefStatus {
	return &NullableBlueprintDownloadResourcesDefStatus{value: val, isSet: true}
}

func (v NullableBlueprintDownloadResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintDownloadResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
