...
// checks if the ComponentError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComponentError{}

// ComponentError validation errors in action rule.
type ComponentError struct {
	...
	ErrorObjectList []ErrorMessageObject `json:"error_object_list,omitempty"`
	// list of parameter error messages.
	ParameterErrorList []ParameterError `json:"parameter_error_list,omitempty"`
	// component type like action or trigger.
	ComponentType *string `json:"component_type,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
	// name of the component.
	ComponentName *string `json:"component_name,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
	AdditionalProperties map[string]interface{}
}

type _ComponentError ComponentError
...
// GetErrorObjectList returns the ErrorObjectList field value if set, zero value otherwise.
func (o *ComponentError) GetErrorObjectList() []ErrorMessageObject {
	if o == nil || IsNil(o.ErrorObjectList) {
		var ret []ErrorMessageObject
		return ret
	}
	return o.ErrorObjectList
}

// GetErrorObjectListOk returns a tuple with the ErrorObjectList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ComponentError) GetErrorObjectListOk() ([]ErrorMessageObject, bool) {
	if o == nil || IsNil(o.ErrorObjectList) {
		return nil, false
	}
	return o.ErrorObjectList, true
}
...
// SetErrorObjectList gets a reference to the given []ErrorMessageObject and assigns it to the ErrorObjectList field.
func (o *ComponentError) SetErrorObjectList(v []ErrorMessageObject) {
	o.ErrorObjectList = v
}

// GetParameterErrorList returns the ParameterErrorList field value if set, zero value otherwise.
func (o *ComponentError) GetParameterErrorList() []ParameterError {
	if o == nil || IsNil(o.ParameterErrorList) {
		var ret []ParameterError
		return ret
	}
	return o.ParameterErrorList
}

// GetParameterErrorListOk returns a tuple with the ParameterErrorList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ComponentError) GetParameterErrorListOk() ([]ParameterError, bool) {
	if o == nil || IsNil(o.ParameterErrorList) {
		return nil, false
	}
	return o.ParameterErrorList, true
}
...
// SetParameterErrorList gets a reference to the given []ParameterError and assigns it to the ParameterErrorList field.
func (o *ComponentError) SetParameterErrorList(v []ParameterError) {
	o.ParameterErrorList = v
}
...
func (o ComponentError) MarshalJSON() ([]byte, error) {
...
func (o ComponentError) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.InstanceUuid) {
		toSerialize["instance_uuid"] = o.InstanceUuid
	}
	if !IsNil(o.ErrorObjectList) {
		toSerialize["error_object_list"] = o.ErrorObjectList
	}
	if !IsNil(o.ParameterErrorList) {
		toSerialize["parameter_error_list"] = o.ParameterErrorList
	}
...
func (o *ComponentError) UnmarshalJSON(data []byte) (err error) {
	varComponentError := _ComponentError{}

	err = json.Unmarshal(data, &varComponentError)

	if err != nil {
		return err
	}

	*o = ComponentError(varComponentError)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "instance_uuid")
		delete(additionalProperties, "error_object_list")
		delete(additionalProperties, "parameter_error_list")
...
type NullableComponentError struct {
	value *ComponentError
	isSet bool
}

func (v NullableComponentError) Get() *ComponentError {
	return v.value
}

func (v *NullableComponentError) Set(val *ComponentError) {
	v.value = val
	v.isSet = true
}

func (v NullableComponentError) IsSet() bool {
	return v.isSet
}

func (v *NullableComponentError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComponentError(val *ComponentError) *NullableComponentError {
	return &NullableComponentError{value: val, isSet: true}
}

func (v NullableComponentError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComponentError) UnmarshalJSON(src []byte) error {
	v.isSet = true
