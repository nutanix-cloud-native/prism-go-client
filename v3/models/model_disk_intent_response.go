...
// checks if the DiskIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskIntentResponse{}
...
type _DiskIntentResponse DiskIntentResponse
...
func (o DiskIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DiskIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DiskIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDiskIntentResponse := _DiskIntentResponse{}

	err = json.Unmarshal(data, &varDiskIntentResponse)

	if err != nil {
		return err
	}

	*o = DiskIntentResponse(varDiskIntentResponse)
...
type NullableDiskIntentResponse struct {
	value *DiskIntentResponse
	isSet bool
}

func (v NullableDiskIntentResponse) Get() *DiskIntentResponse {
	return v.value
}

func (v *NullableDiskIntentResponse) Set(val *DiskIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskIntentResponse(val *DiskIntentResponse) *NullableDiskIntentResponse {
	return &NullableDiskIntentResponse{value: val, isSet: true}
}

func (v NullableDiskIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
