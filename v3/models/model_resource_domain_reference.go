...
// checks if the ResourceDomainReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceDomainReference{}

// ResourceDomainReference The reference to a resource_domain
...
type _ResourceDomainReference ResourceDomainReference
...
func (o ResourceDomainReference) MarshalJSON() ([]byte, error) {
...
func (o ResourceDomainReference) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceDomainReference) UnmarshalJSON(data []byte) (err error) {
	...
	varResourceDomainReference := _ResourceDomainReference{}

	err = json.Unmarshal(data, &varResourceDomainReference)

	if err != nil {
		return err
	}

	*o = ResourceDomainReference(varResourceDomainReference)
...
type NullableResourceDomainReference struct {
	value *ResourceDomainReference
	isSet bool
}

func (v NullableResourceDomainReference) Get() *ResourceDomainReference {
	return v.value
}

func (v *NullableResourceDomainReference) Set(val *ResourceDomainReference) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceDomainReference) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceDomainReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceDomainReference(val *ResourceDomainReference) *NullableResourceDomainReference {
	return &NullableResourceDomainReference{value: val, isSet: true}
}

func (v NullableResourceDomainReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceDomainReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
