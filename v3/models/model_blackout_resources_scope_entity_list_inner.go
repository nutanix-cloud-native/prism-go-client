...
// checks if the BlackoutResourcesScopeEntityListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackoutResourcesScopeEntityListInner{}

// BlackoutResourcesScopeEntityListInner struct for BlackoutResourcesScopeEntityListInner
type BlackoutResourcesScopeEntityListInner struct {
	UuidList []string `json:"uuid_list,omitempty"`
	EntityType string `json:"entity_type"`
	AdditionalProperties map[string]interface{}
}

type _BlackoutResourcesScopeEntityListInner BlackoutResourcesScopeEntityListInner
...
func NewBlackoutResourcesScopeEntityListInner(entityType string) *BlackoutResourcesScopeEntityListInner {
	this := BlackoutResourcesScopeEntityListInner{}
...
// GetUuidList returns the UuidList field value if set, zero value otherwise.
func (o *BlackoutResourcesScopeEntityListInner) GetUuidList() []string {
	if o == nil || IsNil(o.UuidList) {
		var ret []string
		return ret
	}
	return o.UuidList
...
// GetUuidListOk returns a tuple with the UuidList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlackoutResourcesScopeEntityListInner) GetUuidListOk() ([]string, bool) {
	if o == nil || IsNil(o.UuidList) {
		return nil, false
	}
	return o.UuidList, true
}
...
// SetUuidList gets a reference to the given []string and assigns it to the UuidList field.
...
func (o BlackoutResourcesScopeEntityListInner) MarshalJSON() ([]byte, error) {
...
func (o BlackoutResourcesScopeEntityListInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.UuidList) {
		toSerialize["uuid_list"] = o.UuidList
	}
...
func (o *BlackoutResourcesScopeEntityListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varBlackoutResourcesScopeEntityListInner := _BlackoutResourcesScopeEntityListInner{}

	err = json.Unmarshal(data, &varBlackoutResourcesScopeEntityListInner)

	if err != nil {
		return err
	}

	*o = BlackoutResourcesScopeEntityListInner(varBlackoutResourcesScopeEntityListInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "uuid_list")
...
type NullableBlackoutResourcesScopeEntityListInner struct {
	value *BlackoutResourcesScopeEntityListInner
	isSet bool
}

func (v NullableBlackoutResourcesScopeEntityListInner) Get() *BlackoutResourcesScopeEntityListInner {
	return v.value
}

func (v *NullableBlackoutResourcesScopeEntityListInner) Set(val *BlackoutResourcesScopeEntityListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBlackoutResourcesScopeEntityListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBlackoutResourcesScopeEntityListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlackoutResourcesScopeEntityListInner(val *BlackoutResourcesScopeEntityListInner) *NullableBlackoutResourcesScopeEntityListInner {
	return &NullableBlackoutResourcesScopeEntityListInner{value: val, isSet: true}
}

func (v NullableBlackoutResourcesScopeEntityListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlackoutResourcesScopeEntityListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
