...
// checks if the StreamingPolicyIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyIntentResponse{}

// StreamingPolicyIntentResponse Response object for intentful operations on a streaming_policy
type StreamingPolicyIntentResponse struct {
...
type _StreamingPolicyIntentResponse StreamingPolicyIntentResponse
...
func NewStreamingPolicyIntentResponse(apiVersion string, metadata StreamingPolicyMetadata) *StreamingPolicyIntentResponse {
	this := StreamingPolicyIntentResponse{}
...
func (o StreamingPolicyIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicyIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varStreamingPolicyIntentResponse := _StreamingPolicyIntentResponse{}

	err = json.Unmarshal(data, &varStreamingPolicyIntentResponse)

	if err != nil {
		return err
	}

	*o = StreamingPolicyIntentResponse(varStreamingPolicyIntentResponse)
...
type NullableStreamingPolicyIntentResponse struct {
	value *StreamingPolicyIntentResponse
	isSet bool
}

func (v NullableStreamingPolicyIntentResponse) Get() *StreamingPolicyIntentResponse {
	return v.value
}

func (v *NullableStreamingPolicyIntentResponse) Set(val *StreamingPolicyIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyIntentResponse(val *StreamingPolicyIntentResponse) *NullableStreamingPolicyIntentResponse {
	return &NullableStreamingPolicyIntentResponse{value: val, isSet: true}
}

func (v NullableStreamingPolicyIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
