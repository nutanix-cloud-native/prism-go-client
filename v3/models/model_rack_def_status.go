...
// checks if the RackDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackDefStatus{}

// RackDefStatus Rack entity status defintion
type RackDefStatus struct {
	// The state of the rack entity
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	// Rack Name
	Name string `json:"name"`
	Resources RackResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _RackDefStatus RackDefStatus
...
func (o RackDefStatus) MarshalJSON() ([]byte, error) {
...
func (o RackDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RackDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varRackDefStatus := _RackDefStatus{}

	err = json.Unmarshal(data, &varRackDefStatus)

	if err != nil {
		return err
	}

	*o = RackDefStatus(varRackDefStatus)
...
type NullableRackDefStatus struct {
	value *RackDefStatus
	isSet bool
}

func (v NullableRackDefStatus) Get() *RackDefStatus {
	return v.value
}

func (v *NullableRackDefStatus) Set(val *RackDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRackDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRackDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackDefStatus(val *RackDefStatus) *NullableRackDefStatus {
	return &NullableRackDefStatus{value: val, isSet: true}
}

func (v NullableRackDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
