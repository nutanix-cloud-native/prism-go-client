...
// checks if the AppVariableResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppVariableResponse{}

// AppVariableResponse Variable definition for application.
type AppVariableResponse struct {
	// 
...
type _AppVariableResponse AppVariableResponse
...
func (o AppVariableResponse) MarshalJSON() ([]byte, error) {
...
func (o AppVariableResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppVariableResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppVariableResponse := _AppVariableResponse{}

	err = json.Unmarshal(data, &varAppVariableResponse)

	if err != nil {
		return err
	}

	*o = AppVariableResponse(varAppVariableResponse)
...
type NullableAppVariableResponse struct {
	value *AppVariableResponse
	isSet bool
}

func (v NullableAppVariableResponse) Get() *AppVariableResponse {
	return v.value
}

func (v *NullableAppVariableResponse) Set(val *AppVariableResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppVariableResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppVariableResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppVariableResponse(val *AppVariableResponse) *NullableAppVariableResponse {
	return &NullableAppVariableResponse{value: val, isSet: true}
}

func (v NullableAppVariableResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppVariableResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
