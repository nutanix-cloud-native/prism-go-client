...
// Result Object describing the search query result.
type Result struct {
	DisambiguatedSearches *Perspective `json:"disambiguated_searches,omitempty"`
	ActivePerspective *Perspective `json:"active_perspective,omitempty"`
	// Each result contains a set of perspectives links eg. summary, entities, alerts, metrics, etc.. These are used to populate the left hand navigation panel. These perspective links can be grouped together into different groups. So we send back a list of such perspective groups. 
	PerspectiveGroupList []PerspectiveLinkGroup `json:"perspective_group_list,omitempty"`
...
// GetDisambiguatedSearches returns the DisambiguatedSearches field value if set, zero value otherwise.
func (o *Result) GetDisambiguatedSearches() Perspective {
	if o == nil || IsNil(o.DisambiguatedSearches) {
		var ret Perspective
		return ret
	}
	return *o.DisambiguatedSearches
}

// GetDisambiguatedSearchesOk returns a tuple with the DisambiguatedSearches field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Result) GetDisambiguatedSearchesOk() (*Perspective, bool) {
	if o == nil || IsNil(o.DisambiguatedSearches) {
		return nil, false
	}
	return o.DisambiguatedSearches, true
}
...
// SetDisambiguatedSearches gets a reference to the given Perspective and assigns it to the DisambiguatedSearches field.
func (o *Result) SetDisambiguatedSearches(v Perspective) {
	o.DisambiguatedSearches = &v
}

// GetActivePerspective returns the ActivePerspective field value if set, zero value otherwise.
func (o *Result) GetActivePerspective() Perspective {
	if o == nil || IsNil(o.ActivePerspective) {
		var ret Perspective
		return ret
	}
	return *o.ActivePerspective
}

// GetActivePerspectiveOk returns a tuple with the ActivePerspective field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Result) GetActivePerspectiveOk() (*Perspective, bool) {
	if o == nil || IsNil(o.ActivePerspective) {
		return nil, false
	}
	return o.ActivePerspective, true
}
...
// SetActivePerspective gets a reference to the given Perspective and assigns it to the ActivePerspective field.
func (o *Result) SetActivePerspective(v Perspective) {
	o.ActivePerspective = &v
}

// GetPerspectiveGroupList returns the PerspectiveGroupList field value if set, zero value otherwise.
func (o *Result) GetPerspectiveGroupList() []PerspectiveLinkGroup {
	if o == nil || IsNil(o.PerspectiveGroupList) {
		var ret []PerspectiveLinkGroup
		return ret
	}
	return o.PerspectiveGroupList
}

// GetPerspectiveGroupListOk returns a tuple with the PerspectiveGroupList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Result) GetPerspectiveGroupListOk() ([]PerspectiveLinkGroup, bool) {
	if o == nil || IsNil(o.PerspectiveGroupList) {
		return nil, false
	}
	return o.PerspectiveGroupList, true
}
...
// SetPerspectiveGroupList gets a reference to the given []PerspectiveLinkGroup and assigns it to the PerspectiveGroupList field.
func (o *Result) SetPerspectiveGroupList(v []PerspectiveLinkGroup) {
	o.PerspectiveGroupList = v
}
...
func (o Result) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DisambiguatedSearches) {
		toSerialize["disambiguated_searches"] = o.DisambiguatedSearches
	}
	if !IsNil(o.ActivePerspective) {
		toSerialize["active_perspective"] = o.ActivePerspective
	}
	if !IsNil(o.PerspectiveGroupList) {
		toSerialize["perspective_group_list"] = o.PerspectiveGroupList
	}
...
func (o *Result) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Result(varResult)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "disambiguated_searches")
		delete(additionalProperties, "active_perspective")
		delete(additionalProperties, "perspective_group_list")
