...
// checks if the SupportCaseListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseListIntentResponse{}

// SupportCaseListIntentResponse Response object for intentful operation of support_cases
type SupportCaseListIntentResponse struct {
	Entities []SupportCaseIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata SupportCaseListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _SupportCaseListIntentResponse SupportCaseListIntentResponse
...
func NewSupportCaseListIntentResponse(apiVersion string, metadata SupportCaseListMetadataOutput) *SupportCaseListIntentResponse {
	this := SupportCaseListIntentResponse{}
...
func (o *SupportCaseListIntentResponse) GetEntities() []SupportCaseIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []SupportCaseIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []SupportCaseIntentResource and assigns it to the Entities field.
...
func (o *SupportCaseListIntentResponse) GetMetadata() SupportCaseListMetadataOutput {
	if o == nil {
		var ret SupportCaseListMetadataOutput
		return ret
	}
...
func (o SupportCaseListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseListIntentResponse := _SupportCaseListIntentResponse{}

	err = json.Unmarshal(data, &varSupportCaseListIntentResponse)

	if err != nil {
		return err
	}

	*o = SupportCaseListIntentResponse(varSupportCaseListIntentResponse)
...
type NullableSupportCaseListIntentResponse struct {
	value *SupportCaseListIntentResponse
	isSet bool
}

func (v NullableSupportCaseListIntentResponse) Get() *SupportCaseListIntentResponse {
	return v.value
}

func (v *NullableSupportCaseListIntentResponse) Set(val *SupportCaseListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseListIntentResponse(val *SupportCaseListIntentResponse) *NullableSupportCaseListIntentResponse {
	return &NullableSupportCaseListIntentResponse{value: val, isSet: true}
}

func (v NullableSupportCaseListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
