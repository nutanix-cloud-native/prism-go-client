...
// checks if the VmReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmReference{}

// VmReference The reference to a vm
...
func (o VmReference) MarshalJSON() ([]byte, error) {
...
func (o VmReference) ToMap() (map[string]interface{}, error) {
...
func (o *VmReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVmReference := _VmReference{}

	err = json.Unmarshal(data, &varVmReference)

	if err != nil {
		return err
	}

	*o = VmReference(varVmReference)
...
type NullableVmReference struct {
	value *VmReference
	isSet bool
}

func (v NullableVmReference) Get() *VmReference {
	return v.value
}

func (v *NullableVmReference) Set(val *VmReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVmReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVmReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmReference(val *VmReference) *NullableVmReference {
	return &NullableVmReference{value: val, isSet: true}
}

func (v NullableVmReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
