...
// checks if the DirectoryServiceReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceReference{}

// DirectoryServiceReference The reference to a directory_service
...
type _DirectoryServiceReference DirectoryServiceReference
...
func (o DirectoryServiceReference) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceReference) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryServiceReference) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectoryServiceReference := _DirectoryServiceReference{}

	err = json.Unmarshal(data, &varDirectoryServiceReference)

	if err != nil {
		return err
	}

	*o = DirectoryServiceReference(varDirectoryServiceReference)
...
type NullableDirectoryServiceReference struct {
	value *DirectoryServiceReference
	isSet bool
}

func (v NullableDirectoryServiceReference) Get() *DirectoryServiceReference {
	return v.value
}

func (v *NullableDirectoryServiceReference) Set(val *DirectoryServiceReference) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceReference) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceReference(val *DirectoryServiceReference) *NullableDirectoryServiceReference {
	return &NullableDirectoryServiceReference{value: val, isSet: true}
}

func (v NullableDirectoryServiceReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
