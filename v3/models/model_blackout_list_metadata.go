...
// checks if the BlackoutListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackoutListMetadata{}

// BlackoutListMetadata All api calls that return a list will have this metadata block as input 
type BlackoutListMetadata struct {
	// The kind name
...
type _BlackoutListMetadata BlackoutListMetadata
...
func (o BlackoutListMetadata) MarshalJSON() ([]byte, error) {
...
func (o BlackoutListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *BlackoutListMetadata) UnmarshalJSON(data []byte) (err error) {
	varBlackoutListMetadata := _BlackoutListMetadata{}

	err = json.Unmarshal(data, &varBlackoutListMetadata)

	if err != nil {
		return err
	}

	*o = BlackoutListMetadata(varBlackoutListMetadata)
...
type NullableBlackoutListMetadata struct {
	value *BlackoutListMetadata
	isSet bool
}

func (v NullableBlackoutListMetadata) Get() *BlackoutListMetadata {
	return v.value
}

func (v *NullableBlackoutListMetadata) Set(val *BlackoutListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableBlackoutListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableBlackoutListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlackoutListMetadata(val *BlackoutListMetadata) *NullableBlackoutListMetadata {
	return &NullableBlackoutListMetadata{value: val, isSet: true}
}

func (v NullableBlackoutListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlackoutListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
