...
// checks if the VmRestoreOverrideSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRestoreOverrideSpec{}

// VmRestoreOverrideSpec Properties of the vm that can be overriden. 
type VmRestoreOverrideSpec struct {
	// vm Name.
...
type _VmRestoreOverrideSpec VmRestoreOverrideSpec
...
func (o VmRestoreOverrideSpec) MarshalJSON() ([]byte, error) {
...
func (o VmRestoreOverrideSpec) ToMap() (map[string]interface{}, error) {
...
func (o *VmRestoreOverrideSpec) UnmarshalJSON(data []byte) (err error) {
	varVmRestoreOverrideSpec := _VmRestoreOverrideSpec{}

	err = json.Unmarshal(data, &varVmRestoreOverrideSpec)

	if err != nil {
		return err
	}

	*o = VmRestoreOverrideSpec(varVmRestoreOverrideSpec)
...
type NullableVmRestoreOverrideSpec struct {
	value *VmRestoreOverrideSpec
	isSet bool
}

func (v NullableVmRestoreOverrideSpec) Get() *VmRestoreOverrideSpec {
	return v.value
}

func (v *NullableVmRestoreOverrideSpec) Set(val *VmRestoreOverrideSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRestoreOverrideSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRestoreOverrideSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRestoreOverrideSpec(val *VmRestoreOverrideSpec) *NullableVmRestoreOverrideSpec {
	return &NullableVmRestoreOverrideSpec{value: val, isSet: true}
}

func (v NullableVmRestoreOverrideSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRestoreOverrideSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
