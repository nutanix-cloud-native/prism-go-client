...
// checks if the MarketplaceItemIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemIntentResponse{}

// MarketplaceItemIntentResponse Response object for intentful operations on a marketplace_item
type MarketplaceItemIntentResponse struct {
	Status *MarketplaceItemDefStatus `json:"status,omitempty"`
	Spec *MarketplaceItem `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata MarketplaceItemMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _MarketplaceItemIntentResponse MarketplaceItemIntentResponse
...
func NewMarketplaceItemIntentResponse(apiVersion string, metadata MarketplaceItemMetadata) *MarketplaceItemIntentResponse {
	this := MarketplaceItemIntentResponse{}
...
func (o *MarketplaceItemIntentResponse) GetStatus() MarketplaceItemDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret MarketplaceItemDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given MarketplaceItemDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given MarketplaceItem and assigns it to the Spec field.
...
func (o *MarketplaceItemIntentResponse) GetMetadata() MarketplaceItemMetadata {
	if o == nil {
		var ret MarketplaceItemMetadata
		return ret
	}
...
func (o MarketplaceItemIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItemIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceItemIntentResponse := _MarketplaceItemIntentResponse{}

	err = json.Unmarshal(data, &varMarketplaceItemIntentResponse)

	if err != nil {
		return err
	}

	*o = MarketplaceItemIntentResponse(varMarketplaceItemIntentResponse)
...
type NullableMarketplaceItemIntentResponse struct {
	value *MarketplaceItemIntentResponse
	isSet bool
}

func (v NullableMarketplaceItemIntentResponse) Get() *MarketplaceItemIntentResponse {
	return v.value
}

func (v *NullableMarketplaceItemIntentResponse) Set(val *MarketplaceItemIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemIntentResponse(val *MarketplaceItemIntentResponse) *NullableMarketplaceItemIntentResponse {
	return &NullableMarketplaceItemIntentResponse{value: val, isSet: true}
}

func (v NullableMarketplaceItemIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
