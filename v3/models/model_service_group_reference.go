...
// checks if the ServiceGroupReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceGroupReference{}

// ServiceGroupReference The reference to a service_group
type ServiceGroupReference struct {
	// The kind name
...
type _ServiceGroupReference ServiceGroupReference
...
func (o ServiceGroupReference) MarshalJSON() ([]byte, error) {
...
func (o ServiceGroupReference) ToMap() (map[string]interface{}, error) {
...
func (o *ServiceGroupReference) UnmarshalJSON(data []byte) (err error) {
	...
	varServiceGroupReference := _ServiceGroupReference{}

	err = json.Unmarshal(data, &varServiceGroupReference)

	if err != nil {
		return err
	}

	*o = ServiceGroupReference(varServiceGroupReference)
...
type NullableServiceGroupReference struct {
	value *ServiceGroupReference
	isSet bool
}

func (v NullableServiceGroupReference) Get() *ServiceGroupReference {
	return v.value
}

func (v *NullableServiceGroupReference) Set(val *ServiceGroupReference) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceGroupReference) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceGroupReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceGroupReference(val *ServiceGroupReference) *NullableServiceGroupReference {
	return &NullableServiceGroupReference{value: val, isSet: true}
}

func (v NullableServiceGroupReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceGroupReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
