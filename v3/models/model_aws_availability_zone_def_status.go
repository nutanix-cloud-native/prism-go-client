...
// checks if the AwsAvailabilityZoneDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsAvailabilityZoneDefStatus{}

// AwsAvailabilityZoneDefStatus aws_availability_zone resources status
type AwsAvailabilityZoneDefStatus struct {
	State *string `json:"state,omitempty"`
	// aws_availability_zone name.
	Name *string `json:"name,omitempty"`
	Resources *AwsAvailabilityZoneResourcesDefStatus `json:"resources,omitempty"`
	// A description for aws_availability_zone.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsAvailabilityZoneDefStatus AwsAvailabilityZoneDefStatus
...
func NewAwsAvailabilityZoneDefStatus() *AwsAvailabilityZoneDefStatus {
	this := AwsAvailabilityZoneDefStatus{}
	return &this
}
...
func (o *AwsAvailabilityZoneDefStatus) GetResources() AwsAvailabilityZoneResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret AwsAvailabilityZoneResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given AwsAvailabilityZoneResourcesDefStatus and assigns it to the Resources field.
...
func (o AwsAvailabilityZoneDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsAvailabilityZoneDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsAvailabilityZoneDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsAvailabilityZoneDefStatus := _AwsAvailabilityZoneDefStatus{}

	err = json.Unmarshal(data, &varAwsAvailabilityZoneDefStatus)

	if err != nil {
		return err
	}

	*o = AwsAvailabilityZoneDefStatus(varAwsAvailabilityZoneDefStatus)
...
type NullableAwsAvailabilityZoneDefStatus struct {
	value *AwsAvailabilityZoneDefStatus
	isSet bool
}

func (v NullableAwsAvailabilityZoneDefStatus) Get() *AwsAvailabilityZoneDefStatus {
	return v.value
}

func (v *NullableAwsAvailabilityZoneDefStatus) Set(val *AwsAvailabilityZoneDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsAvailabilityZoneDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsAvailabilityZoneDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsAvailabilityZoneDefStatus(val *AwsAvailabilityZoneDefStatus) *NullableAwsAvailabilityZoneDefStatus {
	return &NullableAwsAvailabilityZoneDefStatus{value: val, isSet: true}
}

func (v NullableAwsAvailabilityZoneDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsAvailabilityZoneDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
