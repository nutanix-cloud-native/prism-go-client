...
// checks if the AwsMachineTypeDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsMachineTypeDefStatus{}

// AwsMachineTypeDefStatus aws_machine_type resources status
type AwsMachineTypeDefStatus struct {
	State *string `json:"state,omitempty"`
	// aws_machine_type name.
	Name *string `json:"name,omitempty"`
	Resources *AwsMachineTypeResourcesDefStatus `json:"resources,omitempty"`
	// A description for aws_machine_type.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsMachineTypeDefStatus AwsMachineTypeDefStatus
...
func (o *AwsMachineTypeDefStatus) GetResources() AwsMachineTypeResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret AwsMachineTypeResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given AwsMachineTypeResourcesDefStatus and assigns it to the Resources field.
...
func (o AwsMachineTypeDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsMachineTypeDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsMachineTypeDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsMachineTypeDefStatus := _AwsMachineTypeDefStatus{}

	err = json.Unmarshal(data, &varAwsMachineTypeDefStatus)

	if err != nil {
		return err
	}

	*o = AwsMachineTypeDefStatus(varAwsMachineTypeDefStatus)
...
type NullableAwsMachineTypeDefStatus struct {
	value *AwsMachineTypeDefStatus
	isSet bool
}

func (v NullableAwsMachineTypeDefStatus) Get() *AwsMachineTypeDefStatus {
	return v.value
}

func (v *NullableAwsMachineTypeDefStatus) Set(val *AwsMachineTypeDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsMachineTypeDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsMachineTypeDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsMachineTypeDefStatus(val *AwsMachineTypeDefStatus) *NullableAwsMachineTypeDefStatus {
	return &NullableAwsMachineTypeDefStatus{value: val, isSet: true}
}

func (v NullableAwsMachineTypeDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsMachineTypeDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
