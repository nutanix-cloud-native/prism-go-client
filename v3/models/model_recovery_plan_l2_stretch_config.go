...
// checks if the RecoveryPlanL2StretchConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanL2StretchConfig{}

// RecoveryPlanL2StretchConfig Configuration for the Layer2 stretch of the subnet.
type RecoveryPlanL2StretchConfig struct {
	...
	LocalVtepInterfaceIpAddress string `json:"local_vtep_interface_ip_address" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	RemoteVtepGatewayReference VtepGatewayReference `json:"remote_vtep_gateway_reference"`
	LocalVtepGatewayConfig VTEPGatewayConfiguration `json:"local_vtep_gateway_config"`
	// VTEP Interface IP address on site to which subnet is extended. 
	RemoteVtepInterfaceIpAddress string `json:"remote_vtep_interface_ip_address" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanL2StretchConfig RecoveryPlanL2StretchConfig
...
func NewRecoveryPlanL2StretchConfig(localVtepInterfaceIpAddress string, remoteVtepGatewayReference VtepGatewayReference, localVtepGatewayConfig VTEPGatewayConfiguration, remoteVtepInterfaceIpAddress string) *RecoveryPlanL2StretchConfig {
	this := RecoveryPlanL2StretchConfig{}
	this.LocalVtepInterfaceIpAddress = localVtepInterfaceIpAddress
	this.RemoteVtepGatewayReference = remoteVtepGatewayReference
	this.LocalVtepGatewayConfig = localVtepGatewayConfig
	this.RemoteVtepInterfaceIpAddress = remoteVtepInterfaceIpAddress
	return &this
}
...
// GetLocalVtepInterfaceIpAddress returns the LocalVtepInterfaceIpAddress field value
func (o *RecoveryPlanL2StretchConfig) GetLocalVtepInterfaceIpAddress() string {
	...
	return o.LocalVtepInterfaceIpAddress
}

// GetLocalVtepInterfaceIpAddressOk returns a tuple with the LocalVtepInterfaceIpAddress field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanL2StretchConfig) GetLocalVtepInterfaceIpAddressOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.LocalVtepInterfaceIpAddress, true
}

// SetLocalVtepInterfaceIpAddress sets field value
func (o *RecoveryPlanL2StretchConfig) SetLocalVtepInterfaceIpAddress(v string) {
	o.LocalVtepInterfaceIpAddress = v
}

// GetRemoteVtepGatewayReference returns the RemoteVtepGatewayReference field value
func (o *RecoveryPlanL2StretchConfig) GetRemoteVtepGatewayReference() VtepGatewayReference {
	if o == nil {
		var ret VtepGatewayReference
		return ret
	}

	return o.RemoteVtepGatewayReference
}

// GetRemoteVtepGatewayReferenceOk returns a tuple with the RemoteVtepGatewayReference field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanL2StretchConfig) GetRemoteVtepGatewayReferenceOk() (*VtepGatewayReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RemoteVtepGatewayReference, true
}

// SetRemoteVtepGatewayReference sets field value
func (o *RecoveryPlanL2StretchConfig) SetRemoteVtepGatewayReference(v VtepGatewayReference) {
	o.RemoteVtepGatewayReference = v
}

// GetLocalVtepGatewayConfig returns the LocalVtepGatewayConfig field value
func (o *RecoveryPlanL2StretchConfig) GetLocalVtepGatewayConfig() VTEPGatewayConfiguration {
	if o == nil {
		var ret VTEPGatewayConfiguration
		return ret
	}

	return o.LocalVtepGatewayConfig
}

// GetLocalVtepGatewayConfigOk returns a tuple with the LocalVtepGatewayConfig field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanL2StretchConfig) GetLocalVtepGatewayConfigOk() (*VTEPGatewayConfiguration, bool) {
	if o == nil {
		return nil, false
	}
	return &o.LocalVtepGatewayConfig, true
}

// SetLocalVtepGatewayConfig sets field value
func (o *RecoveryPlanL2StretchConfig) SetLocalVtepGatewayConfig(v VTEPGatewayConfiguration) {
	o.LocalVtepGatewayConfig = v
}

// GetRemoteVtepInterfaceIpAddress returns the RemoteVtepInterfaceIpAddress field value
func (o *RecoveryPlanL2StretchConfig) GetRemoteVtepInterfaceIpAddress() string {
	...
	return o.RemoteVtepInterfaceIpAddress
}

// GetRemoteVtepInterfaceIpAddressOk returns a tuple with the RemoteVtepInterfaceIpAddress field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanL2StretchConfig) GetRemoteVtepInterfaceIpAddressOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RemoteVtepInterfaceIpAddress, true
}

// SetRemoteVtepInterfaceIpAddress sets field value
func (o *RecoveryPlanL2StretchConfig) SetRemoteVtepInterfaceIpAddress(v string) {
	o.RemoteVtepInterfaceIpAddress = v
}

func (o RecoveryPlanL2StretchConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanL2StretchConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["local_vtep_interface_ip_address"] = o.LocalVtepInterfaceIpAddress
	toSerialize["remote_vtep_gateway_reference"] = o.RemoteVtepGatewayReference
	toSerialize["local_vtep_gateway_config"] = o.LocalVtepGatewayConfig
	toSerialize["remote_vtep_interface_ip_address"] = o.RemoteVtepInterfaceIpAddress
...
func (o *RecoveryPlanL2StretchConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanL2StretchConfig := _RecoveryPlanL2StretchConfig{}

	err = json.Unmarshal(data, &varRecoveryPlanL2StretchConfig)

	if err != nil {
		return err
	}

	*o = RecoveryPlanL2StretchConfig(varRecoveryPlanL2StretchConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "local_vtep_interface_ip_address")
		delete(additionalProperties, "remote_vtep_gateway_reference")
		delete(additionalProperties, "local_vtep_gateway_config")
		delete(additionalProperties, "remote_vtep_interface_ip_address")
...
type NullableRecoveryPlanL2StretchConfig struct {
	value *RecoveryPlanL2StretchConfig
	isSet bool
}

func (v NullableRecoveryPlanL2StretchConfig) Get() *RecoveryPlanL2StretchConfig {
	return v.value
}

func (v *NullableRecoveryPlanL2StretchConfig) Set(val *RecoveryPlanL2StretchConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanL2StretchConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanL2StretchConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanL2StretchConfig(val *RecoveryPlanL2StretchConfig) *NullableRecoveryPlanL2StretchConfig {
	return &NullableRecoveryPlanL2StretchConfig{value: val, isSet: true}
}

func (v NullableRecoveryPlanL2StretchConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanL2StretchConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
