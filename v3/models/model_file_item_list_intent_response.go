...
// checks if the FileItemListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemListIntentResponse{}

// FileItemListIntentResponse Response object for intentful operation of file_items
type FileItemListIntentResponse struct {
	Entities []FileItemIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata FileItemListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _FileItemListIntentResponse FileItemListIntentResponse
...
func NewFileItemListIntentResponse(apiVersion string, metadata FileItemListMetadataOutput) *FileItemListIntentResponse {
	this := FileItemListIntentResponse{}
...
func (o *FileItemListIntentResponse) GetEntities() []FileItemIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []FileItemIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []FileItemIntentResource and assigns it to the Entities field.
...
func (o *FileItemListIntentResponse) GetMetadata() FileItemListMetadataOutput {
	if o == nil {
		var ret FileItemListMetadataOutput
		return ret
	}
...
func (o FileItemListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o FileItemListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *FileItemListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varFileItemListIntentResponse := _FileItemListIntentResponse{}

	err = json.Unmarshal(data, &varFileItemListIntentResponse)

	if err != nil {
		return err
	}

	*o = FileItemListIntentResponse(varFileItemListIntentResponse)
...
type NullableFileItemListIntentResponse struct {
	value *FileItemListIntentResponse
	isSet bool
}

func (v NullableFileItemListIntentResponse) Get() *FileItemListIntentResponse {
	return v.value
}

func (v *NullableFileItemListIntentResponse) Set(val *FileItemListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemListIntentResponse(val *FileItemListIntentResponse) *NullableFileItemListIntentResponse {
	return &NullableFileItemListIntentResponse{value: val, isSet: true}
}

func (v NullableFileItemListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
