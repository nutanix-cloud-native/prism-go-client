...
// checks if the ActionRuleListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleListMetadata{}

// ActionRuleListMetadata All api calls that return a list will have this metadata block as input 
type ActionRuleListMetadata struct {
	// The kind name
...
type _ActionRuleListMetadata ActionRuleListMetadata
...
func (o ActionRuleListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleListMetadata) UnmarshalJSON(data []byte) (err error) {
	varActionRuleListMetadata := _ActionRuleListMetadata{}

	err = json.Unmarshal(data, &varActionRuleListMetadata)

	if err != nil {
		return err
	}

	*o = ActionRuleListMetadata(varActionRuleListMetadata)
...
type NullableActionRuleListMetadata struct {
	value *ActionRuleListMetadata
	isSet bool
}

func (v NullableActionRuleListMetadata) Get() *ActionRuleListMetadata {
	return v.value
}

func (v *NullableActionRuleListMetadata) Set(val *ActionRuleListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleListMetadata(val *ActionRuleListMetadata) *NullableActionRuleListMetadata {
	return &NullableActionRuleListMetadata{value: val, isSet: true}
}

func (v NullableActionRuleListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
