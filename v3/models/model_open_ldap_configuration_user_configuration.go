...
// checks if the OpenLdapConfigurationUserConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenLdapConfigurationUserConfiguration{}

// OpenLdapConfigurationUserConfiguration struct for OpenLdapConfigurationUserConfiguration
type OpenLdapConfigurationUserConfiguration struct {
...
type _OpenLdapConfigurationUserConfiguration OpenLdapConfigurationUserConfiguration
...
func NewOpenLdapConfigurationUserConfiguration(userSearchBase string, userObjectClass string, usernameAttribute string) *OpenLdapConfigurationUserConfiguration {
	this := OpenLdapConfigurationUserConfiguration{}
...
func (o OpenLdapConfigurationUserConfiguration) MarshalJSON() ([]byte, error) {
...
func (o OpenLdapConfigurationUserConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *OpenLdapConfigurationUserConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenLdapConfigurationUserConfiguration := _OpenLdapConfigurationUserConfiguration{}

	err = json.Unmarshal(data, &varOpenLdapConfigurationUserConfiguration)

	if err != nil {
		return err
	}

	*o = OpenLdapConfigurationUserConfiguration(varOpenLdapConfigurationUserConfiguration)
...
type NullableOpenLdapConfigurationUserConfiguration struct {
	value *OpenLdapConfigurationUserConfiguration
	isSet bool
}

func (v NullableOpenLdapConfigurationUserConfiguration) Get() *OpenLdapConfigurationUserConfiguration {
	return v.value
}

func (v *NullableOpenLdapConfigurationUserConfiguration) Set(val *OpenLdapConfigurationUserConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenLdapConfigurationUserConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenLdapConfigurationUserConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenLdapConfigurationUserConfiguration(val *OpenLdapConfigurationUserConfiguration) *NullableOpenLdapConfigurationUserConfiguration {
	return &NullableOpenLdapConfigurationUserConfiguration{value: val, isSet: true}
}

func (v NullableOpenLdapConfigurationUserConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenLdapConfigurationUserConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
