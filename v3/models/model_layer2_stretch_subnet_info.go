...
// checks if the Layer2StretchSubnetInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchSubnetInfo{}

// Layer2StretchSubnetInfo Layer2 stretch related entities subnet info.
type Layer2StretchSubnetInfo struct {
	IpSubnet *IpSubnetStatus `json:"ip_subnet,omitempty"`
...
type _Layer2StretchSubnetInfo Layer2StretchSubnetInfo
...
// SetIpSubnet gets a reference to the given IpSubnetStatus and assigns it to the IpSubnet field.
...
func (o Layer2StretchSubnetInfo) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchSubnetInfo) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchSubnetInfo) UnmarshalJSON(data []byte) (err error) {
	varLayer2StretchSubnetInfo := _Layer2StretchSubnetInfo{}

	err = json.Unmarshal(data, &varLayer2StretchSubnetInfo)

	if err != nil {
		return err
	}

	*o = Layer2StretchSubnetInfo(varLayer2StretchSubnetInfo)
...
type NullableLayer2StretchSubnetInfo struct {
	value *Layer2StretchSubnetInfo
	isSet bool
}

func (v NullableLayer2StretchSubnetInfo) Get() *Layer2StretchSubnetInfo {
	return v.value
}

func (v *NullableLayer2StretchSubnetInfo) Set(val *Layer2StretchSubnetInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchSubnetInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchSubnetInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchSubnetInfo(val *Layer2StretchSubnetInfo) *NullableLayer2StretchSubnetInfo {
	return &NullableLayer2StretchSubnetInfo{value: val, isSet: true}
}

func (v NullableLayer2StretchSubnetInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchSubnetInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
