...
// checks if the SoftwareMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareMetadata{}

// SoftwareMetadata The software kind metadata
type SoftwareMetadata struct {
	...
	// Categories for the software. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the software. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _SoftwareMetadata SoftwareMetadata
...
func (o SoftwareMetadata) MarshalJSON() ([]byte, error) {
...
func (o SoftwareMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SoftwareMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varSoftwareMetadata := _SoftwareMetadata{}

	err = json.Unmarshal(data, &varSoftwareMetadata)

	if err != nil {
		return err
	}

	*o = SoftwareMetadata(varSoftwareMetadata)
...
type NullableSoftwareMetadata struct {
	value *SoftwareMetadata
	isSet bool
}

func (v NullableSoftwareMetadata) Get() *SoftwareMetadata {
	return v.value
}

func (v *NullableSoftwareMetadata) Set(val *SoftwareMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareMetadata(val *SoftwareMetadata) *NullableSoftwareMetadata {
	return &NullableSoftwareMetadata{value: val, isSet: true}
}

func (v NullableSoftwareMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
