...
// checks if the VmRecoveryPointIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPointIntentResource{}

// VmRecoveryPointIntentResource Response object for intentful operations on a vm_recovery_point
type VmRecoveryPointIntentResource struct {
	...
	Metadata VmRecoveryPointMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VmRecoveryPointIntentResource VmRecoveryPointIntentResource
...
func NewVmRecoveryPointIntentResource(metadata VmRecoveryPointMetadata) *VmRecoveryPointIntentResource {
	this := VmRecoveryPointIntentResource{}
...
func (o *VmRecoveryPointIntentResource) GetStatus() VmRecoveryPointDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret VmRecoveryPointDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given VmRecoveryPointDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given VmRecoveryPoint and assigns it to the Spec field.
...
func (o *VmRecoveryPointIntentResource) GetMetadata() VmRecoveryPointMetadata {
	if o == nil {
		var ret VmRecoveryPointMetadata
		return ret
	}
...
func (o VmRecoveryPointIntentResource) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPointIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPointIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varVmRecoveryPointIntentResource := _VmRecoveryPointIntentResource{}

	err = json.Unmarshal(data, &varVmRecoveryPointIntentResource)

	if err != nil {
		return err
	}

	*o = VmRecoveryPointIntentResource(varVmRecoveryPointIntentResource)
...
type NullableVmRecoveryPointIntentResource struct {
	value *VmRecoveryPointIntentResource
	isSet bool
}

func (v NullableVmRecoveryPointIntentResource) Get() *VmRecoveryPointIntentResource {
	return v.value
}

func (v *NullableVmRecoveryPointIntentResource) Set(val *VmRecoveryPointIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPointIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPointIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPointIntentResource(val *VmRecoveryPointIntentResource) *NullableVmRecoveryPointIntentResource {
	return &NullableVmRecoveryPointIntentResource{value: val, isSet: true}
}

func (v NullableVmRecoveryPointIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPointIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
