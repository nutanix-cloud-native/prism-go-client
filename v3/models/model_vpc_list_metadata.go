...
// checks if the VpcListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcListMetadata{}

// VpcListMetadata All api calls that return a list will have this metadata block as input 
type VpcListMetadata struct {
	// The kind name
...
type _VpcListMetadata VpcListMetadata
...
func (o VpcListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VpcListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VpcListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVpcListMetadata := _VpcListMetadata{}

	err = json.Unmarshal(data, &varVpcListMetadata)

	if err != nil {
		return err
	}

	*o = VpcListMetadata(varVpcListMetadata)
...
type NullableVpcListMetadata struct {
	value *VpcListMetadata
	isSet bool
}

func (v NullableVpcListMetadata) Get() *VpcListMetadata {
	return v.value
}

func (v *NullableVpcListMetadata) Set(val *VpcListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcListMetadata(val *VpcListMetadata) *NullableVpcListMetadata {
	return &NullableVpcListMetadata{value: val, isSet: true}
}

func (v NullableVpcListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
