...
// checks if the ActionRuleResultResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResultResources{}

// ActionRuleResultResources Action rule result entity definition
type ActionRuleResultResources struct {
	// Ordered list of action execution results.
	ActionResultList []ActionResult `json:"action_result_list"`
	// The execution status of an action or an action rule.
	PostExecutionActionStatus *string `json:"post_execution_action_status,omitempty"`
	ExecutionPlan RuleExecutionPlan `json:"execution_plan"`
	// The execution status of an action or an action rule.
	ExecutionStatus string `json:"execution_status"`
	ActionRuleReference ActionRuleReference `json:"action_rule_reference"`
	// The trigger or action required input parameter value map, or the output parameters. 
	RuleParameterValues *map[string]string `json:"rule_parameter_values,omitempty"`
	...
	// Ordered list of PAF action execution results.
	PostExecutionActionResultList []ActionResult `json:"post_execution_action_result_list,omitempty"`
	// The information about the triggers.
	TriggerInfoList []TriggerInfo `json:"trigger_info_list"`
	// The time the last action finished execution.
	ExecutionEndTime *time.Time `json:"execution_end_time,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ActionRuleResultResources ActionRuleResultResources
...
func NewActionRuleResultResources(actionResultList []ActionResult, executionPlan RuleExecutionPlan, executionStatus string, actionRuleReference ActionRuleReference, triggerInfoList []TriggerInfo) *ActionRuleResultResources {
	this := ActionRuleResultResources{}
	this.ActionResultList = actionResultList
	this.ExecutionPlan = executionPlan
	this.ExecutionStatus = executionStatus
	this.ActionRuleReference = actionRuleReference
...
// GetActionResultList returns the ActionResultList field value
func (o *ActionRuleResultResources) GetActionResultList() []ActionResult {
	...
	return o.ActionResultList
}

// GetActionResultListOk returns a tuple with the ActionResultList field value
// and a boolean to check if the value has been set.
func (o *ActionRuleResultResources) GetActionResultListOk() ([]ActionResult, bool) {
	if o == nil {
		return nil, false
	}
	return o.ActionResultList, true
}

// SetActionResultList sets field value
func (o *ActionRuleResultResources) SetActionResultList(v []ActionResult) {
	o.ActionResultList = v
}

// GetPostExecutionActionStatus returns the PostExecutionActionStatus field value if set, zero value otherwise.
func (o *ActionRuleResultResources) GetPostExecutionActionStatus() string {
	if o == nil || IsNil(o.PostExecutionActionStatus) {
		var ret string
		return ret
	}
	return *o.PostExecutionActionStatus
}

// GetPostExecutionActionStatusOk returns a tuple with the PostExecutionActionStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleResultResources) GetPostExecutionActionStatusOk() (*string, bool) {
	if o == nil || IsNil(o.PostExecutionActionStatus) {
		return nil, false
	}
	return o.PostExecutionActionStatus, true
}
...
// SetPostExecutionActionStatus gets a reference to the given string and assigns it to the PostExecutionActionStatus field.
func (o *ActionRuleResultResources) SetPostExecutionActionStatus(v string) {
	o.PostExecutionActionStatus = &v
}

// GetExecutionPlan returns the ExecutionPlan field value
func (o *ActionRuleResultResources) GetExecutionPlan() RuleExecutionPlan {
	if o == nil {
		var ret RuleExecutionPlan
		return ret
	}
...
// GetExecutionPlanOk returns a tuple with the ExecutionPlan field value
// and a boolean to check if the value has been set.
func (o *ActionRuleResultResources) GetExecutionPlanOk() (*RuleExecutionPlan, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ExecutionPlan, true
}

// SetExecutionPlan sets field value
...
// GetActionRuleReference returns the ActionRuleReference field value
func (o *ActionRuleResultResources) GetActionRuleReference() ActionRuleReference {
	if o == nil {
		var ret ActionRuleReference
		return ret
	}

	return o.ActionRuleReference
}

// GetActionRuleReferenceOk returns a tuple with the ActionRuleReference field value
// and a boolean to check if the value has been set.
func (o *ActionRuleResultResources) GetActionRuleReferenceOk() (*ActionRuleReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActionRuleReference, true
}

// SetActionRuleReference sets field value
func (o *ActionRuleResultResources) SetActionRuleReference(v ActionRuleReference) {
	o.ActionRuleReference = v
}

// GetRuleParameterValues returns the RuleParameterValues field value if set, zero value otherwise.
func (o *ActionRuleResultResources) GetRuleParameterValues() map[string]string {
	if o == nil || IsNil(o.RuleParameterValues) {
		var ret map[string]string
		return ret
	}
	return *o.RuleParameterValues
}

// GetRuleParameterValuesOk returns a tuple with the RuleParameterValues field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleResultResources) GetRuleParameterValuesOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.RuleParameterValues) {
		return nil, false
	}
	return o.RuleParameterValues, true
}
...
// SetRuleParameterValues gets a reference to the given map[string]string and assigns it to the RuleParameterValues field.
func (o *ActionRuleResultResources) SetRuleParameterValues(v map[string]string) {
	o.RuleParameterValues = &v
}

// GetExecutionMessages returns the ExecutionMessages field value if set, zero value otherwise.
func (o *ActionRuleResultResources) GetExecutionMessages() []string {
	if o == nil || IsNil(o.ExecutionMessages) {
		var ret []string
		return ret
	}
	return o.ExecutionMessages
}

// GetExecutionMessagesOk returns a tuple with the ExecutionMessages field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleResultResources) GetExecutionMessagesOk() ([]string, bool) {
	if o == nil || IsNil(o.ExecutionMessages) {
		return nil, false
	}
	return o.ExecutionMessages, true
}
...
// SetExecutionMessages gets a reference to the given []string and assigns it to the ExecutionMessages field.
func (o *ActionRuleResultResources) SetExecutionMessages(v []string) {
	o.ExecutionMessages = v
}
...
// GetPostExecutionActionResultList returns the PostExecutionActionResultList field value if set, zero value otherwise.
func (o *ActionRuleResultResources) GetPostExecutionActionResultList() []ActionResult {
	if o == nil || IsNil(o.PostExecutionActionResultList) {
		var ret []ActionResult
		return ret
	}
	return o.PostExecutionActionResultList
}

// GetPostExecutionActionResultListOk returns a tuple with the PostExecutionActionResultList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleResultResources) GetPostExecutionActionResultListOk() ([]ActionResult, bool) {
	if o == nil || IsNil(o.PostExecutionActionResultList) {
		return nil, false
	}
	return o.PostExecutionActionResultList, true
}
...
// SetPostExecutionActionResultList gets a reference to the given []ActionResult and assigns it to the PostExecutionActionResultList field.
func (o *ActionRuleResultResources) SetPostExecutionActionResultList(v []ActionResult) {
	o.PostExecutionActionResultList = v
}

// GetTriggerInfoList returns the TriggerInfoList field value
func (o *ActionRuleResultResources) GetTriggerInfoList() []TriggerInfo {
	...
	return o.TriggerInfoList
}

// GetTriggerInfoListOk returns a tuple with the TriggerInfoList field value
// and a boolean to check if the value has been set.
func (o *ActionRuleResultResources) GetTriggerInfoListOk() ([]TriggerInfo, bool) {
	if o == nil {
		return nil, false
	}
	return o.TriggerInfoList, true
}

// SetTriggerInfoList sets field value
func (o *ActionRuleResultResources) SetTriggerInfoList(v []TriggerInfo) {
	o.TriggerInfoList = v
}

// GetExecutionEndTime returns the ExecutionEndTime field value if set, zero value otherwise.
func (o *ActionRuleResultResources) GetExecutionEndTime() time.Time {
	if o == nil || IsNil(o.ExecutionEndTime) {
		var ret time.Time
		return ret
	}
	return *o.ExecutionEndTime
}

// GetExecutionEndTimeOk returns a tuple with the ExecutionEndTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleResultResources) GetExecutionEndTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.ExecutionEndTime) {
		return nil, false
	}
	return o.ExecutionEndTime, true
}
...
// SetExecutionEndTime gets a reference to the given time.Time and assigns it to the ExecutionEndTime field.
func (o *ActionRuleResultResources) SetExecutionEndTime(v time.Time) {
	o.ExecutionEndTime = &v
}

func (o ActionRuleResultResources) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResultResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["action_result_list"] = o.ActionResultList
	if !IsNil(o.PostExecutionActionStatus) {
		toSerialize["post_execution_action_status"] = o.PostExecutionActionStatus
	}
	toSerialize["execution_plan"] = o.ExecutionPlan
	toSerialize["execution_status"] = o.ExecutionStatus
	toSerialize["action_rule_reference"] = o.ActionRuleReference
	if !IsNil(o.RuleParameterValues) {
		toSerialize["rule_parameter_values"] = o.RuleParameterValues
	}
	if !IsNil(o.ExecutionMessages) {
		toSerialize["execution_messages"] = o.ExecutionMessages
	}
	if !IsNil(o.ExecutionStartTime) {
		toSerialize["execution_start_time"] = o.ExecutionStartTime
	}
	if !IsNil(o.PostExecutionActionResultList) {
		toSerialize["post_execution_action_result_list"] = o.PostExecutionActionResultList
	}
	toSerialize["trigger_info_list"] = o.TriggerInfoList
	if !IsNil(o.ExecutionEndTime) {
		toSerialize["execution_end_time"] = o.ExecutionEndTime
	}
...
func (o *ActionRuleResultResources) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleResultResources := _ActionRuleResultResources{}

	err = json.Unmarshal(data, &varActionRuleResultResources)

	if err != nil {
		return err
	}

	*o = ActionRuleResultResources(varActionRuleResultResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "action_result_list")
		delete(additionalProperties, "post_execution_action_status")
		delete(additionalProperties, "execution_plan")
		delete(additionalProperties, "execution_status")
		delete(additionalProperties, "action_rule_reference")
		delete(additionalProperties, "rule_parameter_values")
		delete(additionalProperties, "execution_messages")
		delete(additionalProperties, "execution_start_time")
		delete(additionalProperties, "post_execution_action_result_list")
		delete(additionalProperties, "trigger_info_list")
		delete(additionalProperties, "execution_end_time")
...
type NullableActionRuleResultResources struct {
	value *ActionRuleResultResources
	isSet bool
}

func (v NullableActionRuleResultResources) Get() *ActionRuleResultResources {
	return v.value
}

func (v *NullableActionRuleResultResources) Set(val *ActionRuleResultResources) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResultResources) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResultResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResultResources(val *ActionRuleResultResources) *NullableActionRuleResultResources {
	return &NullableActionRuleResultResources{value: val, isSet: true}
}

func (v NullableActionRuleResultResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResultResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
