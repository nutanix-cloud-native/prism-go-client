...
// checks if the ParamDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParamDescriptor{}

// ParamDescriptor The metadata describes what a parameter is.
type ParamDescriptor struct {
	DefaultValue *ActionServiceParamValue `json:"default_value,omitempty"`
	// Groups api filter to be used when determining the list of entities that are valid for param of type kEntityInfo 
	...
	ChoiceList []ParamDescriptorChoiceListInner `json:"choice_list,omitempty"`
	...
	// Deprecated
	EntityType *string `json:"entity_type,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
	ValueInfo *ValueInfo `json:"value_info,omitempty"`
	// The parameter's data type.  If the parameter is a list, it is the element data type. 
	ElementDataType string `json:"element_data_type"`
	...
	ParentParams []ParamDescriptorParentParamsInner `json:"parent_params,omitempty"`
...
type _ParamDescriptor ParamDescriptor
...
func (o *ParamDescriptor) GetDefaultValue() ActionServiceParamValue {
	if o == nil || IsNil(o.DefaultValue) {
		var ret ActionServiceParamValue
		return ret
	}
...
// SetDefaultValue gets a reference to the given ActionServiceParamValue and assigns it to the DefaultValue field.
...
// GetIsParameterized returns the IsParameterized field value if set, zero value otherwise.
func (o *ParamDescriptor) GetIsParameterized() bool {
	if o == nil || IsNil(o.IsParameterized) {
		var ret bool
		return ret
	}
	return *o.IsParameterized
}

// GetIsParameterizedOk returns a tuple with the IsParameterized field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ParamDescriptor) GetIsParameterizedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsParameterized) {
		return nil, false
	}
	return o.IsParameterized, true
}
...
// SetIsParameterized gets a reference to the given bool and assigns it to the IsParameterized field.
func (o *ParamDescriptor) SetIsParameterized(v bool) {
	o.IsParameterized = &v
}

// GetChoiceList returns the ChoiceList field value if set, zero value otherwise.
func (o *ParamDescriptor) GetChoiceList() []ParamDescriptorChoiceListInner {
	if o == nil || IsNil(o.ChoiceList) {
		var ret []ParamDescriptorChoiceListInner
		return ret
	}
	return o.ChoiceList
}

// GetChoiceListOk returns a tuple with the ChoiceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ParamDescriptor) GetChoiceListOk() ([]ParamDescriptorChoiceListInner, bool) {
	if o == nil || IsNil(o.ChoiceList) {
		return nil, false
	}
	return o.ChoiceList, true
}
...
// SetChoiceList gets a reference to the given []ParamDescriptorChoiceListInner and assigns it to the ChoiceList field.
...
// SetValueInfo gets a reference to the given ValueInfo and assigns it to the ValueInfo field.
func (o *ParamDescriptor) SetValueInfo(v ValueInfo) {
	o.ValueInfo = &v
}

// GetElementDataType returns the ElementDataType field value
...
// GetElementDataTypeOk returns a tuple with the ElementDataType field value
// and a boolean to check if the value has been set.
...
// SetElementDataType sets field value
...
// GetParentParams returns the ParentParams field value if set, zero value otherwise.
func (o *ParamDescriptor) GetParentParams() []ParamDescriptorParentParamsInner {
	if o == nil || IsNil(o.ParentParams) {
		var ret []ParamDescriptorParentParamsInner
		return ret
	}
	return o.ParentParams
}

// GetParentParamsOk returns a tuple with the ParentParams field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ParamDescriptor) GetParentParamsOk() ([]ParamDescriptorParentParamsInner, bool) {
	if o == nil || IsNil(o.ParentParams) {
		return nil, false
	}
	return o.ParentParams, true
}
...
// SetParentParams gets a reference to the given []ParamDescriptorParentParamsInner and assigns it to the ParentParams field.
...
func (o ParamDescriptor) MarshalJSON() ([]byte, error) {
...
func (o ParamDescriptor) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsParameterized) {
		toSerialize["is_parameterized"] = o.IsParameterized
	}
	if !IsNil(o.ChoiceList) {
		toSerialize["choice_list"] = o.ChoiceList
	}
	if !IsNil(o.IsArray) {
	...
	if !IsNil(o.ValueInfo) {
		toSerialize["value_info"] = o.ValueInfo
	}
	toSerialize["element_data_type"] = o.ElementDataType
	...
	if !IsNil(o.ParentParams) {
		toSerialize["parent_params"] = o.ParentParams
	}
	if !IsNil(o.IsHidden) {
...
func (o *ParamDescriptor) UnmarshalJSON(data []byte) (err error) {
	...
	varParamDescriptor := _ParamDescriptor{}

	err = json.Unmarshal(data, &varParamDescriptor)

	if err != nil {
		return err
	}

	*o = ParamDescriptor(varParamDescriptor)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "entity_types")
		delete(additionalProperties, "display_name")
		delete(additionalProperties, "name")
		delete(additionalProperties, "is_parameterized")
		delete(additionalProperties, "choice_list")
		delete(additionalProperties, "is_array")
		delete(additionalProperties, "entity_type")
		delete(additionalProperties, "value_info")
		delete(additionalProperties, "element_data_type")
		delete(additionalProperties, "is_deprecated")
		delete(additionalProperties, "is_secret")
		delete(additionalProperties, "parent_params")
...
type NullableParamDescriptor struct {
	value *ParamDescriptor
	isSet bool
}

func (v NullableParamDescriptor) Get() *ParamDescriptor {
	return v.value
}

func (v *NullableParamDescriptor) Set(val *ParamDescriptor) {
	v.value = val
	v.isSet = true
}

func (v NullableParamDescriptor) IsSet() bool {
	return v.isSet
}

func (v *NullableParamDescriptor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParamDescriptor(val *ParamDescriptor) *NullableParamDescriptor {
	return &NullableParamDescriptor{value: val, isSet: true}
}

func (v NullableParamDescriptor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParamDescriptor) UnmarshalJSON(src []byte) error {
	v.isSet = true
