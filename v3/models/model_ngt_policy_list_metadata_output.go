...
// checks if the NgtPolicyListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicyListMetadataOutput{}

// NgtPolicyListMetadataOutput All api calls that return a list will have this metadata block 
type NgtPolicyListMetadataOutput struct {
	// The kind name
...
type _NgtPolicyListMetadataOutput NgtPolicyListMetadataOutput
...
func NewNgtPolicyListMetadataOutput() *NgtPolicyListMetadataOutput {
	this := NgtPolicyListMetadataOutput{}
	var kind string = "ngt_policy"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *NgtPolicyListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o NgtPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicyListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicyListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varNgtPolicyListMetadataOutput := _NgtPolicyListMetadataOutput{}

	err = json.Unmarshal(data, &varNgtPolicyListMetadataOutput)

	if err != nil {
		return err
	}

	*o = NgtPolicyListMetadataOutput(varNgtPolicyListMetadataOutput)
...
type NullableNgtPolicyListMetadataOutput struct {
	value *NgtPolicyListMetadataOutput
	isSet bool
}

func (v NullableNgtPolicyListMetadataOutput) Get() *NgtPolicyListMetadataOutput {
	return v.value
}

func (v *NullableNgtPolicyListMetadataOutput) Set(val *NgtPolicyListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicyListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicyListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicyListMetadataOutput(val *NgtPolicyListMetadataOutput) *NullableNgtPolicyListMetadataOutput {
	return &NullableNgtPolicyListMetadataOutput{value: val, isSet: true}
}

func (v NullableNgtPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicyListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
