...
// checks if the RowElement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RowElement{}

// RowElement Row Element Details. Each row element consists of either a widget config or a section Id. 
...
// GetWidgetConfig returns the WidgetConfig field value if set, zero value otherwise.
func (o *RowElement) GetWidgetConfig() WidgetConfig {
	if o == nil || IsNil(o.WidgetConfig) {
		var ret WidgetConfig
		return ret
	}
	return *o.WidgetConfig
}

// GetWidgetConfigOk returns a tuple with the WidgetConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RowElement) GetWidgetConfigOk() (*WidgetConfig, bool) {
	if o == nil || IsNil(o.WidgetConfig) {
		return nil, false
	}
	return o.WidgetConfig, true
}
...
// SetWidgetConfig gets a reference to the given WidgetConfig and assigns it to the WidgetConfig field.
...
func (o RowElement) MarshalJSON() ([]byte, error) {
...
func (o RowElement) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.WidgetConfig) {
		toSerialize["widget_config"] = o.WidgetConfig
	}
	if !IsNil(o.SectionId) {
		toSerialize["section_id"] = o.SectionId
	}
	if !IsNil(o.WidgetId) {
		toSerialize["widget_id"] = o.WidgetId
	}
...
func (o *RowElement) UnmarshalJSON(data []byte) (err error) {
	varRowElement := _RowElement{}

	err = json.Unmarshal(data, &varRowElement)

	if err != nil {
		return err
	}

	*o = RowElement(varRowElement)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "widget_config")
		delete(additionalProperties, "section_id")
		delete(additionalProperties, "widget_id")
...
type NullableRowElement struct {
	value *RowElement
	isSet bool
}

func (v NullableRowElement) Get() *RowElement {
	return v.value
}

func (v *NullableRowElement) Set(val *RowElement) {
	v.value = val
	v.isSet = true
}

func (v NullableRowElement) IsSet() bool {
	return v.isSet
}

func (v *NullableRowElement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRowElement(val *RowElement) *NullableRowElement {
	return &NullableRowElement{value: val, isSet: true}
}

func (v NullableRowElement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRowElement) UnmarshalJSON(src []byte) error {
	v.isSet = true
