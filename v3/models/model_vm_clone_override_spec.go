...
// checks if the VmCloneOverrideSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmCloneOverrideSpec{}

// VmCloneOverrideSpec Properties of the VM that can be overriden during clone.
type VmCloneOverrideSpec struct {
...
type _VmCloneOverrideSpec VmCloneOverrideSpec
...
// SetNicList gets a reference to the given []VmNic and assigns it to the NicList field.
...
// SetGuestCustomization gets a reference to the given GuestCustomization and assigns it to the GuestCustomization field.
func (o *VmCloneOverrideSpec) SetGuestCustomization(v GuestCustomization) {
	o.GuestCustomization = &v
}

func (o VmCloneOverrideSpec) MarshalJSON() ([]byte, error) {
...
func (o VmCloneOverrideSpec) ToMap() (map[string]interface{}, error) {
...
func (o *VmCloneOverrideSpec) UnmarshalJSON(data []byte) (err error) {
	varVmCloneOverrideSpec := _VmCloneOverrideSpec{}

	err = json.Unmarshal(data, &varVmCloneOverrideSpec)

	if err != nil {
		return err
	}

	*o = VmCloneOverrideSpec(varVmCloneOverrideSpec)
...
type NullableVmCloneOverrideSpec struct {
	value *VmCloneOverrideSpec
	isSet bool
}

func (v NullableVmCloneOverrideSpec) Get() *VmCloneOverrideSpec {
	return v.value
}

func (v *NullableVmCloneOverrideSpec) Set(val *VmCloneOverrideSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableVmCloneOverrideSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableVmCloneOverrideSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmCloneOverrideSpec(val *VmCloneOverrideSpec) *NullableVmCloneOverrideSpec {
	return &NullableVmCloneOverrideSpec{value: val, isSet: true}
}

func (v NullableVmCloneOverrideSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmCloneOverrideSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
