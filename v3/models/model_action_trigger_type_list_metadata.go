...
// checks if the ActionTriggerTypeListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTriggerTypeListMetadata{}

// ActionTriggerTypeListMetadata All api calls that return a list will have this metadata block as input 
type ActionTriggerTypeListMetadata struct {
	// The kind name
...
type _ActionTriggerTypeListMetadata ActionTriggerTypeListMetadata
...
func NewActionTriggerTypeListMetadata() *ActionTriggerTypeListMetadata {
	this := ActionTriggerTypeListMetadata{}
...
func (o ActionTriggerTypeListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ActionTriggerTypeListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTriggerTypeListMetadata) UnmarshalJSON(data []byte) (err error) {
	varActionTriggerTypeListMetadata := _ActionTriggerTypeListMetadata{}

	err = json.Unmarshal(data, &varActionTriggerTypeListMetadata)

	if err != nil {
		return err
	}

	*o = ActionTriggerTypeListMetadata(varActionTriggerTypeListMetadata)
...
type NullableActionTriggerTypeListMetadata struct {
	value *ActionTriggerTypeListMetadata
	isSet bool
}

func (v NullableActionTriggerTypeListMetadata) Get() *ActionTriggerTypeListMetadata {
	return v.value
}

func (v *NullableActionTriggerTypeListMetadata) Set(val *ActionTriggerTypeListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTriggerTypeListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTriggerTypeListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTriggerTypeListMetadata(val *ActionTriggerTypeListMetadata) *NullableActionTriggerTypeListMetadata {
	return &NullableActionTriggerTypeListMetadata{value: val, isSet: true}
}

func (v NullableActionTriggerTypeListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTriggerTypeListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
