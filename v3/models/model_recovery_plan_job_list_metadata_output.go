...
// checks if the RecoveryPlanJobListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobListMetadataOutput{}

// RecoveryPlanJobListMetadataOutput All api calls that return a list will have this metadata block 
type RecoveryPlanJobListMetadataOutput struct {
	// The kind name
...
type _RecoveryPlanJobListMetadataOutput RecoveryPlanJobListMetadataOutput
...
func NewRecoveryPlanJobListMetadataOutput() *RecoveryPlanJobListMetadataOutput {
	this := RecoveryPlanJobListMetadataOutput{}
	var kind string = "recovery_plan_job"
	this.Kind = &kind
	return &this
}
...
func (o RecoveryPlanJobListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanJobListMetadataOutput := _RecoveryPlanJobListMetadataOutput{}

	err = json.Unmarshal(data, &varRecoveryPlanJobListMetadataOutput)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobListMetadataOutput(varRecoveryPlanJobListMetadataOutput)
...
type NullableRecoveryPlanJobListMetadataOutput struct {
	value *RecoveryPlanJobListMetadataOutput
	isSet bool
}

func (v NullableRecoveryPlanJobListMetadataOutput) Get() *RecoveryPlanJobListMetadataOutput {
	return v.value
}

func (v *NullableRecoveryPlanJobListMetadataOutput) Set(val *RecoveryPlanJobListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobListMetadataOutput(val *RecoveryPlanJobListMetadataOutput) *NullableRecoveryPlanJobListMetadataOutput {
	return &NullableRecoveryPlanJobListMetadataOutput{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
