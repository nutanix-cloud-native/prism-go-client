...
// checks if the VirtualNetworkIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkIntentResource{}

// VirtualNetworkIntentResource Response object for intentful operations on a virtual_network
type VirtualNetworkIntentResource struct {
	...
	Metadata VirtualNetworkMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VirtualNetworkIntentResource VirtualNetworkIntentResource
...
func NewVirtualNetworkIntentResource(metadata VirtualNetworkMetadata) *VirtualNetworkIntentResource {
	this := VirtualNetworkIntentResource{}
...
func (o *VirtualNetworkIntentResource) GetStatus() VirtualNetworkDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret VirtualNetworkDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given VirtualNetworkDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given VirtualNetwork and assigns it to the Spec field.
...
func (o *VirtualNetworkIntentResource) GetMetadata() VirtualNetworkMetadata {
	if o == nil {
		var ret VirtualNetworkMetadata
		return ret
	}
...
func (o VirtualNetworkIntentResource) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualNetworkIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualNetworkIntentResource := _VirtualNetworkIntentResource{}

	err = json.Unmarshal(data, &varVirtualNetworkIntentResource)

	if err != nil {
		return err
	}

	*o = VirtualNetworkIntentResource(varVirtualNetworkIntentResource)
...
type NullableVirtualNetworkIntentResource struct {
	value *VirtualNetworkIntentResource
	isSet bool
}

func (v NullableVirtualNetworkIntentResource) Get() *VirtualNetworkIntentResource {
	return v.value
}

func (v *NullableVirtualNetworkIntentResource) Set(val *VirtualNetworkIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkIntentResource(val *VirtualNetworkIntentResource) *NullableVirtualNetworkIntentResource {
	return &NullableVirtualNetworkIntentResource{value: val, isSet: true}
}

func (v NullableVirtualNetworkIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
