...
// checks if the CellIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CellIntentResource{}

// CellIntentResource Response object for intentful operations on a cell
type CellIntentResource struct {
	Status *CellDefStatus `json:"status,omitempty"`
...
type _CellIntentResource CellIntentResource
...
// SetStatus gets a reference to the given CellDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Cell and assigns it to the Spec field.
...
func (o CellIntentResource) MarshalJSON() ([]byte, error) {
...
func (o CellIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *CellIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varCellIntentResource := _CellIntentResource{}

	err = json.Unmarshal(data, &varCellIntentResource)

	if err != nil {
		return err
	}

	*o = CellIntentResource(varCellIntentResource)
...
type NullableCellIntentResource struct {
	value *CellIntentResource
	isSet bool
}

func (v NullableCellIntentResource) Get() *CellIntentResource {
	return v.value
}

func (v *NullableCellIntentResource) Set(val *CellIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCellIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCellIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCellIntentResource(val *CellIntentResource) *NullableCellIntentResource {
	return &NullableCellIntentResource{value: val, isSet: true}
}

func (v NullableCellIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCellIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
