...
// checks if the AlertMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertMetadata{}

// AlertMetadata The alert kind metadata
type AlertMetadata struct {
	...
	// Categories for the alert. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the alert. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _AlertMetadata AlertMetadata
...
func (o *AlertMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *AlertMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *AlertMetadata) SetName(v string) {
	o.Name = &v
}
...
func (o AlertMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AlertMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertMetadata := _AlertMetadata{}

	err = json.Unmarshal(data, &varAlertMetadata)

	if err != nil {
		return err
	}

	*o = AlertMetadata(varAlertMetadata)
