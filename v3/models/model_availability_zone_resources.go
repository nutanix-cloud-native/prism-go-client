...
// checks if the AvailabilityZoneResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneResources{}

// AvailabilityZoneResources Availability Zone resources
...
type _AvailabilityZoneResources AvailabilityZoneResources
...
func NewAvailabilityZoneResources(managementPlaneType string) *AvailabilityZoneResources {
	this := AvailabilityZoneResources{}
...
func (o AvailabilityZoneResources) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneResources) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneResources) UnmarshalJSON(data []byte) (err error) {
	...
	varAvailabilityZoneResources := _AvailabilityZoneResources{}

	err = json.Unmarshal(data, &varAvailabilityZoneResources)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneResources(varAvailabilityZoneResources)
...
type NullableAvailabilityZoneResources struct {
	value *AvailabilityZoneResources
	isSet bool
}

func (v NullableAvailabilityZoneResources) Get() *AvailabilityZoneResources {
	return v.value
}

func (v *NullableAvailabilityZoneResources) Set(val *AvailabilityZoneResources) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneResources) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneResources(val *AvailabilityZoneResources) *NullableAvailabilityZoneResources {
	return &NullableAvailabilityZoneResources{value: val, isSet: true}
}

func (v NullableAvailabilityZoneResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
