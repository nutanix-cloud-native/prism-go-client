...
// checks if the VmGpuListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmGpuListMetadataOutput{}

// VmGpuListMetadataOutput All api calls that return a list will have this metadata block 
...
type _VmGpuListMetadataOutput VmGpuListMetadataOutput
...
func NewVmGpuListMetadataOutput() *VmGpuListMetadataOutput {
	this := VmGpuListMetadataOutput{}
	var kind string = "vm_gpu"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *VmGpuListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o VmGpuListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VmGpuListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VmGpuListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVmGpuListMetadataOutput := _VmGpuListMetadataOutput{}

	err = json.Unmarshal(data, &varVmGpuListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VmGpuListMetadataOutput(varVmGpuListMetadataOutput)
...
type NullableVmGpuListMetadataOutput struct {
	value *VmGpuListMetadataOutput
	isSet bool
}

func (v NullableVmGpuListMetadataOutput) Get() *VmGpuListMetadataOutput {
	return v.value
}

func (v *NullableVmGpuListMetadataOutput) Set(val *VmGpuListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmGpuListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmGpuListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmGpuListMetadataOutput(val *VmGpuListMetadataOutput) *NullableVmGpuListMetadataOutput {
	return &NullableVmGpuListMetadataOutput{value: val, isSet: true}
}

func (v NullableVmGpuListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmGpuListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
