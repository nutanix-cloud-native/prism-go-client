...
// checks if the DockerRegistryResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryResources{}
...
type _DockerRegistryResources DockerRegistryResources
...
func (o *DockerRegistryResources) GetIsSystemDefault() bool {
	if o == nil || IsNil(o.IsSystemDefault) {
		var ret bool
		return ret
	}
...
// SetIsSystemDefault gets a reference to the given bool and assigns it to the IsSystemDefault field.
func (o *DockerRegistryResources) SetIsSystemDefault(v bool) {
	o.IsSystemDefault = &v
}

func (o DockerRegistryResources) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryResources) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsSystemDefault) {
		toSerialize["is_system_default"] = o.IsSystemDefault
	}
...
func (o *DockerRegistryResources) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerRegistryResources := _DockerRegistryResources{}

	err = json.Unmarshal(data, &varDockerRegistryResources)

	if err != nil {
		return err
	}

	*o = DockerRegistryResources(varDockerRegistryResources)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "is_system_default")
...
type NullableDockerRegistryResources struct {
	value *DockerRegistryResources
	isSet bool
}

func (v NullableDockerRegistryResources) Get() *DockerRegistryResources {
	return v.value
}

func (v *NullableDockerRegistryResources) Set(val *DockerRegistryResources) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryResources) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryResources(val *DockerRegistryResources) *NullableDockerRegistryResources {
	return &NullableDockerRegistryResources{value: val, isSet: true}
}

func (v NullableDockerRegistryResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
