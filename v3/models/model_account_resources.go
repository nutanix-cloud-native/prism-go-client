...
type _AccountResources AccountResources
...
func (o *AccountResources) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountResources := _AccountResources{}

	err = json.Unmarshal(data, &varAccountResources)

	if err != nil {
		return err
	}

	*o = AccountResources(varAccountResources)
