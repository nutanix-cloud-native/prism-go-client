...
// checks if the DirectConnectVifStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVifStatus{}

// DirectConnectVifStatus BGP status of the direct connect virtual interface. 
type DirectConnectVifStatus struct {
	State *string `json:"state,omitempty"`
	// Detailed informational/error string in human-readable form.
	ErrorDetail *string `json:"error_detail,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DirectConnectVifStatus DirectConnectVifStatus
...
func (o DirectConnectVifStatus) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVifStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectVifStatus) UnmarshalJSON(data []byte) (err error) {
	varDirectConnectVifStatus := _DirectConnectVifStatus{}

	err = json.Unmarshal(data, &varDirectConnectVifStatus)

	if err != nil {
		return err
	}

	*o = DirectConnectVifStatus(varDirectConnectVifStatus)
...
type NullableDirectConnectVifStatus struct {
	value *DirectConnectVifStatus
	isSet bool
}

func (v NullableDirectConnectVifStatus) Get() *DirectConnectVifStatus {
	return v.value
}

func (v *NullableDirectConnectVifStatus) Set(val *DirectConnectVifStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVifStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVifStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVifStatus(val *DirectConnectVifStatus) *NullableDirectConnectVifStatus {
	return &NullableDirectConnectVifStatus{value: val, isSet: true}
}

func (v NullableDirectConnectVifStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVifStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
