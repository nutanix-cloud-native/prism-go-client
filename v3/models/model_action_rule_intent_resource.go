...
// checks if the ActionRuleIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleIntentResource{}

// ActionRuleIntentResource Response object for intentful operations on a action_rule
type ActionRuleIntentResource struct {
...
type _ActionRuleIntentResource ActionRuleIntentResource
...
func (o ActionRuleIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleIntentResource := _ActionRuleIntentResource{}

	err = json.Unmarshal(data, &varActionRuleIntentResource)

	if err != nil {
		return err
	}

	*o = ActionRuleIntentResource(varActionRuleIntentResource)
...
type NullableActionRuleIntentResource struct {
	value *ActionRuleIntentResource
	isSet bool
}

func (v NullableActionRuleIntentResource) Get() *ActionRuleIntentResource {
	return v.value
}

func (v *NullableActionRuleIntentResource) Set(val *ActionRuleIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleIntentResource(val *ActionRuleIntentResource) *NullableActionRuleIntentResource {
	return &NullableActionRuleIntentResource{value: val, isSet: true}
}

func (v NullableActionRuleIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
