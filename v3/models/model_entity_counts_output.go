...
// checks if the EntityCountsOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntityCountsOutput{}

// EntityCountsOutput The object dictates the counts of realized entities, COMPLIANT entities, NON_COMPLIANT entities and IN_PROGRESS entities. 
type EntityCountsOutput struct {
	// Counts of NON_COMPLIANT entities.
	NonCompliantEntitiesCount *int32 `json:"non_compliant_entities_count,omitempty"`
	// Counts of realized entities.
	RealizedEntitiesCount *int32 `json:"realized_entities_count,omitempty"`
	// Counts of IN_PROGRESS entities.
	InProgressEntitiesCount *int32 `json:"in_progress_entities_count,omitempty"`
	// Counts of unrealized entities.
	UnrealizedEntitiesCount *int32 `json:"unrealized_entities_count,omitempty"`
	// Counts of COMPLIANT entities.
	CompliantEntitiesCount *int32 `json:"compliant_entities_count,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _EntityCountsOutput EntityCountsOutput
...
// GetNonCompliantEntitiesCount returns the NonCompliantEntitiesCount field value if set, zero value otherwise.
func (o *EntityCountsOutput) GetNonCompliantEntitiesCount() int32 {
	if o == nil || IsNil(o.NonCompliantEntitiesCount) {
		var ret int32
		return ret
	}
	return *o.NonCompliantEntitiesCount
}

// GetNonCompliantEntitiesCountOk returns a tuple with the NonCompliantEntitiesCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EntityCountsOutput) GetNonCompliantEntitiesCountOk() (*int32, bool) {
	if o == nil || IsNil(o.NonCompliantEntitiesCount) {
		return nil, false
	}
	return o.NonCompliantEntitiesCount, true
}
...
// SetNonCompliantEntitiesCount gets a reference to the given int32 and assigns it to the NonCompliantEntitiesCount field.
func (o *EntityCountsOutput) SetNonCompliantEntitiesCount(v int32) {
	o.NonCompliantEntitiesCount = &v
}

// GetRealizedEntitiesCount returns the RealizedEntitiesCount field value if set, zero value otherwise.
func (o *EntityCountsOutput) GetRealizedEntitiesCount() int32 {
	if o == nil || IsNil(o.RealizedEntitiesCount) {
		var ret int32
		return ret
	}
	return *o.RealizedEntitiesCount
}

// GetRealizedEntitiesCountOk returns a tuple with the RealizedEntitiesCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EntityCountsOutput) GetRealizedEntitiesCountOk() (*int32, bool) {
	if o == nil || IsNil(o.RealizedEntitiesCount) {
		return nil, false
	}
	return o.RealizedEntitiesCount, true
}
...
// SetRealizedEntitiesCount gets a reference to the given int32 and assigns it to the RealizedEntitiesCount field.
func (o *EntityCountsOutput) SetRealizedEntitiesCount(v int32) {
	o.RealizedEntitiesCount = &v
}

// GetInProgressEntitiesCount returns the InProgressEntitiesCount field value if set, zero value otherwise.
func (o *EntityCountsOutput) GetInProgressEntitiesCount() int32 {
	if o == nil || IsNil(o.InProgressEntitiesCount) {
		var ret int32
		return ret
	}
	return *o.InProgressEntitiesCount
}

// GetInProgressEntitiesCountOk returns a tuple with the InProgressEntitiesCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EntityCountsOutput) GetInProgressEntitiesCountOk() (*int32, bool) {
	if o == nil || IsNil(o.InProgressEntitiesCount) {
		return nil, false
	}
	return o.InProgressEntitiesCount, true
}
...
// SetInProgressEntitiesCount gets a reference to the given int32 and assigns it to the InProgressEntitiesCount field.
func (o *EntityCountsOutput) SetInProgressEntitiesCount(v int32) {
	o.InProgressEntitiesCount = &v
}

// GetUnrealizedEntitiesCount returns the UnrealizedEntitiesCount field value if set, zero value otherwise.
func (o *EntityCountsOutput) GetUnrealizedEntitiesCount() int32 {
	if o == nil || IsNil(o.UnrealizedEntitiesCount) {
		var ret int32
		return ret
	}
	return *o.UnrealizedEntitiesCount
}

// GetUnrealizedEntitiesCountOk returns a tuple with the UnrealizedEntitiesCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EntityCountsOutput) GetUnrealizedEntitiesCountOk() (*int32, bool) {
	if o == nil || IsNil(o.UnrealizedEntitiesCount) {
		return nil, false
	}
	return o.UnrealizedEntitiesCount, true
}
...
// SetUnrealizedEntitiesCount gets a reference to the given int32 and assigns it to the UnrealizedEntitiesCount field.
func (o *EntityCountsOutput) SetUnrealizedEntitiesCount(v int32) {
	o.UnrealizedEntitiesCount = &v
}

// GetCompliantEntitiesCount returns the CompliantEntitiesCount field value if set, zero value otherwise.
func (o *EntityCountsOutput) GetCompliantEntitiesCount() int32 {
	if o == nil || IsNil(o.CompliantEntitiesCount) {
		var ret int32
		return ret
	}
	return *o.CompliantEntitiesCount
}

// GetCompliantEntitiesCountOk returns a tuple with the CompliantEntitiesCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EntityCountsOutput) GetCompliantEntitiesCountOk() (*int32, bool) {
	if o == nil || IsNil(o.CompliantEntitiesCount) {
		return nil, false
	}
	return o.CompliantEntitiesCount, true
}
...
// SetCompliantEntitiesCount gets a reference to the given int32 and assigns it to the CompliantEntitiesCount field.
func (o *EntityCountsOutput) SetCompliantEntitiesCount(v int32) {
	o.CompliantEntitiesCount = &v
}

func (o EntityCountsOutput) MarshalJSON() ([]byte, error) {
...
func (o EntityCountsOutput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.NonCompliantEntitiesCount) {
		toSerialize["non_compliant_entities_count"] = o.NonCompliantEntitiesCount
	}
	if !IsNil(o.RealizedEntitiesCount) {
		toSerialize["realized_entities_count"] = o.RealizedEntitiesCount
	}
	if !IsNil(o.InProgressEntitiesCount) {
		toSerialize["in_progress_entities_count"] = o.InProgressEntitiesCount
	}
	if !IsNil(o.UnrealizedEntitiesCount) {
		toSerialize["unrealized_entities_count"] = o.UnrealizedEntitiesCount
	}
	if !IsNil(o.CompliantEntitiesCount) {
		toSerialize["compliant_entities_count"] = o.CompliantEntitiesCount
	}
...
func (o *EntityCountsOutput) UnmarshalJSON(data []byte) (err error) {
	varEntityCountsOutput := _EntityCountsOutput{}

	err = json.Unmarshal(data, &varEntityCountsOutput)

	if err != nil {
		return err
	}

	*o = EntityCountsOutput(varEntityCountsOutput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "non_compliant_entities_count")
		delete(additionalProperties, "realized_entities_count")
		delete(additionalProperties, "in_progress_entities_count")
		delete(additionalProperties, "unrealized_entities_count")
		delete(additionalProperties, "compliant_entities_count")
...
type NullableEntityCountsOutput struct {
	value *EntityCountsOutput
	isSet bool
}

func (v NullableEntityCountsOutput) Get() *EntityCountsOutput {
	return v.value
}

func (v *NullableEntityCountsOutput) Set(val *EntityCountsOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableEntityCountsOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableEntityCountsOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntityCountsOutput(val *EntityCountsOutput) *NullableEntityCountsOutput {
	return &NullableEntityCountsOutput{value: val, isSet: true}
}

func (v NullableEntityCountsOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntityCountsOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
