...
// checks if the SupportCaseReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseReference{}

// SupportCaseReference The reference to a support_case
type SupportCaseReference struct {
	// The kind name
...
type _SupportCaseReference SupportCaseReference
...
func (o SupportCaseReference) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseReference) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseReference) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseReference := _SupportCaseReference{}

	err = json.Unmarshal(data, &varSupportCaseReference)

	if err != nil {
		return err
	}

	*o = SupportCaseReference(varSupportCaseReference)
...
type NullableSupportCaseReference struct {
	value *SupportCaseReference
	isSet bool
}

func (v NullableSupportCaseReference) Get() *SupportCaseReference {
	return v.value
}

func (v *NullableSupportCaseReference) Set(val *SupportCaseReference) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseReference) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseReference(val *SupportCaseReference) *NullableSupportCaseReference {
	return &NullableSupportCaseReference{value: val, isSet: true}
}

func (v NullableSupportCaseReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
