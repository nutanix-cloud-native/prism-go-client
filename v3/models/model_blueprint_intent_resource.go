...
// checks if the BlueprintIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintIntentResource{}

// BlueprintIntentResource Response object for intentful operations on a blueprint
type BlueprintIntentResource struct {
...
type _BlueprintIntentResource BlueprintIntentResource
...
func (o BlueprintIntentResource) MarshalJSON() ([]byte, error) {
...
func (o BlueprintIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintIntentResource := _BlueprintIntentResource{}

	err = json.Unmarshal(data, &varBlueprintIntentResource)

	if err != nil {
		return err
	}

	*o = BlueprintIntentResource(varBlueprintIntentResource)
...
type NullableBlueprintIntentResource struct {
	value *BlueprintIntentResource
	isSet bool
}

func (v NullableBlueprintIntentResource) Get() *BlueprintIntentResource {
	return v.value
}

func (v *NullableBlueprintIntentResource) Set(val *BlueprintIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintIntentResource(val *BlueprintIntentResource) *NullableBlueprintIntentResource {
	return &NullableBlueprintIntentResource{value: val, isSet: true}
}

func (v NullableBlueprintIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
