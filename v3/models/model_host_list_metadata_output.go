...
// checks if the HostListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostListMetadataOutput{}

// HostListMetadataOutput All api calls that return a list will have this metadata block 
...
type _HostListMetadataOutput HostListMetadataOutput
...
func (o HostListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o HostListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *HostListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varHostListMetadataOutput := _HostListMetadataOutput{}

	err = json.Unmarshal(data, &varHostListMetadataOutput)

	if err != nil {
		return err
	}

	*o = HostListMetadataOutput(varHostListMetadataOutput)
...
type NullableHostListMetadataOutput struct {
	value *HostListMetadataOutput
	isSet bool
}

func (v NullableHostListMetadataOutput) Get() *HostListMetadataOutput {
	return v.value
}

func (v *NullableHostListMetadataOutput) Set(val *HostListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableHostListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableHostListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostListMetadataOutput(val *HostListMetadataOutput) *NullableHostListMetadataOutput {
	return &NullableHostListMetadataOutput{value: val, isSet: true}
}

func (v NullableHostListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
