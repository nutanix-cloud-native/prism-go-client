...
// checks if the AwsVmListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVmListMetadataOutput{}

// AwsVmListMetadataOutput All api calls that return a list will have this metadata block 
type AwsVmListMetadataOutput struct {
	// The kind name
...
type _AwsVmListMetadataOutput AwsVmListMetadataOutput
...
func NewAwsVmListMetadataOutput() *AwsVmListMetadataOutput {
	this := AwsVmListMetadataOutput{}
	var kind string = "aws_vm"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *AwsVmListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o AwsVmListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsVmListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVmListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsVmListMetadataOutput := _AwsVmListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsVmListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsVmListMetadataOutput(varAwsVmListMetadataOutput)
...
type NullableAwsVmListMetadataOutput struct {
	value *AwsVmListMetadataOutput
	isSet bool
}

func (v NullableAwsVmListMetadataOutput) Get() *AwsVmListMetadataOutput {
	return v.value
}

func (v *NullableAwsVmListMetadataOutput) Set(val *AwsVmListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVmListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVmListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVmListMetadataOutput(val *AwsVmListMetadataOutput) *NullableAwsVmListMetadataOutput {
	return &NullableAwsVmListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsVmListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVmListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
