...
// checks if the MhVmSpecOverride type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmSpecOverride{}

// MhVmSpecOverride Properties of the VM that can be overriden.
type MhVmSpecOverride struct {
	// Whether to reconfigure NGT inside the guest VM if it was installed at the time of snapshot. 
	ShouldReconfigureNutanixGuestTools *bool `json:"should_reconfigure_nutanix_guest_tools,omitempty"`
	// VM name.
...
type _MhVmSpecOverride MhVmSpecOverride
...
func NewMhVmSpecOverride() *MhVmSpecOverride {
	this := MhVmSpecOverride{}
	var shouldReconfigureNutanixGuestTools bool = true
	this.ShouldReconfigureNutanixGuestTools = &shouldReconfigureNutanixGuestTools
	return &this
}
...
// GetShouldReconfigureNutanixGuestTools returns the ShouldReconfigureNutanixGuestTools field value if set, zero value otherwise.
func (o *MhVmSpecOverride) GetShouldReconfigureNutanixGuestTools() bool {
	if o == nil || IsNil(o.ShouldReconfigureNutanixGuestTools) {
		var ret bool
		return ret
	}
	return *o.ShouldReconfigureNutanixGuestTools
}

// GetShouldReconfigureNutanixGuestToolsOk returns a tuple with the ShouldReconfigureNutanixGuestTools field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MhVmSpecOverride) GetShouldReconfigureNutanixGuestToolsOk() (*bool, bool) {
	if o == nil || IsNil(o.ShouldReconfigureNutanixGuestTools) {
		return nil, false
	}
	return o.ShouldReconfigureNutanixGuestTools, true
}
...
// SetShouldReconfigureNutanixGuestTools gets a reference to the given bool and assigns it to the ShouldReconfigureNutanixGuestTools field.
func (o *MhVmSpecOverride) SetShouldReconfigureNutanixGuestTools(v bool) {
	o.ShouldReconfigureNutanixGuestTools = &v
}
...
// SetResources gets a reference to the given VMResources and assigns it to the Resources field.
func (o *MhVmSpecOverride) SetResources(v VMResources) {
	o.Resources = &v
}

func (o MhVmSpecOverride) MarshalJSON() ([]byte, error) {
...
func (o MhVmSpecOverride) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ShouldReconfigureNutanixGuestTools) {
		toSerialize["should_reconfigure_nutanix_guest_tools"] = o.ShouldReconfigureNutanixGuestTools
	}
	if !IsNil(o.Name) {
...
func (o *MhVmSpecOverride) UnmarshalJSON(data []byte) (err error) {
	varMhVmSpecOverride := _MhVmSpecOverride{}

	err = json.Unmarshal(data, &varMhVmSpecOverride)

	if err != nil {
		return err
	}

	*o = MhVmSpecOverride(varMhVmSpecOverride)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "should_reconfigure_nutanix_guest_tools")
...
type NullableMhVmSpecOverride struct {
	value *MhVmSpecOverride
	isSet bool
}

func (v NullableMhVmSpecOverride) Get() *MhVmSpecOverride {
	return v.value
}

func (v *NullableMhVmSpecOverride) Set(val *MhVmSpecOverride) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmSpecOverride) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmSpecOverride) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmSpecOverride(val *MhVmSpecOverride) *NullableMhVmSpecOverride {
	return &NullableMhVmSpecOverride{value: val, isSet: true}
}

func (v NullableMhVmSpecOverride) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmSpecOverride) UnmarshalJSON(src []byte) error {
	v.isSet = true
