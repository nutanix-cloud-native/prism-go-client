...
// checks if the CompositeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompositeResponse{}

// CompositeResponse Composite response object defintion.
type CompositeResponse struct {
	// Layout of the composite response.
	Layout *string `json:"layout,omitempty"`
	// List containing response. This contains base_response object definiton.
	DataList []map[string]interface{} `json:"data_list,omitempty"`
	// Type of the response.
	Type *string `json:"type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CompositeResponse CompositeResponse
...
// SetDataList gets a reference to the given []map[string]interface{} and assigns it to the DataList field.
...
func (o CompositeResponse) MarshalJSON() ([]byte, error) {
...
func (o CompositeResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CompositeResponse) UnmarshalJSON(data []byte) (err error) {
	varCompositeResponse := _CompositeResponse{}

	err = json.Unmarshal(data, &varCompositeResponse)

	if err != nil {
		return err
	}

	*o = CompositeResponse(varCompositeResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "layout")
		delete(additionalProperties, "data_list")
...
type NullableCompositeResponse struct {
	value *CompositeResponse
	isSet bool
}

func (v NullableCompositeResponse) Get() *CompositeResponse {
	return v.value
}

func (v *NullableCompositeResponse) Set(val *CompositeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCompositeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCompositeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompositeResponse(val *CompositeResponse) *NullableCompositeResponse {
	return &NullableCompositeResponse{value: val, isSet: true}
}

func (v NullableCompositeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompositeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
