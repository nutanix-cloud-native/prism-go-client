...
// checks if the ChangedRegionsListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangedRegionsListMetadataOutput{}

// ChangedRegionsListMetadataOutput All api calls that return a list will have this metadata block 
...
type _ChangedRegionsListMetadataOutput ChangedRegionsListMetadataOutput
...
func NewChangedRegionsListMetadataOutput() *ChangedRegionsListMetadataOutput {
	this := ChangedRegionsListMetadataOutput{}
	var kind string = "changed_regions"
	this.Kind = &kind
	return &this
}
...
func (o ChangedRegionsListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ChangedRegionsListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ChangedRegionsListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varChangedRegionsListMetadataOutput := _ChangedRegionsListMetadataOutput{}

	err = json.Unmarshal(data, &varChangedRegionsListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ChangedRegionsListMetadataOutput(varChangedRegionsListMetadataOutput)
...
type NullableChangedRegionsListMetadataOutput struct {
	value *ChangedRegionsListMetadataOutput
	isSet bool
}

func (v NullableChangedRegionsListMetadataOutput) Get() *ChangedRegionsListMetadataOutput {
	return v.value
}

func (v *NullableChangedRegionsListMetadataOutput) Set(val *ChangedRegionsListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableChangedRegionsListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableChangedRegionsListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangedRegionsListMetadataOutput(val *ChangedRegionsListMetadataOutput) *NullableChangedRegionsListMetadataOutput {
	return &NullableChangedRegionsListMetadataOutput{value: val, isSet: true}
}

func (v NullableChangedRegionsListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangedRegionsListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
