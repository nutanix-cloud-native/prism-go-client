...
// checks if the RecoveryPointRestoreInputVmListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPointRestoreInputVmListInner{}

// RecoveryPointRestoreInputVmListInner struct for RecoveryPointRestoreInputVmListInner
type RecoveryPointRestoreInputVmListInner struct {
	VmRecoveryPointReference VmRecoveryPointReference `json:"vm_recovery_point_reference"`
	MhVmSpec *MhVmSpecOverride `json:"mh_vm_spec,omitempty"`
	VmSpec *VmSpecOverride `json:"vm_spec,omitempty"`
	Metadata *VmMetadataOverride `json:"metadata,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPointRestoreInputVmListInner RecoveryPointRestoreInputVmListInner
...
func NewRecoveryPointRestoreInputVmListInner(vmRecoveryPointReference VmRecoveryPointReference) *RecoveryPointRestoreInputVmListInner {
	this := RecoveryPointRestoreInputVmListInner{}
	this.VmRecoveryPointReference = vmRecoveryPointReference
	return &this
}
...
// GetVmRecoveryPointReference returns the VmRecoveryPointReference field value
...
// GetVmRecoveryPointReferenceOk returns a tuple with the VmRecoveryPointReference field value
...
// SetVmRecoveryPointReference sets field value
...
// GetMhVmSpec returns the MhVmSpec field value if set, zero value otherwise.
func (o *RecoveryPointRestoreInputVmListInner) GetMhVmSpec() MhVmSpecOverride {
	if o == nil || IsNil(o.MhVmSpec) {
		var ret MhVmSpecOverride
		return ret
	}
	return *o.MhVmSpec
}

// GetMhVmSpecOk returns a tuple with the MhVmSpec field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPointRestoreInputVmListInner) GetMhVmSpecOk() (*MhVmSpecOverride, bool) {
	if o == nil || IsNil(o.MhVmSpec) {
		return nil, false
	}
	return o.MhVmSpec, true
}
...
// SetMhVmSpec gets a reference to the given MhVmSpecOverride and assigns it to the MhVmSpec field.
...
// SetVmSpec gets a reference to the given VmSpecOverride and assigns it to the VmSpec field.
...
// SetMetadata gets a reference to the given VmMetadataOverride and assigns it to the Metadata field.
func (o *RecoveryPointRestoreInputVmListInner) SetMetadata(v VmMetadataOverride) {
	o.Metadata = &v
}

func (o RecoveryPointRestoreInputVmListInner) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPointRestoreInputVmListInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["vm_recovery_point_reference"] = o.VmRecoveryPointReference
	if !IsNil(o.MhVmSpec) {
		toSerialize["mh_vm_spec"] = o.MhVmSpec
	}
	if !IsNil(o.VmSpec) {
...
func (o *RecoveryPointRestoreInputVmListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPointRestoreInputVmListInner := _RecoveryPointRestoreInputVmListInner{}

	err = json.Unmarshal(data, &varRecoveryPointRestoreInputVmListInner)

	if err != nil {
		return err
	}

	*o = RecoveryPointRestoreInputVmListInner(varRecoveryPointRestoreInputVmListInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vm_recovery_point_reference")
		delete(additionalProperties, "mh_vm_spec")
...
type NullableRecoveryPointRestoreInputVmListInner struct {
	value *RecoveryPointRestoreInputVmListInner
	isSet bool
}

func (v NullableRecoveryPointRestoreInputVmListInner) Get() *RecoveryPointRestoreInputVmListInner {
	return v.value
}

func (v *NullableRecoveryPointRestoreInputVmListInner) Set(val *RecoveryPointRestoreInputVmListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPointRestoreInputVmListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPointRestoreInputVmListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPointRestoreInputVmListInner(val *RecoveryPointRestoreInputVmListInner) *NullableRecoveryPointRestoreInputVmListInner {
	return &NullableRecoveryPointRestoreInputVmListInner{value: val, isSet: true}
}

func (v NullableRecoveryPointRestoreInputVmListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPointRestoreInputVmListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
