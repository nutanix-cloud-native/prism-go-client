...
// checks if the ActionRuleDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleDefStatus{}

// ActionRuleDefStatus Action rule entity status definition
type ActionRuleDefStatus struct {
...
type _ActionRuleDefStatus ActionRuleDefStatus
...
func (o ActionRuleDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleDefStatus := _ActionRuleDefStatus{}

	err = json.Unmarshal(data, &varActionRuleDefStatus)

	if err != nil {
		return err
	}

	*o = ActionRuleDefStatus(varActionRuleDefStatus)
...
type NullableActionRuleDefStatus struct {
	value *ActionRuleDefStatus
	isSet bool
}

func (v NullableActionRuleDefStatus) Get() *ActionRuleDefStatus {
	return v.value
}

func (v *NullableActionRuleDefStatus) Set(val *ActionRuleDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleDefStatus(val *ActionRuleDefStatus) *NullableActionRuleDefStatus {
	return &NullableActionRuleDefStatus{value: val, isSet: true}
}

func (v NullableActionRuleDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
