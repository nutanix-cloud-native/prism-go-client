...
// checks if the AwsVpcResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVpcResourcesDefStatus{}

// AwsVpcResourcesDefStatus AWS VPC resources
type AwsVpcResourcesDefStatus struct {
	// The supported tenancy options for instances launched into the VPC. 
	InstanceTenancy *string `json:"instance_tenancy,omitempty"`
	// Whether ClassicLink is enabled.
	ClassicLinkEnabled *bool `json:"classic_link_enabled,omitempty"`
	// Whether the VPC is the default VPC.
	IsDefault *bool `json:"is_default,omitempty"`
	// State of the AWS resource
	State *string `json:"state,omitempty"`
	// The CIDR block for the VPC.
	CidrBlock *string `json:"cidr_block,omitempty"`
	// The AWS Tags associated with any AWS resource
	TagList []AwsTagListInner `json:"tag_list,omitempty"`
	// The AWS ID of the VPC.
	Id *string `json:"id,omitempty" validate:"regexp=^vpc-[a-f0-9]{1,17}$"`
	AdditionalProperties map[string]interface{}
}

type _AwsVpcResourcesDefStatus AwsVpcResourcesDefStatus
...
// GetInstanceTenancy returns the InstanceTenancy field value if set, zero value otherwise.
func (o *AwsVpcResourcesDefStatus) GetInstanceTenancy() string {
	if o == nil || IsNil(o.InstanceTenancy) {
		var ret string
		return ret
	}
	return *o.InstanceTenancy
}

// GetInstanceTenancyOk returns a tuple with the InstanceTenancy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AwsVpcResourcesDefStatus) GetInstanceTenancyOk() (*string, bool) {
	if o == nil || IsNil(o.InstanceTenancy) {
		return nil, false
	}
	return o.InstanceTenancy, true
}
...
// SetInstanceTenancy gets a reference to the given string and assigns it to the InstanceTenancy field.
func (o *AwsVpcResourcesDefStatus) SetInstanceTenancy(v string) {
	o.InstanceTenancy = &v
}

// GetClassicLinkEnabled returns the ClassicLinkEnabled field value if set, zero value otherwise.
func (o *AwsVpcResourcesDefStatus) GetClassicLinkEnabled() bool {
	if o == nil || IsNil(o.ClassicLinkEnabled) {
		var ret bool
		return ret
	}
	return *o.ClassicLinkEnabled
}

// GetClassicLinkEnabledOk returns a tuple with the ClassicLinkEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AwsVpcResourcesDefStatus) GetClassicLinkEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.ClassicLinkEnabled) {
		return nil, false
	}
	return o.ClassicLinkEnabled, true
}
...
// SetClassicLinkEnabled gets a reference to the given bool and assigns it to the ClassicLinkEnabled field.
func (o *AwsVpcResourcesDefStatus) SetClassicLinkEnabled(v bool) {
	o.ClassicLinkEnabled = &v
}
...
func (o AwsVpcResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsVpcResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.InstanceTenancy) {
		toSerialize["instance_tenancy"] = o.InstanceTenancy
	}
	if !IsNil(o.ClassicLinkEnabled) {
		toSerialize["classic_link_enabled"] = o.ClassicLinkEnabled
	}
...
func (o *AwsVpcResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsVpcResourcesDefStatus := _AwsVpcResourcesDefStatus{}

	err = json.Unmarshal(data, &varAwsVpcResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = AwsVpcResourcesDefStatus(varAwsVpcResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "instance_tenancy")
		delete(additionalProperties, "classic_link_enabled")
...
type NullableAwsVpcResourcesDefStatus struct {
	value *AwsVpcResourcesDefStatus
	isSet bool
}

func (v NullableAwsVpcResourcesDefStatus) Get() *AwsVpcResourcesDefStatus {
	return v.value
}

func (v *NullableAwsVpcResourcesDefStatus) Set(val *AwsVpcResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVpcResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVpcResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVpcResourcesDefStatus(val *AwsVpcResourcesDefStatus) *NullableAwsVpcResourcesDefStatus {
	return &NullableAwsVpcResourcesDefStatus{value: val, isSet: true}
}

func (v NullableAwsVpcResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVpcResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
