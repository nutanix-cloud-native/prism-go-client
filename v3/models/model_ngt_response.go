...
// checks if the NgtResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtResponse{}

// NgtResponse NGT response.
type NgtResponse struct {
	// List of network configuration of the VMs.
	NetworkInfoList []NetworkConfiguration `json:"network_info_list,omitempty"`
	// UUID
	...
	// Executable scripts in the VM.
	ScriptsExecutable []bool `json:"scripts_executable,omitempty"`
	// Scripts present in the VM.
	ScriptList []string `json:"script_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NgtResponse NgtResponse
...
// GetNetworkInfoList returns the NetworkInfoList field value if set, zero value otherwise.
func (o *NgtResponse) GetNetworkInfoList() []NetworkConfiguration {
	if o == nil || IsNil(o.NetworkInfoList) {
		var ret []NetworkConfiguration
		return ret
	}
	return o.NetworkInfoList
}

// GetNetworkInfoListOk returns a tuple with the NetworkInfoList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NgtResponse) GetNetworkInfoListOk() ([]NetworkConfiguration, bool) {
	if o == nil || IsNil(o.NetworkInfoList) {
		return nil, false
	}
	return o.NetworkInfoList, true
}
...
// SetNetworkInfoList gets a reference to the given []NetworkConfiguration and assigns it to the NetworkInfoList field.
...
// GetScriptsExecutable returns the ScriptsExecutable field value if set, zero value otherwise.
func (o *NgtResponse) GetScriptsExecutable() []bool {
	if o == nil || IsNil(o.ScriptsExecutable) {
		var ret []bool
		return ret
	}
	return o.ScriptsExecutable
}

// GetScriptsExecutableOk returns a tuple with the ScriptsExecutable field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NgtResponse) GetScriptsExecutableOk() ([]bool, bool) {
	if o == nil || IsNil(o.ScriptsExecutable) {
		return nil, false
	}
	return o.ScriptsExecutable, true
}
...
// SetScriptsExecutable gets a reference to the given []bool and assigns it to the ScriptsExecutable field.
func (o *NgtResponse) SetScriptsExecutable(v []bool) {
	o.ScriptsExecutable = v
}
...
// SetScriptList gets a reference to the given []string and assigns it to the ScriptList field.
func (o *NgtResponse) SetScriptList(v []string) {
	o.ScriptList = v
}

func (o NgtResponse) MarshalJSON() ([]byte, error) {
...
func (o NgtResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.NetworkInfoList) {
		toSerialize["network_info_list"] = o.NetworkInfoList
	}
	toSerialize["uuid"] = o.UUID
	toSerialize["vm_uuid"] = o.VmUuid
	if !IsNil(o.ScriptsExecutable) {
		toSerialize["scripts_executable"] = o.ScriptsExecutable
	}
...
func (o *NgtResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtResponse := _NgtResponse{}

	err = json.Unmarshal(data, &varNgtResponse)

	if err != nil {
		return err
	}

	*o = NgtResponse(varNgtResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "network_info_list")
		delete(additionalProperties, "uuid")
		delete(additionalProperties, "vm_uuid")
		delete(additionalProperties, "scripts_executable")
...
type NullableNgtResponse struct {
	value *NgtResponse
	isSet bool
}

func (v NullableNgtResponse) Get() *NgtResponse {
	return v.value
}

func (v *NullableNgtResponse) Set(val *NgtResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtResponse(val *NgtResponse) *NullableNgtResponse {
	return &NullableNgtResponse{value: val, isSet: true}
}

func (v NullableNgtResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
