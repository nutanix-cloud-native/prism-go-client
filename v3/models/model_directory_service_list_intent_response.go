...
// checks if the DirectoryServiceListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceListIntentResponse{}
...
type DirectoryServiceListIntentResponse struct {
	...
	Metadata DirectoryServiceListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _DirectoryServiceListIntentResponse DirectoryServiceListIntentResponse
...
func NewDirectoryServiceListIntentResponse(apiVersion string, metadata DirectoryServiceListMetadataOutput) *DirectoryServiceListIntentResponse {
	this := DirectoryServiceListIntentResponse{}
...
func (o *DirectoryServiceListIntentResponse) GetEntities() []DirectoryServiceIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []DirectoryServiceIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []DirectoryServiceIntentResource and assigns it to the Entities field.
...
func (o *DirectoryServiceListIntentResponse) GetMetadata() DirectoryServiceListMetadataOutput {
	if o == nil {
		var ret DirectoryServiceListMetadataOutput
		return ret
	}
...
func (o DirectoryServiceListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryServiceListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectoryServiceListIntentResponse := _DirectoryServiceListIntentResponse{}

	err = json.Unmarshal(data, &varDirectoryServiceListIntentResponse)

	if err != nil {
		return err
	}

	*o = DirectoryServiceListIntentResponse(varDirectoryServiceListIntentResponse)
...
type NullableDirectoryServiceListIntentResponse struct {
	value *DirectoryServiceListIntentResponse
	isSet bool
}

func (v NullableDirectoryServiceListIntentResponse) Get() *DirectoryServiceListIntentResponse {
	return v.value
}

func (v *NullableDirectoryServiceListIntentResponse) Set(val *DirectoryServiceListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceListIntentResponse(val *DirectoryServiceListIntentResponse) *NullableDirectoryServiceListIntentResponse {
	return &NullableDirectoryServiceListIntentResponse{value: val, isSet: true}
}

func (v NullableDirectoryServiceListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
