...
// checks if the FloatingIpListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpListMetadata{}

// FloatingIpListMetadata All api calls that return a list will have this metadata block as input 
type FloatingIpListMetadata struct {
	// The kind name
...
type _FloatingIpListMetadata FloatingIpListMetadata
...
func (o FloatingIpListMetadata) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *FloatingIpListMetadata) UnmarshalJSON(data []byte) (err error) {
	varFloatingIpListMetadata := _FloatingIpListMetadata{}

	err = json.Unmarshal(data, &varFloatingIpListMetadata)

	if err != nil {
		return err
	}

	*o = FloatingIpListMetadata(varFloatingIpListMetadata)
...
type NullableFloatingIpListMetadata struct {
	value *FloatingIpListMetadata
	isSet bool
}

func (v NullableFloatingIpListMetadata) Get() *FloatingIpListMetadata {
	return v.value
}

func (v *NullableFloatingIpListMetadata) Set(val *FloatingIpListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpListMetadata(val *FloatingIpListMetadata) *NullableFloatingIpListMetadata {
	return &NullableFloatingIpListMetadata{value: val, isSet: true}
}

func (v NullableFloatingIpListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
