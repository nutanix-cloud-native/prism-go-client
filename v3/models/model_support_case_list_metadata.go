...
// checks if the SupportCaseListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseListMetadata{}

// SupportCaseListMetadata All api calls that return a list will have this metadata block as input 
type SupportCaseListMetadata struct {
	// The kind name
...
type _SupportCaseListMetadata SupportCaseListMetadata
...
func (o SupportCaseListMetadata) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseListMetadata) UnmarshalJSON(data []byte) (err error) {
	varSupportCaseListMetadata := _SupportCaseListMetadata{}

	err = json.Unmarshal(data, &varSupportCaseListMetadata)

	if err != nil {
		return err
	}

	*o = SupportCaseListMetadata(varSupportCaseListMetadata)
...
type NullableSupportCaseListMetadata struct {
	value *SupportCaseListMetadata
	isSet bool
}

func (v NullableSupportCaseListMetadata) Get() *SupportCaseListMetadata {
	return v.value
}

func (v *NullableSupportCaseListMetadata) Set(val *SupportCaseListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseListMetadata(val *SupportCaseListMetadata) *NullableSupportCaseListMetadata {
	return &NullableSupportCaseListMetadata{value: val, isSet: true}
}

func (v NullableSupportCaseListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
