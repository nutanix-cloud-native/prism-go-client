...
// checks if the MulticlusterConfigMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MulticlusterConfigMetadata{}

// MulticlusterConfigMetadata The multicluster_config kind metadata
type MulticlusterConfigMetadata struct {
	...
	// Categories for the multicluster_config. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the multicluster_config. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// multicluster_config name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MulticlusterConfigMetadata MulticlusterConfigMetadata
...
func NewMulticlusterConfigMetadata(kind string) *MulticlusterConfigMetadata {
	this := MulticlusterConfigMetadata{}
...
func (o *MulticlusterConfigMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *MulticlusterConfigMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *MulticlusterConfigMetadata) SetName(v string) {
	o.Name = &v
}

func (o MulticlusterConfigMetadata) MarshalJSON() ([]byte, error) {
...
func (o MulticlusterConfigMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *MulticlusterConfigMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varMulticlusterConfigMetadata := _MulticlusterConfigMetadata{}

	err = json.Unmarshal(data, &varMulticlusterConfigMetadata)

	if err != nil {
		return err
	}

	*o = MulticlusterConfigMetadata(varMulticlusterConfigMetadata)
...
type NullableMulticlusterConfigMetadata struct {
	value *MulticlusterConfigMetadata
	isSet bool
}

func (v NullableMulticlusterConfigMetadata) Get() *MulticlusterConfigMetadata {
	return v.value
}

func (v *NullableMulticlusterConfigMetadata) Set(val *MulticlusterConfigMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableMulticlusterConfigMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableMulticlusterConfigMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMulticlusterConfigMetadata(val *MulticlusterConfigMetadata) *NullableMulticlusterConfigMetadata {
	return &NullableMulticlusterConfigMetadata{value: val, isSet: true}
}

func (v NullableMulticlusterConfigMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMulticlusterConfigMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
