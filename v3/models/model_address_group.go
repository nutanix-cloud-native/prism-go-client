...
// checks if the AddressGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressGroup{}

// AddressGroup Address Group definition
type AddressGroup struct {
	...
	IpAddressBlockList []IpSubnet `json:"ip_address_block_list,omitempty"`
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AddressGroup AddressGroup
...
// GetAddressGroupString returns the AddressGroupString field value if set, zero value otherwise.
func (o *AddressGroup) GetAddressGroupString() string {
	if o == nil || IsNil(o.AddressGroupString) {
		var ret string
		return ret
	}
	return *o.AddressGroupString
}

// GetAddressGroupStringOk returns a tuple with the AddressGroupString field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AddressGroup) GetAddressGroupStringOk() (*string, bool) {
	if o == nil || IsNil(o.AddressGroupString) {
		return nil, false
	}
	return o.AddressGroupString, true
}
...
// SetAddressGroupString gets a reference to the given string and assigns it to the AddressGroupString field.
func (o *AddressGroup) SetAddressGroupString(v string) {
	o.AddressGroupString = &v
}
...
// GetIpAddressBlockList returns the IpAddressBlockList field value if set, zero value otherwise.
func (o *AddressGroup) GetIpAddressBlockList() []IpSubnet {
	if o == nil || IsNil(o.IpAddressBlockList) {
		var ret []IpSubnet
		return ret
	}
	return o.IpAddressBlockList
}

// GetIpAddressBlockListOk returns a tuple with the IpAddressBlockList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AddressGroup) GetIpAddressBlockListOk() ([]IpSubnet, bool) {
	if o == nil || IsNil(o.IpAddressBlockList) {
		return nil, false
	}
	return o.IpAddressBlockList, true
}
...
// SetIpAddressBlockList gets a reference to the given []IpSubnet and assigns it to the IpAddressBlockList field.
func (o *AddressGroup) SetIpAddressBlockList(v []IpSubnet) {
	o.IpAddressBlockList = v
}
...
func (o AddressGroup) MarshalJSON() ([]byte, error) {
...
func (o AddressGroup) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AddressGroupString) {
		toSerialize["address_group_string"] = o.AddressGroupString
	}
	if !IsNil(o.Name) {
		toSerialize["name"] = o.Name
	}
	if !IsNil(o.IpAddressBlockList) {
		toSerialize["ip_address_block_list"] = o.IpAddressBlockList
	}
...
func (o *AddressGroup) UnmarshalJSON(data []byte) (err error) {
	varAddressGroup := _AddressGroup{}

	err = json.Unmarshal(data, &varAddressGroup)

	if err != nil {
		return err
	}

	*o = AddressGroup(varAddressGroup)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "address_group_string")
		delete(additionalProperties, "name")
		delete(additionalProperties, "ip_address_block_list")
...
type NullableAddressGroup struct {
	value *AddressGroup
	isSet bool
}

func (v NullableAddressGroup) Get() *AddressGroup {
	return v.value
}

func (v *NullableAddressGroup) Set(val *AddressGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressGroup(val *AddressGroup) *NullableAddressGroup {
	return &NullableAddressGroup{value: val, isSet: true}
}

func (v NullableAddressGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
