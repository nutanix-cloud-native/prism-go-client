...
// checks if the MarketplaceItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItem{}

// MarketplaceItem Detailed spec for creation of an marketplace item
type MarketplaceItem struct {
	// Marketplace item name
	Name string `json:"name"`
	Resources MarketplaceItemInputResources `json:"resources"`
	// Marketplace item description
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MarketplaceItem MarketplaceItem
...
func (o *MarketplaceItem) GetResources() MarketplaceItemInputResources {
	if o == nil {
		var ret MarketplaceItemInputResources
		return ret
	}
...
func (o MarketplaceItem) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItem) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItem) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceItem := _MarketplaceItem{}

	err = json.Unmarshal(data, &varMarketplaceItem)

	if err != nil {
		return err
	}

	*o = MarketplaceItem(varMarketplaceItem)
...
type NullableMarketplaceItem struct {
	value *MarketplaceItem
	isSet bool
}

func (v NullableMarketplaceItem) Get() *MarketplaceItem {
	return v.value
}

func (v *NullableMarketplaceItem) Set(val *MarketplaceItem) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItem) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItem(val *MarketplaceItem) *NullableMarketplaceItem {
	return &NullableMarketplaceItem{value: val, isSet: true}
}

func (v NullableMarketplaceItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
