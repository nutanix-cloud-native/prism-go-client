...
// checks if the TenantReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantReference{}

// TenantReference The reference to a tenant
...
type _TenantReference TenantReference
...
func (o TenantReference) MarshalJSON() ([]byte, error) {
...
func (o TenantReference) ToMap() (map[string]interface{}, error) {
...
func (o *TenantReference) UnmarshalJSON(data []byte) (err error) {
	...
	varTenantReference := _TenantReference{}

	err = json.Unmarshal(data, &varTenantReference)

	if err != nil {
		return err
	}

	*o = TenantReference(varTenantReference)
...
type NullableTenantReference struct {
	value *TenantReference
	isSet bool
}

func (v NullableTenantReference) Get() *TenantReference {
	return v.value
}

func (v *NullableTenantReference) Set(val *TenantReference) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantReference) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantReference(val *TenantReference) *NullableTenantReference {
	return &NullableTenantReference{value: val, isSet: true}
}

func (v NullableTenantReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
