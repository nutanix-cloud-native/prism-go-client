...
// checks if the VmHostAffinityPolicyUpdateInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityPolicyUpdateInput{}

// VmHostAffinityPolicyUpdateInput Defines an affinity policy between a set of VM categories to a set of Host categories. 
type VmHostAffinityPolicyUpdateInput struct {
	Config VmHostAffinityPolicyConfig `json:"config"`
	Metadata VmHostAffinityPolicyUpdateMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VmHostAffinityPolicyUpdateInput VmHostAffinityPolicyUpdateInput
...
func NewVmHostAffinityPolicyUpdateInput(config VmHostAffinityPolicyConfig, metadata VmHostAffinityPolicyUpdateMetadata) *VmHostAffinityPolicyUpdateInput {
	this := VmHostAffinityPolicyUpdateInput{}
	this.Config = config
...
func (o *VmHostAffinityPolicyUpdateInput) GetMetadata() VmHostAffinityPolicyUpdateMetadata {
	if o == nil {
		var ret VmHostAffinityPolicyUpdateMetadata
		return ret
	}
...
func (o VmHostAffinityPolicyUpdateInput) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityPolicyUpdateInput) ToMap() (map[string]interface{}, error) {
...
func (o *VmHostAffinityPolicyUpdateInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVmHostAffinityPolicyUpdateInput := _VmHostAffinityPolicyUpdateInput{}

	err = json.Unmarshal(data, &varVmHostAffinityPolicyUpdateInput)

	if err != nil {
		return err
	}

	*o = VmHostAffinityPolicyUpdateInput(varVmHostAffinityPolicyUpdateInput)
...
type NullableVmHostAffinityPolicyUpdateInput struct {
	value *VmHostAffinityPolicyUpdateInput
	isSet bool
}

func (v NullableVmHostAffinityPolicyUpdateInput) Get() *VmHostAffinityPolicyUpdateInput {
	return v.value
}

func (v *NullableVmHostAffinityPolicyUpdateInput) Set(val *VmHostAffinityPolicyUpdateInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityPolicyUpdateInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityPolicyUpdateInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityPolicyUpdateInput(val *VmHostAffinityPolicyUpdateInput) *NullableVmHostAffinityPolicyUpdateInput {
	return &NullableVmHostAffinityPolicyUpdateInput{value: val, isSet: true}
}

func (v NullableVmHostAffinityPolicyUpdateInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityPolicyUpdateInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
