...
// checks if the IdentityProviderStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderStatus{}

// IdentityProviderStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _IdentityProviderStatus IdentityProviderStatus
...
func (o IdentityProviderStatus) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderStatus) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProviderStatus) UnmarshalJSON(data []byte) (err error) {
	varIdentityProviderStatus := _IdentityProviderStatus{}

	err = json.Unmarshal(data, &varIdentityProviderStatus)

	if err != nil {
		return err
	}

	*o = IdentityProviderStatus(varIdentityProviderStatus)
...
type NullableIdentityProviderStatus struct {
	value *IdentityProviderStatus
	isSet bool
}

func (v NullableIdentityProviderStatus) Get() *IdentityProviderStatus {
	return v.value
}

func (v *NullableIdentityProviderStatus) Set(val *IdentityProviderStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderStatus(val *IdentityProviderStatus) *NullableIdentityProviderStatus {
	return &NullableIdentityProviderStatus{value: val, isSet: true}
}

func (v NullableIdentityProviderStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
