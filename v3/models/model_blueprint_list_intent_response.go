...
// checks if the BlueprintListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintListIntentResponse{}

// BlueprintListIntentResponse Response object for intentful operation of blueprints
type BlueprintListIntentResponse struct {
	Entities []BlueprintIntentResource `json:"entities,omitempty"`
...
type _BlueprintListIntentResponse BlueprintListIntentResponse
...
func NewBlueprintListIntentResponse(apiVersion string, metadata BlueprintListMetadataOutput) *BlueprintListIntentResponse {
	this := BlueprintListIntentResponse{}
...
func (o *BlueprintListIntentResponse) GetEntities() []BlueprintIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []BlueprintIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []BlueprintIntentResource and assigns it to the Entities field.
...
func (o BlueprintListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o BlueprintListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintListIntentResponse := _BlueprintListIntentResponse{}

	err = json.Unmarshal(data, &varBlueprintListIntentResponse)

	if err != nil {
		return err
	}

	*o = BlueprintListIntentResponse(varBlueprintListIntentResponse)
...
type NullableBlueprintListIntentResponse struct {
	value *BlueprintListIntentResponse
	isSet bool
}

func (v NullableBlueprintListIntentResponse) Get() *BlueprintListIntentResponse {
	return v.value
}

func (v *NullableBlueprintListIntentResponse) Set(val *BlueprintListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintListIntentResponse(val *BlueprintListIntentResponse) *NullableBlueprintListIntentResponse {
	return &NullableBlueprintListIntentResponse{value: val, isSet: true}
}

func (v NullableBlueprintListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
