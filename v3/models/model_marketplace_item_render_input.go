...
// checks if the MarketplaceItemRenderInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemRenderInput{}

// MarketplaceItemRenderInput Source spec that describes an entity like a VM, Image that should be translated into an marketplace item 
type MarketplaceItemRenderInput struct {
	InputType string `json:"input_type"`
	InputSpec SpecForTheGivenEntityType `json:"input_spec"`
	// Name of the rendered marketplace item
	Name string `json:"name"`
	// A description for the rendered marketplace item
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MarketplaceItemRenderInput MarketplaceItemRenderInput
...
func NewMarketplaceItemRenderInput(inputType string, inputSpec SpecForTheGivenEntityType, name string) *MarketplaceItemRenderInput {
	this := MarketplaceItemRenderInput{}
...
// GetInputSpec returns the InputSpec field value
func (o *MarketplaceItemRenderInput) GetInputSpec() SpecForTheGivenEntityType {
	if o == nil {
		var ret SpecForTheGivenEntityType
		return ret
	}
...
// GetInputSpecOk returns a tuple with the InputSpec field value
// and a boolean to check if the value has been set.
...
func (o MarketplaceItemRenderInput) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemRenderInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["input_type"] = o.InputType
	toSerialize["input_spec"] = o.InputSpec
...
func (o *MarketplaceItemRenderInput) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceItemRenderInput := _MarketplaceItemRenderInput{}

	err = json.Unmarshal(data, &varMarketplaceItemRenderInput)

	if err != nil {
		return err
	}

	*o = MarketplaceItemRenderInput(varMarketplaceItemRenderInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "input_type")
		delete(additionalProperties, "input_spec")
...
type NullableMarketplaceItemRenderInput struct {
	value *MarketplaceItemRenderInput
	isSet bool
}

func (v NullableMarketplaceItemRenderInput) Get() *MarketplaceItemRenderInput {
	return v.value
}

func (v *NullableMarketplaceItemRenderInput) Set(val *MarketplaceItemRenderInput) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemRenderInput) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemRenderInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemRenderInput(val *MarketplaceItemRenderInput) *NullableMarketplaceItemRenderInput {
	return &NullableMarketplaceItemRenderInput{value: val, isSet: true}
}

func (v NullableMarketplaceItemRenderInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemRenderInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
