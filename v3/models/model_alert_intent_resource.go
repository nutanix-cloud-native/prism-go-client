...
// checks if the AlertIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertIntentResource{}

// AlertIntentResource Response object for intentful operations on a alert
type AlertIntentResource struct {
...
type _AlertIntentResource AlertIntentResource
...
func (o AlertIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AlertIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AlertIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertIntentResource := _AlertIntentResource{}

	err = json.Unmarshal(data, &varAlertIntentResource)

	if err != nil {
		return err
	}

	*o = AlertIntentResource(varAlertIntentResource)
...
type NullableAlertIntentResource struct {
	value *AlertIntentResource
	isSet bool
}

func (v NullableAlertIntentResource) Get() *AlertIntentResource {
	return v.value
}

func (v *NullableAlertIntentResource) Set(val *AlertIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertIntentResource(val *AlertIntentResource) *NullableAlertIntentResource {
	return &NullableAlertIntentResource{value: val, isSet: true}
}

func (v NullableAlertIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
