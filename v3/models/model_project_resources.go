...
type _ProjectResources ProjectResources
...
func (o *ProjectResources) GetEnvironmentReferenceList() []EnvironmentReference {
...
// and a boolean to check if the value has been set.
func (o *ProjectResources) GetDirectoryReferenceListOk() ([]DirectoryReference, bool) {
	if o == nil || IsNil(o.DirectoryReferenceList) {
		return nil, false
	}
...
func (o *ProjectResources) HasVpcReferenceList() bool {
	if o != nil && !IsNil(o.VpcReferenceList) {
		return true
	}
...
func (o *ProjectResources) UnmarshalJSON(data []byte) (err error) {
	varProjectResources := _ProjectResources{}

	err = json.Unmarshal(data, &varProjectResources)

	if err != nil {
		return err
	}

	*o = ProjectResources(varProjectResources)
