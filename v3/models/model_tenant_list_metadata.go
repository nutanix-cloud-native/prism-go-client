...
// checks if the TenantListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantListMetadata{}

// TenantListMetadata All api calls that return a list will have this metadata block as input 
type TenantListMetadata struct {
	// The kind name
...
type _TenantListMetadata TenantListMetadata
...
func (o TenantListMetadata) MarshalJSON() ([]byte, error) {
...
func (o TenantListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *TenantListMetadata) UnmarshalJSON(data []byte) (err error) {
	varTenantListMetadata := _TenantListMetadata{}

	err = json.Unmarshal(data, &varTenantListMetadata)

	if err != nil {
		return err
	}

	*o = TenantListMetadata(varTenantListMetadata)
...
type NullableTenantListMetadata struct {
	value *TenantListMetadata
	isSet bool
}

func (v NullableTenantListMetadata) Get() *TenantListMetadata {
	return v.value
}

func (v *NullableTenantListMetadata) Set(val *TenantListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantListMetadata(val *TenantListMetadata) *NullableTenantListMetadata {
	return &NullableTenantListMetadata{value: val, isSet: true}
}

func (v NullableTenantListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
