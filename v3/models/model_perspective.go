...
// checks if the Perspective type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Perspective{}

// Perspective Perspective object definition.
type Perspective struct {
	// Result list for the perspecitve.
	ResultList []BaseResponse `json:"result_list,omitempty"`
	// Title of the perspective.
	...
	// Name of the view that the perspective represents. The view is used to control the layout of widgets in this perspective. 
	Type *string `json:"type,omitempty"`
	Metadata *Metadata `json:"metadata,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _Perspective Perspective
...
// SetResultList gets a reference to the given []BaseResponse and assigns it to the ResultList field.
...
func (o Perspective) MarshalJSON() ([]byte, error) {
...
func (o Perspective) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ResultList) {
		toSerialize["result_list"] = o.ResultList
	}
	if !IsNil(o.Title) {
...
func (o *Perspective) UnmarshalJSON(data []byte) (err error) {
	varPerspective := _Perspective{}

	err = json.Unmarshal(data, &varPerspective)

	if err != nil {
		return err
	}

	*o = Perspective(varPerspective)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "result_list")
...
type NullablePerspective struct {
	value *Perspective
	isSet bool
}

func (v NullablePerspective) Get() *Perspective {
	return v.value
}

func (v *NullablePerspective) Set(val *Perspective) {
	v.value = val
	v.isSet = true
}

func (v NullablePerspective) IsSet() bool {
	return v.isSet
}

func (v *NullablePerspective) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePerspective(val *Perspective) *NullablePerspective {
	return &NullablePerspective{value: val, isSet: true}
}

func (v NullablePerspective) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePerspective) UnmarshalJSON(src []byte) error {
	v.isSet = true
