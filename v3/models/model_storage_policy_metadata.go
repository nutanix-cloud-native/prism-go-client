...
// checks if the StoragePolicyMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyMetadata{}

// StoragePolicyMetadata The storage_policy kind metadata
type StoragePolicyMetadata struct {
	// UTC date and time in RFC-3339 format when storage_policy was last updated 
	...
	// UTC date and time in RFC-3339 format when storage_policy was created 
	...
	// Categories for the storage_policy. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the storage_policy. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _StoragePolicyMetadata StoragePolicyMetadata
...
func (o StoragePolicyMetadata) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePolicyMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varStoragePolicyMetadata := _StoragePolicyMetadata{}

	err = json.Unmarshal(data, &varStoragePolicyMetadata)

	if err != nil {
		return err
	}

	*o = StoragePolicyMetadata(varStoragePolicyMetadata)
...
type NullableStoragePolicyMetadata struct {
	value *StoragePolicyMetadata
	isSet bool
}

func (v NullableStoragePolicyMetadata) Get() *StoragePolicyMetadata {
	return v.value
}

func (v *NullableStoragePolicyMetadata) Set(val *StoragePolicyMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyMetadata(val *StoragePolicyMetadata) *NullableStoragePolicyMetadata {
	return &NullableStoragePolicyMetadata{value: val, isSet: true}
}

func (v NullableStoragePolicyMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
