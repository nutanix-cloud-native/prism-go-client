...
// checks if the RemoteSyslogServerMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogServerMetadata{}

// RemoteSyslogServerMetadata The remote_syslog_server kind metadata
type RemoteSyslogServerMetadata struct {
	// UTC date and time in RFC-3339 format when remote_syslog_server was last updated 
	...
	// UTC date and time in RFC-3339 format when remote_syslog_server was created 
	...
	// Categories for the remote_syslog_server. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the remote_syslog_server. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// remote_syslog_server name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RemoteSyslogServerMetadata RemoteSyslogServerMetadata
...
func NewRemoteSyslogServerMetadata(kind string) *RemoteSyslogServerMetadata {
	this := RemoteSyslogServerMetadata{}
...
func (o *RemoteSyslogServerMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *RemoteSyslogServerMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *RemoteSyslogServerMetadata) SetName(v string) {
	o.Name = &v
}

func (o RemoteSyslogServerMetadata) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogServerMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogServerMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogServerMetadata := _RemoteSyslogServerMetadata{}

	err = json.Unmarshal(data, &varRemoteSyslogServerMetadata)

	if err != nil {
		return err
	}

	*o = RemoteSyslogServerMetadata(varRemoteSyslogServerMetadata)
...
type NullableRemoteSyslogServerMetadata struct {
	value *RemoteSyslogServerMetadata
	isSet bool
}

func (v NullableRemoteSyslogServerMetadata) Get() *RemoteSyslogServerMetadata {
	return v.value
}

func (v *NullableRemoteSyslogServerMetadata) Set(val *RemoteSyslogServerMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogServerMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogServerMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogServerMetadata(val *RemoteSyslogServerMetadata) *NullableRemoteSyslogServerMetadata {
	return &NullableRemoteSyslogServerMetadata{value: val, isSet: true}
}

func (v NullableRemoteSyslogServerMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogServerMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
