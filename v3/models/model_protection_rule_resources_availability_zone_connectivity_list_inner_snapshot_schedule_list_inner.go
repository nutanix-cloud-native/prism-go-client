...
// checks if the ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner{}

// ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner struct for ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner
type ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner struct {
	// A recovery point objective (RPO) is the maximum acceptable amount of data loss. RPO is measured in time (in seconds) and then dictates disaster recovery procedures. For example, if the RPO is set to 30 minutes, then a backup of the entity is required to be done every 30 minutes. 
	RecoveryPointObjectiveSecs int32 `json:"recovery_point_objective_secs"`
	...
	AutoSuspendTimeoutSecs *int32 `json:"auto_suspend_timeout_secs,omitempty"`
...
type _ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner
...
func NewProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner(recoveryPointObjectiveSecs int32) *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner {
	this := ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner{}
...
// GetRecoveryPointObjectiveSecs returns the RecoveryPointObjectiveSecs field value
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) GetRecoveryPointObjectiveSecs() int32 {
	...
	return o.RecoveryPointObjectiveSecs
}

// GetRecoveryPointObjectiveSecsOk returns a tuple with the RecoveryPointObjectiveSecs field value
...
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) GetRecoveryPointObjectiveSecsOk() (*int32, bool) {
	...
	return &o.RecoveryPointObjectiveSecs, true
}

// SetRecoveryPointObjectiveSecs sets field value
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) SetRecoveryPointObjectiveSecs(v int32) {
	o.RecoveryPointObjectiveSecs = v
}

// GetLocalSnapshotRetentionPolicy returns the LocalSnapshotRetentionPolicy field value if set, zero value otherwise.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) GetLocalSnapshotRetentionPolicy() SnapshotRetentionPolicy {
	if o == nil || IsNil(o.LocalSnapshotRetentionPolicy) {
		var ret SnapshotRetentionPolicy
		return ret
	}
	return *o.LocalSnapshotRetentionPolicy
}

// GetLocalSnapshotRetentionPolicyOk returns a tuple with the LocalSnapshotRetentionPolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) GetLocalSnapshotRetentionPolicyOk() (*SnapshotRetentionPolicy, bool) {
	...
	return o.LocalSnapshotRetentionPolicy, true
}
...
// SetLocalSnapshotRetentionPolicy gets a reference to the given SnapshotRetentionPolicy and assigns it to the LocalSnapshotRetentionPolicy field.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) SetLocalSnapshotRetentionPolicy(v SnapshotRetentionPolicy) {
	o.LocalSnapshotRetentionPolicy = &v
}

// GetAutoSuspendTimeoutSecs returns the AutoSuspendTimeoutSecs field value if set, zero value otherwise.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) GetAutoSuspendTimeoutSecs() int32 {
	if o == nil || IsNil(o.AutoSuspendTimeoutSecs) {
		var ret int32
		return ret
	}
	return *o.AutoSuspendTimeoutSecs
}

// GetAutoSuspendTimeoutSecsOk returns a tuple with the AutoSuspendTimeoutSecs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) GetAutoSuspendTimeoutSecsOk() (*int32, bool) {
	...
	return o.AutoSuspendTimeoutSecs, true
}
...
// SetAutoSuspendTimeoutSecs gets a reference to the given int32 and assigns it to the AutoSuspendTimeoutSecs field.
...
// GetRemoteSnapshotRetentionPolicy returns the RemoteSnapshotRetentionPolicy field value if set, zero value otherwise.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) GetRemoteSnapshotRetentionPolicy() SnapshotRetentionPolicy {
	if o == nil || IsNil(o.RemoteSnapshotRetentionPolicy) {
		var ret SnapshotRetentionPolicy
		return ret
	}
	return *o.RemoteSnapshotRetentionPolicy
}

// GetRemoteSnapshotRetentionPolicyOk returns a tuple with the RemoteSnapshotRetentionPolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) GetRemoteSnapshotRetentionPolicyOk() (*SnapshotRetentionPolicy, bool) {
	...
	return o.RemoteSnapshotRetentionPolicy, true
}
...
// SetRemoteSnapshotRetentionPolicy gets a reference to the given SnapshotRetentionPolicy and assigns it to the RemoteSnapshotRetentionPolicy field.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) SetRemoteSnapshotRetentionPolicy(v SnapshotRetentionPolicy) {
	o.RemoteSnapshotRetentionPolicy = &v
}

func (o ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["recovery_point_objective_secs"] = o.RecoveryPointObjectiveSecs
	if !IsNil(o.LocalSnapshotRetentionPolicy) {
		toSerialize["local_snapshot_retention_policy"] = o.LocalSnapshotRetentionPolicy
	}
	if !IsNil(o.AutoSuspendTimeoutSecs) {
		toSerialize["auto_suspend_timeout_secs"] = o.AutoSuspendTimeoutSecs
	}
	if !IsNil(o.SnapshotType) {
		toSerialize["snapshot_type"] = o.SnapshotType
	}
	if !IsNil(o.RemoteSnapshotRetentionPolicy) {
		toSerialize["remote_snapshot_retention_policy"] = o.RemoteSnapshotRetentionPolicy
	}
...
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner := _ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner{}

	err = json.Unmarshal(data, &varProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner)

	if err != nil {
		return err
	}

	*o = ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner(varProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "recovery_point_objective_secs")
		delete(additionalProperties, "local_snapshot_retention_policy")
		delete(additionalProperties, "auto_suspend_timeout_secs")
		delete(additionalProperties, "snapshot_type")
		delete(additionalProperties, "remote_snapshot_retention_policy")
...
type NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner struct {
	value *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner
	isSet bool
}

func (v NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) Get() *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner {
	return v.value
}

func (v *NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) Set(val *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner(val *ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) *NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner {
	return &NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner{value: val, isSet: true}
}

func (v NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
