...
// checks if the CellResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CellResources{}

// CellResources Datacenter logical cell entity definition.
type CellResources struct {
	DatacenterReference DatacenterReference `json:"datacenter_reference"`
	// Human readable tag that denotes the type of hardware in a cell as well as the networking equipment and setup. 
	CellClass string `json:"cell_class"`
	AdditionalProperties map[string]interface{}
}

type _CellResources CellResources
...
// GetDatacenterReference returns the DatacenterReference field value
...
// GetDatacenterReferenceOk returns a tuple with the DatacenterReference field value
...
// GetCellClassOk returns a tuple with the CellClass field value
// and a boolean to check if the value has been set.
func (o *CellResources) GetCellClassOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CellClass, true
}

// SetCellClass sets field value
func (o *CellResources) SetCellClass(v string) {
	o.CellClass = v
}

func (o CellResources) MarshalJSON() ([]byte, error) {
...
func (o CellResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["datacenter_reference"] = o.DatacenterReference
	toSerialize["cell_class"] = o.CellClass
...
func (o *CellResources) UnmarshalJSON(data []byte) (err error) {
	...
	varCellResources := _CellResources{}

	err = json.Unmarshal(data, &varCellResources)

	if err != nil {
		return err
	}

	*o = CellResources(varCellResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "datacenter_reference")
		delete(additionalProperties, "cell_class")
...
type NullableCellResources struct {
	value *CellResources
	isSet bool
}

func (v NullableCellResources) Get() *CellResources {
	return v.value
}

func (v *NullableCellResources) Set(val *CellResources) {
	v.value = val
	v.isSet = true
}

func (v NullableCellResources) IsSet() bool {
	return v.isSet
}

func (v *NullableCellResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCellResources(val *CellResources) *NullableCellResources {
	return &NullableCellResources{value: val, isSet: true}
}

func (v NullableCellResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCellResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
