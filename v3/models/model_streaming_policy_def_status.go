...
// checks if the StreamingPolicyDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyDefStatus{}

// StreamingPolicyDefStatus Streaming Policy Entity
type StreamingPolicyDefStatus struct {
	// The state of the streaming policy.
	...
	Resources StreamingPolicyDetails `json:"resources"`
	// Policy description
	Description string `json:"description"`
	AdditionalProperties map[string]interface{}
}

type _StreamingPolicyDefStatus StreamingPolicyDefStatus
...
func (o *StreamingPolicyDefStatus) GetResources() StreamingPolicyDetails {
	if o == nil {
		var ret StreamingPolicyDetails
		return ret
	}
...
func (o StreamingPolicyDefStatus) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicyDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varStreamingPolicyDefStatus := _StreamingPolicyDefStatus{}

	err = json.Unmarshal(data, &varStreamingPolicyDefStatus)

	if err != nil {
		return err
	}

	*o = StreamingPolicyDefStatus(varStreamingPolicyDefStatus)
...
type NullableStreamingPolicyDefStatus struct {
	value *StreamingPolicyDefStatus
	isSet bool
}

func (v NullableStreamingPolicyDefStatus) Get() *StreamingPolicyDefStatus {
	return v.value
}

func (v *NullableStreamingPolicyDefStatus) Set(val *StreamingPolicyDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyDefStatus(val *StreamingPolicyDefStatus) *NullableStreamingPolicyDefStatus {
	return &NullableStreamingPolicyDefStatus{value: val, isSet: true}
}

func (v NullableStreamingPolicyDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
