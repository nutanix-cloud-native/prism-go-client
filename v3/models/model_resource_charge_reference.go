...
// checks if the ResourceChargeReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceChargeReference{}

// ResourceChargeReference The reference to a resource_charge
...
type _ResourceChargeReference ResourceChargeReference
...
func (o ResourceChargeReference) MarshalJSON() ([]byte, error) {
...
func (o ResourceChargeReference) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceChargeReference) UnmarshalJSON(data []byte) (err error) {
	...
	varResourceChargeReference := _ResourceChargeReference{}

	err = json.Unmarshal(data, &varResourceChargeReference)

	if err != nil {
		return err
	}

	*o = ResourceChargeReference(varResourceChargeReference)
...
type NullableResourceChargeReference struct {
	value *ResourceChargeReference
	isSet bool
}

func (v NullableResourceChargeReference) Get() *ResourceChargeReference {
	return v.value
}

func (v *NullableResourceChargeReference) Set(val *ResourceChargeReference) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceChargeReference) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceChargeReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceChargeReference(val *ResourceChargeReference) *NullableResourceChargeReference {
	return &NullableResourceChargeReference{value: val, isSet: true}
}

func (v NullableResourceChargeReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceChargeReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
