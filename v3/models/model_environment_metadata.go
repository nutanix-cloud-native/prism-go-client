...
// EnvironmentMetadata The environment kind metadata
type EnvironmentMetadata struct {
	...
	// Categories for the environment. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the environment. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
func (o *EnvironmentMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEnvironmentMetadata)
