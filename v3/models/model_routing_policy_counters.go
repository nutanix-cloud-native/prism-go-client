...
// checks if the RoutingPolicyCounters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyCounters{}

// RoutingPolicyCounters Number of packets and bytes hitting the rule.
type RoutingPolicyCounters struct {
	PacketCount *int32 `json:"packet_count,omitempty"`
	ByteCount *int32 `json:"byte_count,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RoutingPolicyCounters RoutingPolicyCounters
...
// SetPacketCount gets a reference to the given int32 and assigns it to the PacketCount field.
...
// SetByteCount gets a reference to the given int32 and assigns it to the ByteCount field.
func (o *RoutingPolicyCounters) SetByteCount(v int32) {
	o.ByteCount = &v
}

func (o RoutingPolicyCounters) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyCounters) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PacketCount) {
		toSerialize["packet_count"] = o.PacketCount
	}
...
func (o *RoutingPolicyCounters) UnmarshalJSON(data []byte) (err error) {
	varRoutingPolicyCounters := _RoutingPolicyCounters{}

	err = json.Unmarshal(data, &varRoutingPolicyCounters)

	if err != nil {
		return err
	}

	*o = RoutingPolicyCounters(varRoutingPolicyCounters)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "packet_count")
		delete(additionalProperties, "byte_count")
...
type NullableRoutingPolicyCounters struct {
	value *RoutingPolicyCounters
	isSet bool
}

func (v NullableRoutingPolicyCounters) Get() *RoutingPolicyCounters {
	return v.value
}

func (v *NullableRoutingPolicyCounters) Set(val *RoutingPolicyCounters) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyCounters) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyCounters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyCounters(val *RoutingPolicyCounters) *NullableRoutingPolicyCounters {
	return &NullableRoutingPolicyCounters{value: val, isSet: true}
}

func (v NullableRoutingPolicyCounters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyCounters) UnmarshalJSON(src []byte) error {
	v.isSet = true
