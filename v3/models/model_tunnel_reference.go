...
// checks if the TunnelReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TunnelReference{}

// TunnelReference The reference to a tunnel
...
type _TunnelReference TunnelReference
...
func (o TunnelReference) MarshalJSON() ([]byte, error) {
...
func (o TunnelReference) ToMap() (map[string]interface{}, error) {
...
func (o *TunnelReference) UnmarshalJSON(data []byte) (err error) {
	...
	varTunnelReference := _TunnelReference{}

	err = json.Unmarshal(data, &varTunnelReference)

	if err != nil {
		return err
	}

	*o = TunnelReference(varTunnelReference)
...
type NullableTunnelReference struct {
	value *TunnelReference
	isSet bool
}

func (v NullableTunnelReference) Get() *TunnelReference {
	return v.value
}

func (v *NullableTunnelReference) Set(val *TunnelReference) {
	v.value = val
	v.isSet = true
}

func (v NullableTunnelReference) IsSet() bool {
	return v.isSet
}

func (v *NullableTunnelReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTunnelReference(val *TunnelReference) *NullableTunnelReference {
	return &NullableTunnelReference{value: val, isSet: true}
}

func (v NullableTunnelReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTunnelReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
