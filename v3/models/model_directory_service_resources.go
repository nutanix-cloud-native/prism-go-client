...
// checks if the DirectoryServiceResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceResources{}

// DirectoryServiceResources The configuration details of the directory service.
type DirectoryServiceResources struct {
	OpenLdapConfiguration *OpenLdapConfigurationDefStatus `json:"open_ldap_configuration,omitempty"`
...
type _DirectoryServiceResources DirectoryServiceResources
...
func NewDirectoryServiceResources(url string, directoryType string, domainName string, serviceAccount ServiceAccount) *DirectoryServiceResources {
	this := DirectoryServiceResources{}
	this.Url = url
...
func (o *DirectoryServiceResources) GetOpenLdapConfiguration() OpenLdapConfigurationDefStatus {
	if o == nil || IsNil(o.OpenLdapConfiguration) {
		var ret OpenLdapConfigurationDefStatus
		return ret
	}
...
// SetOpenLdapConfiguration gets a reference to the given OpenLdapConfigurationDefStatus and assigns it to the OpenLdapConfiguration field.
...
func (o DirectoryServiceResources) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceResources) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryServiceResources) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectoryServiceResources := _DirectoryServiceResources{}

	err = json.Unmarshal(data, &varDirectoryServiceResources)

	if err != nil {
		return err
	}

	*o = DirectoryServiceResources(varDirectoryServiceResources)
...
type NullableDirectoryServiceResources struct {
	value *DirectoryServiceResources
	isSet bool
}

func (v NullableDirectoryServiceResources) Get() *DirectoryServiceResources {
	return v.value
}

func (v *NullableDirectoryServiceResources) Set(val *DirectoryServiceResources) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceResources) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceResources(val *DirectoryServiceResources) *NullableDirectoryServiceResources {
	return &NullableDirectoryServiceResources{value: val, isSet: true}
}

func (v NullableDirectoryServiceResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
