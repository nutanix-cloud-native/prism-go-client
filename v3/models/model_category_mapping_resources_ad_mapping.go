...
// checks if the CategoryMappingResourcesAdMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingResourcesAdMapping{}

// CategoryMappingResourcesAdMapping A mapping to an object in Active Directory.
type CategoryMappingResourcesAdMapping struct {
...
type _CategoryMappingResourcesAdMapping CategoryMappingResourcesAdMapping
...
func NewCategoryMappingResourcesAdMapping(objectIdentifier string, directoryServiceReference DirectoryServiceReference) *CategoryMappingResourcesAdMapping {
	this := CategoryMappingResourcesAdMapping{}
...
// GetObjectIdentifier returns the ObjectIdentifier field value
...
// GetObjectIdentifierOk returns a tuple with the ObjectIdentifier field value
...
// SetObjectIdentifier sets field value
...
func (o CategoryMappingResourcesAdMapping) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingResourcesAdMapping) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingResourcesAdMapping) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryMappingResourcesAdMapping := _CategoryMappingResourcesAdMapping{}

	err = json.Unmarshal(data, &varCategoryMappingResourcesAdMapping)

	if err != nil {
		return err
	}

	*o = CategoryMappingResourcesAdMapping(varCategoryMappingResourcesAdMapping)
...
type NullableCategoryMappingResourcesAdMapping struct {
	value *CategoryMappingResourcesAdMapping
	isSet bool
}

func (v NullableCategoryMappingResourcesAdMapping) Get() *CategoryMappingResourcesAdMapping {
	return v.value
}

func (v *NullableCategoryMappingResourcesAdMapping) Set(val *CategoryMappingResourcesAdMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingResourcesAdMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingResourcesAdMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingResourcesAdMapping(val *CategoryMappingResourcesAdMapping) *NullableCategoryMappingResourcesAdMapping {
	return &NullableCategoryMappingResourcesAdMapping{value: val, isSet: true}
}

func (v NullableCategoryMappingResourcesAdMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingResourcesAdMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
