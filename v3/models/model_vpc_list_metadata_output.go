...
// checks if the VpcListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcListMetadataOutput{}

// VpcListMetadataOutput All api calls that return a list will have this metadata block 
type VpcListMetadataOutput struct {
	// The kind name
...
type _VpcListMetadataOutput VpcListMetadataOutput
...
// and a boolean to check if the value has been set.
func (o *VpcListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o VpcListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VpcListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VpcListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVpcListMetadataOutput := _VpcListMetadataOutput{}

	err = json.Unmarshal(data, &varVpcListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VpcListMetadataOutput(varVpcListMetadataOutput)
...
type NullableVpcListMetadataOutput struct {
	value *VpcListMetadataOutput
	isSet bool
}

func (v NullableVpcListMetadataOutput) Get() *VpcListMetadataOutput {
	return v.value
}

func (v *NullableVpcListMetadataOutput) Set(val *VpcListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcListMetadataOutput(val *VpcListMetadataOutput) *NullableVpcListMetadataOutput {
	return &NullableVpcListMetadataOutput{value: val, isSet: true}
}

func (v NullableVpcListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
