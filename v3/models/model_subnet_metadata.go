...
// checks if the SubnetMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubnetMetadata{}
...
type SubnetMetadata struct {
	...
	// Categories for the subnet. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the subnet. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _SubnetMetadata SubnetMetadata
...
func (o SubnetMetadata) MarshalJSON() ([]byte, error) {
...
func (o SubnetMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SubnetMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varSubnetMetadata := _SubnetMetadata{}

	err = json.Unmarshal(data, &varSubnetMetadata)

	if err != nil {
		return err
	}

	*o = SubnetMetadata(varSubnetMetadata)
...
type NullableSubnetMetadata struct {
	value *SubnetMetadata
	isSet bool
}

func (v NullableSubnetMetadata) Get() *SubnetMetadata {
	return v.value
}

func (v *NullableSubnetMetadata) Set(val *SubnetMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSubnetMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSubnetMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubnetMetadata(val *SubnetMetadata) *NullableSubnetMetadata {
	return &NullableSubnetMetadata{value: val, isSet: true}
}

func (v NullableSubnetMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubnetMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
