...
// checks if the SyslogServerResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogServerResources{}

// SyslogServerResources Remote Syslog server API resources definition
type SyslogServerResources struct {
	ModuleList []SyslogModule `json:"module_list,omitempty"`
	...
	// Name of the Remote Syslog server
...
type _SyslogServerResources SyslogServerResources
...
// GetModuleList returns the ModuleList field value if set, zero value otherwise.
func (o *SyslogServerResources) GetModuleList() []SyslogModule {
	if o == nil || IsNil(o.ModuleList) {
		var ret []SyslogModule
		return ret
	}
	return o.ModuleList
}

// GetModuleListOk returns a tuple with the ModuleList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SyslogServerResources) GetModuleListOk() ([]SyslogModule, bool) {
	if o == nil || IsNil(o.ModuleList) {
		return nil, false
	}
	return o.ModuleList, true
}
...
// SetModuleList gets a reference to the given []SyslogModule and assigns it to the ModuleList field.
...
func (o SyslogServerResources) MarshalJSON() ([]byte, error) {
...
func (o SyslogServerResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ModuleList) {
		toSerialize["module_list"] = o.ModuleList
	}
...
func (o *SyslogServerResources) UnmarshalJSON(data []byte) (err error) {
	varSyslogServerResources := _SyslogServerResources{}

	err = json.Unmarshal(data, &varSyslogServerResources)

	if err != nil {
		return err
	}

	*o = SyslogServerResources(varSyslogServerResources)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "network_protocol")
...
type NullableSyslogServerResources struct {
	value *SyslogServerResources
	isSet bool
}

func (v NullableSyslogServerResources) Get() *SyslogServerResources {
	return v.value
}

func (v *NullableSyslogServerResources) Set(val *SyslogServerResources) {
	v.value = val
	v.isSet = true
}

func (v NullableSyslogServerResources) IsSet() bool {
	return v.isSet
}

func (v *NullableSyslogServerResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyslogServerResources(val *SyslogServerResources) *NullableSyslogServerResources {
	return &NullableSyslogServerResources{value: val, isSet: true}
}

func (v NullableSyslogServerResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyslogServerResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
