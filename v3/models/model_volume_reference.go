...
// checks if the VolumeReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeReference{}

// VolumeReference The reference to a volume
...
type _VolumeReference VolumeReference
...
func (o VolumeReference) MarshalJSON() ([]byte, error) {
...
func (o VolumeReference) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumeReference := _VolumeReference{}

	err = json.Unmarshal(data, &varVolumeReference)

	if err != nil {
		return err
	}

	*o = VolumeReference(varVolumeReference)
...
type NullableVolumeReference struct {
	value *VolumeReference
	isSet bool
}

func (v NullableVolumeReference) Get() *VolumeReference {
	return v.value
}

func (v *NullableVolumeReference) Set(val *VolumeReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeReference(val *VolumeReference) *NullableVolumeReference {
	return &NullableVolumeReference{value: val, isSet: true}
}

func (v NullableVolumeReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
