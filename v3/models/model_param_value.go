...
// checks if the ParamValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParamValue{}

// ParamValue Scalar value object that handles different types
...
func (o ParamValue) MarshalJSON() ([]byte, error) {
...
func (o ParamValue) ToMap() (map[string]interface{}, error) {
...
func (o *ParamValue) UnmarshalJSON(data []byte) (err error) {
	varParamValue := _ParamValue{}

	err = json.Unmarshal(data, &varParamValue)

	if err != nil {
		return err
	}

	*o = ParamValue(varParamValue)
...
func (v NullableParamValue) Get() *ParamValue {
	return v.value
}

func (v *NullableParamValue) Set(val *ParamValue) {
	v.value = val
	v.isSet = true
}

func (v NullableParamValue) IsSet() bool {
	return v.isSet
}

func (v *NullableParamValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParamValue(val *ParamValue) *NullableParamValue {
	return &NullableParamValue{value: val, isSet: true}
}

func (v NullableParamValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParamValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
