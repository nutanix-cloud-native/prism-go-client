...
// checks if the AccessControlPolicyIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyIntentResource{}

// AccessControlPolicyIntentResource Response object for intentful operations on a access_control_policy
type AccessControlPolicyIntentResource struct {
	Status *AccessControlPolicyDefStatus `json:"status,omitempty"`
	Spec *AccessControlPolicy `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata AccessControlPolicyMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AccessControlPolicyIntentResource AccessControlPolicyIntentResource
...
func NewAccessControlPolicyIntentResource(metadata AccessControlPolicyMetadata) *AccessControlPolicyIntentResource {
	this := AccessControlPolicyIntentResource{}
...
func (o *AccessControlPolicyIntentResource) GetStatus() AccessControlPolicyDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret AccessControlPolicyDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given AccessControlPolicyDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given AccessControlPolicy and assigns it to the Spec field.
...
func (o *AccessControlPolicyIntentResource) GetMetadata() AccessControlPolicyMetadata {
	if o == nil {
		var ret AccessControlPolicyMetadata
		return ret
	}
...
func (o AccessControlPolicyIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AccessControlPolicyIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessControlPolicyIntentResource := _AccessControlPolicyIntentResource{}

	err = json.Unmarshal(data, &varAccessControlPolicyIntentResource)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyIntentResource(varAccessControlPolicyIntentResource)
...
type NullableAccessControlPolicyIntentResource struct {
	value *AccessControlPolicyIntentResource
	isSet bool
}

func (v NullableAccessControlPolicyIntentResource) Get() *AccessControlPolicyIntentResource {
	return v.value
}

func (v *NullableAccessControlPolicyIntentResource) Set(val *AccessControlPolicyIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyIntentResource(val *AccessControlPolicyIntentResource) *NullableAccessControlPolicyIntentResource {
	return &NullableAccessControlPolicyIntentResource{value: val, isSet: true}
}

func (v NullableAccessControlPolicyIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
