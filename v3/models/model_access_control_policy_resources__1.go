...
// checks if the AccessControlPolicyResources1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyResources1{}

// AccessControlPolicyResources1 Access Control Policy resources.
type AccessControlPolicyResources1 struct {
...
type _AccessControlPolicyResources1 AccessControlPolicyResources1
...
func NewAccessControlPolicyResources1(roleReference RoleReference) *AccessControlPolicyResources1 {
	this := AccessControlPolicyResources1{}
...
// GetRoleReference returns the RoleReference field value
...
// GetRoleReferenceOk returns a tuple with the RoleReference field value
...
// SetRoleReference sets field value
...
func (o AccessControlPolicyResources1) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyResources1) ToMap() (map[string]interface{}, error) {
...
func (o *AccessControlPolicyResources1) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessControlPolicyResources1 := _AccessControlPolicyResources1{}

	err = json.Unmarshal(data, &varAccessControlPolicyResources1)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyResources1(varAccessControlPolicyResources1)
...
type NullableAccessControlPolicyResources1 struct {
	value *AccessControlPolicyResources1
	isSet bool
}

func (v NullableAccessControlPolicyResources1) Get() *AccessControlPolicyResources1 {
	return v.value
}

func (v *NullableAccessControlPolicyResources1) Set(val *AccessControlPolicyResources1) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyResources1) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyResources1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyResources1(val *AccessControlPolicyResources1) *NullableAccessControlPolicyResources1 {
	return &NullableAccessControlPolicyResources1{value: val, isSet: true}
}

func (v NullableAccessControlPolicyResources1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyResources1) UnmarshalJSON(src []byte) error {
	v.isSet = true
