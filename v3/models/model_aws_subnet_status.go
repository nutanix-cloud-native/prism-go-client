...
// checks if the AwsSubnetStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSubnetStatus{}

// AwsSubnetStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _AwsSubnetStatus AwsSubnetStatus
...
func (o AwsSubnetStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsSubnetStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSubnetStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsSubnetStatus := _AwsSubnetStatus{}

	err = json.Unmarshal(data, &varAwsSubnetStatus)

	if err != nil {
		return err
	}

	*o = AwsSubnetStatus(varAwsSubnetStatus)
...
type NullableAwsSubnetStatus struct {
	value *AwsSubnetStatus
	isSet bool
}

func (v NullableAwsSubnetStatus) Get() *AwsSubnetStatus {
	return v.value
}

func (v *NullableAwsSubnetStatus) Set(val *AwsSubnetStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSubnetStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSubnetStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSubnetStatus(val *AwsSubnetStatus) *NullableAwsSubnetStatus {
	return &NullableAwsSubnetStatus{value: val, isSet: true}
}

func (v NullableAwsSubnetStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSubnetStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
