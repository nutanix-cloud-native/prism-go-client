...
// ClusterMetadata The cluster kind metadata
type ClusterMetadata struct {
	...
	// Categories for the cluster. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the cluster. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _ClusterMetadata ClusterMetadata
...
func (o *ClusterMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterMetadata := _ClusterMetadata{}

	err = json.Unmarshal(data, &varClusterMetadata)

	if err != nil {
		return err
	}

	*o = ClusterMetadata(varClusterMetadata)
