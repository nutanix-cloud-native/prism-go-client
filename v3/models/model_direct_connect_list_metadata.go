...
// checks if the DirectConnectListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectListMetadata{}

// DirectConnectListMetadata All api calls that return a list will have this metadata block as input 
type DirectConnectListMetadata struct {
	// The kind name
...
type _DirectConnectListMetadata DirectConnectListMetadata
...
func NewDirectConnectListMetadata() *DirectConnectListMetadata {
	this := DirectConnectListMetadata{}
...
func (o DirectConnectListMetadata) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectListMetadata) UnmarshalJSON(data []byte) (err error) {
	varDirectConnectListMetadata := _DirectConnectListMetadata{}

	err = json.Unmarshal(data, &varDirectConnectListMetadata)

	if err != nil {
		return err
	}

	*o = DirectConnectListMetadata(varDirectConnectListMetadata)
...
type NullableDirectConnectListMetadata struct {
	value *DirectConnectListMetadata
	isSet bool
}

func (v NullableDirectConnectListMetadata) Get() *DirectConnectListMetadata {
	return v.value
}

func (v *NullableDirectConnectListMetadata) Set(val *DirectConnectListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectListMetadata(val *DirectConnectListMetadata) *NullableDirectConnectListMetadata {
	return &NullableDirectConnectListMetadata{value: val, isSet: true}
}

func (v NullableDirectConnectListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
