...
// checks if the ProjectListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectListIntentResponse{}

// ProjectListIntentResponse Response object for intentful operation of projects
type ProjectListIntentResponse struct {
	Entities []ProjectIntentResource `json:"entities,omitempty"`
...
type _ProjectListIntentResponse ProjectListIntentResponse
...
func NewProjectListIntentResponse(apiVersion string, metadata ProjectListMetadataOutput) *ProjectListIntentResponse {
	this := ProjectListIntentResponse{}
...
// SetEntities gets a reference to the given []ProjectIntentResource and assigns it to the Entities field.
...
func (o *ProjectListIntentResponse) GetMetadata() ProjectListMetadataOutput {
	if o == nil {
		var ret ProjectListMetadataOutput
		return ret
	}
...
func (o ProjectListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ProjectListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectListIntentResponse := _ProjectListIntentResponse{}

	err = json.Unmarshal(data, &varProjectListIntentResponse)

	if err != nil {
		return err
	}

	*o = ProjectListIntentResponse(varProjectListIntentResponse)
...
type NullableProjectListIntentResponse struct {
	value *ProjectListIntentResponse
	isSet bool
}

func (v NullableProjectListIntentResponse) Get() *ProjectListIntentResponse {
	return v.value
}

func (v *NullableProjectListIntentResponse) Set(val *ProjectListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectListIntentResponse(val *ProjectListIntentResponse) *NullableProjectListIntentResponse {
	return &NullableProjectListIntentResponse{value: val, isSet: true}
}

func (v NullableProjectListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
