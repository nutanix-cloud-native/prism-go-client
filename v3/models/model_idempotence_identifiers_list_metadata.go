...
// checks if the IdempotenceIdentifiersListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdempotenceIdentifiersListMetadata{}

// IdempotenceIdentifiersListMetadata All api calls that return a list will have this metadata block as input 
...
type _IdempotenceIdentifiersListMetadata IdempotenceIdentifiersListMetadata
...
func NewIdempotenceIdentifiersListMetadata() *IdempotenceIdentifiersListMetadata {
	this := IdempotenceIdentifiersListMetadata{}
...
func (o IdempotenceIdentifiersListMetadata) MarshalJSON() ([]byte, error) {
...
func (o IdempotenceIdentifiersListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *IdempotenceIdentifiersListMetadata) UnmarshalJSON(data []byte) (err error) {
	varIdempotenceIdentifiersListMetadata := _IdempotenceIdentifiersListMetadata{}

	err = json.Unmarshal(data, &varIdempotenceIdentifiersListMetadata)

	if err != nil {
		return err
	}

	*o = IdempotenceIdentifiersListMetadata(varIdempotenceIdentifiersListMetadata)
...
type NullableIdempotenceIdentifiersListMetadata struct {
	value *IdempotenceIdentifiersListMetadata
	isSet bool
}

func (v NullableIdempotenceIdentifiersListMetadata) Get() *IdempotenceIdentifiersListMetadata {
	return v.value
}

func (v *NullableIdempotenceIdentifiersListMetadata) Set(val *IdempotenceIdentifiersListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIdempotenceIdentifiersListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIdempotenceIdentifiersListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdempotenceIdentifiersListMetadata(val *IdempotenceIdentifiersListMetadata) *NullableIdempotenceIdentifiersListMetadata {
	return &NullableIdempotenceIdentifiersListMetadata{value: val, isSet: true}
}

func (v NullableIdempotenceIdentifiersListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdempotenceIdentifiersListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
