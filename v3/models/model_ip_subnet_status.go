...
// checks if the IpSubnetStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpSubnetStatus{}

// IpSubnetStatus IP subnet provided as an address and prefix length.
type IpSubnetStatus struct {
	// IPV4 address.
...
type _IpSubnetStatus IpSubnetStatus
...
func (o IpSubnetStatus) MarshalJSON() ([]byte, error) {
...
func (o IpSubnetStatus) ToMap() (map[string]interface{}, error) {
...
func (o *IpSubnetStatus) UnmarshalJSON(data []byte) (err error) {
	varIpSubnetStatus := _IpSubnetStatus{}

	err = json.Unmarshal(data, &varIpSubnetStatus)

	if err != nil {
		return err
	}

	*o = IpSubnetStatus(varIpSubnetStatus)
...
type NullableIpSubnetStatus struct {
	value *IpSubnetStatus
	isSet bool
}

func (v NullableIpSubnetStatus) Get() *IpSubnetStatus {
	return v.value
}

func (v *NullableIpSubnetStatus) Set(val *IpSubnetStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableIpSubnetStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableIpSubnetStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpSubnetStatus(val *IpSubnetStatus) *NullableIpSubnetStatus {
	return &NullableIpSubnetStatus{value: val, isSet: true}
}

func (v NullableIpSubnetStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpSubnetStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
