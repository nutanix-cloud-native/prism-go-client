...
// checks if the EntitySyncRuleIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySyncRuleIntentInput{}

// EntitySyncRuleIntentInput An intentful representation of a entity_sync_rule
type EntitySyncRuleIntentInput struct {
	Spec EntitySyncRule `json:"spec"`
...
type _EntitySyncRuleIntentInput EntitySyncRuleIntentInput
...
func NewEntitySyncRuleIntentInput(spec EntitySyncRule, metadata EntitySyncRuleMetadata) *EntitySyncRuleIntentInput {
	this := EntitySyncRuleIntentInput{}
	this.Spec = spec
...
func (o EntitySyncRuleIntentInput) MarshalJSON() ([]byte, error) {
...
func (o EntitySyncRuleIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *EntitySyncRuleIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varEntitySyncRuleIntentInput := _EntitySyncRuleIntentInput{}

	err = json.Unmarshal(data, &varEntitySyncRuleIntentInput)

	if err != nil {
		return err
	}

	*o = EntitySyncRuleIntentInput(varEntitySyncRuleIntentInput)
...
type NullableEntitySyncRuleIntentInput struct {
	value *EntitySyncRuleIntentInput
	isSet bool
}

func (v NullableEntitySyncRuleIntentInput) Get() *EntitySyncRuleIntentInput {
	return v.value
}

func (v *NullableEntitySyncRuleIntentInput) Set(val *EntitySyncRuleIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySyncRuleIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySyncRuleIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySyncRuleIntentInput(val *EntitySyncRuleIntentInput) *NullableEntitySyncRuleIntentInput {
	return &NullableEntitySyncRuleIntentInput{value: val, isSet: true}
}

func (v NullableEntitySyncRuleIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySyncRuleIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
