...
// checks if the ClusterIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterIntentInput{}

// ClusterIntentInput An intentful representation of a cluster
type ClusterIntentInput struct {
	Spec Cluster `json:"spec"`
...
type _ClusterIntentInput ClusterIntentInput
...
func (o ClusterIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ClusterIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterIntentInput := _ClusterIntentInput{}

	err = json.Unmarshal(data, &varClusterIntentInput)

	if err != nil {
		return err
	}

	*o = ClusterIntentInput(varClusterIntentInput)
...
type NullableClusterIntentInput struct {
	value *ClusterIntentInput
	isSet bool
}

func (v NullableClusterIntentInput) Get() *ClusterIntentInput {
	return v.value
}

func (v *NullableClusterIntentInput) Set(val *ClusterIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterIntentInput(val *ClusterIntentInput) *NullableClusterIntentInput {
	return &NullableClusterIntentInput{value: val, isSet: true}
}

func (v NullableClusterIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
