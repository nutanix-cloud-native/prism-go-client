...
// checks if the DirectoryServiceStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceStatus{}

// DirectoryServiceStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _DirectoryServiceStatus DirectoryServiceStatus
...
func (o DirectoryServiceStatus) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryServiceStatus) UnmarshalJSON(data []byte) (err error) {
	varDirectoryServiceStatus := _DirectoryServiceStatus{}

	err = json.Unmarshal(data, &varDirectoryServiceStatus)

	if err != nil {
		return err
	}

	*o = DirectoryServiceStatus(varDirectoryServiceStatus)
...
type NullableDirectoryServiceStatus struct {
	value *DirectoryServiceStatus
	isSet bool
}

func (v NullableDirectoryServiceStatus) Get() *DirectoryServiceStatus {
	return v.value
}

func (v *NullableDirectoryServiceStatus) Set(val *DirectoryServiceStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceStatus(val *DirectoryServiceStatus) *NullableDirectoryServiceStatus {
	return &NullableDirectoryServiceStatus{value: val, isSet: true}
}

func (v NullableDirectoryServiceStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
