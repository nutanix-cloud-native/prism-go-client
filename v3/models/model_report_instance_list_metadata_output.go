...
// checks if the ReportInstanceListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstanceListMetadataOutput{}

// ReportInstanceListMetadataOutput All api calls that return a list will have this metadata block 
type ReportInstanceListMetadataOutput struct {
	// The kind name
...
type _ReportInstanceListMetadataOutput ReportInstanceListMetadataOutput
...
func NewReportInstanceListMetadataOutput() *ReportInstanceListMetadataOutput {
	this := ReportInstanceListMetadataOutput{}
	var kind string = "report_instance"
	this.Kind = &kind
	return &this
}
...
func (o ReportInstanceListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ReportInstanceListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ReportInstanceListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varReportInstanceListMetadataOutput := _ReportInstanceListMetadataOutput{}

	err = json.Unmarshal(data, &varReportInstanceListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ReportInstanceListMetadataOutput(varReportInstanceListMetadataOutput)
...
type NullableReportInstanceListMetadataOutput struct {
	value *ReportInstanceListMetadataOutput
	isSet bool
}

func (v NullableReportInstanceListMetadataOutput) Get() *ReportInstanceListMetadataOutput {
	return v.value
}

func (v *NullableReportInstanceListMetadataOutput) Set(val *ReportInstanceListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstanceListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstanceListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstanceListMetadataOutput(val *ReportInstanceListMetadataOutput) *NullableReportInstanceListMetadataOutput {
	return &NullableReportInstanceListMetadataOutput{value: val, isSet: true}
}

func (v NullableReportInstanceListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstanceListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
