...
// checks if the NetworkSecurityRuleResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleResources{}

// NetworkSecurityRuleResources Network security rule resources
type NetworkSecurityRuleResources struct {
	...
	QuarantineRule *QuarantineRule1 `json:"quarantine_rule,omitempty"`
	IsolationRule *IsolationRule `json:"isolation_rule,omitempty"`
	AppRule *AppRule1 `json:"app_rule,omitempty"`
	AdRule *ADRule1 `json:"ad_rule,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NetworkSecurityRuleResources NetworkSecurityRuleResources
...
func NewNetworkSecurityRuleResources() *NetworkSecurityRuleResources {
	this := NetworkSecurityRuleResources{}
	return &this
}
...
// SetQuarantineRule gets a reference to the given QuarantineRule1 and assigns it to the QuarantineRule field.
...
// SetAppRule gets a reference to the given AppRule1 and assigns it to the AppRule field.
...
// SetAdRule gets a reference to the given ADRule1 and assigns it to the AdRule field.
func (o *NetworkSecurityRuleResources) SetAdRule(v ADRule1) {
	o.AdRule = &v
}

func (o NetworkSecurityRuleResources) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleResources) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRuleResources) UnmarshalJSON(data []byte) (err error) {
	varNetworkSecurityRuleResources := _NetworkSecurityRuleResources{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleResources)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleResources(varNetworkSecurityRuleResources)
...
type NullableNetworkSecurityRuleResources struct {
	value *NetworkSecurityRuleResources
	isSet bool
}

func (v NullableNetworkSecurityRuleResources) Get() *NetworkSecurityRuleResources {
	return v.value
}

func (v *NullableNetworkSecurityRuleResources) Set(val *NetworkSecurityRuleResources) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleResources) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleResources(val *NetworkSecurityRuleResources) *NullableNetworkSecurityRuleResources {
	return &NullableNetworkSecurityRuleResources{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
