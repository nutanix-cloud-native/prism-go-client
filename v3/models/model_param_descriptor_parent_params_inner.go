...
// checks if the ParamDescriptorParentParamsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParamDescriptorParentParamsInner{}

// ParamDescriptorParentParamsInner Parent field
type ParamDescriptorParentParamsInner struct {
	// the name of the parent param.
	Name *string `json:"name,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
	// Expected value of the parent param. 
	Value *string `json:"value,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ParamDescriptorParentParamsInner ParamDescriptorParentParamsInner
...
func NewParamDescriptorParentParamsInner() *ParamDescriptorParentParamsInner {
	this := ParamDescriptorParentParamsInner{}
	return &this
}
...
func (o ParamDescriptorParentParamsInner) MarshalJSON() ([]byte, error) {
...
func (o ParamDescriptorParentParamsInner) ToMap() (map[string]interface{}, error) {
...
func (o *ParamDescriptorParentParamsInner) UnmarshalJSON(data []byte) (err error) {
	varParamDescriptorParentParamsInner := _ParamDescriptorParentParamsInner{}

	err = json.Unmarshal(data, &varParamDescriptorParentParamsInner)

	if err != nil {
		return err
	}

	*o = ParamDescriptorParentParamsInner(varParamDescriptorParentParamsInner)
...
type NullableParamDescriptorParentParamsInner struct {
	value *ParamDescriptorParentParamsInner
	isSet bool
}

func (v NullableParamDescriptorParentParamsInner) Get() *ParamDescriptorParentParamsInner {
	return v.value
}

func (v *NullableParamDescriptorParentParamsInner) Set(val *ParamDescriptorParentParamsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableParamDescriptorParentParamsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableParamDescriptorParentParamsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParamDescriptorParentParamsInner(val *ParamDescriptorParentParamsInner) *NullableParamDescriptorParentParamsInner {
	return &NullableParamDescriptorParentParamsInner{value: val, isSet: true}
}

func (v NullableParamDescriptorParentParamsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParamDescriptorParentParamsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
