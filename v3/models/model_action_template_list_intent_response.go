...
// checks if the ActionTemplateListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTemplateListIntentResponse{}

// ActionTemplateListIntentResponse Response object for intentful operation of action_templates
type ActionTemplateListIntentResponse struct {
	Entities []ActionTemplateIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ActionTemplateListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ActionTemplateListIntentResponse ActionTemplateListIntentResponse
...
func NewActionTemplateListIntentResponse(apiVersion string, metadata ActionTemplateListMetadataOutput) *ActionTemplateListIntentResponse {
	this := ActionTemplateListIntentResponse{}
...
func (o *ActionTemplateListIntentResponse) GetEntities() []ActionTemplateIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []ActionTemplateIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []ActionTemplateIntentResource and assigns it to the Entities field.
...
func (o *ActionTemplateListIntentResponse) GetMetadata() ActionTemplateListMetadataOutput {
	if o == nil {
		var ret ActionTemplateListMetadataOutput
		return ret
	}
...
func (o ActionTemplateListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ActionTemplateListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTemplateListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTemplateListIntentResponse := _ActionTemplateListIntentResponse{}

	err = json.Unmarshal(data, &varActionTemplateListIntentResponse)

	if err != nil {
		return err
	}

	*o = ActionTemplateListIntentResponse(varActionTemplateListIntentResponse)
...
type NullableActionTemplateListIntentResponse struct {
	value *ActionTemplateListIntentResponse
	isSet bool
}

func (v NullableActionTemplateListIntentResponse) Get() *ActionTemplateListIntentResponse {
	return v.value
}

func (v *NullableActionTemplateListIntentResponse) Set(val *ActionTemplateListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTemplateListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTemplateListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTemplateListIntentResponse(val *ActionTemplateListIntentResponse) *NullableActionTemplateListIntentResponse {
	return &NullableActionTemplateListIntentResponse{value: val, isSet: true}
}

func (v NullableActionTemplateListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTemplateListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
