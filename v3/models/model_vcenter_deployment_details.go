...
// checks if the VcenterDeploymentDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VcenterDeploymentDetails{}

// VcenterDeploymentDetails vCenter specific information required to deploy the VPN VM on on-prem ESXi clusters. 
type VcenterDeploymentDetails struct {
	// vcenter network name to which the vpn vm nic is attached. 
	VcenterNetworkName *string `json:"vcenter_network_name,omitempty"`
	// vcenter datacenter that the cluster belongs to. required when interacting with vcenter apis to deploy the vpn vm. 
	VcenterDatacenterName *string `json:"vcenter_datacenter_name,omitempty"`
	// vcenter datastore to which the vpn disks and images will be uploaded during deployment. 
	VcenterDatastoreName *string `json:"vcenter_datastore_name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VcenterDeploymentDetails VcenterDeploymentDetails
...
// GetVcenterNetworkName returns the VcenterNetworkName field value if set, zero value otherwise.
func (o *VcenterDeploymentDetails) GetVcenterNetworkName() string {
	if o == nil || IsNil(o.VcenterNetworkName) {
		var ret string
		return ret
	}
	return *o.VcenterNetworkName
}

// GetVcenterNetworkNameOk returns a tuple with the VcenterNetworkName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VcenterDeploymentDetails) GetVcenterNetworkNameOk() (*string, bool) {
	if o == nil || IsNil(o.VcenterNetworkName) {
		return nil, false
	}
	return o.VcenterNetworkName, true
}
...
// SetVcenterNetworkName gets a reference to the given string and assigns it to the VcenterNetworkName field.
func (o *VcenterDeploymentDetails) SetVcenterNetworkName(v string) {
	o.VcenterNetworkName = &v
}

// GetVcenterDatacenterName returns the VcenterDatacenterName field value if set, zero value otherwise.
func (o *VcenterDeploymentDetails) GetVcenterDatacenterName() string {
	if o == nil || IsNil(o.VcenterDatacenterName) {
		var ret string
		return ret
	}
	return *o.VcenterDatacenterName
}

// GetVcenterDatacenterNameOk returns a tuple with the VcenterDatacenterName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VcenterDeploymentDetails) GetVcenterDatacenterNameOk() (*string, bool) {
	if o == nil || IsNil(o.VcenterDatacenterName) {
		return nil, false
	}
	return o.VcenterDatacenterName, true
}
...
// SetVcenterDatacenterName gets a reference to the given string and assigns it to the VcenterDatacenterName field.
func (o *VcenterDeploymentDetails) SetVcenterDatacenterName(v string) {
	o.VcenterDatacenterName = &v
}

// GetVcenterDatastoreName returns the VcenterDatastoreName field value if set, zero value otherwise.
func (o *VcenterDeploymentDetails) GetVcenterDatastoreName() string {
	if o == nil || IsNil(o.VcenterDatastoreName) {
		var ret string
		return ret
	}
	return *o.VcenterDatastoreName
}

// GetVcenterDatastoreNameOk returns a tuple with the VcenterDatastoreName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VcenterDeploymentDetails) GetVcenterDatastoreNameOk() (*string, bool) {
	if o == nil || IsNil(o.VcenterDatastoreName) {
		return nil, false
	}
	return o.VcenterDatastoreName, true
}
...
// SetVcenterDatastoreName gets a reference to the given string and assigns it to the VcenterDatastoreName field.
func (o *VcenterDeploymentDetails) SetVcenterDatastoreName(v string) {
	o.VcenterDatastoreName = &v
}

func (o VcenterDeploymentDetails) MarshalJSON() ([]byte, error) {
...
func (o VcenterDeploymentDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VcenterNetworkName) {
		toSerialize["vcenter_network_name"] = o.VcenterNetworkName
	}
	if !IsNil(o.VcenterDatacenterName) {
		toSerialize["vcenter_datacenter_name"] = o.VcenterDatacenterName
	}
	if !IsNil(o.VcenterDatastoreName) {
		toSerialize["vcenter_datastore_name"] = o.VcenterDatastoreName
	}
...
func (o *VcenterDeploymentDetails) UnmarshalJSON(data []byte) (err error) {
	varVcenterDeploymentDetails := _VcenterDeploymentDetails{}

	err = json.Unmarshal(data, &varVcenterDeploymentDetails)

	if err != nil {
		return err
	}

	*o = VcenterDeploymentDetails(varVcenterDeploymentDetails)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vcenter_network_name")
		delete(additionalProperties, "vcenter_datacenter_name")
		delete(additionalProperties, "vcenter_datastore_name")
...
type NullableVcenterDeploymentDetails struct {
	value *VcenterDeploymentDetails
	isSet bool
}

func (v NullableVcenterDeploymentDetails) Get() *VcenterDeploymentDetails {
	return v.value
}

func (v *NullableVcenterDeploymentDetails) Set(val *VcenterDeploymentDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableVcenterDeploymentDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableVcenterDeploymentDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVcenterDeploymentDetails(val *VcenterDeploymentDetails) *NullableVcenterDeploymentDetails {
	return &NullableVcenterDeploymentDetails{value: val, isSet: true}
}

func (v NullableVcenterDeploymentDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVcenterDeploymentDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
