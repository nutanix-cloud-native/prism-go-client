...
// checks if the ActionRuleIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleIntentInput{}

// ActionRuleIntentInput An intentful representation of a action_rule
type ActionRuleIntentInput struct {
	Spec ActionRule `json:"spec"`
...
type _ActionRuleIntentInput ActionRuleIntentInput
...
func (o ActionRuleIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleIntentInput := _ActionRuleIntentInput{}

	err = json.Unmarshal(data, &varActionRuleIntentInput)

	if err != nil {
		return err
	}

	*o = ActionRuleIntentInput(varActionRuleIntentInput)
...
type NullableActionRuleIntentInput struct {
	value *ActionRuleIntentInput
	isSet bool
}

func (v NullableActionRuleIntentInput) Get() *ActionRuleIntentInput {
	return v.value
}

func (v *NullableActionRuleIntentInput) Set(val *ActionRuleIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleIntentInput(val *ActionRuleIntentInput) *NullableActionRuleIntentInput {
	return &NullableActionRuleIntentInput{value: val, isSet: true}
}

func (v NullableActionRuleIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
