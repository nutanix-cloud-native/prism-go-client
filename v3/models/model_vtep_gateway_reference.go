...
// checks if the VtepGatewayReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VtepGatewayReference{}

// VtepGatewayReference The reference to a vtep_gateway
...
type _VtepGatewayReference VtepGatewayReference
...
func (o VtepGatewayReference) MarshalJSON() ([]byte, error) {
...
func (o VtepGatewayReference) ToMap() (map[string]interface{}, error) {
...
func (o *VtepGatewayReference) UnmarshalJSON(data []byte) (err error) {
	...
	varVtepGatewayReference := _VtepGatewayReference{}

	err = json.Unmarshal(data, &varVtepGatewayReference)

	if err != nil {
		return err
	}

	*o = VtepGatewayReference(varVtepGatewayReference)
...
type NullableVtepGatewayReference struct {
	value *VtepGatewayReference
	isSet bool
}

func (v NullableVtepGatewayReference) Get() *VtepGatewayReference {
	return v.value
}

func (v *NullableVtepGatewayReference) Set(val *VtepGatewayReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVtepGatewayReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVtepGatewayReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVtepGatewayReference(val *VtepGatewayReference) *NullableVtepGatewayReference {
	return &NullableVtepGatewayReference{value: val, isSet: true}
}

func (v NullableVtepGatewayReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVtepGatewayReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
