...
// checks if the ReplicateRecoveryPointInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicateRecoveryPointInput{}

// ReplicateRecoveryPointInput Input for replicating a Recovery Point.
type ReplicateRecoveryPointInput struct {
...
type _ReplicateRecoveryPointInput ReplicateRecoveryPointInput
...
func NewReplicateRecoveryPointInput(sourceAvailabilityZoneReference AvailabilityZoneReference, targetAvailabilityZoneReference AvailabilityZoneReference) *ReplicateRecoveryPointInput {
	this := ReplicateRecoveryPointInput{}
...
func (o ReplicateRecoveryPointInput) MarshalJSON() ([]byte, error) {
...
func (o ReplicateRecoveryPointInput) ToMap() (map[string]interface{}, error) {
...
func (o *ReplicateRecoveryPointInput) UnmarshalJSON(data []byte) (err error) {
	...
	varReplicateRecoveryPointInput := _ReplicateRecoveryPointInput{}

	err = json.Unmarshal(data, &varReplicateRecoveryPointInput)

	if err != nil {
		return err
	}

	*o = ReplicateRecoveryPointInput(varReplicateRecoveryPointInput)
...
type NullableReplicateRecoveryPointInput struct {
	value *ReplicateRecoveryPointInput
	isSet bool
}

func (v NullableReplicateRecoveryPointInput) Get() *ReplicateRecoveryPointInput {
	return v.value
}

func (v *NullableReplicateRecoveryPointInput) Set(val *ReplicateRecoveryPointInput) {
	v.value = val
	v.isSet = true
}

func (v NullableReplicateRecoveryPointInput) IsSet() bool {
	return v.isSet
}

func (v *NullableReplicateRecoveryPointInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReplicateRecoveryPointInput(val *ReplicateRecoveryPointInput) *NullableReplicateRecoveryPointInput {
	return &NullableReplicateRecoveryPointInput{value: val, isSet: true}
}

func (v NullableReplicateRecoveryPointInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReplicateRecoveryPointInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
