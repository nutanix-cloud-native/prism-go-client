...
// ProtectionPolicyState Policy State
//
// State of enforced policy on an entity.
//
// swagger:model protection_policy_state
...
// Validate validates this protection policy state
func (m *ProtectionPolicyState) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProtectionPolicyState) validateComplianceStatus(formats strfmt.Registry) error {
...
func (m *ProtectionPolicyState) validateEnforcementMode(formats strfmt.Registry) error {
...
func (m *ProtectionPolicyState) validateErrorMessageList(formats strfmt.Registry) error {
...
func (m *ProtectionPolicyState) validatePolicyInfo(formats strfmt.Registry) error {
...
func (m *ProtectionPolicyState) validatePolicyReference(formats strfmt.Registry) error {
...
// ContextValidate validate this protection policy state based on the context it is used
func (m *ProtectionPolicyState) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ProtectionPolicyState) contextValidateComplianceStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionPolicyState) contextValidateErrorMessageList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionPolicyState) contextValidatePolicyInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionPolicyState) contextValidatePolicyReference(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionPolicyState) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ProtectionPolicyState) UnmarshalBinary(b []byte) error {
	var res ProtectionPolicyState
