...
// checks if the AwsRegionListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRegionListIntentResponse{}

// AwsRegionListIntentResponse AWS VPC entity list.
type AwsRegionListIntentResponse struct {
	Entities []AwsRegionIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsRegionListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsRegionListIntentResponse AwsRegionListIntentResponse
...
func NewAwsRegionListIntentResponse(apiVersion string, metadata AwsRegionListMetadataOutput) *AwsRegionListIntentResponse {
	this := AwsRegionListIntentResponse{}
...
func (o *AwsRegionListIntentResponse) GetEntities() []AwsRegionIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []AwsRegionIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []AwsRegionIntentResource and assigns it to the Entities field.
...
func (o *AwsRegionListIntentResponse) GetMetadata() AwsRegionListMetadataOutput {
	if o == nil {
		var ret AwsRegionListMetadataOutput
		return ret
	}
...
func (o AwsRegionListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsRegionListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRegionListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsRegionListIntentResponse := _AwsRegionListIntentResponse{}

	err = json.Unmarshal(data, &varAwsRegionListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsRegionListIntentResponse(varAwsRegionListIntentResponse)
...
type NullableAwsRegionListIntentResponse struct {
	value *AwsRegionListIntentResponse
	isSet bool
}

func (v NullableAwsRegionListIntentResponse) Get() *AwsRegionListIntentResponse {
	return v.value
}

func (v *NullableAwsRegionListIntentResponse) Set(val *AwsRegionListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRegionListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRegionListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRegionListIntentResponse(val *AwsRegionListIntentResponse) *NullableAwsRegionListIntentResponse {
	return &NullableAwsRegionListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsRegionListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRegionListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
