...
// checks if the AppResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppResourcesDefStatus{}

// AppResourcesDefStatus Status for Application.
type AppResourcesDefStatus struct {
	AppState string `json:"app_state"`
	// List of Action for Application.
	ActionList []AppActionResponse `json:"action_list"`
	...
	CredentialList []AppCredentialResponse `json:"credential_list"`
	AppBlueprintConfigReference *BlueprintReference `json:"app_blueprint_config_reference,omitempty"`
	AppBlueprintReference BlueprintReference `json:"app_blueprint_reference"`
	AppProfileConfigReference *AppProfileReference `json:"app_profile_config_reference,omitempty"`
	...
	DependencyList []BlueprintDependencyList `json:"dependency_list,omitempty"`
	// List of variables
	VariableList []AppVariableResponse `json:"variable_list"`
	// List of Deployment Spec for Application.
	DeploymentList []AppDeploymentResponse `json:"deployment_list"`
	AdditionalProperties map[string]interface{}
}

type _AppResourcesDefStatus AppResourcesDefStatus
...
func NewAppResourcesDefStatus(appState string, actionList []AppActionResponse, credentialList []AppCredentialResponse, appBlueprintReference BlueprintReference, variableList []AppVariableResponse, deploymentList []AppDeploymentResponse) *AppResourcesDefStatus {
	this := AppResourcesDefStatus{}
	this.AppState = appState
	this.ActionList = actionList
	this.CredentialList = credentialList
	this.AppBlueprintReference = appBlueprintReference
...
// GetSourceMarketplaceName returns the SourceMarketplaceName field value if set, zero value otherwise.
func (o *AppResourcesDefStatus) GetSourceMarketplaceName() string {
	if o == nil || IsNil(o.SourceMarketplaceName) {
		var ret string
		return ret
	}
	return *o.SourceMarketplaceName
}

// GetSourceMarketplaceNameOk returns a tuple with the SourceMarketplaceName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppResourcesDefStatus) GetSourceMarketplaceNameOk() (*string, bool) {
	if o == nil || IsNil(o.SourceMarketplaceName) {
		return nil, false
	}
	return o.SourceMarketplaceName, true
}
...
// SetSourceMarketplaceName gets a reference to the given string and assigns it to the SourceMarketplaceName field.
func (o *AppResourcesDefStatus) SetSourceMarketplaceName(v string) {
	o.SourceMarketplaceName = &v
}

// GetCredentialList returns the CredentialList field value
...
// GetCredentialListOk returns a tuple with the CredentialList field value
// and a boolean to check if the value has been set.
...
// SetCredentialList sets field value
func (o *AppResourcesDefStatus) SetCredentialList(v []AppCredentialResponse) {
	o.CredentialList = v
}

// GetAppBlueprintConfigReference returns the AppBlueprintConfigReference field value if set, zero value otherwise.
func (o *AppResourcesDefStatus) GetAppBlueprintConfigReference() BlueprintReference {
	if o == nil || IsNil(o.AppBlueprintConfigReference) {
		var ret BlueprintReference
		return ret
	}
	return *o.AppBlueprintConfigReference
}

// GetAppBlueprintConfigReferenceOk returns a tuple with the AppBlueprintConfigReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppResourcesDefStatus) GetAppBlueprintConfigReferenceOk() (*BlueprintReference, bool) {
	if o == nil || IsNil(o.AppBlueprintConfigReference) {
		return nil, false
	}
	return o.AppBlueprintConfigReference, true
}
...
// SetAppBlueprintConfigReference gets a reference to the given BlueprintReference and assigns it to the AppBlueprintConfigReference field.
func (o *AppResourcesDefStatus) SetAppBlueprintConfigReference(v BlueprintReference) {
	o.AppBlueprintConfigReference = &v
}

// GetAppBlueprintReference returns the AppBlueprintReference field value
func (o *AppResourcesDefStatus) GetAppBlueprintReference() BlueprintReference {
	...
	return o.AppBlueprintReference
}

// GetAppBlueprintReferenceOk returns a tuple with the AppBlueprintReference field value
// and a boolean to check if the value has been set.
func (o *AppResourcesDefStatus) GetAppBlueprintReferenceOk() (*BlueprintReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AppBlueprintReference, true
}

// SetAppBlueprintReference sets field value
func (o *AppResourcesDefStatus) SetAppBlueprintReference(v BlueprintReference) {
	o.AppBlueprintReference = v
}

// GetAppProfileConfigReference returns the AppProfileConfigReference field value if set, zero value otherwise.
func (o *AppResourcesDefStatus) GetAppProfileConfigReference() AppProfileReference {
	if o == nil || IsNil(o.AppProfileConfigReference) {
		var ret AppProfileReference
		return ret
	}
	return *o.AppProfileConfigReference
}

// GetAppProfileConfigReferenceOk returns a tuple with the AppProfileConfigReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppResourcesDefStatus) GetAppProfileConfigReferenceOk() (*AppProfileReference, bool) {
	if o == nil || IsNil(o.AppProfileConfigReference) {
		return nil, false
	}
	return o.AppProfileConfigReference, true
}
...
// SetAppProfileConfigReference gets a reference to the given AppProfileReference and assigns it to the AppProfileConfigReference field.
func (o *AppResourcesDefStatus) SetAppProfileConfigReference(v AppProfileReference) {
	o.AppProfileConfigReference = &v
}

// GetSourceMarketplaceVersion returns the SourceMarketplaceVersion field value if set, zero value otherwise.
func (o *AppResourcesDefStatus) GetSourceMarketplaceVersion() string {
	if o == nil || IsNil(o.SourceMarketplaceVersion) {
		var ret string
		return ret
	}
	return *o.SourceMarketplaceVersion
}

// GetSourceMarketplaceVersionOk returns a tuple with the SourceMarketplaceVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppResourcesDefStatus) GetSourceMarketplaceVersionOk() (*string, bool) {
	if o == nil || IsNil(o.SourceMarketplaceVersion) {
		return nil, false
	}
	return o.SourceMarketplaceVersion, true
}
...
// SetSourceMarketplaceVersion gets a reference to the given string and assigns it to the SourceMarketplaceVersion field.
func (o *AppResourcesDefStatus) SetSourceMarketplaceVersion(v string) {
	o.SourceMarketplaceVersion = &v
}
...
// GetDependencyList returns the DependencyList field value if set, zero value otherwise.
func (o *AppResourcesDefStatus) GetDependencyList() []BlueprintDependencyList {
	if o == nil || IsNil(o.DependencyList) {
		var ret []BlueprintDependencyList
		return ret
	}
	return o.DependencyList
}

// GetDependencyListOk returns a tuple with the DependencyList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppResourcesDefStatus) GetDependencyListOk() ([]BlueprintDependencyList, bool) {
	if o == nil || IsNil(o.DependencyList) {
		return nil, false
	}
	return o.DependencyList, true
}
...
// SetDependencyList gets a reference to the given []BlueprintDependencyList and assigns it to the DependencyList field.
func (o *AppResourcesDefStatus) SetDependencyList(v []BlueprintDependencyList) {
	o.DependencyList = v
}

// GetVariableList returns the VariableList field value
...
// GetVariableListOk returns a tuple with the VariableList field value
// and a boolean to check if the value has been set.
...
// SetVariableList sets field value
func (o *AppResourcesDefStatus) SetVariableList(v []AppVariableResponse) {
	o.VariableList = v
}

// GetDeploymentList returns the DeploymentList field value
func (o *AppResourcesDefStatus) GetDeploymentList() []AppDeploymentResponse {
	if o == nil {
		var ret []AppDeploymentResponse
		return ret
	}

	return o.DeploymentList
}

// GetDeploymentListOk returns a tuple with the DeploymentList field value
// and a boolean to check if the value has been set.
func (o *AppResourcesDefStatus) GetDeploymentListOk() ([]AppDeploymentResponse, bool) {
	if o == nil {
		return nil, false
	}
	return o.DeploymentList, true
}

// SetDeploymentList sets field value
func (o *AppResourcesDefStatus) SetDeploymentList(v []AppDeploymentResponse) {
	o.DeploymentList = v
}

func (o AppResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AppResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["app_state"] = o.AppState
	toSerialize["action_list"] = o.ActionList
	if !IsNil(o.SourceMarketplaceName) {
		toSerialize["source_marketplace_name"] = o.SourceMarketplaceName
	}
	toSerialize["credential_list"] = o.CredentialList
	if !IsNil(o.AppBlueprintConfigReference) {
		toSerialize["app_blueprint_config_reference"] = o.AppBlueprintConfigReference
	}
	toSerialize["app_blueprint_reference"] = o.AppBlueprintReference
	if !IsNil(o.AppProfileConfigReference) {
		toSerialize["app_profile_config_reference"] = o.AppProfileConfigReference
	}
	if !IsNil(o.SourceMarketplaceVersion) {
		toSerialize["source_marketplace_version"] = o.SourceMarketplaceVersion
	}
	if !IsNil(o.ClientAttrs) {
		toSerialize["client_attrs"] = o.ClientAttrs
	}
	if !IsNil(o.DependencyList) {
		toSerialize["dependency_list"] = o.DependencyList
	}
	toSerialize["variable_list"] = o.VariableList
	toSerialize["deployment_list"] = o.DeploymentList
...
func (o *AppResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAppResourcesDefStatus := _AppResourcesDefStatus{}

	err = json.Unmarshal(data, &varAppResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = AppResourcesDefStatus(varAppResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "app_state")
		delete(additionalProperties, "action_list")
		delete(additionalProperties, "source_marketplace_name")
		delete(additionalProperties, "credential_list")
		delete(additionalProperties, "app_blueprint_config_reference")
		delete(additionalProperties, "app_blueprint_reference")
		delete(additionalProperties, "app_profile_config_reference")
		delete(additionalProperties, "source_marketplace_version")
		delete(additionalProperties, "client_attrs")
		delete(additionalProperties, "dependency_list")
		delete(additionalProperties, "variable_list")
		delete(additionalProperties, "deployment_list")
...
type NullableAppResourcesDefStatus struct {
	value *AppResourcesDefStatus
	isSet bool
}

func (v NullableAppResourcesDefStatus) Get() *AppResourcesDefStatus {
	return v.value
}

func (v *NullableAppResourcesDefStatus) Set(val *AppResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAppResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAppResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppResourcesDefStatus(val *AppResourcesDefStatus) *NullableAppResourcesDefStatus {
	return &NullableAppResourcesDefStatus{value: val, isSet: true}
}

func (v NullableAppResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
