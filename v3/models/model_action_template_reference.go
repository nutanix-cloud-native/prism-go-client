...
// checks if the ActionTemplateReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTemplateReference{}

// ActionTemplateReference The reference to a action_template
type ActionTemplateReference struct {
	// The kind name
...
type _ActionTemplateReference ActionTemplateReference
...
func (o ActionTemplateReference) MarshalJSON() ([]byte, error) {
...
func (o ActionTemplateReference) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTemplateReference) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTemplateReference := _ActionTemplateReference{}

	err = json.Unmarshal(data, &varActionTemplateReference)

	if err != nil {
		return err
	}

	*o = ActionTemplateReference(varActionTemplateReference)
...
type NullableActionTemplateReference struct {
	value *ActionTemplateReference
	isSet bool
}

func (v NullableActionTemplateReference) Get() *ActionTemplateReference {
	return v.value
}

func (v *NullableActionTemplateReference) Set(val *ActionTemplateReference) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTemplateReference) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTemplateReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTemplateReference(val *ActionTemplateReference) *NullableActionTemplateReference {
	return &NullableActionTemplateReference{value: val, isSet: true}
}

func (v NullableActionTemplateReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTemplateReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
