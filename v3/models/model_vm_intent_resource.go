...
// checks if the VmIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmIntentResource{}
...
type _VmIntentResource VmIntentResource
...
// SetStatus gets a reference to the given VmDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Vm and assigns it to the Spec field.
...
func (o VmIntentResource) MarshalJSON() ([]byte, error) {
...
func (o VmIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *VmIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varVmIntentResource := _VmIntentResource{}

	err = json.Unmarshal(data, &varVmIntentResource)

	if err != nil {
		return err
	}

	*o = VmIntentResource(varVmIntentResource)
...
type NullableVmIntentResource struct {
	value *VmIntentResource
	isSet bool
}

func (v NullableVmIntentResource) Get() *VmIntentResource {
	return v.value
}

func (v *NullableVmIntentResource) Set(val *VmIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableVmIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableVmIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmIntentResource(val *VmIntentResource) *NullableVmIntentResource {
	return &NullableVmIntentResource{value: val, isSet: true}
}

func (v NullableVmIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
