...
// AuditMetadata The audit kind metadata
type AuditMetadata struct {
	// UTC date and time in RFC-3339 format when audit was last updated 
	...
	// UTC date and time in RFC-3339 format when audit was created 
...
func (o *AuditMetadata) UnmarshalJSON(data []byte) (err error) {
	varAuditMetadata := _AuditMetadata{}

	err = json.Unmarshal(data, &varAuditMetadata)

	if err != nil {
		return err
	}

	*o = AuditMetadata(varAuditMetadata)
