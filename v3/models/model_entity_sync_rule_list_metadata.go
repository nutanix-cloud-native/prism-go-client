...
// checks if the EntitySyncRuleListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySyncRuleListMetadata{}

// EntitySyncRuleListMetadata All api calls that return a list will have this metadata block as input 
type EntitySyncRuleListMetadata struct {
	// The kind name
...
type _EntitySyncRuleListMetadata EntitySyncRuleListMetadata
...
func NewEntitySyncRuleListMetadata() *EntitySyncRuleListMetadata {
	this := EntitySyncRuleListMetadata{}
...
func (o EntitySyncRuleListMetadata) MarshalJSON() ([]byte, error) {
...
func (o EntitySyncRuleListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *EntitySyncRuleListMetadata) UnmarshalJSON(data []byte) (err error) {
	varEntitySyncRuleListMetadata := _EntitySyncRuleListMetadata{}

	err = json.Unmarshal(data, &varEntitySyncRuleListMetadata)

	if err != nil {
		return err
	}

	*o = EntitySyncRuleListMetadata(varEntitySyncRuleListMetadata)
...
type NullableEntitySyncRuleListMetadata struct {
	value *EntitySyncRuleListMetadata
	isSet bool
}

func (v NullableEntitySyncRuleListMetadata) Get() *EntitySyncRuleListMetadata {
	return v.value
}

func (v *NullableEntitySyncRuleListMetadata) Set(val *EntitySyncRuleListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySyncRuleListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySyncRuleListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySyncRuleListMetadata(val *EntitySyncRuleListMetadata) *NullableEntitySyncRuleListMetadata {
	return &NullableEntitySyncRuleListMetadata{value: val, isSet: true}
}

func (v NullableEntitySyncRuleListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySyncRuleListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
