...
// checks if the UserGroupListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupListMetadataOutput{}

// UserGroupListMetadataOutput All api calls that return a list will have this metadata block 
type UserGroupListMetadataOutput struct {
	// The kind name
...
type _UserGroupListMetadataOutput UserGroupListMetadataOutput
...
func NewUserGroupListMetadataOutput() *UserGroupListMetadataOutput {
	this := UserGroupListMetadataOutput{}
	var kind string = "user_group"
	this.Kind = &kind
	return &this
}
...
func (o UserGroupListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o UserGroupListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *UserGroupListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varUserGroupListMetadataOutput := _UserGroupListMetadataOutput{}

	err = json.Unmarshal(data, &varUserGroupListMetadataOutput)

	if err != nil {
		return err
	}

	*o = UserGroupListMetadataOutput(varUserGroupListMetadataOutput)
...
type NullableUserGroupListMetadataOutput struct {
	value *UserGroupListMetadataOutput
	isSet bool
}

func (v NullableUserGroupListMetadataOutput) Get() *UserGroupListMetadataOutput {
	return v.value
}

func (v *NullableUserGroupListMetadataOutput) Set(val *UserGroupListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupListMetadataOutput(val *UserGroupListMetadataOutput) *NullableUserGroupListMetadataOutput {
	return &NullableUserGroupListMetadataOutput{value: val, isSet: true}
}

func (v NullableUserGroupListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
