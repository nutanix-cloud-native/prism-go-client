...
// checks if the AwsSecurityGroupStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSecurityGroupStatus{}

// AwsSecurityGroupStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _AwsSecurityGroupStatus AwsSecurityGroupStatus
...
func (o AwsSecurityGroupStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsSecurityGroupStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSecurityGroupStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsSecurityGroupStatus := _AwsSecurityGroupStatus{}

	err = json.Unmarshal(data, &varAwsSecurityGroupStatus)

	if err != nil {
		return err
	}

	*o = AwsSecurityGroupStatus(varAwsSecurityGroupStatus)
...
type NullableAwsSecurityGroupStatus struct {
	value *AwsSecurityGroupStatus
	isSet bool
}

func (v NullableAwsSecurityGroupStatus) Get() *AwsSecurityGroupStatus {
	return v.value
}

func (v *NullableAwsSecurityGroupStatus) Set(val *AwsSecurityGroupStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSecurityGroupStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSecurityGroupStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSecurityGroupStatus(val *AwsSecurityGroupStatus) *NullableAwsSecurityGroupStatus {
	return &NullableAwsSecurityGroupStatus{value: val, isSet: true}
}

func (v NullableAwsSecurityGroupStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSecurityGroupStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
