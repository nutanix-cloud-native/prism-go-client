...
// checks if the UserGroupStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupStatus{}

// UserGroupStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _UserGroupStatus UserGroupStatus
...
func (o UserGroupStatus) MarshalJSON() ([]byte, error) {
...
func (o UserGroupStatus) ToMap() (map[string]interface{}, error) {
...
func (o *UserGroupStatus) UnmarshalJSON(data []byte) (err error) {
	varUserGroupStatus := _UserGroupStatus{}

	err = json.Unmarshal(data, &varUserGroupStatus)

	if err != nil {
		return err
	}

	*o = UserGroupStatus(varUserGroupStatus)
...
type NullableUserGroupStatus struct {
	value *UserGroupStatus
	isSet bool
}

func (v NullableUserGroupStatus) Get() *UserGroupStatus {
	return v.value
}

func (v *NullableUserGroupStatus) Set(val *UserGroupStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupStatus(val *UserGroupStatus) *NullableUserGroupStatus {
	return &NullableUserGroupStatus{value: val, isSet: true}
}

func (v NullableUserGroupStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
