...
// checks if the HypervisorServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorServer{}

// HypervisorServer Hypervisor server information.
...
type _HypervisorServer HypervisorServer
...
func (o HypervisorServer) MarshalJSON() ([]byte, error) {
...
func (o HypervisorServer) ToMap() (map[string]interface{}, error) {
...
func (o *HypervisorServer) UnmarshalJSON(data []byte) (err error) {
	...
	varHypervisorServer := _HypervisorServer{}

	err = json.Unmarshal(data, &varHypervisorServer)

	if err != nil {
		return err
	}

	*o = HypervisorServer(varHypervisorServer)
...
type NullableHypervisorServer struct {
	value *HypervisorServer
	isSet bool
}

func (v NullableHypervisorServer) Get() *HypervisorServer {
	return v.value
}

func (v *NullableHypervisorServer) Set(val *HypervisorServer) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorServer) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorServer(val *HypervisorServer) *NullableHypervisorServer {
	return &NullableHypervisorServer{value: val, isSet: true}
}

func (v NullableHypervisorServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
