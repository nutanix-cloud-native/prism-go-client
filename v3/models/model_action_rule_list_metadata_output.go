...
// checks if the ActionRuleListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleListMetadataOutput{}

// ActionRuleListMetadataOutput All api calls that return a list will have this metadata block 
type ActionRuleListMetadataOutput struct {
	// The kind name
...
type _ActionRuleListMetadataOutput ActionRuleListMetadataOutput
...
func NewActionRuleListMetadataOutput() *ActionRuleListMetadataOutput {
	this := ActionRuleListMetadataOutput{}
	var kind string = "action_rule"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *ActionRuleListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o ActionRuleListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varActionRuleListMetadataOutput := _ActionRuleListMetadataOutput{}

	err = json.Unmarshal(data, &varActionRuleListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ActionRuleListMetadataOutput(varActionRuleListMetadataOutput)
...
type NullableActionRuleListMetadataOutput struct {
	value *ActionRuleListMetadataOutput
	isSet bool
}

func (v NullableActionRuleListMetadataOutput) Get() *ActionRuleListMetadataOutput {
	return v.value
}

func (v *NullableActionRuleListMetadataOutput) Set(val *ActionRuleListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleListMetadataOutput(val *ActionRuleListMetadataOutput) *NullableActionRuleListMetadataOutput {
	return &NullableActionRuleListMetadataOutput{value: val, isSet: true}
}

func (v NullableActionRuleListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
