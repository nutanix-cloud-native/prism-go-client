...
// checks if the AwsSecurityGroupListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSecurityGroupListMetadataOutput{}

// AwsSecurityGroupListMetadataOutput All api calls that return a list will have this metadata block 
type AwsSecurityGroupListMetadataOutput struct {
	// The kind name
...
type _AwsSecurityGroupListMetadataOutput AwsSecurityGroupListMetadataOutput
...
func NewAwsSecurityGroupListMetadataOutput() *AwsSecurityGroupListMetadataOutput {
	this := AwsSecurityGroupListMetadataOutput{}
	var kind string = "aws_security_group"
	this.Kind = &kind
	return &this
}
...
func (o AwsSecurityGroupListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsSecurityGroupListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSecurityGroupListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsSecurityGroupListMetadataOutput := _AwsSecurityGroupListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsSecurityGroupListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsSecurityGroupListMetadataOutput(varAwsSecurityGroupListMetadataOutput)
...
type NullableAwsSecurityGroupListMetadataOutput struct {
	value *AwsSecurityGroupListMetadataOutput
	isSet bool
}

func (v NullableAwsSecurityGroupListMetadataOutput) Get() *AwsSecurityGroupListMetadataOutput {
	return v.value
}

func (v *NullableAwsSecurityGroupListMetadataOutput) Set(val *AwsSecurityGroupListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSecurityGroupListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSecurityGroupListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSecurityGroupListMetadataOutput(val *AwsSecurityGroupListMetadataOutput) *NullableAwsSecurityGroupListMetadataOutput {
	return &NullableAwsSecurityGroupListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsSecurityGroupListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSecurityGroupListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
