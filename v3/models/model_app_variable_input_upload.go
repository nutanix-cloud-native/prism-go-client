...
// checks if the AppVariableInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppVariableInputUpload{}

// AppVariableInputUpload Variable definition for application.
type AppVariableInputUpload struct {
	// 
...
type _AppVariableInputUpload AppVariableInputUpload
...
func (o AppVariableInputUpload) MarshalJSON() ([]byte, error) {
...
func (o AppVariableInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppVariableInputUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppVariableInputUpload := _AppVariableInputUpload{}

	err = json.Unmarshal(data, &varAppVariableInputUpload)

	if err != nil {
		return err
	}

	*o = AppVariableInputUpload(varAppVariableInputUpload)
...
type NullableAppVariableInputUpload struct {
	value *AppVariableInputUpload
	isSet bool
}

func (v NullableAppVariableInputUpload) Get() *AppVariableInputUpload {
	return v.value
}

func (v *NullableAppVariableInputUpload) Set(val *AppVariableInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppVariableInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppVariableInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppVariableInputUpload(val *AppVariableInputUpload) *NullableAppVariableInputUpload {
	return &NullableAppVariableInputUpload{value: val, isSet: true}
}

func (v NullableAppVariableInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppVariableInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
