...
// checks if the DirectConnectResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectResourcesDefStatus{}

// DirectConnectResourcesDefStatus Direct connect create/modify status
type DirectConnectResourcesDefStatus struct {
	...
	// Direct connect total bandwidth in Mbps.
	BandwidthMbps *int32 `json:"bandwidth_mbps,omitempty"`
	// The provisioning status of the direct connect.
	ProvisioningStatus *string `json:"provisioning_status,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DirectConnectResourcesDefStatus DirectConnectResourcesDefStatus
...
func NewDirectConnectResourcesDefStatus() *DirectConnectResourcesDefStatus {
	this := DirectConnectResourcesDefStatus{}
	return &this
}
...
// SetBandwidthMbps gets a reference to the given int32 and assigns it to the BandwidthMbps field.
...
func (o DirectConnectResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectResourcesDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varDirectConnectResourcesDefStatus := _DirectConnectResourcesDefStatus{}

	err = json.Unmarshal(data, &varDirectConnectResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = DirectConnectResourcesDefStatus(varDirectConnectResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vpc_reference")
		delete(additionalProperties, "service_provider")
		delete(additionalProperties, "virtual_network_reference")
		delete(additionalProperties, "bandwidth_mbps")
...
type NullableDirectConnectResourcesDefStatus struct {
	value *DirectConnectResourcesDefStatus
	isSet bool
}

func (v NullableDirectConnectResourcesDefStatus) Get() *DirectConnectResourcesDefStatus {
	return v.value
}

func (v *NullableDirectConnectResourcesDefStatus) Set(val *DirectConnectResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectResourcesDefStatus(val *DirectConnectResourcesDefStatus) *NullableDirectConnectResourcesDefStatus {
	return &NullableDirectConnectResourcesDefStatus{value: val, isSet: true}
}

func (v NullableDirectConnectResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
