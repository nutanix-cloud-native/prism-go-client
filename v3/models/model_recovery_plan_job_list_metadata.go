...
// checks if the RecoveryPlanJobListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobListMetadata{}

// RecoveryPlanJobListMetadata All api calls that return a list will have this metadata block as input 
type RecoveryPlanJobListMetadata struct {
	// The kind name
...
type _RecoveryPlanJobListMetadata RecoveryPlanJobListMetadata
...
func NewRecoveryPlanJobListMetadata() *RecoveryPlanJobListMetadata {
	this := RecoveryPlanJobListMetadata{}
...
func (o RecoveryPlanJobListMetadata) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobListMetadata) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanJobListMetadata := _RecoveryPlanJobListMetadata{}

	err = json.Unmarshal(data, &varRecoveryPlanJobListMetadata)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobListMetadata(varRecoveryPlanJobListMetadata)
...
type NullableRecoveryPlanJobListMetadata struct {
	value *RecoveryPlanJobListMetadata
	isSet bool
}

func (v NullableRecoveryPlanJobListMetadata) Get() *RecoveryPlanJobListMetadata {
	return v.value
}

func (v *NullableRecoveryPlanJobListMetadata) Set(val *RecoveryPlanJobListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobListMetadata(val *RecoveryPlanJobListMetadata) *NullableRecoveryPlanJobListMetadata {
	return &NullableRecoveryPlanJobListMetadata{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
