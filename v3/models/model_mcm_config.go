...
// checks if the McmConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &McmConfig{}

// McmConfig MCM config for PC Deployment definition.
type McmConfig struct {
	...
	ComponentRegistryBaseUrl string `json:"component_registry_base_url" validate:"regexp=^((((http[s]?):\\/)?\\/?([^:\\/\\\\s]+)((\\/\\\\w+)*(:[0-9]+)*?\\/)([\\\\w\\\\-\\\\.]+[^#?\\\\s]+)(.*)?)(#[\\\\w\\\\-]+)?$|(http[s]?:\\/\\/([\\\\w\\\\d\\\\-_\\\\.])((\\/?\\\\w+\\\\.*)*(:[0-9]+)*_\\/?)))"`
	// MCM base URL.
	OrchestratorBaseUrl string `json:"orchestrator_base_url" validate:"regexp=^((((http[s]?):\\/)?\\/?([^:\\/\\\\s]+)((\\/\\\\w+)*(:[0-9]+)*?\\/)([\\\\w\\\\-\\\\.]+[^#?\\\\s]+)(.*)?)(#[\\\\w\\\\-]+)?$|(http[s]?:\\/\\/([\\\\w\\\\d\\\\-_\\\\.])((\\/?\\\\w+\\\\.*)*(:[0-9]+)*_\\/?)))"`
	AdditionalProperties map[string]interface{}
}

type _McmConfig McmConfig
...
func NewMcmConfig(deploymentSettings DeploymentSettings, productName string, componentRegistryBaseUrl string, orchestratorBaseUrl string) *McmConfig {
	...
	this.ComponentRegistryBaseUrl = componentRegistryBaseUrl
...
// GetDeploymentSettings returns the DeploymentSettings field value
...
// GetDeploymentSettingsOk returns a tuple with the DeploymentSettings field value
...
// SetDeploymentSettings sets field value
...
// GetComponentRegistryBaseUrl returns the ComponentRegistryBaseUrl field value
func (o *McmConfig) GetComponentRegistryBaseUrl() string {
	...
	return o.ComponentRegistryBaseUrl
}

// GetComponentRegistryBaseUrlOk returns a tuple with the ComponentRegistryBaseUrl field value
// and a boolean to check if the value has been set.
func (o *McmConfig) GetComponentRegistryBaseUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ComponentRegistryBaseUrl, true
}

// SetComponentRegistryBaseUrl sets field value
func (o *McmConfig) SetComponentRegistryBaseUrl(v string) {
	o.ComponentRegistryBaseUrl = v
}

// GetOrchestratorBaseUrl returns the OrchestratorBaseUrl field value
func (o *McmConfig) GetOrchestratorBaseUrl() string {
	...
	return o.OrchestratorBaseUrl
}

// GetOrchestratorBaseUrlOk returns a tuple with the OrchestratorBaseUrl field value
// and a boolean to check if the value has been set.
func (o *McmConfig) GetOrchestratorBaseUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.OrchestratorBaseUrl, true
}

// SetOrchestratorBaseUrl sets field value
func (o *McmConfig) SetOrchestratorBaseUrl(v string) {
	o.OrchestratorBaseUrl = v
}

func (o McmConfig) MarshalJSON() ([]byte, error) {
...
func (o McmConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["deployment_settings"] = o.DeploymentSettings
	toSerialize["product_name"] = o.ProductName
	toSerialize["component_registry_base_url"] = o.ComponentRegistryBaseUrl
	toSerialize["orchestrator_base_url"] = o.OrchestratorBaseUrl
...
func (o *McmConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varMcmConfig := _McmConfig{}

	err = json.Unmarshal(data, &varMcmConfig)

	if err != nil {
		return err
	}

	*o = McmConfig(varMcmConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "deployment_settings")
		delete(additionalProperties, "product_name")
		delete(additionalProperties, "component_registry_base_url")
		delete(additionalProperties, "orchestrator_base_url")
...
type NullableMcmConfig struct {
	value *McmConfig
	isSet bool
}

func (v NullableMcmConfig) Get() *McmConfig {
	return v.value
}

func (v *NullableMcmConfig) Set(val *McmConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableMcmConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableMcmConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMcmConfig(val *McmConfig) *NullableMcmConfig {
	return &NullableMcmConfig{value: val, isSet: true}
}

func (v NullableMcmConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMcmConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
