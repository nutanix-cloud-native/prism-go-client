...
// checks if the AppCredentialReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCredentialReference{}

// AppCredentialReference The reference to a app_credential
type AppCredentialReference struct {
	// The kind name
...
type _AppCredentialReference AppCredentialReference
...
func (o AppCredentialReference) MarshalJSON() ([]byte, error) {
...
func (o AppCredentialReference) ToMap() (map[string]interface{}, error) {
...
func (o *AppCredentialReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCredentialReference := _AppCredentialReference{}

	err = json.Unmarshal(data, &varAppCredentialReference)

	if err != nil {
		return err
	}

	*o = AppCredentialReference(varAppCredentialReference)
...
type NullableAppCredentialReference struct {
	value *AppCredentialReference
	isSet bool
}

func (v NullableAppCredentialReference) Get() *AppCredentialReference {
	return v.value
}

func (v *NullableAppCredentialReference) Set(val *AppCredentialReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCredentialReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCredentialReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCredentialReference(val *AppCredentialReference) *NullableAppCredentialReference {
	return &NullableAppCredentialReference{value: val, isSet: true}
}

func (v NullableAppCredentialReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCredentialReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
