...
// checks if the FileItemIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemIntentResource{}

// FileItemIntentResource Response object for intentful operations on a file_item
type FileItemIntentResource struct {
	Status *FileItemDefStatus `json:"status,omitempty"`
	Spec *FileItem `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata FileItemMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _FileItemIntentResource FileItemIntentResource
...
// SetStatus gets a reference to the given FileItemDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given FileItem and assigns it to the Spec field.
...
func (o FileItemIntentResource) MarshalJSON() ([]byte, error) {
...
func (o FileItemIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *FileItemIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varFileItemIntentResource := _FileItemIntentResource{}

	err = json.Unmarshal(data, &varFileItemIntentResource)

	if err != nil {
		return err
	}

	*o = FileItemIntentResource(varFileItemIntentResource)
...
type NullableFileItemIntentResource struct {
	value *FileItemIntentResource
	isSet bool
}

func (v NullableFileItemIntentResource) Get() *FileItemIntentResource {
	return v.value
}

func (v *NullableFileItemIntentResource) Set(val *FileItemIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemIntentResource(val *FileItemIntentResource) *NullableFileItemIntentResource {
	return &NullableFileItemIntentResource{value: val, isSet: true}
}

func (v NullableFileItemIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
