...
// checks if the PermissionDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionDefStatus{}

// PermissionDefStatus Permission Status Definition.
...
type _PermissionDefStatus PermissionDefStatus
...
func (o PermissionDefStatus) MarshalJSON() ([]byte, error) {
...
func (o PermissionDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *PermissionDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varPermissionDefStatus := _PermissionDefStatus{}

	err = json.Unmarshal(data, &varPermissionDefStatus)

	if err != nil {
		return err
	}

	*o = PermissionDefStatus(varPermissionDefStatus)
...
type NullablePermissionDefStatus struct {
	value *PermissionDefStatus
	isSet bool
}

func (v NullablePermissionDefStatus) Get() *PermissionDefStatus {
	return v.value
}

func (v *NullablePermissionDefStatus) Set(val *PermissionDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionDefStatus(val *PermissionDefStatus) *NullablePermissionDefStatus {
	return &NullablePermissionDefStatus{value: val, isSet: true}
}

func (v NullablePermissionDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
