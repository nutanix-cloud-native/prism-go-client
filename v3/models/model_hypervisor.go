...
// checks if the Hypervisor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Hypervisor{}
...
// SetNumVms gets a reference to the given int64 and assigns it to the NumVms field.
...
// GetHypervisorFullName returns the HypervisorFullName field value if set, zero value otherwise.
func (o *Hypervisor) GetHypervisorFullName() string {
	if o == nil || IsNil(o.HypervisorFullName) {
		var ret string
		return ret
	}
	return *o.HypervisorFullName
}

// GetHypervisorFullNameOk returns a tuple with the HypervisorFullName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Hypervisor) GetHypervisorFullNameOk() (*string, bool) {
	if o == nil || IsNil(o.HypervisorFullName) {
		return nil, false
	}
	return o.HypervisorFullName, true
}
...
// SetHypervisorFullName gets a reference to the given string and assigns it to the HypervisorFullName field.
func (o *Hypervisor) SetHypervisorFullName(v string) {
	o.HypervisorFullName = &v
}

func (o Hypervisor) MarshalJSON() ([]byte, error) {
...
func (o Hypervisor) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.NumVms) {
		toSerialize["num_vms"] = o.NumVms
	}
	toSerialize["ip"] = o.Ip
	if !IsNil(o.HypervisorFullName) {
		toSerialize["hypervisor_full_name"] = o.HypervisorFullName
	}
...
func (o *Hypervisor) UnmarshalJSON(data []byte) (err error) {
	...
	varHypervisor := _Hypervisor{}

	err = json.Unmarshal(data, &varHypervisor)

	if err != nil {
		return err
	}

	*o = Hypervisor(varHypervisor)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "num_vms")
		delete(additionalProperties, "ip")
		delete(additionalProperties, "hypervisor_full_name")
...
type NullableHypervisor struct {
	value *Hypervisor
	isSet bool
}

func (v NullableHypervisor) Get() *Hypervisor {
	return v.value
}

func (v *NullableHypervisor) Set(val *Hypervisor) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisor) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisor(val *Hypervisor) *NullableHypervisor {
	return &NullableHypervisor{value: val, isSet: true}
}

func (v NullableHypervisor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisor) UnmarshalJSON(src []byte) error {
	v.isSet = true
