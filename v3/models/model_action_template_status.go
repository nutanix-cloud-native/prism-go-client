...
// checks if the ActionTemplateStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTemplateStatus{}

// ActionTemplateStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _ActionTemplateStatus ActionTemplateStatus
...
func (o ActionTemplateStatus) MarshalJSON() ([]byte, error) {
...
func (o ActionTemplateStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTemplateStatus) UnmarshalJSON(data []byte) (err error) {
	varActionTemplateStatus := _ActionTemplateStatus{}

	err = json.Unmarshal(data, &varActionTemplateStatus)

	if err != nil {
		return err
	}

	*o = ActionTemplateStatus(varActionTemplateStatus)
...
type NullableActionTemplateStatus struct {
	value *ActionTemplateStatus
	isSet bool
}

func (v NullableActionTemplateStatus) Get() *ActionTemplateStatus {
	return v.value
}

func (v *NullableActionTemplateStatus) Set(val *ActionTemplateStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTemplateStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTemplateStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTemplateStatus(val *ActionTemplateStatus) *NullableActionTemplateStatus {
	return &NullableActionTemplateStatus{value: val, isSet: true}
}

func (v NullableActionTemplateStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTemplateStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
