...
// checks if the RemoteConnectionResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionResources{}

// RemoteConnectionResources Remote connection resources
type RemoteConnectionResources struct {
	RemoteCredential *RemoteConnectionCredential `json:"remote_credential,omitempty"`
	// Role of the cluster in remote connection
	Role *string `json:"role,omitempty"`
	RemoteAddress *Address `json:"remote_address,omitempty"`
	LocalConnectionInfo *RemoteConnectionInfo `json:"local_connection_info,omitempty"`
	RemoteConnectionInfo *RemoteConnectionInfo `json:"remote_connection_info,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RemoteConnectionResources RemoteConnectionResources
...
func NewRemoteConnectionResources() *RemoteConnectionResources {
	this := RemoteConnectionResources{}
	var role string = "INITIATOR"
	this.Role = &role
	return &this
}
...
// GetRemoteCredential returns the RemoteCredential field value if set, zero value otherwise.
func (o *RemoteConnectionResources) GetRemoteCredential() RemoteConnectionCredential {
	if o == nil || IsNil(o.RemoteCredential) {
		var ret RemoteConnectionCredential
		return ret
	}
	return *o.RemoteCredential
}

// GetRemoteCredentialOk returns a tuple with the RemoteCredential field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RemoteConnectionResources) GetRemoteCredentialOk() (*RemoteConnectionCredential, bool) {
	if o == nil || IsNil(o.RemoteCredential) {
		return nil, false
	}
	return o.RemoteCredential, true
}
...
// SetRemoteCredential gets a reference to the given RemoteConnectionCredential and assigns it to the RemoteCredential field.
func (o *RemoteConnectionResources) SetRemoteCredential(v RemoteConnectionCredential) {
	o.RemoteCredential = &v
}
...
// SetRemoteAddress gets a reference to the given Address and assigns it to the RemoteAddress field.
func (o *RemoteConnectionResources) SetRemoteAddress(v Address) {
	o.RemoteAddress = &v
}

// GetLocalConnectionInfo returns the LocalConnectionInfo field value if set, zero value otherwise.
func (o *RemoteConnectionResources) GetLocalConnectionInfo() RemoteConnectionInfo {
	if o == nil || IsNil(o.LocalConnectionInfo) {
		var ret RemoteConnectionInfo
		return ret
	}
	return *o.LocalConnectionInfo
}

// GetLocalConnectionInfoOk returns a tuple with the LocalConnectionInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RemoteConnectionResources) GetLocalConnectionInfoOk() (*RemoteConnectionInfo, bool) {
	if o == nil || IsNil(o.LocalConnectionInfo) {
		return nil, false
	}
	return o.LocalConnectionInfo, true
}
...
// SetLocalConnectionInfo gets a reference to the given RemoteConnectionInfo and assigns it to the LocalConnectionInfo field.
func (o *RemoteConnectionResources) SetLocalConnectionInfo(v RemoteConnectionInfo) {
	o.LocalConnectionInfo = &v
}

// GetRemoteConnectionInfo returns the RemoteConnectionInfo field value if set, zero value otherwise.
func (o *RemoteConnectionResources) GetRemoteConnectionInfo() RemoteConnectionInfo {
	if o == nil || IsNil(o.RemoteConnectionInfo) {
		var ret RemoteConnectionInfo
		return ret
	}
	return *o.RemoteConnectionInfo
}

// GetRemoteConnectionInfoOk returns a tuple with the RemoteConnectionInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RemoteConnectionResources) GetRemoteConnectionInfoOk() (*RemoteConnectionInfo, bool) {
	if o == nil || IsNil(o.RemoteConnectionInfo) {
		return nil, false
	}
	return o.RemoteConnectionInfo, true
}
...
// SetRemoteConnectionInfo gets a reference to the given RemoteConnectionInfo and assigns it to the RemoteConnectionInfo field.
func (o *RemoteConnectionResources) SetRemoteConnectionInfo(v RemoteConnectionInfo) {
	o.RemoteConnectionInfo = &v
}

func (o RemoteConnectionResources) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RemoteCredential) {
		toSerialize["remote_credential"] = o.RemoteCredential
	}
	if !IsNil(o.Role) {
	...
	if !IsNil(o.LocalConnectionInfo) {
		toSerialize["local_connection_info"] = o.LocalConnectionInfo
	}
	if !IsNil(o.RemoteConnectionInfo) {
		toSerialize["remote_connection_info"] = o.RemoteConnectionInfo
	}
...
func (o *RemoteConnectionResources) UnmarshalJSON(data []byte) (err error) {
	varRemoteConnectionResources := _RemoteConnectionResources{}

	err = json.Unmarshal(data, &varRemoteConnectionResources)

	if err != nil {
		return err
	}

	*o = RemoteConnectionResources(varRemoteConnectionResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "remote_credential")
		delete(additionalProperties, "role")
		delete(additionalProperties, "remote_address")
		delete(additionalProperties, "local_connection_info")
		delete(additionalProperties, "remote_connection_info")
...
type NullableRemoteConnectionResources struct {
	value *RemoteConnectionResources
	isSet bool
}

func (v NullableRemoteConnectionResources) Get() *RemoteConnectionResources {
	return v.value
}

func (v *NullableRemoteConnectionResources) Set(val *RemoteConnectionResources) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionResources) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionResources(val *RemoteConnectionResources) *NullableRemoteConnectionResources {
	return &NullableRemoteConnectionResources{value: val, isSet: true}
}

func (v NullableRemoteConnectionResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
