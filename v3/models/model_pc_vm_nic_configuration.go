...
// checks if the PcVmNicConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PcVmNicConfiguration{}
...
type _PcVmNicConfiguration PcVmNicConfiguration
...
// SetNetworkConfiguration gets a reference to the given NetworkConfig and assigns it to the NetworkConfiguration field.
...
func (o PcVmNicConfiguration) MarshalJSON() ([]byte, error) {
...
func (o PcVmNicConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *PcVmNicConfiguration) UnmarshalJSON(data []byte) (err error) {
	varPcVmNicConfiguration := _PcVmNicConfiguration{}

	err = json.Unmarshal(data, &varPcVmNicConfiguration)

	if err != nil {
		return err
	}

	*o = PcVmNicConfiguration(varPcVmNicConfiguration)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "network_configuration")
		delete(additionalProperties, "ip_list")
...
type NullablePcVmNicConfiguration struct {
	value *PcVmNicConfiguration
	isSet bool
}

func (v NullablePcVmNicConfiguration) Get() *PcVmNicConfiguration {
	return v.value
}

func (v *NullablePcVmNicConfiguration) Set(val *PcVmNicConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullablePcVmNicConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullablePcVmNicConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePcVmNicConfiguration(val *PcVmNicConfiguration) *NullablePcVmNicConfiguration {
	return &NullablePcVmNicConfiguration{value: val, isSet: true}
}

func (v NullablePcVmNicConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePcVmNicConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
