...
// checks if the StreamingPolicyListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyListMetadata{}

// StreamingPolicyListMetadata All api calls that return a list will have this metadata block as input 
type StreamingPolicyListMetadata struct {
	// The kind name
...
type _StreamingPolicyListMetadata StreamingPolicyListMetadata
...
func NewStreamingPolicyListMetadata() *StreamingPolicyListMetadata {
	this := StreamingPolicyListMetadata{}
...
func (o StreamingPolicyListMetadata) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicyListMetadata) UnmarshalJSON(data []byte) (err error) {
	varStreamingPolicyListMetadata := _StreamingPolicyListMetadata{}

	err = json.Unmarshal(data, &varStreamingPolicyListMetadata)

	if err != nil {
		return err
	}

	*o = StreamingPolicyListMetadata(varStreamingPolicyListMetadata)
...
type NullableStreamingPolicyListMetadata struct {
	value *StreamingPolicyListMetadata
	isSet bool
}

func (v NullableStreamingPolicyListMetadata) Get() *StreamingPolicyListMetadata {
	return v.value
}

func (v *NullableStreamingPolicyListMetadata) Set(val *StreamingPolicyListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyListMetadata(val *StreamingPolicyListMetadata) *NullableStreamingPolicyListMetadata {
	return &NullableStreamingPolicyListMetadata{value: val, isSet: true}
}

func (v NullableStreamingPolicyListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
