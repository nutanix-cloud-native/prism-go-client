...
// checks if the VpnConnectionResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionResourcesDefStatus{}

// VpnConnectionResourcesDefStatus VPN connection creation/modification status.
type VpnConnectionResourcesDefStatus struct {
	EbgpStatus *VpnComponentStatus `json:"ebgp_status,omitempty"`
	IpsecTunnelStatus *VpnComponentStatus `json:"ipsec_tunnel_status,omitempty"`
	RemoteGatewayReference *VpnGatewayReference `json:"remote_gateway_reference,omitempty"`
	// IP prefixes learned from the remote gateway over eBGP.
	PeerRoutePrefixList []IpSubnetStatus `json:"peer_route_prefix_list,omitempty"`
	QosConfig *QosConfigStatus `json:"qos_config,omitempty"`
	// Local gateway role (acceptor or initiator) in the connection. 
	LocalGatewayRole *string `json:"local_gateway_role,omitempty"`
	IpsecConfig *IpsecConfigStatus `json:"ipsec_config,omitempty"`
	...
	LocalGatewayReference *VpnGatewayReference `json:"local_gateway_reference,omitempty"`
	// IP prefixes advertised to the remote gateway over eBGP.
	LocalRoutePrefixList []IpSubnetStatus `json:"local_route_prefix_list,omitempty"`
	DpdConfig *DpdConfigStatus `json:"dpd_config,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VpnConnectionResourcesDefStatus VpnConnectionResourcesDefStatus
...
func NewVpnConnectionResourcesDefStatus() *VpnConnectionResourcesDefStatus {
	this := VpnConnectionResourcesDefStatus{}
	return &this
}
...
// GetEbgpStatus returns the EbgpStatus field value if set, zero value otherwise.
func (o *VpnConnectionResourcesDefStatus) GetEbgpStatus() VpnComponentStatus {
	if o == nil || IsNil(o.EbgpStatus) {
		var ret VpnComponentStatus
		return ret
	}
	return *o.EbgpStatus
}

// GetEbgpStatusOk returns a tuple with the EbgpStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnConnectionResourcesDefStatus) GetEbgpStatusOk() (*VpnComponentStatus, bool) {
	if o == nil || IsNil(o.EbgpStatus) {
		return nil, false
	}
	return o.EbgpStatus, true
}
...
// SetEbgpStatus gets a reference to the given VpnComponentStatus and assigns it to the EbgpStatus field.
func (o *VpnConnectionResourcesDefStatus) SetEbgpStatus(v VpnComponentStatus) {
	o.EbgpStatus = &v
}

// GetIpsecTunnelStatus returns the IpsecTunnelStatus field value if set, zero value otherwise.
func (o *VpnConnectionResourcesDefStatus) GetIpsecTunnelStatus() VpnComponentStatus {
	if o == nil || IsNil(o.IpsecTunnelStatus) {
		var ret VpnComponentStatus
		return ret
	}
	return *o.IpsecTunnelStatus
}

// GetIpsecTunnelStatusOk returns a tuple with the IpsecTunnelStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnConnectionResourcesDefStatus) GetIpsecTunnelStatusOk() (*VpnComponentStatus, bool) {
	if o == nil || IsNil(o.IpsecTunnelStatus) {
		return nil, false
	}
	return o.IpsecTunnelStatus, true
}
...
// SetIpsecTunnelStatus gets a reference to the given VpnComponentStatus and assigns it to the IpsecTunnelStatus field.
func (o *VpnConnectionResourcesDefStatus) SetIpsecTunnelStatus(v VpnComponentStatus) {
	o.IpsecTunnelStatus = &v
}

// GetRemoteGatewayReference returns the RemoteGatewayReference field value if set, zero value otherwise.
func (o *VpnConnectionResourcesDefStatus) GetRemoteGatewayReference() VpnGatewayReference {
	if o == nil || IsNil(o.RemoteGatewayReference) {
		var ret VpnGatewayReference
		return ret
	}
	return *o.RemoteGatewayReference
}

// GetRemoteGatewayReferenceOk returns a tuple with the RemoteGatewayReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnConnectionResourcesDefStatus) GetRemoteGatewayReferenceOk() (*VpnGatewayReference, bool) {
	if o == nil || IsNil(o.RemoteGatewayReference) {
		return nil, false
	}
	return o.RemoteGatewayReference, true
}
...
// SetRemoteGatewayReference gets a reference to the given VpnGatewayReference and assigns it to the RemoteGatewayReference field.
func (o *VpnConnectionResourcesDefStatus) SetRemoteGatewayReference(v VpnGatewayReference) {
	o.RemoteGatewayReference = &v
}

// GetPeerRoutePrefixList returns the PeerRoutePrefixList field value if set, zero value otherwise.
func (o *VpnConnectionResourcesDefStatus) GetPeerRoutePrefixList() []IpSubnetStatus {
	if o == nil || IsNil(o.PeerRoutePrefixList) {
		var ret []IpSubnetStatus
		return ret
	}
	return o.PeerRoutePrefixList
}

// GetPeerRoutePrefixListOk returns a tuple with the PeerRoutePrefixList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnConnectionResourcesDefStatus) GetPeerRoutePrefixListOk() ([]IpSubnetStatus, bool) {
	if o == nil || IsNil(o.PeerRoutePrefixList) {
		return nil, false
	}
	return o.PeerRoutePrefixList, true
}
...
// SetPeerRoutePrefixList gets a reference to the given []IpSubnetStatus and assigns it to the PeerRoutePrefixList field.
func (o *VpnConnectionResourcesDefStatus) SetPeerRoutePrefixList(v []IpSubnetStatus) {
	o.PeerRoutePrefixList = v
}
...
// SetQosConfig gets a reference to the given QosConfigStatus and assigns it to the QosConfig field.
func (o *VpnConnectionResourcesDefStatus) SetQosConfig(v QosConfigStatus) {
	o.QosConfig = &v
}

// GetLocalGatewayRole returns the LocalGatewayRole field value if set, zero value otherwise.
func (o *VpnConnectionResourcesDefStatus) GetLocalGatewayRole() string {
	if o == nil || IsNil(o.LocalGatewayRole) {
		var ret string
		return ret
	}
	return *o.LocalGatewayRole
}

// GetLocalGatewayRoleOk returns a tuple with the LocalGatewayRole field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnConnectionResourcesDefStatus) GetLocalGatewayRoleOk() (*string, bool) {
	if o == nil || IsNil(o.LocalGatewayRole) {
		return nil, false
	}
	return o.LocalGatewayRole, true
}
...
// SetLocalGatewayRole gets a reference to the given string and assigns it to the LocalGatewayRole field.
func (o *VpnConnectionResourcesDefStatus) SetLocalGatewayRole(v string) {
	o.LocalGatewayRole = &v
}

// GetIpsecConfig returns the IpsecConfig field value if set, zero value otherwise.
func (o *VpnConnectionResourcesDefStatus) GetIpsecConfig() IpsecConfigStatus {
	if o == nil || IsNil(o.IpsecConfig) {
		var ret IpsecConfigStatus
		return ret
	}
	return *o.IpsecConfig
}

// GetIpsecConfigOk returns a tuple with the IpsecConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnConnectionResourcesDefStatus) GetIpsecConfigOk() (*IpsecConfigStatus, bool) {
	if o == nil || IsNil(o.IpsecConfig) {
		return nil, false
	}
	return o.IpsecConfig, true
}
...
// SetIpsecConfig gets a reference to the given IpsecConfigStatus and assigns it to the IpsecConfig field.
...
// GetLocalGatewayReference returns the LocalGatewayReference field value if set, zero value otherwise.
func (o *VpnConnectionResourcesDefStatus) GetLocalGatewayReference() VpnGatewayReference {
	if o == nil || IsNil(o.LocalGatewayReference) {
		var ret VpnGatewayReference
		return ret
	}
	return *o.LocalGatewayReference
}

// GetLocalGatewayReferenceOk returns a tuple with the LocalGatewayReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnConnectionResourcesDefStatus) GetLocalGatewayReferenceOk() (*VpnGatewayReference, bool) {
	if o == nil || IsNil(o.LocalGatewayReference) {
		return nil, false
	}
	return o.LocalGatewayReference, true
}
...
// SetLocalGatewayReference gets a reference to the given VpnGatewayReference and assigns it to the LocalGatewayReference field.
func (o *VpnConnectionResourcesDefStatus) SetLocalGatewayReference(v VpnGatewayReference) {
	o.LocalGatewayReference = &v
}

// GetLocalRoutePrefixList returns the LocalRoutePrefixList field value if set, zero value otherwise.
func (o *VpnConnectionResourcesDefStatus) GetLocalRoutePrefixList() []IpSubnetStatus {
	if o == nil || IsNil(o.LocalRoutePrefixList) {
		var ret []IpSubnetStatus
		return ret
	}
	return o.LocalRoutePrefixList
}

// GetLocalRoutePrefixListOk returns a tuple with the LocalRoutePrefixList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnConnectionResourcesDefStatus) GetLocalRoutePrefixListOk() ([]IpSubnetStatus, bool) {
	if o == nil || IsNil(o.LocalRoutePrefixList) {
		return nil, false
	}
	return o.LocalRoutePrefixList, true
}
...
// SetLocalRoutePrefixList gets a reference to the given []IpSubnetStatus and assigns it to the LocalRoutePrefixList field.
func (o *VpnConnectionResourcesDefStatus) SetLocalRoutePrefixList(v []IpSubnetStatus) {
	o.LocalRoutePrefixList = v
}

// GetDpdConfig returns the DpdConfig field value if set, zero value otherwise.
func (o *VpnConnectionResourcesDefStatus) GetDpdConfig() DpdConfigStatus {
	if o == nil || IsNil(o.DpdConfig) {
		var ret DpdConfigStatus
		return ret
	}
	return *o.DpdConfig
}

// GetDpdConfigOk returns a tuple with the DpdConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnConnectionResourcesDefStatus) GetDpdConfigOk() (*DpdConfigStatus, bool) {
	if o == nil || IsNil(o.DpdConfig) {
		return nil, false
	}
	return o.DpdConfig, true
}
...
// SetDpdConfig gets a reference to the given DpdConfigStatus and assigns it to the DpdConfig field.
func (o *VpnConnectionResourcesDefStatus) SetDpdConfig(v DpdConfigStatus) {
	o.DpdConfig = &v
}

func (o VpnConnectionResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.EbgpStatus) {
		toSerialize["ebgp_status"] = o.EbgpStatus
	}
	if !IsNil(o.IpsecTunnelStatus) {
		toSerialize["ipsec_tunnel_status"] = o.IpsecTunnelStatus
	}
	if !IsNil(o.RemoteGatewayReference) {
		toSerialize["remote_gateway_reference"] = o.RemoteGatewayReference
	}
	if !IsNil(o.PeerRoutePrefixList) {
		toSerialize["peer_route_prefix_list"] = o.PeerRoutePrefixList
	}
	if !IsNil(o.QosConfig) {
		toSerialize["qos_config"] = o.QosConfig
	}
	if !IsNil(o.LocalGatewayRole) {
		toSerialize["local_gateway_role"] = o.LocalGatewayRole
	}
	if !IsNil(o.IpsecConfig) {
		toSerialize["ipsec_config"] = o.IpsecConfig
	}
	if !IsNil(o.DynamicRoutePriority) {
		toSerialize["dynamic_route_priority"] = o.DynamicRoutePriority
	}
	if !IsNil(o.LocalGatewayReference) {
		toSerialize["local_gateway_reference"] = o.LocalGatewayReference
	}
	if !IsNil(o.LocalRoutePrefixList) {
		toSerialize["local_route_prefix_list"] = o.LocalRoutePrefixList
	}
	if !IsNil(o.DpdConfig) {
		toSerialize["dpd_config"] = o.DpdConfig
	}
...
func (o *VpnConnectionResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varVpnConnectionResourcesDefStatus := _VpnConnectionResourcesDefStatus{}

	err = json.Unmarshal(data, &varVpnConnectionResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = VpnConnectionResourcesDefStatus(varVpnConnectionResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "ebgp_status")
		delete(additionalProperties, "ipsec_tunnel_status")
		delete(additionalProperties, "remote_gateway_reference")
		delete(additionalProperties, "peer_route_prefix_list")
		delete(additionalProperties, "qos_config")
		delete(additionalProperties, "local_gateway_role")
		delete(additionalProperties, "ipsec_config")
		delete(additionalProperties, "dynamic_route_priority")
		delete(additionalProperties, "local_gateway_reference")
		delete(additionalProperties, "local_route_prefix_list")
		delete(additionalProperties, "dpd_config")
...
type NullableVpnConnectionResourcesDefStatus struct {
	value *VpnConnectionResourcesDefStatus
	isSet bool
}

func (v NullableVpnConnectionResourcesDefStatus) Get() *VpnConnectionResourcesDefStatus {
	return v.value
}

func (v *NullableVpnConnectionResourcesDefStatus) Set(val *VpnConnectionResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionResourcesDefStatus(val *VpnConnectionResourcesDefStatus) *NullableVpnConnectionResourcesDefStatus {
	return &NullableVpnConnectionResourcesDefStatus{value: val, isSet: true}
}

func (v NullableVpnConnectionResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
