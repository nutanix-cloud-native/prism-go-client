...
// checks if the ProtectionRuleResourcesAvailabilityZoneConnectivityListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleResourcesAvailabilityZoneConnectivityListInner{}

// ProtectionRuleResourcesAvailabilityZoneConnectivityListInner struct for ProtectionRuleResourcesAvailabilityZoneConnectivityListInner
type ProtectionRuleResourcesAvailabilityZoneConnectivityListInner struct {
	// Index of the availability zone in ordered_availability_zone_list. This represents the availability zone where the entity needs to be replicated to. Index starts at 0. 
	DestinationAvailabilityZoneIndex *int32 `json:"destination_availability_zone_index,omitempty"`
	// Index of the availability zone in ordered_availability_zone_list. This represents the source availability zone where the entity is running. Index starts at 0. 
	SourceAvailabilityZoneIndex *int32 `json:"source_availability_zone_index,omitempty"`
	// Snapshot schedules for the pair of the availability zones. 
	SnapshotScheduleList []ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner `json:"snapshot_schedule_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ProtectionRuleResourcesAvailabilityZoneConnectivityListInner ProtectionRuleResourcesAvailabilityZoneConnectivityListInner
...
func NewProtectionRuleResourcesAvailabilityZoneConnectivityListInner() *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner {
	this := ProtectionRuleResourcesAvailabilityZoneConnectivityListInner{}
	return &this
}
...
// GetDestinationAvailabilityZoneIndex returns the DestinationAvailabilityZoneIndex field value if set, zero value otherwise.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) GetDestinationAvailabilityZoneIndex() int32 {
	if o == nil || IsNil(o.DestinationAvailabilityZoneIndex) {
		var ret int32
		return ret
	}
	return *o.DestinationAvailabilityZoneIndex
}

// GetDestinationAvailabilityZoneIndexOk returns a tuple with the DestinationAvailabilityZoneIndex field value if set, nil otherwise
...
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) GetDestinationAvailabilityZoneIndexOk() (*int32, bool) {
	...
	return o.DestinationAvailabilityZoneIndex, true
}
...
// SetDestinationAvailabilityZoneIndex gets a reference to the given int32 and assigns it to the DestinationAvailabilityZoneIndex field.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) SetDestinationAvailabilityZoneIndex(v int32) {
	o.DestinationAvailabilityZoneIndex = &v
}

// GetSourceAvailabilityZoneIndex returns the SourceAvailabilityZoneIndex field value if set, zero value otherwise.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) GetSourceAvailabilityZoneIndex() int32 {
	if o == nil || IsNil(o.SourceAvailabilityZoneIndex) {
		var ret int32
		return ret
	}
	return *o.SourceAvailabilityZoneIndex
}

// GetSourceAvailabilityZoneIndexOk returns a tuple with the SourceAvailabilityZoneIndex field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) GetSourceAvailabilityZoneIndexOk() (*int32, bool) {
	if o == nil || IsNil(o.SourceAvailabilityZoneIndex) {
		return nil, false
	}
	return o.SourceAvailabilityZoneIndex, true
}
...
// SetSourceAvailabilityZoneIndex gets a reference to the given int32 and assigns it to the SourceAvailabilityZoneIndex field.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) SetSourceAvailabilityZoneIndex(v int32) {
	o.SourceAvailabilityZoneIndex = &v
}

// GetSnapshotScheduleList returns the SnapshotScheduleList field value if set, zero value otherwise.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) GetSnapshotScheduleList() []ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner {
	if o == nil || IsNil(o.SnapshotScheduleList) {
		var ret []ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner
		return ret
	}
	return o.SnapshotScheduleList
}

// GetSnapshotScheduleListOk returns a tuple with the SnapshotScheduleList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) GetSnapshotScheduleListOk() ([]ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner, bool) {
	...
	return o.SnapshotScheduleList, true
}
...
// SetSnapshotScheduleList gets a reference to the given []ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner and assigns it to the SnapshotScheduleList field.
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) SetSnapshotScheduleList(v []ProtectionRuleResourcesAvailabilityZoneConnectivityListInnerSnapshotScheduleListInner) {
	o.SnapshotScheduleList = v
}

func (o ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DestinationAvailabilityZoneIndex) {
		toSerialize["destination_availability_zone_index"] = o.DestinationAvailabilityZoneIndex
	}
	if !IsNil(o.SourceAvailabilityZoneIndex) {
		toSerialize["source_availability_zone_index"] = o.SourceAvailabilityZoneIndex
	}
	if !IsNil(o.SnapshotScheduleList) {
		toSerialize["snapshot_schedule_list"] = o.SnapshotScheduleList
	}
...
func (o *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) UnmarshalJSON(data []byte) (err error) {
	varProtectionRuleResourcesAvailabilityZoneConnectivityListInner := _ProtectionRuleResourcesAvailabilityZoneConnectivityListInner{}

	err = json.Unmarshal(data, &varProtectionRuleResourcesAvailabilityZoneConnectivityListInner)

	if err != nil {
		return err
	}

	*o = ProtectionRuleResourcesAvailabilityZoneConnectivityListInner(varProtectionRuleResourcesAvailabilityZoneConnectivityListInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "destination_availability_zone_index")
		delete(additionalProperties, "source_availability_zone_index")
		delete(additionalProperties, "snapshot_schedule_list")
...
type NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInner struct {
	value *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner
	isSet bool
}

func (v NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInner) Get() *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner {
	return v.value
}

func (v *NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInner) Set(val *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleResourcesAvailabilityZoneConnectivityListInner(val *ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) *NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInner {
	return &NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInner{value: val, isSet: true}
}

func (v NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleResourcesAvailabilityZoneConnectivityListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
