...
// checks if the NetworkFunctionStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionStatus{}

// NetworkFunctionStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _NetworkFunctionStatus NetworkFunctionStatus
...
func (o NetworkFunctionStatus) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionStatus) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionStatus) UnmarshalJSON(data []byte) (err error) {
	varNetworkFunctionStatus := _NetworkFunctionStatus{}

	err = json.Unmarshal(data, &varNetworkFunctionStatus)

	if err != nil {
		return err
	}

	*o = NetworkFunctionStatus(varNetworkFunctionStatus)
...
type NullableNetworkFunctionStatus struct {
	value *NetworkFunctionStatus
	isSet bool
}

func (v NullableNetworkFunctionStatus) Get() *NetworkFunctionStatus {
	return v.value
}

func (v *NullableNetworkFunctionStatus) Set(val *NetworkFunctionStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionStatus(val *NetworkFunctionStatus) *NullableNetworkFunctionStatus {
	return &NullableNetworkFunctionStatus{value: val, isSet: true}
}

func (v NullableNetworkFunctionStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
