...
// checks if the DhcpOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpOptions{}
...
// GetDomainNameServerList returns the DomainNameServerList field value if set, zero value otherwise.
func (o *DhcpOptions) GetDomainNameServerList() []string {
	if o == nil || IsNil(o.DomainNameServerList) {
		var ret []string
		return ret
	}
	return o.DomainNameServerList
}

// GetDomainNameServerListOk returns a tuple with the DomainNameServerList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DhcpOptions) GetDomainNameServerListOk() ([]string, bool) {
	if o == nil || IsNil(o.DomainNameServerList) {
		return nil, false
	}
	return o.DomainNameServerList, true
}
...
// SetDomainNameServerList gets a reference to the given []string and assigns it to the DomainNameServerList field.
func (o *DhcpOptions) SetDomainNameServerList(v []string) {
	o.DomainNameServerList = v
}
...
// GetDomainSearchList returns the DomainSearchList field value if set, zero value otherwise.
func (o *DhcpOptions) GetDomainSearchList() []string {
	if o == nil || IsNil(o.DomainSearchList) {
		var ret []string
		return ret
	}
	return o.DomainSearchList
}

// GetDomainSearchListOk returns a tuple with the DomainSearchList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DhcpOptions) GetDomainSearchListOk() ([]string, bool) {
	if o == nil || IsNil(o.DomainSearchList) {
		return nil, false
	}
	return o.DomainSearchList, true
}
...
// SetDomainSearchList gets a reference to the given []string and assigns it to the DomainSearchList field.
func (o *DhcpOptions) SetDomainSearchList(v []string) {
	o.DomainSearchList = v
}
...
func (o DhcpOptions) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DomainNameServerList) {
		toSerialize["domain_name_server_list"] = o.DomainNameServerList
	}
	if !IsNil(o.BootFileName) {
		toSerialize["boot_file_name"] = o.BootFileName
	}
	if !IsNil(o.DomainSearchList) {
		toSerialize["domain_search_list"] = o.DomainSearchList
	}
	if !IsNil(o.DomainName) {
		toSerialize["domain_name"] = o.DomainName
	}
	if !IsNil(o.TftpServerName) {
		toSerialize["tftp_server_name"] = o.TftpServerName
	}
...
func (o *DhcpOptions) UnmarshalJSON(data []byte) (err error) {
	varDhcpOptions := _DhcpOptions{}

	err = json.Unmarshal(data, &varDhcpOptions)

	if err != nil {
		return err
	}

	*o = DhcpOptions(varDhcpOptions)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "domain_name_server_list")
		delete(additionalProperties, "boot_file_name")
		delete(additionalProperties, "domain_search_list")
		delete(additionalProperties, "domain_name")
		delete(additionalProperties, "tftp_server_name")
...
type NullableDhcpOptions struct {
	value *DhcpOptions
	isSet bool
}

func (v NullableDhcpOptions) Get() *DhcpOptions {
	return v.value
}

func (v *NullableDhcpOptions) Set(val *DhcpOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpOptions(val *DhcpOptions) *NullableDhcpOptions {
	return &NullableDhcpOptions{value: val, isSet: true}
}

func (v NullableDhcpOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
