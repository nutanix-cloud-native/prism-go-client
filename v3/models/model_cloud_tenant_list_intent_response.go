...
// checks if the CloudTenantListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTenantListIntentResponse{}

// CloudTenantListIntentResponse Response object for intentful operation of cloud_tenants
type CloudTenantListIntentResponse struct {
	Entities []CloudTenantIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata CloudTenantListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _CloudTenantListIntentResponse CloudTenantListIntentResponse
...
func NewCloudTenantListIntentResponse(apiVersion string, metadata CloudTenantListMetadataOutput) *CloudTenantListIntentResponse {
	this := CloudTenantListIntentResponse{}
...
func (o *CloudTenantListIntentResponse) GetEntities() []CloudTenantIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []CloudTenantIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []CloudTenantIntentResource and assigns it to the Entities field.
...
func (o *CloudTenantListIntentResponse) GetMetadata() CloudTenantListMetadataOutput {
	if o == nil {
		var ret CloudTenantListMetadataOutput
		return ret
	}
...
func (o CloudTenantListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CloudTenantListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTenantListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTenantListIntentResponse := _CloudTenantListIntentResponse{}

	err = json.Unmarshal(data, &varCloudTenantListIntentResponse)

	if err != nil {
		return err
	}

	*o = CloudTenantListIntentResponse(varCloudTenantListIntentResponse)
...
type NullableCloudTenantListIntentResponse struct {
	value *CloudTenantListIntentResponse
	isSet bool
}

func (v NullableCloudTenantListIntentResponse) Get() *CloudTenantListIntentResponse {
	return v.value
}

func (v *NullableCloudTenantListIntentResponse) Set(val *CloudTenantListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTenantListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTenantListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTenantListIntentResponse(val *CloudTenantListIntentResponse) *NullableCloudTenantListIntentResponse {
	return &NullableCloudTenantListIntentResponse{value: val, isSet: true}
}

func (v NullableCloudTenantListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTenantListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
