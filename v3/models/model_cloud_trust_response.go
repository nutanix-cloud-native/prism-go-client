...
// checks if the CloudTrustResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustResponse{}

// CloudTrustResponse Cloud trusts response definition.
type CloudTrustResponse struct {
	// URL of the Cloud (Nutanix hosted cloud/ Onprem Cloud) to pair to.
	...
	RemoteConnectionReference RemoteConnectionReference `json:"remote_connection_reference"`
	AdditionalProperties map[string]interface{}
}

type _CloudTrustResponse CloudTrustResponse
...
func NewCloudTrustResponse(remoteConnectionReference RemoteConnectionReference) *CloudTrustResponse {
	this := CloudTrustResponse{}
	this.RemoteConnectionReference = remoteConnectionReference
	return &this
}
...
// GetRemoteConnectionReference returns the RemoteConnectionReference field value
func (o *CloudTrustResponse) GetRemoteConnectionReference() RemoteConnectionReference {
	if o == nil {
		var ret RemoteConnectionReference
		return ret
	}

	return o.RemoteConnectionReference
}

// GetRemoteConnectionReferenceOk returns a tuple with the RemoteConnectionReference field value
// and a boolean to check if the value has been set.
func (o *CloudTrustResponse) GetRemoteConnectionReferenceOk() (*RemoteConnectionReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RemoteConnectionReference, true
}

// SetRemoteConnectionReference sets field value
func (o *CloudTrustResponse) SetRemoteConnectionReference(v RemoteConnectionReference) {
	o.RemoteConnectionReference = v
}

func (o CloudTrustResponse) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["remote_connection_reference"] = o.RemoteConnectionReference
...
func (o *CloudTrustResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTrustResponse := _CloudTrustResponse{}

	err = json.Unmarshal(data, &varCloudTrustResponse)

	if err != nil {
		return err
	}

	*o = CloudTrustResponse(varCloudTrustResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "cloud_type")
		delete(additionalProperties, "remote_connection_reference")
...
type NullableCloudTrustResponse struct {
	value *CloudTrustResponse
	isSet bool
}

func (v NullableCloudTrustResponse) Get() *CloudTrustResponse {
	return v.value
}

func (v *NullableCloudTrustResponse) Set(val *CloudTrustResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustResponse(val *CloudTrustResponse) *NullableCloudTrustResponse {
	return &NullableCloudTrustResponse{value: val, isSet: true}
}

func (v NullableCloudTrustResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
