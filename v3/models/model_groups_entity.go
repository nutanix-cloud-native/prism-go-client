...
// checks if the GroupsEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupsEntity{}

// GroupsEntity An Individual Entity.
...
type _GroupsEntity GroupsEntity
...
// SetData gets a reference to the given []GroupsFieldData and assigns it to the Data field.
func (o *GroupsEntity) SetData(v []GroupsFieldData) {
	o.Data = v
}

func (o GroupsEntity) MarshalJSON() ([]byte, error) {
...
func (o GroupsEntity) ToMap() (map[string]interface{}, error) {
...
func (o *GroupsEntity) UnmarshalJSON(data []byte) (err error) {
	varGroupsEntity := _GroupsEntity{}

	err = json.Unmarshal(data, &varGroupsEntity)

	if err != nil {
		return err
	}

	*o = GroupsEntity(varGroupsEntity)
...
type NullableGroupsEntity struct {
	value *GroupsEntity
	isSet bool
}

func (v NullableGroupsEntity) Get() *GroupsEntity {
	return v.value
}

func (v *NullableGroupsEntity) Set(val *GroupsEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupsEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupsEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupsEntity(val *GroupsEntity) *NullableGroupsEntity {
	return &NullableGroupsEntity{value: val, isSet: true}
}

func (v NullableGroupsEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupsEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
