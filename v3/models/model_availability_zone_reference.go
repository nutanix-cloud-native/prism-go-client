...
// checks if the AvailabilityZoneReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneReference{}

// AvailabilityZoneReference The reference to a availability_zone
...
type _AvailabilityZoneReference AvailabilityZoneReference
...
func (o AvailabilityZoneReference) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneReference) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAvailabilityZoneReference := _AvailabilityZoneReference{}

	err = json.Unmarshal(data, &varAvailabilityZoneReference)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneReference(varAvailabilityZoneReference)
...
type NullableAvailabilityZoneReference struct {
	value *AvailabilityZoneReference
	isSet bool
}

func (v NullableAvailabilityZoneReference) Get() *AvailabilityZoneReference {
	return v.value
}

func (v *NullableAvailabilityZoneReference) Set(val *AvailabilityZoneReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneReference(val *AvailabilityZoneReference) *NullableAvailabilityZoneReference {
	return &NullableAvailabilityZoneReference{value: val, isSet: true}
}

func (v NullableAvailabilityZoneReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
