...
// checks if the StoragePolicyIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyIntentResponse{}

// StoragePolicyIntentResponse Response object for intentful operations on a storage_policy
type StoragePolicyIntentResponse struct {
...
type _StoragePolicyIntentResponse StoragePolicyIntentResponse
...
func NewStoragePolicyIntentResponse(apiVersion string, metadata StoragePolicyMetadata) *StoragePolicyIntentResponse {
	this := StoragePolicyIntentResponse{}
...
func (o StoragePolicyIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePolicyIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varStoragePolicyIntentResponse := _StoragePolicyIntentResponse{}

	err = json.Unmarshal(data, &varStoragePolicyIntentResponse)

	if err != nil {
		return err
	}

	*o = StoragePolicyIntentResponse(varStoragePolicyIntentResponse)
...
type NullableStoragePolicyIntentResponse struct {
	value *StoragePolicyIntentResponse
	isSet bool
}

func (v NullableStoragePolicyIntentResponse) Get() *StoragePolicyIntentResponse {
	return v.value
}

func (v *NullableStoragePolicyIntentResponse) Set(val *StoragePolicyIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyIntentResponse(val *StoragePolicyIntentResponse) *NullableStoragePolicyIntentResponse {
	return &NullableStoragePolicyIntentResponse{value: val, isSet: true}
}

func (v NullableStoragePolicyIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
