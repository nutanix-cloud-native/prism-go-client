...
// checks if the SupportCaseIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseIntentResource{}

// SupportCaseIntentResource Response object for intentful operations on a support_case
type SupportCaseIntentResource struct {
	Status *SupportCaseDefStatus `json:"status,omitempty"`
	Spec *SupportCase `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata SupportCaseMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _SupportCaseIntentResource SupportCaseIntentResource
...
func NewSupportCaseIntentResource(metadata SupportCaseMetadata) *SupportCaseIntentResource {
	this := SupportCaseIntentResource{}
...
// SetStatus gets a reference to the given SupportCaseDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given SupportCase and assigns it to the Spec field.
...
func (o SupportCaseIntentResource) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseIntentResource := _SupportCaseIntentResource{}

	err = json.Unmarshal(data, &varSupportCaseIntentResource)

	if err != nil {
		return err
	}

	*o = SupportCaseIntentResource(varSupportCaseIntentResource)
...
type NullableSupportCaseIntentResource struct {
	value *SupportCaseIntentResource
	isSet bool
}

func (v NullableSupportCaseIntentResource) Get() *SupportCaseIntentResource {
	return v.value
}

func (v *NullableSupportCaseIntentResource) Set(val *SupportCaseIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseIntentResource(val *SupportCaseIntentResource) *NullableSupportCaseIntentResource {
	return &NullableSupportCaseIntentResource{value: val, isSet: true}
}

func (v NullableSupportCaseIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
