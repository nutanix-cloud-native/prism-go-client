...
// checks if the AppPublishedServiceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPublishedServiceResponse{}

// AppPublishedServiceResponse Published service definition
type AppPublishedServiceResponse struct {
	...
	ConfigReference *AppPublishedServiceReference `json:"config_reference,omitempty"`
	// 
...
type _AppPublishedServiceResponse AppPublishedServiceResponse
...
func NewAppPublishedServiceResponse(actionList []AppActionResponse, name string, state string, variableList []AppVariableResponse, uUID string) *AppPublishedServiceResponse {
	this := AppPublishedServiceResponse{}
...
// SetConfigReference gets a reference to the given AppPublishedServiceReference and assigns it to the ConfigReference field.
...
func (o AppPublishedServiceResponse) MarshalJSON() ([]byte, error) {
...
func (o AppPublishedServiceResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppPublishedServiceResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPublishedServiceResponse := _AppPublishedServiceResponse{}

	err = json.Unmarshal(data, &varAppPublishedServiceResponse)

	if err != nil {
		return err
	}

	*o = AppPublishedServiceResponse(varAppPublishedServiceResponse)
...
type NullableAppPublishedServiceResponse struct {
	value *AppPublishedServiceResponse
	isSet bool
}

func (v NullableAppPublishedServiceResponse) Get() *AppPublishedServiceResponse {
	return v.value
}

func (v *NullableAppPublishedServiceResponse) Set(val *AppPublishedServiceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPublishedServiceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPublishedServiceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPublishedServiceResponse(val *AppPublishedServiceResponse) *NullableAppPublishedServiceResponse {
	return &NullableAppPublishedServiceResponse{value: val, isSet: true}
}

func (v NullableAppPublishedServiceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPublishedServiceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
