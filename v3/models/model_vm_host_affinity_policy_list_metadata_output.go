...
// checks if the VmHostAffinityPolicyListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityPolicyListMetadataOutput{}

// VmHostAffinityPolicyListMetadataOutput All API calls that return a list will have this metadata block. 
type VmHostAffinityPolicyListMetadataOutput struct {
	// Total matches found.
...
type _VmHostAffinityPolicyListMetadataOutput VmHostAffinityPolicyListMetadataOutput
...
func NewVmHostAffinityPolicyListMetadataOutput() *VmHostAffinityPolicyListMetadataOutput {
	this := VmHostAffinityPolicyListMetadataOutput{}
...
func (o VmHostAffinityPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityPolicyListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VmHostAffinityPolicyListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVmHostAffinityPolicyListMetadataOutput := _VmHostAffinityPolicyListMetadataOutput{}

	err = json.Unmarshal(data, &varVmHostAffinityPolicyListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VmHostAffinityPolicyListMetadataOutput(varVmHostAffinityPolicyListMetadataOutput)
...
type NullableVmHostAffinityPolicyListMetadataOutput struct {
	value *VmHostAffinityPolicyListMetadataOutput
	isSet bool
}

func (v NullableVmHostAffinityPolicyListMetadataOutput) Get() *VmHostAffinityPolicyListMetadataOutput {
	return v.value
}

func (v *NullableVmHostAffinityPolicyListMetadataOutput) Set(val *VmHostAffinityPolicyListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityPolicyListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityPolicyListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityPolicyListMetadataOutput(val *VmHostAffinityPolicyListMetadataOutput) *NullableVmHostAffinityPolicyListMetadataOutput {
	return &NullableVmHostAffinityPolicyListMetadataOutput{value: val, isSet: true}
}

func (v NullableVmHostAffinityPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityPolicyListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
