...
// checks if the AwsImageIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsImageIntentResource{}

// AwsImageIntentResource aws_image entity
type AwsImageIntentResource struct {
	Status *AwsImageDefStatus `json:"status,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsImageMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsImageIntentResource AwsImageIntentResource
...
// SetStatus gets a reference to the given AwsImageDefStatus and assigns it to the Status field.
...
func (o AwsImageIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsImageIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsImageIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsImageIntentResource := _AwsImageIntentResource{}

	err = json.Unmarshal(data, &varAwsImageIntentResource)

	if err != nil {
		return err
	}

	*o = AwsImageIntentResource(varAwsImageIntentResource)
...
type NullableAwsImageIntentResource struct {
	value *AwsImageIntentResource
	isSet bool
}

func (v NullableAwsImageIntentResource) Get() *AwsImageIntentResource {
	return v.value
}

func (v *NullableAwsImageIntentResource) Set(val *AwsImageIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsImageIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsImageIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsImageIntentResource(val *AwsImageIntentResource) *NullableAwsImageIntentResource {
	return &NullableAwsImageIntentResource{value: val, isSet: true}
}

func (v NullableAwsImageIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsImageIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
