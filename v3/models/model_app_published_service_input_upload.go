...
// checks if the AppPublishedServiceInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPublishedServiceInputUpload{}

// AppPublishedServiceInputUpload Published service definition
type AppPublishedServiceInputUpload struct {
...
type _AppPublishedServiceInputUpload AppPublishedServiceInputUpload
...
func NewAppPublishedServiceInputUpload(name string) *AppPublishedServiceInputUpload {
	this := AppPublishedServiceInputUpload{}
...
func (o AppPublishedServiceInputUpload) MarshalJSON() ([]byte, error) {
...
func (o AppPublishedServiceInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppPublishedServiceInputUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPublishedServiceInputUpload := _AppPublishedServiceInputUpload{}

	err = json.Unmarshal(data, &varAppPublishedServiceInputUpload)

	if err != nil {
		return err
	}

	*o = AppPublishedServiceInputUpload(varAppPublishedServiceInputUpload)
...
type NullableAppPublishedServiceInputUpload struct {
	value *AppPublishedServiceInputUpload
	isSet bool
}

func (v NullableAppPublishedServiceInputUpload) Get() *AppPublishedServiceInputUpload {
	return v.value
}

func (v *NullableAppPublishedServiceInputUpload) Set(val *AppPublishedServiceInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPublishedServiceInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPublishedServiceInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPublishedServiceInputUpload(val *AppPublishedServiceInputUpload) *NullableAppPublishedServiceInputUpload {
	return &NullableAppPublishedServiceInputUpload{value: val, isSet: true}
}

func (v NullableAppPublishedServiceInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPublishedServiceInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
