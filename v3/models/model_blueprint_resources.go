...
// checks if the BlueprintResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintResources{}

// BlueprintResources Resources for Blueprint.
type BlueprintResources struct {
	...
	ServiceDefinitionList []AppServiceInput `json:"service_definition_list,omitempty"`
	// Substrate definitions for Blueprint.
	SubstrateDefinitionList []AppSubstrateInput `json:"substrate_definition_list,omitempty"`
	// Credential definitions for Blueprint.
	CredentialDefinitionList []AppCredentialInput `json:"credential_definition_list,omitempty"`
	// Package definitions for Blueprint.
	PackageDefinitionList []AppPackageInput `json:"package_definition_list,omitempty"`
	// App profile definitions for Blueprint.
	AppProfileList []AppProfileInput `json:"app_profile_list,omitempty"`
	// Published service definitions for Blueprint.
	PublishedServiceDefinitionList []AppPublishedServiceInput `json:"published_service_definition_list,omitempty"`
...
type _BlueprintResources BlueprintResources
...
// SetServiceDefinitionList gets a reference to the given []AppServiceInput and assigns it to the ServiceDefinitionList field.
...
// SetSubstrateDefinitionList gets a reference to the given []AppSubstrateInput and assigns it to the SubstrateDefinitionList field.
...
// SetCredentialDefinitionList gets a reference to the given []AppCredentialInput and assigns it to the CredentialDefinitionList field.
...
// SetPackageDefinitionList gets a reference to the given []AppPackageInput and assigns it to the PackageDefinitionList field.
...
// SetAppProfileList gets a reference to the given []AppProfileInput and assigns it to the AppProfileList field.
...
// SetPublishedServiceDefinitionList gets a reference to the given []AppPublishedServiceInput and assigns it to the PublishedServiceDefinitionList field.
...
func (o BlueprintResources) MarshalJSON() ([]byte, error) {
...
func (o BlueprintResources) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintResources) UnmarshalJSON(data []byte) (err error) {
	varBlueprintResources := _BlueprintResources{}

	err = json.Unmarshal(data, &varBlueprintResources)

	if err != nil {
		return err
	}

	*o = BlueprintResources(varBlueprintResources)
...
type NullableBlueprintResources struct {
	value *BlueprintResources
	isSet bool
}

func (v NullableBlueprintResources) Get() *BlueprintResources {
	return v.value
}

func (v *NullableBlueprintResources) Set(val *BlueprintResources) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintResources) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintResources(val *BlueprintResources) *NullableBlueprintResources {
	return &NullableBlueprintResources{value: val, isSet: true}
}

func (v NullableBlueprintResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
