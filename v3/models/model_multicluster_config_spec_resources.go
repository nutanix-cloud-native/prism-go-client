...
// checks if the MulticlusterConfigSpecResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MulticlusterConfigSpecResources{}

// MulticlusterConfigSpecResources Multicluster config resources.
type MulticlusterConfigSpecResources struct {
	UpgradeSchedule *ExecutionSchedule `json:"upgrade_schedule,omitempty"`
...
type _MulticlusterConfigSpecResources MulticlusterConfigSpecResources
...
func NewMulticlusterConfigSpecResources(executionPlan string, specList []ClusterIntentInput) *MulticlusterConfigSpecResources {
	this := MulticlusterConfigSpecResources{}
...
func NewMulticlusterConfigSpecResourcesWithDefaults() *MulticlusterConfigSpecResources {
	this := MulticlusterConfigSpecResources{}
	var executionPlan string = "PARALLEL"
	this.ExecutionPlan = executionPlan
	return &this
}

// GetUpgradeSchedule returns the UpgradeSchedule field value if set, zero value otherwise.
func (o *MulticlusterConfigSpecResources) GetUpgradeSchedule() ExecutionSchedule {
	if o == nil || IsNil(o.UpgradeSchedule) {
		var ret ExecutionSchedule
		return ret
	}
	return *o.UpgradeSchedule
}

// GetUpgradeScheduleOk returns a tuple with the UpgradeSchedule field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MulticlusterConfigSpecResources) GetUpgradeScheduleOk() (*ExecutionSchedule, bool) {
	if o == nil || IsNil(o.UpgradeSchedule) {
		return nil, false
	}
	return o.UpgradeSchedule, true
}
...
// SetUpgradeSchedule gets a reference to the given ExecutionSchedule and assigns it to the UpgradeSchedule field.
...
// GetSpecList returns the SpecList field value
func (o *MulticlusterConfigSpecResources) GetSpecList() []ClusterIntentInput {
	if o == nil {
		var ret []ClusterIntentInput
		return ret
	}
...
// GetSpecListOk returns a tuple with the SpecList field value
// and a boolean to check if the value has been set.
func (o *MulticlusterConfigSpecResources) GetSpecListOk() ([]ClusterIntentInput, bool) {
	if o == nil {
		return nil, false
	}
	return o.SpecList, true
}

// SetSpecList sets field value
func (o *MulticlusterConfigSpecResources) SetSpecList(v []ClusterIntentInput) {
	o.SpecList = v
}

func (o MulticlusterConfigSpecResources) MarshalJSON() ([]byte, error) {
...
func (o MulticlusterConfigSpecResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.UpgradeSchedule) {
		toSerialize["upgrade_schedule"] = o.UpgradeSchedule
	}
	toSerialize["execution_plan"] = o.ExecutionPlan
	toSerialize["spec_list"] = o.SpecList
...
func (o *MulticlusterConfigSpecResources) UnmarshalJSON(data []byte) (err error) {
	...
	varMulticlusterConfigSpecResources := _MulticlusterConfigSpecResources{}

	err = json.Unmarshal(data, &varMulticlusterConfigSpecResources)

	if err != nil {
		return err
	}

	*o = MulticlusterConfigSpecResources(varMulticlusterConfigSpecResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "upgrade_schedule")
		delete(additionalProperties, "execution_plan")
		delete(additionalProperties, "spec_list")
...
type NullableMulticlusterConfigSpecResources struct {
	value *MulticlusterConfigSpecResources
	isSet bool
}

func (v NullableMulticlusterConfigSpecResources) Get() *MulticlusterConfigSpecResources {
	return v.value
}

func (v *NullableMulticlusterConfigSpecResources) Set(val *MulticlusterConfigSpecResources) {
	v.value = val
	v.isSet = true
}

func (v NullableMulticlusterConfigSpecResources) IsSet() bool {
	return v.isSet
}

func (v *NullableMulticlusterConfigSpecResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMulticlusterConfigSpecResources(val *MulticlusterConfigSpecResources) *NullableMulticlusterConfigSpecResources {
	return &NullableMulticlusterConfigSpecResources{value: val, isSet: true}
}

func (v NullableMulticlusterConfigSpecResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMulticlusterConfigSpecResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
