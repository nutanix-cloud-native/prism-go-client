...
// checks if the DatacenterIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterIntentResponse{}

// DatacenterIntentResponse Response object for intentful operations on a datacenter
type DatacenterIntentResponse struct {
...
type _DatacenterIntentResponse DatacenterIntentResponse
...
func (o DatacenterIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DatacenterIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DatacenterIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDatacenterIntentResponse := _DatacenterIntentResponse{}

	err = json.Unmarshal(data, &varDatacenterIntentResponse)

	if err != nil {
		return err
	}

	*o = DatacenterIntentResponse(varDatacenterIntentResponse)
...
type NullableDatacenterIntentResponse struct {
	value *DatacenterIntentResponse
	isSet bool
}

func (v NullableDatacenterIntentResponse) Get() *DatacenterIntentResponse {
	return v.value
}

func (v *NullableDatacenterIntentResponse) Set(val *DatacenterIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterIntentResponse(val *DatacenterIntentResponse) *NullableDatacenterIntentResponse {
	return &NullableDatacenterIntentResponse{value: val, isSet: true}
}

func (v NullableDatacenterIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
