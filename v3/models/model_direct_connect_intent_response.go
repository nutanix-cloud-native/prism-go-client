...
// checks if the DirectConnectIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectIntentResponse{}

// DirectConnectIntentResponse Response object for intentful operations on a direct_connect
type DirectConnectIntentResponse struct {
...
type _DirectConnectIntentResponse DirectConnectIntentResponse
...
func NewDirectConnectIntentResponse(apiVersion string, metadata DirectConnectMetadata) *DirectConnectIntentResponse {
	this := DirectConnectIntentResponse{}
...
func (o DirectConnectIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectIntentResponse := _DirectConnectIntentResponse{}

	err = json.Unmarshal(data, &varDirectConnectIntentResponse)

	if err != nil {
		return err
	}

	*o = DirectConnectIntentResponse(varDirectConnectIntentResponse)
...
type NullableDirectConnectIntentResponse struct {
	value *DirectConnectIntentResponse
	isSet bool
}

func (v NullableDirectConnectIntentResponse) Get() *DirectConnectIntentResponse {
	return v.value
}

func (v *NullableDirectConnectIntentResponse) Set(val *DirectConnectIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectIntentResponse(val *DirectConnectIntentResponse) *NullableDirectConnectIntentResponse {
	return &NullableDirectConnectIntentResponse{value: val, isSet: true}
}

func (v NullableDirectConnectIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
