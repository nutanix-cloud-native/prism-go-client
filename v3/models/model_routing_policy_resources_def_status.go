...
// checks if the RoutingPolicyResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyResourcesDefStatus{}

// RoutingPolicyResourcesDefStatus Routing policy creation/modification status.
type RoutingPolicyResourcesDefStatus struct {
	...
	ServiceIpCountersReverseDirection []ServiceIpCounters `json:"service_ip_counters_reverse_direction,omitempty"`
	...
	Destination *NetworkAddressStatus `json:"destination,omitempty"`
	RerouteFallbackCounters *RoutingPolicyCounters `json:"reroute_fallback_counters,omitempty"`
	// Policy counters for each service IP.
	ServiceIpCounters []ServiceIpCounters `json:"service_ip_counters,omitempty"`
	...
	Source *NetworkAddressStatus `json:"source,omitempty"`
	RoutingPolicyCounters *RoutingPolicyCounters `json:"routing_policy_counters,omitempty"`
	ProtocolParameters *ProtocolParametersStatus `json:"protocol_parameters,omitempty"`
	VirtualNetworkReference *VirtualNetworkReference `json:"virtual_network_reference,omitempty"`
	RerouteFallbackCountersReverseDirection *RoutingPolicyCounters `json:"reroute_fallback_counters_reverse_direction,omitempty"`
	Action *RoutingPolicyActionStatus `json:"action,omitempty"`
...
type _RoutingPolicyResourcesDefStatus RoutingPolicyResourcesDefStatus
...
func NewRoutingPolicyResourcesDefStatus() *RoutingPolicyResourcesDefStatus {
	this := RoutingPolicyResourcesDefStatus{}
...
// GetServiceIpCountersReverseDirection returns the ServiceIpCountersReverseDirection field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetServiceIpCountersReverseDirection() []ServiceIpCounters {
	if o == nil || IsNil(o.ServiceIpCountersReverseDirection) {
		var ret []ServiceIpCounters
		return ret
	}
	return o.ServiceIpCountersReverseDirection
}

// GetServiceIpCountersReverseDirectionOk returns a tuple with the ServiceIpCountersReverseDirection field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyResourcesDefStatus) GetServiceIpCountersReverseDirectionOk() ([]ServiceIpCounters, bool) {
	if o == nil || IsNil(o.ServiceIpCountersReverseDirection) {
		return nil, false
	}
	return o.ServiceIpCountersReverseDirection, true
}
...
// SetServiceIpCountersReverseDirection gets a reference to the given []ServiceIpCounters and assigns it to the ServiceIpCountersReverseDirection field.
func (o *RoutingPolicyResourcesDefStatus) SetServiceIpCountersReverseDirection(v []ServiceIpCounters) {
	o.ServiceIpCountersReverseDirection = v
}

// GetVpcReference returns the VpcReference field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetVpcReference() VpcReference {
	if o == nil || IsNil(o.VpcReference) {
		var ret VpcReference
		return ret
	}
	return *o.VpcReference
}

// GetVpcReferenceOk returns a tuple with the VpcReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyResourcesDefStatus) GetVpcReferenceOk() (*VpcReference, bool) {
	if o == nil || IsNil(o.VpcReference) {
		return nil, false
	}
	return o.VpcReference, true
}
...
// SetVpcReference gets a reference to the given VpcReference and assigns it to the VpcReference field.
...
// GetRoutingPolicyCountersReverseDirection returns the RoutingPolicyCountersReverseDirection field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetRoutingPolicyCountersReverseDirection() RoutingPolicyCounters {
	if o == nil || IsNil(o.RoutingPolicyCountersReverseDirection) {
		var ret RoutingPolicyCounters
		return ret
	}
	return *o.RoutingPolicyCountersReverseDirection
}

// GetRoutingPolicyCountersReverseDirectionOk returns a tuple with the RoutingPolicyCountersReverseDirection field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyResourcesDefStatus) GetRoutingPolicyCountersReverseDirectionOk() (*RoutingPolicyCounters, bool) {
	if o == nil || IsNil(o.RoutingPolicyCountersReverseDirection) {
		return nil, false
	}
	return o.RoutingPolicyCountersReverseDirection, true
}
...
// SetRoutingPolicyCountersReverseDirection gets a reference to the given RoutingPolicyCounters and assigns it to the RoutingPolicyCountersReverseDirection field.
func (o *RoutingPolicyResourcesDefStatus) SetRoutingPolicyCountersReverseDirection(v RoutingPolicyCounters) {
	o.RoutingPolicyCountersReverseDirection = &v
}

// GetDestination returns the Destination field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetDestination() NetworkAddressStatus {
	if o == nil || IsNil(o.Destination) {
		var ret NetworkAddressStatus
		return ret
	}
...
// SetDestination gets a reference to the given NetworkAddressStatus and assigns it to the Destination field.
func (o *RoutingPolicyResourcesDefStatus) SetDestination(v NetworkAddressStatus) {
	o.Destination = &v
}

// GetRerouteFallbackCounters returns the RerouteFallbackCounters field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetRerouteFallbackCounters() RoutingPolicyCounters {
	if o == nil || IsNil(o.RerouteFallbackCounters) {
		var ret RoutingPolicyCounters
		return ret
	}
	return *o.RerouteFallbackCounters
}

// GetRerouteFallbackCountersOk returns a tuple with the RerouteFallbackCounters field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyResourcesDefStatus) GetRerouteFallbackCountersOk() (*RoutingPolicyCounters, bool) {
	if o == nil || IsNil(o.RerouteFallbackCounters) {
		return nil, false
	}
	return o.RerouteFallbackCounters, true
}
...
// SetRerouteFallbackCounters gets a reference to the given RoutingPolicyCounters and assigns it to the RerouteFallbackCounters field.
func (o *RoutingPolicyResourcesDefStatus) SetRerouteFallbackCounters(v RoutingPolicyCounters) {
	o.RerouteFallbackCounters = &v
}

// GetServiceIpCounters returns the ServiceIpCounters field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetServiceIpCounters() []ServiceIpCounters {
	if o == nil || IsNil(o.ServiceIpCounters) {
		var ret []ServiceIpCounters
		return ret
	}
	return o.ServiceIpCounters
}

// GetServiceIpCountersOk returns a tuple with the ServiceIpCounters field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyResourcesDefStatus) GetServiceIpCountersOk() ([]ServiceIpCounters, bool) {
	if o == nil || IsNil(o.ServiceIpCounters) {
		return nil, false
	}
	return o.ServiceIpCounters, true
}
...
// SetServiceIpCounters gets a reference to the given []ServiceIpCounters and assigns it to the ServiceIpCounters field.
func (o *RoutingPolicyResourcesDefStatus) SetServiceIpCounters(v []ServiceIpCounters) {
	o.ServiceIpCounters = v
}

// GetIsBidirectional returns the IsBidirectional field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetIsBidirectional() bool {
	if o == nil || IsNil(o.IsBidirectional) {
		var ret bool
		return ret
	}
	return *o.IsBidirectional
}

// GetIsBidirectionalOk returns a tuple with the IsBidirectional field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyResourcesDefStatus) GetIsBidirectionalOk() (*bool, bool) {
	if o == nil || IsNil(o.IsBidirectional) {
		return nil, false
	}
	return o.IsBidirectional, true
}
...
// SetIsBidirectional gets a reference to the given bool and assigns it to the IsBidirectional field.
...
// SetSource gets a reference to the given NetworkAddressStatus and assigns it to the Source field.
func (o *RoutingPolicyResourcesDefStatus) SetSource(v NetworkAddressStatus) {
	o.Source = &v
}

// GetRoutingPolicyCounters returns the RoutingPolicyCounters field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetRoutingPolicyCounters() RoutingPolicyCounters {
	if o == nil || IsNil(o.RoutingPolicyCounters) {
		var ret RoutingPolicyCounters
		return ret
	}
	return *o.RoutingPolicyCounters
}

// GetRoutingPolicyCountersOk returns a tuple with the RoutingPolicyCounters field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyResourcesDefStatus) GetRoutingPolicyCountersOk() (*RoutingPolicyCounters, bool) {
	if o == nil || IsNil(o.RoutingPolicyCounters) {
		return nil, false
	}
	return o.RoutingPolicyCounters, true
}
...
// SetRoutingPolicyCounters gets a reference to the given RoutingPolicyCounters and assigns it to the RoutingPolicyCounters field.
func (o *RoutingPolicyResourcesDefStatus) SetRoutingPolicyCounters(v RoutingPolicyCounters) {
	o.RoutingPolicyCounters = &v
}

// GetProtocolParameters returns the ProtocolParameters field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetProtocolParameters() ProtocolParametersStatus {
	if o == nil || IsNil(o.ProtocolParameters) {
		var ret ProtocolParametersStatus
		return ret
	}
	return *o.ProtocolParameters
}

// GetProtocolParametersOk returns a tuple with the ProtocolParameters field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyResourcesDefStatus) GetProtocolParametersOk() (*ProtocolParametersStatus, bool) {
	if o == nil || IsNil(o.ProtocolParameters) {
		return nil, false
	}
	return o.ProtocolParameters, true
}
...
// SetProtocolParameters gets a reference to the given ProtocolParametersStatus and assigns it to the ProtocolParameters field.
func (o *RoutingPolicyResourcesDefStatus) SetProtocolParameters(v ProtocolParametersStatus) {
	o.ProtocolParameters = &v
}

// GetVirtualNetworkReference returns the VirtualNetworkReference field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetVirtualNetworkReference() VirtualNetworkReference {
	if o == nil || IsNil(o.VirtualNetworkReference) {
		var ret VirtualNetworkReference
		return ret
	}
	return *o.VirtualNetworkReference
}

// GetVirtualNetworkReferenceOk returns a tuple with the VirtualNetworkReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyResourcesDefStatus) GetVirtualNetworkReferenceOk() (*VirtualNetworkReference, bool) {
	if o == nil || IsNil(o.VirtualNetworkReference) {
		return nil, false
	}
	return o.VirtualNetworkReference, true
}
...
// SetVirtualNetworkReference gets a reference to the given VirtualNetworkReference and assigns it to the VirtualNetworkReference field.
func (o *RoutingPolicyResourcesDefStatus) SetVirtualNetworkReference(v VirtualNetworkReference) {
	o.VirtualNetworkReference = &v
}

// GetRerouteFallbackCountersReverseDirection returns the RerouteFallbackCountersReverseDirection field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetRerouteFallbackCountersReverseDirection() RoutingPolicyCounters {
	if o == nil || IsNil(o.RerouteFallbackCountersReverseDirection) {
		var ret RoutingPolicyCounters
		return ret
	}
	return *o.RerouteFallbackCountersReverseDirection
}

// GetRerouteFallbackCountersReverseDirectionOk returns a tuple with the RerouteFallbackCountersReverseDirection field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyResourcesDefStatus) GetRerouteFallbackCountersReverseDirectionOk() (*RoutingPolicyCounters, bool) {
	if o == nil || IsNil(o.RerouteFallbackCountersReverseDirection) {
		return nil, false
	}
	return o.RerouteFallbackCountersReverseDirection, true
}
...
// SetRerouteFallbackCountersReverseDirection gets a reference to the given RoutingPolicyCounters and assigns it to the RerouteFallbackCountersReverseDirection field.
func (o *RoutingPolicyResourcesDefStatus) SetRerouteFallbackCountersReverseDirection(v RoutingPolicyCounters) {
	o.RerouteFallbackCountersReverseDirection = &v
}

// GetAction returns the Action field value if set, zero value otherwise.
func (o *RoutingPolicyResourcesDefStatus) GetAction() RoutingPolicyActionStatus {
	if o == nil || IsNil(o.Action) {
		var ret RoutingPolicyActionStatus
		return ret
	}
	return *o.Action
}
...
// SetAction gets a reference to the given RoutingPolicyActionStatus and assigns it to the Action field.
...
func (o RoutingPolicyResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ServiceIpCountersReverseDirection) {
		toSerialize["service_ip_counters_reverse_direction"] = o.ServiceIpCountersReverseDirection
	}
	if !IsNil(o.VpcReference) {
		toSerialize["vpc_reference"] = o.VpcReference
	}
	if !IsNil(o.ErrorMessage) {
		toSerialize["error_message"] = o.ErrorMessage
	}
	if !IsNil(o.RoutingPolicyCountersReverseDirection) {
		toSerialize["routing_policy_counters_reverse_direction"] = o.RoutingPolicyCountersReverseDirection
	}
	if !IsNil(o.Destination) {
		toSerialize["destination"] = o.Destination
	}
	if !IsNil(o.RerouteFallbackCounters) {
		toSerialize["reroute_fallback_counters"] = o.RerouteFallbackCounters
	}
	if !IsNil(o.ServiceIpCounters) {
		toSerialize["service_ip_counters"] = o.ServiceIpCounters
	}
	if !IsNil(o.IsBidirectional) {
		toSerialize["is_bidirectional"] = o.IsBidirectional
	}
	if !IsNil(o.Source) {
		toSerialize["source"] = o.Source
	}
	if !IsNil(o.RoutingPolicyCounters) {
		toSerialize["routing_policy_counters"] = o.RoutingPolicyCounters
	}
	if !IsNil(o.ProtocolParameters) {
		toSerialize["protocol_parameters"] = o.ProtocolParameters
	}
	if !IsNil(o.VirtualNetworkReference) {
		toSerialize["virtual_network_reference"] = o.VirtualNetworkReference
	}
	if !IsNil(o.RerouteFallbackCountersReverseDirection) {
		toSerialize["reroute_fallback_counters_reverse_direction"] = o.RerouteFallbackCountersReverseDirection
	}
	if !IsNil(o.Action) {
...
func (o *RoutingPolicyResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varRoutingPolicyResourcesDefStatus := _RoutingPolicyResourcesDefStatus{}

	err = json.Unmarshal(data, &varRoutingPolicyResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = RoutingPolicyResourcesDefStatus(varRoutingPolicyResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "service_ip_counters_reverse_direction")
		delete(additionalProperties, "vpc_reference")
		delete(additionalProperties, "error_message")
		delete(additionalProperties, "routing_policy_counters_reverse_direction")
		delete(additionalProperties, "destination")
		delete(additionalProperties, "reroute_fallback_counters")
		delete(additionalProperties, "service_ip_counters")
		delete(additionalProperties, "is_bidirectional")
		delete(additionalProperties, "source")
		delete(additionalProperties, "routing_policy_counters")
		delete(additionalProperties, "protocol_parameters")
		delete(additionalProperties, "virtual_network_reference")
		delete(additionalProperties, "reroute_fallback_counters_reverse_direction")
		delete(additionalProperties, "action")
		delete(additionalProperties, "protocol_type")
...
type NullableRoutingPolicyResourcesDefStatus struct {
	value *RoutingPolicyResourcesDefStatus
	isSet bool
}

func (v NullableRoutingPolicyResourcesDefStatus) Get() *RoutingPolicyResourcesDefStatus {
	return v.value
}

func (v *NullableRoutingPolicyResourcesDefStatus) Set(val *RoutingPolicyResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyResourcesDefStatus(val *RoutingPolicyResourcesDefStatus) *NullableRoutingPolicyResourcesDefStatus {
	return &NullableRoutingPolicyResourcesDefStatus{value: val, isSet: true}
}

func (v NullableRoutingPolicyResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
