...
// checks if the EntityInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntityInfo{}
...
func (o EntityInfo) ToMap() (map[string]interface{}, error) {
...
func (o *EntityInfo) UnmarshalJSON(data []byte) (err error) {
	varEntityInfo := _EntityInfo{}

	err = json.Unmarshal(data, &varEntityInfo)

	if err != nil {
		return err
	}

	*o = EntityInfo(varEntityInfo)
