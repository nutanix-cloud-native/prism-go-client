...
// checks if the VmNic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmNic{}
...
func (o VmNic) MarshalJSON() ([]byte, error) {
...
func (o VmNic) ToMap() (map[string]interface{}, error) {
...
func (o *VmNic) UnmarshalJSON(data []byte) (err error) {
	varVmNic := _VmNic{}

	err = json.Unmarshal(data, &varVmNic)
...
type NullableVmNic struct {
	value *VmNic
	isSet bool
}

func (v NullableVmNic) Get() *VmNic {
	return v.value
}

func (v *NullableVmNic) Set(val *VmNic) {
	v.value = val
	v.isSet = true
}

func (v NullableVmNic) IsSet() bool {
	return v.isSet
}

func (v *NullableVmNic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmNic(val *VmNic) *NullableVmNic {
	return &NullableVmNic{value: val, isSet: true}
}

func (v NullableVmNic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmNic) UnmarshalJSON(src []byte) error {
	v.isSet = true
