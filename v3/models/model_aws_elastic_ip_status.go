...
// checks if the AwsElasticIpStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsElasticIpStatus{}

// AwsElasticIpStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _AwsElasticIpStatus AwsElasticIpStatus
...
func (o AwsElasticIpStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsElasticIpStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsElasticIpStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsElasticIpStatus := _AwsElasticIpStatus{}

	err = json.Unmarshal(data, &varAwsElasticIpStatus)

	if err != nil {
		return err
	}

	*o = AwsElasticIpStatus(varAwsElasticIpStatus)
...
type NullableAwsElasticIpStatus struct {
	value *AwsElasticIpStatus
	isSet bool
}

func (v NullableAwsElasticIpStatus) Get() *AwsElasticIpStatus {
	return v.value
}

func (v *NullableAwsElasticIpStatus) Set(val *AwsElasticIpStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsElasticIpStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsElasticIpStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsElasticIpStatus(val *AwsElasticIpStatus) *NullableAwsElasticIpStatus {
	return &NullableAwsElasticIpStatus{value: val, isSet: true}
}

func (v NullableAwsElasticIpStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsElasticIpStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
