...
// checks if the StreamingPolicyListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyListIntentResponse{}

// StreamingPolicyListIntentResponse Response object for intentful operation of streaming_policys
type StreamingPolicyListIntentResponse struct {
	Entities []StreamingPolicyIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata StreamingPolicyListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _StreamingPolicyListIntentResponse StreamingPolicyListIntentResponse
...
func NewStreamingPolicyListIntentResponse(apiVersion string, metadata StreamingPolicyListMetadataOutput) *StreamingPolicyListIntentResponse {
	this := StreamingPolicyListIntentResponse{}
...
func (o *StreamingPolicyListIntentResponse) GetEntities() []StreamingPolicyIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []StreamingPolicyIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []StreamingPolicyIntentResource and assigns it to the Entities field.
...
func (o *StreamingPolicyListIntentResponse) GetMetadata() StreamingPolicyListMetadataOutput {
	if o == nil {
		var ret StreamingPolicyListMetadataOutput
		return ret
	}
...
func (o StreamingPolicyListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicyListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varStreamingPolicyListIntentResponse := _StreamingPolicyListIntentResponse{}

	err = json.Unmarshal(data, &varStreamingPolicyListIntentResponse)

	if err != nil {
		return err
	}

	*o = StreamingPolicyListIntentResponse(varStreamingPolicyListIntentResponse)
...
type NullableStreamingPolicyListIntentResponse struct {
	value *StreamingPolicyListIntentResponse
	isSet bool
}

func (v NullableStreamingPolicyListIntentResponse) Get() *StreamingPolicyListIntentResponse {
	return v.value
}

func (v *NullableStreamingPolicyListIntentResponse) Set(val *StreamingPolicyListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyListIntentResponse(val *StreamingPolicyListIntentResponse) *NullableStreamingPolicyListIntentResponse {
	return &NullableStreamingPolicyListIntentResponse{value: val, isSet: true}
}

func (v NullableStreamingPolicyListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
