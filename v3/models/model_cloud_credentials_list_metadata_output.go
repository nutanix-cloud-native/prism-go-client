...
// checks if the CloudCredentialsListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCredentialsListMetadataOutput{}

// CloudCredentialsListMetadataOutput All api calls that return a list will have this metadata block 
...
type _CloudCredentialsListMetadataOutput CloudCredentialsListMetadataOutput
...
func NewCloudCredentialsListMetadataOutput() *CloudCredentialsListMetadataOutput {
	this := CloudCredentialsListMetadataOutput{}
	var kind string = "cloud_credentials"
	this.Kind = &kind
	return &this
}
...
func (o CloudCredentialsListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o CloudCredentialsListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *CloudCredentialsListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varCloudCredentialsListMetadataOutput := _CloudCredentialsListMetadataOutput{}

	err = json.Unmarshal(data, &varCloudCredentialsListMetadataOutput)

	if err != nil {
		return err
	}

	*o = CloudCredentialsListMetadataOutput(varCloudCredentialsListMetadataOutput)
...
type NullableCloudCredentialsListMetadataOutput struct {
	value *CloudCredentialsListMetadataOutput
	isSet bool
}

func (v NullableCloudCredentialsListMetadataOutput) Get() *CloudCredentialsListMetadataOutput {
	return v.value
}

func (v *NullableCloudCredentialsListMetadataOutput) Set(val *CloudCredentialsListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCredentialsListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCredentialsListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCredentialsListMetadataOutput(val *CloudCredentialsListMetadataOutput) *NullableCloudCredentialsListMetadataOutput {
	return &NullableCloudCredentialsListMetadataOutput{value: val, isSet: true}
}

func (v NullableCloudCredentialsListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCredentialsListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
