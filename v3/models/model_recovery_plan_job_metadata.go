...
// checks if the RecoveryPlanJobMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobMetadata{}

// RecoveryPlanJobMetadata The recovery_plan_job kind metadata
type RecoveryPlanJobMetadata struct {
	...
	// Categories for the recovery_plan_job. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the recovery_plan_job. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// recovery_plan_job name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanJobMetadata RecoveryPlanJobMetadata
...
func (o RecoveryPlanJobMetadata) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobMetadata := _RecoveryPlanJobMetadata{}

	err = json.Unmarshal(data, &varRecoveryPlanJobMetadata)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobMetadata(varRecoveryPlanJobMetadata)
...
type NullableRecoveryPlanJobMetadata struct {
	value *RecoveryPlanJobMetadata
	isSet bool
}

func (v NullableRecoveryPlanJobMetadata) Get() *RecoveryPlanJobMetadata {
	return v.value
}

func (v *NullableRecoveryPlanJobMetadata) Set(val *RecoveryPlanJobMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobMetadata(val *RecoveryPlanJobMetadata) *NullableRecoveryPlanJobMetadata {
	return &NullableRecoveryPlanJobMetadata{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
