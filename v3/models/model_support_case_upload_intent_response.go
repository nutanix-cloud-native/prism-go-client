...
// checks if the SupportCaseUploadIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseUploadIntentResponse{}

// SupportCaseUploadIntentResponse Response object for intentful operations on a support_case_upload
type SupportCaseUploadIntentResponse struct {
	Status *SupportCaseUploadDefStatus `json:"status,omitempty"`
	Spec *SupportCaseUpload `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata SupportCaseUploadMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _SupportCaseUploadIntentResponse SupportCaseUploadIntentResponse
...
func NewSupportCaseUploadIntentResponse(apiVersion string, metadata SupportCaseUploadMetadata) *SupportCaseUploadIntentResponse {
	this := SupportCaseUploadIntentResponse{}
...
func (o *SupportCaseUploadIntentResponse) GetStatus() SupportCaseUploadDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret SupportCaseUploadDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given SupportCaseUploadDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given SupportCaseUpload and assigns it to the Spec field.
...
func (o *SupportCaseUploadIntentResponse) GetMetadata() SupportCaseUploadMetadata {
	if o == nil {
		var ret SupportCaseUploadMetadata
		return ret
	}
...
func (o SupportCaseUploadIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseUploadIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseUploadIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseUploadIntentResponse := _SupportCaseUploadIntentResponse{}

	err = json.Unmarshal(data, &varSupportCaseUploadIntentResponse)

	if err != nil {
		return err
	}

	*o = SupportCaseUploadIntentResponse(varSupportCaseUploadIntentResponse)
...
type NullableSupportCaseUploadIntentResponse struct {
	value *SupportCaseUploadIntentResponse
	isSet bool
}

func (v NullableSupportCaseUploadIntentResponse) Get() *SupportCaseUploadIntentResponse {
	return v.value
}

func (v *NullableSupportCaseUploadIntentResponse) Set(val *SupportCaseUploadIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseUploadIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseUploadIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseUploadIntentResponse(val *SupportCaseUploadIntentResponse) *NullableSupportCaseUploadIntentResponse {
	return &NullableSupportCaseUploadIntentResponse{value: val, isSet: true}
}

func (v NullableSupportCaseUploadIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseUploadIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
