...
// checks if the NusightsProxyStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NusightsProxyStatus{}

// NusightsProxyStatus The status of a REST API call. Only used when there is a failure to report. 
type NusightsProxyStatus struct {
	// The kind name
...
type _NusightsProxyStatus NusightsProxyStatus
...
func (o NusightsProxyStatus) MarshalJSON() ([]byte, error) {
...
func (o NusightsProxyStatus) ToMap() (map[string]interface{}, error) {
...
func (o *NusightsProxyStatus) UnmarshalJSON(data []byte) (err error) {
	varNusightsProxyStatus := _NusightsProxyStatus{}

	err = json.Unmarshal(data, &varNusightsProxyStatus)

	if err != nil {
		return err
	}

	*o = NusightsProxyStatus(varNusightsProxyStatus)
...
type NullableNusightsProxyStatus struct {
	value *NusightsProxyStatus
	isSet bool
}

func (v NullableNusightsProxyStatus) Get() *NusightsProxyStatus {
	return v.value
}

func (v *NullableNusightsProxyStatus) Set(val *NusightsProxyStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNusightsProxyStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNusightsProxyStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNusightsProxyStatus(val *NusightsProxyStatus) *NullableNusightsProxyStatus {
	return &NullableNusightsProxyStatus{value: val, isSet: true}
}

func (v NullableNusightsProxyStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNusightsProxyStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
