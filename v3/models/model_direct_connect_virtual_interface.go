...
// checks if the DirectConnectVirtualInterface type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterface{}

// DirectConnectVirtualInterface An intentful representation of a direct_connect_virtual_interface spec
type DirectConnectVirtualInterface struct {
	...
	Resources DirectConnectVirtualInterfaceResources `json:"resources"`
	// direct_connect_virtual_interface Name.
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _DirectConnectVirtualInterface DirectConnectVirtualInterface
...
func NewDirectConnectVirtualInterface(resources DirectConnectVirtualInterfaceResources, name string) *DirectConnectVirtualInterface {
	this := DirectConnectVirtualInterface{}
...
func (o *DirectConnectVirtualInterface) GetResources() DirectConnectVirtualInterfaceResources {
	if o == nil {
		var ret DirectConnectVirtualInterfaceResources
		return ret
	}
...
func (o DirectConnectVirtualInterface) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterface) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectVirtualInterface) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectVirtualInterface := _DirectConnectVirtualInterface{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterface)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterface(varDirectConnectVirtualInterface)
...
type NullableDirectConnectVirtualInterface struct {
	value *DirectConnectVirtualInterface
	isSet bool
}

func (v NullableDirectConnectVirtualInterface) Get() *DirectConnectVirtualInterface {
	return v.value
}

func (v *NullableDirectConnectVirtualInterface) Set(val *DirectConnectVirtualInterface) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterface) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterface) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterface(val *DirectConnectVirtualInterface) *NullableDirectConnectVirtualInterface {
	return &NullableDirectConnectVirtualInterface{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterface) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterface) UnmarshalJSON(src []byte) error {
	v.isSet = true
