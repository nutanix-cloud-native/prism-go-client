...
// checks if the RecoverEntitiesEntityInfoListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverEntitiesEntityInfoListInner{}

// RecoverEntitiesEntityInfoListInner struct for RecoverEntitiesEntityInfoListInner
type RecoverEntitiesEntityInfoListInner struct {
	...
	VolumeGroupAttachmentList []RecoverEntitiesEntityInfoListInnerVolumeGroupAttachmentListInner `json:"volume_group_attachment_list,omitempty"`
	// Categories for filtering entities.
	Categories *map[string]string `json:"categories,omitempty"`
	// List of scripts to be executed inside the guest VMs after recovery. 
	ScriptList []RecoveryPlanScriptConfig `json:"script_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoverEntitiesEntityInfoListInner RecoverEntitiesEntityInfoListInner
...
func NewRecoverEntitiesEntityInfoListInner() *RecoverEntitiesEntityInfoListInner {
	this := RecoverEntitiesEntityInfoListInner{}
	return &this
}
...
// GetVmPowerState returns the VmPowerState field value if set, zero value otherwise.
func (o *RecoverEntitiesEntityInfoListInner) GetVmPowerState() string {
	if o == nil || IsNil(o.VmPowerState) {
		var ret string
		return ret
	}
	return *o.VmPowerState
}

// GetVmPowerStateOk returns a tuple with the VmPowerState field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoverEntitiesEntityInfoListInner) GetVmPowerStateOk() (*string, bool) {
	if o == nil || IsNil(o.VmPowerState) {
		return nil, false
	}
	return o.VmPowerState, true
}
...
// SetVmPowerState gets a reference to the given string and assigns it to the VmPowerState field.
func (o *RecoverEntitiesEntityInfoListInner) SetVmPowerState(v string) {
	o.VmPowerState = &v
}

// GetAnyEntityReference returns the AnyEntityReference field value if set, zero value otherwise.
func (o *RecoverEntitiesEntityInfoListInner) GetAnyEntityReference() Reference {
	if o == nil || IsNil(o.AnyEntityReference) {
		var ret Reference
		return ret
	}
...
// GetAnyEntityReferenceOk returns a tuple with the AnyEntityReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAnyEntityReference gets a reference to the given Reference and assigns it to the AnyEntityReference field.
func (o *RecoverEntitiesEntityInfoListInner) SetAnyEntityReference(v Reference) {
	o.AnyEntityReference = &v
}

// GetVolumeGroupAttachmentList returns the VolumeGroupAttachmentList field value if set, zero value otherwise.
func (o *RecoverEntitiesEntityInfoListInner) GetVolumeGroupAttachmentList() []RecoverEntitiesEntityInfoListInnerVolumeGroupAttachmentListInner {
	if o == nil || IsNil(o.VolumeGroupAttachmentList) {
		var ret []RecoverEntitiesEntityInfoListInnerVolumeGroupAttachmentListInner
		return ret
	}
	return o.VolumeGroupAttachmentList
}

// GetVolumeGroupAttachmentListOk returns a tuple with the VolumeGroupAttachmentList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoverEntitiesEntityInfoListInner) GetVolumeGroupAttachmentListOk() ([]RecoverEntitiesEntityInfoListInnerVolumeGroupAttachmentListInner, bool) {
	...
	return o.VolumeGroupAttachmentList, true
}
...
// SetVolumeGroupAttachmentList gets a reference to the given []RecoverEntitiesEntityInfoListInnerVolumeGroupAttachmentListInner and assigns it to the VolumeGroupAttachmentList field.
...
// GetScriptList returns the ScriptList field value if set, zero value otherwise.
func (o *RecoverEntitiesEntityInfoListInner) GetScriptList() []RecoveryPlanScriptConfig {
	if o == nil || IsNil(o.ScriptList) {
		var ret []RecoveryPlanScriptConfig
		return ret
	}
	return o.ScriptList
}

// GetScriptListOk returns a tuple with the ScriptList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoverEntitiesEntityInfoListInner) GetScriptListOk() ([]RecoveryPlanScriptConfig, bool) {
	if o == nil || IsNil(o.ScriptList) {
		return nil, false
	}
	return o.ScriptList, true
}
...
// SetScriptList gets a reference to the given []RecoveryPlanScriptConfig and assigns it to the ScriptList field.
func (o *RecoverEntitiesEntityInfoListInner) SetScriptList(v []RecoveryPlanScriptConfig) {
	o.ScriptList = v
}

func (o RecoverEntitiesEntityInfoListInner) MarshalJSON() ([]byte, error) {
...
func (o RecoverEntitiesEntityInfoListInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VmPowerState) {
		toSerialize["vm_power_state"] = o.VmPowerState
	}
	if !IsNil(o.AnyEntityReference) {
		toSerialize["any_entity_reference"] = o.AnyEntityReference
	}
	if !IsNil(o.VolumeGroupAttachmentList) {
		toSerialize["volume_group_attachment_list"] = o.VolumeGroupAttachmentList
	}
	if !IsNil(o.Categories) {
		toSerialize["categories"] = o.Categories
	}
	if !IsNil(o.ScriptList) {
		toSerialize["script_list"] = o.ScriptList
	}
...
func (o *RecoverEntitiesEntityInfoListInner) UnmarshalJSON(data []byte) (err error) {
	varRecoverEntitiesEntityInfoListInner := _RecoverEntitiesEntityInfoListInner{}

	err = json.Unmarshal(data, &varRecoverEntitiesEntityInfoListInner)

	if err != nil {
		return err
	}

	*o = RecoverEntitiesEntityInfoListInner(varRecoverEntitiesEntityInfoListInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vm_power_state")
		delete(additionalProperties, "any_entity_reference")
		delete(additionalProperties, "volume_group_attachment_list")
		delete(additionalProperties, "categories")
		delete(additionalProperties, "script_list")
...
type NullableRecoverEntitiesEntityInfoListInner struct {
	value *RecoverEntitiesEntityInfoListInner
	isSet bool
}

func (v NullableRecoverEntitiesEntityInfoListInner) Get() *RecoverEntitiesEntityInfoListInner {
	return v.value
}

func (v *NullableRecoverEntitiesEntityInfoListInner) Set(val *RecoverEntitiesEntityInfoListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverEntitiesEntityInfoListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverEntitiesEntityInfoListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverEntitiesEntityInfoListInner(val *RecoverEntitiesEntityInfoListInner) *NullableRecoverEntitiesEntityInfoListInner {
	return &NullableRecoverEntitiesEntityInfoListInner{value: val, isSet: true}
}

func (v NullableRecoverEntitiesEntityInfoListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverEntitiesEntityInfoListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
