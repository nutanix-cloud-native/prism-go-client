...
// checks if the DirectConnectVirtualInterfaceResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterfaceResources{}

// DirectConnectVirtualInterfaceResources Direct connect virtual interface spec.
type DirectConnectVirtualInterfaceResources struct {
	...
	DirectConnectReference DirectConnectReference `json:"direct_connect_reference"`
	...
	PeerIpPrefix string `json:"peer_ip_prefix" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(\\/(\\\\d|[1-2]\\\\d|3[0-2]))$"`
	// md5 hash for bgp peering.
	Md5 *string `json:"md5,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DirectConnectVirtualInterfaceResources DirectConnectVirtualInterfaceResources
...
func NewDirectConnectVirtualInterfaceResources(directConnectReference DirectConnectReference, peerAsn int32, peerIpPrefix string) *DirectConnectVirtualInterfaceResources {
	this := DirectConnectVirtualInterfaceResources{}
	this.DirectConnectReference = directConnectReference
	this.PeerAsn = peerAsn
	this.PeerIpPrefix = peerIpPrefix
	return &this
}
...
// GetDirectConnectReference returns the DirectConnectReference field value
...
// GetDirectConnectReferenceOk returns a tuple with the DirectConnectReference field value
// and a boolean to check if the value has been set.
...
// SetDirectConnectReference sets field value
...
// GetPeerIpPrefix returns the PeerIpPrefix field value
...
// GetPeerIpPrefixOk returns a tuple with the PeerIpPrefix field value
// and a boolean to check if the value has been set.
...
// SetPeerIpPrefix sets field value
...
func (o DirectConnectVirtualInterfaceResources) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterfaceResources) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectVirtualInterfaceResources) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectVirtualInterfaceResources := _DirectConnectVirtualInterfaceResources{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterfaceResources)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterfaceResources(varDirectConnectVirtualInterfaceResources)
...
type NullableDirectConnectVirtualInterfaceResources struct {
	value *DirectConnectVirtualInterfaceResources
	isSet bool
}

func (v NullableDirectConnectVirtualInterfaceResources) Get() *DirectConnectVirtualInterfaceResources {
	return v.value
}

func (v *NullableDirectConnectVirtualInterfaceResources) Set(val *DirectConnectVirtualInterfaceResources) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterfaceResources) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterfaceResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterfaceResources(val *DirectConnectVirtualInterfaceResources) *NullableDirectConnectVirtualInterfaceResources {
	return &NullableDirectConnectVirtualInterfaceResources{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterfaceResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterfaceResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
