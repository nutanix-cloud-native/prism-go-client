...
// checks if the AuditListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditListMetadata{}

// AuditListMetadata All api calls that return a list will have this metadata block as input 
type AuditListMetadata struct {
	// The kind name
...
type _AuditListMetadata AuditListMetadata
...
func (o AuditListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AuditListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AuditListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAuditListMetadata := _AuditListMetadata{}

	err = json.Unmarshal(data, &varAuditListMetadata)

	if err != nil {
		return err
	}

	*o = AuditListMetadata(varAuditListMetadata)
...
type NullableAuditListMetadata struct {
	value *AuditListMetadata
	isSet bool
}

func (v NullableAuditListMetadata) Get() *AuditListMetadata {
	return v.value
}

func (v *NullableAuditListMetadata) Set(val *AuditListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditListMetadata(val *AuditListMetadata) *NullableAuditListMetadata {
	return &NullableAuditListMetadata{value: val, isSet: true}
}

func (v NullableAuditListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
