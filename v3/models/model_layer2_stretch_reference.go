...
// checks if the Layer2StretchReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchReference{}

// Layer2StretchReference The reference to a layer2_stretch
type Layer2StretchReference struct {
	// The kind name
...
type _Layer2StretchReference Layer2StretchReference
...
func (o Layer2StretchReference) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchReference) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchReference) UnmarshalJSON(data []byte) (err error) {
	...
	varLayer2StretchReference := _Layer2StretchReference{}

	err = json.Unmarshal(data, &varLayer2StretchReference)

	if err != nil {
		return err
	}

	*o = Layer2StretchReference(varLayer2StretchReference)
...
type NullableLayer2StretchReference struct {
	value *Layer2StretchReference
	isSet bool
}

func (v NullableLayer2StretchReference) Get() *Layer2StretchReference {
	return v.value
}

func (v *NullableLayer2StretchReference) Set(val *Layer2StretchReference) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchReference) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchReference(val *Layer2StretchReference) *NullableLayer2StretchReference {
	return &NullableLayer2StretchReference{value: val, isSet: true}
}

func (v NullableLayer2StretchReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
