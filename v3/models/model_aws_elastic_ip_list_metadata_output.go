...
// checks if the AwsElasticIpListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsElasticIpListMetadataOutput{}

// AwsElasticIpListMetadataOutput All api calls that return a list will have this metadata block 
type AwsElasticIpListMetadataOutput struct {
	// The kind name
...
type _AwsElasticIpListMetadataOutput AwsElasticIpListMetadataOutput
...
func NewAwsElasticIpListMetadataOutput() *AwsElasticIpListMetadataOutput {
	this := AwsElasticIpListMetadataOutput{}
	var kind string = "aws_elastic_ip"
	this.Kind = &kind
	return &this
}
...
func (o AwsElasticIpListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsElasticIpListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsElasticIpListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsElasticIpListMetadataOutput := _AwsElasticIpListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsElasticIpListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsElasticIpListMetadataOutput(varAwsElasticIpListMetadataOutput)
...
type NullableAwsElasticIpListMetadataOutput struct {
	value *AwsElasticIpListMetadataOutput
	isSet bool
}

func (v NullableAwsElasticIpListMetadataOutput) Get() *AwsElasticIpListMetadataOutput {
	return v.value
}

func (v *NullableAwsElasticIpListMetadataOutput) Set(val *AwsElasticIpListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsElasticIpListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsElasticIpListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsElasticIpListMetadataOutput(val *AwsElasticIpListMetadataOutput) *NullableAwsElasticIpListMetadataOutput {
	return &NullableAwsElasticIpListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsElasticIpListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsElasticIpListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
