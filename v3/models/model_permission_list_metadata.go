...
// checks if the PermissionListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionListMetadata{}

// PermissionListMetadata All api calls that return a list will have this metadata block as input 
...
type _PermissionListMetadata PermissionListMetadata
...
func (o PermissionListMetadata) MarshalJSON() ([]byte, error) {
...
func (o PermissionListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *PermissionListMetadata) UnmarshalJSON(data []byte) (err error) {
	varPermissionListMetadata := _PermissionListMetadata{}

	err = json.Unmarshal(data, &varPermissionListMetadata)

	if err != nil {
		return err
	}

	*o = PermissionListMetadata(varPermissionListMetadata)
...
type NullablePermissionListMetadata struct {
	value *PermissionListMetadata
	isSet bool
}

func (v NullablePermissionListMetadata) Get() *PermissionListMetadata {
	return v.value
}

func (v *NullablePermissionListMetadata) Set(val *PermissionListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionListMetadata(val *PermissionListMetadata) *NullablePermissionListMetadata {
	return &NullablePermissionListMetadata{value: val, isSet: true}
}

func (v NullablePermissionListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
