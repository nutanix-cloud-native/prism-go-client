...
// checks if the StreamingPolicyIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyIntentInput{}

// StreamingPolicyIntentInput An intentful representation of a streaming_policy
type StreamingPolicyIntentInput struct {
	Spec StreamingPolicy `json:"spec"`
...
type _StreamingPolicyIntentInput StreamingPolicyIntentInput
...
func NewStreamingPolicyIntentInput(spec StreamingPolicy, metadata StreamingPolicyMetadata) *StreamingPolicyIntentInput {
	this := StreamingPolicyIntentInput{}
	this.Spec = spec
...
func (o StreamingPolicyIntentInput) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicyIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varStreamingPolicyIntentInput := _StreamingPolicyIntentInput{}

	err = json.Unmarshal(data, &varStreamingPolicyIntentInput)

	if err != nil {
		return err
	}

	*o = StreamingPolicyIntentInput(varStreamingPolicyIntentInput)
...
type NullableStreamingPolicyIntentInput struct {
	value *StreamingPolicyIntentInput
	isSet bool
}

func (v NullableStreamingPolicyIntentInput) Get() *StreamingPolicyIntentInput {
	return v.value
}

func (v *NullableStreamingPolicyIntentInput) Set(val *StreamingPolicyIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyIntentInput(val *StreamingPolicyIntentInput) *NullableStreamingPolicyIntentInput {
	return &NullableStreamingPolicyIntentInput{value: val, isSet: true}
}

func (v NullableStreamingPolicyIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
