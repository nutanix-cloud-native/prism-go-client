...
// checks if the VmCategoryWorkload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmCategoryWorkload{}

// VmCategoryWorkload VM Category workload Object.
...
type _VmCategoryWorkload VmCategoryWorkload
...
func (o VmCategoryWorkload) MarshalJSON() ([]byte, error) {
...
func (o VmCategoryWorkload) ToMap() (map[string]interface{}, error) {
...
func (o *VmCategoryWorkload) UnmarshalJSON(data []byte) (err error) {
	varVmCategoryWorkload := _VmCategoryWorkload{}

	err = json.Unmarshal(data, &varVmCategoryWorkload)

	if err != nil {
		return err
	}

	*o = VmCategoryWorkload(varVmCategoryWorkload)
...
type NullableVmCategoryWorkload struct {
	value *VmCategoryWorkload
	isSet bool
}

func (v NullableVmCategoryWorkload) Get() *VmCategoryWorkload {
	return v.value
}

func (v *NullableVmCategoryWorkload) Set(val *VmCategoryWorkload) {
	v.value = val
	v.isSet = true
}

func (v NullableVmCategoryWorkload) IsSet() bool {
	return v.isSet
}

func (v *NullableVmCategoryWorkload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmCategoryWorkload(val *VmCategoryWorkload) *NullableVmCategoryWorkload {
	return &NullableVmCategoryWorkload{value: val, isSet: true}
}

func (v NullableVmCategoryWorkload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmCategoryWorkload) UnmarshalJSON(src []byte) error {
	v.isSet = true
