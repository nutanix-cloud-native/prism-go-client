...
// RetentionPolicy Retention policy for generated reports. Only one of retention_time_secs and instance_count should be specified. 
type RetentionPolicy struct {
	// Retention period in seconds for the generated reports.
	RetentionTimeSecs *int64 `json:"retention_time_secs,omitempty"`
	// Number of the instances to be be retained.
...
// GetRetentionTimeSecs returns the RetentionTimeSecs field value if set, zero value otherwise.
func (o *RetentionPolicy) GetRetentionTimeSecs() int64 {
	if o == nil || IsNil(o.RetentionTimeSecs) {
		var ret int64
		return ret
	}
	return *o.RetentionTimeSecs
}

// GetRetentionTimeSecsOk returns a tuple with the RetentionTimeSecs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RetentionPolicy) GetRetentionTimeSecsOk() (*int64, bool) {
	if o == nil || IsNil(o.RetentionTimeSecs) {
		return nil, false
	}
	return o.RetentionTimeSecs, true
}
...
// SetRetentionTimeSecs gets a reference to the given int64 and assigns it to the RetentionTimeSecs field.
func (o *RetentionPolicy) SetRetentionTimeSecs(v int64) {
	o.RetentionTimeSecs = &v
}
...
func (o RetentionPolicy) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RetentionTimeSecs) {
		toSerialize["retention_time_secs"] = o.RetentionTimeSecs
	}
...
func (o *RetentionPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	*o = RetentionPolicy(varRetentionPolicy)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "retention_time_secs")
