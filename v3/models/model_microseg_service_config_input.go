...
// checks if the MicrosegServiceConfigInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MicrosegServiceConfigInput{}

// MicrosegServiceConfigInput Input body to configure Microsegmentation.
type MicrosegServiceConfigInput struct {
	// Flag indicating whether to do Microsegmentation enablement validation only. 
	IsValidationOnly *bool `json:"is_validation_only,omitempty"`
	// The desired state of Microsegmentation.
	State *string `json:"state,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MicrosegServiceConfigInput MicrosegServiceConfigInput
...
func NewMicrosegServiceConfigInput() *MicrosegServiceConfigInput {
	this := MicrosegServiceConfigInput{}
	return &this
}
...
// GetIsValidationOnly returns the IsValidationOnly field value if set, zero value otherwise.
func (o *MicrosegServiceConfigInput) GetIsValidationOnly() bool {
	if o == nil || IsNil(o.IsValidationOnly) {
		var ret bool
		return ret
	}
	return *o.IsValidationOnly
}

// GetIsValidationOnlyOk returns a tuple with the IsValidationOnly field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MicrosegServiceConfigInput) GetIsValidationOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.IsValidationOnly) {
		return nil, false
	}
	return o.IsValidationOnly, true
}
...
// SetIsValidationOnly gets a reference to the given bool and assigns it to the IsValidationOnly field.
func (o *MicrosegServiceConfigInput) SetIsValidationOnly(v bool) {
	o.IsValidationOnly = &v
}
...
func (o MicrosegServiceConfigInput) MarshalJSON() ([]byte, error) {
...
func (o MicrosegServiceConfigInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IsValidationOnly) {
		toSerialize["is_validation_only"] = o.IsValidationOnly
	}
	if !IsNil(o.State) {
...
func (o *MicrosegServiceConfigInput) UnmarshalJSON(data []byte) (err error) {
	varMicrosegServiceConfigInput := _MicrosegServiceConfigInput{}

	err = json.Unmarshal(data, &varMicrosegServiceConfigInput)

	if err != nil {
		return err
	}

	*o = MicrosegServiceConfigInput(varMicrosegServiceConfigInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "is_validation_only")
...
type NullableMicrosegServiceConfigInput struct {
	value *MicrosegServiceConfigInput
	isSet bool
}

func (v NullableMicrosegServiceConfigInput) Get() *MicrosegServiceConfigInput {
	return v.value
}

func (v *NullableMicrosegServiceConfigInput) Set(val *MicrosegServiceConfigInput) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosegServiceConfigInput) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosegServiceConfigInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosegServiceConfigInput(val *MicrosegServiceConfigInput) *NullableMicrosegServiceConfigInput {
	return &NullableMicrosegServiceConfigInput{value: val, isSet: true}
}

func (v NullableMicrosegServiceConfigInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosegServiceConfigInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
