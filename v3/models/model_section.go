...
// Section Section Details. Section is a group of widgets.
type Section struct {
	RepetitionCriteria *RepetitionCriteria `json:"repetition_criteria,omitempty"`
	// List of template rows.
	TemplateRows []TemplateRow `json:"template_rows,omitempty"`
	// Description of the section.
	Description *string `json:"description,omitempty"`
	// Name of the section.
	Name *string `json:"name,omitempty"`
	// Identifier for a section. This should be unique in a report config.
...
// GetTemplateRows returns the TemplateRows field value if set, zero value otherwise.
func (o *Section) GetTemplateRows() []TemplateRow {
	if o == nil || IsNil(o.TemplateRows) {
		var ret []TemplateRow
		return ret
	}
...
// GetTemplateRowsOk returns a tuple with the TemplateRows field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTemplateRows gets a reference to the given []TemplateRow and assigns it to the TemplateRows field.
