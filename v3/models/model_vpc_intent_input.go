...
// checks if the VpcIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcIntentInput{}

// VpcIntentInput An intentful representation of a vpc
...
type _VpcIntentInput VpcIntentInput
...
func (o VpcIntentInput) MarshalJSON() ([]byte, error) {
...
func (o VpcIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *VpcIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVpcIntentInput := _VpcIntentInput{}

	err = json.Unmarshal(data, &varVpcIntentInput)

	if err != nil {
		return err
	}

	*o = VpcIntentInput(varVpcIntentInput)
...
type NullableVpcIntentInput struct {
	value *VpcIntentInput
	isSet bool
}

func (v NullableVpcIntentInput) Get() *VpcIntentInput {
	return v.value
}

func (v *NullableVpcIntentInput) Set(val *VpcIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcIntentInput(val *VpcIntentInput) *NullableVpcIntentInput {
	return &NullableVpcIntentInput{value: val, isSet: true}
}

func (v NullableVpcIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
