...
// checks if the DockerRegistryListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryListMetadataOutput{}

// DockerRegistryListMetadataOutput All api calls that return a list will have this metadata block 
...
type _DockerRegistryListMetadataOutput DockerRegistryListMetadataOutput
...
func NewDockerRegistryListMetadataOutput() *DockerRegistryListMetadataOutput {
	this := DockerRegistryListMetadataOutput{}
	var kind string = "docker_registry"
	this.Kind = &kind
	return &this
}
...
func (o DockerRegistryListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varDockerRegistryListMetadataOutput := _DockerRegistryListMetadataOutput{}

	err = json.Unmarshal(data, &varDockerRegistryListMetadataOutput)

	if err != nil {
		return err
	}

	*o = DockerRegistryListMetadataOutput(varDockerRegistryListMetadataOutput)
...
type NullableDockerRegistryListMetadataOutput struct {
	value *DockerRegistryListMetadataOutput
	isSet bool
}

func (v NullableDockerRegistryListMetadataOutput) Get() *DockerRegistryListMetadataOutput {
	return v.value
}

func (v *NullableDockerRegistryListMetadataOutput) Set(val *DockerRegistryListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryListMetadataOutput(val *DockerRegistryListMetadataOutput) *NullableDockerRegistryListMetadataOutput {
	return &NullableDockerRegistryListMetadataOutput{value: val, isSet: true}
}

func (v NullableDockerRegistryListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
