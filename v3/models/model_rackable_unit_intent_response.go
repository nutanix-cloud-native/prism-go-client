...
// checks if the RackableUnitIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackableUnitIntentResponse{}

// RackableUnitIntentResponse Response object for intentful operations on a rackable_unit
type RackableUnitIntentResponse struct {
...
type _RackableUnitIntentResponse RackableUnitIntentResponse
...
func NewRackableUnitIntentResponse(apiVersion string, metadata RackableUnitMetadata) *RackableUnitIntentResponse {
	this := RackableUnitIntentResponse{}
...
func (o RackableUnitIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RackableUnitIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RackableUnitIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRackableUnitIntentResponse := _RackableUnitIntentResponse{}

	err = json.Unmarshal(data, &varRackableUnitIntentResponse)

	if err != nil {
		return err
	}

	*o = RackableUnitIntentResponse(varRackableUnitIntentResponse)
...
type NullableRackableUnitIntentResponse struct {
	value *RackableUnitIntentResponse
	isSet bool
}

func (v NullableRackableUnitIntentResponse) Get() *RackableUnitIntentResponse {
	return v.value
}

func (v *NullableRackableUnitIntentResponse) Set(val *RackableUnitIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRackableUnitIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRackableUnitIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackableUnitIntentResponse(val *RackableUnitIntentResponse) *NullableRackableUnitIntentResponse {
	return &NullableRackableUnitIntentResponse{value: val, isSet: true}
}

func (v NullableRackableUnitIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackableUnitIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
