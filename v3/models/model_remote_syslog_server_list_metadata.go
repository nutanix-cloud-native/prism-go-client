...
// checks if the RemoteSyslogServerListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogServerListMetadata{}

// RemoteSyslogServerListMetadata All api calls that return a list will have this metadata block as input 
type RemoteSyslogServerListMetadata struct {
	// The kind name
...
type _RemoteSyslogServerListMetadata RemoteSyslogServerListMetadata
...
func NewRemoteSyslogServerListMetadata() *RemoteSyslogServerListMetadata {
	this := RemoteSyslogServerListMetadata{}
...
func (o RemoteSyslogServerListMetadata) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogServerListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogServerListMetadata) UnmarshalJSON(data []byte) (err error) {
	varRemoteSyslogServerListMetadata := _RemoteSyslogServerListMetadata{}

	err = json.Unmarshal(data, &varRemoteSyslogServerListMetadata)

	if err != nil {
		return err
	}

	*o = RemoteSyslogServerListMetadata(varRemoteSyslogServerListMetadata)
...
type NullableRemoteSyslogServerListMetadata struct {
	value *RemoteSyslogServerListMetadata
	isSet bool
}

func (v NullableRemoteSyslogServerListMetadata) Get() *RemoteSyslogServerListMetadata {
	return v.value
}

func (v *NullableRemoteSyslogServerListMetadata) Set(val *RemoteSyslogServerListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogServerListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogServerListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogServerListMetadata(val *RemoteSyslogServerListMetadata) *NullableRemoteSyslogServerListMetadata {
	return &NullableRemoteSyslogServerListMetadata{value: val, isSet: true}
}

func (v NullableRemoteSyslogServerListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogServerListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
