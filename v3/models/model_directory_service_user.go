...
// checks if the DirectoryServiceUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceUser{}

// DirectoryServiceUser A Directory Service user.
type DirectoryServiceUser struct {
	...
	// The Unique identifier for each user from the directory service. 
	UserAttributeValue *string `json:"user_attribute_value,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DirectoryServiceUser DirectoryServiceUser
...
// GetUserAttributeValue returns the UserAttributeValue field value if set, zero value otherwise.
func (o *DirectoryServiceUser) GetUserAttributeValue() string {
	if o == nil || IsNil(o.UserAttributeValue) {
		var ret string
		return ret
	}
	return *o.UserAttributeValue
}

// GetUserAttributeValueOk returns a tuple with the UserAttributeValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectoryServiceUser) GetUserAttributeValueOk() (*string, bool) {
	if o == nil || IsNil(o.UserAttributeValue) {
		return nil, false
	}
	return o.UserAttributeValue, true
}
...
// SetUserAttributeValue gets a reference to the given string and assigns it to the UserAttributeValue field.
func (o *DirectoryServiceUser) SetUserAttributeValue(v string) {
	o.UserAttributeValue = &v
}

func (o DirectoryServiceUser) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceUser) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UserAttributeValue) {
		toSerialize["user_attribute_value"] = o.UserAttributeValue
	}
...
func (o *DirectoryServiceUser) UnmarshalJSON(data []byte) (err error) {
	varDirectoryServiceUser := _DirectoryServiceUser{}

	err = json.Unmarshal(data, &varDirectoryServiceUser)

	if err != nil {
		return err
	}

	*o = DirectoryServiceUser(varDirectoryServiceUser)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "user_attribute_value")
...
type NullableDirectoryServiceUser struct {
	value *DirectoryServiceUser
	isSet bool
}

func (v NullableDirectoryServiceUser) Get() *DirectoryServiceUser {
	return v.value
}

func (v *NullableDirectoryServiceUser) Set(val *DirectoryServiceUser) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceUser) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceUser(val *DirectoryServiceUser) *NullableDirectoryServiceUser {
	return &NullableDirectoryServiceUser{value: val, isSet: true}
}

func (v NullableDirectoryServiceUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
