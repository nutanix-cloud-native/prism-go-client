...
// checks if the ClusterIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterIntentResponse{}
...
type _ClusterIntentResponse ClusterIntentResponse
...
func (o ClusterIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ClusterIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterIntentResponse := _ClusterIntentResponse{}

	err = json.Unmarshal(data, &varClusterIntentResponse)

	if err != nil {
		return err
	}

	*o = ClusterIntentResponse(varClusterIntentResponse)
...
type NullableClusterIntentResponse struct {
	value *ClusterIntentResponse
	isSet bool
}

func (v NullableClusterIntentResponse) Get() *ClusterIntentResponse {
	return v.value
}

func (v *NullableClusterIntentResponse) Set(val *ClusterIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterIntentResponse(val *ClusterIntentResponse) *NullableClusterIntentResponse {
	return &NullableClusterIntentResponse{value: val, isSet: true}
}

func (v NullableClusterIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
