...
// checks if the CloudTrustListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustListIntentResponse{}

// CloudTrustListIntentResponse Response object for intentful operation of cloud_trusts
type CloudTrustListIntentResponse struct {
	Entities []CloudTrustIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata CloudTrustListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _CloudTrustListIntentResponse CloudTrustListIntentResponse
...
func NewCloudTrustListIntentResponse(apiVersion string, metadata CloudTrustListMetadataOutput) *CloudTrustListIntentResponse {
	this := CloudTrustListIntentResponse{}
...
func (o *CloudTrustListIntentResponse) GetEntities() []CloudTrustIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []CloudTrustIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []CloudTrustIntentResource and assigns it to the Entities field.
...
func (o *CloudTrustListIntentResponse) GetMetadata() CloudTrustListMetadataOutput {
	if o == nil {
		var ret CloudTrustListMetadataOutput
		return ret
	}
...
func (o CloudTrustListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrustListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTrustListIntentResponse := _CloudTrustListIntentResponse{}

	err = json.Unmarshal(data, &varCloudTrustListIntentResponse)

	if err != nil {
		return err
	}

	*o = CloudTrustListIntentResponse(varCloudTrustListIntentResponse)
...
type NullableCloudTrustListIntentResponse struct {
	value *CloudTrustListIntentResponse
	isSet bool
}

func (v NullableCloudTrustListIntentResponse) Get() *CloudTrustListIntentResponse {
	return v.value
}

func (v *NullableCloudTrustListIntentResponse) Set(val *CloudTrustListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustListIntentResponse(val *CloudTrustListIntentResponse) *NullableCloudTrustListIntentResponse {
	return &NullableCloudTrustListIntentResponse{value: val, isSet: true}
}

func (v NullableCloudTrustListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
