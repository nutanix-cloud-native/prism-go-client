...
// checks if the CommonReportConfigListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigListMetadata{}

// CommonReportConfigListMetadata All api calls that return a list will have this metadata block as input 
type CommonReportConfigListMetadata struct {
	// The kind name
...
type _CommonReportConfigListMetadata CommonReportConfigListMetadata
...
func NewCommonReportConfigListMetadata() *CommonReportConfigListMetadata {
	this := CommonReportConfigListMetadata{}
...
func (o CommonReportConfigListMetadata) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfigListMetadata) UnmarshalJSON(data []byte) (err error) {
	varCommonReportConfigListMetadata := _CommonReportConfigListMetadata{}

	err = json.Unmarshal(data, &varCommonReportConfigListMetadata)

	if err != nil {
		return err
	}

	*o = CommonReportConfigListMetadata(varCommonReportConfigListMetadata)
...
type NullableCommonReportConfigListMetadata struct {
	value *CommonReportConfigListMetadata
	isSet bool
}

func (v NullableCommonReportConfigListMetadata) Get() *CommonReportConfigListMetadata {
	return v.value
}

func (v *NullableCommonReportConfigListMetadata) Set(val *CommonReportConfigListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigListMetadata(val *CommonReportConfigListMetadata) *NullableCommonReportConfigListMetadata {
	return &NullableCommonReportConfigListMetadata{value: val, isSet: true}
}

func (v NullableCommonReportConfigListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
