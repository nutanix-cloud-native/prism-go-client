...
// checks if the ActionRuleResultStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResultStatus{}

// ActionRuleResultStatus The status of a REST API call. Only used when there is a failure to report. 
type ActionRuleResultStatus struct {
	// The kind name
...
type _ActionRuleResultStatus ActionRuleResultStatus
...
func (o ActionRuleResultStatus) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResultStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleResultStatus) UnmarshalJSON(data []byte) (err error) {
	varActionRuleResultStatus := _ActionRuleResultStatus{}

	err = json.Unmarshal(data, &varActionRuleResultStatus)

	if err != nil {
		return err
	}

	*o = ActionRuleResultStatus(varActionRuleResultStatus)
...
type NullableActionRuleResultStatus struct {
	value *ActionRuleResultStatus
	isSet bool
}

func (v NullableActionRuleResultStatus) Get() *ActionRuleResultStatus {
	return v.value
}

func (v *NullableActionRuleResultStatus) Set(val *ActionRuleResultStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResultStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResultStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResultStatus(val *ActionRuleResultStatus) *NullableActionRuleResultStatus {
	return &NullableActionRuleResultStatus{value: val, isSet: true}
}

func (v NullableActionRuleResultStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResultStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
