...
// checks if the ProjectResources1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectResources1{}

// ProjectResources1 struct for ProjectResources1
type ProjectResources1 struct {
...
type _ProjectResources1 ProjectResources1
...
// SetResourceDomain gets a reference to the given ResourceDomainSpec and assigns it to the ResourceDomain field.
...
func (o ProjectResources1) MarshalJSON() ([]byte, error) {
...
func (o ProjectResources1) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectResources1) UnmarshalJSON(data []byte) (err error) {
	varProjectResources1 := _ProjectResources1{}

	err = json.Unmarshal(data, &varProjectResources1)

	if err != nil {
		return err
	}

	*o = ProjectResources1(varProjectResources1)
...
type NullableProjectResources1 struct {
	value *ProjectResources1
	isSet bool
}

func (v NullableProjectResources1) Get() *ProjectResources1 {
	return v.value
}

func (v *NullableProjectResources1) Set(val *ProjectResources1) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectResources1) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectResources1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectResources1(val *ProjectResources1) *NullableProjectResources1 {
	return &NullableProjectResources1{value: val, isSet: true}
}

func (v NullableProjectResources1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectResources1) UnmarshalJSON(src []byte) error {
	v.isSet = true
