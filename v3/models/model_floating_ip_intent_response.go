...
// checks if the FloatingIpIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpIntentResponse{}

// FloatingIpIntentResponse Response object for intentful operations on a floating_ip
type FloatingIpIntentResponse struct {
	...
	Metadata FloatingIpMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _FloatingIpIntentResponse FloatingIpIntentResponse
...
// SetStatus gets a reference to the given FloatingIpDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given FloatingIp and assigns it to the Spec field.
...
func (o FloatingIpIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *FloatingIpIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varFloatingIpIntentResponse := _FloatingIpIntentResponse{}

	err = json.Unmarshal(data, &varFloatingIpIntentResponse)

	if err != nil {
		return err
	}

	*o = FloatingIpIntentResponse(varFloatingIpIntentResponse)
...
type NullableFloatingIpIntentResponse struct {
	value *FloatingIpIntentResponse
	isSet bool
}

func (v NullableFloatingIpIntentResponse) Get() *FloatingIpIntentResponse {
	return v.value
}

func (v *NullableFloatingIpIntentResponse) Set(val *FloatingIpIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpIntentResponse(val *FloatingIpIntentResponse) *NullableFloatingIpIntentResponse {
	return &NullableFloatingIpIntentResponse{value: val, isSet: true}
}

func (v NullableFloatingIpIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
