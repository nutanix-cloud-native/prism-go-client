...
// checks if the AvailabilityZoneInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneInformation{}
...
type _AvailabilityZoneInformation AvailabilityZoneInformation
...
func (o AvailabilityZoneInformation) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneInformation) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneInformation) UnmarshalJSON(data []byte) (err error) {
	...
	varAvailabilityZoneInformation := _AvailabilityZoneInformation{}

	err = json.Unmarshal(data, &varAvailabilityZoneInformation)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneInformation(varAvailabilityZoneInformation)
...
type NullableAvailabilityZoneInformation struct {
	value *AvailabilityZoneInformation
	isSet bool
}

func (v NullableAvailabilityZoneInformation) Get() *AvailabilityZoneInformation {
	return v.value
}

func (v *NullableAvailabilityZoneInformation) Set(val *AvailabilityZoneInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneInformation(val *AvailabilityZoneInformation) *NullableAvailabilityZoneInformation {
	return &NullableAvailabilityZoneInformation{value: val, isSet: true}
}

func (v NullableAvailabilityZoneInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
