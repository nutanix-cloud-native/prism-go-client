...
// checks if the MessageResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MessageResource{}
...
type _MessageResource MessageResource
...
func (o MessageResource) MarshalJSON() ([]byte, error) {
...
func (o MessageResource) ToMap() (map[string]interface{}, error) {
...
func (o *MessageResource) UnmarshalJSON(data []byte) (err error) {
	...
	varMessageResource := _MessageResource{}

	err = json.Unmarshal(data, &varMessageResource)

	if err != nil {
		return err
	}

	*o = MessageResource(varMessageResource)
...
type NullableMessageResource struct {
	value *MessageResource
	isSet bool
}

func (v NullableMessageResource) Get() *MessageResource {
	return v.value
}

func (v *NullableMessageResource) Set(val *MessageResource) {
	v.value = val
	v.isSet = true
}

func (v NullableMessageResource) IsSet() bool {
	return v.isSet
}

func (v *NullableMessageResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMessageResource(val *MessageResource) *NullableMessageResource {
	return &NullableMessageResource{value: val, isSet: true}
}

func (v NullableMessageResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMessageResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
