...
// checks if the RecoveryPlanJobIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobIntentResponse{}

// RecoveryPlanJobIntentResponse Response object for intentful operations on a recovery_plan_job
...
type _RecoveryPlanJobIntentResponse RecoveryPlanJobIntentResponse
...
func NewRecoveryPlanJobIntentResponse(apiVersion string, metadata RecoveryPlanJobMetadata) *RecoveryPlanJobIntentResponse {
	this := RecoveryPlanJobIntentResponse{}
...
func (o RecoveryPlanJobIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobIntentResponse := _RecoveryPlanJobIntentResponse{}

	err = json.Unmarshal(data, &varRecoveryPlanJobIntentResponse)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobIntentResponse(varRecoveryPlanJobIntentResponse)
...
type NullableRecoveryPlanJobIntentResponse struct {
	value *RecoveryPlanJobIntentResponse
	isSet bool
}

func (v NullableRecoveryPlanJobIntentResponse) Get() *RecoveryPlanJobIntentResponse {
	return v.value
}

func (v *NullableRecoveryPlanJobIntentResponse) Set(val *RecoveryPlanJobIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobIntentResponse(val *RecoveryPlanJobIntentResponse) *NullableRecoveryPlanJobIntentResponse {
	return &NullableRecoveryPlanJobIntentResponse{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
