...
// checks if the CloudTrustMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustMetadata{}

// CloudTrustMetadata The cloud_trust kind metadata
type CloudTrustMetadata struct {
	...
	// Categories for the cloud_trust. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the cloud_trust. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _CloudTrustMetadata CloudTrustMetadata
...
func (o CloudTrustMetadata) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrustMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTrustMetadata := _CloudTrustMetadata{}

	err = json.Unmarshal(data, &varCloudTrustMetadata)

	if err != nil {
		return err
	}

	*o = CloudTrustMetadata(varCloudTrustMetadata)
...
type NullableCloudTrustMetadata struct {
	value *CloudTrustMetadata
	isSet bool
}

func (v NullableCloudTrustMetadata) Get() *CloudTrustMetadata {
	return v.value
}

func (v *NullableCloudTrustMetadata) Set(val *CloudTrustMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustMetadata(val *CloudTrustMetadata) *NullableCloudTrustMetadata {
	return &NullableCloudTrustMetadata{value: val, isSet: true}
}

func (v NullableCloudTrustMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
