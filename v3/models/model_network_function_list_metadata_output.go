...
// checks if the NetworkFunctionListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionListMetadataOutput{}

// NetworkFunctionListMetadataOutput All api calls that return a list will have this metadata block 
...
type _NetworkFunctionListMetadataOutput NetworkFunctionListMetadataOutput
...
func NewNetworkFunctionListMetadataOutput() *NetworkFunctionListMetadataOutput {
	this := NetworkFunctionListMetadataOutput{}
	var kind string = "network_function"
	this.Kind = &kind
	return &this
}
...
func (o NetworkFunctionListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varNetworkFunctionListMetadataOutput := _NetworkFunctionListMetadataOutput{}

	err = json.Unmarshal(data, &varNetworkFunctionListMetadataOutput)

	if err != nil {
		return err
	}

	*o = NetworkFunctionListMetadataOutput(varNetworkFunctionListMetadataOutput)
...
type NullableNetworkFunctionListMetadataOutput struct {
	value *NetworkFunctionListMetadataOutput
	isSet bool
}

func (v NullableNetworkFunctionListMetadataOutput) Get() *NetworkFunctionListMetadataOutput {
	return v.value
}

func (v *NullableNetworkFunctionListMetadataOutput) Set(val *NetworkFunctionListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionListMetadataOutput(val *NetworkFunctionListMetadataOutput) *NullableNetworkFunctionListMetadataOutput {
	return &NullableNetworkFunctionListMetadataOutput{value: val, isSet: true}
}

func (v NullableNetworkFunctionListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
