...
type UserInfo struct {
	// The list of Access Control Policies
	AccessControlPolicyList []AccessControlPolicyDetail `json:"access_control_policy_list,omitempty"`
	// User details of the logged in user
	UserDetails []UserDetailsObject `json:"user_details,omitempty"`
	// The legacy name of the logged in user
	UserLegacyName *string `json:"user_legacy_name,omitempty"`
...
func (o *UserInfo) GetAccessControlPolicyList() []AccessControlPolicyDetail {
	if o == nil || IsNil(o.AccessControlPolicyList) {
		var ret []AccessControlPolicyDetail
		return ret
	}
...
// SetAccessControlPolicyList gets a reference to the given []AccessControlPolicyDetail and assigns it to the AccessControlPolicyList field.
...
// SetUserDetails gets a reference to the given []UserDetailsObject and assigns it to the UserDetails field.
func (o *UserInfo) SetUserDetails(v []UserDetailsObject) {
	o.UserDetails = v
}

// GetUserLegacyName returns the UserLegacyName field value if set, zero value otherwise.
func (o *UserInfo) GetUserLegacyName() string {
	if o == nil || IsNil(o.UserLegacyName) {
		var ret string
		return ret
	}
	return *o.UserLegacyName
}

// GetUserLegacyNameOk returns a tuple with the UserLegacyName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserInfo) GetUserLegacyNameOk() (*string, bool) {
	if o == nil || IsNil(o.UserLegacyName) {
		return nil, false
	}
	return o.UserLegacyName, true
}
...
// SetUserLegacyName gets a reference to the given string and assigns it to the UserLegacyName field.
...
func (o UserInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UserLegacyName) {
		toSerialize["user_legacy_name"] = o.UserLegacyName
	}
...
func (o *UserInfo) UnmarshalJSON(data []byte) (err error) {
	...
	*o = UserInfo(varUserInfo)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "user_legacy_name")
