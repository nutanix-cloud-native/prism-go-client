...
// checks if the CmspConfigEnablement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmspConfigEnablement{}

// CmspConfigEnablement MSP configuration for enabling CMSP on PC.
type CmspConfigEnablement struct {
	RegistryImage *ImageSpec `json:"registry_image,omitempty"`
	// The type of operation is kValidate or kEnable. 
	Operation string `json:"operation"`
	Config CmspConfig `json:"config"`
	// Indicates if CMSP enablement is being made as part of PC deployment (value kPE)
	Source *string `json:"source,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CmspConfigEnablement CmspConfigEnablement
...
func NewCmspConfigEnablement(operation string, config CmspConfig) *CmspConfigEnablement {
	this := CmspConfigEnablement{}
	this.Operation = operation
	this.Config = config
	var source string = "kPC"
	this.Source = &source
	return &this
}
...
// SetRegistryImage gets a reference to the given ImageSpec and assigns it to the RegistryImage field.
...
func (o CmspConfigEnablement) MarshalJSON() ([]byte, error) {
...
func (o CmspConfigEnablement) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RegistryImage) {
		toSerialize["registry_image"] = o.RegistryImage
	}
...
func (o *CmspConfigEnablement) UnmarshalJSON(data []byte) (err error) {
	...
	varCmspConfigEnablement := _CmspConfigEnablement{}

	err = json.Unmarshal(data, &varCmspConfigEnablement)

	if err != nil {
		return err
	}

	*o = CmspConfigEnablement(varCmspConfigEnablement)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "registry_image")
...
type NullableCmspConfigEnablement struct {
	value *CmspConfigEnablement
	isSet bool
}

func (v NullableCmspConfigEnablement) Get() *CmspConfigEnablement {
	return v.value
}

func (v *NullableCmspConfigEnablement) Set(val *CmspConfigEnablement) {
	v.value = val
	v.isSet = true
}

func (v NullableCmspConfigEnablement) IsSet() bool {
	return v.isSet
}

func (v *NullableCmspConfigEnablement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmspConfigEnablement(val *CmspConfigEnablement) *NullableCmspConfigEnablement {
	return &NullableCmspConfigEnablement{value: val, isSet: true}
}

func (v NullableCmspConfigEnablement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmspConfigEnablement) UnmarshalJSON(src []byte) error {
	v.isSet = true
