...
// checks if the UnderlaySubnetIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnetIntentResource{}

// UnderlaySubnetIntentResource Response object for intentful operations on a underlay_subnet
type UnderlaySubnetIntentResource struct {
	Status *UnderlaySubnetDefStatus `json:"status,omitempty"`
	Spec *UnderlaySubnet `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata UnderlaySubnetMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _UnderlaySubnetIntentResource UnderlaySubnetIntentResource
...
func NewUnderlaySubnetIntentResource(metadata UnderlaySubnetMetadata) *UnderlaySubnetIntentResource {
	this := UnderlaySubnetIntentResource{}
...
func (o *UnderlaySubnetIntentResource) GetStatus() UnderlaySubnetDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret UnderlaySubnetDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given UnderlaySubnetDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given UnderlaySubnet and assigns it to the Spec field.
...
func (o *UnderlaySubnetIntentResource) GetMetadata() UnderlaySubnetMetadata {
	if o == nil {
		var ret UnderlaySubnetMetadata
		return ret
	}
...
func (o UnderlaySubnetIntentResource) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnetIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *UnderlaySubnetIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varUnderlaySubnetIntentResource := _UnderlaySubnetIntentResource{}

	err = json.Unmarshal(data, &varUnderlaySubnetIntentResource)

	if err != nil {
		return err
	}

	*o = UnderlaySubnetIntentResource(varUnderlaySubnetIntentResource)
...
type NullableUnderlaySubnetIntentResource struct {
	value *UnderlaySubnetIntentResource
	isSet bool
}

func (v NullableUnderlaySubnetIntentResource) Get() *UnderlaySubnetIntentResource {
	return v.value
}

func (v *NullableUnderlaySubnetIntentResource) Set(val *UnderlaySubnetIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnetIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnetIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnetIntentResource(val *UnderlaySubnetIntentResource) *NullableUnderlaySubnetIntentResource {
	return &NullableUnderlaySubnetIntentResource{value: val, isSet: true}
}

func (v NullableUnderlaySubnetIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnetIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
