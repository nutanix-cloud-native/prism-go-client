...
// checks if the RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner{}

// RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner struct for RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner
type RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner struct {
	...
	AvailabilityZoneOrderList []RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerAvailabilityZoneOrderListInner `json:"availability_zone_order_list,omitempty"`
	// List of protected entities associated with Recovery Plan. This list includes the entities which are live and the entities for which Recovery Points are present on the Availability Zone. 
	EntityList []RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner `json:"entity_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner
...
func NewRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner(availabilityZoneUrl string) *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner {
	this := RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner{}
...
// GetAvailabilityZoneOrderList returns the AvailabilityZoneOrderList field value if set, zero value otherwise.
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) GetAvailabilityZoneOrderList() []RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerAvailabilityZoneOrderListInner {
	if o == nil || IsNil(o.AvailabilityZoneOrderList) {
		var ret []RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerAvailabilityZoneOrderListInner
		return ret
	}
	return o.AvailabilityZoneOrderList
}

// GetAvailabilityZoneOrderListOk returns a tuple with the AvailabilityZoneOrderList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) GetAvailabilityZoneOrderListOk() ([]RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerAvailabilityZoneOrderListInner, bool) {
	...
	return o.AvailabilityZoneOrderList, true
}
...
// SetAvailabilityZoneOrderList gets a reference to the given []RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerAvailabilityZoneOrderListInner and assigns it to the AvailabilityZoneOrderList field.
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) SetAvailabilityZoneOrderList(v []RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerAvailabilityZoneOrderListInner) {
	o.AvailabilityZoneOrderList = v
}

// GetEntityList returns the EntityList field value if set, zero value otherwise.
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) GetEntityList() []RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner {
	if o == nil || IsNil(o.EntityList) {
		var ret []RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner
		return ret
	}
	return o.EntityList
}
...
// SetEntityList gets a reference to the given []RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInnerEntityListInner and assigns it to the EntityList field.
...
func (o RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["availability_zone_url"] = o.AvailabilityZoneUrl
	if !IsNil(o.AvailabilityZoneOrderList) {
		toSerialize["availability_zone_order_list"] = o.AvailabilityZoneOrderList
	}
	if !IsNil(o.EntityList) {
		toSerialize["entity_list"] = o.EntityList
	}
...
func (o *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner := _RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner{}

	err = json.Unmarshal(data, &varRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner)

	if err != nil {
		return err
	}

	*o = RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner(varRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "availability_zone_url")
		delete(additionalProperties, "availability_zone_order_list")
		delete(additionalProperties, "entity_list")
...
type NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner struct {
	value *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner
	isSet bool
}

func (v NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) Get() *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner {
	return v.value
}

func (v *NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) Set(val *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner(val *RecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) *NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner {
	return &NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner{value: val, isSet: true}
}

func (v NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanEntitiesEntitiesPerAvailabilityZoneListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
