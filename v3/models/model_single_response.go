...
// checks if the SingleResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SingleResponse{}

// SingleResponse Single response object defintion.
type SingleResponse struct {
	GenericResponse *GenericResponse `json:"generic_response,omitempty"`
	HelpResult *HelpResult `json:"help_result,omitempty"`
	EntitybrowserResponse *EntitybrowserResponse `json:"entitybrowser_response,omitempty"`
	Page *Page `json:"page,omitempty"`
	Link *Link `json:"link,omitempty"`
	TimeseriesResponse *TimeseriesResponse `json:"timeseries_response,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SingleResponse SingleResponse
...
// GetGenericResponse returns the GenericResponse field value if set, zero value otherwise.
func (o *SingleResponse) GetGenericResponse() GenericResponse {
	if o == nil || IsNil(o.GenericResponse) {
		var ret GenericResponse
		return ret
	}
	return *o.GenericResponse
}

// GetGenericResponseOk returns a tuple with the GenericResponse field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SingleResponse) GetGenericResponseOk() (*GenericResponse, bool) {
	if o == nil || IsNil(o.GenericResponse) {
		return nil, false
	}
	return o.GenericResponse, true
}
...
// SetGenericResponse gets a reference to the given GenericResponse and assigns it to the GenericResponse field.
func (o *SingleResponse) SetGenericResponse(v GenericResponse) {
	o.GenericResponse = &v
}

// GetHelpResult returns the HelpResult field value if set, zero value otherwise.
func (o *SingleResponse) GetHelpResult() HelpResult {
	if o == nil || IsNil(o.HelpResult) {
		var ret HelpResult
		return ret
	}
	return *o.HelpResult
...
// GetHelpResultOk returns a tuple with the HelpResult field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SingleResponse) GetHelpResultOk() (*HelpResult, bool) {
	if o == nil || IsNil(o.HelpResult) {
		return nil, false
	}
	return o.HelpResult, true
}
...
// SetHelpResult gets a reference to the given HelpResult and assigns it to the HelpResult field.
func (o *SingleResponse) SetHelpResult(v HelpResult) {
	o.HelpResult = &v
}

// GetEntitybrowserResponse returns the EntitybrowserResponse field value if set, zero value otherwise.
func (o *SingleResponse) GetEntitybrowserResponse() EntitybrowserResponse {
	if o == nil || IsNil(o.EntitybrowserResponse) {
		var ret EntitybrowserResponse
		return ret
	}
	return *o.EntitybrowserResponse
}

// GetEntitybrowserResponseOk returns a tuple with the EntitybrowserResponse field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SingleResponse) GetEntitybrowserResponseOk() (*EntitybrowserResponse, bool) {
	if o == nil || IsNil(o.EntitybrowserResponse) {
		return nil, false
	}
	return o.EntitybrowserResponse, true
}
...
// SetEntitybrowserResponse gets a reference to the given EntitybrowserResponse and assigns it to the EntitybrowserResponse field.
func (o *SingleResponse) SetEntitybrowserResponse(v EntitybrowserResponse) {
	o.EntitybrowserResponse = &v
}
...
// GetTimeseriesResponse returns the TimeseriesResponse field value if set, zero value otherwise.
func (o *SingleResponse) GetTimeseriesResponse() TimeseriesResponse {
	if o == nil || IsNil(o.TimeseriesResponse) {
		var ret TimeseriesResponse
		return ret
	}
	return *o.TimeseriesResponse
}

// GetTimeseriesResponseOk returns a tuple with the TimeseriesResponse field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SingleResponse) GetTimeseriesResponseOk() (*TimeseriesResponse, bool) {
	if o == nil || IsNil(o.TimeseriesResponse) {
		return nil, false
	}
	return o.TimeseriesResponse, true
}
...
// SetTimeseriesResponse gets a reference to the given TimeseriesResponse and assigns it to the TimeseriesResponse field.
func (o *SingleResponse) SetTimeseriesResponse(v TimeseriesResponse) {
	o.TimeseriesResponse = &v
}

func (o SingleResponse) MarshalJSON() ([]byte, error) {
...
func (o SingleResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.GenericResponse) {
		toSerialize["generic_response"] = o.GenericResponse
	}
	if !IsNil(o.HelpResult) {
		toSerialize["help_result"] = o.HelpResult
	}
	if !IsNil(o.EntitybrowserResponse) {
		toSerialize["entitybrowser_response"] = o.EntitybrowserResponse
	}
	if !IsNil(o.Page) {
	...
	if !IsNil(o.TimeseriesResponse) {
		toSerialize["timeseries_response"] = o.TimeseriesResponse
	}
...
func (o *SingleResponse) UnmarshalJSON(data []byte) (err error) {
	varSingleResponse := _SingleResponse{}

	err = json.Unmarshal(data, &varSingleResponse)

	if err != nil {
		return err
	}

	*o = SingleResponse(varSingleResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "generic_response")
		delete(additionalProperties, "help_result")
		delete(additionalProperties, "entitybrowser_response")
		delete(additionalProperties, "page")
		delete(additionalProperties, "link")
		delete(additionalProperties, "timeseries_response")
...
type NullableSingleResponse struct {
	value *SingleResponse
	isSet bool
}

func (v NullableSingleResponse) Get() *SingleResponse {
	return v.value
}

func (v *NullableSingleResponse) Set(val *SingleResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleResponse(val *SingleResponse) *NullableSingleResponse {
	return &NullableSingleResponse{value: val, isSet: true}
}

func (v NullableSingleResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSingleResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
