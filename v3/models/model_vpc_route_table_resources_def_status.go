...
// checks if the VpcRouteTableResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcRouteTableResourcesDefStatus{}

// VpcRouteTableResourcesDefStatus VPC route table resources status
type VpcRouteTableResourcesDefStatus struct {
	// Set of statically configured routes in this table.
	StaticRoutesList []RouteStatus `json:"static_routes_list,omitempty"`
	// Set of dynamically received routes in this table.
	DynamicRoutesList []RouteStatus `json:"dynamic_routes_list,omitempty"`
	DefaultRoute *RouteStatus `json:"default_route,omitempty"`
	// Set of locally defined routes in this table.
	LocalRoutesList []RouteStatus `json:"local_routes_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VpcRouteTableResourcesDefStatus VpcRouteTableResourcesDefStatus
...
func NewVpcRouteTableResourcesDefStatus() *VpcRouteTableResourcesDefStatus {
	this := VpcRouteTableResourcesDefStatus{}
	return &this
}
...
// GetStaticRoutesList returns the StaticRoutesList field value if set, zero value otherwise.
func (o *VpcRouteTableResourcesDefStatus) GetStaticRoutesList() []RouteStatus {
	if o == nil || IsNil(o.StaticRoutesList) {
		var ret []RouteStatus
		return ret
	}
	return o.StaticRoutesList
}

// GetStaticRoutesListOk returns a tuple with the StaticRoutesList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpcRouteTableResourcesDefStatus) GetStaticRoutesListOk() ([]RouteStatus, bool) {
	if o == nil || IsNil(o.StaticRoutesList) {
		return nil, false
	}
	return o.StaticRoutesList, true
}
...
// SetStaticRoutesList gets a reference to the given []RouteStatus and assigns it to the StaticRoutesList field.
func (o *VpcRouteTableResourcesDefStatus) SetStaticRoutesList(v []RouteStatus) {
	o.StaticRoutesList = v
}

// GetDynamicRoutesList returns the DynamicRoutesList field value if set, zero value otherwise.
func (o *VpcRouteTableResourcesDefStatus) GetDynamicRoutesList() []RouteStatus {
	if o == nil || IsNil(o.DynamicRoutesList) {
		var ret []RouteStatus
		return ret
	}
	return o.DynamicRoutesList
}

// GetDynamicRoutesListOk returns a tuple with the DynamicRoutesList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpcRouteTableResourcesDefStatus) GetDynamicRoutesListOk() ([]RouteStatus, bool) {
	if o == nil || IsNil(o.DynamicRoutesList) {
		return nil, false
	}
	return o.DynamicRoutesList, true
}
...
// SetDynamicRoutesList gets a reference to the given []RouteStatus and assigns it to the DynamicRoutesList field.
func (o *VpcRouteTableResourcesDefStatus) SetDynamicRoutesList(v []RouteStatus) {
	o.DynamicRoutesList = v
}
...
// SetDefaultRoute gets a reference to the given RouteStatus and assigns it to the DefaultRoute field.
func (o *VpcRouteTableResourcesDefStatus) SetDefaultRoute(v RouteStatus) {
	o.DefaultRoute = &v
}

// GetLocalRoutesList returns the LocalRoutesList field value if set, zero value otherwise.
func (o *VpcRouteTableResourcesDefStatus) GetLocalRoutesList() []RouteStatus {
	if o == nil || IsNil(o.LocalRoutesList) {
		var ret []RouteStatus
		return ret
	}
	return o.LocalRoutesList
}

// GetLocalRoutesListOk returns a tuple with the LocalRoutesList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpcRouteTableResourcesDefStatus) GetLocalRoutesListOk() ([]RouteStatus, bool) {
	if o == nil || IsNil(o.LocalRoutesList) {
		return nil, false
	}
	return o.LocalRoutesList, true
}
...
// SetLocalRoutesList gets a reference to the given []RouteStatus and assigns it to the LocalRoutesList field.
func (o *VpcRouteTableResourcesDefStatus) SetLocalRoutesList(v []RouteStatus) {
	o.LocalRoutesList = v
}

func (o VpcRouteTableResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VpcRouteTableResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.StaticRoutesList) {
		toSerialize["static_routes_list"] = o.StaticRoutesList
	}
	if !IsNil(o.DynamicRoutesList) {
		toSerialize["dynamic_routes_list"] = o.DynamicRoutesList
	}
	if !IsNil(o.DefaultRoute) {
		toSerialize["default_route"] = o.DefaultRoute
	}
	if !IsNil(o.LocalRoutesList) {
		toSerialize["local_routes_list"] = o.LocalRoutesList
	}
...
func (o *VpcRouteTableResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varVpcRouteTableResourcesDefStatus := _VpcRouteTableResourcesDefStatus{}

	err = json.Unmarshal(data, &varVpcRouteTableResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = VpcRouteTableResourcesDefStatus(varVpcRouteTableResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "static_routes_list")
		delete(additionalProperties, "dynamic_routes_list")
		delete(additionalProperties, "default_route")
		delete(additionalProperties, "local_routes_list")
...
type NullableVpcRouteTableResourcesDefStatus struct {
	value *VpcRouteTableResourcesDefStatus
	isSet bool
}

func (v NullableVpcRouteTableResourcesDefStatus) Get() *VpcRouteTableResourcesDefStatus {
	return v.value
}

func (v *NullableVpcRouteTableResourcesDefStatus) Set(val *VpcRouteTableResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcRouteTableResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcRouteTableResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcRouteTableResourcesDefStatus(val *VpcRouteTableResourcesDefStatus) *NullableVpcRouteTableResourcesDefStatus {
	return &NullableVpcRouteTableResourcesDefStatus{value: val, isSet: true}
}

func (v NullableVpcRouteTableResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcRouteTableResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
