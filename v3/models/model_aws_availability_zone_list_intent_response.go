...
// checks if the AwsAvailabilityZoneListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsAvailabilityZoneListIntentResponse{}

// AwsAvailabilityZoneListIntentResponse AWS VPC entity list.
type AwsAvailabilityZoneListIntentResponse struct {
	Entities []AwsAvailabilityZoneIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsAvailabilityZoneListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsAvailabilityZoneListIntentResponse AwsAvailabilityZoneListIntentResponse
...
func NewAwsAvailabilityZoneListIntentResponse(apiVersion string, metadata AwsAvailabilityZoneListMetadataOutput) *AwsAvailabilityZoneListIntentResponse {
	this := AwsAvailabilityZoneListIntentResponse{}
...
func (o *AwsAvailabilityZoneListIntentResponse) GetEntities() []AwsAvailabilityZoneIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []AwsAvailabilityZoneIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []AwsAvailabilityZoneIntentResource and assigns it to the Entities field.
...
func (o *AwsAvailabilityZoneListIntentResponse) GetMetadata() AwsAvailabilityZoneListMetadataOutput {
	if o == nil {
		var ret AwsAvailabilityZoneListMetadataOutput
		return ret
	}
...
func (o AwsAvailabilityZoneListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsAvailabilityZoneListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsAvailabilityZoneListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsAvailabilityZoneListIntentResponse := _AwsAvailabilityZoneListIntentResponse{}

	err = json.Unmarshal(data, &varAwsAvailabilityZoneListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsAvailabilityZoneListIntentResponse(varAwsAvailabilityZoneListIntentResponse)
...
type NullableAwsAvailabilityZoneListIntentResponse struct {
	value *AwsAvailabilityZoneListIntentResponse
	isSet bool
}

func (v NullableAwsAvailabilityZoneListIntentResponse) Get() *AwsAvailabilityZoneListIntentResponse {
	return v.value
}

func (v *NullableAwsAvailabilityZoneListIntentResponse) Set(val *AwsAvailabilityZoneListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsAvailabilityZoneListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsAvailabilityZoneListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsAvailabilityZoneListIntentResponse(val *AwsAvailabilityZoneListIntentResponse) *NullableAwsAvailabilityZoneListIntentResponse {
	return &NullableAwsAvailabilityZoneListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsAvailabilityZoneListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsAvailabilityZoneListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
