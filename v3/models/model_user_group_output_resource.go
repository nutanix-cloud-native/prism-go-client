...
// checks if the UserGroupOutputResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupOutputResource{}

// UserGroupOutputResource User Group Resource Definition.
type UserGroupOutputResource struct {
	// A list of projects the user group is part of.
	ProjectsReferenceList []ProjectReference `json:"projects_reference_list,omitempty"`
	DirectoryServiceUserGroup *DirectoryServiceUserGroupStatus `json:"directory_service_user_group,omitempty"`
	...
	// The display name for the user group.
	DisplayName string `json:"display_name"`
	UserGroupType *string `json:"user_group_type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UserGroupOutputResource UserGroupOutputResource
...
// GetDirectoryServiceUserGroup returns the DirectoryServiceUserGroup field value if set, zero value otherwise.
func (o *UserGroupOutputResource) GetDirectoryServiceUserGroup() DirectoryServiceUserGroupStatus {
	if o == nil || IsNil(o.DirectoryServiceUserGroup) {
		var ret DirectoryServiceUserGroupStatus
		return ret
	}
	return *o.DirectoryServiceUserGroup
}

// GetDirectoryServiceUserGroupOk returns a tuple with the DirectoryServiceUserGroup field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserGroupOutputResource) GetDirectoryServiceUserGroupOk() (*DirectoryServiceUserGroupStatus, bool) {
	if o == nil || IsNil(o.DirectoryServiceUserGroup) {
		return nil, false
	}
	return o.DirectoryServiceUserGroup, true
}
...
// SetDirectoryServiceUserGroup gets a reference to the given DirectoryServiceUserGroupStatus and assigns it to the DirectoryServiceUserGroup field.
func (o *UserGroupOutputResource) SetDirectoryServiceUserGroup(v DirectoryServiceUserGroupStatus) {
	o.DirectoryServiceUserGroup = &v
}
...
// SetUserGroupType gets a reference to the given string and assigns it to the UserGroupType field.
func (o *UserGroupOutputResource) SetUserGroupType(v string) {
	o.UserGroupType = &v
}

func (o UserGroupOutputResource) MarshalJSON() ([]byte, error) {
...
func (o UserGroupOutputResource) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ProjectsReferenceList) {
		toSerialize["projects_reference_list"] = o.ProjectsReferenceList
	}
	if !IsNil(o.DirectoryServiceUserGroup) {
		toSerialize["directory_service_user_group"] = o.DirectoryServiceUserGroup
	}
	...
	if !IsNil(o.UserGroupType) {
		toSerialize["user_group_type"] = o.UserGroupType
	}
...
func (o *UserGroupOutputResource) UnmarshalJSON(data []byte) (err error) {
	...
	varUserGroupOutputResource := _UserGroupOutputResource{}

	err = json.Unmarshal(data, &varUserGroupOutputResource)

	if err != nil {
		return err
	}

	*o = UserGroupOutputResource(varUserGroupOutputResource)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "projects_reference_list")
		delete(additionalProperties, "directory_service_user_group")
		delete(additionalProperties, "access_control_policy_reference_list")
		delete(additionalProperties, "display_name")
		delete(additionalProperties, "user_group_type")
...
type NullableUserGroupOutputResource struct {
	value *UserGroupOutputResource
	isSet bool
}

func (v NullableUserGroupOutputResource) Get() *UserGroupOutputResource {
	return v.value
}

func (v *NullableUserGroupOutputResource) Set(val *UserGroupOutputResource) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupOutputResource) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupOutputResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupOutputResource(val *UserGroupOutputResource) *NullableUserGroupOutputResource {
	return &NullableUserGroupOutputResource{value: val, isSet: true}
}

func (v NullableUserGroupOutputResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupOutputResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
