...
// checks if the AppServicePort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppServicePort{}

// AppServicePort Port for Application Service.
type AppServicePort struct {
	...
	// 
	ExposedAddress *string `json:"exposed_address,omitempty"`
	// 
...
type _AppServicePort AppServicePort
...
// GetExposedPort returns the ExposedPort field value if set, zero value otherwise.
func (o *AppServicePort) GetExposedPort() string {
	if o == nil || IsNil(o.ExposedPort) {
		var ret string
		return ret
	}
...
// GetExposedPortOk returns a tuple with the ExposedPort field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppServicePort) GetExposedPortOk() (*string, bool) {
	if o == nil || IsNil(o.ExposedPort) {
		return nil, false
	}
	return o.ExposedPort, true
}
...
// SetExposedPort gets a reference to the given string and assigns it to the ExposedPort field.
func (o *AppServicePort) SetExposedPort(v string) {
	o.ExposedPort = &v
}

// GetExposedAddress returns the ExposedAddress field value if set, zero value otherwise.
func (o *AppServicePort) GetExposedAddress() string {
	if o == nil || IsNil(o.ExposedAddress) {
		var ret string
		return ret
	}
	return *o.ExposedAddress
}

// GetExposedAddressOk returns a tuple with the ExposedAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppServicePort) GetExposedAddressOk() (*string, bool) {
	if o == nil || IsNil(o.ExposedAddress) {
		return nil, false
	}
	return o.ExposedAddress, true
}
...
// SetExposedAddress gets a reference to the given string and assigns it to the ExposedAddress field.
...
func (o AppServicePort) MarshalJSON() ([]byte, error) {
...
func (o AppServicePort) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["protocol"] = o.Protocol
	if !IsNil(o.ExposedPort) {
		toSerialize["exposed_port"] = o.ExposedPort
	}
	if !IsNil(o.ExposedAddress) {
		toSerialize["exposed_address"] = o.ExposedAddress
	}
...
func (o *AppServicePort) UnmarshalJSON(data []byte) (err error) {
	...
	varAppServicePort := _AppServicePort{}

	err = json.Unmarshal(data, &varAppServicePort)

	if err != nil {
		return err
	}

	*o = AppServicePort(varAppServicePort)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "protocol")
		delete(additionalProperties, "exposed_port")
		delete(additionalProperties, "exposed_address")
		delete(additionalProperties, "target_port")
		delete(additionalProperties, "endpoint_name")
...
type NullableAppServicePort struct {
	value *AppServicePort
	isSet bool
}

func (v NullableAppServicePort) Get() *AppServicePort {
	return v.value
}

func (v *NullableAppServicePort) Set(val *AppServicePort) {
	v.value = val
	v.isSet = true
}

func (v NullableAppServicePort) IsSet() bool {
	return v.isSet
}

func (v *NullableAppServicePort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppServicePort(val *AppServicePort) *NullableAppServicePort {
	return &NullableAppServicePort{value: val, isSet: true}
}

func (v NullableAppServicePort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppServicePort) UnmarshalJSON(src []byte) error {
	v.isSet = true
