...
// checks if the NetworkFunctionListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionListMetadata{}

// NetworkFunctionListMetadata All api calls that return a list will have this metadata block as input 
...
type _NetworkFunctionListMetadata NetworkFunctionListMetadata
...
func NewNetworkFunctionListMetadata() *NetworkFunctionListMetadata {
	this := NetworkFunctionListMetadata{}
...
func (o NetworkFunctionListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionListMetadata) UnmarshalJSON(data []byte) (err error) {
	varNetworkFunctionListMetadata := _NetworkFunctionListMetadata{}

	err = json.Unmarshal(data, &varNetworkFunctionListMetadata)

	if err != nil {
		return err
	}

	*o = NetworkFunctionListMetadata(varNetworkFunctionListMetadata)
...
type NullableNetworkFunctionListMetadata struct {
	value *NetworkFunctionListMetadata
	isSet bool
}

func (v NullableNetworkFunctionListMetadata) Get() *NetworkFunctionListMetadata {
	return v.value
}

func (v *NullableNetworkFunctionListMetadata) Set(val *NetworkFunctionListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionListMetadata(val *NetworkFunctionListMetadata) *NullableNetworkFunctionListMetadata {
	return &NullableNetworkFunctionListMetadata{value: val, isSet: true}
}

func (v NullableNetworkFunctionListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
