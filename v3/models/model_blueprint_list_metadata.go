...
// checks if the BlueprintListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintListMetadata{}

// BlueprintListMetadata All api calls that return a list will have this metadata block as input 
type BlueprintListMetadata struct {
	// The kind name
...
type _BlueprintListMetadata BlueprintListMetadata
...
func (o BlueprintListMetadata) MarshalJSON() ([]byte, error) {
...
func (o BlueprintListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintListMetadata) UnmarshalJSON(data []byte) (err error) {
	varBlueprintListMetadata := _BlueprintListMetadata{}

	err = json.Unmarshal(data, &varBlueprintListMetadata)

	if err != nil {
		return err
	}

	*o = BlueprintListMetadata(varBlueprintListMetadata)
...
type NullableBlueprintListMetadata struct {
	value *BlueprintListMetadata
	isSet bool
}

func (v NullableBlueprintListMetadata) Get() *BlueprintListMetadata {
	return v.value
}

func (v *NullableBlueprintListMetadata) Set(val *BlueprintListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintListMetadata(val *BlueprintListMetadata) *NullableBlueprintListMetadata {
	return &NullableBlueprintListMetadata{value: val, isSet: true}
}

func (v NullableBlueprintListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
