...
// checks if the CellListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CellListIntentResponse{}

// CellListIntentResponse Response object for intentful operation of cells
type CellListIntentResponse struct {
	Entities []CellIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata CellListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _CellListIntentResponse CellListIntentResponse
...
// SetEntities gets a reference to the given []CellIntentResource and assigns it to the Entities field.
...
func (o *CellListIntentResponse) GetMetadata() CellListMetadataOutput {
	if o == nil {
		var ret CellListMetadataOutput
		return ret
	}
...
func (o CellListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CellListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CellListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCellListIntentResponse := _CellListIntentResponse{}

	err = json.Unmarshal(data, &varCellListIntentResponse)

	if err != nil {
		return err
	}

	*o = CellListIntentResponse(varCellListIntentResponse)
...
type NullableCellListIntentResponse struct {
	value *CellListIntentResponse
	isSet bool
}

func (v NullableCellListIntentResponse) Get() *CellListIntentResponse {
	return v.value
}

func (v *NullableCellListIntentResponse) Set(val *CellListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCellListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCellListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCellListIntentResponse(val *CellListIntentResponse) *NullableCellListIntentResponse {
	return &NullableCellListIntentResponse{value: val, isSet: true}
}

func (v NullableCellListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCellListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
