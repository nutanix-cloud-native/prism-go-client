...
// checks if the ReportConfigIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigIntentInput{}

// ReportConfigIntentInput An intentful representation of a report_config
type ReportConfigIntentInput struct {
	Spec ReportConfig `json:"spec"`
...
type _ReportConfigIntentInput ReportConfigIntentInput
...
func (o ReportConfigIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfigIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varReportConfigIntentInput := _ReportConfigIntentInput{}

	err = json.Unmarshal(data, &varReportConfigIntentInput)

	if err != nil {
		return err
	}

	*o = ReportConfigIntentInput(varReportConfigIntentInput)
...
type NullableReportConfigIntentInput struct {
	value *ReportConfigIntentInput
	isSet bool
}

func (v NullableReportConfigIntentInput) Get() *ReportConfigIntentInput {
	return v.value
}

func (v *NullableReportConfigIntentInput) Set(val *ReportConfigIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigIntentInput(val *ReportConfigIntentInput) *NullableReportConfigIntentInput {
	return &NullableReportConfigIntentInput{value: val, isSet: true}
}

func (v NullableReportConfigIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
