...
// checks if the AccountDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountDefStatus{}

// AccountDefStatus An intentful representation of a account status
type AccountDefStatus struct {
	// account Name.
	Name string `json:"name"`
	// The state of the account.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the account, if in an error state.
	...
	Resources AccountResourcesDefStatus `json:"resources"`
	// A description for account.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AccountDefStatus AccountDefStatus
...
func (o *AccountDefStatus) GetResources() AccountResourcesDefStatus {
	if o == nil {
		var ret AccountResourcesDefStatus
		return ret
	}
...
func (o AccountDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AccountDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AccountDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountDefStatus := _AccountDefStatus{}

	err = json.Unmarshal(data, &varAccountDefStatus)

	if err != nil {
		return err
	}

	*o = AccountDefStatus(varAccountDefStatus)
...
type NullableAccountDefStatus struct {
	value *AccountDefStatus
	isSet bool
}

func (v NullableAccountDefStatus) Get() *AccountDefStatus {
	return v.value
}

func (v *NullableAccountDefStatus) Set(val *AccountDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountDefStatus(val *AccountDefStatus) *NullableAccountDefStatus {
	return &NullableAccountDefStatus{value: val, isSet: true}
}

func (v NullableAccountDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
