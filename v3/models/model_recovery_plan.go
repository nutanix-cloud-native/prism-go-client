...
// checks if the RecoveryPlan type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlan{}
...
type _RecoveryPlan RecoveryPlan
...
func (o RecoveryPlan) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlan) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlan) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlan := _RecoveryPlan{}

	err = json.Unmarshal(data, &varRecoveryPlan)

	if err != nil {
		return err
	}

	*o = RecoveryPlan(varRecoveryPlan)
...
type NullableRecoveryPlan struct {
	value *RecoveryPlan
	isSet bool
}

func (v NullableRecoveryPlan) Get() *RecoveryPlan {
	return v.value
}

func (v *NullableRecoveryPlan) Set(val *RecoveryPlan) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlan) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlan(val *RecoveryPlan) *NullableRecoveryPlan {
	return &NullableRecoveryPlan{value: val, isSet: true}
}

func (v NullableRecoveryPlan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlan) UnmarshalJSON(src []byte) error {
	v.isSet = true
