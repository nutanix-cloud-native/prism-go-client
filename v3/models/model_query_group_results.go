...
// checks if the QueryGroupResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryGroupResults{}

// QueryGroupResults Query results
type QueryGroupResults struct {
	EntityResults []QueryGroupsEntity `json:"entity_results,omitempty"`
	TotalEntityCount *int64 `json:"total_entity_count,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QueryGroupResults QueryGroupResults
...
// SetEntityResults gets a reference to the given []QueryGroupsEntity and assigns it to the EntityResults field.
...
func (o QueryGroupResults) MarshalJSON() ([]byte, error) {
...
func (o QueryGroupResults) ToMap() (map[string]interface{}, error) {
...
func (o *QueryGroupResults) UnmarshalJSON(data []byte) (err error) {
	varQueryGroupResults := _QueryGroupResults{}

	err = json.Unmarshal(data, &varQueryGroupResults)

	if err != nil {
		return err
	}

	*o = QueryGroupResults(varQueryGroupResults)
...
type NullableQueryGroupResults struct {
	value *QueryGroupResults
	isSet bool
}

func (v NullableQueryGroupResults) Get() *QueryGroupResults {
	return v.value
}

func (v *NullableQueryGroupResults) Set(val *QueryGroupResults) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryGroupResults) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryGroupResults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryGroupResults(val *QueryGroupResults) *NullableQueryGroupResults {
	return &NullableQueryGroupResults{value: val, isSet: true}
}

func (v NullableQueryGroupResults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryGroupResults) UnmarshalJSON(src []byte) error {
	v.isSet = true
