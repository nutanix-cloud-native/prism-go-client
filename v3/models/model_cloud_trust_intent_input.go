...
// checks if the CloudTrustIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustIntentInput{}

// CloudTrustIntentInput An intentful representation of a cloud_trust
type CloudTrustIntentInput struct {
	Spec CloudTrust `json:"spec"`
...
type _CloudTrustIntentInput CloudTrustIntentInput
...
func (o CloudTrustIntentInput) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrustIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTrustIntentInput := _CloudTrustIntentInput{}

	err = json.Unmarshal(data, &varCloudTrustIntentInput)

	if err != nil {
		return err
	}

	*o = CloudTrustIntentInput(varCloudTrustIntentInput)
...
type NullableCloudTrustIntentInput struct {
	value *CloudTrustIntentInput
	isSet bool
}

func (v NullableCloudTrustIntentInput) Get() *CloudTrustIntentInput {
	return v.value
}

func (v *NullableCloudTrustIntentInput) Set(val *CloudTrustIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustIntentInput(val *CloudTrustIntentInput) *NullableCloudTrustIntentInput {
	return &NullableCloudTrustIntentInput{value: val, isSet: true}
}

func (v NullableCloudTrustIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
