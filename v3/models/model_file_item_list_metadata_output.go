...
// checks if the FileItemListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemListMetadataOutput{}

// FileItemListMetadataOutput All api calls that return a list will have this metadata block 
type FileItemListMetadataOutput struct {
	// The kind name
...
type _FileItemListMetadataOutput FileItemListMetadataOutput
...
func NewFileItemListMetadataOutput() *FileItemListMetadataOutput {
	this := FileItemListMetadataOutput{}
	var kind string = "file_item"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *FileItemListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o FileItemListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o FileItemListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *FileItemListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varFileItemListMetadataOutput := _FileItemListMetadataOutput{}

	err = json.Unmarshal(data, &varFileItemListMetadataOutput)

	if err != nil {
		return err
	}

	*o = FileItemListMetadataOutput(varFileItemListMetadataOutput)
...
type NullableFileItemListMetadataOutput struct {
	value *FileItemListMetadataOutput
	isSet bool
}

func (v NullableFileItemListMetadataOutput) Get() *FileItemListMetadataOutput {
	return v.value
}

func (v *NullableFileItemListMetadataOutput) Set(val *FileItemListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemListMetadataOutput(val *FileItemListMetadataOutput) *NullableFileItemListMetadataOutput {
	return &NullableFileItemListMetadataOutput{value: val, isSet: true}
}

func (v NullableFileItemListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
