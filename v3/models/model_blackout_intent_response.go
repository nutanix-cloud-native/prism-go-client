...
// checks if the BlackoutIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackoutIntentResponse{}

// BlackoutIntentResponse Response object for intentful operations on a blackout
type BlackoutIntentResponse struct {
	Status *BlackoutDefStatus `json:"status,omitempty"`
	Spec *Blackout `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata BlackoutMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _BlackoutIntentResponse BlackoutIntentResponse
...
// SetStatus gets a reference to the given BlackoutDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Blackout and assigns it to the Spec field.
...
func (o BlackoutIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o BlackoutIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BlackoutIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBlackoutIntentResponse := _BlackoutIntentResponse{}

	err = json.Unmarshal(data, &varBlackoutIntentResponse)

	if err != nil {
		return err
	}

	*o = BlackoutIntentResponse(varBlackoutIntentResponse)
...
type NullableBlackoutIntentResponse struct {
	value *BlackoutIntentResponse
	isSet bool
}

func (v NullableBlackoutIntentResponse) Get() *BlackoutIntentResponse {
	return v.value
}

func (v *NullableBlackoutIntentResponse) Set(val *BlackoutIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlackoutIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlackoutIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlackoutIntentResponse(val *BlackoutIntentResponse) *NullableBlackoutIntentResponse {
	return &NullableBlackoutIntentResponse{value: val, isSet: true}
}

func (v NullableBlackoutIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlackoutIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
