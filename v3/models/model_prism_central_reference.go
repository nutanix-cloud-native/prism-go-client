...
// checks if the PrismCentralReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralReference{}

// PrismCentralReference The reference to a prism_central
...
type _PrismCentralReference PrismCentralReference
...
func (o PrismCentralReference) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralReference) ToMap() (map[string]interface{}, error) {
...
func (o *PrismCentralReference) UnmarshalJSON(data []byte) (err error) {
	...
	varPrismCentralReference := _PrismCentralReference{}

	err = json.Unmarshal(data, &varPrismCentralReference)

	if err != nil {
		return err
	}

	*o = PrismCentralReference(varPrismCentralReference)
...
type NullablePrismCentralReference struct {
	value *PrismCentralReference
	isSet bool
}

func (v NullablePrismCentralReference) Get() *PrismCentralReference {
	return v.value
}

func (v *NullablePrismCentralReference) Set(val *PrismCentralReference) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralReference) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralReference(val *PrismCentralReference) *NullablePrismCentralReference {
	return &NullablePrismCentralReference{value: val, isSet: true}
}

func (v NullablePrismCentralReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
