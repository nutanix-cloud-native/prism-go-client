...
// checks if the CategoryMappingResourcesDefStatusAdMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingResourcesDefStatusAdMapping{}

// CategoryMappingResourcesDefStatusAdMapping A mapping to an object in Active Directory.
type CategoryMappingResourcesDefStatusAdMapping struct {
	// The objectGUID for the object in AD.
	ObjectIdentifier *string `json:"object_identifier,omitempty"`
	// The CN for the mapped object in AD.
	ObjectCommonName *string `json:"object_common_name,omitempty"`
	// Whether the mapping is usable or not; USABLE means it is usable. DELETED means the mapped object has been removed from AD, and DIRECTORY_NOT_CONFIGURED means either the directory service the mapping references has been removed or that directory service is not currently in use for identity categorization. 
...
type _CategoryMappingResourcesDefStatusAdMapping CategoryMappingResourcesDefStatusAdMapping
...
func NewCategoryMappingResourcesDefStatusAdMapping() *CategoryMappingResourcesDefStatusAdMapping {
	this := CategoryMappingResourcesDefStatusAdMapping{}
	return &this
}
...
// GetObjectIdentifier returns the ObjectIdentifier field value if set, zero value otherwise.
func (o *CategoryMappingResourcesDefStatusAdMapping) GetObjectIdentifier() string {
	if o == nil || IsNil(o.ObjectIdentifier) {
		var ret string
		return ret
	}
...
func (o *CategoryMappingResourcesDefStatusAdMapping) GetObjectIdentifierOk() (*string, bool) {
	...
	return o.ObjectIdentifier, true
}
...
// SetObjectIdentifier gets a reference to the given string and assigns it to the ObjectIdentifier field.
func (o *CategoryMappingResourcesDefStatusAdMapping) SetObjectIdentifier(v string) {
	o.ObjectIdentifier = &v
}

// GetObjectCommonName returns the ObjectCommonName field value if set, zero value otherwise.
func (o *CategoryMappingResourcesDefStatusAdMapping) GetObjectCommonName() string {
	if o == nil || IsNil(o.ObjectCommonName) {
		var ret string
		return ret
	}
	return *o.ObjectCommonName
}

// GetObjectCommonNameOk returns a tuple with the ObjectCommonName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CategoryMappingResourcesDefStatusAdMapping) GetObjectCommonNameOk() (*string, bool) {
	if o == nil || IsNil(o.ObjectCommonName) {
		return nil, false
	}
	return o.ObjectCommonName, true
}
...
// SetObjectCommonName gets a reference to the given string and assigns it to the ObjectCommonName field.
func (o *CategoryMappingResourcesDefStatusAdMapping) SetObjectCommonName(v string) {
	o.ObjectCommonName = &v
}
...
// GetDirectoryServiceReference returns the DirectoryServiceReference field value if set, zero value otherwise.
func (o *CategoryMappingResourcesDefStatusAdMapping) GetDirectoryServiceReference() DirectoryServiceReference {
	if o == nil || IsNil(o.DirectoryServiceReference) {
...
// GetDirectoryServiceReferenceOk returns a tuple with the DirectoryServiceReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetDirectoryServiceReference gets a reference to the given DirectoryServiceReference and assigns it to the DirectoryServiceReference field.
...
func (o CategoryMappingResourcesDefStatusAdMapping) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingResourcesDefStatusAdMapping) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ObjectIdentifier) {
		toSerialize["object_identifier"] = o.ObjectIdentifier
	}
	if !IsNil(o.ObjectCommonName) {
		toSerialize["object_common_name"] = o.ObjectCommonName
	}
	if !IsNil(o.Status) {
		toSerialize["status"] = o.Status
	}
	if !IsNil(o.DirectoryServiceReference) {
...
func (o *CategoryMappingResourcesDefStatusAdMapping) UnmarshalJSON(data []byte) (err error) {
	varCategoryMappingResourcesDefStatusAdMapping := _CategoryMappingResourcesDefStatusAdMapping{}

	err = json.Unmarshal(data, &varCategoryMappingResourcesDefStatusAdMapping)

	if err != nil {
		return err
	}

	*o = CategoryMappingResourcesDefStatusAdMapping(varCategoryMappingResourcesDefStatusAdMapping)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "object_identifier")
		delete(additionalProperties, "object_common_name")
		delete(additionalProperties, "status")
		delete(additionalProperties, "directory_service_reference")
		delete(additionalProperties, "object_path")
...
type NullableCategoryMappingResourcesDefStatusAdMapping struct {
	value *CategoryMappingResourcesDefStatusAdMapping
	isSet bool
}

func (v NullableCategoryMappingResourcesDefStatusAdMapping) Get() *CategoryMappingResourcesDefStatusAdMapping {
	return v.value
}

func (v *NullableCategoryMappingResourcesDefStatusAdMapping) Set(val *CategoryMappingResourcesDefStatusAdMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingResourcesDefStatusAdMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingResourcesDefStatusAdMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingResourcesDefStatusAdMapping(val *CategoryMappingResourcesDefStatusAdMapping) *NullableCategoryMappingResourcesDefStatusAdMapping {
	return &NullableCategoryMappingResourcesDefStatusAdMapping{value: val, isSet: true}
}

func (v NullableCategoryMappingResourcesDefStatusAdMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingResourcesDefStatusAdMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
