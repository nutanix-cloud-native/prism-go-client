...
// checks if the IpfixExporterIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpfixExporterIntentResponse{}

// IpfixExporterIntentResponse Response object for intentful operations on a ipfix_exporter
type IpfixExporterIntentResponse struct {
...
type _IpfixExporterIntentResponse IpfixExporterIntentResponse
...
func NewIpfixExporterIntentResponse(apiVersion string, metadata IpfixExporterMetadata) *IpfixExporterIntentResponse {
	this := IpfixExporterIntentResponse{}
...
func (o IpfixExporterIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o IpfixExporterIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *IpfixExporterIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varIpfixExporterIntentResponse := _IpfixExporterIntentResponse{}

	err = json.Unmarshal(data, &varIpfixExporterIntentResponse)

	if err != nil {
		return err
	}

	*o = IpfixExporterIntentResponse(varIpfixExporterIntentResponse)
...
type NullableIpfixExporterIntentResponse struct {
	value *IpfixExporterIntentResponse
	isSet bool
}

func (v NullableIpfixExporterIntentResponse) Get() *IpfixExporterIntentResponse {
	return v.value
}

func (v *NullableIpfixExporterIntentResponse) Set(val *IpfixExporterIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIpfixExporterIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIpfixExporterIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpfixExporterIntentResponse(val *IpfixExporterIntentResponse) *NullableIpfixExporterIntentResponse {
	return &NullableIpfixExporterIntentResponse{value: val, isSet: true}
}

func (v NullableIpfixExporterIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpfixExporterIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
