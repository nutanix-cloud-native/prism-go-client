...
// checks if the DirectConnectIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectIntentResource{}

// DirectConnectIntentResource Response object for intentful operations on a direct_connect
type DirectConnectIntentResource struct {
	Status *DirectConnectDefStatus `json:"status,omitempty"`
	Spec *DirectConnect `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata DirectConnectMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _DirectConnectIntentResource DirectConnectIntentResource
...
func NewDirectConnectIntentResource(metadata DirectConnectMetadata) *DirectConnectIntentResource {
	this := DirectConnectIntentResource{}
...
func (o *DirectConnectIntentResource) GetStatus() DirectConnectDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret DirectConnectDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given DirectConnectDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given DirectConnect and assigns it to the Spec field.
...
func (o DirectConnectIntentResource) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectIntentResource := _DirectConnectIntentResource{}

	err = json.Unmarshal(data, &varDirectConnectIntentResource)

	if err != nil {
		return err
	}

	*o = DirectConnectIntentResource(varDirectConnectIntentResource)
...
type NullableDirectConnectIntentResource struct {
	value *DirectConnectIntentResource
	isSet bool
}

func (v NullableDirectConnectIntentResource) Get() *DirectConnectIntentResource {
	return v.value
}

func (v *NullableDirectConnectIntentResource) Set(val *DirectConnectIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectIntentResource(val *DirectConnectIntentResource) *NullableDirectConnectIntentResource {
	return &NullableDirectConnectIntentResource{value: val, isSet: true}
}

func (v NullableDirectConnectIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
