...
// checks if the AppPackageElement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPackageElement{}

// AppPackageElement Package definition for Application
type AppPackageElement struct {
...
type _AppPackageElement AppPackageElement
...
func (o AppPackageElement) MarshalJSON() ([]byte, error) {
...
func (o AppPackageElement) ToMap() (map[string]interface{}, error) {
...
func (o *AppPackageElement) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPackageElement := _AppPackageElement{}

	err = json.Unmarshal(data, &varAppPackageElement)

	if err != nil {
		return err
	}

	*o = AppPackageElement(varAppPackageElement)
...
type NullableAppPackageElement struct {
	value *AppPackageElement
	isSet bool
}

func (v NullableAppPackageElement) Get() *AppPackageElement {
	return v.value
}

func (v *NullableAppPackageElement) Set(val *AppPackageElement) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPackageElement) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPackageElement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPackageElement(val *AppPackageElement) *NullableAppPackageElement {
	return &NullableAppPackageElement{value: val, isSet: true}
}

func (v NullableAppPackageElement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPackageElement) UnmarshalJSON(src []byte) error {
	v.isSet = true
