...
// checks if the RouteNexthopStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RouteNexthopStatus{}

// RouteNexthopStatus Targeted link being used as the nexthop in a route.
type RouteNexthopStatus struct {
	DirectConnectVirtualInterfaceReference *DirectConnectVirtualInterfaceReference `json:"direct_connect_virtual_interface_reference,omitempty"`
	ExternalSubnetReference *SubnetReference `json:"external_subnet_reference,omitempty"`
	// Nexthop IP address of this route.
	NexthopIpAddress *string `json:"nexthop_ip_address,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	LocalSubnetReference *SubnetReference `json:"local_subnet_reference,omitempty"`
	VpnConnectionReference *VpnConnectionReference `json:"vpn_connection_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RouteNexthopStatus RouteNexthopStatus
...
// GetDirectConnectVirtualInterfaceReference returns the DirectConnectVirtualInterfaceReference field value if set, zero value otherwise.
func (o *RouteNexthopStatus) GetDirectConnectVirtualInterfaceReference() DirectConnectVirtualInterfaceReference {
	if o == nil || IsNil(o.DirectConnectVirtualInterfaceReference) {
		var ret DirectConnectVirtualInterfaceReference
		return ret
	}
	return *o.DirectConnectVirtualInterfaceReference
}

// GetDirectConnectVirtualInterfaceReferenceOk returns a tuple with the DirectConnectVirtualInterfaceReference field value if set, nil otherwise
...
func (o *RouteNexthopStatus) GetDirectConnectVirtualInterfaceReferenceOk() (*DirectConnectVirtualInterfaceReference, bool) {
	...
	return o.DirectConnectVirtualInterfaceReference, true
}
...
// SetDirectConnectVirtualInterfaceReference gets a reference to the given DirectConnectVirtualInterfaceReference and assigns it to the DirectConnectVirtualInterfaceReference field.
func (o *RouteNexthopStatus) SetDirectConnectVirtualInterfaceReference(v DirectConnectVirtualInterfaceReference) {
	o.DirectConnectVirtualInterfaceReference = &v
}

// GetExternalSubnetReference returns the ExternalSubnetReference field value if set, zero value otherwise.
func (o *RouteNexthopStatus) GetExternalSubnetReference() SubnetReference {
	if o == nil || IsNil(o.ExternalSubnetReference) {
		var ret SubnetReference
		return ret
	}
	return *o.ExternalSubnetReference
}

// GetExternalSubnetReferenceOk returns a tuple with the ExternalSubnetReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RouteNexthopStatus) GetExternalSubnetReferenceOk() (*SubnetReference, bool) {
	if o == nil || IsNil(o.ExternalSubnetReference) {
		return nil, false
	}
	return o.ExternalSubnetReference, true
}
...
// SetExternalSubnetReference gets a reference to the given SubnetReference and assigns it to the ExternalSubnetReference field.
func (o *RouteNexthopStatus) SetExternalSubnetReference(v SubnetReference) {
	o.ExternalSubnetReference = &v
}
...
// GetLocalSubnetReference returns the LocalSubnetReference field value if set, zero value otherwise.
func (o *RouteNexthopStatus) GetLocalSubnetReference() SubnetReference {
	if o == nil || IsNil(o.LocalSubnetReference) {
		var ret SubnetReference
		return ret
	}
	return *o.LocalSubnetReference
}

// GetLocalSubnetReferenceOk returns a tuple with the LocalSubnetReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RouteNexthopStatus) GetLocalSubnetReferenceOk() (*SubnetReference, bool) {
	if o == nil || IsNil(o.LocalSubnetReference) {
		return nil, false
	}
	return o.LocalSubnetReference, true
}
...
// SetLocalSubnetReference gets a reference to the given SubnetReference and assigns it to the LocalSubnetReference field.
func (o *RouteNexthopStatus) SetLocalSubnetReference(v SubnetReference) {
	o.LocalSubnetReference = &v
}
...
func (o RouteNexthopStatus) MarshalJSON() ([]byte, error) {
...
func (o RouteNexthopStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DirectConnectVirtualInterfaceReference) {
		toSerialize["direct_connect_virtual_interface_reference"] = o.DirectConnectVirtualInterfaceReference
	}
	if !IsNil(o.ExternalSubnetReference) {
		toSerialize["external_subnet_reference"] = o.ExternalSubnetReference
	}
	if !IsNil(o.NexthopIpAddress) {
		toSerialize["nexthop_ip_address"] = o.NexthopIpAddress
	}
	if !IsNil(o.LocalSubnetReference) {
		toSerialize["local_subnet_reference"] = o.LocalSubnetReference
	}
...
func (o *RouteNexthopStatus) UnmarshalJSON(data []byte) (err error) {
	varRouteNexthopStatus := _RouteNexthopStatus{}

	err = json.Unmarshal(data, &varRouteNexthopStatus)

	if err != nil {
		return err
	}

	*o = RouteNexthopStatus(varRouteNexthopStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "direct_connect_virtual_interface_reference")
		delete(additionalProperties, "external_subnet_reference")
		delete(additionalProperties, "nexthop_ip_address")
		delete(additionalProperties, "local_subnet_reference")
...
type NullableRouteNexthopStatus struct {
	value *RouteNexthopStatus
	isSet bool
}

func (v NullableRouteNexthopStatus) Get() *RouteNexthopStatus {
	return v.value
}

func (v *NullableRouteNexthopStatus) Set(val *RouteNexthopStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRouteNexthopStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRouteNexthopStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRouteNexthopStatus(val *RouteNexthopStatus) *NullableRouteNexthopStatus {
	return &NullableRouteNexthopStatus{value: val, isSet: true}
}

func (v NullableRouteNexthopStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRouteNexthopStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
