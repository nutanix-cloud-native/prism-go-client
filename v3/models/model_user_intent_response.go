...
// checks if the UserIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserIntentResponse{}
...
type _UserIntentResponse UserIntentResponse
...
func (o UserIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o UserIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *UserIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUserIntentResponse := _UserIntentResponse{}

	err = json.Unmarshal(data, &varUserIntentResponse)

	if err != nil {
		return err
	}

	*o = UserIntentResponse(varUserIntentResponse)
...
type NullableUserIntentResponse struct {
	value *UserIntentResponse
	isSet bool
}

func (v NullableUserIntentResponse) Get() *UserIntentResponse {
	return v.value
}

func (v *NullableUserIntentResponse) Set(val *UserIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUserIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUserIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserIntentResponse(val *UserIntentResponse) *NullableUserIntentResponse {
	return &NullableUserIntentResponse{value: val, isSet: true}
}

func (v NullableUserIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
