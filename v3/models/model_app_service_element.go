...
// checks if the AppServiceElement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppServiceElement{}

// AppServiceElement Service definition for Application
type AppServiceElement struct {
...
type _AppServiceElement AppServiceElement
...
func (o AppServiceElement) MarshalJSON() ([]byte, error) {
...
func (o AppServiceElement) ToMap() (map[string]interface{}, error) {
...
func (o *AppServiceElement) UnmarshalJSON(data []byte) (err error) {
	...
	varAppServiceElement := _AppServiceElement{}

	err = json.Unmarshal(data, &varAppServiceElement)

	if err != nil {
		return err
	}

	*o = AppServiceElement(varAppServiceElement)
...
type NullableAppServiceElement struct {
	value *AppServiceElement
	isSet bool
}

func (v NullableAppServiceElement) Get() *AppServiceElement {
	return v.value
}

func (v *NullableAppServiceElement) Set(val *AppServiceElement) {
	v.value = val
	v.isSet = true
}

func (v NullableAppServiceElement) IsSet() bool {
	return v.isSet
}

func (v *NullableAppServiceElement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppServiceElement(val *AppServiceElement) *NullableAppServiceElement {
	return &NullableAppServiceElement{value: val, isSet: true}
}

func (v NullableAppServiceElement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppServiceElement) UnmarshalJSON(src []byte) error {
	v.isSet = true
