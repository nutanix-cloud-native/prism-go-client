...
// checks if the AwsRegionListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRegionListMetadata{}

// AwsRegionListMetadata All api calls that return a list will have this metadata block as input 
type AwsRegionListMetadata struct {
	// The kind name
...
type _AwsRegionListMetadata AwsRegionListMetadata
...
func (o AwsRegionListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsRegionListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRegionListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsRegionListMetadata := _AwsRegionListMetadata{}

	err = json.Unmarshal(data, &varAwsRegionListMetadata)

	if err != nil {
		return err
	}

	*o = AwsRegionListMetadata(varAwsRegionListMetadata)
...
type NullableAwsRegionListMetadata struct {
	value *AwsRegionListMetadata
	isSet bool
}

func (v NullableAwsRegionListMetadata) Get() *AwsRegionListMetadata {
	return v.value
}

func (v *NullableAwsRegionListMetadata) Set(val *AwsRegionListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRegionListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRegionListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRegionListMetadata(val *AwsRegionListMetadata) *NullableAwsRegionListMetadata {
	return &NullableAwsRegionListMetadata{value: val, isSet: true}
}

func (v NullableAwsRegionListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRegionListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
