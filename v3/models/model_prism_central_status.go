...
// checks if the PrismCentralStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralStatus{}

// PrismCentralStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _PrismCentralStatus PrismCentralStatus
...
func (o PrismCentralStatus) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralStatus) ToMap() (map[string]interface{}, error) {
...
func (o *PrismCentralStatus) UnmarshalJSON(data []byte) (err error) {
	varPrismCentralStatus := _PrismCentralStatus{}

	err = json.Unmarshal(data, &varPrismCentralStatus)

	if err != nil {
		return err
	}

	*o = PrismCentralStatus(varPrismCentralStatus)
...
type NullablePrismCentralStatus struct {
	value *PrismCentralStatus
	isSet bool
}

func (v NullablePrismCentralStatus) Get() *PrismCentralStatus {
	return v.value
}

func (v *NullablePrismCentralStatus) Set(val *PrismCentralStatus) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralStatus) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralStatus(val *PrismCentralStatus) *NullablePrismCentralStatus {
	return &NullablePrismCentralStatus{value: val, isSet: true}
}

func (v NullablePrismCentralStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
