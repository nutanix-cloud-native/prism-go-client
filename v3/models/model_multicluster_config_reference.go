...
// checks if the MulticlusterConfigReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MulticlusterConfigReference{}

// MulticlusterConfigReference The reference to a multicluster_config
type MulticlusterConfigReference struct {
	// The kind name
...
type _MulticlusterConfigReference MulticlusterConfigReference
...
func NewMulticlusterConfigReference(kind string, uUID string) *MulticlusterConfigReference {
	this := MulticlusterConfigReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o MulticlusterConfigReference) MarshalJSON() ([]byte, error) {
...
func (o MulticlusterConfigReference) ToMap() (map[string]interface{}, error) {
...
func (o *MulticlusterConfigReference) UnmarshalJSON(data []byte) (err error) {
	...
	varMulticlusterConfigReference := _MulticlusterConfigReference{}

	err = json.Unmarshal(data, &varMulticlusterConfigReference)

	if err != nil {
		return err
	}

	*o = MulticlusterConfigReference(varMulticlusterConfigReference)
...
type NullableMulticlusterConfigReference struct {
	value *MulticlusterConfigReference
	isSet bool
}

func (v NullableMulticlusterConfigReference) Get() *MulticlusterConfigReference {
	return v.value
}

func (v *NullableMulticlusterConfigReference) Set(val *MulticlusterConfigReference) {
	v.value = val
	v.isSet = true
}

func (v NullableMulticlusterConfigReference) IsSet() bool {
	return v.isSet
}

func (v *NullableMulticlusterConfigReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMulticlusterConfigReference(val *MulticlusterConfigReference) *NullableMulticlusterConfigReference {
	return &NullableMulticlusterConfigReference{value: val, isSet: true}
}

func (v NullableMulticlusterConfigReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMulticlusterConfigReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
