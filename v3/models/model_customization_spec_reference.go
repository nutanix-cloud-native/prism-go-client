...
// checks if the CustomizationSpecReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomizationSpecReference{}

// CustomizationSpecReference The reference to a customization_spec
type CustomizationSpecReference struct {
	// The kind name
...
type _CustomizationSpecReference CustomizationSpecReference
...
func NewCustomizationSpecReference(kind string, uUID string) *CustomizationSpecReference {
	this := CustomizationSpecReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o CustomizationSpecReference) MarshalJSON() ([]byte, error) {
...
func (o CustomizationSpecReference) ToMap() (map[string]interface{}, error) {
...
func (o *CustomizationSpecReference) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomizationSpecReference := _CustomizationSpecReference{}

	err = json.Unmarshal(data, &varCustomizationSpecReference)

	if err != nil {
		return err
	}

	*o = CustomizationSpecReference(varCustomizationSpecReference)
...
type NullableCustomizationSpecReference struct {
	value *CustomizationSpecReference
	isSet bool
}

func (v NullableCustomizationSpecReference) Get() *CustomizationSpecReference {
	return v.value
}

func (v *NullableCustomizationSpecReference) Set(val *CustomizationSpecReference) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomizationSpecReference) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomizationSpecReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomizationSpecReference(val *CustomizationSpecReference) *NullableCustomizationSpecReference {
	return &NullableCustomizationSpecReference{value: val, isSet: true}
}

func (v NullableCustomizationSpecReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomizationSpecReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
