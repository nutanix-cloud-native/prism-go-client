...
// checks if the CategoryQueryInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryQueryInput{}

// CategoryQueryInput Categories query input object.
...
type _CategoryQueryInput CategoryQueryInput
...
func (o CategoryQueryInput) MarshalJSON() ([]byte, error) {
...
func (o CategoryQueryInput) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryQueryInput) UnmarshalJSON(data []byte) (err error) {
	varCategoryQueryInput := _CategoryQueryInput{}

	err = json.Unmarshal(data, &varCategoryQueryInput)

	if err != nil {
		return err
	}

	*o = CategoryQueryInput(varCategoryQueryInput)
...
type NullableCategoryQueryInput struct {
	value *CategoryQueryInput
	isSet bool
}

func (v NullableCategoryQueryInput) Get() *CategoryQueryInput {
	return v.value
}

func (v *NullableCategoryQueryInput) Set(val *CategoryQueryInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryQueryInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryQueryInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryQueryInput(val *CategoryQueryInput) *NullableCategoryQueryInput {
	return &NullableCategoryQueryInput{value: val, isSet: true}
}

func (v NullableCategoryQueryInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryQueryInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
