...
// checks if the NusightsProxyMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NusightsProxyMetadata{}

// NusightsProxyMetadata The nusights_proxy kind metadata
type NusightsProxyMetadata struct {
	...
	// Categories for the nusights_proxy. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the nusights_proxy. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _NusightsProxyMetadata NusightsProxyMetadata
...
func (o NusightsProxyMetadata) MarshalJSON() ([]byte, error) {
...
func (o NusightsProxyMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NusightsProxyMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varNusightsProxyMetadata := _NusightsProxyMetadata{}

	err = json.Unmarshal(data, &varNusightsProxyMetadata)

	if err != nil {
		return err
	}

	*o = NusightsProxyMetadata(varNusightsProxyMetadata)
...
type NullableNusightsProxyMetadata struct {
	value *NusightsProxyMetadata
	isSet bool
}

func (v NullableNusightsProxyMetadata) Get() *NusightsProxyMetadata {
	return v.value
}

func (v *NullableNusightsProxyMetadata) Set(val *NusightsProxyMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNusightsProxyMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNusightsProxyMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNusightsProxyMetadata(val *NusightsProxyMetadata) *NullableNusightsProxyMetadata {
	return &NullableNusightsProxyMetadata{value: val, isSet: true}
}

func (v NullableNusightsProxyMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNusightsProxyMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
