...
// checks if the AwsBlockDeviceMap type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsBlockDeviceMap{}

// AwsBlockDeviceMap Describes the EBS Volumes associated.
type AwsBlockDeviceMap struct {
	// Data disks of the instance.
	DataDiskList []AwsInstanceDisk `json:"data_disk_list,omitempty"`
	RootDisk *AwsInstanceDisk `json:"root_disk,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsBlockDeviceMap AwsBlockDeviceMap
...
// GetDataDiskList returns the DataDiskList field value if set, zero value otherwise.
func (o *AwsBlockDeviceMap) GetDataDiskList() []AwsInstanceDisk {
	if o == nil || IsNil(o.DataDiskList) {
		var ret []AwsInstanceDisk
		return ret
	}
	return o.DataDiskList
}

// GetDataDiskListOk returns a tuple with the DataDiskList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AwsBlockDeviceMap) GetDataDiskListOk() ([]AwsInstanceDisk, bool) {
	if o == nil || IsNil(o.DataDiskList) {
		return nil, false
	}
	return o.DataDiskList, true
}
...
// SetDataDiskList gets a reference to the given []AwsInstanceDisk and assigns it to the DataDiskList field.
...
// SetRootDisk gets a reference to the given AwsInstanceDisk and assigns it to the RootDisk field.
func (o *AwsBlockDeviceMap) SetRootDisk(v AwsInstanceDisk) {
	o.RootDisk = &v
}

func (o AwsBlockDeviceMap) MarshalJSON() ([]byte, error) {
...
func (o AwsBlockDeviceMap) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DataDiskList) {
		toSerialize["data_disk_list"] = o.DataDiskList
	}
	if !IsNil(o.RootDisk) {
...
func (o *AwsBlockDeviceMap) UnmarshalJSON(data []byte) (err error) {
	varAwsBlockDeviceMap := _AwsBlockDeviceMap{}

	err = json.Unmarshal(data, &varAwsBlockDeviceMap)

	if err != nil {
		return err
	}

	*o = AwsBlockDeviceMap(varAwsBlockDeviceMap)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "data_disk_list")
		delete(additionalProperties, "root_disk")
...
type NullableAwsBlockDeviceMap struct {
	value *AwsBlockDeviceMap
	isSet bool
}

func (v NullableAwsBlockDeviceMap) Get() *AwsBlockDeviceMap {
	return v.value
}

func (v *NullableAwsBlockDeviceMap) Set(val *AwsBlockDeviceMap) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsBlockDeviceMap) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsBlockDeviceMap) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsBlockDeviceMap(val *AwsBlockDeviceMap) *NullableAwsBlockDeviceMap {
	return &NullableAwsBlockDeviceMap{value: val, isSet: true}
}

func (v NullableAwsBlockDeviceMap) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsBlockDeviceMap) UnmarshalJSON(src []byte) error {
	v.isSet = true
