...
// checks if the AwsVpcIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVpcIntentResource{}

// AwsVpcIntentResource aws_vpc entity
type AwsVpcIntentResource struct {
	Status *AwsVpcDefStatus `json:"status,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsVpcMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsVpcIntentResource AwsVpcIntentResource
...
// SetStatus gets a reference to the given AwsVpcDefStatus and assigns it to the Status field.
...
func (o AwsVpcIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsVpcIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVpcIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVpcIntentResource := _AwsVpcIntentResource{}

	err = json.Unmarshal(data, &varAwsVpcIntentResource)

	if err != nil {
		return err
	}

	*o = AwsVpcIntentResource(varAwsVpcIntentResource)
...
type NullableAwsVpcIntentResource struct {
	value *AwsVpcIntentResource
	isSet bool
}

func (v NullableAwsVpcIntentResource) Get() *AwsVpcIntentResource {
	return v.value
}

func (v *NullableAwsVpcIntentResource) Set(val *AwsVpcIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVpcIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVpcIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVpcIntentResource(val *AwsVpcIntentResource) *NullableAwsVpcIntentResource {
	return &NullableAwsVpcIntentResource{value: val, isSet: true}
}

func (v NullableAwsVpcIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVpcIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
