...
// checks if the BrownfieldInstanceInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BrownfieldInstanceInput{}

// BrownfieldInstanceInput Brownfield instance list
type BrownfieldInstanceInput struct {
	// Id of the vm
...
type _BrownfieldInstanceInput BrownfieldInstanceInput
...
// SetPlatformData gets a reference to the given map[string]string and assigns it to the PlatformData field.
...
func (o BrownfieldInstanceInput) MarshalJSON() ([]byte, error) {
...
func (o BrownfieldInstanceInput) ToMap() (map[string]interface{}, error) {
...
func (o *BrownfieldInstanceInput) UnmarshalJSON(data []byte) (err error) {
	...
	varBrownfieldInstanceInput := _BrownfieldInstanceInput{}

	err = json.Unmarshal(data, &varBrownfieldInstanceInput)

	if err != nil {
		return err
	}

	*o = BrownfieldInstanceInput(varBrownfieldInstanceInput)
...
type NullableBrownfieldInstanceInput struct {
	value *BrownfieldInstanceInput
	isSet bool
}

func (v NullableBrownfieldInstanceInput) Get() *BrownfieldInstanceInput {
	return v.value
}

func (v *NullableBrownfieldInstanceInput) Set(val *BrownfieldInstanceInput) {
	v.value = val
	v.isSet = true
}

func (v NullableBrownfieldInstanceInput) IsSet() bool {
	return v.isSet
}

func (v *NullableBrownfieldInstanceInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrownfieldInstanceInput(val *BrownfieldInstanceInput) *NullableBrownfieldInstanceInput {
	return &NullableBrownfieldInstanceInput{value: val, isSet: true}
}

func (v NullableBrownfieldInstanceInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBrownfieldInstanceInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
