...
// checks if the RemoteSyslogModuleStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogModuleStatus{}

// RemoteSyslogModuleStatus The status of a REST API call. Only used when there is a failure to report. 
type RemoteSyslogModuleStatus struct {
	// The kind name
...
type _RemoteSyslogModuleStatus RemoteSyslogModuleStatus
...
func (o RemoteSyslogModuleStatus) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogModuleStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogModuleStatus) UnmarshalJSON(data []byte) (err error) {
	varRemoteSyslogModuleStatus := _RemoteSyslogModuleStatus{}

	err = json.Unmarshal(data, &varRemoteSyslogModuleStatus)

	if err != nil {
		return err
	}

	*o = RemoteSyslogModuleStatus(varRemoteSyslogModuleStatus)
...
type NullableRemoteSyslogModuleStatus struct {
	value *RemoteSyslogModuleStatus
	isSet bool
}

func (v NullableRemoteSyslogModuleStatus) Get() *RemoteSyslogModuleStatus {
	return v.value
}

func (v *NullableRemoteSyslogModuleStatus) Set(val *RemoteSyslogModuleStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogModuleStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogModuleStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogModuleStatus(val *RemoteSyslogModuleStatus) *NullableRemoteSyslogModuleStatus {
	return &NullableRemoteSyslogModuleStatus{value: val, isSet: true}
}

func (v NullableRemoteSyslogModuleStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogModuleStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
