...
// checks if the ActionTriggerTypeIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTriggerTypeIntentResponse{}

// ActionTriggerTypeIntentResponse Response object for intentful operations on a action_trigger_type
type ActionTriggerTypeIntentResponse struct {
...
type _ActionTriggerTypeIntentResponse ActionTriggerTypeIntentResponse
...
func NewActionTriggerTypeIntentResponse(apiVersion string, metadata ActionTriggerTypeMetadata) *ActionTriggerTypeIntentResponse {
	this := ActionTriggerTypeIntentResponse{}
...
func (o ActionTriggerTypeIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ActionTriggerTypeIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTriggerTypeIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTriggerTypeIntentResponse := _ActionTriggerTypeIntentResponse{}

	err = json.Unmarshal(data, &varActionTriggerTypeIntentResponse)

	if err != nil {
		return err
	}

	*o = ActionTriggerTypeIntentResponse(varActionTriggerTypeIntentResponse)
...
type NullableActionTriggerTypeIntentResponse struct {
	value *ActionTriggerTypeIntentResponse
	isSet bool
}

func (v NullableActionTriggerTypeIntentResponse) Get() *ActionTriggerTypeIntentResponse {
	return v.value
}

func (v *NullableActionTriggerTypeIntentResponse) Set(val *ActionTriggerTypeIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTriggerTypeIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTriggerTypeIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTriggerTypeIntentResponse(val *ActionTriggerTypeIntentResponse) *NullableActionTriggerTypeIntentResponse {
	return &NullableActionTriggerTypeIntentResponse{value: val, isSet: true}
}

func (v NullableActionTriggerTypeIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTriggerTypeIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
