...
// checks if the QosConfigStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QosConfigStatus{}

// QosConfigStatus Quality of Service configuration for the VPN IPSec tunnel.
type QosConfigStatus struct {
	// Ingress traffic limit. (In Mbits/s)
	IngressLimit *int32 `json:"ingress_limit,omitempty"`
	// Egress traffic limit. (In Mbits/s)
	EgressLimit *int32 `json:"egress_limit,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QosConfigStatus QosConfigStatus
...
func (o QosConfigStatus) MarshalJSON() ([]byte, error) {
...
func (o QosConfigStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IngressLimit) {
		toSerialize["ingress_limit"] = o.IngressLimit
	}
	if !IsNil(o.EgressLimit) {
		toSerialize["egress_limit"] = o.EgressLimit
	}
...
func (o *QosConfigStatus) UnmarshalJSON(data []byte) (err error) {
	varQosConfigStatus := _QosConfigStatus{}

	err = json.Unmarshal(data, &varQosConfigStatus)

	if err != nil {
		return err
	}

	*o = QosConfigStatus(varQosConfigStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "ingress_limit")
		delete(additionalProperties, "egress_limit")
...
type NullableQosConfigStatus struct {
	value *QosConfigStatus
	isSet bool
}

func (v NullableQosConfigStatus) Get() *QosConfigStatus {
	return v.value
}

func (v *NullableQosConfigStatus) Set(val *QosConfigStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableQosConfigStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableQosConfigStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQosConfigStatus(val *QosConfigStatus) *NullableQosConfigStatus {
	return &NullableQosConfigStatus{value: val, isSet: true}
}

func (v NullableQosConfigStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQosConfigStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
