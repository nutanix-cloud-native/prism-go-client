...
// checks if the SelectionCriteria type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelectionCriteria{}

// SelectionCriteria Entity selection criteria for category assignment definition.
type SelectionCriteria struct {
	ExpressionList []FilterExpression `json:"expression_list"`
	// Entity type which has to be selected
	EntityType string `json:"entity_type"`
	AdditionalProperties map[string]interface{}
}

type _SelectionCriteria SelectionCriteria
...
// GetExpressionList returns the ExpressionList field value
...
// GetExpressionListOk returns a tuple with the ExpressionList field value
...
// SetExpressionList sets field value
...
func (o SelectionCriteria) ToMap() (map[string]interface{}, error) {
...
func (o *SelectionCriteria) UnmarshalJSON(data []byte) (err error) {
	...
	varSelectionCriteria := _SelectionCriteria{}

	err = json.Unmarshal(data, &varSelectionCriteria)

	if err != nil {
		return err
	}

	*o = SelectionCriteria(varSelectionCriteria)
