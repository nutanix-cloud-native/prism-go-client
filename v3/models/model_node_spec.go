...
// NodeSpec node_spec Object.
type NodeSpec struct {
	RecommendedOnlineTimestampSecs *int32 `json:"recommended_online_timestamp_secs,omitempty"`
	// Indicate if the node is set for removal.
	ToRemoved *bool `json:"to_removed,omitempty"`
	Model *string `json:"model,omitempty"`
	ResourceSpec *GenericResourceSpec `json:"resource_spec,omitempty"`
	NumOfNodes *int32 `json:"num_of_nodes,omitempty"`
...
// GetRecommendedOnlineTimestampSecs returns the RecommendedOnlineTimestampSecs field value if set, zero value otherwise.
func (o *NodeSpec) GetRecommendedOnlineTimestampSecs() int32 {
	if o == nil || IsNil(o.RecommendedOnlineTimestampSecs) {
		var ret int32
		return ret
	}
	return *o.RecommendedOnlineTimestampSecs
}

// GetRecommendedOnlineTimestampSecsOk returns a tuple with the RecommendedOnlineTimestampSecs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NodeSpec) GetRecommendedOnlineTimestampSecsOk() (*int32, bool) {
	if o == nil || IsNil(o.RecommendedOnlineTimestampSecs) {
		return nil, false
	}
	return o.RecommendedOnlineTimestampSecs, true
}
...
// SetRecommendedOnlineTimestampSecs gets a reference to the given int32 and assigns it to the RecommendedOnlineTimestampSecs field.
func (o *NodeSpec) SetRecommendedOnlineTimestampSecs(v int32) {
	o.RecommendedOnlineTimestampSecs = &v
}

// GetToRemoved returns the ToRemoved field value if set, zero value otherwise.
func (o *NodeSpec) GetToRemoved() bool {
	if o == nil || IsNil(o.ToRemoved) {
		var ret bool
		return ret
	}
	return *o.ToRemoved
...
// GetToRemovedOk returns a tuple with the ToRemoved field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NodeSpec) GetToRemovedOk() (*bool, bool) {
	if o == nil || IsNil(o.ToRemoved) {
		return nil, false
	}
	return o.ToRemoved, true
}
...
// SetToRemoved gets a reference to the given bool and assigns it to the ToRemoved field.
...
// SetResourceSpec gets a reference to the given GenericResourceSpec and assigns it to the ResourceSpec field.
func (o *NodeSpec) SetResourceSpec(v GenericResourceSpec) {
	o.ResourceSpec = &v
}

// GetNumOfNodes returns the NumOfNodes field value if set, zero value otherwise.
func (o *NodeSpec) GetNumOfNodes() int32 {
	if o == nil || IsNil(o.NumOfNodes) {
		var ret int32
		return ret
	}
	return *o.NumOfNodes
...
// GetNumOfNodesOk returns a tuple with the NumOfNodes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NodeSpec) GetNumOfNodesOk() (*int32, bool) {
	if o == nil || IsNil(o.NumOfNodes) {
		return nil, false
	}
	return o.NumOfNodes, true
}
...
// SetNumOfNodes gets a reference to the given int32 and assigns it to the NumOfNodes field.
...
func (o NodeSpec) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RecommendedOnlineTimestampSecs) {
		toSerialize["recommended_online_timestamp_secs"] = o.RecommendedOnlineTimestampSecs
	}
	if !IsNil(o.ToRemoved) {
		toSerialize["to_removed"] = o.ToRemoved
	}
	if !IsNil(o.Model) {
	...
	if !IsNil(o.NumOfNodes) {
		toSerialize["num_of_nodes"] = o.NumOfNodes
	}
...
func (o *NodeSpec) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNodeSpec)
	...
	*o = NodeSpec(varNodeSpec)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "recommended_online_timestamp_secs")
		delete(additionalProperties, "to_removed")
		delete(additionalProperties, "model")
		delete(additionalProperties, "resource_spec")
		delete(additionalProperties, "num_of_nodes")
