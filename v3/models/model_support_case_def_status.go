...
// checks if the SupportCaseDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseDefStatus{}

// SupportCaseDefStatus Support Case creation/modification spec.
type SupportCaseDefStatus struct {
	// The state of the support case entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	// Description of the support case.
	Description *string `json:"description,omitempty"`
	Resources SupportCaseResponse `json:"resources"`
	// Subject of the support case.
	Subject string `json:"subject"`
	AdditionalProperties map[string]interface{}
}

type _SupportCaseDefStatus SupportCaseDefStatus
...
func (o SupportCaseDefStatus) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseDefStatus := _SupportCaseDefStatus{}

	err = json.Unmarshal(data, &varSupportCaseDefStatus)

	if err != nil {
		return err
	}

	*o = SupportCaseDefStatus(varSupportCaseDefStatus)
...
type NullableSupportCaseDefStatus struct {
	value *SupportCaseDefStatus
	isSet bool
}

func (v NullableSupportCaseDefStatus) Get() *SupportCaseDefStatus {
	return v.value
}

func (v *NullableSupportCaseDefStatus) Set(val *SupportCaseDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseDefStatus(val *SupportCaseDefStatus) *NullableSupportCaseDefStatus {
	return &NullableSupportCaseDefStatus{value: val, isSet: true}
}

func (v NullableSupportCaseDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
