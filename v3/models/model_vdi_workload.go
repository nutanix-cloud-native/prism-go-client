...
// checks if the VdiWorkload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VdiWorkload{}

// VdiWorkload VDI workload Object.
type VdiWorkload struct {
	NumUsers *int32 `json:"num_users,omitempty"`
	VdiVendor *string `json:"vdi_vendor,omitempty"`
	UserType *string `json:"user_type,omitempty"`
	ProvisioningType *string `json:"provisioning_type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VdiWorkload VdiWorkload
...
// GetVdiVendor returns the VdiVendor field value if set, zero value otherwise.
func (o *VdiWorkload) GetVdiVendor() string {
	if o == nil || IsNil(o.VdiVendor) {
		var ret string
		return ret
	}
	return *o.VdiVendor
...
// GetVdiVendorOk returns a tuple with the VdiVendor field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VdiWorkload) GetVdiVendorOk() (*string, bool) {
	if o == nil || IsNil(o.VdiVendor) {
		return nil, false
	}
	return o.VdiVendor, true
}
...
// SetVdiVendor gets a reference to the given string and assigns it to the VdiVendor field.
...
// SetProvisioningType gets a reference to the given string and assigns it to the ProvisioningType field.
func (o *VdiWorkload) SetProvisioningType(v string) {
	o.ProvisioningType = &v
}

func (o VdiWorkload) MarshalJSON() ([]byte, error) {
...
func (o VdiWorkload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.NumUsers) {
		toSerialize["num_users"] = o.NumUsers
	}
	if !IsNil(o.VdiVendor) {
		toSerialize["vdi_vendor"] = o.VdiVendor
	}
	if !IsNil(o.UserType) {
		toSerialize["user_type"] = o.UserType
	}
	if !IsNil(o.ProvisioningType) {
		toSerialize["provisioning_type"] = o.ProvisioningType
	}
...
func (o *VdiWorkload) UnmarshalJSON(data []byte) (err error) {
	varVdiWorkload := _VdiWorkload{}

	err = json.Unmarshal(data, &varVdiWorkload)

	if err != nil {
		return err
	}

	*o = VdiWorkload(varVdiWorkload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "num_users")
		delete(additionalProperties, "vdi_vendor")
		delete(additionalProperties, "user_type")
		delete(additionalProperties, "provisioning_type")
...
type NullableVdiWorkload struct {
	value *VdiWorkload
	isSet bool
}

func (v NullableVdiWorkload) Get() *VdiWorkload {
	return v.value
}

func (v *NullableVdiWorkload) Set(val *VdiWorkload) {
	v.value = val
	v.isSet = true
}

func (v NullableVdiWorkload) IsSet() bool {
	return v.isSet
}

func (v *NullableVdiWorkload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVdiWorkload(val *VdiWorkload) *NullableVdiWorkload {
	return &NullableVdiWorkload{value: val, isSet: true}
}

func (v NullableVdiWorkload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVdiWorkload) UnmarshalJSON(src []byte) error {
	v.isSet = true
