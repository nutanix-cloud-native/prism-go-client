...
// checks if the CategoryListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryListMetadataOutput{}

// CategoryListMetadataOutput All api calls that return a list will have this metadata block 
type CategoryListMetadataOutput struct {
	// The kind name
...
type _CategoryListMetadataOutput CategoryListMetadataOutput
...
func NewCategoryListMetadataOutput() *CategoryListMetadataOutput {
	this := CategoryListMetadataOutput{}
...
func (o CategoryListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o CategoryListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varCategoryListMetadataOutput := _CategoryListMetadataOutput{}

	err = json.Unmarshal(data, &varCategoryListMetadataOutput)

	if err != nil {
		return err
	}

	*o = CategoryListMetadataOutput(varCategoryListMetadataOutput)
...
type NullableCategoryListMetadataOutput struct {
	value *CategoryListMetadataOutput
	isSet bool
}

func (v NullableCategoryListMetadataOutput) Get() *CategoryListMetadataOutput {
	return v.value
}

func (v *NullableCategoryListMetadataOutput) Set(val *CategoryListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryListMetadataOutput(val *CategoryListMetadataOutput) *NullableCategoryListMetadataOutput {
	return &NullableCategoryListMetadataOutput{value: val, isSet: true}
}

func (v NullableCategoryListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
