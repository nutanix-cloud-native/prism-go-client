...
// checks if the RoutingPolicyIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyIntentResponse{}

// RoutingPolicyIntentResponse Response object for intentful operations on a routing_policy
type RoutingPolicyIntentResponse struct {
...
type _RoutingPolicyIntentResponse RoutingPolicyIntentResponse
...
func NewRoutingPolicyIntentResponse(apiVersion string, metadata RoutingPolicyMetadata) *RoutingPolicyIntentResponse {
	this := RoutingPolicyIntentResponse{}
...
func (o RoutingPolicyIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingPolicyIntentResponse := _RoutingPolicyIntentResponse{}

	err = json.Unmarshal(data, &varRoutingPolicyIntentResponse)

	if err != nil {
		return err
	}

	*o = RoutingPolicyIntentResponse(varRoutingPolicyIntentResponse)
...
type NullableRoutingPolicyIntentResponse struct {
	value *RoutingPolicyIntentResponse
	isSet bool
}

func (v NullableRoutingPolicyIntentResponse) Get() *RoutingPolicyIntentResponse {
	return v.value
}

func (v *NullableRoutingPolicyIntentResponse) Set(val *RoutingPolicyIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyIntentResponse(val *RoutingPolicyIntentResponse) *NullableRoutingPolicyIntentResponse {
	return &NullableRoutingPolicyIntentResponse{value: val, isSet: true}
}

func (v NullableRoutingPolicyIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
