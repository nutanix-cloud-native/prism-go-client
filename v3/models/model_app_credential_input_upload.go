...
// checks if the AppCredentialInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCredentialInputUpload{}

// AppCredentialInputUpload Credential for application
type AppCredentialInputUpload struct {
	// 
...
type _AppCredentialInputUpload AppCredentialInputUpload
...
func (o AppCredentialInputUpload) MarshalJSON() ([]byte, error) {
...
func (o AppCredentialInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppCredentialInputUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCredentialInputUpload := _AppCredentialInputUpload{}

	err = json.Unmarshal(data, &varAppCredentialInputUpload)

	if err != nil {
		return err
	}

	*o = AppCredentialInputUpload(varAppCredentialInputUpload)
...
type NullableAppCredentialInputUpload struct {
	value *AppCredentialInputUpload
	isSet bool
}

func (v NullableAppCredentialInputUpload) Get() *AppCredentialInputUpload {
	return v.value
}

func (v *NullableAppCredentialInputUpload) Set(val *AppCredentialInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCredentialInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCredentialInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCredentialInputUpload(val *AppCredentialInputUpload) *NullableAppCredentialInputUpload {
	return &NullableAppCredentialInputUpload{value: val, isSet: true}
}

func (v NullableAppCredentialInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCredentialInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
