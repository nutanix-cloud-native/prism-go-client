...
// checks if the PortalSoftware type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PortalSoftware{}

// PortalSoftware Software information from Nutanix Portal
type PortalSoftware struct {
	...
	UpgradeNotification *UpgradeNotification `json:"upgrade_notification,omitempty"`
	...
	CompatiblePeVersionList []string `json:"compatible_pe_version_list,omitempty"`
	// Software type
...
type _PortalSoftware PortalSoftware
...
// GetReleaseNoteUrl returns the ReleaseNoteUrl field value if set, zero value otherwise.
func (o *PortalSoftware) GetReleaseNoteUrl() string {
	if o == nil || IsNil(o.ReleaseNoteUrl) {
		var ret string
		return ret
	}
	return *o.ReleaseNoteUrl
}

// GetReleaseNoteUrlOk returns a tuple with the ReleaseNoteUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PortalSoftware) GetReleaseNoteUrlOk() (*string, bool) {
	if o == nil || IsNil(o.ReleaseNoteUrl) {
		return nil, false
	}
	return o.ReleaseNoteUrl, true
}
...
// SetReleaseNoteUrl gets a reference to the given string and assigns it to the ReleaseNoteUrl field.
func (o *PortalSoftware) SetReleaseNoteUrl(v string) {
	o.ReleaseNoteUrl = &v
}

// GetUpgradeNotification returns the UpgradeNotification field value if set, zero value otherwise.
func (o *PortalSoftware) GetUpgradeNotification() UpgradeNotification {
	if o == nil || IsNil(o.UpgradeNotification) {
		var ret UpgradeNotification
		return ret
	}
	return *o.UpgradeNotification
}

// GetUpgradeNotificationOk returns a tuple with the UpgradeNotification field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PortalSoftware) GetUpgradeNotificationOk() (*UpgradeNotification, bool) {
	if o == nil || IsNil(o.UpgradeNotification) {
		return nil, false
	}
	return o.UpgradeNotification, true
}
...
// SetUpgradeNotification gets a reference to the given UpgradeNotification and assigns it to the UpgradeNotification field.
func (o *PortalSoftware) SetUpgradeNotification(v UpgradeNotification) {
	o.UpgradeNotification = &v
}
...
// GetCompatibleVersionList returns the CompatibleVersionList field value if set, zero value otherwise.
func (o *PortalSoftware) GetCompatibleVersionList() []string {
	if o == nil || IsNil(o.CompatibleVersionList) {
		var ret []string
		return ret
	}
	return o.CompatibleVersionList
}

// GetCompatibleVersionListOk returns a tuple with the CompatibleVersionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PortalSoftware) GetCompatibleVersionListOk() ([]string, bool) {
	if o == nil || IsNil(o.CompatibleVersionList) {
		return nil, false
	}
	return o.CompatibleVersionList, true
}
...
// SetCompatibleVersionList gets a reference to the given []string and assigns it to the CompatibleVersionList field.
func (o *PortalSoftware) SetCompatibleVersionList(v []string) {
	o.CompatibleVersionList = v
}
...
// GetCompatiblePeVersionList returns the CompatiblePeVersionList field value if set, zero value otherwise.
func (o *PortalSoftware) GetCompatiblePeVersionList() []string {
	if o == nil || IsNil(o.CompatiblePeVersionList) {
		var ret []string
		return ret
	}
	return o.CompatiblePeVersionList
}

// GetCompatiblePeVersionListOk returns a tuple with the CompatiblePeVersionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PortalSoftware) GetCompatiblePeVersionListOk() ([]string, bool) {
	if o == nil || IsNil(o.CompatiblePeVersionList) {
		return nil, false
	}
	return o.CompatiblePeVersionList, true
}
...
// SetCompatiblePeVersionList gets a reference to the given []string and assigns it to the CompatiblePeVersionList field.
func (o *PortalSoftware) SetCompatiblePeVersionList(v []string) {
	o.CompatiblePeVersionList = v
}
...
func (o PortalSoftware) MarshalJSON() ([]byte, error) {
...
func (o PortalSoftware) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ReleaseNoteUrl) {
		toSerialize["release_note_url"] = o.ReleaseNoteUrl
	}
	if !IsNil(o.UpgradeNotification) {
		toSerialize["upgrade_notification"] = o.UpgradeNotification
	}
	...
	if !IsNil(o.CompatibleVersionList) {
		toSerialize["compatible_version_list"] = o.CompatibleVersionList
	}
	if !IsNil(o.Version) {
		toSerialize["version"] = o.Version
	}
	if !IsNil(o.CompatiblePeVersionList) {
		toSerialize["compatible_pe_version_list"] = o.CompatiblePeVersionList
	}
...
func (o *PortalSoftware) UnmarshalJSON(data []byte) (err error) {
	varPortalSoftware := _PortalSoftware{}

	err = json.Unmarshal(data, &varPortalSoftware)

	if err != nil {
		return err
	}

	*o = PortalSoftware(varPortalSoftware)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "release_note_url")
		delete(additionalProperties, "upgrade_notification")
		delete(additionalProperties, "release_date")
		delete(additionalProperties, "md5sum")
		delete(additionalProperties, "compatible_version_list")
		delete(additionalProperties, "version")
		delete(additionalProperties, "compatible_pe_version_list")
...
type NullablePortalSoftware struct {
	value *PortalSoftware
	isSet bool
}

func (v NullablePortalSoftware) Get() *PortalSoftware {
	return v.value
}

func (v *NullablePortalSoftware) Set(val *PortalSoftware) {
	v.value = val
	v.isSet = true
}

func (v NullablePortalSoftware) IsSet() bool {
	return v.isSet
}

func (v *NullablePortalSoftware) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePortalSoftware(val *PortalSoftware) *NullablePortalSoftware {
	return &NullablePortalSoftware{value: val, isSet: true}
}

func (v NullablePortalSoftware) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePortalSoftware) UnmarshalJSON(src []byte) error {
	v.isSet = true
