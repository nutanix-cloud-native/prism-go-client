...
// checks if the MulticlusterConfigStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MulticlusterConfigStatus{}

// MulticlusterConfigStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _MulticlusterConfigStatus MulticlusterConfigStatus
...
func (o MulticlusterConfigStatus) MarshalJSON() ([]byte, error) {
...
func (o MulticlusterConfigStatus) ToMap() (map[string]interface{}, error) {
...
func (o *MulticlusterConfigStatus) UnmarshalJSON(data []byte) (err error) {
	varMulticlusterConfigStatus := _MulticlusterConfigStatus{}

	err = json.Unmarshal(data, &varMulticlusterConfigStatus)

	if err != nil {
		return err
	}

	*o = MulticlusterConfigStatus(varMulticlusterConfigStatus)
...
type NullableMulticlusterConfigStatus struct {
	value *MulticlusterConfigStatus
	isSet bool
}

func (v NullableMulticlusterConfigStatus) Get() *MulticlusterConfigStatus {
	return v.value
}

func (v *NullableMulticlusterConfigStatus) Set(val *MulticlusterConfigStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableMulticlusterConfigStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableMulticlusterConfigStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMulticlusterConfigStatus(val *MulticlusterConfigStatus) *NullableMulticlusterConfigStatus {
	return &NullableMulticlusterConfigStatus{value: val, isSet: true}
}

func (v NullableMulticlusterConfigStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMulticlusterConfigStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
