...
// checks if the AppRunbookResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunbookResponseDownload{}

// AppRunbookResponseDownload Runbook definition for Application
type AppRunbookResponseDownload struct {
	// 
	TaskDefinitionList []AppTaskResponseDownload `json:"task_definition_list,omitempty"`
	// 
	...
	MainTaskLocalReference *AppTaskReferenceUpload `json:"main_task_local_reference,omitempty"`
	// Message list
...
type _AppRunbookResponseDownload AppRunbookResponseDownload
...
func NewAppRunbookResponseDownload(name string, state string, messageList []MessageResource) *AppRunbookResponseDownload {
	this := AppRunbookResponseDownload{}
	this.Name = name
	this.State = state
...
// GetTaskDefinitionList returns the TaskDefinitionList field value if set, zero value otherwise.
func (o *AppRunbookResponseDownload) GetTaskDefinitionList() []AppTaskResponseDownload {
	if o == nil || IsNil(o.TaskDefinitionList) {
		var ret []AppTaskResponseDownload
		return ret
	}
	return o.TaskDefinitionList
}

// GetTaskDefinitionListOk returns a tuple with the TaskDefinitionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppRunbookResponseDownload) GetTaskDefinitionListOk() ([]AppTaskResponseDownload, bool) {
	if o == nil || IsNil(o.TaskDefinitionList) {
		return nil, false
	}
	return o.TaskDefinitionList, true
}
...
// SetTaskDefinitionList gets a reference to the given []AppTaskResponseDownload and assigns it to the TaskDefinitionList field.
func (o *AppRunbookResponseDownload) SetTaskDefinitionList(v []AppTaskResponseDownload) {
	o.TaskDefinitionList = v
}
...
// GetMainTaskLocalReference returns the MainTaskLocalReference field value if set, zero value otherwise.
func (o *AppRunbookResponseDownload) GetMainTaskLocalReference() AppTaskReferenceUpload {
	if o == nil || IsNil(o.MainTaskLocalReference) {
		var ret AppTaskReferenceUpload
		return ret
	}
	return *o.MainTaskLocalReference
}

// GetMainTaskLocalReferenceOk returns a tuple with the MainTaskLocalReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppRunbookResponseDownload) GetMainTaskLocalReferenceOk() (*AppTaskReferenceUpload, bool) {
	if o == nil || IsNil(o.MainTaskLocalReference) {
		return nil, false
	}
	return o.MainTaskLocalReference, true
}
...
// SetMainTaskLocalReference gets a reference to the given AppTaskReferenceUpload and assigns it to the MainTaskLocalReference field.
func (o *AppRunbookResponseDownload) SetMainTaskLocalReference(v AppTaskReferenceUpload) {
	o.MainTaskLocalReference = &v
}
...
func (o AppRunbookResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o AppRunbookResponseDownload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TaskDefinitionList) {
		toSerialize["task_definition_list"] = o.TaskDefinitionList
	}
	...
	if !IsNil(o.MainTaskLocalReference) {
		toSerialize["main_task_local_reference"] = o.MainTaskLocalReference
	}
...
func (o *AppRunbookResponseDownload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRunbookResponseDownload := _AppRunbookResponseDownload{}

	err = json.Unmarshal(data, &varAppRunbookResponseDownload)

	if err != nil {
		return err
	}

	*o = AppRunbookResponseDownload(varAppRunbookResponseDownload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "task_definition_list")
		delete(additionalProperties, "description")
		delete(additionalProperties, "name")
		delete(additionalProperties, "state")
		delete(additionalProperties, "main_task_local_reference")
...
type NullableAppRunbookResponseDownload struct {
	value *AppRunbookResponseDownload
	isSet bool
}

func (v NullableAppRunbookResponseDownload) Get() *AppRunbookResponseDownload {
	return v.value
}

func (v *NullableAppRunbookResponseDownload) Set(val *AppRunbookResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunbookResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunbookResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunbookResponseDownload(val *AppRunbookResponseDownload) *NullableAppRunbookResponseDownload {
	return &NullableAppRunbookResponseDownload{value: val, isSet: true}
}

func (v NullableAppRunbookResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunbookResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
