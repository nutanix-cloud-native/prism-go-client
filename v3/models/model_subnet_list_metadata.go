...
// checks if the SubnetListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubnetListMetadata{}

// SubnetListMetadata All api calls that return a list will have this metadata block as input 
...
type _SubnetListMetadata SubnetListMetadata
...
func (o SubnetListMetadata) MarshalJSON() ([]byte, error) {
...
func (o SubnetListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SubnetListMetadata) UnmarshalJSON(data []byte) (err error) {
	varSubnetListMetadata := _SubnetListMetadata{}

	err = json.Unmarshal(data, &varSubnetListMetadata)

	if err != nil {
		return err
	}

	*o = SubnetListMetadata(varSubnetListMetadata)
...
type NullableSubnetListMetadata struct {
	value *SubnetListMetadata
	isSet bool
}

func (v NullableSubnetListMetadata) Get() *SubnetListMetadata {
	return v.value
}

func (v *NullableSubnetListMetadata) Set(val *SubnetListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSubnetListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSubnetListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubnetListMetadata(val *SubnetListMetadata) *NullableSubnetListMetadata {
	return &NullableSubnetListMetadata{value: val, isSet: true}
}

func (v NullableSubnetListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubnetListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
