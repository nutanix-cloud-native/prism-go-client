...
// checks if the Layer2StretchIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchIntentResource{}

// Layer2StretchIntentResource Response object for intentful operations on a layer2_stretch
type Layer2StretchIntentResource struct {
...
type _Layer2StretchIntentResource Layer2StretchIntentResource
...
func NewLayer2StretchIntentResource(metadata Layer2StretchMetadata) *Layer2StretchIntentResource {
	this := Layer2StretchIntentResource{}
...
func (o Layer2StretchIntentResource) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varLayer2StretchIntentResource := _Layer2StretchIntentResource{}

	err = json.Unmarshal(data, &varLayer2StretchIntentResource)

	if err != nil {
		return err
	}

	*o = Layer2StretchIntentResource(varLayer2StretchIntentResource)
...
type NullableLayer2StretchIntentResource struct {
	value *Layer2StretchIntentResource
	isSet bool
}

func (v NullableLayer2StretchIntentResource) Get() *Layer2StretchIntentResource {
	return v.value
}

func (v *NullableLayer2StretchIntentResource) Set(val *Layer2StretchIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchIntentResource(val *Layer2StretchIntentResource) *NullableLayer2StretchIntentResource {
	return &NullableLayer2StretchIntentResource{value: val, isSet: true}
}

func (v NullableLayer2StretchIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
