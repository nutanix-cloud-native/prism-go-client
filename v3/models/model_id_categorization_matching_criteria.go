...
// checks if the IdCategorizationMatchingCriteria type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdCategorizationMatchingCriteria{}

// IdCategorizationMatchingCriteria The matching criteria used to determine whether an entity will be categorized by identity categorization. If match type is ALL, all the entities will be categorized. 
type IdCategorizationMatchingCriteria struct {
	...
	MatchEntity string `json:"match_entity"`
	AdditionalProperties map[string]interface{}
}

type _IdCategorizationMatchingCriteria IdCategorizationMatchingCriteria
...
func NewIdCategorizationMatchingCriteria(matchField string, matchType string, matchEntity string) *IdCategorizationMatchingCriteria {
	this := IdCategorizationMatchingCriteria{}
...
// GetMatchField returns the MatchField field value
...
// GetMatchFieldOk returns a tuple with the MatchField field value
...
// SetMatchField sets field value
...
// GetMatchEntity returns the MatchEntity field value
...
// GetMatchEntityOk returns a tuple with the MatchEntity field value
// and a boolean to check if the value has been set.
...
// SetMatchEntity sets field value
func (o *IdCategorizationMatchingCriteria) SetMatchEntity(v string) {
	o.MatchEntity = v
}

func (o IdCategorizationMatchingCriteria) MarshalJSON() ([]byte, error) {
...
func (o IdCategorizationMatchingCriteria) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["match_field"] = o.MatchField
	if !IsNil(o.Criteria) {
		toSerialize["criteria"] = o.Criteria
	}
	toSerialize["match_type"] = o.MatchType
	toSerialize["match_entity"] = o.MatchEntity
...
func (o *IdCategorizationMatchingCriteria) UnmarshalJSON(data []byte) (err error) {
	...
	varIdCategorizationMatchingCriteria := _IdCategorizationMatchingCriteria{}

	err = json.Unmarshal(data, &varIdCategorizationMatchingCriteria)

	if err != nil {
		return err
	}

	*o = IdCategorizationMatchingCriteria(varIdCategorizationMatchingCriteria)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "match_field")
		delete(additionalProperties, "criteria")
		delete(additionalProperties, "match_type")
		delete(additionalProperties, "match_entity")
...
type NullableIdCategorizationMatchingCriteria struct {
	value *IdCategorizationMatchingCriteria
	isSet bool
}

func (v NullableIdCategorizationMatchingCriteria) Get() *IdCategorizationMatchingCriteria {
	return v.value
}

func (v *NullableIdCategorizationMatchingCriteria) Set(val *IdCategorizationMatchingCriteria) {
	v.value = val
	v.isSet = true
}

func (v NullableIdCategorizationMatchingCriteria) IsSet() bool {
	return v.isSet
}

func (v *NullableIdCategorizationMatchingCriteria) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdCategorizationMatchingCriteria(val *IdCategorizationMatchingCriteria) *NullableIdCategorizationMatchingCriteria {
	return &NullableIdCategorizationMatchingCriteria{value: val, isSet: true}
}

func (v NullableIdCategorizationMatchingCriteria) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdCategorizationMatchingCriteria) UnmarshalJSON(src []byte) error {
	v.isSet = true
