...
// checks if the VmRecoveryPoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPoint{}

// VmRecoveryPoint The input object that defines a vm recovery point.
...
func (o *VmRecoveryPoint) GetResources() RecoveryPointResources {
	if o == nil || IsNil(o.Resources) {
		var ret RecoveryPointResources
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given RecoveryPointResources and assigns it to the Resources field.
...
func (o VmRecoveryPoint) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPoint) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPoint) UnmarshalJSON(data []byte) (err error) {
	varVmRecoveryPoint := _VmRecoveryPoint{}

	err = json.Unmarshal(data, &varVmRecoveryPoint)

	if err != nil {
		return err
	}

	*o = VmRecoveryPoint(varVmRecoveryPoint)
...
type NullableVmRecoveryPoint struct {
	value *VmRecoveryPoint
	isSet bool
}

func (v NullableVmRecoveryPoint) Get() *VmRecoveryPoint {
	return v.value
}

func (v *NullableVmRecoveryPoint) Set(val *VmRecoveryPoint) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPoint) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPoint) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPoint(val *VmRecoveryPoint) *NullableVmRecoveryPoint {
	return &NullableVmRecoveryPoint{value: val, isSet: true}
}

func (v NullableVmRecoveryPoint) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPoint) UnmarshalJSON(src []byte) error {
	v.isSet = true
