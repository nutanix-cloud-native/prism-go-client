...
type _DeploymentSettings DeploymentSettings
...
// GetMyNtnxToken returns the MyNtnxToken field value
func (o *DeploymentSettings) GetMyNtnxToken() MyNtnxToken {
	...
	return o.MyNtnxToken
}

// GetMyNtnxTokenOk returns a tuple with the MyNtnxToken field value
// and a boolean to check if the value has been set.
func (o *DeploymentSettings) GetMyNtnxTokenOk() (*MyNtnxToken, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MyNtnxToken, true
}

// SetMyNtnxToken sets field value
...
func (o DeploymentSettings) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["my_ntnx_token"] = o.MyNtnxToken
...
func (o *DeploymentSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varDeploymentSettings := _DeploymentSettings{}

	err = json.Unmarshal(data, &varDeploymentSettings)

	if err != nil {
		return err
	}

	*o = DeploymentSettings(varDeploymentSettings)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "system_id")
		delete(additionalProperties, "my_ntnx_token")
