...
// checks if the CommonReportConfigStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigStatus{}

// CommonReportConfigStatus The status of a REST API call. Only used when there is a failure to report. 
type CommonReportConfigStatus struct {
	// The kind name
...
type _CommonReportConfigStatus CommonReportConfigStatus
...
func (o CommonReportConfigStatus) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfigStatus) UnmarshalJSON(data []byte) (err error) {
	varCommonReportConfigStatus := _CommonReportConfigStatus{}

	err = json.Unmarshal(data, &varCommonReportConfigStatus)

	if err != nil {
		return err
	}

	*o = CommonReportConfigStatus(varCommonReportConfigStatus)
...
type NullableCommonReportConfigStatus struct {
	value *CommonReportConfigStatus
	isSet bool
}

func (v NullableCommonReportConfigStatus) Get() *CommonReportConfigStatus {
	return v.value
}

func (v *NullableCommonReportConfigStatus) Set(val *CommonReportConfigStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigStatus(val *CommonReportConfigStatus) *NullableCommonReportConfigStatus {
	return &NullableCommonReportConfigStatus{value: val, isSet: true}
}

func (v NullableCommonReportConfigStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
