...
// checks if the DirectoryServiceIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceIntentResource{}

// DirectoryServiceIntentResource Response object for intentful operations on a directory_service
...
type _DirectoryServiceIntentResource DirectoryServiceIntentResource
...
func NewDirectoryServiceIntentResource(metadata DirectoryServiceMetadata) *DirectoryServiceIntentResource {
	this := DirectoryServiceIntentResource{}
...
func (o *DirectoryServiceIntentResource) GetStatus() DirectoryServiceDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret DirectoryServiceDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given DirectoryServiceDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given DirectoryService and assigns it to the Spec field.
...
func (o *DirectoryServiceIntentResource) GetMetadata() DirectoryServiceMetadata {
	if o == nil {
		var ret DirectoryServiceMetadata
		return ret
	}
...
func (o DirectoryServiceIntentResource) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryServiceIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectoryServiceIntentResource := _DirectoryServiceIntentResource{}

	err = json.Unmarshal(data, &varDirectoryServiceIntentResource)

	if err != nil {
		return err
	}

	*o = DirectoryServiceIntentResource(varDirectoryServiceIntentResource)
...
type NullableDirectoryServiceIntentResource struct {
	value *DirectoryServiceIntentResource
	isSet bool
}

func (v NullableDirectoryServiceIntentResource) Get() *DirectoryServiceIntentResource {
	return v.value
}

func (v *NullableDirectoryServiceIntentResource) Set(val *DirectoryServiceIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceIntentResource(val *DirectoryServiceIntentResource) *NullableDirectoryServiceIntentResource {
	return &NullableDirectoryServiceIntentResource{value: val, isSet: true}
}

func (v NullableDirectoryServiceIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
