...
// checks if the ReportInstance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstance{}

// ReportInstance Report instance resources.
type ReportInstance struct {
	...
	ReportConfigReference ReportConfigReference `json:"report_config_reference"`
	AdditionalProperties map[string]interface{}
}

type _ReportInstance ReportInstance
...
func NewReportInstance(reportConfigReference ReportConfigReference) *ReportInstance {
	this := ReportInstance{}
	this.ReportConfigReference = reportConfigReference
	return &this
}
...
// GetReportConfigReference returns the ReportConfigReference field value
...
// GetReportConfigReferenceOk returns a tuple with the ReportConfigReference field value
// and a boolean to check if the value has been set.
...
func (o ReportInstance) ToMap() (map[string]interface{}, error) {
...
func (o *ReportInstance) UnmarshalJSON(data []byte) (err error) {
	...
	varReportInstance := _ReportInstance{}

	err = json.Unmarshal(data, &varReportInstance)

	if err != nil {
		return err
	}

	*o = ReportInstance(varReportInstance)
...
type NullableReportInstance struct {
	value *ReportInstance
	isSet bool
}

func (v NullableReportInstance) Get() *ReportInstance {
	return v.value
}

func (v *NullableReportInstance) Set(val *ReportInstance) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstance) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstance(val *ReportInstance) *NullableReportInstance {
	return &NullableReportInstance{value: val, isSet: true}
}

func (v NullableReportInstance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstance) UnmarshalJSON(src []byte) error {
	v.isSet = true
