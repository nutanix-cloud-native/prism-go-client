...
// checks if the NetworkFunctionChainMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionChainMetadata{}

// NetworkFunctionChainMetadata The network_function_chain kind metadata
type NetworkFunctionChainMetadata struct {
	...
	// Categories for the network_function_chain. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the network_function_chain. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _NetworkFunctionChainMetadata NetworkFunctionChainMetadata
...
func NewNetworkFunctionChainMetadata(kind string) *NetworkFunctionChainMetadata {
	this := NetworkFunctionChainMetadata{}
...
func (o *NetworkFunctionChainMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *NetworkFunctionChainMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *NetworkFunctionChainMetadata) SetName(v string) {
	o.Name = &v
}

func (o NetworkFunctionChainMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionChainMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionChainMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkFunctionChainMetadata := _NetworkFunctionChainMetadata{}

	err = json.Unmarshal(data, &varNetworkFunctionChainMetadata)

	if err != nil {
		return err
	}

	*o = NetworkFunctionChainMetadata(varNetworkFunctionChainMetadata)
...
type NullableNetworkFunctionChainMetadata struct {
	value *NetworkFunctionChainMetadata
	isSet bool
}

func (v NullableNetworkFunctionChainMetadata) Get() *NetworkFunctionChainMetadata {
	return v.value
}

func (v *NullableNetworkFunctionChainMetadata) Set(val *NetworkFunctionChainMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionChainMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionChainMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionChainMetadata(val *NetworkFunctionChainMetadata) *NullableNetworkFunctionChainMetadata {
	return &NullableNetworkFunctionChainMetadata{value: val, isSet: true}
}

func (v NullableNetworkFunctionChainMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionChainMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
