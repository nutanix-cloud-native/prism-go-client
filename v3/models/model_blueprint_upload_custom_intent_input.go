...
// checks if the BlueprintUploadCustomIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintUploadCustomIntentInput{}

// BlueprintUploadCustomIntentInput An intentful representation of a blueprint
type BlueprintUploadCustomIntentInput struct {
...
type _BlueprintUploadCustomIntentInput BlueprintUploadCustomIntentInput
...
func NewBlueprintUploadCustomIntentInput(spec BlueprintUpload, apiVersion string, metadata BlueprintMetadata) *BlueprintUploadCustomIntentInput {
	this := BlueprintUploadCustomIntentInput{}
	this.Spec = spec
...
func (o BlueprintUploadCustomIntentInput) MarshalJSON() ([]byte, error) {
...
func (o BlueprintUploadCustomIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintUploadCustomIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintUploadCustomIntentInput := _BlueprintUploadCustomIntentInput{}

	err = json.Unmarshal(data, &varBlueprintUploadCustomIntentInput)

	if err != nil {
		return err
	}

	*o = BlueprintUploadCustomIntentInput(varBlueprintUploadCustomIntentInput)
...
type NullableBlueprintUploadCustomIntentInput struct {
	value *BlueprintUploadCustomIntentInput
	isSet bool
}

func (v NullableBlueprintUploadCustomIntentInput) Get() *BlueprintUploadCustomIntentInput {
	return v.value
}

func (v *NullableBlueprintUploadCustomIntentInput) Set(val *BlueprintUploadCustomIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintUploadCustomIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintUploadCustomIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintUploadCustomIntentInput(val *BlueprintUploadCustomIntentInput) *NullableBlueprintUploadCustomIntentInput {
	return &NullableBlueprintUploadCustomIntentInput{value: val, isSet: true}
}

func (v NullableBlueprintUploadCustomIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintUploadCustomIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
