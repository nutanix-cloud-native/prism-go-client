...
// checks if the NgtPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicy{}

// NgtPolicy NGT policy spec.
type NgtPolicy struct {
	// NGT policy name.
...
func (o NgtPolicy) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtPolicy := _NgtPolicy{}

	err = json.Unmarshal(data, &varNgtPolicy)

	if err != nil {
		return err
	}

	*o = NgtPolicy(varNgtPolicy)
...
type NullableNgtPolicy struct {
	value *NgtPolicy
	isSet bool
}

func (v NullableNgtPolicy) Get() *NgtPolicy {
	return v.value
}

func (v *NullableNgtPolicy) Set(val *NgtPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicy(val *NgtPolicy) *NullableNgtPolicy {
	return &NullableNgtPolicy{value: val, isSet: true}
}

func (v NullableNgtPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
