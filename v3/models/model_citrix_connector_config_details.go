...
// checks if the CitrixConnectorConfigDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CitrixConnectorConfigDetails{}
...
type _CitrixConnectorConfigDetails CitrixConnectorConfigDetails
...
func NewCitrixConnectorConfigDetails() *CitrixConnectorConfigDetails {
	this := CitrixConnectorConfigDetails{}
	return &this
}
...
func (o *CitrixConnectorConfigDetails) GetResourceLocation() CitrixResourceLocation {
	if o == nil || IsNil(o.ResourceLocation) {
		var ret CitrixResourceLocation
		return ret
	}
...
// SetResourceLocation gets a reference to the given CitrixResourceLocation and assigns it to the ResourceLocation field.
func (o *CitrixConnectorConfigDetails) SetResourceLocation(v CitrixResourceLocation) {
	o.ResourceLocation = &v
}

func (o CitrixConnectorConfigDetails) MarshalJSON() ([]byte, error) {
...
func (o CitrixConnectorConfigDetails) ToMap() (map[string]interface{}, error) {
...
func (o *CitrixConnectorConfigDetails) UnmarshalJSON(data []byte) (err error) {
	varCitrixConnectorConfigDetails := _CitrixConnectorConfigDetails{}

	err = json.Unmarshal(data, &varCitrixConnectorConfigDetails)

	if err != nil {
		return err
	}

	*o = CitrixConnectorConfigDetails(varCitrixConnectorConfigDetails)
...
type NullableCitrixConnectorConfigDetails struct {
	value *CitrixConnectorConfigDetails
	isSet bool
}

func (v NullableCitrixConnectorConfigDetails) Get() *CitrixConnectorConfigDetails {
	return v.value
}

func (v *NullableCitrixConnectorConfigDetails) Set(val *CitrixConnectorConfigDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCitrixConnectorConfigDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCitrixConnectorConfigDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCitrixConnectorConfigDetails(val *CitrixConnectorConfigDetails) *NullableCitrixConnectorConfigDetails {
	return &NullableCitrixConnectorConfigDetails{value: val, isSet: true}
}

func (v NullableCitrixConnectorConfigDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCitrixConnectorConfigDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
