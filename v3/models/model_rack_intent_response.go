...
// checks if the RackIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackIntentResponse{}

// RackIntentResponse Response object for intentful operations on a rack
type RackIntentResponse struct {
...
type _RackIntentResponse RackIntentResponse
...
func (o RackIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RackIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RackIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRackIntentResponse := _RackIntentResponse{}

	err = json.Unmarshal(data, &varRackIntentResponse)

	if err != nil {
		return err
	}

	*o = RackIntentResponse(varRackIntentResponse)
...
type NullableRackIntentResponse struct {
	value *RackIntentResponse
	isSet bool
}

func (v NullableRackIntentResponse) Get() *RackIntentResponse {
	return v.value
}

func (v *NullableRackIntentResponse) Set(val *RackIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRackIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRackIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackIntentResponse(val *RackIntentResponse) *NullableRackIntentResponse {
	return &NullableRackIntentResponse{value: val, isSet: true}
}

func (v NullableRackIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
