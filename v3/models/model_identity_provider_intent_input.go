...
// checks if the IdentityProviderIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderIntentInput{}

// IdentityProviderIntentInput An intentful representation of a identity_provider
type IdentityProviderIntentInput struct {
	Spec IdentityProvider `json:"spec"`
...
type _IdentityProviderIntentInput IdentityProviderIntentInput
...
func NewIdentityProviderIntentInput(spec IdentityProvider, metadata IdentityProviderMetadata) *IdentityProviderIntentInput {
	this := IdentityProviderIntentInput{}
	this.Spec = spec
...
func (o IdentityProviderIntentInput) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProviderIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varIdentityProviderIntentInput := _IdentityProviderIntentInput{}

	err = json.Unmarshal(data, &varIdentityProviderIntentInput)

	if err != nil {
		return err
	}

	*o = IdentityProviderIntentInput(varIdentityProviderIntentInput)
...
type NullableIdentityProviderIntentInput struct {
	value *IdentityProviderIntentInput
	isSet bool
}

func (v NullableIdentityProviderIntentInput) Get() *IdentityProviderIntentInput {
	return v.value
}

func (v *NullableIdentityProviderIntentInput) Set(val *IdentityProviderIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderIntentInput(val *IdentityProviderIntentInput) *NullableIdentityProviderIntentInput {
	return &NullableIdentityProviderIntentInput{value: val, isSet: true}
}

func (v NullableIdentityProviderIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
