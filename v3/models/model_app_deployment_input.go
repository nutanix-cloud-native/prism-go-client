...
// checks if the AppDeploymentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppDeploymentInput{}

// AppDeploymentInput Deployment definition for Application.
type AppDeploymentInput struct {
	...
	PackageList []AppPackageInput `json:"package_list,omitempty"`
	// 
...
type _AppDeploymentInput AppDeploymentInput
...
// GetSubstrate returns the Substrate field value
func (o *AppDeploymentInput) GetSubstrate() AppSubstrateInput {
	if o == nil {
		var ret AppSubstrateInput
		return ret
	}
...
// GetSubstrateOk returns a tuple with the Substrate field value
// and a boolean to check if the value has been set.
func (o *AppDeploymentInput) GetSubstrateOk() (*AppSubstrateInput, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Substrate, true
}

// SetSubstrate sets field value
...
// SetServiceList gets a reference to the given []AppServiceInput and assigns it to the ServiceList field.
...
// SetPackageList gets a reference to the given []AppPackageInput and assigns it to the PackageList field.
...
func (o AppDeploymentInput) MarshalJSON() ([]byte, error) {
...
func (o AppDeploymentInput) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["substrate"] = o.Substrate
...
func (o *AppDeploymentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppDeploymentInput := _AppDeploymentInput{}

	err = json.Unmarshal(data, &varAppDeploymentInput)

	if err != nil {
		return err
	}

	*o = AppDeploymentInput(varAppDeploymentInput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "substrate")
...
type NullableAppDeploymentInput struct {
	value *AppDeploymentInput
	isSet bool
}

func (v NullableAppDeploymentInput) Get() *AppDeploymentInput {
	return v.value
}

func (v *NullableAppDeploymentInput) Set(val *AppDeploymentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppDeploymentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppDeploymentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppDeploymentInput(val *AppDeploymentInput) *NullableAppDeploymentInput {
	return &NullableAppDeploymentInput{value: val, isSet: true}
}

func (v NullableAppDeploymentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppDeploymentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
