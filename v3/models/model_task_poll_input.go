...
// checks if the TaskPollInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskPollInput{}

// TaskPollInput Input for a task poll
type TaskPollInput struct {
	// Poll timeout in seconds
	PollTimeoutSeconds int32 `json:"poll_timeout_seconds"`
	// List of task UUIDs to poll on
	TaskUuidList []string `json:"task_uuid_list"`
	AdditionalProperties map[string]interface{}
}

type _TaskPollInput TaskPollInput
...
// GetPollTimeoutSeconds returns the PollTimeoutSeconds field value
...
// GetPollTimeoutSecondsOk returns a tuple with the PollTimeoutSeconds field value
...
// SetPollTimeoutSeconds sets field value
func (o *TaskPollInput) SetPollTimeoutSeconds(v int32) {
	o.PollTimeoutSeconds = v
}

// GetTaskUuidList returns the TaskUuidList field value
func (o *TaskPollInput) GetTaskUuidList() []string {
	...
	return o.TaskUuidList
}

// GetTaskUuidListOk returns a tuple with the TaskUuidList field value
// and a boolean to check if the value has been set.
func (o *TaskPollInput) GetTaskUuidListOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.TaskUuidList, true
}

// SetTaskUuidList sets field value
func (o *TaskPollInput) SetTaskUuidList(v []string) {
	o.TaskUuidList = v
}

func (o TaskPollInput) MarshalJSON() ([]byte, error) {
...
func (o TaskPollInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["poll_timeout_seconds"] = o.PollTimeoutSeconds
	toSerialize["task_uuid_list"] = o.TaskUuidList
...
func (o *TaskPollInput) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskPollInput := _TaskPollInput{}

	err = json.Unmarshal(data, &varTaskPollInput)

	if err != nil {
		return err
	}

	*o = TaskPollInput(varTaskPollInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "poll_timeout_seconds")
		delete(additionalProperties, "task_uuid_list")
...
type NullableTaskPollInput struct {
	value *TaskPollInput
	isSet bool
}

func (v NullableTaskPollInput) Get() *TaskPollInput {
	return v.value
}

func (v *NullableTaskPollInput) Set(val *TaskPollInput) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskPollInput) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskPollInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskPollInput(val *TaskPollInput) *NullableTaskPollInput {
	return &NullableTaskPollInput{value: val, isSet: true}
}

func (v NullableTaskPollInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskPollInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
