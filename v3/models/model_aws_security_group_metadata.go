...
// checks if the AwsSecurityGroupMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSecurityGroupMetadata{}

// AwsSecurityGroupMetadata The aws_security_group kind metadata
type AwsSecurityGroupMetadata struct {
	// UTC date and time in RFC-3339 format when aws_security_group was last updated 
	LastUpdateTime *time.Time `json:"last_update_time,omitempty"`
	// The kind name
	Kind string `json:"kind"`
	// aws_security_group uuid
	...
	// Categories for the aws_security_group
...
type _AwsSecurityGroupMetadata AwsSecurityGroupMetadata
...
func (o AwsSecurityGroupMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsSecurityGroupMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSecurityGroupMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsSecurityGroupMetadata := _AwsSecurityGroupMetadata{}

	err = json.Unmarshal(data, &varAwsSecurityGroupMetadata)

	if err != nil {
		return err
	}

	*o = AwsSecurityGroupMetadata(varAwsSecurityGroupMetadata)
...
type NullableAwsSecurityGroupMetadata struct {
	value *AwsSecurityGroupMetadata
	isSet bool
}

func (v NullableAwsSecurityGroupMetadata) Get() *AwsSecurityGroupMetadata {
	return v.value
}

func (v *NullableAwsSecurityGroupMetadata) Set(val *AwsSecurityGroupMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSecurityGroupMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSecurityGroupMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSecurityGroupMetadata(val *AwsSecurityGroupMetadata) *NullableAwsSecurityGroupMetadata {
	return &NullableAwsSecurityGroupMetadata{value: val, isSet: true}
}

func (v NullableAwsSecurityGroupMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSecurityGroupMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
