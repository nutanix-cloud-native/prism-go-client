...
// checks if the VmHostAffinityPolicyVmsListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityPolicyVmsListMetadata{}

// VmHostAffinityPolicyVmsListMetadata API call for VMs list that returns a list will have this metadata block as input. 
type VmHostAffinityPolicyVmsListMetadata struct {
	// The kind name
...
type _VmHostAffinityPolicyVmsListMetadata VmHostAffinityPolicyVmsListMetadata
...
func NewVmHostAffinityPolicyVmsListMetadata() *VmHostAffinityPolicyVmsListMetadata {
	this := VmHostAffinityPolicyVmsListMetadata{}
	var kind string = "vm"
	this.Kind = &kind
	return &this
}
...
func (o VmHostAffinityPolicyVmsListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityPolicyVmsListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmHostAffinityPolicyVmsListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVmHostAffinityPolicyVmsListMetadata := _VmHostAffinityPolicyVmsListMetadata{}

	err = json.Unmarshal(data, &varVmHostAffinityPolicyVmsListMetadata)

	if err != nil {
		return err
	}

	*o = VmHostAffinityPolicyVmsListMetadata(varVmHostAffinityPolicyVmsListMetadata)
...
type NullableVmHostAffinityPolicyVmsListMetadata struct {
	value *VmHostAffinityPolicyVmsListMetadata
	isSet bool
}

func (v NullableVmHostAffinityPolicyVmsListMetadata) Get() *VmHostAffinityPolicyVmsListMetadata {
	return v.value
}

func (v *NullableVmHostAffinityPolicyVmsListMetadata) Set(val *VmHostAffinityPolicyVmsListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityPolicyVmsListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityPolicyVmsListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityPolicyVmsListMetadata(val *VmHostAffinityPolicyVmsListMetadata) *NullableVmHostAffinityPolicyVmsListMetadata {
	return &NullableVmHostAffinityPolicyVmsListMetadata{value: val, isSet: true}
}

func (v NullableVmHostAffinityPolicyVmsListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityPolicyVmsListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
