...
// checks if the AwsAvailabilityZoneIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsAvailabilityZoneIntentResource{}

// AwsAvailabilityZoneIntentResource aws_availability_zone entity
type AwsAvailabilityZoneIntentResource struct {
	Status *AwsAvailabilityZoneDefStatus `json:"status,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsAvailabilityZoneMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsAvailabilityZoneIntentResource AwsAvailabilityZoneIntentResource
...
func NewAwsAvailabilityZoneIntentResource(apiVersion string, metadata AwsAvailabilityZoneMetadata) *AwsAvailabilityZoneIntentResource {
	this := AwsAvailabilityZoneIntentResource{}
...
func (o *AwsAvailabilityZoneIntentResource) GetStatus() AwsAvailabilityZoneDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret AwsAvailabilityZoneDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given AwsAvailabilityZoneDefStatus and assigns it to the Status field.
...
func (o *AwsAvailabilityZoneIntentResource) GetMetadata() AwsAvailabilityZoneMetadata {
	if o == nil {
		var ret AwsAvailabilityZoneMetadata
		return ret
	}
...
func (o AwsAvailabilityZoneIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsAvailabilityZoneIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsAvailabilityZoneIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsAvailabilityZoneIntentResource := _AwsAvailabilityZoneIntentResource{}

	err = json.Unmarshal(data, &varAwsAvailabilityZoneIntentResource)

	if err != nil {
		return err
	}

	*o = AwsAvailabilityZoneIntentResource(varAwsAvailabilityZoneIntentResource)
...
type NullableAwsAvailabilityZoneIntentResource struct {
	value *AwsAvailabilityZoneIntentResource
	isSet bool
}

func (v NullableAwsAvailabilityZoneIntentResource) Get() *AwsAvailabilityZoneIntentResource {
	return v.value
}

func (v *NullableAwsAvailabilityZoneIntentResource) Set(val *AwsAvailabilityZoneIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsAvailabilityZoneIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsAvailabilityZoneIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsAvailabilityZoneIntentResource(val *AwsAvailabilityZoneIntentResource) *NullableAwsAvailabilityZoneIntentResource {
	return &NullableAwsAvailabilityZoneIntentResource{value: val, isSet: true}
}

func (v NullableAwsAvailabilityZoneIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsAvailabilityZoneIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
