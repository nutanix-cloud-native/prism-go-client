...
// checks if the VpnGatewayStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayStatus{}

// VpnGatewayStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _VpnGatewayStatus VpnGatewayStatus
...
func (o VpnGatewayStatus) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VpnGatewayStatus) UnmarshalJSON(data []byte) (err error) {
	varVpnGatewayStatus := _VpnGatewayStatus{}

	err = json.Unmarshal(data, &varVpnGatewayStatus)

	if err != nil {
		return err
	}

	*o = VpnGatewayStatus(varVpnGatewayStatus)
...
type NullableVpnGatewayStatus struct {
	value *VpnGatewayStatus
	isSet bool
}

func (v NullableVpnGatewayStatus) Get() *VpnGatewayStatus {
	return v.value
}

func (v *NullableVpnGatewayStatus) Set(val *VpnGatewayStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayStatus(val *VpnGatewayStatus) *NullableVpnGatewayStatus {
	return &NullableVpnGatewayStatus{value: val, isSet: true}
}

func (v NullableVpnGatewayStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
