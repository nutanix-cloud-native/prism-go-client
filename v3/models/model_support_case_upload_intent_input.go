...
// checks if the SupportCaseUploadIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseUploadIntentInput{}

// SupportCaseUploadIntentInput An intentful representation of a support_case_upload
type SupportCaseUploadIntentInput struct {
	Spec SupportCaseUpload `json:"spec"`
...
type _SupportCaseUploadIntentInput SupportCaseUploadIntentInput
...
func NewSupportCaseUploadIntentInput(spec SupportCaseUpload, metadata SupportCaseUploadMetadata) *SupportCaseUploadIntentInput {
	this := SupportCaseUploadIntentInput{}
	this.Spec = spec
...
func (o SupportCaseUploadIntentInput) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseUploadIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseUploadIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseUploadIntentInput := _SupportCaseUploadIntentInput{}

	err = json.Unmarshal(data, &varSupportCaseUploadIntentInput)

	if err != nil {
		return err
	}

	*o = SupportCaseUploadIntentInput(varSupportCaseUploadIntentInput)
...
type NullableSupportCaseUploadIntentInput struct {
	value *SupportCaseUploadIntentInput
	isSet bool
}

func (v NullableSupportCaseUploadIntentInput) Get() *SupportCaseUploadIntentInput {
	return v.value
}

func (v *NullableSupportCaseUploadIntentInput) Set(val *SupportCaseUploadIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseUploadIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseUploadIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseUploadIntentInput(val *SupportCaseUploadIntentInput) *NullableSupportCaseUploadIntentInput {
	return &NullableSupportCaseUploadIntentInput{value: val, isSet: true}
}

func (v NullableSupportCaseUploadIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseUploadIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
