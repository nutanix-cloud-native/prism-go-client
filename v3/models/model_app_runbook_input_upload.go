...
// checks if the AppRunbookInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunbookInputUpload{}

// AppRunbookInputUpload Runbook definition for Application
type AppRunbookInputUpload struct {
	// 
	TaskDefinitionList []AppTaskInputUpload `json:"task_definition_list,omitempty"`
	// 
...
type _AppRunbookInputUpload AppRunbookInputUpload
...
// SetTaskDefinitionList gets a reference to the given []AppTaskInputUpload and assigns it to the TaskDefinitionList field.
...
func (o AppRunbookInputUpload) MarshalJSON() ([]byte, error) {
...
func (o AppRunbookInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunbookInputUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRunbookInputUpload := _AppRunbookInputUpload{}

	err = json.Unmarshal(data, &varAppRunbookInputUpload)

	if err != nil {
		return err
	}

	*o = AppRunbookInputUpload(varAppRunbookInputUpload)
...
type NullableAppRunbookInputUpload struct {
	value *AppRunbookInputUpload
	isSet bool
}

func (v NullableAppRunbookInputUpload) Get() *AppRunbookInputUpload {
	return v.value
}

func (v *NullableAppRunbookInputUpload) Set(val *AppRunbookInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunbookInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunbookInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunbookInputUpload(val *AppRunbookInputUpload) *NullableAppRunbookInputUpload {
	return &NullableAppRunbookInputUpload{value: val, isSet: true}
}

func (v NullableAppRunbookInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunbookInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
