...
// checks if the VolumeGroupListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupListIntentResponse{}

// VolumeGroupListIntentResponse Response object for intentful operation of volume_groups
type VolumeGroupListIntentResponse struct {
	Entities []VolumeGroupIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata VolumeGroupListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VolumeGroupListIntentResponse VolumeGroupListIntentResponse
...
func NewVolumeGroupListIntentResponse(apiVersion string, metadata VolumeGroupListMetadataOutput) *VolumeGroupListIntentResponse {
	this := VolumeGroupListIntentResponse{}
...
func (o *VolumeGroupListIntentResponse) GetEntities() []VolumeGroupIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []VolumeGroupIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []VolumeGroupIntentResource and assigns it to the Entities field.
...
func (o *VolumeGroupListIntentResponse) GetMetadata() VolumeGroupListMetadataOutput {
	if o == nil {
		var ret VolumeGroupListMetadataOutput
		return ret
	}
...
func (o VolumeGroupListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeGroupListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumeGroupListIntentResponse := _VolumeGroupListIntentResponse{}

	err = json.Unmarshal(data, &varVolumeGroupListIntentResponse)

	if err != nil {
		return err
	}

	*o = VolumeGroupListIntentResponse(varVolumeGroupListIntentResponse)
...
type NullableVolumeGroupListIntentResponse struct {
	value *VolumeGroupListIntentResponse
	isSet bool
}

func (v NullableVolumeGroupListIntentResponse) Get() *VolumeGroupListIntentResponse {
	return v.value
}

func (v *NullableVolumeGroupListIntentResponse) Set(val *VolumeGroupListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupListIntentResponse(val *VolumeGroupListIntentResponse) *NullableVolumeGroupListIntentResponse {
	return &NullableVolumeGroupListIntentResponse{value: val, isSet: true}
}

func (v NullableVolumeGroupListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
