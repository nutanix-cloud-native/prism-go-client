...
// checks if the AccountListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountListMetadataOutput{}

// AccountListMetadataOutput All api calls that return a list will have this metadata block 
...
type _AccountListMetadataOutput AccountListMetadataOutput
...
func NewAccountListMetadataOutput() *AccountListMetadataOutput {
	this := AccountListMetadataOutput{}
	var kind string = "account"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *AccountListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o AccountListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AccountListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AccountListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAccountListMetadataOutput := _AccountListMetadataOutput{}

	err = json.Unmarshal(data, &varAccountListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AccountListMetadataOutput(varAccountListMetadataOutput)
...
type NullableAccountListMetadataOutput struct {
	value *AccountListMetadataOutput
	isSet bool
}

func (v NullableAccountListMetadataOutput) Get() *AccountListMetadataOutput {
	return v.value
}

func (v *NullableAccountListMetadataOutput) Set(val *AccountListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountListMetadataOutput(val *AccountListMetadataOutput) *NullableAccountListMetadataOutput {
	return &NullableAccountListMetadataOutput{value: val, isSet: true}
}

func (v NullableAccountListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
