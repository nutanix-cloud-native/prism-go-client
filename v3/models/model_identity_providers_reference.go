...
// checks if the IdentityProvidersReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProvidersReference{}

// IdentityProvidersReference Identity Provider resource.
...
type _IdentityProvidersReference IdentityProvidersReference
...
func NewIdentityProvidersReference() *IdentityProvidersReference {
	this := IdentityProvidersReference{}
	return &this
}
...
func (o IdentityProvidersReference) MarshalJSON() ([]byte, error) {
...
func (o IdentityProvidersReference) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProvidersReference) UnmarshalJSON(data []byte) (err error) {
	varIdentityProvidersReference := _IdentityProvidersReference{}

	err = json.Unmarshal(data, &varIdentityProvidersReference)

	if err != nil {
		return err
	}

	*o = IdentityProvidersReference(varIdentityProvidersReference)
...
type NullableIdentityProvidersReference struct {
	value *IdentityProvidersReference
	isSet bool
}

func (v NullableIdentityProvidersReference) Get() *IdentityProvidersReference {
	return v.value
}

func (v *NullableIdentityProvidersReference) Set(val *IdentityProvidersReference) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProvidersReference) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProvidersReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProvidersReference(val *IdentityProvidersReference) *NullableIdentityProvidersReference {
	return &NullableIdentityProvidersReference{value: val, isSet: true}
}

func (v NullableIdentityProvidersReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProvidersReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
