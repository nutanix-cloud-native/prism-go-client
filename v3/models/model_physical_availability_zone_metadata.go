...
// checks if the PhysicalAvailabilityZoneMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalAvailabilityZoneMetadata{}

// PhysicalAvailabilityZoneMetadata The physical_availability_zone kind metadata
type PhysicalAvailabilityZoneMetadata struct {
	...
	// physical_availability_zone uuid
	...
	// Categories for the physical_availability_zone. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the physical_availability_zone. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// physical_availability_zone name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PhysicalAvailabilityZoneMetadata PhysicalAvailabilityZoneMetadata
...
func NewPhysicalAvailabilityZoneMetadata(kind string) *PhysicalAvailabilityZoneMetadata {
	this := PhysicalAvailabilityZoneMetadata{}
...
func (o PhysicalAvailabilityZoneMetadata) MarshalJSON() ([]byte, error) {
...
func (o PhysicalAvailabilityZoneMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *PhysicalAvailabilityZoneMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varPhysicalAvailabilityZoneMetadata := _PhysicalAvailabilityZoneMetadata{}

	err = json.Unmarshal(data, &varPhysicalAvailabilityZoneMetadata)

	if err != nil {
		return err
	}

	*o = PhysicalAvailabilityZoneMetadata(varPhysicalAvailabilityZoneMetadata)
...
type NullablePhysicalAvailabilityZoneMetadata struct {
	value *PhysicalAvailabilityZoneMetadata
	isSet bool
}

func (v NullablePhysicalAvailabilityZoneMetadata) Get() *PhysicalAvailabilityZoneMetadata {
	return v.value
}

func (v *NullablePhysicalAvailabilityZoneMetadata) Set(val *PhysicalAvailabilityZoneMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullablePhysicalAvailabilityZoneMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullablePhysicalAvailabilityZoneMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhysicalAvailabilityZoneMetadata(val *PhysicalAvailabilityZoneMetadata) *NullablePhysicalAvailabilityZoneMetadata {
	return &NullablePhysicalAvailabilityZoneMetadata{value: val, isSet: true}
}

func (v NullablePhysicalAvailabilityZoneMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhysicalAvailabilityZoneMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
