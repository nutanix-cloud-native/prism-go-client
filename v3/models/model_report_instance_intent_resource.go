...
// checks if the ReportInstanceIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstanceIntentResource{}

// ReportInstanceIntentResource Response object for intentful operations on a report_instance
type ReportInstanceIntentResource struct {
...
type _ReportInstanceIntentResource ReportInstanceIntentResource
...
func NewReportInstanceIntentResource(metadata ReportInstanceMetadata) *ReportInstanceIntentResource {
	this := ReportInstanceIntentResource{}
...
func (o ReportInstanceIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ReportInstanceIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ReportInstanceIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varReportInstanceIntentResource := _ReportInstanceIntentResource{}

	err = json.Unmarshal(data, &varReportInstanceIntentResource)

	if err != nil {
		return err
	}

	*o = ReportInstanceIntentResource(varReportInstanceIntentResource)
...
type NullableReportInstanceIntentResource struct {
	value *ReportInstanceIntentResource
	isSet bool
}

func (v NullableReportInstanceIntentResource) Get() *ReportInstanceIntentResource {
	return v.value
}

func (v *NullableReportInstanceIntentResource) Set(val *ReportInstanceIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstanceIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstanceIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstanceIntentResource(val *ReportInstanceIntentResource) *NullableReportInstanceIntentResource {
	return &NullableReportInstanceIntentResource{value: val, isSet: true}
}

func (v NullableReportInstanceIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstanceIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
