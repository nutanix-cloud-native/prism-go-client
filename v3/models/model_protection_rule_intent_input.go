...
// checks if the ProtectionRuleIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleIntentInput{}

// ProtectionRuleIntentInput An intentful representation of a protection_rule
type ProtectionRuleIntentInput struct {
	Spec ProtectionRule `json:"spec"`
...
type _ProtectionRuleIntentInput ProtectionRuleIntentInput
...
func NewProtectionRuleIntentInput(spec ProtectionRule, metadata ProtectionRuleMetadata) *ProtectionRuleIntentInput {
	this := ProtectionRuleIntentInput{}
	this.Spec = spec
...
func (o ProtectionRuleIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionRuleIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varProtectionRuleIntentInput := _ProtectionRuleIntentInput{}

	err = json.Unmarshal(data, &varProtectionRuleIntentInput)

	if err != nil {
		return err
	}

	*o = ProtectionRuleIntentInput(varProtectionRuleIntentInput)
...
type NullableProtectionRuleIntentInput struct {
	value *ProtectionRuleIntentInput
	isSet bool
}

func (v NullableProtectionRuleIntentInput) Get() *ProtectionRuleIntentInput {
	return v.value
}

func (v *NullableProtectionRuleIntentInput) Set(val *ProtectionRuleIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleIntentInput(val *ProtectionRuleIntentInput) *NullableProtectionRuleIntentInput {
	return &NullableProtectionRuleIntentInput{value: val, isSet: true}
}

func (v NullableProtectionRuleIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
