...
// checks if the NetworkRuleStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkRuleStatus{}

// NetworkRuleStatus Network rule status
type NetworkRuleStatus struct {
	...
	TcpPortRangeList []PortRangeStatus `json:"tcp_port_range_list,omitempty"`
	// List of UDP ports that are allowed by this rule.
	UdpPortRangeList []PortRangeStatus `json:"udp_port_range_list,omitempty"`
	...
	// List of service groups associated with this rule. The existing fields for protocol or ports is not recommended for and will be deprecated for these new fields at the API level.
	ServiceGroupList []ServiceGroupReference `json:"service_group_list,omitempty"`
	// List of ICMP types and codes allowed by this rule.
	IcmpTypeCodeList []NetworkRuleStatusIcmpTypeCodeListInner `json:"icmp_type_code_list,omitempty"`
	...
	AddressGroupInclusionList []AddressGroupReference `json:"address_group_inclusion_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NetworkRuleStatus NetworkRuleStatus
...
// SetIpSubnet gets a reference to the given IpSubnet and assigns it to the IpSubnet field.
func (o *NetworkRuleStatus) SetIpSubnet(v IpSubnet) {
	o.IpSubnet = &v
}

// GetTcpPortRangeList returns the TcpPortRangeList field value if set, zero value otherwise.
func (o *NetworkRuleStatus) GetTcpPortRangeList() []PortRangeStatus {
	if o == nil || IsNil(o.TcpPortRangeList) {
		var ret []PortRangeStatus
		return ret
	}
	return o.TcpPortRangeList
}

// GetTcpPortRangeListOk returns a tuple with the TcpPortRangeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkRuleStatus) GetTcpPortRangeListOk() ([]PortRangeStatus, bool) {
	if o == nil || IsNil(o.TcpPortRangeList) {
		return nil, false
	}
	return o.TcpPortRangeList, true
}
...
// SetTcpPortRangeList gets a reference to the given []PortRangeStatus and assigns it to the TcpPortRangeList field.
func (o *NetworkRuleStatus) SetTcpPortRangeList(v []PortRangeStatus) {
	o.TcpPortRangeList = v
}

// GetUdpPortRangeList returns the UdpPortRangeList field value if set, zero value otherwise.
func (o *NetworkRuleStatus) GetUdpPortRangeList() []PortRangeStatus {
	if o == nil || IsNil(o.UdpPortRangeList) {
		var ret []PortRangeStatus
		return ret
	}
	return o.UdpPortRangeList
}

// GetUdpPortRangeListOk returns a tuple with the UdpPortRangeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkRuleStatus) GetUdpPortRangeListOk() ([]PortRangeStatus, bool) {
	if o == nil || IsNil(o.UdpPortRangeList) {
		return nil, false
	}
	return o.UdpPortRangeList, true
}
...
// SetUdpPortRangeList gets a reference to the given []PortRangeStatus and assigns it to the UdpPortRangeList field.
func (o *NetworkRuleStatus) SetUdpPortRangeList(v []PortRangeStatus) {
	o.UdpPortRangeList = v
}

// GetPeerSpecificationType returns the PeerSpecificationType field value if set, zero value otherwise.
func (o *NetworkRuleStatus) GetPeerSpecificationType() string {
	if o == nil || IsNil(o.PeerSpecificationType) {
		var ret string
		return ret
	}
	return *o.PeerSpecificationType
}

// GetPeerSpecificationTypeOk returns a tuple with the PeerSpecificationType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkRuleStatus) GetPeerSpecificationTypeOk() (*string, bool) {
	if o == nil || IsNil(o.PeerSpecificationType) {
		return nil, false
	}
	return o.PeerSpecificationType, true
}
...
// SetPeerSpecificationType gets a reference to the given string and assigns it to the PeerSpecificationType field.
func (o *NetworkRuleStatus) SetPeerSpecificationType(v string) {
	o.PeerSpecificationType = &v
}
...
// SetFilter gets a reference to the given CategoryFilter and assigns it to the Filter field.
func (o *NetworkRuleStatus) SetFilter(v CategoryFilter) {
	o.Filter = &v
}

// GetServiceGroupList returns the ServiceGroupList field value if set, zero value otherwise.
func (o *NetworkRuleStatus) GetServiceGroupList() []ServiceGroupReference {
	if o == nil || IsNil(o.ServiceGroupList) {
		var ret []ServiceGroupReference
		return ret
	}
	return o.ServiceGroupList
}

// GetServiceGroupListOk returns a tuple with the ServiceGroupList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkRuleStatus) GetServiceGroupListOk() ([]ServiceGroupReference, bool) {
	if o == nil || IsNil(o.ServiceGroupList) {
		return nil, false
	}
	return o.ServiceGroupList, true
}
...
// SetServiceGroupList gets a reference to the given []ServiceGroupReference and assigns it to the ServiceGroupList field.
func (o *NetworkRuleStatus) SetServiceGroupList(v []ServiceGroupReference) {
	o.ServiceGroupList = v
}

// GetIcmpTypeCodeList returns the IcmpTypeCodeList field value if set, zero value otherwise.
func (o *NetworkRuleStatus) GetIcmpTypeCodeList() []NetworkRuleStatusIcmpTypeCodeListInner {
	if o == nil || IsNil(o.IcmpTypeCodeList) {
		var ret []NetworkRuleStatusIcmpTypeCodeListInner
		return ret
	}
	return o.IcmpTypeCodeList
}

// GetIcmpTypeCodeListOk returns a tuple with the IcmpTypeCodeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkRuleStatus) GetIcmpTypeCodeListOk() ([]NetworkRuleStatusIcmpTypeCodeListInner, bool) {
	if o == nil || IsNil(o.IcmpTypeCodeList) {
		return nil, false
	}
	return o.IcmpTypeCodeList, true
}
...
// SetIcmpTypeCodeList gets a reference to the given []NetworkRuleStatusIcmpTypeCodeListInner and assigns it to the IcmpTypeCodeList field.
func (o *NetworkRuleStatus) SetIcmpTypeCodeList(v []NetworkRuleStatusIcmpTypeCodeListInner) {
	o.IcmpTypeCodeList = v
}
...
// GetAddressGroupInclusionList returns the AddressGroupInclusionList field value if set, zero value otherwise.
func (o *NetworkRuleStatus) GetAddressGroupInclusionList() []AddressGroupReference {
	if o == nil || IsNil(o.AddressGroupInclusionList) {
		var ret []AddressGroupReference
		return ret
	}
	return o.AddressGroupInclusionList
}

// GetAddressGroupInclusionListOk returns a tuple with the AddressGroupInclusionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkRuleStatus) GetAddressGroupInclusionListOk() ([]AddressGroupReference, bool) {
	if o == nil || IsNil(o.AddressGroupInclusionList) {
		return nil, false
	}
	return o.AddressGroupInclusionList, true
}
...
// SetAddressGroupInclusionList gets a reference to the given []AddressGroupReference and assigns it to the AddressGroupInclusionList field.
func (o *NetworkRuleStatus) SetAddressGroupInclusionList(v []AddressGroupReference) {
	o.AddressGroupInclusionList = v
}

func (o NetworkRuleStatus) MarshalJSON() ([]byte, error) {
...
func (o NetworkRuleStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IpSubnet) {
		toSerialize["ip_subnet"] = o.IpSubnet
	}
	if !IsNil(o.TcpPortRangeList) {
		toSerialize["tcp_port_range_list"] = o.TcpPortRangeList
	}
	if !IsNil(o.UdpPortRangeList) {
		toSerialize["udp_port_range_list"] = o.UdpPortRangeList
	}
	if !IsNil(o.PeerSpecificationType) {
		toSerialize["peer_specification_type"] = o.PeerSpecificationType
	}
	if !IsNil(o.Filter) {
		toSerialize["filter"] = o.Filter
	}
	if !IsNil(o.ServiceGroupList) {
		toSerialize["service_group_list"] = o.ServiceGroupList
	}
	if !IsNil(o.IcmpTypeCodeList) {
		toSerialize["icmp_type_code_list"] = o.IcmpTypeCodeList
	}
	...
	if !IsNil(o.AddressGroupInclusionList) {
		toSerialize["address_group_inclusion_list"] = o.AddressGroupInclusionList
	}
...
func (o *NetworkRuleStatus) UnmarshalJSON(data []byte) (err error) {
	varNetworkRuleStatus := _NetworkRuleStatus{}

	err = json.Unmarshal(data, &varNetworkRuleStatus)

	if err != nil {
		return err
	}

	*o = NetworkRuleStatus(varNetworkRuleStatus)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ip_subnet")
		delete(additionalProperties, "tcp_port_range_list")
		delete(additionalProperties, "udp_port_range_list")
		delete(additionalProperties, "peer_specification_type")
		delete(additionalProperties, "filter")
		delete(additionalProperties, "service_group_list")
		delete(additionalProperties, "icmp_type_code_list")
		...
		delete(additionalProperties, "address_group_inclusion_list")
...
type NullableNetworkRuleStatus struct {
	value *NetworkRuleStatus
	isSet bool
}

func (v NullableNetworkRuleStatus) Get() *NetworkRuleStatus {
	return v.value
}

func (v *NullableNetworkRuleStatus) Set(val *NetworkRuleStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkRuleStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkRuleStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkRuleStatus(val *NetworkRuleStatus) *NullableNetworkRuleStatus {
	return &NullableNetworkRuleStatus{value: val, isSet: true}
}

func (v NullableNetworkRuleStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkRuleStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
