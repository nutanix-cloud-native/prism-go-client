...
// checks if the AwsVmStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVmStatus{}

// AwsVmStatus The status of a REST API call. Only used when there is a failure to report. 
type AwsVmStatus struct {
	// The kind name
...
func (o AwsVmStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsVmStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVmStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsVmStatus := _AwsVmStatus{}

	err = json.Unmarshal(data, &varAwsVmStatus)

	if err != nil {
		return err
	}

	*o = AwsVmStatus(varAwsVmStatus)
...
type NullableAwsVmStatus struct {
	value *AwsVmStatus
	isSet bool
}

func (v NullableAwsVmStatus) Get() *AwsVmStatus {
	return v.value
}

func (v *NullableAwsVmStatus) Set(val *AwsVmStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVmStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVmStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVmStatus(val *AwsVmStatus) *NullableAwsVmStatus {
	return &NullableAwsVmStatus{value: val, isSet: true}
}

func (v NullableAwsVmStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVmStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
