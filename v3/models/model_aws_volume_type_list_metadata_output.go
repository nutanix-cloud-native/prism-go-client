...
// checks if the AwsVolumeTypeListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVolumeTypeListMetadataOutput{}

// AwsVolumeTypeListMetadataOutput All api calls that return a list will have this metadata block 
type AwsVolumeTypeListMetadataOutput struct {
	// The kind name
...
type _AwsVolumeTypeListMetadataOutput AwsVolumeTypeListMetadataOutput
...
func NewAwsVolumeTypeListMetadataOutput() *AwsVolumeTypeListMetadataOutput {
	this := AwsVolumeTypeListMetadataOutput{}
	var kind string = "aws_volume_type"
	this.Kind = &kind
	return &this
}
...
func (o AwsVolumeTypeListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsVolumeTypeListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVolumeTypeListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsVolumeTypeListMetadataOutput := _AwsVolumeTypeListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsVolumeTypeListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsVolumeTypeListMetadataOutput(varAwsVolumeTypeListMetadataOutput)
...
type NullableAwsVolumeTypeListMetadataOutput struct {
	value *AwsVolumeTypeListMetadataOutput
	isSet bool
}

func (v NullableAwsVolumeTypeListMetadataOutput) Get() *AwsVolumeTypeListMetadataOutput {
	return v.value
}

func (v *NullableAwsVolumeTypeListMetadataOutput) Set(val *AwsVolumeTypeListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVolumeTypeListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVolumeTypeListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVolumeTypeListMetadataOutput(val *AwsVolumeTypeListMetadataOutput) *NullableAwsVolumeTypeListMetadataOutput {
	return &NullableAwsVolumeTypeListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsVolumeTypeListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVolumeTypeListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
