...
// checks if the RecoveryPlanJobIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobIntentInput{}

// RecoveryPlanJobIntentInput An intentful representation of a recovery_plan_job
...
type _RecoveryPlanJobIntentInput RecoveryPlanJobIntentInput
...
func NewRecoveryPlanJobIntentInput(spec RecoveryPlanJob, metadata RecoveryPlanJobMetadata) *RecoveryPlanJobIntentInput {
	this := RecoveryPlanJobIntentInput{}
	this.Spec = spec
...
func (o RecoveryPlanJobIntentInput) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobIntentInput := _RecoveryPlanJobIntentInput{}

	err = json.Unmarshal(data, &varRecoveryPlanJobIntentInput)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobIntentInput(varRecoveryPlanJobIntentInput)
...
type NullableRecoveryPlanJobIntentInput struct {
	value *RecoveryPlanJobIntentInput
	isSet bool
}

func (v NullableRecoveryPlanJobIntentInput) Get() *RecoveryPlanJobIntentInput {
	return v.value
}

func (v *NullableRecoveryPlanJobIntentInput) Set(val *RecoveryPlanJobIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobIntentInput(val *RecoveryPlanJobIntentInput) *NullableRecoveryPlanJobIntentInput {
	return &NullableRecoveryPlanJobIntentInput{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
