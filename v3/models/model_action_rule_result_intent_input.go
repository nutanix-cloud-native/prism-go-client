...
// checks if the ActionRuleResultIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResultIntentInput{}

// ActionRuleResultIntentInput An intentful representation of a action_rule_result
type ActionRuleResultIntentInput struct {
	Spec ActionRuleResult `json:"spec"`
...
type _ActionRuleResultIntentInput ActionRuleResultIntentInput
...
func NewActionRuleResultIntentInput(spec ActionRuleResult, metadata ActionRuleResultMetadata) *ActionRuleResultIntentInput {
	this := ActionRuleResultIntentInput{}
	this.Spec = spec
...
func (o ActionRuleResultIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResultIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleResultIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleResultIntentInput := _ActionRuleResultIntentInput{}

	err = json.Unmarshal(data, &varActionRuleResultIntentInput)

	if err != nil {
		return err
	}

	*o = ActionRuleResultIntentInput(varActionRuleResultIntentInput)
...
type NullableActionRuleResultIntentInput struct {
	value *ActionRuleResultIntentInput
	isSet bool
}

func (v NullableActionRuleResultIntentInput) Get() *ActionRuleResultIntentInput {
	return v.value
}

func (v *NullableActionRuleResultIntentInput) Set(val *ActionRuleResultIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResultIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResultIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResultIntentInput(val *ActionRuleResultIntentInput) *NullableActionRuleResultIntentInput {
	return &NullableActionRuleResultIntentInput{value: val, isSet: true}
}

func (v NullableActionRuleResultIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResultIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
