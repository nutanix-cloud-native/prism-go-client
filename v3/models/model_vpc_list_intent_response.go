...
// checks if the VpcListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcListIntentResponse{}

// VpcListIntentResponse Response object for intentful operation of vpcs
type VpcListIntentResponse struct {
	Entities []VpcIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata VpcListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VpcListIntentResponse VpcListIntentResponse
...
// SetEntities gets a reference to the given []VpcIntentResource and assigns it to the Entities field.
...
func (o VpcListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VpcListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VpcListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVpcListIntentResponse := _VpcListIntentResponse{}

	err = json.Unmarshal(data, &varVpcListIntentResponse)

	if err != nil {
		return err
	}

	*o = VpcListIntentResponse(varVpcListIntentResponse)
...
type NullableVpcListIntentResponse struct {
	value *VpcListIntentResponse
	isSet bool
}

func (v NullableVpcListIntentResponse) Get() *VpcListIntentResponse {
	return v.value
}

func (v *NullableVpcListIntentResponse) Set(val *VpcListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcListIntentResponse(val *VpcListIntentResponse) *NullableVpcListIntentResponse {
	return &NullableVpcListIntentResponse{value: val, isSet: true}
}

func (v NullableVpcListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
