...
// checks if the AppPublishedServiceReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPublishedServiceReference{}

// AppPublishedServiceReference The reference to a app_published_service
type AppPublishedServiceReference struct {
	// The kind name
...
type _AppPublishedServiceReference AppPublishedServiceReference
...
func NewAppPublishedServiceReference(kind string, uUID string) *AppPublishedServiceReference {
	this := AppPublishedServiceReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o AppPublishedServiceReference) MarshalJSON() ([]byte, error) {
...
func (o AppPublishedServiceReference) ToMap() (map[string]interface{}, error) {
...
func (o *AppPublishedServiceReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPublishedServiceReference := _AppPublishedServiceReference{}

	err = json.Unmarshal(data, &varAppPublishedServiceReference)

	if err != nil {
		return err
	}

	*o = AppPublishedServiceReference(varAppPublishedServiceReference)
...
type NullableAppPublishedServiceReference struct {
	value *AppPublishedServiceReference
	isSet bool
}

func (v NullableAppPublishedServiceReference) Get() *AppPublishedServiceReference {
	return v.value
}

func (v *NullableAppPublishedServiceReference) Set(val *AppPublishedServiceReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPublishedServiceReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPublishedServiceReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPublishedServiceReference(val *AppPublishedServiceReference) *NullableAppPublishedServiceReference {
	return &NullableAppPublishedServiceReference{value: val, isSet: true}
}

func (v NullableAppPublishedServiceReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPublishedServiceReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
