...
// checks if the ActionTriggerTypeStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTriggerTypeStatus{}

// ActionTriggerTypeStatus The status of a REST API call. Only used when there is a failure to report. 
type ActionTriggerTypeStatus struct {
	// The kind name
...
type _ActionTriggerTypeStatus ActionTriggerTypeStatus
...
func (o ActionTriggerTypeStatus) MarshalJSON() ([]byte, error) {
...
func (o ActionTriggerTypeStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTriggerTypeStatus) UnmarshalJSON(data []byte) (err error) {
	varActionTriggerTypeStatus := _ActionTriggerTypeStatus{}

	err = json.Unmarshal(data, &varActionTriggerTypeStatus)

	if err != nil {
		return err
	}

	*o = ActionTriggerTypeStatus(varActionTriggerTypeStatus)
...
type NullableActionTriggerTypeStatus struct {
	value *ActionTriggerTypeStatus
	isSet bool
}

func (v NullableActionTriggerTypeStatus) Get() *ActionTriggerTypeStatus {
	return v.value
}

func (v *NullableActionTriggerTypeStatus) Set(val *ActionTriggerTypeStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTriggerTypeStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTriggerTypeStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTriggerTypeStatus(val *ActionTriggerTypeStatus) *NullableActionTriggerTypeStatus {
	return &NullableActionTriggerTypeStatus{value: val, isSet: true}
}

func (v NullableActionTriggerTypeStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTriggerTypeStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
