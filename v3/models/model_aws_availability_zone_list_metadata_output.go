...
// checks if the AwsAvailabilityZoneListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsAvailabilityZoneListMetadataOutput{}

// AwsAvailabilityZoneListMetadataOutput All api calls that return a list will have this metadata block 
type AwsAvailabilityZoneListMetadataOutput struct {
	// The kind name
...
type _AwsAvailabilityZoneListMetadataOutput AwsAvailabilityZoneListMetadataOutput
...
func NewAwsAvailabilityZoneListMetadataOutput() *AwsAvailabilityZoneListMetadataOutput {
	this := AwsAvailabilityZoneListMetadataOutput{}
	var kind string = "aws_availability_zone"
	this.Kind = &kind
	return &this
}
...
func (o *AwsAvailabilityZoneListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *AwsAvailabilityZoneListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o AwsAvailabilityZoneListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsAvailabilityZoneListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsAvailabilityZoneListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsAvailabilityZoneListMetadataOutput := _AwsAvailabilityZoneListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsAvailabilityZoneListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsAvailabilityZoneListMetadataOutput(varAwsAvailabilityZoneListMetadataOutput)
...
type NullableAwsAvailabilityZoneListMetadataOutput struct {
	value *AwsAvailabilityZoneListMetadataOutput
	isSet bool
}

func (v NullableAwsAvailabilityZoneListMetadataOutput) Get() *AwsAvailabilityZoneListMetadataOutput {
	return v.value
}

func (v *NullableAwsAvailabilityZoneListMetadataOutput) Set(val *AwsAvailabilityZoneListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsAvailabilityZoneListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsAvailabilityZoneListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsAvailabilityZoneListMetadataOutput(val *AwsAvailabilityZoneListMetadataOutput) *NullableAwsAvailabilityZoneListMetadataOutput {
	return &NullableAwsAvailabilityZoneListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsAvailabilityZoneListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsAvailabilityZoneListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
