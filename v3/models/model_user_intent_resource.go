...
// checks if the UserIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserIntentResource{}

// UserIntentResource Response object for intentful operations on a user
type UserIntentResource struct {
	Status *UserDefStatus `json:"status,omitempty"`
	Spec *User `json:"spec,omitempty"`
...
type _UserIntentResource UserIntentResource
...
// SetStatus gets a reference to the given UserDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given User and assigns it to the Spec field.
...
func (o UserIntentResource) MarshalJSON() ([]byte, error) {
...
func (o UserIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *UserIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varUserIntentResource := _UserIntentResource{}

	err = json.Unmarshal(data, &varUserIntentResource)

	if err != nil {
		return err
	}

	*o = UserIntentResource(varUserIntentResource)
...
type NullableUserIntentResource struct {
	value *UserIntentResource
	isSet bool
}

func (v NullableUserIntentResource) Get() *UserIntentResource {
	return v.value
}

func (v *NullableUserIntentResource) Set(val *UserIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableUserIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableUserIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserIntentResource(val *UserIntentResource) *NullableUserIntentResource {
	return &NullableUserIntentResource{value: val, isSet: true}
}

func (v NullableUserIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
