...
// checks if the DatacenterStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterStatus{}

// DatacenterStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _DatacenterStatus DatacenterStatus
...
func (o DatacenterStatus) MarshalJSON() ([]byte, error) {
...
func (o DatacenterStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DatacenterStatus) UnmarshalJSON(data []byte) (err error) {
	varDatacenterStatus := _DatacenterStatus{}

	err = json.Unmarshal(data, &varDatacenterStatus)

	if err != nil {
		return err
	}

	*o = DatacenterStatus(varDatacenterStatus)
...
type NullableDatacenterStatus struct {
	value *DatacenterStatus
	isSet bool
}

func (v NullableDatacenterStatus) Get() *DatacenterStatus {
	return v.value
}

func (v *NullableDatacenterStatus) Set(val *DatacenterStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterStatus(val *DatacenterStatus) *NullableDatacenterStatus {
	return &NullableDatacenterStatus{value: val, isSet: true}
}

func (v NullableDatacenterStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
