...
// checks if the UdpStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UdpStatus{}

// UdpStatus UDP parameters to be matched in routing policy
...
func (o UdpStatus) MarshalJSON() ([]byte, error) {
...
func (o UdpStatus) ToMap() (map[string]interface{}, error) {
...
func (o *UdpStatus) UnmarshalJSON(data []byte) (err error) {
	varUdpStatus := _UdpStatus{}

	err = json.Unmarshal(data, &varUdpStatus)

	if err != nil {
		return err
	}

	*o = UdpStatus(varUdpStatus)
...
type NullableUdpStatus struct {
	value *UdpStatus
	isSet bool
}

func (v NullableUdpStatus) Get() *UdpStatus {
	return v.value
}

func (v *NullableUdpStatus) Set(val *UdpStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableUdpStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableUdpStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUdpStatus(val *UdpStatus) *NullableUdpStatus {
	return &NullableUdpStatus{value: val, isSet: true}
}

func (v NullableUdpStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUdpStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
