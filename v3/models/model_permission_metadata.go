...
// checks if the PermissionMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionMetadata{}

// PermissionMetadata The permission kind metadata
type PermissionMetadata struct {
	...
	// Categories for the permission. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the permission. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _PermissionMetadata PermissionMetadata
...
func (o PermissionMetadata) MarshalJSON() ([]byte, error) {
...
func (o PermissionMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *PermissionMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varPermissionMetadata := _PermissionMetadata{}

	err = json.Unmarshal(data, &varPermissionMetadata)

	if err != nil {
		return err
	}

	*o = PermissionMetadata(varPermissionMetadata)
...
type NullablePermissionMetadata struct {
	value *PermissionMetadata
	isSet bool
}

func (v NullablePermissionMetadata) Get() *PermissionMetadata {
	return v.value
}

func (v *NullablePermissionMetadata) Set(val *PermissionMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionMetadata(val *PermissionMetadata) *NullablePermissionMetadata {
	return &NullablePermissionMetadata{value: val, isSet: true}
}

func (v NullablePermissionMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
