...
// checks if the IdentityProviderMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderMetadata{}

// IdentityProviderMetadata The identity_provider kind metadata
type IdentityProviderMetadata struct {
	...
	// Categories for the identity_provider. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the identity_provider. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _IdentityProviderMetadata IdentityProviderMetadata
...
func (o *IdentityProviderMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *IdentityProviderMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *IdentityProviderMetadata) SetName(v string) {
	o.Name = &v
}

func (o IdentityProviderMetadata) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProviderMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varIdentityProviderMetadata := _IdentityProviderMetadata{}

	err = json.Unmarshal(data, &varIdentityProviderMetadata)

	if err != nil {
		return err
	}

	*o = IdentityProviderMetadata(varIdentityProviderMetadata)
...
type NullableIdentityProviderMetadata struct {
	value *IdentityProviderMetadata
	isSet bool
}

func (v NullableIdentityProviderMetadata) Get() *IdentityProviderMetadata {
	return v.value
}

func (v *NullableIdentityProviderMetadata) Set(val *IdentityProviderMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderMetadata(val *IdentityProviderMetadata) *NullableIdentityProviderMetadata {
	return &NullableIdentityProviderMetadata{value: val, isSet: true}
}

func (v NullableIdentityProviderMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
