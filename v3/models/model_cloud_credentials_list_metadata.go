...
// checks if the CloudCredentialsListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCredentialsListMetadata{}

// CloudCredentialsListMetadata All api calls that return a list will have this metadata block as input 
...
type _CloudCredentialsListMetadata CloudCredentialsListMetadata
...
func NewCloudCredentialsListMetadata() *CloudCredentialsListMetadata {
	this := CloudCredentialsListMetadata{}
...
func (o CloudCredentialsListMetadata) MarshalJSON() ([]byte, error) {
...
func (o CloudCredentialsListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CloudCredentialsListMetadata) UnmarshalJSON(data []byte) (err error) {
	varCloudCredentialsListMetadata := _CloudCredentialsListMetadata{}

	err = json.Unmarshal(data, &varCloudCredentialsListMetadata)

	if err != nil {
		return err
	}

	*o = CloudCredentialsListMetadata(varCloudCredentialsListMetadata)
...
type NullableCloudCredentialsListMetadata struct {
	value *CloudCredentialsListMetadata
	isSet bool
}

func (v NullableCloudCredentialsListMetadata) Get() *CloudCredentialsListMetadata {
	return v.value
}

func (v *NullableCloudCredentialsListMetadata) Set(val *CloudCredentialsListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCredentialsListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCredentialsListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCredentialsListMetadata(val *CloudCredentialsListMetadata) *NullableCloudCredentialsListMetadata {
	return &NullableCloudCredentialsListMetadata{value: val, isSet: true}
}

func (v NullableCloudCredentialsListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCredentialsListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
