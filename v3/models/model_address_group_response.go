...
// checks if the AddressGroupResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressGroupResponse{}

// AddressGroupResponse Address group response object for GET calls. This can have an associated policies list in the future.
...
type _AddressGroupResponse AddressGroupResponse
...
// GetAddressGroup returns the AddressGroup field value if set, zero value otherwise.
func (o *AddressGroupResponse) GetAddressGroup() AddressGroup {
	if o == nil || IsNil(o.AddressGroup) {
		var ret AddressGroup
		return ret
	}
	return *o.AddressGroup
}

// GetAddressGroupOk returns a tuple with the AddressGroup field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AddressGroupResponse) GetAddressGroupOk() (*AddressGroup, bool) {
	if o == nil || IsNil(o.AddressGroup) {
		return nil, false
	}
	return o.AddressGroup, true
}
...
// SetAddressGroup gets a reference to the given AddressGroup and assigns it to the AddressGroup field.
...
func (o AddressGroupResponse) MarshalJSON() ([]byte, error) {
...
func (o AddressGroupResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AddressGroup) {
		toSerialize["address_group"] = o.AddressGroup
	}
	if !IsNil(o.UUID) {
...
func (o *AddressGroupResponse) UnmarshalJSON(data []byte) (err error) {
	varAddressGroupResponse := _AddressGroupResponse{}

	err = json.Unmarshal(data, &varAddressGroupResponse)

	if err != nil {
		return err
	}

	*o = AddressGroupResponse(varAddressGroupResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "address_group")
...
type NullableAddressGroupResponse struct {
	value *AddressGroupResponse
	isSet bool
}

func (v NullableAddressGroupResponse) Get() *AddressGroupResponse {
	return v.value
}

func (v *NullableAddressGroupResponse) Set(val *AddressGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressGroupResponse(val *AddressGroupResponse) *NullableAddressGroupResponse {
	return &NullableAddressGroupResponse{value: val, isSet: true}
}

func (v NullableAddressGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
