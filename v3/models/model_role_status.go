...
// checks if the RoleStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleStatus{}

// RoleStatus The status of a REST API call. Only used when there is a failure to report. 
...
func (o RoleStatus) MarshalJSON() ([]byte, error) {
...
func (o RoleStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RoleStatus) UnmarshalJSON(data []byte) (err error) {
	varRoleStatus := _RoleStatus{}

	err = json.Unmarshal(data, &varRoleStatus)

	if err != nil {
		return err
	}

	*o = RoleStatus(varRoleStatus)
