...
// checks if the AssignmentRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssignmentRule{}

// AssignmentRule Rule defintion for entity selection.
type AssignmentRule struct {
	// List of entities to be excluded from category assignment.
	ExclusionList []Reference `json:"exclusion_list,omitempty"`
	// List of entities to be included in category assignment.
	InclusionList []Reference `json:"inclusion_list,omitempty"`
	// Name of the assignment rule.
	Name *string `json:"name,omitempty"`
	// List of selection criteria for category assignment.
	SelectionCriteriaList []SelectionCriteria `json:"selection_criteria_list"`
	// Description of the assignment rule.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AssignmentRule AssignmentRule
...
// GetExclusionList returns the ExclusionList field value if set, zero value otherwise.
func (o *AssignmentRule) GetExclusionList() []Reference {
	if o == nil || IsNil(o.ExclusionList) {
		var ret []Reference
		return ret
	}
	return o.ExclusionList
}

// GetExclusionListOk returns a tuple with the ExclusionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AssignmentRule) GetExclusionListOk() ([]Reference, bool) {
	if o == nil || IsNil(o.ExclusionList) {
		return nil, false
	}
	return o.ExclusionList, true
}
...
// SetExclusionList gets a reference to the given []Reference and assigns it to the ExclusionList field.
func (o *AssignmentRule) SetExclusionList(v []Reference) {
	o.ExclusionList = v
}

// GetInclusionList returns the InclusionList field value if set, zero value otherwise.
func (o *AssignmentRule) GetInclusionList() []Reference {
	if o == nil || IsNil(o.InclusionList) {
		var ret []Reference
		return ret
	}
	return o.InclusionList
}

// GetInclusionListOk returns a tuple with the InclusionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AssignmentRule) GetInclusionListOk() ([]Reference, bool) {
	if o == nil || IsNil(o.InclusionList) {
		return nil, false
	}
	return o.InclusionList, true
}
...
// SetInclusionList gets a reference to the given []Reference and assigns it to the InclusionList field.
...
// GetSelectionCriteriaList returns the SelectionCriteriaList field value
func (o *AssignmentRule) GetSelectionCriteriaList() []SelectionCriteria {
	...
	return o.SelectionCriteriaList
}

// GetSelectionCriteriaListOk returns a tuple with the SelectionCriteriaList field value
// and a boolean to check if the value has been set.
func (o *AssignmentRule) GetSelectionCriteriaListOk() ([]SelectionCriteria, bool) {
	if o == nil {
		return nil, false
	}
	return o.SelectionCriteriaList, true
}

// SetSelectionCriteriaList sets field value
func (o *AssignmentRule) SetSelectionCriteriaList(v []SelectionCriteria) {
	o.SelectionCriteriaList = v
}
...
func (o AssignmentRule) MarshalJSON() ([]byte, error) {
...
func (o AssignmentRule) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ExclusionList) {
		toSerialize["exclusion_list"] = o.ExclusionList
	}
	if !IsNil(o.InclusionList) {
		toSerialize["inclusion_list"] = o.InclusionList
	}
	if !IsNil(o.Name) {
		toSerialize["name"] = o.Name
	}
	toSerialize["selection_criteria_list"] = o.SelectionCriteriaList
...
func (o *AssignmentRule) UnmarshalJSON(data []byte) (err error) {
	...
	varAssignmentRule := _AssignmentRule{}

	err = json.Unmarshal(data, &varAssignmentRule)

	if err != nil {
		return err
	}

	*o = AssignmentRule(varAssignmentRule)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "exclusion_list")
		delete(additionalProperties, "inclusion_list")
		delete(additionalProperties, "name")
		delete(additionalProperties, "selection_criteria_list")
...
type NullableAssignmentRule struct {
	value *AssignmentRule
	isSet bool
}

func (v NullableAssignmentRule) Get() *AssignmentRule {
	return v.value
}

func (v *NullableAssignmentRule) Set(val *AssignmentRule) {
	v.value = val
	v.isSet = true
}

func (v NullableAssignmentRule) IsSet() bool {
	return v.isSet
}

func (v *NullableAssignmentRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssignmentRule(val *AssignmentRule) *NullableAssignmentRule {
	return &NullableAssignmentRule{value: val, isSet: true}
}

func (v NullableAssignmentRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssignmentRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
