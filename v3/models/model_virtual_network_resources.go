...
// checks if the VirtualNetworkResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkResources{}

// VirtualNetworkResources Virtual network resources
...
type _VirtualNetworkResources VirtualNetworkResources
...
// SetExternalSubnetList gets a reference to the given []ExternalSubnet and assigns it to the ExternalSubnetList field.
...
func (o VirtualNetworkResources) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkResources) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualNetworkResources) UnmarshalJSON(data []byte) (err error) {
	varVirtualNetworkResources := _VirtualNetworkResources{}

	err = json.Unmarshal(data, &varVirtualNetworkResources)

	if err != nil {
		return err
	}

	*o = VirtualNetworkResources(varVirtualNetworkResources)
...
type NullableVirtualNetworkResources struct {
	value *VirtualNetworkResources
	isSet bool
}

func (v NullableVirtualNetworkResources) Get() *VirtualNetworkResources {
	return v.value
}

func (v *NullableVirtualNetworkResources) Set(val *VirtualNetworkResources) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkResources) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkResources(val *VirtualNetworkResources) *NullableVirtualNetworkResources {
	return &NullableVirtualNetworkResources{value: val, isSet: true}
}

func (v NullableVirtualNetworkResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
