...
// checks if the UserUsageInProjects type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserUsageInProjects{}

// UserUsageInProjects User usage in project definition.
type UserUsageInProjects struct {
	ProjectResourceDomainList []UserUsageInProjectsProjectResourceDomainListInner `json:"project_resource_domain_list,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	AdditionalProperties map[string]interface{}
}

type _UserUsageInProjects UserUsageInProjects
...
// GetProjectResourceDomainList returns the ProjectResourceDomainList field value if set, zero value otherwise.
func (o *UserUsageInProjects) GetProjectResourceDomainList() []UserUsageInProjectsProjectResourceDomainListInner {
	if o == nil || IsNil(o.ProjectResourceDomainList) {
		var ret []UserUsageInProjectsProjectResourceDomainListInner
		return ret
	}
	return o.ProjectResourceDomainList
}

// GetProjectResourceDomainListOk returns a tuple with the ProjectResourceDomainList field value if set, nil otherwise
...
func (o *UserUsageInProjects) GetProjectResourceDomainListOk() ([]UserUsageInProjectsProjectResourceDomainListInner, bool) {
	...
	return o.ProjectResourceDomainList, true
}
...
// SetProjectResourceDomainList gets a reference to the given []UserUsageInProjectsProjectResourceDomainListInner and assigns it to the ProjectResourceDomainList field.
func (o *UserUsageInProjects) SetProjectResourceDomainList(v []UserUsageInProjectsProjectResourceDomainListInner) {
	o.ProjectResourceDomainList = v
}
...
func (o UserUsageInProjects) MarshalJSON() ([]byte, error) {
...
func (o UserUsageInProjects) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ProjectResourceDomainList) {
		toSerialize["project_resource_domain_list"] = o.ProjectResourceDomainList
	}
...
func (o *UserUsageInProjects) UnmarshalJSON(data []byte) (err error) {
	...
	varUserUsageInProjects := _UserUsageInProjects{}

	err = json.Unmarshal(data, &varUserUsageInProjects)

	if err != nil {
		return err
	}

	*o = UserUsageInProjects(varUserUsageInProjects)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "project_resource_domain_list")
...
type NullableUserUsageInProjects struct {
	value *UserUsageInProjects
	isSet bool
}

func (v NullableUserUsageInProjects) Get() *UserUsageInProjects {
	return v.value
}

func (v *NullableUserUsageInProjects) Set(val *UserUsageInProjects) {
	v.value = val
	v.isSet = true
}

func (v NullableUserUsageInProjects) IsSet() bool {
	return v.isSet
}

func (v *NullableUserUsageInProjects) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserUsageInProjects(val *UserUsageInProjects) *NullableUserUsageInProjects {
	return &NullableUserUsageInProjects{value: val, isSet: true}
}

func (v NullableUserUsageInProjects) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserUsageInProjects) UnmarshalJSON(src []byte) error {
	v.isSet = true
