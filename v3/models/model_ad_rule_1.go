...
// checks if the ADRule1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADRule1{}

// ADRule1 These rules govern what flows are allowed for AD categories. Target group is a required attribute. Empty inbound_allow_list will not allow anything into the target group. Empty outbound_allow_list will not allow anything from the target group. 
type ADRule1 struct {
...
func (o ADRule1) MarshalJSON() ([]byte, error) {
...
func (o ADRule1) ToMap() (map[string]interface{}, error) {
...
func (o *ADRule1) UnmarshalJSON(data []byte) (err error) {
	varADRule1 := _ADRule1{}

	err = json.Unmarshal(data, &varADRule1)

	if err != nil {
		return err
	}

	*o = ADRule1(varADRule1)
...
type NullableADRule1 struct {
	value *ADRule1
	isSet bool
}

func (v NullableADRule1) Get() *ADRule1 {
	return v.value
}

func (v *NullableADRule1) Set(val *ADRule1) {
	v.value = val
	v.isSet = true
}

func (v NullableADRule1) IsSet() bool {
	return v.isSet
}

func (v *NullableADRule1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableADRule1(val *ADRule1) *NullableADRule1 {
	return &NullableADRule1{value: val, isSet: true}
}

func (v NullableADRule1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableADRule1) UnmarshalJSON(src []byte) error {
	v.isSet = true
