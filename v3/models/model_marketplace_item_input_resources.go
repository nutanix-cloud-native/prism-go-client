...
// checks if the MarketplaceItemInputResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemInputResources{}

// MarketplaceItemInputResources Description of the marketplace item
type MarketplaceItemInputResources struct {
...
type _MarketplaceItemInputResources MarketplaceItemInputResources
...
func NewMarketplaceItemInputResources(appBlueprintTemplate MarketplaceItemInputResourcesAppBlueprintTemplate, author string) *MarketplaceItemInputResources {
	this := MarketplaceItemInputResources{}
...
func (o MarketplaceItemInputResources) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemInputResources) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItemInputResources) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceItemInputResources := _MarketplaceItemInputResources{}

	err = json.Unmarshal(data, &varMarketplaceItemInputResources)

	if err != nil {
		return err
	}

	*o = MarketplaceItemInputResources(varMarketplaceItemInputResources)
...
type NullableMarketplaceItemInputResources struct {
	value *MarketplaceItemInputResources
	isSet bool
}

func (v NullableMarketplaceItemInputResources) Get() *MarketplaceItemInputResources {
	return v.value
}

func (v *NullableMarketplaceItemInputResources) Set(val *MarketplaceItemInputResources) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemInputResources) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemInputResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemInputResources(val *MarketplaceItemInputResources) *NullableMarketplaceItemInputResources {
	return &NullableMarketplaceItemInputResources{value: val, isSet: true}
}

func (v NullableMarketplaceItemInputResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemInputResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
