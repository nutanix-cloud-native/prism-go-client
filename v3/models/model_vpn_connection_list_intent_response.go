...
// checks if the VpnConnectionListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionListIntentResponse{}

// VpnConnectionListIntentResponse Response object for intentful operation of vpn_connections
type VpnConnectionListIntentResponse struct {
	Entities []VpnConnectionIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata VpnConnectionListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VpnConnectionListIntentResponse VpnConnectionListIntentResponse
...
func NewVpnConnectionListIntentResponse(apiVersion string, metadata VpnConnectionListMetadataOutput) *VpnConnectionListIntentResponse {
	this := VpnConnectionListIntentResponse{}
...
func (o *VpnConnectionListIntentResponse) GetEntities() []VpnConnectionIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []VpnConnectionIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []VpnConnectionIntentResource and assigns it to the Entities field.
...
func (o *VpnConnectionListIntentResponse) GetMetadata() VpnConnectionListMetadataOutput {
	if o == nil {
		var ret VpnConnectionListMetadataOutput
		return ret
	}
...
func (o VpnConnectionListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnectionListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnConnectionListIntentResponse := _VpnConnectionListIntentResponse{}

	err = json.Unmarshal(data, &varVpnConnectionListIntentResponse)

	if err != nil {
		return err
	}

	*o = VpnConnectionListIntentResponse(varVpnConnectionListIntentResponse)
...
type NullableVpnConnectionListIntentResponse struct {
	value *VpnConnectionListIntentResponse
	isSet bool
}

func (v NullableVpnConnectionListIntentResponse) Get() *VpnConnectionListIntentResponse {
	return v.value
}

func (v *NullableVpnConnectionListIntentResponse) Set(val *VpnConnectionListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionListIntentResponse(val *VpnConnectionListIntentResponse) *NullableVpnConnectionListIntentResponse {
	return &NullableVpnConnectionListIntentResponse{value: val, isSet: true}
}

func (v NullableVpnConnectionListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
