...
// checks if the BlueprintIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintIntentInput{}

// BlueprintIntentInput An intentful representation of a blueprint
type BlueprintIntentInput struct {
...
type _BlueprintIntentInput BlueprintIntentInput
...
func (o BlueprintIntentInput) MarshalJSON() ([]byte, error) {
...
func (o BlueprintIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintIntentInput := _BlueprintIntentInput{}

	err = json.Unmarshal(data, &varBlueprintIntentInput)

	if err != nil {
		return err
	}

	*o = BlueprintIntentInput(varBlueprintIntentInput)
...
type NullableBlueprintIntentInput struct {
	value *BlueprintIntentInput
	isSet bool
}

func (v NullableBlueprintIntentInput) Get() *BlueprintIntentInput {
	return v.value
}

func (v *NullableBlueprintIntentInput) Set(val *BlueprintIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintIntentInput(val *BlueprintIntentInput) *NullableBlueprintIntentInput {
	return &NullableBlueprintIntentInput{value: val, isSet: true}
}

func (v NullableBlueprintIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
