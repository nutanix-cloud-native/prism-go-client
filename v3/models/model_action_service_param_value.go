...
// checks if the ActionServiceParamValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionServiceParamValue{}

// ActionServiceParamValue Scalar value object that handles different types
type ActionServiceParamValue struct {
	DoubleValue *float64 `json:"double_value,omitempty"`
	FileValue *ActionServiceFileValue `json:"file_value,omitempty"`
...
type _ActionServiceParamValue ActionServiceParamValue
...
// GetFileValue returns the FileValue field value if set, zero value otherwise.
func (o *ActionServiceParamValue) GetFileValue() ActionServiceFileValue {
	if o == nil || IsNil(o.FileValue) {
		var ret ActionServiceFileValue
		return ret
	}
	return *o.FileValue
}

// GetFileValueOk returns a tuple with the FileValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionServiceParamValue) GetFileValueOk() (*ActionServiceFileValue, bool) {
	if o == nil || IsNil(o.FileValue) {
		return nil, false
	}
	return o.FileValue, true
}
...
// SetFileValue gets a reference to the given ActionServiceFileValue and assigns it to the FileValue field.
...
func (o *ActionServiceParamValue) GetBytesValue() string {
...
// SetEntityInfo gets a reference to the given EntityInfo and assigns it to the EntityInfo field.
...
func (o ActionServiceParamValue) MarshalJSON() ([]byte, error) {
...
func (o ActionServiceParamValue) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DoubleValue) {
		toSerialize["double_value"] = o.DoubleValue
	}
	if !IsNil(o.FileValue) {
		toSerialize["file_value"] = o.FileValue
	}
	if !IsNil(o.StringValue) {
		toSerialize["string_value"] = o.StringValue
	}
	if !IsNil(o.BytesValue) {
		toSerialize["bytes_value"] = o.BytesValue
	}
	if !IsNil(o.LongValue) {
		toSerialize["long_value"] = o.LongValue
	}
...
func (o *ActionServiceParamValue) UnmarshalJSON(data []byte) (err error) {
	varActionServiceParamValue := _ActionServiceParamValue{}

	err = json.Unmarshal(data, &varActionServiceParamValue)

	if err != nil {
		return err
	}

	*o = ActionServiceParamValue(varActionServiceParamValue)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "double_value")
		delete(additionalProperties, "file_value")
		delete(additionalProperties, "string_value")
		delete(additionalProperties, "bytes_value")
		delete(additionalProperties, "long_value")
		delete(additionalProperties, "entity_info")
		delete(additionalProperties, "bool_value")
...
type NullableActionServiceParamValue struct {
	value *ActionServiceParamValue
	isSet bool
}

func (v NullableActionServiceParamValue) Get() *ActionServiceParamValue {
	return v.value
}

func (v *NullableActionServiceParamValue) Set(val *ActionServiceParamValue) {
	v.value = val
	v.isSet = true
}

func (v NullableActionServiceParamValue) IsSet() bool {
	return v.isSet
}

func (v *NullableActionServiceParamValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionServiceParamValue(val *ActionServiceParamValue) *NullableActionServiceParamValue {
	return &NullableActionServiceParamValue{value: val, isSet: true}
}

func (v NullableActionServiceParamValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionServiceParamValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
