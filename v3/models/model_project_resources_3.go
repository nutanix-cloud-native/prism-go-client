...
// checks if the ProjectResources3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectResources3{}

// ProjectResources3 struct for ProjectResources3
type ProjectResources3 struct {
	...
	// List of identity providers references in the project
...
type _ProjectResources3 ProjectResources3
...
func (o ProjectResources3) MarshalJSON() ([]byte, error) {
...
func (o ProjectResources3) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectResources3) UnmarshalJSON(data []byte) (err error) {
	varProjectResources3 := _ProjectResources3{}

	err = json.Unmarshal(data, &varProjectResources3)

	if err != nil {
		return err
	}

	*o = ProjectResources3(varProjectResources3)
...
type NullableProjectResources3 struct {
	value *ProjectResources3
	isSet bool
}

func (v NullableProjectResources3) Get() *ProjectResources3 {
	return v.value
}

func (v *NullableProjectResources3) Set(val *ProjectResources3) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectResources3) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectResources3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectResources3(val *ProjectResources3) *NullableProjectResources3 {
	return &NullableProjectResources3{value: val, isSet: true}
}

func (v NullableProjectResources3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectResources3) UnmarshalJSON(src []byte) error {
	v.isSet = true
