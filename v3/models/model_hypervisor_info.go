...
// checks if the HypervisorInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervisorInfo{}

// HypervisorInfo Hypervisor info for a cluster.
...
type _HypervisorInfo HypervisorInfo
...
func (o HypervisorInfo) MarshalJSON() ([]byte, error) {
...
func (o HypervisorInfo) ToMap() (map[string]interface{}, error) {
...
func (o *HypervisorInfo) UnmarshalJSON(data []byte) (err error) {
	varHypervisorInfo := _HypervisorInfo{}

	err = json.Unmarshal(data, &varHypervisorInfo)

	if err != nil {
		return err
	}

	*o = HypervisorInfo(varHypervisorInfo)
...
type NullableHypervisorInfo struct {
	value *HypervisorInfo
	isSet bool
}

func (v NullableHypervisorInfo) Get() *HypervisorInfo {
	return v.value
}

func (v *NullableHypervisorInfo) Set(val *HypervisorInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableHypervisorInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableHypervisorInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHypervisorInfo(val *HypervisorInfo) *NullableHypervisorInfo {
	return &NullableHypervisorInfo{value: val, isSet: true}
}

func (v NullableHypervisorInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHypervisorInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
