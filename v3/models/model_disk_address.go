...
// checks if the DiskAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskAddress{}
...
// GetDeviceIndex returns the DeviceIndex field value
...
// GetDeviceIndexOk returns a tuple with the DeviceIndex field value
...
// SetDeviceIndex sets field value
func (o *DiskAddress) SetDeviceIndex(v int32) {
	o.DeviceIndex = v
}

// GetAdapterType returns the AdapterType field value
...
// GetAdapterTypeOk returns a tuple with the AdapterType field value
// and a boolean to check if the value has been set.
...
// SetAdapterType sets field value
func (o *DiskAddress) SetAdapterType(v string) {
	o.AdapterType = v
}

func (o DiskAddress) MarshalJSON() ([]byte, error) {
...
func (o DiskAddress) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["device_index"] = o.DeviceIndex
...
func (o *DiskAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varDiskAddress := _DiskAddress{}

	err = json.Unmarshal(data, &varDiskAddress)

	if err != nil {
		return err
	}

	*o = DiskAddress(varDiskAddress)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "device_index")
...
type NullableDiskAddress struct {
	value *DiskAddress
	isSet bool
}

func (v NullableDiskAddress) Get() *DiskAddress {
	return v.value
}

func (v *NullableDiskAddress) Set(val *DiskAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskAddress(val *DiskAddress) *NullableDiskAddress {
	return &NullableDiskAddress{value: val, isSet: true}
}

func (v NullableDiskAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
