...
// checks if the ResourceUtilizationStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceUtilizationStatus{}

// ResourceUtilizationStatus stores resource utilization and limits for a domain
...
type _ResourceUtilizationStatus ResourceUtilizationStatus
...
func NewResourceUtilizationStatus(units string, value int32, resourceType string) *ResourceUtilizationStatus {
	this := ResourceUtilizationStatus{}
	this.Units = units
	this.Value = value
...
func (o ResourceUtilizationStatus) MarshalJSON() ([]byte, error) {
...
func (o ResourceUtilizationStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceUtilizationStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varResourceUtilizationStatus := _ResourceUtilizationStatus{}

	err = json.Unmarshal(data, &varResourceUtilizationStatus)

	if err != nil {
		return err
	}

	*o = ResourceUtilizationStatus(varResourceUtilizationStatus)
...
type NullableResourceUtilizationStatus struct {
	value *ResourceUtilizationStatus
	isSet bool
}

func (v NullableResourceUtilizationStatus) Get() *ResourceUtilizationStatus {
	return v.value
}

func (v *NullableResourceUtilizationStatus) Set(val *ResourceUtilizationStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceUtilizationStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceUtilizationStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceUtilizationStatus(val *ResourceUtilizationStatus) *NullableResourceUtilizationStatus {
	return &NullableResourceUtilizationStatus{value: val, isSet: true}
}

func (v NullableResourceUtilizationStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceUtilizationStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
