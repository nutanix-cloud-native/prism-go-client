...
// checks if the VmNicStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmNicStatus{}

// VmNicStatus The status of a REST API call. Only used when there is a failure to report. 
...
func (o VmNicStatus) MarshalJSON() ([]byte, error) {
...
func (o VmNicStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VmNicStatus) UnmarshalJSON(data []byte) (err error) {
	varVmNicStatus := _VmNicStatus{}

	err = json.Unmarshal(data, &varVmNicStatus)

	if err != nil {
		return err
	}

	*o = VmNicStatus(varVmNicStatus)
...
type NullableVmNicStatus struct {
	value *VmNicStatus
	isSet bool
}

func (v NullableVmNicStatus) Get() *VmNicStatus {
	return v.value
}

func (v *NullableVmNicStatus) Set(val *VmNicStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVmNicStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVmNicStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmNicStatus(val *VmNicStatus) *NullableVmNicStatus {
	return &NullableVmNicStatus{value: val, isSet: true}
}

func (v NullableVmNicStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmNicStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
