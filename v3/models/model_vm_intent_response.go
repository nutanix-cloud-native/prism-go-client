...
// checks if the VmIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmIntentResponse{}
...
type _VmIntentResponse VmIntentResponse
...
func (o VmIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VmIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VmIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVmIntentResponse := _VmIntentResponse{}

	err = json.Unmarshal(data, &varVmIntentResponse)

	if err != nil {
		return err
	}

	*o = VmIntentResponse(varVmIntentResponse)
...
type NullableVmIntentResponse struct {
	value *VmIntentResponse
	isSet bool
}

func (v NullableVmIntentResponse) Get() *VmIntentResponse {
	return v.value
}

func (v *NullableVmIntentResponse) Set(val *VmIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVmIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVmIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmIntentResponse(val *VmIntentResponse) *NullableVmIntentResponse {
	return &NullableVmIntentResponse{value: val, isSet: true}
}

func (v NullableVmIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
