...
// checks if the AwsImageStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsImageStatus{}

// AwsImageStatus The status of a REST API call. Only used when there is a failure to report. 
type AwsImageStatus struct {
	// The kind name
...
type _AwsImageStatus AwsImageStatus
...
func (o AwsImageStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsImageStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsImageStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsImageStatus := _AwsImageStatus{}

	err = json.Unmarshal(data, &varAwsImageStatus)

	if err != nil {
		return err
	}

	*o = AwsImageStatus(varAwsImageStatus)
...
type NullableAwsImageStatus struct {
	value *AwsImageStatus
	isSet bool
}

func (v NullableAwsImageStatus) Get() *AwsImageStatus {
	return v.value
}

func (v *NullableAwsImageStatus) Set(val *AwsImageStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsImageStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsImageStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsImageStatus(val *AwsImageStatus) *NullableAwsImageStatus {
	return &NullableAwsImageStatus{value: val, isSet: true}
}

func (v NullableAwsImageStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsImageStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
