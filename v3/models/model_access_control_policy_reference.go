...
// checks if the AccessControlPolicyReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyReference{}

// AccessControlPolicyReference The reference to a access_control_policy
type AccessControlPolicyReference struct {
	// The kind name
...
type _AccessControlPolicyReference AccessControlPolicyReference
...
func NewAccessControlPolicyReference(kind string, uUID string) *AccessControlPolicyReference {
	this := AccessControlPolicyReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o AccessControlPolicyReference) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyReference) ToMap() (map[string]interface{}, error) {
...
func (o *AccessControlPolicyReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessControlPolicyReference := _AccessControlPolicyReference{}

	err = json.Unmarshal(data, &varAccessControlPolicyReference)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyReference(varAccessControlPolicyReference)
...
type NullableAccessControlPolicyReference struct {
	value *AccessControlPolicyReference
	isSet bool
}

func (v NullableAccessControlPolicyReference) Get() *AccessControlPolicyReference {
	return v.value
}

func (v *NullableAccessControlPolicyReference) Set(val *AccessControlPolicyReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyReference(val *AccessControlPolicyReference) *NullableAccessControlPolicyReference {
	return &NullableAccessControlPolicyReference{value: val, isSet: true}
}

func (v NullableAccessControlPolicyReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
