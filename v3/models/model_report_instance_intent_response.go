...
// checks if the ReportInstanceIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstanceIntentResponse{}

// ReportInstanceIntentResponse Response object for intentful operations on a report_instance
type ReportInstanceIntentResponse struct {
	Status *ReportInstanceDefStatus `json:"status,omitempty"`
	Spec *ReportInstance `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ReportInstanceMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ReportInstanceIntentResponse ReportInstanceIntentResponse
...
func NewReportInstanceIntentResponse(apiVersion string, metadata ReportInstanceMetadata) *ReportInstanceIntentResponse {
	this := ReportInstanceIntentResponse{}
...
func (o *ReportInstanceIntentResponse) GetStatus() ReportInstanceDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret ReportInstanceDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ReportInstanceDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given ReportInstance and assigns it to the Spec field.
...
func (o *ReportInstanceIntentResponse) GetMetadata() ReportInstanceMetadata {
	if o == nil {
		var ret ReportInstanceMetadata
		return ret
	}
...
func (o ReportInstanceIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ReportInstanceIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ReportInstanceIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varReportInstanceIntentResponse := _ReportInstanceIntentResponse{}

	err = json.Unmarshal(data, &varReportInstanceIntentResponse)

	if err != nil {
		return err
	}

	*o = ReportInstanceIntentResponse(varReportInstanceIntentResponse)
...
type NullableReportInstanceIntentResponse struct {
	value *ReportInstanceIntentResponse
	isSet bool
}

func (v NullableReportInstanceIntentResponse) Get() *ReportInstanceIntentResponse {
	return v.value
}

func (v *NullableReportInstanceIntentResponse) Set(val *ReportInstanceIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstanceIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstanceIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstanceIntentResponse(val *ReportInstanceIntentResponse) *NullableReportInstanceIntentResponse {
	return &NullableReportInstanceIntentResponse{value: val, isSet: true}
}

func (v NullableReportInstanceIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstanceIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
