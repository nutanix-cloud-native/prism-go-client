...
// checks if the ProjectInternal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectInternal{}

// ProjectInternal A Project resource, combined with Users and ACPs
type ProjectInternal struct {
	// The list of ACPs to be attached to the users belonging to a project. 
	AccessControlPolicyList []ProjectInternalAccessControlPolicyListInner `json:"access_control_policy_list,omitempty"`
	ProjectDetail ProjectDetails `json:"project_detail"`
	// The list of user specification to be associated with the project. 
	UserList []ProjectInternalUserListInner `json:"user_list,omitempty"`
	// The list of user group specification to be associated with the project. 
	UserGroupList []ProjectInternalUserGroupListInner `json:"user_group_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ProjectInternal ProjectInternal
...
// GetAccessControlPolicyList returns the AccessControlPolicyList field value if set, zero value otherwise.
func (o *ProjectInternal) GetAccessControlPolicyList() []ProjectInternalAccessControlPolicyListInner {
	if o == nil || IsNil(o.AccessControlPolicyList) {
		var ret []ProjectInternalAccessControlPolicyListInner
		return ret
	}
	return o.AccessControlPolicyList
}

// GetAccessControlPolicyListOk returns a tuple with the AccessControlPolicyList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectInternal) GetAccessControlPolicyListOk() ([]ProjectInternalAccessControlPolicyListInner, bool) {
	if o == nil || IsNil(o.AccessControlPolicyList) {
		return nil, false
	}
	return o.AccessControlPolicyList, true
}
...
// SetAccessControlPolicyList gets a reference to the given []ProjectInternalAccessControlPolicyListInner and assigns it to the AccessControlPolicyList field.
func (o *ProjectInternal) SetAccessControlPolicyList(v []ProjectInternalAccessControlPolicyListInner) {
	o.AccessControlPolicyList = v
}

// GetProjectDetail returns the ProjectDetail field value
func (o *ProjectInternal) GetProjectDetail() ProjectDetails {
	...
	return o.ProjectDetail
}

// GetProjectDetailOk returns a tuple with the ProjectDetail field value
// and a boolean to check if the value has been set.
func (o *ProjectInternal) GetProjectDetailOk() (*ProjectDetails, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ProjectDetail, true
}

// SetProjectDetail sets field value
...
func (o *ProjectInternal) GetUserList() []ProjectInternalUserListInner {
	if o == nil || IsNil(o.UserList) {
		var ret []ProjectInternalUserListInner
		return ret
	}
	return o.UserList
}
...
// SetUserList gets a reference to the given []ProjectInternalUserListInner and assigns it to the UserList field.
func (o *ProjectInternal) SetUserList(v []ProjectInternalUserListInner) {
	o.UserList = v
}

// GetUserGroupList returns the UserGroupList field value if set, zero value otherwise.
func (o *ProjectInternal) GetUserGroupList() []ProjectInternalUserGroupListInner {
	if o == nil || IsNil(o.UserGroupList) {
		var ret []ProjectInternalUserGroupListInner
		return ret
	}
...
// SetUserGroupList gets a reference to the given []ProjectInternalUserGroupListInner and assigns it to the UserGroupList field.
func (o *ProjectInternal) SetUserGroupList(v []ProjectInternalUserGroupListInner) {
	o.UserGroupList = v
}

func (o ProjectInternal) MarshalJSON() ([]byte, error) {
...
func (o ProjectInternal) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AccessControlPolicyList) {
		toSerialize["access_control_policy_list"] = o.AccessControlPolicyList
	}
	toSerialize["project_detail"] = o.ProjectDetail
	if !IsNil(o.UserList) {
		toSerialize["user_list"] = o.UserList
	}
	if !IsNil(o.UserGroupList) {
		toSerialize["user_group_list"] = o.UserGroupList
	}
...
func (o *ProjectInternal) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectInternal := _ProjectInternal{}

	err = json.Unmarshal(data, &varProjectInternal)

	if err != nil {
		return err
	}

	*o = ProjectInternal(varProjectInternal)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "access_control_policy_list")
		delete(additionalProperties, "project_detail")
		delete(additionalProperties, "user_list")
		delete(additionalProperties, "user_group_list")
...
type NullableProjectInternal struct {
	value *ProjectInternal
	isSet bool
}

func (v NullableProjectInternal) Get() *ProjectInternal {
	return v.value
}

func (v *NullableProjectInternal) Set(val *ProjectInternal) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectInternal) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectInternal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectInternal(val *ProjectInternal) *NullableProjectInternal {
	return &NullableProjectInternal{value: val, isSet: true}
}

func (v NullableProjectInternal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectInternal) UnmarshalJSON(src []byte) error {
	v.isSet = true
