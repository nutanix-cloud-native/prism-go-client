...
// checks if the PermissionIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionIntentResource{}

// PermissionIntentResource Response object for intentful operations on a permission
type PermissionIntentResource struct {
	Status *PermissionDefStatus `json:"status,omitempty"`
	Spec *Permission `json:"spec,omitempty"`
...
type _PermissionIntentResource PermissionIntentResource
...
// SetStatus gets a reference to the given PermissionDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Permission and assigns it to the Spec field.
...
func (o PermissionIntentResource) MarshalJSON() ([]byte, error) {
...
func (o PermissionIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *PermissionIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varPermissionIntentResource := _PermissionIntentResource{}

	err = json.Unmarshal(data, &varPermissionIntentResource)

	if err != nil {
		return err
	}

	*o = PermissionIntentResource(varPermissionIntentResource)
...
type NullablePermissionIntentResource struct {
	value *PermissionIntentResource
	isSet bool
}

func (v NullablePermissionIntentResource) Get() *PermissionIntentResource {
	return v.value
}

func (v *NullablePermissionIntentResource) Set(val *PermissionIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionIntentResource(val *PermissionIntentResource) *NullablePermissionIntentResource {
	return &NullablePermissionIntentResource{value: val, isSet: true}
}

func (v NullablePermissionIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
