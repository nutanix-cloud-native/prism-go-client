...
// checks if the RemoteSyslogModuleReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogModuleReference{}

// RemoteSyslogModuleReference The reference to a remote_syslog_module
type RemoteSyslogModuleReference struct {
	// The kind name
...
type _RemoteSyslogModuleReference RemoteSyslogModuleReference
...
func NewRemoteSyslogModuleReference(kind string, uUID string) *RemoteSyslogModuleReference {
	this := RemoteSyslogModuleReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o RemoteSyslogModuleReference) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogModuleReference) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogModuleReference) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogModuleReference := _RemoteSyslogModuleReference{}

	err = json.Unmarshal(data, &varRemoteSyslogModuleReference)

	if err != nil {
		return err
	}

	*o = RemoteSyslogModuleReference(varRemoteSyslogModuleReference)
...
type NullableRemoteSyslogModuleReference struct {
	value *RemoteSyslogModuleReference
	isSet bool
}

func (v NullableRemoteSyslogModuleReference) Get() *RemoteSyslogModuleReference {
	return v.value
}

func (v *NullableRemoteSyslogModuleReference) Set(val *RemoteSyslogModuleReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogModuleReference) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogModuleReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogModuleReference(val *RemoteSyslogModuleReference) *NullableRemoteSyslogModuleReference {
	return &NullableRemoteSyslogModuleReference{value: val, isSet: true}
}

func (v NullableRemoteSyslogModuleReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogModuleReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
