...
// checks if the DirectConnectVirtualInterfaceStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterfaceStatus{}

// DirectConnectVirtualInterfaceStatus The status of a REST API call. Only used when there is a failure to report. 
type DirectConnectVirtualInterfaceStatus struct {
	// The kind name
...
type _DirectConnectVirtualInterfaceStatus DirectConnectVirtualInterfaceStatus
...
func NewDirectConnectVirtualInterfaceStatus() *DirectConnectVirtualInterfaceStatus {
	this := DirectConnectVirtualInterfaceStatus{}
	return &this
}
...
func (o DirectConnectVirtualInterfaceStatus) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterfaceStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectVirtualInterfaceStatus) UnmarshalJSON(data []byte) (err error) {
	varDirectConnectVirtualInterfaceStatus := _DirectConnectVirtualInterfaceStatus{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterfaceStatus)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterfaceStatus(varDirectConnectVirtualInterfaceStatus)
...
type NullableDirectConnectVirtualInterfaceStatus struct {
	value *DirectConnectVirtualInterfaceStatus
	isSet bool
}

func (v NullableDirectConnectVirtualInterfaceStatus) Get() *DirectConnectVirtualInterfaceStatus {
	return v.value
}

func (v *NullableDirectConnectVirtualInterfaceStatus) Set(val *DirectConnectVirtualInterfaceStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterfaceStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterfaceStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterfaceStatus(val *DirectConnectVirtualInterfaceStatus) *NullableDirectConnectVirtualInterfaceStatus {
	return &NullableDirectConnectVirtualInterfaceStatus{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterfaceStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterfaceStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
