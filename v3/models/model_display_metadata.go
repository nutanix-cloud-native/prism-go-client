...
// checks if the DisplayMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DisplayMetadata{}

// DisplayMetadata display metadata of the form field.
type DisplayMetadata struct {
	// UI component type of the form field.
	FieldType *string `json:"field_type,omitempty"`
	// the name of the form field.
	FieldName *string `json:"field_name,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
	// Tooltip to describe value.
	Tooltip *string `json:"tooltip,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
	AdditionalProperties map[string]interface{}
}

type _DisplayMetadata DisplayMetadata
...
func (o DisplayMetadata) MarshalJSON() ([]byte, error) {
...
func (o DisplayMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DisplayMetadata) UnmarshalJSON(data []byte) (err error) {
	varDisplayMetadata := _DisplayMetadata{}

	err = json.Unmarshal(data, &varDisplayMetadata)

	if err != nil {
		return err
	}

	*o = DisplayMetadata(varDisplayMetadata)
...
type NullableDisplayMetadata struct {
	value *DisplayMetadata
	isSet bool
}

func (v NullableDisplayMetadata) Get() *DisplayMetadata {
	return v.value
}

func (v *NullableDisplayMetadata) Set(val *DisplayMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDisplayMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDisplayMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDisplayMetadata(val *DisplayMetadata) *NullableDisplayMetadata {
	return &NullableDisplayMetadata{value: val, isSet: true}
}

func (v NullableDisplayMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDisplayMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
