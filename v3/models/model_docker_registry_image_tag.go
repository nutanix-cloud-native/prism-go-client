...
// checks if the DockerRegistryImageTag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryImageTag{}
...
type _DockerRegistryImageTag DockerRegistryImageTag
...
func (o DockerRegistryImageTag) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryImageTag) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryImageTag) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerRegistryImageTag := _DockerRegistryImageTag{}

	err = json.Unmarshal(data, &varDockerRegistryImageTag)

	if err != nil {
		return err
	}

	*o = DockerRegistryImageTag(varDockerRegistryImageTag)
...
type NullableDockerRegistryImageTag struct {
	value *DockerRegistryImageTag
	isSet bool
}

func (v NullableDockerRegistryImageTag) Get() *DockerRegistryImageTag {
	return v.value
}

func (v *NullableDockerRegistryImageTag) Set(val *DockerRegistryImageTag) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryImageTag) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryImageTag) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryImageTag(val *DockerRegistryImageTag) *NullableDockerRegistryImageTag {
	return &NullableDockerRegistryImageTag{value: val, isSet: true}
}

func (v NullableDockerRegistryImageTag) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryImageTag) UnmarshalJSON(src []byte) error {
	v.isSet = true
