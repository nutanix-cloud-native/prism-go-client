...
// checks if the DatacenterListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterListIntentResponse{}

// DatacenterListIntentResponse Response object for intentful operation of datacenters
type DatacenterListIntentResponse struct {
	Entities []DatacenterIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata DatacenterListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _DatacenterListIntentResponse DatacenterListIntentResponse
...
func NewDatacenterListIntentResponse(apiVersion string, metadata DatacenterListMetadataOutput) *DatacenterListIntentResponse {
	this := DatacenterListIntentResponse{}
...
func (o *DatacenterListIntentResponse) GetEntities() []DatacenterIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []DatacenterIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []DatacenterIntentResource and assigns it to the Entities field.
...
func (o *DatacenterListIntentResponse) GetMetadata() DatacenterListMetadataOutput {
	if o == nil {
		var ret DatacenterListMetadataOutput
		return ret
	}
...
func (o DatacenterListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DatacenterListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DatacenterListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDatacenterListIntentResponse := _DatacenterListIntentResponse{}

	err = json.Unmarshal(data, &varDatacenterListIntentResponse)

	if err != nil {
		return err
	}

	*o = DatacenterListIntentResponse(varDatacenterListIntentResponse)
...
type NullableDatacenterListIntentResponse struct {
	value *DatacenterListIntentResponse
	isSet bool
}

func (v NullableDatacenterListIntentResponse) Get() *DatacenterListIntentResponse {
	return v.value
}

func (v *NullableDatacenterListIntentResponse) Set(val *DatacenterListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterListIntentResponse(val *DatacenterListIntentResponse) *NullableDatacenterListIntentResponse {
	return &NullableDatacenterListIntentResponse{value: val, isSet: true}
}

func (v NullableDatacenterListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
