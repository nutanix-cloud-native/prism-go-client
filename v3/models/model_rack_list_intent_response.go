...
// checks if the RackListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackListIntentResponse{}

// RackListIntentResponse Response object for intentful operation of racks
type RackListIntentResponse struct {
	Entities []RackIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata RackListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RackListIntentResponse RackListIntentResponse
...
// SetEntities gets a reference to the given []RackIntentResource and assigns it to the Entities field.
...
func (o *RackListIntentResponse) GetMetadata() RackListMetadataOutput {
	if o == nil {
		var ret RackListMetadataOutput
		return ret
	}
...
func (o RackListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RackListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RackListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRackListIntentResponse := _RackListIntentResponse{}

	err = json.Unmarshal(data, &varRackListIntentResponse)

	if err != nil {
		return err
	}

	*o = RackListIntentResponse(varRackListIntentResponse)
...
type NullableRackListIntentResponse struct {
	value *RackListIntentResponse
	isSet bool
}

func (v NullableRackListIntentResponse) Get() *RackListIntentResponse {
	return v.value
}

func (v *NullableRackListIntentResponse) Set(val *RackListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRackListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRackListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackListIntentResponse(val *RackListIntentResponse) *NullableRackListIntentResponse {
	return &NullableRackListIntentResponse{value: val, isSet: true}
}

func (v NullableRackListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
