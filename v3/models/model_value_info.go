...
// checks if the ValueInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValueInfo{}

// ValueInfo Describes a parameter's value range.
type ValueInfo struct {
	// A valid regex expression.
	Pattern *string `json:"pattern,omitempty"`
	Minimum *ValueInfoMinimum `json:"minimum,omitempty"`
	Maximum *ValueInfoMaximum `json:"maximum,omitempty"`
	// The unit of measurement.
	Unit *string `json:"unit,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ValueInfo ValueInfo
...
// SetMinimum gets a reference to the given ValueInfoMinimum and assigns it to the Minimum field.
...
// SetMaximum gets a reference to the given ValueInfoMaximum and assigns it to the Maximum field.
...
func (o ValueInfo) MarshalJSON() ([]byte, error) {
...
func (o ValueInfo) ToMap() (map[string]interface{}, error) {
...
func (o *ValueInfo) UnmarshalJSON(data []byte) (err error) {
	varValueInfo := _ValueInfo{}

	err = json.Unmarshal(data, &varValueInfo)

	if err != nil {
		return err
	}

	*o = ValueInfo(varValueInfo)
...
type NullableValueInfo struct {
	value *ValueInfo
	isSet bool
}

func (v NullableValueInfo) Get() *ValueInfo {
	return v.value
}

func (v *NullableValueInfo) Set(val *ValueInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableValueInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableValueInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValueInfo(val *ValueInfo) *NullableValueInfo {
	return &NullableValueInfo{value: val, isSet: true}
}

func (v NullableValueInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValueInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
