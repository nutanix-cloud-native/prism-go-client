...
// checks if the SamlUserGroupInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SamlUserGroupInput{}

// SamlUserGroupInput A SAML Service user group.
type SamlUserGroupInput struct {
	// The UUID of the Identity Provider that the group belongs to
	IdpUuid *string `json:"idpUuid,omitempty"`
	// The name of the SAML group which the IDP provides as attribute in SAML response
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SamlUserGroupInput SamlUserGroupInput
...
// GetIdpUuid returns the IdpUuid field value if set, zero value otherwise.
func (o *SamlUserGroupInput) GetIdpUuid() string {
	if o == nil || IsNil(o.IdpUuid) {
		var ret string
		return ret
	}
	return *o.IdpUuid
...
// GetIdpUuidOk returns a tuple with the IdpUuid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SamlUserGroupInput) GetIdpUuidOk() (*string, bool) {
	if o == nil || IsNil(o.IdpUuid) {
		return nil, false
	}
	return o.IdpUuid, true
}
...
// SetIdpUuid gets a reference to the given string and assigns it to the IdpUuid field.
...
func (o SamlUserGroupInput) MarshalJSON() ([]byte, error) {
...
func (o SamlUserGroupInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IdpUuid) {
		toSerialize["idpUuid"] = o.IdpUuid
	}
	if !IsNil(o.Name) {
...
func (o *SamlUserGroupInput) UnmarshalJSON(data []byte) (err error) {
	varSamlUserGroupInput := _SamlUserGroupInput{}

	err = json.Unmarshal(data, &varSamlUserGroupInput)

	if err != nil {
		return err
	}

	*o = SamlUserGroupInput(varSamlUserGroupInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "idpUuid")
...
type NullableSamlUserGroupInput struct {
	value *SamlUserGroupInput
	isSet bool
}

func (v NullableSamlUserGroupInput) Get() *SamlUserGroupInput {
	return v.value
}

func (v *NullableSamlUserGroupInput) Set(val *SamlUserGroupInput) {
	v.value = val
	v.isSet = true
}

func (v NullableSamlUserGroupInput) IsSet() bool {
	return v.isSet
}

func (v *NullableSamlUserGroupInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSamlUserGroupInput(val *SamlUserGroupInput) *NullableSamlUserGroupInput {
	return &NullableSamlUserGroupInput{value: val, isSet: true}
}

func (v NullableSamlUserGroupInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSamlUserGroupInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
