...
// checks if the VmValidateMigrationOutputInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmValidateMigrationOutputInner{}

// VmValidateMigrationOutputInner struct for VmValidateMigrationOutputInner
type VmValidateMigrationOutputInner struct {
	// Warning due to which VM may not be fully recoverable at migration target. 
...
type _VmValidateMigrationOutputInner VmValidateMigrationOutputInner
...
func NewVmValidateMigrationOutputInner() *VmValidateMigrationOutputInner {
	this := VmValidateMigrationOutputInner{}
	return &this
}
...
func (o VmValidateMigrationOutputInner) MarshalJSON() ([]byte, error) {
...
func (o VmValidateMigrationOutputInner) ToMap() (map[string]interface{}, error) {
...
func (o *VmValidateMigrationOutputInner) UnmarshalJSON(data []byte) (err error) {
	varVmValidateMigrationOutputInner := _VmValidateMigrationOutputInner{}

	err = json.Unmarshal(data, &varVmValidateMigrationOutputInner)

	if err != nil {
		return err
	}

	*o = VmValidateMigrationOutputInner(varVmValidateMigrationOutputInner)
...
type NullableVmValidateMigrationOutputInner struct {
	value *VmValidateMigrationOutputInner
	isSet bool
}

func (v NullableVmValidateMigrationOutputInner) Get() *VmValidateMigrationOutputInner {
	return v.value
}

func (v *NullableVmValidateMigrationOutputInner) Set(val *VmValidateMigrationOutputInner) {
	v.value = val
	v.isSet = true
}

func (v NullableVmValidateMigrationOutputInner) IsSet() bool {
	return v.isSet
}

func (v *NullableVmValidateMigrationOutputInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmValidateMigrationOutputInner(val *VmValidateMigrationOutputInner) *NullableVmValidateMigrationOutputInner {
	return &NullableVmValidateMigrationOutputInner{value: val, isSet: true}
}

func (v NullableVmValidateMigrationOutputInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmValidateMigrationOutputInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
