...
// checks if the SshUserListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserListIntentResponse{}

// SshUserListIntentResponse Response object for intentful operation of ssh_users
type SshUserListIntentResponse struct {
	Entities []SshUserIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata SshUserListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _SshUserListIntentResponse SshUserListIntentResponse
...
func NewSshUserListIntentResponse(apiVersion string, metadata SshUserListMetadataOutput) *SshUserListIntentResponse {
	this := SshUserListIntentResponse{}
...
// SetEntities gets a reference to the given []SshUserIntentResource and assigns it to the Entities field.
...
func (o *SshUserListIntentResponse) GetMetadata() SshUserListMetadataOutput {
	if o == nil {
		var ret SshUserListMetadataOutput
		return ret
	}
...
func (o SshUserListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o SshUserListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSshUserListIntentResponse := _SshUserListIntentResponse{}

	err = json.Unmarshal(data, &varSshUserListIntentResponse)

	if err != nil {
		return err
	}

	*o = SshUserListIntentResponse(varSshUserListIntentResponse)
...
type NullableSshUserListIntentResponse struct {
	value *SshUserListIntentResponse
	isSet bool
}

func (v NullableSshUserListIntentResponse) Get() *SshUserListIntentResponse {
	return v.value
}

func (v *NullableSshUserListIntentResponse) Set(val *SshUserListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserListIntentResponse(val *SshUserListIntentResponse) *NullableSshUserListIntentResponse {
	return &NullableSshUserListIntentResponse{value: val, isSet: true}
}

func (v NullableSshUserListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
