...
// checks if the ActionRuleTriggerInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleTriggerInput{}

// ActionRuleTriggerInput Input to trigger playbooks on-demand
type ActionRuleTriggerInput struct {
	// The trigger output parameters.
	TriggerInstanceList []map[string]string `json:"trigger_instance_list,omitempty"`
	// The trigger type name
	TriggerType *string `json:"trigger_type,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
	AdditionalProperties map[string]interface{}
}

type _ActionRuleTriggerInput ActionRuleTriggerInput
...
// GetTriggerInstanceList returns the TriggerInstanceList field value if set, zero value otherwise.
func (o *ActionRuleTriggerInput) GetTriggerInstanceList() []map[string]string {
	if o == nil || IsNil(o.TriggerInstanceList) {
		var ret []map[string]string
		return ret
	}
	return o.TriggerInstanceList
}

// GetTriggerInstanceListOk returns a tuple with the TriggerInstanceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleTriggerInput) GetTriggerInstanceListOk() ([]map[string]string, bool) {
	if o == nil || IsNil(o.TriggerInstanceList) {
		return nil, false
	}
	return o.TriggerInstanceList, true
}
...
// SetTriggerInstanceList gets a reference to the given []map[string]string and assigns it to the TriggerInstanceList field.
func (o *ActionRuleTriggerInput) SetTriggerInstanceList(v []map[string]string) {
	o.TriggerInstanceList = v
}
...
func (o ActionRuleTriggerInput) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleTriggerInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TriggerInstanceList) {
		toSerialize["trigger_instance_list"] = o.TriggerInstanceList
	}
...
func (o *ActionRuleTriggerInput) UnmarshalJSON(data []byte) (err error) {
	varActionRuleTriggerInput := _ActionRuleTriggerInput{}

	err = json.Unmarshal(data, &varActionRuleTriggerInput)

	if err != nil {
		return err
	}

	*o = ActionRuleTriggerInput(varActionRuleTriggerInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "trigger_instance_list")
...
type NullableActionRuleTriggerInput struct {
	value *ActionRuleTriggerInput
	isSet bool
}

func (v NullableActionRuleTriggerInput) Get() *ActionRuleTriggerInput {
	return v.value
}

func (v *NullableActionRuleTriggerInput) Set(val *ActionRuleTriggerInput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleTriggerInput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleTriggerInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleTriggerInput(val *ActionRuleTriggerInput) *NullableActionRuleTriggerInput {
	return &NullableActionRuleTriggerInput{value: val, isSet: true}
}

func (v NullableActionRuleTriggerInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleTriggerInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
