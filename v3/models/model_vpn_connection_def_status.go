...
// checks if the VpnConnectionDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionDefStatus{}

// VpnConnectionDefStatus An intentful representation of a vpn_connection status
type VpnConnectionDefStatus struct {
	// vpn_connection Name.
	Name string `json:"name"`
	// The state of the vpn_connection.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the vpn_connection, if in an error state.
	...
	Resources VpnConnectionResourcesDefStatus `json:"resources"`
	// A description for vpn_connection.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VpnConnectionDefStatus VpnConnectionDefStatus
...
func (o *VpnConnectionDefStatus) GetResources() VpnConnectionResourcesDefStatus {
	if o == nil {
		var ret VpnConnectionResourcesDefStatus
		return ret
	}
...
func (o VpnConnectionDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnectionDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnConnectionDefStatus := _VpnConnectionDefStatus{}

	err = json.Unmarshal(data, &varVpnConnectionDefStatus)

	if err != nil {
		return err
	}

	*o = VpnConnectionDefStatus(varVpnConnectionDefStatus)
...
type NullableVpnConnectionDefStatus struct {
	value *VpnConnectionDefStatus
	isSet bool
}

func (v NullableVpnConnectionDefStatus) Get() *VpnConnectionDefStatus {
	return v.value
}

func (v *NullableVpnConnectionDefStatus) Set(val *VpnConnectionDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionDefStatus(val *VpnConnectionDefStatus) *NullableVpnConnectionDefStatus {
	return &NullableVpnConnectionDefStatus{value: val, isSet: true}
}

func (v NullableVpnConnectionDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
