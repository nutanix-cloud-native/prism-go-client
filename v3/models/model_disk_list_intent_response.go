...
// checks if the DiskListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskListIntentResponse{}

// DiskListIntentResponse Response object for intentful operation of disks
type DiskListIntentResponse struct {
	Entities []DiskIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata DiskListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _DiskListIntentResponse DiskListIntentResponse
...
// SetEntities gets a reference to the given []DiskIntentResource and assigns it to the Entities field.
...
func (o *DiskListIntentResponse) GetMetadata() DiskListMetadataOutput {
	if o == nil {
		var ret DiskListMetadataOutput
		return ret
	}
...
func (o DiskListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DiskListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DiskListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDiskListIntentResponse := _DiskListIntentResponse{}

	err = json.Unmarshal(data, &varDiskListIntentResponse)

	if err != nil {
		return err
	}

	*o = DiskListIntentResponse(varDiskListIntentResponse)
...
type NullableDiskListIntentResponse struct {
	value *DiskListIntentResponse
	isSet bool
}

func (v NullableDiskListIntentResponse) Get() *DiskListIntentResponse {
	return v.value
}

func (v *NullableDiskListIntentResponse) Set(val *DiskListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskListIntentResponse(val *DiskListIntentResponse) *NullableDiskListIntentResponse {
	return &NullableDiskListIntentResponse{value: val, isSet: true}
}

func (v NullableDiskListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
