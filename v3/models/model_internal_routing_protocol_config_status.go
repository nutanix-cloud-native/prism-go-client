...
// checks if the InternalRoutingProtocolConfigStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InternalRoutingProtocolConfigStatus{}

// InternalRoutingProtocolConfigStatus Describes the routing protocol configuration status needed by this gateway to peer and learn routes from internal routers using either iBGP or OSFP. 
type InternalRoutingProtocolConfigStatus struct {
	// list of local prefixes to be advertised over eBGP
	LocalPrefixList []IpSubnetStatus `json:"local_prefix_list,omitempty"`
	// iBGP configuration.
	IbgpConfigList []BgpConfigStatus `json:"ibgp_config_list,omitempty"`
	OspfConfig *OspfConfigStatus `json:"ospf_config,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _InternalRoutingProtocolConfigStatus InternalRoutingProtocolConfigStatus
...
func NewInternalRoutingProtocolConfigStatus() *InternalRoutingProtocolConfigStatus {
	this := InternalRoutingProtocolConfigStatus{}
	return &this
}
...
// GetLocalPrefixList returns the LocalPrefixList field value if set, zero value otherwise.
func (o *InternalRoutingProtocolConfigStatus) GetLocalPrefixList() []IpSubnetStatus {
	if o == nil || IsNil(o.LocalPrefixList) {
		var ret []IpSubnetStatus
		return ret
	}
	return o.LocalPrefixList
}

// GetLocalPrefixListOk returns a tuple with the LocalPrefixList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InternalRoutingProtocolConfigStatus) GetLocalPrefixListOk() ([]IpSubnetStatus, bool) {
	if o == nil || IsNil(o.LocalPrefixList) {
		return nil, false
	}
	return o.LocalPrefixList, true
}
...
// SetLocalPrefixList gets a reference to the given []IpSubnetStatus and assigns it to the LocalPrefixList field.
func (o *InternalRoutingProtocolConfigStatus) SetLocalPrefixList(v []IpSubnetStatus) {
	o.LocalPrefixList = v
}

// GetIbgpConfigList returns the IbgpConfigList field value if set, zero value otherwise.
func (o *InternalRoutingProtocolConfigStatus) GetIbgpConfigList() []BgpConfigStatus {
	if o == nil || IsNil(o.IbgpConfigList) {
		var ret []BgpConfigStatus
		return ret
	}
	return o.IbgpConfigList
}

// GetIbgpConfigListOk returns a tuple with the IbgpConfigList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InternalRoutingProtocolConfigStatus) GetIbgpConfigListOk() ([]BgpConfigStatus, bool) {
	if o == nil || IsNil(o.IbgpConfigList) {
		return nil, false
	}
	return o.IbgpConfigList, true
}
...
// SetIbgpConfigList gets a reference to the given []BgpConfigStatus and assigns it to the IbgpConfigList field.
...
// SetOspfConfig gets a reference to the given OspfConfigStatus and assigns it to the OspfConfig field.
func (o *InternalRoutingProtocolConfigStatus) SetOspfConfig(v OspfConfigStatus) {
	o.OspfConfig = &v
}

func (o InternalRoutingProtocolConfigStatus) MarshalJSON() ([]byte, error) {
...
func (o InternalRoutingProtocolConfigStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.LocalPrefixList) {
		toSerialize["local_prefix_list"] = o.LocalPrefixList
	}
	if !IsNil(o.IbgpConfigList) {
		toSerialize["ibgp_config_list"] = o.IbgpConfigList
	}
...
func (o *InternalRoutingProtocolConfigStatus) UnmarshalJSON(data []byte) (err error) {
	varInternalRoutingProtocolConfigStatus := _InternalRoutingProtocolConfigStatus{}

	err = json.Unmarshal(data, &varInternalRoutingProtocolConfigStatus)

	if err != nil {
		return err
	}

	*o = InternalRoutingProtocolConfigStatus(varInternalRoutingProtocolConfigStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "local_prefix_list")
		delete(additionalProperties, "ibgp_config_list")
...
type NullableInternalRoutingProtocolConfigStatus struct {
	value *InternalRoutingProtocolConfigStatus
	isSet bool
}

func (v NullableInternalRoutingProtocolConfigStatus) Get() *InternalRoutingProtocolConfigStatus {
	return v.value
}

func (v *NullableInternalRoutingProtocolConfigStatus) Set(val *InternalRoutingProtocolConfigStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableInternalRoutingProtocolConfigStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableInternalRoutingProtocolConfigStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInternalRoutingProtocolConfigStatus(val *InternalRoutingProtocolConfigStatus) *NullableInternalRoutingProtocolConfigStatus {
	return &NullableInternalRoutingProtocolConfigStatus{value: val, isSet: true}
}

func (v NullableInternalRoutingProtocolConfigStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInternalRoutingProtocolConfigStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
