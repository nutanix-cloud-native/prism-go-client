...
// Schedule Defines the schedule parameters.
...
// GetIntervalMultiple returns the IntervalMultiple field value
func (o *Schedule) GetIntervalMultiple() int32 {
	...
	return o.IntervalMultiple
}

// GetIntervalMultipleOk returns a tuple with the IntervalMultiple field value
// and a boolean to check if the value has been set.
func (o *Schedule) GetIntervalMultipleOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IntervalMultiple, true
}

// SetIntervalMultiple sets field value
func (o *Schedule) SetIntervalMultiple(v int32) {
	o.IntervalMultiple = v
}
...
func (o Schedule) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["interval_multiple"] = o.IntervalMultiple
...
func (o *Schedule) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Schedule(varSchedule)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "interval_type")
		delete(additionalProperties, "duration_secs")
		delete(additionalProperties, "start_time")
		delete(additionalProperties, "interval_multiple")
		delete(additionalProperties, "day_of_week")
		delete(additionalProperties, "end_time")
		delete(additionalProperties, "is_suspended")
