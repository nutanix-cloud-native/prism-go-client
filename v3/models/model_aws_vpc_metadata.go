...
// checks if the AwsVpcMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVpcMetadata{}

// AwsVpcMetadata The aws_vpc kind metadata
type AwsVpcMetadata struct {
...
type _AwsVpcMetadata AwsVpcMetadata
...
func (o AwsVpcMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsVpcMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVpcMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVpcMetadata := _AwsVpcMetadata{}

	err = json.Unmarshal(data, &varAwsVpcMetadata)

	if err != nil {
		return err
	}

	*o = AwsVpcMetadata(varAwsVpcMetadata)
...
type NullableAwsVpcMetadata struct {
	value *AwsVpcMetadata
	isSet bool
}

func (v NullableAwsVpcMetadata) Get() *AwsVpcMetadata {
	return v.value
}

func (v *NullableAwsVpcMetadata) Set(val *AwsVpcMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVpcMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVpcMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVpcMetadata(val *AwsVpcMetadata) *NullableAwsVpcMetadata {
	return &NullableAwsVpcMetadata{value: val, isSet: true}
}

func (v NullableAwsVpcMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVpcMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
