...
// checks if the EntitySyncRuleReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySyncRuleReference{}

// EntitySyncRuleReference The reference to a entity_sync_rule
type EntitySyncRuleReference struct {
	// The kind name
...
type _EntitySyncRuleReference EntitySyncRuleReference
...
func (o EntitySyncRuleReference) MarshalJSON() ([]byte, error) {
...
func (o EntitySyncRuleReference) ToMap() (map[string]interface{}, error) {
...
func (o *EntitySyncRuleReference) UnmarshalJSON(data []byte) (err error) {
	...
	varEntitySyncRuleReference := _EntitySyncRuleReference{}

	err = json.Unmarshal(data, &varEntitySyncRuleReference)

	if err != nil {
		return err
	}

	*o = EntitySyncRuleReference(varEntitySyncRuleReference)
...
type NullableEntitySyncRuleReference struct {
	value *EntitySyncRuleReference
	isSet bool
}

func (v NullableEntitySyncRuleReference) Get() *EntitySyncRuleReference {
	return v.value
}

func (v *NullableEntitySyncRuleReference) Set(val *EntitySyncRuleReference) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySyncRuleReference) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySyncRuleReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySyncRuleReference(val *EntitySyncRuleReference) *NullableEntitySyncRuleReference {
	return &NullableEntitySyncRuleReference{value: val, isSet: true}
}

func (v NullableEntitySyncRuleReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySyncRuleReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
