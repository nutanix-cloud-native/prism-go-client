...
// checks if the UnderlaySubnetReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnetReference{}

// UnderlaySubnetReference The reference to a underlay_subnet
type UnderlaySubnetReference struct {
	// The kind name
...
type _UnderlaySubnetReference UnderlaySubnetReference
...
func (o UnderlaySubnetReference) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnetReference) ToMap() (map[string]interface{}, error) {
...
func (o *UnderlaySubnetReference) UnmarshalJSON(data []byte) (err error) {
	...
	varUnderlaySubnetReference := _UnderlaySubnetReference{}

	err = json.Unmarshal(data, &varUnderlaySubnetReference)

	if err != nil {
		return err
	}

	*o = UnderlaySubnetReference(varUnderlaySubnetReference)
...
type NullableUnderlaySubnetReference struct {
	value *UnderlaySubnetReference
	isSet bool
}

func (v NullableUnderlaySubnetReference) Get() *UnderlaySubnetReference {
	return v.value
}

func (v *NullableUnderlaySubnetReference) Set(val *UnderlaySubnetReference) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnetReference) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnetReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnetReference(val *UnderlaySubnetReference) *NullableUnderlaySubnetReference {
	return &NullableUnderlaySubnetReference{value: val, isSet: true}
}

func (v NullableUnderlaySubnetReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnetReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
