...
// checks if the Layer2StretchMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchMetadata{}

// Layer2StretchMetadata The layer2_stretch kind metadata
type Layer2StretchMetadata struct {
	// UTC date and time in RFC-3339 format when layer2_stretch was last updated 
	...
	// UTC date and time in RFC-3339 format when layer2_stretch was created 
	...
	// Categories for the layer2_stretch. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the layer2_stretch. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _Layer2StretchMetadata Layer2StretchMetadata
...
func (o Layer2StretchMetadata) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varLayer2StretchMetadata := _Layer2StretchMetadata{}

	err = json.Unmarshal(data, &varLayer2StretchMetadata)

	if err != nil {
		return err
	}

	*o = Layer2StretchMetadata(varLayer2StretchMetadata)
...
type NullableLayer2StretchMetadata struct {
	value *Layer2StretchMetadata
	isSet bool
}

func (v NullableLayer2StretchMetadata) Get() *Layer2StretchMetadata {
	return v.value
}

func (v *NullableLayer2StretchMetadata) Set(val *Layer2StretchMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchMetadata(val *Layer2StretchMetadata) *NullableLayer2StretchMetadata {
	return &NullableLayer2StretchMetadata{value: val, isSet: true}
}

func (v NullableLayer2StretchMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
