...
// checks if the RackableUnitListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackableUnitListMetadataOutput{}

// RackableUnitListMetadataOutput All api calls that return a list will have this metadata block 
type RackableUnitListMetadataOutput struct {
	// The kind name
...
type _RackableUnitListMetadataOutput RackableUnitListMetadataOutput
...
func NewRackableUnitListMetadataOutput() *RackableUnitListMetadataOutput {
	this := RackableUnitListMetadataOutput{}
	var kind string = "rackable_unit"
	this.Kind = &kind
	return &this
}
...
func (o RackableUnitListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o RackableUnitListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *RackableUnitListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varRackableUnitListMetadataOutput := _RackableUnitListMetadataOutput{}

	err = json.Unmarshal(data, &varRackableUnitListMetadataOutput)

	if err != nil {
		return err
	}

	*o = RackableUnitListMetadataOutput(varRackableUnitListMetadataOutput)
...
type NullableRackableUnitListMetadataOutput struct {
	value *RackableUnitListMetadataOutput
	isSet bool
}

func (v NullableRackableUnitListMetadataOutput) Get() *RackableUnitListMetadataOutput {
	return v.value
}

func (v *NullableRackableUnitListMetadataOutput) Set(val *RackableUnitListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableRackableUnitListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableRackableUnitListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackableUnitListMetadataOutput(val *RackableUnitListMetadataOutput) *NullableRackableUnitListMetadataOutput {
	return &NullableRackableUnitListMetadataOutput{value: val, isSet: true}
}

func (v NullableRackableUnitListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackableUnitListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
