...
// checks if the SoftwareStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareStatus{}

// SoftwareStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _SoftwareStatus SoftwareStatus
...
func (o SoftwareStatus) MarshalJSON() ([]byte, error) {
...
func (o SoftwareStatus) ToMap() (map[string]interface{}, error) {
...
func (o *SoftwareStatus) UnmarshalJSON(data []byte) (err error) {
	varSoftwareStatus := _SoftwareStatus{}

	err = json.Unmarshal(data, &varSoftwareStatus)

	if err != nil {
		return err
	}

	*o = SoftwareStatus(varSoftwareStatus)
...
type NullableSoftwareStatus struct {
	value *SoftwareStatus
	isSet bool
}

func (v NullableSoftwareStatus) Get() *SoftwareStatus {
	return v.value
}

func (v *NullableSoftwareStatus) Set(val *SoftwareStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareStatus(val *SoftwareStatus) *NullableSoftwareStatus {
	return &NullableSoftwareStatus{value: val, isSet: true}
}

func (v NullableSoftwareStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
