...
// checks if the AppActionResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppActionResponseDownload{}

// AppActionResponseDownload Action definition for Application
type AppActionResponseDownload struct {
	// 
	Description *string `json:"description,omitempty"`
	// Message list for action
	...
	Runbook *AppRunbookResponseDownload `json:"runbook,omitempty"`
	// 
...
type _AppActionResponseDownload AppActionResponseDownload
...
func NewAppActionResponseDownload() *AppActionResponseDownload {
	this := AppActionResponseDownload{}
...
func (o *AppActionResponseDownload) GetRunbook() AppRunbookResponseDownload {
	if o == nil || IsNil(o.Runbook) {
		var ret AppRunbookResponseDownload
		return ret
	}
	return *o.Runbook
}
...
// SetRunbook gets a reference to the given AppRunbookResponseDownload and assigns it to the Runbook field.
...
func (o AppActionResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o AppActionResponseDownload) ToMap() (map[string]interface{}, error) {
...
func (o *AppActionResponseDownload) UnmarshalJSON(data []byte) (err error) {
	varAppActionResponseDownload := _AppActionResponseDownload{}

	err = json.Unmarshal(data, &varAppActionResponseDownload)

	if err != nil {
		return err
	}

	*o = AppActionResponseDownload(varAppActionResponseDownload)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "runbook")
...
type NullableAppActionResponseDownload struct {
	value *AppActionResponseDownload
	isSet bool
}

func (v NullableAppActionResponseDownload) Get() *AppActionResponseDownload {
	return v.value
}

func (v *NullableAppActionResponseDownload) Set(val *AppActionResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppActionResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppActionResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppActionResponseDownload(val *AppActionResponseDownload) *NullableAppActionResponseDownload {
	return &NullableAppActionResponseDownload{value: val, isSet: true}
}

func (v NullableAppActionResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppActionResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
