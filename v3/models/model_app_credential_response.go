...
// checks if the AppCredentialResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCredentialResponse{}

// AppCredentialResponse Credential definition for Application
...
type _AppCredentialResponse AppCredentialResponse
...
func (o AppCredentialResponse) MarshalJSON() ([]byte, error) {
...
func (o AppCredentialResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppCredentialResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCredentialResponse := _AppCredentialResponse{}

	err = json.Unmarshal(data, &varAppCredentialResponse)

	if err != nil {
		return err
	}

	*o = AppCredentialResponse(varAppCredentialResponse)
...
type NullableAppCredentialResponse struct {
	value *AppCredentialResponse
	isSet bool
}

func (v NullableAppCredentialResponse) Get() *AppCredentialResponse {
	return v.value
}

func (v *NullableAppCredentialResponse) Set(val *AppCredentialResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCredentialResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCredentialResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCredentialResponse(val *AppCredentialResponse) *NullableAppCredentialResponse {
	return &NullableAppCredentialResponse{value: val, isSet: true}
}

func (v NullableAppCredentialResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCredentialResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
