...
// checks if the QueryGroupsFieldData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryGroupsFieldData{}

// QueryGroupsFieldData Query Group Summary Data.
type QueryGroupsFieldData struct {
	Values []QueryTimevaluePair `json:"values,omitempty"`
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QueryGroupsFieldData QueryGroupsFieldData
...
// SetValues gets a reference to the given []QueryTimevaluePair and assigns it to the Values field.
...
func (o QueryGroupsFieldData) MarshalJSON() ([]byte, error) {
...
func (o QueryGroupsFieldData) ToMap() (map[string]interface{}, error) {
...
func (o *QueryGroupsFieldData) UnmarshalJSON(data []byte) (err error) {
	varQueryGroupsFieldData := _QueryGroupsFieldData{}

	err = json.Unmarshal(data, &varQueryGroupsFieldData)

	if err != nil {
		return err
	}

	*o = QueryGroupsFieldData(varQueryGroupsFieldData)
...
type NullableQueryGroupsFieldData struct {
	value *QueryGroupsFieldData
	isSet bool
}

func (v NullableQueryGroupsFieldData) Get() *QueryGroupsFieldData {
	return v.value
}

func (v *NullableQueryGroupsFieldData) Set(val *QueryGroupsFieldData) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryGroupsFieldData) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryGroupsFieldData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryGroupsFieldData(val *QueryGroupsFieldData) *NullableQueryGroupsFieldData {
	return &NullableQueryGroupsFieldData{value: val, isSet: true}
}

func (v NullableQueryGroupsFieldData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryGroupsFieldData) UnmarshalJSON(src []byte) error {
	v.isSet = true
