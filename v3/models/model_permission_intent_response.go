...
// checks if the PermissionIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionIntentResponse{}
...
type _PermissionIntentResponse PermissionIntentResponse
...
func (o PermissionIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o PermissionIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PermissionIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPermissionIntentResponse := _PermissionIntentResponse{}

	err = json.Unmarshal(data, &varPermissionIntentResponse)

	if err != nil {
		return err
	}

	*o = PermissionIntentResponse(varPermissionIntentResponse)
...
type NullablePermissionIntentResponse struct {
	value *PermissionIntentResponse
	isSet bool
}

func (v NullablePermissionIntentResponse) Get() *PermissionIntentResponse {
	return v.value
}

func (v *NullablePermissionIntentResponse) Set(val *PermissionIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionIntentResponse(val *PermissionIntentResponse) *NullablePermissionIntentResponse {
	return &NullablePermissionIntentResponse{value: val, isSet: true}
}

func (v NullablePermissionIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
