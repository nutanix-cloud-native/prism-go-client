...
// checks if the RecoveryPlanDataServiceIpConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanDataServiceIpConfig{}

// RecoveryPlanDataServiceIpConfig Information about Data Service IP to be configured on the VM during Volume Group attachment. 
type RecoveryPlanDataServiceIpConfig struct {
	...
	RecoveryDataServiceIp string `json:"recovery_data_service_ip" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	...
	TestDataServiceIp *string `json:"test_data_service_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanDataServiceIpConfig RecoveryPlanDataServiceIpConfig
...
func NewRecoveryPlanDataServiceIpConfig(recoveryDataServiceIp string, availabilityZoneUrl string, clusterReference ClusterReference) *RecoveryPlanDataServiceIpConfig {
	this := RecoveryPlanDataServiceIpConfig{}
	this.RecoveryDataServiceIp = recoveryDataServiceIp
...
// GetRecoveryDataServiceIp returns the RecoveryDataServiceIp field value
func (o *RecoveryPlanDataServiceIpConfig) GetRecoveryDataServiceIp() string {
	...
	return o.RecoveryDataServiceIp
}

// GetRecoveryDataServiceIpOk returns a tuple with the RecoveryDataServiceIp field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanDataServiceIpConfig) GetRecoveryDataServiceIpOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RecoveryDataServiceIp, true
}

// SetRecoveryDataServiceIp sets field value
func (o *RecoveryPlanDataServiceIpConfig) SetRecoveryDataServiceIp(v string) {
	o.RecoveryDataServiceIp = v
}
...
// GetClusterReference returns the ClusterReference field value
...
// GetClusterReferenceOk returns a tuple with the ClusterReference field value
// and a boolean to check if the value has been set.
...
// SetClusterReference sets field value
func (o *RecoveryPlanDataServiceIpConfig) SetClusterReference(v ClusterReference) {
	o.ClusterReference = v
}

// GetTestDataServiceIp returns the TestDataServiceIp field value if set, zero value otherwise.
func (o *RecoveryPlanDataServiceIpConfig) GetTestDataServiceIp() string {
	if o == nil || IsNil(o.TestDataServiceIp) {
		var ret string
		return ret
	}
	return *o.TestDataServiceIp
}

// GetTestDataServiceIpOk returns a tuple with the TestDataServiceIp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanDataServiceIpConfig) GetTestDataServiceIpOk() (*string, bool) {
	if o == nil || IsNil(o.TestDataServiceIp) {
		return nil, false
	}
	return o.TestDataServiceIp, true
}
...
// SetTestDataServiceIp gets a reference to the given string and assigns it to the TestDataServiceIp field.
func (o *RecoveryPlanDataServiceIpConfig) SetTestDataServiceIp(v string) {
	o.TestDataServiceIp = &v
}

func (o RecoveryPlanDataServiceIpConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanDataServiceIpConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["recovery_data_service_ip"] = o.RecoveryDataServiceIp
	toSerialize["availability_zone_url"] = o.AvailabilityZoneUrl
	toSerialize["cluster_reference"] = o.ClusterReference
	if !IsNil(o.TestDataServiceIp) {
		toSerialize["test_data_service_ip"] = o.TestDataServiceIp
	}
...
func (o *RecoveryPlanDataServiceIpConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanDataServiceIpConfig := _RecoveryPlanDataServiceIpConfig{}

	err = json.Unmarshal(data, &varRecoveryPlanDataServiceIpConfig)

	if err != nil {
		return err
	}

	*o = RecoveryPlanDataServiceIpConfig(varRecoveryPlanDataServiceIpConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "recovery_data_service_ip")
		delete(additionalProperties, "availability_zone_url")
		delete(additionalProperties, "cluster_reference")
		delete(additionalProperties, "test_data_service_ip")
...
type NullableRecoveryPlanDataServiceIpConfig struct {
	value *RecoveryPlanDataServiceIpConfig
	isSet bool
}

func (v NullableRecoveryPlanDataServiceIpConfig) Get() *RecoveryPlanDataServiceIpConfig {
	return v.value
}

func (v *NullableRecoveryPlanDataServiceIpConfig) Set(val *RecoveryPlanDataServiceIpConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanDataServiceIpConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanDataServiceIpConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanDataServiceIpConfig(val *RecoveryPlanDataServiceIpConfig) *NullableRecoveryPlanDataServiceIpConfig {
	return &NullableRecoveryPlanDataServiceIpConfig{value: val, isSet: true}
}

func (v NullableRecoveryPlanDataServiceIpConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanDataServiceIpConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
