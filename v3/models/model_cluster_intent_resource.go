...
// checks if the ClusterIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterIntentResource{}

// ClusterIntentResource Response object for intentful operations on a cluster
...
type _ClusterIntentResource ClusterIntentResource
...
// SetStatus gets a reference to the given ClusterDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Cluster and assigns it to the Spec field.
...
func (o ClusterIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ClusterIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterIntentResource := _ClusterIntentResource{}

	err = json.Unmarshal(data, &varClusterIntentResource)

	if err != nil {
		return err
	}

	*o = ClusterIntentResource(varClusterIntentResource)
...
type NullableClusterIntentResource struct {
	value *ClusterIntentResource
	isSet bool
}

func (v NullableClusterIntentResource) Get() *ClusterIntentResource {
	return v.value
}

func (v *NullableClusterIntentResource) Set(val *ClusterIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterIntentResource(val *ClusterIntentResource) *NullableClusterIntentResource {
	return &NullableClusterIntentResource{value: val, isSet: true}
}

func (v NullableClusterIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
