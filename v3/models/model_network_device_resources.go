...
// checks if the NetworkDeviceResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDeviceResources{}

// NetworkDeviceResources Network device entity definition
type NetworkDeviceResources struct {
	...
	Component *DatacenterComponent `json:"component,omitempty"`
	// device IP address
	IpAddress *string `json:"ip_address,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// upgrade status
	UpgradeStatus *string `json:"upgrade_status,omitempty"`
	RackReference *RackReference `json:"rack_reference,omitempty"`
	// device model
...
type _NetworkDeviceResources NetworkDeviceResources
...
// GetCurrentFirmwareVersion returns the CurrentFirmwareVersion field value if set, zero value otherwise.
func (o *NetworkDeviceResources) GetCurrentFirmwareVersion() string {
	if o == nil || IsNil(o.CurrentFirmwareVersion) {
		var ret string
		return ret
	}
	return *o.CurrentFirmwareVersion
}

// GetCurrentFirmwareVersionOk returns a tuple with the CurrentFirmwareVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkDeviceResources) GetCurrentFirmwareVersionOk() (*string, bool) {
	if o == nil || IsNil(o.CurrentFirmwareVersion) {
		return nil, false
	}
	return o.CurrentFirmwareVersion, true
}
...
// SetCurrentFirmwareVersion gets a reference to the given string and assigns it to the CurrentFirmwareVersion field.
func (o *NetworkDeviceResources) SetCurrentFirmwareVersion(v string) {
	o.CurrentFirmwareVersion = &v
}
...
// SetComponent gets a reference to the given DatacenterComponent and assigns it to the Component field.
...
// GetRackReference returns the RackReference field value if set, zero value otherwise.
func (o *NetworkDeviceResources) GetRackReference() RackReference {
	if o == nil || IsNil(o.RackReference) {
		var ret RackReference
		return ret
	}
	return *o.RackReference
}

// GetRackReferenceOk returns a tuple with the RackReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NetworkDeviceResources) GetRackReferenceOk() (*RackReference, bool) {
	if o == nil || IsNil(o.RackReference) {
		return nil, false
	}
	return o.RackReference, true
}
...
// SetRackReference gets a reference to the given RackReference and assigns it to the RackReference field.
...
func (o NetworkDeviceResources) MarshalJSON() ([]byte, error) {
...
func (o NetworkDeviceResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Description) {
		toSerialize["description"] = o.Description
	}
	if !IsNil(o.CurrentFirmwareVersion) {
		toSerialize["current_firmware_version"] = o.CurrentFirmwareVersion
	}
	...
	if !IsNil(o.RackReference) {
		toSerialize["rack_reference"] = o.RackReference
	}
	if !IsNil(o.Model) {
	...
	if !IsNil(o.TargetFirmwareVersion) {
		toSerialize["target_firmware_version"] = o.TargetFirmwareVersion
	}
...
func (o *NetworkDeviceResources) UnmarshalJSON(data []byte) (err error) {
	varNetworkDeviceResources := _NetworkDeviceResources{}

	err = json.Unmarshal(data, &varNetworkDeviceResources)

	if err != nil {
		return err
	}

	*o = NetworkDeviceResources(varNetworkDeviceResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "description")
		delete(additionalProperties, "current_firmware_version")
		...
		delete(additionalProperties, "rack_reference")
		delete(additionalProperties, "model")
		delete(additionalProperties, "device_serial")
		delete(additionalProperties, "target_firmware_version")
...
type NullableNetworkDeviceResources struct {
	value *NetworkDeviceResources
	isSet bool
}

func (v NullableNetworkDeviceResources) Get() *NetworkDeviceResources {
	return v.value
}

func (v *NullableNetworkDeviceResources) Set(val *NetworkDeviceResources) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDeviceResources) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDeviceResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDeviceResources(val *NetworkDeviceResources) *NullableNetworkDeviceResources {
	return &NullableNetworkDeviceResources{value: val, isSet: true}
}

func (v NullableNetworkDeviceResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDeviceResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
