...
// checks if the FileItemIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemIntentResponse{}

// FileItemIntentResponse Response object for intentful operations on a file_item
type FileItemIntentResponse struct {
...
type _FileItemIntentResponse FileItemIntentResponse
...
func (o FileItemIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o FileItemIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *FileItemIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varFileItemIntentResponse := _FileItemIntentResponse{}

	err = json.Unmarshal(data, &varFileItemIntentResponse)

	if err != nil {
		return err
	}

	*o = FileItemIntentResponse(varFileItemIntentResponse)
...
type NullableFileItemIntentResponse struct {
	value *FileItemIntentResponse
	isSet bool
}

func (v NullableFileItemIntentResponse) Get() *FileItemIntentResponse {
	return v.value
}

func (v *NullableFileItemIntentResponse) Set(val *FileItemIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemIntentResponse(val *FileItemIntentResponse) *NullableFileItemIntentResponse {
	return &NullableFileItemIntentResponse{value: val, isSet: true}
}

func (v NullableFileItemIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
