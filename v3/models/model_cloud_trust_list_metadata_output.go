...
// checks if the CloudTrustListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustListMetadataOutput{}

// CloudTrustListMetadataOutput All api calls that return a list will have this metadata block 
type CloudTrustListMetadataOutput struct {
	// The kind name
...
type _CloudTrustListMetadataOutput CloudTrustListMetadataOutput
...
func NewCloudTrustListMetadataOutput() *CloudTrustListMetadataOutput {
	this := CloudTrustListMetadataOutput{}
	var kind string = "cloud_trust"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *CloudTrustListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o CloudTrustListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrustListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varCloudTrustListMetadataOutput := _CloudTrustListMetadataOutput{}

	err = json.Unmarshal(data, &varCloudTrustListMetadataOutput)

	if err != nil {
		return err
	}

	*o = CloudTrustListMetadataOutput(varCloudTrustListMetadataOutput)
...
type NullableCloudTrustListMetadataOutput struct {
	value *CloudTrustListMetadataOutput
	isSet bool
}

func (v NullableCloudTrustListMetadataOutput) Get() *CloudTrustListMetadataOutput {
	return v.value
}

func (v *NullableCloudTrustListMetadataOutput) Set(val *CloudTrustListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustListMetadataOutput(val *CloudTrustListMetadataOutput) *NullableCloudTrustListMetadataOutput {
	return &NullableCloudTrustListMetadataOutput{value: val, isSet: true}
}

func (v NullableCloudTrustListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
