...
// checks if the WidgetFieldDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WidgetFieldDescriptor{}

// WidgetFieldDescriptor Description of a field of a widget (eg. column in a table).
type WidgetFieldDescriptor struct {
	// Used when aggregating the field data from multiple values.
	...
	// Human-readable label for widget fields.
	Label *string `json:"label,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _WidgetFieldDescriptor WidgetFieldDescriptor
...
func (o *WidgetFieldDescriptor) GetAggregationOperator() string {
	if o == nil || IsNil(o.AggregationOperator) {
		var ret string
		return ret
	}
...
func (o WidgetFieldDescriptor) MarshalJSON() ([]byte, error) {
...
func (o WidgetFieldDescriptor) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AggregationOperator) {
		toSerialize["aggregation_operator"] = o.AggregationOperator
	}
	if !IsNil(o.Property) {
...
func (o *WidgetFieldDescriptor) UnmarshalJSON(data []byte) (err error) {
	varWidgetFieldDescriptor := _WidgetFieldDescriptor{}

	err = json.Unmarshal(data, &varWidgetFieldDescriptor)

	if err != nil {
		return err
	}

	*o = WidgetFieldDescriptor(varWidgetFieldDescriptor)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "aggregation_operator")
...
type NullableWidgetFieldDescriptor struct {
	value *WidgetFieldDescriptor
	isSet bool
}

func (v NullableWidgetFieldDescriptor) Get() *WidgetFieldDescriptor {
	return v.value
}

func (v *NullableWidgetFieldDescriptor) Set(val *WidgetFieldDescriptor) {
	v.value = val
	v.isSet = true
}

func (v NullableWidgetFieldDescriptor) IsSet() bool {
	return v.isSet
}

func (v *NullableWidgetFieldDescriptor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWidgetFieldDescriptor(val *WidgetFieldDescriptor) *NullableWidgetFieldDescriptor {
	return &NullableWidgetFieldDescriptor{value: val, isSet: true}
}

func (v NullableWidgetFieldDescriptor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWidgetFieldDescriptor) UnmarshalJSON(src []byte) error {
	v.isSet = true
