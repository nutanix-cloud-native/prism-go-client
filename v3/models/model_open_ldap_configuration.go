...
// checks if the OpenLdapConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenLdapConfiguration{}

// OpenLdapConfiguration Configuration for OpenLDAP directory service.
type OpenLdapConfiguration struct {
	UserConfiguration OpenLdapConfigurationUserConfiguration `json:"user_configuration"`
	UserGroupConfiguration OpenLdapConfigurationUserGroupConfiguration `json:"user_group_configuration"`
	AdditionalProperties map[string]interface{}
}

type _OpenLdapConfiguration OpenLdapConfiguration
...
// GetUserConfiguration returns the UserConfiguration field value
func (o *OpenLdapConfiguration) GetUserConfiguration() OpenLdapConfigurationUserConfiguration {
	if o == nil {
		var ret OpenLdapConfigurationUserConfiguration
		return ret
	}
...
// GetUserConfigurationOk returns a tuple with the UserConfiguration field value
...
// SetUserConfiguration sets field value
func (o *OpenLdapConfiguration) SetUserConfiguration(v OpenLdapConfigurationUserConfiguration) {
	o.UserConfiguration = v
}

// GetUserGroupConfiguration returns the UserGroupConfiguration field value
func (o *OpenLdapConfiguration) GetUserGroupConfiguration() OpenLdapConfigurationUserGroupConfiguration {
	if o == nil {
		var ret OpenLdapConfigurationUserGroupConfiguration
		return ret
	}

	return o.UserGroupConfiguration
}

// GetUserGroupConfigurationOk returns a tuple with the UserGroupConfiguration field value
// and a boolean to check if the value has been set.
func (o *OpenLdapConfiguration) GetUserGroupConfigurationOk() (*OpenLdapConfigurationUserGroupConfiguration, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UserGroupConfiguration, true
}

// SetUserGroupConfiguration sets field value
func (o *OpenLdapConfiguration) SetUserGroupConfiguration(v OpenLdapConfigurationUserGroupConfiguration) {
	o.UserGroupConfiguration = v
}

func (o OpenLdapConfiguration) MarshalJSON() ([]byte, error) {
...
func (o OpenLdapConfiguration) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["user_configuration"] = o.UserConfiguration
	toSerialize["user_group_configuration"] = o.UserGroupConfiguration
...
func (o *OpenLdapConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenLdapConfiguration := _OpenLdapConfiguration{}

	err = json.Unmarshal(data, &varOpenLdapConfiguration)

	if err != nil {
		return err
	}

	*o = OpenLdapConfiguration(varOpenLdapConfiguration)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "user_configuration")
		delete(additionalProperties, "user_group_configuration")
...
type NullableOpenLdapConfiguration struct {
	value *OpenLdapConfiguration
	isSet bool
}

func (v NullableOpenLdapConfiguration) Get() *OpenLdapConfiguration {
	return v.value
}

func (v *NullableOpenLdapConfiguration) Set(val *OpenLdapConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenLdapConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenLdapConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenLdapConfiguration(val *OpenLdapConfiguration) *NullableOpenLdapConfiguration {
	return &NullableOpenLdapConfiguration{value: val, isSet: true}
}

func (v NullableOpenLdapConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenLdapConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
