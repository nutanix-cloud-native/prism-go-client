...
// checks if the AppPublishedServiceInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPublishedServiceInput{}

// AppPublishedServiceInput Published service definition
type AppPublishedServiceInput struct {
...
type _AppPublishedServiceInput AppPublishedServiceInput
...
func (o AppPublishedServiceInput) MarshalJSON() ([]byte, error) {
...
func (o AppPublishedServiceInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppPublishedServiceInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPublishedServiceInput := _AppPublishedServiceInput{}

	err = json.Unmarshal(data, &varAppPublishedServiceInput)

	if err != nil {
		return err
	}

	*o = AppPublishedServiceInput(varAppPublishedServiceInput)
...
type NullableAppPublishedServiceInput struct {
	value *AppPublishedServiceInput
	isSet bool
}

func (v NullableAppPublishedServiceInput) Get() *AppPublishedServiceInput {
	return v.value
}

func (v *NullableAppPublishedServiceInput) Set(val *AppPublishedServiceInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPublishedServiceInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPublishedServiceInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPublishedServiceInput(val *AppPublishedServiceInput) *NullableAppPublishedServiceInput {
	return &NullableAppPublishedServiceInput{value: val, isSet: true}
}

func (v NullableAppPublishedServiceInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPublishedServiceInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
