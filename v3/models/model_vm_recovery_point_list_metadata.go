...
// checks if the VmRecoveryPointListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPointListMetadata{}

// VmRecoveryPointListMetadata All api calls that return a list will have this metadata block as input 
type VmRecoveryPointListMetadata struct {
	// The kind name
...
type _VmRecoveryPointListMetadata VmRecoveryPointListMetadata
...
func NewVmRecoveryPointListMetadata() *VmRecoveryPointListMetadata {
	this := VmRecoveryPointListMetadata{}
...
func (o VmRecoveryPointListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPointListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPointListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVmRecoveryPointListMetadata := _VmRecoveryPointListMetadata{}

	err = json.Unmarshal(data, &varVmRecoveryPointListMetadata)

	if err != nil {
		return err
	}

	*o = VmRecoveryPointListMetadata(varVmRecoveryPointListMetadata)
...
type NullableVmRecoveryPointListMetadata struct {
	value *VmRecoveryPointListMetadata
	isSet bool
}

func (v NullableVmRecoveryPointListMetadata) Get() *VmRecoveryPointListMetadata {
	return v.value
}

func (v *NullableVmRecoveryPointListMetadata) Set(val *VmRecoveryPointListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPointListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPointListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPointListMetadata(val *VmRecoveryPointListMetadata) *NullableVmRecoveryPointListMetadata {
	return &NullableVmRecoveryPointListMetadata{value: val, isSet: true}
}

func (v NullableVmRecoveryPointListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPointListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
