...
// checks if the CellMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CellMetadata{}

// CellMetadata The cell kind metadata
type CellMetadata struct {
	...
	// Categories for the cell. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the cell. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _CellMetadata CellMetadata
...
func (o CellMetadata) MarshalJSON() ([]byte, error) {
...
func (o CellMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CellMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varCellMetadata := _CellMetadata{}

	err = json.Unmarshal(data, &varCellMetadata)

	if err != nil {
		return err
	}

	*o = CellMetadata(varCellMetadata)
...
type NullableCellMetadata struct {
	value *CellMetadata
	isSet bool
}

func (v NullableCellMetadata) Get() *CellMetadata {
	return v.value
}

func (v *NullableCellMetadata) Set(val *CellMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCellMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCellMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCellMetadata(val *CellMetadata) *NullableCellMetadata {
	return &NullableCellMetadata{value: val, isSet: true}
}

func (v NullableCellMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCellMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
