...
// checks if the AlertState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertState{}

// AlertState The status data construct for acknowledgement and resolution.
type AlertState struct {
	// A boolean status for acknowledgement or resolution
	IsTrue *bool `json:"is_true,omitempty"`
	// It is automatically resolved or user manually resolved.  Currently, it is limtied to the resolution only. 
	IsAutoResolved *bool `json:"is_auto_resolved,omitempty"`
	// Name of the user who change this alert status.
	User *string `json:"user,omitempty"`
	// The time the alert status was changed.
	Time *time.Time `json:"time,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AlertState AlertState
...
// GetIsTrue returns the IsTrue field value if set, zero value otherwise.
func (o *AlertState) GetIsTrue() bool {
	if o == nil || IsNil(o.IsTrue) {
		var ret bool
		return ret
	}
	return *o.IsTrue
...
// GetIsTrueOk returns a tuple with the IsTrue field value if set, nil otherwise
...
// SetIsTrue gets a reference to the given bool and assigns it to the IsTrue field.
func (o *AlertState) SetIsTrue(v bool) {
	o.IsTrue = &v
}

// GetIsAutoResolved returns the IsAutoResolved field value if set, zero value otherwise.
func (o *AlertState) GetIsAutoResolved() bool {
	if o == nil || IsNil(o.IsAutoResolved) {
		var ret bool
		return ret
	}
	return *o.IsAutoResolved
}

// GetIsAutoResolvedOk returns a tuple with the IsAutoResolved field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertState) GetIsAutoResolvedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsAutoResolved) {
		return nil, false
	}
	return o.IsAutoResolved, true
}
...
// SetIsAutoResolved gets a reference to the given bool and assigns it to the IsAutoResolved field.
...
func (o AlertState) MarshalJSON() ([]byte, error) {
...
func (o AlertState) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IsTrue) {
		toSerialize["is_true"] = o.IsTrue
	}
	if !IsNil(o.IsAutoResolved) {
		toSerialize["is_auto_resolved"] = o.IsAutoResolved
	}
	if !IsNil(o.User) {
...
func (o *AlertState) UnmarshalJSON(data []byte) (err error) {
	varAlertState := _AlertState{}

	err = json.Unmarshal(data, &varAlertState)

	if err != nil {
		return err
	}

	*o = AlertState(varAlertState)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "is_true")
		delete(additionalProperties, "is_auto_resolved")
