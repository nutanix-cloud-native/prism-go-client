...
// checks if the VirtualNetworkListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkListIntentResponse{}

// VirtualNetworkListIntentResponse Response object for intentful operation of virtual_networks
type VirtualNetworkListIntentResponse struct {
	Entities []VirtualNetworkIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata VirtualNetworkListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VirtualNetworkListIntentResponse VirtualNetworkListIntentResponse
...
func NewVirtualNetworkListIntentResponse(apiVersion string, metadata VirtualNetworkListMetadataOutput) *VirtualNetworkListIntentResponse {
	this := VirtualNetworkListIntentResponse{}
...
func (o *VirtualNetworkListIntentResponse) GetEntities() []VirtualNetworkIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []VirtualNetworkIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []VirtualNetworkIntentResource and assigns it to the Entities field.
...
func (o *VirtualNetworkListIntentResponse) GetMetadata() VirtualNetworkListMetadataOutput {
	if o == nil {
		var ret VirtualNetworkListMetadataOutput
		return ret
	}
...
func (o VirtualNetworkListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualNetworkListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualNetworkListIntentResponse := _VirtualNetworkListIntentResponse{}

	err = json.Unmarshal(data, &varVirtualNetworkListIntentResponse)

	if err != nil {
		return err
	}

	*o = VirtualNetworkListIntentResponse(varVirtualNetworkListIntentResponse)
...
type NullableVirtualNetworkListIntentResponse struct {
	value *VirtualNetworkListIntentResponse
	isSet bool
}

func (v NullableVirtualNetworkListIntentResponse) Get() *VirtualNetworkListIntentResponse {
	return v.value
}

func (v *NullableVirtualNetworkListIntentResponse) Set(val *VirtualNetworkListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkListIntentResponse(val *VirtualNetworkListIntentResponse) *NullableVirtualNetworkListIntentResponse {
	return &NullableVirtualNetworkListIntentResponse{value: val, isSet: true}
}

func (v NullableVirtualNetworkListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
