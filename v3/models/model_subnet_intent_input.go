...
// checks if the SubnetIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubnetIntentInput{}
...
type _SubnetIntentInput SubnetIntentInput
...
func (o SubnetIntentInput) MarshalJSON() ([]byte, error) {
...
func (o SubnetIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *SubnetIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varSubnetIntentInput := _SubnetIntentInput{}

	err = json.Unmarshal(data, &varSubnetIntentInput)

	if err != nil {
		return err
	}

	*o = SubnetIntentInput(varSubnetIntentInput)
...
type NullableSubnetIntentInput struct {
	value *SubnetIntentInput
	isSet bool
}

func (v NullableSubnetIntentInput) Get() *SubnetIntentInput {
	return v.value
}

func (v *NullableSubnetIntentInput) Set(val *SubnetIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableSubnetIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableSubnetIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubnetIntentInput(val *SubnetIntentInput) *NullableSubnetIntentInput {
	return &NullableSubnetIntentInput{value: val, isSet: true}
}

func (v NullableSubnetIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubnetIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
