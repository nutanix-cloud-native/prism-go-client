...
// checks if the VpnGatewayIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayIntentResource{}

// VpnGatewayIntentResource Response object for intentful operations on a vpn_gateway
type VpnGatewayIntentResource struct {
	Status *VpnGatewayDefStatus `json:"status,omitempty"`
	Spec *VpnGateway `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata VpnGatewayMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VpnGatewayIntentResource VpnGatewayIntentResource
...
// SetStatus gets a reference to the given VpnGatewayDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given VpnGateway and assigns it to the Spec field.
...
func (o VpnGatewayIntentResource) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *VpnGatewayIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnGatewayIntentResource := _VpnGatewayIntentResource{}

	err = json.Unmarshal(data, &varVpnGatewayIntentResource)

	if err != nil {
		return err
	}

	*o = VpnGatewayIntentResource(varVpnGatewayIntentResource)
...
type NullableVpnGatewayIntentResource struct {
	value *VpnGatewayIntentResource
	isSet bool
}

func (v NullableVpnGatewayIntentResource) Get() *VpnGatewayIntentResource {
	return v.value
}

func (v *NullableVpnGatewayIntentResource) Set(val *VpnGatewayIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayIntentResource(val *VpnGatewayIntentResource) *NullableVpnGatewayIntentResource {
	return &NullableVpnGatewayIntentResource{value: val, isSet: true}
}

func (v NullableVpnGatewayIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
