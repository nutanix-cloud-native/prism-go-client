...
// checks if the AppRule1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRule1{}

// AppRule1 These rules govern what flows are allowed for app rules. Target group is a required attribute. Empty inbound_allow_list will not allow anything into the target group. Empty outbound_allow_list will not allow anything from the target group. 
type AppRule1 struct {
	// Type of deployment of the rule.
...
func (o AppRule1) MarshalJSON() ([]byte, error) {
...
func (o AppRule1) ToMap() (map[string]interface{}, error) {
...
func (o *AppRule1) UnmarshalJSON(data []byte) (err error) {
	varAppRule1 := _AppRule1{}

	err = json.Unmarshal(data, &varAppRule1)

	if err != nil {
		return err
	}

	*o = AppRule1(varAppRule1)
...
type NullableAppRule1 struct {
	value *AppRule1
	isSet bool
}

func (v NullableAppRule1) Get() *AppRule1 {
	return v.value
}

func (v *NullableAppRule1) Set(val *AppRule1) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRule1) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRule1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRule1(val *AppRule1) *NullableAppRule1 {
	return &NullableAppRule1{value: val, isSet: true}
}

func (v NullableAppRule1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRule1) UnmarshalJSON(src []byte) error {
	v.isSet = true
