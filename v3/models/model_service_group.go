...
// ServiceGroup Service Group definition
type ServiceGroup struct {
	// List of port, protocol or icmp codes
	ServiceList []FlowService `json:"service_list,omitempty"`
...
type _ServiceGroup ServiceGroup
...
// SetServiceList gets a reference to the given []FlowService and assigns it to the ServiceList field.
...
func (o *ServiceGroup) UnmarshalJSON(data []byte) (err error) {
	varServiceGroup := _ServiceGroup{}

	err = json.Unmarshal(data, &varServiceGroup)

	if err != nil {
		return err
	}

	*o = ServiceGroup(varServiceGroup)
