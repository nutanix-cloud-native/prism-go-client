...
// checks if the UserIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserIntentInput{}

// UserIntentInput An intentful representation of a user
...
type _UserIntentInput UserIntentInput
...
func (o UserIntentInput) MarshalJSON() ([]byte, error) {
...
func (o UserIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *UserIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varUserIntentInput := _UserIntentInput{}

	err = json.Unmarshal(data, &varUserIntentInput)

	if err != nil {
		return err
	}

	*o = UserIntentInput(varUserIntentInput)
...
type NullableUserIntentInput struct {
	value *UserIntentInput
	isSet bool
}

func (v NullableUserIntentInput) Get() *UserIntentInput {
	return v.value
}

func (v *NullableUserIntentInput) Set(val *UserIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableUserIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableUserIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserIntentInput(val *UserIntentInput) *NullableUserIntentInput {
	return &NullableUserIntentInput{value: val, isSet: true}
}

func (v NullableUserIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
