...
// checks if the VmHostAffinityPolicyListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityPolicyListResponse{}

// VmHostAffinityPolicyListResponse Response object for list operation of VM Host Affinity Policy.
type VmHostAffinityPolicyListResponse struct {
	Entities []VmHostAffinityPolicyGetResponse `json:"entities,omitempty"`
	Metadata VmHostAffinityPolicyListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _VmHostAffinityPolicyListResponse VmHostAffinityPolicyListResponse
...
func NewVmHostAffinityPolicyListResponse(metadata VmHostAffinityPolicyListMetadataOutput) *VmHostAffinityPolicyListResponse {
	this := VmHostAffinityPolicyListResponse{}
...
func (o *VmHostAffinityPolicyListResponse) GetEntities() []VmHostAffinityPolicyGetResponse {
	if o == nil || IsNil(o.Entities) {
		var ret []VmHostAffinityPolicyGetResponse
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []VmHostAffinityPolicyGetResponse and assigns it to the Entities field.
...
func (o *VmHostAffinityPolicyListResponse) GetMetadata() VmHostAffinityPolicyListMetadataOutput {
	if o == nil {
		var ret VmHostAffinityPolicyListMetadataOutput
		return ret
	}
...
func (o VmHostAffinityPolicyListResponse) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityPolicyListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VmHostAffinityPolicyListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVmHostAffinityPolicyListResponse := _VmHostAffinityPolicyListResponse{}

	err = json.Unmarshal(data, &varVmHostAffinityPolicyListResponse)

	if err != nil {
		return err
	}

	*o = VmHostAffinityPolicyListResponse(varVmHostAffinityPolicyListResponse)
...
type NullableVmHostAffinityPolicyListResponse struct {
	value *VmHostAffinityPolicyListResponse
	isSet bool
}

func (v NullableVmHostAffinityPolicyListResponse) Get() *VmHostAffinityPolicyListResponse {
	return v.value
}

func (v *NullableVmHostAffinityPolicyListResponse) Set(val *VmHostAffinityPolicyListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityPolicyListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityPolicyListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityPolicyListResponse(val *VmHostAffinityPolicyListResponse) *NullableVmHostAffinityPolicyListResponse {
	return &NullableVmHostAffinityPolicyListResponse{value: val, isSet: true}
}

func (v NullableVmHostAffinityPolicyListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityPolicyListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
