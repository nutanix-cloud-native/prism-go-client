...
// checks if the RecoveryPlanListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanListMetadata{}

// RecoveryPlanListMetadata All api calls that return a list will have this metadata block as input 
type RecoveryPlanListMetadata struct {
	// The kind name
...
type _RecoveryPlanListMetadata RecoveryPlanListMetadata
...
func (o RecoveryPlanListMetadata) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanListMetadata) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanListMetadata := _RecoveryPlanListMetadata{}

	err = json.Unmarshal(data, &varRecoveryPlanListMetadata)

	if err != nil {
		return err
	}

	*o = RecoveryPlanListMetadata(varRecoveryPlanListMetadata)
...
type NullableRecoveryPlanListMetadata struct {
	value *RecoveryPlanListMetadata
	isSet bool
}

func (v NullableRecoveryPlanListMetadata) Get() *RecoveryPlanListMetadata {
	return v.value
}

func (v *NullableRecoveryPlanListMetadata) Set(val *RecoveryPlanListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanListMetadata(val *RecoveryPlanListMetadata) *NullableRecoveryPlanListMetadata {
	return &NullableRecoveryPlanListMetadata{value: val, isSet: true}
}

func (v NullableRecoveryPlanListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
