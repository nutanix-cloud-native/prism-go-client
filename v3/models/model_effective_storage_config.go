...
// checks if the EffectiveStorageConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EffectiveStorageConfig{}

// EffectiveStorageConfig Indicates the storage configuration attributes being effective on the VM. This state is resultant of storage attributes configured on the VM and storage policies associated with the VM. 
type EffectiveStorageConfig struct {
	// Deprecated. Delay in seconds after which the VM disk data will be compressed. 
...
type _EffectiveStorageConfig EffectiveStorageConfig
...
func (o EffectiveStorageConfig) MarshalJSON() ([]byte, error) {
...
func (o EffectiveStorageConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CompressionDelaySecs) {
		toSerialize["compression_delay_secs"] = o.CompressionDelaySecs
	}
...
func (o *EffectiveStorageConfig) UnmarshalJSON(data []byte) (err error) {
	varEffectiveStorageConfig := _EffectiveStorageConfig{}

	err = json.Unmarshal(data, &varEffectiveStorageConfig)

	if err != nil {
		return err
	}

	*o = EffectiveStorageConfig(varEffectiveStorageConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "compression_delay_secs")
...
type NullableEffectiveStorageConfig struct {
	value *EffectiveStorageConfig
	isSet bool
}

func (v NullableEffectiveStorageConfig) Get() *EffectiveStorageConfig {
	return v.value
}

func (v *NullableEffectiveStorageConfig) Set(val *EffectiveStorageConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableEffectiveStorageConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableEffectiveStorageConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEffectiveStorageConfig(val *EffectiveStorageConfig) *NullableEffectiveStorageConfig {
	return &NullableEffectiveStorageConfig{value: val, isSet: true}
}

func (v NullableEffectiveStorageConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEffectiveStorageConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
