...
// checks if the AwsRoleListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRoleListIntentResponse{}

// AwsRoleListIntentResponse AWS VPC entity list.
type AwsRoleListIntentResponse struct {
	Entities []AwsRoleIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsRoleListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsRoleListIntentResponse AwsRoleListIntentResponse
...
func NewAwsRoleListIntentResponse(apiVersion string, metadata AwsRoleListMetadataOutput) *AwsRoleListIntentResponse {
	this := AwsRoleListIntentResponse{}
...
// SetEntities gets a reference to the given []AwsRoleIntentResource and assigns it to the Entities field.
...
func (o *AwsRoleListIntentResponse) GetMetadata() AwsRoleListMetadataOutput {
	if o == nil {
		var ret AwsRoleListMetadataOutput
		return ret
	}
...
func (o AwsRoleListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsRoleListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRoleListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsRoleListIntentResponse := _AwsRoleListIntentResponse{}

	err = json.Unmarshal(data, &varAwsRoleListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsRoleListIntentResponse(varAwsRoleListIntentResponse)
...
type NullableAwsRoleListIntentResponse struct {
	value *AwsRoleListIntentResponse
	isSet bool
}

func (v NullableAwsRoleListIntentResponse) Get() *AwsRoleListIntentResponse {
	return v.value
}

func (v *NullableAwsRoleListIntentResponse) Set(val *AwsRoleListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRoleListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRoleListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRoleListIntentResponse(val *AwsRoleListIntentResponse) *NullableAwsRoleListIntentResponse {
	return &NullableAwsRoleListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsRoleListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRoleListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
