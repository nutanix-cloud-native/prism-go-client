...
// checks if the ActionTriggerTypeListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTriggerTypeListIntentResponse{}

// ActionTriggerTypeListIntentResponse Response object for intentful operation of action_trigger_types
type ActionTriggerTypeListIntentResponse struct {
	Entities []ActionTriggerTypeIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ActionTriggerTypeListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ActionTriggerTypeListIntentResponse ActionTriggerTypeListIntentResponse
...
func NewActionTriggerTypeListIntentResponse(apiVersion string, metadata ActionTriggerTypeListMetadataOutput) *ActionTriggerTypeListIntentResponse {
	this := ActionTriggerTypeListIntentResponse{}
...
func (o *ActionTriggerTypeListIntentResponse) GetEntities() []ActionTriggerTypeIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []ActionTriggerTypeIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []ActionTriggerTypeIntentResource and assigns it to the Entities field.
...
func (o *ActionTriggerTypeListIntentResponse) GetMetadata() ActionTriggerTypeListMetadataOutput {
	if o == nil {
		var ret ActionTriggerTypeListMetadataOutput
		return ret
	}
...
func (o ActionTriggerTypeListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ActionTriggerTypeListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTriggerTypeListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTriggerTypeListIntentResponse := _ActionTriggerTypeListIntentResponse{}

	err = json.Unmarshal(data, &varActionTriggerTypeListIntentResponse)

	if err != nil {
		return err
	}

	*o = ActionTriggerTypeListIntentResponse(varActionTriggerTypeListIntentResponse)
...
type NullableActionTriggerTypeListIntentResponse struct {
	value *ActionTriggerTypeListIntentResponse
	isSet bool
}

func (v NullableActionTriggerTypeListIntentResponse) Get() *ActionTriggerTypeListIntentResponse {
	return v.value
}

func (v *NullableActionTriggerTypeListIntentResponse) Set(val *ActionTriggerTypeListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTriggerTypeListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTriggerTypeListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTriggerTypeListIntentResponse(val *ActionTriggerTypeListIntentResponse) *NullableActionTriggerTypeListIntentResponse {
	return &NullableActionTriggerTypeListIntentResponse{value: val, isSet: true}
}

func (v NullableActionTriggerTypeListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTriggerTypeListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
