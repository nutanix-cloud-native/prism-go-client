...
// checks if the AwsMachineTypeListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsMachineTypeListIntentResponse{}

// AwsMachineTypeListIntentResponse AWS VPC entity list.
type AwsMachineTypeListIntentResponse struct {
	Entities []AwsMachineTypeIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsMachineTypeListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsMachineTypeListIntentResponse AwsMachineTypeListIntentResponse
...
func NewAwsMachineTypeListIntentResponse(apiVersion string, metadata AwsMachineTypeListMetadataOutput) *AwsMachineTypeListIntentResponse {
	this := AwsMachineTypeListIntentResponse{}
...
func (o *AwsMachineTypeListIntentResponse) GetEntities() []AwsMachineTypeIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []AwsMachineTypeIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []AwsMachineTypeIntentResource and assigns it to the Entities field.
...
func (o *AwsMachineTypeListIntentResponse) GetMetadata() AwsMachineTypeListMetadataOutput {
	if o == nil {
		var ret AwsMachineTypeListMetadataOutput
		return ret
	}
...
func (o AwsMachineTypeListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsMachineTypeListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsMachineTypeListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsMachineTypeListIntentResponse := _AwsMachineTypeListIntentResponse{}

	err = json.Unmarshal(data, &varAwsMachineTypeListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsMachineTypeListIntentResponse(varAwsMachineTypeListIntentResponse)
...
type NullableAwsMachineTypeListIntentResponse struct {
	value *AwsMachineTypeListIntentResponse
	isSet bool
}

func (v NullableAwsMachineTypeListIntentResponse) Get() *AwsMachineTypeListIntentResponse {
	return v.value
}

func (v *NullableAwsMachineTypeListIntentResponse) Set(val *AwsMachineTypeListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsMachineTypeListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsMachineTypeListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsMachineTypeListIntentResponse(val *AwsMachineTypeListIntentResponse) *NullableAwsMachineTypeListIntentResponse {
	return &NullableAwsMachineTypeListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsMachineTypeListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsMachineTypeListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
