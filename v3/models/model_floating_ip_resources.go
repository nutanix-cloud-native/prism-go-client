...
// checks if the FloatingIpResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpResources{}

// FloatingIpResources Associate Floating IP to NIC
...
type _FloatingIpResources FloatingIpResources
...
func (o FloatingIpResources) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpResources) ToMap() (map[string]interface{}, error) {
...
func (o *FloatingIpResources) UnmarshalJSON(data []byte) (err error) {
	varFloatingIpResources := _FloatingIpResources{}

	err = json.Unmarshal(data, &varFloatingIpResources)

	if err != nil {
		return err
	}

	*o = FloatingIpResources(varFloatingIpResources)
...
type NullableFloatingIpResources struct {
	value *FloatingIpResources
	isSet bool
}

func (v NullableFloatingIpResources) Get() *FloatingIpResources {
	return v.value
}

func (v *NullableFloatingIpResources) Set(val *FloatingIpResources) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpResources) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpResources(val *FloatingIpResources) *NullableFloatingIpResources {
	return &NullableFloatingIpResources{value: val, isSet: true}
}

func (v NullableFloatingIpResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
