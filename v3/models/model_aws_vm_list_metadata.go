...
// checks if the AwsVmListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVmListMetadata{}

// AwsVmListMetadata All api calls that return a list will have this metadata block as input 
type AwsVmListMetadata struct {
	// The kind name
...
type _AwsVmListMetadata AwsVmListMetadata
...
func (o AwsVmListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsVmListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVmListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsVmListMetadata := _AwsVmListMetadata{}

	err = json.Unmarshal(data, &varAwsVmListMetadata)

	if err != nil {
		return err
	}

	*o = AwsVmListMetadata(varAwsVmListMetadata)
...
type NullableAwsVmListMetadata struct {
	value *AwsVmListMetadata
	isSet bool
}

func (v NullableAwsVmListMetadata) Get() *AwsVmListMetadata {
	return v.value
}

func (v *NullableAwsVmListMetadata) Set(val *AwsVmListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVmListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVmListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVmListMetadata(val *AwsVmListMetadata) *NullableAwsVmListMetadata {
	return &NullableAwsVmListMetadata{value: val, isSet: true}
}

func (v NullableAwsVmListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVmListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
