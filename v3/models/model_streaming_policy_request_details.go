...
// checks if the StreamingPolicyRequestDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyRequestDetails{}

// StreamingPolicyRequestDetails Streaming policy request details
type StreamingPolicyRequestDetails struct {
	// If policy is enabled
	IsEnabled *bool `json:"is_enabled,omitempty"`
	// Time window on which policy needs to be applied
	WindowDuration *string `json:"window_duration,omitempty"`
	// How often policy needs to be evaluated
	ExecutionFrequency *string `json:"execution_frequency,omitempty"`
	// Policy as SQL string
	SqlQuery string `json:"sql_query"`
	AdditionalProperties map[string]interface{}
}

type _StreamingPolicyRequestDetails StreamingPolicyRequestDetails
...
func NewStreamingPolicyRequestDetails(sqlQuery string) *StreamingPolicyRequestDetails {
	this := StreamingPolicyRequestDetails{}
	var isEnabled bool = true
	this.IsEnabled = &isEnabled
	var windowDuration string = "FIVE_MINUTES"
	this.WindowDuration = &windowDuration
	var executionFrequency string = "FIVE_MINUTES"
...
// GetWindowDuration returns the WindowDuration field value if set, zero value otherwise.
func (o *StreamingPolicyRequestDetails) GetWindowDuration() string {
	if o == nil || IsNil(o.WindowDuration) {
		var ret string
		return ret
	}
...
// GetWindowDurationOk returns a tuple with the WindowDuration field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StreamingPolicyRequestDetails) GetWindowDurationOk() (*string, bool) {
	if o == nil || IsNil(o.WindowDuration) {
		return nil, false
	}
	return o.WindowDuration, true
}
...
// SetWindowDuration gets a reference to the given string and assigns it to the WindowDuration field.
...
func (o *StreamingPolicyRequestDetails) GetExecutionFrequency() string {
	if o == nil || IsNil(o.ExecutionFrequency) {
		var ret string
		return ret
	}
...
func (o StreamingPolicyRequestDetails) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyRequestDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IsEnabled) {
		toSerialize["is_enabled"] = o.IsEnabled
	}
	if !IsNil(o.WindowDuration) {
		toSerialize["window_duration"] = o.WindowDuration
	}
	if !IsNil(o.ExecutionFrequency) {
		toSerialize["execution_frequency"] = o.ExecutionFrequency
	}
	toSerialize["sql_query"] = o.SqlQuery
...
func (o *StreamingPolicyRequestDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varStreamingPolicyRequestDetails := _StreamingPolicyRequestDetails{}

	err = json.Unmarshal(data, &varStreamingPolicyRequestDetails)

	if err != nil {
		return err
	}

	*o = StreamingPolicyRequestDetails(varStreamingPolicyRequestDetails)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "is_enabled")
		delete(additionalProperties, "window_duration")
		delete(additionalProperties, "execution_frequency")
		delete(additionalProperties, "sql_query")
...
type NullableStreamingPolicyRequestDetails struct {
	value *StreamingPolicyRequestDetails
	isSet bool
}

func (v NullableStreamingPolicyRequestDetails) Get() *StreamingPolicyRequestDetails {
	return v.value
}

func (v *NullableStreamingPolicyRequestDetails) Set(val *StreamingPolicyRequestDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyRequestDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyRequestDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyRequestDetails(val *StreamingPolicyRequestDetails) *NullableStreamingPolicyRequestDetails {
	return &NullableStreamingPolicyRequestDetails{value: val, isSet: true}
}

func (v NullableStreamingPolicyRequestDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyRequestDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
