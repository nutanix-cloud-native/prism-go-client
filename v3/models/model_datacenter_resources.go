...
// checks if the DatacenterResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterResources{}

// DatacenterResources Datacenter entity definition
type DatacenterResources struct {
	AvailabilityZoneReference AvailabilityZoneReference `json:"availability_zone_reference"`
	Address *PostalAddress `json:"address,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DatacenterResources DatacenterResources
...
// SetAddress gets a reference to the given PostalAddress and assigns it to the Address field.
func (o *DatacenterResources) SetAddress(v PostalAddress) {
	o.Address = &v
}

func (o DatacenterResources) MarshalJSON() ([]byte, error) {
...
func (o DatacenterResources) ToMap() (map[string]interface{}, error) {
...
func (o *DatacenterResources) UnmarshalJSON(data []byte) (err error) {
	...
	varDatacenterResources := _DatacenterResources{}

	err = json.Unmarshal(data, &varDatacenterResources)

	if err != nil {
		return err
	}

	*o = DatacenterResources(varDatacenterResources)
...
type NullableDatacenterResources struct {
	value *DatacenterResources
	isSet bool
}

func (v NullableDatacenterResources) Get() *DatacenterResources {
	return v.value
}

func (v *NullableDatacenterResources) Set(val *DatacenterResources) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterResources) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterResources(val *DatacenterResources) *NullableDatacenterResources {
	return &NullableDatacenterResources{value: val, isSet: true}
}

func (v NullableDatacenterResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
