...
// checks if the ImageVersionResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageVersionResources{}
...
type _ImageVersionResources ImageVersionResources
...
func (o ImageVersionResources) MarshalJSON() ([]byte, error) {
...
func (o ImageVersionResources) ToMap() (map[string]interface{}, error) {
...
func (o *ImageVersionResources) UnmarshalJSON(data []byte) (err error) {
	...
	varImageVersionResources := _ImageVersionResources{}

	err = json.Unmarshal(data, &varImageVersionResources)

	if err != nil {
		return err
	}

	*o = ImageVersionResources(varImageVersionResources)
...
type NullableImageVersionResources struct {
	value *ImageVersionResources
	isSet bool
}

func (v NullableImageVersionResources) Get() *ImageVersionResources {
	return v.value
}

func (v *NullableImageVersionResources) Set(val *ImageVersionResources) {
	v.value = val
	v.isSet = true
}

func (v NullableImageVersionResources) IsSet() bool {
	return v.isSet
}

func (v *NullableImageVersionResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageVersionResources(val *ImageVersionResources) *NullableImageVersionResources {
	return &NullableImageVersionResources{value: val, isSet: true}
}

func (v NullableImageVersionResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageVersionResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
