...
// checks if the ActionTemplateMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTemplateMetadata{}

// ActionTemplateMetadata The action_template kind metadata
type ActionTemplateMetadata struct {
	// UTC date and time in RFC-3339 format when action_template was last updated 
	...
	// UTC date and time in RFC-3339 format when action_template was created 
	...
	// Categories for the action_template. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the action_template. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _ActionTemplateMetadata ActionTemplateMetadata
...
func (o ActionTemplateMetadata) MarshalJSON() ([]byte, error) {
...
func (o ActionTemplateMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTemplateMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTemplateMetadata := _ActionTemplateMetadata{}

	err = json.Unmarshal(data, &varActionTemplateMetadata)

	if err != nil {
		return err
	}

	*o = ActionTemplateMetadata(varActionTemplateMetadata)
...
type NullableActionTemplateMetadata struct {
	value *ActionTemplateMetadata
	isSet bool
}

func (v NullableActionTemplateMetadata) Get() *ActionTemplateMetadata {
	return v.value
}

func (v *NullableActionTemplateMetadata) Set(val *ActionTemplateMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTemplateMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTemplateMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTemplateMetadata(val *ActionTemplateMetadata) *NullableActionTemplateMetadata {
	return &NullableActionTemplateMetadata{value: val, isSet: true}
}

func (v NullableActionTemplateMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTemplateMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
