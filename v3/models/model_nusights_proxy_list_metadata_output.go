...
// checks if the NusightsProxyListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NusightsProxyListMetadataOutput{}

// NusightsProxyListMetadataOutput All api calls that return a list will have this metadata block 
type NusightsProxyListMetadataOutput struct {
	// The kind name
...
type _NusightsProxyListMetadataOutput NusightsProxyListMetadataOutput
...
func NewNusightsProxyListMetadataOutput() *NusightsProxyListMetadataOutput {
	this := NusightsProxyListMetadataOutput{}
	var kind string = "nusights_proxy"
	this.Kind = &kind
	return &this
}
...
func (o NusightsProxyListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o NusightsProxyListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *NusightsProxyListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varNusightsProxyListMetadataOutput := _NusightsProxyListMetadataOutput{}

	err = json.Unmarshal(data, &varNusightsProxyListMetadataOutput)

	if err != nil {
		return err
	}

	*o = NusightsProxyListMetadataOutput(varNusightsProxyListMetadataOutput)
...
type NullableNusightsProxyListMetadataOutput struct {
	value *NusightsProxyListMetadataOutput
	isSet bool
}

func (v NullableNusightsProxyListMetadataOutput) Get() *NusightsProxyListMetadataOutput {
	return v.value
}

func (v *NullableNusightsProxyListMetadataOutput) Set(val *NusightsProxyListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableNusightsProxyListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableNusightsProxyListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNusightsProxyListMetadataOutput(val *NusightsProxyListMetadataOutput) *NullableNusightsProxyListMetadataOutput {
	return &NullableNusightsProxyListMetadataOutput{value: val, isSet: true}
}

func (v NullableNusightsProxyListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNusightsProxyListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
