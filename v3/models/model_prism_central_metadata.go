...
// checks if the PrismCentralMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralMetadata{}

// PrismCentralMetadata The prism_central kind metadata
type PrismCentralMetadata struct {
	...
	// Categories for the prism_central. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the prism_central. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _PrismCentralMetadata PrismCentralMetadata
...
func (o *PrismCentralMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *PrismCentralMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *PrismCentralMetadata) SetName(v string) {
	o.Name = &v
}

func (o PrismCentralMetadata) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *PrismCentralMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varPrismCentralMetadata := _PrismCentralMetadata{}

	err = json.Unmarshal(data, &varPrismCentralMetadata)

	if err != nil {
		return err
	}

	*o = PrismCentralMetadata(varPrismCentralMetadata)
...
type NullablePrismCentralMetadata struct {
	value *PrismCentralMetadata
	isSet bool
}

func (v NullablePrismCentralMetadata) Get() *PrismCentralMetadata {
	return v.value
}

func (v *NullablePrismCentralMetadata) Set(val *PrismCentralMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralMetadata(val *PrismCentralMetadata) *NullablePrismCentralMetadata {
	return &NullablePrismCentralMetadata{value: val, isSet: true}
}

func (v NullablePrismCentralMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
