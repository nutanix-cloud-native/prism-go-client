...
// checks if the EntitySyncRuleIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySyncRuleIntentResource{}

// EntitySyncRuleIntentResource Response object for intentful operations on a entity_sync_rule
type EntitySyncRuleIntentResource struct {
	Status *EntitySyncRuleDefStatus `json:"status,omitempty"`
	Spec *EntitySyncRule `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata EntitySyncRuleMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _EntitySyncRuleIntentResource EntitySyncRuleIntentResource
...
func NewEntitySyncRuleIntentResource(metadata EntitySyncRuleMetadata) *EntitySyncRuleIntentResource {
	this := EntitySyncRuleIntentResource{}
...
func (o *EntitySyncRuleIntentResource) GetStatus() EntitySyncRuleDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret EntitySyncRuleDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given EntitySyncRuleDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given EntitySyncRule and assigns it to the Spec field.
...
func (o *EntitySyncRuleIntentResource) GetMetadata() EntitySyncRuleMetadata {
	if o == nil {
		var ret EntitySyncRuleMetadata
		return ret
	}
...
func (o EntitySyncRuleIntentResource) MarshalJSON() ([]byte, error) {
...
func (o EntitySyncRuleIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *EntitySyncRuleIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varEntitySyncRuleIntentResource := _EntitySyncRuleIntentResource{}

	err = json.Unmarshal(data, &varEntitySyncRuleIntentResource)

	if err != nil {
		return err
	}

	*o = EntitySyncRuleIntentResource(varEntitySyncRuleIntentResource)
...
type NullableEntitySyncRuleIntentResource struct {
	value *EntitySyncRuleIntentResource
	isSet bool
}

func (v NullableEntitySyncRuleIntentResource) Get() *EntitySyncRuleIntentResource {
	return v.value
}

func (v *NullableEntitySyncRuleIntentResource) Set(val *EntitySyncRuleIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySyncRuleIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySyncRuleIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySyncRuleIntentResource(val *EntitySyncRuleIntentResource) *NullableEntitySyncRuleIntentResource {
	return &NullableEntitySyncRuleIntentResource{value: val, isSet: true}
}

func (v NullableEntitySyncRuleIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySyncRuleIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
