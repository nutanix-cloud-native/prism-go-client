...
// checks if the AppTaskIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskIntentResponse{}

// AppTaskIntentResponse Response object for intentful operations on a app_task
type AppTaskIntentResponse struct {
...
type _AppTaskIntentResponse AppTaskIntentResponse
...
func (o AppTaskIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AppTaskIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskIntentResponse := _AppTaskIntentResponse{}

	err = json.Unmarshal(data, &varAppTaskIntentResponse)

	if err != nil {
		return err
	}

	*o = AppTaskIntentResponse(varAppTaskIntentResponse)
...
type NullableAppTaskIntentResponse struct {
	value *AppTaskIntentResponse
	isSet bool
}

func (v NullableAppTaskIntentResponse) Get() *AppTaskIntentResponse {
	return v.value
}

func (v *NullableAppTaskIntentResponse) Set(val *AppTaskIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskIntentResponse(val *AppTaskIntentResponse) *NullableAppTaskIntentResponse {
	return &NullableAppTaskIntentResponse{value: val, isSet: true}
}

func (v NullableAppTaskIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
