...
// checks if the AwsVpcDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVpcDefStatus{}

// AwsVpcDefStatus aws_vpc resources status
type AwsVpcDefStatus struct {
	State *string `json:"state,omitempty"`
	// aws_vpc name.
	Name *string `json:"name,omitempty"`
	Resources *AwsVpcResourcesDefStatus `json:"resources,omitempty"`
	// A description for aws_vpc.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsVpcDefStatus AwsVpcDefStatus
...
func (o *AwsVpcDefStatus) GetResources() AwsVpcResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret AwsVpcResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given AwsVpcResourcesDefStatus and assigns it to the Resources field.
...
func (o AwsVpcDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsVpcDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVpcDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsVpcDefStatus := _AwsVpcDefStatus{}

	err = json.Unmarshal(data, &varAwsVpcDefStatus)

	if err != nil {
		return err
	}

	*o = AwsVpcDefStatus(varAwsVpcDefStatus)
...
type NullableAwsVpcDefStatus struct {
	value *AwsVpcDefStatus
	isSet bool
}

func (v NullableAwsVpcDefStatus) Get() *AwsVpcDefStatus {
	return v.value
}

func (v *NullableAwsVpcDefStatus) Set(val *AwsVpcDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVpcDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVpcDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVpcDefStatus(val *AwsVpcDefStatus) *NullableAwsVpcDefStatus {
	return &NullableAwsVpcDefStatus{value: val, isSet: true}
}

func (v NullableAwsVpcDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVpcDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
