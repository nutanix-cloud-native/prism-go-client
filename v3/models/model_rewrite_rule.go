...
// checks if the RewriteRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RewriteRule{}

// RewriteRule Rule to rewrite api endpoints.
...
func (o RewriteRule) MarshalJSON() ([]byte, error) {
...
func (o RewriteRule) ToMap() (map[string]interface{}, error) {
...
func (o *RewriteRule) UnmarshalJSON(data []byte) (err error) {
	...
	varRewriteRule := _RewriteRule{}

	err = json.Unmarshal(data, &varRewriteRule)

	if err != nil {
		return err
	}

	*o = RewriteRule(varRewriteRule)
...
type NullableRewriteRule struct {
	value *RewriteRule
	isSet bool
}

func (v NullableRewriteRule) Get() *RewriteRule {
	return v.value
}

func (v *NullableRewriteRule) Set(val *RewriteRule) {
	v.value = val
	v.isSet = true
}

func (v NullableRewriteRule) IsSet() bool {
	return v.isSet
}

func (v *NullableRewriteRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRewriteRule(val *RewriteRule) *NullableRewriteRule {
	return &NullableRewriteRule{value: val, isSet: true}
}

func (v NullableRewriteRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRewriteRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
