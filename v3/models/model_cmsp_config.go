...
// checks if the CmspConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmspConfig{}

// CmspConfig MSP configuration for CMSP on PC used in deployment and enablement. 
type CmspConfig struct {
	...
	PcDomainName string `json:"pc_domain_name" validate:"regexp=^(?:[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?\\\\.)+[a-z0-9][a-z0-9-]{0,61}[a-z0-9]$"`
	AdditionalProperties map[string]interface{}
}

type _CmspConfig CmspConfig
...
func NewCmspConfig(platformIpBlockList []string, platformNetworkConfiguration CmspNetworkConfig, pcDomainName string) *CmspConfig {
	this := CmspConfig{}
	this.PlatformIpBlockList = platformIpBlockList
	this.PlatformNetworkConfiguration = platformNetworkConfiguration
...
// GetPlatformIpBlockList returns the PlatformIpBlockList field value
func (o *CmspConfig) GetPlatformIpBlockList() []string {
	...
	return o.PlatformIpBlockList
}

// GetPlatformIpBlockListOk returns a tuple with the PlatformIpBlockList field value
// and a boolean to check if the value has been set.
func (o *CmspConfig) GetPlatformIpBlockListOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.PlatformIpBlockList, true
}

// SetPlatformIpBlockList sets field value
func (o *CmspConfig) SetPlatformIpBlockList(v []string) {
	o.PlatformIpBlockList = v
}

// GetPlatformNetworkConfiguration returns the PlatformNetworkConfiguration field value
func (o *CmspConfig) GetPlatformNetworkConfiguration() CmspNetworkConfig {
	if o == nil {
		var ret CmspNetworkConfig
		return ret
	}

	return o.PlatformNetworkConfiguration
}

// GetPlatformNetworkConfigurationOk returns a tuple with the PlatformNetworkConfiguration field value
// and a boolean to check if the value has been set.
func (o *CmspConfig) GetPlatformNetworkConfigurationOk() (*CmspNetworkConfig, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PlatformNetworkConfiguration, true
}

// SetPlatformNetworkConfiguration sets field value
func (o *CmspConfig) SetPlatformNetworkConfiguration(v CmspNetworkConfig) {
	o.PlatformNetworkConfiguration = v
}

// GetCmspArgs returns the CmspArgs field value if set, zero value otherwise.
func (o *CmspConfig) GetCmspArgs() string {
	if o == nil || IsNil(o.CmspArgs) {
		var ret string
		return ret
	}
	return *o.CmspArgs
...
// GetCmspArgsOk returns a tuple with the CmspArgs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CmspConfig) GetCmspArgsOk() (*string, bool) {
	if o == nil || IsNil(o.CmspArgs) {
		return nil, false
	}
	return o.CmspArgs, true
}
...
// SetCmspArgs gets a reference to the given string and assigns it to the CmspArgs field.
func (o *CmspConfig) SetCmspArgs(v string) {
	o.CmspArgs = &v
}

// GetPcDomainName returns the PcDomainName field value
func (o *CmspConfig) GetPcDomainName() string {
	...
	return o.PcDomainName
}

// GetPcDomainNameOk returns a tuple with the PcDomainName field value
// and a boolean to check if the value has been set.
func (o *CmspConfig) GetPcDomainNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PcDomainName, true
}

// SetPcDomainName sets field value
func (o *CmspConfig) SetPcDomainName(v string) {
	o.PcDomainName = v
}

func (o CmspConfig) MarshalJSON() ([]byte, error) {
...
func (o CmspConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["platform_ip_block_list"] = o.PlatformIpBlockList
	toSerialize["platform_network_configuration"] = o.PlatformNetworkConfiguration
	if !IsNil(o.CmspArgs) {
		toSerialize["cmsp_args"] = o.CmspArgs
	}
	toSerialize["pc_domain_name"] = o.PcDomainName
...
func (o *CmspConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varCmspConfig := _CmspConfig{}

	err = json.Unmarshal(data, &varCmspConfig)

	if err != nil {
		return err
	}

	*o = CmspConfig(varCmspConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "platform_ip_block_list")
		delete(additionalProperties, "platform_network_configuration")
		delete(additionalProperties, "cmsp_args")
		delete(additionalProperties, "pc_domain_name")
...
type NullableCmspConfig struct {
	value *CmspConfig
	isSet bool
}

func (v NullableCmspConfig) Get() *CmspConfig {
	return v.value
}

func (v *NullableCmspConfig) Set(val *CmspConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableCmspConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableCmspConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmspConfig(val *CmspConfig) *NullableCmspConfig {
	return &NullableCmspConfig{value: val, isSet: true}
}

func (v NullableCmspConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmspConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
