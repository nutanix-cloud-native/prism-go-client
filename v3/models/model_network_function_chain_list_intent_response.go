...
// checks if the NetworkFunctionChainListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionChainListIntentResponse{}

// NetworkFunctionChainListIntentResponse Response object for intentful operation of network_function_chains
type NetworkFunctionChainListIntentResponse struct {
	Entities []NetworkFunctionChainIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata NetworkFunctionChainListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _NetworkFunctionChainListIntentResponse NetworkFunctionChainListIntentResponse
...
func NewNetworkFunctionChainListIntentResponse(apiVersion string, metadata NetworkFunctionChainListMetadataOutput) *NetworkFunctionChainListIntentResponse {
	this := NetworkFunctionChainListIntentResponse{}
...
func (o *NetworkFunctionChainListIntentResponse) GetEntities() []NetworkFunctionChainIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []NetworkFunctionChainIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []NetworkFunctionChainIntentResource and assigns it to the Entities field.
...
func (o *NetworkFunctionChainListIntentResponse) GetMetadata() NetworkFunctionChainListMetadataOutput {
	if o == nil {
		var ret NetworkFunctionChainListMetadataOutput
		return ret
	}
...
func (o NetworkFunctionChainListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionChainListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionChainListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkFunctionChainListIntentResponse := _NetworkFunctionChainListIntentResponse{}

	err = json.Unmarshal(data, &varNetworkFunctionChainListIntentResponse)

	if err != nil {
		return err
	}

	*o = NetworkFunctionChainListIntentResponse(varNetworkFunctionChainListIntentResponse)
...
type NullableNetworkFunctionChainListIntentResponse struct {
	value *NetworkFunctionChainListIntentResponse
	isSet bool
}

func (v NullableNetworkFunctionChainListIntentResponse) Get() *NetworkFunctionChainListIntentResponse {
	return v.value
}

func (v *NullableNetworkFunctionChainListIntentResponse) Set(val *NetworkFunctionChainListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionChainListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionChainListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionChainListIntentResponse(val *NetworkFunctionChainListIntentResponse) *NullableNetworkFunctionChainListIntentResponse {
	return &NullableNetworkFunctionChainListIntentResponse{value: val, isSet: true}
}

func (v NullableNetworkFunctionChainListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionChainListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
