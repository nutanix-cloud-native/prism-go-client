...
// checks if the AccessControlPolicyListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyListIntentResponse{}

// AccessControlPolicyListIntentResponse Response object for intentful operation of access_control_policys
type AccessControlPolicyListIntentResponse struct {
	Entities []AccessControlPolicyIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AccessControlPolicyListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AccessControlPolicyListIntentResponse AccessControlPolicyListIntentResponse
...
func NewAccessControlPolicyListIntentResponse(apiVersion string, metadata AccessControlPolicyListMetadataOutput) *AccessControlPolicyListIntentResponse {
	this := AccessControlPolicyListIntentResponse{}
...
func (o *AccessControlPolicyListIntentResponse) GetEntities() []AccessControlPolicyIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []AccessControlPolicyIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []AccessControlPolicyIntentResource and assigns it to the Entities field.
...
func (o *AccessControlPolicyListIntentResponse) GetMetadata() AccessControlPolicyListMetadataOutput {
	if o == nil {
		var ret AccessControlPolicyListMetadataOutput
		return ret
	}
...
func (o AccessControlPolicyListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AccessControlPolicyListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessControlPolicyListIntentResponse := _AccessControlPolicyListIntentResponse{}

	err = json.Unmarshal(data, &varAccessControlPolicyListIntentResponse)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyListIntentResponse(varAccessControlPolicyListIntentResponse)
...
type NullableAccessControlPolicyListIntentResponse struct {
	value *AccessControlPolicyListIntentResponse
	isSet bool
}

func (v NullableAccessControlPolicyListIntentResponse) Get() *AccessControlPolicyListIntentResponse {
	return v.value
}

func (v *NullableAccessControlPolicyListIntentResponse) Set(val *AccessControlPolicyListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyListIntentResponse(val *AccessControlPolicyListIntentResponse) *NullableAccessControlPolicyListIntentResponse {
	return &NullableAccessControlPolicyListIntentResponse{value: val, isSet: true}
}

func (v NullableAccessControlPolicyListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
