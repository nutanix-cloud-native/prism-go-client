...
// checks if the AwsRoleMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRoleMetadata{}

// AwsRoleMetadata The aws_role kind metadata
type AwsRoleMetadata struct {
...
type _AwsRoleMetadata AwsRoleMetadata
...
func (o *AwsRoleMetadata) SetLastUpdateTime(v time.Time) {
	o.LastUpdateTime = &v
}
...
func (o *AwsRoleMetadata) GetProjectReference() ProjectReference {
...
// and a boolean to check if the value has been set.
func (o *AwsRoleMetadata) GetSpecVersionOk() (*int32, bool) {
	if o == nil || IsNil(o.SpecVersion) {
		return nil, false
	}
...
func (o *AwsRoleMetadata) SetCategories(v map[string]string) {
	o.Categories = &v
}
...
func (o AwsRoleMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsRoleMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRoleMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsRoleMetadata := _AwsRoleMetadata{}

	err = json.Unmarshal(data, &varAwsRoleMetadata)

	if err != nil {
		return err
	}

	*o = AwsRoleMetadata(varAwsRoleMetadata)
...
type NullableAwsRoleMetadata struct {
	value *AwsRoleMetadata
	isSet bool
}

func (v NullableAwsRoleMetadata) Get() *AwsRoleMetadata {
	return v.value
}

func (v *NullableAwsRoleMetadata) Set(val *AwsRoleMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRoleMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRoleMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRoleMetadata(val *AwsRoleMetadata) *NullableAwsRoleMetadata {
	return &NullableAwsRoleMetadata{value: val, isSet: true}
}

func (v NullableAwsRoleMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRoleMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
