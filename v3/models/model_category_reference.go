...
// checks if the CategoryReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryReference{}

// CategoryReference The reference to a category
...
type _CategoryReference CategoryReference
...
func (o CategoryReference) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryReference) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryReference := _CategoryReference{}

	err = json.Unmarshal(data, &varCategoryReference)

	if err != nil {
		return err
	}

	*o = CategoryReference(varCategoryReference)
...
type NullableCategoryReference struct {
	value *CategoryReference
	isSet bool
}

func (v NullableCategoryReference) Get() *CategoryReference {
	return v.value
}

func (v *NullableCategoryReference) Set(val *CategoryReference) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryReference) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryReference(val *CategoryReference) *NullableCategoryReference {
	return &NullableCategoryReference{value: val, isSet: true}
}

func (v NullableCategoryReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
