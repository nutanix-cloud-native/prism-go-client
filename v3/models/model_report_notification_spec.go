...
// checks if the ReportNotificationSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportNotificationSpec{}

// ReportNotificationSpec Report Instance notification spec.
type ReportNotificationSpec struct {
	...
	InstanceReferenceList []ReportInstanceReference `json:"instance_reference_list,omitempty"`
...
type _ReportNotificationSpec ReportNotificationSpec
...
// GetInstanceReferenceList returns the InstanceReferenceList field value if set, zero value otherwise.
func (o *ReportNotificationSpec) GetInstanceReferenceList() []ReportInstanceReference {
	if o == nil || IsNil(o.InstanceReferenceList) {
		var ret []ReportInstanceReference
		return ret
	}
	return o.InstanceReferenceList
}

// GetInstanceReferenceListOk returns a tuple with the InstanceReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportNotificationSpec) GetInstanceReferenceListOk() ([]ReportInstanceReference, bool) {
	if o == nil || IsNil(o.InstanceReferenceList) {
		return nil, false
	}
	return o.InstanceReferenceList, true
}
...
// SetInstanceReferenceList gets a reference to the given []ReportInstanceReference and assigns it to the InstanceReferenceList field.
func (o *ReportNotificationSpec) SetInstanceReferenceList(v []ReportInstanceReference) {
	o.InstanceReferenceList = v
}
...
func (o ReportNotificationSpec) MarshalJSON() ([]byte, error) {
...
func (o ReportNotificationSpec) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InstanceReferenceList) {
		toSerialize["instance_reference_list"] = o.InstanceReferenceList
	}
...
func (o *ReportNotificationSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varReportNotificationSpec := _ReportNotificationSpec{}

	err = json.Unmarshal(data, &varReportNotificationSpec)

	if err != nil {
		return err
	}

	*o = ReportNotificationSpec(varReportNotificationSpec)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "instance_reference_list")
...
type NullableReportNotificationSpec struct {
	value *ReportNotificationSpec
	isSet bool
}

func (v NullableReportNotificationSpec) Get() *ReportNotificationSpec {
	return v.value
}

func (v *NullableReportNotificationSpec) Set(val *ReportNotificationSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableReportNotificationSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableReportNotificationSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportNotificationSpec(val *ReportNotificationSpec) *NullableReportNotificationSpec {
	return &NullableReportNotificationSpec{value: val, isSet: true}
}

func (v NullableReportNotificationSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportNotificationSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
