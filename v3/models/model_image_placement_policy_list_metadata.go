...
// checks if the ImagePlacementPolicyListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyListMetadata{}

// ImagePlacementPolicyListMetadata All api calls that return a list will have this metadata block as input 
type ImagePlacementPolicyListMetadata struct {
	// The kind name
...
type _ImagePlacementPolicyListMetadata ImagePlacementPolicyListMetadata
...
func NewImagePlacementPolicyListMetadata() *ImagePlacementPolicyListMetadata {
	this := ImagePlacementPolicyListMetadata{}
...
func (o ImagePlacementPolicyListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicyListMetadata) UnmarshalJSON(data []byte) (err error) {
	varImagePlacementPolicyListMetadata := _ImagePlacementPolicyListMetadata{}

	err = json.Unmarshal(data, &varImagePlacementPolicyListMetadata)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyListMetadata(varImagePlacementPolicyListMetadata)
...
type NullableImagePlacementPolicyListMetadata struct {
	value *ImagePlacementPolicyListMetadata
	isSet bool
}

func (v NullableImagePlacementPolicyListMetadata) Get() *ImagePlacementPolicyListMetadata {
	return v.value
}

func (v *NullableImagePlacementPolicyListMetadata) Set(val *ImagePlacementPolicyListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyListMetadata(val *ImagePlacementPolicyListMetadata) *NullableImagePlacementPolicyListMetadata {
	return &NullableImagePlacementPolicyListMetadata{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
