...
// checks if the AwsSecurityGroupListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSecurityGroupListIntentResponse{}

// AwsSecurityGroupListIntentResponse AWS VPC entity list.
type AwsSecurityGroupListIntentResponse struct {
	Entities []AwsSecurityGroupIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsSecurityGroupListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsSecurityGroupListIntentResponse AwsSecurityGroupListIntentResponse
...
func NewAwsSecurityGroupListIntentResponse(apiVersion string, metadata AwsSecurityGroupListMetadataOutput) *AwsSecurityGroupListIntentResponse {
	this := AwsSecurityGroupListIntentResponse{}
...
func (o *AwsSecurityGroupListIntentResponse) GetEntities() []AwsSecurityGroupIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []AwsSecurityGroupIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []AwsSecurityGroupIntentResource and assigns it to the Entities field.
...
func (o *AwsSecurityGroupListIntentResponse) GetMetadata() AwsSecurityGroupListMetadataOutput {
	if o == nil {
		var ret AwsSecurityGroupListMetadataOutput
		return ret
	}
...
func (o AwsSecurityGroupListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsSecurityGroupListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSecurityGroupListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsSecurityGroupListIntentResponse := _AwsSecurityGroupListIntentResponse{}

	err = json.Unmarshal(data, &varAwsSecurityGroupListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsSecurityGroupListIntentResponse(varAwsSecurityGroupListIntentResponse)
...
type NullableAwsSecurityGroupListIntentResponse struct {
	value *AwsSecurityGroupListIntentResponse
	isSet bool
}

func (v NullableAwsSecurityGroupListIntentResponse) Get() *AwsSecurityGroupListIntentResponse {
	return v.value
}

func (v *NullableAwsSecurityGroupListIntentResponse) Set(val *AwsSecurityGroupListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSecurityGroupListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSecurityGroupListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSecurityGroupListIntentResponse(val *AwsSecurityGroupListIntentResponse) *NullableAwsSecurityGroupListIntentResponse {
	return &NullableAwsSecurityGroupListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsSecurityGroupListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSecurityGroupListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
