...
// checks if the ClusterSynchronousReplicationCapableInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterSynchronousReplicationCapableInput{}

// ClusterSynchronousReplicationCapableInput Input object for API to check if a remote cluster is capable of synchronous replication. 
type ClusterSynchronousReplicationCapableInput struct {
	SourceClusterReferenceList []ClusterReference `json:"source_cluster_reference_list,omitempty"`
	RemoteAvailabilityZoneReference AvailabilityZoneReference `json:"remote_availability_zone_reference"`
	RemoteClusterReference ClusterReference `json:"remote_cluster_reference"`
	AdditionalProperties map[string]interface{}
}

type _ClusterSynchronousReplicationCapableInput ClusterSynchronousReplicationCapableInput
...
func NewClusterSynchronousReplicationCapableInput(remoteAvailabilityZoneReference AvailabilityZoneReference, remoteClusterReference ClusterReference) *ClusterSynchronousReplicationCapableInput {
	this := ClusterSynchronousReplicationCapableInput{}
	this.RemoteAvailabilityZoneReference = remoteAvailabilityZoneReference
	this.RemoteClusterReference = remoteClusterReference
	return &this
}
...
// GetSourceClusterReferenceList returns the SourceClusterReferenceList field value if set, zero value otherwise.
func (o *ClusterSynchronousReplicationCapableInput) GetSourceClusterReferenceList() []ClusterReference {
	if o == nil || IsNil(o.SourceClusterReferenceList) {
		var ret []ClusterReference
		return ret
	}
	return o.SourceClusterReferenceList
}

// GetSourceClusterReferenceListOk returns a tuple with the SourceClusterReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterSynchronousReplicationCapableInput) GetSourceClusterReferenceListOk() ([]ClusterReference, bool) {
	if o == nil || IsNil(o.SourceClusterReferenceList) {
		return nil, false
	}
	return o.SourceClusterReferenceList, true
}
...
// SetSourceClusterReferenceList gets a reference to the given []ClusterReference and assigns it to the SourceClusterReferenceList field.
func (o *ClusterSynchronousReplicationCapableInput) SetSourceClusterReferenceList(v []ClusterReference) {
	o.SourceClusterReferenceList = v
}

// GetRemoteAvailabilityZoneReference returns the RemoteAvailabilityZoneReference field value
func (o *ClusterSynchronousReplicationCapableInput) GetRemoteAvailabilityZoneReference() AvailabilityZoneReference {
	...
	return o.RemoteAvailabilityZoneReference
}

// GetRemoteAvailabilityZoneReferenceOk returns a tuple with the RemoteAvailabilityZoneReference field value
// and a boolean to check if the value has been set.
func (o *ClusterSynchronousReplicationCapableInput) GetRemoteAvailabilityZoneReferenceOk() (*AvailabilityZoneReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RemoteAvailabilityZoneReference, true
}

// SetRemoteAvailabilityZoneReference sets field value
func (o *ClusterSynchronousReplicationCapableInput) SetRemoteAvailabilityZoneReference(v AvailabilityZoneReference) {
	o.RemoteAvailabilityZoneReference = v
}

// GetRemoteClusterReference returns the RemoteClusterReference field value
func (o *ClusterSynchronousReplicationCapableInput) GetRemoteClusterReference() ClusterReference {
	...
	return o.RemoteClusterReference
}

// GetRemoteClusterReferenceOk returns a tuple with the RemoteClusterReference field value
// and a boolean to check if the value has been set.
func (o *ClusterSynchronousReplicationCapableInput) GetRemoteClusterReferenceOk() (*ClusterReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RemoteClusterReference, true
}

// SetRemoteClusterReference sets field value
func (o *ClusterSynchronousReplicationCapableInput) SetRemoteClusterReference(v ClusterReference) {
	o.RemoteClusterReference = v
}

func (o ClusterSynchronousReplicationCapableInput) MarshalJSON() ([]byte, error) {
...
func (o ClusterSynchronousReplicationCapableInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SourceClusterReferenceList) {
		toSerialize["source_cluster_reference_list"] = o.SourceClusterReferenceList
	}
	toSerialize["remote_availability_zone_reference"] = o.RemoteAvailabilityZoneReference
	toSerialize["remote_cluster_reference"] = o.RemoteClusterReference
...
func (o *ClusterSynchronousReplicationCapableInput) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterSynchronousReplicationCapableInput := _ClusterSynchronousReplicationCapableInput{}

	err = json.Unmarshal(data, &varClusterSynchronousReplicationCapableInput)

	if err != nil {
		return err
	}

	*o = ClusterSynchronousReplicationCapableInput(varClusterSynchronousReplicationCapableInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "source_cluster_reference_list")
		delete(additionalProperties, "remote_availability_zone_reference")
		delete(additionalProperties, "remote_cluster_reference")
...
type NullableClusterSynchronousReplicationCapableInput struct {
	value *ClusterSynchronousReplicationCapableInput
	isSet bool
}

func (v NullableClusterSynchronousReplicationCapableInput) Get() *ClusterSynchronousReplicationCapableInput {
	return v.value
}

func (v *NullableClusterSynchronousReplicationCapableInput) Set(val *ClusterSynchronousReplicationCapableInput) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterSynchronousReplicationCapableInput) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterSynchronousReplicationCapableInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterSynchronousReplicationCapableInput(val *ClusterSynchronousReplicationCapableInput) *NullableClusterSynchronousReplicationCapableInput {
	return &NullableClusterSynchronousReplicationCapableInput{value: val, isSet: true}
}

func (v NullableClusterSynchronousReplicationCapableInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterSynchronousReplicationCapableInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
