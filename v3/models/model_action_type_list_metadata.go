...
// checks if the ActionTypeListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTypeListMetadata{}

// ActionTypeListMetadata All api calls that return a list will have this metadata block as input 
type ActionTypeListMetadata struct {
	// The kind name
...
type _ActionTypeListMetadata ActionTypeListMetadata
...
func (o ActionTypeListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ActionTypeListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTypeListMetadata) UnmarshalJSON(data []byte) (err error) {
	varActionTypeListMetadata := _ActionTypeListMetadata{}

	err = json.Unmarshal(data, &varActionTypeListMetadata)

	if err != nil {
		return err
	}

	*o = ActionTypeListMetadata(varActionTypeListMetadata)
...
type NullableActionTypeListMetadata struct {
	value *ActionTypeListMetadata
	isSet bool
}

func (v NullableActionTypeListMetadata) Get() *ActionTypeListMetadata {
	return v.value
}

func (v *NullableActionTypeListMetadata) Set(val *ActionTypeListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTypeListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTypeListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTypeListMetadata(val *ActionTypeListMetadata) *NullableActionTypeListMetadata {
	return &NullableActionTypeListMetadata{value: val, isSet: true}
}

func (v NullableActionTypeListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTypeListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
