...
// checks if the UserDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserDefStatus{}

// UserDefStatus User status definition.
type UserDefStatus struct {
	...
	Resources UserStatusResource `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _UserDefStatus UserDefStatus
...
func (o UserDefStatus) MarshalJSON() ([]byte, error) {
...
func (o UserDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *UserDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varUserDefStatus := _UserDefStatus{}

	err = json.Unmarshal(data, &varUserDefStatus)

	if err != nil {
		return err
	}

	*o = UserDefStatus(varUserDefStatus)
...
type NullableUserDefStatus struct {
	value *UserDefStatus
	isSet bool
}

func (v NullableUserDefStatus) Get() *UserDefStatus {
	return v.value
}

func (v *NullableUserDefStatus) Set(val *UserDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableUserDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableUserDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserDefStatus(val *UserDefStatus) *NullableUserDefStatus {
	return &NullableUserDefStatus{value: val, isSet: true}
}

func (v NullableUserDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
