...
// checks if the UnderlaySubnetListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnetListIntentResponse{}

// UnderlaySubnetListIntentResponse Response object for intentful operation of underlay_subnets
type UnderlaySubnetListIntentResponse struct {
	Entities []UnderlaySubnetIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata UnderlaySubnetListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _UnderlaySubnetListIntentResponse UnderlaySubnetListIntentResponse
...
func NewUnderlaySubnetListIntentResponse(apiVersion string, metadata UnderlaySubnetListMetadataOutput) *UnderlaySubnetListIntentResponse {
	this := UnderlaySubnetListIntentResponse{}
...
func (o *UnderlaySubnetListIntentResponse) GetEntities() []UnderlaySubnetIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []UnderlaySubnetIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []UnderlaySubnetIntentResource and assigns it to the Entities field.
...
func (o *UnderlaySubnetListIntentResponse) GetMetadata() UnderlaySubnetListMetadataOutput {
	if o == nil {
		var ret UnderlaySubnetListMetadataOutput
		return ret
	}
...
func (o UnderlaySubnetListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnetListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *UnderlaySubnetListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUnderlaySubnetListIntentResponse := _UnderlaySubnetListIntentResponse{}

	err = json.Unmarshal(data, &varUnderlaySubnetListIntentResponse)

	if err != nil {
		return err
	}

	*o = UnderlaySubnetListIntentResponse(varUnderlaySubnetListIntentResponse)
...
type NullableUnderlaySubnetListIntentResponse struct {
	value *UnderlaySubnetListIntentResponse
	isSet bool
}

func (v NullableUnderlaySubnetListIntentResponse) Get() *UnderlaySubnetListIntentResponse {
	return v.value
}

func (v *NullableUnderlaySubnetListIntentResponse) Set(val *UnderlaySubnetListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnetListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnetListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnetListIntentResponse(val *UnderlaySubnetListIntentResponse) *NullableUnderlaySubnetListIntentResponse {
	return &NullableUnderlaySubnetListIntentResponse{value: val, isSet: true}
}

func (v NullableUnderlaySubnetListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnetListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
