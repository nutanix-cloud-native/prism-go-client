...
// checks if the FloatingIpReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpReference{}

// FloatingIpReference The reference to a floating_ip
...
type _FloatingIpReference FloatingIpReference
...
func (o FloatingIpReference) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpReference) ToMap() (map[string]interface{}, error) {
...
func (o *FloatingIpReference) UnmarshalJSON(data []byte) (err error) {
	...
	varFloatingIpReference := _FloatingIpReference{}

	err = json.Unmarshal(data, &varFloatingIpReference)

	if err != nil {
		return err
	}

	*o = FloatingIpReference(varFloatingIpReference)
...
type NullableFloatingIpReference struct {
	value *FloatingIpReference
	isSet bool
}

func (v NullableFloatingIpReference) Get() *FloatingIpReference {
	return v.value
}

func (v *NullableFloatingIpReference) Set(val *FloatingIpReference) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpReference) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpReference(val *FloatingIpReference) *NullableFloatingIpReference {
	return &NullableFloatingIpReference{value: val, isSet: true}
}

func (v NullableFloatingIpReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
