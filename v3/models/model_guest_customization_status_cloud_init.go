...
// checks if the GuestCustomizationStatusCloudInit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestCustomizationStatusCloudInit{}
...
type _GuestCustomizationStatusCloudInit GuestCustomizationStatusCloudInit
...
func NewGuestCustomizationStatusCloudInit() *GuestCustomizationStatusCloudInit {
	this := GuestCustomizationStatusCloudInit{}
	return &this
}
...
func (o GuestCustomizationStatusCloudInit) MarshalJSON() ([]byte, error) {
...
func (o GuestCustomizationStatusCloudInit) ToMap() (map[string]interface{}, error) {
...
func (o *GuestCustomizationStatusCloudInit) UnmarshalJSON(data []byte) (err error) {
	varGuestCustomizationStatusCloudInit := _GuestCustomizationStatusCloudInit{}

	err = json.Unmarshal(data, &varGuestCustomizationStatusCloudInit)

	if err != nil {
		return err
	}

	*o = GuestCustomizationStatusCloudInit(varGuestCustomizationStatusCloudInit)
...
type NullableGuestCustomizationStatusCloudInit struct {
	value *GuestCustomizationStatusCloudInit
	isSet bool
}

func (v NullableGuestCustomizationStatusCloudInit) Get() *GuestCustomizationStatusCloudInit {
	return v.value
}

func (v *NullableGuestCustomizationStatusCloudInit) Set(val *GuestCustomizationStatusCloudInit) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestCustomizationStatusCloudInit) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestCustomizationStatusCloudInit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestCustomizationStatusCloudInit(val *GuestCustomizationStatusCloudInit) *NullableGuestCustomizationStatusCloudInit {
	return &NullableGuestCustomizationStatusCloudInit{value: val, isSet: true}
}

func (v NullableGuestCustomizationStatusCloudInit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestCustomizationStatusCloudInit) UnmarshalJSON(src []byte) error {
	v.isSet = true
