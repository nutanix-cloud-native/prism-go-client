...
// checks if the QueryValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryValue{}

// QueryValue Object Encompassing Specific Datatypes for Values.
...
// GetIntList returns the IntList field value if set, zero value otherwise.
func (o *QueryValue) GetIntList() []int64 {
	if o == nil || IsNil(o.IntList) {
		var ret []int64
		return ret
	}
	return o.IntList
...
// GetIntListOk returns a tuple with the IntList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QueryValue) GetIntListOk() ([]int64, bool) {
	if o == nil || IsNil(o.IntList) {
		return nil, false
	}
	return o.IntList, true
}
...
// SetIntList gets a reference to the given []int64 and assigns it to the IntList field.
...
// SetStringList gets a reference to the given []string and assigns it to the StringList field.
func (o *QueryValue) SetStringList(v []string) {
	o.StringList = v
}

// GetFloatList returns the FloatList field value if set, zero value otherwise.
func (o *QueryValue) GetFloatList() []float32 {
	if o == nil || IsNil(o.FloatList) {
		var ret []float32
		return ret
	}
	return o.FloatList
...
// GetFloatListOk returns a tuple with the FloatList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QueryValue) GetFloatListOk() ([]float32, bool) {
	if o == nil || IsNil(o.FloatList) {
		return nil, false
	}
	return o.FloatList, true
}
...
// SetFloatList gets a reference to the given []float32 and assigns it to the FloatList field.
...
func (o QueryValue) MarshalJSON() ([]byte, error) {
...
func (o QueryValue) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.StringValue) {
		toSerialize["string_value"] = o.StringValue
	}
	if !IsNil(o.IntList) {
		toSerialize["int_list"] = o.IntList
	}
	if !IsNil(o.FloatValue) {
		toSerialize["float_value"] = o.FloatValue
	}
	if !IsNil(o.StringList) {
		toSerialize["string_list"] = o.StringList
	}
	if !IsNil(o.FloatList) {
		toSerialize["float_list"] = o.FloatList
	}
	if !IsNil(o.IntValue) {
...
func (o *QueryValue) UnmarshalJSON(data []byte) (err error) {
	varQueryValue := _QueryValue{}

	err = json.Unmarshal(data, &varQueryValue)

	if err != nil {
		return err
	}

	*o = QueryValue(varQueryValue)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "string_value")
		delete(additionalProperties, "int_list")
		delete(additionalProperties, "float_value")
		delete(additionalProperties, "string_list")
		delete(additionalProperties, "float_list")
		delete(additionalProperties, "int_value")
