...
// checks if the ErrorMessageObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorMessageObject{}

// ErrorMessageObject structured error object for UI consumption
type ErrorMessageObject struct {
	// params to enhance error message
	ParamList []string `json:"param_list,omitempty"`
	// error message with param place holders
	ErrorMessage *string `json:"error_message,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ErrorMessageObject ErrorMessageObject
...
// SetParamList gets a reference to the given []string and assigns it to the ParamList field.
...
func (o ErrorMessageObject) MarshalJSON() ([]byte, error) {
...
func (o ErrorMessageObject) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ParamList) {
		toSerialize["param_list"] = o.ParamList
	}
...
func (o *ErrorMessageObject) UnmarshalJSON(data []byte) (err error) {
	varErrorMessageObject := _ErrorMessageObject{}

	err = json.Unmarshal(data, &varErrorMessageObject)

	if err != nil {
		return err
	}

	*o = ErrorMessageObject(varErrorMessageObject)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "param_list")
...
type NullableErrorMessageObject struct {
	value *ErrorMessageObject
	isSet bool
}

func (v NullableErrorMessageObject) Get() *ErrorMessageObject {
	return v.value
}

func (v *NullableErrorMessageObject) Set(val *ErrorMessageObject) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorMessageObject) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorMessageObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorMessageObject(val *ErrorMessageObject) *NullableErrorMessageObject {
	return &NullableErrorMessageObject{value: val, isSet: true}
}

func (v NullableErrorMessageObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorMessageObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
