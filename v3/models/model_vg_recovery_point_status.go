...
// checks if the VgRecoveryPointStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VgRecoveryPointStatus{}

// VgRecoveryPointStatus The status of a REST API call. Only used when there is a failure to report. 
type VgRecoveryPointStatus struct {
	// The kind name
...
type _VgRecoveryPointStatus VgRecoveryPointStatus
...
func (o VgRecoveryPointStatus) MarshalJSON() ([]byte, error) {
...
func (o VgRecoveryPointStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VgRecoveryPointStatus) UnmarshalJSON(data []byte) (err error) {
	varVgRecoveryPointStatus := _VgRecoveryPointStatus{}

	err = json.Unmarshal(data, &varVgRecoveryPointStatus)

	if err != nil {
		return err
	}

	*o = VgRecoveryPointStatus(varVgRecoveryPointStatus)
...
type NullableVgRecoveryPointStatus struct {
	value *VgRecoveryPointStatus
	isSet bool
}

func (v NullableVgRecoveryPointStatus) Get() *VgRecoveryPointStatus {
	return v.value
}

func (v *NullableVgRecoveryPointStatus) Set(val *VgRecoveryPointStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVgRecoveryPointStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVgRecoveryPointStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVgRecoveryPointStatus(val *VgRecoveryPointStatus) *NullableVgRecoveryPointStatus {
	return &NullableVgRecoveryPointStatus{value: val, isSet: true}
}

func (v NullableVgRecoveryPointStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVgRecoveryPointStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
