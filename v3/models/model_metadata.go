...
// Metadata Result metadata object definition.
type Metadata struct {
	// List of entity instances.
	InstanceList []EntityMetadata `json:"instance_list,omitempty"`
	// User query in simple text.
	UserQuery *string `json:"user_query,omitempty"`
	// List of filters.
	FilterList []Expression `json:"filter_list,omitempty"`
	// Type of the entity.
...
// SetInstanceList gets a reference to the given []EntityMetadata and assigns it to the InstanceList field.
...
// SetFilterList gets a reference to the given []Expression and assigns it to the FilterList field.
...
func (o *Metadata) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Metadata(varMetadata)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "instance_list")
