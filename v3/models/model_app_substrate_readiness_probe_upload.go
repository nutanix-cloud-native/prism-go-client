...
// checks if the AppSubstrateReadinessProbeUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSubstrateReadinessProbeUpload{}

// AppSubstrateReadinessProbeUpload Readiness probe for substrate
type AppSubstrateReadinessProbeUpload struct {
	// 
	ConnectionType *string `json:"connection_type,omitempty"`
	// 
	ConnectionPort *int32 `json:"connection_port,omitempty"`
	// 
	TimeoutSecs *string `json:"timeout_secs,omitempty"`
	// 
	Address *string `json:"address,omitempty"`
	// Delay after substrate provision.
	DelaySecs *string `json:"delay_secs,omitempty"`
	// 
	DisableReadinessProbe *bool `json:"disable_readiness_probe,omitempty"`
	LoginCredentialLocalReference *AppCredentialReferenceUpload `json:"login_credential_local_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AppSubstrateReadinessProbeUpload AppSubstrateReadinessProbeUpload
...
func NewAppSubstrateReadinessProbeUpload() *AppSubstrateReadinessProbeUpload {
	this := AppSubstrateReadinessProbeUpload{}
	var connectionPort int32 = 22
...
// GetConnectionPort returns the ConnectionPort field value if set, zero value otherwise.
func (o *AppSubstrateReadinessProbeUpload) GetConnectionPort() int32 {
	if o == nil || IsNil(o.ConnectionPort) {
		var ret int32
		return ret
	}
	return *o.ConnectionPort
}

// GetConnectionPortOk returns a tuple with the ConnectionPort field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppSubstrateReadinessProbeUpload) GetConnectionPortOk() (*int32, bool) {
	if o == nil || IsNil(o.ConnectionPort) {
		return nil, false
	}
	return o.ConnectionPort, true
}
...
// SetConnectionPort gets a reference to the given int32 and assigns it to the ConnectionPort field.
...
// GetDelaySecs returns the DelaySecs field value if set, zero value otherwise.
func (o *AppSubstrateReadinessProbeUpload) GetDelaySecs() string {
	if o == nil || IsNil(o.DelaySecs) {
		var ret string
		return ret
	}
	return *o.DelaySecs
...
// SetDelaySecs gets a reference to the given string and assigns it to the DelaySecs field.
func (o *AppSubstrateReadinessProbeUpload) SetDelaySecs(v string) {
	o.DelaySecs = &v
}

// GetDisableReadinessProbe returns the DisableReadinessProbe field value if set, zero value otherwise.
func (o *AppSubstrateReadinessProbeUpload) GetDisableReadinessProbe() bool {
	if o == nil || IsNil(o.DisableReadinessProbe) {
		var ret bool
		return ret
	}
	return *o.DisableReadinessProbe
}

// GetDisableReadinessProbeOk returns a tuple with the DisableReadinessProbe field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppSubstrateReadinessProbeUpload) GetDisableReadinessProbeOk() (*bool, bool) {
	if o == nil || IsNil(o.DisableReadinessProbe) {
		return nil, false
	}
	return o.DisableReadinessProbe, true
}
...
// SetDisableReadinessProbe gets a reference to the given bool and assigns it to the DisableReadinessProbe field.
func (o *AppSubstrateReadinessProbeUpload) SetDisableReadinessProbe(v bool) {
	o.DisableReadinessProbe = &v
}

// GetLoginCredentialLocalReference returns the LoginCredentialLocalReference field value if set, zero value otherwise.
func (o *AppSubstrateReadinessProbeUpload) GetLoginCredentialLocalReference() AppCredentialReferenceUpload {
	if o == nil || IsNil(o.LoginCredentialLocalReference) {
		var ret AppCredentialReferenceUpload
		return ret
	}
	return *o.LoginCredentialLocalReference
}

// GetLoginCredentialLocalReferenceOk returns a tuple with the LoginCredentialLocalReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppSubstrateReadinessProbeUpload) GetLoginCredentialLocalReferenceOk() (*AppCredentialReferenceUpload, bool) {
	if o == nil || IsNil(o.LoginCredentialLocalReference) {
		return nil, false
	}
	return o.LoginCredentialLocalReference, true
}
...
// SetLoginCredentialLocalReference gets a reference to the given AppCredentialReferenceUpload and assigns it to the LoginCredentialLocalReference field.
func (o *AppSubstrateReadinessProbeUpload) SetLoginCredentialLocalReference(v AppCredentialReferenceUpload) {
	o.LoginCredentialLocalReference = &v
}

func (o AppSubstrateReadinessProbeUpload) MarshalJSON() ([]byte, error) {
...
func (o AppSubstrateReadinessProbeUpload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ConnectionType) {
		toSerialize["connection_type"] = o.ConnectionType
	}
	if !IsNil(o.ConnectionPort) {
		toSerialize["connection_port"] = o.ConnectionPort
	}
	...
	if !IsNil(o.DelaySecs) {
		toSerialize["delay_secs"] = o.DelaySecs
	}
	if !IsNil(o.DisableReadinessProbe) {
		toSerialize["disable_readiness_probe"] = o.DisableReadinessProbe
	}
	if !IsNil(o.LoginCredentialLocalReference) {
		toSerialize["login_credential_local_reference"] = o.LoginCredentialLocalReference
	}
...
func (o *AppSubstrateReadinessProbeUpload) UnmarshalJSON(data []byte) (err error) {
	varAppSubstrateReadinessProbeUpload := _AppSubstrateReadinessProbeUpload{}

	err = json.Unmarshal(data, &varAppSubstrateReadinessProbeUpload)

	if err != nil {
		return err
	}

	*o = AppSubstrateReadinessProbeUpload(varAppSubstrateReadinessProbeUpload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "connection_type")
		delete(additionalProperties, "connection_port")
		delete(additionalProperties, "timeout_secs")
		delete(additionalProperties, "address")
		delete(additionalProperties, "delay_secs")
		delete(additionalProperties, "disable_readiness_probe")
		delete(additionalProperties, "login_credential_local_reference")
...
type NullableAppSubstrateReadinessProbeUpload struct {
	value *AppSubstrateReadinessProbeUpload
	isSet bool
}

func (v NullableAppSubstrateReadinessProbeUpload) Get() *AppSubstrateReadinessProbeUpload {
	return v.value
}

func (v *NullableAppSubstrateReadinessProbeUpload) Set(val *AppSubstrateReadinessProbeUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppSubstrateReadinessProbeUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppSubstrateReadinessProbeUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppSubstrateReadinessProbeUpload(val *AppSubstrateReadinessProbeUpload) *NullableAppSubstrateReadinessProbeUpload {
	return &NullableAppSubstrateReadinessProbeUpload{value: val, isSet: true}
}

func (v NullableAppSubstrateReadinessProbeUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppSubstrateReadinessProbeUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
