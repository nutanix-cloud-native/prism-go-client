...
// checks if the DockerRegistryDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryDefStatus{}
...
type _DockerRegistryDefStatus DockerRegistryDefStatus
...
func (o *DockerRegistryDefStatus) GetResources() DockerRegistryResources {
	if o == nil {
		var ret DockerRegistryResources
		return ret
	}
...
func (o DockerRegistryDefStatus) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerRegistryDefStatus := _DockerRegistryDefStatus{}

	err = json.Unmarshal(data, &varDockerRegistryDefStatus)

	if err != nil {
		return err
	}

	*o = DockerRegistryDefStatus(varDockerRegistryDefStatus)
...
type NullableDockerRegistryDefStatus struct {
	value *DockerRegistryDefStatus
	isSet bool
}

func (v NullableDockerRegistryDefStatus) Get() *DockerRegistryDefStatus {
	return v.value
}

func (v *NullableDockerRegistryDefStatus) Set(val *DockerRegistryDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryDefStatus(val *DockerRegistryDefStatus) *NullableDockerRegistryDefStatus {
	return &NullableDockerRegistryDefStatus{value: val, isSet: true}
}

func (v NullableDockerRegistryDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
