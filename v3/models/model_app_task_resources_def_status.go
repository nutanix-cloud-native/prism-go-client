...
// checks if the AppTaskResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskResourcesDefStatus{}

// AppTaskResourcesDefStatus Libraty task resources definition.
type AppTaskResourcesDefStatus struct {
	TargetAnyLocalReference *EntityReference `json:"target_any_local_reference,omitempty"`
	// Number of retries for the task.
	Retries *string `json:"retries,omitempty"`
	// Message list.
	MessageList []MessageResource `json:"message_list"`
	// The projects this task has been assigned to
	ProjectReferenceList []ProjectReference `json:"project_reference_list,omitempty"`
	// 
	ChildTasksLocalReferenceList []AppTaskReference `json:"child_tasks_local_reference_list,omitempty"`
	// 
	State string `json:"state"`
	// Task attrs for application of type object.
	Attrs map[string]interface{} `json:"attrs,omitempty"`
	// task timeout.
	TimeoutSecs *string `json:"timeout_secs,omitempty"`
	// 
...
type _AppTaskResourcesDefStatus AppTaskResourcesDefStatus
...
func NewAppTaskResourcesDefStatus(messageList []MessageResource, state string, type_ string) *AppTaskResourcesDefStatus {
	this := AppTaskResourcesDefStatus{}
...
// GetTargetAnyLocalReference returns the TargetAnyLocalReference field value if set, zero value otherwise.
func (o *AppTaskResourcesDefStatus) GetTargetAnyLocalReference() EntityReference {
	if o == nil || IsNil(o.TargetAnyLocalReference) {
		var ret EntityReference
		return ret
	}
	return *o.TargetAnyLocalReference
}

// GetTargetAnyLocalReferenceOk returns a tuple with the TargetAnyLocalReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppTaskResourcesDefStatus) GetTargetAnyLocalReferenceOk() (*EntityReference, bool) {
	if o == nil || IsNil(o.TargetAnyLocalReference) {
		return nil, false
	}
	return o.TargetAnyLocalReference, true
}
...
// SetTargetAnyLocalReference gets a reference to the given EntityReference and assigns it to the TargetAnyLocalReference field.
func (o *AppTaskResourcesDefStatus) SetTargetAnyLocalReference(v EntityReference) {
	o.TargetAnyLocalReference = &v
}
...
// SetRetries gets a reference to the given string and assigns it to the Retries field.
...
// GetChildTasksLocalReferenceList returns the ChildTasksLocalReferenceList field value if set, zero value otherwise.
func (o *AppTaskResourcesDefStatus) GetChildTasksLocalReferenceList() []AppTaskReference {
	if o == nil || IsNil(o.ChildTasksLocalReferenceList) {
		var ret []AppTaskReference
		return ret
	}
	return o.ChildTasksLocalReferenceList
}

// GetChildTasksLocalReferenceListOk returns a tuple with the ChildTasksLocalReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppTaskResourcesDefStatus) GetChildTasksLocalReferenceListOk() ([]AppTaskReference, bool) {
	if o == nil || IsNil(o.ChildTasksLocalReferenceList) {
		return nil, false
	}
	return o.ChildTasksLocalReferenceList, true
}
...
// SetChildTasksLocalReferenceList gets a reference to the given []AppTaskReference and assigns it to the ChildTasksLocalReferenceList field.
func (o *AppTaskResourcesDefStatus) SetChildTasksLocalReferenceList(v []AppTaskReference) {
	o.ChildTasksLocalReferenceList = v
}
...
// SetTimeoutSecs gets a reference to the given string and assigns it to the TimeoutSecs field.
...
func (o AppTaskResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AppTaskResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TargetAnyLocalReference) {
		toSerialize["target_any_local_reference"] = o.TargetAnyLocalReference
	}
	if !IsNil(o.Retries) {
	...
	if !IsNil(o.ChildTasksLocalReferenceList) {
		toSerialize["child_tasks_local_reference_list"] = o.ChildTasksLocalReferenceList
	}
...
func (o *AppTaskResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskResourcesDefStatus := _AppTaskResourcesDefStatus{}

	err = json.Unmarshal(data, &varAppTaskResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = AppTaskResourcesDefStatus(varAppTaskResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "target_any_local_reference")
		...
		delete(additionalProperties, "child_tasks_local_reference_list")
		delete(additionalProperties, "state")
		delete(additionalProperties, "attrs")
		delete(additionalProperties, "timeout_secs")
...
type NullableAppTaskResourcesDefStatus struct {
	value *AppTaskResourcesDefStatus
	isSet bool
}

func (v NullableAppTaskResourcesDefStatus) Get() *AppTaskResourcesDefStatus {
	return v.value
}

func (v *NullableAppTaskResourcesDefStatus) Set(val *AppTaskResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskResourcesDefStatus(val *AppTaskResourcesDefStatus) *NullableAppTaskResourcesDefStatus {
	return &NullableAppTaskResourcesDefStatus{value: val, isSet: true}
}

func (v NullableAppTaskResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
