...
// checks if the IdempotenceIdentifiersListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdempotenceIdentifiersListMetadataOutput{}

// IdempotenceIdentifiersListMetadataOutput All api calls that return a list will have this metadata block 
...
type _IdempotenceIdentifiersListMetadataOutput IdempotenceIdentifiersListMetadataOutput
...
func NewIdempotenceIdentifiersListMetadataOutput() *IdempotenceIdentifiersListMetadataOutput {
	this := IdempotenceIdentifiersListMetadataOutput{}
	var kind string = "idempotence_identifiers"
	this.Kind = &kind
	return &this
}
...
func (o *IdempotenceIdentifiersListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *IdempotenceIdentifiersListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o IdempotenceIdentifiersListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o IdempotenceIdentifiersListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *IdempotenceIdentifiersListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varIdempotenceIdentifiersListMetadataOutput := _IdempotenceIdentifiersListMetadataOutput{}

	err = json.Unmarshal(data, &varIdempotenceIdentifiersListMetadataOutput)

	if err != nil {
		return err
	}

	*o = IdempotenceIdentifiersListMetadataOutput(varIdempotenceIdentifiersListMetadataOutput)
...
type NullableIdempotenceIdentifiersListMetadataOutput struct {
	value *IdempotenceIdentifiersListMetadataOutput
	isSet bool
}

func (v NullableIdempotenceIdentifiersListMetadataOutput) Get() *IdempotenceIdentifiersListMetadataOutput {
	return v.value
}

func (v *NullableIdempotenceIdentifiersListMetadataOutput) Set(val *IdempotenceIdentifiersListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableIdempotenceIdentifiersListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableIdempotenceIdentifiersListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdempotenceIdentifiersListMetadataOutput(val *IdempotenceIdentifiersListMetadataOutput) *NullableIdempotenceIdentifiersListMetadataOutput {
	return &NullableIdempotenceIdentifiersListMetadataOutput{value: val, isSet: true}
}

func (v NullableIdempotenceIdentifiersListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdempotenceIdentifiersListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
