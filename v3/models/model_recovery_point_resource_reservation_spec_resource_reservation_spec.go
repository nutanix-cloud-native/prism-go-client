...
// checks if the RecoveryPointResourceReservationSpecResourceReservationSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPointResourceReservationSpecResourceReservationSpec{}

// RecoveryPointResourceReservationSpecResourceReservationSpec Resource reservation specification.
type RecoveryPointResourceReservationSpecResourceReservationSpec struct {
	// Operation to be performed on the resource reservation made by Lazan for the recovery point. 
	OperationType string `json:"operation_type"`
	// Amount of time in seconds for which the reservation lease made by Lazan need to be refreshed. 
	ReservationLeaseTimeoutSecs *int64 `json:"reservation_lease_timeout_secs,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPointResourceReservationSpecResourceReservationSpec RecoveryPointResourceReservationSpecResourceReservationSpec
...
func NewRecoveryPointResourceReservationSpecResourceReservationSpec(operationType string) *RecoveryPointResourceReservationSpecResourceReservationSpec {
	this := RecoveryPointResourceReservationSpecResourceReservationSpec{}
...
// GetReservationLeaseTimeoutSecs returns the ReservationLeaseTimeoutSecs field value if set, zero value otherwise.
func (o *RecoveryPointResourceReservationSpecResourceReservationSpec) GetReservationLeaseTimeoutSecs() int64 {
	if o == nil || IsNil(o.ReservationLeaseTimeoutSecs) {
		var ret int64
		return ret
	}
	return *o.ReservationLeaseTimeoutSecs
}

// GetReservationLeaseTimeoutSecsOk returns a tuple with the ReservationLeaseTimeoutSecs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPointResourceReservationSpecResourceReservationSpec) GetReservationLeaseTimeoutSecsOk() (*int64, bool) {
	if o == nil || IsNil(o.ReservationLeaseTimeoutSecs) {
		return nil, false
	}
	return o.ReservationLeaseTimeoutSecs, true
}
...
// SetReservationLeaseTimeoutSecs gets a reference to the given int64 and assigns it to the ReservationLeaseTimeoutSecs field.
func (o *RecoveryPointResourceReservationSpecResourceReservationSpec) SetReservationLeaseTimeoutSecs(v int64) {
	o.ReservationLeaseTimeoutSecs = &v
}

func (o RecoveryPointResourceReservationSpecResourceReservationSpec) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPointResourceReservationSpecResourceReservationSpec) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["operation_type"] = o.OperationType
	if !IsNil(o.ReservationLeaseTimeoutSecs) {
		toSerialize["reservation_lease_timeout_secs"] = o.ReservationLeaseTimeoutSecs
	}
...
func (o *RecoveryPointResourceReservationSpecResourceReservationSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPointResourceReservationSpecResourceReservationSpec := _RecoveryPointResourceReservationSpecResourceReservationSpec{}

	err = json.Unmarshal(data, &varRecoveryPointResourceReservationSpecResourceReservationSpec)

	if err != nil {
		return err
	}

	*o = RecoveryPointResourceReservationSpecResourceReservationSpec(varRecoveryPointResourceReservationSpecResourceReservationSpec)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "operation_type")
		delete(additionalProperties, "reservation_lease_timeout_secs")
...
type NullableRecoveryPointResourceReservationSpecResourceReservationSpec struct {
	value *RecoveryPointResourceReservationSpecResourceReservationSpec
	isSet bool
}

func (v NullableRecoveryPointResourceReservationSpecResourceReservationSpec) Get() *RecoveryPointResourceReservationSpecResourceReservationSpec {
	return v.value
}

func (v *NullableRecoveryPointResourceReservationSpecResourceReservationSpec) Set(val *RecoveryPointResourceReservationSpecResourceReservationSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPointResourceReservationSpecResourceReservationSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPointResourceReservationSpecResourceReservationSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPointResourceReservationSpecResourceReservationSpec(val *RecoveryPointResourceReservationSpecResourceReservationSpec) *NullableRecoveryPointResourceReservationSpecResourceReservationSpec {
	return &NullableRecoveryPointResourceReservationSpecResourceReservationSpec{value: val, isSet: true}
}

func (v NullableRecoveryPointResourceReservationSpecResourceReservationSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPointResourceReservationSpecResourceReservationSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
