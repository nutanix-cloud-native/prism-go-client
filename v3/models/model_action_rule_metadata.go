...
// checks if the ActionRuleMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleMetadata{}

// ActionRuleMetadata The action_rule kind metadata
type ActionRuleMetadata struct {
	...
	// Categories for the action_rule. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the action_rule. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _ActionRuleMetadata ActionRuleMetadata
...
func (o ActionRuleMetadata) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleMetadata := _ActionRuleMetadata{}

	err = json.Unmarshal(data, &varActionRuleMetadata)

	if err != nil {
		return err
	}

	*o = ActionRuleMetadata(varActionRuleMetadata)
...
type NullableActionRuleMetadata struct {
	value *ActionRuleMetadata
	isSet bool
}

func (v NullableActionRuleMetadata) Get() *ActionRuleMetadata {
	return v.value
}

func (v *NullableActionRuleMetadata) Set(val *ActionRuleMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleMetadata(val *ActionRuleMetadata) *NullableActionRuleMetadata {
	return &NullableActionRuleMetadata{value: val, isSet: true}
}

func (v NullableActionRuleMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
