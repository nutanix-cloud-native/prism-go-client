...
// checks if the ActionRuleResultMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResultMetadata{}

// ActionRuleResultMetadata The action_rule_result kind metadata
type ActionRuleResultMetadata struct {
	...
	// Categories for the action_rule_result. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the action_rule_result. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// action_rule_result name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ActionRuleResultMetadata ActionRuleResultMetadata
...
func (o ActionRuleResultMetadata) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResultMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleResultMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleResultMetadata := _ActionRuleResultMetadata{}

	err = json.Unmarshal(data, &varActionRuleResultMetadata)

	if err != nil {
		return err
	}

	*o = ActionRuleResultMetadata(varActionRuleResultMetadata)
...
type NullableActionRuleResultMetadata struct {
	value *ActionRuleResultMetadata
	isSet bool
}

func (v NullableActionRuleResultMetadata) Get() *ActionRuleResultMetadata {
	return v.value
}

func (v *NullableActionRuleResultMetadata) Set(val *ActionRuleResultMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResultMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResultMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResultMetadata(val *ActionRuleResultMetadata) *NullableActionRuleResultMetadata {
	return &NullableActionRuleResultMetadata{value: val, isSet: true}
}

func (v NullableActionRuleResultMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResultMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
