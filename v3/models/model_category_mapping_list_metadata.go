...
// checks if the CategoryMappingListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingListMetadata{}

// CategoryMappingListMetadata All api calls that return a list will have this metadata block as input 
type CategoryMappingListMetadata struct {
	// The kind name
...
type _CategoryMappingListMetadata CategoryMappingListMetadata
...
func NewCategoryMappingListMetadata() *CategoryMappingListMetadata {
	this := CategoryMappingListMetadata{}
...
func (o CategoryMappingListMetadata) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingListMetadata) UnmarshalJSON(data []byte) (err error) {
	varCategoryMappingListMetadata := _CategoryMappingListMetadata{}

	err = json.Unmarshal(data, &varCategoryMappingListMetadata)

	if err != nil {
		return err
	}

	*o = CategoryMappingListMetadata(varCategoryMappingListMetadata)
...
type NullableCategoryMappingListMetadata struct {
	value *CategoryMappingListMetadata
	isSet bool
}

func (v NullableCategoryMappingListMetadata) Get() *CategoryMappingListMetadata {
	return v.value
}

func (v *NullableCategoryMappingListMetadata) Set(val *CategoryMappingListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingListMetadata(val *CategoryMappingListMetadata) *NullableCategoryMappingListMetadata {
	return &NullableCategoryMappingListMetadata{value: val, isSet: true}
}

func (v NullableCategoryMappingListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
