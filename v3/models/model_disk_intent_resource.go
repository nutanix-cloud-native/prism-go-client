...
// checks if the DiskIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskIntentResource{}

// DiskIntentResource Response object for intentful operations on a disk
type DiskIntentResource struct {
	Status *DiskDefStatus `json:"status,omitempty"`
	// Disk specification.
...
type _DiskIntentResource DiskIntentResource
...
// SetStatus gets a reference to the given DiskDefStatus and assigns it to the Status field.
...
func (o DiskIntentResource) MarshalJSON() ([]byte, error) {
...
func (o DiskIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *DiskIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varDiskIntentResource := _DiskIntentResource{}

	err = json.Unmarshal(data, &varDiskIntentResource)

	if err != nil {
		return err
	}

	*o = DiskIntentResource(varDiskIntentResource)
...
type NullableDiskIntentResource struct {
	value *DiskIntentResource
	isSet bool
}

func (v NullableDiskIntentResource) Get() *DiskIntentResource {
	return v.value
}

func (v *NullableDiskIntentResource) Set(val *DiskIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskIntentResource(val *DiskIntentResource) *NullableDiskIntentResource {
	return &NullableDiskIntentResource{value: val, isSet: true}
}

func (v NullableDiskIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
