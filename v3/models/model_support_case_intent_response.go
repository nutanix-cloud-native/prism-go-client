...
// checks if the SupportCaseIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseIntentResponse{}

// SupportCaseIntentResponse Response object for intentful operations on a support_case
type SupportCaseIntentResponse struct {
...
type _SupportCaseIntentResponse SupportCaseIntentResponse
...
func NewSupportCaseIntentResponse(apiVersion string, metadata SupportCaseMetadata) *SupportCaseIntentResponse {
	this := SupportCaseIntentResponse{}
...
func (o SupportCaseIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseIntentResponse := _SupportCaseIntentResponse{}

	err = json.Unmarshal(data, &varSupportCaseIntentResponse)

	if err != nil {
		return err
	}

	*o = SupportCaseIntentResponse(varSupportCaseIntentResponse)
...
type NullableSupportCaseIntentResponse struct {
	value *SupportCaseIntentResponse
	isSet bool
}

func (v NullableSupportCaseIntentResponse) Get() *SupportCaseIntentResponse {
	return v.value
}

func (v *NullableSupportCaseIntentResponse) Set(val *SupportCaseIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseIntentResponse(val *SupportCaseIntentResponse) *NullableSupportCaseIntentResponse {
	return &NullableSupportCaseIntentResponse{value: val, isSet: true}
}

func (v NullableSupportCaseIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
