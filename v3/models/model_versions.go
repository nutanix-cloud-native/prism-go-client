...
func (o *Versions) UnmarshalJSON(data []byte) (err error) {
	...
	varVersions := _Versions{}

	err = json.Unmarshal(data, &varVersions)

	if err != nil {
		return err
	}

	*o = Versions(varVersions)
