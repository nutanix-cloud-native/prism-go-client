...
// checks if the PrismCentralResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralResources{}
...
type PrismCentralResources struct {
	...
	VirtualIp *string `json:"virtual_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
...
type _PrismCentralResources PrismCentralResources
...
func NewPrismCentralResources(pcVmList []PcVm, version string) *PrismCentralResources {
	this := PrismCentralResources{}
	var shouldAutoRegister bool = false
	this.ShouldAutoRegister = &shouldAutoRegister
	var isRegisteredToHostingPe bool = false
	this.IsRegisteredToHostingPe = &isRegisteredToHostingPe
	this.PcVmList = pcVmList
...
// GetShouldAutoRegister returns the ShouldAutoRegister field value if set, zero value otherwise.
func (o *PrismCentralResources) GetShouldAutoRegister() bool {
	if o == nil || IsNil(o.ShouldAutoRegister) {
		var ret bool
		return ret
	}
	return *o.ShouldAutoRegister
}

// GetShouldAutoRegisterOk returns a tuple with the ShouldAutoRegister field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PrismCentralResources) GetShouldAutoRegisterOk() (*bool, bool) {
	if o == nil || IsNil(o.ShouldAutoRegister) {
		return nil, false
	}
	return o.ShouldAutoRegister, true
}
...
// SetShouldAutoRegister gets a reference to the given bool and assigns it to the ShouldAutoRegister field.
func (o *PrismCentralResources) SetShouldAutoRegister(v bool) {
	o.ShouldAutoRegister = &v
}
...
// GetIsRegisteredToHostingPe returns the IsRegisteredToHostingPe field value if set, zero value otherwise.
func (o *PrismCentralResources) GetIsRegisteredToHostingPe() bool {
	if o == nil || IsNil(o.IsRegisteredToHostingPe) {
		var ret bool
		return ret
	}
	return *o.IsRegisteredToHostingPe
}

// GetIsRegisteredToHostingPeOk returns a tuple with the IsRegisteredToHostingPe field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PrismCentralResources) GetIsRegisteredToHostingPeOk() (*bool, bool) {
	if o == nil || IsNil(o.IsRegisteredToHostingPe) {
		return nil, false
	}
	return o.IsRegisteredToHostingPe, true
}
...
// SetIsRegisteredToHostingPe gets a reference to the given bool and assigns it to the IsRegisteredToHostingPe field.
func (o *PrismCentralResources) SetIsRegisteredToHostingPe(v bool) {
	o.IsRegisteredToHostingPe = &v
}

// GetCmspConfig returns the CmspConfig field value if set, zero value otherwise.
func (o *PrismCentralResources) GetCmspConfig() CmspConfig {
	if o == nil || IsNil(o.CmspConfig) {
		var ret CmspConfig
		return ret
	}
	return *o.CmspConfig
...
// GetCmspConfigOk returns a tuple with the CmspConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PrismCentralResources) GetCmspConfigOk() (*CmspConfig, bool) {
	if o == nil || IsNil(o.CmspConfig) {
		return nil, false
	}
	return o.CmspConfig, true
}
...
// SetCmspConfig gets a reference to the given CmspConfig and assigns it to the CmspConfig field.
func (o *PrismCentralResources) SetCmspConfig(v CmspConfig) {
	o.CmspConfig = &v
}

// GetMcmConfig returns the McmConfig field value if set, zero value otherwise.
func (o *PrismCentralResources) GetMcmConfig() McmConfig {
	if o == nil || IsNil(o.McmConfig) {
		var ret McmConfig
		return ret
	}
	return *o.McmConfig
...
// GetMcmConfigOk returns a tuple with the McmConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PrismCentralResources) GetMcmConfigOk() (*McmConfig, bool) {
	if o == nil || IsNil(o.McmConfig) {
		return nil, false
	}
	return o.McmConfig, true
}
...
// SetMcmConfig gets a reference to the given McmConfig and assigns it to the McmConfig field.
func (o *PrismCentralResources) SetMcmConfig(v McmConfig) {
	o.McmConfig = &v
}

// GetPcVmList returns the PcVmList field value
...
// GetPcVmListOk returns a tuple with the PcVmList field value
// and a boolean to check if the value has been set.
func (o *PrismCentralResources) GetPcVmListOk() ([]PcVm, bool) {
	if o == nil {
		return nil, false
	}
	return o.PcVmList, true
}

// SetPcVmList sets field value
...
func (o PrismCentralResources) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ShouldAutoRegister) {
		toSerialize["should_auto_register"] = o.ShouldAutoRegister
	}
	if !IsNil(o.InitialPassword) {
		toSerialize["initial_password"] = o.InitialPassword
	}
	if !IsNil(o.IsRegisteredToHostingPe) {
		toSerialize["is_registered_to_hosting_pe"] = o.IsRegisteredToHostingPe
	}
	if !IsNil(o.CmspConfig) {
		toSerialize["cmsp_config"] = o.CmspConfig
	}
	if !IsNil(o.McmConfig) {
		toSerialize["mcm_config"] = o.McmConfig
	}
	toSerialize["pc_vm_list"] = o.PcVmList
...
func (o *PrismCentralResources) UnmarshalJSON(data []byte) (err error) {
	...
	varPrismCentralResources := _PrismCentralResources{}

	err = json.Unmarshal(data, &varPrismCentralResources)

	if err != nil {
		return err
	}

	*o = PrismCentralResources(varPrismCentralResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "should_auto_register")
		delete(additionalProperties, "initial_password")
		delete(additionalProperties, "is_registered_to_hosting_pe")
		delete(additionalProperties, "cmsp_config")
		delete(additionalProperties, "mcm_config")
		delete(additionalProperties, "pc_vm_list")
...
type NullablePrismCentralResources struct {
	value *PrismCentralResources
	isSet bool
}

func (v NullablePrismCentralResources) Get() *PrismCentralResources {
	return v.value
}

func (v *NullablePrismCentralResources) Set(val *PrismCentralResources) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralResources) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralResources(val *PrismCentralResources) *NullablePrismCentralResources {
	return &NullablePrismCentralResources{value: val, isSet: true}
}

func (v NullablePrismCentralResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
