...
// checks if the NutanixGuestToolsStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NutanixGuestToolsStatus{}
...
type _NutanixGuestToolsStatus NutanixGuestToolsStatus
...
// GetNgtState returns the NgtState field value if set, zero value otherwise.
func (o *NutanixGuestToolsStatus) GetNgtState() string {
	if o == nil || IsNil(o.NgtState) {
		var ret string
		return ret
	}
	return *o.NgtState
...
// GetNgtStateOk returns a tuple with the NgtState field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NutanixGuestToolsStatus) GetNgtStateOk() (*string, bool) {
	if o == nil || IsNil(o.NgtState) {
		return nil, false
	}
	return o.NgtState, true
}
...
// SetNgtState gets a reference to the given string and assigns it to the NgtState field.
func (o *NutanixGuestToolsStatus) SetNgtState(v string) {
	o.NgtState = &v
}

// GetIsoMountState returns the IsoMountState field value if set, zero value otherwise.
func (o *NutanixGuestToolsStatus) GetIsoMountState() string {
	if o == nil || IsNil(o.IsoMountState) {
		var ret string
		return ret
	}
	return *o.IsoMountState
}

// GetIsoMountStateOk returns a tuple with the IsoMountState field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NutanixGuestToolsStatus) GetIsoMountStateOk() (*string, bool) {
	if o == nil || IsNil(o.IsoMountState) {
		return nil, false
	}
	return o.IsoMountState, true
}
...
// SetIsoMountState gets a reference to the given string and assigns it to the IsoMountState field.
...
// GetEnabledCapabilityList returns the EnabledCapabilityList field value if set, zero value otherwise.
func (o *NutanixGuestToolsStatus) GetEnabledCapabilityList() []string {
	if o == nil || IsNil(o.EnabledCapabilityList) {
		var ret []string
		return ret
	}
	return o.EnabledCapabilityList
}

// GetEnabledCapabilityListOk returns a tuple with the EnabledCapabilityList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NutanixGuestToolsStatus) GetEnabledCapabilityListOk() ([]string, bool) {
	if o == nil || IsNil(o.EnabledCapabilityList) {
		return nil, false
	}
	return o.EnabledCapabilityList, true
}
...
// SetEnabledCapabilityList gets a reference to the given []string and assigns it to the EnabledCapabilityList field.
func (o *NutanixGuestToolsStatus) SetEnabledCapabilityList(v []string) {
	o.EnabledCapabilityList = v
}
...
// GetVssSnapshotCapable returns the VssSnapshotCapable field value if set, zero value otherwise.
func (o *NutanixGuestToolsStatus) GetVssSnapshotCapable() bool {
	if o == nil || IsNil(o.VssSnapshotCapable) {
		var ret bool
		return ret
	}
	return *o.VssSnapshotCapable
}

// GetVssSnapshotCapableOk returns a tuple with the VssSnapshotCapable field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NutanixGuestToolsStatus) GetVssSnapshotCapableOk() (*bool, bool) {
	if o == nil || IsNil(o.VssSnapshotCapable) {
		return nil, false
	}
	return o.VssSnapshotCapable, true
}
...
// SetVssSnapshotCapable gets a reference to the given bool and assigns it to the VssSnapshotCapable field.
func (o *NutanixGuestToolsStatus) SetVssSnapshotCapable(v bool) {
	o.VssSnapshotCapable = &v
}
...
// GetVmMobilityDriversInstalled returns the VmMobilityDriversInstalled field value if set, zero value otherwise.
func (o *NutanixGuestToolsStatus) GetVmMobilityDriversInstalled() bool {
	if o == nil || IsNil(o.VmMobilityDriversInstalled) {
		var ret bool
		return ret
	}
	return *o.VmMobilityDriversInstalled
}

// GetVmMobilityDriversInstalledOk returns a tuple with the VmMobilityDriversInstalled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NutanixGuestToolsStatus) GetVmMobilityDriversInstalledOk() (*bool, bool) {
	if o == nil || IsNil(o.VmMobilityDriversInstalled) {
		return nil, false
	}
	return o.VmMobilityDriversInstalled, true
}
...
// SetVmMobilityDriversInstalled gets a reference to the given bool and assigns it to the VmMobilityDriversInstalled field.
func (o *NutanixGuestToolsStatus) SetVmMobilityDriversInstalled(v bool) {
	o.VmMobilityDriversInstalled = &v
}

func (o NutanixGuestToolsStatus) MarshalJSON() ([]byte, error) {
...
func (o NutanixGuestToolsStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AvailableVersion) {
		toSerialize["available_version"] = o.AvailableVersion
	}
	if !IsNil(o.NgtState) {
		toSerialize["ngt_state"] = o.NgtState
	}
	if !IsNil(o.IsoMountState) {
		toSerialize["iso_mount_state"] = o.IsoMountState
	}
	if !IsNil(o.GuestOsVersion) {
		toSerialize["guest_os_version"] = o.GuestOsVersion
	}
	if !IsNil(o.State) {
	...
	if !IsNil(o.EnabledCapabilityList) {
		toSerialize["enabled_capability_list"] = o.EnabledCapabilityList
	}
	if !IsNil(o.Credentials) {
		toSerialize["credentials"] = o.Credentials
	}
	if !IsNil(o.VssSnapshotCapable) {
		toSerialize["vss_snapshot_capable"] = o.VssSnapshotCapable
	}
	if !IsNil(o.IsReachable) {
		toSerialize["is_reachable"] = o.IsReachable
	}
	if !IsNil(o.VmMobilityDriversInstalled) {
		toSerialize["vm_mobility_drivers_installed"] = o.VmMobilityDriversInstalled
	}
...
func (o *NutanixGuestToolsStatus) UnmarshalJSON(data []byte) (err error) {
	varNutanixGuestToolsStatus := _NutanixGuestToolsStatus{}

	err = json.Unmarshal(data, &varNutanixGuestToolsStatus)

	if err != nil {
		return err
	}

	*o = NutanixGuestToolsStatus(varNutanixGuestToolsStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "available_version")
		delete(additionalProperties, "ngt_state")
		delete(additionalProperties, "iso_mount_state")
		delete(additionalProperties, "guest_os_version")
		delete(additionalProperties, "state")
		delete(additionalProperties, "version")
		delete(additionalProperties, "enabled_capability_list")
		delete(additionalProperties, "credentials")
		delete(additionalProperties, "vss_snapshot_capable")
		delete(additionalProperties, "is_reachable")
		delete(additionalProperties, "vm_mobility_drivers_installed")
...
type NullableNutanixGuestToolsStatus struct {
	value *NutanixGuestToolsStatus
	isSet bool
}

func (v NullableNutanixGuestToolsStatus) Get() *NutanixGuestToolsStatus {
	return v.value
}

func (v *NullableNutanixGuestToolsStatus) Set(val *NutanixGuestToolsStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNutanixGuestToolsStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNutanixGuestToolsStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNutanixGuestToolsStatus(val *NutanixGuestToolsStatus) *NullableNutanixGuestToolsStatus {
	return &NullableNutanixGuestToolsStatus{value: val, isSet: true}
}

func (v NullableNutanixGuestToolsStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNutanixGuestToolsStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
