...
// checks if the DpdConfigStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DpdConfigStatus{}

// DpdConfigStatus DPD (Dead Peer Detection) related configuration spec for the VPN connections.
type DpdConfigStatus struct {
...
type _DpdConfigStatus DpdConfigStatus
...
// SetIntervalSecs gets a reference to the given int32 and assigns it to the IntervalSecs field.
...
func (o DpdConfigStatus) MarshalJSON() ([]byte, error) {
...
func (o DpdConfigStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DpdConfigStatus) UnmarshalJSON(data []byte) (err error) {
	varDpdConfigStatus := _DpdConfigStatus{}

	err = json.Unmarshal(data, &varDpdConfigStatus)

	if err != nil {
		return err
	}

	*o = DpdConfigStatus(varDpdConfigStatus)
...
type NullableDpdConfigStatus struct {
	value *DpdConfigStatus
	isSet bool
}

func (v NullableDpdConfigStatus) Get() *DpdConfigStatus {
	return v.value
}

func (v *NullableDpdConfigStatus) Set(val *DpdConfigStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDpdConfigStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDpdConfigStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDpdConfigStatus(val *DpdConfigStatus) *NullableDpdConfigStatus {
	return &NullableDpdConfigStatus{value: val, isSet: true}
}

func (v NullableDpdConfigStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDpdConfigStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
