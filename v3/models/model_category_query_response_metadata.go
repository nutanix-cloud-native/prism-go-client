...
// checks if the CategoryQueryResponseMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryQueryResponseMetadata{}

// CategoryQueryResponseMetadata Response metadata.
...
type _CategoryQueryResponseMetadata CategoryQueryResponseMetadata
...
func NewCategoryQueryResponseMetadata() *CategoryQueryResponseMetadata {
	this := CategoryQueryResponseMetadata{}
	return &this
}
...
func (o CategoryQueryResponseMetadata) MarshalJSON() ([]byte, error) {
...
func (o CategoryQueryResponseMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryQueryResponseMetadata) UnmarshalJSON(data []byte) (err error) {
	varCategoryQueryResponseMetadata := _CategoryQueryResponseMetadata{}

	err = json.Unmarshal(data, &varCategoryQueryResponseMetadata)

	if err != nil {
		return err
	}

	*o = CategoryQueryResponseMetadata(varCategoryQueryResponseMetadata)
...
type NullableCategoryQueryResponseMetadata struct {
	value *CategoryQueryResponseMetadata
	isSet bool
}

func (v NullableCategoryQueryResponseMetadata) Get() *CategoryQueryResponseMetadata {
	return v.value
}

func (v *NullableCategoryQueryResponseMetadata) Set(val *CategoryQueryResponseMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryQueryResponseMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryQueryResponseMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryQueryResponseMetadata(val *CategoryQueryResponseMetadata) *NullableCategoryQueryResponseMetadata {
	return &NullableCategoryQueryResponseMetadata{value: val, isSet: true}
}

func (v NullableCategoryQueryResponseMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryQueryResponseMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
