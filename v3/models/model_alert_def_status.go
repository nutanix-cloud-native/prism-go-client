...
// checks if the AlertDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertDefStatus{}

// AlertDefStatus Alert entity status definition
type AlertDefStatus struct {
	// The state of the entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	Resources AlertResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _AlertDefStatus AlertDefStatus
...
func (o AlertDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AlertDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AlertDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertDefStatus := _AlertDefStatus{}

	err = json.Unmarshal(data, &varAlertDefStatus)

	if err != nil {
		return err
	}

	*o = AlertDefStatus(varAlertDefStatus)
