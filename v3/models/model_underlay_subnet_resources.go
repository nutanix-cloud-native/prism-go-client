...
// checks if the UnderlaySubnetResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnetResources{}

// UnderlaySubnetResources Underlay subnet entity definition
type UnderlaySubnetResources struct {
	DatacenterReference *DatacenterReference `json:"datacenter_reference,omitempty"`
	// Netmask (could be in CIDR or IP format)
	Netmask string `json:"netmask"`
	// Gateway IP address
	Gateway string `json:"gateway" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	AdditionalProperties map[string]interface{}
}

type _UnderlaySubnetResources UnderlaySubnetResources
...
// GetDatacenterReference returns the DatacenterReference field value if set, zero value otherwise.
func (o *UnderlaySubnetResources) GetDatacenterReference() DatacenterReference {
	if o == nil || IsNil(o.DatacenterReference) {
		var ret DatacenterReference
		return ret
	}
	return *o.DatacenterReference
}

// GetDatacenterReferenceOk returns a tuple with the DatacenterReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnderlaySubnetResources) GetDatacenterReferenceOk() (*DatacenterReference, bool) {
	if o == nil || IsNil(o.DatacenterReference) {
		return nil, false
	}
	return o.DatacenterReference, true
}
...
// SetDatacenterReference gets a reference to the given DatacenterReference and assigns it to the DatacenterReference field.
func (o *UnderlaySubnetResources) SetDatacenterReference(v DatacenterReference) {
	o.DatacenterReference = &v
}
...
func (o UnderlaySubnetResources) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnetResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DatacenterReference) {
		toSerialize["datacenter_reference"] = o.DatacenterReference
	}
...
func (o *UnderlaySubnetResources) UnmarshalJSON(data []byte) (err error) {
	...
	varUnderlaySubnetResources := _UnderlaySubnetResources{}

	err = json.Unmarshal(data, &varUnderlaySubnetResources)

	if err != nil {
		return err
	}

	*o = UnderlaySubnetResources(varUnderlaySubnetResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "datacenter_reference")
...
type NullableUnderlaySubnetResources struct {
	value *UnderlaySubnetResources
	isSet bool
}

func (v NullableUnderlaySubnetResources) Get() *UnderlaySubnetResources {
	return v.value
}

func (v *NullableUnderlaySubnetResources) Set(val *UnderlaySubnetResources) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnetResources) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnetResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnetResources(val *UnderlaySubnetResources) *NullableUnderlaySubnetResources {
	return &NullableUnderlaySubnetResources{value: val, isSet: true}
}

func (v NullableUnderlaySubnetResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnetResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
