...
// AppStatus The status of a REST API call. Only used when there is a failure to report. 
...
func (o *AppStatus) UnmarshalJSON(data []byte) (err error) {
	varAppStatus := _AppStatus{}

	err = json.Unmarshal(data, &varAppStatus)

	if err != nil {
		return err
	}

	*o = AppStatus(varAppStatus)
