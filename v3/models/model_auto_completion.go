...
// checks if the AutoCompletion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoCompletion{}

// AutoCompletion Auto completion object definition.
type AutoCompletion struct {
	// Search type for the autocompletion. 
	SearchType *string `json:"search_type,omitempty"`
	// The complete query corresponding the the auto-completion.
	CompleteQuery *string `json:"complete_query,omitempty"`
	...
	// Enity type or focus for the autocompletion.
	EntityType *string `json:"entity_type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AutoCompletion AutoCompletion
...
// GetCompleteQuery returns the CompleteQuery field value if set, zero value otherwise.
func (o *AutoCompletion) GetCompleteQuery() string {
	if o == nil || IsNil(o.CompleteQuery) {
		var ret string
		return ret
	}
	return *o.CompleteQuery
}

// GetCompleteQueryOk returns a tuple with the CompleteQuery field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AutoCompletion) GetCompleteQueryOk() (*string, bool) {
	if o == nil || IsNil(o.CompleteQuery) {
		return nil, false
	}
	return o.CompleteQuery, true
}
...
// SetCompleteQuery gets a reference to the given string and assigns it to the CompleteQuery field.
...
func (o AutoCompletion) MarshalJSON() ([]byte, error) {
...
func (o AutoCompletion) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SearchType) {
		toSerialize["search_type"] = o.SearchType
	}
	if !IsNil(o.CompleteQuery) {
		toSerialize["complete_query"] = o.CompleteQuery
	}
...
func (o *AutoCompletion) UnmarshalJSON(data []byte) (err error) {
	varAutoCompletion := _AutoCompletion{}

	err = json.Unmarshal(data, &varAutoCompletion)

	if err != nil {
		return err
	}

	*o = AutoCompletion(varAutoCompletion)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "search_type")
		delete(additionalProperties, "complete_query")
...
type NullableAutoCompletion struct {
	value *AutoCompletion
	isSet bool
}

func (v NullableAutoCompletion) Get() *AutoCompletion {
	return v.value
}

func (v *NullableAutoCompletion) Set(val *AutoCompletion) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoCompletion) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoCompletion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoCompletion(val *AutoCompletion) *NullableAutoCompletion {
	return &NullableAutoCompletion{value: val, isSet: true}
}

func (v NullableAutoCompletion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoCompletion) UnmarshalJSON(src []byte) error {
	v.isSet = true
