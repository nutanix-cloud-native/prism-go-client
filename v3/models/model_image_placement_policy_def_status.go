...
// checks if the ImagePlacementPolicyDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyDefStatus{}

// ImagePlacementPolicyDefStatus Image placement policy status
type ImagePlacementPolicyDefStatus struct {
	// The state of the image placement policy.
	State *string `json:"state,omitempty"`
	// Any error messages for the image placement policy, if in an error state.
	MessageList []MessageResource `json:"message_list,omitempty"`
	// Image placement policy name.
	Name string `json:"name"`
	Resources ImagePlacementPolicyResourcesDefStatus `json:"resources"`
	// A description for image placement policy.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ImagePlacementPolicyDefStatus ImagePlacementPolicyDefStatus
...
func NewImagePlacementPolicyDefStatus(name string, resources ImagePlacementPolicyResourcesDefStatus) *ImagePlacementPolicyDefStatus {
	this := ImagePlacementPolicyDefStatus{}
	this.Name = name
...
func (o *ImagePlacementPolicyDefStatus) GetResources() ImagePlacementPolicyResourcesDefStatus {
	if o == nil {
		var ret ImagePlacementPolicyResourcesDefStatus
		return ret
	}
...
func (o ImagePlacementPolicyDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ImagePlacementPolicyDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varImagePlacementPolicyDefStatus := _ImagePlacementPolicyDefStatus{}

	err = json.Unmarshal(data, &varImagePlacementPolicyDefStatus)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyDefStatus(varImagePlacementPolicyDefStatus)
...
type NullableImagePlacementPolicyDefStatus struct {
	value *ImagePlacementPolicyDefStatus
	isSet bool
}

func (v NullableImagePlacementPolicyDefStatus) Get() *ImagePlacementPolicyDefStatus {
	return v.value
}

func (v *NullableImagePlacementPolicyDefStatus) Set(val *ImagePlacementPolicyDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyDefStatus(val *ImagePlacementPolicyDefStatus) *NullableImagePlacementPolicyDefStatus {
	return &NullableImagePlacementPolicyDefStatus{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
