...
// checks if the UnderlaySubnetMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnetMetadata{}

// UnderlaySubnetMetadata The underlay_subnet kind metadata
type UnderlaySubnetMetadata struct {
	...
	// Categories for the underlay_subnet. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the underlay_subnet. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// underlay_subnet name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UnderlaySubnetMetadata UnderlaySubnetMetadata
...
func (o *UnderlaySubnetMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *UnderlaySubnetMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *UnderlaySubnetMetadata) SetName(v string) {
	o.Name = &v
}

func (o UnderlaySubnetMetadata) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnetMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *UnderlaySubnetMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varUnderlaySubnetMetadata := _UnderlaySubnetMetadata{}

	err = json.Unmarshal(data, &varUnderlaySubnetMetadata)

	if err != nil {
		return err
	}

	*o = UnderlaySubnetMetadata(varUnderlaySubnetMetadata)
...
type NullableUnderlaySubnetMetadata struct {
	value *UnderlaySubnetMetadata
	isSet bool
}

func (v NullableUnderlaySubnetMetadata) Get() *UnderlaySubnetMetadata {
	return v.value
}

func (v *NullableUnderlaySubnetMetadata) Set(val *UnderlaySubnetMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnetMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnetMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnetMetadata(val *UnderlaySubnetMetadata) *NullableUnderlaySubnetMetadata {
	return &NullableUnderlaySubnetMetadata{value: val, isSet: true}
}

func (v NullableUnderlaySubnetMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnetMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
