...
// checks if the RoutingPolicyListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyListMetadata{}

// RoutingPolicyListMetadata All api calls that return a list will have this metadata block as input 
type RoutingPolicyListMetadata struct {
	// The kind name
...
type _RoutingPolicyListMetadata RoutingPolicyListMetadata
...
func NewRoutingPolicyListMetadata() *RoutingPolicyListMetadata {
	this := RoutingPolicyListMetadata{}
...
func (o RoutingPolicyListMetadata) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyListMetadata) UnmarshalJSON(data []byte) (err error) {
	varRoutingPolicyListMetadata := _RoutingPolicyListMetadata{}

	err = json.Unmarshal(data, &varRoutingPolicyListMetadata)

	if err != nil {
		return err
	}

	*o = RoutingPolicyListMetadata(varRoutingPolicyListMetadata)
...
type NullableRoutingPolicyListMetadata struct {
	value *RoutingPolicyListMetadata
	isSet bool
}

func (v NullableRoutingPolicyListMetadata) Get() *RoutingPolicyListMetadata {
	return v.value
}

func (v *NullableRoutingPolicyListMetadata) Set(val *RoutingPolicyListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyListMetadata(val *RoutingPolicyListMetadata) *NullableRoutingPolicyListMetadata {
	return &NullableRoutingPolicyListMetadata{value: val, isSet: true}
}

func (v NullableRoutingPolicyListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
