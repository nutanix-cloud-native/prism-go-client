...
// checks if the CloudTrustStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTrustStatus{}

// CloudTrustStatus The status of a REST API call. Only used when there is a failure to report. 
type CloudTrustStatus struct {
	// The kind name
...
type _CloudTrustStatus CloudTrustStatus
...
func (o CloudTrustStatus) MarshalJSON() ([]byte, error) {
...
func (o CloudTrustStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTrustStatus) UnmarshalJSON(data []byte) (err error) {
	varCloudTrustStatus := _CloudTrustStatus{}

	err = json.Unmarshal(data, &varCloudTrustStatus)

	if err != nil {
		return err
	}

	*o = CloudTrustStatus(varCloudTrustStatus)
...
type NullableCloudTrustStatus struct {
	value *CloudTrustStatus
	isSet bool
}

func (v NullableCloudTrustStatus) Get() *CloudTrustStatus {
	return v.value
}

func (v *NullableCloudTrustStatus) Set(val *CloudTrustStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTrustStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTrustStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTrustStatus(val *CloudTrustStatus) *NullableCloudTrustStatus {
	return &NullableCloudTrustStatus{value: val, isSet: true}
}

func (v NullableCloudTrustStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTrustStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
