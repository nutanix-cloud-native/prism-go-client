...
// checks if the RemoteConnectionToken type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionToken{}

// RemoteConnectionToken Token information for communicating with remote peer
type RemoteConnectionToken struct {
	// Access token
	AccessToken *string `json:"access_token,omitempty"`
	// Client Secret
	ClientSecret *string `json:"client_secret,omitempty"`
	// Refresh token endpoint
	RefreshTokenEndpoint *string `json:"refresh_token_endpoint,omitempty"`
	// Client Id
...
type _RemoteConnectionToken RemoteConnectionToken
...
// GetRefreshTokenEndpoint returns the RefreshTokenEndpoint field value if set, zero value otherwise.
func (o *RemoteConnectionToken) GetRefreshTokenEndpoint() string {
	if o == nil || IsNil(o.RefreshTokenEndpoint) {
		var ret string
		return ret
	}
...
// GetRefreshTokenEndpointOk returns a tuple with the RefreshTokenEndpoint field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RemoteConnectionToken) GetRefreshTokenEndpointOk() (*string, bool) {
	if o == nil || IsNil(o.RefreshTokenEndpoint) {
		return nil, false
	}
	return o.RefreshTokenEndpoint, true
}
...
// SetRefreshTokenEndpoint gets a reference to the given string and assigns it to the RefreshTokenEndpoint field.
func (o *RemoteConnectionToken) SetRefreshTokenEndpoint(v string) {
	o.RefreshTokenEndpoint = &v
}
...
func (o RemoteConnectionToken) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionToken) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RefreshTokenEndpoint) {
		toSerialize["refresh_token_endpoint"] = o.RefreshTokenEndpoint
	}
	if !IsNil(o.ClientId) {
...
func (o *RemoteConnectionToken) UnmarshalJSON(data []byte) (err error) {
	varRemoteConnectionToken := _RemoteConnectionToken{}

	err = json.Unmarshal(data, &varRemoteConnectionToken)

	if err != nil {
		return err
	}

	*o = RemoteConnectionToken(varRemoteConnectionToken)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "refresh_token_endpoint")
...
type NullableRemoteConnectionToken struct {
	value *RemoteConnectionToken
	isSet bool
}

func (v NullableRemoteConnectionToken) Get() *RemoteConnectionToken {
	return v.value
}

func (v *NullableRemoteConnectionToken) Set(val *RemoteConnectionToken) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionToken) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionToken) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionToken(val *RemoteConnectionToken) *NullableRemoteConnectionToken {
	return &NullableRemoteConnectionToken{value: val, isSet: true}
}

func (v NullableRemoteConnectionToken) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionToken) UnmarshalJSON(src []byte) error {
	v.isSet = true
