...
// checks if the AppProfileInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppProfileInput{}

// AppProfileInput App profile resources
type AppProfileInput struct {
	// 
	DeploymentCreateList []BlueprintDeploymentInput `json:"deployment_create_list,omitempty"`
	// 
...
type _AppProfileInput AppProfileInput
...
func (o *AppProfileInput) GetDeploymentCreateList() []BlueprintDeploymentInput {
	if o == nil || IsNil(o.DeploymentCreateList) {
		var ret []BlueprintDeploymentInput
		return ret
	}
...
// SetDeploymentCreateList gets a reference to the given []BlueprintDeploymentInput and assigns it to the DeploymentCreateList field.
...
func (o AppProfileInput) MarshalJSON() ([]byte, error) {
...
func (o AppProfileInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppProfileInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppProfileInput := _AppProfileInput{}

	err = json.Unmarshal(data, &varAppProfileInput)

	if err != nil {
		return err
	}

	*o = AppProfileInput(varAppProfileInput)
...
type NullableAppProfileInput struct {
	value *AppProfileInput
	isSet bool
}

func (v NullableAppProfileInput) Get() *AppProfileInput {
	return v.value
}

func (v *NullableAppProfileInput) Set(val *AppProfileInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppProfileInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppProfileInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppProfileInput(val *AppProfileInput) *NullableAppProfileInput {
	return &NullableAppProfileInput{value: val, isSet: true}
}

func (v NullableAppProfileInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppProfileInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
