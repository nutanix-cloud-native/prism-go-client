...
// checks if the AwsRegionDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRegionDefStatus{}

// AwsRegionDefStatus aws_region resources status
type AwsRegionDefStatus struct {
	State *string `json:"state,omitempty"`
	// aws_region name.
	Name *string `json:"name,omitempty"`
	Resources *AwsRegionResourcesDefStatus `json:"resources,omitempty"`
	// A description for aws_region.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsRegionDefStatus AwsRegionDefStatus
...
func (o *AwsRegionDefStatus) GetResources() AwsRegionResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret AwsRegionResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given AwsRegionResourcesDefStatus and assigns it to the Resources field.
...
func (o AwsRegionDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsRegionDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRegionDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsRegionDefStatus := _AwsRegionDefStatus{}

	err = json.Unmarshal(data, &varAwsRegionDefStatus)

	if err != nil {
		return err
	}

	*o = AwsRegionDefStatus(varAwsRegionDefStatus)
...
type NullableAwsRegionDefStatus struct {
	value *AwsRegionDefStatus
	isSet bool
}

func (v NullableAwsRegionDefStatus) Get() *AwsRegionDefStatus {
	return v.value
}

func (v *NullableAwsRegionDefStatus) Set(val *AwsRegionDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRegionDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRegionDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRegionDefStatus(val *AwsRegionDefStatus) *NullableAwsRegionDefStatus {
	return &NullableAwsRegionDefStatus{value: val, isSet: true}
}

func (v NullableAwsRegionDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRegionDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
