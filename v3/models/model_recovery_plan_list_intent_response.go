...
// checks if the RecoveryPlanListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanListIntentResponse{}

// RecoveryPlanListIntentResponse Response object for intentful operation of recovery_plans
type RecoveryPlanListIntentResponse struct {
	Entities []RecoveryPlanIntentResource `json:"entities,omitempty"`
...
type _RecoveryPlanListIntentResponse RecoveryPlanListIntentResponse
...
func NewRecoveryPlanListIntentResponse(apiVersion string, metadata RecoveryPlanListMetadataOutput) *RecoveryPlanListIntentResponse {
	this := RecoveryPlanListIntentResponse{}
...
func (o *RecoveryPlanListIntentResponse) GetEntities() []RecoveryPlanIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []RecoveryPlanIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []RecoveryPlanIntentResource and assigns it to the Entities field.
...
func (o *RecoveryPlanListIntentResponse) GetMetadata() RecoveryPlanListMetadataOutput {
	if o == nil {
		var ret RecoveryPlanListMetadataOutput
		return ret
	}
...
func (o RecoveryPlanListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanListIntentResponse := _RecoveryPlanListIntentResponse{}

	err = json.Unmarshal(data, &varRecoveryPlanListIntentResponse)

	if err != nil {
		return err
	}

	*o = RecoveryPlanListIntentResponse(varRecoveryPlanListIntentResponse)
...
type NullableRecoveryPlanListIntentResponse struct {
	value *RecoveryPlanListIntentResponse
	isSet bool
}

func (v NullableRecoveryPlanListIntentResponse) Get() *RecoveryPlanListIntentResponse {
	return v.value
}

func (v *NullableRecoveryPlanListIntentResponse) Set(val *RecoveryPlanListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanListIntentResponse(val *RecoveryPlanListIntentResponse) *NullableRecoveryPlanListIntentResponse {
	return &NullableRecoveryPlanListIntentResponse{value: val, isSet: true}
}

func (v NullableRecoveryPlanListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
