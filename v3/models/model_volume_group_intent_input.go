...
// checks if the VolumeGroupIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupIntentInput{}

// VolumeGroupIntentInput An intentful representation of a volume_group
type VolumeGroupIntentInput struct {
	Spec VolumeGroup `json:"spec"`
...
type _VolumeGroupIntentInput VolumeGroupIntentInput
...
func (o VolumeGroupIntentInput) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeGroupIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumeGroupIntentInput := _VolumeGroupIntentInput{}

	err = json.Unmarshal(data, &varVolumeGroupIntentInput)

	if err != nil {
		return err
	}

	*o = VolumeGroupIntentInput(varVolumeGroupIntentInput)
...
type NullableVolumeGroupIntentInput struct {
	value *VolumeGroupIntentInput
	isSet bool
}

func (v NullableVolumeGroupIntentInput) Get() *VolumeGroupIntentInput {
	return v.value
}

func (v *NullableVolumeGroupIntentInput) Set(val *VolumeGroupIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupIntentInput(val *VolumeGroupIntentInput) *NullableVolumeGroupIntentInput {
	return &NullableVolumeGroupIntentInput{value: val, isSet: true}
}

func (v NullableVolumeGroupIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
