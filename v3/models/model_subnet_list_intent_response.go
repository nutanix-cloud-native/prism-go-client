...
// checks if the SubnetListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubnetListIntentResponse{}

// SubnetListIntentResponse Response object for intentful operation of subnets
...
type _SubnetListIntentResponse SubnetListIntentResponse
...
// SetEntities gets a reference to the given []SubnetIntentResource and assigns it to the Entities field.
...
func (o *SubnetListIntentResponse) GetMetadata() SubnetListMetadataOutput {
	if o == nil {
		var ret SubnetListMetadataOutput
		return ret
	}
...
func (o SubnetListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o SubnetListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SubnetListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubnetListIntentResponse := _SubnetListIntentResponse{}

	err = json.Unmarshal(data, &varSubnetListIntentResponse)

	if err != nil {
		return err
	}

	*o = SubnetListIntentResponse(varSubnetListIntentResponse)
...
type NullableSubnetListIntentResponse struct {
	value *SubnetListIntentResponse
	isSet bool
}

func (v NullableSubnetListIntentResponse) Get() *SubnetListIntentResponse {
	return v.value
}

func (v *NullableSubnetListIntentResponse) Set(val *SubnetListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSubnetListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSubnetListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubnetListIntentResponse(val *SubnetListIntentResponse) *NullableSubnetListIntentResponse {
	return &NullableSubnetListIntentResponse{value: val, isSet: true}
}

func (v NullableSubnetListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubnetListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
