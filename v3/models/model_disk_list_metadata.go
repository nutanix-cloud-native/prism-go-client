...
// checks if the DiskListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskListMetadata{}

// DiskListMetadata All api calls that return a list will have this metadata block as input 
...
type _DiskListMetadata DiskListMetadata
...
func (o DiskListMetadata) MarshalJSON() ([]byte, error) {
...
func (o DiskListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DiskListMetadata) UnmarshalJSON(data []byte) (err error) {
	varDiskListMetadata := _DiskListMetadata{}

	err = json.Unmarshal(data, &varDiskListMetadata)

	if err != nil {
		return err
	}

	*o = DiskListMetadata(varDiskListMetadata)
...
type NullableDiskListMetadata struct {
	value *DiskListMetadata
	isSet bool
}

func (v NullableDiskListMetadata) Get() *DiskListMetadata {
	return v.value
}

func (v *NullableDiskListMetadata) Set(val *DiskListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskListMetadata(val *DiskListMetadata) *NullableDiskListMetadata {
	return &NullableDiskListMetadata{value: val, isSet: true}
}

func (v NullableDiskListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
