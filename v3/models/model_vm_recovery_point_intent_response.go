...
// checks if the VmRecoveryPointIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPointIntentResponse{}
...
type _VmRecoveryPointIntentResponse VmRecoveryPointIntentResponse
...
func NewVmRecoveryPointIntentResponse(apiVersion string, metadata VmRecoveryPointMetadata) *VmRecoveryPointIntentResponse {
	this := VmRecoveryPointIntentResponse{}
...
func (o VmRecoveryPointIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPointIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPointIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVmRecoveryPointIntentResponse := _VmRecoveryPointIntentResponse{}

	err = json.Unmarshal(data, &varVmRecoveryPointIntentResponse)

	if err != nil {
		return err
	}

	*o = VmRecoveryPointIntentResponse(varVmRecoveryPointIntentResponse)
...
type NullableVmRecoveryPointIntentResponse struct {
	value *VmRecoveryPointIntentResponse
	isSet bool
}

func (v NullableVmRecoveryPointIntentResponse) Get() *VmRecoveryPointIntentResponse {
	return v.value
}

func (v *NullableVmRecoveryPointIntentResponse) Set(val *VmRecoveryPointIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPointIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPointIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPointIntentResponse(val *VmRecoveryPointIntentResponse) *NullableVmRecoveryPointIntentResponse {
	return &NullableVmRecoveryPointIntentResponse{value: val, isSet: true}
}

func (v NullableVmRecoveryPointIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPointIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
