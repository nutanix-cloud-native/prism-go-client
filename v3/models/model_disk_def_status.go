...
// checks if the DiskDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskDefStatus{}

// DiskDefStatus Disk object.
type DiskDefStatus struct {
	...
	Resources DiskDefStatusResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _DiskDefStatus DiskDefStatus
...
func (o *DiskDefStatus) GetResources() DiskDefStatusResources {
	if o == nil {
		var ret DiskDefStatusResources
		return ret
	}
...
func (o DiskDefStatus) MarshalJSON() ([]byte, error) {
...
func (o DiskDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DiskDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varDiskDefStatus := _DiskDefStatus{}

	err = json.Unmarshal(data, &varDiskDefStatus)

	if err != nil {
		return err
	}

	*o = DiskDefStatus(varDiskDefStatus)
...
type NullableDiskDefStatus struct {
	value *DiskDefStatus
	isSet bool
}

func (v NullableDiskDefStatus) Get() *DiskDefStatus {
	return v.value
}

func (v *NullableDiskDefStatus) Set(val *DiskDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskDefStatus(val *DiskDefStatus) *NullableDiskDefStatus {
	return &NullableDiskDefStatus{value: val, isSet: true}
}

func (v NullableDiskDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
