...
// checks if the NetworkSecurityRuleReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleReference{}

// NetworkSecurityRuleReference The reference to a network_security_rule
type NetworkSecurityRuleReference struct {
	// The kind name
...
type _NetworkSecurityRuleReference NetworkSecurityRuleReference
...
func NewNetworkSecurityRuleReference(kind string, uUID string) *NetworkSecurityRuleReference {
	this := NetworkSecurityRuleReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o NetworkSecurityRuleReference) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleReference) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRuleReference) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkSecurityRuleReference := _NetworkSecurityRuleReference{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleReference)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleReference(varNetworkSecurityRuleReference)
...
type NullableNetworkSecurityRuleReference struct {
	value *NetworkSecurityRuleReference
	isSet bool
}

func (v NullableNetworkSecurityRuleReference) Get() *NetworkSecurityRuleReference {
	return v.value
}

func (v *NullableNetworkSecurityRuleReference) Set(val *NetworkSecurityRuleReference) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleReference) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleReference(val *NetworkSecurityRuleReference) *NullableNetworkSecurityRuleReference {
	return &NullableNetworkSecurityRuleReference{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
