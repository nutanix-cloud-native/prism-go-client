...
// checks if the IpfixExporterResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpfixExporterResources{}

// IpfixExporterResources IPFix exporter API resources definition
type IpfixExporterResources struct {
	// IP address of the IPFix collector
	CollectorIpAddress *string `json:"collector_ip_address,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// Network Protocol used by the IPFix collector
	CollectorProtocol *string `json:"collector_protocol,omitempty"`
	// Port of the IPFix collector
	CollectorPort *int32 `json:"collector_port,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _IpfixExporterResources IpfixExporterResources
...
// GetCollectorIpAddress returns the CollectorIpAddress field value if set, zero value otherwise.
func (o *IpfixExporterResources) GetCollectorIpAddress() string {
	if o == nil || IsNil(o.CollectorIpAddress) {
		var ret string
		return ret
	}
	return *o.CollectorIpAddress
}

// GetCollectorIpAddressOk returns a tuple with the CollectorIpAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpfixExporterResources) GetCollectorIpAddressOk() (*string, bool) {
	if o == nil || IsNil(o.CollectorIpAddress) {
		return nil, false
	}
	return o.CollectorIpAddress, true
}
...
// SetCollectorIpAddress gets a reference to the given string and assigns it to the CollectorIpAddress field.
func (o *IpfixExporterResources) SetCollectorIpAddress(v string) {
	o.CollectorIpAddress = &v
}

// GetCollectorProtocol returns the CollectorProtocol field value if set, zero value otherwise.
func (o *IpfixExporterResources) GetCollectorProtocol() string {
	if o == nil || IsNil(o.CollectorProtocol) {
		var ret string
		return ret
	}
	return *o.CollectorProtocol
}

// GetCollectorProtocolOk returns a tuple with the CollectorProtocol field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IpfixExporterResources) GetCollectorProtocolOk() (*string, bool) {
	if o == nil || IsNil(o.CollectorProtocol) {
		return nil, false
	}
	return o.CollectorProtocol, true
}
...
// SetCollectorProtocol gets a reference to the given string and assigns it to the CollectorProtocol field.
func (o *IpfixExporterResources) SetCollectorProtocol(v string) {
	o.CollectorProtocol = &v
}
...
func (o IpfixExporterResources) MarshalJSON() ([]byte, error) {
...
func (o IpfixExporterResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CollectorIpAddress) {
		toSerialize["collector_ip_address"] = o.CollectorIpAddress
	}
	if !IsNil(o.CollectorProtocol) {
		toSerialize["collector_protocol"] = o.CollectorProtocol
	}
	if !IsNil(o.CollectorPort) {
		toSerialize["collector_port"] = o.CollectorPort
	}
...
func (o *IpfixExporterResources) UnmarshalJSON(data []byte) (err error) {
	varIpfixExporterResources := _IpfixExporterResources{}

	err = json.Unmarshal(data, &varIpfixExporterResources)

	if err != nil {
		return err
	}

	*o = IpfixExporterResources(varIpfixExporterResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "collector_ip_address")
		delete(additionalProperties, "collector_protocol")
		delete(additionalProperties, "collector_port")
...
type NullableIpfixExporterResources struct {
	value *IpfixExporterResources
	isSet bool
}

func (v NullableIpfixExporterResources) Get() *IpfixExporterResources {
	return v.value
}

func (v *NullableIpfixExporterResources) Set(val *IpfixExporterResources) {
	v.value = val
	v.isSet = true
}

func (v NullableIpfixExporterResources) IsSet() bool {
	return v.isSet
}

func (v *NullableIpfixExporterResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpfixExporterResources(val *IpfixExporterResources) *NullableIpfixExporterResources {
	return &NullableIpfixExporterResources{value: val, isSet: true}
}

func (v NullableIpfixExporterResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpfixExporterResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
