...
// checks if the OauthClientList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthClientList{}
...
type _OauthClientList OauthClientList
...
func (o *OauthClientList) GetMetadata() OauthClientListMetadata {
	if o == nil {
		var ret OauthClientListMetadata
		return ret
	}
...
func (o OauthClientList) MarshalJSON() ([]byte, error) {
...
func (o OauthClientList) ToMap() (map[string]interface{}, error) {
...
func (o *OauthClientList) UnmarshalJSON(data []byte) (err error) {
	...
	varOauthClientList := _OauthClientList{}

	err = json.Unmarshal(data, &varOauthClientList)

	if err != nil {
		return err
	}

	*o = OauthClientList(varOauthClientList)
...
type NullableOauthClientList struct {
	value *OauthClientList
	isSet bool
}

func (v NullableOauthClientList) Get() *OauthClientList {
	return v.value
}

func (v *NullableOauthClientList) Set(val *OauthClientList) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthClientList) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthClientList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthClientList(val *OauthClientList) *NullableOauthClientList {
	return &NullableOauthClientList{value: val, isSet: true}
}

func (v NullableOauthClientList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthClientList) UnmarshalJSON(src []byte) error {
	v.isSet = true
