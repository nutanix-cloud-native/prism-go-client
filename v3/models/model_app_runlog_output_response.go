...
// checks if the AppRunlogOutputResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunlogOutputResponse{}

// AppRunlogOutputResponse Response containing the last 10 lines of output
type AppRunlogOutputResponse struct {
	Status AppRunlogOutputStatus `json:"status"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AppRunlogMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AppRunlogOutputResponse AppRunlogOutputResponse
...
func (o AppRunlogOutputResponse) MarshalJSON() ([]byte, error) {
...
func (o AppRunlogOutputResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunlogOutputResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRunlogOutputResponse := _AppRunlogOutputResponse{}

	err = json.Unmarshal(data, &varAppRunlogOutputResponse)

	if err != nil {
		return err
	}

	*o = AppRunlogOutputResponse(varAppRunlogOutputResponse)
...
type NullableAppRunlogOutputResponse struct {
	value *AppRunlogOutputResponse
	isSet bool
}

func (v NullableAppRunlogOutputResponse) Get() *AppRunlogOutputResponse {
	return v.value
}

func (v *NullableAppRunlogOutputResponse) Set(val *AppRunlogOutputResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunlogOutputResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunlogOutputResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunlogOutputResponse(val *AppRunlogOutputResponse) *NullableAppRunlogOutputResponse {
	return &NullableAppRunlogOutputResponse{value: val, isSet: true}
}

func (v NullableAppRunlogOutputResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunlogOutputResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
