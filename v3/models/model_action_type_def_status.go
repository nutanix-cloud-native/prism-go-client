...
// checks if the ActionTypeDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTypeDefStatus{}

// ActionTypeDefStatus Action type entity status definition
type ActionTypeDefStatus struct {
	// The state of the entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	Resources ActionType `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _ActionTypeDefStatus ActionTypeDefStatus
...
func (o ActionTypeDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ActionTypeDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTypeDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTypeDefStatus := _ActionTypeDefStatus{}

	err = json.Unmarshal(data, &varActionTypeDefStatus)

	if err != nil {
		return err
	}

	*o = ActionTypeDefStatus(varActionTypeDefStatus)
...
type NullableActionTypeDefStatus struct {
	value *ActionTypeDefStatus
	isSet bool
}

func (v NullableActionTypeDefStatus) Get() *ActionTypeDefStatus {
	return v.value
}

func (v *NullableActionTypeDefStatus) Set(val *ActionTypeDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTypeDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTypeDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTypeDefStatus(val *ActionTypeDefStatus) *NullableActionTypeDefStatus {
	return &NullableActionTypeDefStatus{value: val, isSet: true}
}

func (v NullableActionTypeDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTypeDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
