...
// checks if the NetworkDeviceListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDeviceListIntentResponse{}

// NetworkDeviceListIntentResponse Response object for intentful operation of network_devices
type NetworkDeviceListIntentResponse struct {
	Entities []NetworkDeviceIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata NetworkDeviceListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _NetworkDeviceListIntentResponse NetworkDeviceListIntentResponse
...
func NewNetworkDeviceListIntentResponse(apiVersion string, metadata NetworkDeviceListMetadataOutput) *NetworkDeviceListIntentResponse {
	this := NetworkDeviceListIntentResponse{}
...
func (o *NetworkDeviceListIntentResponse) GetEntities() []NetworkDeviceIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []NetworkDeviceIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []NetworkDeviceIntentResource and assigns it to the Entities field.
...
func (o *NetworkDeviceListIntentResponse) GetMetadata() NetworkDeviceListMetadataOutput {
	if o == nil {
		var ret NetworkDeviceListMetadataOutput
		return ret
	}
...
func (o NetworkDeviceListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o NetworkDeviceListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkDeviceListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkDeviceListIntentResponse := _NetworkDeviceListIntentResponse{}

	err = json.Unmarshal(data, &varNetworkDeviceListIntentResponse)

	if err != nil {
		return err
	}

	*o = NetworkDeviceListIntentResponse(varNetworkDeviceListIntentResponse)
...
type NullableNetworkDeviceListIntentResponse struct {
	value *NetworkDeviceListIntentResponse
	isSet bool
}

func (v NullableNetworkDeviceListIntentResponse) Get() *NetworkDeviceListIntentResponse {
	return v.value
}

func (v *NullableNetworkDeviceListIntentResponse) Set(val *NetworkDeviceListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDeviceListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDeviceListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDeviceListIntentResponse(val *NetworkDeviceListIntentResponse) *NullableNetworkDeviceListIntentResponse {
	return &NullableNetworkDeviceListIntentResponse{value: val, isSet: true}
}

func (v NullableNetworkDeviceListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDeviceListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
