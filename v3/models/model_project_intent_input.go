...
// checks if the ProjectIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectIntentInput{}

// ProjectIntentInput An intentful representation of a project
...
type _ProjectIntentInput ProjectIntentInput
...
func (o ProjectIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ProjectIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectIntentInput := _ProjectIntentInput{}

	err = json.Unmarshal(data, &varProjectIntentInput)

	if err != nil {
		return err
	}

	*o = ProjectIntentInput(varProjectIntentInput)
...
type NullableProjectIntentInput struct {
	value *ProjectIntentInput
	isSet bool
}

func (v NullableProjectIntentInput) Get() *ProjectIntentInput {
	return v.value
}

func (v *NullableProjectIntentInput) Set(val *ProjectIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectIntentInput(val *ProjectIntentInput) *NullableProjectIntentInput {
	return &NullableProjectIntentInput{value: val, isSet: true}
}

func (v NullableProjectIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
