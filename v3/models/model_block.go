...
// GetBlockSerialNumber returns the BlockSerialNumber field value if set, zero value otherwise.
func (o *Block) GetBlockSerialNumber() string {
	if o == nil || IsNil(o.BlockSerialNumber) {
		var ret string
		return ret
	}
	return *o.BlockSerialNumber
}

// GetBlockSerialNumberOk returns a tuple with the BlockSerialNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Block) GetBlockSerialNumberOk() (*string, bool) {
	if o == nil || IsNil(o.BlockSerialNumber) {
		return nil, false
	}
	return o.BlockSerialNumber, true
}
...
// SetBlockSerialNumber gets a reference to the given string and assigns it to the BlockSerialNumber field.
func (o *Block) SetBlockSerialNumber(v string) {
	o.BlockSerialNumber = &v
}
...
func (o Block) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BlockSerialNumber) {
		toSerialize["block_serial_number"] = o.BlockSerialNumber
	}
	if !IsNil(o.BlockModel) {
		toSerialize["block_model"] = o.BlockModel
	}
...
func (o *Block) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Block(varBlock)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "block_serial_number")
		delete(additionalProperties, "block_model")
