...
// checks if the ClusterCapability type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterCapability{}

// ClusterCapability Feature capability on a cluster.
type ClusterCapability struct {
	// list of any additional precheck for cluster capability
	PrecheckList []ClusterCapabilityPrecheck `json:"precheck_list,omitempty"`
	// If this cluster is capable for a feature.
	IsCapable *bool `json:"is_capable,omitempty"`
	// Name of the cluster.
	ClusterName *string `json:"cluster_name,omitempty"`
	// Type and version of hypervisors on the cluster.
	HypervisorList []HypervisorInfo `json:"hypervisor_list,omitempty"`
	...
	// AOS version of the cluster.
	AosVersion *string `json:"aos_version,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ClusterCapability ClusterCapability
...
// GetPrecheckList returns the PrecheckList field value if set, zero value otherwise.
func (o *ClusterCapability) GetPrecheckList() []ClusterCapabilityPrecheck {
	if o == nil || IsNil(o.PrecheckList) {
		var ret []ClusterCapabilityPrecheck
		return ret
	}
	return o.PrecheckList
}

// GetPrecheckListOk returns a tuple with the PrecheckList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterCapability) GetPrecheckListOk() ([]ClusterCapabilityPrecheck, bool) {
	if o == nil || IsNil(o.PrecheckList) {
		return nil, false
	}
	return o.PrecheckList, true
}
...
// SetPrecheckList gets a reference to the given []ClusterCapabilityPrecheck and assigns it to the PrecheckList field.
func (o *ClusterCapability) SetPrecheckList(v []ClusterCapabilityPrecheck) {
	o.PrecheckList = v
}

// GetIsCapable returns the IsCapable field value if set, zero value otherwise.
func (o *ClusterCapability) GetIsCapable() bool {
	if o == nil || IsNil(o.IsCapable) {
		var ret bool
		return ret
	}
	return *o.IsCapable
...
// GetIsCapableOk returns a tuple with the IsCapable field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterCapability) GetIsCapableOk() (*bool, bool) {
	if o == nil || IsNil(o.IsCapable) {
		return nil, false
	}
	return o.IsCapable, true
}
...
// SetIsCapable gets a reference to the given bool and assigns it to the IsCapable field.
...
// GetHypervisorList returns the HypervisorList field value if set, zero value otherwise.
func (o *ClusterCapability) GetHypervisorList() []HypervisorInfo {
	if o == nil || IsNil(o.HypervisorList) {
		var ret []HypervisorInfo
		return ret
	}
	return o.HypervisorList
}

// GetHypervisorListOk returns a tuple with the HypervisorList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterCapability) GetHypervisorListOk() ([]HypervisorInfo, bool) {
	if o == nil || IsNil(o.HypervisorList) {
		return nil, false
	}
	return o.HypervisorList, true
}
...
// SetHypervisorList gets a reference to the given []HypervisorInfo and assigns it to the HypervisorList field.
...
// GetAosVersion returns the AosVersion field value if set, zero value otherwise.
func (o *ClusterCapability) GetAosVersion() string {
	if o == nil || IsNil(o.AosVersion) {
		var ret string
		return ret
	}
	return *o.AosVersion
...
// GetAosVersionOk returns a tuple with the AosVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterCapability) GetAosVersionOk() (*string, bool) {
	if o == nil || IsNil(o.AosVersion) {
		return nil, false
	}
	return o.AosVersion, true
}
...
// SetAosVersion gets a reference to the given string and assigns it to the AosVersion field.
func (o *ClusterCapability) SetAosVersion(v string) {
	o.AosVersion = &v
}

func (o ClusterCapability) MarshalJSON() ([]byte, error) {
...
func (o ClusterCapability) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PrecheckList) {
		toSerialize["precheck_list"] = o.PrecheckList
	}
	if !IsNil(o.IsCapable) {
		toSerialize["is_capable"] = o.IsCapable
	}
	if !IsNil(o.ClusterName) {
		toSerialize["cluster_name"] = o.ClusterName
	}
	if !IsNil(o.HypervisorList) {
		toSerialize["hypervisor_list"] = o.HypervisorList
	}
	if !IsNil(o.ClusterUuid) {
		toSerialize["cluster_uuid"] = o.ClusterUuid
	}
	if !IsNil(o.AosVersion) {
		toSerialize["aos_version"] = o.AosVersion
	}
...
func (o *ClusterCapability) UnmarshalJSON(data []byte) (err error) {
	varClusterCapability := _ClusterCapability{}

	err = json.Unmarshal(data, &varClusterCapability)

	if err != nil {
		return err
	}

	*o = ClusterCapability(varClusterCapability)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "precheck_list")
		delete(additionalProperties, "is_capable")
		delete(additionalProperties, "cluster_name")
		delete(additionalProperties, "hypervisor_list")
		delete(additionalProperties, "cluster_uuid")
		delete(additionalProperties, "aos_version")
...
type NullableClusterCapability struct {
	value *ClusterCapability
	isSet bool
}

func (v NullableClusterCapability) Get() *ClusterCapability {
	return v.value
}

func (v *NullableClusterCapability) Set(val *ClusterCapability) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterCapability) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterCapability) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterCapability(val *ClusterCapability) *NullableClusterCapability {
	return &NullableClusterCapability{value: val, isSet: true}
}

func (v NullableClusterCapability) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterCapability) UnmarshalJSON(src []byte) error {
	v.isSet = true
