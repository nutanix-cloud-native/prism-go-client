...
// checks if the PlacementDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlacementDetail{}

// PlacementDetail Details of the cluster or the LTSS service where the entity need to be placed. 
type PlacementDetail struct {
	// IP of the cluster.
	ClusterIp *string `json:"cluster_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// DR network segmentation virtual IP of the cluster.
	ClusterDrNetworkSegmentedVip *string `json:"cluster_dr_network_segmented_vip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// Port of the cluster.
	ClusterPort *int32 `json:"cluster_port,omitempty"`
	ClusterReference *ClusterReference `json:"cluster_reference,omitempty"`
	LtssServiceDetails *LtssServiceInfo `json:"ltss_service_details,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PlacementDetail PlacementDetail
...
// GetClusterDrNetworkSegmentedVip returns the ClusterDrNetworkSegmentedVip field value if set, zero value otherwise.
func (o *PlacementDetail) GetClusterDrNetworkSegmentedVip() string {
	if o == nil || IsNil(o.ClusterDrNetworkSegmentedVip) {
		var ret string
		return ret
	}
	return *o.ClusterDrNetworkSegmentedVip
}

// GetClusterDrNetworkSegmentedVipOk returns a tuple with the ClusterDrNetworkSegmentedVip field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PlacementDetail) GetClusterDrNetworkSegmentedVipOk() (*string, bool) {
	if o == nil || IsNil(o.ClusterDrNetworkSegmentedVip) {
		return nil, false
	}
	return o.ClusterDrNetworkSegmentedVip, true
}
...
// SetClusterDrNetworkSegmentedVip gets a reference to the given string and assigns it to the ClusterDrNetworkSegmentedVip field.
func (o *PlacementDetail) SetClusterDrNetworkSegmentedVip(v string) {
	o.ClusterDrNetworkSegmentedVip = &v
}

// GetClusterPort returns the ClusterPort field value if set, zero value otherwise.
func (o *PlacementDetail) GetClusterPort() int32 {
	if o == nil || IsNil(o.ClusterPort) {
		var ret int32
		return ret
	}
...
// GetClusterPortOk returns a tuple with the ClusterPort field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PlacementDetail) GetClusterPortOk() (*int32, bool) {
	if o == nil || IsNil(o.ClusterPort) {
		return nil, false
	}
	return o.ClusterPort, true
}
...
// SetClusterPort gets a reference to the given int32 and assigns it to the ClusterPort field.
...
// GetLtssServiceDetails returns the LtssServiceDetails field value if set, zero value otherwise.
func (o *PlacementDetail) GetLtssServiceDetails() LtssServiceInfo {
	if o == nil || IsNil(o.LtssServiceDetails) {
		var ret LtssServiceInfo
		return ret
	}
	return *o.LtssServiceDetails
}

// GetLtssServiceDetailsOk returns a tuple with the LtssServiceDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PlacementDetail) GetLtssServiceDetailsOk() (*LtssServiceInfo, bool) {
	if o == nil || IsNil(o.LtssServiceDetails) {
		return nil, false
	}
	return o.LtssServiceDetails, true
}
...
// SetLtssServiceDetails gets a reference to the given LtssServiceInfo and assigns it to the LtssServiceDetails field.
func (o *PlacementDetail) SetLtssServiceDetails(v LtssServiceInfo) {
	o.LtssServiceDetails = &v
}

func (o PlacementDetail) MarshalJSON() ([]byte, error) {
...
func (o PlacementDetail) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ClusterIp) {
		toSerialize["cluster_ip"] = o.ClusterIp
	}
	if !IsNil(o.ClusterDrNetworkSegmentedVip) {
		toSerialize["cluster_dr_network_segmented_vip"] = o.ClusterDrNetworkSegmentedVip
	}
	if !IsNil(o.ClusterPort) {
		toSerialize["cluster_port"] = o.ClusterPort
	}
	if !IsNil(o.ClusterReference) {
		toSerialize["cluster_reference"] = o.ClusterReference
	}
	if !IsNil(o.LtssServiceDetails) {
		toSerialize["ltss_service_details"] = o.LtssServiceDetails
	}
...
func (o *PlacementDetail) UnmarshalJSON(data []byte) (err error) {
	varPlacementDetail := _PlacementDetail{}

	err = json.Unmarshal(data, &varPlacementDetail)

	if err != nil {
		return err
	}

	*o = PlacementDetail(varPlacementDetail)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "cluster_ip")
		delete(additionalProperties, "cluster_dr_network_segmented_vip")
		delete(additionalProperties, "cluster_port")
		delete(additionalProperties, "cluster_reference")
		delete(additionalProperties, "ltss_service_details")
...
type NullablePlacementDetail struct {
	value *PlacementDetail
	isSet bool
}

func (v NullablePlacementDetail) Get() *PlacementDetail {
	return v.value
}

func (v *NullablePlacementDetail) Set(val *PlacementDetail) {
	v.value = val
	v.isSet = true
}

func (v NullablePlacementDetail) IsSet() bool {
	return v.isSet
}

func (v *NullablePlacementDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlacementDetail(val *PlacementDetail) *NullablePlacementDetail {
	return &NullablePlacementDetail{value: val, isSet: true}
}

func (v NullablePlacementDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlacementDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
