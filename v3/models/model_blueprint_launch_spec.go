...
// checks if the BlueprintLaunchSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintLaunchSpec{}

// BlueprintLaunchSpec Spec for Blueprint launch.
type BlueprintLaunchSpec struct {
	// Application name by which the application need to be created.
	ApplicationName *string `json:"application_name,omitempty"`
	AppProfileReference *AppProfileReference `json:"app_profile_reference,omitempty"`
	// description for blueprint launch
	Description *string `json:"description,omitempty"`
	Resources *BlueprintResources `json:"resources,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _BlueprintLaunchSpec BlueprintLaunchSpec
...
// GetAppProfileReference returns the AppProfileReference field value if set, zero value otherwise.
func (o *BlueprintLaunchSpec) GetAppProfileReference() AppProfileReference {
	if o == nil || IsNil(o.AppProfileReference) {
		var ret AppProfileReference
		return ret
	}
	return *o.AppProfileReference
}

// GetAppProfileReferenceOk returns a tuple with the AppProfileReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintLaunchSpec) GetAppProfileReferenceOk() (*AppProfileReference, bool) {
	if o == nil || IsNil(o.AppProfileReference) {
		return nil, false
	}
	return o.AppProfileReference, true
}
...
// SetAppProfileReference gets a reference to the given AppProfileReference and assigns it to the AppProfileReference field.
func (o *BlueprintLaunchSpec) SetAppProfileReference(v AppProfileReference) {
	o.AppProfileReference = &v
}
...
// SetResources gets a reference to the given BlueprintResources and assigns it to the Resources field.
func (o *BlueprintLaunchSpec) SetResources(v BlueprintResources) {
	o.Resources = &v
}

func (o BlueprintLaunchSpec) MarshalJSON() ([]byte, error) {
...
func (o BlueprintLaunchSpec) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ApplicationName) {
		toSerialize["application_name"] = o.ApplicationName
	}
	if !IsNil(o.AppProfileReference) {
		toSerialize["app_profile_reference"] = o.AppProfileReference
	}
...
func (o *BlueprintLaunchSpec) UnmarshalJSON(data []byte) (err error) {
	varBlueprintLaunchSpec := _BlueprintLaunchSpec{}

	err = json.Unmarshal(data, &varBlueprintLaunchSpec)

	if err != nil {
		return err
	}

	*o = BlueprintLaunchSpec(varBlueprintLaunchSpec)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "application_name")
		delete(additionalProperties, "app_profile_reference")
...
type NullableBlueprintLaunchSpec struct {
	value *BlueprintLaunchSpec
	isSet bool
}

func (v NullableBlueprintLaunchSpec) Get() *BlueprintLaunchSpec {
	return v.value
}

func (v *NullableBlueprintLaunchSpec) Set(val *BlueprintLaunchSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintLaunchSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintLaunchSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintLaunchSpec(val *BlueprintLaunchSpec) *NullableBlueprintLaunchSpec {
	return &NullableBlueprintLaunchSpec{value: val, isSet: true}
}

func (v NullableBlueprintLaunchSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintLaunchSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
