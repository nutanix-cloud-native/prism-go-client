...
// checks if the NgtPolicyIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicyIntentResponse{}

// NgtPolicyIntentResponse Response object for intentful operations on a ngt_policy
type NgtPolicyIntentResponse struct {
	Status *NgtPolicyDefStatus `json:"status,omitempty"`
	Spec *NgtPolicy `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata NgtPolicyMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _NgtPolicyIntentResponse NgtPolicyIntentResponse
...
// SetStatus gets a reference to the given NgtPolicyDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given NgtPolicy and assigns it to the Spec field.
...
func (o NgtPolicyIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicyIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicyIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtPolicyIntentResponse := _NgtPolicyIntentResponse{}

	err = json.Unmarshal(data, &varNgtPolicyIntentResponse)

	if err != nil {
		return err
	}

	*o = NgtPolicyIntentResponse(varNgtPolicyIntentResponse)
...
type NullableNgtPolicyIntentResponse struct {
	value *NgtPolicyIntentResponse
	isSet bool
}

func (v NullableNgtPolicyIntentResponse) Get() *NgtPolicyIntentResponse {
	return v.value
}

func (v *NullableNgtPolicyIntentResponse) Set(val *NgtPolicyIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicyIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicyIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicyIntentResponse(val *NgtPolicyIntentResponse) *NullableNgtPolicyIntentResponse {
	return &NullableNgtPolicyIntentResponse{value: val, isSet: true}
}

func (v NullableNgtPolicyIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicyIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
