...
// checks if the AppProfileReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppProfileReference{}

// AppProfileReference The reference to a app_profile
...
type _AppProfileReference AppProfileReference
...
func (o AppProfileReference) MarshalJSON() ([]byte, error) {
...
func (o AppProfileReference) ToMap() (map[string]interface{}, error) {
...
func (o *AppProfileReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAppProfileReference := _AppProfileReference{}

	err = json.Unmarshal(data, &varAppProfileReference)

	if err != nil {
		return err
	}

	*o = AppProfileReference(varAppProfileReference)
...
type NullableAppProfileReference struct {
	value *AppProfileReference
	isSet bool
}

func (v NullableAppProfileReference) Get() *AppProfileReference {
	return v.value
}

func (v *NullableAppProfileReference) Set(val *AppProfileReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAppProfileReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAppProfileReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppProfileReference(val *AppProfileReference) *NullableAppProfileReference {
	return &NullableAppProfileReference{value: val, isSet: true}
}

func (v NullableAppProfileReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppProfileReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
