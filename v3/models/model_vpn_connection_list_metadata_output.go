...
// checks if the VpnConnectionListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionListMetadataOutput{}

// VpnConnectionListMetadataOutput All api calls that return a list will have this metadata block 
type VpnConnectionListMetadataOutput struct {
	// The kind name
...
type _VpnConnectionListMetadataOutput VpnConnectionListMetadataOutput
...
func NewVpnConnectionListMetadataOutput() *VpnConnectionListMetadataOutput {
	this := VpnConnectionListMetadataOutput{}
	var kind string = "vpn_connection"
	this.Kind = &kind
	return &this
}
...
func (o VpnConnectionListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnectionListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVpnConnectionListMetadataOutput := _VpnConnectionListMetadataOutput{}

	err = json.Unmarshal(data, &varVpnConnectionListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VpnConnectionListMetadataOutput(varVpnConnectionListMetadataOutput)
...
type NullableVpnConnectionListMetadataOutput struct {
	value *VpnConnectionListMetadataOutput
	isSet bool
}

func (v NullableVpnConnectionListMetadataOutput) Get() *VpnConnectionListMetadataOutput {
	return v.value
}

func (v *NullableVpnConnectionListMetadataOutput) Set(val *VpnConnectionListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionListMetadataOutput(val *VpnConnectionListMetadataOutput) *NullableVpnConnectionListMetadataOutput {
	return &NullableVpnConnectionListMetadataOutput{value: val, isSet: true}
}

func (v NullableVpnConnectionListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
