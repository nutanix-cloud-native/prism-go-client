...
// checks if the ProjectIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectIntentResource{}

// ProjectIntentResource Response object for intentful operations on a project
...
type _ProjectIntentResource ProjectIntentResource
...
// SetStatus gets a reference to the given ProjectDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Project and assigns it to the Spec field.
...
func (o ProjectIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ProjectIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectIntentResource := _ProjectIntentResource{}

	err = json.Unmarshal(data, &varProjectIntentResource)

	if err != nil {
		return err
	}

	*o = ProjectIntentResource(varProjectIntentResource)
...
type NullableProjectIntentResource struct {
	value *ProjectIntentResource
	isSet bool
}

func (v NullableProjectIntentResource) Get() *ProjectIntentResource {
	return v.value
}

func (v *NullableProjectIntentResource) Set(val *ProjectIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectIntentResource(val *ProjectIntentResource) *NullableProjectIntentResource {
	return &NullableProjectIntentResource{value: val, isSet: true}
}

func (v NullableProjectIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
