...
// checks if the NucalmServiceConfigInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NucalmServiceConfigInput{}

// NucalmServiceConfigInput Input body to configure NuCalm service.
type NucalmServiceConfigInput struct {
	// Flag indicating whether to enable Nutanix apps.
	EnableNutanixApps *bool `json:"enable_nutanix_apps,omitempty"`
	// The desired state of NuCalm service.
	State *string `json:"state,omitempty"`
	// Enable lite versions of service.
	EnableLite *bool `json:"enable_lite,omitempty"`
	// Flag indicating whether to do NuCalm enablement validation only. 
	PerformValidationOnly *bool `json:"perform_validation_only,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NucalmServiceConfigInput NucalmServiceConfigInput
...
// GetEnableNutanixApps returns the EnableNutanixApps field value if set, zero value otherwise.
func (o *NucalmServiceConfigInput) GetEnableNutanixApps() bool {
	if o == nil || IsNil(o.EnableNutanixApps) {
		var ret bool
		return ret
	}
	return *o.EnableNutanixApps
}

// GetEnableNutanixAppsOk returns a tuple with the EnableNutanixApps field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NucalmServiceConfigInput) GetEnableNutanixAppsOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableNutanixApps) {
		return nil, false
	}
	return o.EnableNutanixApps, true
}
...
// SetEnableNutanixApps gets a reference to the given bool and assigns it to the EnableNutanixApps field.
func (o *NucalmServiceConfigInput) SetEnableNutanixApps(v bool) {
	o.EnableNutanixApps = &v
}
...
// GetEnableLite returns the EnableLite field value if set, zero value otherwise.
func (o *NucalmServiceConfigInput) GetEnableLite() bool {
	if o == nil || IsNil(o.EnableLite) {
		var ret bool
		return ret
	}
	return *o.EnableLite
...
// GetEnableLiteOk returns a tuple with the EnableLite field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NucalmServiceConfigInput) GetEnableLiteOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableLite) {
		return nil, false
	}
	return o.EnableLite, true
}
...
// SetEnableLite gets a reference to the given bool and assigns it to the EnableLite field.
func (o *NucalmServiceConfigInput) SetEnableLite(v bool) {
	o.EnableLite = &v
}

// GetPerformValidationOnly returns the PerformValidationOnly field value if set, zero value otherwise.
func (o *NucalmServiceConfigInput) GetPerformValidationOnly() bool {
	if o == nil || IsNil(o.PerformValidationOnly) {
		var ret bool
		return ret
	}
	return *o.PerformValidationOnly
}

// GetPerformValidationOnlyOk returns a tuple with the PerformValidationOnly field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NucalmServiceConfigInput) GetPerformValidationOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.PerformValidationOnly) {
		return nil, false
	}
	return o.PerformValidationOnly, true
}
...
// SetPerformValidationOnly gets a reference to the given bool and assigns it to the PerformValidationOnly field.
func (o *NucalmServiceConfigInput) SetPerformValidationOnly(v bool) {
	o.PerformValidationOnly = &v
}

func (o NucalmServiceConfigInput) MarshalJSON() ([]byte, error) {
...
func (o NucalmServiceConfigInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.EnableNutanixApps) {
		toSerialize["enable_nutanix_apps"] = o.EnableNutanixApps
	}
	if !IsNil(o.State) {
		toSerialize["state"] = o.State
	}
	if !IsNil(o.EnableLite) {
		toSerialize["enable_lite"] = o.EnableLite
	}
	if !IsNil(o.PerformValidationOnly) {
		toSerialize["perform_validation_only"] = o.PerformValidationOnly
	}
...
func (o *NucalmServiceConfigInput) UnmarshalJSON(data []byte) (err error) {
	varNucalmServiceConfigInput := _NucalmServiceConfigInput{}

	err = json.Unmarshal(data, &varNucalmServiceConfigInput)

	if err != nil {
		return err
	}

	*o = NucalmServiceConfigInput(varNucalmServiceConfigInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "enable_nutanix_apps")
		delete(additionalProperties, "state")
		delete(additionalProperties, "enable_lite")
		delete(additionalProperties, "perform_validation_only")
...
type NullableNucalmServiceConfigInput struct {
	value *NucalmServiceConfigInput
	isSet bool
}

func (v NullableNucalmServiceConfigInput) Get() *NucalmServiceConfigInput {
	return v.value
}

func (v *NullableNucalmServiceConfigInput) Set(val *NucalmServiceConfigInput) {
	v.value = val
	v.isSet = true
}

func (v NullableNucalmServiceConfigInput) IsSet() bool {
	return v.isSet
}

func (v *NullableNucalmServiceConfigInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNucalmServiceConfigInput(val *NucalmServiceConfigInput) *NullableNucalmServiceConfigInput {
	return &NullableNucalmServiceConfigInput{value: val, isSet: true}
}

func (v NullableNucalmServiceConfigInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNucalmServiceConfigInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
