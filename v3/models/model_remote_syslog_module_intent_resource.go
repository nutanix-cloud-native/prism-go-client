...
// checks if the RemoteSyslogModuleIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogModuleIntentResource{}

// RemoteSyslogModuleIntentResource Response object for intentful operations on a remote_syslog_module
type RemoteSyslogModuleIntentResource struct {
	Status *RemoteSyslogModuleDefStatus `json:"status,omitempty"`
	Spec *RemoteSyslogModule `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata RemoteSyslogModuleMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RemoteSyslogModuleIntentResource RemoteSyslogModuleIntentResource
...
func NewRemoteSyslogModuleIntentResource(metadata RemoteSyslogModuleMetadata) *RemoteSyslogModuleIntentResource {
	this := RemoteSyslogModuleIntentResource{}
...
func (o *RemoteSyslogModuleIntentResource) GetStatus() RemoteSyslogModuleDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret RemoteSyslogModuleDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given RemoteSyslogModuleDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given RemoteSyslogModule and assigns it to the Spec field.
...
func (o *RemoteSyslogModuleIntentResource) GetMetadata() RemoteSyslogModuleMetadata {
	if o == nil {
		var ret RemoteSyslogModuleMetadata
		return ret
	}
...
func (o RemoteSyslogModuleIntentResource) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogModuleIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogModuleIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogModuleIntentResource := _RemoteSyslogModuleIntentResource{}

	err = json.Unmarshal(data, &varRemoteSyslogModuleIntentResource)

	if err != nil {
		return err
	}

	*o = RemoteSyslogModuleIntentResource(varRemoteSyslogModuleIntentResource)
...
type NullableRemoteSyslogModuleIntentResource struct {
	value *RemoteSyslogModuleIntentResource
	isSet bool
}

func (v NullableRemoteSyslogModuleIntentResource) Get() *RemoteSyslogModuleIntentResource {
	return v.value
}

func (v *NullableRemoteSyslogModuleIntentResource) Set(val *RemoteSyslogModuleIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogModuleIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogModuleIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogModuleIntentResource(val *RemoteSyslogModuleIntentResource) *NullableRemoteSyslogModuleIntentResource {
	return &NullableRemoteSyslogModuleIntentResource{value: val, isSet: true}
}

func (v NullableRemoteSyslogModuleIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogModuleIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
