...
// Filter A filter defines the selection criteria for entities. It consists of two lists of filter expressions. The filter expressions can be of two types, Scope or Entity. The expressions in both these lists are combined with a logical AND. 
type Filter struct {
	// A list of Entity filter expressions.
	EntityFilterExpressionList []EntityFilterExpression `json:"entity_filter_expression_list"`
	// A list of Scope filter expressions.
	ScopeFilterExpressionList []ScopeFilterExpression `json:"scope_filter_expression_list,omitempty"`
...
func NewFilter(entityFilterExpressionList []EntityFilterExpression) *Filter {
	this := Filter{}
	this.EntityFilterExpressionList = entityFilterExpressionList
	return &this
}
...
// GetEntityFilterExpressionList returns the EntityFilterExpressionList field value
func (o *Filter) GetEntityFilterExpressionList() []EntityFilterExpression {
	if o == nil {
		var ret []EntityFilterExpression
		return ret
	}

	return o.EntityFilterExpressionList
}

// GetEntityFilterExpressionListOk returns a tuple with the EntityFilterExpressionList field value
// and a boolean to check if the value has been set.
func (o *Filter) GetEntityFilterExpressionListOk() ([]EntityFilterExpression, bool) {
	if o == nil {
		return nil, false
	}
	return o.EntityFilterExpressionList, true
}

// SetEntityFilterExpressionList sets field value
func (o *Filter) SetEntityFilterExpressionList(v []EntityFilterExpression) {
	o.EntityFilterExpressionList = v
}

// GetScopeFilterExpressionList returns the ScopeFilterExpressionList field value if set, zero value otherwise.
func (o *Filter) GetScopeFilterExpressionList() []ScopeFilterExpression {
	if o == nil || IsNil(o.ScopeFilterExpressionList) {
		var ret []ScopeFilterExpression
		return ret
	}
	return o.ScopeFilterExpressionList
}

// GetScopeFilterExpressionListOk returns a tuple with the ScopeFilterExpressionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Filter) GetScopeFilterExpressionListOk() ([]ScopeFilterExpression, bool) {
	if o == nil || IsNil(o.ScopeFilterExpressionList) {
		return nil, false
	}
	return o.ScopeFilterExpressionList, true
}
...
// SetScopeFilterExpressionList gets a reference to the given []ScopeFilterExpression and assigns it to the ScopeFilterExpressionList field.
func (o *Filter) SetScopeFilterExpressionList(v []ScopeFilterExpression) {
	o.ScopeFilterExpressionList = v
}
...
func (o Filter) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["entity_filter_expression_list"] = o.EntityFilterExpressionList
	if !IsNil(o.ScopeFilterExpressionList) {
		toSerialize["scope_filter_expression_list"] = o.ScopeFilterExpressionList
	}
...
func (o *Filter) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Filter(varFilter)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "entity_filter_expression_list")
		delete(additionalProperties, "scope_filter_expression_list")
