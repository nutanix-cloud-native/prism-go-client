...
// checks if the PermissionIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionIntentInput{}

// PermissionIntentInput An intentful representation of a permission
type PermissionIntentInput struct {
	Spec Permission `json:"spec"`
...
type _PermissionIntentInput PermissionIntentInput
...
func (o PermissionIntentInput) MarshalJSON() ([]byte, error) {
...
func (o PermissionIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *PermissionIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varPermissionIntentInput := _PermissionIntentInput{}

	err = json.Unmarshal(data, &varPermissionIntentInput)

	if err != nil {
		return err
	}

	*o = PermissionIntentInput(varPermissionIntentInput)
...
type NullablePermissionIntentInput struct {
	value *PermissionIntentInput
	isSet bool
}

func (v NullablePermissionIntentInput) Get() *PermissionIntentInput {
	return v.value
}

func (v *NullablePermissionIntentInput) Set(val *PermissionIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionIntentInput(val *PermissionIntentInput) *NullablePermissionIntentInput {
	return &NullablePermissionIntentInput{value: val, isSet: true}
}

func (v NullablePermissionIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
