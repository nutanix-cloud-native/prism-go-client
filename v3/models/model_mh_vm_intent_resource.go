...
// checks if the MhVmIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmIntentResource{}

// MhVmIntentResource Response object for intentful operations on a mh_vm
type MhVmIntentResource struct {
	Status *MhVmDefStatus `json:"status,omitempty"`
	Spec *MhVm `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata MhVmMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _MhVmIntentResource MhVmIntentResource
...
// SetStatus gets a reference to the given MhVmDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given MhVm and assigns it to the Spec field.
...
func (o MhVmIntentResource) MarshalJSON() ([]byte, error) {
...
func (o MhVmIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varMhVmIntentResource := _MhVmIntentResource{}

	err = json.Unmarshal(data, &varMhVmIntentResource)

	if err != nil {
		return err
	}

	*o = MhVmIntentResource(varMhVmIntentResource)
...
type NullableMhVmIntentResource struct {
	value *MhVmIntentResource
	isSet bool
}

func (v NullableMhVmIntentResource) Get() *MhVmIntentResource {
	return v.value
}

func (v *NullableMhVmIntentResource) Set(val *MhVmIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmIntentResource(val *MhVmIntentResource) *NullableMhVmIntentResource {
	return &NullableMhVmIntentResource{value: val, isSet: true}
}

func (v NullableMhVmIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
