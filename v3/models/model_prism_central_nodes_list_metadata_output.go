...
// checks if the PrismCentralNodesListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismCentralNodesListMetadataOutput{}

// PrismCentralNodesListMetadataOutput All api calls that return a list will have this metadata block 
type PrismCentralNodesListMetadataOutput struct {
	// The kind name
...
type _PrismCentralNodesListMetadataOutput PrismCentralNodesListMetadataOutput
...
func NewPrismCentralNodesListMetadataOutput() *PrismCentralNodesListMetadataOutput {
	this := PrismCentralNodesListMetadataOutput{}
	var kind string = "prism_central_nodes"
	this.Kind = &kind
	return &this
}
...
func (o *PrismCentralNodesListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *PrismCentralNodesListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o PrismCentralNodesListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o PrismCentralNodesListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *PrismCentralNodesListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varPrismCentralNodesListMetadataOutput := _PrismCentralNodesListMetadataOutput{}

	err = json.Unmarshal(data, &varPrismCentralNodesListMetadataOutput)

	if err != nil {
		return err
	}

	*o = PrismCentralNodesListMetadataOutput(varPrismCentralNodesListMetadataOutput)
...
type NullablePrismCentralNodesListMetadataOutput struct {
	value *PrismCentralNodesListMetadataOutput
	isSet bool
}

func (v NullablePrismCentralNodesListMetadataOutput) Get() *PrismCentralNodesListMetadataOutput {
	return v.value
}

func (v *NullablePrismCentralNodesListMetadataOutput) Set(val *PrismCentralNodesListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismCentralNodesListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismCentralNodesListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismCentralNodesListMetadataOutput(val *PrismCentralNodesListMetadataOutput) *NullablePrismCentralNodesListMetadataOutput {
	return &NullablePrismCentralNodesListMetadataOutput{value: val, isSet: true}
}

func (v NullablePrismCentralNodesListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismCentralNodesListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
