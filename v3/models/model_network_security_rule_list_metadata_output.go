...
// checks if the NetworkSecurityRuleListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleListMetadataOutput{}

// NetworkSecurityRuleListMetadataOutput All api calls that return a list will have this metadata block 
type NetworkSecurityRuleListMetadataOutput struct {
	// The kind name
...
type _NetworkSecurityRuleListMetadataOutput NetworkSecurityRuleListMetadataOutput
...
func NewNetworkSecurityRuleListMetadataOutput() *NetworkSecurityRuleListMetadataOutput {
	this := NetworkSecurityRuleListMetadataOutput{}
	var kind string = "network_security_rule"
	this.Kind = &kind
	return &this
}
...
func (o *NetworkSecurityRuleListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *NetworkSecurityRuleListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o NetworkSecurityRuleListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRuleListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varNetworkSecurityRuleListMetadataOutput := _NetworkSecurityRuleListMetadataOutput{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleListMetadataOutput)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleListMetadataOutput(varNetworkSecurityRuleListMetadataOutput)
...
type NullableNetworkSecurityRuleListMetadataOutput struct {
	value *NetworkSecurityRuleListMetadataOutput
	isSet bool
}

func (v NullableNetworkSecurityRuleListMetadataOutput) Get() *NetworkSecurityRuleListMetadataOutput {
	return v.value
}

func (v *NullableNetworkSecurityRuleListMetadataOutput) Set(val *NetworkSecurityRuleListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleListMetadataOutput(val *NetworkSecurityRuleListMetadataOutput) *NullableNetworkSecurityRuleListMetadataOutput {
	return &NullableNetworkSecurityRuleListMetadataOutput{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
