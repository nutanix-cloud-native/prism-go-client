...
// checks if the ValueInfoMaximum type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValueInfoMaximum{}

// ValueInfoMaximum The maximum value (or the length, if the value data type is string). 
type ValueInfoMaximum struct {
	DoubleValue *float64 `json:"double_value,omitempty"`
	LongValue *int64 `json:"long_value,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ValueInfoMaximum ValueInfoMaximum
...
func (o ValueInfoMaximum) MarshalJSON() ([]byte, error) {
...
func (o ValueInfoMaximum) ToMap() (map[string]interface{}, error) {
...
func (o *ValueInfoMaximum) UnmarshalJSON(data []byte) (err error) {
	varValueInfoMaximum := _ValueInfoMaximum{}

	err = json.Unmarshal(data, &varValueInfoMaximum)

	if err != nil {
		return err
	}

	*o = ValueInfoMaximum(varValueInfoMaximum)
...
type NullableValueInfoMaximum struct {
	value *ValueInfoMaximum
	isSet bool
}

func (v NullableValueInfoMaximum) Get() *ValueInfoMaximum {
	return v.value
}

func (v *NullableValueInfoMaximum) Set(val *ValueInfoMaximum) {
	v.value = val
	v.isSet = true
}

func (v NullableValueInfoMaximum) IsSet() bool {
	return v.isSet
}

func (v *NullableValueInfoMaximum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValueInfoMaximum(val *ValueInfoMaximum) *NullableValueInfoMaximum {
	return &NullableValueInfoMaximum{value: val, isSet: true}
}

func (v NullableValueInfoMaximum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValueInfoMaximum) UnmarshalJSON(src []byte) error {
	v.isSet = true
