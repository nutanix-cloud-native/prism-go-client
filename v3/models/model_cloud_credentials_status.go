...
// checks if the CloudCredentialsStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCredentialsStatus{}

// CloudCredentialsStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _CloudCredentialsStatus CloudCredentialsStatus
...
func (o CloudCredentialsStatus) MarshalJSON() ([]byte, error) {
...
func (o CloudCredentialsStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CloudCredentialsStatus) UnmarshalJSON(data []byte) (err error) {
	varCloudCredentialsStatus := _CloudCredentialsStatus{}

	err = json.Unmarshal(data, &varCloudCredentialsStatus)

	if err != nil {
		return err
	}

	*o = CloudCredentialsStatus(varCloudCredentialsStatus)
...
type NullableCloudCredentialsStatus struct {
	value *CloudCredentialsStatus
	isSet bool
}

func (v NullableCloudCredentialsStatus) Get() *CloudCredentialsStatus {
	return v.value
}

func (v *NullableCloudCredentialsStatus) Set(val *CloudCredentialsStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCredentialsStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCredentialsStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCredentialsStatus(val *CloudCredentialsStatus) *NullableCloudCredentialsStatus {
	return &NullableCloudCredentialsStatus{value: val, isSet: true}
}

func (v NullableCloudCredentialsStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCredentialsStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
