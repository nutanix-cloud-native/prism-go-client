...
// PageMetadata Page metadata object defintion.
type PageMetadata struct {
	// Type of the entity represented in page.
	EntityType *string `json:"entity_type,omitempty"`
	// Target Id for the UI page.
	TargetId *string `json:"target_id,omitempty"`
	// Tab id of the page in UI.
	TargetTabId *string `json:"target_tab_id,omitempty"`
	// List of expressions required for page.
	Params []Expression `json:"params,omitempty"`
	// Query in simple text.
...
type _PageMetadata PageMetadata
...
// GetTargetTabId returns the TargetTabId field value if set, zero value otherwise.
func (o *PageMetadata) GetTargetTabId() string {
	if o == nil || IsNil(o.TargetTabId) {
		var ret string
		return ret
	}
	return *o.TargetTabId
}

// GetTargetTabIdOk returns a tuple with the TargetTabId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PageMetadata) GetTargetTabIdOk() (*string, bool) {
	if o == nil || IsNil(o.TargetTabId) {
		return nil, false
	}
	return o.TargetTabId, true
}
...
// SetTargetTabId gets a reference to the given string and assigns it to the TargetTabId field.
...
// SetParams gets a reference to the given []Expression and assigns it to the Params field.
...
func (o PageMetadata) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TargetTabId) {
		toSerialize["target_tab_id"] = o.TargetTabId
	}
	if !IsNil(o.Params) {
...
func (o *PageMetadata) UnmarshalJSON(data []byte) (err error) {
	varPageMetadata := _PageMetadata{}

	err = json.Unmarshal(data, &varPageMetadata)

	if err != nil {
		return err
	}

	*o = PageMetadata(varPageMetadata)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "target_tab_id")
