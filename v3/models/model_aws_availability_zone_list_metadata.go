...
// checks if the AwsAvailabilityZoneListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsAvailabilityZoneListMetadata{}

// AwsAvailabilityZoneListMetadata All api calls that return a list will have this metadata block as input 
type AwsAvailabilityZoneListMetadata struct {
	// The kind name
...
type _AwsAvailabilityZoneListMetadata AwsAvailabilityZoneListMetadata
...
func NewAwsAvailabilityZoneListMetadata() *AwsAvailabilityZoneListMetadata {
	this := AwsAvailabilityZoneListMetadata{}
...
func (o AwsAvailabilityZoneListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsAvailabilityZoneListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsAvailabilityZoneListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsAvailabilityZoneListMetadata := _AwsAvailabilityZoneListMetadata{}

	err = json.Unmarshal(data, &varAwsAvailabilityZoneListMetadata)

	if err != nil {
		return err
	}

	*o = AwsAvailabilityZoneListMetadata(varAwsAvailabilityZoneListMetadata)
...
type NullableAwsAvailabilityZoneListMetadata struct {
	value *AwsAvailabilityZoneListMetadata
	isSet bool
}

func (v NullableAwsAvailabilityZoneListMetadata) Get() *AwsAvailabilityZoneListMetadata {
	return v.value
}

func (v *NullableAwsAvailabilityZoneListMetadata) Set(val *AwsAvailabilityZoneListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsAvailabilityZoneListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsAvailabilityZoneListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsAvailabilityZoneListMetadata(val *AwsAvailabilityZoneListMetadata) *NullableAwsAvailabilityZoneListMetadata {
	return &NullableAwsAvailabilityZoneListMetadata{value: val, isSet: true}
}

func (v NullableAwsAvailabilityZoneListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsAvailabilityZoneListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
