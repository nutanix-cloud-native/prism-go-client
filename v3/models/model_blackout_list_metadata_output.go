...
// checks if the BlackoutListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackoutListMetadataOutput{}

// BlackoutListMetadataOutput All api calls that return a list will have this metadata block 
type BlackoutListMetadataOutput struct {
	// The kind name
...
type _BlackoutListMetadataOutput BlackoutListMetadataOutput
...
func NewBlackoutListMetadataOutput() *BlackoutListMetadataOutput {
	this := BlackoutListMetadataOutput{}
	var kind string = "blackout"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *BlackoutListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o BlackoutListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o BlackoutListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *BlackoutListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varBlackoutListMetadataOutput := _BlackoutListMetadataOutput{}

	err = json.Unmarshal(data, &varBlackoutListMetadataOutput)

	if err != nil {
		return err
	}

	*o = BlackoutListMetadataOutput(varBlackoutListMetadataOutput)
...
type NullableBlackoutListMetadataOutput struct {
	value *BlackoutListMetadataOutput
	isSet bool
}

func (v NullableBlackoutListMetadataOutput) Get() *BlackoutListMetadataOutput {
	return v.value
}

func (v *NullableBlackoutListMetadataOutput) Set(val *BlackoutListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableBlackoutListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableBlackoutListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlackoutListMetadataOutput(val *BlackoutListMetadataOutput) *NullableBlackoutListMetadataOutput {
	return &NullableBlackoutListMetadataOutput{value: val, isSet: true}
}

func (v NullableBlackoutListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlackoutListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
