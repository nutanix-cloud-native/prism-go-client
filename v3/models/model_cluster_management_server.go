...
// checks if the ClusterManagementServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterManagementServer{}

// ClusterManagementServer Cluster Management server information.
type ClusterManagementServer struct {
	...
	// Array of management server status: - 'REGISTERED': Indicates whether the server is registered with                 Nutanix or not. - 'IN_USE': Indicates whether any host is managed by this server or             not. 
	StatusList []string `json:"status_list,omitempty"`
	Type string `json:"type"`
	AdditionalProperties map[string]interface{}
}

type _ClusterManagementServer ClusterManagementServer
...
// SetStatusList gets a reference to the given []string and assigns it to the StatusList field.
...
func (o ClusterManagementServer) MarshalJSON() ([]byte, error) {
...
func (o ClusterManagementServer) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.StatusList) {
		toSerialize["status_list"] = o.StatusList
	}
...
func (o *ClusterManagementServer) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterManagementServer := _ClusterManagementServer{}

	err = json.Unmarshal(data, &varClusterManagementServer)

	if err != nil {
		return err
	}

	*o = ClusterManagementServer(varClusterManagementServer)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "ip")
		delete(additionalProperties, "drs_enabled")
		delete(additionalProperties, "status_list")
...
type NullableClusterManagementServer struct {
	value *ClusterManagementServer
	isSet bool
}

func (v NullableClusterManagementServer) Get() *ClusterManagementServer {
	return v.value
}

func (v *NullableClusterManagementServer) Set(val *ClusterManagementServer) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterManagementServer) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterManagementServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterManagementServer(val *ClusterManagementServer) *NullableClusterManagementServer {
	return &NullableClusterManagementServer{value: val, isSet: true}
}

func (v NullableClusterManagementServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterManagementServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
