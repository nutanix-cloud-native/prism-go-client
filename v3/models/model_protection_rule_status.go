...
// checks if the ProtectionRuleStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleStatus{}

// ProtectionRuleStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _ProtectionRuleStatus ProtectionRuleStatus
...
func (o ProtectionRuleStatus) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionRuleStatus) UnmarshalJSON(data []byte) (err error) {
	varProtectionRuleStatus := _ProtectionRuleStatus{}

	err = json.Unmarshal(data, &varProtectionRuleStatus)

	if err != nil {
		return err
	}

	*o = ProtectionRuleStatus(varProtectionRuleStatus)
...
type NullableProtectionRuleStatus struct {
	value *ProtectionRuleStatus
	isSet bool
}

func (v NullableProtectionRuleStatus) Get() *ProtectionRuleStatus {
	return v.value
}

func (v *NullableProtectionRuleStatus) Set(val *ProtectionRuleStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleStatus(val *ProtectionRuleStatus) *NullableProtectionRuleStatus {
	return &NullableProtectionRuleStatus{value: val, isSet: true}
}

func (v NullableProtectionRuleStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
