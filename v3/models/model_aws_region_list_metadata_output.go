...
// checks if the AwsRegionListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRegionListMetadataOutput{}

// AwsRegionListMetadataOutput All api calls that return a list will have this metadata block 
type AwsRegionListMetadataOutput struct {
	// The kind name
...
type _AwsRegionListMetadataOutput AwsRegionListMetadataOutput
...
func NewAwsRegionListMetadataOutput() *AwsRegionListMetadataOutput {
	this := AwsRegionListMetadataOutput{}
	var kind string = "aws_region"
	this.Kind = &kind
	return &this
}
...
func (o AwsRegionListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsRegionListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRegionListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsRegionListMetadataOutput := _AwsRegionListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsRegionListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsRegionListMetadataOutput(varAwsRegionListMetadataOutput)
...
type NullableAwsRegionListMetadataOutput struct {
	value *AwsRegionListMetadataOutput
	isSet bool
}

func (v NullableAwsRegionListMetadataOutput) Get() *AwsRegionListMetadataOutput {
	return v.value
}

func (v *NullableAwsRegionListMetadataOutput) Set(val *AwsRegionListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRegionListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRegionListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRegionListMetadataOutput(val *AwsRegionListMetadataOutput) *NullableAwsRegionListMetadataOutput {
	return &NullableAwsRegionListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsRegionListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRegionListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
