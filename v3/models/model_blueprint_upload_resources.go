...
// checks if the BlueprintUploadResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintUploadResources{}

// BlueprintUploadResources Resources for Blueprint.
type BlueprintUploadResources struct {
	// Data needed for clients.
	ClientAttrs map[string]interface{} `json:"client_attrs,omitempty"`
	// Service definitions for Blueprint.
	ServiceDefinitionList []AppServiceInputUpload `json:"service_definition_list,omitempty"`
	// Substrate definitions for Blueprint.
	SubstrateDefinitionList []AppSubstrateInputUpload `json:"substrate_definition_list,omitempty"`
	// Credential definitions for Blueprint.
	CredentialDefinitionList []AppCredentialInputUpload `json:"credential_definition_list,omitempty"`
	// Package definitions for Blueprint.
	PackageDefinitionList []AppPackageInputUpload `json:"package_definition_list,omitempty"`
	// App profile definitions for Blueprint.
	AppProfileList []AppProfileInputUpload `json:"app_profile_list,omitempty"`
	// Published service definitions for Blueprint.
	PublishedServiceDefinitionList []AppPublishedServiceInputUpload `json:"published_service_definition_list,omitempty"`
...
type _BlueprintUploadResources BlueprintUploadResources
...
// SetServiceDefinitionList gets a reference to the given []AppServiceInputUpload and assigns it to the ServiceDefinitionList field.
...
func (o *BlueprintUploadResources) GetSubstrateDefinitionList() []AppSubstrateInputUpload {
	if o == nil || IsNil(o.SubstrateDefinitionList) {
		var ret []AppSubstrateInputUpload
		return ret
	}
...
// SetSubstrateDefinitionList gets a reference to the given []AppSubstrateInputUpload and assigns it to the SubstrateDefinitionList field.
...
func (o *BlueprintUploadResources) GetCredentialDefinitionList() []AppCredentialInputUpload {
	if o == nil || IsNil(o.CredentialDefinitionList) {
		var ret []AppCredentialInputUpload
		return ret
	}
...
// SetCredentialDefinitionList gets a reference to the given []AppCredentialInputUpload and assigns it to the CredentialDefinitionList field.
...
// SetPackageDefinitionList gets a reference to the given []AppPackageInputUpload and assigns it to the PackageDefinitionList field.
...
// SetAppProfileList gets a reference to the given []AppProfileInputUpload and assigns it to the AppProfileList field.
...
func (o *BlueprintUploadResources) GetPublishedServiceDefinitionList() []AppPublishedServiceInputUpload {
	if o == nil || IsNil(o.PublishedServiceDefinitionList) {
		var ret []AppPublishedServiceInputUpload
		return ret
	}
...
// SetPublishedServiceDefinitionList gets a reference to the given []AppPublishedServiceInputUpload and assigns it to the PublishedServiceDefinitionList field.
...
func (o BlueprintUploadResources) MarshalJSON() ([]byte, error) {
...
func (o BlueprintUploadResources) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintUploadResources) UnmarshalJSON(data []byte) (err error) {
	varBlueprintUploadResources := _BlueprintUploadResources{}

	err = json.Unmarshal(data, &varBlueprintUploadResources)

	if err != nil {
		return err
	}

	*o = BlueprintUploadResources(varBlueprintUploadResources)
...
type NullableBlueprintUploadResources struct {
	value *BlueprintUploadResources
	isSet bool
}

func (v NullableBlueprintUploadResources) Get() *BlueprintUploadResources {
	return v.value
}

func (v *NullableBlueprintUploadResources) Set(val *BlueprintUploadResources) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintUploadResources) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintUploadResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintUploadResources(val *BlueprintUploadResources) *NullableBlueprintUploadResources {
	return &NullableBlueprintUploadResources{value: val, isSet: true}
}

func (v NullableBlueprintUploadResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintUploadResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
