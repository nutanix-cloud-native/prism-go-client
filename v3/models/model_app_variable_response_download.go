...
// checks if the AppVariableResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppVariableResponseDownload{}

// AppVariableResponseDownload Variable definition for application.
type AppVariableResponseDownload struct {
	// 
...
type _AppVariableResponseDownload AppVariableResponseDownload
...
func NewAppVariableResponseDownload(name string, messageList []MessageResource, state string) *AppVariableResponseDownload {
	this := AppVariableResponseDownload{}
	this.Name = name
...
// GetValType returns the ValType field value if set, zero value otherwise.
func (o *AppVariableResponseDownload) GetValType() string {
	if o == nil || IsNil(o.ValType) {
		var ret string
		return ret
	}
	return *o.ValType
...
// GetValTypeOk returns a tuple with the ValType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppVariableResponseDownload) GetValTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ValType) {
		return nil, false
	}
	return o.ValType, true
}
...
// SetValType gets a reference to the given string and assigns it to the ValType field.
...
func (o AppVariableResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o AppVariableResponseDownload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ValType) {
		toSerialize["val_type"] = o.ValType
	}
...
func (o *AppVariableResponseDownload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppVariableResponseDownload := _AppVariableResponseDownload{}

	err = json.Unmarshal(data, &varAppVariableResponseDownload)

	if err != nil {
		return err
	}

	*o = AppVariableResponseDownload(varAppVariableResponseDownload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "val_type")
...
type NullableAppVariableResponseDownload struct {
	value *AppVariableResponseDownload
	isSet bool
}

func (v NullableAppVariableResponseDownload) Get() *AppVariableResponseDownload {
	return v.value
}

func (v *NullableAppVariableResponseDownload) Set(val *AppVariableResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppVariableResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppVariableResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppVariableResponseDownload(val *AppVariableResponseDownload) *NullableAppVariableResponseDownload {
	return &NullableAppVariableResponseDownload{value: val, isSet: true}
}

func (v NullableAppVariableResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppVariableResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
