...
// checks if the RemoteConnectionCredential type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionCredential{}

// RemoteConnectionCredential Credentials to connect with remote endpoint
type RemoteConnectionCredential struct {
	// Type of credentials to use
	AuthType *string `json:"auth_type,omitempty"`
	// token to use with bearer authorization, must for BEARER auth_type 
	BearerToken *string `json:"bearer_token,omitempty"`
	BasicCredential *BasicCredential `json:"basic_credential,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RemoteConnectionCredential RemoteConnectionCredential
...
func NewRemoteConnectionCredential() *RemoteConnectionCredential {
	this := RemoteConnectionCredential{}
	return &this
}
...
// GetBasicCredential returns the BasicCredential field value if set, zero value otherwise.
func (o *RemoteConnectionCredential) GetBasicCredential() BasicCredential {
	if o == nil || IsNil(o.BasicCredential) {
		var ret BasicCredential
		return ret
	}
	return *o.BasicCredential
}

// GetBasicCredentialOk returns a tuple with the BasicCredential field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RemoteConnectionCredential) GetBasicCredentialOk() (*BasicCredential, bool) {
	if o == nil || IsNil(o.BasicCredential) {
		return nil, false
	}
	return o.BasicCredential, true
}
...
// SetBasicCredential gets a reference to the given BasicCredential and assigns it to the BasicCredential field.
func (o *RemoteConnectionCredential) SetBasicCredential(v BasicCredential) {
	o.BasicCredential = &v
}

func (o RemoteConnectionCredential) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionCredential) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BasicCredential) {
		toSerialize["basic_credential"] = o.BasicCredential
	}
...
func (o *RemoteConnectionCredential) UnmarshalJSON(data []byte) (err error) {
	varRemoteConnectionCredential := _RemoteConnectionCredential{}

	err = json.Unmarshal(data, &varRemoteConnectionCredential)

	if err != nil {
		return err
	}

	*o = RemoteConnectionCredential(varRemoteConnectionCredential)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "basic_credential")
...
type NullableRemoteConnectionCredential struct {
	value *RemoteConnectionCredential
	isSet bool
}

func (v NullableRemoteConnectionCredential) Get() *RemoteConnectionCredential {
	return v.value
}

func (v *NullableRemoteConnectionCredential) Set(val *RemoteConnectionCredential) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionCredential) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionCredential) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionCredential(val *RemoteConnectionCredential) *NullableRemoteConnectionCredential {
	return &NullableRemoteConnectionCredential{value: val, isSet: true}
}

func (v NullableRemoteConnectionCredential) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionCredential) UnmarshalJSON(src []byte) error {
	v.isSet = true
