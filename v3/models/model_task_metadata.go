...
// checks if the TaskMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskMetadata{}

// TaskMetadata The task kind metadata
type TaskMetadata struct {
	...
	// Categories for the task. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the task. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _TaskMetadata TaskMetadata
...
func (o *TaskMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *TaskMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o TaskMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *TaskMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskMetadata := _TaskMetadata{}

	err = json.Unmarshal(data, &varTaskMetadata)

	if err != nil {
		return err
	}

	*o = TaskMetadata(varTaskMetadata)
