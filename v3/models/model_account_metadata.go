...
// checks if the AccountMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountMetadata{}

// AccountMetadata The account kind metadata
type AccountMetadata struct {
	...
	// Categories for the account. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the account. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _AccountMetadata AccountMetadata
...
func (o AccountMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AccountMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountMetadata := _AccountMetadata{}

	err = json.Unmarshal(data, &varAccountMetadata)

	if err != nil {
		return err
	}

	*o = AccountMetadata(varAccountMetadata)
