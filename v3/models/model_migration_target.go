...
// checks if the MigrationTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MigrationTarget{}

// MigrationTarget A migration target is comprised of availability zone reference and optionally reference to any particular cluster within that availability zone. 
...
type _MigrationTarget MigrationTarget
...
func (o MigrationTarget) MarshalJSON() ([]byte, error) {
...
func (o MigrationTarget) ToMap() (map[string]interface{}, error) {
...
func (o *MigrationTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varMigrationTarget := _MigrationTarget{}

	err = json.Unmarshal(data, &varMigrationTarget)

	if err != nil {
		return err
	}

	*o = MigrationTarget(varMigrationTarget)
...
type NullableMigrationTarget struct {
	value *MigrationTarget
	isSet bool
}

func (v NullableMigrationTarget) Get() *MigrationTarget {
	return v.value
}

func (v *NullableMigrationTarget) Set(val *MigrationTarget) {
	v.value = val
	v.isSet = true
}

func (v NullableMigrationTarget) IsSet() bool {
	return v.isSet
}

func (v *NullableMigrationTarget) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMigrationTarget(val *MigrationTarget) *NullableMigrationTarget {
	return &NullableMigrationTarget{value: val, isSet: true}
}

func (v NullableMigrationTarget) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMigrationTarget) UnmarshalJSON(src []byte) error {
	v.isSet = true
