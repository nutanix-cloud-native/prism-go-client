...
// checks if the IdentityProviderDefStatusResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderDefStatusResources{}

// IdentityProviderDefStatusResources Urls and other info about the IDP.
type IdentityProviderDefStatusResources struct {
	...
	GroupsDelim *string `json:"groups_delim,omitempty"`
	IdpProperties *IdentityProviderDefStatusResourcesIdpProperties `json:"idp_properties,omitempty"`
...
type _IdentityProviderDefStatusResources IdentityProviderDefStatusResources
...
func NewIdentityProviderDefStatusResources() *IdentityProviderDefStatusResources {
	this := IdentityProviderDefStatusResources{}
	return &this
}
...
// GetGroupsDelim returns the GroupsDelim field value if set, zero value otherwise.
func (o *IdentityProviderDefStatusResources) GetGroupsDelim() string {
	if o == nil || IsNil(o.GroupsDelim) {
		var ret string
		return ret
	}
	return *o.GroupsDelim
}

// GetGroupsDelimOk returns a tuple with the GroupsDelim field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdentityProviderDefStatusResources) GetGroupsDelimOk() (*string, bool) {
	if o == nil || IsNil(o.GroupsDelim) {
		return nil, false
	}
	return o.GroupsDelim, true
}
...
// SetGroupsDelim gets a reference to the given string and assigns it to the GroupsDelim field.
func (o *IdentityProviderDefStatusResources) SetGroupsDelim(v string) {
	o.GroupsDelim = &v
}

// GetIdpProperties returns the IdpProperties field value if set, zero value otherwise.
func (o *IdentityProviderDefStatusResources) GetIdpProperties() IdentityProviderDefStatusResourcesIdpProperties {
	if o == nil || IsNil(o.IdpProperties) {
		var ret IdentityProviderDefStatusResourcesIdpProperties
		return ret
	}
...
// SetIdpProperties gets a reference to the given IdentityProviderDefStatusResourcesIdpProperties and assigns it to the IdpProperties field.
...
// GetGroupsAttr returns the GroupsAttr field value if set, zero value otherwise.
func (o *IdentityProviderDefStatusResources) GetGroupsAttr() string {
	if o == nil || IsNil(o.GroupsAttr) {
		var ret string
		return ret
	}
	return *o.GroupsAttr
...
// GetGroupsAttrOk returns a tuple with the GroupsAttr field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdentityProviderDefStatusResources) GetGroupsAttrOk() (*string, bool) {
	if o == nil || IsNil(o.GroupsAttr) {
		return nil, false
	}
	return o.GroupsAttr, true
}
...
// SetGroupsAttr gets a reference to the given string and assigns it to the GroupsAttr field.
func (o *IdentityProviderDefStatusResources) SetGroupsAttr(v string) {
	o.GroupsAttr = &v
}

func (o IdentityProviderDefStatusResources) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderDefStatusResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.GroupsDelim) {
		toSerialize["groups_delim"] = o.GroupsDelim
	}
	if !IsNil(o.IdpProperties) {
		toSerialize["idp_properties"] = o.IdpProperties
	}
	if !IsNil(o.IdpMetadata) {
		toSerialize["idp_metadata"] = o.IdpMetadata
	}
	if !IsNil(o.GroupsAttr) {
		toSerialize["groups_attr"] = o.GroupsAttr
	}
...
func (o *IdentityProviderDefStatusResources) UnmarshalJSON(data []byte) (err error) {
	varIdentityProviderDefStatusResources := _IdentityProviderDefStatusResources{}

	err = json.Unmarshal(data, &varIdentityProviderDefStatusResources)

	if err != nil {
		return err
	}

	*o = IdentityProviderDefStatusResources(varIdentityProviderDefStatusResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "groups_delim")
		delete(additionalProperties, "idp_properties")
		delete(additionalProperties, "idp_metadata")
		delete(additionalProperties, "groups_attr")
...
type NullableIdentityProviderDefStatusResources struct {
	value *IdentityProviderDefStatusResources
	isSet bool
}

func (v NullableIdentityProviderDefStatusResources) Get() *IdentityProviderDefStatusResources {
	return v.value
}

func (v *NullableIdentityProviderDefStatusResources) Set(val *IdentityProviderDefStatusResources) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderDefStatusResources) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderDefStatusResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderDefStatusResources(val *IdentityProviderDefStatusResources) *NullableIdentityProviderDefStatusResources {
	return &NullableIdentityProviderDefStatusResources{value: val, isSet: true}
}

func (v NullableIdentityProviderDefStatusResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderDefStatusResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
