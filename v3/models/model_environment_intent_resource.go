...
// checks if the EnvironmentIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentIntentResource{}

// EnvironmentIntentResource Response object for intentful operations on a environment
type EnvironmentIntentResource struct {
...
type _EnvironmentIntentResource EnvironmentIntentResource
...
func NewEnvironmentIntentResource(metadata EnvironmentMetadata) *EnvironmentIntentResource {
	this := EnvironmentIntentResource{}
...
func (o EnvironmentIntentResource) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *EnvironmentIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvironmentIntentResource := _EnvironmentIntentResource{}

	err = json.Unmarshal(data, &varEnvironmentIntentResource)

	if err != nil {
		return err
	}

	*o = EnvironmentIntentResource(varEnvironmentIntentResource)
...
type NullableEnvironmentIntentResource struct {
	value *EnvironmentIntentResource
	isSet bool
}

func (v NullableEnvironmentIntentResource) Get() *EnvironmentIntentResource {
	return v.value
}

func (v *NullableEnvironmentIntentResource) Set(val *EnvironmentIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentIntentResource(val *EnvironmentIntentResource) *NullableEnvironmentIntentResource {
	return &NullableEnvironmentIntentResource{value: val, isSet: true}
}

func (v NullableEnvironmentIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
