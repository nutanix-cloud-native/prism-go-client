...
// checks if the PermissionListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionListMetadataOutput{}

// PermissionListMetadataOutput All api calls that return a list will have this metadata block 
...
type _PermissionListMetadataOutput PermissionListMetadataOutput
...
func NewPermissionListMetadataOutput() *PermissionListMetadataOutput {
	this := PermissionListMetadataOutput{}
	var kind string = "permission"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *PermissionListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o PermissionListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o PermissionListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *PermissionListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varPermissionListMetadataOutput := _PermissionListMetadataOutput{}

	err = json.Unmarshal(data, &varPermissionListMetadataOutput)

	if err != nil {
		return err
	}

	*o = PermissionListMetadataOutput(varPermissionListMetadataOutput)
...
type NullablePermissionListMetadataOutput struct {
	value *PermissionListMetadataOutput
	isSet bool
}

func (v NullablePermissionListMetadataOutput) Get() *PermissionListMetadataOutput {
	return v.value
}

func (v *NullablePermissionListMetadataOutput) Set(val *PermissionListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionListMetadataOutput(val *PermissionListMetadataOutput) *NullablePermissionListMetadataOutput {
	return &NullablePermissionListMetadataOutput{value: val, isSet: true}
}

func (v NullablePermissionListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
