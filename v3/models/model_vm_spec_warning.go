...
// checks if the VmSpecWarning type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmSpecWarning{}

// VmSpecWarning Warning message for an attribute in VM spec whose value is either not present in OVA or not supported by AHV. 
type VmSpecWarning struct {
	// Warning message for the corresponding key.
	Message *string `json:"message,omitempty"`
	// Possible values for the key.
	PossibleValues []string `json:"possible_values,omitempty"`
	// Attribute of VM spec for which a warning is generated.
	Key *string `json:"key,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VmSpecWarning VmSpecWarning
...
func (o VmSpecWarning) MarshalJSON() ([]byte, error) {
...
func (o VmSpecWarning) ToMap() (map[string]interface{}, error) {
...
func (o *VmSpecWarning) UnmarshalJSON(data []byte) (err error) {
	varVmSpecWarning := _VmSpecWarning{}

	err = json.Unmarshal(data, &varVmSpecWarning)

	if err != nil {
		return err
	}

	*o = VmSpecWarning(varVmSpecWarning)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "message")
		delete(additionalProperties, "possible_values")
...
type NullableVmSpecWarning struct {
	value *VmSpecWarning
	isSet bool
}

func (v NullableVmSpecWarning) Get() *VmSpecWarning {
	return v.value
}

func (v *NullableVmSpecWarning) Set(val *VmSpecWarning) {
	v.value = val
	v.isSet = true
}

func (v NullableVmSpecWarning) IsSet() bool {
	return v.isSet
}

func (v *NullableVmSpecWarning) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmSpecWarning(val *VmSpecWarning) *NullableVmSpecWarning {
	return &NullableVmSpecWarning{value: val, isSet: true}
}

func (v NullableVmSpecWarning) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmSpecWarning) UnmarshalJSON(src []byte) error {
	v.isSet = true
