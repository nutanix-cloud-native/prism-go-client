...
// checks if the SshUserReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserReference{}

// SshUserReference The reference to a ssh_user
type SshUserReference struct {
	// The kind name
...
type _SshUserReference SshUserReference
...
func (o SshUserReference) MarshalJSON() ([]byte, error) {
...
func (o SshUserReference) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserReference) UnmarshalJSON(data []byte) (err error) {
	...
	varSshUserReference := _SshUserReference{}

	err = json.Unmarshal(data, &varSshUserReference)

	if err != nil {
		return err
	}

	*o = SshUserReference(varSshUserReference)
...
type NullableSshUserReference struct {
	value *SshUserReference
	isSet bool
}

func (v NullableSshUserReference) Get() *SshUserReference {
	return v.value
}

func (v *NullableSshUserReference) Set(val *SshUserReference) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserReference) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserReference(val *SshUserReference) *NullableSshUserReference {
	return &NullableSshUserReference{value: val, isSet: true}
}

func (v NullableSshUserReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
