...
// checks if the ProjectInternalAccessControlPolicyListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectInternalAccessControlPolicyListInner{}

// ProjectInternalAccessControlPolicyListInner struct for ProjectInternalAccessControlPolicyListInner
type ProjectInternalAccessControlPolicyListInner struct {
	// Indicates the action(add, delete, update)
	Operation string `json:"operation"`
	Acp AccessControlPolicyInput `json:"acp"`
	Metadata ProjectInternalAccessControlPolicyListInnerMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ProjectInternalAccessControlPolicyListInner ProjectInternalAccessControlPolicyListInner
...
func NewProjectInternalAccessControlPolicyListInner(operation string, acp AccessControlPolicyInput, metadata ProjectInternalAccessControlPolicyListInnerMetadata) *ProjectInternalAccessControlPolicyListInner {
	this := ProjectInternalAccessControlPolicyListInner{}
...
func (o *ProjectInternalAccessControlPolicyListInner) GetAcp() AccessControlPolicyInput {
	if o == nil {
		var ret AccessControlPolicyInput
		return ret
	}
...
func (o *ProjectInternalAccessControlPolicyListInner) GetMetadata() ProjectInternalAccessControlPolicyListInnerMetadata {
	if o == nil {
		var ret ProjectInternalAccessControlPolicyListInnerMetadata
		return ret
	}
...
func (o ProjectInternalAccessControlPolicyListInner) MarshalJSON() ([]byte, error) {
...
func (o ProjectInternalAccessControlPolicyListInner) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectInternalAccessControlPolicyListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectInternalAccessControlPolicyListInner := _ProjectInternalAccessControlPolicyListInner{}

	err = json.Unmarshal(data, &varProjectInternalAccessControlPolicyListInner)

	if err != nil {
		return err
	}

	*o = ProjectInternalAccessControlPolicyListInner(varProjectInternalAccessControlPolicyListInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "operation")
		delete(additionalProperties, "acp")
...
type NullableProjectInternalAccessControlPolicyListInner struct {
	value *ProjectInternalAccessControlPolicyListInner
	isSet bool
}

func (v NullableProjectInternalAccessControlPolicyListInner) Get() *ProjectInternalAccessControlPolicyListInner {
	return v.value
}

func (v *NullableProjectInternalAccessControlPolicyListInner) Set(val *ProjectInternalAccessControlPolicyListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectInternalAccessControlPolicyListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectInternalAccessControlPolicyListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectInternalAccessControlPolicyListInner(val *ProjectInternalAccessControlPolicyListInner) *NullableProjectInternalAccessControlPolicyListInner {
	return &NullableProjectInternalAccessControlPolicyListInner{value: val, isSet: true}
}

func (v NullableProjectInternalAccessControlPolicyListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectInternalAccessControlPolicyListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
