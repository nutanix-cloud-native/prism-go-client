...
// checks if the NetworkFunctionChainReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionChainReference{}

// NetworkFunctionChainReference The reference to a network_function_chain
...
type _NetworkFunctionChainReference NetworkFunctionChainReference
...
func NewNetworkFunctionChainReference(kind string, uUID string) *NetworkFunctionChainReference {
	this := NetworkFunctionChainReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o NetworkFunctionChainReference) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionChainReference) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionChainReference) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkFunctionChainReference := _NetworkFunctionChainReference{}

	err = json.Unmarshal(data, &varNetworkFunctionChainReference)

	if err != nil {
		return err
	}

	*o = NetworkFunctionChainReference(varNetworkFunctionChainReference)
...
type NullableNetworkFunctionChainReference struct {
	value *NetworkFunctionChainReference
	isSet bool
}

func (v NullableNetworkFunctionChainReference) Get() *NetworkFunctionChainReference {
	return v.value
}

func (v *NullableNetworkFunctionChainReference) Set(val *NetworkFunctionChainReference) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionChainReference) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionChainReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionChainReference(val *NetworkFunctionChainReference) *NullableNetworkFunctionChainReference {
	return &NullableNetworkFunctionChainReference{value: val, isSet: true}
}

func (v NullableNetworkFunctionChainReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionChainReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
