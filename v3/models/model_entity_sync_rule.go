...
// checks if the EntitySyncRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySyncRule{}

// EntitySyncRule Entity sync rule creation/modification spec.
...
type _EntitySyncRule EntitySyncRule
...
func (o EntitySyncRule) MarshalJSON() ([]byte, error) {
...
func (o EntitySyncRule) ToMap() (map[string]interface{}, error) {
...
func (o *EntitySyncRule) UnmarshalJSON(data []byte) (err error) {
	...
	varEntitySyncRule := _EntitySyncRule{}

	err = json.Unmarshal(data, &varEntitySyncRule)

	if err != nil {
		return err
	}

	*o = EntitySyncRule(varEntitySyncRule)
...
type NullableEntitySyncRule struct {
	value *EntitySyncRule
	isSet bool
}

func (v NullableEntitySyncRule) Get() *EntitySyncRule {
	return v.value
}

func (v *NullableEntitySyncRule) Set(val *EntitySyncRule) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySyncRule) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySyncRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySyncRule(val *EntitySyncRule) *NullableEntitySyncRule {
	return &NullableEntitySyncRule{value: val, isSet: true}
}

func (v NullableEntitySyncRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySyncRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
