...
// checks if the BlueprintListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintListMetadataOutput{}

// BlueprintListMetadataOutput All api calls that return a list will have this metadata block 
type BlueprintListMetadataOutput struct {
	// The kind name
...
type _BlueprintListMetadataOutput BlueprintListMetadataOutput
...
func NewBlueprintListMetadataOutput() *BlueprintListMetadataOutput {
	this := BlueprintListMetadataOutput{}
...
// and a boolean to check if the value has been set.
func (o *BlueprintListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o BlueprintListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o BlueprintListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varBlueprintListMetadataOutput := _BlueprintListMetadataOutput{}

	err = json.Unmarshal(data, &varBlueprintListMetadataOutput)

	if err != nil {
		return err
	}

	*o = BlueprintListMetadataOutput(varBlueprintListMetadataOutput)
...
type NullableBlueprintListMetadataOutput struct {
	value *BlueprintListMetadataOutput
	isSet bool
}

func (v NullableBlueprintListMetadataOutput) Get() *BlueprintListMetadataOutput {
	return v.value
}

func (v *NullableBlueprintListMetadataOutput) Set(val *BlueprintListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintListMetadataOutput(val *BlueprintListMetadataOutput) *NullableBlueprintListMetadataOutput {
	return &NullableBlueprintListMetadataOutput{value: val, isSet: true}
}

func (v NullableBlueprintListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
