...
// checks if the NgtReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtReference{}

// NgtReference The reference to a ngt
type NgtReference struct {
	// The kind name
...
type _NgtReference NgtReference
...
func (o NgtReference) MarshalJSON() ([]byte, error) {
...
func (o NgtReference) ToMap() (map[string]interface{}, error) {
...
func (o *NgtReference) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtReference := _NgtReference{}

	err = json.Unmarshal(data, &varNgtReference)

	if err != nil {
		return err
	}

	*o = NgtReference(varNgtReference)
...
type NullableNgtReference struct {
	value *NgtReference
	isSet bool
}

func (v NullableNgtReference) Get() *NgtReference {
	return v.value
}

func (v *NullableNgtReference) Set(val *NgtReference) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtReference) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtReference(val *NgtReference) *NullableNgtReference {
	return &NullableNgtReference{value: val, isSet: true}
}

func (v NullableNgtReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
