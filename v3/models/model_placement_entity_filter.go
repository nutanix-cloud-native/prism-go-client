...
// checks if the PlacementEntityFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlacementEntityFilter{}

// PlacementEntityFilter Image placement policy filter. Specify the filter match type and categories 
type PlacementEntityFilter struct {
...
type _PlacementEntityFilter PlacementEntityFilter
...
func NewPlacementEntityFilterWithDefaults() *PlacementEntityFilter {
	this := PlacementEntityFilter{}
	var type_ string = "CATEGORIES_MATCH_ANY"
	this.Type = type_
	return &this
}
...
func (o PlacementEntityFilter) MarshalJSON() ([]byte, error) {
...
func (o PlacementEntityFilter) ToMap() (map[string]interface{}, error) {
...
func (o *PlacementEntityFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varPlacementEntityFilter := _PlacementEntityFilter{}

	err = json.Unmarshal(data, &varPlacementEntityFilter)

	if err != nil {
		return err
	}

	*o = PlacementEntityFilter(varPlacementEntityFilter)
...
type NullablePlacementEntityFilter struct {
	value *PlacementEntityFilter
	isSet bool
}

func (v NullablePlacementEntityFilter) Get() *PlacementEntityFilter {
	return v.value
}

func (v *NullablePlacementEntityFilter) Set(val *PlacementEntityFilter) {
	v.value = val
	v.isSet = true
}

func (v NullablePlacementEntityFilter) IsSet() bool {
	return v.isSet
}

func (v *NullablePlacementEntityFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlacementEntityFilter(val *PlacementEntityFilter) *NullablePlacementEntityFilter {
	return &NullablePlacementEntityFilter{value: val, isSet: true}
}

func (v NullablePlacementEntityFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlacementEntityFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
