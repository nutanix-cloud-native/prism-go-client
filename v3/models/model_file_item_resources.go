...
// checks if the FileItemResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemResources{}

// FileItemResources File item spec object
type FileItemResources struct {
...
type _FileItemResources FileItemResources
...
func (o FileItemResources) MarshalJSON() ([]byte, error) {
...
func (o FileItemResources) ToMap() (map[string]interface{}, error) {
...
func (o *FileItemResources) UnmarshalJSON(data []byte) (err error) {
	varFileItemResources := _FileItemResources{}

	err = json.Unmarshal(data, &varFileItemResources)

	if err != nil {
		return err
	}

	*o = FileItemResources(varFileItemResources)
...
type NullableFileItemResources struct {
	value *FileItemResources
	isSet bool
}

func (v NullableFileItemResources) Get() *FileItemResources {
	return v.value
}

func (v *NullableFileItemResources) Set(val *FileItemResources) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemResources) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemResources(val *FileItemResources) *NullableFileItemResources {
	return &NullableFileItemResources{value: val, isSet: true}
}

func (v NullableFileItemResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
