...
// checks if the VmDiskOutputStatusDataSourceReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDiskOutputStatusDataSourceReference{}

// VmDiskOutputStatusDataSourceReference struct for VmDiskOutputStatusDataSourceReference
type VmDiskOutputStatusDataSourceReference struct {
	...
	Url *string `json:"url,omitempty" validate:"regexp=^((((http[s]?):\\/)?\\/?([^:\\/\\\\s]+)((\\/\\\\w+)*(:[0-9]+)*?\\/)([\\\\w\\\\-\\\\.]+[^#?\\\\s]+)(.*)?)(#[\\\\w\\\\-]+)?$|(http[s]?:\\/\\/([\\\\w\\\\d\\\\-_\\\\.])((\\/?\\\\w+\\\\.*)*(:[0-9]+)*_\\/?)))"`
...
type _VmDiskOutputStatusDataSourceReference VmDiskOutputStatusDataSourceReference
...
func NewVmDiskOutputStatusDataSourceReference() *VmDiskOutputStatusDataSourceReference {
	this := VmDiskOutputStatusDataSourceReference{}
	return &this
}
...
// GetIsDirectAttach returns the IsDirectAttach field value if set, zero value otherwise.
func (o *VmDiskOutputStatusDataSourceReference) GetIsDirectAttach() bool {
	if o == nil || IsNil(o.IsDirectAttach) {
		var ret bool
		return ret
	}
	return *o.IsDirectAttach
}

// GetIsDirectAttachOk returns a tuple with the IsDirectAttach field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmDiskOutputStatusDataSourceReference) GetIsDirectAttachOk() (*bool, bool) {
	if o == nil || IsNil(o.IsDirectAttach) {
		return nil, false
	}
	return o.IsDirectAttach, true
}
...
// SetIsDirectAttach gets a reference to the given bool and assigns it to the IsDirectAttach field.
...
func (o VmDiskOutputStatusDataSourceReference) MarshalJSON() ([]byte, error) {
...
func (o VmDiskOutputStatusDataSourceReference) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IsDirectAttach) {
		toSerialize["is_direct_attach"] = o.IsDirectAttach
	}
	if !IsNil(o.Url) {
...
func (o *VmDiskOutputStatusDataSourceReference) UnmarshalJSON(data []byte) (err error) {
	varVmDiskOutputStatusDataSourceReference := _VmDiskOutputStatusDataSourceReference{}

	err = json.Unmarshal(data, &varVmDiskOutputStatusDataSourceReference)

	if err != nil {
		return err
	}

	*o = VmDiskOutputStatusDataSourceReference(varVmDiskOutputStatusDataSourceReference)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "is_direct_attach")
...
type NullableVmDiskOutputStatusDataSourceReference struct {
	value *VmDiskOutputStatusDataSourceReference
	isSet bool
}

func (v NullableVmDiskOutputStatusDataSourceReference) Get() *VmDiskOutputStatusDataSourceReference {
	return v.value
}

func (v *NullableVmDiskOutputStatusDataSourceReference) Set(val *VmDiskOutputStatusDataSourceReference) {
	v.value = val
	v.isSet = true
}

func (v NullableVmDiskOutputStatusDataSourceReference) IsSet() bool {
	return v.isSet
}

func (v *NullableVmDiskOutputStatusDataSourceReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmDiskOutputStatusDataSourceReference(val *VmDiskOutputStatusDataSourceReference) *NullableVmDiskOutputStatusDataSourceReference {
	return &NullableVmDiskOutputStatusDataSourceReference{value: val, isSet: true}
}

func (v NullableVmDiskOutputStatusDataSourceReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmDiskOutputStatusDataSourceReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
