...
// checks if the AwsImageListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsImageListMetadata{}

// AwsImageListMetadata All api calls that return a list will have this metadata block as input 
type AwsImageListMetadata struct {
	// The kind name
...
type _AwsImageListMetadata AwsImageListMetadata
...
func (o AwsImageListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsImageListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsImageListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsImageListMetadata := _AwsImageListMetadata{}

	err = json.Unmarshal(data, &varAwsImageListMetadata)

	if err != nil {
		return err
	}

	*o = AwsImageListMetadata(varAwsImageListMetadata)
...
type NullableAwsImageListMetadata struct {
	value *AwsImageListMetadata
	isSet bool
}

func (v NullableAwsImageListMetadata) Get() *AwsImageListMetadata {
	return v.value
}

func (v *NullableAwsImageListMetadata) Set(val *AwsImageListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsImageListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsImageListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsImageListMetadata(val *AwsImageListMetadata) *NullableAwsImageListMetadata {
	return &NullableAwsImageListMetadata{value: val, isSet: true}
}

func (v NullableAwsImageListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsImageListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
