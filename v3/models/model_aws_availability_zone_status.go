...
// checks if the AwsAvailabilityZoneStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsAvailabilityZoneStatus{}

// AwsAvailabilityZoneStatus The status of a REST API call. Only used when there is a failure to report. 
type AwsAvailabilityZoneStatus struct {
	// The kind name
...
type _AwsAvailabilityZoneStatus AwsAvailabilityZoneStatus
...
func NewAwsAvailabilityZoneStatus() *AwsAvailabilityZoneStatus {
	this := AwsAvailabilityZoneStatus{}
	return &this
}
...
func (o AwsAvailabilityZoneStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsAvailabilityZoneStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsAvailabilityZoneStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsAvailabilityZoneStatus := _AwsAvailabilityZoneStatus{}

	err = json.Unmarshal(data, &varAwsAvailabilityZoneStatus)

	if err != nil {
		return err
	}

	*o = AwsAvailabilityZoneStatus(varAwsAvailabilityZoneStatus)
...
type NullableAwsAvailabilityZoneStatus struct {
	value *AwsAvailabilityZoneStatus
	isSet bool
}

func (v NullableAwsAvailabilityZoneStatus) Get() *AwsAvailabilityZoneStatus {
	return v.value
}

func (v *NullableAwsAvailabilityZoneStatus) Set(val *AwsAvailabilityZoneStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsAvailabilityZoneStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsAvailabilityZoneStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsAvailabilityZoneStatus(val *AwsAvailabilityZoneStatus) *NullableAwsAvailabilityZoneStatus {
	return &NullableAwsAvailabilityZoneStatus{value: val, isSet: true}
}

func (v NullableAwsAvailabilityZoneStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsAvailabilityZoneStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
