...
// checks if the GetInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetInfo{}

// GetInfo Indicates the storage configuration attributes being effective on the entity type specified. This state is resultant of storage attributes configured on the entity and storage policies associated with the entity. 
type GetInfo struct {
	// Indicates whether compression is inline or post-process on the entity. 
	InlineCompression *bool `json:"inline_compression,omitempty"`
	...
	ActiveStoragePolicyReferenceList []Reference `json:"active_storage_policy_reference_list,omitempty"`
	// Indicates whether compression is enabled or not on the entity. 
	CompressionEnabled *bool `json:"compression_enabled,omitempty"`
	// The replication factor effective on the entity.
	ReplicationFactor *int64 `json:"replication_factor,omitempty"`
	// Indicates whether encryption is enabled or not on the entity. 
	EncryptionEnabled *bool `json:"encryption_enabled,omitempty"`
	// Indicates the reasons of non-compliance with the applied policy. 
	NonCompliantErrorCodes []string `json:"non_compliant_error_codes,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _GetInfo GetInfo
...
func NewGetInfo() *GetInfo {
	this := GetInfo{}
	var complianceState string = "IN_PROGRESS"
...
// GetInlineCompression returns the InlineCompression field value if set, zero value otherwise.
func (o *GetInfo) GetInlineCompression() bool {
	if o == nil || IsNil(o.InlineCompression) {
		var ret bool
		return ret
	}
	return *o.InlineCompression
}

// GetInlineCompressionOk returns a tuple with the InlineCompression field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetInfo) GetInlineCompressionOk() (*bool, bool) {
	if o == nil || IsNil(o.InlineCompression) {
		return nil, false
	}
	return o.InlineCompression, true
}
...
// SetInlineCompression gets a reference to the given bool and assigns it to the InlineCompression field.
func (o *GetInfo) SetInlineCompression(v bool) {
	o.InlineCompression = &v
}
...
// GetThrottledIops returns the ThrottledIops field value if set, zero value otherwise.
func (o *GetInfo) GetThrottledIops() int32 {
	if o == nil || IsNil(o.ThrottledIops) {
		var ret int32
		return ret
	}
	return *o.ThrottledIops
}

// GetThrottledIopsOk returns a tuple with the ThrottledIops field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetInfo) GetThrottledIopsOk() (*int32, bool) {
	if o == nil || IsNil(o.ThrottledIops) {
		return nil, false
	}
	return o.ThrottledIops, true
}
...
// SetThrottledIops gets a reference to the given int32 and assigns it to the ThrottledIops field.
func (o *GetInfo) SetThrottledIops(v int32) {
	o.ThrottledIops = &v
}

// GetActiveStoragePolicyReferenceList returns the ActiveStoragePolicyReferenceList field value if set, zero value otherwise.
func (o *GetInfo) GetActiveStoragePolicyReferenceList() []Reference {
	if o == nil || IsNil(o.ActiveStoragePolicyReferenceList) {
		var ret []Reference
		return ret
	}
	return o.ActiveStoragePolicyReferenceList
}

// GetActiveStoragePolicyReferenceListOk returns a tuple with the ActiveStoragePolicyReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetInfo) GetActiveStoragePolicyReferenceListOk() ([]Reference, bool) {
	if o == nil || IsNil(o.ActiveStoragePolicyReferenceList) {
		return nil, false
	}
	return o.ActiveStoragePolicyReferenceList, true
}
...
// SetActiveStoragePolicyReferenceList gets a reference to the given []Reference and assigns it to the ActiveStoragePolicyReferenceList field.
func (o *GetInfo) SetActiveStoragePolicyReferenceList(v []Reference) {
	o.ActiveStoragePolicyReferenceList = v
}
...
// GetNonCompliantErrorCodes returns the NonCompliantErrorCodes field value if set, zero value otherwise.
func (o *GetInfo) GetNonCompliantErrorCodes() []string {
	if o == nil || IsNil(o.NonCompliantErrorCodes) {
		var ret []string
		return ret
	}
	return o.NonCompliantErrorCodes
}

// GetNonCompliantErrorCodesOk returns a tuple with the NonCompliantErrorCodes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetInfo) GetNonCompliantErrorCodesOk() ([]string, bool) {
	if o == nil || IsNil(o.NonCompliantErrorCodes) {
		return nil, false
	}
	return o.NonCompliantErrorCodes, true
}
...
// SetNonCompliantErrorCodes gets a reference to the given []string and assigns it to the NonCompliantErrorCodes field.
func (o *GetInfo) SetNonCompliantErrorCodes(v []string) {
	o.NonCompliantErrorCodes = v
}

func (o GetInfo) MarshalJSON() ([]byte, error) {
...
func (o GetInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.InlineCompression) {
		toSerialize["inline_compression"] = o.InlineCompression
	}
	if !IsNil(o.ComplianceState) {
		toSerialize["compliance_state"] = o.ComplianceState
	}
	if !IsNil(o.ThrottledIops) {
		toSerialize["throttled_iops"] = o.ThrottledIops
	}
	if !IsNil(o.ActiveStoragePolicyReferenceList) {
		toSerialize["active_storage_policy_reference_list"] = o.ActiveStoragePolicyReferenceList
	}
	...
	if !IsNil(o.NonCompliantErrorCodes) {
		toSerialize["non_compliant_error_codes"] = o.NonCompliantErrorCodes
	}
...
func (o *GetInfo) UnmarshalJSON(data []byte) (err error) {
	varGetInfo := _GetInfo{}

	err = json.Unmarshal(data, &varGetInfo)

	if err != nil {
		return err
	}

	*o = GetInfo(varGetInfo)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "inline_compression")
		delete(additionalProperties, "compliance_state")
		delete(additionalProperties, "throttled_iops")
		delete(additionalProperties, "active_storage_policy_reference_list")
		delete(additionalProperties, "compression_enabled")
		delete(additionalProperties, "replication_factor")
		delete(additionalProperties, "encryption_enabled")
		delete(additionalProperties, "non_compliant_error_codes")
...
type NullableGetInfo struct {
	value *GetInfo
	isSet bool
}

func (v NullableGetInfo) Get() *GetInfo {
	return v.value
}

func (v *NullableGetInfo) Set(val *GetInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableGetInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableGetInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetInfo(val *GetInfo) *NullableGetInfo {
	return &NullableGetInfo{value: val, isSet: true}
}

func (v NullableGetInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
