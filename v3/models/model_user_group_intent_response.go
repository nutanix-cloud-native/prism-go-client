...
// checks if the UserGroupIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupIntentResponse{}

// UserGroupIntentResponse Response object for intentful operations on a user_group
...
type _UserGroupIntentResponse UserGroupIntentResponse
...
func (o UserGroupIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o UserGroupIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *UserGroupIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUserGroupIntentResponse := _UserGroupIntentResponse{}

	err = json.Unmarshal(data, &varUserGroupIntentResponse)

	if err != nil {
		return err
	}

	*o = UserGroupIntentResponse(varUserGroupIntentResponse)
...
type NullableUserGroupIntentResponse struct {
	value *UserGroupIntentResponse
	isSet bool
}

func (v NullableUserGroupIntentResponse) Get() *UserGroupIntentResponse {
	return v.value
}

func (v *NullableUserGroupIntentResponse) Set(val *UserGroupIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupIntentResponse(val *UserGroupIntentResponse) *NullableUserGroupIntentResponse {
	return &NullableUserGroupIntentResponse{value: val, isSet: true}
}

func (v NullableUserGroupIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
