...
// checks if the VolumeGroupListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupListMetadataOutput{}

// VolumeGroupListMetadataOutput All api calls that return a list will have this metadata block 
...
type _VolumeGroupListMetadataOutput VolumeGroupListMetadataOutput
...
func NewVolumeGroupListMetadataOutput() *VolumeGroupListMetadataOutput {
	this := VolumeGroupListMetadataOutput{}
	var kind string = "volume_group"
	this.Kind = &kind
	return &this
}
...
func (o VolumeGroupListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeGroupListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVolumeGroupListMetadataOutput := _VolumeGroupListMetadataOutput{}

	err = json.Unmarshal(data, &varVolumeGroupListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VolumeGroupListMetadataOutput(varVolumeGroupListMetadataOutput)
...
type NullableVolumeGroupListMetadataOutput struct {
	value *VolumeGroupListMetadataOutput
	isSet bool
}

func (v NullableVolumeGroupListMetadataOutput) Get() *VolumeGroupListMetadataOutput {
	return v.value
}

func (v *NullableVolumeGroupListMetadataOutput) Set(val *VolumeGroupListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupListMetadataOutput(val *VolumeGroupListMetadataOutput) *NullableVolumeGroupListMetadataOutput {
	return &NullableVolumeGroupListMetadataOutput{value: val, isSet: true}
}

func (v NullableVolumeGroupListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
