...
// checks if the DatacenterComponent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterComponent{}

// DatacenterComponent Common properties for node or a network device in datacenters 
type DatacenterComponent struct {
	// rack unit height
	RackUnitHeight *int32 `json:"rack_unit_height,omitempty"`
	// management IP address
	ManagementIp *string `json:"management_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// management mac address
	ManagementMacAddress *string `json:"management_mac_address,omitempty" validate:"regexp=^([0-9A-Fa-f]{2}[:-]){5}([0-9A-Fa-f]{2})$"`
	// rack unit position
	RackUnitPosition *int32 `json:"rack_unit_position,omitempty"`
	// installation date time
	InstallationTime *time.Time `json:"installation_time,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DatacenterComponent DatacenterComponent
...
// GetRackUnitHeight returns the RackUnitHeight field value if set, zero value otherwise.
func (o *DatacenterComponent) GetRackUnitHeight() int32 {
	if o == nil || IsNil(o.RackUnitHeight) {
		var ret int32
		return ret
	}
	return *o.RackUnitHeight
}

// GetRackUnitHeightOk returns a tuple with the RackUnitHeight field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DatacenterComponent) GetRackUnitHeightOk() (*int32, bool) {
	if o == nil || IsNil(o.RackUnitHeight) {
		return nil, false
	}
	return o.RackUnitHeight, true
}
...
// SetRackUnitHeight gets a reference to the given int32 and assigns it to the RackUnitHeight field.
...
// GetRackUnitPosition returns the RackUnitPosition field value if set, zero value otherwise.
func (o *DatacenterComponent) GetRackUnitPosition() int32 {
	if o == nil || IsNil(o.RackUnitPosition) {
		var ret int32
		return ret
	}
	return *o.RackUnitPosition
}

// GetRackUnitPositionOk returns a tuple with the RackUnitPosition field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DatacenterComponent) GetRackUnitPositionOk() (*int32, bool) {
	if o == nil || IsNil(o.RackUnitPosition) {
		return nil, false
	}
	return o.RackUnitPosition, true
}
...
// SetRackUnitPosition gets a reference to the given int32 and assigns it to the RackUnitPosition field.
func (o *DatacenterComponent) SetRackUnitPosition(v int32) {
	o.RackUnitPosition = &v
}

// GetInstallationTime returns the InstallationTime field value if set, zero value otherwise.
func (o *DatacenterComponent) GetInstallationTime() time.Time {
	if o == nil || IsNil(o.InstallationTime) {
		var ret time.Time
		return ret
	}
	return *o.InstallationTime
}

// GetInstallationTimeOk returns a tuple with the InstallationTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DatacenterComponent) GetInstallationTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.InstallationTime) {
		return nil, false
	}
	return o.InstallationTime, true
}
...
// SetInstallationTime gets a reference to the given time.Time and assigns it to the InstallationTime field.
func (o *DatacenterComponent) SetInstallationTime(v time.Time) {
	o.InstallationTime = &v
}

func (o DatacenterComponent) MarshalJSON() ([]byte, error) {
...
func (o DatacenterComponent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RackUnitHeight) {
		toSerialize["rack_unit_height"] = o.RackUnitHeight
	}
	if !IsNil(o.ManagementIp) {
		toSerialize["management_ip"] = o.ManagementIp
	}
	if !IsNil(o.ManagementMacAddress) {
		toSerialize["management_mac_address"] = o.ManagementMacAddress
	}
	if !IsNil(o.RackUnitPosition) {
		toSerialize["rack_unit_position"] = o.RackUnitPosition
	}
	if !IsNil(o.InstallationTime) {
		toSerialize["installation_time"] = o.InstallationTime
	}
...
func (o *DatacenterComponent) UnmarshalJSON(data []byte) (err error) {
	varDatacenterComponent := _DatacenterComponent{}

	err = json.Unmarshal(data, &varDatacenterComponent)

	if err != nil {
		return err
	}

	*o = DatacenterComponent(varDatacenterComponent)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "rack_unit_height")
		delete(additionalProperties, "management_ip")
		delete(additionalProperties, "management_mac_address")
		delete(additionalProperties, "rack_unit_position")
		delete(additionalProperties, "installation_time")
...
type NullableDatacenterComponent struct {
	value *DatacenterComponent
	isSet bool
}

func (v NullableDatacenterComponent) Get() *DatacenterComponent {
	return v.value
}

func (v *NullableDatacenterComponent) Set(val *DatacenterComponent) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterComponent) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterComponent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterComponent(val *DatacenterComponent) *NullableDatacenterComponent {
	return &NullableDatacenterComponent{value: val, isSet: true}
}

func (v NullableDatacenterComponent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterComponent) UnmarshalJSON(src []byte) error {
	v.isSet = true
