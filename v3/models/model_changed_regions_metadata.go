...
// checks if the ChangedRegionsMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangedRegionsMetadata{}

// ChangedRegionsMetadata The changed_regions kind metadata
type ChangedRegionsMetadata struct {
	...
	// Categories for the changed_regions. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the changed_regions. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _ChangedRegionsMetadata ChangedRegionsMetadata
...
func (o *ChangedRegionsMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *ChangedRegionsMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *ChangedRegionsMetadata) SetName(v string) {
	o.Name = &v
}

func (o ChangedRegionsMetadata) MarshalJSON() ([]byte, error) {
...
func (o ChangedRegionsMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ChangedRegionsMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varChangedRegionsMetadata := _ChangedRegionsMetadata{}

	err = json.Unmarshal(data, &varChangedRegionsMetadata)

	if err != nil {
		return err
	}

	*o = ChangedRegionsMetadata(varChangedRegionsMetadata)
...
type NullableChangedRegionsMetadata struct {
	value *ChangedRegionsMetadata
	isSet bool
}

func (v NullableChangedRegionsMetadata) Get() *ChangedRegionsMetadata {
	return v.value
}

func (v *NullableChangedRegionsMetadata) Set(val *ChangedRegionsMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableChangedRegionsMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableChangedRegionsMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangedRegionsMetadata(val *ChangedRegionsMetadata) *NullableChangedRegionsMetadata {
	return &NullableChangedRegionsMetadata{value: val, isSet: true}
}

func (v NullableChangedRegionsMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangedRegionsMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
