...
// checks if the CategoryListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryListMetadata{}
...
type _CategoryListMetadata CategoryListMetadata
...
func (o CategoryListMetadata) MarshalJSON() ([]byte, error) {
...
func (o CategoryListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryListMetadata) UnmarshalJSON(data []byte) (err error) {
	varCategoryListMetadata := _CategoryListMetadata{}

	err = json.Unmarshal(data, &varCategoryListMetadata)

	if err != nil {
		return err
	}

	*o = CategoryListMetadata(varCategoryListMetadata)
...
type NullableCategoryListMetadata struct {
	value *CategoryListMetadata
	isSet bool
}

func (v NullableCategoryListMetadata) Get() *CategoryListMetadata {
	return v.value
}

func (v *NullableCategoryListMetadata) Set(val *CategoryListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryListMetadata(val *CategoryListMetadata) *NullableCategoryListMetadata {
	return &NullableCategoryListMetadata{value: val, isSet: true}
}

func (v NullableCategoryListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
