...
// checks if the NgtListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtListResponse{}

// NgtListResponse NGT list response.
type NgtListResponse struct {
	EntitiesList []NgtResponse `json:"entities_list,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata *NgtListMetadataOutput `json:"metadata,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NgtListResponse NgtListResponse
...
// GetEntitiesList returns the EntitiesList field value if set, zero value otherwise.
func (o *NgtListResponse) GetEntitiesList() []NgtResponse {
	if o == nil || IsNil(o.EntitiesList) {
		var ret []NgtResponse
		return ret
	}
	return o.EntitiesList
}

// GetEntitiesListOk returns a tuple with the EntitiesList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NgtListResponse) GetEntitiesListOk() ([]NgtResponse, bool) {
	if o == nil || IsNil(o.EntitiesList) {
		return nil, false
	}
	return o.EntitiesList, true
}
...
// SetEntitiesList gets a reference to the given []NgtResponse and assigns it to the EntitiesList field.
...
// SetMetadata gets a reference to the given NgtListMetadataOutput and assigns it to the Metadata field.
func (o *NgtListResponse) SetMetadata(v NgtListMetadataOutput) {
	o.Metadata = &v
}

func (o NgtListResponse) MarshalJSON() ([]byte, error) {
...
func (o NgtListResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.EntitiesList) {
		toSerialize["entities_list"] = o.EntitiesList
	}
...
func (o *NgtListResponse) UnmarshalJSON(data []byte) (err error) {
	varNgtListResponse := _NgtListResponse{}

	err = json.Unmarshal(data, &varNgtListResponse)

	if err != nil {
		return err
	}

	*o = NgtListResponse(varNgtListResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "entities_list")
...
type NullableNgtListResponse struct {
	value *NgtListResponse
	isSet bool
}

func (v NullableNgtListResponse) Get() *NgtListResponse {
	return v.value
}

func (v *NullableNgtListResponse) Set(val *NgtListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtListResponse(val *NgtListResponse) *NullableNgtListResponse {
	return &NullableNgtListResponse{value: val, isSet: true}
}

func (v NullableNgtListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
