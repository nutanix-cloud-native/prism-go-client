...
// checks if the ServiceIpCounters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceIpCounters{}

// ServiceIpCounters Number of packets and bytes hitting the service IP.
type ServiceIpCounters struct {
	Received *RoutingPolicyCounters `json:"received,omitempty"`
	ServiceIp *string `json:"service_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	Sent *RoutingPolicyCounters `json:"sent,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ServiceIpCounters ServiceIpCounters
...
// SetReceived gets a reference to the given RoutingPolicyCounters and assigns it to the Received field.
...
// SetSent gets a reference to the given RoutingPolicyCounters and assigns it to the Sent field.
func (o *ServiceIpCounters) SetSent(v RoutingPolicyCounters) {
	o.Sent = &v
}

func (o ServiceIpCounters) MarshalJSON() ([]byte, error) {
...
func (o ServiceIpCounters) ToMap() (map[string]interface{}, error) {
...
func (o *ServiceIpCounters) UnmarshalJSON(data []byte) (err error) {
	varServiceIpCounters := _ServiceIpCounters{}

	err = json.Unmarshal(data, &varServiceIpCounters)

	if err != nil {
		return err
	}

	*o = ServiceIpCounters(varServiceIpCounters)
...
type NullableServiceIpCounters struct {
	value *ServiceIpCounters
	isSet bool
}

func (v NullableServiceIpCounters) Get() *ServiceIpCounters {
	return v.value
}

func (v *NullableServiceIpCounters) Set(val *ServiceIpCounters) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceIpCounters) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceIpCounters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceIpCounters(val *ServiceIpCounters) *NullableServiceIpCounters {
	return &NullableServiceIpCounters{value: val, isSet: true}
}

func (v NullableServiceIpCounters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceIpCounters) UnmarshalJSON(src []byte) error {
	v.isSet = true
