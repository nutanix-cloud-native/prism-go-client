...
// checks if the DirectConnectVirtualInterfaceIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterfaceIntentInput{}

// DirectConnectVirtualInterfaceIntentInput An intentful representation of a direct_connect_virtual_interface
type DirectConnectVirtualInterfaceIntentInput struct {
	Spec DirectConnectVirtualInterface `json:"spec"`
...
type _DirectConnectVirtualInterfaceIntentInput DirectConnectVirtualInterfaceIntentInput
...
func NewDirectConnectVirtualInterfaceIntentInput(spec DirectConnectVirtualInterface, metadata DirectConnectVirtualInterfaceMetadata) *DirectConnectVirtualInterfaceIntentInput {
	this := DirectConnectVirtualInterfaceIntentInput{}
	this.Spec = spec
...
func (o DirectConnectVirtualInterfaceIntentInput) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterfaceIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectVirtualInterfaceIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectVirtualInterfaceIntentInput := _DirectConnectVirtualInterfaceIntentInput{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterfaceIntentInput)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterfaceIntentInput(varDirectConnectVirtualInterfaceIntentInput)
...
type NullableDirectConnectVirtualInterfaceIntentInput struct {
	value *DirectConnectVirtualInterfaceIntentInput
	isSet bool
}

func (v NullableDirectConnectVirtualInterfaceIntentInput) Get() *DirectConnectVirtualInterfaceIntentInput {
	return v.value
}

func (v *NullableDirectConnectVirtualInterfaceIntentInput) Set(val *DirectConnectVirtualInterfaceIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterfaceIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterfaceIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterfaceIntentInput(val *DirectConnectVirtualInterfaceIntentInput) *NullableDirectConnectVirtualInterfaceIntentInput {
	return &NullableDirectConnectVirtualInterfaceIntentInput{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterfaceIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterfaceIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
