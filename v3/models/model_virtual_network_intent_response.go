...
// checks if the VirtualNetworkIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkIntentResponse{}

// VirtualNetworkIntentResponse Response object for intentful operations on a virtual_network
type VirtualNetworkIntentResponse struct {
...
type _VirtualNetworkIntentResponse VirtualNetworkIntentResponse
...
func NewVirtualNetworkIntentResponse(apiVersion string, metadata VirtualNetworkMetadata) *VirtualNetworkIntentResponse {
	this := VirtualNetworkIntentResponse{}
...
func (o VirtualNetworkIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualNetworkIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualNetworkIntentResponse := _VirtualNetworkIntentResponse{}

	err = json.Unmarshal(data, &varVirtualNetworkIntentResponse)

	if err != nil {
		return err
	}

	*o = VirtualNetworkIntentResponse(varVirtualNetworkIntentResponse)
...
type NullableVirtualNetworkIntentResponse struct {
	value *VirtualNetworkIntentResponse
	isSet bool
}

func (v NullableVirtualNetworkIntentResponse) Get() *VirtualNetworkIntentResponse {
	return v.value
}

func (v *NullableVirtualNetworkIntentResponse) Set(val *VirtualNetworkIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkIntentResponse(val *VirtualNetworkIntentResponse) *NullableVirtualNetworkIntentResponse {
	return &NullableVirtualNetworkIntentResponse{value: val, isSet: true}
}

func (v NullableVirtualNetworkIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
