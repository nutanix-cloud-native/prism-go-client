...
// checks if the NgtListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtListMetadataOutput{}

// NgtListMetadataOutput All api calls that return a list will have this metadata block 
type NgtListMetadataOutput struct {
	// The kind name
...
type _NgtListMetadataOutput NgtListMetadataOutput
...
// and a boolean to check if the value has been set.
func (o *NgtListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o NgtListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o NgtListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *NgtListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varNgtListMetadataOutput := _NgtListMetadataOutput{}

	err = json.Unmarshal(data, &varNgtListMetadataOutput)

	if err != nil {
		return err
	}

	*o = NgtListMetadataOutput(varNgtListMetadataOutput)
...
type NullableNgtListMetadataOutput struct {
	value *NgtListMetadataOutput
	isSet bool
}

func (v NullableNgtListMetadataOutput) Get() *NgtListMetadataOutput {
	return v.value
}

func (v *NullableNgtListMetadataOutput) Set(val *NgtListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtListMetadataOutput(val *NgtListMetadataOutput) *NullableNgtListMetadataOutput {
	return &NullableNgtListMetadataOutput{value: val, isSet: true}
}

func (v NullableNgtListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
