...
// checks if the RoutingPolicyStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyStatus{}

// RoutingPolicyStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _RoutingPolicyStatus RoutingPolicyStatus
...
func (o RoutingPolicyStatus) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyStatus) UnmarshalJSON(data []byte) (err error) {
	varRoutingPolicyStatus := _RoutingPolicyStatus{}

	err = json.Unmarshal(data, &varRoutingPolicyStatus)

	if err != nil {
		return err
	}

	*o = RoutingPolicyStatus(varRoutingPolicyStatus)
...
type NullableRoutingPolicyStatus struct {
	value *RoutingPolicyStatus
	isSet bool
}

func (v NullableRoutingPolicyStatus) Get() *RoutingPolicyStatus {
	return v.value
}

func (v *NullableRoutingPolicyStatus) Set(val *RoutingPolicyStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyStatus(val *RoutingPolicyStatus) *NullableRoutingPolicyStatus {
	return &NullableRoutingPolicyStatus{value: val, isSet: true}
}

func (v NullableRoutingPolicyStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
