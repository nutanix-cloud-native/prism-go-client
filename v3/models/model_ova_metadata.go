...
// checks if the OvaMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OvaMetadata{}

// OvaMetadata Metadata for OVA
type OvaMetadata struct {
	OwnerReference *UserReference `json:"owner_reference,omitempty"`
	// The kind name
	Kind *string `json:"kind,omitempty"`
	// Creation time of OVA
...
func (o OvaMetadata) MarshalJSON() ([]byte, error) {
...
func (o OvaMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *OvaMetadata) UnmarshalJSON(data []byte) (err error) {
	varOvaMetadata := _OvaMetadata{}

	err = json.Unmarshal(data, &varOvaMetadata)

	if err != nil {
		return err
	}

	*o = OvaMetadata(varOvaMetadata)
...
type NullableOvaMetadata struct {
	value *OvaMetadata
	isSet bool
}

func (v NullableOvaMetadata) Get() *OvaMetadata {
	return v.value
}

func (v *NullableOvaMetadata) Set(val *OvaMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableOvaMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableOvaMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOvaMetadata(val *OvaMetadata) *NullableOvaMetadata {
	return &NullableOvaMetadata{value: val, isSet: true}
}

func (v NullableOvaMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOvaMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
