...
// checks if the CellReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CellReference{}

// CellReference The reference to a cell
...
type _CellReference CellReference
...
func (o CellReference) MarshalJSON() ([]byte, error) {
...
func (o CellReference) ToMap() (map[string]interface{}, error) {
...
func (o *CellReference) UnmarshalJSON(data []byte) (err error) {
	...
	varCellReference := _CellReference{}

	err = json.Unmarshal(data, &varCellReference)

	if err != nil {
		return err
	}

	*o = CellReference(varCellReference)
...
type NullableCellReference struct {
	value *CellReference
	isSet bool
}

func (v NullableCellReference) Get() *CellReference {
	return v.value
}

func (v *NullableCellReference) Set(val *CellReference) {
	v.value = val
	v.isSet = true
}

func (v NullableCellReference) IsSet() bool {
	return v.isSet
}

func (v *NullableCellReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCellReference(val *CellReference) *NullableCellReference {
	return &NullableCellReference{value: val, isSet: true}
}

func (v NullableCellReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCellReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
