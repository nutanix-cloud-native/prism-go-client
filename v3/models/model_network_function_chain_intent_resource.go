...
// checks if the NetworkFunctionChainIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionChainIntentResource{}

// NetworkFunctionChainIntentResource Response object for intentful operations on a network_function_chain
type NetworkFunctionChainIntentResource struct {
	Status *NetworkFunctionChainDefStatus `json:"status,omitempty"`
	Spec *NetworkFunctionChain `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata NetworkFunctionChainMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _NetworkFunctionChainIntentResource NetworkFunctionChainIntentResource
...
func NewNetworkFunctionChainIntentResource(metadata NetworkFunctionChainMetadata) *NetworkFunctionChainIntentResource {
	this := NetworkFunctionChainIntentResource{}
...
func (o *NetworkFunctionChainIntentResource) GetStatus() NetworkFunctionChainDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret NetworkFunctionChainDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given NetworkFunctionChainDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given NetworkFunctionChain and assigns it to the Spec field.
...
func (o *NetworkFunctionChainIntentResource) GetMetadata() NetworkFunctionChainMetadata {
	if o == nil {
		var ret NetworkFunctionChainMetadata
		return ret
	}
...
func (o NetworkFunctionChainIntentResource) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionChainIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionChainIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkFunctionChainIntentResource := _NetworkFunctionChainIntentResource{}

	err = json.Unmarshal(data, &varNetworkFunctionChainIntentResource)

	if err != nil {
		return err
	}

	*o = NetworkFunctionChainIntentResource(varNetworkFunctionChainIntentResource)
...
type NullableNetworkFunctionChainIntentResource struct {
	value *NetworkFunctionChainIntentResource
	isSet bool
}

func (v NullableNetworkFunctionChainIntentResource) Get() *NetworkFunctionChainIntentResource {
	return v.value
}

func (v *NullableNetworkFunctionChainIntentResource) Set(val *NetworkFunctionChainIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionChainIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionChainIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionChainIntentResource(val *NetworkFunctionChainIntentResource) *NullableNetworkFunctionChainIntentResource {
	return &NullableNetworkFunctionChainIntentResource{value: val, isSet: true}
}

func (v NullableNetworkFunctionChainIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionChainIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
