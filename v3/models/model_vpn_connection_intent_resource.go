...
// checks if the VpnConnectionIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionIntentResource{}

// VpnConnectionIntentResource Response object for intentful operations on a vpn_connection
type VpnConnectionIntentResource struct {
...
type _VpnConnectionIntentResource VpnConnectionIntentResource
...
func NewVpnConnectionIntentResource(metadata VpnConnectionMetadata) *VpnConnectionIntentResource {
	this := VpnConnectionIntentResource{}
...
func (o VpnConnectionIntentResource) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnectionIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnConnectionIntentResource := _VpnConnectionIntentResource{}

	err = json.Unmarshal(data, &varVpnConnectionIntentResource)

	if err != nil {
		return err
	}

	*o = VpnConnectionIntentResource(varVpnConnectionIntentResource)
...
type NullableVpnConnectionIntentResource struct {
	value *VpnConnectionIntentResource
	isSet bool
}

func (v NullableVpnConnectionIntentResource) Get() *VpnConnectionIntentResource {
	return v.value
}

func (v *NullableVpnConnectionIntentResource) Set(val *VpnConnectionIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionIntentResource(val *VpnConnectionIntentResource) *NullableVpnConnectionIntentResource {
	return &NullableVpnConnectionIntentResource{value: val, isSet: true}
}

func (v NullableVpnConnectionIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
