...
// DeploymentStatus Deployment related status for this gateway.
type DeploymentStatus struct {
	...
	InstallLbRoute *bool `json:"install_lb_route,omitempty"`
	VmReference *VmReference `json:"vm_reference,omitempty"`
	VcenterDeploymentDetails *VcenterDeploymentDetails `json:"vcenter_deployment_details,omitempty"`
	// IP prefix length of the subnet that the gateway VM is on.
	IpPrefixLength *int32 `json:"ip_prefix_length,omitempty"`
	// Static IP address of the VPN gateway VM.
	StaticIp *string `json:"static_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// Default gateway IP address.
	DefaultGatewayIp *string `json:"default_gateway_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// The software image installed on the gateway appliance.
	ImageSourceUrl *string `json:"image_source_url,omitempty"`
	PeClusterReference *ClusterReference `json:"pe_cluster_reference,omitempty"`
	SubnetReference *SubnetReference `json:"subnet_reference,omitempty"`
	// The supported gateway appliance version.
	SupportedSoftwareVersion *string `json:"supported_software_version,omitempty"`
	// The software version installed on the gateway appliance.
	InstalledSoftwareVersion *string `json:"installed_software_version,omitempty"`
...
// GetInstallLbRoute returns the InstallLbRoute field value if set, zero value otherwise.
func (o *DeploymentStatus) GetInstallLbRoute() bool {
	if o == nil || IsNil(o.InstallLbRoute) {
		var ret bool
		return ret
	}
	return *o.InstallLbRoute
}

// GetInstallLbRouteOk returns a tuple with the InstallLbRoute field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DeploymentStatus) GetInstallLbRouteOk() (*bool, bool) {
	if o == nil || IsNil(o.InstallLbRoute) {
		return nil, false
	}
	return o.InstallLbRoute, true
}
...
// SetInstallLbRoute gets a reference to the given bool and assigns it to the InstallLbRoute field.
func (o *DeploymentStatus) SetInstallLbRoute(v bool) {
	o.InstallLbRoute = &v
}

// GetVmReference returns the VmReference field value if set, zero value otherwise.
func (o *DeploymentStatus) GetVmReference() VmReference {
	if o == nil || IsNil(o.VmReference) {
		var ret VmReference
		return ret
	}
	return *o.VmReference
}

// GetVmReferenceOk returns a tuple with the VmReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DeploymentStatus) GetVmReferenceOk() (*VmReference, bool) {
	if o == nil || IsNil(o.VmReference) {
		return nil, false
	}
	return o.VmReference, true
}
...
// SetVmReference gets a reference to the given VmReference and assigns it to the VmReference field.
func (o *DeploymentStatus) SetVmReference(v VmReference) {
	o.VmReference = &v
}

// GetVcenterDeploymentDetails returns the VcenterDeploymentDetails field value if set, zero value otherwise.
func (o *DeploymentStatus) GetVcenterDeploymentDetails() VcenterDeploymentDetails {
	if o == nil || IsNil(o.VcenterDeploymentDetails) {
		var ret VcenterDeploymentDetails
		return ret
	}
	return *o.VcenterDeploymentDetails
}

// GetVcenterDeploymentDetailsOk returns a tuple with the VcenterDeploymentDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DeploymentStatus) GetVcenterDeploymentDetailsOk() (*VcenterDeploymentDetails, bool) {
	if o == nil || IsNil(o.VcenterDeploymentDetails) {
		return nil, false
	}
	return o.VcenterDeploymentDetails, true
}
...
// SetVcenterDeploymentDetails gets a reference to the given VcenterDeploymentDetails and assigns it to the VcenterDeploymentDetails field.
func (o *DeploymentStatus) SetVcenterDeploymentDetails(v VcenterDeploymentDetails) {
	o.VcenterDeploymentDetails = &v
}

// GetIpPrefixLength returns the IpPrefixLength field value if set, zero value otherwise.
func (o *DeploymentStatus) GetIpPrefixLength() int32 {
	if o == nil || IsNil(o.IpPrefixLength) {
		var ret int32
		return ret
	}
	return *o.IpPrefixLength
}

// GetIpPrefixLengthOk returns a tuple with the IpPrefixLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DeploymentStatus) GetIpPrefixLengthOk() (*int32, bool) {
	if o == nil || IsNil(o.IpPrefixLength) {
		return nil, false
	}
	return o.IpPrefixLength, true
}
...
// SetIpPrefixLength gets a reference to the given int32 and assigns it to the IpPrefixLength field.
...
// GetDefaultGatewayIp returns the DefaultGatewayIp field value if set, zero value otherwise.
func (o *DeploymentStatus) GetDefaultGatewayIp() string {
	if o == nil || IsNil(o.DefaultGatewayIp) {
		var ret string
		return ret
	}
	return *o.DefaultGatewayIp
}
...
func (o *DeploymentStatus) GetDefaultGatewayIpOk() (*string, bool) {
	...
	return o.DefaultGatewayIp, true
}
...
// SetDefaultGatewayIp gets a reference to the given string and assigns it to the DefaultGatewayIp field.
func (o *DeploymentStatus) SetDefaultGatewayIp(v string) {
	o.DefaultGatewayIp = &v
}

// GetImageSourceUrl returns the ImageSourceUrl field value if set, zero value otherwise.
func (o *DeploymentStatus) GetImageSourceUrl() string {
	if o == nil || IsNil(o.ImageSourceUrl) {
		var ret string
		return ret
	}
	return *o.ImageSourceUrl
}

// GetImageSourceUrlOk returns a tuple with the ImageSourceUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DeploymentStatus) GetImageSourceUrlOk() (*string, bool) {
	if o == nil || IsNil(o.ImageSourceUrl) {
		return nil, false
	}
	return o.ImageSourceUrl, true
}
...
// SetImageSourceUrl gets a reference to the given string and assigns it to the ImageSourceUrl field.
func (o *DeploymentStatus) SetImageSourceUrl(v string) {
	o.ImageSourceUrl = &v
}

// GetPeClusterReference returns the PeClusterReference field value if set, zero value otherwise.
func (o *DeploymentStatus) GetPeClusterReference() ClusterReference {
	if o == nil || IsNil(o.PeClusterReference) {
		var ret ClusterReference
		return ret
	}
	return *o.PeClusterReference
}

// GetPeClusterReferenceOk returns a tuple with the PeClusterReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DeploymentStatus) GetPeClusterReferenceOk() (*ClusterReference, bool) {
	if o == nil || IsNil(o.PeClusterReference) {
		return nil, false
	}
	return o.PeClusterReference, true
}
...
// SetPeClusterReference gets a reference to the given ClusterReference and assigns it to the PeClusterReference field.
func (o *DeploymentStatus) SetPeClusterReference(v ClusterReference) {
	o.PeClusterReference = &v
}

// GetSubnetReference returns the SubnetReference field value if set, zero value otherwise.
func (o *DeploymentStatus) GetSubnetReference() SubnetReference {
	if o == nil || IsNil(o.SubnetReference) {
		var ret SubnetReference
		return ret
	}
	return *o.SubnetReference
}

// GetSubnetReferenceOk returns a tuple with the SubnetReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DeploymentStatus) GetSubnetReferenceOk() (*SubnetReference, bool) {
	if o == nil || IsNil(o.SubnetReference) {
		return nil, false
	}
	return o.SubnetReference, true
}
...
// SetSubnetReference gets a reference to the given SubnetReference and assigns it to the SubnetReference field.
func (o *DeploymentStatus) SetSubnetReference(v SubnetReference) {
	o.SubnetReference = &v
}

// GetSupportedSoftwareVersion returns the SupportedSoftwareVersion field value if set, zero value otherwise.
func (o *DeploymentStatus) GetSupportedSoftwareVersion() string {
	if o == nil || IsNil(o.SupportedSoftwareVersion) {
		var ret string
		return ret
	}
	return *o.SupportedSoftwareVersion
}

// GetSupportedSoftwareVersionOk returns a tuple with the SupportedSoftwareVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DeploymentStatus) GetSupportedSoftwareVersionOk() (*string, bool) {
	if o == nil || IsNil(o.SupportedSoftwareVersion) {
		return nil, false
	}
	return o.SupportedSoftwareVersion, true
}
...
// SetSupportedSoftwareVersion gets a reference to the given string and assigns it to the SupportedSoftwareVersion field.
func (o *DeploymentStatus) SetSupportedSoftwareVersion(v string) {
	o.SupportedSoftwareVersion = &v
}

// GetInstalledSoftwareVersion returns the InstalledSoftwareVersion field value if set, zero value otherwise.
func (o *DeploymentStatus) GetInstalledSoftwareVersion() string {
	if o == nil || IsNil(o.InstalledSoftwareVersion) {
		var ret string
		return ret
	}
	return *o.InstalledSoftwareVersion
}

// GetInstalledSoftwareVersionOk returns a tuple with the InstalledSoftwareVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DeploymentStatus) GetInstalledSoftwareVersionOk() (*string, bool) {
	if o == nil || IsNil(o.InstalledSoftwareVersion) {
		return nil, false
	}
	return o.InstalledSoftwareVersion, true
}
...
// SetInstalledSoftwareVersion gets a reference to the given string and assigns it to the InstalledSoftwareVersion field.
func (o *DeploymentStatus) SetInstalledSoftwareVersion(v string) {
	o.InstalledSoftwareVersion = &v
}
...
func (o DeploymentStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InstallLbRoute) {
		toSerialize["install_lb_route"] = o.InstallLbRoute
	}
	if !IsNil(o.VmReference) {
		toSerialize["vm_reference"] = o.VmReference
	}
	if !IsNil(o.VcenterDeploymentDetails) {
		toSerialize["vcenter_deployment_details"] = o.VcenterDeploymentDetails
	}
	if !IsNil(o.IpPrefixLength) {
		toSerialize["ip_prefix_length"] = o.IpPrefixLength
	}
	if !IsNil(o.StaticIp) {
		toSerialize["static_ip"] = o.StaticIp
	}
	if !IsNil(o.DefaultGatewayIp) {
		toSerialize["default_gateway_ip"] = o.DefaultGatewayIp
	}
	if !IsNil(o.ImageSourceUrl) {
		toSerialize["image_source_url"] = o.ImageSourceUrl
	}
	if !IsNil(o.PeClusterReference) {
		toSerialize["pe_cluster_reference"] = o.PeClusterReference
	}
	if !IsNil(o.SubnetReference) {
		toSerialize["subnet_reference"] = o.SubnetReference
	}
	if !IsNil(o.SupportedSoftwareVersion) {
		toSerialize["supported_software_version"] = o.SupportedSoftwareVersion
	}
	if !IsNil(o.InstalledSoftwareVersion) {
		toSerialize["installed_software_version"] = o.InstalledSoftwareVersion
	}
	if !IsNil(o.VlanId) {
...
func (o *DeploymentStatus) UnmarshalJSON(data []byte) (err error) {
	...
	*o = DeploymentStatus(varDeploymentStatus)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "install_lb_route")
		delete(additionalProperties, "vm_reference")
		delete(additionalProperties, "vcenter_deployment_details")
		delete(additionalProperties, "ip_prefix_length")
		delete(additionalProperties, "static_ip")
		delete(additionalProperties, "default_gateway_ip")
		delete(additionalProperties, "image_source_url")
		delete(additionalProperties, "pe_cluster_reference")
		delete(additionalProperties, "subnet_reference")
		delete(additionalProperties, "supported_software_version")
		delete(additionalProperties, "installed_software_version")
