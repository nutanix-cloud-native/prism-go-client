...
// checks if the VmNicListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmNicListMetadataOutput{}

// VmNicListMetadataOutput All api calls that return a list will have this metadata block 
...
type _VmNicListMetadataOutput VmNicListMetadataOutput
...
func NewVmNicListMetadataOutput() *VmNicListMetadataOutput {
	this := VmNicListMetadataOutput{}
	var kind string = "vm_nic"
	this.Kind = &kind
	return &this
}
...
func (o VmNicListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VmNicListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VmNicListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVmNicListMetadataOutput := _VmNicListMetadataOutput{}

	err = json.Unmarshal(data, &varVmNicListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VmNicListMetadataOutput(varVmNicListMetadataOutput)
...
type NullableVmNicListMetadataOutput struct {
	value *VmNicListMetadataOutput
	isSet bool
}

func (v NullableVmNicListMetadataOutput) Get() *VmNicListMetadataOutput {
	return v.value
}

func (v *NullableVmNicListMetadataOutput) Set(val *VmNicListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmNicListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmNicListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmNicListMetadataOutput(val *VmNicListMetadataOutput) *NullableVmNicListMetadataOutput {
	return &NullableVmNicListMetadataOutput{value: val, isSet: true}
}

func (v NullableVmNicListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmNicListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
