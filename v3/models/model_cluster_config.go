...
func NewClusterConfig() *ClusterConfig {
	this := ClusterConfig{}
	var encryptionStatus string = "NOT_SUPPORTED"
	this.EncryptionStatus = &encryptionStatus
	var supportedInformationVerbosity string = "BASIC_PLUS_CORE_DUMP"
	this.SupportedInformationVerbosity = &supportedInformationVerbosity
	var domainAwarenessLevel string = "NODE"
...
// GetAuthorizedPublicKeyList returns the AuthorizedPublicKeyList field value if set, zero value otherwise.
func (o *ClusterConfig) GetAuthorizedPublicKeyList() []PublicKey {
	if o == nil || IsNil(o.AuthorizedPublicKeyList) {
		var ret []PublicKey
		return ret
	}
	return o.AuthorizedPublicKeyList
}

// GetAuthorizedPublicKeyListOk returns a tuple with the AuthorizedPublicKeyList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterConfig) GetAuthorizedPublicKeyListOk() ([]PublicKey, bool) {
	if o == nil || IsNil(o.AuthorizedPublicKeyList) {
		return nil, false
	}
	return o.AuthorizedPublicKeyList, true
}
...
// SetAuthorizedPublicKeyList gets a reference to the given []PublicKey and assigns it to the AuthorizedPublicKeyList field.
func (o *ClusterConfig) SetAuthorizedPublicKeyList(v []PublicKey) {
	o.AuthorizedPublicKeyList = v
}

// GetSoftwareMap returns the SoftwareMap field value if set, zero value otherwise.
func (o *ClusterConfig) GetSoftwareMap() map[string]ClusterSoftware {
	if o == nil || IsNil(o.SoftwareMap) {
		var ret map[string]ClusterSoftware
		return ret
	}
	return *o.SoftwareMap
}

// GetSoftwareMapOk returns a tuple with the SoftwareMap field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterConfig) GetSoftwareMapOk() (*map[string]ClusterSoftware, bool) {
	if o == nil || IsNil(o.SoftwareMap) {
		return nil, false
	}
	return o.SoftwareMap, true
}
...
// SetSoftwareMap gets a reference to the given map[string]ClusterSoftware and assigns it to the SoftwareMap field.
...
// SetSslKey gets a reference to the given SslKey and assigns it to the SslKey field.
...
// SetServiceList gets a reference to the given []string and assigns it to the ServiceList field.
func (o *ClusterConfig) SetServiceList(v []string) {
	o.ServiceList = v
}

// GetSupportedInformationVerbosity returns the SupportedInformationVerbosity field value if set, zero value otherwise.
func (o *ClusterConfig) GetSupportedInformationVerbosity() string {
	if o == nil || IsNil(o.SupportedInformationVerbosity) {
		var ret string
		return ret
	}
	return *o.SupportedInformationVerbosity
}

// GetSupportedInformationVerbosityOk returns a tuple with the SupportedInformationVerbosity field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterConfig) GetSupportedInformationVerbosityOk() (*string, bool) {
	if o == nil || IsNil(o.SupportedInformationVerbosity) {
		return nil, false
	}
	return o.SupportedInformationVerbosity, true
}
...
// SetSupportedInformationVerbosity gets a reference to the given string and assigns it to the SupportedInformationVerbosity field.
func (o *ClusterConfig) SetSupportedInformationVerbosity(v string) {
	o.SupportedInformationVerbosity = &v
}

// GetCertificationSigningInfo returns the CertificationSigningInfo field value if set, zero value otherwise.
func (o *ClusterConfig) GetCertificationSigningInfo() CertificationSigningInfo {
	if o == nil || IsNil(o.CertificationSigningInfo) {
		var ret CertificationSigningInfo
		return ret
	}
	return *o.CertificationSigningInfo
}

// GetCertificationSigningInfoOk returns a tuple with the CertificationSigningInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterConfig) GetCertificationSigningInfoOk() (*CertificationSigningInfo, bool) {
	if o == nil || IsNil(o.CertificationSigningInfo) {
		return nil, false
	}
	return o.CertificationSigningInfo, true
}
...
// SetCertificationSigningInfo gets a reference to the given CertificationSigningInfo and assigns it to the CertificationSigningInfo field.
func (o *ClusterConfig) SetCertificationSigningInfo(v CertificationSigningInfo) {
	o.CertificationSigningInfo = &v
}
...
// SetRedundancyFactor gets a reference to the given int32 and assigns it to the RedundancyFactor field.
func (o *ClusterConfig) SetRedundancyFactor(v int32) {
	o.RedundancyFactor = &v
}

// GetExternalConfigurations returns the ExternalConfigurations field value if set, zero value otherwise.
func (o *ClusterConfig) GetExternalConfigurations() ExternalConfigurations {
	if o == nil || IsNil(o.ExternalConfigurations) {
		var ret ExternalConfigurations
		return ret
	}
	return *o.ExternalConfigurations
}

// GetExternalConfigurationsOk returns a tuple with the ExternalConfigurations field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterConfig) GetExternalConfigurationsOk() (*ExternalConfigurations, bool) {
	if o == nil || IsNil(o.ExternalConfigurations) {
		return nil, false
	}
	return o.ExternalConfigurations, true
}
...
// SetExternalConfigurations gets a reference to the given ExternalConfigurations and assigns it to the ExternalConfigurations field.
func (o *ClusterConfig) SetExternalConfigurations(v ExternalConfigurations) {
	o.ExternalConfigurations = &v
}
...
// GetCaCertificateList returns the CaCertificateList field value if set, zero value otherwise.
func (o *ClusterConfig) GetCaCertificateList() []CaCert {
	if o == nil || IsNil(o.CaCertificateList) {
		var ret []CaCert
		return ret
	}
	return o.CaCertificateList
}

// GetCaCertificateListOk returns a tuple with the CaCertificateList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterConfig) GetCaCertificateListOk() ([]CaCert, bool) {
	if o == nil || IsNil(o.CaCertificateList) {
		return nil, false
	}
	return o.CaCertificateList, true
}
...
// SetCaCertificateList gets a reference to the given []CaCert and assigns it to the CaCertificateList field.
func (o *ClusterConfig) SetCaCertificateList(v []CaCert) {
	o.CaCertificateList = v
}
...
// GetEnabledFeatureList returns the EnabledFeatureList field value if set, zero value otherwise.
func (o *ClusterConfig) GetEnabledFeatureList() []string {
	if o == nil || IsNil(o.EnabledFeatureList) {
		var ret []string
		return ret
	}
	return o.EnabledFeatureList
}

// GetEnabledFeatureListOk returns a tuple with the EnabledFeatureList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterConfig) GetEnabledFeatureListOk() ([]string, bool) {
	if o == nil || IsNil(o.EnabledFeatureList) {
		return nil, false
	}
	return o.EnabledFeatureList, true
}
...
// SetEnabledFeatureList gets a reference to the given []string and assigns it to the EnabledFeatureList field.
func (o *ClusterConfig) SetEnabledFeatureList(v []string) {
	o.EnabledFeatureList = v
}
...
// SetBuild gets a reference to the given BuildInfo and assigns it to the Build field.
...
// GetEnableEfficientMetricSync returns the EnableEfficientMetricSync field value if set, zero value otherwise.
func (o *ClusterConfig) GetEnableEfficientMetricSync() bool {
	if o == nil || IsNil(o.EnableEfficientMetricSync) {
		var ret bool
		return ret
	}
	return *o.EnableEfficientMetricSync
}

// GetEnableEfficientMetricSyncOk returns a tuple with the EnableEfficientMetricSync field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterConfig) GetEnableEfficientMetricSyncOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableEfficientMetricSync) {
		return nil, false
	}
	return o.EnableEfficientMetricSync, true
}
...
// SetEnableEfficientMetricSync gets a reference to the given bool and assigns it to the EnableEfficientMetricSync field.
func (o *ClusterConfig) SetEnableEfficientMetricSync(v bool) {
	o.EnableEfficientMetricSync = &v
}
...
// GetManagementServerList returns the ManagementServerList field value if set, zero value otherwise.
func (o *ClusterConfig) GetManagementServerList() []ClusterManagementServer {
	if o == nil || IsNil(o.ManagementServerList) {
		var ret []ClusterManagementServer
		return ret
	}
	return o.ManagementServerList
}

// GetManagementServerListOk returns a tuple with the ManagementServerList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterConfig) GetManagementServerListOk() ([]ClusterManagementServer, bool) {
	if o == nil || IsNil(o.ManagementServerList) {
		return nil, false
	}
	return o.ManagementServerList, true
}
...
// SetManagementServerList gets a reference to the given []ClusterManagementServer and assigns it to the ManagementServerList field.
func (o *ClusterConfig) SetManagementServerList(v []ClusterManagementServer) {
	o.ManagementServerList = v
}
...
func (o ClusterConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GpuDriverVersion) {
		toSerialize["gpu_driver_version"] = o.GpuDriverVersion
	}
	if !IsNil(o.ClientAuth) {
		toSerialize["client_auth"] = o.ClientAuth
	}
	if !IsNil(o.AuthorizedPublicKeyList) {
		toSerialize["authorized_public_key_list"] = o.AuthorizedPublicKeyList
	}
	if !IsNil(o.SoftwareMap) {
		toSerialize["software_map"] = o.SoftwareMap
	}
	if !IsNil(o.EncryptionStatus) {
		toSerialize["encryption_status"] = o.EncryptionStatus
	}
	if !IsNil(o.SslKey) {
		toSerialize["ssl_key"] = o.SslKey
	}
	if !IsNil(o.ServiceList) {
		toSerialize["service_list"] = o.ServiceList
	}
	if !IsNil(o.SupportedInformationVerbosity) {
		toSerialize["supported_information_verbosity"] = o.SupportedInformationVerbosity
	}
	if !IsNil(o.CertificationSigningInfo) {
		toSerialize["certification_signing_info"] = o.CertificationSigningInfo
	}
	if !IsNil(o.RedundancyFactor) {
		toSerialize["redundancy_factor"] = o.RedundancyFactor
	}
	if !IsNil(o.ExternalConfigurations) {
		toSerialize["external_configurations"] = o.ExternalConfigurations
	}
	if !IsNil(o.OperationMode) {
		toSerialize["operation_mode"] = o.OperationMode
	}
	if !IsNil(o.CaCertificateList) {
		toSerialize["ca_certificate_list"] = o.CaCertificateList
	}
	if !IsNil(o.DomainAwarenessLevel) {
		toSerialize["domain_awareness_level"] = o.DomainAwarenessLevel
	}
	if !IsNil(o.EnabledFeatureList) {
		toSerialize["enabled_feature_list"] = o.EnabledFeatureList
	}
	...
	if !IsNil(o.EnableEfficientMetricSync) {
		toSerialize["enable_efficient_metric_sync"] = o.EnableEfficientMetricSync
	}
	if !IsNil(o.ClusterArch) {
		toSerialize["cluster_arch"] = o.ClusterArch
	}
	if !IsNil(o.ManagementServerList) {
		toSerialize["management_server_list"] = o.ManagementServerList
	}
...
func (o *ClusterConfig) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ClusterConfig(varClusterConfig)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "gpu_driver_version")
		delete(additionalProperties, "client_auth")
		delete(additionalProperties, "authorized_public_key_list")
		delete(additionalProperties, "software_map")
		delete(additionalProperties, "encryption_status")
		delete(additionalProperties, "ssl_key")
		delete(additionalProperties, "service_list")
		delete(additionalProperties, "supported_information_verbosity")
		delete(additionalProperties, "certification_signing_info")
		delete(additionalProperties, "redundancy_factor")
		delete(additionalProperties, "external_configurations")
		delete(additionalProperties, "operation_mode")
		delete(additionalProperties, "ca_certificate_list")
		delete(additionalProperties, "domain_awareness_level")
		delete(additionalProperties, "enabled_feature_list")
		delete(additionalProperties, "is_available")
		delete(additionalProperties, "build")
		delete(additionalProperties, "timezone")
		delete(additionalProperties, "enable_efficient_metric_sync")
		delete(additionalProperties, "cluster_arch")
		delete(additionalProperties, "management_server_list")
