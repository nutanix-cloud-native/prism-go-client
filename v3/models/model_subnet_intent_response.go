...
// checks if the SubnetIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubnetIntentResponse{}
...
type _SubnetIntentResponse SubnetIntentResponse
...
func (o SubnetIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o SubnetIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SubnetIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubnetIntentResponse := _SubnetIntentResponse{}

	err = json.Unmarshal(data, &varSubnetIntentResponse)

	if err != nil {
		return err
	}

	*o = SubnetIntentResponse(varSubnetIntentResponse)
...
type NullableSubnetIntentResponse struct {
	value *SubnetIntentResponse
	isSet bool
}

func (v NullableSubnetIntentResponse) Get() *SubnetIntentResponse {
	return v.value
}

func (v *NullableSubnetIntentResponse) Set(val *SubnetIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSubnetIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSubnetIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubnetIntentResponse(val *SubnetIntentResponse) *NullableSubnetIntentResponse {
	return &NullableSubnetIntentResponse{value: val, isSet: true}
}

func (v NullableSubnetIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubnetIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
