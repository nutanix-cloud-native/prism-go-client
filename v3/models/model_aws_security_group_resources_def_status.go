...
// checks if the AwsSecurityGroupResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSecurityGroupResourcesDefStatus{}

// AwsSecurityGroupResourcesDefStatus AWS Security Group resources
type AwsSecurityGroupResourcesDefStatus struct {
	// The AWS ID of the VPC for the security group.
	...
	// The AWS ID of the security group.
	Id *string `json:"id,omitempty" validate:"regexp=^sg-[a-f0-9]{1,17}$"`
	AdditionalProperties map[string]interface{}
}

type _AwsSecurityGroupResourcesDefStatus AwsSecurityGroupResourcesDefStatus
...
func NewAwsSecurityGroupResourcesDefStatus() *AwsSecurityGroupResourcesDefStatus {
	this := AwsSecurityGroupResourcesDefStatus{}
	return &this
}
...
func (o AwsSecurityGroupResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsSecurityGroupResourcesDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSecurityGroupResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsSecurityGroupResourcesDefStatus := _AwsSecurityGroupResourcesDefStatus{}

	err = json.Unmarshal(data, &varAwsSecurityGroupResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = AwsSecurityGroupResourcesDefStatus(varAwsSecurityGroupResourcesDefStatus)
...
type NullableAwsSecurityGroupResourcesDefStatus struct {
	value *AwsSecurityGroupResourcesDefStatus
	isSet bool
}

func (v NullableAwsSecurityGroupResourcesDefStatus) Get() *AwsSecurityGroupResourcesDefStatus {
	return v.value
}

func (v *NullableAwsSecurityGroupResourcesDefStatus) Set(val *AwsSecurityGroupResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSecurityGroupResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSecurityGroupResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSecurityGroupResourcesDefStatus(val *AwsSecurityGroupResourcesDefStatus) *NullableAwsSecurityGroupResourcesDefStatus {
	return &NullableAwsSecurityGroupResourcesDefStatus{value: val, isSet: true}
}

func (v NullableAwsSecurityGroupResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSecurityGroupResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
