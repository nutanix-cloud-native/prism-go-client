...
// checks if the VmGpu type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmGpu{}
...
func (o VmGpu) MarshalJSON() ([]byte, error) {
...
func (o VmGpu) ToMap() (map[string]interface{}, error) {
...
func (o *VmGpu) UnmarshalJSON(data []byte) (err error) {
	varVmGpu := _VmGpu{}

	err = json.Unmarshal(data, &varVmGpu)
...
type NullableVmGpu struct {
	value *VmGpu
	isSet bool
}

func (v NullableVmGpu) Get() *VmGpu {
	return v.value
}

func (v *NullableVmGpu) Set(val *VmGpu) {
	v.value = val
	v.isSet = true
}

func (v NullableVmGpu) IsSet() bool {
	return v.isSet
}

func (v *NullableVmGpu) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmGpu(val *VmGpu) *NullableVmGpu {
	return &NullableVmGpu{value: val, isSet: true}
}

func (v NullableVmGpu) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmGpu) UnmarshalJSON(src []byte) error {
	v.isSet = true
