...
// checks if the RoutingPolicyListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyListMetadataOutput{}

// RoutingPolicyListMetadataOutput All api calls that return a list will have this metadata block 
type RoutingPolicyListMetadataOutput struct {
	// The kind name
...
type _RoutingPolicyListMetadataOutput RoutingPolicyListMetadataOutput
...
func NewRoutingPolicyListMetadataOutput() *RoutingPolicyListMetadataOutput {
	this := RoutingPolicyListMetadataOutput{}
	var kind string = "routing_policy"
	this.Kind = &kind
	return &this
}
...
func (o RoutingPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varRoutingPolicyListMetadataOutput := _RoutingPolicyListMetadataOutput{}

	err = json.Unmarshal(data, &varRoutingPolicyListMetadataOutput)

	if err != nil {
		return err
	}

	*o = RoutingPolicyListMetadataOutput(varRoutingPolicyListMetadataOutput)
...
type NullableRoutingPolicyListMetadataOutput struct {
	value *RoutingPolicyListMetadataOutput
	isSet bool
}

func (v NullableRoutingPolicyListMetadataOutput) Get() *RoutingPolicyListMetadataOutput {
	return v.value
}

func (v *NullableRoutingPolicyListMetadataOutput) Set(val *RoutingPolicyListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyListMetadataOutput(val *RoutingPolicyListMetadataOutput) *NullableRoutingPolicyListMetadataOutput {
	return &NullableRoutingPolicyListMetadataOutput{value: val, isSet: true}
}

func (v NullableRoutingPolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
