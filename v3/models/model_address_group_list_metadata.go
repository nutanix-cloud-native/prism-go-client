...
// checks if the AddressGroupListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressGroupListMetadata{}

// AddressGroupListMetadata Api calls that return a list have this metadata block as input
type AddressGroupListMetadata struct {
	// The kind name
...
type _AddressGroupListMetadata AddressGroupListMetadata
...
func NewAddressGroupListMetadata() *AddressGroupListMetadata {
	this := AddressGroupListMetadata{}
	var kind string = "address_group"
	this.Kind = &kind
	return &this
}
...
func (o AddressGroupListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AddressGroupListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AddressGroupListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAddressGroupListMetadata := _AddressGroupListMetadata{}

	err = json.Unmarshal(data, &varAddressGroupListMetadata)

	if err != nil {
		return err
	}

	*o = AddressGroupListMetadata(varAddressGroupListMetadata)
...
type NullableAddressGroupListMetadata struct {
	value *AddressGroupListMetadata
	isSet bool
}

func (v NullableAddressGroupListMetadata) Get() *AddressGroupListMetadata {
	return v.value
}

func (v *NullableAddressGroupListMetadata) Set(val *AddressGroupListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressGroupListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressGroupListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressGroupListMetadata(val *AddressGroupListMetadata) *NullableAddressGroupListMetadata {
	return &NullableAddressGroupListMetadata{value: val, isSet: true}
}

func (v NullableAddressGroupListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressGroupListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
