...
// checks if the ReportInstanceReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstanceReference{}

// ReportInstanceReference The reference to a report_instance
type ReportInstanceReference struct {
	// The kind name
...
type _ReportInstanceReference ReportInstanceReference
...
func (o ReportInstanceReference) MarshalJSON() ([]byte, error) {
...
func (o ReportInstanceReference) ToMap() (map[string]interface{}, error) {
...
func (o *ReportInstanceReference) UnmarshalJSON(data []byte) (err error) {
	...
	varReportInstanceReference := _ReportInstanceReference{}

	err = json.Unmarshal(data, &varReportInstanceReference)

	if err != nil {
		return err
	}

	*o = ReportInstanceReference(varReportInstanceReference)
...
type NullableReportInstanceReference struct {
	value *ReportInstanceReference
	isSet bool
}

func (v NullableReportInstanceReference) Get() *ReportInstanceReference {
	return v.value
}

func (v *NullableReportInstanceReference) Set(val *ReportInstanceReference) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstanceReference) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstanceReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstanceReference(val *ReportInstanceReference) *NullableReportInstanceReference {
	return &NullableReportInstanceReference{value: val, isSet: true}
}

func (v NullableReportInstanceReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstanceReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
