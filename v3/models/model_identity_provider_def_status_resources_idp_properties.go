...
// checks if the IdentityProviderDefStatusResourcesIdpProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderDefStatusResourcesIdpProperties{}

// IdentityProviderDefStatusResourcesIdpProperties Urls and other info about the IDP.
type IdentityProviderDefStatusResourcesIdpProperties struct {
...
type _IdentityProviderDefStatusResourcesIdpProperties IdentityProviderDefStatusResourcesIdpProperties
...
func NewIdentityProviderDefStatusResourcesIdpProperties(loginUrl string, certificate string, idpUrl string) *IdentityProviderDefStatusResourcesIdpProperties {
	this := IdentityProviderDefStatusResourcesIdpProperties{}
...
func (o IdentityProviderDefStatusResourcesIdpProperties) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderDefStatusResourcesIdpProperties) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["login_url"] = o.LoginUrl
	toSerialize["certificate"] = o.Certificate
	toSerialize["idp_url"] = o.IdpUrl
	if !IsNil(o.ErrorUrl) {
		toSerialize["error_url"] = o.ErrorUrl
	}
...
func (o *IdentityProviderDefStatusResourcesIdpProperties) UnmarshalJSON(data []byte) (err error) {
	...
	varIdentityProviderDefStatusResourcesIdpProperties := _IdentityProviderDefStatusResourcesIdpProperties{}

	err = json.Unmarshal(data, &varIdentityProviderDefStatusResourcesIdpProperties)

	if err != nil {
		return err
	}

	*o = IdentityProviderDefStatusResourcesIdpProperties(varIdentityProviderDefStatusResourcesIdpProperties)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "idp_url")
		delete(additionalProperties, "error_url")
...
type NullableIdentityProviderDefStatusResourcesIdpProperties struct {
	value *IdentityProviderDefStatusResourcesIdpProperties
	isSet bool
}

func (v NullableIdentityProviderDefStatusResourcesIdpProperties) Get() *IdentityProviderDefStatusResourcesIdpProperties {
	return v.value
}

func (v *NullableIdentityProviderDefStatusResourcesIdpProperties) Set(val *IdentityProviderDefStatusResourcesIdpProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderDefStatusResourcesIdpProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderDefStatusResourcesIdpProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderDefStatusResourcesIdpProperties(val *IdentityProviderDefStatusResourcesIdpProperties) *NullableIdentityProviderDefStatusResourcesIdpProperties {
	return &NullableIdentityProviderDefStatusResourcesIdpProperties{value: val, isSet: true}
}

func (v NullableIdentityProviderDefStatusResourcesIdpProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderDefStatusResourcesIdpProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
