...
// checks if the AppProfileReferenceUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppProfileReferenceUpload{}

// AppProfileReferenceUpload The reference to a app_profile
type AppProfileReferenceUpload struct {
	// The kind name
...
type _AppProfileReferenceUpload AppProfileReferenceUpload
...
func NewAppProfileReferenceUpload(kind string, name string) *AppProfileReferenceUpload {
	this := AppProfileReferenceUpload{}
	this.Kind = kind
	this.Name = name
	return &this
}
...
func (o AppProfileReferenceUpload) MarshalJSON() ([]byte, error) {
...
func (o AppProfileReferenceUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppProfileReferenceUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppProfileReferenceUpload := _AppProfileReferenceUpload{}

	err = json.Unmarshal(data, &varAppProfileReferenceUpload)

	if err != nil {
		return err
	}

	*o = AppProfileReferenceUpload(varAppProfileReferenceUpload)
...
type NullableAppProfileReferenceUpload struct {
	value *AppProfileReferenceUpload
	isSet bool
}

func (v NullableAppProfileReferenceUpload) Get() *AppProfileReferenceUpload {
	return v.value
}

func (v *NullableAppProfileReferenceUpload) Set(val *AppProfileReferenceUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppProfileReferenceUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppProfileReferenceUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppProfileReferenceUpload(val *AppProfileReferenceUpload) *NullableAppProfileReferenceUpload {
	return &NullableAppProfileReferenceUpload{value: val, isSet: true}
}

func (v NullableAppProfileReferenceUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppProfileReferenceUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
