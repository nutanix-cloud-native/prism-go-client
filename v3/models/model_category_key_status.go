...
// checks if the CategoryKeyStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryKeyStatus{}

// CategoryKeyStatus Category Key Definition.
...
type _CategoryKeyStatus CategoryKeyStatus
...
func (o CategoryKeyStatus) MarshalJSON() ([]byte, error) {
...
func (o CategoryKeyStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryKeyStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryKeyStatus := _CategoryKeyStatus{}

	err = json.Unmarshal(data, &varCategoryKeyStatus)

	if err != nil {
		return err
	}

	*o = CategoryKeyStatus(varCategoryKeyStatus)
...
type NullableCategoryKeyStatus struct {
	value *CategoryKeyStatus
	isSet bool
}

func (v NullableCategoryKeyStatus) Get() *CategoryKeyStatus {
	return v.value
}

func (v *NullableCategoryKeyStatus) Set(val *CategoryKeyStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryKeyStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryKeyStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryKeyStatus(val *CategoryKeyStatus) *NullableCategoryKeyStatus {
	return &NullableCategoryKeyStatus{value: val, isSet: true}
}

func (v NullableCategoryKeyStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryKeyStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
