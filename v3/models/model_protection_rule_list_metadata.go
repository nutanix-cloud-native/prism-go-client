...
// checks if the ProtectionRuleListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleListMetadata{}

// ProtectionRuleListMetadata All api calls that return a list will have this metadata block as input 
type ProtectionRuleListMetadata struct {
	// The kind name
...
type _ProtectionRuleListMetadata ProtectionRuleListMetadata
...
func NewProtectionRuleListMetadata() *ProtectionRuleListMetadata {
	this := ProtectionRuleListMetadata{}
...
func (o ProtectionRuleListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionRuleListMetadata) UnmarshalJSON(data []byte) (err error) {
	varProtectionRuleListMetadata := _ProtectionRuleListMetadata{}

	err = json.Unmarshal(data, &varProtectionRuleListMetadata)

	if err != nil {
		return err
	}

	*o = ProtectionRuleListMetadata(varProtectionRuleListMetadata)
...
type NullableProtectionRuleListMetadata struct {
	value *ProtectionRuleListMetadata
	isSet bool
}

func (v NullableProtectionRuleListMetadata) Get() *ProtectionRuleListMetadata {
	return v.value
}

func (v *NullableProtectionRuleListMetadata) Set(val *ProtectionRuleListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleListMetadata(val *ProtectionRuleListMetadata) *NullableProtectionRuleListMetadata {
	return &NullableProtectionRuleListMetadata{value: val, isSet: true}
}

func (v NullableProtectionRuleListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
