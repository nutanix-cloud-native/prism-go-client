...
// checks if the ActionTypeListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTypeListMetadataOutput{}

// ActionTypeListMetadataOutput All api calls that return a list will have this metadata block 
type ActionTypeListMetadataOutput struct {
	// The kind name
...
type _ActionTypeListMetadataOutput ActionTypeListMetadataOutput
...
func NewActionTypeListMetadataOutput() *ActionTypeListMetadataOutput {
	this := ActionTypeListMetadataOutput{}
	var kind string = "action_type"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *ActionTypeListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o ActionTypeListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ActionTypeListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTypeListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varActionTypeListMetadataOutput := _ActionTypeListMetadataOutput{}

	err = json.Unmarshal(data, &varActionTypeListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ActionTypeListMetadataOutput(varActionTypeListMetadataOutput)
...
type NullableActionTypeListMetadataOutput struct {
	value *ActionTypeListMetadataOutput
	isSet bool
}

func (v NullableActionTypeListMetadataOutput) Get() *ActionTypeListMetadataOutput {
	return v.value
}

func (v *NullableActionTypeListMetadataOutput) Set(val *ActionTypeListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTypeListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTypeListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTypeListMetadataOutput(val *ActionTypeListMetadataOutput) *NullableActionTypeListMetadataOutput {
	return &NullableActionTypeListMetadataOutput{value: val, isSet: true}
}

func (v NullableActionTypeListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTypeListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
