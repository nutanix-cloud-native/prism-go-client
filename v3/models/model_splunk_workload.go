...
// checks if the SplunkWorkload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SplunkWorkload{}

// SplunkWorkload Splunk workload Object.
type SplunkWorkload struct {
	SearchUsers *int32 `json:"search_users,omitempty"`
	ColdRetentionDays *int32 `json:"cold_retention_days,omitempty"`
	DailyAverageIndexingRate *int32 `json:"daily_average_indexing_rate,omitempty"`
	HotRetentionDays *int32 `json:"hot_retention_days,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SplunkWorkload SplunkWorkload
...
// GetSearchUsers returns the SearchUsers field value if set, zero value otherwise.
func (o *SplunkWorkload) GetSearchUsers() int32 {
	if o == nil || IsNil(o.SearchUsers) {
		var ret int32
		return ret
	}
	return *o.SearchUsers
}

// GetSearchUsersOk returns a tuple with the SearchUsers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SplunkWorkload) GetSearchUsersOk() (*int32, bool) {
	if o == nil || IsNil(o.SearchUsers) {
		return nil, false
	}
	return o.SearchUsers, true
}
...
// SetSearchUsers gets a reference to the given int32 and assigns it to the SearchUsers field.
func (o *SplunkWorkload) SetSearchUsers(v int32) {
	o.SearchUsers = &v
}

// GetColdRetentionDays returns the ColdRetentionDays field value if set, zero value otherwise.
func (o *SplunkWorkload) GetColdRetentionDays() int32 {
	if o == nil || IsNil(o.ColdRetentionDays) {
		var ret int32
		return ret
	}
	return *o.ColdRetentionDays
}

// GetColdRetentionDaysOk returns a tuple with the ColdRetentionDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SplunkWorkload) GetColdRetentionDaysOk() (*int32, bool) {
	if o == nil || IsNil(o.ColdRetentionDays) {
		return nil, false
	}
	return o.ColdRetentionDays, true
}
...
// SetColdRetentionDays gets a reference to the given int32 and assigns it to the ColdRetentionDays field.
func (o *SplunkWorkload) SetColdRetentionDays(v int32) {
	o.ColdRetentionDays = &v
}

// GetDailyAverageIndexingRate returns the DailyAverageIndexingRate field value if set, zero value otherwise.
func (o *SplunkWorkload) GetDailyAverageIndexingRate() int32 {
	if o == nil || IsNil(o.DailyAverageIndexingRate) {
		var ret int32
		return ret
	}
	return *o.DailyAverageIndexingRate
}

// GetDailyAverageIndexingRateOk returns a tuple with the DailyAverageIndexingRate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SplunkWorkload) GetDailyAverageIndexingRateOk() (*int32, bool) {
	if o == nil || IsNil(o.DailyAverageIndexingRate) {
		return nil, false
	}
	return o.DailyAverageIndexingRate, true
}
...
// SetDailyAverageIndexingRate gets a reference to the given int32 and assigns it to the DailyAverageIndexingRate field.
func (o *SplunkWorkload) SetDailyAverageIndexingRate(v int32) {
	o.DailyAverageIndexingRate = &v
}

// GetHotRetentionDays returns the HotRetentionDays field value if set, zero value otherwise.
func (o *SplunkWorkload) GetHotRetentionDays() int32 {
	if o == nil || IsNil(o.HotRetentionDays) {
		var ret int32
		return ret
	}
	return *o.HotRetentionDays
}

// GetHotRetentionDaysOk returns a tuple with the HotRetentionDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SplunkWorkload) GetHotRetentionDaysOk() (*int32, bool) {
	if o == nil || IsNil(o.HotRetentionDays) {
		return nil, false
	}
	return o.HotRetentionDays, true
}
...
// SetHotRetentionDays gets a reference to the given int32 and assigns it to the HotRetentionDays field.
func (o *SplunkWorkload) SetHotRetentionDays(v int32) {
	o.HotRetentionDays = &v
}

func (o SplunkWorkload) MarshalJSON() ([]byte, error) {
...
func (o SplunkWorkload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SearchUsers) {
		toSerialize["search_users"] = o.SearchUsers
	}
	if !IsNil(o.ColdRetentionDays) {
		toSerialize["cold_retention_days"] = o.ColdRetentionDays
	}
	if !IsNil(o.DailyAverageIndexingRate) {
		toSerialize["daily_average_indexing_rate"] = o.DailyAverageIndexingRate
	}
	if !IsNil(o.HotRetentionDays) {
		toSerialize["hot_retention_days"] = o.HotRetentionDays
	}
...
func (o *SplunkWorkload) UnmarshalJSON(data []byte) (err error) {
	varSplunkWorkload := _SplunkWorkload{}

	err = json.Unmarshal(data, &varSplunkWorkload)

	if err != nil {
		return err
	}

	*o = SplunkWorkload(varSplunkWorkload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "search_users")
		delete(additionalProperties, "cold_retention_days")
		delete(additionalProperties, "daily_average_indexing_rate")
		delete(additionalProperties, "hot_retention_days")
...
type NullableSplunkWorkload struct {
	value *SplunkWorkload
	isSet bool
}

func (v NullableSplunkWorkload) Get() *SplunkWorkload {
	return v.value
}

func (v *NullableSplunkWorkload) Set(val *SplunkWorkload) {
	v.value = val
	v.isSet = true
}

func (v NullableSplunkWorkload) IsSet() bool {
	return v.isSet
}

func (v *NullableSplunkWorkload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSplunkWorkload(val *SplunkWorkload) *NullableSplunkWorkload {
	return &NullableSplunkWorkload{value: val, isSet: true}
}

func (v NullableSplunkWorkload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSplunkWorkload) UnmarshalJSON(src []byte) error {
	v.isSet = true
