...
// checks if the WidgetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WidgetConfig{}

// WidgetConfig Configuration of the widget.
type WidgetConfig struct {
	// List of selected fields for the widget.
	WidgetFieldList []WidgetFieldDescriptor `json:"widget_field_list,omitempty"`
	// Type of the entity.
	EntityType *string `json:"entity_type,omitempty"`
	RepetitionCriteria *RepetitionCriteria `json:"repetition_criteria,omitempty"`
	WidgetDataProjection *WidgetDataProjection `json:"widget_data_projection,omitempty"`
	...
	WidgetHeading *string `json:"widget_heading,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _WidgetConfig WidgetConfig
...
// GetWidgetFieldList returns the WidgetFieldList field value if set, zero value otherwise.
func (o *WidgetConfig) GetWidgetFieldList() []WidgetFieldDescriptor {
	if o == nil || IsNil(o.WidgetFieldList) {
		var ret []WidgetFieldDescriptor
		return ret
	}
	return o.WidgetFieldList
}

// GetWidgetFieldListOk returns a tuple with the WidgetFieldList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WidgetConfig) GetWidgetFieldListOk() ([]WidgetFieldDescriptor, bool) {
	if o == nil || IsNil(o.WidgetFieldList) {
		return nil, false
	}
	return o.WidgetFieldList, true
}
...
// SetWidgetFieldList gets a reference to the given []WidgetFieldDescriptor and assigns it to the WidgetFieldList field.
...
// SetRepetitionCriteria gets a reference to the given RepetitionCriteria and assigns it to the RepetitionCriteria field.
func (o *WidgetConfig) SetRepetitionCriteria(v RepetitionCriteria) {
	o.RepetitionCriteria = &v
}

// GetWidgetDataProjection returns the WidgetDataProjection field value if set, zero value otherwise.
func (o *WidgetConfig) GetWidgetDataProjection() WidgetDataProjection {
	if o == nil || IsNil(o.WidgetDataProjection) {
		var ret WidgetDataProjection
		return ret
	}
	return *o.WidgetDataProjection
}

// GetWidgetDataProjectionOk returns a tuple with the WidgetDataProjection field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WidgetConfig) GetWidgetDataProjectionOk() (*WidgetDataProjection, bool) {
	if o == nil || IsNil(o.WidgetDataProjection) {
		return nil, false
	}
	return o.WidgetDataProjection, true
}
...
// SetWidgetDataProjection gets a reference to the given WidgetDataProjection and assigns it to the WidgetDataProjection field.
func (o *WidgetConfig) SetWidgetDataProjection(v WidgetDataProjection) {
	o.WidgetDataProjection = &v
}

// GetWidgetDescription returns the WidgetDescription field value if set, zero value otherwise.
func (o *WidgetConfig) GetWidgetDescription() string {
	if o == nil || IsNil(o.WidgetDescription) {
		var ret string
		return ret
	}
	return *o.WidgetDescription
}

// GetWidgetDescriptionOk returns a tuple with the WidgetDescription field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WidgetConfig) GetWidgetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.WidgetDescription) {
		return nil, false
	}
	return o.WidgetDescription, true
}
...
// SetWidgetDescription gets a reference to the given string and assigns it to the WidgetDescription field.
func (o *WidgetConfig) SetWidgetDescription(v string) {
	o.WidgetDescription = &v
}
...
// SetWidgetSize gets a reference to the given string and assigns it to the WidgetSize field.
func (o *WidgetConfig) SetWidgetSize(v string) {
	o.WidgetSize = &v
}

// GetWidgetHeading returns the WidgetHeading field value if set, zero value otherwise.
func (o *WidgetConfig) GetWidgetHeading() string {
	if o == nil || IsNil(o.WidgetHeading) {
		var ret string
		return ret
	}
	return *o.WidgetHeading
}

// GetWidgetHeadingOk returns a tuple with the WidgetHeading field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WidgetConfig) GetWidgetHeadingOk() (*string, bool) {
	if o == nil || IsNil(o.WidgetHeading) {
		return nil, false
	}
	return o.WidgetHeading, true
}
...
// SetWidgetHeading gets a reference to the given string and assigns it to the WidgetHeading field.
func (o *WidgetConfig) SetWidgetHeading(v string) {
	o.WidgetHeading = &v
}

func (o WidgetConfig) MarshalJSON() ([]byte, error) {
...
func (o WidgetConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.WidgetFieldList) {
		toSerialize["widget_field_list"] = o.WidgetFieldList
	}
	if !IsNil(o.EntityType) {
		toSerialize["entity_type"] = o.EntityType
	}
	if !IsNil(o.RepetitionCriteria) {
		toSerialize["repetition_criteria"] = o.RepetitionCriteria
	}
	if !IsNil(o.WidgetDataProjection) {
		toSerialize["widget_data_projection"] = o.WidgetDataProjection
	}
	if !IsNil(o.WidgetDescription) {
		toSerialize["widget_description"] = o.WidgetDescription
	}
	toSerialize["widget_type"] = o.WidgetType
	if !IsNil(o.WidgetSize) {
		toSerialize["widget_size"] = o.WidgetSize
	}
	if !IsNil(o.WidgetHeading) {
		toSerialize["widget_heading"] = o.WidgetHeading
	}
...
func (o *WidgetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varWidgetConfig := _WidgetConfig{}

	err = json.Unmarshal(data, &varWidgetConfig)

	if err != nil {
		return err
	}

	*o = WidgetConfig(varWidgetConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "widget_field_list")
		delete(additionalProperties, "entity_type")
		delete(additionalProperties, "repetition_criteria")
		delete(additionalProperties, "widget_data_projection")
		delete(additionalProperties, "widget_description")
		delete(additionalProperties, "widget_type")
		delete(additionalProperties, "widget_size")
		delete(additionalProperties, "widget_heading")
...
type NullableWidgetConfig struct {
	value *WidgetConfig
	isSet bool
}

func (v NullableWidgetConfig) Get() *WidgetConfig {
	return v.value
}

func (v *NullableWidgetConfig) Set(val *WidgetConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableWidgetConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableWidgetConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWidgetConfig(val *WidgetConfig) *NullableWidgetConfig {
	return &NullableWidgetConfig{value: val, isSet: true}
}

func (v NullableWidgetConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWidgetConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
