...
// checks if the VpcRouteTableMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcRouteTableMetadata{}

// VpcRouteTableMetadata The vpc_route_table kind metadata
type VpcRouteTableMetadata struct {
	// UTC date and time in RFC-3339 format when vpc_route_table was last updated 
	...
	// UTC date and time in RFC-3339 format when vpc_route_table was created 
	...
	// Categories for the vpc_route_table. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the vpc_route_table. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _VpcRouteTableMetadata VpcRouteTableMetadata
...
func (o VpcRouteTableMetadata) MarshalJSON() ([]byte, error) {
...
func (o VpcRouteTableMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VpcRouteTableMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVpcRouteTableMetadata := _VpcRouteTableMetadata{}

	err = json.Unmarshal(data, &varVpcRouteTableMetadata)

	if err != nil {
		return err
	}

	*o = VpcRouteTableMetadata(varVpcRouteTableMetadata)
...
type NullableVpcRouteTableMetadata struct {
	value *VpcRouteTableMetadata
	isSet bool
}

func (v NullableVpcRouteTableMetadata) Get() *VpcRouteTableMetadata {
	return v.value
}

func (v *NullableVpcRouteTableMetadata) Set(val *VpcRouteTableMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcRouteTableMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcRouteTableMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcRouteTableMetadata(val *VpcRouteTableMetadata) *NullableVpcRouteTableMetadata {
	return &NullableVpcRouteTableMetadata{value: val, isSet: true}
}

func (v NullableVpcRouteTableMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcRouteTableMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
