...
// checks if the InternalRoutingProtocolConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InternalRoutingProtocolConfig{}

// InternalRoutingProtocolConfig Describes the routing protocol configuration spec needed by this gateway to peer and learn routes from internal routers using either iBGP or OSFP. 
type InternalRoutingProtocolConfig struct {
	// list of local prefixes to be advertised over eBGP
	LocalPrefixList []IpSubnet `json:"local_prefix_list,omitempty"`
	// iBGP configuration.
	IbgpConfigList []BgpConfig `json:"ibgp_config_list,omitempty"`
	OspfConfig *OspfConfig `json:"ospf_config,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _InternalRoutingProtocolConfig InternalRoutingProtocolConfig
...
func NewInternalRoutingProtocolConfig() *InternalRoutingProtocolConfig {
	this := InternalRoutingProtocolConfig{}
	return &this
}
...
// SetLocalPrefixList gets a reference to the given []IpSubnet and assigns it to the LocalPrefixList field.
...
// SetIbgpConfigList gets a reference to the given []BgpConfig and assigns it to the IbgpConfigList field.
...
func (o InternalRoutingProtocolConfig) MarshalJSON() ([]byte, error) {
...
func (o InternalRoutingProtocolConfig) ToMap() (map[string]interface{}, error) {
...
func (o *InternalRoutingProtocolConfig) UnmarshalJSON(data []byte) (err error) {
	varInternalRoutingProtocolConfig := _InternalRoutingProtocolConfig{}

	err = json.Unmarshal(data, &varInternalRoutingProtocolConfig)

	if err != nil {
		return err
	}

	*o = InternalRoutingProtocolConfig(varInternalRoutingProtocolConfig)
...
type NullableInternalRoutingProtocolConfig struct {
	value *InternalRoutingProtocolConfig
	isSet bool
}

func (v NullableInternalRoutingProtocolConfig) Get() *InternalRoutingProtocolConfig {
	return v.value
}

func (v *NullableInternalRoutingProtocolConfig) Set(val *InternalRoutingProtocolConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableInternalRoutingProtocolConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableInternalRoutingProtocolConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInternalRoutingProtocolConfig(val *InternalRoutingProtocolConfig) *NullableInternalRoutingProtocolConfig {
	return &NullableInternalRoutingProtocolConfig{value: val, isSet: true}
}

func (v NullableInternalRoutingProtocolConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInternalRoutingProtocolConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
