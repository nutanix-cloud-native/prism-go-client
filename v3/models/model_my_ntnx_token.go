...
// checks if the MyNtnxToken type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MyNtnxToken{}
...
// GetSubscopeId returns the SubscopeId field value
...
// GetSubscopeIdOk returns a tuple with the SubscopeId field value
// and a boolean to check if the value has been set.
func (o *MyNtnxToken) GetSubscopeIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SubscopeId, true
}

// SetSubscopeId sets field value
func (o *MyNtnxToken) SetSubscopeId(v string) {
	o.SubscopeId = v
}

func (o MyNtnxToken) MarshalJSON() ([]byte, error) {
...
func (o MyNtnxToken) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["key_id"] = o.KeyId
	toSerialize["api_key"] = o.ApiKey
	toSerialize["scope_id"] = o.ScopeId
	toSerialize["subscope_id"] = o.SubscopeId
...
func (o *MyNtnxToken) UnmarshalJSON(data []byte) (err error) {
	...
	varMyNtnxToken := _MyNtnxToken{}

	err = json.Unmarshal(data, &varMyNtnxToken)

	if err != nil {
		return err
	}

	*o = MyNtnxToken(varMyNtnxToken)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "subscope_id")
...
type NullableMyNtnxToken struct {
	value *MyNtnxToken
	isSet bool
}

func (v NullableMyNtnxToken) Get() *MyNtnxToken {
	return v.value
}

func (v *NullableMyNtnxToken) Set(val *MyNtnxToken) {
	v.value = val
	v.isSet = true
}

func (v NullableMyNtnxToken) IsSet() bool {
	return v.isSet
}

func (v *NullableMyNtnxToken) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMyNtnxToken(val *MyNtnxToken) *NullableMyNtnxToken {
	return &NullableMyNtnxToken{value: val, isSet: true}
}

func (v NullableMyNtnxToken) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMyNtnxToken) UnmarshalJSON(src []byte) error {
	v.isSet = true
