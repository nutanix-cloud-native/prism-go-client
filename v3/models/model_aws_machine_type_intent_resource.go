...
// checks if the AwsMachineTypeIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsMachineTypeIntentResource{}

// AwsMachineTypeIntentResource aws_machine_type entity
type AwsMachineTypeIntentResource struct {
	Status *AwsMachineTypeDefStatus `json:"status,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsMachineTypeMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsMachineTypeIntentResource AwsMachineTypeIntentResource
...
func NewAwsMachineTypeIntentResource(apiVersion string, metadata AwsMachineTypeMetadata) *AwsMachineTypeIntentResource {
	this := AwsMachineTypeIntentResource{}
...
func (o *AwsMachineTypeIntentResource) GetStatus() AwsMachineTypeDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret AwsMachineTypeDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given AwsMachineTypeDefStatus and assigns it to the Status field.
...
func (o *AwsMachineTypeIntentResource) GetMetadata() AwsMachineTypeMetadata {
	if o == nil {
		var ret AwsMachineTypeMetadata
		return ret
	}
...
func (o AwsMachineTypeIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsMachineTypeIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsMachineTypeIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsMachineTypeIntentResource := _AwsMachineTypeIntentResource{}

	err = json.Unmarshal(data, &varAwsMachineTypeIntentResource)

	if err != nil {
		return err
	}

	*o = AwsMachineTypeIntentResource(varAwsMachineTypeIntentResource)
...
type NullableAwsMachineTypeIntentResource struct {
	value *AwsMachineTypeIntentResource
	isSet bool
}

func (v NullableAwsMachineTypeIntentResource) Get() *AwsMachineTypeIntentResource {
	return v.value
}

func (v *NullableAwsMachineTypeIntentResource) Set(val *AwsMachineTypeIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsMachineTypeIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsMachineTypeIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsMachineTypeIntentResource(val *AwsMachineTypeIntentResource) *NullableAwsMachineTypeIntentResource {
	return &NullableAwsMachineTypeIntentResource{value: val, isSet: true}
}

func (v NullableAwsMachineTypeIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsMachineTypeIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
