...
// checks if the AppRunlogArchiveResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunlogArchiveResponse{}

// AppRunlogArchiveResponse App Archive Response
type AppRunlogArchiveResponse struct {
	// Archive file name.
	Name *string `json:"name,omitempty"`
	// From time for archive.
	StartTime *time.Time `json:"start_time,omitempty"`
	// Creation time of archive.
	CreationTime *time.Time `json:"creation_time,omitempty"`
	// Archive available flag.
	IsAvailable *bool `json:"is_available,omitempty"`
	// Till time for archive.
...
type _AppRunlogArchiveResponse AppRunlogArchiveResponse
...
func (o AppRunlogArchiveResponse) MarshalJSON() ([]byte, error) {
...
func (o AppRunlogArchiveResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunlogArchiveResponse) UnmarshalJSON(data []byte) (err error) {
	varAppRunlogArchiveResponse := _AppRunlogArchiveResponse{}

	err = json.Unmarshal(data, &varAppRunlogArchiveResponse)

	if err != nil {
		return err
	}

	*o = AppRunlogArchiveResponse(varAppRunlogArchiveResponse)
...
type NullableAppRunlogArchiveResponse struct {
	value *AppRunlogArchiveResponse
	isSet bool
}

func (v NullableAppRunlogArchiveResponse) Get() *AppRunlogArchiveResponse {
	return v.value
}

func (v *NullableAppRunlogArchiveResponse) Set(val *AppRunlogArchiveResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunlogArchiveResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunlogArchiveResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunlogArchiveResponse(val *AppRunlogArchiveResponse) *NullableAppRunlogArchiveResponse {
	return &NullableAppRunlogArchiveResponse{value: val, isSet: true}
}

func (v NullableAppRunlogArchiveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunlogArchiveResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
