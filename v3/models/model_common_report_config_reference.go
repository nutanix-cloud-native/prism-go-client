...
// checks if the CommonReportConfigReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigReference{}

// CommonReportConfigReference The reference to a common_report_config
type CommonReportConfigReference struct {
	// The kind name
...
type _CommonReportConfigReference CommonReportConfigReference
...
func NewCommonReportConfigReference(kind string, uUID string) *CommonReportConfigReference {
	this := CommonReportConfigReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o CommonReportConfigReference) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigReference) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfigReference) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonReportConfigReference := _CommonReportConfigReference{}

	err = json.Unmarshal(data, &varCommonReportConfigReference)

	if err != nil {
		return err
	}

	*o = CommonReportConfigReference(varCommonReportConfigReference)
...
type NullableCommonReportConfigReference struct {
	value *CommonReportConfigReference
	isSet bool
}

func (v NullableCommonReportConfigReference) Get() *CommonReportConfigReference {
	return v.value
}

func (v *NullableCommonReportConfigReference) Set(val *CommonReportConfigReference) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigReference) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigReference(val *CommonReportConfigReference) *NullableCommonReportConfigReference {
	return &NullableCommonReportConfigReference{value: val, isSet: true}
}

func (v NullableCommonReportConfigReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
