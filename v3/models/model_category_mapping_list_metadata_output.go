...
// checks if the CategoryMappingListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingListMetadataOutput{}

// CategoryMappingListMetadataOutput All api calls that return a list will have this metadata block 
type CategoryMappingListMetadataOutput struct {
	// The kind name
...
type _CategoryMappingListMetadataOutput CategoryMappingListMetadataOutput
...
func NewCategoryMappingListMetadataOutput() *CategoryMappingListMetadataOutput {
	this := CategoryMappingListMetadataOutput{}
	var kind string = "category_mapping"
	this.Kind = &kind
	return &this
}
...
func (o CategoryMappingListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varCategoryMappingListMetadataOutput := _CategoryMappingListMetadataOutput{}

	err = json.Unmarshal(data, &varCategoryMappingListMetadataOutput)

	if err != nil {
		return err
	}

	*o = CategoryMappingListMetadataOutput(varCategoryMappingListMetadataOutput)
...
type NullableCategoryMappingListMetadataOutput struct {
	value *CategoryMappingListMetadataOutput
	isSet bool
}

func (v NullableCategoryMappingListMetadataOutput) Get() *CategoryMappingListMetadataOutput {
	return v.value
}

func (v *NullableCategoryMappingListMetadataOutput) Set(val *CategoryMappingListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingListMetadataOutput(val *CategoryMappingListMetadataOutput) *NullableCategoryMappingListMetadataOutput {
	return &NullableCategoryMappingListMetadataOutput{value: val, isSet: true}
}

func (v NullableCategoryMappingListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
