...
// checks if the CitrixResourceLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CitrixResourceLocation{}

// CitrixResourceLocation Resource Location on Citrix Cloud.
...
type _CitrixResourceLocation CitrixResourceLocation
...
func (o CitrixResourceLocation) MarshalJSON() ([]byte, error) {
...
func (o CitrixResourceLocation) ToMap() (map[string]interface{}, error) {
...
func (o *CitrixResourceLocation) UnmarshalJSON(data []byte) (err error) {
	varCitrixResourceLocation := _CitrixResourceLocation{}

	err = json.Unmarshal(data, &varCitrixResourceLocation)

	if err != nil {
		return err
	}

	*o = CitrixResourceLocation(varCitrixResourceLocation)
...
type NullableCitrixResourceLocation struct {
	value *CitrixResourceLocation
	isSet bool
}

func (v NullableCitrixResourceLocation) Get() *CitrixResourceLocation {
	return v.value
}

func (v *NullableCitrixResourceLocation) Set(val *CitrixResourceLocation) {
	v.value = val
	v.isSet = true
}

func (v NullableCitrixResourceLocation) IsSet() bool {
	return v.isSet
}

func (v *NullableCitrixResourceLocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCitrixResourceLocation(val *CitrixResourceLocation) *NullableCitrixResourceLocation {
	return &NullableCitrixResourceLocation{value: val, isSet: true}
}

func (v NullableCitrixResourceLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCitrixResourceLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
