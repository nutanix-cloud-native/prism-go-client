...
// checks if the ProtectionRuleMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleMetadata{}

// ProtectionRuleMetadata The protection_rule kind metadata
type ProtectionRuleMetadata struct {
	...
	// Categories for the protection_rule. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// protection_rule name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ProtectionRuleMetadata ProtectionRuleMetadata
...
func (o *ProtectionRuleMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *ProtectionRuleMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *ProtectionRuleMetadata) SetName(v string) {
	o.Name = &v
}

func (o ProtectionRuleMetadata) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionRuleMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varProtectionRuleMetadata := _ProtectionRuleMetadata{}

	err = json.Unmarshal(data, &varProtectionRuleMetadata)

	if err != nil {
		return err
	}

	*o = ProtectionRuleMetadata(varProtectionRuleMetadata)
...
type NullableProtectionRuleMetadata struct {
	value *ProtectionRuleMetadata
	isSet bool
}

func (v NullableProtectionRuleMetadata) Get() *ProtectionRuleMetadata {
	return v.value
}

func (v *NullableProtectionRuleMetadata) Set(val *ProtectionRuleMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleMetadata(val *ProtectionRuleMetadata) *NullableProtectionRuleMetadata {
	return &NullableProtectionRuleMetadata{value: val, isSet: true}
}

func (v NullableProtectionRuleMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
