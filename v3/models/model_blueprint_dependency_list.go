...
// checks if the BlueprintDependencyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintDependencyList{}

// BlueprintDependencyList Depends on definition for Application.
type BlueprintDependencyList struct {
	// 
	GetterResourceKind string `json:"getter_resource_kind"`
	// 
	FromResourceKind *string `json:"from_resource_kind,omitempty"`
	// 
	SetterResourceKind string `json:"setter_resource_kind"`
	// 
	SetterResourceName string `json:"setter_resource_name"`
	// 
	ActionName string `json:"action_name"`
	// 
	ActionResourceName string `json:"action_resource_name"`
	// 
	GetterResourceName string `json:"getter_resource_name"`
	// 
	SetterResourceAttr string `json:"setter_resource_attr"`
	// 
	ActionResourceKind string `json:"action_resource_kind"`
	AdditionalProperties map[string]interface{}
}

type _BlueprintDependencyList BlueprintDependencyList
...
func NewBlueprintDependencyList(getterResourceKind string, setterResourceKind string, setterResourceName string, actionName string, actionResourceName string, getterResourceName string, setterResourceAttr string, actionResourceKind string) *BlueprintDependencyList {
	this := BlueprintDependencyList{}
	this.GetterResourceKind = getterResourceKind
	this.SetterResourceKind = setterResourceKind
	this.SetterResourceName = setterResourceName
	this.ActionName = actionName
	this.ActionResourceName = actionResourceName
	this.GetterResourceName = getterResourceName
	this.SetterResourceAttr = setterResourceAttr
	this.ActionResourceKind = actionResourceKind
	return &this
}
...
// GetGetterResourceKind returns the GetterResourceKind field value
func (o *BlueprintDependencyList) GetGetterResourceKind() string {
	...
	return o.GetterResourceKind
}

// GetGetterResourceKindOk returns a tuple with the GetterResourceKind field value
// and a boolean to check if the value has been set.
func (o *BlueprintDependencyList) GetGetterResourceKindOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.GetterResourceKind, true
}

// SetGetterResourceKind sets field value
func (o *BlueprintDependencyList) SetGetterResourceKind(v string) {
	o.GetterResourceKind = v
}

// GetFromResourceKind returns the FromResourceKind field value if set, zero value otherwise.
func (o *BlueprintDependencyList) GetFromResourceKind() string {
	if o == nil || IsNil(o.FromResourceKind) {
		var ret string
		return ret
	}
	return *o.FromResourceKind
}

// GetFromResourceKindOk returns a tuple with the FromResourceKind field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDependencyList) GetFromResourceKindOk() (*string, bool) {
	if o == nil || IsNil(o.FromResourceKind) {
		return nil, false
	}
	return o.FromResourceKind, true
}
...
// SetFromResourceKind gets a reference to the given string and assigns it to the FromResourceKind field.
func (o *BlueprintDependencyList) SetFromResourceKind(v string) {
	o.FromResourceKind = &v
}

// GetSetterResourceKind returns the SetterResourceKind field value
func (o *BlueprintDependencyList) GetSetterResourceKind() string {
	...
	return o.SetterResourceKind
}

// GetSetterResourceKindOk returns a tuple with the SetterResourceKind field value
// and a boolean to check if the value has been set.
func (o *BlueprintDependencyList) GetSetterResourceKindOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SetterResourceKind, true
}

// SetSetterResourceKind sets field value
func (o *BlueprintDependencyList) SetSetterResourceKind(v string) {
	o.SetterResourceKind = v
}

// GetSetterResourceName returns the SetterResourceName field value
func (o *BlueprintDependencyList) GetSetterResourceName() string {
	...
	return o.SetterResourceName
}

// GetSetterResourceNameOk returns a tuple with the SetterResourceName field value
// and a boolean to check if the value has been set.
func (o *BlueprintDependencyList) GetSetterResourceNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SetterResourceName, true
}

// SetSetterResourceName sets field value
func (o *BlueprintDependencyList) SetSetterResourceName(v string) {
	o.SetterResourceName = v
}
...
// GetActionResourceName returns the ActionResourceName field value
func (o *BlueprintDependencyList) GetActionResourceName() string {
	...
	return o.ActionResourceName
}

// GetActionResourceNameOk returns a tuple with the ActionResourceName field value
// and a boolean to check if the value has been set.
func (o *BlueprintDependencyList) GetActionResourceNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActionResourceName, true
}

// SetActionResourceName sets field value
func (o *BlueprintDependencyList) SetActionResourceName(v string) {
	o.ActionResourceName = v
}

// GetGetterResourceName returns the GetterResourceName field value
func (o *BlueprintDependencyList) GetGetterResourceName() string {
	if o == nil {
		var ret string
		return ret
	}

	return o.GetterResourceName
}

// GetGetterResourceNameOk returns a tuple with the GetterResourceName field value
// and a boolean to check if the value has been set.
func (o *BlueprintDependencyList) GetGetterResourceNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.GetterResourceName, true
}

// SetGetterResourceName sets field value
func (o *BlueprintDependencyList) SetGetterResourceName(v string) {
	o.GetterResourceName = v
}

// GetSetterResourceAttr returns the SetterResourceAttr field value
func (o *BlueprintDependencyList) GetSetterResourceAttr() string {
	...
	return o.SetterResourceAttr
}

// GetSetterResourceAttrOk returns a tuple with the SetterResourceAttr field value
// and a boolean to check if the value has been set.
func (o *BlueprintDependencyList) GetSetterResourceAttrOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SetterResourceAttr, true
}

// SetSetterResourceAttr sets field value
func (o *BlueprintDependencyList) SetSetterResourceAttr(v string) {
	o.SetterResourceAttr = v
}

// GetActionResourceKind returns the ActionResourceKind field value
func (o *BlueprintDependencyList) GetActionResourceKind() string {
	...
	return o.ActionResourceKind
}

// GetActionResourceKindOk returns a tuple with the ActionResourceKind field value
// and a boolean to check if the value has been set.
func (o *BlueprintDependencyList) GetActionResourceKindOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActionResourceKind, true
}

// SetActionResourceKind sets field value
func (o *BlueprintDependencyList) SetActionResourceKind(v string) {
	o.ActionResourceKind = v
}

func (o BlueprintDependencyList) MarshalJSON() ([]byte, error) {
...
func (o BlueprintDependencyList) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["getter_resource_kind"] = o.GetterResourceKind
	if !IsNil(o.FromResourceKind) {
		toSerialize["from_resource_kind"] = o.FromResourceKind
	}
	toSerialize["setter_resource_kind"] = o.SetterResourceKind
	toSerialize["setter_resource_name"] = o.SetterResourceName
	toSerialize["action_name"] = o.ActionName
	toSerialize["action_resource_name"] = o.ActionResourceName
	toSerialize["getter_resource_name"] = o.GetterResourceName
	toSerialize["setter_resource_attr"] = o.SetterResourceAttr
	toSerialize["action_resource_kind"] = o.ActionResourceKind
...
func (o *BlueprintDependencyList) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintDependencyList := _BlueprintDependencyList{}

	err = json.Unmarshal(data, &varBlueprintDependencyList)

	if err != nil {
		return err
	}

	*o = BlueprintDependencyList(varBlueprintDependencyList)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "getter_resource_kind")
		delete(additionalProperties, "from_resource_kind")
		delete(additionalProperties, "setter_resource_kind")
		delete(additionalProperties, "setter_resource_name")
		delete(additionalProperties, "action_name")
		delete(additionalProperties, "action_resource_name")
		delete(additionalProperties, "getter_resource_name")
		delete(additionalProperties, "setter_resource_attr")
		delete(additionalProperties, "action_resource_kind")
...
type NullableBlueprintDependencyList struct {
	value *BlueprintDependencyList
	isSet bool
}

func (v NullableBlueprintDependencyList) Get() *BlueprintDependencyList {
	return v.value
}

func (v *NullableBlueprintDependencyList) Set(val *BlueprintDependencyList) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintDependencyList) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintDependencyList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintDependencyList(val *BlueprintDependencyList) *NullableBlueprintDependencyList {
	return &NullableBlueprintDependencyList{value: val, isSet: true}
}

func (v NullableBlueprintDependencyList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintDependencyList) UnmarshalJSON(src []byte) error {
	v.isSet = true
