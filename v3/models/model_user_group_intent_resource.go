...
// checks if the UserGroupIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupIntentResource{}

// UserGroupIntentResource Response object for intentful operations on a user_group
type UserGroupIntentResource struct {
	Status *UserGroupDefStatus `json:"status,omitempty"`
	Spec *UserGroup `json:"spec,omitempty"`
...
type _UserGroupIntentResource UserGroupIntentResource
...
// SetStatus gets a reference to the given UserGroupDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given UserGroup and assigns it to the Spec field.
...
func (o UserGroupIntentResource) MarshalJSON() ([]byte, error) {
...
func (o UserGroupIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *UserGroupIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varUserGroupIntentResource := _UserGroupIntentResource{}

	err = json.Unmarshal(data, &varUserGroupIntentResource)

	if err != nil {
		return err
	}

	*o = UserGroupIntentResource(varUserGroupIntentResource)
...
type NullableUserGroupIntentResource struct {
	value *UserGroupIntentResource
	isSet bool
}

func (v NullableUserGroupIntentResource) Get() *UserGroupIntentResource {
	return v.value
}

func (v *NullableUserGroupIntentResource) Set(val *UserGroupIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupIntentResource(val *UserGroupIntentResource) *NullableUserGroupIntentResource {
	return &NullableUserGroupIntentResource{value: val, isSet: true}
}

func (v NullableUserGroupIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
