...
// checks if the BlueprintDeploymentInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintDeploymentInputUpload{}

// BlueprintDeploymentInputUpload Deployment definition for Application.
type BlueprintDeploymentInputUpload struct {
	// 
	...
	ActionList []AppActionInputUpload `json:"action_list,omitempty"`
	...
	// 
	VariableList []AppVariableInputUpload `json:"variable_list,omitempty"`
...
type _BlueprintDeploymentInputUpload BlueprintDeploymentInputUpload
...
func NewBlueprintDeploymentInputUpload(name string, maxReplicas string, substrateLocalReference AppSubstrateReferenceUpload, minReplicas string) *BlueprintDeploymentInputUpload {
	this := BlueprintDeploymentInputUpload{}
	this.Name = name
...
// SetActionList gets a reference to the given []AppActionInputUpload and assigns it to the ActionList field.
...
func (o *BlueprintDeploymentInputUpload) GetVariableList() []AppVariableInputUpload {
	if o == nil || IsNil(o.VariableList) {
		var ret []AppVariableInputUpload
		return ret
	}
...
// SetVariableList gets a reference to the given []AppVariableInputUpload and assigns it to the VariableList field.
...
func (o BlueprintDeploymentInputUpload) MarshalJSON() ([]byte, error) {
...
func (o BlueprintDeploymentInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintDeploymentInputUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintDeploymentInputUpload := _BlueprintDeploymentInputUpload{}

	err = json.Unmarshal(data, &varBlueprintDeploymentInputUpload)

	if err != nil {
		return err
	}

	*o = BlueprintDeploymentInputUpload(varBlueprintDeploymentInputUpload)
...
type NullableBlueprintDeploymentInputUpload struct {
	value *BlueprintDeploymentInputUpload
	isSet bool
}

func (v NullableBlueprintDeploymentInputUpload) Get() *BlueprintDeploymentInputUpload {
	return v.value
}

func (v *NullableBlueprintDeploymentInputUpload) Set(val *BlueprintDeploymentInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintDeploymentInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintDeploymentInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintDeploymentInputUpload(val *BlueprintDeploymentInputUpload) *NullableBlueprintDeploymentInputUpload {
	return &NullableBlueprintDeploymentInputUpload{value: val, isSet: true}
}

func (v NullableBlueprintDeploymentInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintDeploymentInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
