...
// checks if the ProjectInternalDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectInternalDefStatus{}

// ProjectInternalDefStatus A Project resource, combined with Users and ACPs.
type ProjectInternalDefStatus struct {
	// The list of access control policies associates with users in the project. 
	AccessControlPolicyListStatus []ProjectInternalDefStatusAccessControlPolicyListStatusInner `json:"access_control_policy_list_status,omitempty"`
	ProjectStatus ProjectResourceStatus `json:"project_status"`
	AdditionalProperties map[string]interface{}
}

type _ProjectInternalDefStatus ProjectInternalDefStatus
...
// GetAccessControlPolicyListStatus returns the AccessControlPolicyListStatus field value if set, zero value otherwise.
func (o *ProjectInternalDefStatus) GetAccessControlPolicyListStatus() []ProjectInternalDefStatusAccessControlPolicyListStatusInner {
	if o == nil || IsNil(o.AccessControlPolicyListStatus) {
		var ret []ProjectInternalDefStatusAccessControlPolicyListStatusInner
		return ret
	}
	return o.AccessControlPolicyListStatus
}

// GetAccessControlPolicyListStatusOk returns a tuple with the AccessControlPolicyListStatus field value if set, nil otherwise
...
func (o *ProjectInternalDefStatus) GetAccessControlPolicyListStatusOk() ([]ProjectInternalDefStatusAccessControlPolicyListStatusInner, bool) {
	...
	return o.AccessControlPolicyListStatus, true
}
...
// SetAccessControlPolicyListStatus gets a reference to the given []ProjectInternalDefStatusAccessControlPolicyListStatusInner and assigns it to the AccessControlPolicyListStatus field.
func (o *ProjectInternalDefStatus) SetAccessControlPolicyListStatus(v []ProjectInternalDefStatusAccessControlPolicyListStatusInner) {
	o.AccessControlPolicyListStatus = v
}
...
func (o ProjectInternalDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ProjectInternalDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AccessControlPolicyListStatus) {
		toSerialize["access_control_policy_list_status"] = o.AccessControlPolicyListStatus
	}
...
func (o *ProjectInternalDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectInternalDefStatus := _ProjectInternalDefStatus{}

	err = json.Unmarshal(data, &varProjectInternalDefStatus)

	if err != nil {
		return err
	}

	*o = ProjectInternalDefStatus(varProjectInternalDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "access_control_policy_list_status")
		delete(additionalProperties, "project_status")
...
type NullableProjectInternalDefStatus struct {
	value *ProjectInternalDefStatus
	isSet bool
}

func (v NullableProjectInternalDefStatus) Get() *ProjectInternalDefStatus {
	return v.value
}

func (v *NullableProjectInternalDefStatus) Set(val *ProjectInternalDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectInternalDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectInternalDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectInternalDefStatus(val *ProjectInternalDefStatus) *NullableProjectInternalDefStatus {
	return &NullableProjectInternalDefStatus{value: val, isSet: true}
}

func (v NullableProjectInternalDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectInternalDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
