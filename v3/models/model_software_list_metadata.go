...
// checks if the SoftwareListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareListMetadata{}

// SoftwareListMetadata All api calls that return a list will have this metadata block as input 
...
type _SoftwareListMetadata SoftwareListMetadata

// NewSoftwareListMetadata instantiates a new SoftwareListMetadata object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSoftwareListMetadata() *SoftwareListMetadata {
	this := SoftwareListMetadata{}
	var kind string = "software"
	this.Kind = &kind
	return &this
}

// NewSoftwareListMetadataWithDefaults instantiates a new SoftwareListMetadata object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSoftwareListMetadataWithDefaults() *SoftwareListMetadata {
	this := SoftwareListMetadata{}
	var kind string = "software"
	this.Kind = &kind
	return &this
...
func (o *SoftwareListMetadata) GetKind() string {
...
func (o *SoftwareListMetadata) GetKindOk() (*string, bool) {
	if o == nil || IsNil(o.Kind) {
		return nil, false
	}
	return o.Kind, true
...
func (o *SoftwareListMetadata) HasKind() bool {
	if o != nil && !IsNil(o.Kind) {
		return true
	}
...
func (o *SoftwareListMetadata) SetKind(v string) {
	o.Kind = &v
}

// GetSortAttribute returns the SortAttribute field value if set, zero value otherwise.
func (o *SoftwareListMetadata) GetSortAttribute() string {
...
// and a boolean to check if the value has been set.
func (o *SoftwareListMetadata) GetSortAttributeOk() (*string, bool) {
	if o == nil || IsNil(o.SortAttribute) {
		return nil, false
	}
...
func (o *SoftwareListMetadata) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o *SoftwareListMetadata) SetSortAttribute(v string) {
	o.SortAttribute = &v
}

// GetFilter returns the Filter field value if set, zero value otherwise.
// Deprecated
func (o *SoftwareListMetadata) GetFilter() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *SoftwareListMetadata) GetFilterOk() (*string, bool) {
	if o == nil || IsNil(o.Filter) {
		return nil, false
	}
...
func (o *SoftwareListMetadata) HasFilter() bool {
	if o != nil && !IsNil(o.Filter) {
		return true
	}
...
// Deprecated
func (o *SoftwareListMetadata) SetFilter(v string) {
	o.Filter = &v
}

// GetLength returns the Length field value if set, zero value otherwise.
func (o *SoftwareListMetadata) GetLength() int32 {
...
// and a boolean to check if the value has been set.
func (o *SoftwareListMetadata) GetLengthOk() (*int32, bool) {
	if o == nil || IsNil(o.Length) {
		return nil, false
	}
...
func (o *SoftwareListMetadata) HasLength() bool {
	if o != nil && !IsNil(o.Length) {
		return true
	}
...
func (o *SoftwareListMetadata) SetLength(v int32) {
	o.Length = &v
}

// GetSortOrder returns the SortOrder field value if set, zero value otherwise.
func (o *SoftwareListMetadata) GetSortOrder() string {
...
// and a boolean to check if the value has been set.
func (o *SoftwareListMetadata) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o *SoftwareListMetadata) HasSortOrder() bool {
	if o != nil && !IsNil(o.SortOrder) {
		return true
	}
...
func (o *SoftwareListMetadata) SetSortOrder(v string) {
	o.SortOrder = &v
}

// GetOffset returns the Offset field value if set, zero value otherwise.
func (o *SoftwareListMetadata) GetOffset() int32 {
...
// and a boolean to check if the value has been set.
func (o *SoftwareListMetadata) GetOffsetOk() (*int32, bool) {
	if o == nil || IsNil(o.Offset) {
		return nil, false
	}
...
func (o *SoftwareListMetadata) HasOffset() bool {
	if o != nil && !IsNil(o.Offset) {
		return true
	}
...
func (o *SoftwareListMetadata) SetOffset(v int32) {
	o.Offset = &v
}

func (o SoftwareListMetadata) MarshalJSON() ([]byte, error) {
...
func (o SoftwareListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SoftwareListMetadata) UnmarshalJSON(data []byte) (err error) {
	varSoftwareListMetadata := _SoftwareListMetadata{}

	err = json.Unmarshal(data, &varSoftwareListMetadata)

	if err != nil {
		return err
	}

	*o = SoftwareListMetadata(varSoftwareListMetadata)
...
type NullableSoftwareListMetadata struct {
	value *SoftwareListMetadata
	isSet bool
}

func (v NullableSoftwareListMetadata) Get() *SoftwareListMetadata {
	return v.value
}

func (v *NullableSoftwareListMetadata) Set(val *SoftwareListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareListMetadata(val *SoftwareListMetadata) *NullableSoftwareListMetadata {
	return &NullableSoftwareListMetadata{value: val, isSet: true}
}

func (v NullableSoftwareListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
