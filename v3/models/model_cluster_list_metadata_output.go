...
// checks if the ClusterListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterListMetadataOutput{}

// ClusterListMetadataOutput All api calls that return a list will have this metadata block 
...
type _ClusterListMetadataOutput ClusterListMetadataOutput
...
func NewClusterListMetadataOutput() *ClusterListMetadataOutput {
	this := ClusterListMetadataOutput{}
...
// and a boolean to check if the value has been set.
func (o *ClusterListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o ClusterListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ClusterListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varClusterListMetadataOutput := _ClusterListMetadataOutput{}

	err = json.Unmarshal(data, &varClusterListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ClusterListMetadataOutput(varClusterListMetadataOutput)
...
type NullableClusterListMetadataOutput struct {
	value *ClusterListMetadataOutput
	isSet bool
}

func (v NullableClusterListMetadataOutput) Get() *ClusterListMetadataOutput {
	return v.value
}

func (v *NullableClusterListMetadataOutput) Set(val *ClusterListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterListMetadataOutput(val *ClusterListMetadataOutput) *NullableClusterListMetadataOutput {
	return &NullableClusterListMetadataOutput{value: val, isSet: true}
}

func (v NullableClusterListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
