...
// checks if the DockerRegistryImageSearchListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryImageSearchListIntentResponse{}
...
type DockerRegistryImageSearchListIntentResponse struct {
	EntityList []DockerRegistryImageStatus `json:"entity_list,omitempty"`
...
type _DockerRegistryImageSearchListIntentResponse DockerRegistryImageSearchListIntentResponse
...
func NewDockerRegistryImageSearchListIntentResponse(apiVersion string, metadata DockerRegistryListMetadata) *DockerRegistryImageSearchListIntentResponse {
	this := DockerRegistryImageSearchListIntentResponse{}
...
func (o *DockerRegistryImageSearchListIntentResponse) GetEntityList() []DockerRegistryImageStatus {
	if o == nil || IsNil(o.EntityList) {
		var ret []DockerRegistryImageStatus
		return ret
	}
	return o.EntityList
}
...
// SetEntityList gets a reference to the given []DockerRegistryImageStatus and assigns it to the EntityList field.
...
func (o *DockerRegistryImageSearchListIntentResponse) GetMetadata() DockerRegistryListMetadata {
	if o == nil {
		var ret DockerRegistryListMetadata
		return ret
	}
...
func (o DockerRegistryImageSearchListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryImageSearchListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryImageSearchListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerRegistryImageSearchListIntentResponse := _DockerRegistryImageSearchListIntentResponse{}

	err = json.Unmarshal(data, &varDockerRegistryImageSearchListIntentResponse)

	if err != nil {
		return err
	}

	*o = DockerRegistryImageSearchListIntentResponse(varDockerRegistryImageSearchListIntentResponse)
...
type NullableDockerRegistryImageSearchListIntentResponse struct {
	value *DockerRegistryImageSearchListIntentResponse
	isSet bool
}

func (v NullableDockerRegistryImageSearchListIntentResponse) Get() *DockerRegistryImageSearchListIntentResponse {
	return v.value
}

func (v *NullableDockerRegistryImageSearchListIntentResponse) Set(val *DockerRegistryImageSearchListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryImageSearchListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryImageSearchListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryImageSearchListIntentResponse(val *DockerRegistryImageSearchListIntentResponse) *NullableDockerRegistryImageSearchListIntentResponse {
	return &NullableDockerRegistryImageSearchListIntentResponse{value: val, isSet: true}
}

func (v NullableDockerRegistryImageSearchListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryImageSearchListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
