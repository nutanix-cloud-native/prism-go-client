...
// checks if the ExternalNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalNetwork{}

// ExternalNetwork External network resource.
...
func (o ExternalNetwork) MarshalJSON() ([]byte, error) {
...
func (o ExternalNetwork) ToMap() (map[string]interface{}, error) {
...
func (o *ExternalNetwork) UnmarshalJSON(data []byte) (err error) {
	varExternalNetwork := _ExternalNetwork{}

	err = json.Unmarshal(data, &varExternalNetwork)

	if err != nil {
		return err
	}

	*o = ExternalNetwork(varExternalNetwork)
...
type NullableExternalNetwork struct {
	value *ExternalNetwork
	isSet bool
}

func (v NullableExternalNetwork) Get() *ExternalNetwork {
	return v.value
}

func (v *NullableExternalNetwork) Set(val *ExternalNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalNetwork(val *ExternalNetwork) *NullableExternalNetwork {
	return &NullableExternalNetwork{value: val, isSet: true}
}

func (v NullableExternalNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
