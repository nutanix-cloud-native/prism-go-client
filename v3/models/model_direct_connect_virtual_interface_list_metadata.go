...
// checks if the DirectConnectVirtualInterfaceListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterfaceListMetadata{}

// DirectConnectVirtualInterfaceListMetadata All api calls that return a list will have this metadata block as input 
type DirectConnectVirtualInterfaceListMetadata struct {
	// The kind name
...
type _DirectConnectVirtualInterfaceListMetadata DirectConnectVirtualInterfaceListMetadata
...
func NewDirectConnectVirtualInterfaceListMetadata() *DirectConnectVirtualInterfaceListMetadata {
	this := DirectConnectVirtualInterfaceListMetadata{}
...
func (o *DirectConnectVirtualInterfaceListMetadata) SetKind(v string) {
	o.Kind = &v
}
...
func (o *DirectConnectVirtualInterfaceListMetadata) HasFilter() bool {
	if o != nil && !IsNil(o.Filter) {
		return true
	}
...
func (o DirectConnectVirtualInterfaceListMetadata) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterfaceListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectVirtualInterfaceListMetadata) UnmarshalJSON(data []byte) (err error) {
	varDirectConnectVirtualInterfaceListMetadata := _DirectConnectVirtualInterfaceListMetadata{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterfaceListMetadata)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterfaceListMetadata(varDirectConnectVirtualInterfaceListMetadata)
...
type NullableDirectConnectVirtualInterfaceListMetadata struct {
	value *DirectConnectVirtualInterfaceListMetadata
	isSet bool
}

func (v NullableDirectConnectVirtualInterfaceListMetadata) Get() *DirectConnectVirtualInterfaceListMetadata {
	return v.value
}

func (v *NullableDirectConnectVirtualInterfaceListMetadata) Set(val *DirectConnectVirtualInterfaceListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterfaceListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterfaceListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterfaceListMetadata(val *DirectConnectVirtualInterfaceListMetadata) *NullableDirectConnectVirtualInterfaceListMetadata {
	return &NullableDirectConnectVirtualInterfaceListMetadata{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterfaceListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterfaceListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
