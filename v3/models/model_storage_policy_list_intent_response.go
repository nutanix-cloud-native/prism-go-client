...
// checks if the StoragePolicyListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyListIntentResponse{}

// StoragePolicyListIntentResponse Response object for intentful operation of storage_policys
type StoragePolicyListIntentResponse struct {
	Entities []StoragePolicyIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata StoragePolicyListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _StoragePolicyListIntentResponse StoragePolicyListIntentResponse
...
func NewStoragePolicyListIntentResponse(apiVersion string, metadata StoragePolicyListMetadataOutput) *StoragePolicyListIntentResponse {
	this := StoragePolicyListIntentResponse{}
...
func (o *StoragePolicyListIntentResponse) GetEntities() []StoragePolicyIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []StoragePolicyIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []StoragePolicyIntentResource and assigns it to the Entities field.
...
func (o *StoragePolicyListIntentResponse) GetMetadata() StoragePolicyListMetadataOutput {
	if o == nil {
		var ret StoragePolicyListMetadataOutput
		return ret
	}
...
func (o StoragePolicyListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePolicyListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varStoragePolicyListIntentResponse := _StoragePolicyListIntentResponse{}

	err = json.Unmarshal(data, &varStoragePolicyListIntentResponse)

	if err != nil {
		return err
	}

	*o = StoragePolicyListIntentResponse(varStoragePolicyListIntentResponse)
...
type NullableStoragePolicyListIntentResponse struct {
	value *StoragePolicyListIntentResponse
	isSet bool
}

func (v NullableStoragePolicyListIntentResponse) Get() *StoragePolicyListIntentResponse {
	return v.value
}

func (v *NullableStoragePolicyListIntentResponse) Set(val *StoragePolicyListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyListIntentResponse(val *StoragePolicyListIntentResponse) *NullableStoragePolicyListIntentResponse {
	return &NullableStoragePolicyListIntentResponse{value: val, isSet: true}
}

func (v NullableStoragePolicyListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
