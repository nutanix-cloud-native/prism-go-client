...
// Capability Capability object containing information about each capability
type Capability struct {
	// Optional value describing the capability
	CapabilityDescription *string `json:"capability_description,omitempty"`
	SelfCapability *CapabilityDetails `json:"self_capability,omitempty"`
	// Name of capability
	Name *string `json:"name,omitempty"`
	// List of members having the capability
	CapableMembers []CapabilityDetails `json:"capable_members,omitempty"`
...
// GetCapabilityDescription returns the CapabilityDescription field value if set, zero value otherwise.
func (o *Capability) GetCapabilityDescription() string {
	if o == nil || IsNil(o.CapabilityDescription) {
		var ret string
		return ret
	}
	return *o.CapabilityDescription
}

// GetCapabilityDescriptionOk returns a tuple with the CapabilityDescription field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capability) GetCapabilityDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.CapabilityDescription) {
		return nil, false
	}
	return o.CapabilityDescription, true
}
...
// SetCapabilityDescription gets a reference to the given string and assigns it to the CapabilityDescription field.
func (o *Capability) SetCapabilityDescription(v string) {
	o.CapabilityDescription = &v
}

// GetSelfCapability returns the SelfCapability field value if set, zero value otherwise.
func (o *Capability) GetSelfCapability() CapabilityDetails {
	if o == nil || IsNil(o.SelfCapability) {
		var ret CapabilityDetails
		return ret
	}
	return *o.SelfCapability
}

// GetSelfCapabilityOk returns a tuple with the SelfCapability field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capability) GetSelfCapabilityOk() (*CapabilityDetails, bool) {
	if o == nil || IsNil(o.SelfCapability) {
		return nil, false
	}
	return o.SelfCapability, true
}
...
// SetSelfCapability gets a reference to the given CapabilityDetails and assigns it to the SelfCapability field.
...
// GetCapableMembers returns the CapableMembers field value if set, zero value otherwise.
func (o *Capability) GetCapableMembers() []CapabilityDetails {
	if o == nil || IsNil(o.CapableMembers) {
		var ret []CapabilityDetails
		return ret
	}
	return o.CapableMembers
}

// GetCapableMembersOk returns a tuple with the CapableMembers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capability) GetCapableMembersOk() ([]CapabilityDetails, bool) {
	if o == nil || IsNil(o.CapableMembers) {
		return nil, false
	}
	return o.CapableMembers, true
}
...
// SetCapableMembers gets a reference to the given []CapabilityDetails and assigns it to the CapableMembers field.
...
func (o Capability) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CapabilityDescription) {
		toSerialize["capability_description"] = o.CapabilityDescription
	}
	if !IsNil(o.SelfCapability) {
		toSerialize["self_capability"] = o.SelfCapability
	}
	if !IsNil(o.Name) {
		toSerialize["name"] = o.Name
	}
	if !IsNil(o.CapableMembers) {
		toSerialize["capable_members"] = o.CapableMembers
	}
...
func (o *Capability) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Capability(varCapability)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "capability_description")
		delete(additionalProperties, "self_capability")
		delete(additionalProperties, "name")
		delete(additionalProperties, "capable_members")
