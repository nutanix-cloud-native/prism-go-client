...
// checks if the RackableUnitListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackableUnitListIntentResponse{}

// RackableUnitListIntentResponse Response object for intentful operation of rackable_units
type RackableUnitListIntentResponse struct {
	Entities []RackableUnitIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata RackableUnitListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RackableUnitListIntentResponse RackableUnitListIntentResponse
...
func NewRackableUnitListIntentResponse(apiVersion string, metadata RackableUnitListMetadataOutput) *RackableUnitListIntentResponse {
	this := RackableUnitListIntentResponse{}
...
func (o *RackableUnitListIntentResponse) GetEntities() []RackableUnitIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []RackableUnitIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []RackableUnitIntentResource and assigns it to the Entities field.
...
func (o *RackableUnitListIntentResponse) GetMetadata() RackableUnitListMetadataOutput {
	if o == nil {
		var ret RackableUnitListMetadataOutput
		return ret
	}
...
func (o RackableUnitListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RackableUnitListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RackableUnitListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRackableUnitListIntentResponse := _RackableUnitListIntentResponse{}

	err = json.Unmarshal(data, &varRackableUnitListIntentResponse)

	if err != nil {
		return err
	}

	*o = RackableUnitListIntentResponse(varRackableUnitListIntentResponse)
...
type NullableRackableUnitListIntentResponse struct {
	value *RackableUnitListIntentResponse
	isSet bool
}

func (v NullableRackableUnitListIntentResponse) Get() *RackableUnitListIntentResponse {
	return v.value
}

func (v *NullableRackableUnitListIntentResponse) Set(val *RackableUnitListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRackableUnitListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRackableUnitListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackableUnitListIntentResponse(val *RackableUnitListIntentResponse) *NullableRackableUnitListIntentResponse {
	return &NullableRackableUnitListIntentResponse{value: val, isSet: true}
}

func (v NullableRackableUnitListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackableUnitListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
