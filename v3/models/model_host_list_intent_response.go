...
// checks if the HostListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostListIntentResponse{}
...
type HostListIntentResponse struct {
	...
	Metadata HostListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _HostListIntentResponse HostListIntentResponse
...
// SetEntities gets a reference to the given []HostIntentResource and assigns it to the Entities field.
...
func (o *HostListIntentResponse) GetMetadata() HostListMetadataOutput {
	if o == nil {
		var ret HostListMetadataOutput
		return ret
	}
...
func (o HostListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o HostListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *HostListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varHostListIntentResponse := _HostListIntentResponse{}

	err = json.Unmarshal(data, &varHostListIntentResponse)

	if err != nil {
		return err
	}

	*o = HostListIntentResponse(varHostListIntentResponse)
...
type NullableHostListIntentResponse struct {
	value *HostListIntentResponse
	isSet bool
}

func (v NullableHostListIntentResponse) Get() *HostListIntentResponse {
	return v.value
}

func (v *NullableHostListIntentResponse) Set(val *HostListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHostListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHostListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostListIntentResponse(val *HostListIntentResponse) *NullableHostListIntentResponse {
	return &NullableHostListIntentResponse{value: val, isSet: true}
}

func (v NullableHostListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
