...
// checks if the CategoryMappingIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingIntentResponse{}

// CategoryMappingIntentResponse Response object for intentful operations on a category_mapping
type CategoryMappingIntentResponse struct {
...
type _CategoryMappingIntentResponse CategoryMappingIntentResponse
...
func NewCategoryMappingIntentResponse(apiVersion string, metadata CategoryMappingMetadata) *CategoryMappingIntentResponse {
	this := CategoryMappingIntentResponse{}
...
func (o CategoryMappingIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryMappingIntentResponse := _CategoryMappingIntentResponse{}

	err = json.Unmarshal(data, &varCategoryMappingIntentResponse)

	if err != nil {
		return err
	}

	*o = CategoryMappingIntentResponse(varCategoryMappingIntentResponse)
...
type NullableCategoryMappingIntentResponse struct {
	value *CategoryMappingIntentResponse
	isSet bool
}

func (v NullableCategoryMappingIntentResponse) Get() *CategoryMappingIntentResponse {
	return v.value
}

func (v *NullableCategoryMappingIntentResponse) Set(val *CategoryMappingIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingIntentResponse(val *CategoryMappingIntentResponse) *NullableCategoryMappingIntentResponse {
	return &NullableCategoryMappingIntentResponse{value: val, isSet: true}
}

func (v NullableCategoryMappingIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
