...
// checks if the VpcRouteTableIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcRouteTableIntentInput{}

// VpcRouteTableIntentInput An intentful representation of a vpc_route_table
type VpcRouteTableIntentInput struct {
	Spec VpcRouteTable `json:"spec"`
...
type _VpcRouteTableIntentInput VpcRouteTableIntentInput
...
func (o VpcRouteTableIntentInput) MarshalJSON() ([]byte, error) {
...
func (o VpcRouteTableIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *VpcRouteTableIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVpcRouteTableIntentInput := _VpcRouteTableIntentInput{}

	err = json.Unmarshal(data, &varVpcRouteTableIntentInput)

	if err != nil {
		return err
	}

	*o = VpcRouteTableIntentInput(varVpcRouteTableIntentInput)
...
type NullableVpcRouteTableIntentInput struct {
	value *VpcRouteTableIntentInput
	isSet bool
}

func (v NullableVpcRouteTableIntentInput) Get() *VpcRouteTableIntentInput {
	return v.value
}

func (v *NullableVpcRouteTableIntentInput) Set(val *VpcRouteTableIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcRouteTableIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcRouteTableIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcRouteTableIntentInput(val *VpcRouteTableIntentInput) *NullableVpcRouteTableIntentInput {
	return &NullableVpcRouteTableIntentInput{value: val, isSet: true}
}

func (v NullableVpcRouteTableIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcRouteTableIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
