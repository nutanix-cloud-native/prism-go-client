...
// checks if the NetworkFunctionChainStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionChainStatus{}

// NetworkFunctionChainStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _NetworkFunctionChainStatus NetworkFunctionChainStatus
...
func NewNetworkFunctionChainStatus() *NetworkFunctionChainStatus {
	this := NetworkFunctionChainStatus{}
	return &this
}
...
func (o NetworkFunctionChainStatus) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionChainStatus) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionChainStatus) UnmarshalJSON(data []byte) (err error) {
	varNetworkFunctionChainStatus := _NetworkFunctionChainStatus{}

	err = json.Unmarshal(data, &varNetworkFunctionChainStatus)

	if err != nil {
		return err
	}

	*o = NetworkFunctionChainStatus(varNetworkFunctionChainStatus)
...
type NullableNetworkFunctionChainStatus struct {
	value *NetworkFunctionChainStatus
	isSet bool
}

func (v NullableNetworkFunctionChainStatus) Get() *NetworkFunctionChainStatus {
	return v.value
}

func (v *NullableNetworkFunctionChainStatus) Set(val *NetworkFunctionChainStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionChainStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionChainStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionChainStatus(val *NetworkFunctionChainStatus) *NullableNetworkFunctionChainStatus {
	return &NullableNetworkFunctionChainStatus{value: val, isSet: true}
}

func (v NullableNetworkFunctionChainStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionChainStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
