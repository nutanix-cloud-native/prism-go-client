...
// checks if the ReportConfigResources1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigResources1{}

// ReportConfigResources1 Description of report config.
type ReportConfigResources1 struct {
	RetentionPolicy *RetentionPolicy `json:"retention_policy,omitempty"`
	// Description of the common report config.
	Description *string `json:"description,omitempty"`
	// Offset for end time for data collection during report generation.
	EndTimeOffsetSecs *int64 `json:"end_time_offset_secs,omitempty"`
	Schedule *Schedule `json:"schedule,omitempty"`
	// Version of the template spec.
	TemplateSpecVersion *string `json:"template_spec_version,omitempty"`
	// List specifying the formats in which report is to be created.
	GenerationFormat []string `json:"generation_format,omitempty"`
	// Offset for start time for data collection during report generation.
	StartTimeOffsetSecs *int64 `json:"start_time_offset_secs,omitempty"`
	...
	// Flag specifying if Report Config is a pre defined report.
	OutOfBoxReport *bool `json:"out_of_box_report,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ReportConfigResources1 ReportConfigResources1
...
// SetRetentionPolicy gets a reference to the given RetentionPolicy and assigns it to the RetentionPolicy field.
...
// GetEndTimeOffsetSecs returns the EndTimeOffsetSecs field value if set, zero value otherwise.
func (o *ReportConfigResources1) GetEndTimeOffsetSecs() int64 {
	if o == nil || IsNil(o.EndTimeOffsetSecs) {
		var ret int64
		return ret
	}
	return *o.EndTimeOffsetSecs
}

// GetEndTimeOffsetSecsOk returns a tuple with the EndTimeOffsetSecs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportConfigResources1) GetEndTimeOffsetSecsOk() (*int64, bool) {
	if o == nil || IsNil(o.EndTimeOffsetSecs) {
		return nil, false
	}
	return o.EndTimeOffsetSecs, true
}
...
// SetEndTimeOffsetSecs gets a reference to the given int64 and assigns it to the EndTimeOffsetSecs field.
func (o *ReportConfigResources1) SetEndTimeOffsetSecs(v int64) {
	o.EndTimeOffsetSecs = &v
}
...
// GetTemplateSpecVersion returns the TemplateSpecVersion field value if set, zero value otherwise.
func (o *ReportConfigResources1) GetTemplateSpecVersion() string {
	if o == nil || IsNil(o.TemplateSpecVersion) {
		var ret string
		return ret
	}
	return *o.TemplateSpecVersion
}

// GetTemplateSpecVersionOk returns a tuple with the TemplateSpecVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportConfigResources1) GetTemplateSpecVersionOk() (*string, bool) {
	if o == nil || IsNil(o.TemplateSpecVersion) {
		return nil, false
	}
	return o.TemplateSpecVersion, true
}
...
// SetTemplateSpecVersion gets a reference to the given string and assigns it to the TemplateSpecVersion field.
func (o *ReportConfigResources1) SetTemplateSpecVersion(v string) {
	o.TemplateSpecVersion = &v
}

// GetGenerationFormat returns the GenerationFormat field value if set, zero value otherwise.
func (o *ReportConfigResources1) GetGenerationFormat() []string {
	if o == nil || IsNil(o.GenerationFormat) {
		var ret []string
		return ret
	}
	return o.GenerationFormat
}

// GetGenerationFormatOk returns a tuple with the GenerationFormat field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportConfigResources1) GetGenerationFormatOk() ([]string, bool) {
	if o == nil || IsNil(o.GenerationFormat) {
		return nil, false
	}
	return o.GenerationFormat, true
}
...
// SetGenerationFormat gets a reference to the given []string and assigns it to the GenerationFormat field.
func (o *ReportConfigResources1) SetGenerationFormat(v []string) {
	o.GenerationFormat = v
}

// GetStartTimeOffsetSecs returns the StartTimeOffsetSecs field value if set, zero value otherwise.
func (o *ReportConfigResources1) GetStartTimeOffsetSecs() int64 {
	if o == nil || IsNil(o.StartTimeOffsetSecs) {
		var ret int64
		return ret
	}
	return *o.StartTimeOffsetSecs
}

// GetStartTimeOffsetSecsOk returns a tuple with the StartTimeOffsetSecs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportConfigResources1) GetStartTimeOffsetSecsOk() (*int64, bool) {
	if o == nil || IsNil(o.StartTimeOffsetSecs) {
		return nil, false
	}
	return o.StartTimeOffsetSecs, true
}
...
// SetStartTimeOffsetSecs gets a reference to the given int64 and assigns it to the StartTimeOffsetSecs field.
func (o *ReportConfigResources1) SetStartTimeOffsetSecs(v int64) {
	o.StartTimeOffsetSecs = &v
}

// GetTemplate returns the Template field value if set, zero value otherwise.
func (o *ReportConfigResources1) GetTemplate() ReportTemplate {
	if o == nil || IsNil(o.Template) {
		var ret ReportTemplate
		return ret
	}
	return *o.Template
}
...
// SetTemplate gets a reference to the given ReportTemplate and assigns it to the Template field.
...
// GetNotificationPolicy returns the NotificationPolicy field value if set, zero value otherwise.
func (o *ReportConfigResources1) GetNotificationPolicy() NotificationPolicy {
	if o == nil || IsNil(o.NotificationPolicy) {
		var ret NotificationPolicy
		return ret
	}
	return *o.NotificationPolicy
}

// GetNotificationPolicyOk returns a tuple with the NotificationPolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportConfigResources1) GetNotificationPolicyOk() (*NotificationPolicy, bool) {
	if o == nil || IsNil(o.NotificationPolicy) {
		return nil, false
	}
	return o.NotificationPolicy, true
}
...
// SetNotificationPolicy gets a reference to the given NotificationPolicy and assigns it to the NotificationPolicy field.
func (o *ReportConfigResources1) SetNotificationPolicy(v NotificationPolicy) {
	o.NotificationPolicy = &v
}

// GetOutOfBoxReport returns the OutOfBoxReport field value if set, zero value otherwise.
func (o *ReportConfigResources1) GetOutOfBoxReport() bool {
	if o == nil || IsNil(o.OutOfBoxReport) {
		var ret bool
		return ret
	}
	return *o.OutOfBoxReport
}

// GetOutOfBoxReportOk returns a tuple with the OutOfBoxReport field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportConfigResources1) GetOutOfBoxReportOk() (*bool, bool) {
	if o == nil || IsNil(o.OutOfBoxReport) {
		return nil, false
	}
	return o.OutOfBoxReport, true
}
...
// SetOutOfBoxReport gets a reference to the given bool and assigns it to the OutOfBoxReport field.
func (o *ReportConfigResources1) SetOutOfBoxReport(v bool) {
	o.OutOfBoxReport = &v
}

func (o ReportConfigResources1) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigResources1) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EndTimeOffsetSecs) {
		toSerialize["end_time_offset_secs"] = o.EndTimeOffsetSecs
	}
	if !IsNil(o.Schedule) {
		toSerialize["schedule"] = o.Schedule
	}
	if !IsNil(o.TemplateSpecVersion) {
		toSerialize["template_spec_version"] = o.TemplateSpecVersion
	}
	if !IsNil(o.GenerationFormat) {
		toSerialize["generation_format"] = o.GenerationFormat
	}
	if !IsNil(o.StartTimeOffsetSecs) {
		toSerialize["start_time_offset_secs"] = o.StartTimeOffsetSecs
	}
	if !IsNil(o.Template) {
	...
	if !IsNil(o.NotificationPolicy) {
		toSerialize["notification_policy"] = o.NotificationPolicy
	}
	if !IsNil(o.OutOfBoxReport) {
		toSerialize["out_of_box_report"] = o.OutOfBoxReport
	}
...
func (o *ReportConfigResources1) UnmarshalJSON(data []byte) (err error) {
	varReportConfigResources1 := _ReportConfigResources1{}

	err = json.Unmarshal(data, &varReportConfigResources1)

	if err != nil {
		return err
	}

	*o = ReportConfigResources1(varReportConfigResources1)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "retention_policy")
		delete(additionalProperties, "description")
		delete(additionalProperties, "end_time_offset_secs")
		delete(additionalProperties, "schedule")
		delete(additionalProperties, "template_spec_version")
		delete(additionalProperties, "generation_format")
		delete(additionalProperties, "start_time_offset_secs")
		delete(additionalProperties, "template")
		delete(additionalProperties, "timezone")
		delete(additionalProperties, "notification_policy")
		delete(additionalProperties, "out_of_box_report")
...
type NullableReportConfigResources1 struct {
	value *ReportConfigResources1
	isSet bool
}

func (v NullableReportConfigResources1) Get() *ReportConfigResources1 {
	return v.value
}

func (v *NullableReportConfigResources1) Set(val *ReportConfigResources1) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigResources1) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigResources1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigResources1(val *ReportConfigResources1) *NullableReportConfigResources1 {
	return &NullableReportConfigResources1{value: val, isSet: true}
}

func (v NullableReportConfigResources1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigResources1) UnmarshalJSON(src []byte) error {
	v.isSet = true
