...
// checks if the DpdConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DpdConfig{}

// DpdConfig DPD (Dead Peer Detection) related configuration spec for the VPN connections.
...
func (o DpdConfig) MarshalJSON() ([]byte, error) {
...
func (o DpdConfig) ToMap() (map[string]interface{}, error) {
...
func (o *DpdConfig) UnmarshalJSON(data []byte) (err error) {
	varDpdConfig := _DpdConfig{}

	err = json.Unmarshal(data, &varDpdConfig)

	if err != nil {
		return err
	}

	*o = DpdConfig(varDpdConfig)
...
type NullableDpdConfig struct {
	value *DpdConfig
	isSet bool
}

func (v NullableDpdConfig) Get() *DpdConfig {
	return v.value
}

func (v *NullableDpdConfig) Set(val *DpdConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableDpdConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableDpdConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDpdConfig(val *DpdConfig) *NullableDpdConfig {
	return &NullableDpdConfig{value: val, isSet: true}
}

func (v NullableDpdConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDpdConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
