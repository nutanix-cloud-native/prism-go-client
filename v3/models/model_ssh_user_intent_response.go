...
// checks if the SshUserIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserIntentResponse{}

// SshUserIntentResponse Response object for intentful operations on a ssh_user
type SshUserIntentResponse struct {
...
type _SshUserIntentResponse SshUserIntentResponse
...
func (o SshUserIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o SshUserIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSshUserIntentResponse := _SshUserIntentResponse{}

	err = json.Unmarshal(data, &varSshUserIntentResponse)

	if err != nil {
		return err
	}

	*o = SshUserIntentResponse(varSshUserIntentResponse)
...
type NullableSshUserIntentResponse struct {
	value *SshUserIntentResponse
	isSet bool
}

func (v NullableSshUserIntentResponse) Get() *SshUserIntentResponse {
	return v.value
}

func (v *NullableSshUserIntentResponse) Set(val *SshUserIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserIntentResponse(val *SshUserIntentResponse) *NullableSshUserIntentResponse {
	return &NullableSshUserIntentResponse{value: val, isSet: true}
}

func (v NullableSshUserIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
