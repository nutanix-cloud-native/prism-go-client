...
// checks if the EntitySpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySpec{}

// EntitySpec Specification of the entities which need to be placed.
type EntitySpec struct {
	VolumeSpec *VolumeSpec `json:"volume_spec,omitempty"`
	VmSpec *VmSpec `json:"vm_spec,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _EntitySpec EntitySpec
...
// SetVolumeSpec gets a reference to the given VolumeSpec and assigns it to the VolumeSpec field.
...
// SetVmSpec gets a reference to the given VmSpec and assigns it to the VmSpec field.
func (o *EntitySpec) SetVmSpec(v VmSpec) {
	o.VmSpec = &v
}

func (o EntitySpec) MarshalJSON() ([]byte, error) {
...
func (o EntitySpec) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VolumeSpec) {
		toSerialize["volume_spec"] = o.VolumeSpec
	}
	if !IsNil(o.VmSpec) {
...
func (o *EntitySpec) UnmarshalJSON(data []byte) (err error) {
	varEntitySpec := _EntitySpec{}

	err = json.Unmarshal(data, &varEntitySpec)

	if err != nil {
		return err
	}

	*o = EntitySpec(varEntitySpec)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "volume_spec")
...
type NullableEntitySpec struct {
	value *EntitySpec
	isSet bool
}

func (v NullableEntitySpec) Get() *EntitySpec {
	return v.value
}

func (v *NullableEntitySpec) Set(val *EntitySpec) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySpec) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySpec(val *EntitySpec) *NullableEntitySpec {
	return &NullableEntitySpec{value: val, isSet: true}
}

func (v NullableEntitySpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
