...
// checks if the DirectoryReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryReference{}

// DirectoryReference directory service resource.
...
type _DirectoryReference DirectoryReference
...
func (o DirectoryReference) MarshalJSON() ([]byte, error) {
...
func (o DirectoryReference) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryReference) UnmarshalJSON(data []byte) (err error) {
	varDirectoryReference := _DirectoryReference{}

	err = json.Unmarshal(data, &varDirectoryReference)

	if err != nil {
		return err
	}

	*o = DirectoryReference(varDirectoryReference)
...
type NullableDirectoryReference struct {
	value *DirectoryReference
	isSet bool
}

func (v NullableDirectoryReference) Get() *DirectoryReference {
	return v.value
}

func (v *NullableDirectoryReference) Set(val *DirectoryReference) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryReference) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryReference(val *DirectoryReference) *NullableDirectoryReference {
	return &NullableDirectoryReference{value: val, isSet: true}
}

func (v NullableDirectoryReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
