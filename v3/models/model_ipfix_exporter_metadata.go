...
// checks if the IpfixExporterMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpfixExporterMetadata{}

// IpfixExporterMetadata The ipfix_exporter kind metadata
type IpfixExporterMetadata struct {
	// UTC date and time in RFC-3339 format when ipfix_exporter was last updated 
	...
	// UTC date and time in RFC-3339 format when ipfix_exporter was created 
	...
	// Categories for the ipfix_exporter. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the ipfix_exporter. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _IpfixExporterMetadata IpfixExporterMetadata
...
func (o IpfixExporterMetadata) MarshalJSON() ([]byte, error) {
...
func (o IpfixExporterMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *IpfixExporterMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varIpfixExporterMetadata := _IpfixExporterMetadata{}

	err = json.Unmarshal(data, &varIpfixExporterMetadata)

	if err != nil {
		return err
	}

	*o = IpfixExporterMetadata(varIpfixExporterMetadata)
...
type NullableIpfixExporterMetadata struct {
	value *IpfixExporterMetadata
	isSet bool
}

func (v NullableIpfixExporterMetadata) Get() *IpfixExporterMetadata {
	return v.value
}

func (v *NullableIpfixExporterMetadata) Set(val *IpfixExporterMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIpfixExporterMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIpfixExporterMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpfixExporterMetadata(val *IpfixExporterMetadata) *NullableIpfixExporterMetadata {
	return &NullableIpfixExporterMetadata{value: val, isSet: true}
}

func (v NullableIpfixExporterMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpfixExporterMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
