...
// checks if the ExternalSubnet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalSubnet{}

// ExternalSubnet External subnet definition
type ExternalSubnet struct {
	ExternalSubnetReference SubnetReference `json:"external_subnet_reference"`
...
type _ExternalSubnet ExternalSubnet
...
// GetExternalSubnetReference returns the ExternalSubnetReference field value
...
// GetExternalSubnetReferenceOk returns a tuple with the ExternalSubnetReference field value
...
// SetExternalSubnetReference sets field value
...
func (o ExternalSubnet) MarshalJSON() ([]byte, error) {
...
func (o ExternalSubnet) ToMap() (map[string]interface{}, error) {
...
func (o *ExternalSubnet) UnmarshalJSON(data []byte) (err error) {
	...
	varExternalSubnet := _ExternalSubnet{}

	err = json.Unmarshal(data, &varExternalSubnet)

	if err != nil {
		return err
	}

	*o = ExternalSubnet(varExternalSubnet)
...
type NullableExternalSubnet struct {
	value *ExternalSubnet
	isSet bool
}

func (v NullableExternalSubnet) Get() *ExternalSubnet {
	return v.value
}

func (v *NullableExternalSubnet) Set(val *ExternalSubnet) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalSubnet) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalSubnet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalSubnet(val *ExternalSubnet) *NullableExternalSubnet {
	return &NullableExternalSubnet{value: val, isSet: true}
}

func (v NullableExternalSubnet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalSubnet) UnmarshalJSON(src []byte) error {
	v.isSet = true
