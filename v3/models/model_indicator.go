...
// Indicator It is a symptom that caused the alert.
type Indicator struct {
	// The metric display name in English
	MetricDisplayName *string `json:"metric_display_name,omitempty"`
	// The metric key name
	MetricName *string `json:"metric_name,omitempty"`
	// The time that this indicator was created.  It is the source metric time. 
	TriggerTime *time.Time `json:"trigger_time,omitempty"`
	// Indicating if this symptom is caused by static threshold or anomaly (dynamic threshold) evaluation.  If an indicator is raised, there may have another indicator indicating the safe guard zone value. 
	ConditionType *string `json:"condition_type,omitempty"`
	Threshold *ParamValue `json:"threshold,omitempty"`
	LastValue *ParamValue `json:"last_value,omitempty"`
	// The comparison operator used in this evaluation
	...
	WaitTimeInUsecs *int64 `json:"wait_time_in_usecs,omitempty"`
...
// GetMetricDisplayName returns the MetricDisplayName field value if set, zero value otherwise.
func (o *Indicator) GetMetricDisplayName() string {
	if o == nil || IsNil(o.MetricDisplayName) {
		var ret string
		return ret
	}
	return *o.MetricDisplayName
}

// GetMetricDisplayNameOk returns a tuple with the MetricDisplayName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Indicator) GetMetricDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.MetricDisplayName) {
		return nil, false
	}
	return o.MetricDisplayName, true
}
...
// SetMetricDisplayName gets a reference to the given string and assigns it to the MetricDisplayName field.
func (o *Indicator) SetMetricDisplayName(v string) {
	o.MetricDisplayName = &v
}
...
// SetThreshold gets a reference to the given ParamValue and assigns it to the Threshold field.
func (o *Indicator) SetThreshold(v ParamValue) {
	o.Threshold = &v
}

// GetLastValue returns the LastValue field value if set, zero value otherwise.
...
// SetLastValue gets a reference to the given ParamValue and assigns it to the LastValue field.
...
// GetWaitTimeInUsecs returns the WaitTimeInUsecs field value if set, zero value otherwise.
func (o *Indicator) GetWaitTimeInUsecs() int64 {
	if o == nil || IsNil(o.WaitTimeInUsecs) {
		var ret int64
		return ret
	}
	return *o.WaitTimeInUsecs
}

// GetWaitTimeInUsecsOk returns a tuple with the WaitTimeInUsecs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Indicator) GetWaitTimeInUsecsOk() (*int64, bool) {
	if o == nil || IsNil(o.WaitTimeInUsecs) {
		return nil, false
	}
	return o.WaitTimeInUsecs, true
}
...
// SetWaitTimeInUsecs gets a reference to the given int64 and assigns it to the WaitTimeInUsecs field.
...
func (o Indicator) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MetricDisplayName) {
		toSerialize["metric_display_name"] = o.MetricDisplayName
	}
	...
	if !IsNil(o.WaitTimeInUsecs) {
		toSerialize["wait_time_in_usecs"] = o.WaitTimeInUsecs
	}
...
func (o *Indicator) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIndicator)
	...
	*o = Indicator(varIndicator)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "metric_display_name")
		...
		delete(additionalProperties, "wait_time_in_usecs")
