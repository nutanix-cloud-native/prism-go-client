...
// checks if the VmSpecOverride type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmSpecOverride{}

// VmSpecOverride Properties of the VM that can be overriden.
type VmSpecOverride struct {
	...
	Resources *VMResources1 `json:"resources,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VmSpecOverride VmSpecOverride
...
// SetResources gets a reference to the given VMResources1 and assigns it to the Resources field.
func (o *VmSpecOverride) SetResources(v VMResources1) {
	o.Resources = &v
}

func (o VmSpecOverride) MarshalJSON() ([]byte, error) {
...
func (o VmSpecOverride) ToMap() (map[string]interface{}, error) {
...
func (o *VmSpecOverride) UnmarshalJSON(data []byte) (err error) {
	varVmSpecOverride := _VmSpecOverride{}

	err = json.Unmarshal(data, &varVmSpecOverride)

	if err != nil {
		return err
	}

	*o = VmSpecOverride(varVmSpecOverride)
...
type NullableVmSpecOverride struct {
	value *VmSpecOverride
	isSet bool
}

func (v NullableVmSpecOverride) Get() *VmSpecOverride {
	return v.value
}

func (v *NullableVmSpecOverride) Set(val *VmSpecOverride) {
	v.value = val
	v.isSet = true
}

func (v NullableVmSpecOverride) IsSet() bool {
	return v.isSet
}

func (v *NullableVmSpecOverride) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmSpecOverride(val *VmSpecOverride) *NullableVmSpecOverride {
	return &NullableVmSpecOverride{value: val, isSet: true}
}

func (v NullableVmSpecOverride) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmSpecOverride) UnmarshalJSON(src []byte) error {
	v.isSet = true
