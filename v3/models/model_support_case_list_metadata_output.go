...
// checks if the SupportCaseListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseListMetadataOutput{}

// SupportCaseListMetadataOutput All api calls that return a list will have this metadata block 
type SupportCaseListMetadataOutput struct {
	// The kind name
...
type _SupportCaseListMetadataOutput SupportCaseListMetadataOutput
...
func NewSupportCaseListMetadataOutput() *SupportCaseListMetadataOutput {
	this := SupportCaseListMetadataOutput{}
	var kind string = "support_case"
	this.Kind = &kind
	return &this
}
...
func (o SupportCaseListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varSupportCaseListMetadataOutput := _SupportCaseListMetadataOutput{}

	err = json.Unmarshal(data, &varSupportCaseListMetadataOutput)

	if err != nil {
		return err
	}

	*o = SupportCaseListMetadataOutput(varSupportCaseListMetadataOutput)
...
type NullableSupportCaseListMetadataOutput struct {
	value *SupportCaseListMetadataOutput
	isSet bool
}

func (v NullableSupportCaseListMetadataOutput) Get() *SupportCaseListMetadataOutput {
	return v.value
}

func (v *NullableSupportCaseListMetadataOutput) Set(val *SupportCaseListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseListMetadataOutput(val *SupportCaseListMetadataOutput) *NullableSupportCaseListMetadataOutput {
	return &NullableSupportCaseListMetadataOutput{value: val, isSet: true}
}

func (v NullableSupportCaseListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
