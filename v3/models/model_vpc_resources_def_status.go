...
// checks if the VpcResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcResourcesDefStatus{}
...
type _VpcResourcesDefStatus VpcResourcesDefStatus
...
func (o VpcResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VpcResourcesDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VpcResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varVpcResourcesDefStatus := _VpcResourcesDefStatus{}

	err = json.Unmarshal(data, &varVpcResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = VpcResourcesDefStatus(varVpcResourcesDefStatus)
...
type NullableVpcResourcesDefStatus struct {
	value *VpcResourcesDefStatus
	isSet bool
}

func (v NullableVpcResourcesDefStatus) Get() *VpcResourcesDefStatus {
	return v.value
}

func (v *NullableVpcResourcesDefStatus) Set(val *VpcResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcResourcesDefStatus(val *VpcResourcesDefStatus) *NullableVpcResourcesDefStatus {
	return &NullableVpcResourcesDefStatus{value: val, isSet: true}
}

func (v NullableVpcResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
