...
// checks if the ActionRuleXPilotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleXPilotParams{}

// ActionRuleXPilotParams Parameters required for XPilot enabled rule
type ActionRuleXPilotParams struct {
	// The name of the KPI that will be monitored
	MetricName string `json:"metric_name" validate:"regexp=^[^&<>'\\/\\"]*$"`
	// The Type of the entity whose KPI will be monitored
	EntityType string `json:"entity_type" validate:"regexp=^[^&<>'\\/\\"]*$"`
	...
	MonitorDurationMins *int64 `json:"monitor_duration_mins,omitempty"`
	...
	RequestApprovalAfterEachRetry *bool `json:"request_approval_after_each_retry,omitempty"`
	...
	MaxRetryCount *int64 `json:"max_retry_count,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ActionRuleXPilotParams ActionRuleXPilotParams
...
func NewActionRuleXPilotParams(metricName string, entityType string, entityInfo string) *ActionRuleXPilotParams {
	this := ActionRuleXPilotParams{}
	this.MetricName = metricName
	this.EntityType = entityType
	this.EntityInfo = entityInfo
	var maxRetryCount int64 = 5
...
// GetMinThreshold returns the MinThreshold field value if set, zero value otherwise.
func (o *ActionRuleXPilotParams) GetMinThreshold() float64 {
	if o == nil || IsNil(o.MinThreshold) {
		var ret float64
		return ret
	}
	return *o.MinThreshold
}
...
// SetMinThreshold gets a reference to the given float64 and assigns it to the MinThreshold field.
func (o *ActionRuleXPilotParams) SetMinThreshold(v float64) {
	o.MinThreshold = &v
}

// GetMonitorDurationMins returns the MonitorDurationMins field value if set, zero value otherwise.
func (o *ActionRuleXPilotParams) GetMonitorDurationMins() int64 {
	if o == nil || IsNil(o.MonitorDurationMins) {
		var ret int64
		return ret
	}
	return *o.MonitorDurationMins
}

// GetMonitorDurationMinsOk returns a tuple with the MonitorDurationMins field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleXPilotParams) GetMonitorDurationMinsOk() (*int64, bool) {
	if o == nil || IsNil(o.MonitorDurationMins) {
		return nil, false
	}
	return o.MonitorDurationMins, true
}
...
// SetMonitorDurationMins gets a reference to the given int64 and assigns it to the MonitorDurationMins field.
func (o *ActionRuleXPilotParams) SetMonitorDurationMins(v int64) {
	o.MonitorDurationMins = &v
}
...
// GetRequestApprovalAfterEachRetry returns the RequestApprovalAfterEachRetry field value if set, zero value otherwise.
func (o *ActionRuleXPilotParams) GetRequestApprovalAfterEachRetry() bool {
	if o == nil || IsNil(o.RequestApprovalAfterEachRetry) {
		var ret bool
		return ret
	}
	return *o.RequestApprovalAfterEachRetry
}

// GetRequestApprovalAfterEachRetryOk returns a tuple with the RequestApprovalAfterEachRetry field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleXPilotParams) GetRequestApprovalAfterEachRetryOk() (*bool, bool) {
	if o == nil || IsNil(o.RequestApprovalAfterEachRetry) {
		return nil, false
	}
	return o.RequestApprovalAfterEachRetry, true
}
...
// SetRequestApprovalAfterEachRetry gets a reference to the given bool and assigns it to the RequestApprovalAfterEachRetry field.
func (o *ActionRuleXPilotParams) SetRequestApprovalAfterEachRetry(v bool) {
	o.RequestApprovalAfterEachRetry = &v
}

// GetMaxThreshold returns the MaxThreshold field value if set, zero value otherwise.
func (o *ActionRuleXPilotParams) GetMaxThreshold() float64 {
	if o == nil || IsNil(o.MaxThreshold) {
		var ret float64
		return ret
	}
...
// SetMaxThreshold gets a reference to the given float64 and assigns it to the MaxThreshold field.
func (o *ActionRuleXPilotParams) SetMaxThreshold(v float64) {
	o.MaxThreshold = &v
}

// GetMaxRetryCount returns the MaxRetryCount field value if set, zero value otherwise.
func (o *ActionRuleXPilotParams) GetMaxRetryCount() int64 {
	if o == nil || IsNil(o.MaxRetryCount) {
		var ret int64
		return ret
	}
...
// GetMaxRetryCountOk returns a tuple with the MaxRetryCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionRuleXPilotParams) GetMaxRetryCountOk() (*int64, bool) {
	if o == nil || IsNil(o.MaxRetryCount) {
		return nil, false
	}
	return o.MaxRetryCount, true
}
...
// SetMaxRetryCount gets a reference to the given int64 and assigns it to the MaxRetryCount field.
func (o *ActionRuleXPilotParams) SetMaxRetryCount(v int64) {
	o.MaxRetryCount = &v
}

func (o ActionRuleXPilotParams) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleXPilotParams) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["metric_name"] = o.MetricName
	toSerialize["entity_type"] = o.EntityType
	if !IsNil(o.MinThreshold) {
		toSerialize["min_threshold"] = o.MinThreshold
	}
	if !IsNil(o.MonitorDurationMins) {
		toSerialize["monitor_duration_mins"] = o.MonitorDurationMins
	}
	toSerialize["entity_info"] = o.EntityInfo
	if !IsNil(o.RequestApprovalAfterEachRetry) {
		toSerialize["request_approval_after_each_retry"] = o.RequestApprovalAfterEachRetry
	}
	if !IsNil(o.MaxThreshold) {
		toSerialize["max_threshold"] = o.MaxThreshold
	}
	if !IsNil(o.MaxRetryCount) {
		toSerialize["max_retry_count"] = o.MaxRetryCount
	}
...
func (o *ActionRuleXPilotParams) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleXPilotParams := _ActionRuleXPilotParams{}

	err = json.Unmarshal(data, &varActionRuleXPilotParams)

	if err != nil {
		return err
	}

	*o = ActionRuleXPilotParams(varActionRuleXPilotParams)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "min_threshold")
		delete(additionalProperties, "monitor_duration_mins")
		delete(additionalProperties, "entity_info")
		delete(additionalProperties, "request_approval_after_each_retry")
		delete(additionalProperties, "max_threshold")
		delete(additionalProperties, "max_retry_count")
...
type NullableActionRuleXPilotParams struct {
	value *ActionRuleXPilotParams
	isSet bool
}

func (v NullableActionRuleXPilotParams) Get() *ActionRuleXPilotParams {
	return v.value
}

func (v *NullableActionRuleXPilotParams) Set(val *ActionRuleXPilotParams) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleXPilotParams) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleXPilotParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleXPilotParams(val *ActionRuleXPilotParams) *NullableActionRuleXPilotParams {
	return &NullableActionRuleXPilotParams{value: val, isSet: true}
}

func (v NullableActionRuleXPilotParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleXPilotParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
