...
// checks if the RecoveryPointResourceReservationSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPointResourceReservationSpec{}

// RecoveryPointResourceReservationSpec Information about required changes in resource reservation. 
type RecoveryPointResourceReservationSpec struct {
	ResourceReservationSpec RecoveryPointResourceReservationSpecResourceReservationSpec `json:"resource_reservation_spec"`
	RecoveryPointSpec *RecoveryPointResourceReservationSpecRecoveryPointSpec `json:"recovery_point_spec,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPointResourceReservationSpec RecoveryPointResourceReservationSpec
...
func NewRecoveryPointResourceReservationSpec(resourceReservationSpec RecoveryPointResourceReservationSpecResourceReservationSpec) *RecoveryPointResourceReservationSpec {
	this := RecoveryPointResourceReservationSpec{}
	this.ResourceReservationSpec = resourceReservationSpec
	return &this
}
...
// GetResourceReservationSpec returns the ResourceReservationSpec field value
func (o *RecoveryPointResourceReservationSpec) GetResourceReservationSpec() RecoveryPointResourceReservationSpecResourceReservationSpec {
	if o == nil {
		var ret RecoveryPointResourceReservationSpecResourceReservationSpec
		return ret
	}

	return o.ResourceReservationSpec
}

// GetResourceReservationSpecOk returns a tuple with the ResourceReservationSpec field value
...
func (o *RecoveryPointResourceReservationSpec) GetResourceReservationSpecOk() (*RecoveryPointResourceReservationSpecResourceReservationSpec, bool) {
	...
	return &o.ResourceReservationSpec, true
}

// SetResourceReservationSpec sets field value
func (o *RecoveryPointResourceReservationSpec) SetResourceReservationSpec(v RecoveryPointResourceReservationSpecResourceReservationSpec) {
	o.ResourceReservationSpec = v
}

// GetRecoveryPointSpec returns the RecoveryPointSpec field value if set, zero value otherwise.
func (o *RecoveryPointResourceReservationSpec) GetRecoveryPointSpec() RecoveryPointResourceReservationSpecRecoveryPointSpec {
	if o == nil || IsNil(o.RecoveryPointSpec) {
		var ret RecoveryPointResourceReservationSpecRecoveryPointSpec
		return ret
	}
	return *o.RecoveryPointSpec
}

// GetRecoveryPointSpecOk returns a tuple with the RecoveryPointSpec field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPointResourceReservationSpec) GetRecoveryPointSpecOk() (*RecoveryPointResourceReservationSpecRecoveryPointSpec, bool) {
	...
	return o.RecoveryPointSpec, true
}
...
// SetRecoveryPointSpec gets a reference to the given RecoveryPointResourceReservationSpecRecoveryPointSpec and assigns it to the RecoveryPointSpec field.
func (o *RecoveryPointResourceReservationSpec) SetRecoveryPointSpec(v RecoveryPointResourceReservationSpecRecoveryPointSpec) {
	o.RecoveryPointSpec = &v
}

func (o RecoveryPointResourceReservationSpec) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPointResourceReservationSpec) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["resource_reservation_spec"] = o.ResourceReservationSpec
	if !IsNil(o.RecoveryPointSpec) {
		toSerialize["recovery_point_spec"] = o.RecoveryPointSpec
	}
...
func (o *RecoveryPointResourceReservationSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPointResourceReservationSpec := _RecoveryPointResourceReservationSpec{}

	err = json.Unmarshal(data, &varRecoveryPointResourceReservationSpec)

	if err != nil {
		return err
	}

	*o = RecoveryPointResourceReservationSpec(varRecoveryPointResourceReservationSpec)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "resource_reservation_spec")
		delete(additionalProperties, "recovery_point_spec")
...
type NullableRecoveryPointResourceReservationSpec struct {
	value *RecoveryPointResourceReservationSpec
	isSet bool
}

func (v NullableRecoveryPointResourceReservationSpec) Get() *RecoveryPointResourceReservationSpec {
	return v.value
}

func (v *NullableRecoveryPointResourceReservationSpec) Set(val *RecoveryPointResourceReservationSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPointResourceReservationSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPointResourceReservationSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPointResourceReservationSpec(val *RecoveryPointResourceReservationSpec) *NullableRecoveryPointResourceReservationSpec {
	return &NullableRecoveryPointResourceReservationSpec{value: val, isSet: true}
}

func (v NullableRecoveryPointResourceReservationSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPointResourceReservationSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
