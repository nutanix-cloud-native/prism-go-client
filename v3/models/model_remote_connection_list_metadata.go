...
// checks if the RemoteConnectionListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionListMetadata{}

// RemoteConnectionListMetadata All api calls that return a list will have this metadata block as input 
type RemoteConnectionListMetadata struct {
	// The kind name
...
type _RemoteConnectionListMetadata RemoteConnectionListMetadata
...
func NewRemoteConnectionListMetadata() *RemoteConnectionListMetadata {
	this := RemoteConnectionListMetadata{}
...
func (o RemoteConnectionListMetadata) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteConnectionListMetadata) UnmarshalJSON(data []byte) (err error) {
	varRemoteConnectionListMetadata := _RemoteConnectionListMetadata{}

	err = json.Unmarshal(data, &varRemoteConnectionListMetadata)

	if err != nil {
		return err
	}

	*o = RemoteConnectionListMetadata(varRemoteConnectionListMetadata)
...
type NullableRemoteConnectionListMetadata struct {
	value *RemoteConnectionListMetadata
	isSet bool
}

func (v NullableRemoteConnectionListMetadata) Get() *RemoteConnectionListMetadata {
	return v.value
}

func (v *NullableRemoteConnectionListMetadata) Set(val *RemoteConnectionListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionListMetadata(val *RemoteConnectionListMetadata) *NullableRemoteConnectionListMetadata {
	return &NullableRemoteConnectionListMetadata{value: val, isSet: true}
}

func (v NullableRemoteConnectionListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
