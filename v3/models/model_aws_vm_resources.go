...
// checks if the AwsVmResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVmResources{}

// AwsVmResources AWS VM Resources Definition.
type AwsVmResources struct {
	...
	BlockDeviceMap *AwsBlockDeviceMap `json:"block_device_map,omitempty"`
...
type _AwsVmResources AwsVmResources
...
// SetBlockDeviceMap gets a reference to the given AwsBlockDeviceMap and assigns it to the BlockDeviceMap field.
...
// GetAssociatePublicIpAddress returns the AssociatePublicIpAddress field value if set, zero value otherwise.
func (o *AwsVmResources) GetAssociatePublicIpAddress() bool {
	if o == nil || IsNil(o.AssociatePublicIpAddress) {
		var ret bool
		return ret
	}
	return *o.AssociatePublicIpAddress
}

// GetAssociatePublicIpAddressOk returns a tuple with the AssociatePublicIpAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AwsVmResources) GetAssociatePublicIpAddressOk() (*bool, bool) {
	if o == nil || IsNil(o.AssociatePublicIpAddress) {
		return nil, false
	}
	return o.AssociatePublicIpAddress, true
}
...
// SetAssociatePublicIpAddress gets a reference to the given bool and assigns it to the AssociatePublicIpAddress field.
func (o *AwsVmResources) SetAssociatePublicIpAddress(v bool) {
	o.AssociatePublicIpAddress = &v
}

func (o AwsVmResources) MarshalJSON() ([]byte, error) {
...
func (o AwsVmResources) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AssociatePublicIpAddress) {
		toSerialize["associate_public_ip_address"] = o.AssociatePublicIpAddress
	}
...
func (o *AwsVmResources) UnmarshalJSON(data []byte) (err error) {
	varAwsVmResources := _AwsVmResources{}

	err = json.Unmarshal(data, &varAwsVmResources)

	if err != nil {
		return err
	}

	*o = AwsVmResources(varAwsVmResources)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "associate_public_ip_address")
...
type NullableAwsVmResources struct {
	value *AwsVmResources
	isSet bool
}

func (v NullableAwsVmResources) Get() *AwsVmResources {
	return v.value
}

func (v *NullableAwsVmResources) Set(val *AwsVmResources) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVmResources) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVmResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVmResources(val *AwsVmResources) *NullableAwsVmResources {
	return &NullableAwsVmResources{value: val, isSet: true}
}

func (v NullableAwsVmResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVmResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
