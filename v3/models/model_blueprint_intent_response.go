...
// checks if the BlueprintIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintIntentResponse{}

// BlueprintIntentResponse Response object for intentful operations on a blueprint
type BlueprintIntentResponse struct {
	Status *BlueprintDefStatus `json:"status,omitempty"`
	Spec *Blueprint `json:"spec,omitempty"`
...
type _BlueprintIntentResponse BlueprintIntentResponse
...
// SetStatus gets a reference to the given BlueprintDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Blueprint and assigns it to the Spec field.
...
func (o BlueprintIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o BlueprintIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintIntentResponse := _BlueprintIntentResponse{}

	err = json.Unmarshal(data, &varBlueprintIntentResponse)

	if err != nil {
		return err
	}

	*o = BlueprintIntentResponse(varBlueprintIntentResponse)
...
type NullableBlueprintIntentResponse struct {
	value *BlueprintIntentResponse
	isSet bool
}

func (v NullableBlueprintIntentResponse) Get() *BlueprintIntentResponse {
	return v.value
}

func (v *NullableBlueprintIntentResponse) Set(val *BlueprintIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintIntentResponse(val *BlueprintIntentResponse) *NullableBlueprintIntentResponse {
	return &NullableBlueprintIntentResponse{value: val, isSet: true}
}

func (v NullableBlueprintIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
