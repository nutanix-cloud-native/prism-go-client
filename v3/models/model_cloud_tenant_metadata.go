...
// checks if the CloudTenantMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTenantMetadata{}

// CloudTenantMetadata The cloud_tenant kind metadata
type CloudTenantMetadata struct {
	// UTC date and time in RFC-3339 format when cloud_tenant was last updated 
	...
	// UTC date and time in RFC-3339 format when cloud_tenant was created 
	...
	// Categories for the cloud_tenant. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the cloud_tenant. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _CloudTenantMetadata CloudTenantMetadata
...
func (o CloudTenantMetadata) MarshalJSON() ([]byte, error) {
...
func (o CloudTenantMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTenantMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudTenantMetadata := _CloudTenantMetadata{}

	err = json.Unmarshal(data, &varCloudTenantMetadata)

	if err != nil {
		return err
	}

	*o = CloudTenantMetadata(varCloudTenantMetadata)
...
type NullableCloudTenantMetadata struct {
	value *CloudTenantMetadata
	isSet bool
}

func (v NullableCloudTenantMetadata) Get() *CloudTenantMetadata {
	return v.value
}

func (v *NullableCloudTenantMetadata) Set(val *CloudTenantMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTenantMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTenantMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTenantMetadata(val *CloudTenantMetadata) *NullableCloudTenantMetadata {
	return &NullableCloudTenantMetadata{value: val, isSet: true}
}

func (v NullableCloudTenantMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTenantMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
