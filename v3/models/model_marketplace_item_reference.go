...
// checks if the MarketplaceItemReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemReference{}

// MarketplaceItemReference The reference to a marketplace_item
type MarketplaceItemReference struct {
	// The kind name
...
type _MarketplaceItemReference MarketplaceItemReference
...
func (o MarketplaceItemReference) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemReference) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItemReference) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceItemReference := _MarketplaceItemReference{}

	err = json.Unmarshal(data, &varMarketplaceItemReference)

	if err != nil {
		return err
	}

	*o = MarketplaceItemReference(varMarketplaceItemReference)
...
type NullableMarketplaceItemReference struct {
	value *MarketplaceItemReference
	isSet bool
}

func (v NullableMarketplaceItemReference) Get() *MarketplaceItemReference {
	return v.value
}

func (v *NullableMarketplaceItemReference) Set(val *MarketplaceItemReference) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemReference) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemReference(val *MarketplaceItemReference) *NullableMarketplaceItemReference {
	return &NullableMarketplaceItemReference{value: val, isSet: true}
}

func (v NullableMarketplaceItemReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
