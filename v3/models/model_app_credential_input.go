...
// checks if the AppCredentialInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCredentialInput{}

// AppCredentialInput Credential for application
type AppCredentialInput struct {
	// 
...
type _AppCredentialInput AppCredentialInput
...
func (o AppCredentialInput) MarshalJSON() ([]byte, error) {
...
func (o AppCredentialInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppCredentialInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCredentialInput := _AppCredentialInput{}

	err = json.Unmarshal(data, &varAppCredentialInput)

	if err != nil {
		return err
	}

	*o = AppCredentialInput(varAppCredentialInput)
...
type NullableAppCredentialInput struct {
	value *AppCredentialInput
	isSet bool
}

func (v NullableAppCredentialInput) Get() *AppCredentialInput {
	return v.value
}

func (v *NullableAppCredentialInput) Set(val *AppCredentialInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCredentialInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCredentialInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCredentialInput(val *AppCredentialInput) *NullableAppCredentialInput {
	return &NullableAppCredentialInput{value: val, isSet: true}
}

func (v NullableAppCredentialInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCredentialInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
