...
// checks if the AppActionrunInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppActionrunInput{}

// AppActionrunInput Request object for action_run, contains action_run_log
type AppActionrunInput struct {
...
type _AppActionrunInput AppActionrunInput
...
func (o AppActionrunInput) MarshalJSON() ([]byte, error) {
...
func (o AppActionrunInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppActionrunInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppActionrunInput := _AppActionrunInput{}

	err = json.Unmarshal(data, &varAppActionrunInput)

	if err != nil {
		return err
	}

	*o = AppActionrunInput(varAppActionrunInput)
...
type NullableAppActionrunInput struct {
	value *AppActionrunInput
	isSet bool
}

func (v NullableAppActionrunInput) Get() *AppActionrunInput {
	return v.value
}

func (v *NullableAppActionrunInput) Set(val *AppActionrunInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppActionrunInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppActionrunInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppActionrunInput(val *AppActionrunInput) *NullableAppActionrunInput {
	return &NullableAppActionrunInput{value: val, isSet: true}
}

func (v NullableAppActionrunInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppActionrunInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
