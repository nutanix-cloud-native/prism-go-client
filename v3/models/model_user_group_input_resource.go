...
// checks if the UserGroupInputResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupInputResource{}

// UserGroupInputResource User Group Resource Definition
type UserGroupInputResource struct {
	SamlUserGroup *SamlUserGroupInput `json:"saml_user_group,omitempty"`
	DirectoryServiceUserGroup *DirectoryServiceUserGroupInput `json:"directory_service_user_group,omitempty"`
	DirectoryServiceOu *DirectoryServiceOuInput `json:"directory_service_ou,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UserGroupInputResource UserGroupInputResource
...
// GetSamlUserGroup returns the SamlUserGroup field value if set, zero value otherwise.
func (o *UserGroupInputResource) GetSamlUserGroup() SamlUserGroupInput {
	if o == nil || IsNil(o.SamlUserGroup) {
		var ret SamlUserGroupInput
		return ret
	}
	return *o.SamlUserGroup
}

// GetSamlUserGroupOk returns a tuple with the SamlUserGroup field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserGroupInputResource) GetSamlUserGroupOk() (*SamlUserGroupInput, bool) {
	if o == nil || IsNil(o.SamlUserGroup) {
		return nil, false
	}
	return o.SamlUserGroup, true
}
...
// SetSamlUserGroup gets a reference to the given SamlUserGroupInput and assigns it to the SamlUserGroup field.
...
func (o *UserGroupInputResource) GetDirectoryServiceUserGroup() DirectoryServiceUserGroupInput {
	if o == nil || IsNil(o.DirectoryServiceUserGroup) {
		var ret DirectoryServiceUserGroupInput
		return ret
	}
...
// SetDirectoryServiceUserGroup gets a reference to the given DirectoryServiceUserGroupInput and assigns it to the DirectoryServiceUserGroup field.
func (o *UserGroupInputResource) SetDirectoryServiceUserGroup(v DirectoryServiceUserGroupInput) {
	o.DirectoryServiceUserGroup = &v
}

// GetDirectoryServiceOu returns the DirectoryServiceOu field value if set, zero value otherwise.
func (o *UserGroupInputResource) GetDirectoryServiceOu() DirectoryServiceOuInput {
	if o == nil || IsNil(o.DirectoryServiceOu) {
		var ret DirectoryServiceOuInput
		return ret
	}
	return *o.DirectoryServiceOu
}

// GetDirectoryServiceOuOk returns a tuple with the DirectoryServiceOu field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserGroupInputResource) GetDirectoryServiceOuOk() (*DirectoryServiceOuInput, bool) {
	if o == nil || IsNil(o.DirectoryServiceOu) {
		return nil, false
	}
	return o.DirectoryServiceOu, true
}
...
// SetDirectoryServiceOu gets a reference to the given DirectoryServiceOuInput and assigns it to the DirectoryServiceOu field.
func (o *UserGroupInputResource) SetDirectoryServiceOu(v DirectoryServiceOuInput) {
	o.DirectoryServiceOu = &v
}

func (o UserGroupInputResource) MarshalJSON() ([]byte, error) {
...
func (o UserGroupInputResource) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SamlUserGroup) {
		toSerialize["saml_user_group"] = o.SamlUserGroup
	}
	if !IsNil(o.DirectoryServiceUserGroup) {
		toSerialize["directory_service_user_group"] = o.DirectoryServiceUserGroup
	}
	if !IsNil(o.DirectoryServiceOu) {
		toSerialize["directory_service_ou"] = o.DirectoryServiceOu
	}
...
func (o *UserGroupInputResource) UnmarshalJSON(data []byte) (err error) {
	varUserGroupInputResource := _UserGroupInputResource{}

	err = json.Unmarshal(data, &varUserGroupInputResource)

	if err != nil {
		return err
	}

	*o = UserGroupInputResource(varUserGroupInputResource)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "saml_user_group")
		delete(additionalProperties, "directory_service_user_group")
		delete(additionalProperties, "directory_service_ou")
...
type NullableUserGroupInputResource struct {
	value *UserGroupInputResource
	isSet bool
}

func (v NullableUserGroupInputResource) Get() *UserGroupInputResource {
	return v.value
}

func (v *NullableUserGroupInputResource) Set(val *UserGroupInputResource) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupInputResource) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupInputResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupInputResource(val *UserGroupInputResource) *NullableUserGroupInputResource {
	return &NullableUserGroupInputResource{value: val, isSet: true}
}

func (v NullableUserGroupInputResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupInputResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
