...
// checks if the CommonReportConfigDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigDefStatus{}

// CommonReportConfigDefStatus Common Report Config creation/modification status.
type CommonReportConfigDefStatus struct {
	// The state of the common report config entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	// Name of the common report config.
	Name string `json:"name"`
	Resources CommonReportConfigResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _CommonReportConfigDefStatus CommonReportConfigDefStatus
...
func NewCommonReportConfigDefStatus(name string, resources CommonReportConfigResources) *CommonReportConfigDefStatus {
	this := CommonReportConfigDefStatus{}
	this.Name = name
...
func (o *CommonReportConfigDefStatus) GetResources() CommonReportConfigResources {
	if o == nil {
		var ret CommonReportConfigResources
		return ret
	}
...
func (o CommonReportConfigDefStatus) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfigDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonReportConfigDefStatus := _CommonReportConfigDefStatus{}

	err = json.Unmarshal(data, &varCommonReportConfigDefStatus)

	if err != nil {
		return err
	}

	*o = CommonReportConfigDefStatus(varCommonReportConfigDefStatus)
...
type NullableCommonReportConfigDefStatus struct {
	value *CommonReportConfigDefStatus
	isSet bool
}

func (v NullableCommonReportConfigDefStatus) Get() *CommonReportConfigDefStatus {
	return v.value
}

func (v *NullableCommonReportConfigDefStatus) Set(val *CommonReportConfigDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigDefStatus(val *CommonReportConfigDefStatus) *NullableCommonReportConfigDefStatus {
	return &NullableCommonReportConfigDefStatus{value: val, isSet: true}
}

func (v NullableCommonReportConfigDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
