...
// checks if the MarketplaceItemStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemStatus{}

// MarketplaceItemStatus The status of a REST API call. Only used when there is a failure to report. 
type MarketplaceItemStatus struct {
	// The kind name
...
type _MarketplaceItemStatus MarketplaceItemStatus
...
func (o MarketplaceItemStatus) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemStatus) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItemStatus) UnmarshalJSON(data []byte) (err error) {
	varMarketplaceItemStatus := _MarketplaceItemStatus{}

	err = json.Unmarshal(data, &varMarketplaceItemStatus)

	if err != nil {
		return err
	}

	*o = MarketplaceItemStatus(varMarketplaceItemStatus)
...
type NullableMarketplaceItemStatus struct {
	value *MarketplaceItemStatus
	isSet bool
}

func (v NullableMarketplaceItemStatus) Get() *MarketplaceItemStatus {
	return v.value
}

func (v *NullableMarketplaceItemStatus) Set(val *MarketplaceItemStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemStatus(val *MarketplaceItemStatus) *NullableMarketplaceItemStatus {
	return &NullableMarketplaceItemStatus{value: val, isSet: true}
}

func (v NullableMarketplaceItemStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
