...
// checks if the VmHostAffinityPolicyConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityPolicyConfig{}

// VmHostAffinityPolicyConfig Defines an affinity policy between a set of VM categories to a set of Host categories. 
type VmHostAffinityPolicyConfig struct {
	// VM categories across whom affinity is being defined. 
	VmCategories map[string][]string `json:"vm_categories"`
	// Description of the policy.
	Description *string `json:"description,omitempty"`
	// Host categories across whom affinity is being defined. 
	HostCategories map[string][]string `json:"host_categories"`
	// Name of the policy.
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _VmHostAffinityPolicyConfig VmHostAffinityPolicyConfig
...
func NewVmHostAffinityPolicyConfig(vmCategories map[string][]string, hostCategories map[string][]string, name string) *VmHostAffinityPolicyConfig {
	this := VmHostAffinityPolicyConfig{}
...
// GetVmCategories returns the VmCategories field value
...
// GetVmCategoriesOk returns a tuple with the VmCategories field value
...
// SetVmCategories sets field value
...
// GetHostCategories returns the HostCategories field value
func (o *VmHostAffinityPolicyConfig) GetHostCategories() map[string][]string {
	...
	return o.HostCategories
}

// GetHostCategoriesOk returns a tuple with the HostCategories field value
// and a boolean to check if the value has been set.
func (o *VmHostAffinityPolicyConfig) GetHostCategoriesOk() (*map[string][]string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.HostCategories, true
}

// SetHostCategories sets field value
...
func (o VmHostAffinityPolicyConfig) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityPolicyConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["vm_categories"] = o.VmCategories
	if !IsNil(o.Description) {
		toSerialize["description"] = o.Description
	}
	toSerialize["host_categories"] = o.HostCategories
...
func (o *VmHostAffinityPolicyConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varVmHostAffinityPolicyConfig := _VmHostAffinityPolicyConfig{}

	err = json.Unmarshal(data, &varVmHostAffinityPolicyConfig)

	if err != nil {
		return err
	}

	*o = VmHostAffinityPolicyConfig(varVmHostAffinityPolicyConfig)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "host_categories")
...
type NullableVmHostAffinityPolicyConfig struct {
	value *VmHostAffinityPolicyConfig
	isSet bool
}

func (v NullableVmHostAffinityPolicyConfig) Get() *VmHostAffinityPolicyConfig {
	return v.value
}

func (v *NullableVmHostAffinityPolicyConfig) Set(val *VmHostAffinityPolicyConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityPolicyConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityPolicyConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityPolicyConfig(val *VmHostAffinityPolicyConfig) *NullableVmHostAffinityPolicyConfig {
	return &NullableVmHostAffinityPolicyConfig{value: val, isSet: true}
}

func (v NullableVmHostAffinityPolicyConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityPolicyConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
