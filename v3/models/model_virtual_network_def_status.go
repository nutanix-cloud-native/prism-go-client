...
// checks if the VirtualNetworkDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkDefStatus{}

// VirtualNetworkDefStatus Virtual network output status
...
type _VirtualNetworkDefStatus VirtualNetworkDefStatus
...
func (o *VirtualNetworkDefStatus) GetResources() VirtualNetworkResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret VirtualNetworkResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given VirtualNetworkResourcesDefStatus and assigns it to the Resources field.
...
func (o VirtualNetworkDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualNetworkDefStatus) UnmarshalJSON(data []byte) (err error) {
	varVirtualNetworkDefStatus := _VirtualNetworkDefStatus{}

	err = json.Unmarshal(data, &varVirtualNetworkDefStatus)

	if err != nil {
		return err
	}

	*o = VirtualNetworkDefStatus(varVirtualNetworkDefStatus)
...
type NullableVirtualNetworkDefStatus struct {
	value *VirtualNetworkDefStatus
	isSet bool
}

func (v NullableVirtualNetworkDefStatus) Get() *VirtualNetworkDefStatus {
	return v.value
}

func (v *NullableVirtualNetworkDefStatus) Set(val *VirtualNetworkDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkDefStatus(val *VirtualNetworkDefStatus) *NullableVirtualNetworkDefStatus {
	return &NullableVirtualNetworkDefStatus{value: val, isSet: true}
}

func (v NullableVirtualNetworkDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
