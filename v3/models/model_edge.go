...
type Edge struct {
	...
	DestinationVertexId *string `json:"destination_vertex_id,omitempty"`
	// ID of source vertex
	SourceVertexId *string `json:"source_vertex_id,omitempty"`
	// Traffic information of the edge.
	TrafficList []Traffic `json:"traffic_list,omitempty"`
...
// GetDestinationVertexId returns the DestinationVertexId field value if set, zero value otherwise.
func (o *Edge) GetDestinationVertexId() string {
	if o == nil || IsNil(o.DestinationVertexId) {
		var ret string
		return ret
	}
	return *o.DestinationVertexId
}

// GetDestinationVertexIdOk returns a tuple with the DestinationVertexId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Edge) GetDestinationVertexIdOk() (*string, bool) {
	if o == nil || IsNil(o.DestinationVertexId) {
		return nil, false
	}
	return o.DestinationVertexId, true
}
...
// SetDestinationVertexId gets a reference to the given string and assigns it to the DestinationVertexId field.
func (o *Edge) SetDestinationVertexId(v string) {
	o.DestinationVertexId = &v
}

// GetSourceVertexId returns the SourceVertexId field value if set, zero value otherwise.
func (o *Edge) GetSourceVertexId() string {
	if o == nil || IsNil(o.SourceVertexId) {
		var ret string
		return ret
	}
	return *o.SourceVertexId
}

// GetSourceVertexIdOk returns a tuple with the SourceVertexId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Edge) GetSourceVertexIdOk() (*string, bool) {
	if o == nil || IsNil(o.SourceVertexId) {
		return nil, false
	}
	return o.SourceVertexId, true
}
...
// SetSourceVertexId gets a reference to the given string and assigns it to the SourceVertexId field.
func (o *Edge) SetSourceVertexId(v string) {
	o.SourceVertexId = &v
}

// GetTrafficList returns the TrafficList field value if set, zero value otherwise.
func (o *Edge) GetTrafficList() []Traffic {
	if o == nil || IsNil(o.TrafficList) {
		var ret []Traffic
		return ret
	}
	return o.TrafficList
}

// GetTrafficListOk returns a tuple with the TrafficList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Edge) GetTrafficListOk() ([]Traffic, bool) {
	if o == nil || IsNil(o.TrafficList) {
		return nil, false
	}
	return o.TrafficList, true
}
...
// SetTrafficList gets a reference to the given []Traffic and assigns it to the TrafficList field.
...
func (o Edge) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DestinationVertexId) {
		toSerialize["destination_vertex_id"] = o.DestinationVertexId
	}
	if !IsNil(o.SourceVertexId) {
		toSerialize["source_vertex_id"] = o.SourceVertexId
	}
	if !IsNil(o.TrafficList) {
		toSerialize["traffic_list"] = o.TrafficList
	}
...
func (o *Edge) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEdge)
	...
	*o = Edge(varEdge)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "destination_vertex_id")
		delete(additionalProperties, "source_vertex_id")
		delete(additionalProperties, "traffic_list")
