...
// checks if the AccessControlPolicyListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessControlPolicyListMetadata{}

// AccessControlPolicyListMetadata All api calls that return a list will have this metadata block as input 
type AccessControlPolicyListMetadata struct {
	// The kind name
...
type _AccessControlPolicyListMetadata AccessControlPolicyListMetadata
...
func NewAccessControlPolicyListMetadata() *AccessControlPolicyListMetadata {
	this := AccessControlPolicyListMetadata{}
...
func (o AccessControlPolicyListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AccessControlPolicyListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AccessControlPolicyListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAccessControlPolicyListMetadata := _AccessControlPolicyListMetadata{}

	err = json.Unmarshal(data, &varAccessControlPolicyListMetadata)

	if err != nil {
		return err
	}

	*o = AccessControlPolicyListMetadata(varAccessControlPolicyListMetadata)
...
type NullableAccessControlPolicyListMetadata struct {
	value *AccessControlPolicyListMetadata
	isSet bool
}

func (v NullableAccessControlPolicyListMetadata) Get() *AccessControlPolicyListMetadata {
	return v.value
}

func (v *NullableAccessControlPolicyListMetadata) Set(val *AccessControlPolicyListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessControlPolicyListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessControlPolicyListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessControlPolicyListMetadata(val *AccessControlPolicyListMetadata) *NullableAccessControlPolicyListMetadata {
	return &NullableAccessControlPolicyListMetadata{value: val, isSet: true}
}

func (v NullableAccessControlPolicyListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessControlPolicyListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
