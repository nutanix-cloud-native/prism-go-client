...
// checks if the FilterExpression type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FilterExpression{}

// FilterExpression Filter Expression details.
type FilterExpression struct {
	// Operator to be used for the value on the entity. Example, =, cs, >=, etc. 
	Operator string `json:"operator"`
	// String corresponding to the value to be displayed on UI.
	DisplayForValue *string `json:"display_for_value,omitempty"`
	// Value of property.
	Value string `json:"value"`
	// Name of the entity property.
	PropertyName string `json:"property_name"`
	// String corresponding to the operator to be displayed on UI.
	DisplayForOperator *string `json:"display_for_operator,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FilterExpression FilterExpression
...
// GetDisplayForValue returns the DisplayForValue field value if set, zero value otherwise.
func (o *FilterExpression) GetDisplayForValue() string {
	if o == nil || IsNil(o.DisplayForValue) {
		var ret string
		return ret
	}
	return *o.DisplayForValue
}

// GetDisplayForValueOk returns a tuple with the DisplayForValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FilterExpression) GetDisplayForValueOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayForValue) {
		return nil, false
	}
	return o.DisplayForValue, true
}
...
// SetDisplayForValue gets a reference to the given string and assigns it to the DisplayForValue field.
...
func (o FilterExpression) MarshalJSON() ([]byte, error) {
...
func (o FilterExpression) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["operator"] = o.Operator
	if !IsNil(o.DisplayForValue) {
		toSerialize["display_for_value"] = o.DisplayForValue
	}
...
func (o *FilterExpression) UnmarshalJSON(data []byte) (err error) {
	...
	varFilterExpression := _FilterExpression{}

	err = json.Unmarshal(data, &varFilterExpression)

	if err != nil {
		return err
	}

	*o = FilterExpression(varFilterExpression)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "operator")
		delete(additionalProperties, "display_for_value")
