...
// checks if the ResourceDomainListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceDomainListMetadataOutput{}

// ResourceDomainListMetadataOutput All api calls that return a list will have this metadata block 
...
type _ResourceDomainListMetadataOutput ResourceDomainListMetadataOutput
...
func NewResourceDomainListMetadataOutput() *ResourceDomainListMetadataOutput {
	this := ResourceDomainListMetadataOutput{}
	var kind string = "resource_domain"
	this.Kind = &kind
	return &this
}
...
func (o ResourceDomainListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ResourceDomainListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceDomainListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varResourceDomainListMetadataOutput := _ResourceDomainListMetadataOutput{}

	err = json.Unmarshal(data, &varResourceDomainListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ResourceDomainListMetadataOutput(varResourceDomainListMetadataOutput)
...
type NullableResourceDomainListMetadataOutput struct {
	value *ResourceDomainListMetadataOutput
	isSet bool
}

func (v NullableResourceDomainListMetadataOutput) Get() *ResourceDomainListMetadataOutput {
	return v.value
}

func (v *NullableResourceDomainListMetadataOutput) Set(val *ResourceDomainListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceDomainListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceDomainListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceDomainListMetadataOutput(val *ResourceDomainListMetadataOutput) *NullableResourceDomainListMetadataOutput {
	return &NullableResourceDomainListMetadataOutput{value: val, isSet: true}
}

func (v NullableResourceDomainListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceDomainListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
