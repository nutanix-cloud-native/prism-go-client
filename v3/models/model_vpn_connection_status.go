...
// checks if the VpnConnectionStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionStatus{}

// VpnConnectionStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _VpnConnectionStatus VpnConnectionStatus
...
func (o VpnConnectionStatus) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnectionStatus) UnmarshalJSON(data []byte) (err error) {
	varVpnConnectionStatus := _VpnConnectionStatus{}

	err = json.Unmarshal(data, &varVpnConnectionStatus)

	if err != nil {
		return err
	}

	*o = VpnConnectionStatus(varVpnConnectionStatus)
...
type NullableVpnConnectionStatus struct {
	value *VpnConnectionStatus
	isSet bool
}

func (v NullableVpnConnectionStatus) Get() *VpnConnectionStatus {
	return v.value
}

func (v *NullableVpnConnectionStatus) Set(val *VpnConnectionStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionStatus(val *VpnConnectionStatus) *NullableVpnConnectionStatus {
	return &NullableVpnConnectionStatus{value: val, isSet: true}
}

func (v NullableVpnConnectionStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
