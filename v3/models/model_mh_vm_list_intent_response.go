...
// checks if the MhVmListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmListIntentResponse{}

// MhVmListIntentResponse Response object for intentful operation of mh_vms
type MhVmListIntentResponse struct {
	Entities []MhVmIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata MhVmListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _MhVmListIntentResponse MhVmListIntentResponse
...
// SetEntities gets a reference to the given []MhVmIntentResource and assigns it to the Entities field.
...
func (o *MhVmListIntentResponse) GetMetadata() MhVmListMetadataOutput {
	if o == nil {
		var ret MhVmListMetadataOutput
		return ret
	}
...
func (o MhVmListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o MhVmListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMhVmListIntentResponse := _MhVmListIntentResponse{}

	err = json.Unmarshal(data, &varMhVmListIntentResponse)

	if err != nil {
		return err
	}

	*o = MhVmListIntentResponse(varMhVmListIntentResponse)
...
type NullableMhVmListIntentResponse struct {
	value *MhVmListIntentResponse
	isSet bool
}

func (v NullableMhVmListIntentResponse) Get() *MhVmListIntentResponse {
	return v.value
}

func (v *NullableMhVmListIntentResponse) Set(val *MhVmListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmListIntentResponse(val *MhVmListIntentResponse) *NullableMhVmListIntentResponse {
	return &NullableMhVmListIntentResponse{value: val, isSet: true}
}

func (v NullableMhVmListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
