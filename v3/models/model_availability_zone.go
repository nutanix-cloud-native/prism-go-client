...
// AvailabilityZone Availability Zone creation/modification spec
type AvailabilityZone struct {
	// Availability Zone Name
	Name string `json:"name"`
	Resources AvailabilityZoneResourcesSpec `json:"resources"`
...
func (o *AvailabilityZone) GetResources() AvailabilityZoneResourcesSpec {
	if o == nil {
		var ret AvailabilityZoneResourcesSpec
		return ret
	}
