...
// checks if the BlueprintReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintReference{}

// BlueprintReference The reference to a blueprint
...
type _BlueprintReference BlueprintReference
...
func (o BlueprintReference) MarshalJSON() ([]byte, error) {
...
func (o BlueprintReference) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintReference) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintReference := _BlueprintReference{}

	err = json.Unmarshal(data, &varBlueprintReference)

	if err != nil {
		return err
	}

	*o = BlueprintReference(varBlueprintReference)
...
type NullableBlueprintReference struct {
	value *BlueprintReference
	isSet bool
}

func (v NullableBlueprintReference) Get() *BlueprintReference {
	return v.value
}

func (v *NullableBlueprintReference) Set(val *BlueprintReference) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintReference) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintReference(val *BlueprintReference) *NullableBlueprintReference {
	return &NullableBlueprintReference{value: val, isSet: true}
}

func (v NullableBlueprintReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
