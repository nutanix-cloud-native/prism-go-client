...
// checks if the DockerRegistryIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryIntentInput{}

// DockerRegistryIntentInput An intentful representation of a docker_registry
type DockerRegistryIntentInput struct {
	Spec DockerRegistry `json:"spec"`
...
type _DockerRegistryIntentInput DockerRegistryIntentInput
...
func NewDockerRegistryIntentInput(spec DockerRegistry, metadata DockerRegistryMetadata) *DockerRegistryIntentInput {
	this := DockerRegistryIntentInput{}
	this.Spec = spec
...
func (o DockerRegistryIntentInput) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerRegistryIntentInput := _DockerRegistryIntentInput{}

	err = json.Unmarshal(data, &varDockerRegistryIntentInput)

	if err != nil {
		return err
	}

	*o = DockerRegistryIntentInput(varDockerRegistryIntentInput)
...
type NullableDockerRegistryIntentInput struct {
	value *DockerRegistryIntentInput
	isSet bool
}

func (v NullableDockerRegistryIntentInput) Get() *DockerRegistryIntentInput {
	return v.value
}

func (v *NullableDockerRegistryIntentInput) Set(val *DockerRegistryIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryIntentInput(val *DockerRegistryIntentInput) *NullableDockerRegistryIntentInput {
	return &NullableDockerRegistryIntentInput{value: val, isSet: true}
}

func (v NullableDockerRegistryIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
