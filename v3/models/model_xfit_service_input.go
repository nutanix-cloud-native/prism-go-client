...
// checks if the XfitServiceInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &XfitServiceInput{}

// XfitServiceInput Input body to configure xfit service.
type XfitServiceInput struct {
	// The desired state of xfit service.
	State *string `json:"state,omitempty"`
	// Flag indicating whether to do Xfit enablement validation only. 
	ValidationOnly *bool `json:"validation_only,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _XfitServiceInput XfitServiceInput
...
// GetValidationOnly returns the ValidationOnly field value if set, zero value otherwise.
func (o *XfitServiceInput) GetValidationOnly() bool {
	if o == nil || IsNil(o.ValidationOnly) {
		var ret bool
		return ret
	}
	return *o.ValidationOnly
}

// GetValidationOnlyOk returns a tuple with the ValidationOnly field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *XfitServiceInput) GetValidationOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.ValidationOnly) {
		return nil, false
	}
	return o.ValidationOnly, true
}
...
// SetValidationOnly gets a reference to the given bool and assigns it to the ValidationOnly field.
func (o *XfitServiceInput) SetValidationOnly(v bool) {
	o.ValidationOnly = &v
}

func (o XfitServiceInput) MarshalJSON() ([]byte, error) {
...
func (o XfitServiceInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.State) {
		toSerialize["state"] = o.State
	}
	if !IsNil(o.ValidationOnly) {
		toSerialize["validation_only"] = o.ValidationOnly
	}
...
func (o *XfitServiceInput) UnmarshalJSON(data []byte) (err error) {
	varXfitServiceInput := _XfitServiceInput{}

	err = json.Unmarshal(data, &varXfitServiceInput)

	if err != nil {
		return err
	}

	*o = XfitServiceInput(varXfitServiceInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "state")
		delete(additionalProperties, "validation_only")
...
type NullableXfitServiceInput struct {
	value *XfitServiceInput
	isSet bool
}

func (v NullableXfitServiceInput) Get() *XfitServiceInput {
	return v.value
}

func (v *NullableXfitServiceInput) Set(val *XfitServiceInput) {
	v.value = val
	v.isSet = true
}

func (v NullableXfitServiceInput) IsSet() bool {
	return v.isSet
}

func (v *NullableXfitServiceInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableXfitServiceInput(val *XfitServiceInput) *NullableXfitServiceInput {
	return &NullableXfitServiceInput{value: val, isSet: true}
}

func (v NullableXfitServiceInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableXfitServiceInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
