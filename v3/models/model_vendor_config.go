...
// VendorConfig Vendor device and its versions.
type VendorConfig struct {
	// Vendor device version list.
...
// GetVersionList returns the VersionList field value if set, zero value otherwise.
func (o *VendorConfig) GetVersionList() []string {
	if o == nil || IsNil(o.VersionList) {
		var ret []string
		return ret
	}
	return o.VersionList
}

// GetVersionListOk returns a tuple with the VersionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VendorConfig) GetVersionListOk() ([]string, bool) {
	if o == nil || IsNil(o.VersionList) {
		return nil, false
	}
	return o.VersionList, true
}
...
// SetVersionList gets a reference to the given []string and assigns it to the VersionList field.
...
func (o VendorConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.VersionList) {
		toSerialize["version_list"] = o.VersionList
	}
	if !IsNil(o.Name) {
...
func (o *VendorConfig) UnmarshalJSON(data []byte) (err error) {
	...
	*o = VendorConfig(varVendorConfig)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "version_list")
