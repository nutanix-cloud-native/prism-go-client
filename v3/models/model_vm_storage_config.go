...
// checks if the VmStorageConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmStorageConfig{}

// VmStorageConfig User inputs of storage configuration parameters for VMs.
...
type _VmStorageConfig VmStorageConfig
...
func (o VmStorageConfig) MarshalJSON() ([]byte, error) {
...
func (o VmStorageConfig) ToMap() (map[string]interface{}, error) {
...
func (o *VmStorageConfig) UnmarshalJSON(data []byte) (err error) {
	varVmStorageConfig := _VmStorageConfig{}

	err = json.Unmarshal(data, &varVmStorageConfig)

	if err != nil {
		return err
	}

	*o = VmStorageConfig(varVmStorageConfig)
...
type NullableVmStorageConfig struct {
	value *VmStorageConfig
	isSet bool
}

func (v NullableVmStorageConfig) Get() *VmStorageConfig {
	return v.value
}

func (v *NullableVmStorageConfig) Set(val *VmStorageConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableVmStorageConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableVmStorageConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmStorageConfig(val *VmStorageConfig) *NullableVmStorageConfig {
	return &NullableVmStorageConfig{value: val, isSet: true}
}

func (v NullableVmStorageConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmStorageConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
