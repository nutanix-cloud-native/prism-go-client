...
type NetworkRule struct {
	...
	IcmpTypeCodeList []NetworkRuleIcmpTypeCodeListInner `json:"icmp_type_code_list,omitempty"`
...
// SetTcpPortRangeList gets a reference to the given []PortRange and assigns it to the TcpPortRangeList field.
...
// SetUdpPortRangeList gets a reference to the given []PortRange and assigns it to the UdpPortRangeList field.
...
func (o *NetworkRule) GetIcmpTypeCodeList() []NetworkRuleIcmpTypeCodeListInner {
	if o == nil || IsNil(o.IcmpTypeCodeList) {
		var ret []NetworkRuleIcmpTypeCodeListInner
		return ret
	}
...
// SetIcmpTypeCodeList gets a reference to the given []NetworkRuleIcmpTypeCodeListInner and assigns it to the IcmpTypeCodeList field.
...
func (o *NetworkRule) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNetworkRule)
