...
// checks if the IdentityCategorizationConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityCategorizationConfig{}

// IdentityCategorizationConfig Configuration for identity categorization such as registered directories, etc. 
type IdentityCategorizationConfig struct {
	// Enablement status of the default category.
	IsDefaultCategoryEnabled *bool `json:"is_default_category_enabled,omitempty"`
	// Retain default category on user login.
	KeepDefaultCategoryOnLogin *bool `json:"keep_default_category_on_login,omitempty"`
	// Directory service specific config.
	DirectoryServiceConfigList []IdentityCategorizationDirectoryConfig `json:"directory_service_config_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _IdentityCategorizationConfig IdentityCategorizationConfig
...
func NewIdentityCategorizationConfig() *IdentityCategorizationConfig {
	this := IdentityCategorizationConfig{}
	var isDefaultCategoryEnabled bool = false
	this.IsDefaultCategoryEnabled = &isDefaultCategoryEnabled
	var keepDefaultCategoryOnLogin bool = false
	this.KeepDefaultCategoryOnLogin = &keepDefaultCategoryOnLogin
	return &this
}
...
// GetIsDefaultCategoryEnabled returns the IsDefaultCategoryEnabled field value if set, zero value otherwise.
func (o *IdentityCategorizationConfig) GetIsDefaultCategoryEnabled() bool {
	if o == nil || IsNil(o.IsDefaultCategoryEnabled) {
		var ret bool
		return ret
	}
	return *o.IsDefaultCategoryEnabled
}

// GetIsDefaultCategoryEnabledOk returns a tuple with the IsDefaultCategoryEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdentityCategorizationConfig) GetIsDefaultCategoryEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.IsDefaultCategoryEnabled) {
		return nil, false
	}
	return o.IsDefaultCategoryEnabled, true
}
...
// SetIsDefaultCategoryEnabled gets a reference to the given bool and assigns it to the IsDefaultCategoryEnabled field.
func (o *IdentityCategorizationConfig) SetIsDefaultCategoryEnabled(v bool) {
	o.IsDefaultCategoryEnabled = &v
}

// GetKeepDefaultCategoryOnLogin returns the KeepDefaultCategoryOnLogin field value if set, zero value otherwise.
func (o *IdentityCategorizationConfig) GetKeepDefaultCategoryOnLogin() bool {
	if o == nil || IsNil(o.KeepDefaultCategoryOnLogin) {
		var ret bool
		return ret
	}
	return *o.KeepDefaultCategoryOnLogin
}

// GetKeepDefaultCategoryOnLoginOk returns a tuple with the KeepDefaultCategoryOnLogin field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdentityCategorizationConfig) GetKeepDefaultCategoryOnLoginOk() (*bool, bool) {
	if o == nil || IsNil(o.KeepDefaultCategoryOnLogin) {
		return nil, false
	}
	return o.KeepDefaultCategoryOnLogin, true
}
...
// SetKeepDefaultCategoryOnLogin gets a reference to the given bool and assigns it to the KeepDefaultCategoryOnLogin field.
func (o *IdentityCategorizationConfig) SetKeepDefaultCategoryOnLogin(v bool) {
	o.KeepDefaultCategoryOnLogin = &v
}

// GetDirectoryServiceConfigList returns the DirectoryServiceConfigList field value if set, zero value otherwise.
func (o *IdentityCategorizationConfig) GetDirectoryServiceConfigList() []IdentityCategorizationDirectoryConfig {
	if o == nil || IsNil(o.DirectoryServiceConfigList) {
		var ret []IdentityCategorizationDirectoryConfig
		return ret
	}
	return o.DirectoryServiceConfigList
}

// GetDirectoryServiceConfigListOk returns a tuple with the DirectoryServiceConfigList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdentityCategorizationConfig) GetDirectoryServiceConfigListOk() ([]IdentityCategorizationDirectoryConfig, bool) {
	if o == nil || IsNil(o.DirectoryServiceConfigList) {
		return nil, false
	}
	return o.DirectoryServiceConfigList, true
}
...
// SetDirectoryServiceConfigList gets a reference to the given []IdentityCategorizationDirectoryConfig and assigns it to the DirectoryServiceConfigList field.
func (o *IdentityCategorizationConfig) SetDirectoryServiceConfigList(v []IdentityCategorizationDirectoryConfig) {
	o.DirectoryServiceConfigList = v
}

func (o IdentityCategorizationConfig) MarshalJSON() ([]byte, error) {
...
func (o IdentityCategorizationConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IsDefaultCategoryEnabled) {
		toSerialize["is_default_category_enabled"] = o.IsDefaultCategoryEnabled
	}
	if !IsNil(o.KeepDefaultCategoryOnLogin) {
		toSerialize["keep_default_category_on_login"] = o.KeepDefaultCategoryOnLogin
	}
	if !IsNil(o.DirectoryServiceConfigList) {
		toSerialize["directory_service_config_list"] = o.DirectoryServiceConfigList
	}
...
func (o *IdentityCategorizationConfig) UnmarshalJSON(data []byte) (err error) {
	varIdentityCategorizationConfig := _IdentityCategorizationConfig{}

	err = json.Unmarshal(data, &varIdentityCategorizationConfig)

	if err != nil {
		return err
	}

	*o = IdentityCategorizationConfig(varIdentityCategorizationConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "is_default_category_enabled")
		delete(additionalProperties, "keep_default_category_on_login")
		delete(additionalProperties, "directory_service_config_list")
...
type NullableIdentityCategorizationConfig struct {
	value *IdentityCategorizationConfig
	isSet bool
}

func (v NullableIdentityCategorizationConfig) Get() *IdentityCategorizationConfig {
	return v.value
}

func (v *NullableIdentityCategorizationConfig) Set(val *IdentityCategorizationConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityCategorizationConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityCategorizationConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityCategorizationConfig(val *IdentityCategorizationConfig) *NullableIdentityCategorizationConfig {
	return &NullableIdentityCategorizationConfig{value: val, isSet: true}
}

func (v NullableIdentityCategorizationConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityCategorizationConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
