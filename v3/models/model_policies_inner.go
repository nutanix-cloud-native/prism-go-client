...
// checks if the PoliciesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoliciesInner{}

// PoliciesInner struct for PoliciesInner
...
type _PoliciesInner PoliciesInner
...
func (o PoliciesInner) MarshalJSON() ([]byte, error) {
...
func (o PoliciesInner) ToMap() (map[string]interface{}, error) {
...
func (o *PoliciesInner) UnmarshalJSON(data []byte) (err error) {
	varPoliciesInner := _PoliciesInner{}

	err = json.Unmarshal(data, &varPoliciesInner)

	if err != nil {
		return err
	}

	*o = PoliciesInner(varPoliciesInner)
...
type NullablePoliciesInner struct {
	value *PoliciesInner
	isSet bool
}

func (v NullablePoliciesInner) Get() *PoliciesInner {
	return v.value
}

func (v *NullablePoliciesInner) Set(val *PoliciesInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePoliciesInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePoliciesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePoliciesInner(val *PoliciesInner) *NullablePoliciesInner {
	return &NullablePoliciesInner{value: val, isSet: true}
}

func (v NullablePoliciesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePoliciesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
