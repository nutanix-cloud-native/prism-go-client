...
// checks if the IdempotenceIdentifiersInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdempotenceIdentifiersInput{}
...
type IdempotenceIdentifiersInput struct {
	...
	ValidDurationInMinutes *int32 `json:"valid_duration_in_minutes,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _IdempotenceIdentifiersInput IdempotenceIdentifiersInput
...
func NewIdempotenceIdentifiersInput(count int32) *IdempotenceIdentifiersInput {
	this := IdempotenceIdentifiersInput{}
	this.Count = count
	var validDurationInMinutes int32 = 527040
	this.ValidDurationInMinutes = &validDurationInMinutes
	return &this
}
...
// GetValidDurationInMinutes returns the ValidDurationInMinutes field value if set, zero value otherwise.
func (o *IdempotenceIdentifiersInput) GetValidDurationInMinutes() int32 {
	if o == nil || IsNil(o.ValidDurationInMinutes) {
		var ret int32
		return ret
	}
	return *o.ValidDurationInMinutes
}

// GetValidDurationInMinutesOk returns a tuple with the ValidDurationInMinutes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdempotenceIdentifiersInput) GetValidDurationInMinutesOk() (*int32, bool) {
	if o == nil || IsNil(o.ValidDurationInMinutes) {
		return nil, false
	}
	return o.ValidDurationInMinutes, true
}
...
// SetValidDurationInMinutes gets a reference to the given int32 and assigns it to the ValidDurationInMinutes field.
func (o *IdempotenceIdentifiersInput) SetValidDurationInMinutes(v int32) {
	o.ValidDurationInMinutes = &v
}

func (o IdempotenceIdentifiersInput) MarshalJSON() ([]byte, error) {
...
func (o IdempotenceIdentifiersInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ClientIdentifier) {
		toSerialize["client_identifier"] = o.ClientIdentifier
	}
	toSerialize["count"] = o.Count
	if !IsNil(o.ValidDurationInMinutes) {
		toSerialize["valid_duration_in_minutes"] = o.ValidDurationInMinutes
	}
...
func (o *IdempotenceIdentifiersInput) UnmarshalJSON(data []byte) (err error) {
	...
	varIdempotenceIdentifiersInput := _IdempotenceIdentifiersInput{}

	err = json.Unmarshal(data, &varIdempotenceIdentifiersInput)

	if err != nil {
		return err
	}

	*o = IdempotenceIdentifiersInput(varIdempotenceIdentifiersInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "client_identifier")
		delete(additionalProperties, "count")
		delete(additionalProperties, "valid_duration_in_minutes")
...
type NullableIdempotenceIdentifiersInput struct {
	value *IdempotenceIdentifiersInput
	isSet bool
}

func (v NullableIdempotenceIdentifiersInput) Get() *IdempotenceIdentifiersInput {
	return v.value
}

func (v *NullableIdempotenceIdentifiersInput) Set(val *IdempotenceIdentifiersInput) {
	v.value = val
	v.isSet = true
}

func (v NullableIdempotenceIdentifiersInput) IsSet() bool {
	return v.isSet
}

func (v *NullableIdempotenceIdentifiersInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdempotenceIdentifiersInput(val *IdempotenceIdentifiersInput) *NullableIdempotenceIdentifiersInput {
	return &NullableIdempotenceIdentifiersInput{value: val, isSet: true}
}

func (v NullableIdempotenceIdentifiersInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdempotenceIdentifiersInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
