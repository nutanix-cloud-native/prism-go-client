...
// checks if the ProjectInternalIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectInternalIntentResponse{}

// ProjectInternalIntentResponse Response object for intentful operations on a Project
type ProjectInternalIntentResponse struct {
	Status *ProjectInternalDefStatus `json:"status,omitempty"`
	Spec *ProjectInternal `json:"spec,omitempty"`
...
type _ProjectInternalIntentResponse ProjectInternalIntentResponse
...
func NewProjectInternalIntentResponse(apiVersion string, metadata ProjectMetadata) *ProjectInternalIntentResponse {
	this := ProjectInternalIntentResponse{}
...
func (o *ProjectInternalIntentResponse) GetStatus() ProjectInternalDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret ProjectInternalDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ProjectInternalDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given ProjectInternal and assigns it to the Spec field.
...
func (o ProjectInternalIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ProjectInternalIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectInternalIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectInternalIntentResponse := _ProjectInternalIntentResponse{}

	err = json.Unmarshal(data, &varProjectInternalIntentResponse)

	if err != nil {
		return err
	}

	*o = ProjectInternalIntentResponse(varProjectInternalIntentResponse)
...
type NullableProjectInternalIntentResponse struct {
	value *ProjectInternalIntentResponse
	isSet bool
}

func (v NullableProjectInternalIntentResponse) Get() *ProjectInternalIntentResponse {
	return v.value
}

func (v *NullableProjectInternalIntentResponse) Set(val *ProjectInternalIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectInternalIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectInternalIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectInternalIntentResponse(val *ProjectInternalIntentResponse) *NullableProjectInternalIntentResponse {
	return &NullableProjectInternalIntentResponse{value: val, isSet: true}
}

func (v NullableProjectInternalIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectInternalIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
