...
// BaseResponse Base response object definition.
type BaseResponse struct {
	SearchQuery *AutoCompletion `json:"search_query,omitempty"`
	ComposedResult *CompositeResponse `json:"composed_result,omitempty"`
	SingleResult *SingleResponse `json:"single_result,omitempty"`
	// Title of the Base response.
...
// GetComposedResult returns the ComposedResult field value if set, zero value otherwise.
func (o *BaseResponse) GetComposedResult() CompositeResponse {
	if o == nil || IsNil(o.ComposedResult) {
		var ret CompositeResponse
		return ret
	}
	return *o.ComposedResult
}

// GetComposedResultOk returns a tuple with the ComposedResult field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BaseResponse) GetComposedResultOk() (*CompositeResponse, bool) {
	if o == nil || IsNil(o.ComposedResult) {
		return nil, false
	}
	return o.ComposedResult, true
}
...
// SetComposedResult gets a reference to the given CompositeResponse and assigns it to the ComposedResult field.
func (o *BaseResponse) SetComposedResult(v CompositeResponse) {
	o.ComposedResult = &v
}

// GetSingleResult returns the SingleResult field value if set, zero value otherwise.
func (o *BaseResponse) GetSingleResult() SingleResponse {
	if o == nil || IsNil(o.SingleResult) {
		var ret SingleResponse
		return ret
	}
	return *o.SingleResult
}

// GetSingleResultOk returns a tuple with the SingleResult field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BaseResponse) GetSingleResultOk() (*SingleResponse, bool) {
	if o == nil || IsNil(o.SingleResult) {
		return nil, false
	}
	return o.SingleResult, true
}
...
// SetSingleResult gets a reference to the given SingleResponse and assigns it to the SingleResult field.
...
func (o BaseResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ComposedResult) {
		toSerialize["composed_result"] = o.ComposedResult
	}
	if !IsNil(o.SingleResult) {
		toSerialize["single_result"] = o.SingleResult
	}
	if !IsNil(o.Title) {
...
func (o *BaseResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = BaseResponse(varBaseResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "composed_result")
		delete(additionalProperties, "single_result")
