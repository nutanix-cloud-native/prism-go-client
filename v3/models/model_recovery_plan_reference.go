...
// checks if the RecoveryPlanReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanReference{}

// RecoveryPlanReference The reference to a recovery_plan
type RecoveryPlanReference struct {
	// The kind name
...
type _RecoveryPlanReference RecoveryPlanReference
...
func (o RecoveryPlanReference) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanReference) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanReference) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanReference := _RecoveryPlanReference{}

	err = json.Unmarshal(data, &varRecoveryPlanReference)

	if err != nil {
		return err
	}

	*o = RecoveryPlanReference(varRecoveryPlanReference)
...
type NullableRecoveryPlanReference struct {
	value *RecoveryPlanReference
	isSet bool
}

func (v NullableRecoveryPlanReference) Get() *RecoveryPlanReference {
	return v.value
}

func (v *NullableRecoveryPlanReference) Set(val *RecoveryPlanReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanReference) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanReference(val *RecoveryPlanReference) *NullableRecoveryPlanReference {
	return &NullableRecoveryPlanReference{value: val, isSet: true}
}

func (v NullableRecoveryPlanReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
