...
// checks if the DirectConnectVirtualInterfaceResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterfaceResourcesDefStatus{}

// DirectConnectVirtualInterfaceResourcesDefStatus Direct connect virtual interface create/modify status
type DirectConnectVirtualInterfaceResourcesDefStatus struct {
	VpcReference *VpcReference `json:"vpc_reference,omitempty"`
	// Customer peering IPv4 /30 or /31 prefix.
	PeerIpPrefix *string `json:"peer_ip_prefix,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(\\/(\\\\d|[1-2]\\\\d|3[0-2]))$"`
	// Customer peering autonomous system number (ASN).
	PeerAsn *int32 `json:"peer_asn,omitempty"`
	// IP prefixes learned from the remote gateway over eBGP.
	ReceivedPrefixList []IpSubnetStatus `json:"received_prefix_list,omitempty"`
	// IP prefixes advertised to the remote gateway over eBGP.
	SentPrefixList []IpSubnetStatus `json:"sent_prefix_list,omitempty"`
	// Nutanix peering IP address.
	NutanixPeerIp *string `json:"nutanix_peer_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	DirectConnectReference *DirectConnectReference `json:"direct_connect_reference,omitempty"`
	...
	DynamicRoutePriority *int32 `json:"dynamic_route_priority,omitempty"`
	PeeringStatus *DirectConnectVifStatus `json:"peering_status,omitempty"`
	// Nutanix peering autonomous system number.
	NutanixPeerAsn *int32 `json:"nutanix_peer_asn,omitempty"`
...
type _DirectConnectVirtualInterfaceResourcesDefStatus DirectConnectVirtualInterfaceResourcesDefStatus
...
func NewDirectConnectVirtualInterfaceResourcesDefStatus() *DirectConnectVirtualInterfaceResourcesDefStatus {
	this := DirectConnectVirtualInterfaceResourcesDefStatus{}
	return &this
}
...
// GetPeerIpPrefix returns the PeerIpPrefix field value if set, zero value otherwise.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetPeerIpPrefix() string {
	if o == nil || IsNil(o.PeerIpPrefix) {
		var ret string
		return ret
	}
	return *o.PeerIpPrefix
}

// GetPeerIpPrefixOk returns a tuple with the PeerIpPrefix field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetPeerIpPrefixOk() (*string, bool) {
	if o == nil || IsNil(o.PeerIpPrefix) {
		return nil, false
	}
	return o.PeerIpPrefix, true
}
...
// SetPeerIpPrefix gets a reference to the given string and assigns it to the PeerIpPrefix field.
...
// GetReceivedPrefixList returns the ReceivedPrefixList field value if set, zero value otherwise.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetReceivedPrefixList() []IpSubnetStatus {
	if o == nil || IsNil(o.ReceivedPrefixList) {
		var ret []IpSubnetStatus
		return ret
	}
	return o.ReceivedPrefixList
}

// GetReceivedPrefixListOk returns a tuple with the ReceivedPrefixList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetReceivedPrefixListOk() ([]IpSubnetStatus, bool) {
	if o == nil || IsNil(o.ReceivedPrefixList) {
		return nil, false
	}
	return o.ReceivedPrefixList, true
}
...
// SetReceivedPrefixList gets a reference to the given []IpSubnetStatus and assigns it to the ReceivedPrefixList field.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) SetReceivedPrefixList(v []IpSubnetStatus) {
	o.ReceivedPrefixList = v
}

// GetSentPrefixList returns the SentPrefixList field value if set, zero value otherwise.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetSentPrefixList() []IpSubnetStatus {
	if o == nil || IsNil(o.SentPrefixList) {
		var ret []IpSubnetStatus
		return ret
	}
	return o.SentPrefixList
}

// GetSentPrefixListOk returns a tuple with the SentPrefixList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetSentPrefixListOk() ([]IpSubnetStatus, bool) {
	if o == nil || IsNil(o.SentPrefixList) {
		return nil, false
	}
	return o.SentPrefixList, true
}
...
// SetSentPrefixList gets a reference to the given []IpSubnetStatus and assigns it to the SentPrefixList field.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) SetSentPrefixList(v []IpSubnetStatus) {
	o.SentPrefixList = v
}

// GetNutanixPeerIp returns the NutanixPeerIp field value if set, zero value otherwise.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetNutanixPeerIp() string {
	if o == nil || IsNil(o.NutanixPeerIp) {
		var ret string
		return ret
	}
	return *o.NutanixPeerIp
}

// GetNutanixPeerIpOk returns a tuple with the NutanixPeerIp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetNutanixPeerIpOk() (*string, bool) {
	if o == nil || IsNil(o.NutanixPeerIp) {
		return nil, false
	}
	return o.NutanixPeerIp, true
}
...
// SetNutanixPeerIp gets a reference to the given string and assigns it to the NutanixPeerIp field.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) SetNutanixPeerIp(v string) {
	o.NutanixPeerIp = &v
}

// GetDirectConnectReference returns the DirectConnectReference field value if set, zero value otherwise.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetDirectConnectReference() DirectConnectReference {
	if o == nil || IsNil(o.DirectConnectReference) {
		var ret DirectConnectReference
		return ret
	}
	return *o.DirectConnectReference
}

// GetDirectConnectReferenceOk returns a tuple with the DirectConnectReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetDirectConnectReferenceOk() (*DirectConnectReference, bool) {
	if o == nil || IsNil(o.DirectConnectReference) {
		return nil, false
	}
	return o.DirectConnectReference, true
}
...
// SetDirectConnectReference gets a reference to the given DirectConnectReference and assigns it to the DirectConnectReference field.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) SetDirectConnectReference(v DirectConnectReference) {
	o.DirectConnectReference = &v
}

// GetDynamicRoutePriority returns the DynamicRoutePriority field value if set, zero value otherwise.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetDynamicRoutePriority() int32 {
	if o == nil || IsNil(o.DynamicRoutePriority) {
		var ret int32
		return ret
	}
	return *o.DynamicRoutePriority
}

// GetDynamicRoutePriorityOk returns a tuple with the DynamicRoutePriority field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetDynamicRoutePriorityOk() (*int32, bool) {
	if o == nil || IsNil(o.DynamicRoutePriority) {
		return nil, false
	}
	return o.DynamicRoutePriority, true
}
...
// SetDynamicRoutePriority gets a reference to the given int32 and assigns it to the DynamicRoutePriority field.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) SetDynamicRoutePriority(v int32) {
	o.DynamicRoutePriority = &v
}

// GetPeeringStatus returns the PeeringStatus field value if set, zero value otherwise.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetPeeringStatus() DirectConnectVifStatus {
	if o == nil || IsNil(o.PeeringStatus) {
		var ret DirectConnectVifStatus
		return ret
	}
	return *o.PeeringStatus
}
...
// SetPeeringStatus gets a reference to the given DirectConnectVifStatus and assigns it to the PeeringStatus field.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) SetPeeringStatus(v DirectConnectVifStatus) {
	o.PeeringStatus = &v
}

// GetNutanixPeerAsn returns the NutanixPeerAsn field value if set, zero value otherwise.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetNutanixPeerAsn() int32 {
	if o == nil || IsNil(o.NutanixPeerAsn) {
		var ret int32
		return ret
	}
	return *o.NutanixPeerAsn
}

// GetNutanixPeerAsnOk returns a tuple with the NutanixPeerAsn field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) GetNutanixPeerAsnOk() (*int32, bool) {
	if o == nil || IsNil(o.NutanixPeerAsn) {
		return nil, false
	}
	return o.NutanixPeerAsn, true
}
...
// SetNutanixPeerAsn gets a reference to the given int32 and assigns it to the NutanixPeerAsn field.
...
func (o DirectConnectVirtualInterfaceResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterfaceResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VpcReference) {
		toSerialize["vpc_reference"] = o.VpcReference
	}
	if !IsNil(o.PeerIpPrefix) {
		toSerialize["peer_ip_prefix"] = o.PeerIpPrefix
	}
	if !IsNil(o.PeerAsn) {
		toSerialize["peer_asn"] = o.PeerAsn
	}
	if !IsNil(o.ReceivedPrefixList) {
		toSerialize["received_prefix_list"] = o.ReceivedPrefixList
	}
	if !IsNil(o.SentPrefixList) {
		toSerialize["sent_prefix_list"] = o.SentPrefixList
	}
	if !IsNil(o.NutanixPeerIp) {
		toSerialize["nutanix_peer_ip"] = o.NutanixPeerIp
	}
	if !IsNil(o.DirectConnectReference) {
		toSerialize["direct_connect_reference"] = o.DirectConnectReference
	}
	if !IsNil(o.DynamicRoutePriority) {
		toSerialize["dynamic_route_priority"] = o.DynamicRoutePriority
	}
	if !IsNil(o.PeeringStatus) {
		toSerialize["peering_status"] = o.PeeringStatus
	}
	if !IsNil(o.NutanixPeerAsn) {
		toSerialize["nutanix_peer_asn"] = o.NutanixPeerAsn
	}
	if !IsNil(o.Md5) {
...
func (o *DirectConnectVirtualInterfaceResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varDirectConnectVirtualInterfaceResourcesDefStatus := _DirectConnectVirtualInterfaceResourcesDefStatus{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterfaceResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterfaceResourcesDefStatus(varDirectConnectVirtualInterfaceResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vpc_reference")
		delete(additionalProperties, "peer_ip_prefix")
		delete(additionalProperties, "peer_asn")
		delete(additionalProperties, "received_prefix_list")
		delete(additionalProperties, "sent_prefix_list")
		delete(additionalProperties, "nutanix_peer_ip")
		delete(additionalProperties, "direct_connect_reference")
		delete(additionalProperties, "dynamic_route_priority")
		delete(additionalProperties, "peering_status")
		delete(additionalProperties, "nutanix_peer_asn")
...
type NullableDirectConnectVirtualInterfaceResourcesDefStatus struct {
	value *DirectConnectVirtualInterfaceResourcesDefStatus
	isSet bool
}

func (v NullableDirectConnectVirtualInterfaceResourcesDefStatus) Get() *DirectConnectVirtualInterfaceResourcesDefStatus {
	return v.value
}

func (v *NullableDirectConnectVirtualInterfaceResourcesDefStatus) Set(val *DirectConnectVirtualInterfaceResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterfaceResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterfaceResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterfaceResourcesDefStatus(val *DirectConnectVirtualInterfaceResourcesDefStatus) *NullableDirectConnectVirtualInterfaceResourcesDefStatus {
	return &NullableDirectConnectVirtualInterfaceResourcesDefStatus{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterfaceResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterfaceResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
