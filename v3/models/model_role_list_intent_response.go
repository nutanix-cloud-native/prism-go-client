...
// checks if the RoleListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleListIntentResponse{}

// RoleListIntentResponse Response object for intentful operation of roles
type RoleListIntentResponse struct {
	Entities []RoleIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata RoleListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RoleListIntentResponse RoleListIntentResponse
...
// SetEntities gets a reference to the given []RoleIntentResource and assigns it to the Entities field.
...
func (o *RoleListIntentResponse) GetMetadata() RoleListMetadataOutput {
	if o == nil {
		var ret RoleListMetadataOutput
		return ret
	}
...
func (o RoleListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RoleListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RoleListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleListIntentResponse := _RoleListIntentResponse{}

	err = json.Unmarshal(data, &varRoleListIntentResponse)

	if err != nil {
		return err
	}

	*o = RoleListIntentResponse(varRoleListIntentResponse)
...
type NullableRoleListIntentResponse struct {
	value *RoleListIntentResponse
	isSet bool
}

func (v NullableRoleListIntentResponse) Get() *RoleListIntentResponse {
	return v.value
}

func (v *NullableRoleListIntentResponse) Set(val *RoleListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleListIntentResponse(val *RoleListIntentResponse) *NullableRoleListIntentResponse {
	return &NullableRoleListIntentResponse{value: val, isSet: true}
}

func (v NullableRoleListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
