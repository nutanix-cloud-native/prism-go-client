...
// checks if the HostIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostIntentResponse{}

// HostIntentResponse Response object for intentful operations on a host
...
type _HostIntentResponse HostIntentResponse
...
func (o HostIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o HostIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *HostIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varHostIntentResponse := _HostIntentResponse{}

	err = json.Unmarshal(data, &varHostIntentResponse)

	if err != nil {
		return err
	}

	*o = HostIntentResponse(varHostIntentResponse)
...
type NullableHostIntentResponse struct {
	value *HostIntentResponse
	isSet bool
}

func (v NullableHostIntentResponse) Get() *HostIntentResponse {
	return v.value
}

func (v *NullableHostIntentResponse) Set(val *HostIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHostIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHostIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostIntentResponse(val *HostIntentResponse) *NullableHostIntentResponse {
	return &NullableHostIntentResponse{value: val, isSet: true}
}

func (v NullableHostIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
