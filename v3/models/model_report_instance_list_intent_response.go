...
// checks if the ReportInstanceListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstanceListIntentResponse{}

// ReportInstanceListIntentResponse Response object for intentful operation of report_instances
type ReportInstanceListIntentResponse struct {
	Entities []ReportInstanceIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ReportInstanceListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ReportInstanceListIntentResponse ReportInstanceListIntentResponse
...
func NewReportInstanceListIntentResponse(apiVersion string, metadata ReportInstanceListMetadataOutput) *ReportInstanceListIntentResponse {
	this := ReportInstanceListIntentResponse{}
...
func (o *ReportInstanceListIntentResponse) GetEntities() []ReportInstanceIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []ReportInstanceIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []ReportInstanceIntentResource and assigns it to the Entities field.
...
func (o *ReportInstanceListIntentResponse) GetMetadata() ReportInstanceListMetadataOutput {
	if o == nil {
		var ret ReportInstanceListMetadataOutput
		return ret
	}
...
func (o ReportInstanceListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ReportInstanceListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ReportInstanceListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varReportInstanceListIntentResponse := _ReportInstanceListIntentResponse{}

	err = json.Unmarshal(data, &varReportInstanceListIntentResponse)

	if err != nil {
		return err
	}

	*o = ReportInstanceListIntentResponse(varReportInstanceListIntentResponse)
...
type NullableReportInstanceListIntentResponse struct {
	value *ReportInstanceListIntentResponse
	isSet bool
}

func (v NullableReportInstanceListIntentResponse) Get() *ReportInstanceListIntentResponse {
	return v.value
}

func (v *NullableReportInstanceListIntentResponse) Set(val *ReportInstanceListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstanceListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstanceListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstanceListIntentResponse(val *ReportInstanceListIntentResponse) *NullableReportInstanceListIntentResponse {
	return &NullableReportInstanceListIntentResponse{value: val, isSet: true}
}

func (v NullableReportInstanceListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstanceListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
