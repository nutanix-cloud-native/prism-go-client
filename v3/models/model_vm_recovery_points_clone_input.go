...
// checks if the VmRecoveryPointsCloneInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmRecoveryPointsCloneInput{}

// VmRecoveryPointsCloneInput Input object for the clone API for vm recovery point. User can provide the optional UUID of the vm_recovery_point that will be created as a result of this operation on target site. 
type VmRecoveryPointsCloneInput struct {
...
type _VmRecoveryPointsCloneInput VmRecoveryPointsCloneInput
...
func NewVmRecoveryPointsCloneInput(availabilityZoneReference AvailabilityZoneReference) *VmRecoveryPointsCloneInput {
	this := VmRecoveryPointsCloneInput{}
...
func (o VmRecoveryPointsCloneInput) MarshalJSON() ([]byte, error) {
...
func (o VmRecoveryPointsCloneInput) ToMap() (map[string]interface{}, error) {
...
func (o *VmRecoveryPointsCloneInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVmRecoveryPointsCloneInput := _VmRecoveryPointsCloneInput{}

	err = json.Unmarshal(data, &varVmRecoveryPointsCloneInput)

	if err != nil {
		return err
	}

	*o = VmRecoveryPointsCloneInput(varVmRecoveryPointsCloneInput)
...
type NullableVmRecoveryPointsCloneInput struct {
	value *VmRecoveryPointsCloneInput
	isSet bool
}

func (v NullableVmRecoveryPointsCloneInput) Get() *VmRecoveryPointsCloneInput {
	return v.value
}

func (v *NullableVmRecoveryPointsCloneInput) Set(val *VmRecoveryPointsCloneInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmRecoveryPointsCloneInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmRecoveryPointsCloneInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmRecoveryPointsCloneInput(val *VmRecoveryPointsCloneInput) *NullableVmRecoveryPointsCloneInput {
	return &NullableVmRecoveryPointsCloneInput{value: val, isSet: true}
}

func (v NullableVmRecoveryPointsCloneInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmRecoveryPointsCloneInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
