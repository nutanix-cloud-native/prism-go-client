...
// checks if the ReportInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInstance1{}

// ReportInstance1 Report instance resources.
type ReportInstance1 struct {
	// Description of the report.
	Description *string `json:"description,omitempty"`
	// Recipients in addition to specified on the report config. 
	RecipientList []Recipient `json:"recipient_list,omitempty"`
	...
	RecipientFormat []string `json:"recipient_format,omitempty"`
	// Generated instance saved or not.
	SaveInstance *bool `json:"save_instance,omitempty"`
	...
	RuntimeKeyValues *map[string]string `json:"runtime_key_values,omitempty"`
	// Generation status of the report.
	GenerationStatus *string `json:"generation_status,omitempty"`
	ReportConfigReference *ReportConfigReference `json:"report_config_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ReportInstance1 ReportInstance1
...
// GetRecipientFormat returns the RecipientFormat field value if set, zero value otherwise.
func (o *ReportInstance1) GetRecipientFormat() []string {
	if o == nil || IsNil(o.RecipientFormat) {
		var ret []string
		return ret
	}
	return o.RecipientFormat
}

// GetRecipientFormatOk returns a tuple with the RecipientFormat field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportInstance1) GetRecipientFormatOk() ([]string, bool) {
	if o == nil || IsNil(o.RecipientFormat) {
		return nil, false
	}
	return o.RecipientFormat, true
}
...
// SetRecipientFormat gets a reference to the given []string and assigns it to the RecipientFormat field.
func (o *ReportInstance1) SetRecipientFormat(v []string) {
	o.RecipientFormat = v
}

// GetSaveInstance returns the SaveInstance field value if set, zero value otherwise.
func (o *ReportInstance1) GetSaveInstance() bool {
	if o == nil || IsNil(o.SaveInstance) {
		var ret bool
		return ret
	}
	return *o.SaveInstance
}

// GetSaveInstanceOk returns a tuple with the SaveInstance field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportInstance1) GetSaveInstanceOk() (*bool, bool) {
	if o == nil || IsNil(o.SaveInstance) {
		return nil, false
	}
	return o.SaveInstance, true
}
...
// SetSaveInstance gets a reference to the given bool and assigns it to the SaveInstance field.
...
// GetRuntimeKeyValues returns the RuntimeKeyValues field value if set, zero value otherwise.
func (o *ReportInstance1) GetRuntimeKeyValues() map[string]string {
	if o == nil || IsNil(o.RuntimeKeyValues) {
		var ret map[string]string
		return ret
	}
	return *o.RuntimeKeyValues
}

// GetRuntimeKeyValuesOk returns a tuple with the RuntimeKeyValues field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportInstance1) GetRuntimeKeyValuesOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.RuntimeKeyValues) {
		return nil, false
	}
	return o.RuntimeKeyValues, true
}
...
// SetRuntimeKeyValues gets a reference to the given map[string]string and assigns it to the RuntimeKeyValues field.
func (o *ReportInstance1) SetRuntimeKeyValues(v map[string]string) {
	o.RuntimeKeyValues = &v
}
...
// SetGenerationStatus gets a reference to the given string and assigns it to the GenerationStatus field.
func (o *ReportInstance1) SetGenerationStatus(v string) {
	o.GenerationStatus = &v
}

// GetReportConfigReference returns the ReportConfigReference field value if set, zero value otherwise.
func (o *ReportInstance1) GetReportConfigReference() ReportConfigReference {
	if o == nil || IsNil(o.ReportConfigReference) {
		var ret ReportConfigReference
		return ret
	}
	return *o.ReportConfigReference
}

// GetReportConfigReferenceOk returns a tuple with the ReportConfigReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportInstance1) GetReportConfigReferenceOk() (*ReportConfigReference, bool) {
	if o == nil || IsNil(o.ReportConfigReference) {
		return nil, false
	}
	return o.ReportConfigReference, true
}
...
// SetReportConfigReference gets a reference to the given ReportConfigReference and assigns it to the ReportConfigReference field.
func (o *ReportInstance1) SetReportConfigReference(v ReportConfigReference) {
	o.ReportConfigReference = &v
}

func (o ReportInstance1) MarshalJSON() ([]byte, error) {
...
func (o ReportInstance1) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Description) {
		toSerialize["description"] = o.Description
	}
	if !IsNil(o.RecipientList) {
		toSerialize["recipient_list"] = o.RecipientList
	}
	if !IsNil(o.ErrorMessage) {
		toSerialize["error_message"] = o.ErrorMessage
	}
	if !IsNil(o.DataStartTime) {
		toSerialize["data_start_time"] = o.DataStartTime
	}
	if !IsNil(o.GenerationFormat) {
		toSerialize["generation_format"] = o.GenerationFormat
	}
	if !IsNil(o.RecipientFormat) {
		toSerialize["recipient_format"] = o.RecipientFormat
	}
	if !IsNil(o.SaveInstance) {
		toSerialize["save_instance"] = o.SaveInstance
	}
	if !IsNil(o.DataEndTime) {
		toSerialize["data_end_time"] = o.DataEndTime
	}
	if !IsNil(o.Timezone) {
		toSerialize["timezone"] = o.Timezone
	}
	if !IsNil(o.RuntimeKeyValues) {
		toSerialize["runtime_key_values"] = o.RuntimeKeyValues
	}
	if !IsNil(o.GenerationStatus) {
		toSerialize["generation_status"] = o.GenerationStatus
	}
	if !IsNil(o.ReportConfigReference) {
		toSerialize["report_config_reference"] = o.ReportConfigReference
	}
...
func (o *ReportInstance1) UnmarshalJSON(data []byte) (err error) {
	varReportInstance1 := _ReportInstance1{}

	err = json.Unmarshal(data, &varReportInstance1)

	if err != nil {
		return err
	}

	*o = ReportInstance1(varReportInstance1)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "description")
		delete(additionalProperties, "recipient_list")
		delete(additionalProperties, "error_message")
		delete(additionalProperties, "data_start_time")
		delete(additionalProperties, "generation_format")
		delete(additionalProperties, "recipient_format")
		delete(additionalProperties, "save_instance")
		delete(additionalProperties, "data_end_time")
		delete(additionalProperties, "timezone")
		delete(additionalProperties, "runtime_key_values")
		delete(additionalProperties, "generation_status")
		delete(additionalProperties, "report_config_reference")
...
type NullableReportInstance1 struct {
	value *ReportInstance1
	isSet bool
}

func (v NullableReportInstance1) Get() *ReportInstance1 {
	return v.value
}

func (v *NullableReportInstance1) Set(val *ReportInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInstance1(val *ReportInstance1) *NullableReportInstance1 {
	return &NullableReportInstance1{value: val, isSet: true}
}

func (v NullableReportInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
