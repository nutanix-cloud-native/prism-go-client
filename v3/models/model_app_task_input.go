...
// checks if the AppTaskInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskInput{}

// AppTaskInput Task definition for Application.
type AppTaskInput struct {
...
type _AppTaskInput AppTaskInput
...
func (o AppTaskInput) MarshalJSON() ([]byte, error) {
...
func (o AppTaskInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskInput := _AppTaskInput{}

	err = json.Unmarshal(data, &varAppTaskInput)

	if err != nil {
		return err
	}

	*o = AppTaskInput(varAppTaskInput)
...
type NullableAppTaskInput struct {
	value *AppTaskInput
	isSet bool
}

func (v NullableAppTaskInput) Get() *AppTaskInput {
	return v.value
}

func (v *NullableAppTaskInput) Set(val *AppTaskInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskInput(val *AppTaskInput) *NullableAppTaskInput {
	return &NullableAppTaskInput{value: val, isSet: true}
}

func (v NullableAppTaskInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
