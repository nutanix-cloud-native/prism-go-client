...
// checks if the FileItemReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemReference{}

// FileItemReference The reference to a file_item
type FileItemReference struct {
	// The kind name
...
type _FileItemReference FileItemReference
...
func (o FileItemReference) MarshalJSON() ([]byte, error) {
...
func (o FileItemReference) ToMap() (map[string]interface{}, error) {
...
func (o *FileItemReference) UnmarshalJSON(data []byte) (err error) {
	...
	varFileItemReference := _FileItemReference{}

	err = json.Unmarshal(data, &varFileItemReference)

	if err != nil {
		return err
	}

	*o = FileItemReference(varFileItemReference)
...
type NullableFileItemReference struct {
	value *FileItemReference
	isSet bool
}

func (v NullableFileItemReference) Get() *FileItemReference {
	return v.value
}

func (v *NullableFileItemReference) Set(val *FileItemReference) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemReference) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemReference(val *FileItemReference) *NullableFileItemReference {
	return &NullableFileItemReference{value: val, isSet: true}
}

func (v NullableFileItemReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
