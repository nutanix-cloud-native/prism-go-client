...
// checks if the PhysicalAvailabilityZoneListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalAvailabilityZoneListMetadataOutput{}

// PhysicalAvailabilityZoneListMetadataOutput All api calls that return a list will have this metadata block 
type PhysicalAvailabilityZoneListMetadataOutput struct {
	// The kind name
...
type _PhysicalAvailabilityZoneListMetadataOutput PhysicalAvailabilityZoneListMetadataOutput
...
func NewPhysicalAvailabilityZoneListMetadataOutput() *PhysicalAvailabilityZoneListMetadataOutput {
	this := PhysicalAvailabilityZoneListMetadataOutput{}
	var kind string = "physical_availability_zone"
	this.Kind = &kind
	return &this
}
...
func (o PhysicalAvailabilityZoneListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o PhysicalAvailabilityZoneListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *PhysicalAvailabilityZoneListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varPhysicalAvailabilityZoneListMetadataOutput := _PhysicalAvailabilityZoneListMetadataOutput{}

	err = json.Unmarshal(data, &varPhysicalAvailabilityZoneListMetadataOutput)

	if err != nil {
		return err
	}

	*o = PhysicalAvailabilityZoneListMetadataOutput(varPhysicalAvailabilityZoneListMetadataOutput)
...
type NullablePhysicalAvailabilityZoneListMetadataOutput struct {
	value *PhysicalAvailabilityZoneListMetadataOutput
	isSet bool
}

func (v NullablePhysicalAvailabilityZoneListMetadataOutput) Get() *PhysicalAvailabilityZoneListMetadataOutput {
	return v.value
}

func (v *NullablePhysicalAvailabilityZoneListMetadataOutput) Set(val *PhysicalAvailabilityZoneListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullablePhysicalAvailabilityZoneListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullablePhysicalAvailabilityZoneListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhysicalAvailabilityZoneListMetadataOutput(val *PhysicalAvailabilityZoneListMetadataOutput) *NullablePhysicalAvailabilityZoneListMetadataOutput {
	return &NullablePhysicalAvailabilityZoneListMetadataOutput{value: val, isSet: true}
}

func (v NullablePhysicalAvailabilityZoneListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhysicalAvailabilityZoneListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
