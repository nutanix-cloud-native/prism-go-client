...
// checks if the CauseAnalysis type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CauseAnalysis{}

// CauseAnalysis The root cause analysis and possible resolutions.
...
type _CauseAnalysis CauseAnalysis
...
// GetCauseList returns the CauseList field value if set, zero value otherwise.
func (o *CauseAnalysis) GetCauseList() []string {
	if o == nil || IsNil(o.CauseList) {
		var ret []string
		return ret
	}
	return o.CauseList
...
// GetCauseListOk returns a tuple with the CauseList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CauseAnalysis) GetCauseListOk() ([]string, bool) {
	if o == nil || IsNil(o.CauseList) {
		return nil, false
	}
	return o.CauseList, true
}
...
// SetCauseList gets a reference to the given []string and assigns it to the CauseList field.
func (o *CauseAnalysis) SetCauseList(v []string) {
	o.CauseList = v
}

func (o CauseAnalysis) MarshalJSON() ([]byte, error) {
...
func (o CauseAnalysis) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ResolutionList) {
		toSerialize["resolution_list"] = o.ResolutionList
	}
	if !IsNil(o.CauseList) {
		toSerialize["cause_list"] = o.CauseList
	}
...
func (o *CauseAnalysis) UnmarshalJSON(data []byte) (err error) {
	varCauseAnalysis := _CauseAnalysis{}

	err = json.Unmarshal(data, &varCauseAnalysis)

	if err != nil {
		return err
	}

	*o = CauseAnalysis(varCauseAnalysis)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "resolution_list")
		delete(additionalProperties, "cause_list")
...
type NullableCauseAnalysis struct {
	value *CauseAnalysis
	isSet bool
}

func (v NullableCauseAnalysis) Get() *CauseAnalysis {
	return v.value
}

func (v *NullableCauseAnalysis) Set(val *CauseAnalysis) {
	v.value = val
	v.isSet = true
}

func (v NullableCauseAnalysis) IsSet() bool {
	return v.isSet
}

func (v *NullableCauseAnalysis) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCauseAnalysis(val *CauseAnalysis) *NullableCauseAnalysis {
	return &NullableCauseAnalysis{value: val, isSet: true}
}

func (v NullableCauseAnalysis) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCauseAnalysis) UnmarshalJSON(src []byte) error {
	v.isSet = true
