...
// checks if the StoragePolicyResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyResources{}

// StoragePolicyResources Storage Policy Resources Definition
type StoragePolicyResources struct {
	...
	// Regex for entities on which the policy is to be applied
	FilterList []Filter `json:"filter_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _StoragePolicyResources StoragePolicyResources
...
func (o StoragePolicyResources) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyResources) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePolicyResources) UnmarshalJSON(data []byte) (err error) {
	varStoragePolicyResources := _StoragePolicyResources{}

	err = json.Unmarshal(data, &varStoragePolicyResources)

	if err != nil {
		return err
	}

	*o = StoragePolicyResources(varStoragePolicyResources)
...
type NullableStoragePolicyResources struct {
	value *StoragePolicyResources
	isSet bool
}

func (v NullableStoragePolicyResources) Get() *StoragePolicyResources {
	return v.value
}

func (v *NullableStoragePolicyResources) Set(val *StoragePolicyResources) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyResources) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyResources(val *StoragePolicyResources) *NullableStoragePolicyResources {
	return &NullableStoragePolicyResources{value: val, isSet: true}
}

func (v NullableStoragePolicyResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
