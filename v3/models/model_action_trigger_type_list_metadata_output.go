...
// checks if the ActionTriggerTypeListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTriggerTypeListMetadataOutput{}

// ActionTriggerTypeListMetadataOutput All api calls that return a list will have this metadata block 
type ActionTriggerTypeListMetadataOutput struct {
	// The kind name
...
type _ActionTriggerTypeListMetadataOutput ActionTriggerTypeListMetadataOutput
...
func NewActionTriggerTypeListMetadataOutput() *ActionTriggerTypeListMetadataOutput {
	this := ActionTriggerTypeListMetadataOutput{}
	var kind string = "action_trigger_type"
	this.Kind = &kind
	return &this
}
...
func (o *ActionTriggerTypeListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *ActionTriggerTypeListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o ActionTriggerTypeListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ActionTriggerTypeListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTriggerTypeListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varActionTriggerTypeListMetadataOutput := _ActionTriggerTypeListMetadataOutput{}

	err = json.Unmarshal(data, &varActionTriggerTypeListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ActionTriggerTypeListMetadataOutput(varActionTriggerTypeListMetadataOutput)
...
type NullableActionTriggerTypeListMetadataOutput struct {
	value *ActionTriggerTypeListMetadataOutput
	isSet bool
}

func (v NullableActionTriggerTypeListMetadataOutput) Get() *ActionTriggerTypeListMetadataOutput {
	return v.value
}

func (v *NullableActionTriggerTypeListMetadataOutput) Set(val *ActionTriggerTypeListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTriggerTypeListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTriggerTypeListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTriggerTypeListMetadataOutput(val *ActionTriggerTypeListMetadataOutput) *NullableActionTriggerTypeListMetadataOutput {
	return &NullableActionTriggerTypeListMetadataOutput{value: val, isSet: true}
}

func (v NullableActionTriggerTypeListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTriggerTypeListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
