...
// checks if the DiskListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskListMetadataOutput{}

// DiskListMetadataOutput All api calls that return a list will have this metadata block 
...
type _DiskListMetadataOutput DiskListMetadataOutput
...
func (o DiskListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o DiskListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *DiskListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varDiskListMetadataOutput := _DiskListMetadataOutput{}

	err = json.Unmarshal(data, &varDiskListMetadataOutput)

	if err != nil {
		return err
	}

	*o = DiskListMetadataOutput(varDiskListMetadataOutput)
...
type NullableDiskListMetadataOutput struct {
	value *DiskListMetadataOutput
	isSet bool
}

func (v NullableDiskListMetadataOutput) Get() *DiskListMetadataOutput {
	return v.value
}

func (v *NullableDiskListMetadataOutput) Set(val *DiskListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskListMetadataOutput(val *DiskListMetadataOutput) *NullableDiskListMetadataOutput {
	return &NullableDiskListMetadataOutput{value: val, isSet: true}
}

func (v NullableDiskListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
