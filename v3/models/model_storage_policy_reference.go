...
// checks if the StoragePolicyReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyReference{}

// StoragePolicyReference The reference to a storage_policy
type StoragePolicyReference struct {
	// The kind name
...
type _StoragePolicyReference StoragePolicyReference
...
func (o StoragePolicyReference) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyReference) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePolicyReference) UnmarshalJSON(data []byte) (err error) {
	...
	varStoragePolicyReference := _StoragePolicyReference{}

	err = json.Unmarshal(data, &varStoragePolicyReference)

	if err != nil {
		return err
	}

	*o = StoragePolicyReference(varStoragePolicyReference)
...
type NullableStoragePolicyReference struct {
	value *StoragePolicyReference
	isSet bool
}

func (v NullableStoragePolicyReference) Get() *StoragePolicyReference {
	return v.value
}

func (v *NullableStoragePolicyReference) Set(val *StoragePolicyReference) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyReference) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyReference(val *StoragePolicyReference) *NullableStoragePolicyReference {
	return &NullableStoragePolicyReference{value: val, isSet: true}
}

func (v NullableStoragePolicyReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
