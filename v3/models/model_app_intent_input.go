...
// checks if the AppIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppIntentInput{}

// AppIntentInput An intentful representation of a app
type AppIntentInput struct {
	Spec App `json:"spec"`
...
type _AppIntentInput AppIntentInput
...
func (o AppIntentInput) MarshalJSON() ([]byte, error) {
...
func (o AppIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppIntentInput := _AppIntentInput{}

	err = json.Unmarshal(data, &varAppIntentInput)

	if err != nil {
		return err
	}

	*o = AppIntentInput(varAppIntentInput)
...
type NullableAppIntentInput struct {
	value *AppIntentInput
	isSet bool
}

func (v NullableAppIntentInput) Get() *AppIntentInput {
	return v.value
}

func (v *NullableAppIntentInput) Set(val *AppIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppIntentInput(val *AppIntentInput) *NullableAppIntentInput {
	return &NullableAppIntentInput{value: val, isSet: true}
}

func (v NullableAppIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
