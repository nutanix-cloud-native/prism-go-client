...
// checks if the IdentityProviderListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderListIntentResponse{}

// IdentityProviderListIntentResponse Response object for intentful operation of identity_providers
type IdentityProviderListIntentResponse struct {
	Entities []IdentityProviderIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata IdentityProviderListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _IdentityProviderListIntentResponse IdentityProviderListIntentResponse
...
func NewIdentityProviderListIntentResponse(apiVersion string, metadata IdentityProviderListMetadataOutput) *IdentityProviderListIntentResponse {
	this := IdentityProviderListIntentResponse{}
...
func (o *IdentityProviderListIntentResponse) GetEntities() []IdentityProviderIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []IdentityProviderIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []IdentityProviderIntentResource and assigns it to the Entities field.
...
func (o *IdentityProviderListIntentResponse) GetMetadata() IdentityProviderListMetadataOutput {
	if o == nil {
		var ret IdentityProviderListMetadataOutput
		return ret
	}
...
func (o IdentityProviderListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProviderListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varIdentityProviderListIntentResponse := _IdentityProviderListIntentResponse{}

	err = json.Unmarshal(data, &varIdentityProviderListIntentResponse)

	if err != nil {
		return err
	}

	*o = IdentityProviderListIntentResponse(varIdentityProviderListIntentResponse)
...
type NullableIdentityProviderListIntentResponse struct {
	value *IdentityProviderListIntentResponse
	isSet bool
}

func (v NullableIdentityProviderListIntentResponse) Get() *IdentityProviderListIntentResponse {
	return v.value
}

func (v *NullableIdentityProviderListIntentResponse) Set(val *IdentityProviderListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderListIntentResponse(val *IdentityProviderListIntentResponse) *NullableIdentityProviderListIntentResponse {
	return &NullableIdentityProviderListIntentResponse{value: val, isSet: true}
}

func (v NullableIdentityProviderListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
