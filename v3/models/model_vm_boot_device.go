...
// checks if the VmBootDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmBootDevice{}
...
type _VmBootDevice VmBootDevice
...
func (o VmBootDevice) MarshalJSON() ([]byte, error) {
...
func (o VmBootDevice) ToMap() (map[string]interface{}, error) {
...
func (o *VmBootDevice) UnmarshalJSON(data []byte) (err error) {
	varVmBootDevice := _VmBootDevice{}

	err = json.Unmarshal(data, &varVmBootDevice)

	if err != nil {
		return err
	}

	*o = VmBootDevice(varVmBootDevice)
...
type NullableVmBootDevice struct {
	value *VmBootDevice
	isSet bool
}

func (v NullableVmBootDevice) Get() *VmBootDevice {
	return v.value
}

func (v *NullableVmBootDevice) Set(val *VmBootDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableVmBootDevice) IsSet() bool {
	return v.isSet
}

func (v *NullableVmBootDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmBootDevice(val *VmBootDevice) *NullableVmBootDevice {
	return &NullableVmBootDevice{value: val, isSet: true}
}

func (v NullableVmBootDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmBootDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
