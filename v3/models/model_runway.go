...
// checks if the Runway type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Runway{}

// Runway Runway Object.
type Runway struct {
	// The runway value as number. Possbile value 0-365, and 365.5.
	MinRunwayDays *float32 `json:"min_runway_days,omitempty"`
	// The runway value as number. Possbile value 0-365, and 365.5.
	StorageRunwayDays *float32 `json:"storage_runway_days,omitempty"`
	// The runway value as number. Possbile value 0-365, and 365.5.
	MemoryRunwayDays *float32 `json:"memory_runway_days,omitempty"`
	// The runway value as number. Possbile value 0-365, and 365.5.
	CpuRunwayDays *float32 `json:"cpu_runway_days,omitempty"`
...
// GetMinRunwayDays returns the MinRunwayDays field value if set, zero value otherwise.
func (o *Runway) GetMinRunwayDays() float32 {
	if o == nil || IsNil(o.MinRunwayDays) {
		var ret float32
		return ret
	}
	return *o.MinRunwayDays
}

// GetMinRunwayDaysOk returns a tuple with the MinRunwayDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Runway) GetMinRunwayDaysOk() (*float32, bool) {
	if o == nil || IsNil(o.MinRunwayDays) {
		return nil, false
	}
	return o.MinRunwayDays, true
}
...
// SetMinRunwayDays gets a reference to the given float32 and assigns it to the MinRunwayDays field.
func (o *Runway) SetMinRunwayDays(v float32) {
	o.MinRunwayDays = &v
}

// GetStorageRunwayDays returns the StorageRunwayDays field value if set, zero value otherwise.
func (o *Runway) GetStorageRunwayDays() float32 {
	if o == nil || IsNil(o.StorageRunwayDays) {
		var ret float32
		return ret
	}
	return *o.StorageRunwayDays
}

// GetStorageRunwayDaysOk returns a tuple with the StorageRunwayDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Runway) GetStorageRunwayDaysOk() (*float32, bool) {
	if o == nil || IsNil(o.StorageRunwayDays) {
		return nil, false
	}
	return o.StorageRunwayDays, true
}
...
// SetStorageRunwayDays gets a reference to the given float32 and assigns it to the StorageRunwayDays field.
func (o *Runway) SetStorageRunwayDays(v float32) {
	o.StorageRunwayDays = &v
}

// GetMemoryRunwayDays returns the MemoryRunwayDays field value if set, zero value otherwise.
func (o *Runway) GetMemoryRunwayDays() float32 {
	if o == nil || IsNil(o.MemoryRunwayDays) {
		var ret float32
		return ret
	}
	return *o.MemoryRunwayDays
}

// GetMemoryRunwayDaysOk returns a tuple with the MemoryRunwayDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Runway) GetMemoryRunwayDaysOk() (*float32, bool) {
	if o == nil || IsNil(o.MemoryRunwayDays) {
		return nil, false
	}
	return o.MemoryRunwayDays, true
}
...
// SetMemoryRunwayDays gets a reference to the given float32 and assigns it to the MemoryRunwayDays field.
func (o *Runway) SetMemoryRunwayDays(v float32) {
	o.MemoryRunwayDays = &v
}

// GetCpuRunwayDays returns the CpuRunwayDays field value if set, zero value otherwise.
func (o *Runway) GetCpuRunwayDays() float32 {
	if o == nil || IsNil(o.CpuRunwayDays) {
		var ret float32
		return ret
	}
	return *o.CpuRunwayDays
}

// GetCpuRunwayDaysOk returns a tuple with the CpuRunwayDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Runway) GetCpuRunwayDaysOk() (*float32, bool) {
	if o == nil || IsNil(o.CpuRunwayDays) {
		return nil, false
	}
	return o.CpuRunwayDays, true
}
...
// SetCpuRunwayDays gets a reference to the given float32 and assigns it to the CpuRunwayDays field.
func (o *Runway) SetCpuRunwayDays(v float32) {
	o.CpuRunwayDays = &v
}

func (o Runway) MarshalJSON() ([]byte, error) {
...
func (o Runway) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.MinRunwayDays) {
		toSerialize["min_runway_days"] = o.MinRunwayDays
	}
	if !IsNil(o.StorageRunwayDays) {
		toSerialize["storage_runway_days"] = o.StorageRunwayDays
	}
	if !IsNil(o.MemoryRunwayDays) {
		toSerialize["memory_runway_days"] = o.MemoryRunwayDays
	}
	if !IsNil(o.CpuRunwayDays) {
		toSerialize["cpu_runway_days"] = o.CpuRunwayDays
	}
...
func (o *Runway) UnmarshalJSON(data []byte) (err error) {
	varRunway := _Runway{}

	err = json.Unmarshal(data, &varRunway)
	...
	*o = Runway(varRunway)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "min_runway_days")
		delete(additionalProperties, "storage_runway_days")
		delete(additionalProperties, "memory_runway_days")
		delete(additionalProperties, "cpu_runway_days")
...
type NullableRunway struct {
	value *Runway
	isSet bool
}

func (v NullableRunway) Get() *Runway {
	return v.value
}

func (v *NullableRunway) Set(val *Runway) {
	v.value = val
	v.isSet = true
}

func (v NullableRunway) IsSet() bool {
	return v.isSet
}

func (v *NullableRunway) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunway(val *Runway) *NullableRunway {
	return &NullableRunway{value: val, isSet: true}
}

func (v NullableRunway) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunway) UnmarshalJSON(src []byte) error {
	v.isSet = true
