...
// checks if the QuarantineRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuarantineRule{}

// QuarantineRule These rules are used for quarantining suspected VMs. Target group is a required attribute.  Empty inbound_allow_list will not allow anything into target group. Empty outbound_allow_list will allow everything from target group. 
type QuarantineRule struct {
	// Type of action.
	Action *string `json:"action,omitempty"`
	OutboundAllowList []NetworkRuleStatus `json:"outbound_allow_list,omitempty"`
	TargetGroup *TargetGroup `json:"target_group,omitempty"`
	InboundAllowList []NetworkRuleStatus `json:"inbound_allow_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QuarantineRule QuarantineRule
...
// GetOutboundAllowList returns the OutboundAllowList field value if set, zero value otherwise.
func (o *QuarantineRule) GetOutboundAllowList() []NetworkRuleStatus {
	if o == nil || IsNil(o.OutboundAllowList) {
		var ret []NetworkRuleStatus
		return ret
	}
	return o.OutboundAllowList
}

// GetOutboundAllowListOk returns a tuple with the OutboundAllowList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QuarantineRule) GetOutboundAllowListOk() ([]NetworkRuleStatus, bool) {
	if o == nil || IsNil(o.OutboundAllowList) {
		return nil, false
	}
	return o.OutboundAllowList, true
}
...
// SetOutboundAllowList gets a reference to the given []NetworkRuleStatus and assigns it to the OutboundAllowList field.
func (o *QuarantineRule) SetOutboundAllowList(v []NetworkRuleStatus) {
	o.OutboundAllowList = v
}
...
// GetInboundAllowList returns the InboundAllowList field value if set, zero value otherwise.
func (o *QuarantineRule) GetInboundAllowList() []NetworkRuleStatus {
	if o == nil || IsNil(o.InboundAllowList) {
		var ret []NetworkRuleStatus
		return ret
	}
	return o.InboundAllowList
}

// GetInboundAllowListOk returns a tuple with the InboundAllowList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QuarantineRule) GetInboundAllowListOk() ([]NetworkRuleStatus, bool) {
	if o == nil || IsNil(o.InboundAllowList) {
		return nil, false
	}
	return o.InboundAllowList, true
}
...
// SetInboundAllowList gets a reference to the given []NetworkRuleStatus and assigns it to the InboundAllowList field.
func (o *QuarantineRule) SetInboundAllowList(v []NetworkRuleStatus) {
	o.InboundAllowList = v
}

func (o QuarantineRule) MarshalJSON() ([]byte, error) {
...
func (o QuarantineRule) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Action) {
		toSerialize["action"] = o.Action
	}
	if !IsNil(o.OutboundAllowList) {
		toSerialize["outbound_allow_list"] = o.OutboundAllowList
	}
	if !IsNil(o.TargetGroup) {
		toSerialize["target_group"] = o.TargetGroup
	}
	if !IsNil(o.InboundAllowList) {
		toSerialize["inbound_allow_list"] = o.InboundAllowList
	}
...
func (o *QuarantineRule) UnmarshalJSON(data []byte) (err error) {
	varQuarantineRule := _QuarantineRule{}

	err = json.Unmarshal(data, &varQuarantineRule)

	if err != nil {
		return err
	}

	*o = QuarantineRule(varQuarantineRule)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "action")
		delete(additionalProperties, "outbound_allow_list")
		delete(additionalProperties, "target_group")
		delete(additionalProperties, "inbound_allow_list")
...
type NullableQuarantineRule struct {
	value *QuarantineRule
	isSet bool
}

func (v NullableQuarantineRule) Get() *QuarantineRule {
	return v.value
}

func (v *NullableQuarantineRule) Set(val *QuarantineRule) {
	v.value = val
	v.isSet = true
}

func (v NullableQuarantineRule) IsSet() bool {
	return v.isSet
}

func (v *NullableQuarantineRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuarantineRule(val *QuarantineRule) *NullableQuarantineRule {
	return &NullableQuarantineRule{value: val, isSet: true}
}

func (v NullableQuarantineRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuarantineRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
