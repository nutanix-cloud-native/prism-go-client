...
// checks if the AwsElasticIpListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsElasticIpListIntentResponse{}

// AwsElasticIpListIntentResponse AWS VPC entity list.
type AwsElasticIpListIntentResponse struct {
	Entities []AwsElasticIpIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsElasticIpListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsElasticIpListIntentResponse AwsElasticIpListIntentResponse
...
func NewAwsElasticIpListIntentResponse(apiVersion string, metadata AwsElasticIpListMetadataOutput) *AwsElasticIpListIntentResponse {
	this := AwsElasticIpListIntentResponse{}
...
func (o *AwsElasticIpListIntentResponse) GetEntities() []AwsElasticIpIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []AwsElasticIpIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []AwsElasticIpIntentResource and assigns it to the Entities field.
...
func (o *AwsElasticIpListIntentResponse) GetMetadata() AwsElasticIpListMetadataOutput {
	if o == nil {
		var ret AwsElasticIpListMetadataOutput
		return ret
	}
...
func (o AwsElasticIpListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AwsElasticIpListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AwsElasticIpListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsElasticIpListIntentResponse := _AwsElasticIpListIntentResponse{}

	err = json.Unmarshal(data, &varAwsElasticIpListIntentResponse)

	if err != nil {
		return err
	}

	*o = AwsElasticIpListIntentResponse(varAwsElasticIpListIntentResponse)
...
type NullableAwsElasticIpListIntentResponse struct {
	value *AwsElasticIpListIntentResponse
	isSet bool
}

func (v NullableAwsElasticIpListIntentResponse) Get() *AwsElasticIpListIntentResponse {
	return v.value
}

func (v *NullableAwsElasticIpListIntentResponse) Set(val *AwsElasticIpListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsElasticIpListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsElasticIpListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsElasticIpListIntentResponse(val *AwsElasticIpListIntentResponse) *NullableAwsElasticIpListIntentResponse {
	return &NullableAwsElasticIpListIntentResponse{value: val, isSet: true}
}

func (v NullableAwsElasticIpListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsElasticIpListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
