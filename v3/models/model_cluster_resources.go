...
// SetConfig gets a reference to the given ClusterConfigSpec and assigns it to the Config field.
...
// SetNetwork gets a reference to the given ClusterNetwork and assigns it to the Network field.
