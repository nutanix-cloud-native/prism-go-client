...
// checks if the VolumeGroupDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupDefStatus{}
...
type VolumeGroupDefStatus struct {
	...
	Resources VolumeGroupResourcesOutput `json:"resources"`
	// Volume group name.
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _VolumeGroupDefStatus VolumeGroupDefStatus
...
func (o *VolumeGroupDefStatus) GetResources() VolumeGroupResourcesOutput {
	if o == nil {
		var ret VolumeGroupResourcesOutput
		return ret
	}
...
func (o VolumeGroupDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeGroupDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumeGroupDefStatus := _VolumeGroupDefStatus{}

	err = json.Unmarshal(data, &varVolumeGroupDefStatus)

	if err != nil {
		return err
	}

	*o = VolumeGroupDefStatus(varVolumeGroupDefStatus)
...
type NullableVolumeGroupDefStatus struct {
	value *VolumeGroupDefStatus
	isSet bool
}

func (v NullableVolumeGroupDefStatus) Get() *VolumeGroupDefStatus {
	return v.value
}

func (v *NullableVolumeGroupDefStatus) Set(val *VolumeGroupDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupDefStatus(val *VolumeGroupDefStatus) *NullableVolumeGroupDefStatus {
	return &NullableVolumeGroupDefStatus{value: val, isSet: true}
}

func (v NullableVolumeGroupDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
