...
// checks if the FloatingIpIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpIntentInput{}

// FloatingIpIntentInput An intentful representation of a floating_ip
type FloatingIpIntentInput struct {
	Spec FloatingIp `json:"spec"`
...
type _FloatingIpIntentInput FloatingIpIntentInput
...
func (o FloatingIpIntentInput) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *FloatingIpIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varFloatingIpIntentInput := _FloatingIpIntentInput{}

	err = json.Unmarshal(data, &varFloatingIpIntentInput)

	if err != nil {
		return err
	}

	*o = FloatingIpIntentInput(varFloatingIpIntentInput)
...
type NullableFloatingIpIntentInput struct {
	value *FloatingIpIntentInput
	isSet bool
}

func (v NullableFloatingIpIntentInput) Get() *FloatingIpIntentInput {
	return v.value
}

func (v *NullableFloatingIpIntentInput) Set(val *FloatingIpIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpIntentInput(val *FloatingIpIntentInput) *NullableFloatingIpIntentInput {
	return &NullableFloatingIpIntentInput{value: val, isSet: true}
}

func (v NullableFloatingIpIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
