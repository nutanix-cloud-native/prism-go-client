...
// checks if the CmspNetworkConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmspNetworkConfig{}
...
type CmspNetworkConfig struct {
	...
	SubnetMask string `json:"subnet_mask" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// Network type.
	Type *string `json:"type,omitempty"`
	// Network name for cmsp cluster.
	NetworkName *string `json:"network_name,omitempty"`
	// Gateway IP address.
	DefaultGateway string `json:"default_gateway" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	AdditionalProperties map[string]interface{}
}

type _CmspNetworkConfig CmspNetworkConfig
...
func NewCmspNetworkConfig(subnetMask string, defaultGateway string) *CmspNetworkConfig {
	this := CmspNetworkConfig{}
	this.SubnetMask = subnetMask
	var type_ string = "kFull"
	this.Type = &type_
...
func (o CmspNetworkConfig) MarshalJSON() ([]byte, error) {
...
func (o CmspNetworkConfig) ToMap() (map[string]interface{}, error) {
...
func (o *CmspNetworkConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varCmspNetworkConfig := _CmspNetworkConfig{}

	err = json.Unmarshal(data, &varCmspNetworkConfig)

	if err != nil {
		return err
	}

	*o = CmspNetworkConfig(varCmspNetworkConfig)
...
type NullableCmspNetworkConfig struct {
	value *CmspNetworkConfig
	isSet bool
}

func (v NullableCmspNetworkConfig) Get() *CmspNetworkConfig {
	return v.value
}

func (v *NullableCmspNetworkConfig) Set(val *CmspNetworkConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableCmspNetworkConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableCmspNetworkConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmspNetworkConfig(val *CmspNetworkConfig) *NullableCmspNetworkConfig {
	return &NullableCmspNetworkConfig{value: val, isSet: true}
}

func (v NullableCmspNetworkConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmspNetworkConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
