...
// checks if the AppTaskResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskResponseDownload{}

// AppTaskResponseDownload Task definition for Application.
type AppTaskResponseDownload struct {
	...
	// 
	ChildTasksLocalReferenceList []AppTaskReferenceUpload `json:"child_tasks_local_reference_list,omitempty"`
	// 
...
type _AppTaskResponseDownload AppTaskResponseDownload
...
func (o *AppTaskResponseDownload) GetChildTasksLocalReferenceList() []AppTaskReferenceUpload {
	if o == nil || IsNil(o.ChildTasksLocalReferenceList) {
		var ret []AppTaskReferenceUpload
		return ret
	}
...
// SetChildTasksLocalReferenceList gets a reference to the given []AppTaskReferenceUpload and assigns it to the ChildTasksLocalReferenceList field.
...
func (o AppTaskResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o AppTaskResponseDownload) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskResponseDownload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskResponseDownload := _AppTaskResponseDownload{}

	err = json.Unmarshal(data, &varAppTaskResponseDownload)

	if err != nil {
		return err
	}

	*o = AppTaskResponseDownload(varAppTaskResponseDownload)
...
type NullableAppTaskResponseDownload struct {
	value *AppTaskResponseDownload
	isSet bool
}

func (v NullableAppTaskResponseDownload) Get() *AppTaskResponseDownload {
	return v.value
}

func (v *NullableAppTaskResponseDownload) Set(val *AppTaskResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskResponseDownload(val *AppTaskResponseDownload) *NullableAppTaskResponseDownload {
	return &NullableAppTaskResponseDownload{value: val, isSet: true}
}

func (v NullableAppTaskResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
