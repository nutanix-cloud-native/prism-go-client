...
// checks if the DatacenterDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterDefStatus{}

// DatacenterDefStatus Datacenter entity status definition
type DatacenterDefStatus struct {
	// The datacenter name
	Name string `json:"name"`
	Resources DatacenterResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _DatacenterDefStatus DatacenterDefStatus
...
func (o DatacenterDefStatus) MarshalJSON() ([]byte, error) {
...
func (o DatacenterDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DatacenterDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varDatacenterDefStatus := _DatacenterDefStatus{}

	err = json.Unmarshal(data, &varDatacenterDefStatus)

	if err != nil {
		return err
	}

	*o = DatacenterDefStatus(varDatacenterDefStatus)
...
type NullableDatacenterDefStatus struct {
	value *DatacenterDefStatus
	isSet bool
}

func (v NullableDatacenterDefStatus) Get() *DatacenterDefStatus {
	return v.value
}

func (v *NullableDatacenterDefStatus) Set(val *DatacenterDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterDefStatus(val *DatacenterDefStatus) *NullableDatacenterDefStatus {
	return &NullableDatacenterDefStatus{value: val, isSet: true}
}

func (v NullableDatacenterDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
