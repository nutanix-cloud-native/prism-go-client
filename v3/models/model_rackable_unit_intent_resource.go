...
// checks if the RackableUnitIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackableUnitIntentResource{}

// RackableUnitIntentResource Response object for intentful operations on a rackable_unit
type RackableUnitIntentResource struct {
	Status *RackableUnitDefStatus `json:"status,omitempty"`
	Spec *RackableUnit `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata RackableUnitMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RackableUnitIntentResource RackableUnitIntentResource
...
func NewRackableUnitIntentResource(metadata RackableUnitMetadata) *RackableUnitIntentResource {
	this := RackableUnitIntentResource{}
...
// SetStatus gets a reference to the given RackableUnitDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given RackableUnit and assigns it to the Spec field.
...
func (o RackableUnitIntentResource) MarshalJSON() ([]byte, error) {
...
func (o RackableUnitIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *RackableUnitIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varRackableUnitIntentResource := _RackableUnitIntentResource{}

	err = json.Unmarshal(data, &varRackableUnitIntentResource)

	if err != nil {
		return err
	}

	*o = RackableUnitIntentResource(varRackableUnitIntentResource)
...
type NullableRackableUnitIntentResource struct {
	value *RackableUnitIntentResource
	isSet bool
}

func (v NullableRackableUnitIntentResource) Get() *RackableUnitIntentResource {
	return v.value
}

func (v *NullableRackableUnitIntentResource) Set(val *RackableUnitIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableRackableUnitIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableRackableUnitIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackableUnitIntentResource(val *RackableUnitIntentResource) *NullableRackableUnitIntentResource {
	return &NullableRackableUnitIntentResource{value: val, isSet: true}
}

func (v NullableRackableUnitIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackableUnitIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
