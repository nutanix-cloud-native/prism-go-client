...
// checks if the CitrixConnectorConfigDetailsSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CitrixConnectorConfigDetailsSpec{}
...
type CitrixConnectorConfigDetailsSpec struct {
	...
	CitrixVmReferenceList []VmReference `json:"citrix_vm_reference_list,omitempty"`
...
type _CitrixConnectorConfigDetailsSpec CitrixConnectorConfigDetailsSpec
...
func NewCitrixConnectorConfigDetailsSpec() *CitrixConnectorConfigDetailsSpec {
	this := CitrixConnectorConfigDetailsSpec{}
	return &this
}
...
// GetCitrixVmReferenceList returns the CitrixVmReferenceList field value if set, zero value otherwise.
func (o *CitrixConnectorConfigDetailsSpec) GetCitrixVmReferenceList() []VmReference {
	if o == nil || IsNil(o.CitrixVmReferenceList) {
		var ret []VmReference
		return ret
	}
	return o.CitrixVmReferenceList
}

// GetCitrixVmReferenceListOk returns a tuple with the CitrixVmReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CitrixConnectorConfigDetailsSpec) GetCitrixVmReferenceListOk() ([]VmReference, bool) {
	if o == nil || IsNil(o.CitrixVmReferenceList) {
		return nil, false
	}
	return o.CitrixVmReferenceList, true
}
...
// SetCitrixVmReferenceList gets a reference to the given []VmReference and assigns it to the CitrixVmReferenceList field.
func (o *CitrixConnectorConfigDetailsSpec) SetCitrixVmReferenceList(v []VmReference) {
	o.CitrixVmReferenceList = v
}
...
func (o *CitrixConnectorConfigDetailsSpec) GetResourceLocation() CitrixResourceLocationSpec {
	if o == nil || IsNil(o.ResourceLocation) {
		var ret CitrixResourceLocationSpec
		return ret
	}
...
// SetResourceLocation gets a reference to the given CitrixResourceLocationSpec and assigns it to the ResourceLocation field.
func (o *CitrixConnectorConfigDetailsSpec) SetResourceLocation(v CitrixResourceLocationSpec) {
	o.ResourceLocation = &v
}

func (o CitrixConnectorConfigDetailsSpec) MarshalJSON() ([]byte, error) {
...
func (o CitrixConnectorConfigDetailsSpec) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CitrixVmReferenceList) {
		toSerialize["citrix_vm_reference_list"] = o.CitrixVmReferenceList
	}
	...
	if !IsNil(o.ResourceLocation) {
		toSerialize["resource_location"] = o.ResourceLocation
	}
...
func (o *CitrixConnectorConfigDetailsSpec) UnmarshalJSON(data []byte) (err error) {
	varCitrixConnectorConfigDetailsSpec := _CitrixConnectorConfigDetailsSpec{}

	err = json.Unmarshal(data, &varCitrixConnectorConfigDetailsSpec)

	if err != nil {
		return err
	}

	*o = CitrixConnectorConfigDetailsSpec(varCitrixConnectorConfigDetailsSpec)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "citrix_vm_reference_list")
		delete(additionalProperties, "client_secret")
		delete(additionalProperties, "customer_id")
		delete(additionalProperties, "client_id")
		delete(additionalProperties, "resource_location")
...
type NullableCitrixConnectorConfigDetailsSpec struct {
	value *CitrixConnectorConfigDetailsSpec
	isSet bool
}

func (v NullableCitrixConnectorConfigDetailsSpec) Get() *CitrixConnectorConfigDetailsSpec {
	return v.value
}

func (v *NullableCitrixConnectorConfigDetailsSpec) Set(val *CitrixConnectorConfigDetailsSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableCitrixConnectorConfigDetailsSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableCitrixConnectorConfigDetailsSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCitrixConnectorConfigDetailsSpec(val *CitrixConnectorConfigDetailsSpec) *NullableCitrixConnectorConfigDetailsSpec {
	return &NullableCitrixConnectorConfigDetailsSpec{value: val, isSet: true}
}

func (v NullableCitrixConnectorConfigDetailsSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCitrixConnectorConfigDetailsSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
