...
// checks if the BillingSummaryChargeGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingSummaryChargeGroup{}

// BillingSummaryChargeGroup Charges incurred for charge_date.
type BillingSummaryChargeGroup struct {
	ChargeAmount *MonetaryValue `json:"charge_amount,omitempty"`
	// date on which charge occurred.
...
type _BillingSummaryChargeGroup BillingSummaryChargeGroup
...
func NewBillingSummaryChargeGroup() *BillingSummaryChargeGroup {
	this := BillingSummaryChargeGroup{}
	return &this
}
...
// SetChargeAmount gets a reference to the given MonetaryValue and assigns it to the ChargeAmount field.
...
// SetChargeDate gets a reference to the given string and assigns it to the ChargeDate field.
...
func (o BillingSummaryChargeGroup) MarshalJSON() ([]byte, error) {
...
func (o BillingSummaryChargeGroup) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ChargeAmount) {
		toSerialize["charge_amount"] = o.ChargeAmount
	}
	if !IsNil(o.ChargeDate) {
		toSerialize["charge_date"] = o.ChargeDate
	}
	if !IsNil(o.Quantity) {
...
func (o *BillingSummaryChargeGroup) UnmarshalJSON(data []byte) (err error) {
	varBillingSummaryChargeGroup := _BillingSummaryChargeGroup{}

	err = json.Unmarshal(data, &varBillingSummaryChargeGroup)

	if err != nil {
		return err
	}

	*o = BillingSummaryChargeGroup(varBillingSummaryChargeGroup)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "charge_amount")
		delete(additionalProperties, "charge_date")
...
type NullableBillingSummaryChargeGroup struct {
	value *BillingSummaryChargeGroup
	isSet bool
}

func (v NullableBillingSummaryChargeGroup) Get() *BillingSummaryChargeGroup {
	return v.value
}

func (v *NullableBillingSummaryChargeGroup) Set(val *BillingSummaryChargeGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingSummaryChargeGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingSummaryChargeGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingSummaryChargeGroup(val *BillingSummaryChargeGroup) *NullableBillingSummaryChargeGroup {
	return &NullableBillingSummaryChargeGroup{value: val, isSet: true}
}

func (v NullableBillingSummaryChargeGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingSummaryChargeGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
