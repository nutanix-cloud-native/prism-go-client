...
// checks if the AppServiceInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppServiceInputUpload{}

// AppServiceInputUpload Service definition for Application
type AppServiceInputUpload struct {
	...
	ActionList []AppActionInputUpload `json:"action_list"`
	// 
	...
	// 
	VariableList []AppVariableInputUpload `json:"variable_list"`
	// 
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _AppServiceInputUpload AppServiceInputUpload
...
func (o AppServiceInputUpload) MarshalJSON() ([]byte, error) {
...
func (o AppServiceInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppServiceInputUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppServiceInputUpload := _AppServiceInputUpload{}

	err = json.Unmarshal(data, &varAppServiceInputUpload)

	if err != nil {
		return err
	}

	*o = AppServiceInputUpload(varAppServiceInputUpload)
...
type NullableAppServiceInputUpload struct {
	value *AppServiceInputUpload
	isSet bool
}

func (v NullableAppServiceInputUpload) Get() *AppServiceInputUpload {
	return v.value
}

func (v *NullableAppServiceInputUpload) Set(val *AppServiceInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppServiceInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppServiceInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppServiceInputUpload(val *AppServiceInputUpload) *NullableAppServiceInputUpload {
	return &NullableAppServiceInputUpload{value: val, isSet: true}
}

func (v NullableAppServiceInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppServiceInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
