...
// checks if the LogCollectorSupportCaseUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogCollectorSupportCaseUpload{}

// LogCollectorSupportCaseUpload Log Collector object.
type LogCollectorSupportCaseUpload struct {
	...
	// Flag for anonymized log collection.
	AnonymizeOutput *bool `json:"anonymize_output,omitempty"`
	...
	// Number of hours for which log has to be collected. Starts from current time - no_of_hours till current time.
	NumHours *int32 `json:"num_hours,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _LogCollectorSupportCaseUpload LogCollectorSupportCaseUpload
...
func NewLogCollectorSupportCaseUpload() *LogCollectorSupportCaseUpload {
	this := LogCollectorSupportCaseUpload{}
	return &this
}
...
// GetNumHours returns the NumHours field value if set, zero value otherwise.
func (o *LogCollectorSupportCaseUpload) GetNumHours() int32 {
	if o == nil || IsNil(o.NumHours) {
		var ret int32
		return ret
	}
	return *o.NumHours
...
// GetNumHoursOk returns a tuple with the NumHours field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LogCollectorSupportCaseUpload) GetNumHoursOk() (*int32, bool) {
	if o == nil || IsNil(o.NumHours) {
		return nil, false
	}
	return o.NumHours, true
}
...
// SetNumHours gets a reference to the given int32 and assigns it to the NumHours field.
func (o *LogCollectorSupportCaseUpload) SetNumHours(v int32) {
	o.NumHours = &v
}

func (o LogCollectorSupportCaseUpload) MarshalJSON() ([]byte, error) {
...
func (o LogCollectorSupportCaseUpload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.StartTime) {
		toSerialize["start_time"] = o.StartTime
	}
	if !IsNil(o.AnonymizeOutput) {
		toSerialize["anonymize_output"] = o.AnonymizeOutput
	}
	if !IsNil(o.EndTime) {
		toSerialize["end_time"] = o.EndTime
	}
	if !IsNil(o.NumHours) {
		toSerialize["num_hours"] = o.NumHours
	}
...
func (o *LogCollectorSupportCaseUpload) UnmarshalJSON(data []byte) (err error) {
	varLogCollectorSupportCaseUpload := _LogCollectorSupportCaseUpload{}

	err = json.Unmarshal(data, &varLogCollectorSupportCaseUpload)

	if err != nil {
		return err
	}

	*o = LogCollectorSupportCaseUpload(varLogCollectorSupportCaseUpload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "start_time")
		delete(additionalProperties, "anonymize_output")
		delete(additionalProperties, "end_time")
		delete(additionalProperties, "num_hours")
...
type NullableLogCollectorSupportCaseUpload struct {
	value *LogCollectorSupportCaseUpload
	isSet bool
}

func (v NullableLogCollectorSupportCaseUpload) Get() *LogCollectorSupportCaseUpload {
	return v.value
}

func (v *NullableLogCollectorSupportCaseUpload) Set(val *LogCollectorSupportCaseUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableLogCollectorSupportCaseUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableLogCollectorSupportCaseUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLogCollectorSupportCaseUpload(val *LogCollectorSupportCaseUpload) *NullableLogCollectorSupportCaseUpload {
	return &NullableLogCollectorSupportCaseUpload{value: val, isSet: true}
}

func (v NullableLogCollectorSupportCaseUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLogCollectorSupportCaseUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
