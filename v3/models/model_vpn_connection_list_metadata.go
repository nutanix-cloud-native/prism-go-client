...
// checks if the VpnConnectionListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionListMetadata{}

// VpnConnectionListMetadata All api calls that return a list will have this metadata block as input 
type VpnConnectionListMetadata struct {
	// The kind name
...
type _VpnConnectionListMetadata VpnConnectionListMetadata
...
func NewVpnConnectionListMetadata() *VpnConnectionListMetadata {
	this := VpnConnectionListMetadata{}
...
func (o VpnConnectionListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnectionListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVpnConnectionListMetadata := _VpnConnectionListMetadata{}

	err = json.Unmarshal(data, &varVpnConnectionListMetadata)

	if err != nil {
		return err
	}

	*o = VpnConnectionListMetadata(varVpnConnectionListMetadata)
...
type NullableVpnConnectionListMetadata struct {
	value *VpnConnectionListMetadata
	isSet bool
}

func (v NullableVpnConnectionListMetadata) Get() *VpnConnectionListMetadata {
	return v.value
}

func (v *NullableVpnConnectionListMetadata) Set(val *VpnConnectionListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionListMetadata(val *VpnConnectionListMetadata) *NullableVpnConnectionListMetadata {
	return &NullableVpnConnectionListMetadata{value: val, isSet: true}
}

func (v NullableVpnConnectionListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
