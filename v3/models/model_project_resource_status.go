...
// checks if the ProjectResourceStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectResourceStatus{}

// ProjectResourceStatus A Project resource.
type ProjectResourceStatus struct {
	...
	// The reason for the state if in error.
	Message *string `json:"message,omitempty"`
	Resources ProjectResources3 `json:"resources"`
	// Project description.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ProjectResourceStatus ProjectResourceStatus
...
func (o ProjectResourceStatus) MarshalJSON() ([]byte, error) {
...
func (o ProjectResourceStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectResourceStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectResourceStatus := _ProjectResourceStatus{}

	err = json.Unmarshal(data, &varProjectResourceStatus)

	if err != nil {
		return err
	}

	*o = ProjectResourceStatus(varProjectResourceStatus)
...
type NullableProjectResourceStatus struct {
	value *ProjectResourceStatus
	isSet bool
}

func (v NullableProjectResourceStatus) Get() *ProjectResourceStatus {
	return v.value
}

func (v *NullableProjectResourceStatus) Set(val *ProjectResourceStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectResourceStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectResourceStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectResourceStatus(val *ProjectResourceStatus) *NullableProjectResourceStatus {
	return &NullableProjectResourceStatus{value: val, isSet: true}
}

func (v NullableProjectResourceStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectResourceStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
