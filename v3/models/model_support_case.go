...
// checks if the SupportCase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCase{}

// SupportCase Support Case creation/modification spec.
type SupportCase struct {
	// Description of the support case.
	Description *string `json:"description,omitempty"`
	Resources SupportCaseResources `json:"resources"`
	// Subject of the support case.
	Subject string `json:"subject"`
	AdditionalProperties map[string]interface{}
}

type _SupportCase SupportCase
...
func (o SupportCase) MarshalJSON() ([]byte, error) {
...
func (o SupportCase) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCase) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCase := _SupportCase{}

	err = json.Unmarshal(data, &varSupportCase)

	if err != nil {
		return err
	}

	*o = SupportCase(varSupportCase)
...
type NullableSupportCase struct {
	value *SupportCase
	isSet bool
}

func (v NullableSupportCase) Get() *SupportCase {
	return v.value
}

func (v *NullableSupportCase) Set(val *SupportCase) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCase) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCase(val *SupportCase) *NullableSupportCase {
	return &NullableSupportCase{value: val, isSet: true}
}

func (v NullableSupportCase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCase) UnmarshalJSON(src []byte) error {
	v.isSet = true
