...
// checks if the TrafficVisibilityValidationResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrafficVisibilityValidationResult{}

// TrafficVisibilityValidationResult Traffic visibility validation item.
type TrafficVisibilityValidationResult struct {
	// Whether the validation passed.
	HasPassed *bool `json:"has_passed,omitempty"`
	// The minimum version the validation is checking against. 
	Version *string `json:"version,omitempty"`
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _TrafficVisibilityValidationResult TrafficVisibilityValidationResult
...
func NewTrafficVisibilityValidationResult() *TrafficVisibilityValidationResult {
	this := TrafficVisibilityValidationResult{}
	return &this
}
...
// GetHasPassed returns the HasPassed field value if set, zero value otherwise.
func (o *TrafficVisibilityValidationResult) GetHasPassed() bool {
	if o == nil || IsNil(o.HasPassed) {
		var ret bool
		return ret
	}
	return *o.HasPassed
...
// GetHasPassedOk returns a tuple with the HasPassed field value if set, nil otherwise
...
// SetHasPassed gets a reference to the given bool and assigns it to the HasPassed field.
...
func (o TrafficVisibilityValidationResult) MarshalJSON() ([]byte, error) {
...
func (o TrafficVisibilityValidationResult) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.HasPassed) {
		toSerialize["has_passed"] = o.HasPassed
	}
	if !IsNil(o.Version) {
...
func (o *TrafficVisibilityValidationResult) UnmarshalJSON(data []byte) (err error) {
	varTrafficVisibilityValidationResult := _TrafficVisibilityValidationResult{}

	err = json.Unmarshal(data, &varTrafficVisibilityValidationResult)

	if err != nil {
		return err
	}

	*o = TrafficVisibilityValidationResult(varTrafficVisibilityValidationResult)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "has_passed")
...
type NullableTrafficVisibilityValidationResult struct {
	value *TrafficVisibilityValidationResult
	isSet bool
}

func (v NullableTrafficVisibilityValidationResult) Get() *TrafficVisibilityValidationResult {
	return v.value
}

func (v *NullableTrafficVisibilityValidationResult) Set(val *TrafficVisibilityValidationResult) {
	v.value = val
	v.isSet = true
}

func (v NullableTrafficVisibilityValidationResult) IsSet() bool {
	return v.isSet
}

func (v *NullableTrafficVisibilityValidationResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrafficVisibilityValidationResult(val *TrafficVisibilityValidationResult) *NullableTrafficVisibilityValidationResult {
	return &NullableTrafficVisibilityValidationResult{value: val, isSet: true}
}

func (v NullableTrafficVisibilityValidationResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrafficVisibilityValidationResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
