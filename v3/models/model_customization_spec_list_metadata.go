...
// checks if the CustomizationSpecListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomizationSpecListMetadata{}

// CustomizationSpecListMetadata All api calls that return a list will have this metadata block as input 
type CustomizationSpecListMetadata struct {
	// The kind name
...
type _CustomizationSpecListMetadata CustomizationSpecListMetadata
...
func NewCustomizationSpecListMetadata() *CustomizationSpecListMetadata {
	this := CustomizationSpecListMetadata{}
...
func (o CustomizationSpecListMetadata) MarshalJSON() ([]byte, error) {
...
func (o CustomizationSpecListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CustomizationSpecListMetadata) UnmarshalJSON(data []byte) (err error) {
	varCustomizationSpecListMetadata := _CustomizationSpecListMetadata{}

	err = json.Unmarshal(data, &varCustomizationSpecListMetadata)

	if err != nil {
		return err
	}

	*o = CustomizationSpecListMetadata(varCustomizationSpecListMetadata)
...
type NullableCustomizationSpecListMetadata struct {
	value *CustomizationSpecListMetadata
	isSet bool
}

func (v NullableCustomizationSpecListMetadata) Get() *CustomizationSpecListMetadata {
	return v.value
}

func (v *NullableCustomizationSpecListMetadata) Set(val *CustomizationSpecListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomizationSpecListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomizationSpecListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomizationSpecListMetadata(val *CustomizationSpecListMetadata) *NullableCustomizationSpecListMetadata {
	return &NullableCustomizationSpecListMetadata{value: val, isSet: true}
}

func (v NullableCustomizationSpecListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomizationSpecListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
