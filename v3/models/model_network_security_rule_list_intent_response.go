...
// checks if the NetworkSecurityRuleListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleListIntentResponse{}
...
type NetworkSecurityRuleListIntentResponse struct {
	Entities []NetworkSecurityRuleIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata NetworkSecurityRuleListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _NetworkSecurityRuleListIntentResponse NetworkSecurityRuleListIntentResponse
...
func NewNetworkSecurityRuleListIntentResponse(apiVersion string, metadata NetworkSecurityRuleListMetadataOutput) *NetworkSecurityRuleListIntentResponse {
	this := NetworkSecurityRuleListIntentResponse{}
...
func (o *NetworkSecurityRuleListIntentResponse) GetEntities() []NetworkSecurityRuleIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []NetworkSecurityRuleIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []NetworkSecurityRuleIntentResource and assigns it to the Entities field.
...
func (o *NetworkSecurityRuleListIntentResponse) GetMetadata() NetworkSecurityRuleListMetadataOutput {
	if o == nil {
		var ret NetworkSecurityRuleListMetadataOutput
		return ret
	}
...
func (o NetworkSecurityRuleListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRuleListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkSecurityRuleListIntentResponse := _NetworkSecurityRuleListIntentResponse{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleListIntentResponse)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleListIntentResponse(varNetworkSecurityRuleListIntentResponse)
...
type NullableNetworkSecurityRuleListIntentResponse struct {
	value *NetworkSecurityRuleListIntentResponse
	isSet bool
}

func (v NullableNetworkSecurityRuleListIntentResponse) Get() *NetworkSecurityRuleListIntentResponse {
	return v.value
}

func (v *NullableNetworkSecurityRuleListIntentResponse) Set(val *NetworkSecurityRuleListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleListIntentResponse(val *NetworkSecurityRuleListIntentResponse) *NullableNetworkSecurityRuleListIntentResponse {
	return &NullableNetworkSecurityRuleListIntentResponse{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
