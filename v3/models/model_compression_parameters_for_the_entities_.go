...
// checks if the CompressionParametersForTheEntities type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompressionParametersForTheEntities{}

// CompressionParametersForTheEntities struct for CompressionParametersForTheEntities
type CompressionParametersForTheEntities struct {
	// Enable or disable compression for entities governed by the policy. If user does not have an explicit preference for compression, the system decides an appropriate value. 
	State *string `json:"state,omitempty"`
	// Indicates inline or post-process compression. If compression state is SYSTEM_DERIVED, then this field has no significance. 
	InlineCompression *bool `json:"inline_compression,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CompressionParametersForTheEntities CompressionParametersForTheEntities
...
func NewCompressionParametersForTheEntities() *CompressionParametersForTheEntities {
	this := CompressionParametersForTheEntities{}
	var state string = "SYSTEM_DERIVED"
	this.State = &state
	return &this
}
...
func (o CompressionParametersForTheEntities) MarshalJSON() ([]byte, error) {
...
func (o CompressionParametersForTheEntities) ToMap() (map[string]interface{}, error) {
...
func (o *CompressionParametersForTheEntities) UnmarshalJSON(data []byte) (err error) {
	varCompressionParametersForTheEntities := _CompressionParametersForTheEntities{}

	err = json.Unmarshal(data, &varCompressionParametersForTheEntities)

	if err != nil {
		return err
	}

	*o = CompressionParametersForTheEntities(varCompressionParametersForTheEntities)
...
type NullableCompressionParametersForTheEntities struct {
	value *CompressionParametersForTheEntities
	isSet bool
}

func (v NullableCompressionParametersForTheEntities) Get() *CompressionParametersForTheEntities {
	return v.value
}

func (v *NullableCompressionParametersForTheEntities) Set(val *CompressionParametersForTheEntities) {
	v.value = val
	v.isSet = true
}

func (v NullableCompressionParametersForTheEntities) IsSet() bool {
	return v.isSet
}

func (v *NullableCompressionParametersForTheEntities) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompressionParametersForTheEntities(val *CompressionParametersForTheEntities) *NullableCompressionParametersForTheEntities {
	return &NullableCompressionParametersForTheEntities{value: val, isSet: true}
}

func (v NullableCompressionParametersForTheEntities) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompressionParametersForTheEntities) UnmarshalJSON(src []byte) error {
	v.isSet = true
