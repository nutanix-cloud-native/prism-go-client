...
// checks if the SshUserDetailsEntityListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserDetailsEntityListInner{}

// SshUserDetailsEntityListInner struct for SshUserDetailsEntityListInner
type SshUserDetailsEntityListInner struct {
	// Entity UUID
...
type _SshUserDetailsEntityListInner SshUserDetailsEntityListInner
...
func NewSshUserDetailsEntityListInner() *SshUserDetailsEntityListInner {
	this := SshUserDetailsEntityListInner{}
	return &this
}
...
// GetEntityIp returns the EntityIp field value if set, zero value otherwise.
func (o *SshUserDetailsEntityListInner) GetEntityIp() string {
	if o == nil || IsNil(o.EntityIp) {
		var ret string
		return ret
	}
	return *o.EntityIp
...
// GetEntityIpOk returns a tuple with the EntityIp field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetEntityIp gets a reference to the given string and assigns it to the EntityIp field.
...
func (o SshUserDetailsEntityListInner) MarshalJSON() ([]byte, error) {
...
func (o SshUserDetailsEntityListInner) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserDetailsEntityListInner) UnmarshalJSON(data []byte) (err error) {
	varSshUserDetailsEntityListInner := _SshUserDetailsEntityListInner{}

	err = json.Unmarshal(data, &varSshUserDetailsEntityListInner)

	if err != nil {
		return err
	}

	*o = SshUserDetailsEntityListInner(varSshUserDetailsEntityListInner)
...
type NullableSshUserDetailsEntityListInner struct {
	value *SshUserDetailsEntityListInner
	isSet bool
}

func (v NullableSshUserDetailsEntityListInner) Get() *SshUserDetailsEntityListInner {
	return v.value
}

func (v *NullableSshUserDetailsEntityListInner) Set(val *SshUserDetailsEntityListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserDetailsEntityListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserDetailsEntityListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserDetailsEntityListInner(val *SshUserDetailsEntityListInner) *NullableSshUserDetailsEntityListInner {
	return &NullableSshUserDetailsEntityListInner{value: val, isSet: true}
}

func (v NullableSshUserDetailsEntityListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserDetailsEntityListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
