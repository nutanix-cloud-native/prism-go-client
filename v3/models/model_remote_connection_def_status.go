...
// checks if the RemoteConnectionDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionDefStatus{}

// RemoteConnectionDefStatus Remote connection status definition
type RemoteConnectionDefStatus struct {
	// The state of the remote connection entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	// Remote connection name
	Name string `json:"name"`
	Resources RemoteConnectionResources `json:"resources"`
	// Remote connection description
	Description string `json:"description"`
	AdditionalProperties map[string]interface{}
}

type _RemoteConnectionDefStatus RemoteConnectionDefStatus
...
func NewRemoteConnectionDefStatus(name string, resources RemoteConnectionResources, description string) *RemoteConnectionDefStatus {
	this := RemoteConnectionDefStatus{}
	this.Name = name
...
func (o *RemoteConnectionDefStatus) GetResources() RemoteConnectionResources {
	if o == nil {
		var ret RemoteConnectionResources
		return ret
	}
...
func (o RemoteConnectionDefStatus) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteConnectionDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteConnectionDefStatus := _RemoteConnectionDefStatus{}

	err = json.Unmarshal(data, &varRemoteConnectionDefStatus)

	if err != nil {
		return err
	}

	*o = RemoteConnectionDefStatus(varRemoteConnectionDefStatus)
...
type NullableRemoteConnectionDefStatus struct {
	value *RemoteConnectionDefStatus
	isSet bool
}

func (v NullableRemoteConnectionDefStatus) Get() *RemoteConnectionDefStatus {
	return v.value
}

func (v *NullableRemoteConnectionDefStatus) Set(val *RemoteConnectionDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionDefStatus(val *RemoteConnectionDefStatus) *NullableRemoteConnectionDefStatus {
	return &NullableRemoteConnectionDefStatus{value: val, isSet: true}
}

func (v NullableRemoteConnectionDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
