...
// checks if the RecoveryPlanJobStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobStatus{}

// RecoveryPlanJobStatus The status of a REST API call. Only used when there is a failure to report. 
type RecoveryPlanJobStatus struct {
	// The kind name
...
type _RecoveryPlanJobStatus RecoveryPlanJobStatus
...
func (o RecoveryPlanJobStatus) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobStatus) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanJobStatus := _RecoveryPlanJobStatus{}

	err = json.Unmarshal(data, &varRecoveryPlanJobStatus)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobStatus(varRecoveryPlanJobStatus)
...
type NullableRecoveryPlanJobStatus struct {
	value *RecoveryPlanJobStatus
	isSet bool
}

func (v NullableRecoveryPlanJobStatus) Get() *RecoveryPlanJobStatus {
	return v.value
}

func (v *NullableRecoveryPlanJobStatus) Set(val *RecoveryPlanJobStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobStatus(val *RecoveryPlanJobStatus) *NullableRecoveryPlanJobStatus {
	return &NullableRecoveryPlanJobStatus{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
