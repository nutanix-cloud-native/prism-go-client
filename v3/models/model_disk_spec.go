...
// checks if the DiskSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskSpec{}

// DiskSpec Details of the VM/Volume virtual disk.
...
func (o DiskSpec) MarshalJSON() ([]byte, error) {
...
func (o DiskSpec) ToMap() (map[string]interface{}, error) {
...
func (o *DiskSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varDiskSpec := _DiskSpec{}

	err = json.Unmarshal(data, &varDiskSpec)

	if err != nil {
		return err
	}

	*o = DiskSpec(varDiskSpec)
...
type NullableDiskSpec struct {
	value *DiskSpec
	isSet bool
}

func (v NullableDiskSpec) Get() *DiskSpec {
	return v.value
}

func (v *NullableDiskSpec) Set(val *DiskSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskSpec(val *DiskSpec) *NullableDiskSpec {
	return &NullableDiskSpec{value: val, isSet: true}
}

func (v NullableDiskSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
