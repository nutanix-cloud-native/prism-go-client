...
// checks if the VmHostAffinityPolicyVmsListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmHostAffinityPolicyVmsListMetadataOutput{}

// VmHostAffinityPolicyVmsListMetadataOutput API call for VMs list that returns a list will have this metadata block. 
type VmHostAffinityPolicyVmsListMetadataOutput struct {
	// Total matches found.
...
type _VmHostAffinityPolicyVmsListMetadataOutput VmHostAffinityPolicyVmsListMetadataOutput
...
func NewVmHostAffinityPolicyVmsListMetadataOutput() *VmHostAffinityPolicyVmsListMetadataOutput {
	this := VmHostAffinityPolicyVmsListMetadataOutput{}
	var kind string = "vm"
	this.Kind = &kind
	return &this
}
...
func (o VmHostAffinityPolicyVmsListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VmHostAffinityPolicyVmsListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VmHostAffinityPolicyVmsListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVmHostAffinityPolicyVmsListMetadataOutput := _VmHostAffinityPolicyVmsListMetadataOutput{}

	err = json.Unmarshal(data, &varVmHostAffinityPolicyVmsListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VmHostAffinityPolicyVmsListMetadataOutput(varVmHostAffinityPolicyVmsListMetadataOutput)
...
type NullableVmHostAffinityPolicyVmsListMetadataOutput struct {
	value *VmHostAffinityPolicyVmsListMetadataOutput
	isSet bool
}

func (v NullableVmHostAffinityPolicyVmsListMetadataOutput) Get() *VmHostAffinityPolicyVmsListMetadataOutput {
	return v.value
}

func (v *NullableVmHostAffinityPolicyVmsListMetadataOutput) Set(val *VmHostAffinityPolicyVmsListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmHostAffinityPolicyVmsListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmHostAffinityPolicyVmsListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmHostAffinityPolicyVmsListMetadataOutput(val *VmHostAffinityPolicyVmsListMetadataOutput) *NullableVmHostAffinityPolicyVmsListMetadataOutput {
	return &NullableVmHostAffinityPolicyVmsListMetadataOutput{value: val, isSet: true}
}

func (v NullableVmHostAffinityPolicyVmsListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmHostAffinityPolicyVmsListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
