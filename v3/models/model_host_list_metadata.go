...
// checks if the HostListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostListMetadata{}
...
type _HostListMetadata HostListMetadata
...
func (o HostListMetadata) MarshalJSON() ([]byte, error) {
...
func (o HostListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *HostListMetadata) UnmarshalJSON(data []byte) (err error) {
	varHostListMetadata := _HostListMetadata{}

	err = json.Unmarshal(data, &varHostListMetadata)

	if err != nil {
		return err
	}

	*o = HostListMetadata(varHostListMetadata)
...
type NullableHostListMetadata struct {
	value *HostListMetadata
	isSet bool
}

func (v NullableHostListMetadata) Get() *HostListMetadata {
	return v.value
}

func (v *NullableHostListMetadata) Set(val *HostListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableHostListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableHostListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostListMetadata(val *HostListMetadata) *NullableHostListMetadata {
	return &NullableHostListMetadata{value: val, isSet: true}
}

func (v NullableHostListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
