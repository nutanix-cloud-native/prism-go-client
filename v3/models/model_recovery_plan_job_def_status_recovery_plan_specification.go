...
// checks if the RecoveryPlanJobDefStatusRecoveryPlanSpecification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobDefStatusRecoveryPlanSpecification{}

// RecoveryPlanJobDefStatusRecoveryPlanSpecification Specification of the Recovery Plan on which the Recovery Plan Job is being executed. 
type RecoveryPlanJobDefStatusRecoveryPlanSpecification struct {
	// Recovery Plan name
	Name string `json:"name"`
	Resources RecoveryPlanResources `json:"resources"`
	// User provided description for the Recovery Plan.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanJobDefStatusRecoveryPlanSpecification RecoveryPlanJobDefStatusRecoveryPlanSpecification
...
func NewRecoveryPlanJobDefStatusRecoveryPlanSpecification(name string, resources RecoveryPlanResources) *RecoveryPlanJobDefStatusRecoveryPlanSpecification {
	this := RecoveryPlanJobDefStatusRecoveryPlanSpecification{}
	this.Name = name
...
func (o RecoveryPlanJobDefStatusRecoveryPlanSpecification) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobDefStatusRecoveryPlanSpecification) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobDefStatusRecoveryPlanSpecification) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobDefStatusRecoveryPlanSpecification := _RecoveryPlanJobDefStatusRecoveryPlanSpecification{}

	err = json.Unmarshal(data, &varRecoveryPlanJobDefStatusRecoveryPlanSpecification)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobDefStatusRecoveryPlanSpecification(varRecoveryPlanJobDefStatusRecoveryPlanSpecification)
...
type NullableRecoveryPlanJobDefStatusRecoveryPlanSpecification struct {
	value *RecoveryPlanJobDefStatusRecoveryPlanSpecification
	isSet bool
}

func (v NullableRecoveryPlanJobDefStatusRecoveryPlanSpecification) Get() *RecoveryPlanJobDefStatusRecoveryPlanSpecification {
	return v.value
}

func (v *NullableRecoveryPlanJobDefStatusRecoveryPlanSpecification) Set(val *RecoveryPlanJobDefStatusRecoveryPlanSpecification) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobDefStatusRecoveryPlanSpecification) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobDefStatusRecoveryPlanSpecification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobDefStatusRecoveryPlanSpecification(val *RecoveryPlanJobDefStatusRecoveryPlanSpecification) *NullableRecoveryPlanJobDefStatusRecoveryPlanSpecification {
	return &NullableRecoveryPlanJobDefStatusRecoveryPlanSpecification{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobDefStatusRecoveryPlanSpecification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobDefStatusRecoveryPlanSpecification) UnmarshalJSON(src []byte) error {
	v.isSet = true
