...
// checks if the NetworkSecurityRuleListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleListMetadata{}

// NetworkSecurityRuleListMetadata All api calls that return a list will have this metadata block as input 
type NetworkSecurityRuleListMetadata struct {
	// The kind name
...
type _NetworkSecurityRuleListMetadata NetworkSecurityRuleListMetadata
...
func NewNetworkSecurityRuleListMetadata() *NetworkSecurityRuleListMetadata {
	this := NetworkSecurityRuleListMetadata{}
...
func (o NetworkSecurityRuleListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRuleListMetadata) UnmarshalJSON(data []byte) (err error) {
	varNetworkSecurityRuleListMetadata := _NetworkSecurityRuleListMetadata{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleListMetadata)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleListMetadata(varNetworkSecurityRuleListMetadata)
...
type NullableNetworkSecurityRuleListMetadata struct {
	value *NetworkSecurityRuleListMetadata
	isSet bool
}

func (v NullableNetworkSecurityRuleListMetadata) Get() *NetworkSecurityRuleListMetadata {
	return v.value
}

func (v *NullableNetworkSecurityRuleListMetadata) Set(val *NetworkSecurityRuleListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleListMetadata(val *NetworkSecurityRuleListMetadata) *NullableNetworkSecurityRuleListMetadata {
	return &NullableNetworkSecurityRuleListMetadata{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
