...
// checks if the ServiceGroupResponseResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceGroupResponseResource{}

// ServiceGroupResponseResource Response object for operations on a service group
type ServiceGroupResponseResource struct {
	...
	// The policies where the service_group is being used
	AssociatedPoliciesList []Reference `json:"associated_policies_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ServiceGroupResponseResource ServiceGroupResponseResource
...
func NewServiceGroupResponseResource() *ServiceGroupResponseResource {
	this := ServiceGroupResponseResource{}
	return &this
}
...
// GetServiceGroup returns the ServiceGroup field value if set, zero value otherwise.
func (o *ServiceGroupResponseResource) GetServiceGroup() ServiceGroup {
	if o == nil || IsNil(o.ServiceGroup) {
		var ret ServiceGroup
		return ret
	}
	return *o.ServiceGroup
}
...
// SetServiceGroup gets a reference to the given ServiceGroup and assigns it to the ServiceGroup field.
...
// GetAssociatedPoliciesList returns the AssociatedPoliciesList field value if set, zero value otherwise.
func (o *ServiceGroupResponseResource) GetAssociatedPoliciesList() []Reference {
	if o == nil || IsNil(o.AssociatedPoliciesList) {
		var ret []Reference
		return ret
	}
	return o.AssociatedPoliciesList
}

// GetAssociatedPoliciesListOk returns a tuple with the AssociatedPoliciesList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceGroupResponseResource) GetAssociatedPoliciesListOk() ([]Reference, bool) {
	if o == nil || IsNil(o.AssociatedPoliciesList) {
		return nil, false
	}
	return o.AssociatedPoliciesList, true
}
...
// SetAssociatedPoliciesList gets a reference to the given []Reference and assigns it to the AssociatedPoliciesList field.
func (o *ServiceGroupResponseResource) SetAssociatedPoliciesList(v []Reference) {
	o.AssociatedPoliciesList = v
}

func (o ServiceGroupResponseResource) MarshalJSON() ([]byte, error) {
...
func (o ServiceGroupResponseResource) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ServiceGroup) {
		toSerialize["service_group"] = o.ServiceGroup
	}
	if !IsNil(o.UUID) {
		toSerialize["uuid"] = o.UUID
	}
	if !IsNil(o.AssociatedPoliciesList) {
		toSerialize["associated_policies_list"] = o.AssociatedPoliciesList
	}
...
func (o *ServiceGroupResponseResource) UnmarshalJSON(data []byte) (err error) {
	varServiceGroupResponseResource := _ServiceGroupResponseResource{}

	err = json.Unmarshal(data, &varServiceGroupResponseResource)

	if err != nil {
		return err
	}

	*o = ServiceGroupResponseResource(varServiceGroupResponseResource)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "service_group")
		delete(additionalProperties, "uuid")
		delete(additionalProperties, "associated_policies_list")
...
type NullableServiceGroupResponseResource struct {
	value *ServiceGroupResponseResource
	isSet bool
}

func (v NullableServiceGroupResponseResource) Get() *ServiceGroupResponseResource {
	return v.value
}

func (v *NullableServiceGroupResponseResource) Set(val *ServiceGroupResponseResource) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceGroupResponseResource) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceGroupResponseResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceGroupResponseResource(val *ServiceGroupResponseResource) *NullableServiceGroupResponseResource {
	return &NullableServiceGroupResponseResource{value: val, isSet: true}
}

func (v NullableServiceGroupResponseResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceGroupResponseResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
