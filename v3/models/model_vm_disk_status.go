...
// checks if the VmDiskStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDiskStatus{}

// VmDiskStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _VmDiskStatus VmDiskStatus
...
func (o VmDiskStatus) MarshalJSON() ([]byte, error) {
...
func (o VmDiskStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VmDiskStatus) UnmarshalJSON(data []byte) (err error) {
	varVmDiskStatus := _VmDiskStatus{}

	err = json.Unmarshal(data, &varVmDiskStatus)

	if err != nil {
		return err
	}

	*o = VmDiskStatus(varVmDiskStatus)
...
type NullableVmDiskStatus struct {
	value *VmDiskStatus
	isSet bool
}

func (v NullableVmDiskStatus) Get() *VmDiskStatus {
	return v.value
}

func (v *NullableVmDiskStatus) Set(val *VmDiskStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVmDiskStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVmDiskStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmDiskStatus(val *VmDiskStatus) *NullableVmDiskStatus {
	return &NullableVmDiskStatus{value: val, isSet: true}
}

func (v NullableVmDiskStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmDiskStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
