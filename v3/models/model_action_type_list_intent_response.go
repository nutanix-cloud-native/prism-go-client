...
// checks if the ActionTypeListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTypeListIntentResponse{}

// ActionTypeListIntentResponse Response object for intentful operation of action_types
type ActionTypeListIntentResponse struct {
	Entities []ActionTypeIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ActionTypeListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ActionTypeListIntentResponse ActionTypeListIntentResponse
...
func NewActionTypeListIntentResponse(apiVersion string, metadata ActionTypeListMetadataOutput) *ActionTypeListIntentResponse {
	this := ActionTypeListIntentResponse{}
...
func (o *ActionTypeListIntentResponse) GetEntities() []ActionTypeIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []ActionTypeIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []ActionTypeIntentResource and assigns it to the Entities field.
...
func (o *ActionTypeListIntentResponse) GetMetadata() ActionTypeListMetadataOutput {
	if o == nil {
		var ret ActionTypeListMetadataOutput
		return ret
	}
...
func (o ActionTypeListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ActionTypeListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTypeListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTypeListIntentResponse := _ActionTypeListIntentResponse{}

	err = json.Unmarshal(data, &varActionTypeListIntentResponse)

	if err != nil {
		return err
	}

	*o = ActionTypeListIntentResponse(varActionTypeListIntentResponse)
...
type NullableActionTypeListIntentResponse struct {
	value *ActionTypeListIntentResponse
	isSet bool
}

func (v NullableActionTypeListIntentResponse) Get() *ActionTypeListIntentResponse {
	return v.value
}

func (v *NullableActionTypeListIntentResponse) Set(val *ActionTypeListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTypeListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTypeListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTypeListIntentResponse(val *ActionTypeListIntentResponse) *NullableActionTypeListIntentResponse {
	return &NullableActionTypeListIntentResponse{value: val, isSet: true}
}

func (v NullableActionTypeListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTypeListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
