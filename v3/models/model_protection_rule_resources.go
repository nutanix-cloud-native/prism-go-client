...
// checks if the ProtectionRuleResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleResources{}

// ProtectionRuleResources Protection rule encodes the overall topology of all the availability zones where the entity is replicated to. This encoding allows the system to figure out where the entity should be running in the case of one or more availability zone failures. 
type ProtectionRuleResources struct {
	...
	AvailabilityZoneConnectivityList []ProtectionRuleResourcesAvailabilityZoneConnectivityListInner `json:"availability_zone_connectivity_list"`
	...
	OrderedAvailabilityZoneList []ProtectionRuleResourcesOrderedAvailabilityZoneListInner `json:"ordered_availability_zone_list"`
	...
	PrimaryLocationList []int32 `json:"primary_location_list,omitempty"`
	CategoryFilter *CategoryFilter `json:"category_filter,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ProtectionRuleResources ProtectionRuleResources
...
func NewProtectionRuleResources(availabilityZoneConnectivityList []ProtectionRuleResourcesAvailabilityZoneConnectivityListInner, orderedAvailabilityZoneList []ProtectionRuleResourcesOrderedAvailabilityZoneListInner) *ProtectionRuleResources {
	this := ProtectionRuleResources{}
	this.AvailabilityZoneConnectivityList = availabilityZoneConnectivityList
	this.OrderedAvailabilityZoneList = orderedAvailabilityZoneList
	return &this
}
...
// GetAvailabilityZoneConnectivityList returns the AvailabilityZoneConnectivityList field value
func (o *ProtectionRuleResources) GetAvailabilityZoneConnectivityList() []ProtectionRuleResourcesAvailabilityZoneConnectivityListInner {
	if o == nil {
		var ret []ProtectionRuleResourcesAvailabilityZoneConnectivityListInner
		return ret
	}

	return o.AvailabilityZoneConnectivityList
}

// GetAvailabilityZoneConnectivityListOk returns a tuple with the AvailabilityZoneConnectivityList field value
// and a boolean to check if the value has been set.
func (o *ProtectionRuleResources) GetAvailabilityZoneConnectivityListOk() ([]ProtectionRuleResourcesAvailabilityZoneConnectivityListInner, bool) {
	...
	return o.AvailabilityZoneConnectivityList, true
}

// SetAvailabilityZoneConnectivityList sets field value
func (o *ProtectionRuleResources) SetAvailabilityZoneConnectivityList(v []ProtectionRuleResourcesAvailabilityZoneConnectivityListInner) {
	o.AvailabilityZoneConnectivityList = v
}

// GetOrderedAvailabilityZoneList returns the OrderedAvailabilityZoneList field value
func (o *ProtectionRuleResources) GetOrderedAvailabilityZoneList() []ProtectionRuleResourcesOrderedAvailabilityZoneListInner {
	if o == nil {
		var ret []ProtectionRuleResourcesOrderedAvailabilityZoneListInner
		return ret
	}

	return o.OrderedAvailabilityZoneList
}

// GetOrderedAvailabilityZoneListOk returns a tuple with the OrderedAvailabilityZoneList field value
// and a boolean to check if the value has been set.
func (o *ProtectionRuleResources) GetOrderedAvailabilityZoneListOk() ([]ProtectionRuleResourcesOrderedAvailabilityZoneListInner, bool) {
	...
	return o.OrderedAvailabilityZoneList, true
}

// SetOrderedAvailabilityZoneList sets field value
func (o *ProtectionRuleResources) SetOrderedAvailabilityZoneList(v []ProtectionRuleResourcesOrderedAvailabilityZoneListInner) {
	o.OrderedAvailabilityZoneList = v
}

// GetPrimaryLocationList returns the PrimaryLocationList field value if set, zero value otherwise.
func (o *ProtectionRuleResources) GetPrimaryLocationList() []int32 {
	if o == nil || IsNil(o.PrimaryLocationList) {
		var ret []int32
		return ret
	}
	return o.PrimaryLocationList
}

// GetPrimaryLocationListOk returns a tuple with the PrimaryLocationList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProtectionRuleResources) GetPrimaryLocationListOk() ([]int32, bool) {
	if o == nil || IsNil(o.PrimaryLocationList) {
		return nil, false
	}
	return o.PrimaryLocationList, true
}
...
// SetPrimaryLocationList gets a reference to the given []int32 and assigns it to the PrimaryLocationList field.
func (o *ProtectionRuleResources) SetPrimaryLocationList(v []int32) {
	o.PrimaryLocationList = v
}

// GetCategoryFilter returns the CategoryFilter field value if set, zero value otherwise.
func (o *ProtectionRuleResources) GetCategoryFilter() CategoryFilter {
	if o == nil || IsNil(o.CategoryFilter) {
		var ret CategoryFilter
		return ret
	}
	return *o.CategoryFilter
}

// GetCategoryFilterOk returns a tuple with the CategoryFilter field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProtectionRuleResources) GetCategoryFilterOk() (*CategoryFilter, bool) {
	if o == nil || IsNil(o.CategoryFilter) {
		return nil, false
	}
	return o.CategoryFilter, true
}
...
// SetCategoryFilter gets a reference to the given CategoryFilter and assigns it to the CategoryFilter field.
func (o *ProtectionRuleResources) SetCategoryFilter(v CategoryFilter) {
	o.CategoryFilter = &v
}

func (o ProtectionRuleResources) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.StartTime) {
		toSerialize["start_time"] = o.StartTime
	}
	toSerialize["availability_zone_connectivity_list"] = o.AvailabilityZoneConnectivityList
	toSerialize["ordered_availability_zone_list"] = o.OrderedAvailabilityZoneList
	if !IsNil(o.PrimaryLocationList) {
		toSerialize["primary_location_list"] = o.PrimaryLocationList
	}
	if !IsNil(o.CategoryFilter) {
		toSerialize["category_filter"] = o.CategoryFilter
	}
...
func (o *ProtectionRuleResources) UnmarshalJSON(data []byte) (err error) {
	...
	varProtectionRuleResources := _ProtectionRuleResources{}

	err = json.Unmarshal(data, &varProtectionRuleResources)

	if err != nil {
		return err
	}

	*o = ProtectionRuleResources(varProtectionRuleResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "start_time")
		delete(additionalProperties, "availability_zone_connectivity_list")
		delete(additionalProperties, "ordered_availability_zone_list")
		delete(additionalProperties, "primary_location_list")
		delete(additionalProperties, "category_filter")
...
type NullableProtectionRuleResources struct {
	value *ProtectionRuleResources
	isSet bool
}

func (v NullableProtectionRuleResources) Get() *ProtectionRuleResources {
	return v.value
}

func (v *NullableProtectionRuleResources) Set(val *ProtectionRuleResources) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleResources) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleResources(val *ProtectionRuleResources) *NullableProtectionRuleResources {
	return &NullableProtectionRuleResources{value: val, isSet: true}
}

func (v NullableProtectionRuleResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
