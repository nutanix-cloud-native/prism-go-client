...
type PoolStats struct {
	...
	Range *string `json:"range,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)[ ](?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
...
// GetNumTotalIps returns the NumTotalIps field value if set, zero value otherwise.
func (o *PoolStats) GetNumTotalIps() int32 {
	if o == nil || IsNil(o.NumTotalIps) {
		var ret int32
		return ret
	}
	return *o.NumTotalIps
}

// GetNumTotalIpsOk returns a tuple with the NumTotalIps field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PoolStats) GetNumTotalIpsOk() (*int32, bool) {
	if o == nil || IsNil(o.NumTotalIps) {
		return nil, false
	}
	return o.NumTotalIps, true
}
...
// SetNumTotalIps gets a reference to the given int32 and assigns it to the NumTotalIps field.
...
func (o PoolStats) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NumTotalIps) {
		toSerialize["num_total_ips"] = o.NumTotalIps
	}
	if !IsNil(o.Range) {
...
func (o *PoolStats) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPoolStats)
	...
	*o = PoolStats(varPoolStats)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "num_total_ips")
