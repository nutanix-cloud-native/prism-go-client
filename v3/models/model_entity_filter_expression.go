...
// checks if the EntityFilterExpression type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntityFilterExpression{}

// EntityFilterExpression Entity Filter Expression is a combination of LHS-Operator-RHS. This filter expression helps express the Filter on actual entities. Example1 - To express All VMs   left_hand_side = VM   operator = IN   right_hand_side = ALL Example2 - To express Not VM1 or VM2   left_hand_side =  VM   operator = NOT_IN   right_hand_side = [\"VM1\", \"VM2\"] 
type EntityFilterExpression struct {
	// The operator in the filter expression.
	Operator string `json:"operator"`
	RightHandSide RightHandSide `json:"right_hand_side"`
	LeftHandSide EntityFilterExpressionLeftHandSide `json:"left_hand_side"`
	AdditionalProperties map[string]interface{}
}

type _EntityFilterExpression EntityFilterExpression
...
func (o *EntityFilterExpression) GetLeftHandSide() EntityFilterExpressionLeftHandSide {
	if o == nil {
		var ret EntityFilterExpressionLeftHandSide
		return ret
	}
...
func (o EntityFilterExpression) MarshalJSON() ([]byte, error) {
...
func (o EntityFilterExpression) ToMap() (map[string]interface{}, error) {
...
func (o *EntityFilterExpression) UnmarshalJSON(data []byte) (err error) {
	...
	varEntityFilterExpression := _EntityFilterExpression{}

	err = json.Unmarshal(data, &varEntityFilterExpression)

	if err != nil {
		return err
	}

	*o = EntityFilterExpression(varEntityFilterExpression)
...
type NullableEntityFilterExpression struct {
	value *EntityFilterExpression
	isSet bool
}

func (v NullableEntityFilterExpression) Get() *EntityFilterExpression {
	return v.value
}

func (v *NullableEntityFilterExpression) Set(val *EntityFilterExpression) {
	v.value = val
	v.isSet = true
}

func (v NullableEntityFilterExpression) IsSet() bool {
	return v.isSet
}

func (v *NullableEntityFilterExpression) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntityFilterExpression(val *EntityFilterExpression) *NullableEntityFilterExpression {
	return &NullableEntityFilterExpression{value: val, isSet: true}
}

func (v NullableEntityFilterExpression) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntityFilterExpression) UnmarshalJSON(src []byte) error {
	v.isSet = true
