...
// checks if the AwsVpcListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVpcListMetadataOutput{}

// AwsVpcListMetadataOutput All api calls that return a list will have this metadata block 
type AwsVpcListMetadataOutput struct {
	// The kind name
...
type _AwsVpcListMetadataOutput AwsVpcListMetadataOutput
...
func NewAwsVpcListMetadataOutput() *AwsVpcListMetadataOutput {
	this := AwsVpcListMetadataOutput{}
	var kind string = "aws_vpc"
	this.Kind = &kind
	return &this
}
...
func (o AwsVpcListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsVpcListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVpcListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsVpcListMetadataOutput := _AwsVpcListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsVpcListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsVpcListMetadataOutput(varAwsVpcListMetadataOutput)
...
type NullableAwsVpcListMetadataOutput struct {
	value *AwsVpcListMetadataOutput
	isSet bool
}

func (v NullableAwsVpcListMetadataOutput) Get() *AwsVpcListMetadataOutput {
	return v.value
}

func (v *NullableAwsVpcListMetadataOutput) Set(val *AwsVpcListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVpcListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVpcListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVpcListMetadataOutput(val *AwsVpcListMetadataOutput) *NullableAwsVpcListMetadataOutput {
	return &NullableAwsVpcListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsVpcListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVpcListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
