...
// checks if the RemoteConnectionIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionIntentInput{}

// RemoteConnectionIntentInput An intentful representation of a remote_connection
type RemoteConnectionIntentInput struct {
	Spec RemoteConnection `json:"spec"`
...
type _RemoteConnectionIntentInput RemoteConnectionIntentInput
...
func NewRemoteConnectionIntentInput(spec RemoteConnection, metadata RemoteConnectionMetadata) *RemoteConnectionIntentInput {
	this := RemoteConnectionIntentInput{}
	this.Spec = spec
...
func (o RemoteConnectionIntentInput) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteConnectionIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteConnectionIntentInput := _RemoteConnectionIntentInput{}

	err = json.Unmarshal(data, &varRemoteConnectionIntentInput)

	if err != nil {
		return err
	}

	*o = RemoteConnectionIntentInput(varRemoteConnectionIntentInput)
...
type NullableRemoteConnectionIntentInput struct {
	value *RemoteConnectionIntentInput
	isSet bool
}

func (v NullableRemoteConnectionIntentInput) Get() *RemoteConnectionIntentInput {
	return v.value
}

func (v *NullableRemoteConnectionIntentInput) Set(val *RemoteConnectionIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionIntentInput(val *RemoteConnectionIntentInput) *NullableRemoteConnectionIntentInput {
	return &NullableRemoteConnectionIntentInput{value: val, isSet: true}
}

func (v NullableRemoteConnectionIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
