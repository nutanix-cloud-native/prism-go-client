...
// checks if the VpnConnection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnection{}

// VpnConnection An intentful representation of a vpn_connection spec
type VpnConnection struct {
	...
	Resources VpnConnectionResources `json:"resources"`
	// vpn_connection Name.
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _VpnConnection VpnConnection
...
func (o *VpnConnection) GetResources() VpnConnectionResources {
	if o == nil {
		var ret VpnConnectionResources
		return ret
	}
...
func (o VpnConnection) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnection) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnConnection := _VpnConnection{}

	err = json.Unmarshal(data, &varVpnConnection)

	if err != nil {
		return err
	}

	*o = VpnConnection(varVpnConnection)
