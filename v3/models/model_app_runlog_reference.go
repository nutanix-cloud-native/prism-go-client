...
// checks if the AppRunlogReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunlogReference{}

// AppRunlogReference The reference to a app_runlog
type AppRunlogReference struct {
	// The kind name
...
type _AppRunlogReference AppRunlogReference
...
func (o AppRunlogReference) MarshalJSON() ([]byte, error) {
...
func (o AppRunlogReference) ToMap() (map[string]interface{}, error) {
...
func (o *AppRunlogReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRunlogReference := _AppRunlogReference{}

	err = json.Unmarshal(data, &varAppRunlogReference)

	if err != nil {
		return err
	}

	*o = AppRunlogReference(varAppRunlogReference)
...
type NullableAppRunlogReference struct {
	value *AppRunlogReference
	isSet bool
}

func (v NullableAppRunlogReference) Get() *AppRunlogReference {
	return v.value
}

func (v *NullableAppRunlogReference) Set(val *AppRunlogReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunlogReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunlogReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunlogReference(val *AppRunlogReference) *NullableAppRunlogReference {
	return &NullableAppRunlogReference{value: val, isSet: true}
}

func (v NullableAppRunlogReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunlogReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
