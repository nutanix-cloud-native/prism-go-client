...
// checks if the IdentityProviderListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityProviderListMetadata{}

// IdentityProviderListMetadata All api calls that return a list will have this metadata block as input 
type IdentityProviderListMetadata struct {
	// The kind name
...
type _IdentityProviderListMetadata IdentityProviderListMetadata
...
func NewIdentityProviderListMetadata() *IdentityProviderListMetadata {
	this := IdentityProviderListMetadata{}
...
func (o IdentityProviderListMetadata) MarshalJSON() ([]byte, error) {
...
func (o IdentityProviderListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *IdentityProviderListMetadata) UnmarshalJSON(data []byte) (err error) {
	varIdentityProviderListMetadata := _IdentityProviderListMetadata{}

	err = json.Unmarshal(data, &varIdentityProviderListMetadata)

	if err != nil {
		return err
	}

	*o = IdentityProviderListMetadata(varIdentityProviderListMetadata)
...
type NullableIdentityProviderListMetadata struct {
	value *IdentityProviderListMetadata
	isSet bool
}

func (v NullableIdentityProviderListMetadata) Get() *IdentityProviderListMetadata {
	return v.value
}

func (v *NullableIdentityProviderListMetadata) Set(val *IdentityProviderListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityProviderListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityProviderListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityProviderListMetadata(val *IdentityProviderListMetadata) *NullableIdentityProviderListMetadata {
	return &NullableIdentityProviderListMetadata{value: val, isSet: true}
}

func (v NullableIdentityProviderListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityProviderListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
