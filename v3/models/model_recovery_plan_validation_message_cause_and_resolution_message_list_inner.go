...
// checks if the RecoveryPlanValidationMessageCauseAndResolutionMessageListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanValidationMessageCauseAndResolutionMessageListInner{}

// RecoveryPlanValidationMessageCauseAndResolutionMessageListInner struct for RecoveryPlanValidationMessageCauseAndResolutionMessageListInner
type RecoveryPlanValidationMessageCauseAndResolutionMessageListInner struct {
	// Steps to resolve the warning or error.
	ResolutionList []string `json:"resolution_list,omitempty"`
	// Cause of the validation warning or error.
	Cause string `json:"cause"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanValidationMessageCauseAndResolutionMessageListInner RecoveryPlanValidationMessageCauseAndResolutionMessageListInner
...
func NewRecoveryPlanValidationMessageCauseAndResolutionMessageListInner(cause string) *RecoveryPlanValidationMessageCauseAndResolutionMessageListInner {
	this := RecoveryPlanValidationMessageCauseAndResolutionMessageListInner{}
	this.Cause = cause
	return &this
}
...
// GetResolutionList returns the ResolutionList field value if set, zero value otherwise.
func (o *RecoveryPlanValidationMessageCauseAndResolutionMessageListInner) GetResolutionList() []string {
	if o == nil || IsNil(o.ResolutionList) {
		var ret []string
		return ret
	}
	return o.ResolutionList
}

// GetResolutionListOk returns a tuple with the ResolutionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanValidationMessageCauseAndResolutionMessageListInner) GetResolutionListOk() ([]string, bool) {
	if o == nil || IsNil(o.ResolutionList) {
		return nil, false
	}
	return o.ResolutionList, true
}
...
// SetResolutionList gets a reference to the given []string and assigns it to the ResolutionList field.
...
func (o RecoveryPlanValidationMessageCauseAndResolutionMessageListInner) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanValidationMessageCauseAndResolutionMessageListInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ResolutionList) {
		toSerialize["resolution_list"] = o.ResolutionList
	}
...
func (o *RecoveryPlanValidationMessageCauseAndResolutionMessageListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanValidationMessageCauseAndResolutionMessageListInner := _RecoveryPlanValidationMessageCauseAndResolutionMessageListInner{}

	err = json.Unmarshal(data, &varRecoveryPlanValidationMessageCauseAndResolutionMessageListInner)

	if err != nil {
		return err
	}

	*o = RecoveryPlanValidationMessageCauseAndResolutionMessageListInner(varRecoveryPlanValidationMessageCauseAndResolutionMessageListInner)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "resolution_list")
...
type NullableRecoveryPlanValidationMessageCauseAndResolutionMessageListInner struct {
	value *RecoveryPlanValidationMessageCauseAndResolutionMessageListInner
	isSet bool
}

func (v NullableRecoveryPlanValidationMessageCauseAndResolutionMessageListInner) Get() *RecoveryPlanValidationMessageCauseAndResolutionMessageListInner {
	return v.value
}

func (v *NullableRecoveryPlanValidationMessageCauseAndResolutionMessageListInner) Set(val *RecoveryPlanValidationMessageCauseAndResolutionMessageListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanValidationMessageCauseAndResolutionMessageListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanValidationMessageCauseAndResolutionMessageListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanValidationMessageCauseAndResolutionMessageListInner(val *RecoveryPlanValidationMessageCauseAndResolutionMessageListInner) *NullableRecoveryPlanValidationMessageCauseAndResolutionMessageListInner {
	return &NullableRecoveryPlanValidationMessageCauseAndResolutionMessageListInner{value: val, isSet: true}
}

func (v NullableRecoveryPlanValidationMessageCauseAndResolutionMessageListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanValidationMessageCauseAndResolutionMessageListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
