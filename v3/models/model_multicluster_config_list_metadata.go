...
// checks if the MulticlusterConfigListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MulticlusterConfigListMetadata{}

// MulticlusterConfigListMetadata All api calls that return a list will have this metadata block as input 
type MulticlusterConfigListMetadata struct {
	// The kind name
...
type _MulticlusterConfigListMetadata MulticlusterConfigListMetadata
...
func NewMulticlusterConfigListMetadata() *MulticlusterConfigListMetadata {
	this := MulticlusterConfigListMetadata{}
...
func (o MulticlusterConfigListMetadata) MarshalJSON() ([]byte, error) {
...
func (o MulticlusterConfigListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *MulticlusterConfigListMetadata) UnmarshalJSON(data []byte) (err error) {
	varMulticlusterConfigListMetadata := _MulticlusterConfigListMetadata{}

	err = json.Unmarshal(data, &varMulticlusterConfigListMetadata)

	if err != nil {
		return err
	}

	*o = MulticlusterConfigListMetadata(varMulticlusterConfigListMetadata)
...
type NullableMulticlusterConfigListMetadata struct {
	value *MulticlusterConfigListMetadata
	isSet bool
}

func (v NullableMulticlusterConfigListMetadata) Get() *MulticlusterConfigListMetadata {
	return v.value
}

func (v *NullableMulticlusterConfigListMetadata) Set(val *MulticlusterConfigListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableMulticlusterConfigListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableMulticlusterConfigListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMulticlusterConfigListMetadata(val *MulticlusterConfigListMetadata) *NullableMulticlusterConfigListMetadata {
	return &NullableMulticlusterConfigListMetadata{value: val, isSet: true}
}

func (v NullableMulticlusterConfigListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMulticlusterConfigListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
