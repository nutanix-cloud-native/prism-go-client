...
// checks if the RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner{}

// RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner struct for RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner
type RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner struct {
...
type _RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner
...
func NewRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner(volumeGroupReference VolumeGroupReference) *RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner {
	this := RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner{}
...
func (o RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner := _RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner{}

	err = json.Unmarshal(data, &varRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner)

	if err != nil {
		return err
	}

	*o = RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner(varRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner)
...
type NullableRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner struct {
	value *RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner
	isSet bool
}

func (v NullableRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner) Get() *RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner {
	return v.value
}

func (v *NullableRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner) Set(val *RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner(val *RecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner) *NullableRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner {
	return &NullableRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner{value: val, isSet: true}
}

func (v NullableRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanVolumeGroupRecoveryInfoVolumeGroupConfigInfoListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
