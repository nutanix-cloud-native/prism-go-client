...
// checks if the VpnGatewayDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayDefStatus{}

// VpnGatewayDefStatus An intentful representation of a vpn_gateway status
type VpnGatewayDefStatus struct {
	// vpn_gateway Name.
	Name string `json:"name"`
	// The state of the vpn_gateway.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the vpn_gateway, if in an error state.
	...
	Resources VpnGatewayResourcesDefStatus `json:"resources"`
	// A description for vpn_gateway.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VpnGatewayDefStatus VpnGatewayDefStatus
...
func (o *VpnGatewayDefStatus) GetResources() VpnGatewayResourcesDefStatus {
	if o == nil {
		var ret VpnGatewayResourcesDefStatus
		return ret
	}
...
func (o VpnGatewayDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VpnGatewayDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnGatewayDefStatus := _VpnGatewayDefStatus{}

	err = json.Unmarshal(data, &varVpnGatewayDefStatus)

	if err != nil {
		return err
	}

	*o = VpnGatewayDefStatus(varVpnGatewayDefStatus)
...
type NullableVpnGatewayDefStatus struct {
	value *VpnGatewayDefStatus
	isSet bool
}

func (v NullableVpnGatewayDefStatus) Get() *VpnGatewayDefStatus {
	return v.value
}

func (v *NullableVpnGatewayDefStatus) Set(val *VpnGatewayDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayDefStatus(val *VpnGatewayDefStatus) *NullableVpnGatewayDefStatus {
	return &NullableVpnGatewayDefStatus{value: val, isSet: true}
}

func (v NullableVpnGatewayDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
