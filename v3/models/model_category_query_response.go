...
// checks if the CategoryQueryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryQueryResponse{}

// CategoryQueryResponse Categories query response object.
type CategoryQueryResponse struct {
	Results []CategoryQueryResponseResultsInner `json:"results,omitempty"`
...
type _CategoryQueryResponse CategoryQueryResponse
...
func (o *CategoryQueryResponse) GetResults() []CategoryQueryResponseResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []CategoryQueryResponseResultsInner
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []CategoryQueryResponseResultsInner and assigns it to the Results field.
...
func (o *CategoryQueryResponse) GetMetadata() CategoryQueryResponseMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret CategoryQueryResponseMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given CategoryQueryResponseMetadata and assigns it to the Metadata field.
func (o *CategoryQueryResponse) SetMetadata(v CategoryQueryResponseMetadata) {
	o.Metadata = &v
}

func (o CategoryQueryResponse) MarshalJSON() ([]byte, error) {
...
func (o CategoryQueryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryQueryResponse) UnmarshalJSON(data []byte) (err error) {
	varCategoryQueryResponse := _CategoryQueryResponse{}

	err = json.Unmarshal(data, &varCategoryQueryResponse)

	if err != nil {
		return err
	}

	*o = CategoryQueryResponse(varCategoryQueryResponse)
...
type NullableCategoryQueryResponse struct {
	value *CategoryQueryResponse
	isSet bool
}

func (v NullableCategoryQueryResponse) Get() *CategoryQueryResponse {
	return v.value
}

func (v *NullableCategoryQueryResponse) Set(val *CategoryQueryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryQueryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryQueryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryQueryResponse(val *CategoryQueryResponse) *NullableCategoryQueryResponse {
	return &NullableCategoryQueryResponse{value: val, isSet: true}
}

func (v NullableCategoryQueryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryQueryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
