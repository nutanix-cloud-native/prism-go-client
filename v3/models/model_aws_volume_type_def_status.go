...
// checks if the AwsVolumeTypeDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVolumeTypeDefStatus{}

// AwsVolumeTypeDefStatus aws_volume_type resources status
type AwsVolumeTypeDefStatus struct {
	State *string `json:"state,omitempty"`
	// aws_volume_type name.
	Name *string `json:"name,omitempty"`
	Resources *AwsVolumeTypeResourcesDefStatus `json:"resources,omitempty"`
	// A description for aws_volume_type.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsVolumeTypeDefStatus AwsVolumeTypeDefStatus
...
func (o *AwsVolumeTypeDefStatus) GetResources() AwsVolumeTypeResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret AwsVolumeTypeResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given AwsVolumeTypeResourcesDefStatus and assigns it to the Resources field.
...
func (o AwsVolumeTypeDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsVolumeTypeDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVolumeTypeDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsVolumeTypeDefStatus := _AwsVolumeTypeDefStatus{}

	err = json.Unmarshal(data, &varAwsVolumeTypeDefStatus)

	if err != nil {
		return err
	}

	*o = AwsVolumeTypeDefStatus(varAwsVolumeTypeDefStatus)
...
type NullableAwsVolumeTypeDefStatus struct {
	value *AwsVolumeTypeDefStatus
	isSet bool
}

func (v NullableAwsVolumeTypeDefStatus) Get() *AwsVolumeTypeDefStatus {
	return v.value
}

func (v *NullableAwsVolumeTypeDefStatus) Set(val *AwsVolumeTypeDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVolumeTypeDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVolumeTypeDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVolumeTypeDefStatus(val *AwsVolumeTypeDefStatus) *NullableAwsVolumeTypeDefStatus {
	return &NullableAwsVolumeTypeDefStatus{value: val, isSet: true}
}

func (v NullableAwsVolumeTypeDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVolumeTypeDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
