...
// checks if the DatacenterListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterListMetadata{}

// DatacenterListMetadata All api calls that return a list will have this metadata block as input 
type DatacenterListMetadata struct {
	// The kind name
...
type _DatacenterListMetadata DatacenterListMetadata
...
func (o DatacenterListMetadata) MarshalJSON() ([]byte, error) {
...
func (o DatacenterListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *DatacenterListMetadata) UnmarshalJSON(data []byte) (err error) {
	varDatacenterListMetadata := _DatacenterListMetadata{}

	err = json.Unmarshal(data, &varDatacenterListMetadata)

	if err != nil {
		return err
	}

	*o = DatacenterListMetadata(varDatacenterListMetadata)
...
type NullableDatacenterListMetadata struct {
	value *DatacenterListMetadata
	isSet bool
}

func (v NullableDatacenterListMetadata) Get() *DatacenterListMetadata {
	return v.value
}

func (v *NullableDatacenterListMetadata) Set(val *DatacenterListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterListMetadata(val *DatacenterListMetadata) *NullableDatacenterListMetadata {
	return &NullableDatacenterListMetadata{value: val, isSet: true}
}

func (v NullableDatacenterListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
