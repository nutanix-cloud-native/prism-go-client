...
// checks if the AwsAvailabilityZoneResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsAvailabilityZoneResourcesDefStatus{}

// AwsAvailabilityZoneResourcesDefStatus aws_availability_zone resources
type AwsAvailabilityZoneResourcesDefStatus struct {
	// Name of the region the zone belongs to.
...
type _AwsAvailabilityZoneResourcesDefStatus AwsAvailabilityZoneResourcesDefStatus
...
func NewAwsAvailabilityZoneResourcesDefStatus() *AwsAvailabilityZoneResourcesDefStatus {
	this := AwsAvailabilityZoneResourcesDefStatus{}
	return &this
}
...
func (o AwsAvailabilityZoneResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsAvailabilityZoneResourcesDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsAvailabilityZoneResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsAvailabilityZoneResourcesDefStatus := _AwsAvailabilityZoneResourcesDefStatus{}

	err = json.Unmarshal(data, &varAwsAvailabilityZoneResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = AwsAvailabilityZoneResourcesDefStatus(varAwsAvailabilityZoneResourcesDefStatus)
...
type NullableAwsAvailabilityZoneResourcesDefStatus struct {
	value *AwsAvailabilityZoneResourcesDefStatus
	isSet bool
}

func (v NullableAwsAvailabilityZoneResourcesDefStatus) Get() *AwsAvailabilityZoneResourcesDefStatus {
	return v.value
}

func (v *NullableAwsAvailabilityZoneResourcesDefStatus) Set(val *AwsAvailabilityZoneResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsAvailabilityZoneResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsAvailabilityZoneResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsAvailabilityZoneResourcesDefStatus(val *AwsAvailabilityZoneResourcesDefStatus) *NullableAwsAvailabilityZoneResourcesDefStatus {
	return &NullableAwsAvailabilityZoneResourcesDefStatus{value: val, isSet: true}
}

func (v NullableAwsAvailabilityZoneResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsAvailabilityZoneResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
