...
// checks if the AddressGroupReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressGroupReference{}

// AddressGroupReference The reference to a address_group
...
type _AddressGroupReference AddressGroupReference
...
func (o AddressGroupReference) MarshalJSON() ([]byte, error) {
...
func (o AddressGroupReference) ToMap() (map[string]interface{}, error) {
...
func (o *AddressGroupReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAddressGroupReference := _AddressGroupReference{}

	err = json.Unmarshal(data, &varAddressGroupReference)

	if err != nil {
		return err
	}

	*o = AddressGroupReference(varAddressGroupReference)
...
type NullableAddressGroupReference struct {
	value *AddressGroupReference
	isSet bool
}

func (v NullableAddressGroupReference) Get() *AddressGroupReference {
	return v.value
}

func (v *NullableAddressGroupReference) Set(val *AddressGroupReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressGroupReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressGroupReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressGroupReference(val *AddressGroupReference) *NullableAddressGroupReference {
	return &NullableAddressGroupReference{value: val, isSet: true}
}

func (v NullableAddressGroupReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressGroupReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
