...
// checks if the ProjectInternalIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectInternalIntentInput{}

// ProjectInternalIntentInput An intentful representation of a Project
type ProjectInternalIntentInput struct {
	Spec ProjectInternal `json:"spec"`
...
type _ProjectInternalIntentInput ProjectInternalIntentInput
...
func NewProjectInternalIntentInput(spec ProjectInternal, apiVersion string, metadata ProjectMetadata) *ProjectInternalIntentInput {
	this := ProjectInternalIntentInput{}
	this.Spec = spec
...
func (o ProjectInternalIntentInput) MarshalJSON() ([]byte, error) {
...
func (o ProjectInternalIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectInternalIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectInternalIntentInput := _ProjectInternalIntentInput{}

	err = json.Unmarshal(data, &varProjectInternalIntentInput)

	if err != nil {
		return err
	}

	*o = ProjectInternalIntentInput(varProjectInternalIntentInput)
...
type NullableProjectInternalIntentInput struct {
	value *ProjectInternalIntentInput
	isSet bool
}

func (v NullableProjectInternalIntentInput) Get() *ProjectInternalIntentInput {
	return v.value
}

func (v *NullableProjectInternalIntentInput) Set(val *ProjectInternalIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectInternalIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectInternalIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectInternalIntentInput(val *ProjectInternalIntentInput) *NullableProjectInternalIntentInput {
	return &NullableProjectInternalIntentInput{value: val, isSet: true}
}

func (v NullableProjectInternalIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectInternalIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
