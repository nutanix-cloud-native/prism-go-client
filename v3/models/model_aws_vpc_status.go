...
// checks if the AwsVpcStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVpcStatus{}

// AwsVpcStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _AwsVpcStatus AwsVpcStatus
...
func (o AwsVpcStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsVpcStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVpcStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsVpcStatus := _AwsVpcStatus{}

	err = json.Unmarshal(data, &varAwsVpcStatus)

	if err != nil {
		return err
	}

	*o = AwsVpcStatus(varAwsVpcStatus)
...
type NullableAwsVpcStatus struct {
	value *AwsVpcStatus
	isSet bool
}

func (v NullableAwsVpcStatus) Get() *AwsVpcStatus {
	return v.value
}

func (v *NullableAwsVpcStatus) Set(val *AwsVpcStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVpcStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVpcStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVpcStatus(val *AwsVpcStatus) *NullableAwsVpcStatus {
	return &NullableAwsVpcStatus{value: val, isSet: true}
}

func (v NullableAwsVpcStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVpcStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
