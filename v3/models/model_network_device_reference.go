...
// checks if the NetworkDeviceReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDeviceReference{}

// NetworkDeviceReference The reference to a network_device
type NetworkDeviceReference struct {
	// The kind name
...
type _NetworkDeviceReference NetworkDeviceReference
...
func (o NetworkDeviceReference) MarshalJSON() ([]byte, error) {
...
func (o NetworkDeviceReference) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkDeviceReference) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkDeviceReference := _NetworkDeviceReference{}

	err = json.Unmarshal(data, &varNetworkDeviceReference)

	if err != nil {
		return err
	}

	*o = NetworkDeviceReference(varNetworkDeviceReference)
...
type NullableNetworkDeviceReference struct {
	value *NetworkDeviceReference
	isSet bool
}

func (v NullableNetworkDeviceReference) Get() *NetworkDeviceReference {
	return v.value
}

func (v *NullableNetworkDeviceReference) Set(val *NetworkDeviceReference) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDeviceReference) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDeviceReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDeviceReference(val *NetworkDeviceReference) *NullableNetworkDeviceReference {
	return &NullableNetworkDeviceReference{value: val, isSet: true}
}

func (v NullableNetworkDeviceReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDeviceReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
