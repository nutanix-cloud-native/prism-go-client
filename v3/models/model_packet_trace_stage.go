...
// checks if the PacketTraceStage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PacketTraceStage{}

// PacketTraceStage Details of the pipeline stage that dropped/forwarded the packet
type PacketTraceStage struct {
	Action *string `json:"action,omitempty"`
	RoutingPolicyReference *RoutingPolicyReference `json:"routing_policy_reference,omitempty"`
	DestinationIp *string `json:"destination_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// Indicates if the packet was forwarded to a Xi VM, Internet or other data center 
	DestinationType *string `json:"destination_type,omitempty"`
	Stage *string `json:"stage,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PacketTraceStage PacketTraceStage
...
// GetRoutingPolicyReference returns the RoutingPolicyReference field value if set, zero value otherwise.
func (o *PacketTraceStage) GetRoutingPolicyReference() RoutingPolicyReference {
	if o == nil || IsNil(o.RoutingPolicyReference) {
		var ret RoutingPolicyReference
		return ret
	}
	return *o.RoutingPolicyReference
}

// GetRoutingPolicyReferenceOk returns a tuple with the RoutingPolicyReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PacketTraceStage) GetRoutingPolicyReferenceOk() (*RoutingPolicyReference, bool) {
	if o == nil || IsNil(o.RoutingPolicyReference) {
		return nil, false
	}
	return o.RoutingPolicyReference, true
}
...
// SetRoutingPolicyReference gets a reference to the given RoutingPolicyReference and assigns it to the RoutingPolicyReference field.
func (o *PacketTraceStage) SetRoutingPolicyReference(v RoutingPolicyReference) {
	o.RoutingPolicyReference = &v
}
...
func (o PacketTraceStage) MarshalJSON() ([]byte, error) {
...
func (o PacketTraceStage) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Action) {
		toSerialize["action"] = o.Action
	}
	if !IsNil(o.RoutingPolicyReference) {
		toSerialize["routing_policy_reference"] = o.RoutingPolicyReference
	}
...
func (o *PacketTraceStage) UnmarshalJSON(data []byte) (err error) {
	varPacketTraceStage := _PacketTraceStage{}

	err = json.Unmarshal(data, &varPacketTraceStage)

	if err != nil {
		return err
	}

	*o = PacketTraceStage(varPacketTraceStage)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "action")
		delete(additionalProperties, "routing_policy_reference")
...
type NullablePacketTraceStage struct {
	value *PacketTraceStage
	isSet bool
}

func (v NullablePacketTraceStage) Get() *PacketTraceStage {
	return v.value
}

func (v *NullablePacketTraceStage) Set(val *PacketTraceStage) {
	v.value = val
	v.isSet = true
}

func (v NullablePacketTraceStage) IsSet() bool {
	return v.isSet
}

func (v *NullablePacketTraceStage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePacketTraceStage(val *PacketTraceStage) *NullablePacketTraceStage {
	return &NullablePacketTraceStage{value: val, isSet: true}
}

func (v NullablePacketTraceStage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePacketTraceStage) UnmarshalJSON(src []byte) error {
	v.isSet = true
