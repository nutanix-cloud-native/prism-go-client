...
// checks if the ProjectInternalUserListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectInternalUserListInner{}

// ProjectInternalUserListInner The details of the user such as principal name and directory_reference. Also contains metadata. 
type ProjectInternalUserListInner struct {
...
type _ProjectInternalUserListInner ProjectInternalUserListInner
...
func NewProjectInternalUserListInner(operation string, user User, metadata ProjectInternalAccessControlPolicyListInnerMetadata) *ProjectInternalUserListInner {
	this := ProjectInternalUserListInner{}
...
func (o ProjectInternalUserListInner) MarshalJSON() ([]byte, error) {
...
func (o ProjectInternalUserListInner) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectInternalUserListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectInternalUserListInner := _ProjectInternalUserListInner{}

	err = json.Unmarshal(data, &varProjectInternalUserListInner)

	if err != nil {
		return err
	}

	*o = ProjectInternalUserListInner(varProjectInternalUserListInner)
...
type NullableProjectInternalUserListInner struct {
	value *ProjectInternalUserListInner
	isSet bool
}

func (v NullableProjectInternalUserListInner) Get() *ProjectInternalUserListInner {
	return v.value
}

func (v *NullableProjectInternalUserListInner) Set(val *ProjectInternalUserListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectInternalUserListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectInternalUserListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectInternalUserListInner(val *ProjectInternalUserListInner) *NullableProjectInternalUserListInner {
	return &NullableProjectInternalUserListInner{value: val, isSet: true}
}

func (v NullableProjectInternalUserListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectInternalUserListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
