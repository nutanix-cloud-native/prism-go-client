...
// checks if the BlueprintUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintUpload{}

// BlueprintUpload App blueprint upload kind
...
type _BlueprintUpload BlueprintUpload
...
func (o BlueprintUpload) MarshalJSON() ([]byte, error) {
...
func (o BlueprintUpload) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintUpload := _BlueprintUpload{}

	err = json.Unmarshal(data, &varBlueprintUpload)

	if err != nil {
		return err
	}

	*o = BlueprintUpload(varBlueprintUpload)
...
type NullableBlueprintUpload struct {
	value *BlueprintUpload
	isSet bool
}

func (v NullableBlueprintUpload) Get() *BlueprintUpload {
	return v.value
}

func (v *NullableBlueprintUpload) Set(val *BlueprintUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintUpload(val *BlueprintUpload) *NullableBlueprintUpload {
	return &NullableBlueprintUpload{value: val, isSet: true}
}

func (v NullableBlueprintUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
