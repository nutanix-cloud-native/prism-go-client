...
// checks if the BlueprintPendingLaunchesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintPendingLaunchesResponse{}

// BlueprintPendingLaunchesResponse Response containing status, milestone reached and application uuid
type BlueprintPendingLaunchesResponse struct {
	...
	// state of launch which can be pending, running, success, failure
...
type _BlueprintPendingLaunchesResponse BlueprintPendingLaunchesResponse
...
func NewBlueprintPendingLaunchesResponse(appName string, state string, milestone string, bpName string) *BlueprintPendingLaunchesResponse {
	this := BlueprintPendingLaunchesResponse{}
...
// GetBpName returns the BpName field value
...
// GetBpNameOk returns a tuple with the BpName field value
// and a boolean to check if the value has been set.
...
// SetBpName sets field value
func (o *BlueprintPendingLaunchesResponse) SetBpName(v string) {
	o.BpName = v
}

func (o BlueprintPendingLaunchesResponse) MarshalJSON() ([]byte, error) {
...
func (o BlueprintPendingLaunchesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BlueprintPendingLaunchesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintPendingLaunchesResponse := _BlueprintPendingLaunchesResponse{}

	err = json.Unmarshal(data, &varBlueprintPendingLaunchesResponse)

	if err != nil {
		return err
	}

	*o = BlueprintPendingLaunchesResponse(varBlueprintPendingLaunchesResponse)
...
type NullableBlueprintPendingLaunchesResponse struct {
	value *BlueprintPendingLaunchesResponse
	isSet bool
}

func (v NullableBlueprintPendingLaunchesResponse) Get() *BlueprintPendingLaunchesResponse {
	return v.value
}

func (v *NullableBlueprintPendingLaunchesResponse) Set(val *BlueprintPendingLaunchesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintPendingLaunchesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintPendingLaunchesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintPendingLaunchesResponse(val *BlueprintPendingLaunchesResponse) *NullableBlueprintPendingLaunchesResponse {
	return &NullableBlueprintPendingLaunchesResponse{value: val, isSet: true}
}

func (v NullableBlueprintPendingLaunchesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintPendingLaunchesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
