...
// checks if the Vertex type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Vertex{}

// Vertex Vertex Information
type Vertex struct {
	// Denotes if this is a one-hop node.
	IsOneHop *bool `json:"is_one_hop,omitempty"`
	// Type of the entity represented by the vertex
	EntityType *string `json:"entity_type,omitempty"`
	// Vertex label
	Label *string `json:"label,omitempty"`
	// ID of vertex.
	VertexId *string `json:"vertex_id,omitempty"`
	// UUID of the entity represented by the vertex.
	...
	// Number of instances within the node denoting a group
...
// GetIsOneHop returns the IsOneHop field value if set, zero value otherwise.
func (o *Vertex) GetIsOneHop() bool {
	if o == nil || IsNil(o.IsOneHop) {
		var ret bool
		return ret
	}
	return *o.IsOneHop
...
// GetIsOneHopOk returns a tuple with the IsOneHop field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Vertex) GetIsOneHopOk() (*bool, bool) {
	if o == nil || IsNil(o.IsOneHop) {
		return nil, false
	}
	return o.IsOneHop, true
}
...
// SetIsOneHop gets a reference to the given bool and assigns it to the IsOneHop field.
...
// GetVertexId returns the VertexId field value if set, zero value otherwise.
func (o *Vertex) GetVertexId() string {
	if o == nil || IsNil(o.VertexId) {
		var ret string
		return ret
	}
	return *o.VertexId
...
// GetVertexIdOk returns a tuple with the VertexId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Vertex) GetVertexIdOk() (*string, bool) {
	if o == nil || IsNil(o.VertexId) {
		return nil, false
	}
	return o.VertexId, true
}
...
// SetVertexId gets a reference to the given string and assigns it to the VertexId field.
...
func (o Vertex) MarshalJSON() ([]byte, error) {
...
func (o Vertex) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IsOneHop) {
		toSerialize["is_one_hop"] = o.IsOneHop
	}
	...
	if !IsNil(o.VertexId) {
		toSerialize["vertex_id"] = o.VertexId
	}
...
func (o *Vertex) UnmarshalJSON(data []byte) (err error) {
	varVertex := _Vertex{}

	err = json.Unmarshal(data, &varVertex)
	...
	*o = Vertex(varVertex)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "is_one_hop")
		delete(additionalProperties, "entity_type")
		delete(additionalProperties, "label")
		delete(additionalProperties, "vertex_id")
		delete(additionalProperties, "entity_uuid")
		delete(additionalProperties, "instance_count")
...
type NullableVertex struct {
	value *Vertex
	isSet bool
}

func (v NullableVertex) Get() *Vertex {
	return v.value
}

func (v *NullableVertex) Set(val *Vertex) {
	v.value = val
	v.isSet = true
}

func (v NullableVertex) IsSet() bool {
	return v.isSet
}

func (v *NullableVertex) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVertex(val *Vertex) *NullableVertex {
	return &NullableVertex{value: val, isSet: true}
}

func (v NullableVertex) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVertex) UnmarshalJSON(src []byte) error {
	v.isSet = true
