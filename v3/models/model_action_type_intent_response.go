...
// checks if the ActionTypeIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTypeIntentResponse{}

// ActionTypeIntentResponse Response object for intentful operations on a action_type
type ActionTypeIntentResponse struct {
	Status *ActionTypeDefStatus `json:"status,omitempty"`
	Spec *ActionType `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ActionTypeMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ActionTypeIntentResponse ActionTypeIntentResponse
...
// SetStatus gets a reference to the given ActionTypeDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given ActionType and assigns it to the Spec field.
...
func (o ActionTypeIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ActionTypeIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTypeIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTypeIntentResponse := _ActionTypeIntentResponse{}

	err = json.Unmarshal(data, &varActionTypeIntentResponse)

	if err != nil {
		return err
	}

	*o = ActionTypeIntentResponse(varActionTypeIntentResponse)
...
type NullableActionTypeIntentResponse struct {
	value *ActionTypeIntentResponse
	isSet bool
}

func (v NullableActionTypeIntentResponse) Get() *ActionTypeIntentResponse {
	return v.value
}

func (v *NullableActionTypeIntentResponse) Set(val *ActionTypeIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTypeIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTypeIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTypeIntentResponse(val *ActionTypeIntentResponse) *NullableActionTypeIntentResponse {
	return &NullableActionTypeIntentResponse{value: val, isSet: true}
}

func (v NullableActionTypeIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTypeIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
