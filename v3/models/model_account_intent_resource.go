...
// checks if the AccountIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountIntentResource{}

// AccountIntentResource Response object for intentful operations on a account
type AccountIntentResource struct {
	Status *AccountDefStatus `json:"status,omitempty"`
	Spec *Account `json:"spec,omitempty"`
...
type _AccountIntentResource AccountIntentResource
...
// SetStatus gets a reference to the given AccountDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Account and assigns it to the Spec field.
...
func (o AccountIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AccountIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AccountIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountIntentResource := _AccountIntentResource{}

	err = json.Unmarshal(data, &varAccountIntentResource)

	if err != nil {
		return err
	}

	*o = AccountIntentResource(varAccountIntentResource)
...
type NullableAccountIntentResource struct {
	value *AccountIntentResource
	isSet bool
}

func (v NullableAccountIntentResource) Get() *AccountIntentResource {
	return v.value
}

func (v *NullableAccountIntentResource) Set(val *AccountIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountIntentResource(val *AccountIntentResource) *NullableAccountIntentResource {
	return &NullableAccountIntentResource{value: val, isSet: true}
}

func (v NullableAccountIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
