...
// checks if the RemoteSyslogModuleMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogModuleMetadata{}

// RemoteSyslogModuleMetadata The remote_syslog_module kind metadata
type RemoteSyslogModuleMetadata struct {
	// UTC date and time in RFC-3339 format when remote_syslog_module was last updated 
	...
	// UTC date and time in RFC-3339 format when remote_syslog_module was created 
	...
	// Categories for the remote_syslog_module. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the remote_syslog_module. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// remote_syslog_module name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RemoteSyslogModuleMetadata RemoteSyslogModuleMetadata
...
func NewRemoteSyslogModuleMetadata(kind string) *RemoteSyslogModuleMetadata {
	this := RemoteSyslogModuleMetadata{}
...
func (o RemoteSyslogModuleMetadata) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogModuleMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogModuleMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogModuleMetadata := _RemoteSyslogModuleMetadata{}

	err = json.Unmarshal(data, &varRemoteSyslogModuleMetadata)

	if err != nil {
		return err
	}

	*o = RemoteSyslogModuleMetadata(varRemoteSyslogModuleMetadata)
...
type NullableRemoteSyslogModuleMetadata struct {
	value *RemoteSyslogModuleMetadata
	isSet bool
}

func (v NullableRemoteSyslogModuleMetadata) Get() *RemoteSyslogModuleMetadata {
	return v.value
}

func (v *NullableRemoteSyslogModuleMetadata) Set(val *RemoteSyslogModuleMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogModuleMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogModuleMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogModuleMetadata(val *RemoteSyslogModuleMetadata) *NullableRemoteSyslogModuleMetadata {
	return &NullableRemoteSyslogModuleMetadata{value: val, isSet: true}
}

func (v NullableRemoteSyslogModuleMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogModuleMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
