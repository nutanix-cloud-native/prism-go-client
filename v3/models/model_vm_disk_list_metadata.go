...
// checks if the VmDiskListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDiskListMetadata{}

// VmDiskListMetadata All api calls that return a list will have this metadata block as input 
...
type _VmDiskListMetadata VmDiskListMetadata
...
func (o VmDiskListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmDiskListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmDiskListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVmDiskListMetadata := _VmDiskListMetadata{}

	err = json.Unmarshal(data, &varVmDiskListMetadata)

	if err != nil {
		return err
	}

	*o = VmDiskListMetadata(varVmDiskListMetadata)
...
type NullableVmDiskListMetadata struct {
	value *VmDiskListMetadata
	isSet bool
}

func (v NullableVmDiskListMetadata) Get() *VmDiskListMetadata {
	return v.value
}

func (v *NullableVmDiskListMetadata) Set(val *VmDiskListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmDiskListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmDiskListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmDiskListMetadata(val *VmDiskListMetadata) *NullableVmDiskListMetadata {
	return &NullableVmDiskListMetadata{value: val, isSet: true}
}

func (v NullableVmDiskListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmDiskListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
