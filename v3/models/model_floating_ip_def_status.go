...
// checks if the FloatingIpDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpDefStatus{}

// FloatingIpDefStatus An intentful representation of a floating_ip status
type FloatingIpDefStatus struct {
	...
	Resources FloatingIpResourcesDefStatus `json:"resources"`
	// A description for floating_ip.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FloatingIpDefStatus FloatingIpDefStatus
...
func (o *FloatingIpDefStatus) GetResources() FloatingIpResourcesDefStatus {
	if o == nil {
		var ret FloatingIpResourcesDefStatus
		return ret
	}
...
func (o FloatingIpDefStatus) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *FloatingIpDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varFloatingIpDefStatus := _FloatingIpDefStatus{}

	err = json.Unmarshal(data, &varFloatingIpDefStatus)

	if err != nil {
		return err
	}

	*o = FloatingIpDefStatus(varFloatingIpDefStatus)
...
type NullableFloatingIpDefStatus struct {
	value *FloatingIpDefStatus
	isSet bool
}

func (v NullableFloatingIpDefStatus) Get() *FloatingIpDefStatus {
	return v.value
}

func (v *NullableFloatingIpDefStatus) Set(val *FloatingIpDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpDefStatus(val *FloatingIpDefStatus) *NullableFloatingIpDefStatus {
	return &NullableFloatingIpDefStatus{value: val, isSet: true}
}

func (v NullableFloatingIpDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
