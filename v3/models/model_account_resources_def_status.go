...
// checks if the AccountResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountResourcesDefStatus{}

// AccountResourcesDefStatus Account resources
type AccountResourcesDefStatus struct {
	// Account data
...
type _AccountResourcesDefStatus AccountResourcesDefStatus

// NewAccountResourcesDefStatus instantiates a new AccountResourcesDefStatus object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAccountResourcesDefStatus(data map[string]interface{}, type_ string) *AccountResourcesDefStatus {
	this := AccountResourcesDefStatus{}
	this.Data = data
	this.Type = type_
	return &this
}

// NewAccountResourcesDefStatusWithDefaults instantiates a new AccountResourcesDefStatus object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAccountResourcesDefStatusWithDefaults() *AccountResourcesDefStatus {
	this := AccountResourcesDefStatus{}
	return &this
}

// GetData returns the Data field value
func (o *AccountResourcesDefStatus) GetData() map[string]interface{} {
	if o == nil {
...
func (o *AccountResourcesDefStatus) GetDataOk() (map[string]interface{}, bool) {
	if o == nil {
...
func (o *AccountResourcesDefStatus) SetData(v map[string]interface{}) {
	o.Data = v
}

// GetType returns the Type field value
func (o *AccountResourcesDefStatus) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AccountResourcesDefStatus) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *AccountResourcesDefStatus) SetType(v string) {
	o.Type = v
}

func (o AccountResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AccountResourcesDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AccountResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountResourcesDefStatus := _AccountResourcesDefStatus{}

	err = json.Unmarshal(data, &varAccountResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = AccountResourcesDefStatus(varAccountResourcesDefStatus)
...
type NullableAccountResourcesDefStatus struct {
	value *AccountResourcesDefStatus
	isSet bool
}

func (v NullableAccountResourcesDefStatus) Get() *AccountResourcesDefStatus {
	return v.value
}

func (v *NullableAccountResourcesDefStatus) Set(val *AccountResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountResourcesDefStatus(val *AccountResourcesDefStatus) *NullableAccountResourcesDefStatus {
	return &NullableAccountResourcesDefStatus{value: val, isSet: true}
}

func (v NullableAccountResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
