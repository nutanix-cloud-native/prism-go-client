...
// checks if the CategoryMappingMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryMappingMetadata{}

// CategoryMappingMetadata The category_mapping kind metadata
type CategoryMappingMetadata struct {
	// UTC date and time in RFC-3339 format when category_mapping was last updated 
	...
	// UTC date and time in RFC-3339 format when category_mapping was created 
	...
	// Categories for the category_mapping. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the category_mapping. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _CategoryMappingMetadata CategoryMappingMetadata
...
func (o CategoryMappingMetadata) MarshalJSON() ([]byte, error) {
...
func (o CategoryMappingMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryMappingMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryMappingMetadata := _CategoryMappingMetadata{}

	err = json.Unmarshal(data, &varCategoryMappingMetadata)

	if err != nil {
		return err
	}

	*o = CategoryMappingMetadata(varCategoryMappingMetadata)
...
type NullableCategoryMappingMetadata struct {
	value *CategoryMappingMetadata
	isSet bool
}

func (v NullableCategoryMappingMetadata) Get() *CategoryMappingMetadata {
	return v.value
}

func (v *NullableCategoryMappingMetadata) Set(val *CategoryMappingMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryMappingMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryMappingMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryMappingMetadata(val *CategoryMappingMetadata) *NullableCategoryMappingMetadata {
	return &NullableCategoryMappingMetadata{value: val, isSet: true}
}

func (v NullableCategoryMappingMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryMappingMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
