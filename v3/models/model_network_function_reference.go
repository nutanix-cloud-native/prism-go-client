...
// checks if the NetworkFunctionReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionReference{}

// NetworkFunctionReference The reference to a network_function
...
type _NetworkFunctionReference NetworkFunctionReference
...
func (o NetworkFunctionReference) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionReference) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionReference) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkFunctionReference := _NetworkFunctionReference{}

	err = json.Unmarshal(data, &varNetworkFunctionReference)

	if err != nil {
		return err
	}

	*o = NetworkFunctionReference(varNetworkFunctionReference)
...
type NullableNetworkFunctionReference struct {
	value *NetworkFunctionReference
	isSet bool
}

func (v NullableNetworkFunctionReference) Get() *NetworkFunctionReference {
	return v.value
}

func (v *NullableNetworkFunctionReference) Set(val *NetworkFunctionReference) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionReference) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionReference(val *NetworkFunctionReference) *NullableNetworkFunctionReference {
	return &NullableNetworkFunctionReference{value: val, isSet: true}
}

func (v NullableNetworkFunctionReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
