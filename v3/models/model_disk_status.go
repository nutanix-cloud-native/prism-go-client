...
// DiskStatus The status of a REST API call. Only used when there is a failure to report. 
...
func (o *DiskStatus) UnmarshalJSON(data []byte) (err error) {
	varDiskStatus := _DiskStatus{}

	err = json.Unmarshal(data, &varDiskStatus)

	if err != nil {
		return err
	}

	*o = DiskStatus(varDiskStatus)
