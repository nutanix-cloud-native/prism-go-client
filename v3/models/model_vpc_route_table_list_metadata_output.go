...
// checks if the VpcRouteTableListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcRouteTableListMetadataOutput{}

// VpcRouteTableListMetadataOutput All api calls that return a list will have this metadata block 
type VpcRouteTableListMetadataOutput struct {
	// The kind name
...
type _VpcRouteTableListMetadataOutput VpcRouteTableListMetadataOutput
...
func NewVpcRouteTableListMetadataOutput() *VpcRouteTableListMetadataOutput {
	this := VpcRouteTableListMetadataOutput{}
	var kind string = "vpc_route_table"
	this.Kind = &kind
	return &this
}
...
func (o VpcRouteTableListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VpcRouteTableListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VpcRouteTableListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVpcRouteTableListMetadataOutput := _VpcRouteTableListMetadataOutput{}

	err = json.Unmarshal(data, &varVpcRouteTableListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VpcRouteTableListMetadataOutput(varVpcRouteTableListMetadataOutput)
...
type NullableVpcRouteTableListMetadataOutput struct {
	value *VpcRouteTableListMetadataOutput
	isSet bool
}

func (v NullableVpcRouteTableListMetadataOutput) Get() *VpcRouteTableListMetadataOutput {
	return v.value
}

func (v *NullableVpcRouteTableListMetadataOutput) Set(val *VpcRouteTableListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcRouteTableListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcRouteTableListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcRouteTableListMetadataOutput(val *VpcRouteTableListMetadataOutput) *NullableVpcRouteTableListMetadataOutput {
	return &NullableVpcRouteTableListMetadataOutput{value: val, isSet: true}
}

func (v NullableVpcRouteTableListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcRouteTableListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
