...
// checks if the PemkeySpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PemkeySpec{}
...
func (o PemkeySpec) MarshalJSON() ([]byte, error) {
...
func (o PemkeySpec) ToMap() (map[string]interface{}, error) {
...
func (o *PemkeySpec) UnmarshalJSON(data []byte) (err error) {
	...
	varPemkeySpec := _PemkeySpec{}

	err = json.Unmarshal(data, &varPemkeySpec)

	if err != nil {
		return err
	}

	*o = PemkeySpec(varPemkeySpec)
...
type NullablePemkeySpec struct {
	value *PemkeySpec
	isSet bool
}

func (v NullablePemkeySpec) Get() *PemkeySpec {
	return v.value
}

func (v *NullablePemkeySpec) Set(val *PemkeySpec) {
	v.value = val
	v.isSet = true
}

func (v NullablePemkeySpec) IsSet() bool {
	return v.isSet
}

func (v *NullablePemkeySpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePemkeySpec(val *PemkeySpec) *NullablePemkeySpec {
	return &NullablePemkeySpec{value: val, isSet: true}
}

func (v NullablePemkeySpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePemkeySpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
