...
// checks if the TopologyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TopologyRequest{}

// TopologyRequest Topology request.
type TopologyRequest struct {
	// Toggle to view one hop traffic
	EnableOneHopTraffic *bool `json:"enable_one_hop_traffic,omitempty"`
...
type _TopologyRequest TopologyRequest
...
// GetEnableOneHopTraffic returns the EnableOneHopTraffic field value if set, zero value otherwise.
func (o *TopologyRequest) GetEnableOneHopTraffic() bool {
	if o == nil || IsNil(o.EnableOneHopTraffic) {
		var ret bool
		return ret
	}
	return *o.EnableOneHopTraffic
}

// GetEnableOneHopTrafficOk returns a tuple with the EnableOneHopTraffic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TopologyRequest) GetEnableOneHopTrafficOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableOneHopTraffic) {
		return nil, false
	}
	return o.EnableOneHopTraffic, true
}
...
// SetEnableOneHopTraffic gets a reference to the given bool and assigns it to the EnableOneHopTraffic field.
func (o *TopologyRequest) SetEnableOneHopTraffic(v bool) {
	o.EnableOneHopTraffic = &v
}
...
func (o TopologyRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.EnableOneHopTraffic) {
		toSerialize["enable_one_hop_traffic"] = o.EnableOneHopTraffic
	}
...
func (o *TopologyRequest) UnmarshalJSON(data []byte) (err error) {
	varTopologyRequest := _TopologyRequest{}

	err = json.Unmarshal(data, &varTopologyRequest)

	if err != nil {
		return err
	}

	*o = TopologyRequest(varTopologyRequest)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "enable_one_hop_traffic")
...
type NullableTopologyRequest struct {
	value *TopologyRequest
	isSet bool
}

func (v NullableTopologyRequest) Get() *TopologyRequest {
	return v.value
}

func (v *NullableTopologyRequest) Set(val *TopologyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableTopologyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableTopologyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTopologyRequest(val *TopologyRequest) *NullableTopologyRequest {
	return &NullableTopologyRequest{value: val, isSet: true}
}

func (v NullableTopologyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTopologyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
