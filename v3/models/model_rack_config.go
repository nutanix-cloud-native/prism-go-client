...
// checks if the RackConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackConfig{}

// RackConfig Map of rack's name to the hosts it contains. The rack may or may not exist in the cluster yet. 
type RackConfig struct {
	HostList []HostReference `json:"host_list,omitempty"`
	RackName *string `json:"rack_name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RackConfig RackConfig
...
// SetHostList gets a reference to the given []HostReference and assigns it to the HostList field.
...
func (o RackConfig) MarshalJSON() ([]byte, error) {
...
func (o RackConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RackConfig) UnmarshalJSON(data []byte) (err error) {
	varRackConfig := _RackConfig{}

	err = json.Unmarshal(data, &varRackConfig)

	if err != nil {
		return err
	}

	*o = RackConfig(varRackConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "host_list")
		delete(additionalProperties, "rack_name")
...
type NullableRackConfig struct {
	value *RackConfig
	isSet bool
}

func (v NullableRackConfig) Get() *RackConfig {
	return v.value
}

func (v *NullableRackConfig) Set(val *RackConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRackConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRackConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackConfig(val *RackConfig) *NullableRackConfig {
	return &NullableRackConfig{value: val, isSet: true}
}

func (v NullableRackConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
