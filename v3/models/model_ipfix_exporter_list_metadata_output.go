...
// checks if the IpfixExporterListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpfixExporterListMetadataOutput{}

// IpfixExporterListMetadataOutput All api calls that return a list will have this metadata block 
type IpfixExporterListMetadataOutput struct {
	// The kind name
...
type _IpfixExporterListMetadataOutput IpfixExporterListMetadataOutput
...
func NewIpfixExporterListMetadataOutput() *IpfixExporterListMetadataOutput {
	this := IpfixExporterListMetadataOutput{}
...
func (o IpfixExporterListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o IpfixExporterListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *IpfixExporterListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varIpfixExporterListMetadataOutput := _IpfixExporterListMetadataOutput{}

	err = json.Unmarshal(data, &varIpfixExporterListMetadataOutput)

	if err != nil {
		return err
	}

	*o = IpfixExporterListMetadataOutput(varIpfixExporterListMetadataOutput)
...
type NullableIpfixExporterListMetadataOutput struct {
	value *IpfixExporterListMetadataOutput
	isSet bool
}

func (v NullableIpfixExporterListMetadataOutput) Get() *IpfixExporterListMetadataOutput {
	return v.value
}

func (v *NullableIpfixExporterListMetadataOutput) Set(val *IpfixExporterListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableIpfixExporterListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableIpfixExporterListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpfixExporterListMetadataOutput(val *IpfixExporterListMetadataOutput) *NullableIpfixExporterListMetadataOutput {
	return &NullableIpfixExporterListMetadataOutput{value: val, isSet: true}
}

func (v NullableIpfixExporterListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpfixExporterListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
