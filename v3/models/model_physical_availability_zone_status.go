...
// checks if the PhysicalAvailabilityZoneStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalAvailabilityZoneStatus{}

// PhysicalAvailabilityZoneStatus The status of a REST API call. Only used when there is a failure to report. 
type PhysicalAvailabilityZoneStatus struct {
	// The kind name
...
type _PhysicalAvailabilityZoneStatus PhysicalAvailabilityZoneStatus
...
func NewPhysicalAvailabilityZoneStatus() *PhysicalAvailabilityZoneStatus {
	this := PhysicalAvailabilityZoneStatus{}
	return &this
}
...
func (o PhysicalAvailabilityZoneStatus) MarshalJSON() ([]byte, error) {
...
func (o PhysicalAvailabilityZoneStatus) ToMap() (map[string]interface{}, error) {
...
func (o *PhysicalAvailabilityZoneStatus) UnmarshalJSON(data []byte) (err error) {
	varPhysicalAvailabilityZoneStatus := _PhysicalAvailabilityZoneStatus{}

	err = json.Unmarshal(data, &varPhysicalAvailabilityZoneStatus)

	if err != nil {
		return err
	}

	*o = PhysicalAvailabilityZoneStatus(varPhysicalAvailabilityZoneStatus)
...
type NullablePhysicalAvailabilityZoneStatus struct {
	value *PhysicalAvailabilityZoneStatus
	isSet bool
}

func (v NullablePhysicalAvailabilityZoneStatus) Get() *PhysicalAvailabilityZoneStatus {
	return v.value
}

func (v *NullablePhysicalAvailabilityZoneStatus) Set(val *PhysicalAvailabilityZoneStatus) {
	v.value = val
	v.isSet = true
}

func (v NullablePhysicalAvailabilityZoneStatus) IsSet() bool {
	return v.isSet
}

func (v *NullablePhysicalAvailabilityZoneStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhysicalAvailabilityZoneStatus(val *PhysicalAvailabilityZoneStatus) *NullablePhysicalAvailabilityZoneStatus {
	return &NullablePhysicalAvailabilityZoneStatus{value: val, isSet: true}
}

func (v NullablePhysicalAvailabilityZoneStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhysicalAvailabilityZoneStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
