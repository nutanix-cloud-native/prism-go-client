...
// checks if the AppSubstrateInputUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSubstrateInputUpload{}

// AppSubstrateInputUpload Substrate definition
type AppSubstrateInputUpload struct {
	// 
	...
	ReadinessProbe *AppSubstrateReadinessProbeUpload `json:"readiness_probe,omitempty"`
...
type _AppSubstrateInputUpload AppSubstrateInputUpload
...
func (o *AppSubstrateInputUpload) GetReadinessProbe() AppSubstrateReadinessProbeUpload {
	if o == nil || IsNil(o.ReadinessProbe) {
		var ret AppSubstrateReadinessProbeUpload
		return ret
	}
...
// SetReadinessProbe gets a reference to the given AppSubstrateReadinessProbeUpload and assigns it to the ReadinessProbe field.
...
func (o AppSubstrateInputUpload) MarshalJSON() ([]byte, error) {
...
func (o AppSubstrateInputUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AppSubstrateInputUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppSubstrateInputUpload := _AppSubstrateInputUpload{}

	err = json.Unmarshal(data, &varAppSubstrateInputUpload)

	if err != nil {
		return err
	}

	*o = AppSubstrateInputUpload(varAppSubstrateInputUpload)
...
type NullableAppSubstrateInputUpload struct {
	value *AppSubstrateInputUpload
	isSet bool
}

func (v NullableAppSubstrateInputUpload) Get() *AppSubstrateInputUpload {
	return v.value
}

func (v *NullableAppSubstrateInputUpload) Set(val *AppSubstrateInputUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppSubstrateInputUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppSubstrateInputUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppSubstrateInputUpload(val *AppSubstrateInputUpload) *NullableAppSubstrateInputUpload {
	return &NullableAppSubstrateInputUpload{value: val, isSet: true}
}

func (v NullableAppSubstrateInputUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppSubstrateInputUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
