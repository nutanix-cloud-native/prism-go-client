...
// checks if the AwsVmIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVmIntentInput{}

// AwsVmIntentInput An intentful representation of a aws_vm
type AwsVmIntentInput struct {
	Spec AwsVm `json:"spec"`
...
type _AwsVmIntentInput AwsVmIntentInput
...
func (o AwsVmIntentInput) MarshalJSON() ([]byte, error) {
...
func (o AwsVmIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVmIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsVmIntentInput := _AwsVmIntentInput{}

	err = json.Unmarshal(data, &varAwsVmIntentInput)

	if err != nil {
		return err
	}

	*o = AwsVmIntentInput(varAwsVmIntentInput)
...
type NullableAwsVmIntentInput struct {
	value *AwsVmIntentInput
	isSet bool
}

func (v NullableAwsVmIntentInput) Get() *AwsVmIntentInput {
	return v.value
}

func (v *NullableAwsVmIntentInput) Set(val *AwsVmIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVmIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVmIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVmIntentInput(val *AwsVmIntentInput) *NullableAwsVmIntentInput {
	return &NullableAwsVmIntentInput{value: val, isSet: true}
}

func (v NullableAwsVmIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVmIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
