...
// checks if the VmDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDefStatus{}
...
func (o VmDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VmDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VmDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varVmDefStatus := _VmDefStatus{}

	err = json.Unmarshal(data, &varVmDefStatus)

	if err != nil {
		return err
	}

	*o = VmDefStatus(varVmDefStatus)
...
type NullableVmDefStatus struct {
	value *VmDefStatus
	isSet bool
}

func (v NullableVmDefStatus) Get() *VmDefStatus {
	return v.value
}

func (v *NullableVmDefStatus) Set(val *VmDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVmDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVmDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmDefStatus(val *VmDefStatus) *NullableVmDefStatus {
	return &NullableVmDefStatus{value: val, isSet: true}
}

func (v NullableVmDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
