...
// checks if the RackableUnitDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackableUnitDefStatus{}
...
type RackableUnitDefStatus struct {
	// The rackable unit serial
	Serial string `json:"serial"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	// The rackable unit model
	Model string `json:"model"`
	Resources RackableUnitResources `json:"resources"`
	// The state of the rackable unit entity
	State *string `json:"state,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RackableUnitDefStatus RackableUnitDefStatus
...
func (o RackableUnitDefStatus) MarshalJSON() ([]byte, error) {
...
func (o RackableUnitDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RackableUnitDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varRackableUnitDefStatus := _RackableUnitDefStatus{}

	err = json.Unmarshal(data, &varRackableUnitDefStatus)

	if err != nil {
		return err
	}

	*o = RackableUnitDefStatus(varRackableUnitDefStatus)
...
type NullableRackableUnitDefStatus struct {
	value *RackableUnitDefStatus
	isSet bool
}

func (v NullableRackableUnitDefStatus) Get() *RackableUnitDefStatus {
	return v.value
}

func (v *NullableRackableUnitDefStatus) Set(val *RackableUnitDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRackableUnitDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRackableUnitDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackableUnitDefStatus(val *RackableUnitDefStatus) *NullableRackableUnitDefStatus {
	return &NullableRackableUnitDefStatus{value: val, isSet: true}
}

func (v NullableRackableUnitDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackableUnitDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
