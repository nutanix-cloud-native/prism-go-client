...
// checks if the ActionTemplateIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTemplateIntentResponse{}

// ActionTemplateIntentResponse Response object for intentful operations on a action_template
type ActionTemplateIntentResponse struct {
...
type _ActionTemplateIntentResponse ActionTemplateIntentResponse
...
func NewActionTemplateIntentResponse(apiVersion string, metadata ActionTemplateMetadata) *ActionTemplateIntentResponse {
	this := ActionTemplateIntentResponse{}
...
func (o ActionTemplateIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ActionTemplateIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ActionTemplateIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTemplateIntentResponse := _ActionTemplateIntentResponse{}

	err = json.Unmarshal(data, &varActionTemplateIntentResponse)

	if err != nil {
		return err
	}

	*o = ActionTemplateIntentResponse(varActionTemplateIntentResponse)
...
type NullableActionTemplateIntentResponse struct {
	value *ActionTemplateIntentResponse
	isSet bool
}

func (v NullableActionTemplateIntentResponse) Get() *ActionTemplateIntentResponse {
	return v.value
}

func (v *NullableActionTemplateIntentResponse) Set(val *ActionTemplateIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTemplateIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTemplateIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTemplateIntentResponse(val *ActionTemplateIntentResponse) *NullableActionTemplateIntentResponse {
	return &NullableActionTemplateIntentResponse{value: val, isSet: true}
}

func (v NullableActionTemplateIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTemplateIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
