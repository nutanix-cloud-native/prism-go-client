...
// checks if the ActionRuleReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleReference{}

// ActionRuleReference The reference to a action_rule
type ActionRuleReference struct {
	// The kind name
...
type _ActionRuleReference ActionRuleReference
...
func (o ActionRuleReference) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleReference) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleReference) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleReference := _ActionRuleReference{}

	err = json.Unmarshal(data, &varActionRuleReference)

	if err != nil {
		return err
	}

	*o = ActionRuleReference(varActionRuleReference)
...
type NullableActionRuleReference struct {
	value *ActionRuleReference
	isSet bool
}

func (v NullableActionRuleReference) Get() *ActionRuleReference {
	return v.value
}

func (v *NullableActionRuleReference) Set(val *ActionRuleReference) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleReference) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleReference(val *ActionRuleReference) *NullableActionRuleReference {
	return &NullableActionRuleReference{value: val, isSet: true}
}

func (v NullableActionRuleReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
