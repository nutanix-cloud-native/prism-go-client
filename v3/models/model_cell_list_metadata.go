...
// checks if the CellListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CellListMetadata{}

// CellListMetadata All api calls that return a list will have this metadata block as input 
type CellListMetadata struct {
	// The kind name
...
type _CellListMetadata CellListMetadata
...
func (o CellListMetadata) MarshalJSON() ([]byte, error) {
...
func (o CellListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *CellListMetadata) UnmarshalJSON(data []byte) (err error) {
	varCellListMetadata := _CellListMetadata{}

	err = json.Unmarshal(data, &varCellListMetadata)

	if err != nil {
		return err
	}

	*o = CellListMetadata(varCellListMetadata)
...
type NullableCellListMetadata struct {
	value *CellListMetadata
	isSet bool
}

func (v NullableCellListMetadata) Get() *CellListMetadata {
	return v.value
}

func (v *NullableCellListMetadata) Set(val *CellListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCellListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCellListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCellListMetadata(val *CellListMetadata) *NullableCellListMetadata {
	return &NullableCellListMetadata{value: val, isSet: true}
}

func (v NullableCellListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCellListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
