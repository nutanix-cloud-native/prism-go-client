...
// checks if the GuestCustomizationStatusSysprep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestCustomizationStatusSysprep{}
...
type _GuestCustomizationStatusSysprep GuestCustomizationStatusSysprep
...
func NewGuestCustomizationStatusSysprep() *GuestCustomizationStatusSysprep {
	this := GuestCustomizationStatusSysprep{}
	var installType string = "PREPARED"
...
// GetUnattendXml returns the UnattendXml field value if set, zero value otherwise.
func (o *GuestCustomizationStatusSysprep) GetUnattendXml() string {
	if o == nil || IsNil(o.UnattendXml) {
		var ret string
		return ret
	}
	return *o.UnattendXml
}

// GetUnattendXmlOk returns a tuple with the UnattendXml field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GuestCustomizationStatusSysprep) GetUnattendXmlOk() (*string, bool) {
	if o == nil || IsNil(o.UnattendXml) {
		return nil, false
	}
	return o.UnattendXml, true
}
...
// SetUnattendXml gets a reference to the given string and assigns it to the UnattendXml field.
...
func (o GuestCustomizationStatusSysprep) MarshalJSON() ([]byte, error) {
...
func (o GuestCustomizationStatusSysprep) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.InstallType) {
		toSerialize["install_type"] = o.InstallType
	}
	if !IsNil(o.UnattendXml) {
		toSerialize["unattend_xml"] = o.UnattendXml
	}
...
func (o *GuestCustomizationStatusSysprep) UnmarshalJSON(data []byte) (err error) {
	varGuestCustomizationStatusSysprep := _GuestCustomizationStatusSysprep{}

	err = json.Unmarshal(data, &varGuestCustomizationStatusSysprep)

	if err != nil {
		return err
	}

	*o = GuestCustomizationStatusSysprep(varGuestCustomizationStatusSysprep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "install_type")
		delete(additionalProperties, "unattend_xml")
...
type NullableGuestCustomizationStatusSysprep struct {
	value *GuestCustomizationStatusSysprep
	isSet bool
}

func (v NullableGuestCustomizationStatusSysprep) Get() *GuestCustomizationStatusSysprep {
	return v.value
}

func (v *NullableGuestCustomizationStatusSysprep) Set(val *GuestCustomizationStatusSysprep) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestCustomizationStatusSysprep) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestCustomizationStatusSysprep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestCustomizationStatusSysprep(val *GuestCustomizationStatusSysprep) *NullableGuestCustomizationStatusSysprep {
	return &NullableGuestCustomizationStatusSysprep{value: val, isSet: true}
}

func (v NullableGuestCustomizationStatusSysprep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestCustomizationStatusSysprep) UnmarshalJSON(src []byte) error {
	v.isSet = true
