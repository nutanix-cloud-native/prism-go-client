...
func (o *VmDisk) GetDataSourceReference() VmDiskDataSourceReference {
	if o == nil || IsNil(o.DataSourceReference) {
		var ret VmDiskDataSourceReference
		return ret
	}
...
// SetDataSourceReference gets a reference to the given VmDiskDataSourceReference and assigns it to the DataSourceReference field.
