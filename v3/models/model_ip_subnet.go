...
// checks if the IpSubnet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpSubnet{}
...
func (o IpSubnet) MarshalJSON() ([]byte, error) {
...
func (o IpSubnet) ToMap() (map[string]interface{}, error) {
...
func (o *IpSubnet) UnmarshalJSON(data []byte) (err error) {
	varIpSubnet := _IpSubnet{}

	err = json.Unmarshal(data, &varIpSubnet)

	if err != nil {
		return err
	}

	*o = IpSubnet(varIpSubnet)
...
type NullableIpSubnet struct {
	value *IpSubnet
	isSet bool
}

func (v NullableIpSubnet) Get() *IpSubnet {
	return v.value
}

func (v *NullableIpSubnet) Set(val *IpSubnet) {
	v.value = val
	v.isSet = true
}

func (v NullableIpSubnet) IsSet() bool {
	return v.isSet
}

func (v *NullableIpSubnet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpSubnet(val *IpSubnet) *NullableIpSubnet {
	return &NullableIpSubnet{value: val, isSet: true}
}

func (v NullableIpSubnet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpSubnet) UnmarshalJSON(src []byte) error {
	v.isSet = true
