...
type ApiResponse struct {
	...
	ApiResponse map[string]map[string]interface{} `json:"api_response"`
...
// GetApiResponse returns the ApiResponse field value
...
// GetApiResponseOk returns a tuple with the ApiResponse field value
// and a boolean to check if the value has been set.
func (o *ApiResponse) GetApiResponseOk() (map[string]map[string]interface{}, bool) {
	if o == nil {
		return map[string]map[string]interface{}{}, false
	}
	return o.ApiResponse, true
}

// SetApiResponse sets field value
...
func (o ApiResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["api_response"] = o.ApiResponse
...
func (o *ApiResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ApiResponse(varApiResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "api_response")
		delete(additionalProperties, "path_and_params")
