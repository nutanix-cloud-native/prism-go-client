...
// checks if the ActionTemplateResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionTemplateResources{}

// ActionTemplateResources Action template object for example action templates.
type ActionTemplateResources struct {
	...
	// Flag to indicate if action template is disabled
	...
	// Is this a blank template or a user defined template.
	BlankTemplate *bool `json:"blank_template,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ActionTemplateResources ActionTemplateResources
...
// GetBlankTemplate returns the BlankTemplate field value if set, zero value otherwise.
func (o *ActionTemplateResources) GetBlankTemplate() bool {
	if o == nil || IsNil(o.BlankTemplate) {
		var ret bool
		return ret
	}
	return *o.BlankTemplate
}

// GetBlankTemplateOk returns a tuple with the BlankTemplate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActionTemplateResources) GetBlankTemplateOk() (*bool, bool) {
	if o == nil || IsNil(o.BlankTemplate) {
		return nil, false
	}
	return o.BlankTemplate, true
}
...
// SetBlankTemplate gets a reference to the given bool and assigns it to the BlankTemplate field.
func (o *ActionTemplateResources) SetBlankTemplate(v bool) {
	o.BlankTemplate = &v
}

func (o ActionTemplateResources) MarshalJSON() ([]byte, error) {
...
func (o ActionTemplateResources) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BlankTemplate) {
		toSerialize["blank_template"] = o.BlankTemplate
	}
...
func (o *ActionTemplateResources) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTemplateResources := _ActionTemplateResources{}

	err = json.Unmarshal(data, &varActionTemplateResources)

	if err != nil {
		return err
	}

	*o = ActionTemplateResources(varActionTemplateResources)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "blank_template")
...
type NullableActionTemplateResources struct {
	value *ActionTemplateResources
	isSet bool
}

func (v NullableActionTemplateResources) Get() *ActionTemplateResources {
	return v.value
}

func (v *NullableActionTemplateResources) Set(val *ActionTemplateResources) {
	v.value = val
	v.isSet = true
}

func (v NullableActionTemplateResources) IsSet() bool {
	return v.isSet
}

func (v *NullableActionTemplateResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionTemplateResources(val *ActionTemplateResources) *NullableActionTemplateResources {
	return &NullableActionTemplateResources{value: val, isSet: true}
}

func (v NullableActionTemplateResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionTemplateResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
