...
// checks if the AppRunlogResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunlogResources{}

// AppRunlogResources Runlog resources
type AppRunlogResources struct {
	ActionReference *EntityReference `json:"action_reference,omitempty"`
	TaskReference *AppTaskReference `json:"task_reference,omitempty"`
	UserdataReference *EntityReference `json:"userdata_reference,omitempty"`
	// critical or non-critical runlog
	IsCritical bool `json:"is_critical"`
	RootReference *AppRunlogReference `json:"root_reference,omitempty"`
	CallRunbookReference *AppTaskReference `json:"call_runbook_reference,omitempty"`
	// type of element this runlog refers to.
	ElementType *string `json:"element_type,omitempty"`
	// reasons of failure if any
	ReasonList []string `json:"reason_list"`
	ParentReference *AppRunlogReference `json:"parent_reference,omitempty"`
	// Describe if action runlog is archived
	IsRunlogArchived *bool `json:"is_runlog_archived,omitempty"`
	// type of runlog
	Type string `json:"type"`
	ApplicationReference *AppReference `json:"application_reference,omitempty"`
	ElementReference *EntityReference `json:"element_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AppRunlogResources AppRunlogResources
...
func NewAppRunlogResources(isCritical bool, reasonList []string, type_ string) *AppRunlogResources {
	this := AppRunlogResources{}
	this.IsCritical = isCritical
	this.ReasonList = reasonList
	var isRunlogArchived bool = false
	this.IsRunlogArchived = &isRunlogArchived
	this.Type = type_
	return &this
}
...
// SetActionReference gets a reference to the given EntityReference and assigns it to the ActionReference field.
func (o *AppRunlogResources) SetActionReference(v EntityReference) {
	o.ActionReference = &v
}

// GetTaskReference returns the TaskReference field value if set, zero value otherwise.
func (o *AppRunlogResources) GetTaskReference() AppTaskReference {
	if o == nil || IsNil(o.TaskReference) {
		var ret AppTaskReference
		return ret
	}
	return *o.TaskReference
}

// GetTaskReferenceOk returns a tuple with the TaskReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppRunlogResources) GetTaskReferenceOk() (*AppTaskReference, bool) {
	if o == nil || IsNil(o.TaskReference) {
		return nil, false
	}
	return o.TaskReference, true
}
...
// SetTaskReference gets a reference to the given AppTaskReference and assigns it to the TaskReference field.
func (o *AppRunlogResources) SetTaskReference(v AppTaskReference) {
	o.TaskReference = &v
}

// GetUserdataReference returns the UserdataReference field value if set, zero value otherwise.
func (o *AppRunlogResources) GetUserdataReference() EntityReference {
	if o == nil || IsNil(o.UserdataReference) {
		var ret EntityReference
		return ret
	}
	return *o.UserdataReference
}

// GetUserdataReferenceOk returns a tuple with the UserdataReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppRunlogResources) GetUserdataReferenceOk() (*EntityReference, bool) {
	if o == nil || IsNil(o.UserdataReference) {
		return nil, false
	}
	return o.UserdataReference, true
}
...
// SetUserdataReference gets a reference to the given EntityReference and assigns it to the UserdataReference field.
func (o *AppRunlogResources) SetUserdataReference(v EntityReference) {
	o.UserdataReference = &v
}
...
// GetRootReference returns the RootReference field value if set, zero value otherwise.
func (o *AppRunlogResources) GetRootReference() AppRunlogReference {
	if o == nil || IsNil(o.RootReference) {
		var ret AppRunlogReference
		return ret
	}
	return *o.RootReference
}

// GetRootReferenceOk returns a tuple with the RootReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppRunlogResources) GetRootReferenceOk() (*AppRunlogReference, bool) {
	if o == nil || IsNil(o.RootReference) {
		return nil, false
	}
	return o.RootReference, true
}
...
// SetRootReference gets a reference to the given AppRunlogReference and assigns it to the RootReference field.
func (o *AppRunlogResources) SetRootReference(v AppRunlogReference) {
	o.RootReference = &v
}

// GetCallRunbookReference returns the CallRunbookReference field value if set, zero value otherwise.
func (o *AppRunlogResources) GetCallRunbookReference() AppTaskReference {
	if o == nil || IsNil(o.CallRunbookReference) {
		var ret AppTaskReference
		return ret
	}
	return *o.CallRunbookReference
}

// GetCallRunbookReferenceOk returns a tuple with the CallRunbookReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppRunlogResources) GetCallRunbookReferenceOk() (*AppTaskReference, bool) {
	if o == nil || IsNil(o.CallRunbookReference) {
		return nil, false
	}
	return o.CallRunbookReference, true
}
...
// SetCallRunbookReference gets a reference to the given AppTaskReference and assigns it to the CallRunbookReference field.
func (o *AppRunlogResources) SetCallRunbookReference(v AppTaskReference) {
	o.CallRunbookReference = &v
}
...
// GetReasonList returns the ReasonList field value
...
// GetReasonListOk returns a tuple with the ReasonList field value
// and a boolean to check if the value has been set.
func (o *AppRunlogResources) GetReasonListOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.ReasonList, true
}

// SetReasonList sets field value
...
// SetParentReference gets a reference to the given AppRunlogReference and assigns it to the ParentReference field.
func (o *AppRunlogResources) SetParentReference(v AppRunlogReference) {
	o.ParentReference = &v
}

// GetIsRunlogArchived returns the IsRunlogArchived field value if set, zero value otherwise.
func (o *AppRunlogResources) GetIsRunlogArchived() bool {
	if o == nil || IsNil(o.IsRunlogArchived) {
		var ret bool
		return ret
	}
	return *o.IsRunlogArchived
}

// GetIsRunlogArchivedOk returns a tuple with the IsRunlogArchived field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppRunlogResources) GetIsRunlogArchivedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsRunlogArchived) {
		return nil, false
	}
	return o.IsRunlogArchived, true
}
...
// SetIsRunlogArchived gets a reference to the given bool and assigns it to the IsRunlogArchived field.
func (o *AppRunlogResources) SetIsRunlogArchived(v bool) {
	o.IsRunlogArchived = &v
}
...
// GetApplicationReference returns the ApplicationReference field value if set, zero value otherwise.
func (o *AppRunlogResources) GetApplicationReference() AppReference {
	if o == nil || IsNil(o.ApplicationReference) {
		var ret AppReference
		return ret
	}
	return *o.ApplicationReference
}

// GetApplicationReferenceOk returns a tuple with the ApplicationReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppRunlogResources) GetApplicationReferenceOk() (*AppReference, bool) {
	if o == nil || IsNil(o.ApplicationReference) {
		return nil, false
	}
	return o.ApplicationReference, true
}
...
// SetApplicationReference gets a reference to the given AppReference and assigns it to the ApplicationReference field.
func (o *AppRunlogResources) SetApplicationReference(v AppReference) {
	o.ApplicationReference = &v
}
...
// SetElementReference gets a reference to the given EntityReference and assigns it to the ElementReference field.
func (o *AppRunlogResources) SetElementReference(v EntityReference) {
	o.ElementReference = &v
}

func (o AppRunlogResources) MarshalJSON() ([]byte, error) {
...
func (o AppRunlogResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ActionReference) {
		toSerialize["action_reference"] = o.ActionReference
	}
	if !IsNil(o.TaskReference) {
		toSerialize["task_reference"] = o.TaskReference
	}
	if !IsNil(o.UserdataReference) {
		toSerialize["userdata_reference"] = o.UserdataReference
	}
	toSerialize["is_critical"] = o.IsCritical
	if !IsNil(o.RootReference) {
		toSerialize["root_reference"] = o.RootReference
	}
	if !IsNil(o.CallRunbookReference) {
		toSerialize["call_runbook_reference"] = o.CallRunbookReference
	}
	if !IsNil(o.ElementType) {
		toSerialize["element_type"] = o.ElementType
	}
	toSerialize["reason_list"] = o.ReasonList
	if !IsNil(o.ParentReference) {
		toSerialize["parent_reference"] = o.ParentReference
	}
	if !IsNil(o.IsRunlogArchived) {
		toSerialize["is_runlog_archived"] = o.IsRunlogArchived
	}
	toSerialize["type"] = o.Type
	if !IsNil(o.ApplicationReference) {
		toSerialize["application_reference"] = o.ApplicationReference
	}
	if !IsNil(o.ElementReference) {
		toSerialize["element_reference"] = o.ElementReference
	}
...
func (o *AppRunlogResources) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRunlogResources := _AppRunlogResources{}

	err = json.Unmarshal(data, &varAppRunlogResources)

	if err != nil {
		return err
	}

	*o = AppRunlogResources(varAppRunlogResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "action_reference")
		delete(additionalProperties, "task_reference")
		delete(additionalProperties, "userdata_reference")
		delete(additionalProperties, "is_critical")
		delete(additionalProperties, "root_reference")
		delete(additionalProperties, "call_runbook_reference")
		delete(additionalProperties, "element_type")
		delete(additionalProperties, "reason_list")
		delete(additionalProperties, "parent_reference")
		delete(additionalProperties, "is_runlog_archived")
		delete(additionalProperties, "type")
		delete(additionalProperties, "application_reference")
		delete(additionalProperties, "element_reference")
...
type NullableAppRunlogResources struct {
	value *AppRunlogResources
	isSet bool
}

func (v NullableAppRunlogResources) Get() *AppRunlogResources {
	return v.value
}

func (v *NullableAppRunlogResources) Set(val *AppRunlogResources) {
	v.value = val
	v.isSet = true
}

func (v NullableAppRunlogResources) IsSet() bool {
	return v.isSet
}

func (v *NullableAppRunlogResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppRunlogResources(val *AppRunlogResources) *NullableAppRunlogResources {
	return &NullableAppRunlogResources{value: val, isSet: true}
}

func (v NullableAppRunlogResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppRunlogResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
