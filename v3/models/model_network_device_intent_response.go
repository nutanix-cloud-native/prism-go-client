...
// checks if the NetworkDeviceIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDeviceIntentResponse{}

// NetworkDeviceIntentResponse Response object for intentful operations on a network_device
type NetworkDeviceIntentResponse struct {
	Status *NetworkDeviceDefStatus `json:"status,omitempty"`
	Spec *NetworkDevice `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata NetworkDeviceMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _NetworkDeviceIntentResponse NetworkDeviceIntentResponse
...
func NewNetworkDeviceIntentResponse(apiVersion string, metadata NetworkDeviceMetadata) *NetworkDeviceIntentResponse {
	this := NetworkDeviceIntentResponse{}
...
func (o *NetworkDeviceIntentResponse) GetStatus() NetworkDeviceDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret NetworkDeviceDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given NetworkDeviceDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given NetworkDevice and assigns it to the Spec field.
...
func (o NetworkDeviceIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o NetworkDeviceIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkDeviceIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkDeviceIntentResponse := _NetworkDeviceIntentResponse{}

	err = json.Unmarshal(data, &varNetworkDeviceIntentResponse)

	if err != nil {
		return err
	}

	*o = NetworkDeviceIntentResponse(varNetworkDeviceIntentResponse)
...
type NullableNetworkDeviceIntentResponse struct {
	value *NetworkDeviceIntentResponse
	isSet bool
}

func (v NullableNetworkDeviceIntentResponse) Get() *NetworkDeviceIntentResponse {
	return v.value
}

func (v *NullableNetworkDeviceIntentResponse) Set(val *NetworkDeviceIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDeviceIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDeviceIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDeviceIntentResponse(val *NetworkDeviceIntentResponse) *NullableNetworkDeviceIntentResponse {
	return &NullableNetworkDeviceIntentResponse{value: val, isSet: true}
}

func (v NullableNetworkDeviceIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDeviceIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
