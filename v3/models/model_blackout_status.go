...
// checks if the BlackoutStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackoutStatus{}

// BlackoutStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _BlackoutStatus BlackoutStatus
...
func (o BlackoutStatus) MarshalJSON() ([]byte, error) {
...
func (o BlackoutStatus) ToMap() (map[string]interface{}, error) {
...
func (o *BlackoutStatus) UnmarshalJSON(data []byte) (err error) {
	varBlackoutStatus := _BlackoutStatus{}

	err = json.Unmarshal(data, &varBlackoutStatus)

	if err != nil {
		return err
	}

	*o = BlackoutStatus(varBlackoutStatus)
...
type NullableBlackoutStatus struct {
	value *BlackoutStatus
	isSet bool
}

func (v NullableBlackoutStatus) Get() *BlackoutStatus {
	return v.value
}

func (v *NullableBlackoutStatus) Set(val *BlackoutStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableBlackoutStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableBlackoutStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlackoutStatus(val *BlackoutStatus) *NullableBlackoutStatus {
	return &NullableBlackoutStatus{value: val, isSet: true}
}

func (v NullableBlackoutStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlackoutStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
