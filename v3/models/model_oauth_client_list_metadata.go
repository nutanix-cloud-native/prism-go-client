...
// checks if the OauthClientListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthClientListMetadata{}
...
type _OauthClientListMetadata OauthClientListMetadata
...
func (o OauthClientListMetadata) MarshalJSON() ([]byte, error) {
...
func (o OauthClientListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *OauthClientListMetadata) UnmarshalJSON(data []byte) (err error) {
	varOauthClientListMetadata := _OauthClientListMetadata{}

	err = json.Unmarshal(data, &varOauthClientListMetadata)

	if err != nil {
		return err
	}

	*o = OauthClientListMetadata(varOauthClientListMetadata)
...
type NullableOauthClientListMetadata struct {
	value *OauthClientListMetadata
	isSet bool
}

func (v NullableOauthClientListMetadata) Get() *OauthClientListMetadata {
	return v.value
}

func (v *NullableOauthClientListMetadata) Set(val *OauthClientListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthClientListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthClientListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthClientListMetadata(val *OauthClientListMetadata) *NullableOauthClientListMetadata {
	return &NullableOauthClientListMetadata{value: val, isSet: true}
}

func (v NullableOauthClientListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthClientListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
