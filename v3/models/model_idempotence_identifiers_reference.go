...
// checks if the IdempotenceIdentifiersReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdempotenceIdentifiersReference{}

// IdempotenceIdentifiersReference The reference to a idempotence_identifiers
...
type _IdempotenceIdentifiersReference IdempotenceIdentifiersReference
...
func NewIdempotenceIdentifiersReference(kind string, uUID string) *IdempotenceIdentifiersReference {
	this := IdempotenceIdentifiersReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o IdempotenceIdentifiersReference) MarshalJSON() ([]byte, error) {
...
func (o IdempotenceIdentifiersReference) ToMap() (map[string]interface{}, error) {
...
func (o *IdempotenceIdentifiersReference) UnmarshalJSON(data []byte) (err error) {
	...
	varIdempotenceIdentifiersReference := _IdempotenceIdentifiersReference{}

	err = json.Unmarshal(data, &varIdempotenceIdentifiersReference)

	if err != nil {
		return err
	}

	*o = IdempotenceIdentifiersReference(varIdempotenceIdentifiersReference)
...
type NullableIdempotenceIdentifiersReference struct {
	value *IdempotenceIdentifiersReference
	isSet bool
}

func (v NullableIdempotenceIdentifiersReference) Get() *IdempotenceIdentifiersReference {
	return v.value
}

func (v *NullableIdempotenceIdentifiersReference) Set(val *IdempotenceIdentifiersReference) {
	v.value = val
	v.isSet = true
}

func (v NullableIdempotenceIdentifiersReference) IsSet() bool {
	return v.isSet
}

func (v *NullableIdempotenceIdentifiersReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdempotenceIdentifiersReference(val *IdempotenceIdentifiersReference) *NullableIdempotenceIdentifiersReference {
	return &NullableIdempotenceIdentifiersReference{value: val, isSet: true}
}

func (v NullableIdempotenceIdentifiersReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdempotenceIdentifiersReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
