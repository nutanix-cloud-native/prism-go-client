...
// checks if the HelpResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HelpResult{}

// HelpResult Help result object definition.
type HelpResult struct {
	// URL of the help page from.
	Url *string `json:"url,omitempty"`
	// List of ancestor urls for the help page.
	AncestorUrlList []string `json:"ancestor_url_list,omitempty"`
	// List of ancestor titles for the help page.
	AncestorTitleList []string `json:"ancestor_title_list,omitempty"`
	// List of highlights for the help page.
	HighlightList []string `json:"highlight_list,omitempty"`
	// Title fo the help result.
	Title *string `json:"title,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _HelpResult HelpResult
...
// GetAncestorUrlList returns the AncestorUrlList field value if set, zero value otherwise.
func (o *HelpResult) GetAncestorUrlList() []string {
	if o == nil || IsNil(o.AncestorUrlList) {
		var ret []string
		return ret
	}
	return o.AncestorUrlList
}

// GetAncestorUrlListOk returns a tuple with the AncestorUrlList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HelpResult) GetAncestorUrlListOk() ([]string, bool) {
	if o == nil || IsNil(o.AncestorUrlList) {
		return nil, false
	}
	return o.AncestorUrlList, true
}
...
// SetAncestorUrlList gets a reference to the given []string and assigns it to the AncestorUrlList field.
func (o *HelpResult) SetAncestorUrlList(v []string) {
	o.AncestorUrlList = v
}

// GetAncestorTitleList returns the AncestorTitleList field value if set, zero value otherwise.
func (o *HelpResult) GetAncestorTitleList() []string {
	if o == nil || IsNil(o.AncestorTitleList) {
		var ret []string
		return ret
	}
	return o.AncestorTitleList
}

// GetAncestorTitleListOk returns a tuple with the AncestorTitleList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HelpResult) GetAncestorTitleListOk() ([]string, bool) {
	if o == nil || IsNil(o.AncestorTitleList) {
		return nil, false
	}
	return o.AncestorTitleList, true
}
...
// SetAncestorTitleList gets a reference to the given []string and assigns it to the AncestorTitleList field.
func (o *HelpResult) SetAncestorTitleList(v []string) {
	o.AncestorTitleList = v
}

// GetHighlightList returns the HighlightList field value if set, zero value otherwise.
func (o *HelpResult) GetHighlightList() []string {
	if o == nil || IsNil(o.HighlightList) {
		var ret []string
		return ret
	}
	return o.HighlightList
}

// GetHighlightListOk returns a tuple with the HighlightList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HelpResult) GetHighlightListOk() ([]string, bool) {
	if o == nil || IsNil(o.HighlightList) {
		return nil, false
	}
	return o.HighlightList, true
}
...
// SetHighlightList gets a reference to the given []string and assigns it to the HighlightList field.
...
func (o HelpResult) MarshalJSON() ([]byte, error) {
...
func (o HelpResult) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Url) {
		toSerialize["url"] = o.Url
	}
	if !IsNil(o.AncestorUrlList) {
		toSerialize["ancestor_url_list"] = o.AncestorUrlList
	}
	if !IsNil(o.AncestorTitleList) {
		toSerialize["ancestor_title_list"] = o.AncestorTitleList
	}
	if !IsNil(o.HighlightList) {
		toSerialize["highlight_list"] = o.HighlightList
	}
	if !IsNil(o.Title) {
...
func (o *HelpResult) UnmarshalJSON(data []byte) (err error) {
	varHelpResult := _HelpResult{}

	err = json.Unmarshal(data, &varHelpResult)

	if err != nil {
		return err
	}

	*o = HelpResult(varHelpResult)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "url")
		delete(additionalProperties, "ancestor_url_list")
		delete(additionalProperties, "ancestor_title_list")
		delete(additionalProperties, "highlight_list")
...
type NullableHelpResult struct {
	value *HelpResult
	isSet bool
}

func (v NullableHelpResult) Get() *HelpResult {
	return v.value
}

func (v *NullableHelpResult) Set(val *HelpResult) {
	v.value = val
	v.isSet = true
}

func (v NullableHelpResult) IsSet() bool {
	return v.isSet
}

func (v *NullableHelpResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHelpResult(val *HelpResult) *NullableHelpResult {
	return &NullableHelpResult{value: val, isSet: true}
}

func (v NullableHelpResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHelpResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
