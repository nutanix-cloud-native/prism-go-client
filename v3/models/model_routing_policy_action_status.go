...
// checks if the RoutingPolicyActionStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyActionStatus{}

// RoutingPolicyActionStatus Routing policy action
type RoutingPolicyActionStatus struct {
	...
	// Flag denoting reroute fallback action when service VM is down. This field is valid only when action is REROUTE. Default reroute fallback action is PASSTHROUGH. 
	RerouteFallback *string `json:"reroute_fallback,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RoutingPolicyActionStatus RoutingPolicyActionStatus
...
func NewRoutingPolicyActionStatus(action string) *RoutingPolicyActionStatus {
	this := RoutingPolicyActionStatus{}
	this.Action = action
	return &this
}
...
// GetServiceIpList returns the ServiceIpList field value if set, zero value otherwise.
func (o *RoutingPolicyActionStatus) GetServiceIpList() []string {
	if o == nil || IsNil(o.ServiceIpList) {
		var ret []string
		return ret
	}
	return o.ServiceIpList
}

// GetServiceIpListOk returns a tuple with the ServiceIpList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyActionStatus) GetServiceIpListOk() ([]string, bool) {
	if o == nil || IsNil(o.ServiceIpList) {
		return nil, false
	}
	return o.ServiceIpList, true
}
...
// SetServiceIpList gets a reference to the given []string and assigns it to the ServiceIpList field.
func (o *RoutingPolicyActionStatus) SetServiceIpList(v []string) {
	o.ServiceIpList = v
}

// GetRerouteFallback returns the RerouteFallback field value if set, zero value otherwise.
func (o *RoutingPolicyActionStatus) GetRerouteFallback() string {
	if o == nil || IsNil(o.RerouteFallback) {
		var ret string
		return ret
	}
	return *o.RerouteFallback
}

// GetRerouteFallbackOk returns a tuple with the RerouteFallback field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoutingPolicyActionStatus) GetRerouteFallbackOk() (*string, bool) {
	if o == nil || IsNil(o.RerouteFallback) {
		return nil, false
	}
	return o.RerouteFallback, true
}
...
// SetRerouteFallback gets a reference to the given string and assigns it to the RerouteFallback field.
func (o *RoutingPolicyActionStatus) SetRerouteFallback(v string) {
	o.RerouteFallback = &v
}

func (o RoutingPolicyActionStatus) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyActionStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["action"] = o.Action
	if !IsNil(o.ServiceIpList) {
		toSerialize["service_ip_list"] = o.ServiceIpList
	}
	if !IsNil(o.RerouteFallback) {
		toSerialize["reroute_fallback"] = o.RerouteFallback
	}
...
func (o *RoutingPolicyActionStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingPolicyActionStatus := _RoutingPolicyActionStatus{}

	err = json.Unmarshal(data, &varRoutingPolicyActionStatus)

	if err != nil {
		return err
	}

	*o = RoutingPolicyActionStatus(varRoutingPolicyActionStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "action")
		delete(additionalProperties, "service_ip_list")
		delete(additionalProperties, "reroute_fallback")
...
type NullableRoutingPolicyActionStatus struct {
	value *RoutingPolicyActionStatus
	isSet bool
}

func (v NullableRoutingPolicyActionStatus) Get() *RoutingPolicyActionStatus {
	return v.value
}

func (v *NullableRoutingPolicyActionStatus) Set(val *RoutingPolicyActionStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyActionStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyActionStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyActionStatus(val *RoutingPolicyActionStatus) *NullableRoutingPolicyActionStatus {
	return &NullableRoutingPolicyActionStatus{value: val, isSet: true}
}

func (v NullableRoutingPolicyActionStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyActionStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
