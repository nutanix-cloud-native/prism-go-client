...
// checks if the ActionRuleResultListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResultListIntentResponse{}

// ActionRuleResultListIntentResponse Response object for intentful operation of action_rule_results
type ActionRuleResultListIntentResponse struct {
	Entities []ActionRuleResultIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ActionRuleResultListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ActionRuleResultListIntentResponse ActionRuleResultListIntentResponse
...
func NewActionRuleResultListIntentResponse(apiVersion string, metadata ActionRuleResultListMetadataOutput) *ActionRuleResultListIntentResponse {
	this := ActionRuleResultListIntentResponse{}
...
func (o *ActionRuleResultListIntentResponse) GetEntities() []ActionRuleResultIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []ActionRuleResultIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []ActionRuleResultIntentResource and assigns it to the Entities field.
...
func (o *ActionRuleResultListIntentResponse) GetMetadata() ActionRuleResultListMetadataOutput {
	if o == nil {
		var ret ActionRuleResultListMetadataOutput
		return ret
	}
...
func (o ActionRuleResultListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResultListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleResultListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleResultListIntentResponse := _ActionRuleResultListIntentResponse{}

	err = json.Unmarshal(data, &varActionRuleResultListIntentResponse)

	if err != nil {
		return err
	}

	*o = ActionRuleResultListIntentResponse(varActionRuleResultListIntentResponse)
...
type NullableActionRuleResultListIntentResponse struct {
	value *ActionRuleResultListIntentResponse
	isSet bool
}

func (v NullableActionRuleResultListIntentResponse) Get() *ActionRuleResultListIntentResponse {
	return v.value
}

func (v *NullableActionRuleResultListIntentResponse) Set(val *ActionRuleResultListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResultListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResultListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResultListIntentResponse(val *ActionRuleResultListIntentResponse) *NullableActionRuleResultListIntentResponse {
	return &NullableActionRuleResultListIntentResponse{value: val, isSet: true}
}

func (v NullableActionRuleResultListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResultListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
