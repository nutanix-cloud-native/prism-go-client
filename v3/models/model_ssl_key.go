...
// checks if the SslKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SslKey{}
...
// GetSigningInfo returns the SigningInfo field value if set, zero value otherwise.
func (o *SslKey) GetSigningInfo() CertificationSigningInfo {
	if o == nil || IsNil(o.SigningInfo) {
		var ret CertificationSigningInfo
		return ret
	}
	return *o.SigningInfo
}

// GetSigningInfoOk returns a tuple with the SigningInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SslKey) GetSigningInfoOk() (*CertificationSigningInfo, bool) {
	if o == nil || IsNil(o.SigningInfo) {
		return nil, false
	}
	return o.SigningInfo, true
}
...
// SetSigningInfo gets a reference to the given CertificationSigningInfo and assigns it to the SigningInfo field.
...
// SetExpireDatetime gets a reference to the given time.Time and assigns it to the ExpireDatetime field.
func (o *SslKey) SetExpireDatetime(v time.Time) {
	o.ExpireDatetime = &v
}

func (o SslKey) MarshalJSON() ([]byte, error) {
...
func (o SslKey) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["key_type"] = o.KeyType
	if !IsNil(o.KeyName) {
		toSerialize["key_name"] = o.KeyName
	}
	if !IsNil(o.SigningInfo) {
		toSerialize["signing_info"] = o.SigningInfo
	}
	if !IsNil(o.ExpireDatetime) {
		toSerialize["expire_datetime"] = o.ExpireDatetime
	}
...
func (o *SslKey) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSslKey)
	...
	*o = SslKey(varSslKey)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "signing_info")
		delete(additionalProperties, "expire_datetime")
...
type NullableSslKey struct {
	value *SslKey
	isSet bool
}

func (v NullableSslKey) Get() *SslKey {
	return v.value
}

func (v *NullableSslKey) Set(val *SslKey) {
	v.value = val
	v.isSet = true
}

func (v NullableSslKey) IsSet() bool {
	return v.isSet
}

func (v *NullableSslKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSslKey(val *SslKey) *NullableSslKey {
	return &NullableSslKey{value: val, isSet: true}
}

func (v NullableSslKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSslKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
