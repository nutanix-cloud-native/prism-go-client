...
// checks if the AppActionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppActionResponse{}

// AppActionResponse Action definition for Application
type AppActionResponse struct {
	...
	Runbook *AppRunbookResponse `json:"runbook,omitempty"`
	// 
...
type _AppActionResponse AppActionResponse
...
// SetRunbook gets a reference to the given AppRunbookResponse and assigns it to the Runbook field.
...
func (o AppActionResponse) MarshalJSON() ([]byte, error) {
...
func (o AppActionResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppActionResponse) UnmarshalJSON(data []byte) (err error) {
	varAppActionResponse := _AppActionResponse{}

	err = json.Unmarshal(data, &varAppActionResponse)

	if err != nil {
		return err
	}

	*o = AppActionResponse(varAppActionResponse)
...
type NullableAppActionResponse struct {
	value *AppActionResponse
	isSet bool
}

func (v NullableAppActionResponse) Get() *AppActionResponse {
	return v.value
}

func (v *NullableAppActionResponse) Set(val *AppActionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppActionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppActionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppActionResponse(val *AppActionResponse) *NullableAppActionResponse {
	return &NullableAppActionResponse{value: val, isSet: true}
}

func (v NullableAppActionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppActionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
