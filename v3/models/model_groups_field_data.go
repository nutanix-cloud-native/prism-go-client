...
// checks if the GroupsFieldData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupsFieldData{}
...
type _GroupsFieldData GroupsFieldData
...
// SetBuckets gets a reference to the given map[string]int64 and assigns it to the Buckets field.
...
// SetValues gets a reference to the given []GroupsTimevaluePair and assigns it to the Values field.
...
func (o GroupsFieldData) MarshalJSON() ([]byte, error) {
...
func (o GroupsFieldData) ToMap() (map[string]interface{}, error) {
...
func (o *GroupsFieldData) UnmarshalJSON(data []byte) (err error) {
	varGroupsFieldData := _GroupsFieldData{}

	err = json.Unmarshal(data, &varGroupsFieldData)

	if err != nil {
		return err
	}

	*o = GroupsFieldData(varGroupsFieldData)
...
type NullableGroupsFieldData struct {
	value *GroupsFieldData
	isSet bool
}

func (v NullableGroupsFieldData) Get() *GroupsFieldData {
	return v.value
}

func (v *NullableGroupsFieldData) Set(val *GroupsFieldData) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupsFieldData) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupsFieldData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupsFieldData(val *GroupsFieldData) *NullableGroupsFieldData {
	return &NullableGroupsFieldData{value: val, isSet: true}
}

func (v NullableGroupsFieldData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupsFieldData) UnmarshalJSON(src []byte) error {
	v.isSet = true
