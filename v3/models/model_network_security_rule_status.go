...
// checks if the NetworkSecurityRuleStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSecurityRuleStatus{}
...
type _NetworkSecurityRuleStatus NetworkSecurityRuleStatus
...
func NewNetworkSecurityRuleStatus() *NetworkSecurityRuleStatus {
	this := NetworkSecurityRuleStatus{}
	return &this
}
...
func (o NetworkSecurityRuleStatus) MarshalJSON() ([]byte, error) {
...
func (o NetworkSecurityRuleStatus) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkSecurityRuleStatus) UnmarshalJSON(data []byte) (err error) {
	varNetworkSecurityRuleStatus := _NetworkSecurityRuleStatus{}

	err = json.Unmarshal(data, &varNetworkSecurityRuleStatus)

	if err != nil {
		return err
	}

	*o = NetworkSecurityRuleStatus(varNetworkSecurityRuleStatus)
...
type NullableNetworkSecurityRuleStatus struct {
	value *NetworkSecurityRuleStatus
	isSet bool
}

func (v NullableNetworkSecurityRuleStatus) Get() *NetworkSecurityRuleStatus {
	return v.value
}

func (v *NullableNetworkSecurityRuleStatus) Set(val *NetworkSecurityRuleStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkSecurityRuleStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkSecurityRuleStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkSecurityRuleStatus(val *NetworkSecurityRuleStatus) *NullableNetworkSecurityRuleStatus {
	return &NullableNetworkSecurityRuleStatus{value: val, isSet: true}
}

func (v NullableNetworkSecurityRuleStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkSecurityRuleStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
