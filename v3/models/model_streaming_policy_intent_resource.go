...
// checks if the StreamingPolicyIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyIntentResource{}

// StreamingPolicyIntentResource Response object for intentful operations on a streaming_policy
type StreamingPolicyIntentResource struct {
	Status *StreamingPolicyDefStatus `json:"status,omitempty"`
	Spec *StreamingPolicy `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata StreamingPolicyMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _StreamingPolicyIntentResource StreamingPolicyIntentResource
...
func NewStreamingPolicyIntentResource(metadata StreamingPolicyMetadata) *StreamingPolicyIntentResource {
	this := StreamingPolicyIntentResource{}
...
func (o *StreamingPolicyIntentResource) GetStatus() StreamingPolicyDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret StreamingPolicyDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given StreamingPolicyDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given StreamingPolicy and assigns it to the Spec field.
...
func (o *StreamingPolicyIntentResource) GetMetadata() StreamingPolicyMetadata {
	if o == nil {
		var ret StreamingPolicyMetadata
		return ret
	}
...
func (o StreamingPolicyIntentResource) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicyIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varStreamingPolicyIntentResource := _StreamingPolicyIntentResource{}

	err = json.Unmarshal(data, &varStreamingPolicyIntentResource)

	if err != nil {
		return err
	}

	*o = StreamingPolicyIntentResource(varStreamingPolicyIntentResource)
...
type NullableStreamingPolicyIntentResource struct {
	value *StreamingPolicyIntentResource
	isSet bool
}

func (v NullableStreamingPolicyIntentResource) Get() *StreamingPolicyIntentResource {
	return v.value
}

func (v *NullableStreamingPolicyIntentResource) Set(val *StreamingPolicyIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyIntentResource(val *StreamingPolicyIntentResource) *NullableStreamingPolicyIntentResource {
	return &NullableStreamingPolicyIntentResource{value: val, isSet: true}
}

func (v NullableStreamingPolicyIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
