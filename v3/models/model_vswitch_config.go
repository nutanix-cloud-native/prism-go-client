...
// checks if the VswitchConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VswitchConfig{}
...
type _VswitchConfig VswitchConfig
...
func NewVswitchConfig(nicTeamingPolicy string, uplinkGrouping string) *VswitchConfig {
	...
	this.UplinkGrouping = uplinkGrouping
	return &this
}
...
// GetNicTeamingPolicy returns the NicTeamingPolicy field value
func (o *VswitchConfig) GetNicTeamingPolicy() string {
	...
	return o.NicTeamingPolicy
}

// GetNicTeamingPolicyOk returns a tuple with the NicTeamingPolicy field value
// and a boolean to check if the value has been set.
func (o *VswitchConfig) GetNicTeamingPolicyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.NicTeamingPolicy, true
}

// SetNicTeamingPolicy sets field value
func (o *VswitchConfig) SetNicTeamingPolicy(v string) {
	o.NicTeamingPolicy = v
}

// GetUplinkGrouping returns the UplinkGrouping field value
func (o *VswitchConfig) GetUplinkGrouping() string {
	...
	return o.UplinkGrouping
}

// GetUplinkGroupingOk returns a tuple with the UplinkGrouping field value
// and a boolean to check if the value has been set.
func (o *VswitchConfig) GetUplinkGroupingOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UplinkGrouping, true
}

// SetUplinkGrouping sets field value
func (o *VswitchConfig) SetUplinkGrouping(v string) {
	o.UplinkGrouping = v
}

func (o VswitchConfig) MarshalJSON() ([]byte, error) {
...
func (o VswitchConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["nic_teaming_policy"] = o.NicTeamingPolicy
	toSerialize["uplink_grouping"] = o.UplinkGrouping
...
func (o *VswitchConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varVswitchConfig := _VswitchConfig{}

	err = json.Unmarshal(data, &varVswitchConfig)

	if err != nil {
		return err
	}

	*o = VswitchConfig(varVswitchConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "nic_teaming_policy")
		delete(additionalProperties, "uplink_grouping")
...
type NullableVswitchConfig struct {
	value *VswitchConfig
	isSet bool
}

func (v NullableVswitchConfig) Get() *VswitchConfig {
	return v.value
}

func (v *NullableVswitchConfig) Set(val *VswitchConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableVswitchConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableVswitchConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVswitchConfig(val *VswitchConfig) *NullableVswitchConfig {
	return &NullableVswitchConfig{value: val, isSet: true}
}

func (v NullableVswitchConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVswitchConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
