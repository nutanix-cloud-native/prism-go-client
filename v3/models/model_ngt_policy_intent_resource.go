...
// checks if the NgtPolicyIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NgtPolicyIntentResource{}

// NgtPolicyIntentResource Response object for intentful operations on a ngt_policy
type NgtPolicyIntentResource struct {
...
type _NgtPolicyIntentResource NgtPolicyIntentResource
...
func (o NgtPolicyIntentResource) MarshalJSON() ([]byte, error) {
...
func (o NgtPolicyIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *NgtPolicyIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varNgtPolicyIntentResource := _NgtPolicyIntentResource{}

	err = json.Unmarshal(data, &varNgtPolicyIntentResource)

	if err != nil {
		return err
	}

	*o = NgtPolicyIntentResource(varNgtPolicyIntentResource)
...
type NullableNgtPolicyIntentResource struct {
	value *NgtPolicyIntentResource
	isSet bool
}

func (v NullableNgtPolicyIntentResource) Get() *NgtPolicyIntentResource {
	return v.value
}

func (v *NullableNgtPolicyIntentResource) Set(val *NgtPolicyIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableNgtPolicyIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableNgtPolicyIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNgtPolicyIntentResource(val *NgtPolicyIntentResource) *NullableNgtPolicyIntentResource {
	return &NullableNgtPolicyIntentResource{value: val, isSet: true}
}

func (v NullableNgtPolicyIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNgtPolicyIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
