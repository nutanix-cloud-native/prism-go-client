...
// checks if the AwsVolumeTypeListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVolumeTypeListMetadata{}

// AwsVolumeTypeListMetadata All api calls that return a list will have this metadata block as input 
type AwsVolumeTypeListMetadata struct {
	// The kind name
...
type _AwsVolumeTypeListMetadata AwsVolumeTypeListMetadata
...
func NewAwsVolumeTypeListMetadata() *AwsVolumeTypeListMetadata {
	this := AwsVolumeTypeListMetadata{}
...
func (o AwsVolumeTypeListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsVolumeTypeListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVolumeTypeListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsVolumeTypeListMetadata := _AwsVolumeTypeListMetadata{}

	err = json.Unmarshal(data, &varAwsVolumeTypeListMetadata)

	if err != nil {
		return err
	}

	*o = AwsVolumeTypeListMetadata(varAwsVolumeTypeListMetadata)
...
type NullableAwsVolumeTypeListMetadata struct {
	value *AwsVolumeTypeListMetadata
	isSet bool
}

func (v NullableAwsVolumeTypeListMetadata) Get() *AwsVolumeTypeListMetadata {
	return v.value
}

func (v *NullableAwsVolumeTypeListMetadata) Set(val *AwsVolumeTypeListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVolumeTypeListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVolumeTypeListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVolumeTypeListMetadata(val *AwsVolumeTypeListMetadata) *NullableAwsVolumeTypeListMetadata {
	return &NullableAwsVolumeTypeListMetadata{value: val, isSet: true}
}

func (v NullableAwsVolumeTypeListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVolumeTypeListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
