...
// checks if the RemoteConnectionIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionIntentResource{}

// RemoteConnectionIntentResource Response object for intentful operations on a remote_connection
type RemoteConnectionIntentResource struct {
	Status *RemoteConnectionDefStatus `json:"status,omitempty"`
	Spec *RemoteConnection `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata RemoteConnectionMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RemoteConnectionIntentResource RemoteConnectionIntentResource
...
func NewRemoteConnectionIntentResource(metadata RemoteConnectionMetadata) *RemoteConnectionIntentResource {
	this := RemoteConnectionIntentResource{}
...
func (o *RemoteConnectionIntentResource) GetStatus() RemoteConnectionDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret RemoteConnectionDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given RemoteConnectionDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given RemoteConnection and assigns it to the Spec field.
...
func (o *RemoteConnectionIntentResource) GetMetadata() RemoteConnectionMetadata {
	if o == nil {
		var ret RemoteConnectionMetadata
		return ret
	}
...
func (o RemoteConnectionIntentResource) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteConnectionIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteConnectionIntentResource := _RemoteConnectionIntentResource{}

	err = json.Unmarshal(data, &varRemoteConnectionIntentResource)

	if err != nil {
		return err
	}

	*o = RemoteConnectionIntentResource(varRemoteConnectionIntentResource)
...
type NullableRemoteConnectionIntentResource struct {
	value *RemoteConnectionIntentResource
	isSet bool
}

func (v NullableRemoteConnectionIntentResource) Get() *RemoteConnectionIntentResource {
	return v.value
}

func (v *NullableRemoteConnectionIntentResource) Set(val *RemoteConnectionIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionIntentResource(val *RemoteConnectionIntentResource) *NullableRemoteConnectionIntentResource {
	return &NullableRemoteConnectionIntentResource{value: val, isSet: true}
}

func (v NullableRemoteConnectionIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
