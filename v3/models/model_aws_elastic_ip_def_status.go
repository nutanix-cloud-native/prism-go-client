...
// checks if the AwsElasticIpDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsElasticIpDefStatus{}

// AwsElasticIpDefStatus aws_elastic_ip resources status
type AwsElasticIpDefStatus struct {
	State *string `json:"state,omitempty"`
	// aws_elastic_ip name.
	Name *string `json:"name,omitempty"`
	Resources *AwsElasticIpResourcesDefStatus `json:"resources,omitempty"`
	// A description for aws_elastic_ip.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AwsElasticIpDefStatus AwsElasticIpDefStatus
...
func (o *AwsElasticIpDefStatus) GetResources() AwsElasticIpResourcesDefStatus {
	if o == nil || IsNil(o.Resources) {
		var ret AwsElasticIpResourcesDefStatus
		return ret
	}
	return *o.Resources
}
...
// SetResources gets a reference to the given AwsElasticIpResourcesDefStatus and assigns it to the Resources field.
...
func (o AwsElasticIpDefStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsElasticIpDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsElasticIpDefStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsElasticIpDefStatus := _AwsElasticIpDefStatus{}

	err = json.Unmarshal(data, &varAwsElasticIpDefStatus)

	if err != nil {
		return err
	}

	*o = AwsElasticIpDefStatus(varAwsElasticIpDefStatus)
...
type NullableAwsElasticIpDefStatus struct {
	value *AwsElasticIpDefStatus
	isSet bool
}

func (v NullableAwsElasticIpDefStatus) Get() *AwsElasticIpDefStatus {
	return v.value
}

func (v *NullableAwsElasticIpDefStatus) Set(val *AwsElasticIpDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsElasticIpDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsElasticIpDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsElasticIpDefStatus(val *AwsElasticIpDefStatus) *NullableAwsElasticIpDefStatus {
	return &NullableAwsElasticIpDefStatus{value: val, isSet: true}
}

func (v NullableAwsElasticIpDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsElasticIpDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
