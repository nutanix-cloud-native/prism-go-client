...
// checks if the RemoteSyslogServerIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteSyslogServerIntentInput{}

// RemoteSyslogServerIntentInput An intentful representation of a remote_syslog_server
type RemoteSyslogServerIntentInput struct {
	Spec RemoteSyslogServer `json:"spec"`
...
type _RemoteSyslogServerIntentInput RemoteSyslogServerIntentInput
...
func NewRemoteSyslogServerIntentInput(spec RemoteSyslogServer, metadata RemoteSyslogServerMetadata) *RemoteSyslogServerIntentInput {
	this := RemoteSyslogServerIntentInput{}
	this.Spec = spec
...
func (o RemoteSyslogServerIntentInput) MarshalJSON() ([]byte, error) {
...
func (o RemoteSyslogServerIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteSyslogServerIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteSyslogServerIntentInput := _RemoteSyslogServerIntentInput{}

	err = json.Unmarshal(data, &varRemoteSyslogServerIntentInput)

	if err != nil {
		return err
	}

	*o = RemoteSyslogServerIntentInput(varRemoteSyslogServerIntentInput)
...
type NullableRemoteSyslogServerIntentInput struct {
	value *RemoteSyslogServerIntentInput
	isSet bool
}

func (v NullableRemoteSyslogServerIntentInput) Get() *RemoteSyslogServerIntentInput {
	return v.value
}

func (v *NullableRemoteSyslogServerIntentInput) Set(val *RemoteSyslogServerIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteSyslogServerIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteSyslogServerIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteSyslogServerIntentInput(val *RemoteSyslogServerIntentInput) *NullableRemoteSyslogServerIntentInput {
	return &NullableRemoteSyslogServerIntentInput{value: val, isSet: true}
}

func (v NullableRemoteSyslogServerIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteSyslogServerIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
