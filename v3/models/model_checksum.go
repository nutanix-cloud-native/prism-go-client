...
// GetChecksumAlgorithm returns the ChecksumAlgorithm field value
...
// GetChecksumAlgorithmOk returns a tuple with the ChecksumAlgorithm field value
...
// SetChecksumAlgorithm sets field value
func (o *Checksum) SetChecksumAlgorithm(v string) {
	o.ChecksumAlgorithm = v
}

// GetChecksumValue returns the ChecksumValue field value
func (o *Checksum) GetChecksumValue() string {
	...
	return o.ChecksumValue
}

// GetChecksumValueOk returns a tuple with the ChecksumValue field value
// and a boolean to check if the value has been set.
func (o *Checksum) GetChecksumValueOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ChecksumValue, true
}

// SetChecksumValue sets field value
...
func (o Checksum) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["checksum_value"] = o.ChecksumValue
...
func (o *Checksum) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varChecksum)
	...
	*o = Checksum(varChecksum)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "checksum_algorithm")
		delete(additionalProperties, "checksum_value")
