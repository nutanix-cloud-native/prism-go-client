...
// checks if the AppCustomIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCustomIntentInput{}

// AppCustomIntentInput An intentful representation of an app
type AppCustomIntentInput struct {
...
type _AppCustomIntentInput AppCustomIntentInput
...
func (o AppCustomIntentInput) MarshalJSON() ([]byte, error) {
...
func (o AppCustomIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppCustomIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCustomIntentInput := _AppCustomIntentInput{}

	err = json.Unmarshal(data, &varAppCustomIntentInput)

	if err != nil {
		return err
	}

	*o = AppCustomIntentInput(varAppCustomIntentInput)
...
type NullableAppCustomIntentInput struct {
	value *AppCustomIntentInput
	isSet bool
}

func (v NullableAppCustomIntentInput) Get() *AppCustomIntentInput {
	return v.value
}

func (v *NullableAppCustomIntentInput) Set(val *AppCustomIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCustomIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCustomIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCustomIntentInput(val *AppCustomIntentInput) *NullableAppCustomIntentInput {
	return &NullableAppCustomIntentInput{value: val, isSet: true}
}

func (v NullableAppCustomIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCustomIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
