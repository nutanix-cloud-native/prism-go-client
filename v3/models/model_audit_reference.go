...
// checks if the AuditReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditReference{}

// AuditReference The reference to a audit
...
type _AuditReference AuditReference
...
func (o AuditReference) MarshalJSON() ([]byte, error) {
...
func (o AuditReference) ToMap() (map[string]interface{}, error) {
...
func (o *AuditReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditReference := _AuditReference{}

	err = json.Unmarshal(data, &varAuditReference)

	if err != nil {
		return err
	}

	*o = AuditReference(varAuditReference)
...
type NullableAuditReference struct {
	value *AuditReference
	isSet bool
}

func (v NullableAuditReference) Get() *AuditReference {
	return v.value
}

func (v *NullableAuditReference) Set(val *AuditReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditReference(val *AuditReference) *NullableAuditReference {
	return &NullableAuditReference{value: val, isSet: true}
}

func (v NullableAuditReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
