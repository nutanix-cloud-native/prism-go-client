...
// checks if the AttachmentReferenceOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttachmentReferenceOutput{}

// AttachmentReferenceOutput Attached iSCSI initiators.
type AttachmentReferenceOutput struct {
	// IPv4 address of the external client.
	IscsiInitiatorNetworkId *string `json:"iscsi_initiator_network_id,omitempty"`
	// Which authentication is enabled for client.
...
type _AttachmentReferenceOutput AttachmentReferenceOutput
...
func NewAttachmentReferenceOutput() *AttachmentReferenceOutput {
	this := AttachmentReferenceOutput{}
	return &this
}
...
// GetIscsiInitiatorNetworkId returns the IscsiInitiatorNetworkId field value if set, zero value otherwise.
func (o *AttachmentReferenceOutput) GetIscsiInitiatorNetworkId() string {
	if o == nil || IsNil(o.IscsiInitiatorNetworkId) {
		var ret string
		return ret
	}
	return *o.IscsiInitiatorNetworkId
}

// GetIscsiInitiatorNetworkIdOk returns a tuple with the IscsiInitiatorNetworkId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AttachmentReferenceOutput) GetIscsiInitiatorNetworkIdOk() (*string, bool) {
	if o == nil || IsNil(o.IscsiInitiatorNetworkId) {
		return nil, false
	}
	return o.IscsiInitiatorNetworkId, true
}
...
// SetIscsiInitiatorNetworkId gets a reference to the given string and assigns it to the IscsiInitiatorNetworkId field.
func (o *AttachmentReferenceOutput) SetIscsiInitiatorNetworkId(v string) {
	o.IscsiInitiatorNetworkId = &v
}
...
// GetIscsiInitiatorName returns the IscsiInitiatorName field value if set, zero value otherwise.
func (o *AttachmentReferenceOutput) GetIscsiInitiatorName() string {
	if o == nil || IsNil(o.IscsiInitiatorName) {
		var ret string
		return ret
	}
	return *o.IscsiInitiatorName
}

// GetIscsiInitiatorNameOk returns a tuple with the IscsiInitiatorName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AttachmentReferenceOutput) GetIscsiInitiatorNameOk() (*string, bool) {
	if o == nil || IsNil(o.IscsiInitiatorName) {
		return nil, false
	}
	return o.IscsiInitiatorName, true
}
...
// SetIscsiInitiatorName gets a reference to the given string and assigns it to the IscsiInitiatorName field.
func (o *AttachmentReferenceOutput) SetIscsiInitiatorName(v string) {
	o.IscsiInitiatorName = &v
}

func (o AttachmentReferenceOutput) MarshalJSON() ([]byte, error) {
...
func (o AttachmentReferenceOutput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IscsiInitiatorNetworkId) {
		toSerialize["iscsi_initiator_network_id"] = o.IscsiInitiatorNetworkId
	}
	...
	if !IsNil(o.IscsiInitiatorName) {
		toSerialize["iscsi_initiator_name"] = o.IscsiInitiatorName
	}
...
func (o *AttachmentReferenceOutput) UnmarshalJSON(data []byte) (err error) {
	varAttachmentReferenceOutput := _AttachmentReferenceOutput{}

	err = json.Unmarshal(data, &varAttachmentReferenceOutput)

	if err != nil {
		return err
	}

	*o = AttachmentReferenceOutput(varAttachmentReferenceOutput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "iscsi_initiator_network_id")
		delete(additionalProperties, "enabled_authentications")
		delete(additionalProperties, "vm_reference")
		delete(additionalProperties, "iscsi_initiator_name")
...
type NullableAttachmentReferenceOutput struct {
	value *AttachmentReferenceOutput
	isSet bool
}

func (v NullableAttachmentReferenceOutput) Get() *AttachmentReferenceOutput {
	return v.value
}

func (v *NullableAttachmentReferenceOutput) Set(val *AttachmentReferenceOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAttachmentReferenceOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAttachmentReferenceOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttachmentReferenceOutput(val *AttachmentReferenceOutput) *NullableAttachmentReferenceOutput {
	return &NullableAttachmentReferenceOutput{value: val, isSet: true}
}

func (v NullableAttachmentReferenceOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttachmentReferenceOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
