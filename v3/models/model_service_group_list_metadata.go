...
// checks if the ServiceGroupListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceGroupListMetadata{}

// ServiceGroupListMetadata Api calls that return a list have this metadata block as input
type ServiceGroupListMetadata struct {
	// The kind name
...
type _ServiceGroupListMetadata ServiceGroupListMetadata
...
func NewServiceGroupListMetadata() *ServiceGroupListMetadata {
	this := ServiceGroupListMetadata{}
	var kind string = "service_group"
	this.Kind = &kind
	return &this
}
...
func (o ServiceGroupListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ServiceGroupListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ServiceGroupListMetadata) UnmarshalJSON(data []byte) (err error) {
	varServiceGroupListMetadata := _ServiceGroupListMetadata{}

	err = json.Unmarshal(data, &varServiceGroupListMetadata)

	if err != nil {
		return err
	}

	*o = ServiceGroupListMetadata(varServiceGroupListMetadata)
...
type NullableServiceGroupListMetadata struct {
	value *ServiceGroupListMetadata
	isSet bool
}

func (v NullableServiceGroupListMetadata) Get() *ServiceGroupListMetadata {
	return v.value
}

func (v *NullableServiceGroupListMetadata) Set(val *ServiceGroupListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceGroupListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceGroupListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceGroupListMetadata(val *ServiceGroupListMetadata) *NullableServiceGroupListMetadata {
	return &NullableServiceGroupListMetadata{value: val, isSet: true}
}

func (v NullableServiceGroupListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceGroupListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
