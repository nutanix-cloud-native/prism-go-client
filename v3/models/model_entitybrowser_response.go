...
// checks if the EntitybrowserResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitybrowserResponse{}

// EntitybrowserResponse Entitybrowser response object definition.
type EntitybrowserResponse struct {
...
type _EntitybrowserResponse EntitybrowserResponse
...
func (o EntitybrowserResponse) MarshalJSON() ([]byte, error) {
...
func (o EntitybrowserResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EntitybrowserResponse) UnmarshalJSON(data []byte) (err error) {
	varEntitybrowserResponse := _EntitybrowserResponse{}

	err = json.Unmarshal(data, &varEntitybrowserResponse)

	if err != nil {
		return err
	}

	*o = EntitybrowserResponse(varEntitybrowserResponse)
...
type NullableEntitybrowserResponse struct {
	value *EntitybrowserResponse
	isSet bool
}

func (v NullableEntitybrowserResponse) Get() *EntitybrowserResponse {
	return v.value
}

func (v *NullableEntitybrowserResponse) Set(val *EntitybrowserResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitybrowserResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitybrowserResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitybrowserResponse(val *EntitybrowserResponse) *NullableEntitybrowserResponse {
	return &NullableEntitybrowserResponse{value: val, isSet: true}
}

func (v NullableEntitybrowserResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitybrowserResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
