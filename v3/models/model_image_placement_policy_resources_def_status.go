...
// checks if the ImagePlacementPolicyResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagePlacementPolicyResourcesDefStatus{}

// ImagePlacementPolicyResourcesDefStatus Describes the status of the image policy object
type ImagePlacementPolicyResourcesDefStatus struct {
	ClusterEntityFilter *PlacementEntityFilter `json:"cluster_entity_filter,omitempty"`
	ImageEntityFilter *PlacementEntityFilter `json:"image_entity_filter,omitempty"`
	// Describes the image placement semantic
	PlacementType *string `json:"placement_type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ImagePlacementPolicyResourcesDefStatus ImagePlacementPolicyResourcesDefStatus
...
func NewImagePlacementPolicyResourcesDefStatus() *ImagePlacementPolicyResourcesDefStatus {
	this := ImagePlacementPolicyResourcesDefStatus{}
	return &this
}
...
// GetClusterEntityFilter returns the ClusterEntityFilter field value if set, zero value otherwise.
func (o *ImagePlacementPolicyResourcesDefStatus) GetClusterEntityFilter() PlacementEntityFilter {
	if o == nil || IsNil(o.ClusterEntityFilter) {
		var ret PlacementEntityFilter
		return ret
	}
	return *o.ClusterEntityFilter
}

// GetClusterEntityFilterOk returns a tuple with the ClusterEntityFilter field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImagePlacementPolicyResourcesDefStatus) GetClusterEntityFilterOk() (*PlacementEntityFilter, bool) {
	if o == nil || IsNil(o.ClusterEntityFilter) {
		return nil, false
	}
	return o.ClusterEntityFilter, true
}
...
// SetClusterEntityFilter gets a reference to the given PlacementEntityFilter and assigns it to the ClusterEntityFilter field.
func (o *ImagePlacementPolicyResourcesDefStatus) SetClusterEntityFilter(v PlacementEntityFilter) {
	o.ClusterEntityFilter = &v
}

// GetImageEntityFilter returns the ImageEntityFilter field value if set, zero value otherwise.
func (o *ImagePlacementPolicyResourcesDefStatus) GetImageEntityFilter() PlacementEntityFilter {
	if o == nil || IsNil(o.ImageEntityFilter) {
		var ret PlacementEntityFilter
		return ret
	}
	return *o.ImageEntityFilter
}

// GetImageEntityFilterOk returns a tuple with the ImageEntityFilter field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImagePlacementPolicyResourcesDefStatus) GetImageEntityFilterOk() (*PlacementEntityFilter, bool) {
	if o == nil || IsNil(o.ImageEntityFilter) {
		return nil, false
	}
	return o.ImageEntityFilter, true
}
...
// SetImageEntityFilter gets a reference to the given PlacementEntityFilter and assigns it to the ImageEntityFilter field.
func (o *ImagePlacementPolicyResourcesDefStatus) SetImageEntityFilter(v PlacementEntityFilter) {
	o.ImageEntityFilter = &v
}
...
// SetPlacementType gets a reference to the given string and assigns it to the PlacementType field.
func (o *ImagePlacementPolicyResourcesDefStatus) SetPlacementType(v string) {
	o.PlacementType = &v
}

func (o ImagePlacementPolicyResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ImagePlacementPolicyResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ClusterEntityFilter) {
		toSerialize["cluster_entity_filter"] = o.ClusterEntityFilter
	}
	if !IsNil(o.ImageEntityFilter) {
		toSerialize["image_entity_filter"] = o.ImageEntityFilter
	}
	if !IsNil(o.PlacementType) {
		toSerialize["placement_type"] = o.PlacementType
	}
...
func (o *ImagePlacementPolicyResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varImagePlacementPolicyResourcesDefStatus := _ImagePlacementPolicyResourcesDefStatus{}

	err = json.Unmarshal(data, &varImagePlacementPolicyResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = ImagePlacementPolicyResourcesDefStatus(varImagePlacementPolicyResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "cluster_entity_filter")
		delete(additionalProperties, "image_entity_filter")
		delete(additionalProperties, "placement_type")
...
type NullableImagePlacementPolicyResourcesDefStatus struct {
	value *ImagePlacementPolicyResourcesDefStatus
	isSet bool
}

func (v NullableImagePlacementPolicyResourcesDefStatus) Get() *ImagePlacementPolicyResourcesDefStatus {
	return v.value
}

func (v *NullableImagePlacementPolicyResourcesDefStatus) Set(val *ImagePlacementPolicyResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableImagePlacementPolicyResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableImagePlacementPolicyResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagePlacementPolicyResourcesDefStatus(val *ImagePlacementPolicyResourcesDefStatus) *NullableImagePlacementPolicyResourcesDefStatus {
	return &NullableImagePlacementPolicyResourcesDefStatus{value: val, isSet: true}
}

func (v NullableImagePlacementPolicyResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagePlacementPolicyResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
