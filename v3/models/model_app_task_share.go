...
// checks if the AppTaskShare type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskShare{}

// AppTaskShare App task share kind
type AppTaskShare struct {
	Name string `json:"name"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	Description *string `json:"description,omitempty"`
	Resources AppTaskShareResources `json:"resources"`
	ClusterReference *ClusterReference `json:"cluster_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AppTaskShare AppTaskShare
...
func (o AppTaskShare) MarshalJSON() ([]byte, error) {
...
func (o AppTaskShare) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskShare) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskShare := _AppTaskShare{}

	err = json.Unmarshal(data, &varAppTaskShare)

	if err != nil {
		return err
	}

	*o = AppTaskShare(varAppTaskShare)
...
type NullableAppTaskShare struct {
	value *AppTaskShare
	isSet bool
}

func (v NullableAppTaskShare) Get() *AppTaskShare {
	return v.value
}

func (v *NullableAppTaskShare) Set(val *AppTaskShare) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskShare) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskShare) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskShare(val *AppTaskShare) *NullableAppTaskShare {
	return &NullableAppTaskShare{value: val, isSet: true}
}

func (v NullableAppTaskShare) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskShare) UnmarshalJSON(src []byte) error {
	v.isSet = true
