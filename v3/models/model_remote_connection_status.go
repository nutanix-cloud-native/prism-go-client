...
// checks if the RemoteConnectionStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteConnectionStatus{}

// RemoteConnectionStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _RemoteConnectionStatus RemoteConnectionStatus
...
func (o RemoteConnectionStatus) MarshalJSON() ([]byte, error) {
...
func (o RemoteConnectionStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteConnectionStatus) UnmarshalJSON(data []byte) (err error) {
	varRemoteConnectionStatus := _RemoteConnectionStatus{}

	err = json.Unmarshal(data, &varRemoteConnectionStatus)

	if err != nil {
		return err
	}

	*o = RemoteConnectionStatus(varRemoteConnectionStatus)
...
type NullableRemoteConnectionStatus struct {
	value *RemoteConnectionStatus
	isSet bool
}

func (v NullableRemoteConnectionStatus) Get() *RemoteConnectionStatus {
	return v.value
}

func (v *NullableRemoteConnectionStatus) Set(val *RemoteConnectionStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteConnectionStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteConnectionStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteConnectionStatus(val *RemoteConnectionStatus) *NullableRemoteConnectionStatus {
	return &NullableRemoteConnectionStatus{value: val, isSet: true}
}

func (v NullableRemoteConnectionStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteConnectionStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
