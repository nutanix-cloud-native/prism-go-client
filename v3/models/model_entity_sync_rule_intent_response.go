...
// checks if the EntitySyncRuleIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySyncRuleIntentResponse{}

// EntitySyncRuleIntentResponse Response object for intentful operations on a entity_sync_rule
type EntitySyncRuleIntentResponse struct {
...
type _EntitySyncRuleIntentResponse EntitySyncRuleIntentResponse
...
func NewEntitySyncRuleIntentResponse(apiVersion string, metadata EntitySyncRuleMetadata) *EntitySyncRuleIntentResponse {
	this := EntitySyncRuleIntentResponse{}
...
func (o EntitySyncRuleIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o EntitySyncRuleIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EntitySyncRuleIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEntitySyncRuleIntentResponse := _EntitySyncRuleIntentResponse{}

	err = json.Unmarshal(data, &varEntitySyncRuleIntentResponse)

	if err != nil {
		return err
	}

	*o = EntitySyncRuleIntentResponse(varEntitySyncRuleIntentResponse)
...
type NullableEntitySyncRuleIntentResponse struct {
	value *EntitySyncRuleIntentResponse
	isSet bool
}

func (v NullableEntitySyncRuleIntentResponse) Get() *EntitySyncRuleIntentResponse {
	return v.value
}

func (v *NullableEntitySyncRuleIntentResponse) Set(val *EntitySyncRuleIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySyncRuleIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySyncRuleIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySyncRuleIntentResponse(val *EntitySyncRuleIntentResponse) *NullableEntitySyncRuleIntentResponse {
	return &NullableEntitySyncRuleIntentResponse{value: val, isSet: true}
}

func (v NullableEntitySyncRuleIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySyncRuleIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
