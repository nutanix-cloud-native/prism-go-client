...
// checks if the CellListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CellListMetadataOutput{}

// CellListMetadataOutput All api calls that return a list will have this metadata block 
type CellListMetadataOutput struct {
	// The kind name
...
type _CellListMetadataOutput CellListMetadataOutput
...
func NewCellListMetadataOutput() *CellListMetadataOutput {
	this := CellListMetadataOutput{}
	var kind string = "cell"
	this.Kind = &kind
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *CellListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o CellListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o CellListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *CellListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varCellListMetadataOutput := _CellListMetadataOutput{}

	err = json.Unmarshal(data, &varCellListMetadataOutput)

	if err != nil {
		return err
	}

	*o = CellListMetadataOutput(varCellListMetadataOutput)
...
type NullableCellListMetadataOutput struct {
	value *CellListMetadataOutput
	isSet bool
}

func (v NullableCellListMetadataOutput) Get() *CellListMetadataOutput {
	return v.value
}

func (v *NullableCellListMetadataOutput) Set(val *CellListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableCellListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableCellListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCellListMetadataOutput(val *CellListMetadataOutput) *NullableCellListMetadataOutput {
	return &NullableCellListMetadataOutput{value: val, isSet: true}
}

func (v NullableCellListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCellListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
