...
// checks if the AppResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppResources{}

// AppResources Resources for Application.
type AppResources struct {
	// List of Action for Application.
	ActionList []AppActionInput `json:"action_list"`
	// Credential list for appspec
	CredentialList []AppCredentialInput `json:"credential_list"`
	AppBlueprintConfigReference *BlueprintReference `json:"app_blueprint_config_reference,omitempty"`
	AppBlueprintReference *BlueprintReference `json:"app_blueprint_reference,omitempty"`
	...
	// List of variables
	VariableList []AppVariableInput `json:"variable_list"`
	// List of Deployment Spec for Application.
	DeploymentList []AppDeploymentInput `json:"deployment_list"`
	AdditionalProperties map[string]interface{}
}

type _AppResources AppResources
...
// GetAppBlueprintReference returns the AppBlueprintReference field value if set, zero value otherwise.
func (o *AppResources) GetAppBlueprintReference() BlueprintReference {
	if o == nil || IsNil(o.AppBlueprintReference) {
		var ret BlueprintReference
		return ret
	}
...
// GetAppBlueprintReferenceOk returns a tuple with the AppBlueprintReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAppBlueprintReference gets a reference to the given BlueprintReference and assigns it to the AppBlueprintReference field.
...
func (o AppResources) MarshalJSON() ([]byte, error) {
...
func (o AppResources) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AppBlueprintReference) {
...
func (o *AppResources) UnmarshalJSON(data []byte) (err error) {
	...
	varAppResources := _AppResources{}

	err = json.Unmarshal(data, &varAppResources)

	if err != nil {
		return err
	}

	*o = AppResources(varAppResources)
...
type NullableAppResources struct {
	value *AppResources
	isSet bool
}

func (v NullableAppResources) Get() *AppResources {
	return v.value
}

func (v *NullableAppResources) Set(val *AppResources) {
	v.value = val
	v.isSet = true
}

func (v NullableAppResources) IsSet() bool {
	return v.isSet
}

func (v *NullableAppResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppResources(val *AppResources) *NullableAppResources {
	return &NullableAppResources{value: val, isSet: true}
}

func (v NullableAppResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
