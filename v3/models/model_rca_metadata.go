...
// checks if the RcaMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RcaMetadata{}

// RcaMetadata Root cause analysis from alert RCA metadata.
type RcaMetadata struct {
	...
	// cause id of parent
	ParentCauseId *string `json:"parent_cause_id,omitempty"`
	// Alert cause detail information
...
// GetParentCauseId returns the ParentCauseId field value if set, zero value otherwise.
func (o *RcaMetadata) GetParentCauseId() string {
	if o == nil || IsNil(o.ParentCauseId) {
		var ret string
		return ret
	}
	return *o.ParentCauseId
}

// GetParentCauseIdOk returns a tuple with the ParentCauseId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RcaMetadata) GetParentCauseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ParentCauseId) {
		return nil, false
	}
	return o.ParentCauseId, true
}
...
// SetParentCauseId gets a reference to the given string and assigns it to the ParentCauseId field.
...
func (o RcaMetadata) MarshalJSON() ([]byte, error) {
...
func (o RcaMetadata) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ParentCauseId) {
		toSerialize["parent_cause_id"] = o.ParentCauseId
	}
	if !IsNil(o.Details) {
...
func (o *RcaMetadata) UnmarshalJSON(data []byte) (err error) {
	varRcaMetadata := _RcaMetadata{}

	err = json.Unmarshal(data, &varRcaMetadata)

	if err != nil {
		return err
	}

	*o = RcaMetadata(varRcaMetadata)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "parent_cause_id")
...
type NullableRcaMetadata struct {
	value *RcaMetadata
	isSet bool
}

func (v NullableRcaMetadata) Get() *RcaMetadata {
	return v.value
}

func (v *NullableRcaMetadata) Set(val *RcaMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRcaMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRcaMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRcaMetadata(val *RcaMetadata) *NullableRcaMetadata {
	return &NullableRcaMetadata{value: val, isSet: true}
}

func (v NullableRcaMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRcaMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
