...
// checks if the RootCertificate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootCertificate{}

// RootCertificate Payload for multicluster configuration request.
...
type _RootCertificate RootCertificate
...
// SetCertificateChain gets a reference to the given []Certificate and assigns it to the CertificateChain field.
...
func (o RootCertificate) MarshalJSON() ([]byte, error) {
...
func (o RootCertificate) ToMap() (map[string]interface{}, error) {
...
func (o *RootCertificate) UnmarshalJSON(data []byte) (err error) {
	...
	varRootCertificate := _RootCertificate{}

	err = json.Unmarshal(data, &varRootCertificate)

	if err != nil {
		return err
	}

	*o = RootCertificate(varRootCertificate)
...
type NullableRootCertificate struct {
	value *RootCertificate
	isSet bool
}

func (v NullableRootCertificate) Get() *RootCertificate {
	return v.value
}

func (v *NullableRootCertificate) Set(val *RootCertificate) {
	v.value = val
	v.isSet = true
}

func (v NullableRootCertificate) IsSet() bool {
	return v.isSet
}

func (v *NullableRootCertificate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRootCertificate(val *RootCertificate) *NullableRootCertificate {
	return &NullableRootCertificate{value: val, isSet: true}
}

func (v NullableRootCertificate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRootCertificate) UnmarshalJSON(src []byte) error {
	v.isSet = true
