...
// checks if the FloatingIpIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FloatingIpIntentResource{}

// FloatingIpIntentResource Response object for intentful operations on a floating_ip
type FloatingIpIntentResource struct {
...
type _FloatingIpIntentResource FloatingIpIntentResource
...
func (o FloatingIpIntentResource) MarshalJSON() ([]byte, error) {
...
func (o FloatingIpIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *FloatingIpIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varFloatingIpIntentResource := _FloatingIpIntentResource{}

	err = json.Unmarshal(data, &varFloatingIpIntentResource)

	if err != nil {
		return err
	}

	*o = FloatingIpIntentResource(varFloatingIpIntentResource)
...
type NullableFloatingIpIntentResource struct {
	value *FloatingIpIntentResource
	isSet bool
}

func (v NullableFloatingIpIntentResource) Get() *FloatingIpIntentResource {
	return v.value
}

func (v *NullableFloatingIpIntentResource) Set(val *FloatingIpIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableFloatingIpIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableFloatingIpIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFloatingIpIntentResource(val *FloatingIpIntentResource) *NullableFloatingIpIntentResource {
	return &NullableFloatingIpIntentResource{value: val, isSet: true}
}

func (v NullableFloatingIpIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFloatingIpIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
