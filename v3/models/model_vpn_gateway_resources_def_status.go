...
// checks if the VpnGatewayResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayResourcesDefStatus{}

// VpnGatewayResourcesDefStatus VPN gateway creation/modification status.
type VpnGatewayResourcesDefStatus struct {
	VpcReference *VpcReference `json:"vpc_reference,omitempty"`
	OperationalStatus *VpnComponentStatus `json:"operational_status,omitempty"`
	// 3rd Party VPN Vendor. This could be a traditional device vendor (like Cisco ASA, Fortinet etc.) or one of the public cloud providers (eg: AWS). 
	GatewayDeviceVendor *string `json:"gateway_device_vendor,omitempty"`
	// Public IP address of this gateway.
	PublicIp *string `json:"public_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	// Whether this is local or remote gateway entity.
	GatewayType *string `json:"gateway_type,omitempty"`
	Deployment *DeploymentStatus `json:"deployment,omitempty"`
	InternalRoutingProtocolConfig *InternalRoutingProtocolConfigStatus `json:"internal_routing_protocol_config,omitempty"`
	EbgpConfig *BgpConfigStatus `json:"ebgp_config,omitempty"`
	VirtualNetworkReference *VirtualNetworkReference `json:"virtual_network_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VpnGatewayResourcesDefStatus VpnGatewayResourcesDefStatus
...
func NewVpnGatewayResourcesDefStatus() *VpnGatewayResourcesDefStatus {
	this := VpnGatewayResourcesDefStatus{}
	return &this
}
...
// SetOperationalStatus gets a reference to the given VpnComponentStatus and assigns it to the OperationalStatus field.
func (o *VpnGatewayResourcesDefStatus) SetOperationalStatus(v VpnComponentStatus) {
	o.OperationalStatus = &v
}

// GetGatewayDeviceVendor returns the GatewayDeviceVendor field value if set, zero value otherwise.
func (o *VpnGatewayResourcesDefStatus) GetGatewayDeviceVendor() string {
	if o == nil || IsNil(o.GatewayDeviceVendor) {
		var ret string
		return ret
	}
	return *o.GatewayDeviceVendor
}

// GetGatewayDeviceVendorOk returns a tuple with the GatewayDeviceVendor field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnGatewayResourcesDefStatus) GetGatewayDeviceVendorOk() (*string, bool) {
	if o == nil || IsNil(o.GatewayDeviceVendor) {
		return nil, false
	}
	return o.GatewayDeviceVendor, true
}
...
// SetGatewayDeviceVendor gets a reference to the given string and assigns it to the GatewayDeviceVendor field.
func (o *VpnGatewayResourcesDefStatus) SetGatewayDeviceVendor(v string) {
	o.GatewayDeviceVendor = &v
}
...
// SetDeployment gets a reference to the given DeploymentStatus and assigns it to the Deployment field.
func (o *VpnGatewayResourcesDefStatus) SetDeployment(v DeploymentStatus) {
	o.Deployment = &v
}

// GetInternalRoutingProtocolConfig returns the InternalRoutingProtocolConfig field value if set, zero value otherwise.
func (o *VpnGatewayResourcesDefStatus) GetInternalRoutingProtocolConfig() InternalRoutingProtocolConfigStatus {
	if o == nil || IsNil(o.InternalRoutingProtocolConfig) {
		var ret InternalRoutingProtocolConfigStatus
		return ret
	}
	return *o.InternalRoutingProtocolConfig
}

// GetInternalRoutingProtocolConfigOk returns a tuple with the InternalRoutingProtocolConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnGatewayResourcesDefStatus) GetInternalRoutingProtocolConfigOk() (*InternalRoutingProtocolConfigStatus, bool) {
	if o == nil || IsNil(o.InternalRoutingProtocolConfig) {
		return nil, false
	}
	return o.InternalRoutingProtocolConfig, true
}
...
// SetInternalRoutingProtocolConfig gets a reference to the given InternalRoutingProtocolConfigStatus and assigns it to the InternalRoutingProtocolConfig field.
func (o *VpnGatewayResourcesDefStatus) SetInternalRoutingProtocolConfig(v InternalRoutingProtocolConfigStatus) {
	o.InternalRoutingProtocolConfig = &v
}

// GetEbgpConfig returns the EbgpConfig field value if set, zero value otherwise.
func (o *VpnGatewayResourcesDefStatus) GetEbgpConfig() BgpConfigStatus {
	if o == nil || IsNil(o.EbgpConfig) {
...
// GetEbgpConfigOk returns a tuple with the EbgpConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VpnGatewayResourcesDefStatus) GetEbgpConfigOk() (*BgpConfigStatus, bool) {
	if o == nil || IsNil(o.EbgpConfig) {
		return nil, false
	}
	return o.EbgpConfig, true
}
...
// SetEbgpConfig gets a reference to the given BgpConfigStatus and assigns it to the EbgpConfig field.
...
func (o VpnGatewayResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GatewayDeviceVendor) {
		toSerialize["gateway_device_vendor"] = o.GatewayDeviceVendor
	}
	if !IsNil(o.PublicIp) {
	...
	if !IsNil(o.InternalRoutingProtocolConfig) {
		toSerialize["internal_routing_protocol_config"] = o.InternalRoutingProtocolConfig
	}
	if !IsNil(o.EbgpConfig) {
		toSerialize["ebgp_config"] = o.EbgpConfig
	}
...
func (o *VpnGatewayResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varVpnGatewayResourcesDefStatus := _VpnGatewayResourcesDefStatus{}

	err = json.Unmarshal(data, &varVpnGatewayResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = VpnGatewayResourcesDefStatus(varVpnGatewayResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vpc_reference")
		delete(additionalProperties, "operational_status")
		delete(additionalProperties, "gateway_device_vendor")
		delete(additionalProperties, "public_ip")
		delete(additionalProperties, "gateway_type")
		delete(additionalProperties, "deployment")
		delete(additionalProperties, "internal_routing_protocol_config")
		delete(additionalProperties, "ebgp_config")
...
type NullableVpnGatewayResourcesDefStatus struct {
	value *VpnGatewayResourcesDefStatus
	isSet bool
}

func (v NullableVpnGatewayResourcesDefStatus) Get() *VpnGatewayResourcesDefStatus {
	return v.value
}

func (v *NullableVpnGatewayResourcesDefStatus) Set(val *VpnGatewayResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayResourcesDefStatus(val *VpnGatewayResourcesDefStatus) *NullableVpnGatewayResourcesDefStatus {
	return &NullableVpnGatewayResourcesDefStatus{value: val, isSet: true}
}

func (v NullableVpnGatewayResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
