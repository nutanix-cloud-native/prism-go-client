...
// checks if the GroupsRequestedAttribute type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupsRequestedAttribute{}

// GroupsRequestedAttribute An attribute that has been requested to be returned in the response. 
type GroupsRequestedAttribute struct {
	...
	AncestorEntityType *string `json:"ancestor_entity_type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _GroupsRequestedAttribute GroupsRequestedAttribute
...
// GetAncestorEntityType returns the AncestorEntityType field value if set, zero value otherwise.
func (o *GroupsRequestedAttribute) GetAncestorEntityType() string {
	if o == nil || IsNil(o.AncestorEntityType) {
		var ret string
		return ret
	}
	return *o.AncestorEntityType
}

// GetAncestorEntityTypeOk returns a tuple with the AncestorEntityType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GroupsRequestedAttribute) GetAncestorEntityTypeOk() (*string, bool) {
	if o == nil || IsNil(o.AncestorEntityType) {
		return nil, false
	}
	return o.AncestorEntityType, true
}
...
// SetAncestorEntityType gets a reference to the given string and assigns it to the AncestorEntityType field.
func (o *GroupsRequestedAttribute) SetAncestorEntityType(v string) {
	o.AncestorEntityType = &v
}

func (o GroupsRequestedAttribute) MarshalJSON() ([]byte, error) {
...
func (o GroupsRequestedAttribute) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["attribute"] = o.Attribute
	if !IsNil(o.Operation) {
		toSerialize["operation"] = o.Operation
	}
	if !IsNil(o.AncestorEntityType) {
		toSerialize["ancestor_entity_type"] = o.AncestorEntityType
	}
...
func (o *GroupsRequestedAttribute) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupsRequestedAttribute := _GroupsRequestedAttribute{}

	err = json.Unmarshal(data, &varGroupsRequestedAttribute)

	if err != nil {
		return err
	}

	*o = GroupsRequestedAttribute(varGroupsRequestedAttribute)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ancestor_entity_type")
...
type NullableGroupsRequestedAttribute struct {
	value *GroupsRequestedAttribute
	isSet bool
}

func (v NullableGroupsRequestedAttribute) Get() *GroupsRequestedAttribute {
	return v.value
}

func (v *NullableGroupsRequestedAttribute) Set(val *GroupsRequestedAttribute) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupsRequestedAttribute) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupsRequestedAttribute) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupsRequestedAttribute(val *GroupsRequestedAttribute) *NullableGroupsRequestedAttribute {
	return &NullableGroupsRequestedAttribute{value: val, isSet: true}
}

func (v NullableGroupsRequestedAttribute) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupsRequestedAttribute) UnmarshalJSON(src []byte) error {
	v.isSet = true
