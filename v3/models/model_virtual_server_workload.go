...
// checks if the VirtualServerWorkload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualServerWorkload{}

// VirtualServerWorkload Virtual Server workload Object.
type VirtualServerWorkload struct {
	NumVms *int32 `json:"numVms,omitempty"`
	ServerProfileType *string `json:"server_profile_type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VirtualServerWorkload VirtualServerWorkload
...
// GetNumVms returns the NumVms field value if set, zero value otherwise.
func (o *VirtualServerWorkload) GetNumVms() int32 {
	if o == nil || IsNil(o.NumVms) {
		var ret int32
		return ret
	}
	return *o.NumVms
...
// GetNumVmsOk returns a tuple with the NumVms field value if set, nil otherwise
...
// SetNumVms gets a reference to the given int32 and assigns it to the NumVms field.
func (o *VirtualServerWorkload) SetNumVms(v int32) {
	o.NumVms = &v
}

// GetServerProfileType returns the ServerProfileType field value if set, zero value otherwise.
func (o *VirtualServerWorkload) GetServerProfileType() string {
	if o == nil || IsNil(o.ServerProfileType) {
		var ret string
		return ret
	}
	return *o.ServerProfileType
}

// GetServerProfileTypeOk returns a tuple with the ServerProfileType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VirtualServerWorkload) GetServerProfileTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ServerProfileType) {
		return nil, false
	}
	return o.ServerProfileType, true
}
...
// SetServerProfileType gets a reference to the given string and assigns it to the ServerProfileType field.
func (o *VirtualServerWorkload) SetServerProfileType(v string) {
	o.ServerProfileType = &v
}

func (o VirtualServerWorkload) MarshalJSON() ([]byte, error) {
...
func (o VirtualServerWorkload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.NumVms) {
		toSerialize["numVms"] = o.NumVms
	}
	if !IsNil(o.ServerProfileType) {
		toSerialize["server_profile_type"] = o.ServerProfileType
	}
...
func (o *VirtualServerWorkload) UnmarshalJSON(data []byte) (err error) {
	varVirtualServerWorkload := _VirtualServerWorkload{}

	err = json.Unmarshal(data, &varVirtualServerWorkload)

	if err != nil {
		return err
	}

	*o = VirtualServerWorkload(varVirtualServerWorkload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "numVms")
		delete(additionalProperties, "server_profile_type")
...
type NullableVirtualServerWorkload struct {
	value *VirtualServerWorkload
	isSet bool
}

func (v NullableVirtualServerWorkload) Get() *VirtualServerWorkload {
	return v.value
}

func (v *NullableVirtualServerWorkload) Set(val *VirtualServerWorkload) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualServerWorkload) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualServerWorkload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualServerWorkload(val *VirtualServerWorkload) *NullableVirtualServerWorkload {
	return &NullableVirtualServerWorkload{value: val, isSet: true}
}

func (v NullableVirtualServerWorkload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualServerWorkload) UnmarshalJSON(src []byte) error {
	v.isSet = true
