...
// checks if the VolumeGroupIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupIntentResource{}

// VolumeGroupIntentResource Response object for intentful operations on a volume_group
type VolumeGroupIntentResource struct {
	Status *VolumeGroupDefStatus `json:"status,omitempty"`
	Spec *VolumeGroup `json:"spec,omitempty"`
...
type _VolumeGroupIntentResource VolumeGroupIntentResource
...
func NewVolumeGroupIntentResource(metadata VolumeGroupMetadata) *VolumeGroupIntentResource {
	this := VolumeGroupIntentResource{}
...
// SetStatus gets a reference to the given VolumeGroupDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given VolumeGroup and assigns it to the Spec field.
...
func (o VolumeGroupIntentResource) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeGroupIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumeGroupIntentResource := _VolumeGroupIntentResource{}

	err = json.Unmarshal(data, &varVolumeGroupIntentResource)

	if err != nil {
		return err
	}

	*o = VolumeGroupIntentResource(varVolumeGroupIntentResource)
...
type NullableVolumeGroupIntentResource struct {
	value *VolumeGroupIntentResource
	isSet bool
}

func (v NullableVolumeGroupIntentResource) Get() *VolumeGroupIntentResource {
	return v.value
}

func (v *NullableVolumeGroupIntentResource) Set(val *VolumeGroupIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupIntentResource(val *VolumeGroupIntentResource) *NullableVolumeGroupIntentResource {
	return &NullableVolumeGroupIntentResource{value: val, isSet: true}
}

func (v NullableVolumeGroupIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
