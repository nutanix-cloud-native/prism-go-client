...
// checks if the RecoveryPlanIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanIntentResponse{}

// RecoveryPlanIntentResponse Response object for intentful operations on a recovery_plan
...
type _RecoveryPlanIntentResponse RecoveryPlanIntentResponse
...
func NewRecoveryPlanIntentResponse(apiVersion string, metadata RecoveryPlanMetadata) *RecoveryPlanIntentResponse {
	this := RecoveryPlanIntentResponse{}
...
func (o RecoveryPlanIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanIntentResponse := _RecoveryPlanIntentResponse{}

	err = json.Unmarshal(data, &varRecoveryPlanIntentResponse)

	if err != nil {
		return err
	}

	*o = RecoveryPlanIntentResponse(varRecoveryPlanIntentResponse)
...
type NullableRecoveryPlanIntentResponse struct {
	value *RecoveryPlanIntentResponse
	isSet bool
}

func (v NullableRecoveryPlanIntentResponse) Get() *RecoveryPlanIntentResponse {
	return v.value
}

func (v *NullableRecoveryPlanIntentResponse) Set(val *RecoveryPlanIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanIntentResponse(val *RecoveryPlanIntentResponse) *NullableRecoveryPlanIntentResponse {
	return &NullableRecoveryPlanIntentResponse{value: val, isSet: true}
}

func (v NullableRecoveryPlanIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
