...
// checks if the ProtectionRuleReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleReference{}

// ProtectionRuleReference The reference to a protection_rule
type ProtectionRuleReference struct {
	// The kind name
...
type _ProtectionRuleReference ProtectionRuleReference
...
func (o ProtectionRuleReference) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleReference) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionRuleReference) UnmarshalJSON(data []byte) (err error) {
	...
	varProtectionRuleReference := _ProtectionRuleReference{}

	err = json.Unmarshal(data, &varProtectionRuleReference)

	if err != nil {
		return err
	}

	*o = ProtectionRuleReference(varProtectionRuleReference)
...
type NullableProtectionRuleReference struct {
	value *ProtectionRuleReference
	isSet bool
}

func (v NullableProtectionRuleReference) Get() *ProtectionRuleReference {
	return v.value
}

func (v *NullableProtectionRuleReference) Set(val *ProtectionRuleReference) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleReference) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleReference(val *ProtectionRuleReference) *NullableProtectionRuleReference {
	return &NullableProtectionRuleReference{value: val, isSet: true}
}

func (v NullableProtectionRuleReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
