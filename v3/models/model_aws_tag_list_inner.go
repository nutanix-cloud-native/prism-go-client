...
// checks if the AwsTagListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsTagListInner{}

// AwsTagListInner Generic key value pair.
type AwsTagListInner struct {
	// Tag value
...
type _AwsTagListInner AwsTagListInner
...
func (o AwsTagListInner) MarshalJSON() ([]byte, error) {
...
func (o AwsTagListInner) ToMap() (map[string]interface{}, error) {
...
func (o *AwsTagListInner) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsTagListInner := _AwsTagListInner{}

	err = json.Unmarshal(data, &varAwsTagListInner)

	if err != nil {
		return err
	}

	*o = AwsTagListInner(varAwsTagListInner)
...
type NullableAwsTagListInner struct {
	value *AwsTagListInner
	isSet bool
}

func (v NullableAwsTagListInner) Get() *AwsTagListInner {
	return v.value
}

func (v *NullableAwsTagListInner) Set(val *AwsTagListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsTagListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsTagListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsTagListInner(val *AwsTagListInner) *NullableAwsTagListInner {
	return &NullableAwsTagListInner{value: val, isSet: true}
}

func (v NullableAwsTagListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsTagListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
