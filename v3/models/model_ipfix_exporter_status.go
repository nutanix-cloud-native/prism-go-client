...
// checks if the IpfixExporterStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpfixExporterStatus{}

// IpfixExporterStatus The status of a REST API call. Only used when there is a failure to report. 
type IpfixExporterStatus struct {
	// The kind name
...
type _IpfixExporterStatus IpfixExporterStatus
...
func (o IpfixExporterStatus) MarshalJSON() ([]byte, error) {
...
func (o IpfixExporterStatus) ToMap() (map[string]interface{}, error) {
...
func (o *IpfixExporterStatus) UnmarshalJSON(data []byte) (err error) {
	varIpfixExporterStatus := _IpfixExporterStatus{}

	err = json.Unmarshal(data, &varIpfixExporterStatus)

	if err != nil {
		return err
	}

	*o = IpfixExporterStatus(varIpfixExporterStatus)
...
type NullableIpfixExporterStatus struct {
	value *IpfixExporterStatus
	isSet bool
}

func (v NullableIpfixExporterStatus) Get() *IpfixExporterStatus {
	return v.value
}

func (v *NullableIpfixExporterStatus) Set(val *IpfixExporterStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableIpfixExporterStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableIpfixExporterStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpfixExporterStatus(val *IpfixExporterStatus) *NullableIpfixExporterStatus {
	return &NullableIpfixExporterStatus{value: val, isSet: true}
}

func (v NullableIpfixExporterStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpfixExporterStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
