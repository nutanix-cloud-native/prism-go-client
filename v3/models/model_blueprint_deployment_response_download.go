...
// checks if the BlueprintDeploymentResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintDeploymentResponseDownload{}

// BlueprintDeploymentResponseDownload Deployment definition for Application.
type BlueprintDeploymentResponseDownload struct {
	// 
	PercentFaultTolerance *int64 `json:"percent_fault_tolerance,omitempty"`
	// 
	FaultDomainScope *string `json:"fault_domain_scope,omitempty"`
	// 
	Description *string `json:"description,omitempty"`
	// List of references to action 
	ActionList []AppActionResponseDownload `json:"action_list,omitempty"`
	// 
	...
	Editables map[string]interface{} `json:"editables,omitempty"`
	// 
	State string `json:"state"`
	// List of references for published services
	PublishedServiceLocalReferenceList []AppPublishedServiceReferenceUpload `json:"published_service_local_reference_list,omitempty"`
	// 
	DependsOnList []EntityReference `json:"depends_on_list,omitempty"`
	// Maximum replicas for the deployment.
	MaxReplicas string `json:"max_replicas"`
	// List of references for the packages
	PackageLocalReferenceList []AppPackageReferenceUpload `json:"package_local_reference_list,omitempty"`
	SubstrateLocalReference AppSubstrateReferenceUpload `json:"substrate_local_reference"`
	// 
	VariableList []AppVariableResponseDownload `json:"variable_list,omitempty"`
	// Minimum replicas for the deployment.
	MinReplicas string `json:"min_replicas"`
	// Additional deployment options
	Options map[string]interface{} `json:"options,omitempty"`
	// 
	NumFaultTolerance *int64 `json:"num_fault_tolerance,omitempty"`
	// brownfield map
	BrownfieldInstanceList []BrownfieldInstanceInput `json:"brownfield_instance_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _BlueprintDeploymentResponseDownload BlueprintDeploymentResponseDownload

// NewBlueprintDeploymentResponseDownload instantiates a new BlueprintDeploymentResponseDownload object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBlueprintDeploymentResponseDownload(messageList []MessageResource, name string, state string, maxReplicas string, substrateLocalReference AppSubstrateReferenceUpload, minReplicas string) *BlueprintDeploymentResponseDownload {
	this := BlueprintDeploymentResponseDownload{}
	var type_ string = "GREENFIELD"
	this.Type = &type_
	this.MessageList = messageList
	this.Name = name
	this.State = state
	this.MaxReplicas = maxReplicas
	this.SubstrateLocalReference = substrateLocalReference
...
func NewBlueprintDeploymentResponseDownloadWithDefaults() *BlueprintDeploymentResponseDownload {
	...
	var type_ string = "GREENFIELD"
	this.Type = &type_
	var maxReplicas string = "1"
	this.MaxReplicas = maxReplicas
	var minReplicas string = "1"
	this.MinReplicas = minReplicas
	return &this
}

// GetPercentFaultTolerance returns the PercentFaultTolerance field value if set, zero value otherwise.
func (o *BlueprintDeploymentResponseDownload) GetPercentFaultTolerance() int64 {
	if o == nil || IsNil(o.PercentFaultTolerance) {
		var ret int64
		return ret
	}
	return *o.PercentFaultTolerance
}

// GetPercentFaultToleranceOk returns a tuple with the PercentFaultTolerance field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDeploymentResponseDownload) GetPercentFaultToleranceOk() (*int64, bool) {
	if o == nil || IsNil(o.PercentFaultTolerance) {
		return nil, false
	}
	return o.PercentFaultTolerance, true
}
...
// SetPercentFaultTolerance gets a reference to the given int64 and assigns it to the PercentFaultTolerance field.
func (o *BlueprintDeploymentResponseDownload) SetPercentFaultTolerance(v int64) {
	o.PercentFaultTolerance = &v
}

// GetFaultDomainScope returns the FaultDomainScope field value if set, zero value otherwise.
func (o *BlueprintDeploymentResponseDownload) GetFaultDomainScope() string {
	if o == nil || IsNil(o.FaultDomainScope) {
		var ret string
		return ret
	}
	return *o.FaultDomainScope
}

// GetFaultDomainScopeOk returns a tuple with the FaultDomainScope field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDeploymentResponseDownload) GetFaultDomainScopeOk() (*string, bool) {
	if o == nil || IsNil(o.FaultDomainScope) {
		return nil, false
	}
	return o.FaultDomainScope, true
}

// HasFaultDomainScope returns a boolean if a field has been set.
func (o *BlueprintDeploymentResponseDownload) HasFaultDomainScope() bool {
	if o != nil && !IsNil(o.FaultDomainScope) {
		return true
	}
...
// SetFaultDomainScope gets a reference to the given string and assigns it to the FaultDomainScope field.
func (o *BlueprintDeploymentResponseDownload) SetFaultDomainScope(v string) {
	o.FaultDomainScope = &v
}
...
func (o *BlueprintDeploymentResponseDownload) GetActionList() []AppActionResponseDownload {
	if o == nil || IsNil(o.ActionList) {
		var ret []AppActionResponseDownload
		return ret
	}
	return o.ActionList
}
...
// SetActionList gets a reference to the given []AppActionResponseDownload and assigns it to the ActionList field.
func (o *BlueprintDeploymentResponseDownload) SetActionList(v []AppActionResponseDownload) {
	o.ActionList = v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *BlueprintDeploymentResponseDownload) GetType() string {
...
// GetMessageList returns the MessageList field value
func (o *BlueprintDeploymentResponseDownload) GetMessageList() []MessageResource {
	if o == nil {
		var ret []MessageResource
		return ret
	}

	return o.MessageList
}

// GetMessageListOk returns a tuple with the MessageList field value
// and a boolean to check if the value has been set.
func (o *BlueprintDeploymentResponseDownload) GetMessageListOk() ([]MessageResource, bool) {
	if o == nil {
		return nil, false
	}
	return o.MessageList, true
}

// SetMessageList sets field value
...
func (o *BlueprintDeploymentResponseDownload) SetUUID(v string) {
	o.UUID = &v
}
...
// GetEditables returns the Editables field value if set, zero value otherwise.
func (o *BlueprintDeploymentResponseDownload) GetEditables() map[string]interface{} {
	if o == nil || IsNil(o.Editables) {
...
// GetEditablesOk returns a tuple with the Editables field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDeploymentResponseDownload) GetEditablesOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Editables) {
		return map[string]interface{}{}, false
	}
	return o.Editables, true
}
...
// SetEditables gets a reference to the given map[string]interface{} and assigns it to the Editables field.
func (o *BlueprintDeploymentResponseDownload) SetEditables(v map[string]interface{}) {
	o.Editables = v
}

// GetState returns the State field value
func (o *BlueprintDeploymentResponseDownload) GetState() string {
	if o == nil {
		var ret string
		return ret
	}
...
// GetPublishedServiceLocalReferenceList returns the PublishedServiceLocalReferenceList field value if set, zero value otherwise.
func (o *BlueprintDeploymentResponseDownload) GetPublishedServiceLocalReferenceList() []AppPublishedServiceReferenceUpload {
	if o == nil || IsNil(o.PublishedServiceLocalReferenceList) {
		var ret []AppPublishedServiceReferenceUpload
		return ret
	}
	return o.PublishedServiceLocalReferenceList
}

// GetPublishedServiceLocalReferenceListOk returns a tuple with the PublishedServiceLocalReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDeploymentResponseDownload) GetPublishedServiceLocalReferenceListOk() ([]AppPublishedServiceReferenceUpload, bool) {
	...
	return o.PublishedServiceLocalReferenceList, true
}
...
// SetPublishedServiceLocalReferenceList gets a reference to the given []AppPublishedServiceReferenceUpload and assigns it to the PublishedServiceLocalReferenceList field.
func (o *BlueprintDeploymentResponseDownload) SetPublishedServiceLocalReferenceList(v []AppPublishedServiceReferenceUpload) {
	o.PublishedServiceLocalReferenceList = v
}

// GetDependsOnList returns the DependsOnList field value if set, zero value otherwise.
func (o *BlueprintDeploymentResponseDownload) GetDependsOnList() []EntityReference {
	if o == nil || IsNil(o.DependsOnList) {
		var ret []EntityReference
		return ret
	}
	return o.DependsOnList
}

// GetDependsOnListOk returns a tuple with the DependsOnList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDeploymentResponseDownload) GetDependsOnListOk() ([]EntityReference, bool) {
	if o == nil || IsNil(o.DependsOnList) {
		return nil, false
	}
	return o.DependsOnList, true
}
...
// SetDependsOnList gets a reference to the given []EntityReference and assigns it to the DependsOnList field.
...
// GetPackageLocalReferenceList returns the PackageLocalReferenceList field value if set, zero value otherwise.
func (o *BlueprintDeploymentResponseDownload) GetPackageLocalReferenceList() []AppPackageReferenceUpload {
	if o == nil || IsNil(o.PackageLocalReferenceList) {
		var ret []AppPackageReferenceUpload
		return ret
	}
	return o.PackageLocalReferenceList
}

// GetPackageLocalReferenceListOk returns a tuple with the PackageLocalReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDeploymentResponseDownload) GetPackageLocalReferenceListOk() ([]AppPackageReferenceUpload, bool) {
	if o == nil || IsNil(o.PackageLocalReferenceList) {
		return nil, false
	}
	return o.PackageLocalReferenceList, true
}
...
// SetPackageLocalReferenceList gets a reference to the given []AppPackageReferenceUpload and assigns it to the PackageLocalReferenceList field.
func (o *BlueprintDeploymentResponseDownload) SetPackageLocalReferenceList(v []AppPackageReferenceUpload) {
	o.PackageLocalReferenceList = v
}

// GetSubstrateLocalReference returns the SubstrateLocalReference field value
func (o *BlueprintDeploymentResponseDownload) GetSubstrateLocalReference() AppSubstrateReferenceUpload {
	if o == nil {
		var ret AppSubstrateReferenceUpload
		return ret
	}

	return o.SubstrateLocalReference
}

// GetSubstrateLocalReferenceOk returns a tuple with the SubstrateLocalReference field value
// and a boolean to check if the value has been set.
func (o *BlueprintDeploymentResponseDownload) GetSubstrateLocalReferenceOk() (*AppSubstrateReferenceUpload, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SubstrateLocalReference, true
}

// SetSubstrateLocalReference sets field value
func (o *BlueprintDeploymentResponseDownload) SetSubstrateLocalReference(v AppSubstrateReferenceUpload) {
	o.SubstrateLocalReference = v
}

// GetVariableList returns the VariableList field value if set, zero value otherwise.
func (o *BlueprintDeploymentResponseDownload) GetVariableList() []AppVariableResponseDownload {
	if o == nil || IsNil(o.VariableList) {
		var ret []AppVariableResponseDownload
		return ret
	}
	return o.VariableList
}

// GetVariableListOk returns a tuple with the VariableList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDeploymentResponseDownload) GetVariableListOk() ([]AppVariableResponseDownload, bool) {
	if o == nil || IsNil(o.VariableList) {
		return nil, false
	}
	return o.VariableList, true
}
...
// SetVariableList gets a reference to the given []AppVariableResponseDownload and assigns it to the VariableList field.
...
// GetNumFaultTolerance returns the NumFaultTolerance field value if set, zero value otherwise.
func (o *BlueprintDeploymentResponseDownload) GetNumFaultTolerance() int64 {
	if o == nil || IsNil(o.NumFaultTolerance) {
		var ret int64
		return ret
	}
	return *o.NumFaultTolerance
}

// GetNumFaultToleranceOk returns a tuple with the NumFaultTolerance field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDeploymentResponseDownload) GetNumFaultToleranceOk() (*int64, bool) {
	if o == nil || IsNil(o.NumFaultTolerance) {
		return nil, false
	}
	return o.NumFaultTolerance, true
}
...
// SetNumFaultTolerance gets a reference to the given int64 and assigns it to the NumFaultTolerance field.
func (o *BlueprintDeploymentResponseDownload) SetNumFaultTolerance(v int64) {
	o.NumFaultTolerance = &v
}

// GetBrownfieldInstanceList returns the BrownfieldInstanceList field value if set, zero value otherwise.
func (o *BlueprintDeploymentResponseDownload) GetBrownfieldInstanceList() []BrownfieldInstanceInput {
	if o == nil || IsNil(o.BrownfieldInstanceList) {
		var ret []BrownfieldInstanceInput
		return ret
	}
	return o.BrownfieldInstanceList
}

// GetBrownfieldInstanceListOk returns a tuple with the BrownfieldInstanceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlueprintDeploymentResponseDownload) GetBrownfieldInstanceListOk() ([]BrownfieldInstanceInput, bool) {
	if o == nil || IsNil(o.BrownfieldInstanceList) {
		return nil, false
	}
	return o.BrownfieldInstanceList, true
}
...
// SetBrownfieldInstanceList gets a reference to the given []BrownfieldInstanceInput and assigns it to the BrownfieldInstanceList field.
func (o *BlueprintDeploymentResponseDownload) SetBrownfieldInstanceList(v []BrownfieldInstanceInput) {
	o.BrownfieldInstanceList = v
}

func (o BlueprintDeploymentResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o BlueprintDeploymentResponseDownload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PercentFaultTolerance) {
		toSerialize["percent_fault_tolerance"] = o.PercentFaultTolerance
	}
	if !IsNil(o.FaultDomainScope) {
		toSerialize["fault_domain_scope"] = o.FaultDomainScope
	}
	if !IsNil(o.Description) {
		toSerialize["description"] = o.Description
	}
	if !IsNil(o.ActionList) {
		toSerialize["action_list"] = o.ActionList
	}
	if !IsNil(o.Type) {
		toSerialize["type"] = o.Type
	}
	toSerialize["message_list"] = o.MessageList
	if !IsNil(o.UUID) {
		toSerialize["uuid"] = o.UUID
	}
	toSerialize["name"] = o.Name
	if !IsNil(o.Editables) {
		toSerialize["editables"] = o.Editables
	}
	toSerialize["state"] = o.State
	if !IsNil(o.PublishedServiceLocalReferenceList) {
		toSerialize["published_service_local_reference_list"] = o.PublishedServiceLocalReferenceList
	}
	if !IsNil(o.DependsOnList) {
		toSerialize["depends_on_list"] = o.DependsOnList
	}
	toSerialize["max_replicas"] = o.MaxReplicas
	if !IsNil(o.PackageLocalReferenceList) {
		toSerialize["package_local_reference_list"] = o.PackageLocalReferenceList
	}
	toSerialize["substrate_local_reference"] = o.SubstrateLocalReference
	if !IsNil(o.VariableList) {
		toSerialize["variable_list"] = o.VariableList
	}
	toSerialize["min_replicas"] = o.MinReplicas
	if !IsNil(o.Options) {
		toSerialize["options"] = o.Options
	}
	if !IsNil(o.NumFaultTolerance) {
		toSerialize["num_fault_tolerance"] = o.NumFaultTolerance
	}
	if !IsNil(o.BrownfieldInstanceList) {
		toSerialize["brownfield_instance_list"] = o.BrownfieldInstanceList
	}
...
func (o *BlueprintDeploymentResponseDownload) UnmarshalJSON(data []byte) (err error) {
	...
	varBlueprintDeploymentResponseDownload := _BlueprintDeploymentResponseDownload{}

	err = json.Unmarshal(data, &varBlueprintDeploymentResponseDownload)

	if err != nil {
		return err
	}

	*o = BlueprintDeploymentResponseDownload(varBlueprintDeploymentResponseDownload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "percent_fault_tolerance")
		delete(additionalProperties, "fault_domain_scope")
		delete(additionalProperties, "description")
		delete(additionalProperties, "action_list")
		delete(additionalProperties, "type")
		delete(additionalProperties, "message_list")
		delete(additionalProperties, "uuid")
		delete(additionalProperties, "name")
		delete(additionalProperties, "editables")
		delete(additionalProperties, "state")
		delete(additionalProperties, "published_service_local_reference_list")
		delete(additionalProperties, "depends_on_list")
		delete(additionalProperties, "max_replicas")
		delete(additionalProperties, "package_local_reference_list")
		delete(additionalProperties, "substrate_local_reference")
		delete(additionalProperties, "variable_list")
		delete(additionalProperties, "min_replicas")
		delete(additionalProperties, "options")
		delete(additionalProperties, "num_fault_tolerance")
		delete(additionalProperties, "brownfield_instance_list")
...
type NullableBlueprintDeploymentResponseDownload struct {
	value *BlueprintDeploymentResponseDownload
	isSet bool
}

func (v NullableBlueprintDeploymentResponseDownload) Get() *BlueprintDeploymentResponseDownload {
	return v.value
}

func (v *NullableBlueprintDeploymentResponseDownload) Set(val *BlueprintDeploymentResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintDeploymentResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintDeploymentResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintDeploymentResponseDownload(val *BlueprintDeploymentResponseDownload) *NullableBlueprintDeploymentResponseDownload {
	return &NullableBlueprintDeploymentResponseDownload{value: val, isSet: true}
}

func (v NullableBlueprintDeploymentResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintDeploymentResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
