...
// checks if the AppServiceResponseDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppServiceResponseDownload{}

// AppServiceResponseDownload Service definition for Application
type AppServiceResponseDownload struct {
	...
	// 
	ElementList []AppServiceElement `json:"element_list,omitempty"`
	// 
	DependsOnList []EntityReference `json:"depends_on_list,omitempty"`
	// 
	Name string `json:"name"`
	ConfigReference *AppServiceReferenceUpload `json:"config_reference,omitempty"`
	// 
	State string `json:"state"`
	// 
	PortList []AppServicePort `json:"port_list,omitempty"`
	...
	// Additional properties for k8s continaer spec
	ContainerSpec map[string]interface{} `json:"container_spec,omitempty"`
	// Message list for service
...
type _AppServiceResponseDownload AppServiceResponseDownload
...
func NewAppServiceResponseDownload(uUID string, actionList []AppActionResponse, name string, state string, variableList []AppVariableResponse) *AppServiceResponseDownload {
	this := AppServiceResponseDownload{}
...
// GetSingleton returns the Singleton field value if set, zero value otherwise.
func (o *AppServiceResponseDownload) GetSingleton() bool {
	if o == nil || IsNil(o.Singleton) {
		var ret bool
		return ret
	}
	return *o.Singleton
...
// GetSingletonOk returns a tuple with the Singleton field value if set, nil otherwise
...
// SetSingleton gets a reference to the given bool and assigns it to the Singleton field.
...
// SetElementList gets a reference to the given []AppServiceElement and assigns it to the ElementList field.
...
func (o *AppServiceResponseDownload) GetConfigReference() AppServiceReferenceUpload {
	if o == nil || IsNil(o.ConfigReference) {
		var ret AppServiceReferenceUpload
		return ret
	}
...
// SetConfigReference gets a reference to the given AppServiceReferenceUpload and assigns it to the ConfigReference field.
...
// SetPortList gets a reference to the given []AppServicePort and assigns it to the PortList field.
...
// GetContainerSpec returns the ContainerSpec field value if set, zero value otherwise.
func (o *AppServiceResponseDownload) GetContainerSpec() map[string]interface{} {
	if o == nil || IsNil(o.ContainerSpec) {
		var ret map[string]interface{}
		return ret
	}
	return o.ContainerSpec
}

// GetContainerSpecOk returns a tuple with the ContainerSpec field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppServiceResponseDownload) GetContainerSpecOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.ContainerSpec) {
		return map[string]interface{}{}, false
	}
	return o.ContainerSpec, true
}
...
// SetContainerSpec gets a reference to the given map[string]interface{} and assigns it to the ContainerSpec field.
...
func (o AppServiceResponseDownload) MarshalJSON() ([]byte, error) {
...
func (o AppServiceResponseDownload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Singleton) {
	...
	if !IsNil(o.ContainerSpec) {
		toSerialize["container_spec"] = o.ContainerSpec
	}
...
func (o *AppServiceResponseDownload) UnmarshalJSON(data []byte) (err error) {
	...
	varAppServiceResponseDownload := _AppServiceResponseDownload{}

	err = json.Unmarshal(data, &varAppServiceResponseDownload)

	if err != nil {
		return err
	}

	*o = AppServiceResponseDownload(varAppServiceResponseDownload)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "singleton")
		...
		delete(additionalProperties, "port_list")
		delete(additionalProperties, "editables")
		delete(additionalProperties, "tier")
		delete(additionalProperties, "container_spec")
...
type NullableAppServiceResponseDownload struct {
	value *AppServiceResponseDownload
	isSet bool
}

func (v NullableAppServiceResponseDownload) Get() *AppServiceResponseDownload {
	return v.value
}

func (v *NullableAppServiceResponseDownload) Set(val *AppServiceResponseDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableAppServiceResponseDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableAppServiceResponseDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppServiceResponseDownload(val *AppServiceResponseDownload) *NullableAppServiceResponseDownload {
	return &NullableAppServiceResponseDownload{value: val, isSet: true}
}

func (v NullableAppServiceResponseDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppServiceResponseDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
