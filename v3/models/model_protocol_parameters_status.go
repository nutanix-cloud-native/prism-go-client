...
// checks if the ProtocolParametersStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtocolParametersStatus{}

// ProtocolParametersStatus Routing policy IP protocol parameters
type ProtocolParametersStatus struct {
	Udp *UdpStatus `json:"udp,omitempty"`
	Icmp *IcmpStatus `json:"icmp,omitempty"`
	ProtocolNumber *int32 `json:"protocol_number,omitempty"`
	Tcp *TcpStatus `json:"tcp,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ProtocolParametersStatus ProtocolParametersStatus
...
// SetUdp gets a reference to the given UdpStatus and assigns it to the Udp field.
...
// SetIcmp gets a reference to the given IcmpStatus and assigns it to the Icmp field.
func (o *ProtocolParametersStatus) SetIcmp(v IcmpStatus) {
	o.Icmp = &v
}

// GetProtocolNumber returns the ProtocolNumber field value if set, zero value otherwise.
func (o *ProtocolParametersStatus) GetProtocolNumber() int32 {
	if o == nil || IsNil(o.ProtocolNumber) {
		var ret int32
		return ret
	}
...
// GetProtocolNumberOk returns a tuple with the ProtocolNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProtocolParametersStatus) GetProtocolNumberOk() (*int32, bool) {
	if o == nil || IsNil(o.ProtocolNumber) {
		return nil, false
	}
	return o.ProtocolNumber, true
}
...
// SetProtocolNumber gets a reference to the given int32 and assigns it to the ProtocolNumber field.
...
// SetTcp gets a reference to the given TcpStatus and assigns it to the Tcp field.
func (o *ProtocolParametersStatus) SetTcp(v TcpStatus) {
	o.Tcp = &v
}

func (o ProtocolParametersStatus) MarshalJSON() ([]byte, error) {
...
func (o ProtocolParametersStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ProtocolNumber) {
		toSerialize["protocol_number"] = o.ProtocolNumber
	}
	if !IsNil(o.Tcp) {
...
func (o *ProtocolParametersStatus) UnmarshalJSON(data []byte) (err error) {
	varProtocolParametersStatus := _ProtocolParametersStatus{}

	err = json.Unmarshal(data, &varProtocolParametersStatus)

	if err != nil {
		return err
	}

	*o = ProtocolParametersStatus(varProtocolParametersStatus)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "protocol_number")
...
type NullableProtocolParametersStatus struct {
	value *ProtocolParametersStatus
	isSet bool
}

func (v NullableProtocolParametersStatus) Get() *ProtocolParametersStatus {
	return v.value
}

func (v *NullableProtocolParametersStatus) Set(val *ProtocolParametersStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableProtocolParametersStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableProtocolParametersStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtocolParametersStatus(val *ProtocolParametersStatus) *NullableProtocolParametersStatus {
	return &NullableProtocolParametersStatus{value: val, isSet: true}
}

func (v NullableProtocolParametersStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtocolParametersStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
