...
// checks if the AppSubstrateReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSubstrateReference{}

// AppSubstrateReference The reference to a app_substrate
type AppSubstrateReference struct {
	// The kind name
...
type _AppSubstrateReference AppSubstrateReference
...
func (o AppSubstrateReference) MarshalJSON() ([]byte, error) {
...
func (o AppSubstrateReference) ToMap() (map[string]interface{}, error) {
...
func (o *AppSubstrateReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAppSubstrateReference := _AppSubstrateReference{}

	err = json.Unmarshal(data, &varAppSubstrateReference)

	if err != nil {
		return err
	}

	*o = AppSubstrateReference(varAppSubstrateReference)
...
type NullableAppSubstrateReference struct {
	value *AppSubstrateReference
	isSet bool
}

func (v NullableAppSubstrateReference) Get() *AppSubstrateReference {
	return v.value
}

func (v *NullableAppSubstrateReference) Set(val *AppSubstrateReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAppSubstrateReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAppSubstrateReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppSubstrateReference(val *AppSubstrateReference) *NullableAppSubstrateReference {
	return &NullableAppSubstrateReference{value: val, isSet: true}
}

func (v NullableAppSubstrateReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppSubstrateReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
