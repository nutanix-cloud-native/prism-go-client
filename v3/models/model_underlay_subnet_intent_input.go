...
// checks if the UnderlaySubnetIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnderlaySubnetIntentInput{}

// UnderlaySubnetIntentInput An intentful representation of a underlay_subnet
type UnderlaySubnetIntentInput struct {
	Spec UnderlaySubnet `json:"spec"`
...
type _UnderlaySubnetIntentInput UnderlaySubnetIntentInput
...
func NewUnderlaySubnetIntentInput(spec UnderlaySubnet, metadata UnderlaySubnetMetadata) *UnderlaySubnetIntentInput {
	this := UnderlaySubnetIntentInput{}
	this.Spec = spec
...
func (o UnderlaySubnetIntentInput) MarshalJSON() ([]byte, error) {
...
func (o UnderlaySubnetIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *UnderlaySubnetIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varUnderlaySubnetIntentInput := _UnderlaySubnetIntentInput{}

	err = json.Unmarshal(data, &varUnderlaySubnetIntentInput)

	if err != nil {
		return err
	}

	*o = UnderlaySubnetIntentInput(varUnderlaySubnetIntentInput)
...
type NullableUnderlaySubnetIntentInput struct {
	value *UnderlaySubnetIntentInput
	isSet bool
}

func (v NullableUnderlaySubnetIntentInput) Get() *UnderlaySubnetIntentInput {
	return v.value
}

func (v *NullableUnderlaySubnetIntentInput) Set(val *UnderlaySubnetIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableUnderlaySubnetIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableUnderlaySubnetIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnderlaySubnetIntentInput(val *UnderlaySubnetIntentInput) *NullableUnderlaySubnetIntentInput {
	return &NullableUnderlaySubnetIntentInput{value: val, isSet: true}
}

func (v NullableUnderlaySubnetIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnderlaySubnetIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
