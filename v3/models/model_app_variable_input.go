...
// checks if the AppVariableInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppVariableInput{}

// AppVariableInput Variable definition for application.
...
type _AppVariableInput AppVariableInput
...
func (o AppVariableInput) MarshalJSON() ([]byte, error) {
...
func (o AppVariableInput) ToMap() (map[string]interface{}, error) {
...
func (o *AppVariableInput) UnmarshalJSON(data []byte) (err error) {
	...
	varAppVariableInput := _AppVariableInput{}

	err = json.Unmarshal(data, &varAppVariableInput)

	if err != nil {
		return err
	}

	*o = AppVariableInput(varAppVariableInput)
...
type NullableAppVariableInput struct {
	value *AppVariableInput
	isSet bool
}

func (v NullableAppVariableInput) Get() *AppVariableInput {
	return v.value
}

func (v *NullableAppVariableInput) Set(val *AppVariableInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAppVariableInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAppVariableInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppVariableInput(val *AppVariableInput) *NullableAppVariableInput {
	return &NullableAppVariableInput{value: val, isSet: true}
}

func (v NullableAppVariableInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppVariableInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
