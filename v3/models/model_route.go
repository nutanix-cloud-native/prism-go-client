...
// Route Route directing network traffic through a link to another site or the Internet. 
type Route struct {
	Nexthop RouteNexthopReference `json:"nexthop"`
