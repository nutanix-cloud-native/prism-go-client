...
// checks if the RoutingPolicyDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyDefStatus{}

// RoutingPolicyDefStatus An intentful representation of a routing_policy status
...
type _RoutingPolicyDefStatus RoutingPolicyDefStatus
...
func (o *RoutingPolicyDefStatus) GetResources() RoutingPolicyResourcesDefStatus {
	if o == nil {
		var ret RoutingPolicyResourcesDefStatus
		return ret
	}
...
func (o RoutingPolicyDefStatus) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingPolicyDefStatus := _RoutingPolicyDefStatus{}

	err = json.Unmarshal(data, &varRoutingPolicyDefStatus)

	if err != nil {
		return err
	}

	*o = RoutingPolicyDefStatus(varRoutingPolicyDefStatus)
...
type NullableRoutingPolicyDefStatus struct {
	value *RoutingPolicyDefStatus
	isSet bool
}

func (v NullableRoutingPolicyDefStatus) Get() *RoutingPolicyDefStatus {
	return v.value
}

func (v *NullableRoutingPolicyDefStatus) Set(val *RoutingPolicyDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyDefStatus(val *RoutingPolicyDefStatus) *NullableRoutingPolicyDefStatus {
	return &NullableRoutingPolicyDefStatus{value: val, isSet: true}
}

func (v NullableRoutingPolicyDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
