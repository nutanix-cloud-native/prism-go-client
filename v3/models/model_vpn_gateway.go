...
// VpnGateway An intentful representation of a vpn_gateway spec
type VpnGateway struct {
	...
	Resources VpnGatewayResources `json:"resources"`
	// vpn_gateway Name.
...
func (o *VpnGateway) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVpnGateway)
