...
// checks if the CloudCredentialsReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCredentialsReference{}

// CloudCredentialsReference The reference to a cloud_credentials
...
type _CloudCredentialsReference CloudCredentialsReference
...
func NewCloudCredentialsReference(kind string, uUID string) *CloudCredentialsReference {
	this := CloudCredentialsReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o CloudCredentialsReference) MarshalJSON() ([]byte, error) {
...
func (o CloudCredentialsReference) ToMap() (map[string]interface{}, error) {
...
func (o *CloudCredentialsReference) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudCredentialsReference := _CloudCredentialsReference{}

	err = json.Unmarshal(data, &varCloudCredentialsReference)

	if err != nil {
		return err
	}

	*o = CloudCredentialsReference(varCloudCredentialsReference)
...
type NullableCloudCredentialsReference struct {
	value *CloudCredentialsReference
	isSet bool
}

func (v NullableCloudCredentialsReference) Get() *CloudCredentialsReference {
	return v.value
}

func (v *NullableCloudCredentialsReference) Set(val *CloudCredentialsReference) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCredentialsReference) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCredentialsReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCredentialsReference(val *CloudCredentialsReference) *NullableCloudCredentialsReference {
	return &NullableCloudCredentialsReference{value: val, isSet: true}
}

func (v NullableCloudCredentialsReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCredentialsReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
