...
// checks if the DirectoryServiceUserStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceUserStatus{}

// DirectoryServiceUserStatus A Directory Service user.
type DirectoryServiceUserStatus struct {
	// The UserPrincipalName of the user from the directory service. It will be same as default user principal name if no upn suffix is enabled for user logon name in directory service. 
...
type _DirectoryServiceUserStatus DirectoryServiceUserStatus
...
func NewDirectoryServiceUserStatus() *DirectoryServiceUserStatus {
	this := DirectoryServiceUserStatus{}
	return &this
}
...
// GetDefaultUserPrincipalName returns the DefaultUserPrincipalName field value if set, zero value otherwise.
func (o *DirectoryServiceUserStatus) GetDefaultUserPrincipalName() string {
	if o == nil || IsNil(o.DefaultUserPrincipalName) {
		var ret string
		return ret
	}
	return *o.DefaultUserPrincipalName
}

// GetDefaultUserPrincipalNameOk returns a tuple with the DefaultUserPrincipalName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectoryServiceUserStatus) GetDefaultUserPrincipalNameOk() (*string, bool) {
	if o == nil || IsNil(o.DefaultUserPrincipalName) {
		return nil, false
	}
	return o.DefaultUserPrincipalName, true
}
...
// SetDefaultUserPrincipalName gets a reference to the given string and assigns it to the DefaultUserPrincipalName field.
func (o *DirectoryServiceUserStatus) SetDefaultUserPrincipalName(v string) {
	o.DefaultUserPrincipalName = &v
}

func (o DirectoryServiceUserStatus) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceUserStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DefaultUserPrincipalName) {
		toSerialize["default_user_principal_name"] = o.DefaultUserPrincipalName
	}
...
func (o *DirectoryServiceUserStatus) UnmarshalJSON(data []byte) (err error) {
	varDirectoryServiceUserStatus := _DirectoryServiceUserStatus{}

	err = json.Unmarshal(data, &varDirectoryServiceUserStatus)

	if err != nil {
		return err
	}

	*o = DirectoryServiceUserStatus(varDirectoryServiceUserStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "user_principal_name")
		delete(additionalProperties, "directory_service_reference")
		delete(additionalProperties, "default_user_principal_name")
...
type NullableDirectoryServiceUserStatus struct {
	value *DirectoryServiceUserStatus
	isSet bool
}

func (v NullableDirectoryServiceUserStatus) Get() *DirectoryServiceUserStatus {
	return v.value
}

func (v *NullableDirectoryServiceUserStatus) Set(val *DirectoryServiceUserStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceUserStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceUserStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceUserStatus(val *DirectoryServiceUserStatus) *NullableDirectoryServiceUserStatus {
	return &NullableDirectoryServiceUserStatus{value: val, isSet: true}
}

func (v NullableDirectoryServiceUserStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceUserStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
