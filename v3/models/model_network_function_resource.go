...
// checks if the NetworkFunctionResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionResource{}

// NetworkFunctionResource network function resource definition.
type NetworkFunctionResource struct {
	// The type of the network function.
	NetworkFunctionType string `json:"network_function_type"`
	CategoryFilter CategoryFilter `json:"category_filter"`
	AdditionalProperties map[string]interface{}
}

type _NetworkFunctionResource NetworkFunctionResource
...
// GetNetworkFunctionType returns the NetworkFunctionType field value
func (o *NetworkFunctionResource) GetNetworkFunctionType() string {
	...
	return o.NetworkFunctionType
}

// GetNetworkFunctionTypeOk returns a tuple with the NetworkFunctionType field value
// and a boolean to check if the value has been set.
func (o *NetworkFunctionResource) GetNetworkFunctionTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.NetworkFunctionType, true
}

// SetNetworkFunctionType sets field value
func (o *NetworkFunctionResource) SetNetworkFunctionType(v string) {
	o.NetworkFunctionType = v
}

// GetCategoryFilter returns the CategoryFilter field value
...
// GetCategoryFilterOk returns a tuple with the CategoryFilter field value
// and a boolean to check if the value has been set.
...
// SetCategoryFilter sets field value
func (o *NetworkFunctionResource) SetCategoryFilter(v CategoryFilter) {
	o.CategoryFilter = v
}

func (o NetworkFunctionResource) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionResource) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["network_function_type"] = o.NetworkFunctionType
...
func (o *NetworkFunctionResource) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkFunctionResource := _NetworkFunctionResource{}

	err = json.Unmarshal(data, &varNetworkFunctionResource)

	if err != nil {
		return err
	}

	*o = NetworkFunctionResource(varNetworkFunctionResource)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "network_function_type")
...
type NullableNetworkFunctionResource struct {
	value *NetworkFunctionResource
	isSet bool
}

func (v NullableNetworkFunctionResource) Get() *NetworkFunctionResource {
	return v.value
}

func (v *NullableNetworkFunctionResource) Set(val *NetworkFunctionResource) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionResource) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionResource(val *NetworkFunctionResource) *NullableNetworkFunctionResource {
	return &NullableNetworkFunctionResource{value: val, isSet: true}
}

func (v NullableNetworkFunctionResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
