...
// checks if the UserListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserListMetadata{}

// UserListMetadata All api calls that return a list will have this metadata block as input 
...
type _UserListMetadata UserListMetadata
...
func (o UserListMetadata) MarshalJSON() ([]byte, error) {
...
func (o UserListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *UserListMetadata) UnmarshalJSON(data []byte) (err error) {
	varUserListMetadata := _UserListMetadata{}

	err = json.Unmarshal(data, &varUserListMetadata)

	if err != nil {
		return err
	}

	*o = UserListMetadata(varUserListMetadata)
...
type NullableUserListMetadata struct {
	value *UserListMetadata
	isSet bool
}

func (v NullableUserListMetadata) Get() *UserListMetadata {
	return v.value
}

func (v *NullableUserListMetadata) Set(val *UserListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableUserListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableUserListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserListMetadata(val *UserListMetadata) *NullableUserListMetadata {
	return &NullableUserListMetadata{value: val, isSet: true}
}

func (v NullableUserListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
