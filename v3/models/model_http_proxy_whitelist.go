...
// checks if the HttpProxyWhitelist type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpProxyWhitelist{}

// HttpProxyWhitelist Exempt HTTP traffic to these targets, from going through the configured HTTP Proxy. 
type HttpProxyWhitelist struct {
	// The target's identifier (as specified by the target_type). For eg: \"10.1.1.1\" \"www.google.com\" 
	Target string `json:"target"`
	// Supplementing information for the \"target\" field, that describes how to interpret it. For eg: If target is a IPv4 address such as \"10.1.1.1\", target_type shold be \"IPv4_ADDRESS\". If target is a host name such as \"www.google.com\", then target_type shoold be \"HOST_NAME\" 
	TargetType string `json:"target_type"`
	AdditionalProperties map[string]interface{}
}

type _HttpProxyWhitelist HttpProxyWhitelist
...
func (o HttpProxyWhitelist) MarshalJSON() ([]byte, error) {
...
func (o HttpProxyWhitelist) ToMap() (map[string]interface{}, error) {
...
func (o *HttpProxyWhitelist) UnmarshalJSON(data []byte) (err error) {
	...
	varHttpProxyWhitelist := _HttpProxyWhitelist{}

	err = json.Unmarshal(data, &varHttpProxyWhitelist)

	if err != nil {
		return err
	}

	*o = HttpProxyWhitelist(varHttpProxyWhitelist)
...
type NullableHttpProxyWhitelist struct {
	value *HttpProxyWhitelist
	isSet bool
}

func (v NullableHttpProxyWhitelist) Get() *HttpProxyWhitelist {
	return v.value
}

func (v *NullableHttpProxyWhitelist) Set(val *HttpProxyWhitelist) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpProxyWhitelist) IsSet() bool {
	return v.isSet
}

func (v *NullableHttpProxyWhitelist) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttpProxyWhitelist(val *HttpProxyWhitelist) *NullableHttpProxyWhitelist {
	return &NullableHttpProxyWhitelist{value: val, isSet: true}
}

func (v NullableHttpProxyWhitelist) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHttpProxyWhitelist) UnmarshalJSON(src []byte) error {
	v.isSet = true
