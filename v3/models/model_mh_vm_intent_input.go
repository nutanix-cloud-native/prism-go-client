...
// checks if the MhVmIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MhVmIntentInput{}

// MhVmIntentInput An intentful representation of a mh_vm
type MhVmIntentInput struct {
	Spec MhVm `json:"spec"`
...
type _MhVmIntentInput MhVmIntentInput
...
func (o MhVmIntentInput) MarshalJSON() ([]byte, error) {
...
func (o MhVmIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *MhVmIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varMhVmIntentInput := _MhVmIntentInput{}

	err = json.Unmarshal(data, &varMhVmIntentInput)

	if err != nil {
		return err
	}

	*o = MhVmIntentInput(varMhVmIntentInput)
...
type NullableMhVmIntentInput struct {
	value *MhVmIntentInput
	isSet bool
}

func (v NullableMhVmIntentInput) Get() *MhVmIntentInput {
	return v.value
}

func (v *NullableMhVmIntentInput) Set(val *MhVmIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableMhVmIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableMhVmIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMhVmIntentInput(val *MhVmIntentInput) *NullableMhVmIntentInput {
	return &NullableMhVmIntentInput{value: val, isSet: true}
}

func (v NullableMhVmIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMhVmIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
