...
// checks if the ActionRuleIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleIntentResponse{}

// ActionRuleIntentResponse Response object for intentful operations on a action_rule
type ActionRuleIntentResponse struct {
	Status *ActionRuleDefStatus `json:"status,omitempty"`
	Spec *ActionRule `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata ActionRuleMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _ActionRuleIntentResponse ActionRuleIntentResponse
...
// SetStatus gets a reference to the given ActionRuleDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given ActionRule and assigns it to the Spec field.
...
func (o ActionRuleIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleIntentResponse := _ActionRuleIntentResponse{}

	err = json.Unmarshal(data, &varActionRuleIntentResponse)

	if err != nil {
		return err
	}

	*o = ActionRuleIntentResponse(varActionRuleIntentResponse)
...
type NullableActionRuleIntentResponse struct {
	value *ActionRuleIntentResponse
	isSet bool
}

func (v NullableActionRuleIntentResponse) Get() *ActionRuleIntentResponse {
	return v.value
}

func (v *NullableActionRuleIntentResponse) Set(val *ActionRuleIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleIntentResponse(val *ActionRuleIntentResponse) *NullableActionRuleIntentResponse {
	return &NullableActionRuleIntentResponse{value: val, isSet: true}
}

func (v NullableActionRuleIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
