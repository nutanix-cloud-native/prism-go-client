...
// checks if the VirtualNetworkStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualNetworkStatus{}

// VirtualNetworkStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _VirtualNetworkStatus VirtualNetworkStatus
...
func (o VirtualNetworkStatus) MarshalJSON() ([]byte, error) {
...
func (o VirtualNetworkStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualNetworkStatus) UnmarshalJSON(data []byte) (err error) {
	varVirtualNetworkStatus := _VirtualNetworkStatus{}

	err = json.Unmarshal(data, &varVirtualNetworkStatus)

	if err != nil {
		return err
	}

	*o = VirtualNetworkStatus(varVirtualNetworkStatus)
...
type NullableVirtualNetworkStatus struct {
	value *VirtualNetworkStatus
	isSet bool
}

func (v NullableVirtualNetworkStatus) Get() *VirtualNetworkStatus {
	return v.value
}

func (v *NullableVirtualNetworkStatus) Set(val *VirtualNetworkStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualNetworkStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualNetworkStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualNetworkStatus(val *VirtualNetworkStatus) *NullableVirtualNetworkStatus {
	return &NullableVirtualNetworkStatus{value: val, isSet: true}
}

func (v NullableVirtualNetworkStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualNetworkStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
