...
// checks if the VmDiskMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDiskMetadata{}

// VmDiskMetadata The vm_disk kind metadata
type VmDiskMetadata struct {
	...
	// Categories for the vm_disk. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the vm_disk. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _VmDiskMetadata VmDiskMetadata
...
func (o VmDiskMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmDiskMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmDiskMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVmDiskMetadata := _VmDiskMetadata{}

	err = json.Unmarshal(data, &varVmDiskMetadata)

	if err != nil {
		return err
	}

	*o = VmDiskMetadata(varVmDiskMetadata)
...
type NullableVmDiskMetadata struct {
	value *VmDiskMetadata
	isSet bool
}

func (v NullableVmDiskMetadata) Get() *VmDiskMetadata {
	return v.value
}

func (v *NullableVmDiskMetadata) Set(val *VmDiskMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmDiskMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmDiskMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmDiskMetadata(val *VmDiskMetadata) *NullableVmDiskMetadata {
	return &NullableVmDiskMetadata{value: val, isSet: true}
}

func (v NullableVmDiskMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmDiskMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
