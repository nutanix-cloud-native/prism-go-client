...
// checks if the SecurityPlanningClusterCapability type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityPlanningClusterCapability{}

// SecurityPlanningClusterCapability Flow Security Planning capability of a cluster.
type SecurityPlanningClusterCapability struct {
	...
	DataCollectorPrechecks *SecurityPlanningPrechecks `json:"data_collector_prechecks,omitempty"`
	TrafficVisibilityPrechecks *TrafficVisibilityPrecheckResults `json:"traffic_visibility_prechecks,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SecurityPlanningClusterCapability SecurityPlanningClusterCapability
...
func NewSecurityPlanningClusterCapability() *SecurityPlanningClusterCapability {
	this := SecurityPlanningClusterCapability{}
	return &this
}
...
// GetDataCollectorPrechecks returns the DataCollectorPrechecks field value if set, zero value otherwise.
func (o *SecurityPlanningClusterCapability) GetDataCollectorPrechecks() SecurityPlanningPrechecks {
	if o == nil || IsNil(o.DataCollectorPrechecks) {
		var ret SecurityPlanningPrechecks
		return ret
	}
	return *o.DataCollectorPrechecks
}

// GetDataCollectorPrechecksOk returns a tuple with the DataCollectorPrechecks field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SecurityPlanningClusterCapability) GetDataCollectorPrechecksOk() (*SecurityPlanningPrechecks, bool) {
	if o == nil || IsNil(o.DataCollectorPrechecks) {
		return nil, false
	}
	return o.DataCollectorPrechecks, true
}
...
// SetDataCollectorPrechecks gets a reference to the given SecurityPlanningPrechecks and assigns it to the DataCollectorPrechecks field.
func (o *SecurityPlanningClusterCapability) SetDataCollectorPrechecks(v SecurityPlanningPrechecks) {
	o.DataCollectorPrechecks = &v
}

// GetTrafficVisibilityPrechecks returns the TrafficVisibilityPrechecks field value if set, zero value otherwise.
func (o *SecurityPlanningClusterCapability) GetTrafficVisibilityPrechecks() TrafficVisibilityPrecheckResults {
	if o == nil || IsNil(o.TrafficVisibilityPrechecks) {
		var ret TrafficVisibilityPrecheckResults
		return ret
	}
	return *o.TrafficVisibilityPrechecks
}

// GetTrafficVisibilityPrechecksOk returns a tuple with the TrafficVisibilityPrechecks field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SecurityPlanningClusterCapability) GetTrafficVisibilityPrechecksOk() (*TrafficVisibilityPrecheckResults, bool) {
	if o == nil || IsNil(o.TrafficVisibilityPrechecks) {
		return nil, false
	}
	return o.TrafficVisibilityPrechecks, true
}
...
// SetTrafficVisibilityPrechecks gets a reference to the given TrafficVisibilityPrecheckResults and assigns it to the TrafficVisibilityPrechecks field.
func (o *SecurityPlanningClusterCapability) SetTrafficVisibilityPrechecks(v TrafficVisibilityPrecheckResults) {
	o.TrafficVisibilityPrechecks = &v
}

func (o SecurityPlanningClusterCapability) MarshalJSON() ([]byte, error) {
...
func (o SecurityPlanningClusterCapability) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DataCollectorPrechecks) {
		toSerialize["data_collector_prechecks"] = o.DataCollectorPrechecks
	}
	if !IsNil(o.TrafficVisibilityPrechecks) {
		toSerialize["traffic_visibility_prechecks"] = o.TrafficVisibilityPrechecks
	}
...
func (o *SecurityPlanningClusterCapability) UnmarshalJSON(data []byte) (err error) {
	varSecurityPlanningClusterCapability := _SecurityPlanningClusterCapability{}

	err = json.Unmarshal(data, &varSecurityPlanningClusterCapability)

	if err != nil {
		return err
	}

	*o = SecurityPlanningClusterCapability(varSecurityPlanningClusterCapability)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "data_collector_prechecks")
		delete(additionalProperties, "traffic_visibility_prechecks")
...
type NullableSecurityPlanningClusterCapability struct {
	value *SecurityPlanningClusterCapability
	isSet bool
}

func (v NullableSecurityPlanningClusterCapability) Get() *SecurityPlanningClusterCapability {
	return v.value
}

func (v *NullableSecurityPlanningClusterCapability) Set(val *SecurityPlanningClusterCapability) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityPlanningClusterCapability) IsSet() bool {
	return v.isSet
}

func (v *NullableSecurityPlanningClusterCapability) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecurityPlanningClusterCapability(val *SecurityPlanningClusterCapability) *NullableSecurityPlanningClusterCapability {
	return &NullableSecurityPlanningClusterCapability{value: val, isSet: true}
}

func (v NullableSecurityPlanningClusterCapability) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecurityPlanningClusterCapability) UnmarshalJSON(src []byte) error {
	v.isSet = true
