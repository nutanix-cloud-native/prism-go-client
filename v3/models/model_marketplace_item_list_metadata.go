...
// checks if the MarketplaceItemListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceItemListMetadata{}

// MarketplaceItemListMetadata All api calls that return a list will have this metadata block as input 
type MarketplaceItemListMetadata struct {
	// The kind name
...
type _MarketplaceItemListMetadata MarketplaceItemListMetadata
...
func NewMarketplaceItemListMetadata() *MarketplaceItemListMetadata {
	this := MarketplaceItemListMetadata{}
...
func (o MarketplaceItemListMetadata) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceItemListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceItemListMetadata) UnmarshalJSON(data []byte) (err error) {
	varMarketplaceItemListMetadata := _MarketplaceItemListMetadata{}

	err = json.Unmarshal(data, &varMarketplaceItemListMetadata)

	if err != nil {
		return err
	}

	*o = MarketplaceItemListMetadata(varMarketplaceItemListMetadata)
...
type NullableMarketplaceItemListMetadata struct {
	value *MarketplaceItemListMetadata
	isSet bool
}

func (v NullableMarketplaceItemListMetadata) Get() *MarketplaceItemListMetadata {
	return v.value
}

func (v *NullableMarketplaceItemListMetadata) Set(val *MarketplaceItemListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceItemListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceItemListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceItemListMetadata(val *MarketplaceItemListMetadata) *NullableMarketplaceItemListMetadata {
	return &NullableMarketplaceItemListMetadata{value: val, isSet: true}
}

func (v NullableMarketplaceItemListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceItemListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
