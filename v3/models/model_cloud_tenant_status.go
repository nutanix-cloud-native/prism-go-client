...
// checks if the CloudTenantStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudTenantStatus{}

// CloudTenantStatus The status of a REST API call. Only used when there is a failure to report. 
type CloudTenantStatus struct {
	// The kind name
...
type _CloudTenantStatus CloudTenantStatus
...
func (o CloudTenantStatus) MarshalJSON() ([]byte, error) {
...
func (o CloudTenantStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CloudTenantStatus) UnmarshalJSON(data []byte) (err error) {
	varCloudTenantStatus := _CloudTenantStatus{}

	err = json.Unmarshal(data, &varCloudTenantStatus)

	if err != nil {
		return err
	}

	*o = CloudTenantStatus(varCloudTenantStatus)
...
type NullableCloudTenantStatus struct {
	value *CloudTenantStatus
	isSet bool
}

func (v NullableCloudTenantStatus) Get() *CloudTenantStatus {
	return v.value
}

func (v *NullableCloudTenantStatus) Set(val *CloudTenantStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTenantStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTenantStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTenantStatus(val *CloudTenantStatus) *NullableCloudTenantStatus {
	return &NullableCloudTenantStatus{value: val, isSet: true}
}

func (v NullableCloudTenantStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTenantStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
