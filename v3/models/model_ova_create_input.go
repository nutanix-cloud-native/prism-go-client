...
// checks if the OvaCreateInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OvaCreateInput{}

// OvaCreateInput Input for OVA item create.
type OvaCreateInput struct {
	...
	UploadClusterRefList []ClusterReference `json:"upload_cluster_ref_list,omitempty"`
...
type _OvaCreateInput OvaCreateInput
...
// GetUploadClusterRefList returns the UploadClusterRefList field value if set, zero value otherwise.
func (o *OvaCreateInput) GetUploadClusterRefList() []ClusterReference {
	if o == nil || IsNil(o.UploadClusterRefList) {
		var ret []ClusterReference
		return ret
	}
	return o.UploadClusterRefList
}

// GetUploadClusterRefListOk returns a tuple with the UploadClusterRefList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OvaCreateInput) GetUploadClusterRefListOk() ([]ClusterReference, bool) {
	if o == nil || IsNil(o.UploadClusterRefList) {
		return nil, false
	}
	return o.UploadClusterRefList, true
}
...
// SetUploadClusterRefList gets a reference to the given []ClusterReference and assigns it to the UploadClusterRefList field.
func (o *OvaCreateInput) SetUploadClusterRefList(v []ClusterReference) {
	o.UploadClusterRefList = v
}

// GetUploadLength returns the UploadLength field value if set, zero value otherwise.
func (o *OvaCreateInput) GetUploadLength() int64 {
	if o == nil || IsNil(o.UploadLength) {
		var ret int64
		return ret
	}
	return *o.UploadLength
}

// GetUploadLengthOk returns a tuple with the UploadLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OvaCreateInput) GetUploadLengthOk() (*int64, bool) {
	if o == nil || IsNil(o.UploadLength) {
		return nil, false
	}
	return o.UploadLength, true
}
...
// SetUploadLength gets a reference to the given int64 and assigns it to the UploadLength field.
func (o *OvaCreateInput) SetUploadLength(v int64) {
	o.UploadLength = &v
}

func (o OvaCreateInput) MarshalJSON() ([]byte, error) {
...
func (o OvaCreateInput) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UploadClusterRefList) {
		toSerialize["upload_cluster_ref_list"] = o.UploadClusterRefList
	}
	if !IsNil(o.UploadLength) {
		toSerialize["upload_length"] = o.UploadLength
	}
...
func (o *OvaCreateInput) UnmarshalJSON(data []byte) (err error) {
	...
	varOvaCreateInput := _OvaCreateInput{}

	err = json.Unmarshal(data, &varOvaCreateInput)

	if err != nil {
		return err
	}

	*o = OvaCreateInput(varOvaCreateInput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "upload_cluster_ref_list")
		delete(additionalProperties, "upload_length")
...
type NullableOvaCreateInput struct {
	value *OvaCreateInput
	isSet bool
}

func (v NullableOvaCreateInput) Get() *OvaCreateInput {
	return v.value
}

func (v *NullableOvaCreateInput) Set(val *OvaCreateInput) {
	v.value = val
	v.isSet = true
}

func (v NullableOvaCreateInput) IsSet() bool {
	return v.isSet
}

func (v *NullableOvaCreateInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOvaCreateInput(val *OvaCreateInput) *NullableOvaCreateInput {
	return &NullableOvaCreateInput{value: val, isSet: true}
}

func (v NullableOvaCreateInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOvaCreateInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
