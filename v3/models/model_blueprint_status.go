...
// BlueprintStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _BlueprintStatus BlueprintStatus
...
func (o *BlueprintStatus) UnmarshalJSON(data []byte) (err error) {
	varBlueprintStatus := _BlueprintStatus{}

	err = json.Unmarshal(data, &varBlueprintStatus)

	if err != nil {
		return err
	}

	*o = BlueprintStatus(varBlueprintStatus)
