...
// checks if the ProjectResources2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectResources2{}

// ProjectResources2 struct for ProjectResources2
type ProjectResources2 struct {
	// List of accounts associated with the project.
	AccountReferenceList []AccountReference `json:"account_reference_list,omitempty"`
	ResourceDomain *ResourceDomainResourcesStatus `json:"resource_domain,omitempty"`
	// List of directory references in the project
	DirectoryReferenceList []DirectoryReference `json:"directory_reference_list,omitempty"`
	// List of identity provider references in the project
	IdentityProvidersReferenceList []IdentityProvidersReference `json:"identity_providers_reference_list,omitempty"`
	...
	EnvironmentReferenceList []EnvironmentReference `json:"environment_reference_list,omitempty"`
	// Indicates if it is the default project. 
	IsDefault *bool `json:"is_default,omitempty"`
	// List of tunnels associated with the project.
	TunnelReferenceList []TunnelReference `json:"tunnel_reference_list,omitempty"`
	// List of directory service groups reference. These groups are not managed by Nutanix. 
	ExternalUserGroupReferenceList []UserGroupReference `json:"external_user_group_reference_list,omitempty"`
	...
	SubnetReferenceList []SubnetReference `json:"subnet_reference_list,omitempty"`
	// List of clusters associated with the project.
	ClusterReferenceList []ClusterReference `json:"cluster_reference_list,omitempty"`
	// List of VPCs associated with the project.
	VpcReferenceList []VpcReference `json:"vpc_reference_list,omitempty"`
...
type _ProjectResources2 ProjectResources2
...
// GetAccountReferenceList returns the AccountReferenceList field value if set, zero value otherwise.
func (o *ProjectResources2) GetAccountReferenceList() []AccountReference {
	if o == nil || IsNil(o.AccountReferenceList) {
		var ret []AccountReference
		return ret
	}
	return o.AccountReferenceList
}

// GetAccountReferenceListOk returns a tuple with the AccountReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetAccountReferenceListOk() ([]AccountReference, bool) {
	if o == nil || IsNil(o.AccountReferenceList) {
		return nil, false
	}
	return o.AccountReferenceList, true
}
...
// SetAccountReferenceList gets a reference to the given []AccountReference and assigns it to the AccountReferenceList field.
func (o *ProjectResources2) SetAccountReferenceList(v []AccountReference) {
	o.AccountReferenceList = v
}
...
func (o *ProjectResources2) GetResourceDomain() ResourceDomainResourcesStatus {
	if o == nil || IsNil(o.ResourceDomain) {
		var ret ResourceDomainResourcesStatus
		return ret
	}
...
// SetResourceDomain gets a reference to the given ResourceDomainResourcesStatus and assigns it to the ResourceDomain field.
func (o *ProjectResources2) SetResourceDomain(v ResourceDomainResourcesStatus) {
	o.ResourceDomain = &v
}

// GetDirectoryReferenceList returns the DirectoryReferenceList field value if set, zero value otherwise.
func (o *ProjectResources2) GetDirectoryReferenceList() []DirectoryReference {
	if o == nil || IsNil(o.DirectoryReferenceList) {
		var ret []DirectoryReference
		return ret
	}
	return o.DirectoryReferenceList
}

// GetDirectoryReferenceListOk returns a tuple with the DirectoryReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetDirectoryReferenceListOk() ([]DirectoryReference, bool) {
	if o == nil || IsNil(o.DirectoryReferenceList) {
		return nil, false
	}
	return o.DirectoryReferenceList, true
}
...
// SetDirectoryReferenceList gets a reference to the given []DirectoryReference and assigns it to the DirectoryReferenceList field.
func (o *ProjectResources2) SetDirectoryReferenceList(v []DirectoryReference) {
	o.DirectoryReferenceList = v
}

// GetIdentityProvidersReferenceList returns the IdentityProvidersReferenceList field value if set, zero value otherwise.
func (o *ProjectResources2) GetIdentityProvidersReferenceList() []IdentityProvidersReference {
	if o == nil || IsNil(o.IdentityProvidersReferenceList) {
		var ret []IdentityProvidersReference
		return ret
	}
	return o.IdentityProvidersReferenceList
}

// GetIdentityProvidersReferenceListOk returns a tuple with the IdentityProvidersReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetIdentityProvidersReferenceListOk() ([]IdentityProvidersReference, bool) {
	if o == nil || IsNil(o.IdentityProvidersReferenceList) {
		return nil, false
	}
	return o.IdentityProvidersReferenceList, true
}
...
// SetIdentityProvidersReferenceList gets a reference to the given []IdentityProvidersReference and assigns it to the IdentityProvidersReferenceList field.
func (o *ProjectResources2) SetIdentityProvidersReferenceList(v []IdentityProvidersReference) {
	o.IdentityProvidersReferenceList = v
}

// GetUserReferenceList returns the UserReferenceList field value if set, zero value otherwise.
func (o *ProjectResources2) GetUserReferenceList() []UserReference {
	if o == nil || IsNil(o.UserReferenceList) {
		var ret []UserReference
		return ret
	}
	return o.UserReferenceList
}

// GetUserReferenceListOk returns a tuple with the UserReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetUserReferenceListOk() ([]UserReference, bool) {
	if o == nil || IsNil(o.UserReferenceList) {
		return nil, false
	}
	return o.UserReferenceList, true
}
...
// SetUserReferenceList gets a reference to the given []UserReference and assigns it to the UserReferenceList field.
func (o *ProjectResources2) SetUserReferenceList(v []UserReference) {
	o.UserReferenceList = v
}

// GetDefaultSubnetReference returns the DefaultSubnetReference field value if set, zero value otherwise.
func (o *ProjectResources2) GetDefaultSubnetReference() SubnetReference {
	if o == nil || IsNil(o.DefaultSubnetReference) {
		var ret SubnetReference
		return ret
	}
	return *o.DefaultSubnetReference
}

// GetDefaultSubnetReferenceOk returns a tuple with the DefaultSubnetReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetDefaultSubnetReferenceOk() (*SubnetReference, bool) {
	if o == nil || IsNil(o.DefaultSubnetReference) {
		return nil, false
	}
	return o.DefaultSubnetReference, true
}
...
// SetDefaultSubnetReference gets a reference to the given SubnetReference and assigns it to the DefaultSubnetReference field.
func (o *ProjectResources2) SetDefaultSubnetReference(v SubnetReference) {
	o.DefaultSubnetReference = &v
}

// GetEnvironmentReferenceList returns the EnvironmentReferenceList field value if set, zero value otherwise.
func (o *ProjectResources2) GetEnvironmentReferenceList() []EnvironmentReference {
	if o == nil || IsNil(o.EnvironmentReferenceList) {
		var ret []EnvironmentReference
		return ret
	}
	return o.EnvironmentReferenceList
}

// GetEnvironmentReferenceListOk returns a tuple with the EnvironmentReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetEnvironmentReferenceListOk() ([]EnvironmentReference, bool) {
	if o == nil || IsNil(o.EnvironmentReferenceList) {
		return nil, false
	}
	return o.EnvironmentReferenceList, true
}
...
// SetEnvironmentReferenceList gets a reference to the given []EnvironmentReference and assigns it to the EnvironmentReferenceList field.
func (o *ProjectResources2) SetEnvironmentReferenceList(v []EnvironmentReference) {
	o.EnvironmentReferenceList = v
}
...
// GetTunnelReferenceList returns the TunnelReferenceList field value if set, zero value otherwise.
func (o *ProjectResources2) GetTunnelReferenceList() []TunnelReference {
	if o == nil || IsNil(o.TunnelReferenceList) {
		var ret []TunnelReference
		return ret
	}
	return o.TunnelReferenceList
}

// GetTunnelReferenceListOk returns a tuple with the TunnelReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetTunnelReferenceListOk() ([]TunnelReference, bool) {
	if o == nil || IsNil(o.TunnelReferenceList) {
		return nil, false
	}
	return o.TunnelReferenceList, true
}
...
// SetTunnelReferenceList gets a reference to the given []TunnelReference and assigns it to the TunnelReferenceList field.
func (o *ProjectResources2) SetTunnelReferenceList(v []TunnelReference) {
	o.TunnelReferenceList = v
}

// GetExternalUserGroupReferenceList returns the ExternalUserGroupReferenceList field value if set, zero value otherwise.
func (o *ProjectResources2) GetExternalUserGroupReferenceList() []UserGroupReference {
	if o == nil || IsNil(o.ExternalUserGroupReferenceList) {
		var ret []UserGroupReference
		return ret
	}
	return o.ExternalUserGroupReferenceList
}

// GetExternalUserGroupReferenceListOk returns a tuple with the ExternalUserGroupReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetExternalUserGroupReferenceListOk() ([]UserGroupReference, bool) {
	if o == nil || IsNil(o.ExternalUserGroupReferenceList) {
		return nil, false
	}
	return o.ExternalUserGroupReferenceList, true
}
...
// SetExternalUserGroupReferenceList gets a reference to the given []UserGroupReference and assigns it to the ExternalUserGroupReferenceList field.
func (o *ProjectResources2) SetExternalUserGroupReferenceList(v []UserGroupReference) {
	o.ExternalUserGroupReferenceList = v
}

// GetDefaultEnvironmentReference returns the DefaultEnvironmentReference field value if set, zero value otherwise.
func (o *ProjectResources2) GetDefaultEnvironmentReference() EnvironmentReference {
	if o == nil || IsNil(o.DefaultEnvironmentReference) {
		var ret EnvironmentReference
		return ret
	}
	return *o.DefaultEnvironmentReference
}

// GetDefaultEnvironmentReferenceOk returns a tuple with the DefaultEnvironmentReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetDefaultEnvironmentReferenceOk() (*EnvironmentReference, bool) {
	if o == nil || IsNil(o.DefaultEnvironmentReference) {
		return nil, false
	}
	return o.DefaultEnvironmentReference, true
}
...
// SetDefaultEnvironmentReference gets a reference to the given EnvironmentReference and assigns it to the DefaultEnvironmentReference field.
func (o *ProjectResources2) SetDefaultEnvironmentReference(v EnvironmentReference) {
	o.DefaultEnvironmentReference = &v
}

// GetSubnetReferenceList returns the SubnetReferenceList field value if set, zero value otherwise.
func (o *ProjectResources2) GetSubnetReferenceList() []SubnetReference {
	if o == nil || IsNil(o.SubnetReferenceList) {
		var ret []SubnetReference
		return ret
	}
	return o.SubnetReferenceList
}

// GetSubnetReferenceListOk returns a tuple with the SubnetReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetSubnetReferenceListOk() ([]SubnetReference, bool) {
	if o == nil || IsNil(o.SubnetReferenceList) {
		return nil, false
	}
	return o.SubnetReferenceList, true
}
...
// SetSubnetReferenceList gets a reference to the given []SubnetReference and assigns it to the SubnetReferenceList field.
func (o *ProjectResources2) SetSubnetReferenceList(v []SubnetReference) {
	o.SubnetReferenceList = v
}

// GetClusterReferenceList returns the ClusterReferenceList field value if set, zero value otherwise.
func (o *ProjectResources2) GetClusterReferenceList() []ClusterReference {
	if o == nil || IsNil(o.ClusterReferenceList) {
		var ret []ClusterReference
		return ret
	}
	return o.ClusterReferenceList
}

// GetClusterReferenceListOk returns a tuple with the ClusterReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetClusterReferenceListOk() ([]ClusterReference, bool) {
	if o == nil || IsNil(o.ClusterReferenceList) {
		return nil, false
	}
	return o.ClusterReferenceList, true
}
...
// SetClusterReferenceList gets a reference to the given []ClusterReference and assigns it to the ClusterReferenceList field.
func (o *ProjectResources2) SetClusterReferenceList(v []ClusterReference) {
	o.ClusterReferenceList = v
}

// GetVpcReferenceList returns the VpcReferenceList field value if set, zero value otherwise.
func (o *ProjectResources2) GetVpcReferenceList() []VpcReference {
	if o == nil || IsNil(o.VpcReferenceList) {
		var ret []VpcReference
		return ret
	}
	return o.VpcReferenceList
}

// GetVpcReferenceListOk returns a tuple with the VpcReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetVpcReferenceListOk() ([]VpcReference, bool) {
	if o == nil || IsNil(o.VpcReferenceList) {
		return nil, false
	}
	return o.VpcReferenceList, true
}
...
// SetVpcReferenceList gets a reference to the given []VpcReference and assigns it to the VpcReferenceList field.
func (o *ProjectResources2) SetVpcReferenceList(v []VpcReference) {
	o.VpcReferenceList = v
}

// GetExternalNetworkList returns the ExternalNetworkList field value if set, zero value otherwise.
func (o *ProjectResources2) GetExternalNetworkList() []ExternalNetwork {
	if o == nil || IsNil(o.ExternalNetworkList) {
		var ret []ExternalNetwork
		return ret
	}
	return o.ExternalNetworkList
}

// GetExternalNetworkListOk returns a tuple with the ExternalNetworkList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetExternalNetworkListOk() ([]ExternalNetwork, bool) {
	if o == nil || IsNil(o.ExternalNetworkList) {
		return nil, false
	}
	return o.ExternalNetworkList, true
}
...
// SetExternalNetworkList gets a reference to the given []ExternalNetwork and assigns it to the ExternalNetworkList field.
func (o *ProjectResources2) SetExternalNetworkList(v []ExternalNetwork) {
	o.ExternalNetworkList = v
}

// GetEnableDirectoryAndIdentityProviderWhitelist returns the EnableDirectoryAndIdentityProviderWhitelist field value if set, zero value otherwise.
func (o *ProjectResources2) GetEnableDirectoryAndIdentityProviderWhitelist() bool {
	if o == nil || IsNil(o.EnableDirectoryAndIdentityProviderWhitelist) {
		var ret bool
		return ret
	}
	return *o.EnableDirectoryAndIdentityProviderWhitelist
}

// GetEnableDirectoryAndIdentityProviderWhitelistOk returns a tuple with the EnableDirectoryAndIdentityProviderWhitelist field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectResources2) GetEnableDirectoryAndIdentityProviderWhitelistOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDirectoryAndIdentityProviderWhitelist) {
		return nil, false
	}
	return o.EnableDirectoryAndIdentityProviderWhitelist, true
}
...
// SetEnableDirectoryAndIdentityProviderWhitelist gets a reference to the given bool and assigns it to the EnableDirectoryAndIdentityProviderWhitelist field.
func (o *ProjectResources2) SetEnableDirectoryAndIdentityProviderWhitelist(v bool) {
	o.EnableDirectoryAndIdentityProviderWhitelist = &v
}

func (o ProjectResources2) MarshalJSON() ([]byte, error) {
...
func (o ProjectResources2) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AccountReferenceList) {
		toSerialize["account_reference_list"] = o.AccountReferenceList
	}
	if !IsNil(o.ResourceDomain) {
		toSerialize["resource_domain"] = o.ResourceDomain
	}
	if !IsNil(o.DirectoryReferenceList) {
		toSerialize["directory_reference_list"] = o.DirectoryReferenceList
	}
	if !IsNil(o.IdentityProvidersReferenceList) {
		toSerialize["identity_providers_reference_list"] = o.IdentityProvidersReferenceList
	}
	if !IsNil(o.UserReferenceList) {
		toSerialize["user_reference_list"] = o.UserReferenceList
	}
	if !IsNil(o.DefaultSubnetReference) {
		toSerialize["default_subnet_reference"] = o.DefaultSubnetReference
	}
	if !IsNil(o.EnvironmentReferenceList) {
		toSerialize["environment_reference_list"] = o.EnvironmentReferenceList
	}
	if !IsNil(o.IsDefault) {
		toSerialize["is_default"] = o.IsDefault
	}
	if !IsNil(o.TunnelReferenceList) {
		toSerialize["tunnel_reference_list"] = o.TunnelReferenceList
	}
	if !IsNil(o.ExternalUserGroupReferenceList) {
		toSerialize["external_user_group_reference_list"] = o.ExternalUserGroupReferenceList
	}
	if !IsNil(o.DefaultEnvironmentReference) {
		toSerialize["default_environment_reference"] = o.DefaultEnvironmentReference
	}
	if !IsNil(o.SubnetReferenceList) {
		toSerialize["subnet_reference_list"] = o.SubnetReferenceList
	}
	if !IsNil(o.ClusterReferenceList) {
		toSerialize["cluster_reference_list"] = o.ClusterReferenceList
	}
	if !IsNil(o.VpcReferenceList) {
		toSerialize["vpc_reference_list"] = o.VpcReferenceList
	}
	if !IsNil(o.ExternalNetworkList) {
		toSerialize["external_network_list"] = o.ExternalNetworkList
	}
	if !IsNil(o.EnableDirectoryAndIdentityProviderWhitelist) {
		toSerialize["enable_directory_and_identity_provider_whitelist"] = o.EnableDirectoryAndIdentityProviderWhitelist
	}
...
func (o *ProjectResources2) UnmarshalJSON(data []byte) (err error) {
	varProjectResources2 := _ProjectResources2{}

	err = json.Unmarshal(data, &varProjectResources2)

	if err != nil {
		return err
	}

	*o = ProjectResources2(varProjectResources2)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "account_reference_list")
		delete(additionalProperties, "resource_domain")
		delete(additionalProperties, "directory_reference_list")
		delete(additionalProperties, "identity_providers_reference_list")
		delete(additionalProperties, "user_reference_list")
		delete(additionalProperties, "default_subnet_reference")
		delete(additionalProperties, "environment_reference_list")
		delete(additionalProperties, "is_default")
		delete(additionalProperties, "tunnel_reference_list")
		delete(additionalProperties, "external_user_group_reference_list")
		delete(additionalProperties, "default_environment_reference")
		delete(additionalProperties, "subnet_reference_list")
		delete(additionalProperties, "cluster_reference_list")
		delete(additionalProperties, "vpc_reference_list")
		delete(additionalProperties, "external_network_list")
		delete(additionalProperties, "enable_directory_and_identity_provider_whitelist")
...
type NullableProjectResources2 struct {
	value *ProjectResources2
	isSet bool
}

func (v NullableProjectResources2) Get() *ProjectResources2 {
	return v.value
}

func (v *NullableProjectResources2) Set(val *ProjectResources2) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectResources2) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectResources2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectResources2(val *ProjectResources2) *NullableProjectResources2 {
	return &NullableProjectResources2{value: val, isSet: true}
}

func (v NullableProjectResources2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectResources2) UnmarshalJSON(src []byte) error {
	v.isSet = true
