...
// checks if the ProtectionRuleIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleIntentResource{}

// ProtectionRuleIntentResource Response object for intentful operations on a protection_rule
type ProtectionRuleIntentResource struct {
...
type _ProtectionRuleIntentResource ProtectionRuleIntentResource
...
func NewProtectionRuleIntentResource(metadata ProtectionRuleMetadata) *ProtectionRuleIntentResource {
	this := ProtectionRuleIntentResource{}
...
func (o ProtectionRuleIntentResource) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *ProtectionRuleIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varProtectionRuleIntentResource := _ProtectionRuleIntentResource{}

	err = json.Unmarshal(data, &varProtectionRuleIntentResource)

	if err != nil {
		return err
	}

	*o = ProtectionRuleIntentResource(varProtectionRuleIntentResource)
...
type NullableProtectionRuleIntentResource struct {
	value *ProtectionRuleIntentResource
	isSet bool
}

func (v NullableProtectionRuleIntentResource) Get() *ProtectionRuleIntentResource {
	return v.value
}

func (v *NullableProtectionRuleIntentResource) Set(val *ProtectionRuleIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleIntentResource(val *ProtectionRuleIntentResource) *NullableProtectionRuleIntentResource {
	return &NullableProtectionRuleIntentResource{value: val, isSet: true}
}

func (v NullableProtectionRuleIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
