...
// checks if the OvaGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OvaGetResponse{}

// OvaGetResponse Response while getting an OVA
type OvaGetResponse struct {
	Info *OvaInfo `json:"info,omitempty"`
...
type _OvaGetResponse OvaGetResponse
...
// SetInfo gets a reference to the given OvaInfo and assigns it to the Info field.
...
// SetMetadata gets a reference to the given OvaMetadata and assigns it to the Metadata field.
func (o *OvaGetResponse) SetMetadata(v OvaMetadata) {
	o.Metadata = &v
}

func (o OvaGetResponse) MarshalJSON() ([]byte, error) {
...
func (o OvaGetResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OvaGetResponse) UnmarshalJSON(data []byte) (err error) {
	varOvaGetResponse := _OvaGetResponse{}

	err = json.Unmarshal(data, &varOvaGetResponse)

	if err != nil {
		return err
	}

	*o = OvaGetResponse(varOvaGetResponse)
...
type NullableOvaGetResponse struct {
	value *OvaGetResponse
	isSet bool
}

func (v NullableOvaGetResponse) Get() *OvaGetResponse {
	return v.value
}

func (v *NullableOvaGetResponse) Set(val *OvaGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOvaGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOvaGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOvaGetResponse(val *OvaGetResponse) *NullableOvaGetResponse {
	return &NullableOvaGetResponse{value: val, isSet: true}
}

func (v NullableOvaGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOvaGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
