...
type Tenant struct {
	...
	IdpTenantIdentifier *string `json:"idp_tenant_identifier,omitempty"`
	// UUID of the tenant.
...
// GetIdpTenantIdentifier returns the IdpTenantIdentifier field value if set, zero value otherwise.
func (o *Tenant) GetIdpTenantIdentifier() string {
	if o == nil || IsNil(o.IdpTenantIdentifier) {
		var ret string
		return ret
	}
	return *o.IdpTenantIdentifier
}

// GetIdpTenantIdentifierOk returns a tuple with the IdpTenantIdentifier field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Tenant) GetIdpTenantIdentifierOk() (*string, bool) {
	if o == nil || IsNil(o.IdpTenantIdentifier) {
		return nil, false
	}
	return o.IdpTenantIdentifier, true
}
...
// SetIdpTenantIdentifier gets a reference to the given string and assigns it to the IdpTenantIdentifier field.
func (o *Tenant) SetIdpTenantIdentifier(v string) {
	o.IdpTenantIdentifier = &v
}
...
func (o Tenant) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IdpTenantIdentifier) {
		toSerialize["idp_tenant_identifier"] = o.IdpTenantIdentifier
	}
...
func (o *Tenant) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Tenant(varTenant)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "idp_tenant_identifier")
