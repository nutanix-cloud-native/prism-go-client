...
// checks if the UserGroupMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupMetadata{}

// UserGroupMetadata The user_group kind metadata
type UserGroupMetadata struct {
	...
	// Categories for the user_group. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the user_group. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _UserGroupMetadata UserGroupMetadata
...
func (o *UserGroupMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *UserGroupMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *UserGroupMetadata) SetName(v string) {
	o.Name = &v
}

func (o UserGroupMetadata) MarshalJSON() ([]byte, error) {
...
func (o UserGroupMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *UserGroupMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varUserGroupMetadata := _UserGroupMetadata{}

	err = json.Unmarshal(data, &varUserGroupMetadata)

	if err != nil {
		return err
	}

	*o = UserGroupMetadata(varUserGroupMetadata)
...
type NullableUserGroupMetadata struct {
	value *UserGroupMetadata
	isSet bool
}

func (v NullableUserGroupMetadata) Get() *UserGroupMetadata {
	return v.value
}

func (v *NullableUserGroupMetadata) Set(val *UserGroupMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupMetadata(val *UserGroupMetadata) *NullableUserGroupMetadata {
	return &NullableUserGroupMetadata{value: val, isSet: true}
}

func (v NullableUserGroupMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
