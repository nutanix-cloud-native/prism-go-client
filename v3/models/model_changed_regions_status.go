...
// checks if the ChangedRegionsStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangedRegionsStatus{}

// ChangedRegionsStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _ChangedRegionsStatus ChangedRegionsStatus
...
func (o ChangedRegionsStatus) MarshalJSON() ([]byte, error) {
...
func (o ChangedRegionsStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ChangedRegionsStatus) UnmarshalJSON(data []byte) (err error) {
	varChangedRegionsStatus := _ChangedRegionsStatus{}

	err = json.Unmarshal(data, &varChangedRegionsStatus)

	if err != nil {
		return err
	}

	*o = ChangedRegionsStatus(varChangedRegionsStatus)
...
type NullableChangedRegionsStatus struct {
	value *ChangedRegionsStatus
	isSet bool
}

func (v NullableChangedRegionsStatus) Get() *ChangedRegionsStatus {
	return v.value
}

func (v *NullableChangedRegionsStatus) Set(val *ChangedRegionsStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableChangedRegionsStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableChangedRegionsStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangedRegionsStatus(val *ChangedRegionsStatus) *NullableChangedRegionsStatus {
	return &NullableChangedRegionsStatus{value: val, isSet: true}
}

func (v NullableChangedRegionsStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangedRegionsStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
