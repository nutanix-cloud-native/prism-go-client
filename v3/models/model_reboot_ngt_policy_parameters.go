...
// checks if the RebootNgtPolicyParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RebootNgtPolicyParameters{}

// RebootNgtPolicyParameters NGT reboot policy object.
type RebootNgtPolicyParameters struct {
	// Flag for policies to be applied only once.
	ApplyOnce *bool `json:"apply_once,omitempty"`
	Schedule *RebootNgtPolicyParametersSchedule `json:"schedule,omitempty"`
	// Type of Schedule for policy enforcement.
	ScheduleType string `json:"schedule_type"`
	AdditionalProperties map[string]interface{}
}

type _RebootNgtPolicyParameters RebootNgtPolicyParameters
...
func NewRebootNgtPolicyParameters(scheduleType string) *RebootNgtPolicyParameters {
	this := RebootNgtPolicyParameters{}
	var applyOnce bool = false
...
// GetApplyOnce returns the ApplyOnce field value if set, zero value otherwise.
func (o *RebootNgtPolicyParameters) GetApplyOnce() bool {
	if o == nil || IsNil(o.ApplyOnce) {
		var ret bool
		return ret
	}
	return *o.ApplyOnce
...
// GetApplyOnceOk returns a tuple with the ApplyOnce field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RebootNgtPolicyParameters) GetApplyOnceOk() (*bool, bool) {
	if o == nil || IsNil(o.ApplyOnce) {
		return nil, false
	}
	return o.ApplyOnce, true
}
...
// SetApplyOnce gets a reference to the given bool and assigns it to the ApplyOnce field.
...
func (o *RebootNgtPolicyParameters) GetSchedule() RebootNgtPolicyParametersSchedule {
	if o == nil || IsNil(o.Schedule) {
		var ret RebootNgtPolicyParametersSchedule
		return ret
	}
	return *o.Schedule
}
...
// SetSchedule gets a reference to the given RebootNgtPolicyParametersSchedule and assigns it to the Schedule field.
...
func (o RebootNgtPolicyParameters) MarshalJSON() ([]byte, error) {
...
func (o RebootNgtPolicyParameters) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ApplyOnce) {
		toSerialize["apply_once"] = o.ApplyOnce
	}
	if !IsNil(o.Schedule) {
...
func (o *RebootNgtPolicyParameters) UnmarshalJSON(data []byte) (err error) {
	...
	varRebootNgtPolicyParameters := _RebootNgtPolicyParameters{}

	err = json.Unmarshal(data, &varRebootNgtPolicyParameters)

	if err != nil {
		return err
	}

	*o = RebootNgtPolicyParameters(varRebootNgtPolicyParameters)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "apply_once")
...
type NullableRebootNgtPolicyParameters struct {
	value *RebootNgtPolicyParameters
	isSet bool
}

func (v NullableRebootNgtPolicyParameters) Get() *RebootNgtPolicyParameters {
	return v.value
}

func (v *NullableRebootNgtPolicyParameters) Set(val *RebootNgtPolicyParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableRebootNgtPolicyParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableRebootNgtPolicyParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRebootNgtPolicyParameters(val *RebootNgtPolicyParameters) *NullableRebootNgtPolicyParameters {
	return &NullableRebootNgtPolicyParameters{value: val, isSet: true}
}

func (v NullableRebootNgtPolicyParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRebootNgtPolicyParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
