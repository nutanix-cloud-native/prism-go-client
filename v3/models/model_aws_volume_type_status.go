...
// checks if the AwsVolumeTypeStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsVolumeTypeStatus{}

// AwsVolumeTypeStatus The status of a REST API call. Only used when there is a failure to report. 
type AwsVolumeTypeStatus struct {
	// The kind name
...
type _AwsVolumeTypeStatus AwsVolumeTypeStatus
...
func (o AwsVolumeTypeStatus) MarshalJSON() ([]byte, error) {
...
func (o AwsVolumeTypeStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AwsVolumeTypeStatus) UnmarshalJSON(data []byte) (err error) {
	varAwsVolumeTypeStatus := _AwsVolumeTypeStatus{}

	err = json.Unmarshal(data, &varAwsVolumeTypeStatus)

	if err != nil {
		return err
	}

	*o = AwsVolumeTypeStatus(varAwsVolumeTypeStatus)
...
type NullableAwsVolumeTypeStatus struct {
	value *AwsVolumeTypeStatus
	isSet bool
}

func (v NullableAwsVolumeTypeStatus) Get() *AwsVolumeTypeStatus {
	return v.value
}

func (v *NullableAwsVolumeTypeStatus) Set(val *AwsVolumeTypeStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsVolumeTypeStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsVolumeTypeStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsVolumeTypeStatus(val *AwsVolumeTypeStatus) *NullableAwsVolumeTypeStatus {
	return &NullableAwsVolumeTypeStatus{value: val, isSet: true}
}

func (v NullableAwsVolumeTypeStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsVolumeTypeStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
