...
// checks if the RoutingPolicyAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyAction{}

// RoutingPolicyAction Routing policy action
...
type _RoutingPolicyAction RoutingPolicyAction
...
func (o RoutingPolicyAction) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyAction) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyAction) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingPolicyAction := _RoutingPolicyAction{}

	err = json.Unmarshal(data, &varRoutingPolicyAction)

	if err != nil {
		return err
	}

	*o = RoutingPolicyAction(varRoutingPolicyAction)
...
type NullableRoutingPolicyAction struct {
	value *RoutingPolicyAction
	isSet bool
}

func (v NullableRoutingPolicyAction) Get() *RoutingPolicyAction {
	return v.value
}

func (v *NullableRoutingPolicyAction) Set(val *RoutingPolicyAction) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyAction) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyAction(val *RoutingPolicyAction) *NullableRoutingPolicyAction {
	return &NullableRoutingPolicyAction{value: val, isSet: true}
}

func (v NullableRoutingPolicyAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
