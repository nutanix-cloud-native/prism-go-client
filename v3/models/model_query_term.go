...
// checks if the QueryTerm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryTerm{}

// QueryTerm Query term object definition. This essentially holds the various interpretation of a single query term. 
type QueryTerm struct {
	// User passed string for the query term.
	Term *string `json:"term,omitempty"`
	// All possible interpretations of the term.
	TokenList []Token `json:"token_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QueryTerm QueryTerm
...
// SetTokenList gets a reference to the given []Token and assigns it to the TokenList field.
func (o *QueryTerm) SetTokenList(v []Token) {
	o.TokenList = v
}

func (o QueryTerm) MarshalJSON() ([]byte, error) {
...
func (o QueryTerm) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Term) {
		toSerialize["term"] = o.Term
	}
	if !IsNil(o.TokenList) {
		toSerialize["token_list"] = o.TokenList
	}
...
func (o *QueryTerm) UnmarshalJSON(data []byte) (err error) {
	varQueryTerm := _QueryTerm{}

	err = json.Unmarshal(data, &varQueryTerm)

	if err != nil {
		return err
	}

	*o = QueryTerm(varQueryTerm)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "term")
		delete(additionalProperties, "token_list")
...
type NullableQueryTerm struct {
	value *QueryTerm
	isSet bool
}

func (v NullableQueryTerm) Get() *QueryTerm {
	return v.value
}

func (v *NullableQueryTerm) Set(val *QueryTerm) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryTerm) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryTerm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryTerm(val *QueryTerm) *NullableQueryTerm {
	return &NullableQueryTerm{value: val, isSet: true}
}

func (v NullableQueryTerm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryTerm) UnmarshalJSON(src []byte) error {
	v.isSet = true
