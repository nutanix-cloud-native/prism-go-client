...
// checks if the VmwareListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmwareListMetadata{}

// VmwareListMetadata All vmware meta api calls  will have this metadata block as input 
type VmwareListMetadata struct {
...
type _VmwareListMetadata VmwareListMetadata
...
func (o VmwareListMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmwareListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmwareListMetadata) UnmarshalJSON(data []byte) (err error) {
	varVmwareListMetadata := _VmwareListMetadata{}

	err = json.Unmarshal(data, &varVmwareListMetadata)

	if err != nil {
		return err
	}

	*o = VmwareListMetadata(varVmwareListMetadata)
...
type NullableVmwareListMetadata struct {
	value *VmwareListMetadata
	isSet bool
}

func (v NullableVmwareListMetadata) Get() *VmwareListMetadata {
	return v.value
}

func (v *NullableVmwareListMetadata) Set(val *VmwareListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmwareListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmwareListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmwareListMetadata(val *VmwareListMetadata) *NullableVmwareListMetadata {
	return &NullableVmwareListMetadata{value: val, isSet: true}
}

func (v NullableVmwareListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmwareListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
