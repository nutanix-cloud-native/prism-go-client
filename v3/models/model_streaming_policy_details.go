...
// checks if the StreamingPolicyDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamingPolicyDetails{}

// StreamingPolicyDetails Streaming Policy details
type StreamingPolicyDetails struct {
...
type _StreamingPolicyDetails StreamingPolicyDetails
...
func (o StreamingPolicyDetails) MarshalJSON() ([]byte, error) {
...
func (o StreamingPolicyDetails) ToMap() (map[string]interface{}, error) {
...
func (o *StreamingPolicyDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varStreamingPolicyDetails := _StreamingPolicyDetails{}

	err = json.Unmarshal(data, &varStreamingPolicyDetails)

	if err != nil {
		return err
	}

	*o = StreamingPolicyDetails(varStreamingPolicyDetails)
...
type NullableStreamingPolicyDetails struct {
	value *StreamingPolicyDetails
	isSet bool
}

func (v NullableStreamingPolicyDetails) Get() *StreamingPolicyDetails {
	return v.value
}

func (v *NullableStreamingPolicyDetails) Set(val *StreamingPolicyDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamingPolicyDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamingPolicyDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamingPolicyDetails(val *StreamingPolicyDetails) *NullableStreamingPolicyDetails {
	return &NullableStreamingPolicyDetails{value: val, isSet: true}
}

func (v NullableStreamingPolicyDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamingPolicyDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
