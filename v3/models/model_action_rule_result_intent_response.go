...
// checks if the ActionRuleResultIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResultIntentResponse{}

// ActionRuleResultIntentResponse Response object for intentful operations on a action_rule_result
type ActionRuleResultIntentResponse struct {
...
type _ActionRuleResultIntentResponse ActionRuleResultIntentResponse
...
func NewActionRuleResultIntentResponse(apiVersion string, metadata ActionRuleResultMetadata) *ActionRuleResultIntentResponse {
	this := ActionRuleResultIntentResponse{}
...
func (o ActionRuleResultIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResultIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleResultIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleResultIntentResponse := _ActionRuleResultIntentResponse{}

	err = json.Unmarshal(data, &varActionRuleResultIntentResponse)

	if err != nil {
		return err
	}

	*o = ActionRuleResultIntentResponse(varActionRuleResultIntentResponse)
...
type NullableActionRuleResultIntentResponse struct {
	value *ActionRuleResultIntentResponse
	isSet bool
}

func (v NullableActionRuleResultIntentResponse) Get() *ActionRuleResultIntentResponse {
	return v.value
}

func (v *NullableActionRuleResultIntentResponse) Set(val *ActionRuleResultIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResultIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResultIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResultIntentResponse(val *ActionRuleResultIntentResponse) *NullableActionRuleResultIntentResponse {
	return &NullableActionRuleResultIntentResponse{value: val, isSet: true}
}

func (v NullableActionRuleResultIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResultIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
