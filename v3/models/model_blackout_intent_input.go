...
// checks if the BlackoutIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlackoutIntentInput{}

// BlackoutIntentInput An intentful representation of a blackout
type BlackoutIntentInput struct {
	Spec Blackout `json:"spec"`
...
type _BlackoutIntentInput BlackoutIntentInput
...
func (o BlackoutIntentInput) MarshalJSON() ([]byte, error) {
...
func (o BlackoutIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *BlackoutIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varBlackoutIntentInput := _BlackoutIntentInput{}

	err = json.Unmarshal(data, &varBlackoutIntentInput)

	if err != nil {
		return err
	}

	*o = BlackoutIntentInput(varBlackoutIntentInput)
...
type NullableBlackoutIntentInput struct {
	value *BlackoutIntentInput
	isSet bool
}

func (v NullableBlackoutIntentInput) Get() *BlackoutIntentInput {
	return v.value
}

func (v *NullableBlackoutIntentInput) Set(val *BlackoutIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableBlackoutIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableBlackoutIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlackoutIntentInput(val *BlackoutIntentInput) *NullableBlackoutIntentInput {
	return &NullableBlackoutIntentInput{value: val, isSet: true}
}

func (v NullableBlackoutIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlackoutIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
