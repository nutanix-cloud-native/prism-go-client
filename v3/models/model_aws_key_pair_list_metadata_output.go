...
// checks if the AwsKeyPairListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsKeyPairListMetadataOutput{}

// AwsKeyPairListMetadataOutput All api calls that return a list will have this metadata block 
type AwsKeyPairListMetadataOutput struct {
	// The kind name
...
type _AwsKeyPairListMetadataOutput AwsKeyPairListMetadataOutput
...
func NewAwsKeyPairListMetadataOutput() *AwsKeyPairListMetadataOutput {
	this := AwsKeyPairListMetadataOutput{}
	var kind string = "aws_key_pair"
	this.Kind = &kind
	return &this
}
...
func (o AwsKeyPairListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsKeyPairListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsKeyPairListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsKeyPairListMetadataOutput := _AwsKeyPairListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsKeyPairListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsKeyPairListMetadataOutput(varAwsKeyPairListMetadataOutput)
...
type NullableAwsKeyPairListMetadataOutput struct {
	value *AwsKeyPairListMetadataOutput
	isSet bool
}

func (v NullableAwsKeyPairListMetadataOutput) Get() *AwsKeyPairListMetadataOutput {
	return v.value
}

func (v *NullableAwsKeyPairListMetadataOutput) Set(val *AwsKeyPairListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsKeyPairListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsKeyPairListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsKeyPairListMetadataOutput(val *AwsKeyPairListMetadataOutput) *NullableAwsKeyPairListMetadataOutput {
	return &NullableAwsKeyPairListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsKeyPairListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsKeyPairListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
