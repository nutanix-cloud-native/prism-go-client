...
// checks if the SupportCaseMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseMetadata{}

// SupportCaseMetadata The support_case kind metadata
type SupportCaseMetadata struct {
	...
	// Categories for the support_case. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the support_case. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _SupportCaseMetadata SupportCaseMetadata
...
func (o SupportCaseMetadata) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportCaseMetadata := _SupportCaseMetadata{}

	err = json.Unmarshal(data, &varSupportCaseMetadata)

	if err != nil {
		return err
	}

	*o = SupportCaseMetadata(varSupportCaseMetadata)
...
type NullableSupportCaseMetadata struct {
	value *SupportCaseMetadata
	isSet bool
}

func (v NullableSupportCaseMetadata) Get() *SupportCaseMetadata {
	return v.value
}

func (v *NullableSupportCaseMetadata) Set(val *SupportCaseMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseMetadata(val *SupportCaseMetadata) *NullableSupportCaseMetadata {
	return &NullableSupportCaseMetadata{value: val, isSet: true}
}

func (v NullableSupportCaseMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
