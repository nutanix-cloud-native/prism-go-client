...
// checks if the VpnGatewayResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnGatewayResources{}

// VpnGatewayResources VPN gateway creation/modification spec.
type VpnGatewayResources struct {
	...
	InternalRoutingProtocolConfig *InternalRoutingProtocolConfig `json:"internal_routing_protocol_config,omitempty"`
	EbgpConfig *BgpConfig `json:"ebgp_config,omitempty"`
	VirtualNetworkReference *VirtualNetworkReference `json:"virtual_network_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VpnGatewayResources VpnGatewayResources
...
func (o *VpnGatewayResources) GetInternalRoutingProtocolConfig() InternalRoutingProtocolConfig {
	if o == nil || IsNil(o.InternalRoutingProtocolConfig) {
		var ret InternalRoutingProtocolConfig
		return ret
	}
...
// SetInternalRoutingProtocolConfig gets a reference to the given InternalRoutingProtocolConfig and assigns it to the InternalRoutingProtocolConfig field.
...
// SetEbgpConfig gets a reference to the given BgpConfig and assigns it to the EbgpConfig field.
...
func (o VpnGatewayResources) MarshalJSON() ([]byte, error) {
...
func (o VpnGatewayResources) ToMap() (map[string]interface{}, error) {
...
func (o *VpnGatewayResources) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnGatewayResources := _VpnGatewayResources{}

	err = json.Unmarshal(data, &varVpnGatewayResources)

	if err != nil {
		return err
	}

	*o = VpnGatewayResources(varVpnGatewayResources)
...
type NullableVpnGatewayResources struct {
	value *VpnGatewayResources
	isSet bool
}

func (v NullableVpnGatewayResources) Get() *VpnGatewayResources {
	return v.value
}

func (v *NullableVpnGatewayResources) Set(val *VpnGatewayResources) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnGatewayResources) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnGatewayResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnGatewayResources(val *VpnGatewayResources) *NullableVpnGatewayResources {
	return &NullableVpnGatewayResources{value: val, isSet: true}
}

func (v NullableVpnGatewayResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnGatewayResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
