...
// checks if the MulticlusterConfigIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MulticlusterConfigIntentInput{}

// MulticlusterConfigIntentInput An intentful representation of a multicluster config spec.
type MulticlusterConfigIntentInput struct {
	Spec MulticlusterConfigSpec `json:"spec"`
...
type _MulticlusterConfigIntentInput MulticlusterConfigIntentInput
...
func NewMulticlusterConfigIntentInput(spec MulticlusterConfigSpec, apiVersion string, metadata MulticlusterConfigMetadata) *MulticlusterConfigIntentInput {
	this := MulticlusterConfigIntentInput{}
	this.Spec = spec
...
func (o MulticlusterConfigIntentInput) MarshalJSON() ([]byte, error) {
...
func (o MulticlusterConfigIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *MulticlusterConfigIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varMulticlusterConfigIntentInput := _MulticlusterConfigIntentInput{}

	err = json.Unmarshal(data, &varMulticlusterConfigIntentInput)

	if err != nil {
		return err
	}

	*o = MulticlusterConfigIntentInput(varMulticlusterConfigIntentInput)
...
type NullableMulticlusterConfigIntentInput struct {
	value *MulticlusterConfigIntentInput
	isSet bool
}

func (v NullableMulticlusterConfigIntentInput) Get() *MulticlusterConfigIntentInput {
	return v.value
}

func (v *NullableMulticlusterConfigIntentInput) Set(val *MulticlusterConfigIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableMulticlusterConfigIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableMulticlusterConfigIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMulticlusterConfigIntentInput(val *MulticlusterConfigIntentInput) *NullableMulticlusterConfigIntentInput {
	return &NullableMulticlusterConfigIntentInput{value: val, isSet: true}
}

func (v NullableMulticlusterConfigIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMulticlusterConfigIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
