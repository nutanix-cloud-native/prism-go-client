...
// checks if the RecoveredEntityInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveredEntityInformation{}

// RecoveredEntityInformation This contains Source entity reference and Recovered entity information such as Entity name, Entity UUID. 
type RecoveredEntityInformation struct {
	...
	RecoveredEntityInfo *RecoveredEntityInformationRecoveredEntityInfo `json:"recovered_entity_info,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveredEntityInformation RecoveredEntityInformation
...
func NewRecoveredEntityInformation() *RecoveredEntityInformation {
	this := RecoveredEntityInformation{}
	return &this
}
...
// SetSourceEntityReference gets a reference to the given Reference and assigns it to the SourceEntityReference field.
func (o *RecoveredEntityInformation) SetSourceEntityReference(v Reference) {
	o.SourceEntityReference = &v
}

// GetRecoveredEntityInfo returns the RecoveredEntityInfo field value if set, zero value otherwise.
func (o *RecoveredEntityInformation) GetRecoveredEntityInfo() RecoveredEntityInformationRecoveredEntityInfo {
	if o == nil || IsNil(o.RecoveredEntityInfo) {
		var ret RecoveredEntityInformationRecoveredEntityInfo
		return ret
	}
	return *o.RecoveredEntityInfo
}

// GetRecoveredEntityInfoOk returns a tuple with the RecoveredEntityInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveredEntityInformation) GetRecoveredEntityInfoOk() (*RecoveredEntityInformationRecoveredEntityInfo, bool) {
	if o == nil || IsNil(o.RecoveredEntityInfo) {
		return nil, false
	}
	return o.RecoveredEntityInfo, true
}
...
// SetRecoveredEntityInfo gets a reference to the given RecoveredEntityInformationRecoveredEntityInfo and assigns it to the RecoveredEntityInfo field.
func (o *RecoveredEntityInformation) SetRecoveredEntityInfo(v RecoveredEntityInformationRecoveredEntityInfo) {
	o.RecoveredEntityInfo = &v
}

func (o RecoveredEntityInformation) MarshalJSON() ([]byte, error) {
...
func (o RecoveredEntityInformation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RecoveredEntityInfo) {
		toSerialize["recovered_entity_info"] = o.RecoveredEntityInfo
	}
...
func (o *RecoveredEntityInformation) UnmarshalJSON(data []byte) (err error) {
	varRecoveredEntityInformation := _RecoveredEntityInformation{}

	err = json.Unmarshal(data, &varRecoveredEntityInformation)

	if err != nil {
		return err
	}

	*o = RecoveredEntityInformation(varRecoveredEntityInformation)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "recovered_entity_info")
...
type NullableRecoveredEntityInformation struct {
	value *RecoveredEntityInformation
	isSet bool
}

func (v NullableRecoveredEntityInformation) Get() *RecoveredEntityInformation {
	return v.value
}

func (v *NullableRecoveredEntityInformation) Set(val *RecoveredEntityInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveredEntityInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveredEntityInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveredEntityInformation(val *RecoveredEntityInformation) *NullableRecoveredEntityInformation {
	return &NullableRecoveredEntityInformation{value: val, isSet: true}
}

func (v NullableRecoveredEntityInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveredEntityInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
