...
// checks if the ResourceChargeStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceChargeStatus{}

// ResourceChargeStatus The status of a REST API call. Only used when there is a failure to report. 
...
type _ResourceChargeStatus ResourceChargeStatus
...
func (o ResourceChargeStatus) MarshalJSON() ([]byte, error) {
...
func (o ResourceChargeStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceChargeStatus) UnmarshalJSON(data []byte) (err error) {
	varResourceChargeStatus := _ResourceChargeStatus{}

	err = json.Unmarshal(data, &varResourceChargeStatus)

	if err != nil {
		return err
	}

	*o = ResourceChargeStatus(varResourceChargeStatus)
...
type NullableResourceChargeStatus struct {
	value *ResourceChargeStatus
	isSet bool
}

func (v NullableResourceChargeStatus) Get() *ResourceChargeStatus {
	return v.value
}

func (v *NullableResourceChargeStatus) Set(val *ResourceChargeStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceChargeStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceChargeStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceChargeStatus(val *ResourceChargeStatus) *NullableResourceChargeStatus {
	return &NullableResourceChargeStatus{value: val, isSet: true}
}

func (v NullableResourceChargeStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceChargeStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
