...
// checks if the CommonReportConfigIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigIntentResource{}

// CommonReportConfigIntentResource Response object for intentful operations on a common_report_config
type CommonReportConfigIntentResource struct {
	Status *CommonReportConfigDefStatus `json:"status,omitempty"`
	Spec *CommonReportConfig `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion *string `json:"api_version,omitempty"`
	Metadata CommonReportConfigMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _CommonReportConfigIntentResource CommonReportConfigIntentResource
...
func NewCommonReportConfigIntentResource(metadata CommonReportConfigMetadata) *CommonReportConfigIntentResource {
	this := CommonReportConfigIntentResource{}
...
func (o *CommonReportConfigIntentResource) GetStatus() CommonReportConfigDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret CommonReportConfigDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CommonReportConfigDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given CommonReportConfig and assigns it to the Spec field.
...
func (o *CommonReportConfigIntentResource) GetMetadata() CommonReportConfigMetadata {
	if o == nil {
		var ret CommonReportConfigMetadata
		return ret
	}
...
func (o CommonReportConfigIntentResource) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfigIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonReportConfigIntentResource := _CommonReportConfigIntentResource{}

	err = json.Unmarshal(data, &varCommonReportConfigIntentResource)

	if err != nil {
		return err
	}

	*o = CommonReportConfigIntentResource(varCommonReportConfigIntentResource)
...
type NullableCommonReportConfigIntentResource struct {
	value *CommonReportConfigIntentResource
	isSet bool
}

func (v NullableCommonReportConfigIntentResource) Get() *CommonReportConfigIntentResource {
	return v.value
}

func (v *NullableCommonReportConfigIntentResource) Set(val *CommonReportConfigIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigIntentResource(val *CommonReportConfigIntentResource) *NullableCommonReportConfigIntentResource {
	return &NullableCommonReportConfigIntentResource{value: val, isSet: true}
}

func (v NullableCommonReportConfigIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
