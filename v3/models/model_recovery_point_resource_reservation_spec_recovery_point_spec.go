...
// checks if the RecoveryPointResourceReservationSpecRecoveryPointSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPointResourceReservationSpecRecoveryPointSpec{}

// RecoveryPointResourceReservationSpecRecoveryPointSpec Recovery point specification.
type RecoveryPointResourceReservationSpecRecoveryPointSpec struct {
	VmRecoveryPointReference *VmRecoveryPointReference `json:"vm_recovery_point_reference,omitempty"`
	VgRecoveryPointReference *VgRecoveryPointReference `json:"vg_recovery_point_reference,omitempty"`
	ClusterReference *ClusterReference `json:"cluster_reference,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPointResourceReservationSpecRecoveryPointSpec RecoveryPointResourceReservationSpecRecoveryPointSpec
...
func NewRecoveryPointResourceReservationSpecRecoveryPointSpec() *RecoveryPointResourceReservationSpecRecoveryPointSpec {
	this := RecoveryPointResourceReservationSpecRecoveryPointSpec{}
	return &this
}
...
// GetVgRecoveryPointReference returns the VgRecoveryPointReference field value if set, zero value otherwise.
func (o *RecoveryPointResourceReservationSpecRecoveryPointSpec) GetVgRecoveryPointReference() VgRecoveryPointReference {
	if o == nil || IsNil(o.VgRecoveryPointReference) {
		var ret VgRecoveryPointReference
		return ret
	}
	return *o.VgRecoveryPointReference
}

// GetVgRecoveryPointReferenceOk returns a tuple with the VgRecoveryPointReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPointResourceReservationSpecRecoveryPointSpec) GetVgRecoveryPointReferenceOk() (*VgRecoveryPointReference, bool) {
	if o == nil || IsNil(o.VgRecoveryPointReference) {
		return nil, false
	}
	return o.VgRecoveryPointReference, true
}
...
// SetVgRecoveryPointReference gets a reference to the given VgRecoveryPointReference and assigns it to the VgRecoveryPointReference field.
func (o *RecoveryPointResourceReservationSpecRecoveryPointSpec) SetVgRecoveryPointReference(v VgRecoveryPointReference) {
	o.VgRecoveryPointReference = &v
}
...
func (o RecoveryPointResourceReservationSpecRecoveryPointSpec) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPointResourceReservationSpecRecoveryPointSpec) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VmRecoveryPointReference) {
		toSerialize["vm_recovery_point_reference"] = o.VmRecoveryPointReference
	}
	if !IsNil(o.VgRecoveryPointReference) {
		toSerialize["vg_recovery_point_reference"] = o.VgRecoveryPointReference
	}
...
func (o *RecoveryPointResourceReservationSpecRecoveryPointSpec) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPointResourceReservationSpecRecoveryPointSpec := _RecoveryPointResourceReservationSpecRecoveryPointSpec{}

	err = json.Unmarshal(data, &varRecoveryPointResourceReservationSpecRecoveryPointSpec)

	if err != nil {
		return err
	}

	*o = RecoveryPointResourceReservationSpecRecoveryPointSpec(varRecoveryPointResourceReservationSpecRecoveryPointSpec)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vm_recovery_point_reference")
		delete(additionalProperties, "vg_recovery_point_reference")
...
type NullableRecoveryPointResourceReservationSpecRecoveryPointSpec struct {
	value *RecoveryPointResourceReservationSpecRecoveryPointSpec
	isSet bool
}

func (v NullableRecoveryPointResourceReservationSpecRecoveryPointSpec) Get() *RecoveryPointResourceReservationSpecRecoveryPointSpec {
	return v.value
}

func (v *NullableRecoveryPointResourceReservationSpecRecoveryPointSpec) Set(val *RecoveryPointResourceReservationSpecRecoveryPointSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPointResourceReservationSpecRecoveryPointSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPointResourceReservationSpecRecoveryPointSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPointResourceReservationSpecRecoveryPointSpec(val *RecoveryPointResourceReservationSpecRecoveryPointSpec) *NullableRecoveryPointResourceReservationSpecRecoveryPointSpec {
	return &NullableRecoveryPointResourceReservationSpecRecoveryPointSpec{value: val, isSet: true}
}

func (v NullableRecoveryPointResourceReservationSpecRecoveryPointSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPointResourceReservationSpecRecoveryPointSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
