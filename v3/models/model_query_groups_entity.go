...
// checks if the QueryGroupsEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryGroupsEntity{}

// QueryGroupsEntity An Individual Entity.
type QueryGroupsEntity struct {
	EntityId *string `json:"entity_id,omitempty"`
	Data []QueryGroupsFieldData `json:"data,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QueryGroupsEntity QueryGroupsEntity
...
// SetData gets a reference to the given []QueryGroupsFieldData and assigns it to the Data field.
func (o *QueryGroupsEntity) SetData(v []QueryGroupsFieldData) {
	o.Data = v
}

func (o QueryGroupsEntity) MarshalJSON() ([]byte, error) {
...
func (o QueryGroupsEntity) ToMap() (map[string]interface{}, error) {
...
func (o *QueryGroupsEntity) UnmarshalJSON(data []byte) (err error) {
	varQueryGroupsEntity := _QueryGroupsEntity{}

	err = json.Unmarshal(data, &varQueryGroupsEntity)

	if err != nil {
		return err
	}

	*o = QueryGroupsEntity(varQueryGroupsEntity)
...
type NullableQueryGroupsEntity struct {
	value *QueryGroupsEntity
	isSet bool
}

func (v NullableQueryGroupsEntity) Get() *QueryGroupsEntity {
	return v.value
}

func (v *NullableQueryGroupsEntity) Set(val *QueryGroupsEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryGroupsEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryGroupsEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryGroupsEntity(val *QueryGroupsEntity) *NullableQueryGroupsEntity {
	return &NullableQueryGroupsEntity{value: val, isSet: true}
}

func (v NullableQueryGroupsEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryGroupsEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
