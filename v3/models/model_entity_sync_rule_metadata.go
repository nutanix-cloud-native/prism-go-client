...
// checks if the EntitySyncRuleMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitySyncRuleMetadata{}

// EntitySyncRuleMetadata The entity_sync_rule kind metadata
type EntitySyncRuleMetadata struct {
	...
	// Categories for the entity_sync_rule. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the entity_sync_rule. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
	Categories *map[string]string `json:"categories,omitempty"`
	// entity_sync_rule name
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _EntitySyncRuleMetadata EntitySyncRuleMetadata
...
func (o EntitySyncRuleMetadata) MarshalJSON() ([]byte, error) {
...
func (o EntitySyncRuleMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *EntitySyncRuleMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varEntitySyncRuleMetadata := _EntitySyncRuleMetadata{}

	err = json.Unmarshal(data, &varEntitySyncRuleMetadata)

	if err != nil {
		return err
	}

	*o = EntitySyncRuleMetadata(varEntitySyncRuleMetadata)
...
type NullableEntitySyncRuleMetadata struct {
	value *EntitySyncRuleMetadata
	isSet bool
}

func (v NullableEntitySyncRuleMetadata) Get() *EntitySyncRuleMetadata {
	return v.value
}

func (v *NullableEntitySyncRuleMetadata) Set(val *EntitySyncRuleMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitySyncRuleMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitySyncRuleMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitySyncRuleMetadata(val *EntitySyncRuleMetadata) *NullableEntitySyncRuleMetadata {
	return &NullableEntitySyncRuleMetadata{value: val, isSet: true}
}

func (v NullableEntitySyncRuleMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitySyncRuleMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
