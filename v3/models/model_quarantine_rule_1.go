...
// checks if the QuarantineRule1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuarantineRule1{}

// QuarantineRule1 These rules are used for quarantining suspected VMs. Target group is a required attribute.  Empty inbound_allow_list will not allow anything into target group. Empty outbound_allow_list will allow everything from target group. 
type QuarantineRule1 struct {
	// Type of action.
...
type _QuarantineRule1 QuarantineRule1
...
// SetOutboundAllowList gets a reference to the given []NetworkRule and assigns it to the OutboundAllowList field.
...
// SetInboundAllowList gets a reference to the given []NetworkRule and assigns it to the InboundAllowList field.
func (o *QuarantineRule1) SetInboundAllowList(v []NetworkRule) {
	o.InboundAllowList = v
}

func (o QuarantineRule1) MarshalJSON() ([]byte, error) {
...
func (o QuarantineRule1) ToMap() (map[string]interface{}, error) {
...
func (o *QuarantineRule1) UnmarshalJSON(data []byte) (err error) {
	varQuarantineRule1 := _QuarantineRule1{}

	err = json.Unmarshal(data, &varQuarantineRule1)

	if err != nil {
		return err
	}

	*o = QuarantineRule1(varQuarantineRule1)
...
type NullableQuarantineRule1 struct {
	value *QuarantineRule1
	isSet bool
}

func (v NullableQuarantineRule1) Get() *QuarantineRule1 {
	return v.value
}

func (v *NullableQuarantineRule1) Set(val *QuarantineRule1) {
	v.value = val
	v.isSet = true
}

func (v NullableQuarantineRule1) IsSet() bool {
	return v.isSet
}

func (v *NullableQuarantineRule1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuarantineRule1(val *QuarantineRule1) *NullableQuarantineRule1 {
	return &NullableQuarantineRule1{value: val, isSet: true}
}

func (v NullableQuarantineRule1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuarantineRule1) UnmarshalJSON(src []byte) error {
	v.isSet = true
