...
// checks if the ReportConfigStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigStatus{}

// ReportConfigStatus The status of a REST API call. Only used when there is a failure to report. 
type ReportConfigStatus struct {
	// The kind name
...
type _ReportConfigStatus ReportConfigStatus
...
func (o ReportConfigStatus) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfigStatus) UnmarshalJSON(data []byte) (err error) {
	varReportConfigStatus := _ReportConfigStatus{}

	err = json.Unmarshal(data, &varReportConfigStatus)

	if err != nil {
		return err
	}

	*o = ReportConfigStatus(varReportConfigStatus)
...
type NullableReportConfigStatus struct {
	value *ReportConfigStatus
	isSet bool
}

func (v NullableReportConfigStatus) Get() *ReportConfigStatus {
	return v.value
}

func (v *NullableReportConfigStatus) Set(val *ReportConfigStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigStatus(val *ReportConfigStatus) *NullableReportConfigStatus {
	return &NullableReportConfigStatus{value: val, isSet: true}
}

func (v NullableReportConfigStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
