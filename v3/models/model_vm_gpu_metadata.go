...
// checks if the VmGpuMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmGpuMetadata{}

// VmGpuMetadata The vm_gpu kind metadata
type VmGpuMetadata struct {
	...
	// Categories for the vm_gpu. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the vm_gpu. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _VmGpuMetadata VmGpuMetadata
...
func (o VmGpuMetadata) MarshalJSON() ([]byte, error) {
...
func (o VmGpuMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *VmGpuMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varVmGpuMetadata := _VmGpuMetadata{}

	err = json.Unmarshal(data, &varVmGpuMetadata)

	if err != nil {
		return err
	}

	*o = VmGpuMetadata(varVmGpuMetadata)
...
type NullableVmGpuMetadata struct {
	value *VmGpuMetadata
	isSet bool
}

func (v NullableVmGpuMetadata) Get() *VmGpuMetadata {
	return v.value
}

func (v *NullableVmGpuMetadata) Set(val *VmGpuMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableVmGpuMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableVmGpuMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmGpuMetadata(val *VmGpuMetadata) *NullableVmGpuMetadata {
	return &NullableVmGpuMetadata{value: val, isSet: true}
}

func (v NullableVmGpuMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmGpuMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
