...
// checks if the NetworkDeviceListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDeviceListMetadataOutput{}

// NetworkDeviceListMetadataOutput All api calls that return a list will have this metadata block 
type NetworkDeviceListMetadataOutput struct {
	// The kind name
...
type _NetworkDeviceListMetadataOutput NetworkDeviceListMetadataOutput
...
func NewNetworkDeviceListMetadataOutput() *NetworkDeviceListMetadataOutput {
	this := NetworkDeviceListMetadataOutput{}
	var kind string = "network_device"
	this.Kind = &kind
	return &this
}
...
func (o NetworkDeviceListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o NetworkDeviceListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkDeviceListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varNetworkDeviceListMetadataOutput := _NetworkDeviceListMetadataOutput{}

	err = json.Unmarshal(data, &varNetworkDeviceListMetadataOutput)

	if err != nil {
		return err
	}

	*o = NetworkDeviceListMetadataOutput(varNetworkDeviceListMetadataOutput)
...
type NullableNetworkDeviceListMetadataOutput struct {
	value *NetworkDeviceListMetadataOutput
	isSet bool
}

func (v NullableNetworkDeviceListMetadataOutput) Get() *NetworkDeviceListMetadataOutput {
	return v.value
}

func (v *NullableNetworkDeviceListMetadataOutput) Set(val *NetworkDeviceListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDeviceListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDeviceListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDeviceListMetadataOutput(val *NetworkDeviceListMetadataOutput) *NullableNetworkDeviceListMetadataOutput {
	return &NullableNetworkDeviceListMetadataOutput{value: val, isSet: true}
}

func (v NullableNetworkDeviceListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDeviceListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
