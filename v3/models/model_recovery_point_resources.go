...
// checks if the RecoveryPointResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPointResources{}

// RecoveryPointResources struct for RecoveryPointResources
type RecoveryPointResources struct {
...
type _RecoveryPointResources RecoveryPointResources
...
func (o RecoveryPointResources) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPointResources) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPointResources) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPointResources := _RecoveryPointResources{}

	err = json.Unmarshal(data, &varRecoveryPointResources)

	if err != nil {
		return err
	}

	*o = RecoveryPointResources(varRecoveryPointResources)
...
type NullableRecoveryPointResources struct {
	value *RecoveryPointResources
	isSet bool
}

func (v NullableRecoveryPointResources) Get() *RecoveryPointResources {
	return v.value
}

func (v *NullableRecoveryPointResources) Set(val *RecoveryPointResources) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPointResources) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPointResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPointResources(val *RecoveryPointResources) *NullableRecoveryPointResources {
	return &NullableRecoveryPointResources{value: val, isSet: true}
}

func (v NullableRecoveryPointResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPointResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
