...
// checks if the Layer2StretchIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchIntentResponse{}

// Layer2StretchIntentResponse Response object for intentful operations on a layer2_stretch
type Layer2StretchIntentResponse struct {
	Status *Layer2StretchDefStatus `json:"status,omitempty"`
	Spec *Layer2Stretch `json:"spec,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata Layer2StretchMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _Layer2StretchIntentResponse Layer2StretchIntentResponse
...
func NewLayer2StretchIntentResponse(apiVersion string, metadata Layer2StretchMetadata) *Layer2StretchIntentResponse {
	this := Layer2StretchIntentResponse{}
...
func (o *Layer2StretchIntentResponse) GetStatus() Layer2StretchDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret Layer2StretchDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given Layer2StretchDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Layer2Stretch and assigns it to the Spec field.
...
func (o Layer2StretchIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varLayer2StretchIntentResponse := _Layer2StretchIntentResponse{}

	err = json.Unmarshal(data, &varLayer2StretchIntentResponse)

	if err != nil {
		return err
	}

	*o = Layer2StretchIntentResponse(varLayer2StretchIntentResponse)
...
type NullableLayer2StretchIntentResponse struct {
	value *Layer2StretchIntentResponse
	isSet bool
}

func (v NullableLayer2StretchIntentResponse) Get() *Layer2StretchIntentResponse {
	return v.value
}

func (v *NullableLayer2StretchIntentResponse) Set(val *Layer2StretchIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchIntentResponse(val *Layer2StretchIntentResponse) *NullableLayer2StretchIntentResponse {
	return &NullableLayer2StretchIntentResponse{value: val, isSet: true}
}

func (v NullableLayer2StretchIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
