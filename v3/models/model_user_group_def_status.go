...
// checks if the UserGroupDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroupDefStatus{}

// UserGroupDefStatus User group status definition.
type UserGroupDefStatus struct {
	// The state of the entity.
	State *string `json:"state,omitempty"`
	MessageList []MessageResource `json:"message_list,omitempty"`
	Resources UserGroupOutputResource `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _UserGroupDefStatus UserGroupDefStatus
...
func (o *UserGroupDefStatus) GetResources() UserGroupOutputResource {
	if o == nil {
		var ret UserGroupOutputResource
		return ret
	}
...
func (o UserGroupDefStatus) MarshalJSON() ([]byte, error) {
...
func (o UserGroupDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *UserGroupDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varUserGroupDefStatus := _UserGroupDefStatus{}

	err = json.Unmarshal(data, &varUserGroupDefStatus)

	if err != nil {
		return err
	}

	*o = UserGroupDefStatus(varUserGroupDefStatus)
...
type NullableUserGroupDefStatus struct {
	value *UserGroupDefStatus
	isSet bool
}

func (v NullableUserGroupDefStatus) Get() *UserGroupDefStatus {
	return v.value
}

func (v *NullableUserGroupDefStatus) Set(val *UserGroupDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroupDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroupDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroupDefStatus(val *UserGroupDefStatus) *NullableUserGroupDefStatus {
	return &NullableUserGroupDefStatus{value: val, isSet: true}
}

func (v NullableUserGroupDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroupDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
