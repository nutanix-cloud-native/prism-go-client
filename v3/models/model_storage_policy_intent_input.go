...
// checks if the StoragePolicyIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyIntentInput{}

// StoragePolicyIntentInput An intentful representation of a storage_policy
type StoragePolicyIntentInput struct {
	Spec StoragePolicy `json:"spec"`
...
type _StoragePolicyIntentInput StoragePolicyIntentInput
...
func (o StoragePolicyIntentInput) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePolicyIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varStoragePolicyIntentInput := _StoragePolicyIntentInput{}

	err = json.Unmarshal(data, &varStoragePolicyIntentInput)

	if err != nil {
		return err
	}

	*o = StoragePolicyIntentInput(varStoragePolicyIntentInput)
...
type NullableStoragePolicyIntentInput struct {
	value *StoragePolicyIntentInput
	isSet bool
}

func (v NullableStoragePolicyIntentInput) Get() *StoragePolicyIntentInput {
	return v.value
}

func (v *NullableStoragePolicyIntentInput) Set(val *StoragePolicyIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyIntentInput(val *StoragePolicyIntentInput) *NullableStoragePolicyIntentInput {
	return &NullableStoragePolicyIntentInput{value: val, isSet: true}
}

func (v NullableStoragePolicyIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
