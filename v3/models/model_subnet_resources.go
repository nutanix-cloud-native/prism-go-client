...
// checks if the SubnetResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubnetResources{}
...
type _SubnetResources SubnetResources
...
func (o SubnetResources) MarshalJSON() ([]byte, error) {
...
func (o SubnetResources) ToMap() (map[string]interface{}, error) {
...
func (o *SubnetResources) UnmarshalJSON(data []byte) (err error) {
	...
	varSubnetResources := _SubnetResources{}

	err = json.Unmarshal(data, &varSubnetResources)

	if err != nil {
		return err
	}

	*o = SubnetResources(varSubnetResources)
...
type NullableSubnetResources struct {
	value *SubnetResources
	isSet bool
}

func (v NullableSubnetResources) Get() *SubnetResources {
	return v.value
}

func (v *NullableSubnetResources) Set(val *SubnetResources) {
	v.value = val
	v.isSet = true
}

func (v NullableSubnetResources) IsSet() bool {
	return v.isSet
}

func (v *NullableSubnetResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubnetResources(val *SubnetResources) *NullableSubnetResources {
	return &NullableSubnetResources{value: val, isSet: true}
}

func (v NullableSubnetResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubnetResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
