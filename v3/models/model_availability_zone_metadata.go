...
// checks if the AvailabilityZoneMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneMetadata{}

// AvailabilityZoneMetadata The availability_zone kind metadata
type AvailabilityZoneMetadata struct {
	...
	// Categories for the availability_zone. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the availability_zone. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _AvailabilityZoneMetadata AvailabilityZoneMetadata
...
func (o AvailabilityZoneMetadata) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varAvailabilityZoneMetadata := _AvailabilityZoneMetadata{}

	err = json.Unmarshal(data, &varAvailabilityZoneMetadata)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneMetadata(varAvailabilityZoneMetadata)
...
type NullableAvailabilityZoneMetadata struct {
	value *AvailabilityZoneMetadata
	isSet bool
}

func (v NullableAvailabilityZoneMetadata) Get() *AvailabilityZoneMetadata {
	return v.value
}

func (v *NullableAvailabilityZoneMetadata) Set(val *AvailabilityZoneMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneMetadata(val *AvailabilityZoneMetadata) *NullableAvailabilityZoneMetadata {
	return &NullableAvailabilityZoneMetadata{value: val, isSet: true}
}

func (v NullableAvailabilityZoneMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
