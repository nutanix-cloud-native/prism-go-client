...
// checks if the Layer2Stretch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2Stretch{}

// Layer2Stretch An intentful representation of a layer2_stretch spec
type Layer2Stretch struct {
	...
	Resources Layer2StretchResources `json:"resources"`
	// layer2_stretch Name.
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _Layer2Stretch Layer2Stretch
...
func (o *Layer2Stretch) GetResources() Layer2StretchResources {
	if o == nil {
		var ret Layer2StretchResources
		return ret
	}
...
func (o Layer2Stretch) MarshalJSON() ([]byte, error) {
...
func (o Layer2Stretch) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2Stretch) UnmarshalJSON(data []byte) (err error) {
	...
	varLayer2Stretch := _Layer2Stretch{}

	err = json.Unmarshal(data, &varLayer2Stretch)

	if err != nil {
		return err
	}

	*o = Layer2Stretch(varLayer2Stretch)
...
type NullableLayer2Stretch struct {
	value *Layer2Stretch
	isSet bool
}

func (v NullableLayer2Stretch) Get() *Layer2Stretch {
	return v.value
}

func (v *NullableLayer2Stretch) Set(val *Layer2Stretch) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2Stretch) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2Stretch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2Stretch(val *Layer2Stretch) *NullableLayer2Stretch {
	return &NullableLayer2Stretch{value: val, isSet: true}
}

func (v NullableLayer2Stretch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2Stretch) UnmarshalJSON(src []byte) error {
	v.isSet = true
