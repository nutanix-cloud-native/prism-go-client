...
// checks if the XenWorkload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &XenWorkload{}

// XenWorkload Xen workload Object.
type XenWorkload struct {
	OperatingSystem *string `json:"operating_system,omitempty"`
	Vendor *string `json:"vendor,omitempty"`
	SystemData *int32 `json:"system_data,omitempty"`
	RdshProvisioningType *string `json:"rdsh_provisioning_type,omitempty"`
	NumUsers *int32 `json:"num_users,omitempty"`
	PvsWriteCacheSize *int32 `json:"pvs_write_cache_size,omitempty"`
	McsDiffSize *int32 `json:"mcs_diff_size,omitempty"`
	UserProfileData *int32 `json:"user_profile_data,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _XenWorkload XenWorkload
...
// SetSystemData gets a reference to the given int32 and assigns it to the SystemData field.
func (o *XenWorkload) SetSystemData(v int32) {
	o.SystemData = &v
}

// GetRdshProvisioningType returns the RdshProvisioningType field value if set, zero value otherwise.
func (o *XenWorkload) GetRdshProvisioningType() string {
	if o == nil || IsNil(o.RdshProvisioningType) {
		var ret string
		return ret
	}
	return *o.RdshProvisioningType
}

// GetRdshProvisioningTypeOk returns a tuple with the RdshProvisioningType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *XenWorkload) GetRdshProvisioningTypeOk() (*string, bool) {
	if o == nil || IsNil(o.RdshProvisioningType) {
		return nil, false
	}
	return o.RdshProvisioningType, true
}
...
// SetRdshProvisioningType gets a reference to the given string and assigns it to the RdshProvisioningType field.
func (o *XenWorkload) SetRdshProvisioningType(v string) {
	o.RdshProvisioningType = &v
}
...
// GetPvsWriteCacheSize returns the PvsWriteCacheSize field value if set, zero value otherwise.
func (o *XenWorkload) GetPvsWriteCacheSize() int32 {
	if o == nil || IsNil(o.PvsWriteCacheSize) {
		var ret int32
		return ret
	}
	return *o.PvsWriteCacheSize
}

// GetPvsWriteCacheSizeOk returns a tuple with the PvsWriteCacheSize field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *XenWorkload) GetPvsWriteCacheSizeOk() (*int32, bool) {
	if o == nil || IsNil(o.PvsWriteCacheSize) {
		return nil, false
	}
	return o.PvsWriteCacheSize, true
}
...
// SetPvsWriteCacheSize gets a reference to the given int32 and assigns it to the PvsWriteCacheSize field.
func (o *XenWorkload) SetPvsWriteCacheSize(v int32) {
	o.PvsWriteCacheSize = &v
}

// GetMcsDiffSize returns the McsDiffSize field value if set, zero value otherwise.
func (o *XenWorkload) GetMcsDiffSize() int32 {
	if o == nil || IsNil(o.McsDiffSize) {
		var ret int32
		return ret
	}
	return *o.McsDiffSize
}

// GetMcsDiffSizeOk returns a tuple with the McsDiffSize field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *XenWorkload) GetMcsDiffSizeOk() (*int32, bool) {
	if o == nil || IsNil(o.McsDiffSize) {
		return nil, false
	}
	return o.McsDiffSize, true
}
...
// SetMcsDiffSize gets a reference to the given int32 and assigns it to the McsDiffSize field.
func (o *XenWorkload) SetMcsDiffSize(v int32) {
	o.McsDiffSize = &v
}

// GetUserProfileData returns the UserProfileData field value if set, zero value otherwise.
func (o *XenWorkload) GetUserProfileData() int32 {
	if o == nil || IsNil(o.UserProfileData) {
		var ret int32
		return ret
	}
	return *o.UserProfileData
}

// GetUserProfileDataOk returns a tuple with the UserProfileData field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *XenWorkload) GetUserProfileDataOk() (*int32, bool) {
	if o == nil || IsNil(o.UserProfileData) {
		return nil, false
	}
	return o.UserProfileData, true
}
...
// SetUserProfileData gets a reference to the given int32 and assigns it to the UserProfileData field.
func (o *XenWorkload) SetUserProfileData(v int32) {
	o.UserProfileData = &v
}

func (o XenWorkload) MarshalJSON() ([]byte, error) {
...
func (o XenWorkload) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SystemData) {
		toSerialize["system_data"] = o.SystemData
	}
	if !IsNil(o.RdshProvisioningType) {
		toSerialize["rdsh_provisioning_type"] = o.RdshProvisioningType
	}
	if !IsNil(o.NumUsers) {
		toSerialize["num_users"] = o.NumUsers
	}
	if !IsNil(o.PvsWriteCacheSize) {
		toSerialize["pvs_write_cache_size"] = o.PvsWriteCacheSize
	}
	if !IsNil(o.McsDiffSize) {
		toSerialize["mcs_diff_size"] = o.McsDiffSize
	}
	if !IsNil(o.UserProfileData) {
		toSerialize["user_profile_data"] = o.UserProfileData
	}
...
func (o *XenWorkload) UnmarshalJSON(data []byte) (err error) {
	varXenWorkload := _XenWorkload{}

	err = json.Unmarshal(data, &varXenWorkload)

	if err != nil {
		return err
	}

	*o = XenWorkload(varXenWorkload)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "system_data")
		delete(additionalProperties, "rdsh_provisioning_type")
		delete(additionalProperties, "num_users")
		delete(additionalProperties, "pvs_write_cache_size")
		delete(additionalProperties, "mcs_diff_size")
		delete(additionalProperties, "user_profile_data")
...
type NullableXenWorkload struct {
	value *XenWorkload
	isSet bool
}

func (v NullableXenWorkload) Get() *XenWorkload {
	return v.value
}

func (v *NullableXenWorkload) Set(val *XenWorkload) {
	v.value = val
	v.isSet = true
}

func (v NullableXenWorkload) IsSet() bool {
	return v.isSet
}

func (v *NullableXenWorkload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableXenWorkload(val *XenWorkload) *NullableXenWorkload {
	return &NullableXenWorkload{value: val, isSet: true}
}

func (v NullableXenWorkload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableXenWorkload) UnmarshalJSON(src []byte) error {
	v.isSet = true
