...
// checks if the RecoveryPlanDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanDefStatus{}
...
type RecoveryPlanDefStatus struct {
	...
	RecoveryAvailabilityZoneOrderList []RecoveryPlanDefStatusRecoveryAvailabilityZoneOrderListInner `json:"recovery_availability_zone_order_list"`
	...
	LatestValidationTime *time.Time `json:"latest_validation_time,omitempty"`
	// Time when latest test was done for Recovery Plan.
	LatestTestTime *time.Time `json:"latest_test_time,omitempty"`
...
type _RecoveryPlanDefStatus RecoveryPlanDefStatus
...
func NewRecoveryPlanDefStatus(name string, recoveryAvailabilityZoneOrderList []RecoveryPlanDefStatusRecoveryAvailabilityZoneOrderListInner, resources RecoveryPlanResources) *RecoveryPlanDefStatus {
	this := RecoveryPlanDefStatus{}
	this.Name = name
	this.RecoveryAvailabilityZoneOrderList = recoveryAvailabilityZoneOrderList
...
// GetRecoveryAvailabilityZoneOrderList returns the RecoveryAvailabilityZoneOrderList field value
func (o *RecoveryPlanDefStatus) GetRecoveryAvailabilityZoneOrderList() []RecoveryPlanDefStatusRecoveryAvailabilityZoneOrderListInner {
	if o == nil {
		var ret []RecoveryPlanDefStatusRecoveryAvailabilityZoneOrderListInner
		return ret
	}

	return o.RecoveryAvailabilityZoneOrderList
}

// GetRecoveryAvailabilityZoneOrderListOk returns a tuple with the RecoveryAvailabilityZoneOrderList field value
// and a boolean to check if the value has been set.
func (o *RecoveryPlanDefStatus) GetRecoveryAvailabilityZoneOrderListOk() ([]RecoveryPlanDefStatusRecoveryAvailabilityZoneOrderListInner, bool) {
	...
	return o.RecoveryAvailabilityZoneOrderList, true
}

// SetRecoveryAvailabilityZoneOrderList sets field value
func (o *RecoveryPlanDefStatus) SetRecoveryAvailabilityZoneOrderList(v []RecoveryPlanDefStatusRecoveryAvailabilityZoneOrderListInner) {
	o.RecoveryAvailabilityZoneOrderList = v
}
...
// GetLatestValidationTime returns the LatestValidationTime field value if set, zero value otherwise.
func (o *RecoveryPlanDefStatus) GetLatestValidationTime() time.Time {
	if o == nil || IsNil(o.LatestValidationTime) {
		var ret time.Time
		return ret
	}
	return *o.LatestValidationTime
}

// GetLatestValidationTimeOk returns a tuple with the LatestValidationTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanDefStatus) GetLatestValidationTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LatestValidationTime) {
		return nil, false
	}
	return o.LatestValidationTime, true
}
...
// SetLatestValidationTime gets a reference to the given time.Time and assigns it to the LatestValidationTime field.
func (o *RecoveryPlanDefStatus) SetLatestValidationTime(v time.Time) {
	o.LatestValidationTime = &v
}

// GetLatestTestTime returns the LatestTestTime field value if set, zero value otherwise.
func (o *RecoveryPlanDefStatus) GetLatestTestTime() time.Time {
	if o == nil || IsNil(o.LatestTestTime) {
		var ret time.Time
		return ret
	}
	return *o.LatestTestTime
}

// GetLatestTestTimeOk returns a tuple with the LatestTestTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanDefStatus) GetLatestTestTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LatestTestTime) {
		return nil, false
	}
	return o.LatestTestTime, true
}
...
// SetLatestTestTime gets a reference to the given time.Time and assigns it to the LatestTestTime field.
...
func (o RecoveryPlanDefStatus) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	toSerialize["recovery_availability_zone_order_list"] = o.RecoveryAvailabilityZoneOrderList
	...
	if !IsNil(o.LatestValidationTime) {
		toSerialize["latest_validation_time"] = o.LatestValidationTime
	}
	if !IsNil(o.LatestTestTime) {
		toSerialize["latest_test_time"] = o.LatestTestTime
	}
...
func (o *RecoveryPlanDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanDefStatus := _RecoveryPlanDefStatus{}

	err = json.Unmarshal(data, &varRecoveryPlanDefStatus)

	if err != nil {
		return err
	}

	*o = RecoveryPlanDefStatus(varRecoveryPlanDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "name")
		delete(additionalProperties, "recovery_availability_zone_order_list")
		delete(additionalProperties, "message_list")
		delete(additionalProperties, "state")
		delete(additionalProperties, "latest_validation_time")
		delete(additionalProperties, "latest_test_time")
...
type NullableRecoveryPlanDefStatus struct {
	value *RecoveryPlanDefStatus
	isSet bool
}

func (v NullableRecoveryPlanDefStatus) Get() *RecoveryPlanDefStatus {
	return v.value
}

func (v *NullableRecoveryPlanDefStatus) Set(val *RecoveryPlanDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanDefStatus(val *RecoveryPlanDefStatus) *NullableRecoveryPlanDefStatus {
	return &NullableRecoveryPlanDefStatus{value: val, isSet: true}
}

func (v NullableRecoveryPlanDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
