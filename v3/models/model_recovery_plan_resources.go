...
// checks if the RecoveryPlanResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanResources{}
...
type RecoveryPlanResources struct {
	...
	VolumeGroupRecoveryInfoList []RecoveryPlanVolumeGroupRecoveryInfo `json:"volume_group_recovery_info_list,omitempty"`
	...
	StageList []RecoveryPlanStage `json:"stage_list,omitempty"`
	Parameters *RecoveryPlanResourcesParameters `json:"parameters,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanResources RecoveryPlanResources
...
// GetVolumeGroupRecoveryInfoList returns the VolumeGroupRecoveryInfoList field value if set, zero value otherwise.
func (o *RecoveryPlanResources) GetVolumeGroupRecoveryInfoList() []RecoveryPlanVolumeGroupRecoveryInfo {
	if o == nil || IsNil(o.VolumeGroupRecoveryInfoList) {
		var ret []RecoveryPlanVolumeGroupRecoveryInfo
		return ret
	}
	return o.VolumeGroupRecoveryInfoList
}

// GetVolumeGroupRecoveryInfoListOk returns a tuple with the VolumeGroupRecoveryInfoList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanResources) GetVolumeGroupRecoveryInfoListOk() ([]RecoveryPlanVolumeGroupRecoveryInfo, bool) {
	if o == nil || IsNil(o.VolumeGroupRecoveryInfoList) {
		return nil, false
	}
	return o.VolumeGroupRecoveryInfoList, true
}
...
// SetVolumeGroupRecoveryInfoList gets a reference to the given []RecoveryPlanVolumeGroupRecoveryInfo and assigns it to the VolumeGroupRecoveryInfoList field.
func (o *RecoveryPlanResources) SetVolumeGroupRecoveryInfoList(v []RecoveryPlanVolumeGroupRecoveryInfo) {
	o.VolumeGroupRecoveryInfoList = v
}

// GetStageList returns the StageList field value if set, zero value otherwise.
func (o *RecoveryPlanResources) GetStageList() []RecoveryPlanStage {
	if o == nil || IsNil(o.StageList) {
		var ret []RecoveryPlanStage
		return ret
	}
	return o.StageList
}

// GetStageListOk returns a tuple with the StageList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanResources) GetStageListOk() ([]RecoveryPlanStage, bool) {
	if o == nil || IsNil(o.StageList) {
		return nil, false
	}
	return o.StageList, true
}
...
// SetStageList gets a reference to the given []RecoveryPlanStage and assigns it to the StageList field.
...
func (o *RecoveryPlanResources) GetParameters() RecoveryPlanResourcesParameters {
	if o == nil || IsNil(o.Parameters) {
		var ret RecoveryPlanResourcesParameters
		return ret
	}
	return *o.Parameters
}
...
// SetParameters gets a reference to the given RecoveryPlanResourcesParameters and assigns it to the Parameters field.
func (o *RecoveryPlanResources) SetParameters(v RecoveryPlanResourcesParameters) {
	o.Parameters = &v
}

func (o RecoveryPlanResources) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanResources) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VolumeGroupRecoveryInfoList) {
		toSerialize["volume_group_recovery_info_list"] = o.VolumeGroupRecoveryInfoList
	}
	if !IsNil(o.StageList) {
		toSerialize["stage_list"] = o.StageList
	}
...
func (o *RecoveryPlanResources) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanResources := _RecoveryPlanResources{}

	err = json.Unmarshal(data, &varRecoveryPlanResources)

	if err != nil {
		return err
	}

	*o = RecoveryPlanResources(varRecoveryPlanResources)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "volume_group_recovery_info_list")
		delete(additionalProperties, "stage_list")
...
type NullableRecoveryPlanResources struct {
	value *RecoveryPlanResources
	isSet bool
}

func (v NullableRecoveryPlanResources) Get() *RecoveryPlanResources {
	return v.value
}

func (v *NullableRecoveryPlanResources) Set(val *RecoveryPlanResources) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanResources) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanResources(val *RecoveryPlanResources) *NullableRecoveryPlanResources {
	return &NullableRecoveryPlanResources{value: val, isSet: true}
}

func (v NullableRecoveryPlanResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
