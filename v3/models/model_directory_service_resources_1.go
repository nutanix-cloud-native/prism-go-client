...
// checks if the DirectoryServiceResources1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceResources1{}

// DirectoryServiceResources1 The details of the directory service.
type DirectoryServiceResources1 struct {
	OpenLdapConfiguration *OpenLdapConfiguration `json:"open_ldap_configuration,omitempty"`
	...
	// Secondary URLs of the directory
	SecondaryUrls []string `json:"secondary_urls,omitempty"`
	// The domain name of the directory service.
	DomainName string `json:"domain_name"`
	ServiceAccount ServiceAccount `json:"service_account"`
	// List of admin user groups available in the directory service. 
	AdminGroupReferenceList []UserGroupReference `json:"admin_group_reference_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DirectoryServiceResources1 DirectoryServiceResources1
...
func NewDirectoryServiceResources1(url string, directoryType string, domainName string, serviceAccount ServiceAccount) *DirectoryServiceResources1 {
	this := DirectoryServiceResources1{}
	this.Url = url
...
// GetOpenLdapConfiguration returns the OpenLdapConfiguration field value if set, zero value otherwise.
func (o *DirectoryServiceResources1) GetOpenLdapConfiguration() OpenLdapConfiguration {
	if o == nil || IsNil(o.OpenLdapConfiguration) {
		var ret OpenLdapConfiguration
		return ret
	}
	return *o.OpenLdapConfiguration
}

// GetOpenLdapConfigurationOk returns a tuple with the OpenLdapConfiguration field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectoryServiceResources1) GetOpenLdapConfigurationOk() (*OpenLdapConfiguration, bool) {
	if o == nil || IsNil(o.OpenLdapConfiguration) {
		return nil, false
	}
	return o.OpenLdapConfiguration, true
}
...
// SetOpenLdapConfiguration gets a reference to the given OpenLdapConfiguration and assigns it to the OpenLdapConfiguration field.
func (o *DirectoryServiceResources1) SetOpenLdapConfiguration(v OpenLdapConfiguration) {
	o.OpenLdapConfiguration = &v
}
...
// GetAdminUserReferenceList returns the AdminUserReferenceList field value if set, zero value otherwise.
func (o *DirectoryServiceResources1) GetAdminUserReferenceList() []UserReference {
	if o == nil || IsNil(o.AdminUserReferenceList) {
		var ret []UserReference
		return ret
	}
	return o.AdminUserReferenceList
}

// GetAdminUserReferenceListOk returns a tuple with the AdminUserReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectoryServiceResources1) GetAdminUserReferenceListOk() ([]UserReference, bool) {
	if o == nil || IsNil(o.AdminUserReferenceList) {
		return nil, false
	}
	return o.AdminUserReferenceList, true
}
...
// SetAdminUserReferenceList gets a reference to the given []UserReference and assigns it to the AdminUserReferenceList field.
func (o *DirectoryServiceResources1) SetAdminUserReferenceList(v []UserReference) {
	o.AdminUserReferenceList = v
}

// GetSecondaryUrls returns the SecondaryUrls field value if set, zero value otherwise.
func (o *DirectoryServiceResources1) GetSecondaryUrls() []string {
	if o == nil || IsNil(o.SecondaryUrls) {
		var ret []string
		return ret
	}
	return o.SecondaryUrls
}

// GetSecondaryUrlsOk returns a tuple with the SecondaryUrls field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectoryServiceResources1) GetSecondaryUrlsOk() ([]string, bool) {
	if o == nil || IsNil(o.SecondaryUrls) {
		return nil, false
	}
	return o.SecondaryUrls, true
}
...
// SetSecondaryUrls gets a reference to the given []string and assigns it to the SecondaryUrls field.
...
// GetAdminGroupReferenceList returns the AdminGroupReferenceList field value if set, zero value otherwise.
func (o *DirectoryServiceResources1) GetAdminGroupReferenceList() []UserGroupReference {
	if o == nil || IsNil(o.AdminGroupReferenceList) {
		var ret []UserGroupReference
		return ret
	}
	return o.AdminGroupReferenceList
}

// GetAdminGroupReferenceListOk returns a tuple with the AdminGroupReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectoryServiceResources1) GetAdminGroupReferenceListOk() ([]UserGroupReference, bool) {
	if o == nil || IsNil(o.AdminGroupReferenceList) {
		return nil, false
	}
	return o.AdminGroupReferenceList, true
}
...
// SetAdminGroupReferenceList gets a reference to the given []UserGroupReference and assigns it to the AdminGroupReferenceList field.
func (o *DirectoryServiceResources1) SetAdminGroupReferenceList(v []UserGroupReference) {
	o.AdminGroupReferenceList = v
}

func (o DirectoryServiceResources1) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceResources1) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.OpenLdapConfiguration) {
		toSerialize["open_ldap_configuration"] = o.OpenLdapConfiguration
	}
	toSerialize["url"] = o.Url
	toSerialize["directory_type"] = o.DirectoryType
	if !IsNil(o.AdminUserReferenceList) {
		toSerialize["admin_user_reference_list"] = o.AdminUserReferenceList
	}
	if !IsNil(o.SecondaryUrls) {
		toSerialize["secondary_urls"] = o.SecondaryUrls
	}
	toSerialize["domain_name"] = o.DomainName
	toSerialize["service_account"] = o.ServiceAccount
	if !IsNil(o.AdminGroupReferenceList) {
		toSerialize["admin_group_reference_list"] = o.AdminGroupReferenceList
	}
...
func (o *DirectoryServiceResources1) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectoryServiceResources1 := _DirectoryServiceResources1{}

	err = json.Unmarshal(data, &varDirectoryServiceResources1)

	if err != nil {
		return err
	}

	*o = DirectoryServiceResources1(varDirectoryServiceResources1)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "open_ldap_configuration")
		delete(additionalProperties, "url")
		delete(additionalProperties, "directory_type")
		delete(additionalProperties, "admin_user_reference_list")
		delete(additionalProperties, "secondary_urls")
		delete(additionalProperties, "domain_name")
		delete(additionalProperties, "service_account")
		delete(additionalProperties, "admin_group_reference_list")
...
type NullableDirectoryServiceResources1 struct {
	value *DirectoryServiceResources1
	isSet bool
}

func (v NullableDirectoryServiceResources1) Get() *DirectoryServiceResources1 {
	return v.value
}

func (v *NullableDirectoryServiceResources1) Set(val *DirectoryServiceResources1) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceResources1) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceResources1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceResources1(val *DirectoryServiceResources1) *NullableDirectoryServiceResources1 {
	return &NullableDirectoryServiceResources1{value: val, isSet: true}
}

func (v NullableDirectoryServiceResources1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceResources1) UnmarshalJSON(src []byte) error {
	v.isSet = true
