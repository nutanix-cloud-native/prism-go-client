...
// checks if the EpochConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EpochConfig{}

// EpochConfig Details obtained by user on deploying Epoch AOC.
type EpochConfig struct {
	// IP address or Fully Qualified Domain Name(FQDN) obtained by user on deploying Epoch AOC. 
	AocUrl *string `json:"aoc_url,omitempty"`
	// Organization ID obtained by user on deploying Epoch AOC. 
	OrgId *string `json:"org_id,omitempty"`
	// Application Key obtained by user on deploying Epoch AOC. 
	AppKey *string `json:"app_key,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _EpochConfig EpochConfig
...
// GetAocUrl returns the AocUrl field value if set, zero value otherwise.
func (o *EpochConfig) GetAocUrl() string {
	if o == nil || IsNil(o.AocUrl) {
		var ret string
		return ret
	}
	return *o.AocUrl
...
// GetAocUrlOk returns a tuple with the AocUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EpochConfig) GetAocUrlOk() (*string, bool) {
	if o == nil || IsNil(o.AocUrl) {
		return nil, false
	}
	return o.AocUrl, true
}
...
// SetAocUrl gets a reference to the given string and assigns it to the AocUrl field.
...
func (o EpochConfig) MarshalJSON() ([]byte, error) {
...
func (o EpochConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AocUrl) {
		toSerialize["aoc_url"] = o.AocUrl
	}
	if !IsNil(o.OrgId) {
...
func (o *EpochConfig) UnmarshalJSON(data []byte) (err error) {
	varEpochConfig := _EpochConfig{}

	err = json.Unmarshal(data, &varEpochConfig)

	if err != nil {
		return err
	}

	*o = EpochConfig(varEpochConfig)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "aoc_url")
...
type NullableEpochConfig struct {
	value *EpochConfig
	isSet bool
}

func (v NullableEpochConfig) Get() *EpochConfig {
	return v.value
}

func (v *NullableEpochConfig) Set(val *EpochConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableEpochConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableEpochConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEpochConfig(val *EpochConfig) *NullableEpochConfig {
	return &NullableEpochConfig{value: val, isSet: true}
}

func (v NullableEpochConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEpochConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
