...
// checks if the NetworkFunctionChainListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionChainListMetadataOutput{}

// NetworkFunctionChainListMetadataOutput All api calls that return a list will have this metadata block 
...
type _NetworkFunctionChainListMetadataOutput NetworkFunctionChainListMetadataOutput
...
func NewNetworkFunctionChainListMetadataOutput() *NetworkFunctionChainListMetadataOutput {
	this := NetworkFunctionChainListMetadataOutput{}
	var kind string = "network_function_chain"
	this.Kind = &kind
	return &this
}
...
func (o *NetworkFunctionChainListMetadataOutput) SetKind(v string) {
	o.Kind = &v
}
...
func (o *NetworkFunctionChainListMetadataOutput) HasSortAttribute() bool {
	if o != nil && !IsNil(o.SortAttribute) {
		return true
	}
...
func (o NetworkFunctionChainListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionChainListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionChainListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varNetworkFunctionChainListMetadataOutput := _NetworkFunctionChainListMetadataOutput{}

	err = json.Unmarshal(data, &varNetworkFunctionChainListMetadataOutput)

	if err != nil {
		return err
	}

	*o = NetworkFunctionChainListMetadataOutput(varNetworkFunctionChainListMetadataOutput)
...
type NullableNetworkFunctionChainListMetadataOutput struct {
	value *NetworkFunctionChainListMetadataOutput
	isSet bool
}

func (v NullableNetworkFunctionChainListMetadataOutput) Get() *NetworkFunctionChainListMetadataOutput {
	return v.value
}

func (v *NullableNetworkFunctionChainListMetadataOutput) Set(val *NetworkFunctionChainListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionChainListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionChainListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionChainListMetadataOutput(val *NetworkFunctionChainListMetadataOutput) *NullableNetworkFunctionChainListMetadataOutput {
	return &NullableNetworkFunctionChainListMetadataOutput{value: val, isSet: true}
}

func (v NullableNetworkFunctionChainListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionChainListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
