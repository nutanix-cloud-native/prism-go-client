...
// checks if the TriggerInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerInfo{}

// TriggerInfo The information about the triggering.
type TriggerInfo struct {
	ActionTriggerTypeReference ActionTriggerTypeReference `json:"action_trigger_type_reference"`
	// The trigger display name.  Default to trigger type display name. 
	TriggerTypeDisplayName *string `json:"trigger_type_display_name,omitempty" validate:"regexp=^[^&<>'\\/\\"]*$"`
...
func NewTriggerInfo(actionTriggerTypeReference ActionTriggerTypeReference, triggerTime time.Time) *TriggerInfo {
	this := TriggerInfo{}
	this.ActionTriggerTypeReference = actionTriggerTypeReference
...
// GetActionTriggerTypeReference returns the ActionTriggerTypeReference field value
func (o *TriggerInfo) GetActionTriggerTypeReference() ActionTriggerTypeReference {
	if o == nil {
		var ret ActionTriggerTypeReference
		return ret
	}

	return o.ActionTriggerTypeReference
}

// GetActionTriggerTypeReferenceOk returns a tuple with the ActionTriggerTypeReference field value
// and a boolean to check if the value has been set.
func (o *TriggerInfo) GetActionTriggerTypeReferenceOk() (*ActionTriggerTypeReference, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActionTriggerTypeReference, true
}

// SetActionTriggerTypeReference sets field value
func (o *TriggerInfo) SetActionTriggerTypeReference(v ActionTriggerTypeReference) {
	o.ActionTriggerTypeReference = v
}

// GetTriggerTypeDisplayName returns the TriggerTypeDisplayName field value if set, zero value otherwise.
func (o *TriggerInfo) GetTriggerTypeDisplayName() string {
	if o == nil || IsNil(o.TriggerTypeDisplayName) {
		var ret string
		return ret
	}
	return *o.TriggerTypeDisplayName
}

// GetTriggerTypeDisplayNameOk returns a tuple with the TriggerTypeDisplayName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TriggerInfo) GetTriggerTypeDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.TriggerTypeDisplayName) {
		return nil, false
	}
	return o.TriggerTypeDisplayName, true
}
...
// SetTriggerTypeDisplayName gets a reference to the given string and assigns it to the TriggerTypeDisplayName field.
func (o *TriggerInfo) SetTriggerTypeDisplayName(v string) {
	o.TriggerTypeDisplayName = &v
}
...
func (o TriggerInfo) MarshalJSON() ([]byte, error) {
...
func (o TriggerInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["action_trigger_type_reference"] = o.ActionTriggerTypeReference
	if !IsNil(o.TriggerTypeDisplayName) {
		toSerialize["trigger_type_display_name"] = o.TriggerTypeDisplayName
	}
	toSerialize["trigger_time"] = o.TriggerTime
...
func (o *TriggerInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varTriggerInfo := _TriggerInfo{}

	err = json.Unmarshal(data, &varTriggerInfo)

	if err != nil {
		return err
	}

	*o = TriggerInfo(varTriggerInfo)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "action_trigger_type_reference")
		delete(additionalProperties, "trigger_type_display_name")
		delete(additionalProperties, "trigger_time")
...
type NullableTriggerInfo struct {
	value *TriggerInfo
	isSet bool
}

func (v NullableTriggerInfo) Get() *TriggerInfo {
	return v.value
}

func (v *NullableTriggerInfo) Set(val *TriggerInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableTriggerInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableTriggerInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTriggerInfo(val *TriggerInfo) *NullableTriggerInfo {
	return &NullableTriggerInfo{value: val, isSet: true}
}

func (v NullableTriggerInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTriggerInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
