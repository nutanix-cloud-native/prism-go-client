...
// checks if the VmDiskListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDiskListMetadataOutput{}

// VmDiskListMetadataOutput All api calls that return a list will have this metadata block 
...
type _VmDiskListMetadataOutput VmDiskListMetadataOutput
...
func NewVmDiskListMetadataOutput() *VmDiskListMetadataOutput {
	this := VmDiskListMetadataOutput{}
	var kind string = "vm_disk"
	this.Kind = &kind
	return &this
}
...
func (o VmDiskListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o VmDiskListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VmDiskListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varVmDiskListMetadataOutput := _VmDiskListMetadataOutput{}

	err = json.Unmarshal(data, &varVmDiskListMetadataOutput)

	if err != nil {
		return err
	}

	*o = VmDiskListMetadataOutput(varVmDiskListMetadataOutput)
...
type NullableVmDiskListMetadataOutput struct {
	value *VmDiskListMetadataOutput
	isSet bool
}

func (v NullableVmDiskListMetadataOutput) Get() *VmDiskListMetadataOutput {
	return v.value
}

func (v *NullableVmDiskListMetadataOutput) Set(val *VmDiskListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmDiskListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmDiskListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmDiskListMetadataOutput(val *VmDiskListMetadataOutput) *NullableVmDiskListMetadataOutput {
	return &NullableVmDiskListMetadataOutput{value: val, isSet: true}
}

func (v NullableVmDiskListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmDiskListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
