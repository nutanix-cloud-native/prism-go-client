...
// checks if the AccountListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountListMetadata{}

// AccountListMetadata All api calls that return a list will have this metadata block as input 
...
type _AccountListMetadata AccountListMetadata
...
func (o AccountListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AccountListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AccountListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAccountListMetadata := _AccountListMetadata{}

	err = json.Unmarshal(data, &varAccountListMetadata)

	if err != nil {
		return err
	}

	*o = AccountListMetadata(varAccountListMetadata)
...
type NullableAccountListMetadata struct {
	value *AccountListMetadata
	isSet bool
}

func (v NullableAccountListMetadata) Get() *AccountListMetadata {
	return v.value
}

func (v *NullableAccountListMetadata) Set(val *AccountListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountListMetadata(val *AccountListMetadata) *NullableAccountListMetadata {
	return &NullableAccountListMetadata{value: val, isSet: true}
}

func (v NullableAccountListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
