...
// checks if the AwsInstanceDisk type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsInstanceDisk{}

// AwsInstanceDisk AWS Instance Disk
type AwsInstanceDisk struct {
...
type _AwsInstanceDisk AwsInstanceDisk
...
func (o AwsInstanceDisk) MarshalJSON() ([]byte, error) {
...
func (o AwsInstanceDisk) ToMap() (map[string]interface{}, error) {
...
func (o *AwsInstanceDisk) UnmarshalJSON(data []byte) (err error) {
	varAwsInstanceDisk := _AwsInstanceDisk{}

	err = json.Unmarshal(data, &varAwsInstanceDisk)

	if err != nil {
		return err
	}

	*o = AwsInstanceDisk(varAwsInstanceDisk)
...
type NullableAwsInstanceDisk struct {
	value *AwsInstanceDisk
	isSet bool
}

func (v NullableAwsInstanceDisk) Get() *AwsInstanceDisk {
	return v.value
}

func (v *NullableAwsInstanceDisk) Set(val *AwsInstanceDisk) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsInstanceDisk) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsInstanceDisk) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsInstanceDisk(val *AwsInstanceDisk) *NullableAwsInstanceDisk {
	return &NullableAwsInstanceDisk{value: val, isSet: true}
}

func (v NullableAwsInstanceDisk) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsInstanceDisk) UnmarshalJSON(src []byte) error {
	v.isSet = true
