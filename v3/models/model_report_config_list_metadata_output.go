...
// checks if the ReportConfigListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportConfigListMetadataOutput{}

// ReportConfigListMetadataOutput All api calls that return a list will have this metadata block 
type ReportConfigListMetadataOutput struct {
	// The kind name
...
type _ReportConfigListMetadataOutput ReportConfigListMetadataOutput
...
func NewReportConfigListMetadataOutput() *ReportConfigListMetadataOutput {
	this := ReportConfigListMetadataOutput{}
	var kind string = "report_config"
	this.Kind = &kind
	return &this
}
...
func (o ReportConfigListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o ReportConfigListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ReportConfigListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varReportConfigListMetadataOutput := _ReportConfigListMetadataOutput{}

	err = json.Unmarshal(data, &varReportConfigListMetadataOutput)

	if err != nil {
		return err
	}

	*o = ReportConfigListMetadataOutput(varReportConfigListMetadataOutput)
...
type NullableReportConfigListMetadataOutput struct {
	value *ReportConfigListMetadataOutput
	isSet bool
}

func (v NullableReportConfigListMetadataOutput) Get() *ReportConfigListMetadataOutput {
	return v.value
}

func (v *NullableReportConfigListMetadataOutput) Set(val *ReportConfigListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableReportConfigListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableReportConfigListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportConfigListMetadataOutput(val *ReportConfigListMetadataOutput) *NullableReportConfigListMetadataOutput {
	return &NullableReportConfigListMetadataOutput{value: val, isSet: true}
}

func (v NullableReportConfigListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportConfigListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
