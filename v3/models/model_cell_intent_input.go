...
// checks if the CellIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CellIntentInput{}

// CellIntentInput An intentful representation of a cell
type CellIntentInput struct {
	Spec Cell `json:"spec"`
...
type _CellIntentInput CellIntentInput
...
func (o CellIntentInput) MarshalJSON() ([]byte, error) {
...
func (o CellIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *CellIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCellIntentInput := _CellIntentInput{}

	err = json.Unmarshal(data, &varCellIntentInput)

	if err != nil {
		return err
	}

	*o = CellIntentInput(varCellIntentInput)
...
type NullableCellIntentInput struct {
	value *CellIntentInput
	isSet bool
}

func (v NullableCellIntentInput) Get() *CellIntentInput {
	return v.value
}

func (v *NullableCellIntentInput) Set(val *CellIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCellIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCellIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCellIntentInput(val *CellIntentInput) *NullableCellIntentInput {
	return &NullableCellIntentInput{value: val, isSet: true}
}

func (v NullableCellIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCellIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
