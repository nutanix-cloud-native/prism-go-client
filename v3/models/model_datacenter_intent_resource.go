...
// checks if the DatacenterIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterIntentResource{}

// DatacenterIntentResource Response object for intentful operations on a datacenter
type DatacenterIntentResource struct {
	Status *DatacenterDefStatus `json:"status,omitempty"`
	Spec *Datacenter `json:"spec,omitempty"`
...
type _DatacenterIntentResource DatacenterIntentResource
...
// SetStatus gets a reference to the given DatacenterDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given Datacenter and assigns it to the Spec field.
...
func (o DatacenterIntentResource) MarshalJSON() ([]byte, error) {
...
func (o DatacenterIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *DatacenterIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varDatacenterIntentResource := _DatacenterIntentResource{}

	err = json.Unmarshal(data, &varDatacenterIntentResource)

	if err != nil {
		return err
	}

	*o = DatacenterIntentResource(varDatacenterIntentResource)
...
type NullableDatacenterIntentResource struct {
	value *DatacenterIntentResource
	isSet bool
}

func (v NullableDatacenterIntentResource) Get() *DatacenterIntentResource {
	return v.value
}

func (v *NullableDatacenterIntentResource) Set(val *DatacenterIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterIntentResource(val *DatacenterIntentResource) *NullableDatacenterIntentResource {
	return &NullableDatacenterIntentResource{value: val, isSet: true}
}

func (v NullableDatacenterIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
