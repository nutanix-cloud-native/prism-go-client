...
// checks if the ProjectDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectDefStatus{}

// ProjectDefStatus A Project resource.
type ProjectDefStatus struct {
	...
	Resources ProjectResources2 `json:"resources"`
	// Project description.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ProjectDefStatus ProjectDefStatus
...
func (o ProjectDefStatus) MarshalJSON() ([]byte, error) {
...
func (o ProjectDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectDefStatus := _ProjectDefStatus{}

	err = json.Unmarshal(data, &varProjectDefStatus)

	if err != nil {
		return err
	}

	*o = ProjectDefStatus(varProjectDefStatus)
...
type NullableProjectDefStatus struct {
	value *ProjectDefStatus
	isSet bool
}

func (v NullableProjectDefStatus) Get() *ProjectDefStatus {
	return v.value
}

func (v *NullableProjectDefStatus) Set(val *ProjectDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectDefStatus(val *ProjectDefStatus) *NullableProjectDefStatus {
	return &NullableProjectDefStatus{value: val, isSet: true}
}

func (v NullableProjectDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
