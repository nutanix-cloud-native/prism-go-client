...
// checks if the OplogUsage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OplogUsage{}

// OplogUsage oplog disk usage.
...
// GetOplogDiskPct returns the OplogDiskPct field value if set, zero value otherwise.
func (o *OplogUsage) GetOplogDiskPct() float32 {
	if o == nil || IsNil(o.OplogDiskPct) {
		var ret float32
		return ret
	}
	return *o.OplogDiskPct
}

// GetOplogDiskPctOk returns a tuple with the OplogDiskPct field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OplogUsage) GetOplogDiskPctOk() (*float32, bool) {
	if o == nil || IsNil(o.OplogDiskPct) {
		return nil, false
	}
	return o.OplogDiskPct, true
}
...
// SetOplogDiskPct gets a reference to the given float32 and assigns it to the OplogDiskPct field.
func (o *OplogUsage) SetOplogDiskPct(v float32) {
	o.OplogDiskPct = &v
}

// GetOplogDiskSize returns the OplogDiskSize field value if set, zero value otherwise.
func (o *OplogUsage) GetOplogDiskSize() int64 {
	if o == nil || IsNil(o.OplogDiskSize) {
		var ret int64
		return ret
	}
	return *o.OplogDiskSize
}

// GetOplogDiskSizeOk returns a tuple with the OplogDiskSize field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OplogUsage) GetOplogDiskSizeOk() (*int64, bool) {
	if o == nil || IsNil(o.OplogDiskSize) {
		return nil, false
	}
	return o.OplogDiskSize, true
}
...
// SetOplogDiskSize gets a reference to the given int64 and assigns it to the OplogDiskSize field.
func (o *OplogUsage) SetOplogDiskSize(v int64) {
	o.OplogDiskSize = &v
}

func (o OplogUsage) MarshalJSON() ([]byte, error) {
...
func (o OplogUsage) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.OplogDiskPct) {
		toSerialize["oplog_disk_pct"] = o.OplogDiskPct
	}
	if !IsNil(o.OplogDiskSize) {
		toSerialize["oplog_disk_size"] = o.OplogDiskSize
	}
...
func (o *OplogUsage) UnmarshalJSON(data []byte) (err error) {
	varOplogUsage := _OplogUsage{}

	err = json.Unmarshal(data, &varOplogUsage)

	if err != nil {
		return err
	}

	*o = OplogUsage(varOplogUsage)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "oplog_disk_pct")
		delete(additionalProperties, "oplog_disk_size")
...
type NullableOplogUsage struct {
	value *OplogUsage
	isSet bool
}

func (v NullableOplogUsage) Get() *OplogUsage {
	return v.value
}

func (v *NullableOplogUsage) Set(val *OplogUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableOplogUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableOplogUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOplogUsage(val *OplogUsage) *NullableOplogUsage {
	return &NullableOplogUsage{value: val, isSet: true}
}

func (v NullableOplogUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOplogUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
