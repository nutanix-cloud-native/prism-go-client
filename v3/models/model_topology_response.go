...
type TopologyResponse struct {
	// List containing vertices information in the topology visualization in Security Monitoring. 
	VertexList []Vertex `json:"vertex_list,omitempty"`
	// List containing edges information in the topology visualization in Security Monitoring. 
	EdgeList []Edge `json:"edge_list,omitempty"`
...
// GetVertexList returns the VertexList field value if set, zero value otherwise.
func (o *TopologyResponse) GetVertexList() []Vertex {
	if o == nil || IsNil(o.VertexList) {
		var ret []Vertex
		return ret
	}
	return o.VertexList
...
// GetVertexListOk returns a tuple with the VertexList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TopologyResponse) GetVertexListOk() ([]Vertex, bool) {
	if o == nil || IsNil(o.VertexList) {
		return nil, false
	}
	return o.VertexList, true
}
...
// SetVertexList gets a reference to the given []Vertex and assigns it to the VertexList field.
func (o *TopologyResponse) SetVertexList(v []Vertex) {
	o.VertexList = v
}

// GetEdgeList returns the EdgeList field value if set, zero value otherwise.
func (o *TopologyResponse) GetEdgeList() []Edge {
	if o == nil || IsNil(o.EdgeList) {
		var ret []Edge
		return ret
	}
	return o.EdgeList
...
// GetEdgeListOk returns a tuple with the EdgeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TopologyResponse) GetEdgeListOk() ([]Edge, bool) {
	if o == nil || IsNil(o.EdgeList) {
		return nil, false
	}
	return o.EdgeList, true
}
...
// SetEdgeList gets a reference to the given []Edge and assigns it to the EdgeList field.
...
func (o TopologyResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.VertexList) {
		toSerialize["vertex_list"] = o.VertexList
	}
	if !IsNil(o.EdgeList) {
		toSerialize["edge_list"] = o.EdgeList
	}
...
func (o *TopologyResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTopologyResponse)
	...
	*o = TopologyResponse(varTopologyResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vertex_list")
		delete(additionalProperties, "edge_list")
