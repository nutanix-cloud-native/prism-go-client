...
// checks if the RecoveryPlanJobDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobDefStatus{}

// RecoveryPlanJobDefStatus Recovery Plan Job status.
type RecoveryPlanJobDefStatus struct {
	ValidationInformation *RecoveryPlanJobDefStatusValidationInformation `json:"validation_information,omitempty"`
	// Recovery Plan Job name.
	Name string `json:"name"`
	CleanupStatus *RecoveryPlanJobExecutionPhasesStatus `json:"cleanup_status,omitempty"`
	// Time when the Recovery Plan Job was created.
	StartTime *time.Time `json:"start_time,omitempty"`
	ExecutionStatus *RecoveryPlanJobExecutionPhasesStatus `json:"execution_status,omitempty"`
	RecoveryPlanSpecification *RecoveryPlanJobDefStatusRecoveryPlanSpecification `json:"recovery_plan_specification,omitempty"`
	ParentRecoveryPlanJobReference *RecoveryPlanJobReference `json:"parent_recovery_plan_job_reference,omitempty"`
	// Time when the Recovery Plan Job execution ended.
	EndTime *time.Time `json:"end_time,omitempty"`
	RootRecoveryPlanJobReference *RecoveryPlanJobReference `json:"root_recovery_plan_job_reference,omitempty"`
	// Address of the witness, which has triggered this Recovery Plan Job. This will be same as Availability Zone URL, on which witness is deployed. 
	WitnessAddress *string `json:"witness_address,omitempty"`
	Resources RecoveryPlanJobResources `json:"resources"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanJobDefStatus RecoveryPlanJobDefStatus
...
func (o *RecoveryPlanJobDefStatus) GetValidationInformation() RecoveryPlanJobDefStatusValidationInformation {
	if o == nil || IsNil(o.ValidationInformation) {
		var ret RecoveryPlanJobDefStatusValidationInformation
		return ret
	}
...
// SetValidationInformation gets a reference to the given RecoveryPlanJobDefStatusValidationInformation and assigns it to the ValidationInformation field.
...
// GetCleanupStatus returns the CleanupStatus field value if set, zero value otherwise.
func (o *RecoveryPlanJobDefStatus) GetCleanupStatus() RecoveryPlanJobExecutionPhasesStatus {
	if o == nil || IsNil(o.CleanupStatus) {
		var ret RecoveryPlanJobExecutionPhasesStatus
		return ret
	}
	return *o.CleanupStatus
}

// GetCleanupStatusOk returns a tuple with the CleanupStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobDefStatus) GetCleanupStatusOk() (*RecoveryPlanJobExecutionPhasesStatus, bool) {
	if o == nil || IsNil(o.CleanupStatus) {
		return nil, false
	}
	return o.CleanupStatus, true
}
...
// SetCleanupStatus gets a reference to the given RecoveryPlanJobExecutionPhasesStatus and assigns it to the CleanupStatus field.
...
// SetExecutionStatus gets a reference to the given RecoveryPlanJobExecutionPhasesStatus and assigns it to the ExecutionStatus field.
func (o *RecoveryPlanJobDefStatus) SetExecutionStatus(v RecoveryPlanJobExecutionPhasesStatus) {
	o.ExecutionStatus = &v
}

// GetRecoveryPlanSpecification returns the RecoveryPlanSpecification field value if set, zero value otherwise.
func (o *RecoveryPlanJobDefStatus) GetRecoveryPlanSpecification() RecoveryPlanJobDefStatusRecoveryPlanSpecification {
	if o == nil || IsNil(o.RecoveryPlanSpecification) {
		var ret RecoveryPlanJobDefStatusRecoveryPlanSpecification
		return ret
	}
	return *o.RecoveryPlanSpecification
}

// GetRecoveryPlanSpecificationOk returns a tuple with the RecoveryPlanSpecification field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobDefStatus) GetRecoveryPlanSpecificationOk() (*RecoveryPlanJobDefStatusRecoveryPlanSpecification, bool) {
	if o == nil || IsNil(o.RecoveryPlanSpecification) {
		return nil, false
	}
	return o.RecoveryPlanSpecification, true
}
...
// SetRecoveryPlanSpecification gets a reference to the given RecoveryPlanJobDefStatusRecoveryPlanSpecification and assigns it to the RecoveryPlanSpecification field.
func (o *RecoveryPlanJobDefStatus) SetRecoveryPlanSpecification(v RecoveryPlanJobDefStatusRecoveryPlanSpecification) {
	o.RecoveryPlanSpecification = &v
}

// GetParentRecoveryPlanJobReference returns the ParentRecoveryPlanJobReference field value if set, zero value otherwise.
func (o *RecoveryPlanJobDefStatus) GetParentRecoveryPlanJobReference() RecoveryPlanJobReference {
	if o == nil || IsNil(o.ParentRecoveryPlanJobReference) {
		var ret RecoveryPlanJobReference
		return ret
	}
	return *o.ParentRecoveryPlanJobReference
}

// GetParentRecoveryPlanJobReferenceOk returns a tuple with the ParentRecoveryPlanJobReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobDefStatus) GetParentRecoveryPlanJobReferenceOk() (*RecoveryPlanJobReference, bool) {
	if o == nil || IsNil(o.ParentRecoveryPlanJobReference) {
		return nil, false
	}
	return o.ParentRecoveryPlanJobReference, true
}
...
// SetParentRecoveryPlanJobReference gets a reference to the given RecoveryPlanJobReference and assigns it to the ParentRecoveryPlanJobReference field.
func (o *RecoveryPlanJobDefStatus) SetParentRecoveryPlanJobReference(v RecoveryPlanJobReference) {
	o.ParentRecoveryPlanJobReference = &v
}
...
// GetRootRecoveryPlanJobReference returns the RootRecoveryPlanJobReference field value if set, zero value otherwise.
func (o *RecoveryPlanJobDefStatus) GetRootRecoveryPlanJobReference() RecoveryPlanJobReference {
	if o == nil || IsNil(o.RootRecoveryPlanJobReference) {
		var ret RecoveryPlanJobReference
		return ret
	}
	return *o.RootRecoveryPlanJobReference
}

// GetRootRecoveryPlanJobReferenceOk returns a tuple with the RootRecoveryPlanJobReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobDefStatus) GetRootRecoveryPlanJobReferenceOk() (*RecoveryPlanJobReference, bool) {
	if o == nil || IsNil(o.RootRecoveryPlanJobReference) {
		return nil, false
	}
	return o.RootRecoveryPlanJobReference, true
}
...
// SetRootRecoveryPlanJobReference gets a reference to the given RecoveryPlanJobReference and assigns it to the RootRecoveryPlanJobReference field.
func (o *RecoveryPlanJobDefStatus) SetRootRecoveryPlanJobReference(v RecoveryPlanJobReference) {
	o.RootRecoveryPlanJobReference = &v
}

// GetWitnessAddress returns the WitnessAddress field value if set, zero value otherwise.
func (o *RecoveryPlanJobDefStatus) GetWitnessAddress() string {
	if o == nil || IsNil(o.WitnessAddress) {
		var ret string
		return ret
	}
	return *o.WitnessAddress
}

// GetWitnessAddressOk returns a tuple with the WitnessAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanJobDefStatus) GetWitnessAddressOk() (*string, bool) {
	if o == nil || IsNil(o.WitnessAddress) {
		return nil, false
	}
	return o.WitnessAddress, true
}
...
// SetWitnessAddress gets a reference to the given string and assigns it to the WitnessAddress field.
...
func (o *RecoveryPlanJobDefStatus) GetResources() RecoveryPlanJobResources {
	if o == nil {
		var ret RecoveryPlanJobResources
		return ret
	}
...
func (o RecoveryPlanJobDefStatus) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ValidationInformation) {
		toSerialize["validation_information"] = o.ValidationInformation
	}
	toSerialize["name"] = o.Name
	if !IsNil(o.CleanupStatus) {
		toSerialize["cleanup_status"] = o.CleanupStatus
	}
	...
	if !IsNil(o.RecoveryPlanSpecification) {
		toSerialize["recovery_plan_specification"] = o.RecoveryPlanSpecification
	}
	if !IsNil(o.ParentRecoveryPlanJobReference) {
		toSerialize["parent_recovery_plan_job_reference"] = o.ParentRecoveryPlanJobReference
	}
	if !IsNil(o.EndTime) {
		toSerialize["end_time"] = o.EndTime
	}
	if !IsNil(o.RootRecoveryPlanJobReference) {
		toSerialize["root_recovery_plan_job_reference"] = o.RootRecoveryPlanJobReference
	}
	if !IsNil(o.WitnessAddress) {
		toSerialize["witness_address"] = o.WitnessAddress
	}
...
func (o *RecoveryPlanJobDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobDefStatus := _RecoveryPlanJobDefStatus{}

	err = json.Unmarshal(data, &varRecoveryPlanJobDefStatus)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobDefStatus(varRecoveryPlanJobDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "validation_information")
		delete(additionalProperties, "name")
		delete(additionalProperties, "cleanup_status")
		delete(additionalProperties, "start_time")
		delete(additionalProperties, "execution_status")
		delete(additionalProperties, "recovery_plan_specification")
		delete(additionalProperties, "parent_recovery_plan_job_reference")
		delete(additionalProperties, "end_time")
		delete(additionalProperties, "root_recovery_plan_job_reference")
		delete(additionalProperties, "witness_address")
...
type NullableRecoveryPlanJobDefStatus struct {
	value *RecoveryPlanJobDefStatus
	isSet bool
}

func (v NullableRecoveryPlanJobDefStatus) Get() *RecoveryPlanJobDefStatus {
	return v.value
}

func (v *NullableRecoveryPlanJobDefStatus) Set(val *RecoveryPlanJobDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobDefStatus(val *RecoveryPlanJobDefStatus) *NullableRecoveryPlanJobDefStatus {
	return &NullableRecoveryPlanJobDefStatus{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
