...
// checks if the OauthClientListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthClientListMetadataOutput{}

// OauthClientListMetadataOutput All api calls that return a list will have this metadata block 
type OauthClientListMetadataOutput struct {
	// The kind name
...
type _OauthClientListMetadataOutput OauthClientListMetadataOutput
...
func NewOauthClientListMetadataOutput() *OauthClientListMetadataOutput {
	this := OauthClientListMetadataOutput{}
	var kind string = "oauth_client"
	this.Kind = &kind
	return &this
}
...
func (o OauthClientListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o OauthClientListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *OauthClientListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varOauthClientListMetadataOutput := _OauthClientListMetadataOutput{}

	err = json.Unmarshal(data, &varOauthClientListMetadataOutput)

	if err != nil {
		return err
	}

	*o = OauthClientListMetadataOutput(varOauthClientListMetadataOutput)
...
type NullableOauthClientListMetadataOutput struct {
	value *OauthClientListMetadataOutput
	isSet bool
}

func (v NullableOauthClientListMetadataOutput) Get() *OauthClientListMetadataOutput {
	return v.value
}

func (v *NullableOauthClientListMetadataOutput) Set(val *OauthClientListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthClientListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthClientListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthClientListMetadataOutput(val *OauthClientListMetadataOutput) *NullableOauthClientListMetadataOutput {
	return &NullableOauthClientListMetadataOutput{value: val, isSet: true}
}

func (v NullableOauthClientListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthClientListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
