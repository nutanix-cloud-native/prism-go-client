...
// checks if the RecoveryPlanValidationMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanValidationMessage{}

// RecoveryPlanValidationMessage Validation message used to report Recovery Plan errors and warnings. 
type RecoveryPlanValidationMessage struct {
	// Message describing validation error or warning.
	Message string `json:"message"`
	// Type of validation.
	ValidationType string `json:"validation_type"`
	// List of affected entities for this validation message.
	AffectedAnyReferenceList []Reference `json:"affected_any_reference_list,omitempty"`
	// Impact of the validation message on the Recovery Plan actions. 
	ImpactMessageList []string `json:"impact_message_list,omitempty"`
	// List of causes and resolutions for the validation warning or error. 
	CauseAndResolutionMessageList []RecoveryPlanValidationMessageCauseAndResolutionMessageListInner `json:"cause_and_resolution_message_list,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanValidationMessage RecoveryPlanValidationMessage
...
func NewRecoveryPlanValidationMessage(message string, validationType string) *RecoveryPlanValidationMessage {
	this := RecoveryPlanValidationMessage{}
...
// GetAffectedAnyReferenceList returns the AffectedAnyReferenceList field value if set, zero value otherwise.
func (o *RecoveryPlanValidationMessage) GetAffectedAnyReferenceList() []Reference {
	if o == nil || IsNil(o.AffectedAnyReferenceList) {
		var ret []Reference
		return ret
	}
	return o.AffectedAnyReferenceList
}

// GetAffectedAnyReferenceListOk returns a tuple with the AffectedAnyReferenceList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanValidationMessage) GetAffectedAnyReferenceListOk() ([]Reference, bool) {
	if o == nil || IsNil(o.AffectedAnyReferenceList) {
		return nil, false
	}
	return o.AffectedAnyReferenceList, true
}
...
// SetAffectedAnyReferenceList gets a reference to the given []Reference and assigns it to the AffectedAnyReferenceList field.
func (o *RecoveryPlanValidationMessage) SetAffectedAnyReferenceList(v []Reference) {
	o.AffectedAnyReferenceList = v
}

// GetImpactMessageList returns the ImpactMessageList field value if set, zero value otherwise.
func (o *RecoveryPlanValidationMessage) GetImpactMessageList() []string {
	if o == nil || IsNil(o.ImpactMessageList) {
		var ret []string
		return ret
	}
	return o.ImpactMessageList
}

// GetImpactMessageListOk returns a tuple with the ImpactMessageList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanValidationMessage) GetImpactMessageListOk() ([]string, bool) {
	if o == nil || IsNil(o.ImpactMessageList) {
		return nil, false
	}
	return o.ImpactMessageList, true
}
...
// SetImpactMessageList gets a reference to the given []string and assigns it to the ImpactMessageList field.
func (o *RecoveryPlanValidationMessage) SetImpactMessageList(v []string) {
	o.ImpactMessageList = v
}

// GetCauseAndResolutionMessageList returns the CauseAndResolutionMessageList field value if set, zero value otherwise.
func (o *RecoveryPlanValidationMessage) GetCauseAndResolutionMessageList() []RecoveryPlanValidationMessageCauseAndResolutionMessageListInner {
	if o == nil || IsNil(o.CauseAndResolutionMessageList) {
		var ret []RecoveryPlanValidationMessageCauseAndResolutionMessageListInner
		return ret
	}
	return o.CauseAndResolutionMessageList
}

// GetCauseAndResolutionMessageListOk returns a tuple with the CauseAndResolutionMessageList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoveryPlanValidationMessage) GetCauseAndResolutionMessageListOk() ([]RecoveryPlanValidationMessageCauseAndResolutionMessageListInner, bool) {
	...
	return o.CauseAndResolutionMessageList, true
}
...
// SetCauseAndResolutionMessageList gets a reference to the given []RecoveryPlanValidationMessageCauseAndResolutionMessageListInner and assigns it to the CauseAndResolutionMessageList field.
func (o *RecoveryPlanValidationMessage) SetCauseAndResolutionMessageList(v []RecoveryPlanValidationMessageCauseAndResolutionMessageListInner) {
	o.CauseAndResolutionMessageList = v
}

func (o RecoveryPlanValidationMessage) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanValidationMessage) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["message"] = o.Message
	toSerialize["validation_type"] = o.ValidationType
	if !IsNil(o.AffectedAnyReferenceList) {
		toSerialize["affected_any_reference_list"] = o.AffectedAnyReferenceList
	}
	if !IsNil(o.ImpactMessageList) {
		toSerialize["impact_message_list"] = o.ImpactMessageList
	}
	if !IsNil(o.CauseAndResolutionMessageList) {
		toSerialize["cause_and_resolution_message_list"] = o.CauseAndResolutionMessageList
	}
...
func (o *RecoveryPlanValidationMessage) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanValidationMessage := _RecoveryPlanValidationMessage{}

	err = json.Unmarshal(data, &varRecoveryPlanValidationMessage)

	if err != nil {
		return err
	}

	*o = RecoveryPlanValidationMessage(varRecoveryPlanValidationMessage)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "message")
		delete(additionalProperties, "validation_type")
		delete(additionalProperties, "affected_any_reference_list")
		delete(additionalProperties, "impact_message_list")
		delete(additionalProperties, "cause_and_resolution_message_list")
...
type NullableRecoveryPlanValidationMessage struct {
	value *RecoveryPlanValidationMessage
	isSet bool
}

func (v NullableRecoveryPlanValidationMessage) Get() *RecoveryPlanValidationMessage {
	return v.value
}

func (v *NullableRecoveryPlanValidationMessage) Set(val *RecoveryPlanValidationMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanValidationMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanValidationMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanValidationMessage(val *RecoveryPlanValidationMessage) *NullableRecoveryPlanValidationMessage {
	return &NullableRecoveryPlanValidationMessage{value: val, isSet: true}
}

func (v NullableRecoveryPlanValidationMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanValidationMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
