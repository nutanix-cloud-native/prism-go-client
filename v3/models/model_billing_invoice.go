...
// BillingInvoice Invoice generated for a billing duration.
type BillingInvoice struct {
	...
	InvoiceTargetDate *string `json:"invoice_target_date,omitempty"`
	...
	Balance *MonetaryValue `json:"balance,omitempty"`
...
// GetInvoiceTargetDate returns the InvoiceTargetDate field value if set, zero value otherwise.
func (o *BillingInvoice) GetInvoiceTargetDate() string {
	if o == nil || IsNil(o.InvoiceTargetDate) {
		var ret string
		return ret
	}
	return *o.InvoiceTargetDate
}

// GetInvoiceTargetDateOk returns a tuple with the InvoiceTargetDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BillingInvoice) GetInvoiceTargetDateOk() (*string, bool) {
	if o == nil || IsNil(o.InvoiceTargetDate) {
		return nil, false
	}
	return o.InvoiceTargetDate, true
}
...
// SetInvoiceTargetDate gets a reference to the given string and assigns it to the InvoiceTargetDate field.
func (o *BillingInvoice) SetInvoiceTargetDate(v string) {
	o.InvoiceTargetDate = &v
}
...
// SetAmount gets a reference to the given MonetaryValue and assigns it to the Amount field.
...
// SetBalance gets a reference to the given MonetaryValue and assigns it to the Balance field.
...
func (o BillingInvoice) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InvoiceTargetDate) {
		toSerialize["invoice_target_date"] = o.InvoiceTargetDate
	}
...
func (o *BillingInvoice) UnmarshalJSON(data []byte) (err error) {
	...
	*o = BillingInvoice(varBillingInvoice)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "invoice_target_date")
