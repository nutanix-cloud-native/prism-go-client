...
// checks if the AwsSubnetIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSubnetIntentResource{}

// AwsSubnetIntentResource aws_subnet entity
type AwsSubnetIntentResource struct {
	Status *AwsSubnetDefStatus `json:"status,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AwsSubnetMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AwsSubnetIntentResource AwsSubnetIntentResource
...
// SetStatus gets a reference to the given AwsSubnetDefStatus and assigns it to the Status field.
...
func (o AwsSubnetIntentResource) MarshalJSON() ([]byte, error) {
...
func (o AwsSubnetIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *AwsSubnetIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsSubnetIntentResource := _AwsSubnetIntentResource{}

	err = json.Unmarshal(data, &varAwsSubnetIntentResource)

	if err != nil {
		return err
	}

	*o = AwsSubnetIntentResource(varAwsSubnetIntentResource)
...
type NullableAwsSubnetIntentResource struct {
	value *AwsSubnetIntentResource
	isSet bool
}

func (v NullableAwsSubnetIntentResource) Get() *AwsSubnetIntentResource {
	return v.value
}

func (v *NullableAwsSubnetIntentResource) Set(val *AwsSubnetIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsSubnetIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsSubnetIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsSubnetIntentResource(val *AwsSubnetIntentResource) *NullableAwsSubnetIntentResource {
	return &NullableAwsSubnetIntentResource{value: val, isSet: true}
}

func (v NullableAwsSubnetIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsSubnetIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
