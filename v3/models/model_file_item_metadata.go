...
// checks if the FileItemMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileItemMetadata{}

// FileItemMetadata The file_item kind metadata
type FileItemMetadata struct {
	...
	// Categories for the file_item. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the file_item. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _FileItemMetadata FileItemMetadata
...
func (o *FileItemMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *FileItemMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *FileItemMetadata) SetName(v string) {
	o.Name = &v
}

func (o FileItemMetadata) MarshalJSON() ([]byte, error) {
...
func (o FileItemMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *FileItemMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varFileItemMetadata := _FileItemMetadata{}

	err = json.Unmarshal(data, &varFileItemMetadata)

	if err != nil {
		return err
	}

	*o = FileItemMetadata(varFileItemMetadata)
...
type NullableFileItemMetadata struct {
	value *FileItemMetadata
	isSet bool
}

func (v NullableFileItemMetadata) Get() *FileItemMetadata {
	return v.value
}

func (v *NullableFileItemMetadata) Set(val *FileItemMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableFileItemMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableFileItemMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileItemMetadata(val *FileItemMetadata) *NullableFileItemMetadata {
	return &NullableFileItemMetadata{value: val, isSet: true}
}

func (v NullableFileItemMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileItemMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
