...
// Token Token object definition. This holds the Interpretation of a query term. 
type Token struct {
	DisplayContext *Expression `json:"display_context,omitempty"`
	Identifier *Expression `json:"identifier,omitempty"`
	// Match type of the query term (e.g. exact, prefix).
	MatchType *string `json:"match_type,omitempty"`
	// An indication whether the token is a child entity type.
	IsChildEntityType *bool `json:"is_child_entity_type,omitempty"`
	// Any additional information we have about the token.
	AdditionalContext []Expression `json:"additional_context,omitempty"`
...
// GetDisplayContext returns the DisplayContext field value if set, zero value otherwise.
func (o *Token) GetDisplayContext() Expression {
	if o == nil || IsNil(o.DisplayContext) {
		var ret Expression
		return ret
	}
	return *o.DisplayContext
}

// GetDisplayContextOk returns a tuple with the DisplayContext field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Token) GetDisplayContextOk() (*Expression, bool) {
	if o == nil || IsNil(o.DisplayContext) {
		return nil, false
	}
	return o.DisplayContext, true
}
...
// SetDisplayContext gets a reference to the given Expression and assigns it to the DisplayContext field.
...
// SetIdentifier gets a reference to the given Expression and assigns it to the Identifier field.
...
// GetIsChildEntityType returns the IsChildEntityType field value if set, zero value otherwise.
func (o *Token) GetIsChildEntityType() bool {
	if o == nil || IsNil(o.IsChildEntityType) {
		var ret bool
		return ret
	}
	return *o.IsChildEntityType
}

// GetIsChildEntityTypeOk returns a tuple with the IsChildEntityType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Token) GetIsChildEntityTypeOk() (*bool, bool) {
	if o == nil || IsNil(o.IsChildEntityType) {
		return nil, false
	}
	return o.IsChildEntityType, true
}
...
// SetIsChildEntityType gets a reference to the given bool and assigns it to the IsChildEntityType field.
func (o *Token) SetIsChildEntityType(v bool) {
	o.IsChildEntityType = &v
}
...
// SetAdditionalContext gets a reference to the given []Expression and assigns it to the AdditionalContext field.
...
func (o Token) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DisplayContext) {
		toSerialize["display_context"] = o.DisplayContext
	}
	...
	if !IsNil(o.IsChildEntityType) {
		toSerialize["is_child_entity_type"] = o.IsChildEntityType
	}
	if !IsNil(o.AdditionalContext) {
		toSerialize["additional_context"] = o.AdditionalContext
	}
...
func (o *Token) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Token(varToken)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "display_context")
		delete(additionalProperties, "identifier")
		delete(additionalProperties, "match_type")
		delete(additionalProperties, "is_child_entity_type")
		delete(additionalProperties, "additional_context")
