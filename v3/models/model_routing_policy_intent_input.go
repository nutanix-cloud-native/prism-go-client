...
// checks if the RoutingPolicyIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyIntentInput{}

// RoutingPolicyIntentInput An intentful representation of a routing_policy
type RoutingPolicyIntentInput struct {
	Spec RoutingPolicy `json:"spec"`
...
type _RoutingPolicyIntentInput RoutingPolicyIntentInput
...
func (o RoutingPolicyIntentInput) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingPolicyIntentInput := _RoutingPolicyIntentInput{}

	err = json.Unmarshal(data, &varRoutingPolicyIntentInput)

	if err != nil {
		return err
	}

	*o = RoutingPolicyIntentInput(varRoutingPolicyIntentInput)
...
type NullableRoutingPolicyIntentInput struct {
	value *RoutingPolicyIntentInput
	isSet bool
}

func (v NullableRoutingPolicyIntentInput) Get() *RoutingPolicyIntentInput {
	return v.value
}

func (v *NullableRoutingPolicyIntentInput) Set(val *RoutingPolicyIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyIntentInput(val *RoutingPolicyIntentInput) *NullableRoutingPolicyIntentInput {
	return &NullableRoutingPolicyIntentInput{value: val, isSet: true}
}

func (v NullableRoutingPolicyIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
