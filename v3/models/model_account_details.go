...
// AccountDetails Billing account information of a user.
type AccountDetails struct {
	// Status of the account indicating if it is active or not.
	Status *string `json:"status,omitempty"`
	MinimumChargeAmount *MonetaryValue `json:"minimum_charge_amount,omitempty"`
	PrepaidAmount *MonetaryValue `json:"prepaid_amount,omitempty"`
	// Date on which current subscription plan ends.
	SubscriptionExpiryDate *string `json:"subscription_expiry_date,omitempty"`
	// Date on which next invoice will be generated.
	NextInvoiceDate *string `json:"next_invoice_date,omitempty"`
	// Number associated with the account.
	AccountNumber *string `json:"account_number,omitempty"`
	// Name of the plan that user has subscribed to.
...
// GetMinimumChargeAmount returns the MinimumChargeAmount field value if set, zero value otherwise.
func (o *AccountDetails) GetMinimumChargeAmount() MonetaryValue {
	if o == nil || IsNil(o.MinimumChargeAmount) {
		var ret MonetaryValue
		return ret
	}
	return *o.MinimumChargeAmount
}

// GetMinimumChargeAmountOk returns a tuple with the MinimumChargeAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AccountDetails) GetMinimumChargeAmountOk() (*MonetaryValue, bool) {
	if o == nil || IsNil(o.MinimumChargeAmount) {
		return nil, false
	}
	return o.MinimumChargeAmount, true
}
...
// SetMinimumChargeAmount gets a reference to the given MonetaryValue and assigns it to the MinimumChargeAmount field.
func (o *AccountDetails) SetMinimumChargeAmount(v MonetaryValue) {
	o.MinimumChargeAmount = &v
}

// GetPrepaidAmount returns the PrepaidAmount field value if set, zero value otherwise.
func (o *AccountDetails) GetPrepaidAmount() MonetaryValue {
	if o == nil || IsNil(o.PrepaidAmount) {
		var ret MonetaryValue
		return ret
	}
	return *o.PrepaidAmount
}

// GetPrepaidAmountOk returns a tuple with the PrepaidAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AccountDetails) GetPrepaidAmountOk() (*MonetaryValue, bool) {
	if o == nil || IsNil(o.PrepaidAmount) {
		return nil, false
	}
	return o.PrepaidAmount, true
}
...
// SetPrepaidAmount gets a reference to the given MonetaryValue and assigns it to the PrepaidAmount field.
func (o *AccountDetails) SetPrepaidAmount(v MonetaryValue) {
	o.PrepaidAmount = &v
}

// GetSubscriptionExpiryDate returns the SubscriptionExpiryDate field value if set, zero value otherwise.
func (o *AccountDetails) GetSubscriptionExpiryDate() string {
	if o == nil || IsNil(o.SubscriptionExpiryDate) {
		var ret string
		return ret
	}
	return *o.SubscriptionExpiryDate
}

// GetSubscriptionExpiryDateOk returns a tuple with the SubscriptionExpiryDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AccountDetails) GetSubscriptionExpiryDateOk() (*string, bool) {
	if o == nil || IsNil(o.SubscriptionExpiryDate) {
		return nil, false
	}
	return o.SubscriptionExpiryDate, true
}
...
// SetSubscriptionExpiryDate gets a reference to the given string and assigns it to the SubscriptionExpiryDate field.
func (o *AccountDetails) SetSubscriptionExpiryDate(v string) {
	o.SubscriptionExpiryDate = &v
}
...
func (o AccountDetails) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MinimumChargeAmount) {
		toSerialize["minimum_charge_amount"] = o.MinimumChargeAmount
	}
	if !IsNil(o.PrepaidAmount) {
		toSerialize["prepaid_amount"] = o.PrepaidAmount
	}
	if !IsNil(o.SubscriptionExpiryDate) {
		toSerialize["subscription_expiry_date"] = o.SubscriptionExpiryDate
	}
	if !IsNil(o.NextInvoiceDate) {
		toSerialize["next_invoice_date"] = o.NextInvoiceDate
	}
...
func (o *AccountDetails) UnmarshalJSON(data []byte) (err error) {
	...
	*o = AccountDetails(varAccountDetails)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "minimum_charge_amount")
		delete(additionalProperties, "prepaid_amount")
		delete(additionalProperties, "subscription_expiry_date")
		delete(additionalProperties, "next_invoice_date")
