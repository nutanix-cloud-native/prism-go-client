...
// checks if the ClusterSoftware type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterSoftware{}
...
type _ClusterSoftware ClusterSoftware
...
func NewClusterSoftware(version string, softwareType string) *ClusterSoftware {
	this := ClusterSoftware{}
	var status string = "INSTALLED"
	this.Status = &status
...
func (o ClusterSoftware) MarshalJSON() ([]byte, error) {
...
func (o ClusterSoftware) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterSoftware) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterSoftware := _ClusterSoftware{}

	err = json.Unmarshal(data, &varClusterSoftware)

	if err != nil {
		return err
	}

	*o = ClusterSoftware(varClusterSoftware)
...
type NullableClusterSoftware struct {
	value *ClusterSoftware
	isSet bool
}

func (v NullableClusterSoftware) Get() *ClusterSoftware {
	return v.value
}

func (v *NullableClusterSoftware) Set(val *ClusterSoftware) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterSoftware) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterSoftware) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterSoftware(val *ClusterSoftware) *NullableClusterSoftware {
	return &NullableClusterSoftware{value: val, isSet: true}
}

func (v NullableClusterSoftware) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterSoftware) UnmarshalJSON(src []byte) error {
	v.isSet = true
