...
// checks if the SshUserListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUserListMetadata{}

// SshUserListMetadata All api calls that return a list will have this metadata block as input 
type SshUserListMetadata struct {
	// The kind name
...
type _SshUserListMetadata SshUserListMetadata
...
func (o SshUserListMetadata) MarshalJSON() ([]byte, error) {
...
func (o SshUserListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SshUserListMetadata) UnmarshalJSON(data []byte) (err error) {
	varSshUserListMetadata := _SshUserListMetadata{}

	err = json.Unmarshal(data, &varSshUserListMetadata)

	if err != nil {
		return err
	}

	*o = SshUserListMetadata(varSshUserListMetadata)
...
type NullableSshUserListMetadata struct {
	value *SshUserListMetadata
	isSet bool
}

func (v NullableSshUserListMetadata) Get() *SshUserListMetadata {
	return v.value
}

func (v *NullableSshUserListMetadata) Set(val *SshUserListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSshUserListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSshUserListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshUserListMetadata(val *SshUserListMetadata) *NullableSshUserListMetadata {
	return &NullableSshUserListMetadata{value: val, isSet: true}
}

func (v NullableSshUserListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshUserListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
