...
// checks if the AvailabilityZoneListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneListMetadata{}

// AvailabilityZoneListMetadata All api calls that return a list will have this metadata block as input 
...
type _AvailabilityZoneListMetadata AvailabilityZoneListMetadata
...
func NewAvailabilityZoneListMetadata() *AvailabilityZoneListMetadata {
	this := AvailabilityZoneListMetadata{}
...
func (o AvailabilityZoneListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AvailabilityZoneListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AvailabilityZoneListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAvailabilityZoneListMetadata := _AvailabilityZoneListMetadata{}

	err = json.Unmarshal(data, &varAvailabilityZoneListMetadata)

	if err != nil {
		return err
	}

	*o = AvailabilityZoneListMetadata(varAvailabilityZoneListMetadata)
...
type NullableAvailabilityZoneListMetadata struct {
	value *AvailabilityZoneListMetadata
	isSet bool
}

func (v NullableAvailabilityZoneListMetadata) Get() *AvailabilityZoneListMetadata {
	return v.value
}

func (v *NullableAvailabilityZoneListMetadata) Set(val *AvailabilityZoneListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZoneListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZoneListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZoneListMetadata(val *AvailabilityZoneListMetadata) *NullableAvailabilityZoneListMetadata {
	return &NullableAvailabilityZoneListMetadata{value: val, isSet: true}
}

func (v NullableAvailabilityZoneListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZoneListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
