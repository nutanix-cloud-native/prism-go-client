...
type ClusterNetwork struct {
	...
	MasqueradingIp *string `json:"masquerading_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	...
	ExternalIp *string `json:"external_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
	...
	ExternalDataServicesIp *string `json:"external_data_services_ip,omitempty" validate:"regexp=^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"`
...
func NewClusterNetwork() *ClusterNetwork {
	this := ClusterNetwork{}
	var externalSubnet string = "172.16.0.0/255.240.0.0"
	this.ExternalSubnet = &externalSubnet
	var internalSubnet string = "192.168.5.0/255.255.255.0"
...
// GetMasqueradingIp returns the MasqueradingIp field value if set, zero value otherwise.
func (o *ClusterNetwork) GetMasqueradingIp() string {
	if o == nil || IsNil(o.MasqueradingIp) {
		var ret string
		return ret
	}
	return *o.MasqueradingIp
}
...
// SetMasqueradingIp gets a reference to the given string and assigns it to the MasqueradingIp field.
...
// GetHttpProxyList returns the HttpProxyList field value if set, zero value otherwise.
func (o *ClusterNetwork) GetHttpProxyList() []ClusterNetworkEntity {
	if o == nil || IsNil(o.HttpProxyList) {
		var ret []ClusterNetworkEntity
		return ret
	}
	return o.HttpProxyList
}

// GetHttpProxyListOk returns a tuple with the HttpProxyList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterNetwork) GetHttpProxyListOk() ([]ClusterNetworkEntity, bool) {
	if o == nil || IsNil(o.HttpProxyList) {
		return nil, false
	}
	return o.HttpProxyList, true
}
...
// SetHttpProxyList gets a reference to the given []ClusterNetworkEntity and assigns it to the HttpProxyList field.
...
// SetSmtpServer gets a reference to the given SmtpServer and assigns it to the SmtpServer field.
...
// GetNfsSubnetWhitelist returns the NfsSubnetWhitelist field value if set, zero value otherwise.
func (o *ClusterNetwork) GetNfsSubnetWhitelist() []string {
	if o == nil || IsNil(o.NfsSubnetWhitelist) {
		var ret []string
		return ret
	}
	return o.NfsSubnetWhitelist
}

// GetNfsSubnetWhitelistOk returns a tuple with the NfsSubnetWhitelist field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterNetwork) GetNfsSubnetWhitelistOk() ([]string, bool) {
	if o == nil || IsNil(o.NfsSubnetWhitelist) {
		return nil, false
	}
	return o.NfsSubnetWhitelist, true
}
...
// SetNfsSubnetWhitelist gets a reference to the given []string and assigns it to the NfsSubnetWhitelist field.
func (o *ClusterNetwork) SetNfsSubnetWhitelist(v []string) {
	o.NfsSubnetWhitelist = v
}

// GetExternalDataServicesIp returns the ExternalDataServicesIp field value if set, zero value otherwise.
func (o *ClusterNetwork) GetExternalDataServicesIp() string {
	if o == nil || IsNil(o.ExternalDataServicesIp) {
		var ret string
		return ret
	}
	return *o.ExternalDataServicesIp
}

// GetExternalDataServicesIpOk returns a tuple with the ExternalDataServicesIp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterNetwork) GetExternalDataServicesIpOk() (*string, bool) {
	if o == nil || IsNil(o.ExternalDataServicesIp) {
		return nil, false
	}
	return o.ExternalDataServicesIp, true
}
...
// SetExternalDataServicesIp gets a reference to the given string and assigns it to the ExternalDataServicesIp field.
func (o *ClusterNetwork) SetExternalDataServicesIp(v string) {
	o.ExternalDataServicesIp = &v
}

// GetDomainServer returns the DomainServer field value if set, zero value otherwise.
func (o *ClusterNetwork) GetDomainServer() ClusterDomainServer {
	if o == nil || IsNil(o.DomainServer) {
		var ret ClusterDomainServer
		return ret
	}
	return *o.DomainServer
}

// GetDomainServerOk returns a tuple with the DomainServer field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterNetwork) GetDomainServerOk() (*ClusterDomainServer, bool) {
	if o == nil || IsNil(o.DomainServer) {
		return nil, false
	}
	return o.DomainServer, true
}
...
// SetDomainServer gets a reference to the given ClusterDomainServer and assigns it to the DomainServer field.
...
func (o *ClusterNetwork) GetFullyQualifiedDomainName() string {
	if o == nil || IsNil(o.FullyQualifiedDomainName) {
		var ret string
		return ret
	}
...
// GetNameServerIpList returns the NameServerIpList field value if set, zero value otherwise.
...
// SetNameServerIpList gets a reference to the given []string and assigns it to the NameServerIpList field.
func (o *ClusterNetwork) SetNameServerIpList(v []string) {
	o.NameServerIpList = v
}

// GetHttpProxyWhitelist returns the HttpProxyWhitelist field value if set, zero value otherwise.
func (o *ClusterNetwork) GetHttpProxyWhitelist() []HttpProxyWhitelist {
	if o == nil || IsNil(o.HttpProxyWhitelist) {
		var ret []HttpProxyWhitelist
		return ret
	}
	return o.HttpProxyWhitelist
}

// GetHttpProxyWhitelistOk returns a tuple with the HttpProxyWhitelist field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterNetwork) GetHttpProxyWhitelistOk() ([]HttpProxyWhitelist, bool) {
	if o == nil || IsNil(o.HttpProxyWhitelist) {
		return nil, false
	}
	return o.HttpProxyWhitelist, true
}
...
// SetHttpProxyWhitelist gets a reference to the given []HttpProxyWhitelist and assigns it to the HttpProxyWhitelist field.
func (o *ClusterNetwork) SetHttpProxyWhitelist(v []HttpProxyWhitelist) {
	o.HttpProxyWhitelist = v
}
...
// GetDefaultVswitchConfig returns the DefaultVswitchConfig field value if set, zero value otherwise.
func (o *ClusterNetwork) GetDefaultVswitchConfig() VswitchConfig {
	if o == nil || IsNil(o.DefaultVswitchConfig) {
		var ret VswitchConfig
		return ret
	}
	return *o.DefaultVswitchConfig
}

// GetDefaultVswitchConfigOk returns a tuple with the DefaultVswitchConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterNetwork) GetDefaultVswitchConfigOk() (*VswitchConfig, bool) {
	if o == nil || IsNil(o.DefaultVswitchConfig) {
		return nil, false
	}
	return o.DefaultVswitchConfig, true
}
...
// SetDefaultVswitchConfig gets a reference to the given VswitchConfig and assigns it to the DefaultVswitchConfig field.
func (o *ClusterNetwork) SetDefaultVswitchConfig(v VswitchConfig) {
	o.DefaultVswitchConfig = &v
}
...
func (o ClusterNetwork) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MasqueradingIp) {
		toSerialize["masquerading_ip"] = o.MasqueradingIp
	}
	if !IsNil(o.MasqueradingPort) {
		toSerialize["masquerading_port"] = o.MasqueradingPort
	}
	if !IsNil(o.ExternalIp) {
		toSerialize["external_ip"] = o.ExternalIp
	}
	if !IsNil(o.HttpProxyList) {
		toSerialize["http_proxy_list"] = o.HttpProxyList
	}
	if !IsNil(o.SmtpServer) {
		toSerialize["smtp_server"] = o.SmtpServer
	}
	if !IsNil(o.NtpServerIpList) {
		toSerialize["ntp_server_ip_list"] = o.NtpServerIpList
	}
	if !IsNil(o.ExternalSubnet) {
		toSerialize["external_subnet"] = o.ExternalSubnet
	}
	if !IsNil(o.NfsSubnetWhitelist) {
		toSerialize["nfs_subnet_whitelist"] = o.NfsSubnetWhitelist
	}
	if !IsNil(o.ExternalDataServicesIp) {
		toSerialize["external_data_services_ip"] = o.ExternalDataServicesIp
	}
	if !IsNil(o.DomainServer) {
		toSerialize["domain_server"] = o.DomainServer
	}
	if !IsNil(o.FullyQualifiedDomainName) {
		toSerialize["fully_qualified_domain_name"] = o.FullyQualifiedDomainName
	}
	if !IsNil(o.NameServerIpList) {
		toSerialize["name_server_ip_list"] = o.NameServerIpList
	}
	if !IsNil(o.HttpProxyWhitelist) {
		toSerialize["http_proxy_whitelist"] = o.HttpProxyWhitelist
	}
	if !IsNil(o.InternalSubnet) {
		toSerialize["internal_subnet"] = o.InternalSubnet
	}
	if !IsNil(o.DefaultVswitchConfig) {
		toSerialize["default_vswitch_config"] = o.DefaultVswitchConfig
	}
...
func (o *ClusterNetwork) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ClusterNetwork(varClusterNetwork)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "masquerading_ip")
		delete(additionalProperties, "masquerading_port")
		delete(additionalProperties, "external_ip")
		delete(additionalProperties, "http_proxy_list")
		delete(additionalProperties, "smtp_server")
		delete(additionalProperties, "ntp_server_ip_list")
		delete(additionalProperties, "external_subnet")
		delete(additionalProperties, "nfs_subnet_whitelist")
		delete(additionalProperties, "external_data_services_ip")
		delete(additionalProperties, "domain_server")
		delete(additionalProperties, "fully_qualified_domain_name")
		delete(additionalProperties, "name_server_ip_list")
		delete(additionalProperties, "http_proxy_whitelist")
		delete(additionalProperties, "internal_subnet")
		delete(additionalProperties, "default_vswitch_config")
