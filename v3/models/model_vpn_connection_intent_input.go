...
// checks if the VpnConnectionIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnConnectionIntentInput{}

// VpnConnectionIntentInput An intentful representation of a vpn_connection
type VpnConnectionIntentInput struct {
	Spec VpnConnection `json:"spec"`
...
type _VpnConnectionIntentInput VpnConnectionIntentInput
...
func (o VpnConnectionIntentInput) MarshalJSON() ([]byte, error) {
...
func (o VpnConnectionIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *VpnConnectionIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVpnConnectionIntentInput := _VpnConnectionIntentInput{}

	err = json.Unmarshal(data, &varVpnConnectionIntentInput)

	if err != nil {
		return err
	}

	*o = VpnConnectionIntentInput(varVpnConnectionIntentInput)
...
type NullableVpnConnectionIntentInput struct {
	value *VpnConnectionIntentInput
	isSet bool
}

func (v NullableVpnConnectionIntentInput) Get() *VpnConnectionIntentInput {
	return v.value
}

func (v *NullableVpnConnectionIntentInput) Set(val *VpnConnectionIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnConnectionIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnConnectionIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnConnectionIntentInput(val *VpnConnectionIntentInput) *NullableVpnConnectionIntentInput {
	return &NullableVpnConnectionIntentInput{value: val, isSet: true}
}

func (v NullableVpnConnectionIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnConnectionIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
