...
// checks if the AwsKeyPairListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsKeyPairListMetadata{}

// AwsKeyPairListMetadata All api calls that return a list will have this metadata block as input 
type AwsKeyPairListMetadata struct {
	// The kind name
...
type _AwsKeyPairListMetadata AwsKeyPairListMetadata
...
func (o AwsKeyPairListMetadata) MarshalJSON() ([]byte, error) {
...
func (o AwsKeyPairListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *AwsKeyPairListMetadata) UnmarshalJSON(data []byte) (err error) {
	varAwsKeyPairListMetadata := _AwsKeyPairListMetadata{}

	err = json.Unmarshal(data, &varAwsKeyPairListMetadata)

	if err != nil {
		return err
	}

	*o = AwsKeyPairListMetadata(varAwsKeyPairListMetadata)
...
type NullableAwsKeyPairListMetadata struct {
	value *AwsKeyPairListMetadata
	isSet bool
}

func (v NullableAwsKeyPairListMetadata) Get() *AwsKeyPairListMetadata {
	return v.value
}

func (v *NullableAwsKeyPairListMetadata) Set(val *AwsKeyPairListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsKeyPairListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsKeyPairListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsKeyPairListMetadata(val *AwsKeyPairListMetadata) *NullableAwsKeyPairListMetadata {
	return &NullableAwsKeyPairListMetadata{value: val, isSet: true}
}

func (v NullableAwsKeyPairListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsKeyPairListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
