...
// checks if the CloudCredentialsIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCredentialsIntentResource{}

// CloudCredentialsIntentResource Response object for intentful operations on a cloud_credentials
...
type _CloudCredentialsIntentResource CloudCredentialsIntentResource
...
func NewCloudCredentialsIntentResource(metadata CloudCredentialsMetadata) *CloudCredentialsIntentResource {
	this := CloudCredentialsIntentResource{}
...
func (o CloudCredentialsIntentResource) MarshalJSON() ([]byte, error) {
...
func (o CloudCredentialsIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *CloudCredentialsIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudCredentialsIntentResource := _CloudCredentialsIntentResource{}

	err = json.Unmarshal(data, &varCloudCredentialsIntentResource)

	if err != nil {
		return err
	}

	*o = CloudCredentialsIntentResource(varCloudCredentialsIntentResource)
...
type NullableCloudCredentialsIntentResource struct {
	value *CloudCredentialsIntentResource
	isSet bool
}

func (v NullableCloudCredentialsIntentResource) Get() *CloudCredentialsIntentResource {
	return v.value
}

func (v *NullableCloudCredentialsIntentResource) Set(val *CloudCredentialsIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCredentialsIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCredentialsIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCredentialsIntentResource(val *CloudCredentialsIntentResource) *NullableCloudCredentialsIntentResource {
	return &NullableCloudCredentialsIntentResource{value: val, isSet: true}
}

func (v NullableCloudCredentialsIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCredentialsIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
