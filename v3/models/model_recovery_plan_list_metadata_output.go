...
// checks if the RecoveryPlanListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanListMetadataOutput{}

// RecoveryPlanListMetadataOutput All api calls that return a list will have this metadata block 
...
type _RecoveryPlanListMetadataOutput RecoveryPlanListMetadataOutput
...
func NewRecoveryPlanListMetadataOutput() *RecoveryPlanListMetadataOutput {
	this := RecoveryPlanListMetadataOutput{}
	var kind string = "recovery_plan"
	this.Kind = &kind
	return &this
}
...
func (o RecoveryPlanListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varRecoveryPlanListMetadataOutput := _RecoveryPlanListMetadataOutput{}

	err = json.Unmarshal(data, &varRecoveryPlanListMetadataOutput)

	if err != nil {
		return err
	}

	*o = RecoveryPlanListMetadataOutput(varRecoveryPlanListMetadataOutput)
...
type NullableRecoveryPlanListMetadataOutput struct {
	value *RecoveryPlanListMetadataOutput
	isSet bool
}

func (v NullableRecoveryPlanListMetadataOutput) Get() *RecoveryPlanListMetadataOutput {
	return v.value
}

func (v *NullableRecoveryPlanListMetadataOutput) Set(val *RecoveryPlanListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanListMetadataOutput(val *RecoveryPlanListMetadataOutput) *NullableRecoveryPlanListMetadataOutput {
	return &NullableRecoveryPlanListMetadataOutput{value: val, isSet: true}
}

func (v NullableRecoveryPlanListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
