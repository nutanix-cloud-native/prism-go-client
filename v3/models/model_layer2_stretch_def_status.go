...
// checks if the Layer2StretchDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchDefStatus{}

// Layer2StretchDefStatus An intentful representation of a layer2_stretch status
type Layer2StretchDefStatus struct {
	// layer2_stretch Name.
	Name string `json:"name"`
	// The state of the layer2_stretch.
	State *string `json:"state,omitempty"`
	AvailabilityZoneReference *AvailabilityZoneReference `json:"availability_zone_reference,omitempty"`
	// Any error messages for the layer2_stretch, if in an error state.
	...
	Resources Layer2StretchResourcesDefStatus `json:"resources"`
	// A description for layer2_stretch.
	Description *string `json:"description,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _Layer2StretchDefStatus Layer2StretchDefStatus
...
func (o *Layer2StretchDefStatus) GetResources() Layer2StretchResourcesDefStatus {
	if o == nil {
		var ret Layer2StretchResourcesDefStatus
		return ret
	}
...
func (o Layer2StretchDefStatus) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *Layer2StretchDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varLayer2StretchDefStatus := _Layer2StretchDefStatus{}

	err = json.Unmarshal(data, &varLayer2StretchDefStatus)

	if err != nil {
		return err
	}

	*o = Layer2StretchDefStatus(varLayer2StretchDefStatus)
...
type NullableLayer2StretchDefStatus struct {
	value *Layer2StretchDefStatus
	isSet bool
}

func (v NullableLayer2StretchDefStatus) Get() *Layer2StretchDefStatus {
	return v.value
}

func (v *NullableLayer2StretchDefStatus) Set(val *Layer2StretchDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchDefStatus(val *Layer2StretchDefStatus) *NullableLayer2StretchDefStatus {
	return &NullableLayer2StretchDefStatus{value: val, isSet: true}
}

func (v NullableLayer2StretchDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
