...
// checks if the CloudCredentialsIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCredentialsIntentResponse{}

// CloudCredentialsIntentResponse Response object for intentful operations on a cloud_credentials
...
type _CloudCredentialsIntentResponse CloudCredentialsIntentResponse
...
func NewCloudCredentialsIntentResponse(apiVersion string, metadata CloudCredentialsMetadata) *CloudCredentialsIntentResponse {
	this := CloudCredentialsIntentResponse{}
...
func (o *CloudCredentialsIntentResponse) GetStatus() CloudCredentialsDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret CloudCredentialsDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CloudCredentialsDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given CloudCredentials and assigns it to the Spec field.
...
func (o *CloudCredentialsIntentResponse) GetMetadata() CloudCredentialsMetadata {
	if o == nil {
		var ret CloudCredentialsMetadata
		return ret
	}
...
func (o CloudCredentialsIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CloudCredentialsIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CloudCredentialsIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudCredentialsIntentResponse := _CloudCredentialsIntentResponse{}

	err = json.Unmarshal(data, &varCloudCredentialsIntentResponse)

	if err != nil {
		return err
	}

	*o = CloudCredentialsIntentResponse(varCloudCredentialsIntentResponse)
...
type NullableCloudCredentialsIntentResponse struct {
	value *CloudCredentialsIntentResponse
	isSet bool
}

func (v NullableCloudCredentialsIntentResponse) Get() *CloudCredentialsIntentResponse {
	return v.value
}

func (v *NullableCloudCredentialsIntentResponse) Set(val *CloudCredentialsIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCredentialsIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCredentialsIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCredentialsIntentResponse(val *CloudCredentialsIntentResponse) *NullableCloudCredentialsIntentResponse {
	return &NullableCloudCredentialsIntentResponse{value: val, isSet: true}
}

func (v NullableCloudCredentialsIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCredentialsIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
