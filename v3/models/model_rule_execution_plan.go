...
// checks if the RuleExecutionPlan type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleExecutionPlan{}

// RuleExecutionPlan The Plan includes the list of actions to be executed, as well as the rule type and any other parameters required for the execution of the particular rule type. 
...
func (o RuleExecutionPlan) MarshalJSON() ([]byte, error) {
...
func (o RuleExecutionPlan) ToMap() (map[string]interface{}, error) {
...
func (o *RuleExecutionPlan) UnmarshalJSON(data []byte) (err error) {
	...
	varRuleExecutionPlan := _RuleExecutionPlan{}

	err = json.Unmarshal(data, &varRuleExecutionPlan)

	if err != nil {
		return err
	}

	*o = RuleExecutionPlan(varRuleExecutionPlan)
...
type NullableRuleExecutionPlan struct {
	value *RuleExecutionPlan
	isSet bool
}

func (v NullableRuleExecutionPlan) Get() *RuleExecutionPlan {
	return v.value
}

func (v *NullableRuleExecutionPlan) Set(val *RuleExecutionPlan) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleExecutionPlan) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleExecutionPlan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleExecutionPlan(val *RuleExecutionPlan) *NullableRuleExecutionPlan {
	return &NullableRuleExecutionPlan{value: val, isSet: true}
}

func (v NullableRuleExecutionPlan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleExecutionPlan) UnmarshalJSON(src []byte) error {
	v.isSet = true
