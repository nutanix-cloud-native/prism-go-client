...
// checks if the RoleListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleListMetadataOutput{}

// RoleListMetadataOutput All api calls that return a list will have this metadata block 
...
type _RoleListMetadataOutput RoleListMetadataOutput
...
// and a boolean to check if the value has been set.
func (o *RoleListMetadataOutput) GetSortOrderOk() (*string, bool) {
	if o == nil || IsNil(o.SortOrder) {
		return nil, false
	}
...
func (o RoleListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o RoleListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *RoleListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varRoleListMetadataOutput := _RoleListMetadataOutput{}

	err = json.Unmarshal(data, &varRoleListMetadataOutput)

	if err != nil {
		return err
	}

	*o = RoleListMetadataOutput(varRoleListMetadataOutput)
...
type NullableRoleListMetadataOutput struct {
	value *RoleListMetadataOutput
	isSet bool
}

func (v NullableRoleListMetadataOutput) Get() *RoleListMetadataOutput {
	return v.value
}

func (v *NullableRoleListMetadataOutput) Set(val *RoleListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleListMetadataOutput(val *RoleListMetadataOutput) *NullableRoleListMetadataOutput {
	return &NullableRoleListMetadataOutput{value: val, isSet: true}
}

func (v NullableRoleListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
