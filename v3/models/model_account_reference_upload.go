...
// checks if the AccountReferenceUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountReferenceUpload{}

// AccountReferenceUpload The reference to a account
type AccountReferenceUpload struct {
	// The kind name
...
type _AccountReferenceUpload AccountReferenceUpload
...
func (o AccountReferenceUpload) MarshalJSON() ([]byte, error) {
...
func (o AccountReferenceUpload) ToMap() (map[string]interface{}, error) {
...
func (o *AccountReferenceUpload) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountReferenceUpload := _AccountReferenceUpload{}

	err = json.Unmarshal(data, &varAccountReferenceUpload)

	if err != nil {
		return err
	}

	*o = AccountReferenceUpload(varAccountReferenceUpload)
...
type NullableAccountReferenceUpload struct {
	value *AccountReferenceUpload
	isSet bool
}

func (v NullableAccountReferenceUpload) Get() *AccountReferenceUpload {
	return v.value
}

func (v *NullableAccountReferenceUpload) Set(val *AccountReferenceUpload) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountReferenceUpload) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountReferenceUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountReferenceUpload(val *AccountReferenceUpload) *NullableAccountReferenceUpload {
	return &NullableAccountReferenceUpload{value: val, isSet: true}
}

func (v NullableAccountReferenceUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountReferenceUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
