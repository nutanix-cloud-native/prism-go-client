...
// checks if the Layer2StretchResourcesDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Layer2StretchResourcesDefStatus{}

// Layer2StretchResourcesDefStatus Layer2 stretch status.
type Layer2StretchResourcesDefStatus struct {
	LocalSiteParams *StretchSiteParams `json:"local_site_params,omitempty"`
	StretchStatus *StretchStatus `json:"stretch_status,omitempty"`
	RemoteSiteParams *StretchSiteParams `json:"remote_site_params,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _Layer2StretchResourcesDefStatus Layer2StretchResourcesDefStatus
...
func NewLayer2StretchResourcesDefStatus() *Layer2StretchResourcesDefStatus {
	this := Layer2StretchResourcesDefStatus{}
	return &this
}
...
// GetLocalSiteParams returns the LocalSiteParams field value if set, zero value otherwise.
func (o *Layer2StretchResourcesDefStatus) GetLocalSiteParams() StretchSiteParams {
	if o == nil || IsNil(o.LocalSiteParams) {
		var ret StretchSiteParams
		return ret
	}
	return *o.LocalSiteParams
}

// GetLocalSiteParamsOk returns a tuple with the LocalSiteParams field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Layer2StretchResourcesDefStatus) GetLocalSiteParamsOk() (*StretchSiteParams, bool) {
	if o == nil || IsNil(o.LocalSiteParams) {
		return nil, false
	}
	return o.LocalSiteParams, true
}
...
// SetLocalSiteParams gets a reference to the given StretchSiteParams and assigns it to the LocalSiteParams field.
func (o *Layer2StretchResourcesDefStatus) SetLocalSiteParams(v StretchSiteParams) {
	o.LocalSiteParams = &v
}

// GetStretchStatus returns the StretchStatus field value if set, zero value otherwise.
func (o *Layer2StretchResourcesDefStatus) GetStretchStatus() StretchStatus {
	if o == nil || IsNil(o.StretchStatus) {
		var ret StretchStatus
		return ret
	}
	return *o.StretchStatus
}

// GetStretchStatusOk returns a tuple with the StretchStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Layer2StretchResourcesDefStatus) GetStretchStatusOk() (*StretchStatus, bool) {
	if o == nil || IsNil(o.StretchStatus) {
		return nil, false
	}
	return o.StretchStatus, true
}
...
// SetStretchStatus gets a reference to the given StretchStatus and assigns it to the StretchStatus field.
func (o *Layer2StretchResourcesDefStatus) SetStretchStatus(v StretchStatus) {
	o.StretchStatus = &v
}

// GetRemoteSiteParams returns the RemoteSiteParams field value if set, zero value otherwise.
func (o *Layer2StretchResourcesDefStatus) GetRemoteSiteParams() StretchSiteParams {
	if o == nil || IsNil(o.RemoteSiteParams) {
		var ret StretchSiteParams
		return ret
	}
	return *o.RemoteSiteParams
}

// GetRemoteSiteParamsOk returns a tuple with the RemoteSiteParams field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Layer2StretchResourcesDefStatus) GetRemoteSiteParamsOk() (*StretchSiteParams, bool) {
	if o == nil || IsNil(o.RemoteSiteParams) {
		return nil, false
	}
	return o.RemoteSiteParams, true
}
...
// SetRemoteSiteParams gets a reference to the given StretchSiteParams and assigns it to the RemoteSiteParams field.
func (o *Layer2StretchResourcesDefStatus) SetRemoteSiteParams(v StretchSiteParams) {
	o.RemoteSiteParams = &v
}

func (o Layer2StretchResourcesDefStatus) MarshalJSON() ([]byte, error) {
...
func (o Layer2StretchResourcesDefStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.LocalSiteParams) {
		toSerialize["local_site_params"] = o.LocalSiteParams
	}
	if !IsNil(o.StretchStatus) {
		toSerialize["stretch_status"] = o.StretchStatus
	}
	if !IsNil(o.RemoteSiteParams) {
		toSerialize["remote_site_params"] = o.RemoteSiteParams
	}
...
func (o *Layer2StretchResourcesDefStatus) UnmarshalJSON(data []byte) (err error) {
	varLayer2StretchResourcesDefStatus := _Layer2StretchResourcesDefStatus{}

	err = json.Unmarshal(data, &varLayer2StretchResourcesDefStatus)

	if err != nil {
		return err
	}

	*o = Layer2StretchResourcesDefStatus(varLayer2StretchResourcesDefStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "local_site_params")
		delete(additionalProperties, "stretch_status")
		delete(additionalProperties, "remote_site_params")
...
type NullableLayer2StretchResourcesDefStatus struct {
	value *Layer2StretchResourcesDefStatus
	isSet bool
}

func (v NullableLayer2StretchResourcesDefStatus) Get() *Layer2StretchResourcesDefStatus {
	return v.value
}

func (v *NullableLayer2StretchResourcesDefStatus) Set(val *Layer2StretchResourcesDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableLayer2StretchResourcesDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableLayer2StretchResourcesDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayer2StretchResourcesDefStatus(val *Layer2StretchResourcesDefStatus) *NullableLayer2StretchResourcesDefStatus {
	return &NullableLayer2StretchResourcesDefStatus{value: val, isSet: true}
}

func (v NullableLayer2StretchResourcesDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayer2StretchResourcesDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
