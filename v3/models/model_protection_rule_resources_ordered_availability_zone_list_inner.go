...
// checks if the ProtectionRuleResourcesOrderedAvailabilityZoneListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRuleResourcesOrderedAvailabilityZoneListInner{}

// ProtectionRuleResourcesOrderedAvailabilityZoneListInner struct for ProtectionRuleResourcesOrderedAvailabilityZoneListInner
type ProtectionRuleResourcesOrderedAvailabilityZoneListInner struct {
	// UUID of specific cluster to which we will be replicating. This need to set only if availability zone is of type PC. This can only be specified if target type is AOS_CLUSTER. 
	...
	// The FQDN or IP address of the availability zone. Every Prism Central deployment acts as an availability zone. 
	AvailabilityZoneUrl *string `json:"availability_zone_url,omitempty"`
	// List of cluster UUIDs which are source or target for replication. This should be set only if the availability zone is of type PC. 
	ClusterUuidList []string `json:"cluster_uuid_list,omitempty"`
	// Target type for replication.
	TargetType *string `json:"target_type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ProtectionRuleResourcesOrderedAvailabilityZoneListInner ProtectionRuleResourcesOrderedAvailabilityZoneListInner
...
func NewProtectionRuleResourcesOrderedAvailabilityZoneListInner() *ProtectionRuleResourcesOrderedAvailabilityZoneListInner {
	this := ProtectionRuleResourcesOrderedAvailabilityZoneListInner{}
	return &this
}
...
// GetAvailabilityZoneUrl returns the AvailabilityZoneUrl field value if set, zero value otherwise.
func (o *ProtectionRuleResourcesOrderedAvailabilityZoneListInner) GetAvailabilityZoneUrl() string {
	if o == nil || IsNil(o.AvailabilityZoneUrl) {
		var ret string
		return ret
	}
...
// GetAvailabilityZoneUrlOk returns a tuple with the AvailabilityZoneUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAvailabilityZoneUrl gets a reference to the given string and assigns it to the AvailabilityZoneUrl field.
func (o *ProtectionRuleResourcesOrderedAvailabilityZoneListInner) SetAvailabilityZoneUrl(v string) {
	o.AvailabilityZoneUrl = &v
}

// GetClusterUuidList returns the ClusterUuidList field value if set, zero value otherwise.
func (o *ProtectionRuleResourcesOrderedAvailabilityZoneListInner) GetClusterUuidList() []string {
	if o == nil || IsNil(o.ClusterUuidList) {
		var ret []string
		return ret
	}
	return o.ClusterUuidList
}

// GetClusterUuidListOk returns a tuple with the ClusterUuidList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProtectionRuleResourcesOrderedAvailabilityZoneListInner) GetClusterUuidListOk() ([]string, bool) {
	if o == nil || IsNil(o.ClusterUuidList) {
		return nil, false
	}
	return o.ClusterUuidList, true
}
...
// SetClusterUuidList gets a reference to the given []string and assigns it to the ClusterUuidList field.
...
func (o ProtectionRuleResourcesOrderedAvailabilityZoneListInner) MarshalJSON() ([]byte, error) {
...
func (o ProtectionRuleResourcesOrderedAvailabilityZoneListInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ClusterUuid) {
		toSerialize["cluster_uuid"] = o.ClusterUuid
	}
	if !IsNil(o.AvailabilityZoneUrl) {
		toSerialize["availability_zone_url"] = o.AvailabilityZoneUrl
	}
	if !IsNil(o.ClusterUuidList) {
		toSerialize["cluster_uuid_list"] = o.ClusterUuidList
	}
...
func (o *ProtectionRuleResourcesOrderedAvailabilityZoneListInner) UnmarshalJSON(data []byte) (err error) {
	varProtectionRuleResourcesOrderedAvailabilityZoneListInner := _ProtectionRuleResourcesOrderedAvailabilityZoneListInner{}

	err = json.Unmarshal(data, &varProtectionRuleResourcesOrderedAvailabilityZoneListInner)

	if err != nil {
		return err
	}

	*o = ProtectionRuleResourcesOrderedAvailabilityZoneListInner(varProtectionRuleResourcesOrderedAvailabilityZoneListInner)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "cluster_uuid_list")
...
type NullableProtectionRuleResourcesOrderedAvailabilityZoneListInner struct {
	value *ProtectionRuleResourcesOrderedAvailabilityZoneListInner
	isSet bool
}

func (v NullableProtectionRuleResourcesOrderedAvailabilityZoneListInner) Get() *ProtectionRuleResourcesOrderedAvailabilityZoneListInner {
	return v.value
}

func (v *NullableProtectionRuleResourcesOrderedAvailabilityZoneListInner) Set(val *ProtectionRuleResourcesOrderedAvailabilityZoneListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionRuleResourcesOrderedAvailabilityZoneListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionRuleResourcesOrderedAvailabilityZoneListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionRuleResourcesOrderedAvailabilityZoneListInner(val *ProtectionRuleResourcesOrderedAvailabilityZoneListInner) *NullableProtectionRuleResourcesOrderedAvailabilityZoneListInner {
	return &NullableProtectionRuleResourcesOrderedAvailabilityZoneListInner{value: val, isSet: true}
}

func (v NullableProtectionRuleResourcesOrderedAvailabilityZoneListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionRuleResourcesOrderedAvailabilityZoneListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
