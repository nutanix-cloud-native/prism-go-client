...
// checks if the CommonReportConfigListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonReportConfigListIntentResponse{}

// CommonReportConfigListIntentResponse Response object for intentful operation of common_report_configs
type CommonReportConfigListIntentResponse struct {
	Entities []CommonReportConfigIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata CommonReportConfigListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _CommonReportConfigListIntentResponse CommonReportConfigListIntentResponse
...
func NewCommonReportConfigListIntentResponse(apiVersion string, metadata CommonReportConfigListMetadataOutput) *CommonReportConfigListIntentResponse {
	this := CommonReportConfigListIntentResponse{}
...
func (o *CommonReportConfigListIntentResponse) GetEntities() []CommonReportConfigIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []CommonReportConfigIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []CommonReportConfigIntentResource and assigns it to the Entities field.
...
func (o *CommonReportConfigListIntentResponse) GetMetadata() CommonReportConfigListMetadataOutput {
	if o == nil {
		var ret CommonReportConfigListMetadataOutput
		return ret
	}
...
func (o CommonReportConfigListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o CommonReportConfigListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CommonReportConfigListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonReportConfigListIntentResponse := _CommonReportConfigListIntentResponse{}

	err = json.Unmarshal(data, &varCommonReportConfigListIntentResponse)

	if err != nil {
		return err
	}

	*o = CommonReportConfigListIntentResponse(varCommonReportConfigListIntentResponse)
...
type NullableCommonReportConfigListIntentResponse struct {
	value *CommonReportConfigListIntentResponse
	isSet bool
}

func (v NullableCommonReportConfigListIntentResponse) Get() *CommonReportConfigListIntentResponse {
	return v.value
}

func (v *NullableCommonReportConfigListIntentResponse) Set(val *CommonReportConfigListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonReportConfigListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonReportConfigListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonReportConfigListIntentResponse(val *CommonReportConfigListIntentResponse) *NullableCommonReportConfigListIntentResponse {
	return &NullableCommonReportConfigListIntentResponse{value: val, isSet: true}
}

func (v NullableCommonReportConfigListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonReportConfigListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
