...
// checks if the RackReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RackReference{}

// RackReference The reference to a rack
...
type _RackReference RackReference
...
func (o RackReference) MarshalJSON() ([]byte, error) {
...
func (o RackReference) ToMap() (map[string]interface{}, error) {
...
func (o *RackReference) UnmarshalJSON(data []byte) (err error) {
	...
	varRackReference := _RackReference{}

	err = json.Unmarshal(data, &varRackReference)

	if err != nil {
		return err
	}

	*o = RackReference(varRackReference)
...
type NullableRackReference struct {
	value *RackReference
	isSet bool
}

func (v NullableRackReference) Get() *RackReference {
	return v.value
}

func (v *NullableRackReference) Set(val *RackReference) {
	v.value = val
	v.isSet = true
}

func (v NullableRackReference) IsSet() bool {
	return v.isSet
}

func (v *NullableRackReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRackReference(val *RackReference) *NullableRackReference {
	return &NullableRackReference{value: val, isSet: true}
}

func (v NullableRackReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRackReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
