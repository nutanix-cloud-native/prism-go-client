...
// checks if the AlertListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertListIntentResponse{}

// AlertListIntentResponse Response object for intentful operation of alerts
type AlertListIntentResponse struct {
	Entities []AlertIntentResource `json:"entities,omitempty"`
	// API Version of the Nutanix v3 API framework.
	ApiVersion string `json:"api_version"`
	Metadata AlertListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _AlertListIntentResponse AlertListIntentResponse
...
// SetEntities gets a reference to the given []AlertIntentResource and assigns it to the Entities field.
...
func (o *AlertListIntentResponse) GetMetadata() AlertListMetadataOutput {
	if o == nil {
		var ret AlertListMetadataOutput
		return ret
	}
...
func (o AlertListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o AlertListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AlertListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertListIntentResponse := _AlertListIntentResponse{}

	err = json.Unmarshal(data, &varAlertListIntentResponse)

	if err != nil {
		return err
	}

	*o = AlertListIntentResponse(varAlertListIntentResponse)
...
type NullableAlertListIntentResponse struct {
	value *AlertListIntentResponse
	isSet bool
}

func (v NullableAlertListIntentResponse) Get() *AlertListIntentResponse {
	return v.value
}

func (v *NullableAlertListIntentResponse) Set(val *AlertListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertListIntentResponse(val *AlertListIntentResponse) *NullableAlertListIntentResponse {
	return &NullableAlertListIntentResponse{value: val, isSet: true}
}

func (v NullableAlertListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
