...
// checks if the AppTaskResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppTaskResources{}

// AppTaskResources Libraty task resources definition.
...
type _AppTaskResources AppTaskResources
...
func (o AppTaskResources) MarshalJSON() ([]byte, error) {
...
func (o AppTaskResources) ToMap() (map[string]interface{}, error) {
...
func (o *AppTaskResources) UnmarshalJSON(data []byte) (err error) {
	...
	varAppTaskResources := _AppTaskResources{}

	err = json.Unmarshal(data, &varAppTaskResources)

	if err != nil {
		return err
	}

	*o = AppTaskResources(varAppTaskResources)
...
type NullableAppTaskResources struct {
	value *AppTaskResources
	isSet bool
}

func (v NullableAppTaskResources) Get() *AppTaskResources {
	return v.value
}

func (v *NullableAppTaskResources) Set(val *AppTaskResources) {
	v.value = val
	v.isSet = true
}

func (v NullableAppTaskResources) IsSet() bool {
	return v.isSet
}

func (v *NullableAppTaskResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppTaskResources(val *AppTaskResources) *NullableAppTaskResources {
	return &NullableAppTaskResources{value: val, isSet: true}
}

func (v NullableAppTaskResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppTaskResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
