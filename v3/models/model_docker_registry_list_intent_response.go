...
// checks if the DockerRegistryListIntentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DockerRegistryListIntentResponse{}
...
type DockerRegistryListIntentResponse struct {
	...
	Metadata DockerRegistryListMetadataOutput `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _DockerRegistryListIntentResponse DockerRegistryListIntentResponse
...
func NewDockerRegistryListIntentResponse(apiVersion string, metadata DockerRegistryListMetadataOutput) *DockerRegistryListIntentResponse {
	this := DockerRegistryListIntentResponse{}
...
func (o *DockerRegistryListIntentResponse) GetEntities() []DockerRegistryIntentResource {
	if o == nil || IsNil(o.Entities) {
		var ret []DockerRegistryIntentResource
		return ret
	}
	return o.Entities
}
...
// SetEntities gets a reference to the given []DockerRegistryIntentResource and assigns it to the Entities field.
...
func (o *DockerRegistryListIntentResponse) GetMetadata() DockerRegistryListMetadataOutput {
	if o == nil {
		var ret DockerRegistryListMetadataOutput
		return ret
	}
...
func (o DockerRegistryListIntentResponse) MarshalJSON() ([]byte, error) {
...
func (o DockerRegistryListIntentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DockerRegistryListIntentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerRegistryListIntentResponse := _DockerRegistryListIntentResponse{}

	err = json.Unmarshal(data, &varDockerRegistryListIntentResponse)

	if err != nil {
		return err
	}

	*o = DockerRegistryListIntentResponse(varDockerRegistryListIntentResponse)
...
type NullableDockerRegistryListIntentResponse struct {
	value *DockerRegistryListIntentResponse
	isSet bool
}

func (v NullableDockerRegistryListIntentResponse) Get() *DockerRegistryListIntentResponse {
	return v.value
}

func (v *NullableDockerRegistryListIntentResponse) Set(val *DockerRegistryListIntentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDockerRegistryListIntentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDockerRegistryListIntentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDockerRegistryListIntentResponse(val *DockerRegistryListIntentResponse) *NullableDockerRegistryListIntentResponse {
	return &NullableDockerRegistryListIntentResponse{value: val, isSet: true}
}

func (v NullableDockerRegistryListIntentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDockerRegistryListIntentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
