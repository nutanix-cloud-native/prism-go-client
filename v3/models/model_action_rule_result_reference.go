...
// checks if the ActionRuleResultReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionRuleResultReference{}

// ActionRuleResultReference The reference to a action_rule_result
type ActionRuleResultReference struct {
	// The kind name
...
type _ActionRuleResultReference ActionRuleResultReference
...
func NewActionRuleResultReference(kind string, uUID string) *ActionRuleResultReference {
	this := ActionRuleResultReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o ActionRuleResultReference) MarshalJSON() ([]byte, error) {
...
func (o ActionRuleResultReference) ToMap() (map[string]interface{}, error) {
...
func (o *ActionRuleResultReference) UnmarshalJSON(data []byte) (err error) {
	...
	varActionRuleResultReference := _ActionRuleResultReference{}

	err = json.Unmarshal(data, &varActionRuleResultReference)

	if err != nil {
		return err
	}

	*o = ActionRuleResultReference(varActionRuleResultReference)
...
type NullableActionRuleResultReference struct {
	value *ActionRuleResultReference
	isSet bool
}

func (v NullableActionRuleResultReference) Get() *ActionRuleResultReference {
	return v.value
}

func (v *NullableActionRuleResultReference) Set(val *ActionRuleResultReference) {
	v.value = val
	v.isSet = true
}

func (v NullableActionRuleResultReference) IsSet() bool {
	return v.isSet
}

func (v *NullableActionRuleResultReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionRuleResultReference(val *ActionRuleResultReference) *NullableActionRuleResultReference {
	return &NullableActionRuleResultReference{value: val, isSet: true}
}

func (v NullableActionRuleResultReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionRuleResultReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
