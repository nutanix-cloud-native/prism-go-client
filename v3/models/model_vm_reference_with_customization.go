...
// checks if the VmReferenceWithCustomization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmReferenceWithCustomization{}

// VmReferenceWithCustomization Spec that describes a VM reference along with its customization config. 
type VmReferenceWithCustomization struct {
	VmCustomization GuestCustomization `json:"vm_customization"`
	VmReference VmReference `json:"vm_reference"`
	AdditionalProperties map[string]interface{}
}

type _VmReferenceWithCustomization VmReferenceWithCustomization
...
func NewVmReferenceWithCustomization(vmCustomization GuestCustomization, vmReference VmReference) *VmReferenceWithCustomization {
	this := VmReferenceWithCustomization{}
...
// GetVmCustomization returns the VmCustomization field value
func (o *VmReferenceWithCustomization) GetVmCustomization() GuestCustomization {
	...
	return o.VmCustomization
}

// GetVmCustomizationOk returns a tuple with the VmCustomization field value
// and a boolean to check if the value has been set.
func (o *VmReferenceWithCustomization) GetVmCustomizationOk() (*GuestCustomization, bool) {
	if o == nil {
		return nil, false
	}
	return &o.VmCustomization, true
}

// SetVmCustomization sets field value
...
func (o VmReferenceWithCustomization) MarshalJSON() ([]byte, error) {
...
func (o VmReferenceWithCustomization) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["vm_customization"] = o.VmCustomization
...
func (o *VmReferenceWithCustomization) UnmarshalJSON(data []byte) (err error) {
	...
	varVmReferenceWithCustomization := _VmReferenceWithCustomization{}

	err = json.Unmarshal(data, &varVmReferenceWithCustomization)

	if err != nil {
		return err
	}

	*o = VmReferenceWithCustomization(varVmReferenceWithCustomization)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "vm_customization")
...
type NullableVmReferenceWithCustomization struct {
	value *VmReferenceWithCustomization
	isSet bool
}

func (v NullableVmReferenceWithCustomization) Get() *VmReferenceWithCustomization {
	return v.value
}

func (v *NullableVmReferenceWithCustomization) Set(val *VmReferenceWithCustomization) {
	v.value = val
	v.isSet = true
}

func (v NullableVmReferenceWithCustomization) IsSet() bool {
	return v.isSet
}

func (v *NullableVmReferenceWithCustomization) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmReferenceWithCustomization(val *VmReferenceWithCustomization) *NullableVmReferenceWithCustomization {
	return &NullableVmReferenceWithCustomization{value: val, isSet: true}
}

func (v NullableVmReferenceWithCustomization) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmReferenceWithCustomization) UnmarshalJSON(src []byte) error {
	v.isSet = true
