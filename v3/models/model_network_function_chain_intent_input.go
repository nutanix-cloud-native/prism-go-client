...
// checks if the NetworkFunctionChainIntentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkFunctionChainIntentInput{}

// NetworkFunctionChainIntentInput An intentful representation of a network_function_chain
type NetworkFunctionChainIntentInput struct {
	Spec NetworkFunctionChain `json:"spec"`
...
type _NetworkFunctionChainIntentInput NetworkFunctionChainIntentInput
...
func NewNetworkFunctionChainIntentInput(spec NetworkFunctionChain, metadata NetworkFunctionChainMetadata) *NetworkFunctionChainIntentInput {
	this := NetworkFunctionChainIntentInput{}
	this.Spec = spec
...
func (o NetworkFunctionChainIntentInput) MarshalJSON() ([]byte, error) {
...
func (o NetworkFunctionChainIntentInput) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkFunctionChainIntentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkFunctionChainIntentInput := _NetworkFunctionChainIntentInput{}

	err = json.Unmarshal(data, &varNetworkFunctionChainIntentInput)

	if err != nil {
		return err
	}

	*o = NetworkFunctionChainIntentInput(varNetworkFunctionChainIntentInput)
...
type NullableNetworkFunctionChainIntentInput struct {
	value *NetworkFunctionChainIntentInput
	isSet bool
}

func (v NullableNetworkFunctionChainIntentInput) Get() *NetworkFunctionChainIntentInput {
	return v.value
}

func (v *NullableNetworkFunctionChainIntentInput) Set(val *NetworkFunctionChainIntentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkFunctionChainIntentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkFunctionChainIntentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkFunctionChainIntentInput(val *NetworkFunctionChainIntentInput) *NullableNetworkFunctionChainIntentInput {
	return &NullableNetworkFunctionChainIntentInput{value: val, isSet: true}
}

func (v NullableNetworkFunctionChainIntentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkFunctionChainIntentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
