...
// checks if the DirectoryServiceDefStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryServiceDefStatus{}

// DirectoryServiceDefStatus Details of the directory service.
...
type _DirectoryServiceDefStatus DirectoryServiceDefStatus
...
func NewDirectoryServiceDefStatus(name string, resources DirectoryServiceResources) *DirectoryServiceDefStatus {
	this := DirectoryServiceDefStatus{}
	this.Name = name
...
func (o *DirectoryServiceDefStatus) GetResources() DirectoryServiceResources {
	if o == nil {
		var ret DirectoryServiceResources
		return ret
	}
...
func (o DirectoryServiceDefStatus) MarshalJSON() ([]byte, error) {
...
func (o DirectoryServiceDefStatus) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryServiceDefStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectoryServiceDefStatus := _DirectoryServiceDefStatus{}

	err = json.Unmarshal(data, &varDirectoryServiceDefStatus)

	if err != nil {
		return err
	}

	*o = DirectoryServiceDefStatus(varDirectoryServiceDefStatus)
...
type NullableDirectoryServiceDefStatus struct {
	value *DirectoryServiceDefStatus
	isSet bool
}

func (v NullableDirectoryServiceDefStatus) Get() *DirectoryServiceDefStatus {
	return v.value
}

func (v *NullableDirectoryServiceDefStatus) Set(val *DirectoryServiceDefStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryServiceDefStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryServiceDefStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryServiceDefStatus(val *DirectoryServiceDefStatus) *NullableDirectoryServiceDefStatus {
	return &NullableDirectoryServiceDefStatus{value: val, isSet: true}
}

func (v NullableDirectoryServiceDefStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryServiceDefStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
