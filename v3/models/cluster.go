...
func (cluster ClusterIntentResource) IsPrismCentral() bool {
...
func (clusters *ClusterListIntentResponse) GetPrismElements() []ClusterIntentResource {
	var prismElements []ClusterIntentResource
