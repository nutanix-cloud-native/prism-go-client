...
// checks if the RecoveryPlanJobIntentResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryPlanJobIntentResource{}

// RecoveryPlanJobIntentResource Response object for intentful operations on a recovery_plan_job
type RecoveryPlanJobIntentResource struct {
	...
	Metadata RecoveryPlanJobMetadata `json:"metadata"`
	AdditionalProperties map[string]interface{}
}

type _RecoveryPlanJobIntentResource RecoveryPlanJobIntentResource
...
func NewRecoveryPlanJobIntentResource(metadata RecoveryPlanJobMetadata) *RecoveryPlanJobIntentResource {
	this := RecoveryPlanJobIntentResource{}
...
func (o *RecoveryPlanJobIntentResource) GetStatus() RecoveryPlanJobDefStatus {
	if o == nil || IsNil(o.Status) {
		var ret RecoveryPlanJobDefStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given RecoveryPlanJobDefStatus and assigns it to the Status field.
...
// SetSpec gets a reference to the given RecoveryPlanJob and assigns it to the Spec field.
...
func (o *RecoveryPlanJobIntentResource) GetMetadata() RecoveryPlanJobMetadata {
	if o == nil {
		var ret RecoveryPlanJobMetadata
		return ret
	}
...
func (o RecoveryPlanJobIntentResource) MarshalJSON() ([]byte, error) {
...
func (o RecoveryPlanJobIntentResource) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryPlanJobIntentResource) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoveryPlanJobIntentResource := _RecoveryPlanJobIntentResource{}

	err = json.Unmarshal(data, &varRecoveryPlanJobIntentResource)

	if err != nil {
		return err
	}

	*o = RecoveryPlanJobIntentResource(varRecoveryPlanJobIntentResource)
...
type NullableRecoveryPlanJobIntentResource struct {
	value *RecoveryPlanJobIntentResource
	isSet bool
}

func (v NullableRecoveryPlanJobIntentResource) Get() *RecoveryPlanJobIntentResource {
	return v.value
}

func (v *NullableRecoveryPlanJobIntentResource) Set(val *RecoveryPlanJobIntentResource) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryPlanJobIntentResource) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryPlanJobIntentResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryPlanJobIntentResource(val *RecoveryPlanJobIntentResource) *NullableRecoveryPlanJobIntentResource {
	return &NullableRecoveryPlanJobIntentResource{value: val, isSet: true}
}

func (v NullableRecoveryPlanJobIntentResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryPlanJobIntentResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
