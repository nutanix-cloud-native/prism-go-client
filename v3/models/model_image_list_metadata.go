...
// checks if the ImageListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageListMetadata{}

// ImageListMetadata All api calls that return a list will have this metadata block as input 
...
type _ImageListMetadata ImageListMetadata
...
func (o ImageListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ImageListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ImageListMetadata) UnmarshalJSON(data []byte) (err error) {
	varImageListMetadata := _ImageListMetadata{}

	err = json.Unmarshal(data, &varImageListMetadata)

	if err != nil {
		return err
	}

	*o = ImageListMetadata(varImageListMetadata)
...
type NullableImageListMetadata struct {
	value *ImageListMetadata
	isSet bool
}

func (v NullableImageListMetadata) Get() *ImageListMetadata {
	return v.value
}

func (v *NullableImageListMetadata) Set(val *ImageListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableImageListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableImageListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageListMetadata(val *ImageListMetadata) *NullableImageListMetadata {
	return &NullableImageListMetadata{value: val, isSet: true}
}

func (v NullableImageListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
