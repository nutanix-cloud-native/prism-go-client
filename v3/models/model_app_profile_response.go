...
// checks if the AppProfileResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppProfileResponse{}

// AppProfileResponse App profile resources
type AppProfileResponse struct {
	// 
	DeploymentCreateList []BlueprintDeploymentResponse `json:"deployment_create_list,omitempty"`
	// 
...
type _AppProfileResponse AppProfileResponse
...
func (o *AppProfileResponse) GetDeploymentCreateList() []BlueprintDeploymentResponse {
	if o == nil || IsNil(o.DeploymentCreateList) {
		var ret []BlueprintDeploymentResponse
		return ret
	}
...
// SetDeploymentCreateList gets a reference to the given []BlueprintDeploymentResponse and assigns it to the DeploymentCreateList field.
...
func (o AppProfileResponse) MarshalJSON() ([]byte, error) {
...
func (o AppProfileResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AppProfileResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppProfileResponse := _AppProfileResponse{}

	err = json.Unmarshal(data, &varAppProfileResponse)

	if err != nil {
		return err
	}

	*o = AppProfileResponse(varAppProfileResponse)
...
type NullableAppProfileResponse struct {
	value *AppProfileResponse
	isSet bool
}

func (v NullableAppProfileResponse) Get() *AppProfileResponse {
	return v.value
}

func (v *NullableAppProfileResponse) Set(val *AppProfileResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppProfileResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppProfileResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppProfileResponse(val *AppProfileResponse) *NullableAppProfileResponse {
	return &NullableAppProfileResponse{value: val, isSet: true}
}

func (v NullableAppProfileResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppProfileResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
