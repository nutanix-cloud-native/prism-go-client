...
// checks if the GuestCustomization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestCustomization{}
...
type _GuestCustomization GuestCustomization
...
func (o *GuestCustomization) GetCloudInit() GuestCustomizationCloudInit {
	if o == nil || IsNil(o.CloudInit) {
		var ret GuestCustomizationCloudInit
		return ret
	}
	return *o.CloudInit
}
...
// SetCloudInit gets a reference to the given GuestCustomizationCloudInit and assigns it to the CloudInit field.
...
func (o *GuestCustomization) GetSysprep() GuestCustomizationSysprep {
	if o == nil || IsNil(o.Sysprep) {
		var ret GuestCustomizationSysprep
		return ret
	}
	return *o.Sysprep
}
...
// SetSysprep gets a reference to the given GuestCustomizationSysprep and assigns it to the Sysprep field.
func (o *GuestCustomization) SetSysprep(v GuestCustomizationSysprep) {
	o.Sysprep = &v
}

func (o GuestCustomization) MarshalJSON() ([]byte, error) {
...
func (o GuestCustomization) ToMap() (map[string]interface{}, error) {
...
func (o *GuestCustomization) UnmarshalJSON(data []byte) (err error) {
	varGuestCustomization := _GuestCustomization{}

	err = json.Unmarshal(data, &varGuestCustomization)

	if err != nil {
		return err
	}

	*o = GuestCustomization(varGuestCustomization)
...
type NullableGuestCustomization struct {
	value *GuestCustomization
	isSet bool
}

func (v NullableGuestCustomization) Get() *GuestCustomization {
	return v.value
}

func (v *NullableGuestCustomization) Set(val *GuestCustomization) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestCustomization) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestCustomization) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestCustomization(val *GuestCustomization) *NullableGuestCustomization {
	return &NullableGuestCustomization{value: val, isSet: true}
}

func (v NullableGuestCustomization) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestCustomization) UnmarshalJSON(src []byte) error {
	v.isSet = true
