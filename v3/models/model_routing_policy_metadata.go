...
// checks if the RoutingPolicyMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingPolicyMetadata{}

// RoutingPolicyMetadata The routing_policy kind metadata
type RoutingPolicyMetadata struct {
	...
	// Categories for the routing_policy. This allows setting up multiple values from a single key. Categories assigned using the older view will be present here. This is the new way of assigning categories. 
	...
	// Categories for the routing_policy. This allows assigning one value of a key to any entity. Changes done in this will be reflected in the categories_mapping field. 
...
type _RoutingPolicyMetadata RoutingPolicyMetadata
...
func (o *RoutingPolicyMetadata) SetProjectReference(v ProjectReference) {
...
// and a boolean to check if the value has been set.
func (o *RoutingPolicyMetadata) GetOwnerReferenceOk() (*UserReference, bool) {
	if o == nil || IsNil(o.OwnerReference) {
		return nil, false
	}
...
func (o *RoutingPolicyMetadata) SetName(v string) {
	o.Name = &v
}

func (o RoutingPolicyMetadata) MarshalJSON() ([]byte, error) {
...
func (o RoutingPolicyMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingPolicyMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingPolicyMetadata := _RoutingPolicyMetadata{}

	err = json.Unmarshal(data, &varRoutingPolicyMetadata)

	if err != nil {
		return err
	}

	*o = RoutingPolicyMetadata(varRoutingPolicyMetadata)
...
type NullableRoutingPolicyMetadata struct {
	value *RoutingPolicyMetadata
	isSet bool
}

func (v NullableRoutingPolicyMetadata) Get() *RoutingPolicyMetadata {
	return v.value
}

func (v *NullableRoutingPolicyMetadata) Set(val *RoutingPolicyMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingPolicyMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingPolicyMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingPolicyMetadata(val *RoutingPolicyMetadata) *NullableRoutingPolicyMetadata {
	return &NullableRoutingPolicyMetadata{value: val, isSet: true}
}

func (v NullableRoutingPolicyMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingPolicyMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
