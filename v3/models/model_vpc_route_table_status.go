...
// checks if the VpcRouteTableStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcRouteTableStatus{}

// VpcRouteTableStatus The status of a REST API call. Only used when there is a failure to report. 
type VpcRouteTableStatus struct {
	// The kind name
...
type _VpcRouteTableStatus VpcRouteTableStatus
...
func (o VpcRouteTableStatus) MarshalJSON() ([]byte, error) {
...
func (o VpcRouteTableStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VpcRouteTableStatus) UnmarshalJSON(data []byte) (err error) {
	varVpcRouteTableStatus := _VpcRouteTableStatus{}

	err = json.Unmarshal(data, &varVpcRouteTableStatus)

	if err != nil {
		return err
	}

	*o = VpcRouteTableStatus(varVpcRouteTableStatus)
...
type NullableVpcRouteTableStatus struct {
	value *VpcRouteTableStatus
	isSet bool
}

func (v NullableVpcRouteTableStatus) Get() *VpcRouteTableStatus {
	return v.value
}

func (v *NullableVpcRouteTableStatus) Set(val *VpcRouteTableStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcRouteTableStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcRouteTableStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcRouteTableStatus(val *VpcRouteTableStatus) *NullableVpcRouteTableStatus {
	return &NullableVpcRouteTableStatus{value: val, isSet: true}
}

func (v NullableVpcRouteTableStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcRouteTableStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
