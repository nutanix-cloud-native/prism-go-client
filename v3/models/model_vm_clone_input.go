...
// checks if the VmCloneInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmCloneInput{}

// VmCloneInput Input object for the clone API. User can provide the optional UUID of the vm that will be created as a result of this operation. 
type VmCloneInput struct {
	Metadata *MetadataOfTheClonedVm `json:"metadata,omitempty"`
	OverrideSpec *VmCloneOverrideSpec `json:"override_spec,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _VmCloneInput VmCloneInput
...
// SetMetadata gets a reference to the given MetadataOfTheClonedVm and assigns it to the Metadata field.
...
// SetOverrideSpec gets a reference to the given VmCloneOverrideSpec and assigns it to the OverrideSpec field.
func (o *VmCloneInput) SetOverrideSpec(v VmCloneOverrideSpec) {
	o.OverrideSpec = &v
}

func (o VmCloneInput) MarshalJSON() ([]byte, error) {
...
func (o VmCloneInput) ToMap() (map[string]interface{}, error) {
...
func (o *VmCloneInput) UnmarshalJSON(data []byte) (err error) {
	varVmCloneInput := _VmCloneInput{}

	err = json.Unmarshal(data, &varVmCloneInput)

	if err != nil {
		return err
	}

	*o = VmCloneInput(varVmCloneInput)
...
type NullableVmCloneInput struct {
	value *VmCloneInput
	isSet bool
}

func (v NullableVmCloneInput) Get() *VmCloneInput {
	return v.value
}

func (v *NullableVmCloneInput) Set(val *VmCloneInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVmCloneInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVmCloneInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmCloneInput(val *VmCloneInput) *NullableVmCloneInput {
	return &NullableVmCloneInput{value: val, isSet: true}
}

func (v NullableVmCloneInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmCloneInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
