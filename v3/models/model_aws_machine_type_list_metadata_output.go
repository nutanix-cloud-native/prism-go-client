...
// checks if the AwsMachineTypeListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsMachineTypeListMetadataOutput{}

// AwsMachineTypeListMetadataOutput All api calls that return a list will have this metadata block 
type AwsMachineTypeListMetadataOutput struct {
	// The kind name
...
type _AwsMachineTypeListMetadataOutput AwsMachineTypeListMetadataOutput
...
func NewAwsMachineTypeListMetadataOutput() *AwsMachineTypeListMetadataOutput {
	this := AwsMachineTypeListMetadataOutput{}
	var kind string = "aws_machine_type"
	this.Kind = &kind
	return &this
}
...
func (o AwsMachineTypeListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o AwsMachineTypeListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *AwsMachineTypeListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varAwsMachineTypeListMetadataOutput := _AwsMachineTypeListMetadataOutput{}

	err = json.Unmarshal(data, &varAwsMachineTypeListMetadataOutput)

	if err != nil {
		return err
	}

	*o = AwsMachineTypeListMetadataOutput(varAwsMachineTypeListMetadataOutput)
...
type NullableAwsMachineTypeListMetadataOutput struct {
	value *AwsMachineTypeListMetadataOutput
	isSet bool
}

func (v NullableAwsMachineTypeListMetadataOutput) Get() *AwsMachineTypeListMetadataOutput {
	return v.value
}

func (v *NullableAwsMachineTypeListMetadataOutput) Set(val *AwsMachineTypeListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsMachineTypeListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsMachineTypeListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsMachineTypeListMetadataOutput(val *AwsMachineTypeListMetadataOutput) *NullableAwsMachineTypeListMetadataOutput {
	return &NullableAwsMachineTypeListMetadataOutput{value: val, isSet: true}
}

func (v NullableAwsMachineTypeListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsMachineTypeListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
