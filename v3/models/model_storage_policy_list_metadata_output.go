...
// checks if the StoragePolicyListMetadataOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePolicyListMetadataOutput{}

// StoragePolicyListMetadataOutput All api calls that return a list will have this metadata block 
type StoragePolicyListMetadataOutput struct {
	// The kind name
...
type _StoragePolicyListMetadataOutput StoragePolicyListMetadataOutput
...
func NewStoragePolicyListMetadataOutput() *StoragePolicyListMetadataOutput {
	this := StoragePolicyListMetadataOutput{}
	var kind string = "storage_policy"
	this.Kind = &kind
	return &this
}
...
func (o StoragePolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
...
func (o StoragePolicyListMetadataOutput) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePolicyListMetadataOutput) UnmarshalJSON(data []byte) (err error) {
	varStoragePolicyListMetadataOutput := _StoragePolicyListMetadataOutput{}

	err = json.Unmarshal(data, &varStoragePolicyListMetadataOutput)

	if err != nil {
		return err
	}

	*o = StoragePolicyListMetadataOutput(varStoragePolicyListMetadataOutput)
...
type NullableStoragePolicyListMetadataOutput struct {
	value *StoragePolicyListMetadataOutput
	isSet bool
}

func (v NullableStoragePolicyListMetadataOutput) Get() *StoragePolicyListMetadataOutput {
	return v.value
}

func (v *NullableStoragePolicyListMetadataOutput) Set(val *StoragePolicyListMetadataOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePolicyListMetadataOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePolicyListMetadataOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePolicyListMetadataOutput(val *StoragePolicyListMetadataOutput) *NullableStoragePolicyListMetadataOutput {
	return &NullableStoragePolicyListMetadataOutput{value: val, isSet: true}
}

func (v NullableStoragePolicyListMetadataOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePolicyListMetadataOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
