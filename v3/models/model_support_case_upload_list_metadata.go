...
// checks if the SupportCaseUploadListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCaseUploadListMetadata{}

// SupportCaseUploadListMetadata All api calls that return a list will have this metadata block as input 
type SupportCaseUploadListMetadata struct {
	// The kind name
...
type _SupportCaseUploadListMetadata SupportCaseUploadListMetadata
...
func NewSupportCaseUploadListMetadata() *SupportCaseUploadListMetadata {
	this := SupportCaseUploadListMetadata{}
...
func (o SupportCaseUploadListMetadata) MarshalJSON() ([]byte, error) {
...
func (o SupportCaseUploadListMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SupportCaseUploadListMetadata) UnmarshalJSON(data []byte) (err error) {
	varSupportCaseUploadListMetadata := _SupportCaseUploadListMetadata{}

	err = json.Unmarshal(data, &varSupportCaseUploadListMetadata)

	if err != nil {
		return err
	}

	*o = SupportCaseUploadListMetadata(varSupportCaseUploadListMetadata)
...
type NullableSupportCaseUploadListMetadata struct {
	value *SupportCaseUploadListMetadata
	isSet bool
}

func (v NullableSupportCaseUploadListMetadata) Get() *SupportCaseUploadListMetadata {
	return v.value
}

func (v *NullableSupportCaseUploadListMetadata) Set(val *SupportCaseUploadListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportCaseUploadListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportCaseUploadListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportCaseUploadListMetadata(val *SupportCaseUploadListMetadata) *NullableSupportCaseUploadListMetadata {
	return &NullableSupportCaseUploadListMetadata{value: val, isSet: true}
}

func (v NullableSupportCaseUploadListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportCaseUploadListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
