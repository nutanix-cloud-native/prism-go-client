...
// checks if the DirectConnectVirtualInterfaceReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectConnectVirtualInterfaceReference{}

// DirectConnectVirtualInterfaceReference The reference to a direct_connect_virtual_interface
...
type _DirectConnectVirtualInterfaceReference DirectConnectVirtualInterfaceReference
...
func NewDirectConnectVirtualInterfaceReference(kind string, uUID string) *DirectConnectVirtualInterfaceReference {
	this := DirectConnectVirtualInterfaceReference{}
	this.Kind = kind
	this.UUID = uUID
	return &this
}
...
func (o DirectConnectVirtualInterfaceReference) MarshalJSON() ([]byte, error) {
...
func (o DirectConnectVirtualInterfaceReference) ToMap() (map[string]interface{}, error) {
...
func (o *DirectConnectVirtualInterfaceReference) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectConnectVirtualInterfaceReference := _DirectConnectVirtualInterfaceReference{}

	err = json.Unmarshal(data, &varDirectConnectVirtualInterfaceReference)

	if err != nil {
		return err
	}

	*o = DirectConnectVirtualInterfaceReference(varDirectConnectVirtualInterfaceReference)
...
type NullableDirectConnectVirtualInterfaceReference struct {
	value *DirectConnectVirtualInterfaceReference
	isSet bool
}

func (v NullableDirectConnectVirtualInterfaceReference) Get() *DirectConnectVirtualInterfaceReference {
	return v.value
}

func (v *NullableDirectConnectVirtualInterfaceReference) Set(val *DirectConnectVirtualInterfaceReference) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectConnectVirtualInterfaceReference) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectConnectVirtualInterfaceReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectConnectVirtualInterfaceReference(val *DirectConnectVirtualInterfaceReference) *NullableDirectConnectVirtualInterfaceReference {
	return &NullableDirectConnectVirtualInterfaceReference{value: val, isSet: true}
}

func (v NullableDirectConnectVirtualInterfaceReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectConnectVirtualInterfaceReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
